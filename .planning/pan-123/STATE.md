...
- [x] Reviewed existing KanbanBoard.tsx implementation
- [x] Reviewed server API patterns

### Completed Tasks
- [x] Install @dnd-kit/core and dependencies
- [x] Add move-status API endpoint
- [x] Add DnD providers to KanbanBoard
- [x] Implement drag visual feedback
- [x] Add undo functionality
- [x] Add agent warning dialog
- [x] Add Done column sync prompt
- [x] TypeScript compilation passes
- [x] Tests run (pre-existing failures in work-type-router unrelated)
