...
<ThemedImage
  light="/images/command-deck/issue-cockpit-light.png"
  dark="/images/command-deck/issue-cockpit-dark.png"
  alt="The issue cockpit — blocker spotlight, phase timeline, and single-source metric strip"
/>
...
<ThemedImage
  ...
  alt="Pipeline page — a metric strip (Active issues, Work running, Review queue, Ship, Spend) above phase-grouped issue rows for Ship, Review, and Verifying, with an activity feed on the right"
/>
