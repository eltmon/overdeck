...
export const ArtifactHarness = Schema.Literals(["claude-code", "pi", "user"])
export type ArtifactHarness = typeof ArtifactHarness.Type

export const ArtifactHash = Schema.String.check(Schema.isPattern(/^sha256:[a-f0-9]{64}$/i))
export type ArtifactHash = typeof ArtifactHash.Type

export const ArtifactSeverity = Schema.Literals(["error", "warning"])
export type ArtifactSeverity = typeof ArtifactSeverity.Type
...
export type ArtifactFinding = typeof ArtifactFinding.Type

export const ArtifactValidationResult = Schema.Struct({
  ok: Schema.Boolean,
  errors: Schema.Array(ArtifactFinding),
  warnings: Schema.Array(ArtifactFinding),
  strictModeFindings: Schema.Array(ArtifactFinding),
  size: Schema.Number,
  hash: ArtifactHash,
})
...
export const ArtifactProvenance = Schema.Struct({
  ...
  agentRole: ArtifactAgentRole,
  agentHarness: ArtifactHarness,
  runId: Schema.optional(Schema.String),
  sessionId: Schema.optional(Schema.String),
  filePath: Schema.String,
  currentHash: ArtifactHash,
  lastPublishedHash: Schema.optional(ArtifactHash),
  supersedes: Schema.optional(Schema.String),
  createdAt: Schema.String,
  updatedAt: Schema.String,
  publishedAt: Schema.optional(Schema.String),
  unsharedAt: Schema.optional(Schema.String),
...
export const ArtifactCreateResponse = ArtifactPublishResponse
export type ArtifactCreateResponse = typeof ArtifactCreateResponse.Type

export const ArtifactMetadataResponse = Schema.Struct({
  artifact: ArtifactProvenance,
  status: ArtifactStatus,
  urls: ArtifactUrls,
})
export type ArtifactMetadataResponse = typeof ArtifactMetadataResponse.Type
