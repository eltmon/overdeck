...
export const Role = Schema.Literals(["plan", "work", "review", "test", "ship", "flywheel", "strike", "sequencer", "knowledge", "worker"])
...
export const SessionNode = Schema.Struct({
  ...
  // PAN-3917: the pause and troubled gates are gone with the agent mirror, and
  // so is the mail queue they fed. A node's state is the backend pane's.
