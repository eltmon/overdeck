...
export interface WorkspaceConfig {
  ...
  groups_file?: string;
  repos?: Array<{ name: string; path: string; branch_prefix?: string; default_branch?: string; pr_target?: string; readonly?: boolean; link_type?: 'worktree' | 'symlink'; group?: string }>;
