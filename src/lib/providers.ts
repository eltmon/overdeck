...
import type { ModelId, AnthropicModel, OpenAIModel, GoogleModel } from './settings.js';
...
export const PROVIDERS: Record<ProviderName, ProviderConfig> = {
  ...
  openai: {
    ...
    models: ['gpt-5.2-codex', 'o3-deep-research', 'gpt-4o', 'gpt-4o-mini'] as unknown as ModelId[],
    tested: false,
  ...
  google: {
    ...
    compatibility: 'router',
    models: ['gemini-3-pro-preview', 'gemini-3-flash-preview', 'gemini-2.5-pro', 'gemini-2.5-flash'] as unknown as ModelId[],
    tested: false,
    description: 'Requires claude-code-router for API translation',
  },
