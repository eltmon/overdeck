...
// The GPT-6 family (astra, sol, luna) shares the 272K billing tier and the 872K
// raw ceiling with GPT-5.6 (Codex catalog, 2026-09-07 / 0.157.1), so it takes the same pin. The
// set name is kept for continuity with PAN-3057/PAN-3388.
const GPT_56_MODELS = new Set(['gpt-6-astra', 'gpt-6-sol', 'gpt-6-luna', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna']);
