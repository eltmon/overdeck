 ...
 * - `listRunningAgentsSync` (async: `listRunningAgents`): 8 sites in cli/commands/health.ts,
 *   cli/commands/status.ts, cli/commands/workspace-maintenance.ts, lib/cloister/concurrency.ts,
 *   lib/cloister/service.ts, lib/parked/resolver.ts.
