...
export const DOD_ROWS: readonly DodRowDef[] = [
  {
    ...
    num: 1,
    title: 'Review passed',
    expected: 'review passed, or tracker-closed with landed work and no negative review verdict',
    overridable: true,
  },
  {
    id: 'tests',
    num: 2,
    title: 'Tests passed',
    expected: 'tests passed, or tracker-closed with landed work (negative verdict requires main verification pass)',
    overridable: true,
  },
  {
    id: 'verification',
    ...
    expected: 'verification passed, or tracker-closed with landed work (negative verdict requires main verification pass)',
    overridable: true,
  },
