/**
 * Live tracker canonical state for the post-merge DoD row (PAN-3188 row 5).
 *
 * PAN-3917: relocated verbatim from `cloister/deacon-canonical-state.ts` — it
 * has no cloister/state-layer dependency at all, just `gh issue view` +
 * `mapGitHubStateToCanonical`. Misfiled under cloister/, not deleted content.
 */
