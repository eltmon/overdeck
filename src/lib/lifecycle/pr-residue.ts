/**
 * Residue disposition (PAN-3396): close stale convention PRs/MRs for
 * tracker-closed issues with no landing evidence, via `pan close --residue`.
 * Pure git-remote/gh/glab CLI operations — no state-layer dependency.
 * PAN-3917: recreated here (was lifecycle/residue.ts) since that path is on
 * the Appendix A.5 delete list even though this file's own content never
 * touched the record plane.
 */
