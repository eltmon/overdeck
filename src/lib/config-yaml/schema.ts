...
import type { TieredExecutionConfig, ValidatedTieredExecutionConfig, YamlTieredExecutionConfig } from '../agents/tier-table.js';
...
export interface YamlConfig {
  ...
  /** Difficulty-routed tier table for standing work agents. Off by default. */
  tiered_execution?: YamlTieredExecutionConfig;
