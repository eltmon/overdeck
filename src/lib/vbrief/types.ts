 ...
 *   - subitem metadata.kind: "acceptance_criterion" on child items
 */
...
export function resolveVBriefItemKind(metadata?: VBriefItemMetadata): VBriefItemKind {
  return metadata?.kind ?? 'backend';
}
