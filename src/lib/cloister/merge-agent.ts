              ...
              if (validationResult.valid) {
                ...
                if (preMergeStashRef) {
                  try {
                    ...
                    console.warn(`[merge-agent] ⚠ Failed to drop pre-merge stash after merge: ${popErr.message}`);
                  }
                }
                ...
                if (preMergeStashRef) {
                  try {
                    ...
                    console.warn(`[merge-agent] ⚠ Failed to drop pre-merge stash after revert: ${popErr.message}`);
                  }
                }
