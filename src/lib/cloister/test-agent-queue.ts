...
3. Read .pan/records/${options.issueId.toLowerCase()}.json, the canonical vBRIEF under .pan/specs/ for ${options.issueId}, issue notes, and project instructions to determine required verification. Do not require retired workspace-local .pan/continue.json or .pan/spec.vbrief.json files to exist.
