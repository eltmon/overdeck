...
export const postAgentsRoute = HttpRouter.add(
  ...
  httpHandler(Effect.gen(function* () {
    ...
    const userPickedHarness: 'claude-code' | 'ohmypi' | 'codex' | 'acp' | 'kimi-code' | 'opencode' | null =
      bodyHarness === 'ohmypi' || bodyHarness === 'claude-code' || bodyHarness === 'codex' || bodyHarness === 'acp' || bodyHarness === 'kimi-code' || bodyHarness === 'opencode' ? bodyHarness : null;
