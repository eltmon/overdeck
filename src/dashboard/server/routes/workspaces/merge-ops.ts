...
import { activeStrikeMerge, ensureAgentReadyForMerge, mergeCompletionStatus, normalMergeEligibility, postRebaseVerificationOptions, validateStrikeMergeRequest, type StrikeMergeRequest, type TriggerMergeRequest, type TriggerMergeResult } from './merge-strike.js';
    ...
    const verifyResult = skipLocalVerification
      ...
      : await (async () => {
        ...
        return Effect.runPromise(runVerificationForIssue(
          ...
          { isRemote: false },
          'merge-verify',
          { ...postRebaseVerificationOptions(request), onGateLog: (line) => appendShipLog(issueId, line, 'verifying') },
        ));
      })();
