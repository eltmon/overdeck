      ...
      <div className="flex flex-1 gap-3 px-3 pb-3 pt-2 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-3 gap-3 content-start overflow-auto">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="bg-surface-raised rounded-lg p-3 space-y-2 min-h-[120px]">
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 animate-pulse bg-surface-2 rounded-full" />
                <div className="h-3 w-24 animate-pulse bg-surface-2 rounded" />
              </div>
              <div className="h-3 w-3/4 animate-pulse bg-surface-2 rounded" />
              <div className="h-3 w-1/2 animate-pulse bg-surface-2 rounded" />
              <div className="h-16 animate-pulse bg-surface-2 rounded mt-2" />
            </div>
          ))}
        </div>
        ...
        <div className="w-[220px] shrink-0 space-y-3">
          <div className="bg-surface-raised rounded-lg p-3">
            <div className="h-3 w-20 animate-pulse bg-surface-2 rounded mb-3" />
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex items-center gap-2 py-1.5">
                <div className="h-2 w-2 animate-pulse bg-surface-2 rounded-full" />
                <div className="h-3 flex-1 animate-pulse bg-surface-2 rounded" />
              </div>
            ))}
          </div>
          <div className="bg-surface-raised rounded-lg p-3">
            <div className="h-3 w-24 animate-pulse bg-surface-2 rounded mb-3" />
