...
const TOOLTIP =
  'Reset Issue: stops any running agent, deletes the workspace and feature branch (including the continue file), clears all tasks and vBRIEF, and moves the issue back to Todo. Use when the current approach is completely wrong and you want to start over from planning.';
    ...
    return (
      <div className="min-w-0">
        ...
        <div className="text-[11px] text-muted-foreground mt-0.5" title={TOOLTIP}>
          Deletes the workspace, branch, continue file, tasks, and vBRIEF. Moves the issue back to Todo. Start over from planning.
        </div>
        <button
          onClick={handleClick}
          disabled={isPending}
