...
export const MODELS_BY_PROVIDER: Record<string, ProviderDef> = {
  ...
  openai: {
    name: 'OpenAI',
    models: [
      { id: 'gpt-5.5-pro' as ModelId, name: 'GPT-5.5 Pro', icon: Gem, tier: 'premium', capabilities: ['reasoning', 'code', 'vision', 'agentic', 'large-context'], description: 'Most advanced OpenAI model. Pro subscribers only.' },
      { id: 'gpt-5.5' as ModelId, name: 'GPT-5.5', icon: Sparkles, tier: 'balanced', capabilities: ['reasoning', 'code', 'vision', 'agentic', 'large-context'], description: 'OpenAI flagship. 1.05M context, strong coding.' },
      { id: 'gpt-5.5-mini' as ModelId, name: 'GPT-5.5 Mini', icon: FlaskConical, tier: 'fast', capabilities: ['fast', 'cost-efficient', 'code'], description: 'Fast and efficient. 400K context.' },
      { id: 'gpt-5.5-nano' as ModelId, name: 'GPT-5.5 Nano', icon: Zap, tier: 'fast', capabilities: ['fast', 'cost-efficient'], description: 'Fastest OpenAI model. API-only.' },
      { id: 'gpt-5.4-pro' as ModelId, name: 'GPT-5.4 Pro', icon: Gem, tier: 'premium', capabilities: ['reasoning', 'code', 'vision', 'agentic', 'large-context'], description: 'Previous flagship Pro model.' },
      { id: 'gpt-5.4' as ModelId, name: 'GPT-5.4', icon: Sparkles, tier: 'balanced', capabilities: ['reasoning', 'code', 'vision', 'agentic', 'large-context'], description: 'Previous OpenAI flagship. 1.05M context, strong coding.' },
      { id: 'gpt-5.4-mini' as ModelId, name: 'GPT-5.4 Mini', icon: FlaskConical, tier: 'fast', capabilities: ['fast', 'cost-efficient', 'code'], description: 'Previous fast and efficient 400K context model.' },
      { id: 'gpt-5.4-nano' as ModelId, name: 'GPT-5.4 Nano', icon: Zap, tier: 'fast', capabilities: ['fast', 'cost-efficient'], description: 'Previous fastest OpenAI model. API-only.' },
...
export function getModelById(id: ModelId): ModelDef | undefined {
  ...
  if (idLower.includes('gpt-5.5-pro')) return models.find(m => m.id === 'gpt-5.5-pro');
  ...
  if (idLower.includes('gpt-5') || idLower.includes('codex')) return models.find(m => m.id === 'gpt-5.5');
