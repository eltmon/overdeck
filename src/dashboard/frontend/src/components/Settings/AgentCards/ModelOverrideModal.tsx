...
export const MODELS_BY_PROVIDER: Record<string, ProviderDef> = {
  ...
  google: {
    ...
    models: [
      ...
      { id: 'gemini-3-flash' as ModelId, name: 'Gemini 3 Flash', icon: Zap, tier: 'fast', costPer1MTokens: 0.4, capabilities: ['fast', 'cost-efficient', 'large-context'], description: 'Fast and cheap with 1M context' },
