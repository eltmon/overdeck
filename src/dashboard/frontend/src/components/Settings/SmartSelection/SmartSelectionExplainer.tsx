...
export function SmartSelectionExplainer() {
  return (
    <section className="mb-12">
      ...
      <div className="bg-surface-raised rounded-xl p-6 border border-divider shadow-sm">
        {/* Philosophy */}
        ...
        <div className="border-t border-divider pt-4 mt-4">
          <h4 className="text-sm font-medium mb-3 flex items-center gap-2">
            <span className="material-symbols-outlined text-content-muted">lightbulb</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="bg-surface rounded-lg p-3 border border-divider">
              ...
              <p className="text-content-muted">Claude Opus 4.5 - Best for complex reasoning</p>
            </div>
            <div className="bg-surface rounded-lg p-3 border border-divider">
              <div className="flex items-center gap-2 mb-1">
