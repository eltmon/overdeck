...
type SettingsResponse = {
  ...
  roles?: {
    plan?: {
      ...
      harness?: 'claude-code' | 'pi' | 'ohmypi' | 'codex';
    };
  };
};
...
export function PlanDialog({ issue, isOpen, onClose, onComplete, onTerminalReleased, autoStart = false }: PlanDialogProps) {
  ...
  useEffect(() => {
    ...
    if (defaultPlanningHarness === 'ohmypi' || defaultPlanningHarness === 'pi' || defaultPlanningHarness === 'claude-code' || defaultPlanningHarness === 'codex') {
