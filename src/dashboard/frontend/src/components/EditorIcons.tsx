...
export const CursorIcon: EditorIcon = (props) => (
...
export const TraeIcon: EditorIcon = (props) => (
...
// ─── VS Code (real brand blue) ──────────────────────────────────────────────

export const VSCodeIcon: EditorIcon = (props) => {
  const id = useId();
...
export const ZedIcon: EditorIcon = (props) => {
  const id = useId();
