...
type PreviewTab = 'claude-code' | 'ohmypi' | 'codex' | 'acp' | 'kimi-code' | 'muse' | 'opencode' | 'prime-agent' | 'fullPrompt';
...
const previewOptions: [PreviewTab, string][] = [['claude-code', 'Claude Code'], ['codex', 'Codex'], ['ohmypi', 'oh-my-pi'], ['kimi-code', 'Kimi Code'], ['acp', 'ACP'], ['muse', 'Muse'], ['opencode', 'OpenCode'], ['prime-agent', 'Prime Agent'], ['fullPrompt', 'All harnesses']];
