  ...
  workspaces: [
    {
      ...
      path: '/repo/overdeck/workspaces/feature-pan-1201-slot-3',
      issueId: 'PAN-1201',
    },
  ],
  layers: [
    ...
    },
    {
      kind: 'workspace',
      projectKey: 'overdeck',
      workspacePath: '/repo/overdeck/workspaces/feature-pan-1201-slot-3',
      file: '/repo/overdeck/workspaces/feature-pan-1201-slot-3/.pan/context/workspace.md',
      exists: false,
...
describe('ContextPage', () => {
  ...
  it('offers every harness and preserves source drafts when switching views', async () => {
    ...
    for (const [value, text] of [['codex', 'Codex'], ['acp', 'ACP'], ['kimi-code', 'Kimi']]) {
