...
export const ISSUE_VIEW_INVENTORY: readonly IssueViewInventoryEntry[] = [
  ...
  { section: 'PhaseTimeline', view: 'console', home: 'src/dashboard/frontend/src/components/issue-detail/IssuePhaseRail.tsx' },
  { section: 'DrawerTabs', view: 'console', home: 'src/dashboard/frontend/src/components/issue-detail/IssueDetail.tsx' },
  ...
  { section: 'PickupGateCard', view: 'cockpit', home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueOverviewTab.tsx' },
  { section: 'PlanMapCard', view: 'cockpit', home: 'src/dashboard/frontend/src/components/Stage/cockpit/PlanMapCard.tsx' },
  { section: 'IssueBlockerSpotlight', view: 'cockpit', home: 'src/dashboard/frontend/src/components/issue-view/NeedsYouSlot.tsx' },
  {
    section: 'Session tab',
    view: 'cockpit',
    home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    actionRelocation: {
      surface: 'Conversation / Files / Terminal tabs',
      home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    },
  },
  {
    ...
    home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    actionRelocation: {
      surface: 'Code / Files / Artifacts tabs',
      home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    },
  },
  {
    section: 'Plan / Activity / Discussion tabs',
    view: 'cockpit',
    home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    actionRelocation: {
      surface: 'PRD / Timeline / Discussion tabs',
      home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    },
  },
  {
    section: 'Cost / Artifacts / Ship homes',
    view: 'cockpit',
    home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    actionRelocation: {
      surface: 'Costs / Artifacts / Ship tabs',
      home: 'src/dashboard/frontend/src/components/Stage/cockpit/IssueMissionControl.tsx',
    },
  },
