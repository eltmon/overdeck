...
- **Cycle count:** The codebase had **76** cycles at implementation time, not 74 as estimated in the PRD.
...
- `scripts/circular-deps-baseline.txt` — 76 canonical cycles, sorted.
