...
**Status:** draft v2 (incorporates GPT-5.5 review [`docs/reviews/PAN-1883-1877-1884-GPT55.md`](../../docs/reviews/PAN-1883-1877-1884-GPT55.md) — separates
tracked-repo from local-memory mutation; updates both flywheel surfaces; makes rules mechanically
checkable). Awaiting human + AI re-review before execution.
