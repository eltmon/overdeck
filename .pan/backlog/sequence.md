...
| 3 | PAN-3566 | XS | critical | ok |  |  | Test-role launcher execs claude with no user prompt, so the role boots an idle REPL — the deterministic producer of zombie test agents. |
| 4 | PAN-3285 | M | critical | ok |  |  | A supervisor pinned to a reload generation SIGTERMs every healthy dashboard and cannot start one: 3.5h outage, 1107 silent failures. |
| 5 | PAN-3524 | M | critical | ok |  |  | A server-owned --changed verification loop relaunches through deacon freeze, review abort, pause and operator stop; peaked at 78 workers. |
| 6 | PAN-3250 | S | critical | ok |  |  | Workspace spawn branches from local HEAD instead of origin/main, so every new feature branch inherits unpushed local-main commits. |
| 7 | PAN-2954 | XS | critical | ok |  |  | postMergeLifecycle refuses GitLab projects |
| 8 | PAN-3657 | S | critical | ok |  |  | Merge-train queues endpoint runs the monorepo queue builder for polyrepo projects, so MYN/Auricle trains are permanently empty. |
| 9 | PAN-3565 | M | critical | ok |  |  | Failed review spawn wedges 'starting', and an all-lanes infra failure is synthesized as a real CHANGES REQUESTED verdict. |
| 10 | PAN-3554 | M | critical | needs-refinement |  |  | Red main has no mechanical owner: it hid for ~5h because the merge gate renders red main as an empty queue, not an alarm. |
| 11 | PAN-3532 | S | critical | ok |  |  | CI runs only a hand-picked slice of the frontend suite, so main stayed red on frontend for hours while every run reported green. |
| 12 | PAN-3685 | S | high | ok |  |  | Swarm GC leaves consumed completion markers that hold slot capacity after assignments are freed |
| 13 | PAN-3085 | XS | critical | needs-refinement |  |  | Review feedback is written to .overdeck/feedback but agents and the deacon merge gate are pointed at a nonexistent .pan/feedback. |
| 14 | PAN-3654 | S | critical | needs-refinement |  |  | Compact respawn confirms against the archived session and kills a healthy fresh agent that was already doing the work. |
| 15 | PAN-3653 | M | critical | ok |  |  | A strike blocked on red main has no owner that wakes it when main goes green; the session stays alive so recover refuses it. |
| 16 | PAN-3630 | M | critical | ok |  |  | pan tell reported three deliveries to a live agent, moved all three to read/, and the agent received none — the delivery door lies. |
| 17 | PAN-3805 | S | critical | ok |  |  | Codex idle poke spawns codex exec instead of the app-server door; failed sends still tick the counter and pause healthy agents |
| 18 | PAN-3560 | M | critical | ok |  |  | PTY supervisor overloads under concurrent review convoys; fleet-wide 502 'input echo confirmation failed' kills resumes and feedback. |
| 19 | PAN-3520 | S | critical | ok |  |  | Test gate records 'failed' for load-induced timeouts; retry timeout-only failures in isolation before writing a verdict. |
| 20 | PAN-3500 | S | critical | ok |  |  | A review sub-role edited seven tracked files after writing its report and the changes were auto-committed into the feature history. |
| 21 | PAN-3313 | S | critical | ok |  |  | A transient upstream stream error benches CLIProxy's only auth: ~70% of GPT-routed inference 503s with a message that blames credentials. |
| 22 | PAN-3282 | M | critical | ok |  |  | Review agents die before writing a verdict across 5 issues and 2 projects, leaving a verdict-shaped status with no artifact behind it. |
| 23 | PAN-3898 | M | critical | ok |  |  | First post-epic strike: salvage re-arms a landed strike, close-out records zero merges, no post-merge deploy fires |
| 24 | PAN-3905 | S | critical | ok |  |  | Planner-created workspaces are not pre-trusted; first agent spawned into them dies at the Claude trust dialog |
| 25 | PAN-2695 | S | high | ok |  |  | Concurrent review dispatches race fresh-spawn vs resume |
| 26 | PAN-2742 | S | high | ok |  |  | synthesis fires 42s after spawn and reports reviewers with reports on disk as 'infrastructure failure' |
| 27 | PAN-2706 | M | high | ok |  |  | Ghost test sessions absorb every test dispatch |
| 28 | PAN-2700 | S | high | ok |  |  | Test artifact recovery consumes a stale .pan/test/result.json |
| 29 | PAN-1560 | XS | high | ok |  |  | Re-review after a PR head moves doesn't re-post panopticon/review status → PR stranded BLOCKED |
| 30 | PAN-2828 | S | critical | ok |  |  | pan done --strike always refuses squash-merged strikes (--is-ancestor can't see through a squash) |
| 31 | PAN-2874 | M | critical | ok |  | PAN-2828 | Strike landing pipeline cannot merge strikes: verification gate demands a vBRIEF checklist strikes never have, and failed-feedback deli… |
| 32 | PAN-2883 | M | high | ok |  | PAN-2828 | Close-out deploy row fails for every strike-landed issue |
| 33 | PAN-2806 | S | high | ok |  |  | strike merge trigger registry splits across dashboard chunks |
| 34 | PAN-2940 | M | critical | ok |  |  | Three red-mains in one day from direct-push series bypassing PR CI |
| 35 | PAN-3708 | M | critical | ok |  |  | pan strike dies at git worktree list on a polyrepo wrapper — the urgent-strike escape hatch is unavailable for MYN-class projects. |
| 36 | PAN-3605 | XS | high | ok |  |  | Supply chain: lint-effect-diagnostics npx fell back to the registry and ran a squatted unscoped package; pin the scoped local bin. |
| 37 | PAN-3569 | S | critical | needs-refinement |  |  | A stale pending-post-merge.json deadlocks the deploy gate: no staleness rule, and both owners need the restart the gate refuses. |
| 38 | PAN-3557 | S | critical | ok |  |  | Post-merge label writes have no retry; a 403 hides a merged issue from the verify-on-main sweep while lifecycle reports success. |
| 39 | PAN-3543 | S | critical | ok |  |  | Completed-handoff agents are unstartable: start, --fresh and reset-session all refuse while the refusal itself recommends --fresh. |
| 40 | PAN-3522 | S | critical | ok |  |  | Supervisor watchdog restart-churns under CPU storm because the probe timeout budget ignores the boot warm phase. |
| 41 | PAN-3314 | M | critical | ok |  |  | One cgroup holds every agent pane, so a single hungry agent inflates the unit and oomd kills the whole fleet — twice now. |
| 42 | PAN-3278 | S | critical | ok |  |  | A finished work agent with an open PR sat two hours because review was never dispatched and auto-requeue fired none of 25 attempts. |
| 43 | PAN-3237 | S | critical | ok |  |  | A capacity 409 on planning→work handoff is classified as 'guardrails' and marked terminally stuck; three issues stranded at once. |
| 44 | PAN-3234 | S | critical | ok |  |  | Agents freeze indefinitely on blocking choice menus and no health surface notices; the detector is wired only to delivery refusal. |
| 45 | PAN-3205 | S | critical | ok |  |  | The deployment gate promises the queued deploy will fire at the next verification boundary; that trigger does not exist. |
| 46 | PAN-3168 | XS | critical | ok |  |  | DoD row 5 counts status 'unknown' as running, so an agent paused FOR close-out blocks close-out — a permanent verifying_on_main deadlock. |
| 47 | PAN-3118 | S | critical | ok |  |  | Model-specific quota exhaustion is invisible everywhere but the pane: four planning agents read 'running' at $0.00 with no fallback. |
| 48 | PAN-3106 | S | critical | ok |  |  | auto_merge_default: hold is consulted on one merge path only, so held issues merge individually and defeat the UAT train. |
| 49 | PAN-3103 | S | critical | needs-refinement |  |  | A transient merge_status=failed skips close-out permanently, leaving merged work open and pickup-eligible for a fresh planning agent. |
| 50 | PAN-3100 | S | critical | ok |  |  | The test role evaluates the dirty working tree, so a live work agent's uncommitted edits are recorded as the issue's test failure. |
...
| 53 | PAN-3096 | S | critical | ok |  |  | pan done blocks on generated .devcontainer/ and dev, and agents resolve it by deleting workspace infrastructure or inventing gitignores. |
| 54 | PAN-3084 | S | critical | ok |  |  | A review session spawned but never briefed sits at zero context forever, and restart 'preserves' the zombie that blocks its replacement. |
| 55 | PAN-3043 | S | critical | ok |  |  | Provider health is probed only at spawn, so a mid-run 403 quota refusal leaves an agent 'running' for days holding a slot. |
| 56 | PAN-1824 | S | high | ok |  |  | Fix flaky main CI: fake timers + @slow exclusion for real-timer test family |
| 57 | PAN-2932 | S | high | ok |  | PAN-2337 | intermittent dashboard boot wedge between Cloister start and ReadModel bootstrap leaves :3011 unbound (Bad Gateway) after pan reload |
| 58 | PAN-2935 | S | critical | ok |  |  | Workspace devcontainer duplicate backend hijacks Traefik router |
| 59 | PAN-2337 | XS | critical | ok |  |  | Reload/build atomicity: an in-place `npm run build` under a live dashboard breaks new PTY-supervisor spawns until restart |
...
| 65 | PAN-2758 | S | critical | ok |  |  | Provider capacity error silently zombies a spawned agent: willRetry=false, turn reported completed, state stays status=running forever |
...
| 68 | PAN-2846 | S | critical | ok |  |  | Close-out blocks on a dead agent: postMergeLifecycle pauses the work agent but leaves status=running |
| 69 | PAN-2668 | M | high | ok |  |  | Verification/review feedback silently queued to stopped-by-user agents |
| 70 | PAN-2569 | XS | critical | ok |  |  | planning finalizes (issue→planned) but work agent does not auto-spawn |
| 71 | PAN-3899 | S | high | ok |  |  | pan reload drops the Deacon/resume boot gates chosen at the last restart, so every deploy relaunches with the Deacon off |
| 72 | PAN-3811 | M | high | ok |  |  | The PAN-3809 emergency strike prunes BuildKit unconditionally; inventory, bounded reclaim door and retention floor are still missing |
| 73 | PAN-2179 | S | high | ok |  |  | relaunch can leave a zombie agent |
| 74 | PAN-2169 | S | high | ok |  |  | kimi agent silently frozen at 100% ctx (no thrown overflow error) not caught by CONTEXT_OVERFLOW_PATTERNS |
| 75 | PAN-2734 | S | high | ok |  |  | merge queue head-of-line zombie |
| 76 | PAN-3697 | XS | high | ok |  |  | Deployed dashboard PATH omits Bun, so verification workers hit 'bun: not found' before the required install gate. |
| 77 | PAN-3633 | S | high | ok |  |  | Strike workspaces spawn without @types, so the contract's own typecheck gate fails and agents abort reporting a false red main. |
| 78 | PAN-3104 | S | critical | ok |  |  | A stale .pan/test/result.json is re-applied with no freshness check against HEAD, re-failing an issue long after the fix landed. |
| 79 | PAN-3099 | XS | critical | ok |  |  | --health-timeout 120 is enforced as 120ms and a false-failed check exits after killing the old server — nothing left listening. |
| 80 | PAN-3044 | XS | critical | ok |  |  | Feedback delivery has no terminal-issue guard: it dispatched review and raised needs-you on issues closed 12 days earlier. |
| 81 | PAN-3040 | S | critical | ok |  |  | pan strike is monorepo-shaped end to end and fails immediately on polyrepo projects; same defect as PAN-3708. |
| 82 | PAN-3023 | S | critical | ok |  |  | Post-planning auto-spawn logs 'attempt 1/3' and never retries after a transient Docker EOF, stranding the issue with no re-drive owner. |
| 83 | PAN-1618 | S | high | ok |  |  | Substrate: work-spawn docker-health gate has no autonomous recovery |
| 84 | PAN-3916 | M | high | ok |  |  | Session pointers go stale after rollover + crash recovery; issue view and pan tell confirmation track a dead transcript |
| 85 | PAN-3900 | S | high | ok |  |  | Docker bridge pool exhausted by orphaned workspace networks; pan start fails; bridge-pool patrol only warns |
| 86 | PAN-3793 | S | high | ok |  |  | resolveIssuePullRequestRef probes only feature/ and strike/ names, so close-out cannot find a merged PR on a descriptive branch |
| 87 | PAN-2639 | S | high | ok |  | PAN-2331 | codex-resume replays a rotated-out (revoked) refresh token → codex review convoys wedge with 401 |
| 88 | PAN-2331 | S | high | ok |  |  | codex rate-limit 'Switch to gpt-5.4-mini?' modal stalls autonomous agents (no auto-dismiss) |
| 89 | PAN-2333 | M | high | ok |  |  | feat: handle codex weekly-quota exhaustion gracefully |
| 90 | PAN-2511 | XS | high | ok |  |  | Work agents burn 20+ min on false test failures |
| 91 | PAN-2451 | M | high | ok |  |  | Work agent stranded behind commit-msg gate after overflow-restart + auto-commit + merge-main (non-issue-ref commits) |
| 92 | PAN-2763 | S | high | ok |  |  | Workspace node_modules is symlinked to the primary repo, breaking test resolution |
| 93 | PAN-2170 | XS | high | ok |  |  | Docker init container lacks Python |
| 94 | PAN-1198 | S | high | ok |  |  | Workspace init container's bun install doesn't populate container-node-modules named volume |
| 95 | PAN-2106 | S | high | ok |  |  | pan strike workspace setup leaves broken partial workspace + false 'spawned' success (git-lock race) |
| 96 | PAN-2880 | M | high | ok |  | PAN-2259 | Linear tracker listIssues is a 3N+1 request storm |
| 97 | PAN-2966 | S | high | ok |  |  | Polyrepo wrapper .gitignore misses .pan/ .devcontainer/ dev |
| 98 | PAN-2945 | S | high | ok |  |  | pan done rejects Overdeck-generated runtime in polyrepo wrapper repos (.devcontainer/, dev, .pan/review) |
| 99 | PAN-2680 | M | high | ok |  |  | pan close: Docker teardown silently skips a running stack in multi-repo projects (MYN), aborting close-out |
| 100 | PAN-3734 | S | high | ok |  |  | Completed swarm slot reuse can start a new item from a stale polyrepo branch — silent wrong-parent work. |
| 101 | PAN-3621 | M | high | ok |  |  | pan start intermittently dies resolving a chunk graph spliced across two builds — importer from primary dist, path in the live generation. |
| 102 | PAN-3555 | S | high | ok |  |  | pan start without --fresh silently abandoned an intact 7.5MB warm session, violating the warm-by-default contract. |
| 103 | PAN-3498 | S | high | ok |  |  | write-sequence pins in-pipeline ranks without renumbering, so the persisted sequence carries duplicate ranks and gaps. |
| 104 | PAN-3496 | XS | high | ok |  |  | A review convoy member blocked on an operator AskUserQuestion about review depth; review agents must decide and record, not ask. |
| 105 | PAN-3081 | S | high | ok |  |  | The agent git guard is PATH-based and an agent stripped it unprompted to get past a false block; a control the agent can remove isn't one. |
| 106 | PAN-2627 | S | high | ok |  |  | Linear poller is blind after cycle rollover |
| 107 | PAN-2324 | XS | high | ok |  |  | label transition fails atomically on missing 'in-planning' label |
| 108 | PAN-2165 | XS | high | ok |  |  | pan close: close-issue phase reports success but leaves issue OPEN / wrong labels (remove-label aborts on absent label; no-vBRIEF trans… |
| 109 | PAN-2905 | S | high | ok |  |  | Dashboard steady-state CPU ~50% keeps API responses at 0.5-1.5s |
| 110 | PAN-2259 | S | critical | ok |  |  | something burns the full 5k/hr GitHub GraphQL quota |
| 111 | PAN-2379 | S | high | ok |  |  | dependency install is warn-only + 60s timeout → false verify failures against empty node_modules (blocks swarm convergence) |
| 112 | PAN-2421 | XS | high | ok |  |  | dashboard server route tests flake under full-suite verification load |
| 113 | PAN-2430 | S | high | ok |  |  | frontend typecheck fails with dozens of pre-existing unused-local errors |
| 114 | PAN-2593 | S | high | ok |  |  | server children inherit bare system PATH |
| 115 | PAN-2656 | S | high | ok |  |  | deacon-swarm unit tests read live ~/.overdeck/config.yaml |
| 116 | PAN-2080 | M | high | ok |  | PAN-2079 | Operator Inbox external transports (email/Slack/push/TTS) |
| 117 | PAN-1775 | M | high | ok |  |  | Remote (Fly.io) work agents appear as real session rows in the issue tree |
| 118 | PAN-1436 | S | high | ok |  |  | PAN-1419 follow-up: stale stopped-agent zombies still pollute dashboard list |
| 119 | PAN-3556 | S | high | ok |  |  | No per-agent spawn mutex: two flows allocated session identities 3s apart and the second pin orphaned the first transcript. |
| 120 | PAN-3553 | S | high | ok |  |  | tmux list-panes -a exits 1 on a zero-session server, so the census reads unavailable post-reboot and conversations hang on 'Starting…'. |
| 121 | PAN-3535 | S | high | ok |  |  | The drain/resume hold is re-derived from the caller's env each boot, so any restart from a clean shell silently drops it. |
| 122 | PAN-3464 | XS | high | ok |  |  | pan swarm reset never clears slotCompletions, so a stale marker re-arms the exact wedge the operator ran reset to escape. |
| 123 | PAN-3429 | M | high | ok |  |  | Memory governor defers admissions but sheds nothing under HARD pressure; concurrent heavy gate runs aren't in the shed ladder. |
| 124 | PAN-3397 | S | high | ok |  |  | Fresh convoy lanes freeze at 0 output before kickoff; PAN-3375's detector only covers warm resumes, so recovery is manual. |
| 125 | PAN-3325 | S | high | ok |  |  | A fresh workspace ships an empty-but-present node_modules, so tooling silently resolves the parent repo's deps and gates go false-green. |
| 126 | PAN-3317 | S | high | ok |  |  | Strike agents are told to rebase, the launcher guard blocks it, and pan sync-main can't resolve a -strike workspace. Overlaps PAN-3306. |
| 127 | PAN-3284 | S | high | ok |  |  | A workspace-confined agent wrote a doc edit into the primary main worktree — the PAN-2204 write-to-main hazard through a new door. |
| 128 | PAN-3270 | S | high | ok |  |  | New workspaces arrive with empty node_modules and bun off the agent shell PATH, so the documented bun install remedy fails. |
...
| 130 | PAN-3257 | S | high | ok |  |  | Crash-resume leaves a stale PTY socket and drops supervisorEnabled from state.json, so every supervisor delivery fails afterwards. |
| 131 | PAN-3188 | XS | high | ok |  |  | DoD row 5 accepts only the transient verifying_on_main state, so an already-done issue can never be closed without an override. |
| 132 | PAN-3139 | S | high | ok |  |  | The authoritative agents table under-reports a live 4h agent as stopped while pan start's own liveness check correctly refuses. |
| 133 | PAN-3129 | M | high | ok |  |  | No symlink/TOCTOU containment on canonical writes under agent-controlled paths; a planted symlink redirects a server-side write. |
| 134 | PAN-3120 | S | high | ok |  |  | A scheduler-yielded work agent makes operator MERGE hard-error on polyrepo and silently dead-end on single-repo. |
| 135 | PAN-3077 | XS | high | ok |  |  | Inspect and review-supervisor spawns omit --effort and inherit the harness xhigh default — recurring overspend, once per xBRIEF item. |
| 136 | PAN-3062 | M | high | ok |  |  | The shared primary main worktree stacks several sessions' commits, so whoever pushes next ships everyone else's unverified work. |
| 137 | PAN-3048 | XS | high | ok |  |  | Pipeline auto-commit lands Overdeck's own .pan/drafts PRD into product feature branches; the exclusion list is duplicated and has drifted. |
| 138 | PAN-3032 | S | high | ok |  |  | Rebuild composes under overdeck-feature- while Traefik labels name myn-feature- devnet, and traefik attaches are runtime-only. |
| 139 | PAN-3881 | S | high | ok |  |  | pan sync distributes from a stale primary checkout and never removes deleted sources — resurrects deleted subagent defs |
| 140 | PAN-3833 | S | high | ok |  |  | Feed renders assistant text emitted after tool calls as collapsed thinking rows; operator believes the agent never answered |
| 141 | PAN-3902 | S | high | ok |  |  | Verification gates inherit OVERDECK_* env from the dashboard, so host boot state (e.g. OVERDECK_NO_RESUME) can red any branch |
| 142 | PAN-3826 | M | high | ok |  |  | Conversation view freezes until refresh: Claude JSONL watcher relies solely on fs.watch with no missed-event safety net |
| 143 | PAN-3854 | S | high | ok |  |  | Feature-workspace devcontainer stack 403s on POST /api/dashboard/session, blocking all in-browser mutation UAT |
| 144 | PAN-3866 | S | high | ok |  |  | Test specialist copies the previous head's uatStatus/uatNotes into a new result instead of re-running browser UAT |
| 145 | PAN-3307 | XS | high | ok |  |  | commitlint scope-enum lists 11 scopes, 14 real ones are missing, and it still names the removed beads scope — trains everyone to ignore it. |
| 146 | PAN-3022 | S | high | ok |  |  | The work-spawn route ignores record.workModel, so the role default wins and then persists over the operator's per-issue override. |
...
| 152 | PAN-2059 | XL | high | ok | ✓ |  | Backlog pickup gate |
| 153 | PAN-2376 | XL | high | ok | ✓ |  | Epic: CI/CD reliability |
| 154 | PAN-3775 | S | high | ok |  |  | makeDbLive opens overdeck.db unmigrated; zero-table db poisons a vitest worker home and breaks later read-only audits. |
| 155 | PAN-3652 | XS | high | ok |  |  | No workflow_dispatch on ci.yml / state-plane-branches.yml, so an unverified main tip can never be verified and DoD row 6 blocks close-out. |
| 156 | PAN-3622 | XS | high | ok |  |  | orphan-proposed-reconciler test pins a real issue id and reads live GitHub; it fails pan release check on a green main. |
| 157 | PAN-3579 | M | high | ok |  |  | ~20 frontend mutations hand-write JSON headers and omit the CSRF token, so each 403s the moment its route becomes guarded. |
| 158 | PAN-3541 | S | high | ok |  |  | Review restart loops on the session-resume menu because eligibility ignores how the prior session ended; partial mechanical break landed. |
| 159 | PAN-3463 | S | high | ok |  |  | A legitimate empty-diff slot outcome can never pass item verify, so the slot wedges and blocks dispatch of remaining items forever. |
| 160 | PAN-3460 | S | high | ok |  |  | Per-item verify_commands that run the whole root suite make slot merge gates load-fragile and hold a patrol in flight for ~17 minutes. |
| 161 | PAN-3454 | M | high | ok |  |  | Cost hook rescans fork-copied parent history from byte 0 under the reviewer's id — fabricated cache-miss warnings and double-billed spend. |
| 162 | PAN-3439 | XS | high | ok |  |  | pan start crashes on a 'pending-work-spawn' placeholder row; resume already guards this and takes the fresh-spawn path. |
| 163 | PAN-3432 | S | high | ok |  |  | Preemptive yield fans out: seven work agents paused to make room for one review convoy, then flood back oldest-first. |
| 164 | PAN-3306 | S | high | ok |  |  | Three layers disagree on how a strike rebases: the prompt instructs it, the launcher guard blocks it, sync-main resolves the wrong worktree. |
| 165 | PAN-3297 | S | high | ok |  |  | After a dashboard restart, delivery calls a healthy agent a zombie while resume calls it healthy; both classifiers can't be right. |
| 166 | PAN-3274 | S | high | ok |  |  | A test-role agent spawned and never ran a turn, holding an approved CI-green issue out of the merge gate behind a stale failed verdict. |
| 167 | PAN-3267 | S | high | ok |  |  | GitLab merged-head oracle spawns one glab subprocess per repo × head, so pipeline membership refresh fails on every cycle. |
| 168 | PAN-3261 | S | high | ok |  |  | The tmux delivery fallback answered a live session-resume menu because its own paste hid the menu from the detector — silent /compact. |
| 169 | PAN-3256 | S | high | ok |  |  | glab mr list runs with a polyrepo wrapper root as cwd, which is not a git repo, so MYN membership fails forge_unavailable every cycle. |
| 170 | PAN-3190 | XS | high | ok |  |  | pan merge cancel has a 0% success rate: Commander binds its options object into the injectable fetchImpl parameter. |
| 171 | PAN-3174 | S | high | ok |  |  | Polyrepo UAT stacks 504: Traefik labels carry the old myn- prefix, Traefik isn't on the overdeck-* devnet, and the fe port is wrong. |
| 172 | PAN-3171 | S | high | ok |  |  | The pipeline emits 'merge failed' after a successful merge and successful cleanup, leaving the issue Todo with the commit already on main. |
| 173 | PAN-3050 | XS | high | ok |  |  | Idle-stack reaper's regex only matches overdeck-feature-*-server|frontend, so MYN stacks run for hours after their agents are gone. |
| 174 | PAN-2995 | XS | high | ok |  |  | pan done --strike gates on branch ancestry, which a squash-merge breaks, so it refuses strikes that pan close proves merged. |
| 175 | PAN-2980 | XS | high | ok |  |  | The pre-push file-size guard reads the shared working tree, so another session's uncommitted edits block an unrelated, guard-clean push. |
| 176 | PAN-3668 | L | medium | ok |  |  | Add Prime Agent as a managed harness (in flight — RPC runtime adapter, discovery, transcripts) |
| 177 | PAN-3769 | S | high | needs-refinement |  |  | Red main 707089c5→e4b280b3 blocked deploys ~14h: missing no-loss lock entry + stale OpenRouter expectation. Verify still reproducing. |
| 178 | PAN-3760 | S | high | ok |  |  | permissionMode 'auto' undocumented as non-bypass, launcher can emit invalid --permission-mode, invalid values drop silently. |
| 179 | PAN-3629 | M | high | ok |  |  | No sanctioned door to re-scope a live agent; the operator must violate pan tell doctrine or let the rejected design land. |
| 180 | PAN-3517 | M | high | ok |  |  | Convoy forks still miss the parent prompt cache in production — launch-injection byte drift plus resume dropping the cache-scope header. |
| 181 | PAN-3508 | S | high | ok |  |  | pan reload deletes the generation the global pan link points at, so the CLI vanishes mid-deploy for anyone invoking from elsewhere. |
| 182 | PAN-3303 | S | high | ok |  |  | An empty registered-projects 200 is treated as authoritative, latching Command Deck at 'Unknown project' until a manual page reload. |
| 183 | PAN-3280 | S | high | needs-refinement |  |  | One issue's agent sessions vanished four times in a run while every peer stayed up; specimen-specific — re-confirm the mechanism. |
| 184 | PAN-3243 | XS | high | ok |  |  | auto-commit test polls a fixed 20 setImmediate turns for a real git subprocess; the flake reddened main and blocked a close-out. |
| 185 | PAN-3224 | XS | high | needs-refinement |  |  | Duplicate of PAN-3439: a stranded 'pending-work-spawn' model kills plain pan start while resume already guards it. |
| 186 | PAN-3196 | S | high | ok |  |  | Root-owned container residue makes close-out die on EACCES after passing every DoD row; same family as PAN-3570. |
| 187 | PAN-3186 | XS | high | ok |  |  | One configured non-git member (auricle/infra) blanks pipeline membership for the whole project the resolver claims it can answer. |
| 188 | PAN-3185 | XS | high | ok |  |  | TOCTOU between the duplicate-session guard and session creation makes pan start report a hard failure over a successful spawn. |
| 189 | PAN-3179 | M | high | ok |  |  | A UAT promote is complete at merge time with no production-reach check, so members read shipped while prod serves the old build. |
| 190 | PAN-3176 | S | high | ok |  |  | UAT promote consults no stack health, so a batch whose stack was never exercised can be promoted from a success-green control. |
| 191 | PAN-3130 | S | high | ok |  |  | Identifier-joined write paths have no containment assertion, so a crafted issue or agent id could redirect a canonical write. |
| 192 | PAN-3047 | XS | high | ok |  | PAN-2828 | Strike-branch teardown uses --is-ancestor, which cannot see a squash merge, so all 96 strike/* branches survive as residue. |
| 193 | PAN-3046 | XS | high | ok |  |  | pan exits with ERR_UNHANDLED_REJECTION when the PostHog shutdown flush times out, so callers read a successful merge handoff as failure. |
| 194 | PAN-1711 | S | high | ok |  |  | Dashboard event-loop stalls under load force watchdog restarts; the root cause behind the PAN-3522 churn and the 0.5-1.5s API latencies. |
| 195 | PAN-3667 | M | high | ok |  |  | CLIProxy has no cross-family remap, so every Anthropic-pinned subagent dies at spawn in a proxied session; stopgap is hand-written. |
| 196 | PAN-3596 | M | high | ok |  |  | Deacon patrol has no per-step timing, so overruns in the system's central scheduler cannot be attributed to a step. |
| 197 | PAN-3536 | S | high | ok |  |  | pan tell can not reach ohmypi conversations: with no state.json the expected harness defaults to claude-code and delivery reports a zombie. |
| 198 | PAN-3527 | XS | high | ok |  |  | One failed boot-time fetch leaves the sidebar at CONVERSATIONS 0 / ISSUES 0 for the life of the tab — nothing retries it. |
| 199 | PAN-3510 | S | high | ok |  |  | Agent stop leaves detached docker-run test containers alive for hours, contending with other agents' quality gates. |
| 200 | PAN-3355 | XS | high | ok |  |  | sessionExists collapses 'no such session' and 'could not ask' into false, so callers read not-running when liveness is unknown. |
| 201 | PAN-3289 | S | high | ok |  |  | A sequencer pass ran against an empty manifest while the read model held 1120 issues — a transiently empty read at spawn. |
| 202 | PAN-3245 | XS | high | ok |  |  | The pan done gate flags workspace .pan/drafts as uncommitted despite its own .pan exclusion, training agents to reach for --force. |
| 203 | PAN-3218 | S | high | ok |  |  | No release-drift signal: an install-breaking fix sat merged and unpublished for ~9 hours with nothing surfacing it. |
| 204 | PAN-3210 | XS | high | ok |  |  | Close-out teardown scopes by compose project while the guard scopes by working_dir, so an unprefixed dead init container blocks it. |
| 205 | PAN-3167 | S | high | ok |  |  | krux and lexerra are permanently unreadable through the membership door: an App-not-installed 404 is typed as retryable forge_unavailable. |
| 206 | PAN-3113 | M | high | ok |  |  | Blocking agent-pane choice prompts show nothing in the conversation view; surface them as inline decision cards with keystroke delivery. |
| 207 | PAN-3108 | XS | high | ok |  |  | dashboard.log reached 867MB with no rotation — disk cost and un-greppable incident logs exactly when they're needed. |
| 208 | PAN-3094 | XS | high | ok |  |  | pan done's merge fallback still force-pushes a fast-forwardable branch, so a rejected push leaves completion half-done. |
| 209 | PAN-3012 | M | high | ok |  |  | Archiving preserves the pointer, not the data: harnesses delete session JSONL on their own schedule and the conversation is unrecoverable. |
| 210 | PAN-3627 | XS | high | ok |  |  | backlog-auto-trigger throws on a legitimately empty manifest, so a plain npx @overdeck/core in a non-project dir prints a stack trace. |
| 211 | PAN-3617 | S | high | needs-refinement |  |  | Three strike dispatches for PAN-3586 died with zero output while a sibling worked; may be stale — re-confirm before picking up. |
| 212 | PAN-3308 | XS | high | ok |  |  | The file-size guard prints a paste-ready ratchet-up line, so 2 of 3 agents raised the ceiling instead of shrinking the file. |
| 213 | PAN-3276 | XS | high | ok |  |  | Needs-you rows for pane questions and permission prompts are click-dead, so the list that exists to route the operator routes nowhere. |
| 214 | PAN-3235 | S | high | ok |  |  | Render and answer agent pane-choice menus on the decision card; PAN-3228 shipped the core and CLI, the dashboard UX remains. |
| 215 | PAN-3855 | S | medium | ok |  |  | pan start reuses the old agent's recorded model after pan reset-session, so retuned tiers never apply without --fresh |
| 216 | PAN-3789 | L | medium | needs-refinement |  |  | MCP servers configured in standalone Codex never reach Overdeck conversations; no setup, auth or lifecycle story across harnesses |
| 217 | PAN-3211 | S | high | needs-refinement |  |  | Issues closed without landing have no honest disposition, so their review_status rows are neither close-able nor reapable. |
| 218 | PAN-3175 | M | high | ok |  |  | Merge-train ordering derives conflicts from file overlap alone, so semantically dependent members batch in any order and break the schema. |
| 219 | PAN-3015 | L | high | ok |  |  | Claude Code is the only harness still driven by keystroke injection; a pull-based monitor inbox would retire the whole hardening stack. |
| 220 | PAN-3518 | M | high | needs-refinement |  | PAN-3517 | Re-review resumes re-bill the whole cold history; make reviewResumeDecision TTL- and size-aware. Needs design sign-off. |
| 221 | PAN-3445 | XS | high | ok |  |  | projects.yaml TCP lock ports overlap the OS ephemeral range, so an unrelated socket makes an uncontended config write fail. |
| 222 | PAN-3332 | S | high | ok |  |  | A detached slash-command spawn died in 150ms while the UI kept saying 'running in the background'; the activity must own its outcome. |
| 223 | PAN-3295 | M | high | ok |  |  | Completion-check LLM is invisible infrastructure that fanned out to 35 concurrent processes; one queued summarizer plus observability. |
| 224 | PAN-3236 | XS | high | needs-refinement |  |  | ECONNREFUSED on a dead supervisor socket was treated as ambiguous so feedback never crossed to tmux; a fix commit is cited — verify. |
| 225 | PAN-3013 | XS | high | ok |  |  | Role-spawn wrote 26 session-scoped hook paths into the durable ~/.claude/settings.json; they fail on every Linear tool call forever. |
| 226 | PAN-3771 | M | high | ok |  |  | Conversation search silently empty end-to-end: palette flag off by default, FTS scan manual-only, no summaries. |
| 227 | PAN-3533 | L | high | ok |  |  | No per-project resource partitioning, so one project's docker stacks and installs starve another project's pipeline and the dashboard. |
| 228 | PAN-3107 | S | high | ok |  |  | OOM spikes are unattributable after the fact; productize the machine-local memory-attribution census stopgap. |
| 229 | PAN-3762 | XL | high | needs-refinement |  |  | Overdeck Anywhere direction change: per-machine servers + client-side federation instead of relay-first. Supersedes PAN-2350 plan. |
| 230 | PAN-1666 | XL | medium | ok | ✓ |  | Pipeline Throughput Hardening |
| 231 | PAN-1556 | S | high | ok |  |  | Session/activity feed: coalesce review-spawn spam, supersede re-reviews per issue, keep active conversations most-recent |
| 232 | PAN-2188 | M | high | ok |  |  | Flywheel resilience for the codebase-health flood: substrate-first prioritization + tenets spirit-gate |
| 233 | PAN-2190 | L | high | ok |  |  | Decompose routes/workspaces/merge-ops.ts (1,925 lines) |
| 234 | PAN-2233 | L | high | ok |  |  | decompose merge-agent.ts (1,414 lines) into focused modules |
| 235 | PAN-2526 | M | high | ok |  |  | Refactor deacon.ts below file-size baseline |
| 236 | PAN-2008 | XS | high | ok |  | PAN-1936 | store-access guard |
| 237 | PAN-1936 | M | high | ok |  |  | Single source-of-truth reads |
| 238 | PAN-1988 | M | high | ok |  | PAN-1936 | Verdict signaling: one host-owned write door; agents journal, host owns the DB cache |
| 239 | PAN-1910 | XS | high | ok |  | PAN-1936 | fast-follow(PAN-1908): collapse issue status to ONE canonical field |
| 240 | PAN-1325 | M | high | ok |  |  | Artifact storage model is unsafe for polyrepo projects |
| 241 | PAN-1728 | S | high | ok |  |  | PAN-1700 agent committed .pan/specs/*.vbrief.json mutations |
| 242 | PAN-2651 | S | high | ok |  |  | simplify lifecycle reconciliation and add a safe post-planning reset |
| 243 | PAN-2241 | S | high | ok |  |  | complete-planning is not serialized or idempotent per issue (spec tmp-rename 500s, bead delete-recreate thrash) |
| 244 | PAN-2242 | S | high | ok |  |  | Unidentified duplicate caller fires complete-planning in pairs every ~2 minutes (perpetual loop while session survives) |
| 245 | PAN-2240 | S | high | ok |  |  | pan tell contradicts itself on dead ohmypi sessions |
| 246 | PAN-2243 | S | high | ok |  |  | pan plan finalize: CLI aborts complete-planning at 90s while the server handler legitimately finishes later (false ✖ Failed) |
| 247 | PAN-2244 | S | high | ok |  |  | Recurring [pan-dir/auto-commit] GitError on main |
| 248 | PAN-2202 | S | high | ok |  |  | complete-planning silently skips spec promotion on a dead session's unanswered AskUserQuestion |
| 249 | PAN-2195 | M | high | ok |  |  | pan plan finalize re-plan churn: stale superseded spec on main transiently materializes the old plan |
| 250 | PAN-2237 | S | high | ok |  |  | pan plan done swallows vbrief quality lint details |
| 251 | PAN-2487 | M | high | ok |  |  | CI-green merge skip + Ship & Merge cockpit view (live door log + progress) + active-node spinner |
| 252 | PAN-2469 | M | high | ok |  |  | issue-level assembly owner |
| 253 | PAN-2212 | M | high | ok |  |  | Swarm slot dispatch has no reserved budget |
| 254 | PAN-2213 | M | high | ok |  |  | Swarm slot allocator picks an orphaned slot index and refuses instead of skipping to the next free one |
| 255 | PAN-2211 | M | high | ok |  |  | PAN-2203 follow-up: swarm slot pan done records completion but slot never becomes merge-ready |
| 256 | PAN-2210 | M | high | ok |  |  | PAN-2203 follow-up: a swarm slot's completion can trigger the issue-level review pipeline |
| 257 | PAN-2201 | XS | high | ok |  |  | Close-out label step fails atomically when a hardcoded label (e.g. 'in-planning') is absent from the repo |
| 258 | PAN-2718 | M | high | ok |  |  | pan restart needs a first-class no-dialog reconciliation flag |
| 259 | PAN-2646 | XS | high | ok |  |  | configurable global/project/issue policy UI with default OFF |
...
| 261 | PAN-2652 | M | high | ok |  |  | Conversation view diverges from Terminal: Claude Code backgrounding forks the session file in-process, invisible to all session-id reso… |
| 262 | PAN-2667 | M | high | ok |  |  | Reimplement the task-progress admission signal in resource discovery |
| 263 | PAN-2755 | S | high | ok |  |  | per-issue review-model override never reached convoy sub-reviewers on the discovery-fork path |
| 264 | PAN-2754 | S | high | ok |  |  | `always` is inert |
| 265 | PAN-2809 | M | high | ok |  |  | Live-terminal Playwright UAT blocked in containerized workspaces (node-pty musl/glibc mismatch + Vite/Traefik WS Origin 403) |
| 266 | PAN-2810 | M | high | ok |  |  | Workspace 'vitest --changed' gate diverges from CI: App.test.tsx fails locally on missing selectPendingInputSubjects mock |
| 267 | PAN-2495 | S | high | ok |  |  | PAN-2487 ci-green merge skip bypassed CI-green gate |
| 268 | PAN-2478 | S | high | ok |  |  | CI flake: Playwright browser install fails on packages.microsoft.com apt (NOSPLIT), red-mains legit merges |
| 269 | PAN-1710 | S | high | ok |  |  | 'Clean install + server smoke test' hangs (3 consecutive 20-min timeout kills) on feature/pan-1491 and feature/pan-1641 |
...
| 271 | PAN-1558 | M | high | ok |  |  | Review/specialist agents should run in the workspace Docker container, not inherit host-override |
| 272 | PAN-1650 | M | high | ok |  |  | Split readyForMerge → gatesPassed (derived/event-driven) + shipComplete; auto-dispatch ship on gates-green |
| 273 | PAN-1766 | S | high | ok |  |  | work agents hang on Claude Code settings-file protection when editing .claude/** |
| 274 | PAN-1770 | S | high | ok |  |  | pan-dir auto-commit rebase races live .pan/continues writes |
| 275 | PAN-2027 | M | high | ok |  |  | ohmypi: route kimi-k2 through ohmypi harness instead of CLIProxy (eliminates 200k-window illusion) |
| 276 | PAN-2266 | M | high | ok |  |  | feat: add zcode harness and make it the default for glm-5.2 |
| 277 | PAN-1578 | M | high | ok |  |  | GitHub Copilot CLI as a first-class harness (pipeline peer to Claude Code, Pi, Codex) |
| 278 | PAN-1538 | M | high | ok |  |  | Unblock Pi source forks |
| 279 | PAN-687 | M | high | ok |  |  | Support OpenCode as alternative coding agent |
| 280 | PAN-466 | M | high | ok |  |  | Add QwenCoder CLI as a supported runtime alongside Claude Code and Codex |
| 281 | PAN-465 | M | high | ok |  |  | Add OpenRouter as a model provider |
| 282 | PAN-463 | M | high | ok |  |  | Add Qwen 3.6+ model support |
| 283 | PAN-1142 | M | high | ok |  |  | Add reasoning effort level to per-role / per-conversation model config |
| 284 | PAN-1424 | M | high | needs-refinement |  |  | Model pool dispatch + work.* subtype taxonomy (follow-up to PAN-1122) |
| 285 | PAN-1196 | M | high | needs-refinement |  |  | Workhorse routing by bead difficulty + subject-matter (single-agent and swarm) |
| 286 | PAN-1311 | M | high | needs-refinement |  |  | Swarm: fast-track tier |
| 287 | PAN-1313 | L | high | ok |  |  | Finish src/lib Effect migration: remove or justify legacy Promise/sync surfaces |
| 288 | PAN-1246 | M | high | ok |  |  | Perf: projection-cached VCS driver for diff/checkpoint reads (port of t3code #2586) |
| 289 | PAN-1253 | M | high | ok |  |  | Flywheel: respect issue dependencies before autopicking work |
| 290 | PAN-1254 | L | high | ok |  |  | Tailscale integration: advertise dashboard + workspace endpoints over tailnet (Effect-native) |
| 291 | PAN-1357 | M | high | ok |  |  | Template conversations: load curated skill bundles into a single conversation |
| 292 | PAN-1915 | M | high | ok |  |  | enhancement(security): API key at-rest hardening |
| 293 | PAN-1435 | XS | high | ok |  |  | API keys in ~/.panopticon/config.yaml stored as plaintext |
| 294 | PAN-1672 | M | high | ok |  |  | GPT-5.5/CLIProxy context-window deadlock: conversations get no overflow recovery + 200k window illusion |
| 295 | PAN-1640 | M | high | ok |  |  | Re-platform interactive permission allow/deny onto a PreToolUse hook (provider-agnostic) |
| 296 | PAN-2351 | XS | high | ok |  | PAN-1166 | Overdeck Anywhere P0: scoped access tokens + WS/SSE heartbeats (security prerequisites) |
| 297 | PAN-2350 | L | high | needs-refinement | ✓ |  | Epic container for Overdeck Anywhere P0-P3; PAN-3762 proposes replacing the relay-first direction with per-machine server federation. |
| 298 | PAN-1217 | XS | high | ok |  |  | Requirements reviewer: classify each AC as in_pr_scope vs whole_feature_scope, only !-block in-PR-scope items |
| 299 | PAN-1218 | M | high | ok |  |  | Bead inspect: drop Check 3 (compile/lint), restrict to foundation beads, add end-of-batch mode |
| 300 | PAN-1219 | M | high | ok |  |  | Promote across-cycle review state to first-class data (cycle SHA, prior findings) instead of prompt-derived |
| 301 | PAN-1209 | S | high | ok |  |  | PAN-1052 bead projection disagrees with bd state |
| 302 | PAN-1451 | M | high | ok |  |  | PAN-1124 follow-up: complete planning-on-main pivot (dropped ACs from scope drift) |
| 303 | PAN-1452 | M | high | ok |  |  | PAN-1381 follow-up: per-reviewer restart with model override (architectural mismatch with PAN-1048) |
| 304 | PAN-1454 | M | high | ok |  |  | [META] 9 systemic failure patterns surfaced by 80-issue audit |
| 305 | PAN-1553 | M | high | ok |  |  | Investigate Claude Code Fast mode support (and fast-tier pricing) |
| 306 | PAN-1504 | M | high | ok |  |  | pan hygiene |
...
| 308 | PAN-1480 | L | high | ok |  |  | TLDR: 93% bypass rate |
| 309 | PAN-1479 | M | high | ok |  |  | RTK: Add telemetry to measure token savings from bash output compression |
| 310 | PAN-2950 | L | high | ok |  |  | Refactor god files back under file-size ceilings after the UX overhaul |
| 311 | PAN-2836 | M | high | ok |  |  | okf: in-repo placement presets (okf/, docs/okf/) and /okf migrate to switch placements later |
| 312 | PAN-2720 | M | high | ok |  |  | File-size ratchet counts lines, so it rewards line-packing on the god files it means to improve |
| 313 | PAN-2650 | L | high | ok |  |  | Swarm final ready-to-merge slot wedges when memory-governor sheds the integration stack; pan swarm recover can't recover it |
| 314 | PAN-2358 | M | high | ok |  |  | PAN-2145 follow-up: restore PAN-1535 hardening in transformMessageForHarness (rewritten during conversations.ts decomposition) |
| 315 | PAN-2334 | XS | high | ok |  |  | write a Definition of Ready (DoR) |
| 316 | PAN-2308 | M | high | ok |  |  | hardening(workspaces): migrate stale generated compose files off PORT=3011 + deacon quarantine for deterministic container boot refusal… |
| 317 | PAN-2193 | S | high | ok |  |  | Held issues (objection/parked/vetoed/needs-handoff) are invisible in the Command Deck tree |
| 318 | PAN-1984 | XS | high | ok |  |  | Migrate or delete the 18 dead panopticon.db modules referenced by ~30 test files (#1983 follow-up) |
| 319 | PAN-1913 | XS | high | ok |  |  | Project description: show on click, edit in dashboard, mirror into the project layer (and document what's in .pan and ~/.panopticon) |
| 320 | PAN-1906 | M | high | ok |  |  | Enforce harness restrictions with subscription: gray out non-claude-code, validate everywhere |
| 321 | PAN-1544 | M | high | ok |  |  | Type cleanup: strip 'ship' from the Role union and its ~10 downstream references |
| 322 | PAN-955 | S | high | ok |  |  | Workspace devcontainer template versioning + re-render on demand |
| 323 | PAN-813 | M | high | ok |  |  | Add regression test for /api/review/:issueId/reset preserving work-agent resolution |
| 324 | PAN-807 | L | high | ok |  |  | Epic C: Workspace state sanity on spawn |
| 325 | PAN-630 | M | high | ok |  |  | Multi-tenant workspace isolation with ACLs |
| 326 | PAN-471 | M | high | ok |  |  | Cost reconciler: auto-trigger on agent lifecycle events with debounce |
| 327 | PAN-438 | M | high | ok |  |  | Migrate remaining REST polling endpoints to Effect RPC |
| 328 | PAN-578 | M | high | ok |  |  | Security: Comment mediation layer to prevent prompt injection via tracker comments |
| 329 | PAN-2921 | S | medium | ok |  |  | Strike merge door can report fetch failure after merge and land the same head twice |
| 330 | PAN-2839 | S | medium | ok |  |  | plan→work autoSpawn now 500s with a duplicated workspace prep |
| 331 | PAN-2824 | S | medium | ok |  |  | pan review pending dies when one project's lens gather fails (non-degrading caller; PAN-2820 class) |
| 332 | PAN-2792 | S | medium | ok |  |  | Orphan-process sweeps killed the dashboard and live conversations via lsof +D over Bun-hardlinked node_modules |
| 333 | PAN-2761 | S | medium | ok |  |  | done.test.ts asserts a hardcoded URL without stubbing env, so it fails in any agent shell with OVERDECK_DASHBOARD_URL set and looks lik… |
| 334 | PAN-2739 | S | medium | ok |  |  | first-completion detection throws every patrol cycle |
| 335 | PAN-2738 | S | medium | ok |  |  | strikes deadlock |
| 336 | PAN-2717 | S | medium | ok |  |  | conversation permission waits missing from Awareness; strengthen alert pulse |
| 337 | PAN-2697 | S | medium | ok |  |  | First-review codex parents enter discovery mode and the supervisor session no-ops every discovery-ready signal |
| 338 | PAN-2696 | XS | medium | ok |  |  | Task views still speak beads vocabulary |
| 339 | PAN-2691 | S | medium | ok |  |  | Auto-planned issues park silently when the post-finalize work spawn is gated (stack-unhealthy 422) |
| 340 | PAN-2686 | XS | medium | ok |  |  | Policy strip "restart pending" badge never clears after restart-fresh with a new model (record.model is sticky) |
| 341 | PAN-3701 | L | high | ok |  |  | Four separate first-party LLM client stacks; consolidate onto effect/unstable/ai LanguageModel + ExecutionPlan. PRD written. |
| 342 | PAN-3090 | M | high | ok |  |  | Simple issue page opens with a 55KB raw kickoff prompt and hides the pending question the operator actually has to answer. |
| 343 | PAN-2672 | S | medium | ok |  |  | Post-/clear siblings render the same original transcript (per-tmux resolution + frozen launcher pin + null claude_session_id) |
| 344 | PAN-2670 | S | medium | ok |  |  | Gate the dashboard-server tsconfig in npm run typecheck |
| 345 | PAN-2664 | S | medium | ok |  |  | auto-commit completes unresolved merge with conflict markers |
| 346 | PAN-2663 | S | medium | ok |  |  | health probe can accept old dashboard after replacement EADDRINUSE |
| 347 | PAN-2649 | S | medium | ok |  |  | Ctrl+K conversation search indexes Claude transcripts only |
| 348 | PAN-2580 | S | medium | ok |  |  | pan tell cannot deliver to codex (GPT) conversations |
| 349 | PAN-2572 | M | medium | ok |  |  | Noisy EBADENGINE + deprecation warnings on npx/npm install make a healthy install look broken |
| 350 | PAN-2563 | S | medium | ok |  |  | npm-flavor desktop (npx @overdeck/desktop) lacks node_modules for the server's externalized deps |
| 351 | PAN-2560 | M | medium | ok |  |  | resolveStateReadHomeSync (state-read-home.ts) resolves state dir by path basename, not registry key |
| 352 | PAN-2554 | S | medium | ok |  |  | clicking a project doesn't update the browser URL |
| 353 | PAN-2550 | XS | medium | ok |  |  | npm test exits 0 despite root-suite failures |
| 354 | PAN-2547 | S | medium | ok |  |  | pan restart --health-timeout parses seconds as milliseconds |
| 355 | PAN-2546 | S | medium | ok |  |  | pan tell is codex-conversation-unaware |
| 356 | PAN-2506 | M | medium | ok |  |  | flywheel-primary-root.test.ts fails on macOS: /var vs /private/var symlink not canonicalized |
| 357 | PAN-3504 | XS | high | needs-refinement |  |  | Duplicate of PAN-3499 (parked.ts ProjectConfig.projectPath typecheck red on main); confirm landed and close one of the pair. |
| 358 | PAN-3181 | L | high | ok |  |  | Agent memories are harness-owned, machine-local and keyed by path; move them to a per-repo overdeck-memory orphan branch. |
| 359 | PAN-3003 | XS | medium | ok |  |  | Generated launcher.sh files omit the OVERDECK_AGENT_ID export the PTY supervisor requires, so manual re-launch dies instantly. |
| 360 | PAN-2501 | S | medium | ok |  |  | deleteResourceVenvEffect's HttpRouter.schemaParams call fails typecheck under the root tsconfig (masked by src/dashboard/** exclusion) |
| 361 | PAN-2492 | S | medium | needs-refinement |  |  | pane-detected waits (rate-limit/session-resume) surface as 'needs you' but cannot be answered from the dashboard |
| 362 | PAN-2491 | M | medium | ok |  |  | Migrate @xenova/transformers to @huggingface/transformers to eliminate silent npx install failures from sharp 0.32 postinstall |
| 363 | PAN-2489 | S | medium | ok |  |  | strike agents are invisible in the project issue tree |
| 364 | PAN-2484 | S | medium | ok |  |  | ready set misses merge-eligible issues without flywheel merge verbs |
| 365 | PAN-2465 | S | medium | ok |  |  | pan done's PR lookup fails at MYN polyrepo root |
| 366 | PAN-2454 | S | medium | ok |  |  | ratchet audit fails per-commit on push ranges whose NET baseline delta is zero |
| 367 | PAN-2428 | XS | medium | ok |  |  | MYN workspace Traefik routing broken post-rebrand |
| 368 | PAN-2423 | XS | medium | ok |  |  | pan workspace rebuild hardcodes 'overdeck-' compose project prefix |
| 369 | PAN-2416 | S | medium | ok |  |  | codex agents can wedge on the Codex CLI first-run/consent screen |
| 370 | PAN-2414 | S | medium | ok |  |  | context-overflow recovery is inconsistent |
| 371 | PAN-2408 | S | medium | ok |  |  | pan start --auto commits the spec to main AFTER creating the worktree |
| 372 | PAN-2395 | S | medium | ok |  |  | one invalid tiered_execution enum poisons every config read |
| 373 | PAN-2381 | S | medium | ok |  |  | three event types missing from DomainEvent schema union poison the RPC stream |
| 374 | PAN-2287 | S | medium | ok |  |  | every supervisor.log line written twice |
| 375 | PAN-3661 | XS | medium | ok |  |  | Secure review-mode dispatch dropped the HTTP-200 semantic-rejection surface; two frontend tests fail locally while CI stays green. |
| 376 | PAN-3288 | XS | medium | ok |  |  | Dev-checkout preflight: after a git pull that adds a dep, the CLI dies with ERR_MODULE_NOT_FOUND instead of saying 'run bun install'. |
| 377 | PAN-3164 | XS | medium | ok |  |  | probeUatStack reports readiness from container count, so the UI offers 'Open UAT frontend' while the API is still resolving Maven deps. |
| 378 | PAN-3121 | S | medium | ok |  |  | The failed-send outbox never reconciles against the transcript, so a delivered message keeps a Retry twin that would double-send. |
| 379 | PAN-3014 | XS | medium | ok |  |  | Background title/about spawns use --bare, which now skips credential reads, so every one fails 'Not logged in' with empty stderr. |
| 380 | PAN-3911 | S | medium | needs-refinement |  |  | Issue pause did not stop review convoys; the stranded-review re-dispatch that resumed them was deleted by the cut — re-verify |
| 381 | PAN-3915 | S | medium | ok |  |  | resume-kimi-code test writes a real transcript under ~/.claude; watcher indexes the deleted file and ENOENT sticks in health |
| 382 | PAN-3829 | L | medium | ok |  |  | Managed Claude launch home: overlay hooks/settings/plugins/auth without touching native ~/.claude (draft at handoff/20260909/main) |
| 383 | PAN-2280 | M | medium | ok |  |  | Resumed conversations wedge without writing transcripts when dashboard is black-holed |
| 384 | PAN-2197 | S | medium | ok |  |  | work agents skip `pan done` (manual push instead) |
| 385 | PAN-2186 | S | medium | ok |  |  | post-merge lifecycle can leave merged issues in-review and auto-merge rows stuck |
| 386 | PAN-2069 | XS | medium | ok |  |  | caveman: follow-up gaps |
| 387 | PAN-1918 | XS | medium | ok |  |  | full frontend vitest suite runs in no CI path |
| 388 | PAN-1912 | XS | medium | ok |  |  | Pi agent transcripts hide tool-call detail; agent panes lack the Tools show/hide toggle |
| 389 | PAN-1846 | S | medium | ok |  |  | unbounded log growth |
| 390 | PAN-1830 | S | medium | ok |  |  | Reviewer stuck on gpt-5.5 rate-limit modal blocks REVIEWER_READY |
| 391 | PAN-1816 | S | medium | ok |  |  | Scratch/UAT-lifecycle issues (PAN-18031) enter the real pipeline: kanban, review convoys, agent registry |
| 392 | PAN-1795 | S | medium | ok |  |  | Codebase map bootstrapped in planning worktree is never promoted to main |
| 393 | PAN-1774 | S | medium | ok |  |  | workspace server container crashloops when dist/dashboard/server.js is missing |
| 394 | PAN-1769 | S | medium | ok |  |  | Supervisor echo-confirm false negative on long messages → triple-paste delivery (rewrite ×2 + tmux fallback); resumed-conv message stil… |
| 395 | PAN-1761 | S | medium | ok |  |  | conversations endpoints fetched via relative /api path |
| 396 | PAN-1755 | S | medium | ok |  |  | uat stuck-assembly cap (30m) kills slow-but-alive assemblies and leaves orphaned conflict agents racing the next generation |
| 397 | PAN-3516 | XS | medium | ok |  |  | Repo .claude/skills holds stale duplicates of pan-handoff, pan-flywheel and okf, so overdeck-dev sessions load outdated skill text. |
| 398 | PAN-3455 | XS | medium | ok |  |  | cliproxy --version exits 2, so the up-to-date check always returns false and every ensure re-downloads the pinned release. |
| 399 | PAN-3117 | XS | medium | ok |  |  | A deterministic 400 renders as the generic 'Failed to send' bubble with a Retry that can never succeed. |
| 400 | PAN-3036 | XS | medium | ok |  |  | Pane-idle detection reads a completed strike's idle composer as a pending question, so a finished strike shows '! INPUT'. |
| 401 | PAN-3016 | M | medium | ok |  |  | Operator ask: every view should be URL-addressable; cockpit tabs, stage panes and several drawers are still local state. |
| 402 | PAN-3890 | S | medium | ok |  |  | opencode provider stream errors (rate limit) are invisible in the feed and never retried; first message dies silently |
| 403 | PAN-1740 | XS | medium | ok |  |  | Deacon mislabels SIGTERM workspace container restarts as crashes |
| 404 | PAN-1674 | S | medium | ok |  |  | TLDR .venv (~7.5G) is duplicated into every workspace |
| 405 | PAN-1673 | S | medium | ok |  |  | Regression: pi + gpt-5.5 fails with 'No API key for provider: openai-codex' (worked previously) |
| 406 | PAN-1669 | S | medium | ok |  |  | restart-with-model doesn't emit a live event |
| 407 | PAN-1668 | S | medium | ok |  |  | right-click 'restart with <model>' carries model only, never harness |
| 408 | PAN-1627 | M | medium | ok |  |  | Substrate: Claude Code's native .claude/** settings-edit protection wedges in-scope work agents (un-overridable by PreToolUse auto-appr… |
| 409 | PAN-1624 | S | medium | ok |  |  | pan handoff --author external: authored doc is socket_write-ten but never submitted |
| 410 | PAN-3901 | S | medium | ok |  |  | test-skip gate has no audited exemption for opt-in live suites (skipIf on env/binary); allowlist row with justification |
| 411 | PAN-3852 | S | medium | ok |  |  | Project creation follow-ups: SSH-port repo URLs, dotted repo names, partial-registration retry, non-duplicate 409 mapping |
| 412 | PAN-3862 | L | medium | ok |  |  | /agents-v2 machine session explorer over Herdr + all tmux servers; local first, remote via the PAN-3762 environment model |
| 413 | PAN-1572 | M | medium | ok |  |  | Settings permission-mode can desync from resolved config |
| 414 | PAN-1571 | S | medium | ok |  |  | Large multi-line pastes (handoff docs) land unsubmitted |
| 415 | PAN-1565 | S | medium | ok |  |  | Defensive mitigation: auto-recover conversations poisoned by Claude Code thinking-block resume 400 (upstream #63147) |
| 416 | PAN-1530 | S | medium | ok |  |  | Investigate: state.json with model='gpt-5.5' (a model that doesn't exist) |
| 417 | PAN-1461 | S | medium | ok |  |  | Conversation transcript: in-page search (Ctrl+F) only finds text in currently-rendered virtualized rows |
| 418 | PAN-1449 | S | medium | ok |  |  | PAN-1052 follow-up: memory extraction failing 59% on dogfood project + storage layout deviates from spec |
| 419 | PAN-1446 | S | medium | ok |  |  | PAN-1231 follow-up: remove or implement Table + Timeline modes in FleetAgentsView (scope-creep stubs) |
| 420 | PAN-1445 | S | medium | ok |  |  | PAN-1389 follow-up: remove or implement Files + Comments tabs in SessionFeedSidebar (scope-creep stubs) |
| 421 | PAN-3616 | S | medium | ok |  |  | Planned deploy restarts show the alarm-toned Reconnecting banner; use the lifecycle signal for calm 'updating' copy. |
| 422 | PAN-2982 | XS | medium | ok |  |  | Nothing runs a skill's own selftest when sync-sources/skills/** changes; a convoy passed a PR with its selftest red. |
| 423 | PAN-2981 | S | medium | ok |  |  | The conversation search index never prunes deleted sessions, so Ctrl-K offers zombie hits that 404 on open. |
| 424 | PAN-2976 | L | medium | ok |  |  | Generalize the ACP harness to any capability-passing ACP CLI: named adapters plus a config-declared custom-agent escape hatch. |
| 425 | PAN-1444 | S | medium | ok |  |  | Follow-up to PAN-1416: dashboard port lockfile + pan doctor multi-instance check |
| 426 | PAN-1440 | S | medium | ok |  |  | Follow-up to PAN-1158: bd export --refuse-empty guard + dolt-empty root cause |
| 427 | PAN-1433 | S | medium | ok |  |  | Conversation agents can leave host main repo in abandoned git rebase state for hours |
| 428 | PAN-1416 | S | medium | ok |  |  | Workspace-spawned dashboards must never claim the canonical dashboard port |
| 429 | PAN-1392 | S | medium | ok |  |  | pan close: archive-planning:move-prd fails when completed/ PRD exists but workspace PRD also exists |
| 430 | PAN-1330 | S | medium | ok |  |  | CLI cannot address planning-*/specialist-* sessions |
| 431 | PAN-1244 | M | medium | ok |  |  | pan admin cloister start: CLI crashes with SIGSEGV (exit code 139) after handing off to server |
| 432 | PAN-1240 | S | medium | ok |  |  | Ship-complete PRs going CONFLICTING after main moves need auto re-rebase recovery |
| 433 | PAN-1227 | S | medium | needs-refinement |  |  | Substrate: bead can be closed without delivering the work |
| 434 | PAN-1226 | L | medium | ok |  |  | PAN-1148 unified-dashboard redesign |
| 435 | PAN-1173 | S | medium | ok |  |  | pan show <bare-number> derives wrong agent ID for PAN-prefixed issues |
| 436 | PAN-1154 | M | medium | ok |  |  | pan up does not kill existing port holders |
| 437 | PAN-3540 | M | medium | ok |  |  | God View shows phantom agent orbs from state rows with no live session, a dead Hook Bus panel, and a pressure-blind swap header. |
| 438 | PAN-3354 | XS | medium | ok |  |  | The archive write door accepts kind=main, hiding a project's singleton workspace with no unarchive affordance in the UI. |
| 439 | PAN-3178 | XL | medium | ok |  |  | Make worktrees and diffs first class: +/- badge, dedicated Changes surface, conversation worktrees. PRD and mockup exist. |
| 440 | PAN-3017 | S | medium | ok |  |  | The issue-page UAT panel renders only inline actions, so restart/rebuild/stop are unreachable outside the rail's context menu. |
| 441 | PAN-3864 | M | medium | needs-refinement |  |  | /agents shows 183 STRIKE RUNNING for stopped strikes; cut made liveness live-read — re-verify what remains before building |
| 442 | PAN-3873 | M | medium | ok |  |  | GitHub event delivery: support gh webhook forward alongside smee with guided setup, settings exposure, and docs |
| 443 | PAN-1150 | S | medium | ok |  |  | Settings: "Anthropic is not configured" warning persists in Model Routing after claude /login (Provider tab disagrees) |
| 444 | PAN-1149 | S | medium | ok |  |  | v0.9.3 upgraders: stale workhorses.mid: claude-sonnet-4-7 in config.yaml keeps breaking Model Routing saves |
| 445 | PAN-1130 | S | medium | ok |  |  | Headless review sub-reviewer normal exit misclassified as 'crashed', triggers spurious restart |
| 446 | PAN-1129 | S | medium | ok |  |  | Review-request route pushes wrong branch name: 'feature/977' instead of 'feature/pan-977' |
| 447 | PAN-1128 | S | medium | ok |  |  | Channels: spurious 'no MCP server configured with that name' banner at conversation startup |
| 448 | PAN-1113 | S | medium | ok |  |  | Conversations sidebar lets you message review-specialist sessions, which derails them silently |
| 449 | PAN-1068 | S | medium | ok |  |  | PAN-1048 deferred findings: security, correctness, and model validation gaps |
| 450 | PAN-1027 | S | medium | ok |  |  | Merge-status drift: deacon auto-detect paths set mergeStatus=merged without postMergeLifecycle, never reset on revert |
| 451 | PAN-933 | S | medium | ok |  |  | Review poster cannot post to GitLab MRs (only supports GitHub PRs) |
| 452 | PAN-932 | S | medium | ok |  |  | pan done: polyrepo uncommitted changes check + existing MR handling |
| 453 | PAN-927 | M | medium | ok |  |  | Rewrite containerize route: dead code, orphan processes, no pending-op tracking |
| 454 | PAN-900 | S | medium | ok |  |  | Trust devroot for conversations + atomic .claude.json writes |
| 455 | PAN-886 | S | medium | ok |  |  | pan review request shows 'fetch failed' instead of actual sync-target-branch error |
| 456 | PAN-778 | M | medium | ok |  |  | Write conflict race: review-agent fails when test-agent write scope not yet released |
| 457 | PAN-727 | M | medium | ok |  |  | Fix orphaned work-agent start handoff after planning |
| 458 | PAN-681 | S | medium | ok |  |  | Feedback routing: wrong issueId written to workspace when verification runs for co-active issues |
| 459 | PAN-3732 | S | medium | ok |  |  | Codex handoff serializes a large rollout twice (~286MB peak RSS on 50MB); serialize once or stream. |
| 460 | PAN-3700 | M | medium | ok |  |  | pan acp serve would let Zed and other ACP clients drive Overdeck conversations through canonical doors. PRD written. |
| 461 | PAN-3290 | XS | medium | ok |  |  | xBRIEF items can carry empty metadata.traces, so docs items sit unanchored in the requirement traceability graph. |
| 462 | PAN-3132 | M | medium | ok |  |  | xBRIEF v0.9 agentic dispatch fields are half-adopted as a behavior accident; make difficulty/filesScope/verifyCommands a contract. |
| 463 | PAN-3909 | M | medium | needs-refinement |  |  | One agents read door (operator-directed); the cut deleted the agents table and made liveness.ts canonical — re-scope what remains |
| 464 | PAN-3822 | M | medium | ok |  |  | Link pull requests to conversations via branch detection plus an explicit right-click link/unlink override |
| 465 | PAN-3893 | S | medium | ok |  |  | ACP conversations drop agent thoughts: no agent_thought_chunk case and no thought role in the transcript schema |
| 466 | PAN-3831 | S | medium | ok |  |  | Model picker: gray out models whose provider has no API key or subscription login (per-provider readiness resolver) |
| 467 | PAN-3867 | S | medium | ok |  |  | /projects/new discards keystrokes typed before the first resolve lands; add a delayed-resolve journey test |
| 468 | PAN-538 | S | medium | ok |  |  | pan reload freshness guard must also verify the frontend bundle |
| 469 | PAN-1164 | M | medium | ok |  |  | Conversation diff summaries update live over WebSocket (drop 5s polling) |
| 470 | PAN-1041 | M | medium | ok |  |  | Audit and consolidate REMOTE/LOCAL gates in work-agent prompt template |
| 471 | PAN-924 | L | medium | needs-refinement |  |  | Spike: evaluate GitNexus for Panopticon integration |
| 472 | PAN-3770 | S | medium | ok |  |  | Codex conversations never show the working spinner mid-turn; parser marks every agent_message instantly complete. |
| 473 | PAN-3731 | S | medium | ok |  |  | Restart-gate banner gives no feedback after approval; dead-requester approvals read as a broken button. |
| 474 | PAN-3530 | S | medium | ok |  |  | Four God View components poll on 30s timers instead of the documented /ws/rpc event contract. |
| 475 | PAN-3131 | L | medium | ok |  |  | Support xBRIEF planRef sharding so a 1.1MB/227-item plan stops making every finalize failure whole-plan-fatal. |
| 476 | PAN-3061 | M | medium | ok |  |  | Deterministic start-vs-swarm recommendation at plan-finalize, derived from plan shape plus recorded outcomes. |
| 477 | PAN-3057 | S | medium | needs-refinement |  |  | Harness-initiated compaction idled six agents and GPT-5.6's window was declared twice; both fixes appear landed — verify and close. |
| 478 | PAN-3892 | M | medium | needs-refinement |  |  | Substrate review follow-ups deferred from PAN-3845 (minor findings, config clear-sentinel); split into workable items |
| 479 | PAN-3827 | S | medium | ok |  |  | Dashboard shows the empty welcome state instead of an error when the harness exits before writing a transcript |
...
| 486 | PAN-646 | XS | medium | ok |  |  | Canceled issues: add guided Recover workflow |
| 487 | PAN-532 | M | medium | ok |  |  | Per-project and per-issue model overrides for pipeline roles |
| 488 | PAN-2896 | M | medium | ok |  |  | Warm resource-discovery and membership caches at boot |
| 489 | PAN-2685 | M | medium | ok |  |  | Annotated live preview: Codex-style annotate-the-app feedback delivered to agents |
| 490 | PAN-2626 | M | medium | ok |  |  | allow composer model switching within the same model family (e.g. Sonnet → Fable) |
| 491 | PAN-2625 | XS | medium | ok |  |  | auto-run /pan-new-project on project creation + setup banner, checklist, teaching empty states, and a guided demo issue |
| 492 | PAN-2609 | M | medium | ok |  |  | Cross-device sync of conversations and tasks via user-owned git remote |
| 493 | PAN-2608 | M | medium | ok |  |  | Persistent collaboration roles (owner/editor/viewer) and organizations |
| 494 | PAN-2582 | M | medium | ok |  |  | show slot assignments on the vBRIEF DAG + unify swarm/tiered terminology (Lead/Crew or Trunk/Lanes) |
| 495 | PAN-2566 | L | medium | ok | ✓ |  | Triage list of genuine Traycer capability gaps; a container for child issues, not directly workable. |
| 496 | PAN-2565 | M | medium | ok |  |  | Multi-agent conversations: N agent sessions in one task surface with agent-to-agent messaging |
| 497 | PAN-3735 | S | medium | ok |  |  | Sandboxed pan CLI reports 'dashboard down, run pan up' when the real cause is no network; sends agents down the wrong path. |
| 498 | PAN-3335 | XS | medium | ok |  |  | A pasted screenshot can't be viewed anywhere in the dashboard: thumbnail has no click handler and the sent form is a file-link chip. |
| 499 | PAN-3054 | M | medium | ok |  |  | Benchmark matrix: run one template issue under N crew/model configurations and compare cost, wall-clock and outcome. |
| 500 | PAN-2977 | M | medium | ok |  | PAN-2976 | Settings surface that detects installed ACP CLIs, renders the capability checklist, and guides login without a manual terminal. |
| 501 | PAN-2558 | L | medium | ok |  |  | support polyrepo projects |
| 502 | PAN-2557 | M | medium | ok |  |  | project-level 'Restart All' context action |
| 503 | PAN-2553 | M | medium | ok |  |  | project-level CI visibility |
| 504 | PAN-2548 | XS | medium | ok |  |  | close the PAN-2541 legacy-fallback deprecation window |
...
| 508 | PAN-3903 | M | medium | needs-refinement |  |  | Route pipeline reads through IssuesResolver; the cut deleted the review-status family (readers now use pr-facts) — re-scope |
| 509 | PAN-3853 | S | medium | needs-refinement |  |  | Review synthesizer self-declared an operator override; that override door was deleted by the cut — verify on the PR-review path |
| 510 | PAN-3830 | S | medium | ok |  |  | OpenCode provider: curate picker models via Settings favorites (OpenRouter pattern) instead of listing every discovered model |
| 511 | PAN-3863 | L | medium | ok |  | PAN-3762 | Orca-style SSH Hosts + Remote Servers onboarding; UX extension of the PAN-3762 federation model, not a competing design |
| 512 | PAN-2444 | L | medium | ok |  |  | optional SageOx re-integration |
| 513 | PAN-2443 | M | medium | ok |  |  | OpenTelemetry GenAI semconv |
| 514 | PAN-2442 | M | medium | ok |  |  | Agent Client Protocol (ACP) as Overdeck's structured control plane |
| 515 | PAN-2409 | M | medium | ok |  |  | enforce the workspace boundary |
| 516 | PAN-2399 | M | medium | ok |  |  | wire replay_threshold/compaction_reroute into the slot-recovery respawn seam |
| 517 | PAN-2392 | M | medium | ok |  |  | Standing Crew cost panel |
...
| 545 | PAN-1967 | M | medium | ok |  |  | Flywheel must re-validate (re-plan) pre-cutover plans before implementing them |
...
| 560 | PAN-3499 | XS | medium | needs-refinement |  |  | Same one-line ProjectConfig.path fix as PAN-3504; confirm it landed on main and close the duplicate. |
| 561 | PAN-2978 | S | medium | ok |  | PAN-2976, PAN-2977 | Opt-in per-agent install recipes for ACP CLIs from the setup UI; deliberately separated for its supply-chain trust decision. |
| 562 | PAN-3912 | XS | medium | ok |  |  | pan restart accepts a stray positional (pan restart status) and files a real restart request; reject excess args |
| 563 | PAN-1754 | M | medium | ok |  |  | surface + edit the host claude CLI default model (~/.claude/settings.json) from the Settings page |
| 564 | PAN-1751 | M | medium | ok |  |  | harness picker on every Settings → Roles row (plan/work/review/test/ship/strike), not just Flywheel |
| 565 | PAN-1750 | M | medium | ok |  |  | UAT assembly/conflict agent |
| 566 | PAN-1748 | M | medium | ok |  |  | reuse uat-assembly conflict resolutions across generations (rerere or resolution replay) |
| 567 | PAN-1735 | M | medium | ok |  |  | adopt externally-completed readyForMerge issues into the pipeline/merge queue |
...
| 583 | PAN-1497 | M | medium | ok |  |  | emit TTS announcements on lifecycle events (start, pause, resume, report) |
| 584 | PAN-1490 | M | medium | ok |  |  | show each conversation's current git branch (port t3code BranchToolbar pattern) |
| 585 | PAN-1489 | M | medium | needs-refinement |  |  | task(flywheel): tune v1.0 readiness criteria after 30 days of telemetry |
...
| 588 | PAN-1443 | M | medium | ok |  |  | Follow-up to PAN-487: migrate 10 stale .vbrief.json files from docs/prds/active/ to completed/ |
...
| 607 | PAN-709 | M | medium | ok |  |  | self-improving flywheel |
...
| 610 | PAN-675 | M | medium | ok |  |  | Deacon: detect API rate-limit events, surface on dashboard, auto-restart when window resets |
...
| 646 | PAN-2507 | M | low | ok |  |  | Preemptive pipeline scheduler: yield idle work agents to unblock review/test/merge dispatch |
...
| 650 | PAN-2424 | L | low | ok | ✓ |  | Epic: the Order Book |
| 651 | PAN-2406 | M | low | ok |  |  | close-out gaps: verify-merged rejects record-only deltas; slot/suffixed worktrees never torn down; teardown abort fires after worktree … |
| 652 | PAN-2394 | M | low | ok |  |  | Incident: conv-* agent-dir cleanup destroyed ohmypi/codex conversation transcripts ("no saved history") |
| 653 | PAN-2356 | M | low | needs-refinement |  |  | Overdeck Anywhere P3: relay service |
| 654 | PAN-2355 | M | low | ok |  |  | Overdeck Anywhere P2: mobile PWA (Needs-You feed, conversation view, pipeline board, Web Push) |
| 655 | PAN-2354 | M | low | ok |  |  | Overdeck Anywhere P1c: needs-you push notification bridge (ntfy first, Web Push later) |
| 656 | PAN-2352 | M | low | needs-refinement |  |  | Overdeck Anywhere P1a: remote dashboard access via Cloudflare Tunnel + Access |
| 657 | PAN-2353 | M | low | needs-refinement |  |  | Overdeck Anywhere P1b: Hermes external-agent bridge (scoped API + Fly 6PN) |
| 658 | PAN-3133 | S | low | ok |  |  | Evaluation spike for TRON encoding of prompt-bound xBRIEF payloads; savings are modest today since agents get a bounded slice. |
| 659 | PAN-3011 | M | low | ok |  | PAN-1641, PAN-465 | Add poolside Laguna S 2.1 as a model target; the honest hardware note says it will not fit this machine's GPU. |
...
| 675 | PAN-1980 | M | low | ok |  |  | Stop session rotation on resume (behind a constant); one pipeline-membership view from all lenses |
...
| 677 | PAN-1949 | M | low | ok |  |  | Surface inspection sub-runs in the issue tree + a parent Inspection node aggregating all item verdicts |
| 678 | PAN-1914 | M | low | ok |  |  | Follow-up: move /api/health/agents off agent-directory scans |
| 679 | PAN-1907 | M | low | ok |  |  | Generalize ToS gate: block ALL non-Claude-Code harnesses from Anthropic-subscription models; gray out + non-selectable + validate every… |
| 680 | PAN-1895 | M | low | ok |  |  | Spawn work agents from issue workspace slide-out |
| 681 | PAN-1878 | M | low | ok |  |  | process: bake 'docs updated' into acceptance criteria / definition-of-done in role + planning prompts |
| 682 | PAN-1782 | M | low | ok |  |  | Handoff forks stall at "Injecting…" then die on double 300s summary timeout |
| 683 | PAN-1773 | M | low | ok |  |  | Swarm v2 Phase 2: remote slot agents on Fly (B5 follow-up to PAN-1762) |
| 684 | PAN-1758 | M | low | ok |  |  | Watch: ready-for-merge work must converge despite a continuously moving main |
...
| 700 | PAN-1152 | XS | low | ok |  |  | Remove PANOPTICON_DEV env-var persistence |
| 701 | PAN-1136 | M | low | ok |  |  | Hook system cleanup: dead inspect-on-bead-close, pan-review-agent inconsistency |
| 702 | PAN-1135 | M | low | ok |  |  | Document the hook system in docs/HOOKS.md |
| 703 | PAN-1133 | M | low | ok |  |  | TLDR: deacon supervision + pan doctor check + GC |
| 704 | PAN-1124 | M | low | ok |  |  | Decouple specs and PRDs from workspaces |
...
| 721 | PAN-962 | M | low | ok |  |  | Post-PAN-946: vBRIEF lifecycle follow-up plan |
| 722 | PAN-961 | M | low | ok |  |  | Update documentation for vBRIEF v0.6 lifecycle model |
| 723 | PAN-944 | M | low | ok |  |  | Make vBRIEF the durable task graph source of truth |
...
| 729 | PAN-832 | M | low | ok |  |  | state.json staleness: lastActivity/costSoFar not updated as agent runs; /api/agents drops phase/cost/lastActivity |
| 730 | PAN-810 | XS | low | ok |  |  | Inspector: diagnostic UI when pipeline phase is unknown |
...
| 741 | PAN-772 | M | low | ok |  |  | Unify terminal stack behavior across tmux sessions |
| 742 | PAN-771 | M | low | needs-refinement |  |  | Investigate Vercel Sandbox execution backend support |
| 743 | PAN-769 | M | low | ok |  | PAN-750 | Track verification/review/test phase churn over time |
...
| 783 | PAN-2347 | XS | low | ok |  |  | docs: refresh AGENT-STATE-PLANES.md |
| 784 | PAN-2346 | XS | low | ok |  |  | docs: refresh AGENT_TYPES_INDEX.md |
| 785 | PAN-2345 | XS | low | ok |  |  | docs: refresh pan-done.md |
| 786 | PAN-2344 | XS | low | ok |  |  | docs: refresh KANBAN-MODEL.md |
...
| 798 | PAN-633 | M | low | ok |  |  | Update Cloister PRD and docs index |
...
| 804 | PAN-324 | XS | medium | stale |  |  | Agent detail pane missing Merge/Approve button |
| 805 | PAN-304 | S | medium | stale |  |  | closeLinearDirect returns stepOk even when state update never happens |
| 806 | PAN-247 | S | medium | stale |  |  | Deacon has no backoff or escalation for repeated specialist startup failures |
...
| 809 | PAN-178 | M | medium | stale |  |  | PAN-178: Crash recovery with granular task checkpointing |
...
| 823 | PAN-3861 | M | low | stale |  |  | Stale: terminal.backend (tmux|herdr) setting and Herdr default landed in the PAN-3917 cut (ca15def); close or re-scope the remainder |
| 824 | PAN-2746 | XS | low | stale |  | PAN-2742, PAN-2695 | Stale: targets the review_status record (verdicts are PR reviews) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 825 | PAN-3761 | M | low | stale |  |  | Stale: targets the durable review-status record behind UAT trains deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 826 | PAN-3561 | S | low | stale |  |  | Stale: targets pan-dir/state-git-lock.ts deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 827 | PAN-3283 | S | low | stale |  |  | Stale: targets the review_status record deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 828 | PAN-3631 | S | low | stale |  |  | Stale: targets the overdeck-state sequence mirror (.pan is canonical now) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 829 | PAN-3564 | M | low | stale |  |  | Stale: targets pan-dir/record-lock.ts + state-git lock deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 830 | PAN-3682 | S | low | stale |  |  | Stale: targets the workspace record write door (record plane) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 831 | PAN-3571 | S | low | stale |  |  | Stale: targets work-agent-stop-hook (7b953449633) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 832 | PAN-3563 | S | low | stale |  |  | Stale: targets pan unstick + the stored agent status row deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 833 | PAN-3424 | M | low | stale |  |  | Stale: targets the overdeck-state push path deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 834 | PAN-3281 | S | low | stale |  |  | Stale: targets the ready_for_merge record column (readiness is derived live) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 835 | PAN-3248 | XS | low | stale |  |  | Stale: targets the deploy patrol (pan reload is the new home) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 836 | PAN-2733 | S | low | stale |  |  | Stale: targets substrate-bug-poller deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 837 | PAN-2769 | S | low | stale |  |  | Stale: targets review_status rows deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 838 | PAN-3244 | S | low | stale |  |  | Stale: targets the deploy-patrol deploy window deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 839 | PAN-3078 | S | low | stale |  |  | Stale: targets the inspection gate (FR-14) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 840 | PAN-2886 | M | low | stale |  |  | Stale: targets auto-resume + pending-work-spawn placeholder deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 841 | PAN-2848 | S | low | stale |  |  | Stale: targets the inspection gate (FR-14) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 842 | PAN-2747 | S | low | stale |  |  | Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 843 | PAN-2759 | S | low | stale |  |  | Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 844 | PAN-2709 | M | low | stale |  |  | Stale: targets the flywheel orchestrator run deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 845 | PAN-2567 | S | low | stale |  |  | Stale: targets advancing-selfheal.ts deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 846 | PAN-2775 | S | low | stale |  |  | Stale: targets boot-correlated reaping (boot reconciliation) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 847 | PAN-2323 | S | low | stale |  |  | Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 848 | PAN-2971 | S | low | stale |  |  | Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 849 | PAN-2888 | M | low | stale |  | PAN-2846 | Stale: targets inspect sub-agents + review_status residue deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 850 | PAN-2960 | S | low | stale |  |  | Stale: targets the inspect supervisor deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 851 | PAN-2959 | S | low | stale |  |  | Stale: targets pan inspect deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 852 | PAN-2516 | S | low | stale |  |  | Stale: targets spec-vs-record drift + state push deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 853 | PAN-3650 | S | low | stale |  |  | Stale: targets the deacon auto-resume ladder deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 854 | PAN-3301 | S | low | stale |  |  | Stale: targets the stray-writer patrol (.pan is canonical now) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 855 | PAN-2075 | XL | low | stale | ✓ |  | Stale: targets boot reconciliation (epic) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 856 | PAN-2077 | M | low | stale |  | PAN-1775 | Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 857 | PAN-2078 | M | low | stale |  | PAN-2077 | Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 858 | PAN-2079 | M | low | stale |  | PAN-2077 | Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 859 | PAN-454 | XS | low | stale |  | PAN-2077 | Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 860 | PAN-3651 | M | low | stale |  |  | Stale: targets the overdeck-state push retry deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 861 | PAN-3634 | S | low | stale |  |  | Stale: targets flywheelRunId stamping deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 862 | PAN-3505 | XS | low | stale |  |  | Stale: targets the flywheel state write door deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 863 | PAN-3513 | L | low | stale |  |  | Stale: targets the overdeck-state runtime plane deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 864 | PAN-3137 | XS | low | stale |  |  | Stale: targets the flywheel status snapshot deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 865 | PAN-2678 | M | low | stale |  |  | Stale: targets state worktrees deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 866 | PAN-1720 | S | low | stale |  |  | Stale: targets cloister auto-resume tests deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 867 | PAN-2837 | M | low | stale |  |  | Stale: targets overdeck-state presence records deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 868 | PAN-2830 | M | low | stale |  |  | Stale: targets the overdeck-state branch (archived) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 869 | PAN-2549 | M | low | stale |  |  | Stale: targets overdeck-state sync deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 870 | PAN-2805 | S | low | stale |  |  | Stale: targets FlywheelPage deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 871 | PAN-2659 | S | low | stale |  |  | Stale: targets pan-dir/record-lock.ts deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 872 | PAN-3157 | XS | low | stale |  |  | Stale: targets flywheel run activity deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 873 | PAN-1438 | S | low | stale |  |  | Stale: targets the flywheel launcher process deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 874 | PAN-1386 | S | low | stale |  |  | Stale: targets flywheel status snapshots deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 875 | PAN-1245 | M | low | stale |  |  | Stale: targets the flywheel run gate deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 876 | PAN-3321 | XS | low | stale |  |  | Stale: targets pan unstick deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 877 | PAN-1437 | M | low | stale |  |  | Stale: targets pan flywheel report deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 878 | PAN-3895 | M | low | stale |  |  | Stale: deletes patrols from a patrol loop the PAN-3917 cut (ca15def) already replaced with deacon-lite; re-triage or close |
| 879 | PAN-3896 | S | low | stale |  |  | Stale: would-fire counters (patrol-would-fire.ts) deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 880 | PAN-3914 | S | low | stale |  |  | Stale: checkOrphanedCompletions / deacon.ts patrol deleted by the PAN-3917 cut (ca15def); re-triage or close |
| 881 | PAN-3843 | S | low | stale |  |  | Stale: test-status-green-ci-reconciler.ts deleted by the PAN-3917 cut (ca15def); re-file if the symptom recurs on pr-facts |
| 882 | PAN-3837 | S | low | stale |  |  | Stale: record lock and pending-work-spawn placeholder deleted by the PAN-3917 cut (ca15def); re-file if handoff spawn still dies |
| 883 | PAN-3868 | XS | low | stale |  |  | Stale: work-agent-stop-hook was deleted by the PAN-3917 cut (ca15def) (7b953449633); the wrong verb no longer exists |
| 884 | PAN-299 | M | low | stale |  |  | Granular session state persistence across context compaction |
| 885 | PAN-298 | M | low | stale |  |  | Auto-detect package manager and runtime in workspace setup |
| 886 | PAN-297 | M | low | stale |  |  | Workspace templates: pre/post tool hooks for auto-format, typecheck, lint |
| 887 | PAN-283 | M | low | stale |  |  | Reset should sync workspace feature branch with latest main |
| 888 | PAN-271 | M | low | stale |  |  | Auto-assign Linear project from project config when creating issues |
| 889 | PAN-265 | M | low | stale |  |  | Review skill categorization: all skills available everywhere via personal + workspace |
| 890 | PAN-249 | XS | low | stale |  |  | Add data-testid attributes across dashboard UI and create Playwright smoke test suite |
| 891 | PAN-241 | L | low | stale |  |  | Mobile redesign initiative: full UX/UI overhaul + implementation plan |
| 892 | PAN-228 | M | low | stale |  |  | Shift-left post-edit diagnostics |
| 893 | PAN-227 | M | low | stale |  |  | Phase gate validation |
| 894 | PAN-198 | M | low | stale |  |  | Structured audit trail for agent actions |
| 895 | PAN-190 | M | low | stale |  |  | PAN-190: Specialized reviewer prompts (industry best-practice checklists) |
| 896 | PAN-180 | M | low | stale |  |  | PAN-180: Cross-terminal file locking for concurrent agents |
| 897 | PAN-177 | M | low | stale |  |  | PAN-177: Iteration limits with escalation for autonomous agents |
| 898 | PAN-175 | M | low | stale |  |  | PAN-175: Pre-compact auto-save hook for agent sessions |
| 899 | PAN-155 | L | low | stale |  |  | PAN-155: Redesign health page with Stitch (system overview, timeline, costs) |
| 900 | PAN-146 | M | low | stale |  |  | PAN-146: Refine light mode theming across all dashboard pages |
| 901 | PAN-55 | M | low | stale |  |  | Track specialist costs with time period filtering |
| 902 | PAN-52 | XS | low | stale |  |  | Guidance needed: Running complex multi-container projects with Panopticon worktrees |
| 903 | PAN-51 | M | low | stale |  |  | Documentation: Clarify issue tracker options beyond Linear |
| 904 | PAN-47 | M | low | stale |  |  | PRD files should be committed to feature branch, moved to completed/ on merge |
...
New this pass. Compact respawn confirms the kickoff against the archived session rather than the fresh one, so a replacement session that had already accepted the recovery prompt and created four tasks was declared unconfirmed and killed. Recovery that destroys healthy work is worse than no recovery, and the orphan reconciler only noticed 40 seconds later. Condition changed after the PAN-3917 cut: compaction-continuation/orchestrated-compaction were deleted by the cut; confirm whether compact respawn still exists — re-scope.
...
Strike landing is the urgent-fix door and the first unfrozen strike (PAN-3810) broke on all three steps: salvageStrandedStrikeBranches (still in deacon-strike-landing.ts) ignores mergeStatus/strikeLandingState and re-arms a merged branch, close-out wrote merges: [] and left the issue open, and no deploy unit ran. blocks-main + pipeline; ranked with the critical substrate bugs.
...
New this pass. A stale pending-post-merge.json deadlocks the deploy gate: the gate refuses agent-initiated restarts while any pending file exists, startup would discard it as stale but startup needs the restart the gate refuses, and the deacon patrol that would clear it was frozen. A 3.5-hour-old ghost file blocked every deploy indefinitely while the live dashboard ran a ten-hour-old build. Condition changed after the PAN-3917 cut: the deacon-owned deploy gate is gone; pending-post-merge.json still has two readers — re-scope.
...
resolveBootGates is only called from restart.ts; reload and the post-merge deploy path relaunch with no OVERDECK_* gate env, so deacon-lite is silently off after most deploys. Related to PAN-3898 (same landing).
...
```json
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "rationale": "Strike landing is the urgent-fix door and the first unfrozen strike (PAN-3810) broke on all three steps: salvageStrandedStrikeBranches (still in deacon-strike-landing.ts) ignores mergeStatus/strikeLandingState and re-arms a merged branch, close-out wrote merges: [] and left the issue open, and no deploy unit ran. blocks-main + pipeline; ranked with the critical substrate bugs.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "rationale": "Cost-bleed circuit breaker — progress-aware, always-on guard against runaway spend; the one real guard the epic authorizes. Updated since the prior run (comment/label activity); body substance unchanged, rank held. Note: its costBleedMonitor is described as a deacon patrol — deacon-lite is the new home.",
      "gate": "auto",
      "planning": "skip"
    },
    {
    ...
    },
    {
      ...
      "rationale": "Condition changed after the PAN-3917 cut: lifecycle/residue.ts was deleted by the cut; confirm the closed-without-landing disposition gap survives — re-scope.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "rationale": "The offending re-dispatch (deacon-review-status.ts) is gone, but the expectation that pan pause holds the whole issue (work, review, test, merge) still needs verifying against deacon-lite.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "why": "Stale: targets the review_status record (verdicts are PR reviews) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 2: the component this issue targets (the review_status record (verdicts are PR reviews)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the durable review-status record behind UAT trains deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 10: the component this issue targets (the durable review-status record behind UAT trains) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets pan-dir/state-git-lock.ts deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 13: the component this issue targets (pan-dir/state-git-lock.ts) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the review_status record deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 16: the component this issue targets (the review_status record) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the overdeck-state sequence mirror (.pan is canonical now) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 21: the component this issue targets (the overdeck-state sequence mirror (.pan is canonical now)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets pan-dir/record-lock.ts + state-git lock deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 23: the component this issue targets (pan-dir/record-lock.ts + state-git lock) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the workspace record write door (record plane) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 28: the component this issue targets (the workspace record write door (record plane)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets pan unstick + the stored agent status row deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 33: the component this issue targets (pan unstick + the stored agent status row) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the overdeck-state push path deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 38: the component this issue targets (the overdeck-state push path) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the ready_for_merge record column (readiness is derived live) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 41: the component this issue targets (the ready_for_merge record column (readiness is derived live)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets substrate-bug-poller deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 47: the component this issue targets (substrate-bug-poller) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets review_status rows deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 49: the component this issue targets (review_status rows) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the inspection gate (FR-14) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 78: the component this issue targets (the inspection gate (FR-14)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets auto-resume + pending-work-spawn placeholder deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 89: the component this issue targets (auto-resume + pending-work-spawn placeholder) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "dependsOn": [],
      "why": "Stale: targets the inspection gate (FR-14) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 92: the component this issue targets (the inspection gate (FR-14)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 94: the component this issue targets (the flywheel run record) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "dependsOn": [],
      "why": "Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 95: the component this issue targets (the flywheel run record) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel orchestrator run deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 96: the component this issue targets (the flywheel orchestrator run) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets advancing-selfheal.ts deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 99: the component this issue targets (advancing-selfheal.ts) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "rationale": "Demoted from rank 103: the component this issue targets (boot-correlated reaping (boot reconciliation)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "dependsOn": [],
      "why": "Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 105: the component this issue targets (the flywheel run record) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "dependsOn": [],
      "why": "Stale: targets the flywheel run record deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 113: the component this issue targets (the flywheel run record) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "why": "Stale: targets inspect sub-agents + review_status residue deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 115: the component this issue targets (inspect sub-agents + review_status residue) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the inspect supervisor deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 117: the component this issue targets (the inspect supervisor) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets pan inspect deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 118: the component this issue targets (pan inspect) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets spec-vs-record drift + state push deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 124: the component this issue targets (spec-vs-record drift + state push) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the deacon auto-resume ladder deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 135: the component this issue targets (the deacon auto-resume ladder) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the stray-writer patrol (.pan is canonical now) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 140: the component this issue targets (the stray-writer patrol (.pan is canonical now)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets boot reconciliation (epic) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 152: the component this issue targets (boot reconciliation (epic)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "blocked",
      "planning": "skip",
      "isEpic": true
    },
    {
      ...
      "why": "Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 153: the component this issue targets (boot reconciliation) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "why": "Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 154: the component this issue targets (boot reconciliation) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "why": "Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 155: the component this issue targets (boot reconciliation) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "interactive"
    },
    {
      ...
      "why": "Stale: targets boot reconciliation deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 158: the component this issue targets (boot reconciliation) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the overdeck-state push retry deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 160: the component this issue targets (the overdeck-state push retry) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "rationale": "Demoted from rank 239: the component this issue targets (the flywheel state write door) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the overdeck-state runtime plane deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 252: the component this issue targets (the overdeck-state runtime plane) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "interactive"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel status snapshot deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 259: the component this issue targets (the flywheel status snapshot) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "skip"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets state worktrees deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 287: the component this issue targets (state worktrees) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets cloister auto-resume tests deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 315: the component this issue targets (cloister auto-resume tests) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets overdeck-state presence records deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 356: the component this issue targets (overdeck-state presence records) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "interactive"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the overdeck-state branch (archived) deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 358: the component this issue targets (the overdeck-state branch (archived)) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "interactive"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets overdeck-state sync deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 361: the component this issue targets (overdeck-state sync) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "interactive"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets FlywheelPage deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 382: the component this issue targets (FlywheelPage) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets flywheel run activity deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 468: the component this issue targets (flywheel run activity) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel launcher process deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 474: the component this issue targets (the flywheel launcher process) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets flywheel status snapshots deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 478: the component this issue targets (flywheel status snapshots) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel run gate deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 480: the component this issue targets (the flywheel run gate) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets pan flywheel report deleted by the PAN-3917 cut (ca15def); re-triage or close",
      "rationale": "Demoted from rank 637: the component this issue targets (pan flywheel report) was deleted by the PAN-3917 cut on main; the issue needs re-triage against the new tree or closure.",
      "gate": "auto",
      "planning": "auto"
    },
    {
    ...
    },
    {
      ...
      "condition": "stale",
      "dependsOn": [],
      "why": "Stale: targets the flywheel orchestrator docs (docs/FLYWHEEL.md) deleted by the PAN-3917 cut (ca15def); re-triage or close",
