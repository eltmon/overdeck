...
_Last sequenced: 2026-09-21T00:01:08.626Z · model: claude-opus-5 · open: 856_
...
| 246 | PAN-3975 | S | medium | ok |  |  | Palette collapses 401/reload/500 into "No results"; surface a search-unavailable state so operators stop hunting phantom index bugs |
...
```json
{
  "version": 1,
  "project": "overdeck",
  "generatedAt": "2026-09-21T00:01:08.626Z",
  "model": "claude-opus-5",
  "pass": "incremental",
  "openCount": 856,
  "nodes": [
    ...
    },
    {
      ...
      "condition": "ok",
      "dependsOn": [],
      "why": "Palette collapses 401/reload/500 into \"No results\"; surface a search-unavailable state so operators stop hunting phantom index bugs",
      "rationale": "New issue since the prior run (opened 2026-09-20T23:51Z). Self-contained bug with an exact fix and named test; placed directly after PAN-3771 because both make conversation search look empty when it is not.",
      "gate": "auto",
      "planning": "auto"
    },
    {
