...
Metric-aware Flywheel ranking uses these criteria to explain why one substrate-bug suggestion outranks another; see [Metric-aware suggestion weights](./docs/FLYWHEEL.md#metric-aware-suggestion-weights) for the trailer, label fallback, and operator-facing weight/reason semantics.
