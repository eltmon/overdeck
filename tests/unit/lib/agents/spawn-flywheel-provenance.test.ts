...
vi.mock('../../../../src/lib/agents/spawn-prep.js', async (importOriginal) => ({
  ...
  // spawn.ts calls the prepareWorkspaceForAgentSpawn wrapper, not
  // assertWorkspaceStackHealthyForSpawn directly — mocking only the inner
  // function doesn't intercept it (same-module internal call).
