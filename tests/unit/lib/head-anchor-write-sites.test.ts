...
const ALLOWED_WRITE_SITES: AllowedWriteSite[] = [
  ...
  allow('src/lib/cloister/deacon-review-status.ts', 'reviewedAtCommit', 'reviewedAtCommit: artifact.headSha', 'Producer-fed artifact recovery stamp after the context anchor proves the reviewed HEAD.'),
