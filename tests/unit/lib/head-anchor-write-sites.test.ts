...
const ALLOWED_WRITE_SITES: AllowedWriteSite[] = [
  ...
  allow('src/lib/cloister/deacon-review-status.ts', 'reviewedAtCommit', 'reviewedAtCommit: artifact.headSha', 'Synthesis-artifact recovery stamps its context-proven head SHA (PAN-1577 race guard).'),
