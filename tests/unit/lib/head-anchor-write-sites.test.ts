...
const ALLOWED_WRITE_SITES: AllowedWriteSite[] = [
  ...
  allow('src/lib/cloister/deacon.ts', 'reviewedAtCommit', 'reviewedAtCommit: undefined', 'Explicit blocked-review stale anchor clear before re-dispatch.'),
  allow('src/lib/cloister/deacon.ts', 'reviewedAtCommit', 'reviewedAtCommit: undefined', 'Explicit passed-review stale anchor clear before re-dispatch.'),
