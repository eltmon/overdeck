...
const CONSUMERS = [
  { name: 'resource-discovery', file: 'src/dashboard/server/services/resource-discovery.ts', delegates: /getPipelineMembershipResultsForProjects/, legacy: /filter\(\(issue\) => !isTerminalTrackerState/ },
