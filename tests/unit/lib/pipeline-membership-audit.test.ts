...
const CONSUMERS = [
  { name: 'resource-discovery', file: 'src/dashboard/server/services/resource-discovery.ts', delegates: /readPipelineMembershipSnapshotsForProjects/, legacy: /filter\(\(issue\) => !isTerminalTrackerState/ },
