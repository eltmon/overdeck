...
export const NO_LOSS_MATRIX: MatrixEntry[] = [
  ...
  { surface: 'POST /api/workers/register',                               kind: 'http', disposition: 'WRITE',      door: 'External agent registry: write-once ext-* registration + sessions.json transcript link, shared with pan worker register (PAN-3920 W19)' },
  ...
  { surface: 'GET /api/flywheel/stats', kind: 'http', disposition: 'READ', door: 'flywheel/substrate-stats computeSubstrateStats (PAN-3964: c1/c2 on read from tracker + forge)' },
  ...
  { surface: 'POST /api/flywheel/start', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions startFlywheel (PAN-3964: creates conv-flywheel, runs /pan-flywheel)' },
  { surface: 'POST /api/flywheel/pause', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions pauseFlywheel (PAN-3964: handleConversationStop, row kept)' },
  { surface: 'POST /api/flywheel/resume', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions resumeFlywheel (PAN-3964: handleConversationResume + /pan-flywheel)' },
  { surface: 'POST /api/flywheel/abort', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions abortFlywheel (PAN-3964: pause without a report)' },
  { surface: 'POST /api/flywheel/report', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions requestFlywheelReport (PAN-3964: asks the loop to write .pan/flywheel/report.md)' },
  ...
  { surface: 'GET /api/flywheel/state', kind: 'http', disposition: 'READ', door: 'flywheel/files readFlywheelStateFile (PAN-3964: <planHome>/.pan/flywheel/state.md)' },
  { surface: 'GET /api/flywheel/status', kind: 'http', disposition: 'READ', door: 'flywheel/derive-status deriveFlywheelStatus (PAN-3964: derived on read, shared with pan flywheel status)' },
  { surface: 'GET /api/flywheel/report', kind: 'http', disposition: 'READ', door: 'flywheel/files readFlywheelReportFile (PAN-3964: <planHome>/.pan/flywheel/report.md)' },
  { surface: 'POST /api/flywheel/stop', kind: 'http', disposition: 'WRITE', door: 'flywheel/actions stopFlywheel (PAN-3964: report request, wait, then pause)' },
  ...
  { surface: 'pan flywheel start', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions startFlywheel (PAN-3964)' },
  { surface: 'pan flywheel pause', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions pauseFlywheel (PAN-3964)' },
  { surface: 'pan flywheel resume', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions resumeFlywheel (PAN-3964)' },
  { surface: 'pan flywheel stop', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions stopFlywheel (PAN-3964)' },
  { surface: 'pan flywheel abort', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions abortFlywheel (PAN-3964)' },
  { surface: 'pan flywheel report', kind: 'cli', disposition: 'WRITE', door: 'flywheel/actions requestFlywheelReport | flywheel/files readFlywheelReportFile (PAN-3964)' },
  { surface: 'pan flywheel status', kind: 'cli', disposition: 'READ', door: 'flywheel/derive-status deriveFlywheelStatus (PAN-3964)' },
  { surface: 'pan flywheel stats', kind: 'cli', disposition: 'READ', door: 'flywheel/substrate-stats computeSubstrateStats (PAN-3964)' },
