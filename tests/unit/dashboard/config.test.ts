...
const ENV_KEYS = ['API_PORT', 'PORT', 'HOST', 'LINEAR_API_KEY', 'ANTHROPIC_API_KEY', 'DASHBOARD_URL', 'PANOPTICON_HOME', 'PANOPTICON_WORKSPACE_DASHBOARD_ALLOW_PRIMARY'];
...
beforeEach(() => {
  ...
  // These tests assert raw config defaults; workspace port-guard behavior is covered separately.
