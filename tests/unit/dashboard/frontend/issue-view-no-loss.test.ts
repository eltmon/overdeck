...
// PAN-3917 W7: the stale-review warning read `reviewStaleSince` off the record.
// The record is gone and the PR's own review state is the only truth, so the
// section is deleted rather than relocated.
