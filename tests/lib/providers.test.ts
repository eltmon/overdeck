...
import { KIMI_CODING_BASE_URL, KIMI_PLATFORM_BASE_URL, OLLAMA_OPENAI_BASE_URL, getProviderEnvSync, getProviderForModelSync, piProviderForModel, qualifyPiModel, PROVIDERS } from '../../src/lib/providers.js';
