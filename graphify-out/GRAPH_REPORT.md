...
## Corpus Check
- 2080 files · ~3,635,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33047 nodes · 64092 edges · 1394 communities (1327 shown, 67 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1517 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `294781a9`
...
## Communities (1394 total, 67 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (356): readCavemanVariant(), normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupOrphanReviewerSessions() (+348 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.01
Nodes (303): loadStartCommand(), flywheelAbortCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions (+295 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (249): checkDeadEndAgents(), checkFailedMergeRetry(), cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), clearStaleCiFeedback(), detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState() (+241 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (137): CLAUDE_PROJECTS_DIR, ClaudeMessage, getProjectDirs(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles(), getSessionFilesSync() (+129 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.01
Nodes (202): MODEL_COLORS, HealthEvent, CloisterStatus, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), STATE_COLORS (+194 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (159): getHealthThresholdsMs(), HealthThresholds, checkCostLimits(), getCostSummary(), addLog(), checkFirstCompletionAgents(), checkUndispatchedShip(), DeaconLogEntry (+151 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.03
Nodes (176): pruneStaleCheckpointRefs(), calls, killTmuxSession(), content, mockExeca, CloseOutContext, CloseOutError, CloseOutResult (+168 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.01
Nodes (149): ActivityView(), activeAgent, cafSpy, client, menu, onNavigateToIssues, rafSpy, scrollSpy (+141 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.01
Nodes (170): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause (+162 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (177): loadDeaconWithResumeMock(), applyEnvironmentOverrides(), deepMerge(), loadCloisterConfig(), loadCloisterConfigAsync(), loadCloisterConfigSync(), saveCloisterConfigSync(), shouldAutoStart() (+169 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (179): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), checkPostReviewCommits(), checkStuckReviewing(), monitorReviewConvoySignals(), archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise() (+171 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (147): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+139 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (165): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+157 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (141): config, DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+133 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (149): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+141 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.02
Nodes (148): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter() (+140 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.03
Nodes (138): AutoResumeConfig, fileExists(), API_ERROR_PATTERNS, Command Deck (Core Concept), Access, findDraftPrd(), findDraftPrdSync(), findPrdAnywhere() (+130 more)
...
Cohesion: 0.03
Nodes (129): buildPolyrepoContext(), createCostCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects() (+121 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.02
Nodes (130): isEligibleForCleanup(), displayIssues(), getConfiguredTrackers(), listCommand(), PRIORITY_LABELS, mockLoadProjectsConfig, mockResolveProjectFromIssue, project (+122 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.02
Nodes (128): parseDifficultyLabel(), LiveLastHeard(), stalenessClass(), BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress() (+120 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.02
Nodes (95): AgentTellForm(), AgentTellFormProps, SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS (+87 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (105): determineCavemanVariant(), injectCavemanSettings(), createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch() (+97 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.04
Nodes (113): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+105 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.04
Nodes (101): switchModel(), ZoneActionStrip(), ZoneActionStripProps, MenuDivider(), OverflowItem(), ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+93 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.02
Nodes (95): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+87 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (96): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+88 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (100): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+92 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (98): ActivityFeedSidebar(), conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck() (+90 more)
...
Cohesion: 0.04
Nodes (110): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+102 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (94): Work Agent (shown in inspector terminal), ChatMessage, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+86 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (105): estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneDocsConfig() (+97 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (85): PendingOperation, FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+77 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (75): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), result, GitHubConfig, claudePlanningSystemPromptFiles() (+67 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.04
Nodes (98): relativeTime(), showCommand(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), difficultyColor(), dryRun(), isSwarmRecoverAction() (+90 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (83): VerifyingOnMainBadge(), WorkspaceStatusOverviewProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload() (+75 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.04
Nodes (82): createMemoryCommand(), ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity (+74 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.04
Nodes (82): AgentWarningDialog(), Framer Motion animation library, ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS (+74 more)
...
}, buildAgentLaunchConfig(), determineModel(), getAgentRuntimeBaseCommand(), getProviderExportsForModel(), getRoleRuntimeBaseCommand(), panopticonAgentName(), roleAgentDefinitionPath() (+79 more)
...
Cohesion: 0.03
Nodes (94): updateTtsConfig(), clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, updateConversationsConfigAsync() (+86 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (90): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), completePlanningArtifacts(), checkPlanStatus(), readWorkspacePlanAsync() (+82 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.03
Nodes (93): EventMetadata, ReadEventsOptions, tailEvents(), tailEventsSync(), authorized(), eventsRouteLayer, formatFrame(), getEventStreamRoute (+85 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.03
Nodes (80): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientShape, GitHubComment, GitHubIssue (+72 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (93): TurnDiffFileChange, listConversations(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse, backfillConversationModels(), checkUploadRateLimit() (+85 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.04
Nodes (76): getGlobalRouter(), defaults, first, issueAgentTypes, { models }, second, anthropicModel, anthropicRouter (+68 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.05
Nodes (71): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+63 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.04
Nodes (81): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions, execAsync (+73 more)
...
Cohesion: 0.05
Nodes (69): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+61 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.06
Nodes (72): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+64 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.05
Nodes (64): startPostLaunchSidecars(), startSidecars(), delay(), data, mockExistsSync, mockReadFile, mockUnlink, runner (+56 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.05
Nodes (69): onSelectSession, AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), defaultExpandedFromState(), FeatureContextMenu(), FeatureContextMenuProps (+61 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.06
Nodes (69): resolveNode22(), sleep(), waitForHealth(), waitForHttp200(), waitForPortFree(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus() (+61 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.06
Nodes (65): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+57 more)
...
Cohesion: 0.05
Nodes (56): contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, applyManagedRegion(), cleanupAgentDirectories() (+48 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.06
Nodes (63): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+55 more)
...
Cohesion: 0.05
Nodes (69): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+61 more)
...
Cohesion: 0.04
Nodes (65): ShowOptions, adminRouteLayer, getAdminTldrRoute, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+57 more)
...
Cohesion: 0.06
Nodes (51): formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, checkBudget(), checkBudgetSync() (+43 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.09
Nodes (65): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync() (+57 more)
...
Cohesion: 0.05
Nodes (56): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), getDiscoveredSessionById(), getFtsRow(), markEnrichmentFailed() (+48 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.05
Nodes (62): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+54 more)

### Community 73 - "Merge Queue and App Settings Database"
Cohesion: 0.06
Nodes (65): handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+57 more)
...
Cohesion: 0.04
Nodes (52): changedFiles, errOutput, fetchMock, mockGetRuntimeForAgent, exec(), execMock, execResponses, kCustom (+44 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.04
Nodes (61): MODELS_BY_PROVIDER, DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType, Capability, ModelDef (+53 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.05
Nodes (63): ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE, HandoffEvent (+55 more)
...
Cohesion: 0.08
Nodes (67): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex() (+59 more)
...
Cohesion: 0.04
Nodes (54): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+46 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.06
Nodes (46): PlanningState, useZoneAActions(), ZoneAActionsState, CodexAuthBanner(), PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef() (+38 more)

### Community 85 - "Conversation Compaction and Fork Pipeline"
Cohesion: 0.08
Nodes (53): getReviewStatusAsync(), setReviewStatus(), setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+45 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.06
Nodes (55): StatusDotStatus, ToolFlash(), ToolFlashProps, deriveDotStatus(), formatDuration(), isErrorStatus(), isReviewerRole(), presenceToStatus() (+47 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.04
Nodes (54): ContextUsage, ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, Conversation (+46 more)
...
Cohesion: 0.07
Nodes (45): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), cleanupTestFiles(), getUniqueId(), id, result (+37 more)

### Community 90 - "Cliproxy Process Lifecycle Management"
Cohesion: 0.05
Nodes (51): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+43 more)
...
Cohesion: 0.05
Nodes (53): ProjectData, parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues() (+45 more)

### Community 94 - "Traefik DNS and Platform Install Skills"
Cohesion: 0.05
Nodes (50): ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent(), classifierIssue() (+42 more)
...
Cohesion: 0.06
Nodes (49): RoundMarker, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE (+41 more)

### Community 97 - "Conversation Panel and Chat Phase Types"
Cohesion: 0.07
Nodes (54): devCommand(), ensureDashboardBundle(), killPort(), readConfig(), checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand() (+46 more)

### Community 98 - "Database Settings and Cost Unit Tests"
Cohesion: 0.06
Nodes (46): ReviewButtonInput, ReviewButtonState, ApiKeysConfig, cn(), IssueCard, IssueCardPriority, IssueCardProps, PRIORITY_ACCENT_CLASSES (+38 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.05
Nodes (54): DeepWipeDialog(), DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, StepRow(), WipeState, getSubStepIcon() (+46 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.07
Nodes (54): details, startRealConversationRoutes(), postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken() (+46 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.07
Nodes (49): continue-state.ts, cont, doc, projectRoot, specsDir, workspace, clearFeedback(), runtime (+41 more)
...
Cohesion: 0.04
Nodes (44): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), EFFORT_LEVELS, EffortLevel, EffortPicker() (+36 more)
...
Cohesion: 0.07
Nodes (47): ComposerFooter(), ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, ForkProgressView() (+39 more)
...
Cohesion: 0.06
Nodes (54): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+46 more)

### Community 111 - "Issue Planning and Tracker Resolution"
Cohesion: 0.05
Nodes (47): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+39 more)
...
Cohesion: 0.04
Nodes (50): cosineSimilarity(), insertEmbedding(), rowToSession(), upsertDiscoveredSession(), chalk, cliRows, dashboardRows, identity() (+42 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.07
Nodes (47): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+39 more)

### Community 115 - "Smee Webhook Proxy Process Management"
Cohesion: 0.07
Nodes (47): checkStuckWorkAgents(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), buildSpecialistBaseCommand(), getProviderAuthMode(), inferMemoryProjectId(), resolveEffectiveHarness(), retrieveSpawnTimeMemoryContext() (+39 more)

### Community 116 - "Merge Set and Review Artifact Creation"
Cohesion: 0.1
Nodes (42): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile() (+34 more)

### Community 117 - "Specialist Agent Prompts and Audit Docs"
Cohesion: 0.05
Nodes (45): traefikDir, CopyConfigOptions, PACKAGE_ROOT, ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR (+37 more)

### Community 118 - "Agent Hook Scripts and Repo Artifact Design"
Cohesion: 0.05
Nodes (49): getTtsDaemonAuthHeaders(), TtsDaemonStatus, HeaderMap, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice() (+41 more)

### Community 119 - "vBRIEF Continue State and Feedback Writing"
Cohesion: 0.06
Nodes (45): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), doneCommand(), DoneOptions, execAsync (+37 more)

### Community 120 - "Caveman Hooks and Workspace Setup"
Cohesion: 0.05
Nodes (41): FeedTabContent(), SessionFeedTab, ConversationFeedRow, fetchConversations(), mapConversationsToFeedEntries(), mapConversationToFeedEntry(), mapHarnessToAgent(), useConversationFeed() (+33 more)
...
Cohesion: 0.04
Nodes (44): CostEvent, appendToWal(), appendToWalSync(), resolveWalDir(), dir, event, eventsDir1, eventsDir2 (+36 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.07
Nodes (43): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setPipelineHandler(), setPipelineHandlerSync(), clearStuckMergeStatuses(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions() (+35 more)
...
Cohesion: 0.05
Nodes (43): oldTimestamp, sentinel, eightDaysAgo, events, makeDb(), payload, r1, r2 (+35 more)
...
Cohesion: 0.06
Nodes (36): formatRelativeTime(), ActivityFeedCard(), ActivityFeedCardProps, BucketSection(), BucketSectionProps, AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState (+28 more)
...
Cohesion: 0.07
Nodes (36): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+28 more)

### Community 134 - "Configuration Documentation"
Cohesion: 0.04
Nodes (43): ConversationList(), client, input, input1, input2, makeClient(), mockConversation, patchCalls (+35 more)
...
Cohesion: 0.05
Nodes (37): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, LAZY_PATTERNS, lazySamples, oldTime, stateFile, agentDir (+29 more)
...
Cohesion: 0.07
Nodes (44): ArtifactCommandDeps, artifactCreateCommand(), ArtifactCreateOptions, artifactOpenCommand(), artifactPublishCommand(), ArtifactPublishOptions, artifactShareCommand(), ArtifactShareOptions (+36 more)
...
Cohesion: 0.09
Nodes (44): writeJsonFile(), ensureSessionContextBriefingFile(), writeMarker(), saveProjectMappings(), appendSystemPromptFile(), drainPendingEvents(), envFor(), getDashboardUrl() (+36 more)

### Community 153 - "Agent Inspect Checkpoint Management"
Cohesion: 0.04
Nodes (36): beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads (+28 more)
...
Cohesion: 0.1
Nodes (37): TurnDiffSummary, buildFileDiffRenderKey(), clearDiffParamsFromUrl(), DiffFilePickerList(), DiffPanel(), DiffPanelProps, DiffThemeType, formatShortTimestamp() (+29 more)
...
Cohesion: 0.12
Nodes (33): RemoteProviderConfig, IssueNotFound, createTracker(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config (+25 more)
...
Cohesion: 0.05
Nodes (40): Codex OAuth Authentication, Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider (+32 more)

### Community 171 - "Model Routing and Specialist Redesign Research"
Cohesion: 0.09
Nodes (44): addCommentBefore(), ALIAS, anchorIsValid(), callVisitor(), clone(), createStringifyContext(), format(), formatPropertyKey() (+36 more)
...
Cohesion: 0.07
Nodes (40): getMemoryStatus(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated (+32 more)
...
Cohesion: 0.07
Nodes (37): bufferToFloat32Array(), BuildConfig, buildDocsIndex(), BuildDocsIndexOptions, BuildDocsIndexResult, createDocsEmbeddingFunction(), createDocsIndexSchema(), DEFAULT_CONFIG (+29 more)
...
Cohesion: 0.11
Nodes (30): isAgentIdleForNudge(), checkStuckAgentRemediation(), evaluateAgent(), evaluateFlywheelOrchestrator(), execFileAsync, firstStuckAt(), hasReadyBeads(), issueIdForAgent() (+22 more)

### Community 198 - "Pi Session Cost Parser"
Cohesion: 0.09
Nodes (35): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+27 more)

### Community 199 - "Cost Session Map and Issue Totals"
Cohesion: 0.06
Nodes (33): entry, { issueId }, { limit }, old, op, ops, recent, result (+25 more)

### Community 200 - "Dashboard WebSocket RPC Client Transport"
Cohesion: 0.08
Nodes (35): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+27 more)
...
Cohesion: 0.09
Nodes (33): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps (+25 more)
...
Cohesion: 0.08
Nodes (27): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+19 more)

### Community 215 - "JSONL Path Resolution and Activity Fetching"
Cohesion: 0.05
Nodes (38): getConversationsConfig(), getConversationsConfigAsync(), resolveConversationWatchDirs(), updateConversationsConfig(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema (+30 more)
...
Cohesion: 0.08
Nodes (31): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsNotFoundError (+23 more)
...
Cohesion: 0.08
Nodes (30): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, DEFAULT_GATES, execAsync (+22 more)
...
Cohesion: 0.1
Nodes (27): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+19 more)

### Community 244 - "Agent Prompt Hardening and Decision Locking"
Cohesion: 0.11
Nodes (32): chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources(), DEFAULT_DOCS_CONFIG, discoverDocsCorpusSources(), discoverMarkdownUnder() (+24 more)
...
Cohesion: 0.1
Nodes (31): buildReviewContext(), BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles() (+23 more)
...
Cohesion: 0.08
Nodes (30): approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifact() (+22 more)
...
Cohesion: 0.11
Nodes (31): getArtifactStatus(), addForbiddenAssetIfNeeded(), addForbiddenScriptOrStylesheetIfNeeded(), ASSET_ATTRS, buildResult(), hasContentSecurityPolicy(), hashArtifactContent(), isAllowedAssetUrl() (+23 more)
...
Cohesion: 0.07
Nodes (27): AVATAR_TONE_CLASSES, avatarInitials(), hashString(), IssueRow(), IssueRowAgent, IssueRowAssignee, IssueRowLedger, IssueRowPriority (+19 more)

### Community 269 - "Conversation Panel and Timeline PRDs"
Cohesion: 0.06
Nodes (31): getAgentRollup(), all, costs, dev1, future, ids, modelX, now (+23 more)
...
Cohesion: 0.12
Nodes (25): backup, backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), createBackup() (+17 more)
...
Cohesion: 0.1
Nodes (25): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, extractAcceptanceCriteria(), criteria (+17 more)

### Community 286 - "Command Deck Redesign Zone Layout"
Cohesion: 0.06
Nodes (26): cache, capped, cpuList, events, lines, memFree, memTotal, result (+18 more)

### Community 287 - "Issue Triage State Persistence"
Cohesion: 0.08
Nodes (25): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+17 more)
...
Cohesion: 0.08
Nodes (22): CleanResult, execAsync, WorkspaceInfo, WorkspaceService, WorkspaceServiceLive, WorkspaceServiceShape, MOCK_PROJECT, mockCreateWorkspace (+14 more)
...
Cohesion: 0.17
Nodes (28): int, build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), extract_embedding(), _get_default_sink_state(), load_base_model() (+20 more)
...
Cohesion: 0.08
Nodes (20): NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv() (+12 more)
...
Cohesion: 0.09
Nodes (24): runMemoryFtsStatement(), ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchHit, MemorySearchRow (+16 more)
...
Cohesion: 0.07
Nodes (25): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+17 more)
...
Cohesion: 0.1
Nodes (23): getLinearClient(), LinearClient, LinearClientError, LinearClientLive, LinearClientOptionalLive, LinearClientShape, LinearComment, LinearIssue (+15 more)
...
Cohesion: 0.11
Nodes (21): execAsync, getAgentJsonlMtime(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestionsPromise(), getAgentWorkspace(), getAgentWorkspacePromise() (+13 more)
...
Cohesion: 0.12
Nodes (25): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+17 more)
...
Cohesion: 0.07
Nodes (23): listener(), electron, electron, IPC, result, wrapped(), result, cb (+15 more)
...
Cohesion: 0.17
Nodes (26): hookCommand(), HookOptions, clearHook(), clearHookSync(), getHook(), getHookDir(), getHookFile(), getHookSync() (+18 more)
...
Cohesion: 0.11
Nodes (23): DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding(), embed(), EmbeddingProviderName (+15 more)
...
Cohesion: 0.09
Nodes (23): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+15 more)
...
Cohesion: 0.14
Nodes (17): getRepoForge(), inferProjectForge(), inferProjectForgeSync(), normalizeForge(), normalizeForgeSync(), resolveConfiguredRepos(), resolveConfiguredReposSync(), ResolvedProjectRepo (+9 more)

### Community 393 - "End-to-End Test Fixture"
Cohesion: 0.18
Nodes (23): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+15 more)

### Community 394 - "Handoff Flow Test Fixture"
Cohesion: 0.14
Nodes (19): after, before, blockers, result, statuses, DEFAULT_STATUS_FILE, clearReviewStatus(), clearReviewStatusSync() (+11 more)

### Community 395 - "Specialist Flow Test Fixture"
Cohesion: 0.09
Nodes (20): entries, deriveRoundMarkers(), TimestampedItem, entries, messages, workLog, markers, MESSAGES (+12 more)
...
Cohesion: 0.14
Nodes (17): beads, capturedArgs, err, mockExecFileFn, mockExecFn, BeadRecord, checkOpenBeads(), checkOpenBeadsPromise() (+9 more)
...
Cohesion: 0.13
Nodes (17): cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector, DockerStatsRaw (+9 more)
...
Cohesion: 0.1
Nodes (17): MetricStripProps, MetricStripTile, MetricDeltaDirection, MetricSignal, MetricTileDelta, MetricTileProps, MetricTileVariant, costSub (+9 more)
...
Cohesion: 0.16
Nodes (16): INFERENCE.md Artifact, getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise(), resolveShadowMode() (+8 more)

### Community 489 - "Community 489"
Cohesion: 0.12
Nodes (21): defaultGetBySlug(), defaultListForWorkspaceOrIssue(), defaultUnshareBySlug(), cancelOlderSemanticSearches(), COALESCED_OPERATIONS, coalescingKey(), DashboardDbOperation, failPendingForLane() (+13 more)
...
Cohesion: 0.19
Nodes (17): getForgeAdapter(), ensureMergeSetForIssue(), ensureMergeSetForIssueSync(), upsertMergeSet(), upsertMergeSetSync(), withRepoArtifactUrl(), withRepoArtifactUrlSync(), withRepoState() (+9 more)
...
Cohesion: 0.2
Nodes (18): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+10 more)
...
Cohesion: 0.11
Nodes (17): exec(), execFile(), execMock, capturedCmds, mockCreateReviewArtifactsForIssue, mockEnsureMergeSetForIssue, mockExecFileFn, mockGetAgentState (+9 more)
...
Cohesion: 0.11
Nodes (16): CI_FAILED_STATUS, ciBlockedStatus, feedbackDir, mockGetAgentRuntimeState, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSendKeysAsync, mockSessionExists (+8 more)
...
Cohesion: 0.2
Nodes (14): ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle(), TITLE_SCHEMA (+6 more)

### Community 604 - "Community 604"
Cohesion: 0.12
Nodes (14): getDailyTrends(), getModelRollup(), getCostsByAgentRoute, getCostsByIssueRoute, getCostsByModelRoute, getCostsExperimentsRoute, getCostsIssueRoute, getCostsStreamRoute (+6 more)
...
Cohesion: 0.13
Nodes (4): collectMail(), collectMailSync(), CLEAR_ON, postPermissionEventRoute
...
Cohesion: 0.2
Nodes (8): first, withFakeHome(), execSyncMock, first, parsed, result, second, settingsPath
...
Cohesion: 0.22
Nodes (7): FeatureRegistryListOptions, FeatureRegistryListPayload, featureRegistryRouteLayer, getFeatureRegistryListPayload(), listFeatureRegistryRoute, calls, entry
...
Cohesion: 0.36
Nodes (7): execAsync, RebaseAllResult, rebaseAndPushRepos(), rebaseAndPushReposPromise(), RebaseError, rebaseOneRepo(), tryResolvePlanningConflicts()
...
Cohesion: 0.28
Nodes (7): BYTE_UNITS, BYTE_UNITS, hist, parseBytes(), parseMemUsage(), parseNetIO(), result
...
Cohesion: 0.39
Nodes (9): Deacon Auto-loads Workspace CLAUDE.md, Planning Agent CLAUDE.md Sources, PLANNING_PROMPT as CLI Message Flag File, Project Overlay CLAUDE.md, Specialist CLAUDE.md Sources (Spawn in DEVROOT), System 1: generateClaudeAI() Settings, System 2: Skills Templates Content, Work Agent CLAUDE.md Sources (+1 more)
...
Cohesion: 0.39
Nodes (6): InlineSparkline(), InlineSparklineProps, ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory()
...
Cohesion: 0.33
Nodes (4): ContextMenuFallbackItem, showContextMenu(), ShowContextMenuOptions, onClick
...
## Knowledge Gaps
- **14130 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14125 more)
...
- **Why does `execAsync` connect `Command Deck Overview Tab UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Community 516`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Panopticon 1.0 Stabilization Audit`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Dashboard Screenshots and Brand Assets`, `Kanban Board Agent Status UI`, `Event Store Domain Services`, `Health Metrics and Settings Pages`, `Workspace Lifecycle and Config`, `Tmux Terminal Session Management`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `Specialist Metadata and Grace Period`, `Feature Context and Planning Session Spawn`, `Project Tree Feature Items UI`, `Review Round Status Badge UI`, `Specialist Completion Tracking`, `Agent Queue Position Calculation`, `Cloister Config Deep Merge`, `Community 559`, `Settings Provider and Model Browser UI`, `Community 573`, `Workspace Teardown and Label Cleanup`, `Pi Session Cost Parser`, `Community 455`, `Rally Feature Planning Hierarchy UX`, `Community 459`, `Activity Panel and VTT Parsing`, `Merge Approval and Idempotency Guard`, `vBRIEF Continue State and Feedback Writing`, `Cliproxy Process Lifecycle Management`, `Multi-Tracker Adapter Implementations`, `Community 861`, `Command Deck Action Registry Pipeline`, `Conversation Panel and Chat Phase Types`, `Community 995`, `Multi-Model Settings E2E Tests`, `File and Editor Open Commands`, `UI and Diff Preferences Persistence`, `Smee Webhook Proxy Process Management`, `Electron Desktop App Docs`, `Community 503`, `Electron Desktop App Launch Scripts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Cloister Config Deep Merge` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `VBrief Plan Builder and Viewer`, `Configuration Documentation`, `Specialist Handoff and Planning Spawn`, `Community 520`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Kanban Board Agent Status UI`, `Health Metrics and Settings Pages`, `Issue Service and Data Fetching`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `Remote Workspace Provider Skills`, `Docker Stats and Container Resources`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `VBrief Beads IO and Plan Finalize`, `Command Deck Issue Workbench UI`, `CLI Install DNS and Dev Commands`, `Cost Event Aggregation and Retention`, `Dashboard App Sidebar and Metrics`, `Specialist Context Digest Generation`, `VBrief Task Readiness and Beads IO`, `Platform Supervisor Startup Lifecycle`, `Issue Tracker Polling Service`, `Git Forge PR and MR Artifact Creation`, `System Health and Spawn Guardrails`, `Diff Panel Rendering and Theming`, `Agent List and Handoff Status UI`, `Dashboard WebSocket RPC Client Transport`, `Merge Queue and App Settings Database`, `CLI Command Taxonomy Reorganization`, `Community 603`, `Event Snapshot Cache and State Reducers`, `Command Deck Action Registry Pipeline`, `Rally Tracker Adapter Tests`, `Issue ID Parsing and Agent Cleanup`, `Issue Tracker Project Resolution`, `PTY Terminal Hub WebSocket Streaming`, `Synced Skills List Fixture`, `Config Migration and Test Agent`, `Smee Webhook Proxy Process Management`, `Merge Set and Review Artifact Creation`, `Specialist Agent Prompts and Audit Docs`, `Community 502`, `Community 631`, `Agent Health Event Persistence`, `Electron Desktop App Launch Scripts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `fetch` connect `VBrief Plan Builder and Viewer` to `Agent Session Lifecycle Management`, `Remote Agent Provisioning on Fly`, `Command Deck Overview Tab UI`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Agent Runtime Spawning`, `JSONL Session File Protection`, `Specialist Handoff and Planning Spawn`, `Agent Snapshot and Event Types`, `Running Agents Cache Service`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Dashboard HTTP Routes and Admin`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `CLI Commands and Runtime Adapters`, `Docker Stats and Container Resources`, `Remote Workspace Provider Skills`, `Cost Calculation and Token Usage`, `VBrief Beads IO and Plan Finalize`, `Project Tree Feature Items UI`, `Review Round Status Badge UI`, `Conversation Service WebSocket RPC`, `CLI Install DNS and Dev Commands`, `Chat Messages Timeline Rendering`, `Community 425`, `Community 426`, `Work Type Routing and Config`, `Community 814`, `Cloister Service Handoff Logging`, `Specialist Context Digest Generation`, `Context History Logging and Search`, `Prerequisite Tool Installation Registry`, `Codex Agent Spawn UI Flow`, `VBrief Task Readiness and Beads IO`, `Project Resolution and Review Enrichment`, `Skills CLI Command Listing`, `Settings Provider and Model Browser UI`, `DAG Visualization and Tasks Panel`, `Community 573`, `Codex Authentication and Credential Management`, `Pi Session Cost Parser`, `Resource Process Discovery and Reporting`, `Merge Queue and App Settings Database`, `Multi-Tool Skill Sync Config Migration`, `Community 461`, `Read Model Enrichment and Agent Snapshots`, `Release Command Parsing Tests`, `Plan DAG Visualization and Beads Panel`, `Effect API Verification Script`, `CLI Command Taxonomy Reorganization`, `Community 600`, `Community 602`, `Caveman Hooks and Workspace Setup`, `Rally Tracker Adapter Tests`, `Desktop Menu and Auto-Updater Lifecycle`, `Issue Tracker Project Resolution`, `PTY Terminal Hub WebSocket Streaming`, `Cloister Watchdog and Merge Validation Docs`, `Config Migration and Test Agent`, `TLDR Daemon State Management`, `Cost Event Storage and WAL Tests`, `vBRIEF Continue State and Feedback Writing`, `Planning Handoff Completion Tests`, `FPP Policy Violation Detection and Nudging`, `TTS Daemon and Pi Extension Supervisor`?**
...
- **Are the 245 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 245 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14130 weakly-connected nodes found - possible documentation gaps or missing edges._
