# Graph Report - feature-pan-1053  (2026-05-12)

## Corpus Check
- 1561 files · ~2,056,401 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21569 nodes · 31950 edges · 1136 communities (1098 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 415 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `324f9a66`
...
## Communities (1136 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (162): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod (+154 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (133): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+125 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (140): autoResumeStoppedWorkAgents(), checkPostReviewCommits(), setAgentStoppedNotifier(), announceMerge(), spawnReviewCoordinatorSession(), getAllSpecialistStatus(), SpecialistStatus, pendingCommand() (+132 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (139): checkApiErrorAgents(), checkFirstCompletionAgents(), checkStuckWorkAgents(), checkThinkingSignatureCorruption(), cleanupOrphanedPlanningSessions(), isAgentIdleForNudge(), nudgeIdleWorkAgentsWithOpenBeads(), patrolWorkAgentResolutions() (+131 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (121): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+113 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (127): checkDeadEndAgents(), checkPendingTestDispatch(), clearStaleCiFeedback(), mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), dispatchTestAgentAndNotify() (+119 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (113): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+105 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): logNonCanonicalStashesOnStartup(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes(), execAsync (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): AutoPresoListener, AutoPresoMode, AutoPresoSession, AutoPresoSnapshot, ExcalidrawElementLike, WarmupStatus, adminRouteLayer, getAdminTldrRoute (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (115): checkMissingReviewStatuses(), cleanupOrphanedReviewSessions(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview() (+107 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (103): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkHeartbeat(), checkMassDeath(), checkReadyForMergeStuck() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (99): reconcileAndCheckIfMerged(), transitionIssueState(), transitionIssueToInReview(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (79): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS (+71 more)
...
Cohesion: 0.04
Nodes (67): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+59 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (81): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, showCommand(), findSpecByIssue() (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (64): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationViewProps (+56 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (70): ContainerFilter, fetchContainerHistory(), fetchResources(), groupResources(), ResourceGroup, ResourcesPanel(), ResourcesPanelProps, mockSnapshot (+62 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (68): Access, withConcurrencyLimit(), PrdLocation, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache (+60 more)
...
Cohesion: 0.04
Nodes (45): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps (+37 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (51): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+43 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (58): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+50 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (63): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+55 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (52): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+44 more)
...
Cohesion: 0.04
Nodes (53): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (50): deleteReviewStatus(), all, blockers, entry, history, result, row, rows (+42 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (50): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, DEFAULT_GATES, execAsync (+42 more)
...
Cohesion: 0.06
Nodes (52): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), FileStatus, ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR (+44 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (52): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+44 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (47): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), badPath, customPlanningDir, dir (+39 more)
...
Cohesion: 0.04
Nodes (45): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+37 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (40): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+32 more)
...
Cohesion: 0.06
Nodes (18): emitter, emitter, onTurn, setupVoiceWebSocket(), createGoogleCloudTranscription(), GoogleCloudTranscription, GoogleStreamingRecognizeResponse, createMoonshineTranscription() (+10 more)
...
Cohesion: 0.08
Nodes (40): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+32 more)
...
Cohesion: 0.05
Nodes (44): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, DomainEvent, AgentOutput (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (34): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+26 more)
...
Cohesion: 0.1
Nodes (39): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+31 more)
...
Cohesion: 0.12
Nodes (38): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker() (+30 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (32): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getShadowStatePath() (+24 more)
...
Cohesion: 0.06
Nodes (33): getWindowDimensionsAsync(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getReauthSessionToken(), invalidateReauthToken() (+25 more)
...
Cohesion: 0.07
Nodes (36): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+28 more)
...
Cohesion: 0.08
Nodes (30): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+22 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (37): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+29 more)
...
Cohesion: 0.1
Nodes (35): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+27 more)
...
Cohesion: 0.09
Nodes (28): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, createBeadsFromVBrief(), CreateBeadsResult (+20 more)
...
Cohesion: 0.08
Nodes (31): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+23 more)

### Community 167 - "Community 167"
Cohesion: 0.06
Nodes (28): DEFAULTS, UIPreferences, useUIPreferences(), getEffectiveModelId(), AGENT_CATEGORIES, AgentCategory, AgentDef, DEFAULT_VOICE_HARDWARE_SETTINGS (+20 more)
...
Cohesion: 0.12
Nodes (26): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+18 more)
...
Cohesion: 0.09
Nodes (24): cleanupOrphanReviewerSessions(), getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, BuildReviewerNodesOptions (+16 more)
...
Cohesion: 0.13
Nodes (23): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+15 more)
...
Cohesion: 0.14
Nodes (21): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions (+13 more)
...
Cohesion: 0.13
Nodes (14): daemonRegistry, ensureTldrStateDir(), execAsync, getStateFilePath(), hashWorkspacePath(), listTldrDaemonServices(), readStateFile(), TLDR_STATE_DIR (+6 more)
...
Cohesion: 0.2
Nodes (21): assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths(), getAttachmentCache(), getAttachmentCacheKey() (+13 more)
...
Cohesion: 0.13
Nodes (17): after, before, cfg, compose, ph, result, createWorkspacePlaceholders(), DevcontainerRenderOptions (+9 more)

### Community 334 - "Community 334"
Cohesion: 0.29
Nodes (21): cleanupLabelsGitHub(), cleanupMergedLabels(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync (+13 more)
...
Cohesion: 0.12
Nodes (20): approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), deepWipe(), destructiveResetWorkflow(), archiveIdx (+12 more)

### Community 351 - "Community 351"
Cohesion: 0.15
Nodes (17): extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result, extractIssuePrefix(), GitHubIssueResolution (+9 more)
...
Cohesion: 0.11
Nodes (18): cb, cmdArgs, cmdStr, inline, issueCommentsJson, linearGetComments, linearGetIssueId, mockExec (+10 more)
...
Cohesion: 0.2
Nodes (17): APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+9 more)
...
## Knowledge Gaps
- **11465 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11460 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 2`, `Community 130`, `Community 6`, `Community 648`, `Community 9`, `Community 651`, `Community 12`, `Community 13`, `Community 14`, `Community 143`, `Community 400`, `Community 146`, `Community 19`, `Community 20`, `Community 532`, `Community 22`, `Community 23`, `Community 25`, `Community 154`, `Community 26`, `Community 30`, `Community 31`, `Community 167`, `Community 40`, `Community 43`, `Community 559`, `Community 48`, `Community 177`, `Community 560`, `Community 47`, `Community 52`, `Community 821`, `Community 68`, `Community 70`, `Community 77`, `Community 80`, `Community 336`, `Community 597`, `Community 598`, `Community 98`, `Community 103`, `Community 494`, `Community 756`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 17`, `Community 3`, `Community 13`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 25` to `Community 196`, `Community 38`, `Community 264`, `Community 11`, `Community 108`, `Community 13`, `Community 556`, `Community 17`, `Community 52`, `Community 119`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Are the 158 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 158 INFERRED edges - model-reasoned connections that need verification._
