...
## Corpus Check
- 1573 files · ~2,069,396 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22391 nodes · 33596 edges · 1168 communities (1128 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8185324`
...
1. `fetch` - 167 edges
2. `resolveProjectFromIssue()` - 110 edges
...
## Communities (1168 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (146): ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+138 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (170): cleanupSpawnAndOrphanedStashes(), clearStaleCiFeedback(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput() (+162 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (171): checkStuckWorkAgents(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (138): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+130 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (142): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+134 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (147): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+139 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (104): PlanningState, ZoneAActionsState, ArtifactLinks(), ArtifactLinksProps, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps (+96 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (121): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+113 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (111): shouldAutoStart(), setAgentStoppedNotifier(), emitCoordinatorDied(), after, before, blockers, result, statuses (+103 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (81): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, createHandoffEvent(), ensureLogDir() (+73 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (99): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+91 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (102): readCavemanVariant(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration(), clearSessionId(), countContextTokens(), DEFAULT_SPECIALISTS (+94 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (82): parsePiSession(), waitForPiAgentReady(), writePiAgentPrompt(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (81): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+73 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (92): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (88): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (78): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+70 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (83): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, showCommand(), deleteContinueFile() (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (79): withConcurrencyLimit(), PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync (+71 more)
...
Cohesion: 0.04
Nodes (64): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+56 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (70): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+62 more)
...
Cohesion: 0.03
Nodes (77): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+69 more)
...
Cohesion: 0.09
Nodes (75): extractNumber(), archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), applyClosedOutLabel() (+67 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (75): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+67 more)
...
Cohesion: 0.03
Nodes (63): computeAgentEnrichment(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getActivity(), getAgentRuntimeStateAsync(), saveSessionId() (+55 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (63): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), loadPinState(), PHASE_CHIP_COLORS (+55 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (60): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+52 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (70): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+62 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (30): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+22 more)
...
Cohesion: 0.04
Nodes (58): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, badPath, customPlanningDir, dir (+50 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (58): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (61): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+53 more)
...
Cohesion: 0.03
Nodes (46): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+38 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (50): ConversationMutations, AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem() (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (60): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+52 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (52): contextCommand(), ContextOptions, cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand() (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (48): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+40 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (51): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), FileStatus, ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR (+43 more)
...
Cohesion: 0.08
Nodes (48): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+40 more)
...
Cohesion: 0.05
Nodes (49): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+41 more)
...
Cohesion: 0.06
Nodes (37): DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader() (+29 more)
...
Cohesion: 0.05
Nodes (45): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCavemanExperimentData(), getCostForIssueFromDb() (+37 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (46): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv() (+38 more)
...
Cohesion: 0.05
Nodes (44): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings() (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (44): AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues. (+36 more)
...
Cohesion: 0.09
Nodes (42): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry, readManifest() (+34 more)
...
Cohesion: 0.07
Nodes (35): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+27 more)
...
Cohesion: 0.09
Nodes (38): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+30 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (39): CodexAuthStatus, authStatusVariant(), AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, displayModelRef(), fetchAvailableModels(), fetchSettings() (+31 more)
...
Cohesion: 0.08
Nodes (40): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive() (+32 more)
...
Cohesion: 0.07
Nodes (32): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+24 more)
...
Cohesion: 0.08
Nodes (35): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+27 more)
...
Cohesion: 0.08
Nodes (35): Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds() (+27 more)

### Community 108 - "Community 108"
Cohesion: 0.08
Nodes (37): Access, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+29 more)
...
Cohesion: 0.09
Nodes (32): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+24 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (25): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffWorkerPoolProvider() (+17 more)
...
Cohesion: 0.08
Nodes (31): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, deepMerge() (+23 more)
...
Cohesion: 0.07
Nodes (25): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+17 more)
...
Cohesion: 0.09
Nodes (31): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+23 more)
...
Cohesion: 0.06
Nodes (29): CostBreakdownData, CostBreakdownModal(), CostBreakdownModalProps, formatCost(), formatTokens(), ModelBreakdown, STAGE_CONFIG, StageBreakdown (+21 more)
...
Cohesion: 0.14
Nodes (25): config, originalEnv, tracker, TrackerConfig, Comment, Issue, IssueFilters, IssueNotFoundError (+17 more)
...
Cohesion: 0.12
Nodes (26): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getShadowStatePath() (+18 more)
...
Cohesion: 0.09
Nodes (31): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+23 more)
...
Cohesion: 0.09
Nodes (26): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+18 more)
...
Cohesion: 0.14
Nodes (31): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart(), findLocalWorkspace(), findProjectRoot() (+23 more)
...
Cohesion: 0.11
Nodes (27): InspectContext, onInspectComplete(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getDiffBase(), getDiffStats() (+19 more)
...
Cohesion: 0.1
Nodes (26): ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), PipelineState, ZoneAInput (+18 more)
...
Cohesion: 0.14
Nodes (28): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState() (+20 more)

### Community 221 - "Community 221"
Cohesion: 0.15
Nodes (27): Conversation, listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir() (+19 more)
...
Cohesion: 0.07
Nodes (19): createCall, dbError, deleteCalls, doc, existingBeads, expectedPrefix, initCall, metadata (+11 more)
...
Cohesion: 0.1
Nodes (21): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+13 more)
...
Cohesion: 0.19
Nodes (24): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), clearHook(), collectMail(), generateFixedPointPrompt(), getHook() (+16 more)

### Community 244 - "Community 244"
Cohesion: 0.15
Nodes (12): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+4 more)
...
Cohesion: 0.11
Nodes (24): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth() (+16 more)

### Community 264 - "Community 264"
Cohesion: 0.09
Nodes (18): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+10 more)
...
Cohesion: 0.1
Nodes (14): getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller, websocketRpcRouteLayer, EditorLaunch, execAsync (+6 more)
...
Cohesion: 0.17
Nodes (18): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+10 more)
...
Cohesion: 0.09
Nodes (18): dir, event, eventsDir1, eventsDir2, line, lines, parsed, repo1 (+10 more)

### Community 334 - "Community 334"
Cohesion: 0.23
Nodes (21): destroyRemoteWorkspace(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+13 more)

### Community 335 - "Community 335"
Cohesion: 0.19
Nodes (17): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), clearPendingCodexReauthSession(), clearPendingCodexSpawn() (+9 more)
...
Cohesion: 0.1
Nodes (19): branch, branchMatch, buffer, cavemanVariant, cost, entry, input, lines (+11 more)
...
Cohesion: 0.11
Nodes (18): wipeCommand(), cancelIssueWorkflow(), deepWipe(), destructiveResetWorkflow(), resetToTodo(), archiveIdx, beadsDir, branchStep (+10 more)
...
Cohesion: 0.18
Nodes (17): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig, LauncherHarness (+9 more)
...
Cohesion: 0.11
Nodes (19): code:json ({), code:bash (# 1. Login to npm (one-time)), code:bash (# Bump version (follows semver)), code:bash (# One-shot (no global install needed)), code:bash (# Tag beta releases), code:yaml (# .github/workflows/publish.yml), code:yaml (# .github/workflows/rotate-npm-token.yml), code:bash (echo "//registry.npmjs.org/:_authToken=YOUR_TOKEN" >> ~/.npm) (+11 more)
...
Cohesion: 0.16
Nodes (12): checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, mockSpawnRun (+4 more)
...
Cohesion: 0.12
Nodes (15): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), BRIDGE_ENTRY, entry, exitPromise, forwarder, lines (+7 more)
...
Cohesion: 0.22
Nodes (15): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec(), writeSpec() (+7 more)
...
Cohesion: 0.19
Nodes (11): FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType, ExecResult, RemoteProvider (+3 more)
...
Cohesion: 0.15
Nodes (13): stopSmeeClient(), delay, errorSpy, logSpy, mockExistsSync, mockLoadConfig, mockReadFileSync, mockStart (+5 more)

### Community 470 - "Community 470"
Cohesion: 0.21
Nodes (11): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeOptions, ShadowModeResult, id (+3 more)
...
Cohesion: 0.16
Nodes (11): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+3 more)
...
Cohesion: 0.25
Nodes (11): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), createBackup(), createBackupTimestamp(), listBackups() (+3 more)
...
Cohesion: 0.16
Nodes (9): createFlyApiClient(), FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine (+1 more)
...
Cohesion: 0.16
Nodes (7): createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, resetTransport(), RpcClientFactory, SubscribeOptions, WsTransport
...
Cohesion: 0.15
Nodes (12): Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071), code:bash (pan plan finalize), Finalizing (`pan plan finalize`), Panopticon Planning Lifecycle, Related commands (+4 more)
...
Cohesion: 0.17
Nodes (10): MessagesTimeline, divider, dividers, markers, messages, round1, round2, round3 (+2 more)
...
Cohesion: 0.27
Nodes (9): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), bead, beads (+1 more)
...
Cohesion: 0.31
Nodes (9): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+1 more)
...
Cohesion: 0.32
Nodes (5): computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult, items, result
...
Cohesion: 0.33
Nodes (5): deriveRoundMarkers(), TimestampedItem, markers, MESSAGES, meta
...
Cohesion: 0.29
Nodes (6): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09 (late), Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.5
Nodes (4): code:block126 (┌─────────────────┐    ┌─────────────────┐    ┌─────────────), code:block127 (┌──────────────────────────────────────────────────────────┐), code:yaml (permissions:), Supply Chain Security (npm Provenance)
...
## Knowledge Gaps
- **11889 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11884 more)
...
- **Why does `fetch` connect `Community 4` to `Community 768`, `Community 0`, `Community 385`, `Community 131`, `Community 3`, `Community 5`, `Community 8`, `Community 652`, `Community 13`, `Community 14`, `Community 271`, `Community 653`, `Community 17`, `Community 20`, `Community 148`, `Community 21`, `Community 150`, `Community 22`, `Community 25`, `Community 538`, `Community 539`, `Community 156`, `Community 33`, `Community 34`, `Community 36`, `Community 43`, `Community 49`, `Community 562`, `Community 178`, `Community 50`, `Community 53`, `Community 54`, `Community 566`, `Community 56`, `Community 335`, `Community 88`, `Community 220`, `Community 607`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 81` to `Community 10`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 22` to `Community 1045`, `Community 535`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11889 weakly-connected nodes found - possible documentation gaps or missing edges._
