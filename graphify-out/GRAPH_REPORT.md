...
## Corpus Check
- 1546 files · ~2,047,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21872 nodes · 32557 edges · 1150 communities (1115 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 438 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d54b13e`
...
6. `listSessionNamesAsync()` - 51 edges
...
## Communities (1150 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (180): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, BulkAgentWarningDialogProps, DetailPanelLayout(), DetailPanelLayoutProps (+172 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (166): nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+158 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (128): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+120 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (120): checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), buildProviderExportLines() (+112 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (110): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+102 more)
...
Cohesion: 0.02
Nodes (94): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (91): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+83 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (81): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (80): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+72 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (89): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+81 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (99): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents(), checkHeartbeat() (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (71): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+63 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (93): autoResumeStoppedWorkAgents(), checkFailedMergeRetry(), execFileAsync, reconcileStaleMergeStatus(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+85 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (87): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+79 more)
...
Cohesion: 0.03
Nodes (71): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext, serializeHandoffContext() (+63 more)
...
Cohesion: 0.04
Nodes (62): checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename (+54 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (69): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+61 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (61): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+53 more)
...
Cohesion: 0.04
Nodes (62): generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES (+54 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (61): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (60): loadCloisterConfig(), cleanupStaleAgentState(), { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, getSetting() (+52 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (60): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+52 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (54): getReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, getAgentRuntimeStateAsync(), snapshotToRuntimeState(), withConcurrencyLimit(), listSessionNamesAsync(), fetchActivityDataWithContext() (+46 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (61): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+53 more)
...
Cohesion: 0.04
Nodes (56): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+48 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (47): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL (+39 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (57): showCommand(), findSpecByIssue(), updateSpecStatus(), next, path, read, state, after (+49 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (50): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), beadsDir, doc, result (+42 more)
...
Cohesion: 0.04
Nodes (42): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+34 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (47): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+39 more)
...
Cohesion: 0.05
Nodes (55): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), dropStash(), execAsync (+47 more)
...
Cohesion: 0.06
Nodes (44): isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefDocument, VBriefEdge, VBriefEdgeType, VBriefItem, VBriefItemStatus (+36 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (51): parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (50): FileStatus, AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR (+42 more)
...
Cohesion: 0.1
Nodes (53): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+45 more)

### Community 48 - "Community 48"
Cohesion: 0.09
Nodes (48): calls, { mockExecAsync }, opts, ARCHIVES_DIR, archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd() (+40 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (48): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+40 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (51): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+43 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (48): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput() (+40 more)
...
Cohesion: 0.07
Nodes (38): PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec() (+30 more)
...
Cohesion: 0.06
Nodes (43): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+35 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (43): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+35 more)
...
Cohesion: 0.08
Nodes (38): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession() (+30 more)
...
Cohesion: 0.06
Nodes (34): setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData (+26 more)

### Community 99 - "Community 99"
Cohesion: 0.07
Nodes (30): RoundMarker, fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR (+22 more)
...
Cohesion: 0.07
Nodes (30): firstSessionPanel, firstWorkbench, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps (+22 more)
...
Cohesion: 0.06
Nodes (34): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+26 more)
...
Cohesion: 0.1
Nodes (34): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+26 more)
...
Cohesion: 0.09
Nodes (28): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+20 more)
...
Cohesion: 0.13
Nodes (31): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+23 more)
...
Cohesion: 0.12
Nodes (27): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getShadowStatePath() (+19 more)
...
Cohesion: 0.08
Nodes (26): buildACLookupByTitle(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), WorkAgentPromptContext, criteria, doc, result (+18 more)
...
Cohesion: 0.1
Nodes (27): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+19 more)
...
Cohesion: 0.11
Nodes (29): wipeCommand(), archivePlanning(), closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close() (+21 more)
...
Cohesion: 0.11
Nodes (26): clearFeedbackFiles(), inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir() (+18 more)
...
Cohesion: 0.1
Nodes (27): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+19 more)
...
Cohesion: 0.12
Nodes (26): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig (+18 more)
...
Cohesion: 0.15
Nodes (27): buildWorkAgentPrompt(), readPlanningContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace() (+19 more)
...
Cohesion: 0.14
Nodes (27): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+19 more)

### Community 236 - "Community 236"
Cohesion: 0.11
Nodes (19): configShadowCommand(), ShadowOptions, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus() (+11 more)
...
Cohesion: 0.14
Nodes (22): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+14 more)
...
Cohesion: 0.12
Nodes (16): getTrackerContext(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress() (+8 more)
...
Cohesion: 0.24
Nodes (20): createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs(), isRemoteAgentRunning() (+12 more)
...
Cohesion: 0.18
Nodes (17): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+9 more)

### Community 392 - "Community 392"
Cohesion: 0.21
Nodes (15): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractPrefix() (+7 more)
...
Cohesion: 0.16
Nodes (13): createTerminalWindow(), createWindow(), iconPath, isDevelopment, resolveServerEntry(), resolveWindowUrl(), ROOT_DIR, terminalWindows (+5 more)
...
Cohesion: 0.27
Nodes (13): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRunLog(), getRunLogPath() (+5 more)
...
Cohesion: 0.22
Nodes (10): dispatchMenuAction(), showOrCreateWindow(), buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, checkForUpdates() (+2 more)
...
Cohesion: 0.22
Nodes (8): EditorLaunch, execAsync, getFileManagerCommand(), isCommandAvailable(), PanOpen, PanOpenLive, PanOpenShape, resolveEditorLaunch()
...
Cohesion: 0.2
Nodes (8): content, d, existingDir, lines, oldDir, result, skillDir, migratePanopticonToPan()
...
Cohesion: 0.25
Nodes (5): DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState
...
Cohesion: 0.29
Nodes (5): IPC, resolveResourcePath(), initializeNotifications(), registerNotificationHandlers(), NotificationEventType
...
Cohesion: 0.29
Nodes (5): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), SystemHealthSnapshot, decision
...
## Knowledge Gaps
- **11636 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11631 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 129`, `Community 2`, `Community 130`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 531`, `Community 147`, `Community 21`, `Community 538`, `Community 539`, `Community 155`, `Community 36`, `Community 164`, `Community 37`, `Community 41`, `Community 43`, `Community 427`, `Community 812`, `Community 46`, `Community 50`, `Community 52`, `Community 53`, `Community 183`, `Community 55`, `Community 57`, `Community 60`, `Community 572`, `Community 62`, `Community 319`, `Community 64`, `Community 63`, `Community 68`, `Community 205`, `Community 80`, `Community 606`, `Community 235`, `Community 763`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 158` to `Community 17`, `Community 6`, `Community 1`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 812` to `Community 109`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11636 weakly-connected nodes found - possible documentation gaps or missing edges._
