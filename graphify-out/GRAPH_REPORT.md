...
## Corpus Check
- 1933 files · ~3,155,729 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27650 nodes · 43476 edges · 1293 communities (1239 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 808 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3674db0e`
...
## Communities (1293 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (182): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+174 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (158): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+150 more)
...
Cohesion: 0.04
Nodes (156): monitorReviewConvoySignals(), spawnInspectAgentPromise(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand() (+148 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (133): captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (117): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), MessagesTimeline, ContainerDetailPanel(), ContainerDetailPanelProps (+109 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (105): DRAWER_TABS, cn(), comparePipelineIssues(), filterMatchesShipModifier(), isBlockedFromMerge(), isOpenMergeRequest(), PHASE_FILTERS, PHASES (+97 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (114): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, isStale(), PHASE_CONFIG, recentActionObservations() (+106 more)
...
Cohesion: 0.02
Nodes (108): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+100 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (115): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+107 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (91): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+83 more)
...
Cohesion: 0.03
Nodes (104): transitionIssueToVerifyingOnMain(), getCavemanExperimentData(), httpHandler(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions (+96 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (108): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+100 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (74): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), ensureLogDir() (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (79): isRunningAgent(), PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (93): confirmHostOverride(), resumeCommand(), ResumeOptions, getRuntimeSnapshot(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror() (+85 more)
...
Cohesion: 0.02
Nodes (87): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (87): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+79 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (81): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+73 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (86): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+78 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (84): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+76 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (85): recordAutoCloseOutFailure(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+77 more)
...
Cohesion: 0.03
Nodes (89): getTtsDaemonAuthHeaders(), startTtsDaemon(), TtsDaemonStatus, buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram (+81 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (70): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow (+62 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (80): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocumentFromString() (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (64): TurnDiffSummary, DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffPanel(), DiffPanelProps (+56 more)
...
Cohesion: 0.04
Nodes (81): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), AutoMergeConfig, backupGlobalConfig(), CavemanConfig, CavemanMode (+73 more)
...
Cohesion: 0.04
Nodes (69): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+61 more)
...
Cohesion: 0.05
Nodes (65): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, encodeBeadsVersion() (+57 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (66): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, writeStoryFeatureContext(), getProjectPanPaths(), completePlanningArtifacts() (+58 more)
...
Cohesion: 0.04
Nodes (61): VerifyingOnMainBadge(), WorkspaceStatusOverviewProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload() (+53 more)
...
Cohesion: 0.05
Nodes (64): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+56 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (61): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+53 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (56): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+48 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (61): generateContextDigest(), regenerateContextDigestPromise(), scheduleDigestGeneration(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+53 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (49): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+41 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (65): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), RawFilter, SearchMode, SearchQuery (+57 more)
...
Cohesion: 0.04
Nodes (55): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, Handler, PipelineEvent, setPipelineHandlerSync(), ensureManagedTmuxContextOnce(), emitResetMarkerCreated() (+47 more)
...
Cohesion: 0.03
Nodes (44): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, getKimiAnthropicBaseUrl(), ProviderAuthType, ProviderName, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR (+36 more)
...
Cohesion: 0.05
Nodes (56): getTrackerContext(), AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand() (+48 more)
...
Cohesion: 0.05
Nodes (50): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), createConfiguredClaudeApi() (+42 more)
...
Cohesion: 0.04
Nodes (56): diffPatchSinceCommit(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES (+48 more)
...
Cohesion: 0.05
Nodes (57): getCostsForIssueSync(), Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+49 more)
...
Cohesion: 0.07
Nodes (47): destroyRemoteWorkspace(), loadConfigSync(), saveConfigSync(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p (+39 more)
...
Cohesion: 0.06
Nodes (51): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+43 more)
...
Cohesion: 0.06
Nodes (37): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+29 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (42): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), writeFeedbackFile(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+34 more)
...
Cohesion: 0.06
Nodes (44): parseContainerServiceNameSync(), parseIssueIdFromTextSync(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh() (+36 more)
...
Cohesion: 0.05
Nodes (40): buildCorrelationMapSync(), CorrelationResult, scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget() (+32 more)
...
Cohesion: 0.06
Nodes (34): RestartLockHandle, allowedOrigin(), applyCors(), heldRestartMessage(), LOG_FILE, platformConfig, sendJson(), server (+26 more)

### Community 109 - "Community 109"
Cohesion: 0.08
Nodes (43): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+35 more)
...
Cohesion: 0.09
Nodes (44): loadReportFlywheelStatus(), startFlywheelRun(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRunForDashboard(), abortFlywheelRun(), clearFlywheelGate(), decodeFlywheelRunId (+36 more)

### Community 115 - "Community 115"
Cohesion: 0.05
Nodes (35): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, searchFts(), EnrichmentResponse (+27 more)
...
Cohesion: 0.07
Nodes (34): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+26 more)
...
Cohesion: 0.08
Nodes (41): EnqueueStatusRollup, findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup(), pendingTurnFileName(), pendingTurnRangeKey(), readPendingTurns() (+33 more)
...
Cohesion: 0.09
Nodes (33): registerTestCommands(), runCommand(), RunOptions, workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, destroyCommand(), updateCommand(), useConfigCommand() (+25 more)

### Community 144 - "Community 144"
Cohesion: 0.07
Nodes (34): contextDiffCommand(), renderLayerForHarness(), assembleWorkspaceContext(), claude, out, pf, WorkspaceContextInput, HARNESS_MARKERS (+26 more)

### Community 145 - "Community 145"
Cohesion: 0.07
Nodes (33): parseContainerServiceName(), parseIssueIdFromText(), useAvailableModels(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu() (+25 more)
...
Cohesion: 0.07
Nodes (35): inferMemoryProjectId(), retrieveSpawnTimeMemoryContext(), resolveModel(), canUseHarnessSync(), canUseModelWithAuthSync(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK (+27 more)
...
Cohesion: 0.08
Nodes (36): doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending, queueAutoCommit() (+28 more)

### Community 159 - "Community 159"
Cohesion: 0.11
Nodes (30): AnthropicExtractionProvider, AnthropicCompatibleResponse, CliproxyExtractionProvider, FetchFn, extractWithProviderPolicy(), getTodayMemoryExtractionSpendUsd(), MemoryExtractionPolicyDeps, MemoryExtractionPolicyOptions (+22 more)
...
Cohesion: 0.09
Nodes (35): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+27 more)

### Community 166 - "Community 166"
Cohesion: 0.09
Nodes (30): calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync, { mockExecAsync } (+22 more)
...
Cohesion: 0.11
Nodes (34): contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+26 more)
...
Cohesion: 0.08
Nodes (31): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration() (+23 more)
...
Cohesion: 0.09
Nodes (32): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+24 more)
...
Cohesion: 0.1
Nodes (27): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), IssueStats (+19 more)
...
Cohesion: 0.07
Nodes (23): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), SessionUsage, emptyUsage() (+15 more)
...
Cohesion: 0.1
Nodes (7): getActiveSessionModelSync(), getAllSessionFilesSync(), getProjectDirsSync(), getSessionFilesSync(), parseClaudeSessionSync(), ClaudeCodeRuntime, ClaudeCodeRuntimeSync
...
Cohesion: 0.12
Nodes (28): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsDaemonConfigs(), resolveAndSpeak(), speakTts(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+20 more)
...
Cohesion: 0.12
Nodes (30): FlywheelScope, loadConfigNoMigration(), RoleEffort, runDashboardDbJob(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync (+22 more)
...
Cohesion: 0.16
Nodes (31): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl() (+23 more)
...
Cohesion: 0.14
Nodes (27): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+19 more)
...
Cohesion: 0.1
Nodes (22): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+14 more)
...
Cohesion: 0.13
Nodes (26): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigestPromise(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+18 more)
...
Cohesion: 0.1
Nodes (24): autoRevertMerge(), autoRevertMergePromise(), execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation() (+16 more)
...
Cohesion: 0.11
Nodes (16): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose (+8 more)
...
Cohesion: 0.08
Nodes (23): CostEntry, DEFAULT_PRICING, getPricingSync(), ModelPricing, anthropicModels, cost, entries, haikuPricing (+15 more)
...
Cohesion: 0.13
Nodes (18): recoverUnhealthyTestStack(), workspaceRebuildCommand(), tempDirs, workspace, DevcontainerRenderResult, EnsureDevcontainerInput, EnsureDevcontainerResult, ensureDevcontainerSync() (+10 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, Cleanup After Shutdown, code:bash (# Stop all Panopticon services), code:bash (# Method 1: Separate commands), code:bash (# Clean up log files), code:env (# Graceful shutdown timeout (seconds)), Configuration Options, More Information (+8 more)
...
Cohesion: 0.17
Nodes (9): pickBestSession(), caret, fetchMock, onCleanupOrphanedResources, onSelect, onSelectSession, placeholder, sessions (+1 more)
...
Cohesion: 0.2
Nodes (7): baseFlywheelStatus, consoleErrors, metrics, MockWebSocket, status, statusPane, suggestionsSection
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 1027`, `Community 4`, `Community 5`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 20`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 43`, `Community 44`, `Community 47`, `Community 48`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 572`, `Community 62`, `Community 61`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 74`, `Community 76`, `Community 77`, `Community 82`, `Community 83`, `Community 85`, `Community 86`, `Community 89`, `Community 90`, `Community 93`, `Community 94`, `Community 96`, `Community 100`, `Community 102`, `Community 103`, `Community 108`, `Community 109`, `Community 629`, `Community 121`, `Community 129`, `Community 132`, `Community 134`, `Community 136`, `Community 152`, `Community 155`, `Community 181`, `Community 184`, `Community 202`, `Community 210`, `Community 227`, `Community 745`, `Community 748`, `Community 749`, `Community 239`, `Community 240`, `Community 250`, `Community 264`, `Community 274`, `Community 787`, `Community 277`, `Community 792`, `Community 284`, `Community 285`, `Community 299`, `Community 302`, `Community 313`, `Community 314`, `Community 333`, `Community 341`, `Community 349`, `Community 872`, `Community 366`, `Community 368`, `Community 371`, `Community 398`, `Community 400`, `Community 424`, `Community 455`, `Community 472`, `Community 483`, `Community 490`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 3`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 18`, `Community 276`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 154`, `Community 27`, `Community 285`, `Community 30`, `Community 798`, `Community 160`, `Community 36`, `Community 38`, `Community 45`, `Community 182`, `Community 55`, `Community 54`, `Community 57`, `Community 59`, `Community 316`, `Community 61`, `Community 62`, `Community 64`, `Community 1096`, `Community 201`, `Community 202`, `Community 76`, `Community 210`, `Community 211`, `Community 469`, `Community 90`, `Community 350`, `Community 97`, `Community 226`, `Community 228`, `Community 741`, `Community 617`, `Community 625`, `Community 151`, `Community 250`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 36` to `Community 576`, `Community 1`, `Community 34`, `Community 134`, `Community 38`, `Community 10`, `Community 43`, `Community 47`, `Community 337`, `Community 209`, `Community 21`, `Community 27`, `Community 60`, `Community 31`?**
