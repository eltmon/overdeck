...
## Corpus Check
- 1745 files · ~2,325,999 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23897 nodes · 36623 edges · 1201 communities (1155 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 510 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c261184e`
...
## Communities (1201 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (202): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), ACTIVE_STATUS_PATTERNS, addLog() (+194 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (183): loadDeaconWithResumeMock(), detectHandoffMethod(), HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn(), sleep() (+175 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (163): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+155 more)
...
Cohesion: 0.03
Nodes (127): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+119 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (130): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (116): captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+108 more)
...
Cohesion: 0.04
Nodes (111): embedAction(), confirmCost(), enrichAction(), formatCost(), scanAction(), scan(), ScanProgress, RawFilter (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (109): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+101 more)
...
Cohesion: 0.02
Nodes (103): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+95 more)
...
Cohesion: 0.02
Nodes (93): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+85 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (76): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (91): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), DEFAULTS (+83 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (93): pendingCommand(), after, before, blockers, result, statuses, after, row (+85 more)
...
Cohesion: 0.02
Nodes (78): CopyConfigOptions, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+70 more)
...
Cohesion: 0.04
Nodes (74): readCavemanVariant(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (74): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+66 more)
...
Cohesion: 0.03
Nodes (76): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (78): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+70 more)
...
Cohesion: 0.03
Nodes (75): resetPostMergeState(), agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache() (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (56): updateConversationTitle(), AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState (+48 more)
...
Cohesion: 0.04
Nodes (60): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), closeDatabase(), getDatabasePath() (+52 more)
...
Cohesion: 0.05
Nodes (55): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContinue(), badPath, doc, draftPath (+47 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (60): startPostLaunchSidecars(), startSidecars(), HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning (+52 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (56): projectAddCommand(), syncDnsToWindows(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch() (+48 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (48): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+40 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (48): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, result, ActivityContext, awaitingInputFromProjection() (+40 more)
...
Cohesion: 0.06
Nodes (49): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, installGitHooks() (+41 more)
...
Cohesion: 0.04
Nodes (38): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, fetchMock (+30 more)
...
Cohesion: 0.05
Nodes (47): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions (+39 more)
...
Cohesion: 0.07
Nodes (50): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+42 more)
...
Cohesion: 0.07
Nodes (23): importTrackerConfig(), loadReviewStatusesForIssues(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+15 more)
...
Cohesion: 0.04
Nodes (47): ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema, EnrichBodySchema (+39 more)

### Community 72 - "Community 72"
Cohesion: 0.12
Nodes (45): ARCHIVES_DIR, archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+37 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (42): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+34 more)
...
Cohesion: 0.06
Nodes (41): CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute, ExtractEmbeddingDeps, ExtractEmbeddingInput (+33 more)

### Community 90 - "Community 90"
Cohesion: 0.07
Nodes (43): Access, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats(), getIndexStats(), stat (+35 more)
...
Cohesion: 0.09
Nodes (44): LOGS_DIR, acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb() (+36 more)
...
Cohesion: 0.08
Nodes (40): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, ListOptions, projectInitCommand(), projectListCommand(), projectRemoveCommand() (+32 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (33): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+25 more)
...
Cohesion: 0.08
Nodes (36): calls, { mockExecAsync }, opts, archivePlanning(), compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+28 more)
...
Cohesion: 0.07
Nodes (33): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), createConfiguredClaudeApi() (+25 more)
...
Cohesion: 0.09
Nodes (34): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual() (+26 more)
...
Cohesion: 0.08
Nodes (31): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), resolveProjectConfig() (+23 more)
...
Cohesion: 0.11
Nodes (35): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote() (+27 more)
...
Cohesion: 0.08
Nodes (28): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+20 more)
...
Cohesion: 0.07
Nodes (31): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+23 more)
...
Cohesion: 0.11
Nodes (30): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync(), uniqueTmpPath() (+22 more)
...
Cohesion: 0.09
Nodes (29): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceLive, ReadModelServiceShape (+21 more)
...
Cohesion: 0.09
Nodes (27): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+19 more)
...
Cohesion: 0.2
Nodes (26): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+18 more)
...
Cohesion: 0.13
Nodes (22): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+14 more)
...
Cohesion: 0.17
Nodes (20): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), CloseIssueOptions (+12 more)
...
Cohesion: 0.1
Nodes (14): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession(), getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer (+6 more)
...
Cohesion: 0.23
Nodes (21): createFlyProvider(), getRemoteProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+13 more)
...
Cohesion: 0.23
Nodes (14): startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent(), optionalString() (+6 more)
...
Cohesion: 0.22
Nodes (7): diffsRouteLayer, getDiffsRoute, getFullDiffRoute, getTurnDiffRoute, getVsMainDiffRoute, postTestCheckpointRoute, ReadModelService
...
Cohesion: 0.25
Nodes (7): mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed
...
## Knowledge Gaps
- **12432 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12427 more)
...
- **Why does `fetch` connect `Community 2` to `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 522`, `Community 523`, `Community 12`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 147`, `Community 409`, `Community 796`, `Community 30`, `Community 287`, `Community 34`, `Community 676`, `Community 37`, `Community 294`, `Community 425`, `Community 42`, `Community 43`, `Community 41`, `Community 178`, `Community 51`, `Community 563`, `Community 564`, `Community 59`, `Community 60`, `Community 61`, `Community 190`, `Community 64`, `Community 66`, `Community 200`, `Community 73`, `Community 204`, `Community 590`, `Community 223`, `Community 95`, `Community 110`, `Community 627`, `Community 628`, `Community 120`, `Community 633`, `Community 124`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 6` to `Community 0`, `Community 801`, `Community 1`, `Community 2`, `Community 165`, `Community 7`, `Community 72`, `Community 42`, `Community 268`, `Community 14`, `Community 79`, `Community 117`, `Community 223`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 17` to `Community 26`, `Community 293`, `Community 40`, `Community 12`, `Community 269`, `Community 14`, `Community 177`, `Community 50`, `Community 631`, `Community 58`, `Community 156`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12432 weakly-connected nodes found - possible documentation gaps or missing edges._
