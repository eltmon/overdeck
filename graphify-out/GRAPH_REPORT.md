...
## Corpus Check
- 1746 files · ~2,333,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23930 nodes · 36705 edges · 1194 communities (1145 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa2cd33e`
...
## Communities (1194 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (172): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+164 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (161): buildHandoffPrompt(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+153 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (115): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+107 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (122): DeaconState, captureTmuxOutput(), customPromisify, justNow, longAgo, old, recent, restartCalled (+114 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (124): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), RawFilter, SearchMode, SearchQuery (+116 more)
...
Cohesion: 0.03
Nodes (108): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (103): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (108): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+100 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (93): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (85): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+77 more)
...
Cohesion: 0.03
Nodes (94): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (84): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+76 more)
...
Cohesion: 0.04
Nodes (94): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+86 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (89): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+81 more)
...
Cohesion: 0.03
Nodes (68): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+60 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (94): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+86 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (87): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (86): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (88): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewSessions() (+80 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (81): stampPlanForFinalization(), deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (77): NormalizedTtsDaemonConfig, buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps (+69 more)
...
Cohesion: 0.04
Nodes (66): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+58 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (75): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (72): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+64 more)
...
Cohesion: 0.03
Nodes (68): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+60 more)
...
Cohesion: 0.04
Nodes (73): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getTrackerContext(), cleanFile(), configCommand(), execAsync (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (58): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, INSPECTOR_PANEL_SOURCE, state, EDITOR_LABELS, PanOpenInPicker() (+50 more)
...
Cohesion: 0.06
Nodes (65): startPostLaunchSidecars(), startSidecars(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild() (+57 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (62): readCavemanVariant(), buildSpecialistCavemanExports(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+54 more)
...
Cohesion: 0.04
Nodes (60): checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+52 more)
...
Cohesion: 0.04
Nodes (48): SkillsList(), formatBytes(), KillButton(), severityClasses(), SystemHealthPill(), critical, { mockConfirmAndKill, mockRefreshDashboardState }, { mockToastError, mockUseSystemHealth, hookState } (+40 more)
...
Cohesion: 0.05
Nodes (51): buildACLookupByTitle(), criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult (+43 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (49): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, DeaconLogEntry, DeaconStatus(), DeaconStatusData (+41 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (59): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+51 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (42): destroyRemoteWorkspace(), createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client (+34 more)
...
Cohesion: 0.04
Nodes (52): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+44 more)
...
Cohesion: 0.05
Nodes (50): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, collectJsonlFiles() (+42 more)
...
Cohesion: 0.05
Nodes (51): Access, readLogTail(), buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats(), getIndexStats() (+43 more)
...
Cohesion: 0.06
Nodes (45): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, execAsync (+37 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (45): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SearchFilters (+37 more)
...
Cohesion: 0.07
Nodes (45): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), buildInspectPrompt() (+37 more)
...
Cohesion: 0.08
Nodes (40): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, calls (+32 more)
...
Cohesion: 0.08
Nodes (42): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest() (+34 more)
...
Cohesion: 0.06
Nodes (32): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+24 more)
...
Cohesion: 0.07
Nodes (23): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, subscribeVoiceSettings() (+15 more)
...
Cohesion: 0.09
Nodes (37): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+29 more)

### Community 119 - "Community 119"
Cohesion: 0.09
Nodes (37): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, completePlanningArtifacts(), badPath, doc, draftPath, item (+29 more)
...
Cohesion: 0.07
Nodes (31): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), createConfiguredClaudeApi() (+23 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (30): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+22 more)
...
Cohesion: 0.1
Nodes (31): checkTtsHealth(), speakTts(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+23 more)
...
Cohesion: 0.09
Nodes (33): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels() (+25 more)
...
Cohesion: 0.1
Nodes (27): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, RestartResult, StoppedAgentsBanner(), retryPendingSpawn(), clearPendingCodexReauthSession() (+19 more)
...
Cohesion: 0.1
Nodes (31): CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, LifecycleContext, TeardownOptions, WorkflowResult (+23 more)
...
Cohesion: 0.11
Nodes (29): writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+21 more)
...
Cohesion: 0.12
Nodes (27): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+19 more)
...
Cohesion: 0.14
Nodes (20): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+12 more)
...
Cohesion: 0.13
Nodes (22): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+14 more)
...
Cohesion: 0.1
Nodes (18): issues, result, importTrackerConfig(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+10 more)

### Community 308 - "Community 308"
Cohesion: 0.11
Nodes (18): childEnv, expectedExits, killChildTree(), port, requiredFiles, restartQueue, shutdown(), stopApp() (+10 more)
...
Cohesion: 0.15
Nodes (20): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+12 more)
...
Cohesion: 0.12
Nodes (16): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), startApp(), CONFIG (+8 more)
...
Cohesion: 0.22
Nodes (12): deliverQueuedFeedback(), enqueuePendingFeedbackDelivery(), isDeliveryStillRelevant(), markPendingFeedbackDelivered(), processPendingFeedbackDeliveries(), readStore(), writeStore(), deliver (+4 more)
...
## Knowledge Gaps
- **12441 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12436 more)
...
- **Why does `fetch` connect `Community 5` to `Community 0`, `Community 129`, `Community 2`, `Community 4`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 526`, `Community 15`, `Community 14`, `Community 17`, `Community 19`, `Community 792`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 417`, `Community 36`, `Community 293`, `Community 39`, `Community 296`, `Community 41`, `Community 168`, `Community 683`, `Community 44`, `Community 173`, `Community 172`, `Community 47`, `Community 304`, `Community 45`, `Community 50`, `Community 435`, `Community 52`, `Community 565`, `Community 186`, `Community 63`, `Community 64`, `Community 69`, `Community 198`, `Community 70`, `Community 202`, `Community 77`, `Community 205`, `Community 79`, `Community 592`, `Community 853`, `Community 216`, `Community 89`, `Community 226`, `Community 228`, `Community 239`, `Community 628`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 0` to `Community 1`, `Community 34`, `Community 3`, `Community 164`, `Community 5`, `Community 420`, `Community 199`, `Community 680`, `Community 226`, `Community 46`, `Community 303`, `Community 19`, `Community 372`, `Community 24`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 642`, `Community 99`, `Community 229`, `Community 390`, `Community 9`, `Community 49`, `Community 51`, `Community 23`, `Community 277`, `Community 118`, `Community 119`, `Community 25`, `Community 187`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12441 weakly-connected nodes found - possible documentation gaps or missing edges._
