# Graph Report - feature-pan-1312-slot-5  (2026-05-22)

## Corpus Check
- 1887 files · ~3,052,761 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26757 nodes · 41541 edges · 1266 communities (1215 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26ed0002`
...
## Communities (1266 total, 51 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (213): detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+205 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (150): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+142 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (135): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+127 more)
...
Cohesion: 0.02
Nodes (135): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, ALL_TABS (+127 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (113): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+105 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (134): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+126 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (121): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getTrackerContext(), closeOutCommand(), CloseOutOptions, execFileAsync (+113 more)
...
Cohesion: 0.02
Nodes (117): checkMissingReviewStatuses(), cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), cleanupStaleAgentState(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), isMergeAgentRunning() (+109 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (111): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+103 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (96): getDefaultConversationModel(), Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (85): criteria, doc, result, beadsDir, doc, { projectPath, workspacePath }, promoted, specFiles (+77 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (95): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (100): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext() (+92 more)
...
Cohesion: 0.03
Nodes (88): conversationsTab, firstLens, lens, overview, tablist, CommandDeck(), CommandDeckProps, ContainerStats (+80 more)
...
Cohesion: 0.02
Nodes (96): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), postAgentMessageLikeRoute(), validateAgentMessageOrigin() (+88 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (90): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+82 more)
...
Cohesion: 0.04
Nodes (78): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), ensureExcalidrawMcp() (+70 more)
...
Cohesion: 0.03
Nodes (87): restoreTrackedBeadsExport(), runGit(), spawnerLayer, execFile(), kCustom, mockExecFile, ActivityEntry, activityLog (+79 more)
...
Cohesion: 0.03
Nodes (78): checkApiErrorAgents(), detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+70 more)
...
Cohesion: 0.04
Nodes (77): AgentRuntimeState, claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync() (+69 more)
...
Cohesion: 0.05
Nodes (73): embedAction(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan() (+65 more)
...
Cohesion: 0.03
Nodes (67): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth (+59 more)
...
Cohesion: 0.06
Nodes (48): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor() (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (61): archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, CloisterStatusBar(), DashboardSettings (+53 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (58): startPostLaunchSidecars(), startSidecars(), DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveBundledServerPath(), resolveNode22() (+50 more)
...
Cohesion: 0.05
Nodes (55): buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, buildTmuxArgs() (+47 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (60): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+52 more)
...
Cohesion: 0.03
Nodes (44): SETTINGS_FILE, getKimiAnthropicBaseUrl(), getProviderEnv(), ProviderAuthType, ProviderName, PROVIDERS, generateRouterConfigFromWorkTypes(), Provider (+36 more)
...
Cohesion: 0.04
Nodes (45): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+37 more)
...
Cohesion: 0.05
Nodes (45): sentinel, markAgentStateServiceInProcess(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), startTtsDaemonFromDashboard(), EventRow (+37 more)
...
Cohesion: 0.06
Nodes (38): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, calls (+30 more)
...
Cohesion: 0.09
Nodes (50): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+42 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (45): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkDeadEndAgents(), checkFailedMergeRetry(), checkPendingTestDispatch() (+37 more)
...
Cohesion: 0.06
Nodes (52): Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync (+44 more)
...
Cohesion: 0.05
Nodes (52): AIProvider, buildConversationResponse(), getCachedMessages(), handleConversationMessage(), isPiSessionFile(), activeCompactions, buildContinuationSummary(), compactConversationNative() (+44 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (52): SearchResult, UpsertDiscoveredSessionOpts, updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer (+44 more)
...
Cohesion: 0.05
Nodes (39): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+31 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (41): showCommand(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+33 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (37): archivePlanning(), CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, LifecycleContext, TeardownOptions (+29 more)
...
Cohesion: 0.07
Nodes (37): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, acquireRestartLock() (+29 more)
...
Cohesion: 0.08
Nodes (43): getFlywheelRunPayload(), getFlywheelRunsPayload(), openFlywheelRunReportForDashboard(), resolveReportOpenRunId(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata(), deriveRunStatus() (+35 more)
...
Cohesion: 0.08
Nodes (41): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+33 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (42): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+34 more)
...
Cohesion: 0.05
Nodes (37): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, detectDriveType, DriveType (+29 more)
...
Cohesion: 0.07
Nodes (30): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+22 more)
...
Cohesion: 0.08
Nodes (29): saveConfig(), createRemoteWorkspace(), CreateRemoteWorkspaceOptions, execAsync, RemoteWorkspaceError, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly (+21 more)
...
Cohesion: 0.09
Nodes (32): healthCommand(), HealthOptions, pendingCommand(), listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+24 more)
...
Cohesion: 0.08
Nodes (34): indexDailySummary(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime() (+26 more)
...
Cohesion: 0.08
Nodes (27): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+19 more)
...
Cohesion: 0.08
Nodes (23): getDefaultWorkspaceConfig(), addReposToWorkspace(), AddReposToWorkspaceOptions, AddReposToWorkspaceResult, assignPort(), copyProjectTemplateDirs(), createWorkspace(), createWorktree() (+15 more)
...
Cohesion: 0.09
Nodes (25): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry() (+17 more)
...
Cohesion: 0.07
Nodes (22): getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG (+14 more)
...
Cohesion: 0.07
Nodes (22): RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue(), mapEventToDelta() (+14 more)

### Community 234 - "Community 234"
Cohesion: 0.09
Nodes (26): AutoPresoControls(), warmupIcon(), AutoPresoView(), Excalidraw, ExcalidrawApiLike, TranscriptPanel(), AutoPresoMessage, AutoPresoMode (+18 more)
...
Cohesion: 0.12
Nodes (21): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+13 more)
...
Cohesion: 0.09
Nodes (19): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, AgentTemplateConfig, DatabaseConfig, DnsConfig (+11 more)
...
Cohesion: 0.09
Nodes (21): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+13 more)
...
Cohesion: 0.15
Nodes (18): clearFeedbackFiles(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths(), writeWorkspaceContinue() (+10 more)
...
Cohesion: 0.15
Nodes (15): fetchCost(), fetchSearch(), fetchStats(), triggerScan(), CostThresholdDetails, embedSession(), EnrichRequest, enrichSession() (+7 more)
...
Cohesion: 0.29
Nodes (10): clearFlywheelRunGate(), flywheelAbortCommand(), DatabaseError, getFlywheelActiveRunId(), getSettingEffect(), isDeaconGloballyPaused(), isFlywheelGloballyPaused(), setFlywheelActiveRunId() (+2 more)
...
- **Why does `fetch` connect `Community 46` to `Community 1`, `Community 386`, `Community 255`, `Community 4`, `Community 5`, `Community 520`, `Community 8`, `Community 138`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 21`, `Community 279`, `Community 280`, `Community 24`, `Community 152`, `Community 27`, `Community 29`, `Community 32`, `Community 33`, `Community 40`, `Community 43`, `Community 44`, `Community 47`, `Community 305`, `Community 691`, `Community 1076`, `Community 1077`, `Community 55`, `Community 56`, `Community 569`, `Community 58`, `Community 697`, `Community 188`, `Community 444`, `Community 574`, `Community 190`, `Community 443`, `Community 66`, `Community 329`, `Community 202`, `Community 74`, `Community 460`, `Community 84`, `Community 212`, `Community 85`, `Community 86`, `Community 95`, `Community 223`, `Community 354`, `Community 745`, `Community 235`, `Community 237`, `Community 495`, `Community 624`, `Community 1140`, `Community 1141`, `Community 244`, `Community 383`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 12` to `Community 26`, `Community 35`, `Community 8`, `Community 426`, `Community 14`, `Community 16`, `Community 112`, `Community 209`, `Community 307`, `Community 337`, `Community 25`, `Community 90`, `Community 91`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 293` to `Community 0`, `Community 6`, `Community 135`, `Community 7`, `Community 266`, `Community 523`, `Community 10`, `Community 269`, `Community 14`, `Community 16`, `Community 273`, `Community 147`, `Community 149`, `Community 22`, `Community 281`, `Community 282`, `Community 28`, `Community 412`, `Community 292`, `Community 164`, `Community 44`, `Community 45`, `Community 176`, `Community 306`, `Community 50`, `Community 52`, `Community 438`, `Community 439`, `Community 440`, `Community 188`, `Community 576`, `Community 65`, `Community 195`, `Community 197`, `Community 70`, `Community 199`, `Community 72`, `Community 327`, `Community 74`, `Community 459`, `Community 461`, `Community 462`, `Community 336`, `Community 210`, `Community 339`, `Community 84`, `Community 213`, `Community 86`, `Community 473`, `Community 475`, `Community 222`, `Community 356`, `Community 357`, `Community 111`, `Community 112`, `Community 113`, `Community 628`, `Community 245`, `Community 124`, `Community 382`?**
