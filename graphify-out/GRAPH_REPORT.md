...
## Corpus Check
- 1927 files · ~3,150,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27542 nodes · 43238 edges · 1278 communities (1223 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6750ec02`
...
## Communities (1278 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (227): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+219 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (193): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, dropLingeringPreMergeStashes(), execAsync (+185 more)
...
Cohesion: 0.01
Nodes (144): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+136 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (166): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+158 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (159): resolveAutoResumeConfigForIssue(), buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgentPromise() (+151 more)
...
Cohesion: 0.02
Nodes (114): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, SwitchModelModal() (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (95): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+87 more)
...
Cohesion: 0.03
Nodes (112): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork() (+104 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (76): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (105): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), inferIssueIdFromWorkspace(), readFeatureContext() (+97 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (89): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+81 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (103): getActivity(), pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutexPromise(), agentsCache, AgentStartGateDecision, agentStopRoute() (+95 more)
...
Cohesion: 0.03
Nodes (95): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError (+87 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (97): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+89 more)
...
Cohesion: 0.02
Nodes (104): assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue(), queryBeadsForIssuePromise() (+96 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (86): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+78 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (96): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), ScanOptions, normalizeFilter(), SearchMode (+88 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (87): RoundMarker, conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck() (+79 more)
...
Cohesion: 0.03
Nodes (100): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+92 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (84): buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoffPromise() (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (85): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailedSync(), EmitActivityOptions, emitActivityTtsSync(), emitDashboardLifecycleSync() (+77 more)
...
Cohesion: 0.02
Nodes (82): transitionIssueToVerifyingOnMain(), importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape (+74 more)
...
Cohesion: 0.03
Nodes (74): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+66 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (80): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (78): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult, StoppedAgentsBanner(), CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus() (+70 more)
...
Cohesion: 0.03
Nodes (72): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), performHandoff(), activeRoleRunExists() (+64 more)
...
Cohesion: 0.04
Nodes (60): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), cleanupAgentDirectories() (+52 more)
...
Cohesion: 0.05
Nodes (71): buildPolyrepoContext(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand() (+63 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (68): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+60 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (58): { projectPath, workspacePath }, promoted, specFiles, fsHooks, path, paths, after, doc (+50 more)
...
Cohesion: 0.03
Nodes (70): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+62 more)
...
Cohesion: 0.04
Nodes (61): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask (+53 more)
...
Cohesion: 0.04
Nodes (56): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+48 more)
...
Cohesion: 0.03
Nodes (57): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+49 more)
...
Cohesion: 0.04
Nodes (55): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+47 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (61): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+53 more)
...
Cohesion: 0.05
Nodes (51): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+43 more)
...
Cohesion: 0.07
Nodes (47): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+39 more)
...
Cohesion: 0.04
Nodes (48): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), SessionUsage, emptyUsage() (+40 more)

### Community 77 - "Community 77"
Cohesion: 0.04
Nodes (49): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+41 more)
...
Cohesion: 0.05
Nodes (46): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+38 more)
...
Cohesion: 0.06
Nodes (45): clearFeedbackFilesPromise(), execAsync, rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials (+37 more)
...
Cohesion: 0.05
Nodes (49): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+41 more)
...
Cohesion: 0.07
Nodes (48): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+40 more)
...
Cohesion: 0.07
Nodes (50): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), requireTrustedOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+42 more)
...
Cohesion: 0.06
Nodes (35): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, ConversationsConfig (+27 more)
...
Cohesion: 0.06
Nodes (24): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+16 more)
...
Cohesion: 0.06
Nodes (38): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+30 more)
...
Cohesion: 0.09
Nodes (35): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), resolveAndSpeak(), checkTtsHealth(), extractTtsEmbedding(), speakTts() (+27 more)
...
Cohesion: 0.12
Nodes (40): archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect() (+32 more)
...
Cohesion: 0.12
Nodes (39): atLineEnd(), charAt(), compose(), continueScalar(), end(), getLine(), hasChars(), isEmpty() (+31 more)
...
Cohesion: 0.07
Nodes (31): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardMutationJsonHeaders(), dashboardSessionUrl() (+23 more)
...
Cohesion: 0.11
Nodes (38): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+30 more)
...
Cohesion: 0.09
Nodes (33): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+25 more)
...
Cohesion: 0.09
Nodes (33): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+25 more)

### Community 187 - "Community 187"
Cohesion: 0.1
Nodes (33): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+25 more)
...
Cohesion: 0.09
Nodes (35): composeAlias(), composeDoc(), composeEmptyNode(), composeNode(), composeScalar(), containsNewline(), doubleQuotedValue(), emptyScalarPosition() (+27 more)
...
Cohesion: 0.07
Nodes (23): SearchResult, getConversationsConfig(), resolveConversationWatchDirs(), AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+15 more)
...
Cohesion: 0.1
Nodes (32): detectAwaitingInputForAgent(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+24 more)
...
Cohesion: 0.08
Nodes (26): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, BuildReviewerNodesOptions, CONVOY_REVIEWER_ROLES (+18 more)
...
Cohesion: 0.08
Nodes (28): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+20 more)
...
Cohesion: 0.09
Nodes (28): AgentEnrichment, computeAgentEnrichment(), computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise() (+20 more)
...
Cohesion: 0.1
Nodes (22): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), IMAGE_EXTENSIONS, MarkdownFileLink (+14 more)

### Community 307 - "Community 307"
Cohesion: 0.11
Nodes (22): Access, getIndexStats(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+14 more)
...
Cohesion: 0.12
Nodes (18): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand(), projectShowCommand() (+10 more)
...
Cohesion: 0.12
Nodes (18): CostThresholdDetails, EnrichRequest, enrichSession(), fetchSession(), formatDate(), fromRpcSession(), parseCostThreshold(), Props (+10 more)
...
Cohesion: 0.13
Nodes (14): gitForcePush(), gitMerge(), MainDivergedError, badObjectErr, cmd, exec(), execFile(), execMock (+6 more)
...
Cohesion: 0.12
Nodes (16): code:typescript (export function validateRallyConfig(config: RallyConfig): {), code:typescript (private async pollRally(): Promise<void> {), code:typescript (// POST /api/rally/validate - Test Rally connection and conf), code:typescript (describe('Rally Integration', () => {), code:typescript (const mock = new RallyApiMock();), code:typescript (// Before error throw:), code:typescript (// Add debug logging:), code:typescript (// Improve error logging:) (+8 more)
...
Cohesion: 0.51
Nodes (9): execFileAsync, gitFetch(), gitFetchPromise(), gitForcePushPromise(), gitMergePromise(), gitPushPromise(), gitRevParse(), gitRevParsePromise() (+1 more)
...
## Knowledge Gaps
- **13612 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13607 more)
...
- **Why does `string()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 518`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 49`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 62`, `Community 574`, `Community 65`, `Community 579`, `Community 70`, `Community 72`, `Community 77`, `Community 79`, `Community 83`, `Community 84`, `Community 94`, `Community 96`, `Community 614`, `Community 102`, `Community 106`, `Community 107`, `Community 648`, `Community 650`, `Community 651`, `Community 142`, `Community 151`, `Community 154`, `Community 155`, `Community 157`, `Community 163`, `Community 167`, `Community 169`, `Community 690`, `Community 693`, `Community 184`, `Community 202`, `Community 206`, `Community 207`, `Community 222`, `Community 223`, `Community 741`, `Community 238`, `Community 245`, `Community 257`, `Community 258`, `Community 782`, `Community 785`, `Community 294`, `Community 308`, `Community 332`, `Community 335`, `Community 340`, `Community 861`, `Community 357`, `Community 386`, `Community 387`, `Community 409`, `Community 439`, `Community 466`, `Community 467`, `Community 469`, `Community 471`, `Community 494`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 46` to `Community 387`, `Community 548`, `Community 39`, `Community 9`, `Community 12`, `Community 29`, `Community 19`, `Community 308`, `Community 53`, `Community 309`, `Community 23`, `Community 22`, `Community 213`, `Community 114`, `Community 125`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 6` to `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 272`, `Community 16`, `Community 17`, `Community 273`, `Community 18`, `Community 143`, `Community 22`, `Community 275`, `Community 154`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 291`, `Community 164`, `Community 37`, `Community 38`, `Community 167`, `Community 43`, `Community 177`, `Community 690`, `Community 50`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 62`, `Community 65`, `Community 453`, `Community 329`, `Community 202`, `Community 81`, `Community 210`, `Community 337`, `Community 211`, `Community 92`, `Community 93`, `Community 96`, `Community 225`, `Community 742`, `Community 103`, `Community 104`, `Community 621`, `Community 113`, `Community 245`, `Community 382`, `Community 383`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13612 weakly-connected nodes found - possible documentation gaps or missing edges._
