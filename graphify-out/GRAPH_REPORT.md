...
## Corpus Check
- 1574 files · ~2,071,379 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22398 nodes · 33617 edges · 1160 communities (1122 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5535c1bb`
...
## Communities (1160 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (171): fetchMessages(), resumeConversation(), ViewMode, ConversationList(), fetchConversations(), GeneralConversation, GeneralSectionProps, CommandDeck() (+163 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (158): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), cleanupOrphanedReviewSessions(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE (+150 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (154): checkStuckWorkAgents(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent(), spawnSingleReviewer() (+146 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (138): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+130 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (113): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+105 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (124): checkOrphanedReviewStatuses(), checkStuckReviewing(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (106): setAgentStoppedNotifier(), announceMerge(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+98 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (91): state, WorkspaceStatusOverviewProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload() (+83 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (110): loadCloisterConfig(), shouldAutoStart(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (84): parsePiSession(), waitForPiAgentReady(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent (+76 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (88): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+80 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (84): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+76 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (89): killCommand(), KillOptions, resetSessionCommand(), resumeCommand(), computeAgentEnrichment(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), mirror (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (94): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (81): BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode (+73 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (88): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (74): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (75): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (75): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), ensurePanDirs() (+67 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (61): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationViewProps (+53 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (75): closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+67 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (63): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+55 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (72): resetPostMergeState(), killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested (+64 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (75): clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, WorkhorsesConfig, WorkhorseSlot, MODEL_DEPRECATIONS (+67 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (62): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+54 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (65): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+57 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (63): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (64): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+56 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (55): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+47 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (55): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+47 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (60): checkFailedMergeRetry(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearStaleCiFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile() (+52 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (57): importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment, GitHubIssue (+49 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (60): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+52 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (60): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+52 more)
...
Cohesion: 0.05
Nodes (47): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+39 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (49): isRFC3339DateTime(), toRFC3339(), VBRIEF_INSPECTION_POLICIES, VBriefDifficulty, VBriefDocument, VBriefEdge, VBriefEdgeType, VBriefInspectionPolicy (+41 more)
...
Cohesion: 0.06
Nodes (46): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+38 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (54): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, BUDGETS_FILE, calculateCost(), checkBudget() (+46 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (55): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+47 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (48): contextCommand(), ContextOptions, cvCommand(), CVOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand() (+40 more)
...
Cohesion: 0.04
Nodes (49): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, ghCliIssue (+41 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (41): ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps (+33 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (51): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+43 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (41): configShadowCommand(), ShadowOptions, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus() (+33 more)
...
Cohesion: 0.09
Nodes (49): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+41 more)
...
Cohesion: 0.07
Nodes (48): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv() (+40 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (45): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+37 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (42): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError() (+34 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (36): EventRouter(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase (+28 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (39): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS, EffortLevel (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (44): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), authStatusVariant(), AvailableModel (+36 more)
...
Cohesion: 0.05
Nodes (45): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+37 more)
...
Cohesion: 0.06
Nodes (47): Access, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session() (+39 more)

### Community 61 - "Community 61"
Cohesion: 0.09
Nodes (44): startPostLaunchSidecars(), startSidecars(), resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart() (+36 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (43): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+35 more)
...
Cohesion: 0.05
Nodes (40): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+32 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (37): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+29 more)
...
Cohesion: 0.06
Nodes (28): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffWorkerPoolProvider(), DEFAULTS (+20 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (36): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+28 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (37): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getCodexReauthStatusRoute, getExistingLiveReauthSession(), getLiveReauthSession(), hasExistingLiveReauthSession() (+29 more)
...
Cohesion: 0.07
Nodes (42): fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync, getCachedResourceAllocatedIssues() (+34 more)
...
Cohesion: 0.06
Nodes (30): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BUCKET_STAGES, BucketedFeature, bucketFeature(), CostBadge() (+22 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (40): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+32 more)
...
Cohesion: 0.09
Nodes (39): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+31 more)
...
Cohesion: 0.07
Nodes (36): createSpecialistHandoff(), ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getTodaySpecialistHandoffs(), logSpecialistHandoff(), readIssueSpecialistHandoffs() (+28 more)
...
Cohesion: 0.08
Nodes (40): PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+32 more)
...
Cohesion: 0.08
Nodes (24): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+16 more)

### Community 110 - "Community 110"
Cohesion: 0.12
Nodes (31): createTracker(), createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv (+23 more)

### Community 111 - "Community 111"
Cohesion: 0.07
Nodes (30): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+22 more)

### Community 112 - "Community 112"
Cohesion: 0.07
Nodes (21): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+13 more)
...
Cohesion: 0.06
Nodes (36): FileStatus, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, SOURCE_AGENTS_DIR, SOURCE_DEV_SKILLS_DIR, SOURCE_REVIEW_PROMPTS_DIR, SOURCE_RULES_DIR, SOURCE_SCRIPTS_DIR (+28 more)

### Community 118 - "Community 118"
Cohesion: 0.1
Nodes (38): destroyRemoteWorkspace(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+30 more)
...
Cohesion: 0.12
Nodes (37): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+29 more)
...
Cohesion: 0.1
Nodes (31): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, AgentAlreadyRunning (+23 more)

### Community 132 - "Community 132"
Cohesion: 0.08
Nodes (18): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+10 more)
...
Cohesion: 0.11
Nodes (32): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+24 more)

### Community 142 - "Community 142"
Cohesion: 0.08
Nodes (26): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), criteria, doc, projectDoc, projectRoot (+18 more)
...
Cohesion: 0.11
Nodes (8): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, execAsync, FlyProvider, mapFlyStateToVmStatus()
...
Cohesion: 0.09
Nodes (33): wipeCommand(), archivePlanning(), CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions (+25 more)
...
Cohesion: 0.08
Nodes (25): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), selectAllModels() (+17 more)
...
Cohesion: 0.09
Nodes (33): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), restoreTrackedBeadsExport(), updateGitHubToInReview(), updateLinearToInReview() (+25 more)

### Community 161 - "Community 161"
Cohesion: 0.09
Nodes (32): execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+24 more)
...
Cohesion: 0.16
Nodes (32): cleanupLabelsGitHub(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState() (+24 more)
...
Cohesion: 0.1
Nodes (31): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+23 more)
...
Cohesion: 0.07
Nodes (27): DEFAULT_GATES, calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes (+19 more)

### Community 181 - "Community 181"
Cohesion: 0.08
Nodes (32): cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent(), getRecentHealthHistory(), HealthEvent (+24 more)

### Community 182 - "Community 182"
Cohesion: 0.06
Nodes (34): CLI Distribution Strategy, code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]), code:toml ([project]) (+26 more)
...
Cohesion: 0.11
Nodes (29): buildInspectPrompt(), detectCompileCommand(), InspectContext, onInspectComplete(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead() (+21 more)

### Community 192 - "Community 192"
Cohesion: 0.11
Nodes (31): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+23 more)
...
Cohesion: 0.09
Nodes (31): result, snapshot, status, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentPhase(), toAgentResolution() (+23 more)
...
Cohesion: 0.07
Nodes (26): ComposerFooter(), getDefaultConversationModel(), ForkModal(), ForkModalProps, fetchOpenRouterModels(), KeyStatus, OpenRouterModelsResponse, OpenRouterPage() (+18 more)
...
Cohesion: 0.08
Nodes (26): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+18 more)
...
Cohesion: 0.11
Nodes (23): CloseOutContext, CloseOutResult, CloseOutStep, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat (+15 more)

### Community 222 - "Community 222"
Cohesion: 0.13
Nodes (28): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+20 more)
...
Cohesion: 0.11
Nodes (28): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+20 more)
...
Cohesion: 0.14
Nodes (25): ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, CLAUDE_MD_TEMPLATES (+17 more)
...
Cohesion: 0.09
Nodes (25): ModelProvider, ModelSelectionResult, getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter() (+17 more)

### Community 235 - "Community 235"
Cohesion: 0.1
Nodes (21): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+13 more)
...
Cohesion: 0.17
Nodes (26): extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+18 more)
...
Cohesion: 0.09
Nodes (17): ensureDefaultConversationModel(), ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), HARNESS_OPTIONS, HarnessDecision (+9 more)
...
Cohesion: 0.13
Nodes (21): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractStandardNumber() (+13 more)

### Community 278 - "Community 278"
Cohesion: 0.16
Nodes (24): assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths(), getAttachmentCache(), getAttachmentCacheKey() (+16 more)
...
Cohesion: 0.12
Nodes (23): HandoffContext, ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents() (+15 more)
...
Cohesion: 0.13
Nodes (21): ConversationPanel(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), useNow(), AGENT_TOOLS, BASH_TOOLS (+13 more)

### Community 288 - "Community 288"
Cohesion: 0.1
Nodes (21): result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions, CONVOY_REVIEWER_ROLES, detectApiError(), extractReviewerRole(), findLatestReviewRunDir() (+13 more)
...
Cohesion: 0.13
Nodes (19): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+11 more)
...
Cohesion: 0.11
Nodes (21): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+13 more)
...
Cohesion: 0.13
Nodes (5): clientMock, octokitMock, result, states, LinearTracker
...
Cohesion: 0.11
Nodes (18): badPath, customPlanningDir, dir, doc, filename, item, item2, lifecyclePlan (+10 more)
...
Cohesion: 0.22
Nodes (18): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+10 more)

### Community 379 - "Community 379"
Cohesion: 0.1
Nodes (17): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+9 more)
...
Cohesion: 0.1
Nodes (17): error, mockComment, mockComments, mockIssue, mockIssues, mockOctokit, stateTests, tracker (+9 more)
...
Cohesion: 0.17
Nodes (14): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveWindowUrl() (+6 more)
...
Cohesion: 0.17
Nodes (14): shouldSkipCheckpointReconciliation(), applyEvent(), applyEvents(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxTurnDiffSummariesPerAgent(), INITIAL_READ_MODEL_STATE (+6 more)
...
Cohesion: 0.12
Nodes (13): defectQuery, hrQuery, mockCreate, mockQuery, mockUpdate, tracker, RallyApiConfig, RallyCreateConfig (+5 more)
...
Cohesion: 0.14
Nodes (13): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+5 more)

### Community 499 - "Community 499"
Cohesion: 0.2
Nodes (12): getHeader(), getTrustedOrigins(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin(), appendResolutionEvents, deliverDecision, details (+4 more)
...
Cohesion: 0.24
Nodes (12): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+4 more)
...
Cohesion: 0.17
Nodes (9): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+1 more)

### Community 540 - "Community 540"
Cohesion: 0.26
Nodes (10): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+2 more)
...
Cohesion: 0.15
Nodes (12): Auto-planning, Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071 --auto), code:bash (pan plan finalize), Finalizing (`pan plan finalize`), Panopticon Planning Lifecycle (+4 more)
...
Cohesion: 0.23
Nodes (9): callServerApi(), buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, checkForUpdates(), onUpdateStatusChange() (+1 more)

### Community 563 - "Community 563"
Cohesion: 0.26
Nodes (11): addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials(), removeTunnelIngress(), resolveHostnames() (+3 more)
...
Cohesion: 0.24
Nodes (10): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichReviewArtifactBody(), bead (+2 more)
...
Cohesion: 0.24
Nodes (10): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength() (+2 more)
...
Cohesion: 0.29
Nodes (7): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }
...
Cohesion: 0.22
Nodes (9): buildPermissionActivityDetails(), buildPermissionWaitingMessage(), parsePermissionResponseBehavior(), permissionResolutionVerb(), processPermissionResponse(), ProcessPermissionResponseDeps, ProcessPermissionResponseResult, redactPermissionInputPreview() (+1 more)
...
Cohesion: 0.33
Nodes (9): getTrackerContext(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress() (+1 more)
...
Cohesion: 0.22
Nodes (9): Auto-Behaviors, code:block7 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), Continue State, Dashboard Viewer, Legacy paths, Lifecycle Directories, Status is a JSON field, not a directory, The five-artifact model (PAN-967 + PAN-946) (+1 more)
...
Cohesion: 0.33
Nodes (7): Auto (non-interactive), Auto-Start (skip planning), code:bash (pan plan <id> --auto), code:bash (pan start <id> --auto), code:block8 (**PRD:** [`path/to/prd.md`](https link to the file in the re), Issue Creation from PRDs, Planning Modes
...
Cohesion: 0.33
Nodes (5): defaults, first, issueAgentTypes, { models }, second
...
Cohesion: 0.5
Nodes (3): agentDir, missing, discoverNewAgentIds()

### Community 1057 - "Community 1057"
Cohesion: 0.5
Nodes (4): code:bash (pan plan <id>), code:typescript (// Correct (in sendKeysAsync):), Interactive (default), tmux Message Delivery
...
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 130`, `Community 4`, `Community 7`, `Community 778`, `Community 11`, `Community 10`, `Community 395`, `Community 14`, `Community 143`, `Community 16`, `Community 657`, `Community 140`, `Community 19`, `Community 21`, `Community 279`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 1052`, `Community 539`, `Community 32`, `Community 160`, `Community 36`, `Community 38`, `Community 43`, `Community 47`, `Community 562`, `Community 563`, `Community 51`, `Community 53`, `Community 50`, `Community 55`, `Community 568`, `Community 569`, `Community 58`, `Community 56`, `Community 61`, `Community 192`, `Community 193`, `Community 64`, `Community 833`, `Community 204`, `Community 986`, `Community 349`, `Community 112`, `Community 501`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 167` to `Community 10`, `Community 2`, `Community 5`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 833` to `Community 101`?**
