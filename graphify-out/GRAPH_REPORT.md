...
## Corpus Check
- 1746 files · ~2,333,992 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23936 nodes · 36724 edges · 1196 communities (1145 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2b643f2`
...
## Communities (1196 total, 51 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (149): ActivityView(), AgentList(), formatTimeAgo(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession() (+141 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (144): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus() (+136 more)
...
Cohesion: 0.03
Nodes (128): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+120 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (148): spawnInspectAgent(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), unpauseCommand(), untroubledCommand(), ActivityEntry (+140 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (136): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+128 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (104): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue (+96 more)
...
Cohesion: 0.02
Nodes (102): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), DEFAULTS (+94 more)
...
Cohesion: 0.02
Nodes (102): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+94 more)
...
Cohesion: 0.04
Nodes (92): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), RawFilter, SearchMode, SearchQuery (+84 more)
...
Cohesion: 0.07
Nodes (83): calls, { mockExecAsync }, opts, ARCHIVES_DIR, canonicalPrdSubdir(), findPrdAtStatus(), statusRoot(), archivePlanning() (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (83): checkApiErrorAgents(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+75 more)
...
Cohesion: 0.05
Nodes (78): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), wipeCommand(), WipeOptions, addRepoCommand(), AddRepoOptions (+70 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (63): { projectPath, workspacePath }, promoted, specFiles, doc, path, fsHooks, first, found (+55 more)
...
Cohesion: 0.03
Nodes (59): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+51 more)
...
Cohesion: 0.03
Nodes (63): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (67): readCavemanVariant(), buildSpecialistCavemanExports(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+59 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (68): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, dropLingeringPreMergeStashes() (+60 more)
...
Cohesion: 0.05
Nodes (63): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+55 more)
...
Cohesion: 0.04
Nodes (74): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+66 more)
...
Cohesion: 0.04
Nodes (70): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+62 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (65): monitorReviewConvoySignals(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState (+57 more)
...
Cohesion: 0.05
Nodes (62): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+54 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (60): readWorkspacePlanAsync(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), completePlanningArtifacts(), readWorkspacePlanAsync(), badPath (+52 more)
...
Cohesion: 0.03
Nodes (55): AgentRuntimeState, agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), deleteAgentRoute, EMPTY_CONVERSATION, evaluateAgentStartGate() (+47 more)
...
Cohesion: 0.04
Nodes (50): detectHandoffMethod(), HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+42 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (58): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+50 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (52): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkPendingTestDispatch() (+44 more)
...
Cohesion: 0.05
Nodes (53): getTrackerContext(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+45 more)
...
Cohesion: 0.06
Nodes (51): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+43 more)
...
Cohesion: 0.04
Nodes (52): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+44 more)
...
Cohesion: 0.06
Nodes (49): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+41 more)
...
Cohesion: 0.07
Nodes (22): issues, result, importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged() (+14 more)
...
Cohesion: 0.06
Nodes (49): findDraftPrd(), findPrdAnywhere(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS, ActivityContext, awaitingInputFromProjection() (+41 more)
...
Cohesion: 0.06
Nodes (42): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+34 more)
...
Cohesion: 0.05
Nodes (43): agentsRouteLayer, conversationsRouteLayer, authorized(), eventsRouteLayer, getEventStreamRoute, getEventVersionRoute, getHeader(), PUBLIC_CATALOG (+35 more)

### Community 86 - "Community 86"
Cohesion: 0.05
Nodes (45): CappedBodyReadResult, CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute, ExtractEmbeddingDeps (+37 more)
...
Cohesion: 0.06
Nodes (39): adminRouteLayer, getAdminTldrRoute, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute, startRoute (+31 more)
...
Cohesion: 0.07
Nodes (27): countContextTokens(), findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions() (+19 more)
...
Cohesion: 0.06
Nodes (22): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, getIssueDataService() (+14 more)
...
Cohesion: 0.07
Nodes (38): checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, isMergeAgentRunning(), activeRoleRunExists() (+30 more)
...
Cohesion: 0.14
Nodes (29): createCostCommand(), formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, checkBudget() (+21 more)
...
Cohesion: 0.11
Nodes (22): snapshot, status, Jsonish, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toMergeStatus(), toReviewStatus() (+14 more)
...
Cohesion: 0.22
Nodes (16): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), extractNumber() (+8 more)
...
Cohesion: 0.15
Nodes (13): sshCommand(), runModelSummary(), runPiModelSummary(), buildSpawnEnvForModel(), CONFIG, hadPackageDir, hadPython, hadVenvDir (+5 more)
...
Cohesion: 0.22
Nodes (7): AgentEnrichment, toAgentResolution(), toAgentStatus(), toRole(), EnrichmentServiceState, serviceState, startAgentEnrichmentService()
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 133`, `Community 6`, `Community 136`, `Community 9`, `Community 266`, `Community 11`, `Community 137`, `Community 13`, `Community 14`, `Community 8`, `Community 144`, `Community 142`, `Community 10`, `Community 16`, `Community 22`, `Community 24`, `Community 793`, `Community 25`, `Community 28`, `Community 34`, `Community 677`, `Community 39`, `Community 679`, `Community 424`, `Community 43`, `Community 45`, `Community 48`, `Community 181`, `Community 565`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 202`, `Community 74`, `Community 588`, `Community 205`, `Community 80`, `Community 593`, `Community 597`, `Community 87`, `Community 359`, `Community 494`, `Community 632`, `Community 254`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 28` to `Community 64`, `Community 1`, `Community 34`, `Community 4`, `Community 37`, `Community 5`, `Community 12`, `Community 496`, `Community 17`, `Community 18`, `Community 19`, `Community 52`, `Community 50`, `Community 182`, `Community 54`, `Community 92`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 68`, `Community 40`, `Community 41`, `Community 10`, `Community 75`, `Community 267`, `Community 174`, `Community 17`, `Community 497`, `Community 371`, `Community 20`, `Community 223`?**
