# Graph Report - feature-pan-829  (2026-05-17)

## Corpus Check
- 1685 files · ~2,262,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23109 nodes · 35114 edges · 1173 communities (1130 shown, 43 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 498 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48b1001f`
...
1. `fetch` - 194 edges
2. `resolveProjectFromIssue()` - 118 edges
3. `getDatabase()` - 94 edges
4. `useDashboardStore` - 61 edges
5. `sessionExistsAsync()` - 56 edges
6. `spawnAgent()` - 53 edges
7. `spawnRun()` - 52 edges
8. `messageAgent()` - 49 edges
9. `runPatrol()` - 49 edges
10. `listSessionNamesAsync()` - 47 edges
...
## Communities (1173 total, 43 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (194): autoResumeStoppedWorkAgents(), monitorReviewConvoySignals(), notifyAgentStatusChanged(), performKillAndSpawn(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync (+186 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (158): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+150 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (134): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+126 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (129): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+121 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (155): loadDeaconWithResumeMock(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+147 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (114): ConversationView(), AgentList(), formatTimeAgo(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (83): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent() (+75 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (96): ComposerMode, IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStripProps (+88 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (98): isMergeAgentRunning(), parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder (+90 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (109): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+101 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (111): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+103 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (107): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+99 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (82): fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps (+74 more)
...
Cohesion: 0.03
Nodes (89): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), SwitchModelModal(), SwitchModelModalProps, WorkspaceStatusOverview() (+81 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (88): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+80 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (86): checkStuckReviewing(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+78 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (85): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses() (+77 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (89): renderPrompt(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (80): DEFAULTS, UIPreferences, useUIPreferences(), PROVIDER_INFO, ProviderPanelProps, DesktopSettings, DesktopSettingsSection(), isDesktopApp() (+72 more)
...
Cohesion: 0.04
Nodes (90): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+82 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (90): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, WorkhorsesConfig (+82 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (81): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (78): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+70 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (59): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, { projectPath, workspacePath }, promoted, specFiles, doc, path (+51 more)
...
Cohesion: 0.04
Nodes (72): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+64 more)
...
Cohesion: 0.04
Nodes (55): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, firstSessionPanel, firstWorkbench, overview (+47 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (27): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.1
Nodes (64): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), applyClosedOutLabel(), applyLabelGitHub() (+56 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (58): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), completePlanningArtifacts(), computePlanningState(), badPath, doc (+50 more)
...
Cohesion: 0.06
Nodes (55): projectAddCommand(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials (+47 more)
...
Cohesion: 0.05
Nodes (55): Access, getIssueDataService(), readBridgedCodexCredential(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+47 more)
...
Cohesion: 0.04
Nodes (49): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getCachedFavoritedIds() (+41 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (46): cvCommand(), CVOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+38 more)
...
Cohesion: 0.05
Nodes (49): startPostLaunchSidecars(), HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning (+41 more)
...
Cohesion: 0.04
Nodes (49): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (42): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+34 more)
...
Cohesion: 0.08
Nodes (46): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+38 more)
...
Cohesion: 0.07
Nodes (40): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+32 more)
...
Cohesion: 0.08
Nodes (36): buildACLookupByTitle(), criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult (+28 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (37): resolveWorkTypeKey(), useResolvedModels(), listeners, useSharedTick(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel() (+29 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (40): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+32 more)
...
Cohesion: 0.06
Nodes (31): buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+23 more)
...
Cohesion: 0.07
Nodes (37): agentDir, missing, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState (+29 more)

### Community 122 - "Community 122"
Cohesion: 0.11
Nodes (36): DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions (+28 more)
...
Cohesion: 0.1
Nodes (34): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, TtsDaemonConfig, ActivityTtsPayload, drainQueue() (+26 more)
...
Cohesion: 0.09
Nodes (31): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+23 more)
...
Cohesion: 0.11
Nodes (31): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync() (+23 more)
...
Cohesion: 0.06
Nodes (34): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES (+26 more)
...
Cohesion: 0.11
Nodes (28): createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt(), WhiteboardAgentGuard (+20 more)
...
Cohesion: 0.12
Nodes (30): settle(), bin(), main(), repoRoot, run(), source, target, venvDir (+22 more)
...
Cohesion: 0.14
Nodes (30): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+22 more)
...
Cohesion: 0.13
Nodes (25): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+17 more)
...
Cohesion: 0.09
Nodes (23): AutoPresoAgentSettings, boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode (+15 more)
...
Cohesion: 0.11
Nodes (22): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength(), buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody() (+14 more)
...
Cohesion: 0.12
Nodes (22): Ad-Hoc Speak and CLI Smoke Test, Architecture, code:block1 (pan dashboard                  qwen-tts daemon            au), code:bash (cd skills/pan-tts/scripts), code:yaml (endpoint: http://127.0.0.1:3000/events/stream), code:bash (# one-shot foreground run (smoke test)), code:bash (pan tts test), code:bash (./scripts/say.sh "Build is green, ready for review.") (+14 more)
...
Cohesion: 0.13
Nodes (12): RoundMarker, ZoneCConversation(), ZoneCConversationProps, getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps (+4 more)
...
Cohesion: 0.13
Nodes (12): captureTldrMetrics(), daemonRegistry, getTldrMetrics(), listTldrDaemonServices(), LiveDaemonState, TldrDaemonStatus, TldrMetricsCheckpoint, TldrSessionMetrics (+4 more)
...
Cohesion: 0.18
Nodes (15): checkCliproxyPortAsync(), execAsync, isCliproxyRunning(), isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), restartCliproxyAsync(), stopCliproxy() (+7 more)
...
Cohesion: 0.21
Nodes (13): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+5 more)
...
Cohesion: 0.15
Nodes (8): createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, PanRpcProtocolClient, resetTransport(), RpcClientFactory, SubscribeOptions, WsTransport
...
Cohesion: 0.24
Nodes (8): CopyConfigOptions, getPanopticonHome(), isErrnoException(), readRestartStatus(), RestartStatus, restartStatusPath(), RestartTrigger, writeRestartStatus()

### Community 579 - "Community 579"
Cohesion: 0.29
Nodes (11): LOGS_DIR, getSupervisorPort(), getSupervisorUrl(), isProcessAlive(), isSupervisorRunning(), readSupervisorPid(), resolveSupervisorBundle(), startSupervisorProcess() (+3 more)
...
Cohesion: 0.24
Nodes (10): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), isEligibleForCleanup(), installGitHooks() (+2 more)
...
Cohesion: 0.36
Nodes (8): validateAgentDeliveryMethodOrigin(), getHeader(), getTrustedOrigins(), isTrustedOriginForHost(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin(), result
...
Cohesion: 0.2
Nodes (8): BASE_TIME, exitSpy, loadStartCommand(), mailDir, mailFiles, state, stderrSpy, written
...
## Knowledge Gaps
- **12053 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12048 more)
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 387`, `Community 388`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 782`, `Community 15`, `Community 14`, `Community 273`, `Community 659`, `Community 20`, `Community 277`, `Community 21`, `Community 151`, `Community 282`, `Community 27`, `Community 28`, `Community 31`, `Community 545`, `Community 164`, `Community 36`, `Community 40`, `Community 43`, `Community 47`, `Community 55`, `Community 57`, `Community 571`, `Community 59`, `Community 60`, `Community 62`, `Community 702`, `Community 189`, `Community 68`, `Community 836`, `Community 70`, `Community 74`, `Community 90`, `Community 477`, `Community 613`, `Community 106`, `Community 115`, `Community 502`, `Community 119`, `Community 120`, `Community 122`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 10` to `Community 0`, `Community 1`, `Community 4`, `Community 37`, `Community 69`, `Community 11`, `Community 428`, `Community 140`, `Community 46`, `Community 47`, `Community 18`, `Community 19`, `Community 23`, `Community 25`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 256`, `Community 38`, `Community 361`, `Community 107`, `Community 11`, `Community 78`, `Community 14`, `Community 274`, `Community 500`, `Community 53`, `Community 25`, `Community 157`, `Community 95`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 193 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 193 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12053 weakly-connected nodes found - possible documentation gaps or missing edges._
