...
## Corpus Check
- 2079 files · ~3,633,026 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33008 nodes · 64035 edges · 1386 communities (1318 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1515 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `90682d94`
...
- `writeFeedbackFile()` --calls--> `send-feedback-to-agent skill`  [INFERRED]
  src/lib/cloister/feedback-writer.ts → skills/send-feedback-to-agent/SKILL.md

## Communities (1386 total, 68 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (303): autoResumeStoppedWorkAgents(), checkStuckWorkAgents(), checkThinkingSignatureCorruption(), cleanupOrphanedPlanningSessions(), cleanupOrphanedReviewSessions(), isVerifyPausedAgentState(), notifyAgentStatusChanged(), recoverOrphanedAgents() (+295 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.01
Nodes (251): transitionIssueToVerifyingOnMain(), detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), getCavemanExperimentData() (+243 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (236): Work Agent (shown in inspector terminal), switchModel(), RoundVerdict, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps (+228 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.01
Nodes (232): MODEL_COLORS, HealthEvent, SpecialistHealthState, CloisterStatus, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+224 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (239): readCavemanVariant(), checkPendingTestDispatch(), getSpecialistState(), getSpecialistHarness(), createSpecialistHandoff(), appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit() (+231 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (146): CLAUDE_PROJECTS_DIR, ClaudeMessage, getAllSessionFiles(), getProjectDirs(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles() (+138 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (184): ~/.panopticon/agents/ State Directory, Agent Directory Structure, applyEnvironmentOverrides(), deepMerge(), getHealthThresholdsMs(), loadCloisterConfig(), loadCloisterConfigAsync(), loadCloisterConfigSync() (+176 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (188): API_ERROR_PATTERNS, wipeCommand(), WipeOptions, Command Deck (Core Concept), appendToWal(), appendToWalSync(), resolveWalDir(), Access (+180 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.02
Nodes (191): HookEntry, getUnblockedItems(), AddRepoOptions, CreateOptions, DestroyOptions, RepoGroups, UpdateOptions, UseConfigOptions (+183 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (156): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+148 more)
...
Cohesion: 0.02
Nodes (155): isCoordinatorAliveAsync(), ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle() (+147 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (172): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPostReviewCommits(), cleanupOrphanReviewerSessions(), cleanupSpawnAndOrphanedStashes(), execAsync, killOrphanedWorkspaceProcesses() (+164 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (152): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+144 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (140): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+132 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.02
Nodes (143): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ConversationPanel(), ConversationPanelProps (+135 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (159): parseDifficultyLabel(), LiveLastHeard(), stalenessClass(), BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, TaskItem() (+151 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (121): AgentTellForm(), AgentTellFormProps, SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS (+113 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.03
Nodes (118): determineCavemanVariant(), injectCavemanSettings(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry() (+110 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (117): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+109 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.02
Nodes (118): config, DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+110 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.03
Nodes (118): isAgentIdleForNudge(), StuckRemediationConfig, addLog(), apiErrorRecoveryState, autoCloseOutCache, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+110 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (131): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+123 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.04
Nodes (114): restoreCommand(), showCommand(), continue-state.ts, vBRIEF Lifecycle, cont, doc, projectRoot, specsDir (+106 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (107): ActivityFeedSidebar(), conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck() (+99 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.04
Nodes (111): deriveDotStatus(), presenceToStatus(), onSelectSession, parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), useLiveFlash() (+103 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.04
Nodes (112): checkApiErrorAgents(), logNonCanonicalStashesOnStartup(), recordAutoCloseOutFailure(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures (+104 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (95): mockClaudeSkills, BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+87 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (106): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+98 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (106): registerAdminCommands(), archiveCustomState(), cleanupStatesCommand(), listStatesCommand(), listTeamStates(), bundledFrontendIndex, bundledServer, child (+98 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (105): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+97 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.05
Nodes (101): checkVerificationReviewContradiction(), clearStaleCiFeedback(), reconcileStaleMergeStatus(), buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig() (+93 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (111): findProjectRoot(), estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+103 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.03
Nodes (91): Tab, FlywheelRunSummary, NAV_GROUPS, NavGroup, NavItem, PHASE_DOT_CLASSES, PHASE_LABELS, PIPELINE_PHASES (+83 more)
...
Cohesion: 0.03
Nodes (102): PRIORITY_LABELS, resolveTrackerType(), invalidateAgentsCache(), cb, cmdArgs, cmdStr, inline, issueCommentsJson (+94 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (81): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), GitHubConfig, RallyConfig, claudePlanningSystemPromptFiles() (+73 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (85): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+77 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.03
Nodes (98): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostsResponse, rows (+90 more)
...
Cohesion: 0.03
Nodes (97): defaults, first, issueAgentTypes, { models }, second, ModelRef, RoleConfig, RolesConfig (+89 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.03
Nodes (95): chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources(), DEFAULT_DOCS_CONFIG, discoverDocsCorpusSources(), discoverMarkdownUnder() (+87 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (84): customPromisify, justNow, longAgo, old, recent, restartCalled, state, STATE_FILE (+76 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.04
Nodes (94): buildHostOverrideConfirmation(), confirmHostOverride(), difficultyColor(), dryRun(), parseFiniteInteger(), printWavePlan(), SWARM_RECOVER_ACTIONS, swarmCommand() (+86 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.05
Nodes (87): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+79 more)
...
Cohesion: 0.03
Nodes (95): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+87 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.03
Nodes (94): getSortKey(), sortConversations(), SortOption, ALLOWED_UPLOAD_MIME_TYPES, checkUploadRateLimit(), deleteConversationFavoriteRoute, extractModelFromSessionFile(), generateConversationName() (+86 more)
...
Cohesion: 0.04
Nodes (75): runWithPool(), WorkPoolStats, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), markEnrichmentFailed(), searchFts(), buildEmbeddingText(), EmbedProgress (+67 more)
...
Cohesion: 0.04
Nodes (81): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+73 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.05
Nodes (78): extractAcceptanceCriteria(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext() (+70 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.04
Nodes (72): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+64 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.04
Nodes (66): ConfirmationDialog(), ConfirmationDialogProps, ConfirmationRequest, CavemanExperimentRow, CostsPage(), DailyTrend, ExperimentsResponse, ExperimentsView() (+58 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.05
Nodes (74): CleanupOptions, LinearState, ListOptions, detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), buildWorkAgentPrompt(), getTrackerContext() (+66 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.06
Nodes (66): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+58 more)
...
Cohesion: 0.05
Nodes (63): createMemoryCommand(), ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity (+55 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (73): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), recoverUnhealthyTestStack(), mockLoadProjectsConfig, mockRunQualityGates (+65 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.04
Nodes (68): Agent Enrichment Service, agentDir, missing, result, snapshot, status, AgentEnrichment, missing (+60 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.06
Nodes (67): PROVIDER_ENV_UNSETS, runModelSummary(), runModelSummaryPromise(), runPiModelSummary(), buildSpawnEnvForModel(), buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings (+59 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (60): handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, createHandoffPaths() (+52 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.04
Nodes (63): AlertDialogContent(), AlertOptions, ConfirmDialogContent(), ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+55 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (56): ChatMessage, StandaloneTerminal(), StandaloneTerminalProps, derivePlanningIssueId(), fetchOutput(), popoutTerminal(), TerminalPanel(), TerminalPanelProps (+48 more)
...
Cohesion: 0.04
Nodes (58): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+50 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.06
Nodes (63): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+55 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.05
Nodes (53): { projectPath, workspacePath }, promoted, specFiles, fsHooks, doc, items, TABS, themeButton (+45 more)

### Community 69 - "Swarm Dispatch and DAG Execution"
Cohesion: 0.04
Nodes (69): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage() (+61 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.05
Nodes (65): details, UpsertDiscoveredSessionOpts, validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+57 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.03
Nodes (51): ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first, second (+43 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.04
Nodes (60): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+52 more)
...
Cohesion: 0.05
Nodes (56): startPostLaunchSidecars(), startSidecars(), delay(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget() (+48 more)

### Community 75 - "Path Constants and Postinstall Setup"
Cohesion: 0.05
Nodes (58): backup, backupCleanCommand(), backupListCommand(), PACKAGE_ROOT, restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync() (+50 more)

### Community 76 - "Cost Recovery Scripts and Latency Tests"
Cohesion: 0.04
Nodes (55): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature() (+47 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (54): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), ensureOpenAICompatibleProxyRunningPromise() (+46 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.06
Nodes (63): deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathEffect() (+55 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.05
Nodes (63): briefingCommandAction(), BriefingCommandOptions, createBriefingCommand(), logSpy, nestedCwd, output, statusPath, workspace (+55 more)

### Community 80 - "Skills Merge and Manifest Sync"
Cohesion: 0.06
Nodes (63): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+55 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.04
Nodes (58): future, id, rows, rows1, rows2, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema() (+50 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.05
Nodes (53): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+45 more)

### Community 83 - "Issue Search Modal and Filter State"
Cohesion: 0.1
Nodes (59): systemHealthCommand(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError (+51 more)
...
Cohesion: 0.04
Nodes (56): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+48 more)
...
Cohesion: 0.06
Nodes (54): pruneStaleCheckpointRefs(), cleanFile(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+46 more)

### Community 90 - "Cliproxy Process Lifecycle Management"
Cohesion: 0.06
Nodes (56): contextEditCommand(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextValidateCommand(), LayerName, resolveLayerFile(), resolveProjectRoot() (+48 more)
...
Cohesion: 0.07
Nodes (59): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+51 more)
...
Cohesion: 0.05
Nodes (42): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, ComplexityModels, DashScopeModel (+34 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.06
Nodes (53): injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook(), updateTtsConfig() (+45 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.04
Nodes (44): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession() (+36 more)

### Community 97 - "Conversation Panel and Chat Phase Types"
Cohesion: 0.08
Nodes (41): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), resolveShadowModePromise(), CanonicalState, createShadowState(), createShadowStatePromise() (+33 more)
...
Cohesion: 0.04
Nodes (44): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, first (+36 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.08
Nodes (50): clearFeedbackFiles(), clearFeedbackFilesPromise(), inferIssueIdFromWorkspace(), readPendingFeedback(), FsError, deriveProjectRoot(), readWorkspaceContext(), writeWorkspaceContext() (+42 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.04
Nodes (46): doc, path, badPath, customPlanningDir, dir, doc, draftPath, item (+38 more)
...
Cohesion: 0.07
Nodes (44): content, mockExeca, clearReviewStatus(), CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, LifecycleContext (+36 more)

### Community 105 - "Issue Tracker Linking Tests"
Cohesion: 0.06
Nodes (48): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win (+40 more)

### Community 106 - "Release and Update CLI Commands"
Cohesion: 0.05
Nodes (36): completeSession(), completeSessionSync(), DEFAULT_DATA, findSessionById(), findSessionByIdSync(), getAllIssuesWithCosts(), getAllIssuesWithCostsSync(), getIssueCostSummary() (+28 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.07
Nodes (44): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+36 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.05
Nodes (47): runMemoryFtsTransaction(), emitMemoryHealthChanged(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate (+39 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.09
Nodes (56): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex() (+48 more)
...
Cohesion: 0.05
Nodes (45): autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate() (+37 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.07
Nodes (55): addCommentBefore(), ALIAS, anchorIsValid(), atDocument(), callVisitor(), clone(), constructor(), createNode() (+47 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.1
Nodes (43): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile() (+35 more)
...
Cohesion: 0.06
Nodes (48): applicableLayers(), assertPathInside(), buildContextCatalog(), buildContextLayerState(), contentForLayer(), ContextCatalog, contextDirForFile(), ContextLayerState (+40 more)

### Community 117 - "Specialist Agent Prompts and Audit Docs"
Cohesion: 0.08
Nodes (45): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+37 more)

### Community 118 - "Agent Hook Scripts and Repo Artifact Design"
Cohesion: 0.07
Nodes (43): FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+35 more)

### Community 119 - "vBRIEF Continue State and Feedback Writing"
Cohesion: 0.07
Nodes (42): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), cleanupLegacyRuntimeSymlinksSync(), convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders() (+34 more)
...
Cohesion: 0.05
Nodes (46): TtsDaemonStartResult, TtsDaemonStatus, CappedBodyReadResult, CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute (+38 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.07
Nodes (29): TLDR Daemon - Background Index Manager, mockStop, stop(), captureTldrMetrics(), captureTldrMetricsSync(), daemonRegistry, ensureTldrStateDir(), execAsync (+21 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.05
Nodes (45): DEFAULT_FLYWHEEL_CONFIG, fetchFlywheelConversation(), fetchJson(), findFlywheelConversation(), FlywheelConversationPane(), FlywheelConversationPaneProps, FlywheelPaneViewMode, FlywheelRoleConfig (+37 more)
...
Cohesion: 0.08
Nodes (39): applyStash(), applyStashPromise(), buildStashMessage(), CanonicalStashKind, createNamedStashPromise(), createRecoveryBranchFromStash(), createRecoveryBranchFromStashPromise(), dropStashPromise() (+31 more)
...
Cohesion: 0.07
Nodes (35): applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels() (+27 more)
...
Cohesion: 0.04
Nodes (42): mockConfig, mockGetIssue, parentWorkspace, planDoc, specsDir, written, agentMocks, readlineMocks (+34 more)
...
Cohesion: 0.07
Nodes (46): AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, Verification Gate (PAN-174), Beads prerequisite for work agent start (422 without), Context digest (cross-dispatch memory for test/merge agents), Convoy - Parallel Review Panel, Deacon health monitor (30s patrol, stuck detection), Deft Framework (AI development framework) (+38 more)

### Community 142 - "UI Design Assets and Screen Exports"
Cohesion: 0.07
Nodes (39): SETTINGS_FILE, available, content, defaults, defaults1, defaults2, invalidSettings, settings (+31 more)

### Community 143 - "Issue State Mapping and Workflow Labels"
Cohesion: 0.07
Nodes (38): contextDiffCommand(), contextSyncCommand(), renderLayerForHarness(), assembleWorkspaceContext(), claude, out, pf, WorkspaceContextInput (+30 more)
...
Cohesion: 0.07
Nodes (38): runPreflight(), runStreaming(), err, getVBriefACStatusSync(), beads, capturedArgs, err, mockExecFileFn (+30 more)
...
Cohesion: 0.09
Nodes (43): advanceBudgetRecord(), DEFAULT_DOCS_CONFIG, docsBudgetKey(), DocsBudgetRecord, DocsBudgetState, DocsDisableEntry, DocsDisableScope, DocsDisableState (+35 more)
...
Cohesion: 0.1
Nodes (42): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+34 more)
...
Cohesion: 0.06
Nodes (36): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+28 more)

### Community 159 - "Specialist Registry and Run Lifecycle"
Cohesion: 0.05
Nodes (42): calculateCostSync(), CostEntry, DEFAULT_PRICING, getPricingSync(), logUsageSync(), ModelPricing, anthropicModels, cost (+34 more)
...
Cohesion: 0.08
Nodes (32): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), getDefaultConfig() (+24 more)

### Community 169 - "Git Push Operations and Approval"
Cohesion: 0.09
Nodes (38): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), execAsync, execFileAsync, getBeadDescription(), InspectContext, InspectResult (+30 more)

### Community 170 - "Specialist Workflow Documentation and Gates"
Cohesion: 0.06
Nodes (40): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse (+32 more)
...
Cohesion: 0.06
Nodes (43): CHANGELOG [0.7.0] Command Taxonomy Reorganization, pan plan Command, pan start Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset), Five-bucket CLI taxonomy (lifecycle, observation, managed nouns, system, admin), Plain-text fixture test convention (tests/fixtures/*.txt) (+35 more)
...
Cohesion: 0.07
Nodes (43): Agent Audit Report (2026-04-13), AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), Build Pipeline Documentation, buildTaskPrompt() (specialist prompt dispatch), CloisterBanner Component (+35 more)

### Community 184 - "Issue Filtering and Model Fallback Tests"
Cohesion: 0.14
Nodes (30): IssueNotFound, getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), config, originalEnv, tracker, AnyTrackerError (+22 more)
...
Cohesion: 0.06
Nodes (35): Close-Out Ceremony, Devroot Pattern for Skill Placement, .pan/ Project Directory Structure, Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Issue Lifecycle (Backlog → Todo → In Progress → In Review → Done), Panopticon Kanban Board (4 Columns) (+27 more)
...
Cohesion: 0.08
Nodes (36): isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync, GhPullRequest, hasRecentActivity() (+28 more)
...
Cohesion: 0.08
Nodes (36): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+28 more)
...
Cohesion: 0.08
Nodes (34): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+26 more)

### Community 209 - "Deacon Cleanup and Agent Status Tests"
Cohesion: 0.07
Nodes (24): ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller() (+16 more)

### Community 210 - "Cloister Service Health Tests"
Cohesion: 0.11
Nodes (31): buildFileDiffRenderKey(), clearDiffParamsFromUrl(), DiffFilePickerList(), DiffPanel(), DiffPanelProps, DiffThemeType, formatShortTimestamp(), getRenderablePatch() (+23 more)
...
Cohesion: 0.08
Nodes (35): CliproxyCodexCredentials, getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError (+27 more)

### Community 218 - "LLM Work Type Fit Research"
Cohesion: 0.09
Nodes (32): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), resolveAlsoSyncTools(), resolveAlsoSyncToolsSync(), runMultiToolSync() (+24 more)
...
Cohesion: 0.09
Nodes (31): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), formatTransition(), getProjectPath(), pad() (+23 more)
...
Cohesion: 0.09
Nodes (36): composeAlias(), composeCollection(), composeDoc(), composeEmptyNode(), composeNode(), composeScalar(), containsNewline(), doubleQuotedValue() (+28 more)

### Community 235 - "Review Test Merge Pipeline Docs"
Cohesion: 0.09
Nodes (30): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsNotFoundError (+22 more)
...
Cohesion: 0.08
Nodes (30): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync, HandoffContext (+22 more)

### Community 238 - "Workspace Teardown and Reopen Tests"
Cohesion: 0.09
Nodes (31): GLOBAL_CONFIG_PATH, detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG (+23 more)
...
Cohesion: 0.07
Nodes (29): changedFiles, errOutput, fetchMock, mockFetch(), output, err, exec(), execFile() (+21 more)

### Community 242 - "OpenAI Auth and Cliproxy Bridge"
Cohesion: 0.19
Nodes (34): killTmuxSession(), removeWorktree(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearProjectBeadsImpl(), clearShadowState(), clearShadowStateImpl() (+26 more)
...
Cohesion: 0.09
Nodes (31): after, backupPath, backups, calls, errSpy, exitSpy, original, out (+23 more)
...
Cohesion: 0.11
Nodes (29): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+21 more)

### Community 247 - "Label Cleanup and Workflow Lifecycle Tests"
Cohesion: 0.12
Nodes (33): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+25 more)

### Community 248 - "Pi Extension Session Event Handlers"
Cohesion: 0.1
Nodes (32): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, getWorkspaceStackHealth, health, now, projectRoot (+24 more)
...
Cohesion: 0.12
Nodes (30): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise(), getContextDigestPath(), getContextDirectory() (+22 more)
...
Cohesion: 0.1
Nodes (24): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+16 more)
...
Cohesion: 0.17
Nodes (33): atLineEnd(), charAt(), compose(), continueScalar(), decorate(), end(), getLine(), hasChars() (+25 more)
...
Cohesion: 0.13
Nodes (23): payload, dangerBanner(), DangerousGitOpError, DangerousOp, DangerousOpBlockedError, dryRunGitClean(), dryRunGitCleanPromise(), execAsync (+15 more)

### Community 281 - "Conversation Terminal Integration Refactor"
Cohesion: 0.09
Nodes (27): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, YamlConfig, cloneTtsConfig(), currentConfig (+19 more)
...
Cohesion: 0.1
Nodes (29): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), dedupeRows(), listCommand(), getTrackerConfig(), getTriageStatePath() (+21 more)
...
Cohesion: 0.06
Nodes (31): Codex OAuth Authentication, 1. JWT Expiry (Primary), 2. CLIProxy Log Tailing (Secondary), Automatic Retry, Bridging to CLIProxy, code:block1 (~/.panopticon/cliproxy/auth/codex-primary.json), code:bash (curl http://localhost:3000/api/settings/codex-auth), code:bash (pan config get issue-agent:implementation) (+23 more)
...
Cohesion: 0.14
Nodes (31): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+23 more)
...
Cohesion: 0.12
Nodes (11): LRUCache, openSqliteDb(), formatProbeError(), constructor(), CACHE_DB_PATH, CacheEntry, CacheService, L1Entry (+3 more)

### Community 300 - "Git Rebase and Conflict Resolution"
Cohesion: 0.06
Nodes (26): beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads (+18 more)

### Community 301 - "Experimental Channels Toggle Tests"
Cohesion: 0.1
Nodes (22): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, subscribeVoiceSettings() (+14 more)
...
Cohesion: 0.12
Nodes (29): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+21 more)
...
Cohesion: 0.12
Nodes (25): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPane(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+17 more)
...
Cohesion: 0.11
Nodes (23): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps (+15 more)
...
Cohesion: 0.11
Nodes (26): CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, computeMessageDurationStart(), deriveMessagesTimelineRows(), EstimateHeightInput (+18 more)

### Community 327 - "Dashboard Motion Animation Catalog"
Cohesion: 0.11
Nodes (26): AgentStateIssue, cleanupAgentDirectoriesPromise(), cleanupClosedIssueAgentDirectoriesPromise(), CleanupResult, ClosedIssueAgentCleanupResult, ClosedIssueAgentDir, directoryContainsJsonl(), findClosedIssueAgentDirs() (+18 more)
...
Cohesion: 0.1
Nodes (23): mockGetRuntimeForAgent, buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers (+15 more)
...
Cohesion: 0.11
Nodes (13): DEFAULT_STORE, formatIssueRef(), LinkDirection, LinkManager, LinkStore, parseIssueRef(), pathExists(), link (+5 more)

### Community 358 - "Coding Agent Harness Policy"
Cohesion: 0.18
Nodes (25): hookCommand(), HookOptions, checkAgentForViolations(), generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync() (+17 more)
...
Cohesion: 0.12
Nodes (23): Agent Domain Events, API error auto-nudge (retry on transient error), per-bead implementation workflow, .pan/continue.json structured context, hooks.log (stop-hook invocation log), requiresInspection bead flag (Jidoka gate), notifications.jsonl log (500 entry cap), pan_emit_event function (+15 more)
...
Cohesion: 0.17
Nodes (23): checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost() (+15 more)
...
Cohesion: 0.09
Nodes (26): Cloister lifecycle watchdog, src/lib/cloister/inspect-agent.ts, Inspect Specialist checkpoint system (commit-based diff scoping), Inspect Specialist (inspect-agent), PAN-382: Inspect Specialist — Per-Step Verification, Jidoka Principle — never pass a foundation-class defect downstream, pan inspect <issueId> --bead <beadId> CLI command, metadata.requiresInspection per-bead flag (+18 more)
...
Cohesion: 0.09
Nodes (15): MOCK_PROJECT, mockCreateWorkspace, mockExistsSync, mockLoadProjectsConfig, mockRemoveWorkspace, mockStopWorkspaceDocker, program, MOCK_PROJECT (+7 more)
...
Cohesion: 0.09
Nodes (23): existingSkillDir, existsInTarget, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync, sourcePath (+15 more)
...
Cohesion: 0.21
Nodes (17): execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise(), gitPush() (+9 more)
...
Cohesion: 0.14
Nodes (17): INFERENCE.md Artifact, getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise(), resolveShadowMode() (+9 more)
...
Cohesion: 0.09
Nodes (22): MODELS_BY_PROVIDER, Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData() (+14 more)
...
Cohesion: 0.14
Nodes (18): checkTtsHealth(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent() (+10 more)
...
Cohesion: 0.18
Nodes (16): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getCloisterService() (+8 more)
...
Cohesion: 0.1
Nodes (21): ApiKeysConfig, PROVIDER_INFO, ProviderPanel(), ProviderPanelProps, ApiKeysConfig, DeprecationWarning, Harness, MemorySettingsConfig (+13 more)
...
Cohesion: 0.14
Nodes (11): collectMail(), collectMailSync(), getHookDir(), getMailDir(), Hook, HookItem, initHook(), initHookSync() (+3 more)
...
Cohesion: 0.1
Nodes (16): closeResult, command, ctx, editCalls, labelResult, prResult, calls, ctx (+8 more)
...
Cohesion: 0.1
Nodes (20): activeIssues, date1, date2, expectedOrder, filtered, filteredIds, filterRecentCompletedIssues(), getOneDayAgo() (+12 more)

### Community 485 - "Community 485"
Cohesion: 0.1
Nodes (19): agentDir, dir1, dir2, marker, missing, nested, backup, backup1 (+11 more)
...
Cohesion: 0.15
Nodes (19): AGENT_STATUS_DOT, AgentCard(), AgentCardProps, ContainerCard(), ContainerCardProps, formatBytes(), STATUS_DOT, STATUS_LABEL (+11 more)
...
Cohesion: 0.14
Nodes (17): relativeTime(), showCommand(), ShowOptions, confirmDropRecovery(), isSwarmRecoverAction(), recoverSwarmCommand(), registerSwarmCommands(), resolveBareNumericId() (+9 more)
...
Cohesion: 0.13
Nodes (16): RoundMarker, deriveRoundMarkers(), TimestampedItem, ChatMessage, markers, MESSAGES, meta, divider (+8 more)
...
Cohesion: 0.15
Nodes (18): Claude Code Channels (Experimental), scriptPath, confirmDelivery() (tmux delivery verification), Heartbeat Hook (PostToolUse), PAN-798 Research & Audits Document, PAN-800 — tmux Hook Replacement, PTY Hub Ring Buffer (WebSocket terminal snapshot), execFileAsync (+10 more)
...
Cohesion: 0.18
Nodes (15): archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), movePrdImpl() (+7 more)

### Community 518 - "Community 518"
Cohesion: 0.15
Nodes (15): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+7 more)

### Community 519 - "Community 519"
Cohesion: 0.13
Nodes (13): ActivityFeedCard(), ActivityFeedCardProps, ActivitySessionFeedEntry, CommentSessionFeedEntry, FileChangeSessionFeedEntry, GitSessionFeedEntry, PlaceholderSessionFeedEntry, SessionFeedEntryBase (+5 more)
...
Cohesion: 0.17
Nodes (13): cleanupStaleLocksPromise(), execAsync, findGitLockFiles(), getWorkspaceGitInfoPromise(), hasRunningGitProcesses(), hasStaleLocks(), hasStaleLocksPromise(), execAsync (+5 more)

### Community 541 - "Community 541"
Cohesion: 0.11
Nodes (17): DeaconConfig, config, config1, config2, CONFIG_FILE, customConfig, DEACON_DIR, final (+9 more)

### Community 542 - "Community 542"
Cohesion: 0.2
Nodes (15): createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt(), WhiteboardAgentGuard (+7 more)

### Community 543 - "Community 543"
Cohesion: 0.12
Nodes (15): AutoPresoAgentSettings, AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode, AutoPresoSnapshot, createWarmupUserMessage(), createWhiteboardSession(), ProcessTranscriptResult (+7 more)

### Community 544 - "Community 544"
Cohesion: 0.15
Nodes (16): listener(), wrapped(), DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings(), loadVoiceSettings(), normalizeVoiceSettings(), notifyVoiceSettings() (+8 more)
...
Cohesion: 0.17
Nodes (11): calls, calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+3 more)

### Community 588 - "Community 588"
Cohesion: 0.17
Nodes (8): isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv(), readWatchdogConfig()
...
Cohesion: 0.12
Nodes (13): getActiveSessionModelSync(), claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+5 more)
...
Cohesion: 0.2
Nodes (12): ExcalidrawElement, finiteNumber(), normalizeExcalidrawElement(), randomId(), randomNonce(), extractKeywords(), textFromElement(), canvas (+4 more)

### Community 618 - "Community 618"
Cohesion: 0.19
Nodes (13): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), PermissionPayloadValidationError, utf8ByteLength(), buildPermissionActivityDetails(), normalizePermissionRequestBody() (+5 more)
...
Cohesion: 0.14
Nodes (13): dir, event, eventsDir1, eventsDir2, line, lines, mockListProjects, parsed (+5 more)
...
Cohesion: 0.22
Nodes (11): BranchNode(), BranchNodeProps, ContainerNodeProps, PrNode(), PrNodeProps, countLabel(), getStorageKey(), readExpanded() (+3 more)
...
Cohesion: 0.31
Nodes (12): getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), detectBranch(), detectFilesChanged(), detectPrUrl(), detectPrUrlForRepo(), execAsync (+4 more)
...
Cohesion: 0.15
Nodes (12): syncContextLayers(), syncExitCode(), syncOutput(), content, error, exists(), fixtureProject(), globalFile (+4 more)
...
Cohesion: 0.24
Nodes (10): detectTestCommand(), detectTestCommandEffect(), detectTestCommandSync(), fileExists(), command, jestConfig, packageJson, testDir (+2 more)
...
Cohesion: 0.2
Nodes (8): DEACON_DIR, DeaconState, DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData
...
Cohesion: 0.2
Nodes (8): data, mockExistsSync, mockReadFile, mockUnlink, runner, mockUnlinkSync, mockReadFileSync, PendingLifecycleData
...
Cohesion: 0.22
Nodes (8): addPanopticonHookIfMissing(), ClaudeSettings, isHookConfigured(), added, first, home, second, settings
...
Cohesion: 0.36
Nodes (7): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), startApp()

### Community 933 - "Community 933"
Cohesion: 0.32
Nodes (6): childEnv, desktopDir, __dirname, resolveElectronPath(), child, childEnv
...
Cohesion: 0.29
Nodes (5): entries, entries, messages, workLog, workLog
...
Cohesion: 0.73
Nodes (5): DiffRouteSearch, isDiffOpenValue(), normalizeSearchString(), parseDiffRouteSearch(), stripDiffSearchParams()
...
## Knowledge Gaps
- **14105 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14100 more)
...
- **Why does `specialists` connect `VBrief Plan Builder and Viewer` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Agent Runtime Spawning`, `Panopticon 1.0 Stabilization Audit`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Issue Triage Agent and Analysis`, `Parallel Review Pipeline Dispatch`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Review Agent Feedback Planning`, `Health Metrics and Settings Pages`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `GodView Socket and Activity Feed`, `Specialist Handoff Logging and Queue Depth`, `Cost Events Database and WAL Sync`, `Feature Context and Planning Session Spawn`, `Cost Calculation and Token Usage`, `VBrief Beads IO and Plan Finalize`, `Review Round Status Badge UI`, `Git Push Operations and Approval`, `Model Routing and Specialist Redesign Research`, `Workspace Metadata and Project Config`, `VBrief Task Readiness and Beads IO`, `Issue Tracker Polling Service`, `Settings Page Model Override and Auth`, `Issue Lifecycle Service and Tests`, `Agent Feedback Delivery and Logging`, `Path Constants and Postinstall Setup`, `Root Artifact Cleanup Policy`, `Activity Panel and VTT Parsing`, `Work Agent Prompt and Reopen Flow`, `Frontend Dashboard Component Tests`, `Traefik DNS and Platform Install Skills`, `Config Migration and Test Agent`, `Git Lock File Utilities`, `Pending Lifecycle Event Processing`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Cloister Service Handoff Logging` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Event Store Domain Services`, `UI Design Assets and Screen Exports`, `Electron Desktop App and Tray`, `Remote Workspace Provider Skills`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `Command Deck Zone B Session Nodes`, `Cost Events Database and WAL Sync`, `VBrief Beads IO and Plan Finalize`, `Cloister Config Deep Merge`, `Workspace and Version API Routes`, `Platform Supervisor Startup Lifecycle`, `Settings Page Model Override and Auth`, `Issue Lifecycle Service and Tests`, `System Health and Spawn Guardrails`, `Server Cache Service and Chat Markdown`, `Agent List and Handoff Status UI`, `Workspace Teardown and Label Cleanup`, `Swarm Dispatch and DAG Execution`, `Specialist Run Log Viewer`, `Settings Persistence and Model Defaults`, `Path Constants and Postinstall Setup`, `Skills Merge and Manifest Sync`, `Community 472`, `Frontend Dashboard Component Tests`, `Community 473`, `Multi-Tracker Adapter Implementations`, `Rally Tracker Adapter Tests`, `Issue Tracker Linking Tests`, `Issue Planning and Tracker Resolution`, `Cost Event Storage and WAL Tests`, `Electron Desktop App Docs`, `Label Cleanup and Workflow Lifecycle Tests`, `FPP Policy Violation Detection and Nudging`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `string()` connect `Inspector Panel Terminal UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Parallel Review Pipeline Dispatch`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Health Metrics and Settings Pages`, `Workspace Lifecycle and Config`, `Tmux Terminal Session Management`, `Git Activity and Runtime Metrics`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `VBrief Lifecycle IO and Transitions`, `Specialist Metadata and Grace Period`, `CLI Commands and Runtime Adapters`, `Community 540`, `GodView Socket and Activity Feed`, `Cost Calculation and Token Usage`, `VBrief Beads IO and Plan Finalize`, `Project Tree Feature Items UI`, `Review Round Status Badge UI`, `Dashboard Design Docs and Mockups`, `Cost Event Aggregation and Retention`, `Chat Messages Timeline Rendering`, `Work Type Routing and Config`, `Dashboard App Sidebar and Metrics`, `Chat Composer Model Picker`, `Community 558`, `Model Selection and Subscription Policy`, `Codex Agent Spawn UI Flow`, `VBrief Task Readiness and Beads IO`, `Platform Supervisor Startup Lifecycle`, `Settings Provider and Model Browser UI`, `Multi-Tool Sync and MCP Isolation`, `Permission Request Bridge and Forwarding`, `GitHub Webhook Ingestion Handlers`, `GitHub Client and Agent Spawner`, `Multi-Tracker Runtime Adapter Interface`, `Checkpoint Capture and Diff Routes`, `Community 588`, `Resource-Allocated Issue Discovery`, `Issue Search Modal and Filter State`, `Plan DAG Visualization and Beads Panel`, `Cloister Orchestrator Architecture PRDs`, `Frontend Dashboard Component Tests`, `Multi-Tracker Adapter Implementations`, `User Documentation and Provider Guides`, `Rally Tracker Adapter Tests`, `Desktop Menu and Auto-Updater Lifecycle`, `Project Config and Team Prefix Resolution`, `Release and Update CLI Commands`, `Config Migration and Test Agent`, `Cloister Pipeline Unit Tests`, `Project Registration and Test Runner`, `TLDR Daemon State Management`, `Specialist Pipeline PRDs and Skills`, `Smee Webhook Proxy Process Management`, `Specialist Agent Prompts and Audit Docs`, `Agent Hook Scripts and Repo Artifact Design`, `Reviewer Tree and Command Deck Dashboard`, `Community 640`, `Conversation Smart Compaction`, `Conversation Attachment Lifecycle Management`, `Community 645`, `Community 647`, `Shadow Engineering Observer and Monitoring`, `UI Design Assets and Screen Exports`, `Claude Session JSONL Parsing and Costs`, `Remote Workspace Provider Skills`, `Feature Context and Planning Session Spawn`, `Specialist Workflow Documentation and Gates`, `Community 685`, `Agent Cost Monitoring and Limit Enforcement`, `Community 688`, `Turn Diff File Change Tree UI`, `Community 716`, `Community 718`, `CLI Init and Shell Configuration`, `Cloister Watchdog and Merge Validation Docs`, `Parallel Code Review Skills`, `OpenAI Auth and Cliproxy Bridge`, `Electron Desktop App Docs`, `Agent Prompt Hardening and Decision Locking`, `Label Cleanup and Workflow Lifecycle Tests`, `Pi Extension Session Event Handlers`, `Dashboard Caching Architecture Docs`, `Model Routing Changelog and Configuration`, `Caveman Variant Config and Specialist Tests`, `Agent Enrichment and Phase Detection`, `TTS Sidecar Audio Notification System`, `Dashboard Motion Animation Catalog`, `Root Artifact Cleanup Policy`, `Community 860`, `Review Agent Feedback Planning`, `LLM Model Research Summary`, `Community 440`, `Community 441`, `Community 442`, `Community 502`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14105 weakly-connected nodes found - possible documentation gaps or missing edges._
