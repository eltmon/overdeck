...
## Corpus Check
- 1652 files · ~2,239,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23410 nodes · 35719 edges · 1189 communities (1148 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 491 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a11df590`
...
7. `listSessionNamesAsync()` - 53 edges
8. `spawnRun()` - 52 edges
9. `spawnAgent()` - 52 edges
...
## Communities (1189 total, 41 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (202): loadStartCommand(), spawnInspectAgent(), sendFeedbackToWorkAgent(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), resolveWorkspaceForIssue(), buildSpecialistBaseCommand(), killCommand() (+194 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (153): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState() (+145 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (144): checkMissingReviewStatuses(), checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), monitorReviewConvoySignals(), PatrolResult (+136 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (122): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AlertOptions, ConfirmOptions (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (148): archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview() (+140 more)
...
Cohesion: 0.03
Nodes (127): showCommand(), cont, doc, projectRoot, specsDir, workspace, deriveProjectRoot(), queueAutoCommit() (+119 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (128): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+120 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (133): loadDeaconWithResumeMock(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews() (+125 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (90): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+82 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (96): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), BeadsTask, COMPLEXITY_KEYWORDS (+88 more)
...
Cohesion: 0.02
Nodes (94): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+86 more)
...
Cohesion: 0.04
Nodes (103): readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContinue(), writeWorkspaceContinue() (+95 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (80): parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent, mockKillAgent (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (94): checkApiErrorAgents(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+86 more)
...
Cohesion: 0.03
Nodes (69): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc (+61 more)
...
Cohesion: 0.03
Nodes (80): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, formatBytes() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (87): dequeueMerge(), ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), completePendingOperation(), ContainerPortBinding (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (73): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (81): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync (+73 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (78): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, requireTrustedOrigin(), cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+70 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (78): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+70 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (69): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+61 more)
...
Cohesion: 0.03
Nodes (61): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (72): CopyConfigOptions, devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep() (+64 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (71): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, mockLoadProjectsConfig, mockRunQualityGates (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (69): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+61 more)
...
Cohesion: 0.04
Nodes (76): clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, WorkhorsesConfig, WorkhorseSlot, MODEL_DEPRECATIONS (+68 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (68): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+60 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (59): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+51 more)
...
Cohesion: 0.03
Nodes (55): beadsDir, doc, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+47 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (57): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, DASHBOARD_URL, RequestReviewOptions (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (63): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+55 more)
...
Cohesion: 0.06
Nodes (50): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+42 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (51): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry (+43 more)
...
Cohesion: 0.06
Nodes (39): ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (49): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, execAsync, execFileAsync, firePostMergeLifecycle(), getModelsResolveRoute, getProjectPathForIssue() (+41 more)
...
Cohesion: 0.06
Nodes (51): Access, AIProvider, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats() (+43 more)
...
Cohesion: 0.05
Nodes (38): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getExistingLiveReauthSession(), getLiveReauthSession() (+30 more)
...
Cohesion: 0.06
Nodes (43): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe() (+35 more)
...
Cohesion: 0.07
Nodes (40): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+32 more)
...
Cohesion: 0.06
Nodes (28): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+20 more)
...
Cohesion: 0.08
Nodes (34): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+26 more)
...
Cohesion: 0.07
Nodes (26): ArtifactLinks(), ArtifactLinksProps, EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, refreshDashboardState(), CacheEntry, clearSnapshotCache() (+18 more)
...
Cohesion: 0.09
Nodes (35): AwaitingInputDetection, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+27 more)
...
Cohesion: 0.11
Nodes (32): addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult, LinearComment (+24 more)

### Community 151 - "Community 151"
Cohesion: 0.1
Nodes (30): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+22 more)
...
Cohesion: 0.08
Nodes (32): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+24 more)
...
Cohesion: 0.13
Nodes (29): assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths(), getAttachmentCache(), getAttachmentCacheKey() (+21 more)
...
Cohesion: 0.1
Nodes (28): computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), isSmeeRunning(), errorSpy (+20 more)
...
Cohesion: 0.09
Nodes (18): ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps (+10 more)
...
Cohesion: 0.16
Nodes (22): killAllReviewSessions(), healthCommand(), HealthOptions, AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile() (+14 more)
...
Cohesion: 0.17
Nodes (23): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus() (+15 more)
...
Cohesion: 0.19
Nodes (15): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), getProject() (+7 more)
...
Cohesion: 0.22
Nodes (13): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+5 more)
...
Cohesion: 0.16
Nodes (12): delay, errorSpy, logSpy, mockExistsSync, mockLoadConfig, mockReadFileSync, mockStart, mockStop (+4 more)
...
Cohesion: 0.2
Nodes (11): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus (+3 more)
...
## Knowledge Gaps
- **12288 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12283 more)
...
- **Why does `fetch` connect `Community 6` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 519`, `Community 9`, `Community 10`, `Community 137`, `Community 12`, `Community 13`, `Community 397`, `Community 14`, `Community 274`, `Community 19`, `Community 20`, `Community 21`, `Community 278`, `Community 23`, `Community 24`, `Community 152`, `Community 795`, `Community 27`, `Community 28`, `Community 30`, `Community 671`, `Community 673`, `Community 36`, `Community 39`, `Community 40`, `Community 297`, `Community 169`, `Community 43`, `Community 45`, `Community 559`, `Community 47`, `Community 181`, `Community 54`, `Community 55`, `Community 184`, `Community 57`, `Community 62`, `Community 64`, `Community 580`, `Community 586`, `Community 220`, `Community 348`, `Community 104`, `Community 115`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 9` to `Community 0`, `Community 1`, `Community 418`, `Community 350`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 522`, `Community 399`, `Community 17`, `Community 150`, `Community 22`, `Community 24`, `Community 30`, `Community 159`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 11` to `Community 0`, `Community 1`, `Community 4`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12288 weakly-connected nodes found - possible documentation gaps or missing edges._
