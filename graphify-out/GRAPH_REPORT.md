...
## Corpus Check
- 1545 files · ~2,059,455 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21581 nodes · 31945 edges · 1139 communities (1104 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4aa43ab3`
...
Cohesion: 0.02
Nodes (178): readCavemanVariant(), checkApiErrorAgents(), patrolWorkAgentResolutions(), isMergeAgentRunning(), spawnRebaseAgentForBranch(), buildSpecialistCavemanExports(), recoverCommand(), RecoverOptions (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (145): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+137 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (136): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (105): PlanningState, ZoneAActionsState, DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost() (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (134): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), cleanupOrphanedReviewSessions(), agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState (+126 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (111): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+103 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (113): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+105 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (115): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+107 more)
...
Cohesion: 0.03
Nodes (83): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+75 more)
...
Cohesion: 0.02
Nodes (78): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+70 more)
...
Cohesion: 0.03
Nodes (75): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (74): checkPostReviewCommits(), pendingCommand(), after, before, blockers, result, statuses, after (+66 more)
...
Cohesion: 0.03
Nodes (69): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (70): checkFailedMergeRetry(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+62 more)
...
Cohesion: 0.03
Nodes (65): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, formatCost(), IssueHeader(), IssueHeaderProps (+57 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (71): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState() (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (42): stopDeacon(), createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+34 more)
...
Cohesion: 0.05
Nodes (71): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+63 more)
...
Cohesion: 0.04
Nodes (64): setAgentStoppedNotifier(), generateFallbackSummary(), ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+56 more)
...
Cohesion: 0.04
Nodes (56): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (59): buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+51 more)
...
Cohesion: 0.06
Nodes (47): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc, result, beadsDir (+39 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (48): useLiveFlash(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem() (+40 more)
...
Cohesion: 0.07
Nodes (55): checkStuckWorkAgents(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands() (+47 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (48): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap() (+40 more)
...
Cohesion: 0.05
Nodes (42): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+34 more)
...
Cohesion: 0.06
Nodes (47): PrdLocation, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+39 more)
...
Cohesion: 0.09
Nodes (43): startPostLaunchSidecars(), startSidecars(), resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart() (+35 more)
...
Cohesion: 0.08
Nodes (34): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+26 more)
...
Cohesion: 0.07
Nodes (20): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+12 more)
...
Cohesion: 0.07
Nodes (29): SETTINGS_FILE, config, config1, config2, configDir, configPath, content, googleProvider (+21 more)
...
Cohesion: 0.1
Nodes (27): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), ARCHIVES_DIR (+19 more)
...
Cohesion: 0.15
Nodes (25): AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, CLAUDE_MD_TEMPLATES (+17 more)
...
Cohesion: 0.11
Nodes (23): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+15 more)
...
Cohesion: 0.15
Nodes (13): killCommand(), KillOptions, isRemoteAvailable(), execAsync, initCommand(), InitOptions, resourcesCommand(), ResourcesOptions (+5 more)
...
## Knowledge Gaps
- **11499 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11494 more)
...
- **Why does `fetch` connect `Community 5` to `Community 128`, `Community 641`, `Community 1`, `Community 131`, `Community 4`, `Community 8`, `Community 10`, `Community 11`, `Community 268`, `Community 12`, `Community 524`, `Community 13`, `Community 16`, `Community 525`, `Community 18`, `Community 276`, `Community 21`, `Community 24`, `Community 154`, `Community 418`, `Community 551`, `Community 46`, `Community 48`, `Community 177`, `Community 178`, `Community 179`, `Community 52`, `Community 53`, `Community 56`, `Community 72`, `Community 587`, `Community 210`, `Community 594`, `Community 86`, `Community 87`, `Community 218`, `Community 222`, `Community 750`, `Community 119`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 0`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 138` to `Community 250`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11499 weakly-connected nodes found - possible documentation gaps or missing edges._
