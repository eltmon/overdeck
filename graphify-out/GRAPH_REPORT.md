...
## Corpus Check
- 2080 files · ~3,633,440 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33012 nodes · 64050 edges · 1381 communities (1313 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1515 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `50732125`
...
8. `resolveProjectFromIssueSync()` - 126 edges
9. `config` - 121 edges
10. `getDatabase()` - 115 edges
...
## Communities (1381 total, 68 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (386): readCavemanVariant(), loadStartCommand(), __dirname, __filename, spawnInspectAgent(), spawnInspectAgentPromise(), spawnReviewCoordinatorSession(), spawnSingleReviewer() (+378 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.01
Nodes (312): loadDeaconWithResumeMock(), addLog(), apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+304 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.01
Nodes (194): ActivityView(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket (+186 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (230): getSpecialistState(), reconcileAndCheckIfMerged(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise() (+222 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (213): Agent Enrichment Service, Command Deck (Core Concept), Access, AgentEnrichment, computeAgentEnrichment(), computeAgentEnrichmentPromise(), execAsync, getAgentJsonlMtime() (+205 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.01
Nodes (205): HealthEvent, SpecialistHealthState, CloisterStatus, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus() (+197 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.03
Nodes (174): Work Agent (shown in inspector terminal), switchModel(), RoundVerdict, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps (+166 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (183): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+175 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.02
Nodes (186): logNonCanonicalStashesOnStartup(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+178 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (194): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash() (+186 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.01
Nodes (160): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause, catchIf (+152 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (105): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getAllSessionFiles(), getAllSessionFilesSync(), getProjectDirs(), getProjectDirsSync() (+97 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.03
Nodes (168): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkVerificationReviewContradiction(), clearStaleCiFeedback(), detectMergedSwarmSlots() (+160 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.03
Nodes (164): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+156 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.03
Nodes (142): approveCommand(), cancelCommand(), collectLifecycleRows(), completeCommand(), formatTransition(), getProjectPath(), pad(), printRowsTable() (+134 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.02
Nodes (143): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+135 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (116): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+108 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (124): Conversation, ConversationList(), ConversationListProps, fetchConversations(), ListTab, loadSort(), loadTab(), SORT_LABELS (+116 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.02
Nodes (150): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+142 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.02
Nodes (116): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+108 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.03
Nodes (130): extractAcceptanceCriteria(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext() (+122 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.02
Nodes (114): SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS, BeadTask, IssueActionDialogHost() (+106 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (130): HookEntry, getUnblockedItems(), getActiveSessionModel(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing() (+122 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (128): applyEnvironmentOverrides(), getHealthThresholdsMs(), loadCloisterConfig(), loadCloisterConfigSync(), loadConfig(), activeViolations, checkAgentForViolations(), clearOldViolations() (+120 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.02
Nodes (120): config, DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+112 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.02
Nodes (133): parseDifficultyLabel(), LiveLastHeard(), BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+125 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (108): BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer() (+100 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (110): determineCavemanVariant(), injectCavemanSettings(), addDnsEntry(), addHostsFileEntry(), addWsl2HostEntry(), createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig() (+102 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.02
Nodes (124): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues, output (+116 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.04
Nodes (101): buildPolyrepoContext(), closeOutCommand(), createCostCommand(), configCommand(), listTestsCommand(), runCommand(), RunOptions, addRepoCommand() (+93 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (107): annotated, before, candidate, check, claimed, defaults, doc, { doc: next } (+99 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (88): cont, doc, projectRoot, specsDir, workspace, IssueStatus, StartAgentGuardrailWarning, STATE_TYPE_TO_CANONICAL (+80 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (107): estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneDocsConfig() (+99 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (86): customPromisify, justNow, longAgo, old, recent, restartCalled, state, STATE_FILE (+78 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.04
Nodes (97): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger(), printWavePlan() (+89 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (77): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+69 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.04
Nodes (101): getSortKey(), sortConversations(), SortOption, listConversations(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse (+93 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.04
Nodes (86): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), onPlan, button (+78 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.03
Nodes (82): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature() (+74 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.03
Nodes (90): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+82 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.03
Nodes (81): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+73 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.03
Nodes (92): updateTtsConfig(), clearConfigCache(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, updateConversationsConfigAsync(), WorkhorsesConfig (+84 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (90): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, fmtCost(), ALL_TABS (+82 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.02
Nodes (81): activeAgent, cafSpy, client, menu, onNavigateToIssues, rafSpy, scrollSpy, tiles (+73 more)
...
Cohesion: 0.04
Nodes (72): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+64 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.03
Nodes (81): conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck(), tablist (+73 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.04
Nodes (74): formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, calculateCostSync(), checkBudget() (+66 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.02
Nodes (73): IssueStats, lines, activeBeadsIgnore, activePlanningBeadsIgnore, content, gitignorePath, lines, ROOT (+65 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.03
Nodes (76): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+68 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.05
Nodes (68): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+60 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.05
Nodes (74): __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth(), waitForHttp200() (+66 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.06
Nodes (86): add, addCommentBefore(), addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), applyReviver() (+78 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.04
Nodes (50): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+42 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.05
Nodes (73): ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity, writeObservations() (+65 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.04
Nodes (68): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+60 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.05
Nodes (51): checkCostLimits(), getCostSummary(), getDeaconLogs(), getLastPatrolResult(), stopDeacon(), createHandoffEvent(), ensureLogDir(), ensureLogDirAsync() (+43 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.04
Nodes (60): CodexAuthBanner(), ConfirmationDialog(), ConfirmationDialogProps, ConfirmationRequest, DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause() (+52 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.05
Nodes (68): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+60 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (71): adminRouteLayer, getAdminTldrRoute, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), requireTrustedOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+63 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.05
Nodes (67): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+59 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.03
Nodes (69): agentDir, missing, result, snapshot, status, missing, filterClosedIssueAgents(), discoverNewAgentIds() (+61 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (70): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+62 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.06
Nodes (65): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+57 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (66): TtsDaemonStartResult, TtsDaemonStatus, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput (+58 more)
...
Cohesion: 0.05
Nodes (69): handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+61 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.05
Nodes (68): chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources(), DEFAULT_DOCS_CONFIG, discoverDocsCorpusSources(), discoverMarkdownUnder() (+60 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.04
Nodes (64): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, after, backupPath (+56 more)

### Community 69 - "Swarm Dispatch and DAG Execution"
Cohesion: 0.05
Nodes (66): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), commentOnArtifactEffect() (+58 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.05
Nodes (65): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+57 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.05
Nodes (59): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ConversationPanel(), ConversationPanelProps (+51 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.05
Nodes (58): backup, backupCleanCommand(), backupListCommand(), PACKAGE_ROOT, restoreCommand(), restoreCommand(), BackupInfo, cleanOldBackups() (+50 more)

### Community 73 - "Merge Queue and App Settings Database"
Cohesion: 0.04
Nodes (60): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, EnqueueStatusRollup (+52 more)

### Community 74 - "Checkpoint Capture and Diff Routes"
Cohesion: 0.07
Nodes (51): error, IssueNotFound, createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config (+43 more)
...
Cohesion: 0.04
Nodes (60): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+52 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (56): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+48 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.06
Nodes (62): deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathEffect() (+54 more)
...
Cohesion: 0.1
Nodes (59): bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError, CliproxyGeminiCredentials (+51 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.04
Nodes (44): TLDR Daemon - Background Index Manager, captureTldrMetrics(), captureTldrMetricsSync(), daemonRegistry, ensureTldrStateDir(), execAsync, getPidFilePath(), getStateFilePath() (+36 more)
...
Cohesion: 0.05
Nodes (51): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), delay() (+43 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.07
Nodes (30): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), GitHubConfig, RallyConfig, scheduleNext() (+22 more)
...
Cohesion: 0.07
Nodes (46): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), cleanupTestFiles(), getUniqueId(), result, TEST_SHADOW_STATE_DIR (+38 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.06
Nodes (61): RawFilter, SearchMode, SearchQuery, SearchResult, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), DatabaseError (+53 more)
...
Cohesion: 0.05
Nodes (60): getCachedMessages(), isPiSessionFile(), CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock, ConversationActivitySummary (+52 more)
...
Cohesion: 0.05
Nodes (54): resetDb(), resetDb(), closeDatabase(), resetDatabase(), ExtractedPayload, fallback, identity, primary (+46 more)
...
Cohesion: 0.07
Nodes (48): content, mockExeca, clearReviewStatus(), CloseIssueOptions, LABELS_TO_REMOVE, ApproveOptions, ArchiveOptions, DeepWipeOptions (+40 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.05
Nodes (56): MODELS_BY_PROVIDER, Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, DEFAULT_MODELS_BY_WORK_TYPE, ACTIVITY_SOURCE_OPTIONS (+48 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.04
Nodes (51): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus (+43 more)
...
Cohesion: 0.04
Nodes (54): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse (+46 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.07
Nodes (56): PROVIDER_ENV_UNSETS, destroyRemoteWorkspace(), Role, DEFAULT_CONFIG, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand() (+48 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.06
Nodes (54): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, checkStoppedListClassification() (+46 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.05
Nodes (48): mockGetAgentHealth, computeStuckCount(), map, mockGetAgentHealth, mockGetCloisterService, mockGetStatus, mockListRunningAgents, mockLoadReviewStatuses (+40 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.04
Nodes (51): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+43 more)

### Community 103 - "Claude OAuth Authentication and Settings"
Cohesion: 0.07
Nodes (52): details, startRealConversationRoutes(), validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+44 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.06
Nodes (56): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+48 more)
...
Cohesion: 0.07
Nodes (56): injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook(), writeJsonFile() (+48 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.06
Nodes (47): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+39 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.05
Nodes (51): API_ERROR_PATTERNS, archiveReviewerRound(), ReviewerRoundArtifact, getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, dir (+43 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.06
Nodes (57): Agent Audit Report (2026-04-13), AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), Build Pipeline Documentation, buildTaskPrompt() (specialist prompt dispatch), CloisterBanner Component (+49 more)

### Community 110 - "Project Registration and Test Runner"
Cohesion: 0.08
Nodes (47): traefikDir, devCommand(), checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult (+39 more)

### Community 111 - "Issue Planning and Tracker Resolution"
Cohesion: 0.05
Nodes (36): categorizeToolUse(), CompressedTranscriptDelta, compressEntry(), compressJsonlBuffer(), compressTranscriptDelta(), CompressTranscriptDeltaInput, extractBashCommand(), extractText() (+28 more)

### Community 112 - "TLDR Daemon State Management"
Cohesion: 0.08
Nodes (44): areMemoryObservationsEnabled(), booleanOrDefault(), defaultMemorySettings(), getMemoryRollupPendingThreshold(), getMemoryWorkerConcurrency(), isMemoryPromptTimeInjectionEnabled(), isRecord(), loadMemorySettings() (+36 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.05
Nodes (44): systemHealthCommand(), delay(), data, mockExistsSync, mockReadFile, mockUnlink, runner, computeRestartDelay() (+36 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.06
Nodes (46): embedAction(), runWithPool(), WorkPoolStats, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getDiscoveredStats(), searchFts(), buildEmbeddingText() (+38 more)

### Community 115 - "Smee Webhook Proxy Process Management"
Cohesion: 0.07
Nodes (46): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+38 more)

### Community 116 - "Merge Set and Review Artifact Creation"
Cohesion: 0.05
Nodes (49): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+41 more)
...
Cohesion: 0.07
Nodes (42): migrateConfigCommand(), MigrateConfigOptions, migrateCommand(), BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), cleanupLegacyRuntimeSymlinksSync(), convertToYamlConfig(), convertToYamlConfigSync() (+34 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.04
Nodes (43): MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen, cache, capped (+35 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.05
Nodes (50): CLIProxy component, API Server (port 3002/3002), Dashboard Frontend (port 3001), Traefik reverse proxy, pan install command, pan up / pan down commands, pan workspace create command, # panopticon-auto hosts file marker (+42 more)

### Community 123 - "TTS Daemon and Pi Extension Supervisor"
Cohesion: 0.05
Nodes (43): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+35 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.09
Nodes (47): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+39 more)
...
Cohesion: 0.07
Nodes (42): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel() (+34 more)

### Community 127 - "Specialist Run Log Lifecycle"
Cohesion: 0.05
Nodes (35): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, mockExistsSync (+27 more)

### Community 128 - "Remote Agent Provisioning on Fly"
Cohesion: 0.06
Nodes (34): appendChannelDeliveryLog(), deliverAgentMessage(), deliverAgentPermissionDecision(), getBridgeHttpAgent(), panopticonHomeForChannels(), panopticonHomeForSockets(), postUnixSocketJson(), CloseOutContext (+26 more)

### Community 129 - "Claude Code Hook Management"
Cohesion: 0.04
Nodes (48): claudePlanningSystemPromptFiles(), clearCacheRoute, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute, getDeaconPauseRoute (+40 more)

### Community 130 - "AI Provider Health Probing"
Cohesion: 0.05
Nodes (48): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset) (+40 more)
...
Cohesion: 0.11
Nodes (35): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync(), collectMail() (+27 more)

### Community 138 - "Model Fallback and Routing"
Cohesion: 0.07
Nodes (35): applyFallback(), applyFallbackSync(), applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels() (+27 more)
...
Cohesion: 0.08
Nodes (38): getHealthEmoji(), getHealthLabel(), isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, statusCommand(), StatusOptions, statusCommand() (+30 more)
...
Cohesion: 0.04
Nodes (45): Vision: Local-First Deployment Phase, Vision Phase 2: Multi-Tenant SaaS, Vision Phase 1: Shared Team Instance, Agent Guidance, Agent System, Architecture & Design, Build & Development, Configuration (+37 more)

### Community 152 - "Remote Workspace Provider Skills"
Cohesion: 0.08
Nodes (41): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+33 more)
...
Cohesion: 0.07
Nodes (45): Agent Status Badge System, Agent Card — Grid View Component, Agents Page — Cloister Section Header, Agents Page — Deploy Agent CTA Button, Agents Page — Filter Button, Agents Page — KPI Stats Bar, Agents Page — Left Navigation Sidebar, Agents Page — Custom Right Panel (Results + Chart) (+37 more)
...
Cohesion: 0.08
Nodes (32): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+24 more)
...
Cohesion: 0.05
Nodes (35): PANOPTICON_HOME, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config (+27 more)

### Community 173 - "Cloister Prompt Loading and Parsing"
Cohesion: 0.1
Nodes (37): createRegistryCommand(), formatRegistryEntry(), formatRegistryList(), formatRow(), parsePositiveInteger(), RegistryListCommandOptions, RegistryShowCommandOptions, RegistryTagCommandOptions (+29 more)

### Community 174 - "Specialist Context Digest Generation"
Cohesion: 0.09
Nodes (40): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST() (+32 more)

### Community 175 - "Agent Cost Monitoring and Limit Enforcement"
Cohesion: 0.07
Nodes (39): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels() (+31 more)
...
Cohesion: 0.12
Nodes (41): atLineEnd(), charAt(), compose(), continueScalar(), decorate(), end(), getErrorPos(), getLine() (+33 more)

### Community 188 - "Workspace Manager Artifact Migration"
Cohesion: 0.07
Nodes (34): CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition (+26 more)

### Community 189 - "Project Skills Mirror and Sync"
Cohesion: 0.08
Nodes (35): GLOBAL_CONFIG_PATH, Platform, evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample (+27 more)

### Community 190 - "Agent Grid Dashboard UI Components"
Cohesion: 0.07
Nodes (33): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+25 more)

### Community 191 - "Codex Authentication and Credential Management"
Cohesion: 0.1
Nodes (33): readFeatureContext(), FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+25 more)
...
Cohesion: 0.16
Nodes (39): killTmuxSession(), removeWorktree(), cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), cleanupMergedLabelsImpl(), execAsync, buildPlaceholders() (+31 more)
...
Cohesion: 0.06
Nodes (27): RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue(), mapEventToDelta() (+19 more)
...
Cohesion: 0.1
Nodes (30): isAgentIdleForNudge(), StuckRemediationConfig, evaluateAgent(), evaluateFlywheelOrchestrator(), execFileAsync, firstStuckAt(), hasReadyBeads(), issueIdForAgent() (+22 more)

### Community 201 - "Project Repository Resolution"
Cohesion: 0.05
Nodes (40): CLI Distribution Strategy, code:yaml (# Your original docker-compose.yml), code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]) (+32 more)
...
Cohesion: 0.1
Nodes (32): runPreflight(), runStreaming(), getVBriefACStatusSync(), beads, capturedArgs, err, mockExecFileFn, mockExecFn (+24 more)
...
Cohesion: 0.07
Nodes (24): TranscriptCheckpoint, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller() (+16 more)
...
Cohesion: 0.05
Nodes (39): 10. Tracked Issues, 11. Implementation Scope, 1. Claude Code's Native Hierarchy, 2. Panopticon's Current Distribution (Broken), 3. Real-World Conflict: Mind Your Now, 4. Enterprise / Managed Policy, 5. Path Portability (Completed), 7. Rules: Planned Content (+31 more)
...
Cohesion: 0.08
Nodes (32): createDocsCommand(), DocsQueryOptions, printDocsQueryResult(), DocsDocKind, DocsEmbeddingInput, applyDocsQueryBounds(), centroidVector(), ChunkRow (+24 more)
...
Cohesion: 0.09
Nodes (32): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+24 more)

### Community 222 - "Caveman File Type Detection CLI"
Cohesion: 0.1
Nodes (30): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, getSmeeBinaryPath(), startSmeeProcess(), startSmeeProcessSync(), getSupervisorPort(), getSupervisorPortSync() (+22 more)

### Community 223 - "Agent Enrichment and Context Resolution"
Cohesion: 0.08
Nodes (36): deleted, cleanupOldHealthEvents(), DatabaseError, deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent() (+28 more)

### Community 224 - "Cost Tracking Architecture Docs"
Cohesion: 0.08
Nodes (26): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+18 more)
...
Cohesion: 0.1
Nodes (28): canonicalPrdSubdir(), canonicalPrdSubdirSync(), findDraftPrd(), findDraftPrdSync(), findPrdAnywhere(), findPrdAnywhereSync(), findPrdAtStatus(), findPrdAtStatusSync() (+20 more)
...
Cohesion: 0.08
Nodes (30): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), isEligibleForCleanup(), getIssueDataService() (+22 more)
...
Cohesion: 0.12
Nodes (25): payload, workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, dangerBanner(), DangerousGitOpError, DangerousOp, DangerousOpBlockedError, dryRunGitClean() (+17 more)
...
Cohesion: 0.08
Nodes (35): checkGraphifyFreshness(), execAsync, filterPayload(), parseCostThreshold(), anchorNames(), array, combine, compareArrays() (+27 more)

### Community 243 - "Electron Desktop App Docs"
Cohesion: 0.09
Nodes (30): ExtractedPayload, fetchFn, provider, result, StubExtractionProvider, appendJsonl(), buildQueryExpansionCacheKey(), buildQueryExpansionPrompt() (+22 more)
...
Cohesion: 0.1
Nodes (32): DockerContainerLifecycle, getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, getWorkspaceStackHealth, health, now (+24 more)
...
Cohesion: 0.06
Nodes (10): client, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine, machines (+2 more)
...
Cohesion: 0.13
Nodes (28): runCostSync(), inferIssueId(), buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir() (+20 more)
...
Cohesion: 0.11
Nodes (31): AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, Convoy - Parallel Review Panel, Deft Framework (AI development framework), Deft verification ladder (4 tiers: Static/Command/Behavioral/Human), inspect-agent (per-bead verification), merge-agent (conflict resolution + merge queue), Planning Agent (+23 more)

### Community 290 - "External SSE Event Stream and God View"
Cohesion: 0.14
Nodes (24): execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise(), gitPush() (+16 more)
...
Cohesion: 0.08
Nodes (21): FetchFn, InternalState, LogFn, readWatchdogConfig(), readWatchdogPersistentState(), SpawnRestart, SpawnRestartResult, SupervisorWatchdog (+13 more)

### Community 293 - "Multi-Model Runtime Consolidation PRDs"
Cohesion: 0.1
Nodes (24): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerNetwork, DockerPsRaw, DockerStatsCollector, DockerStatsRaw (+16 more)

### Community 294 - "Test Failure Fix PRDs and Infrastructure"
Cohesion: 0.06
Nodes (31): 4 issues awaiting human UAT, Active Pipeline, Autonomous planning auto-promote (commit 861cf8baa, 2026-05-20, RUN-1), `ctxPercent: 0` in orchestrator snapshot, Cycling Alerts, Deacon orphan-detection races new agent spawn (observed RUN-1 tick 2), Deacon resumes work agent despite stoppedByUser=true, Flywheel State (+23 more)
...
Cohesion: 0.06
Nodes (32): 6. Agreed End-State, Agent Startup Context, code:block10 (pan sync), code:block11 (pan sync), code:yaml (devroot: ~/Projects        # where you launch Claude Code fr), code:json ({), code:json ({), code:bash (pan workspace update MIN-678    # explicit command, only whe) (+24 more)
...
Cohesion: 0.11
Nodes (27): buildReviewContext(), BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, flattenAC(), getChangedFiles(), getCurrentBranch() (+19 more)
...
Cohesion: 0.11
Nodes (25): buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), resolveAndSpeak() (+17 more)

### Community 314 - "Build Pipeline and Output Structure Docs"
Cohesion: 0.09
Nodes (25): autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions (+17 more)
...
Cohesion: 0.1
Nodes (24): SETTINGS_FILE, available, content, defaults, defaults1, defaults2, invalidSettings, settings (+16 more)

### Community 317 - "Directive Flow DAG Issue Overview"
Cohesion: 0.14
Nodes (25): updated, buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, broadcastToRenderers(), checkForUpdates() (+17 more)
...
Cohesion: 0.07
Nodes (26): DEACON_DIR, DeaconConfig, DeaconState, config, config1, config2, CONFIG_FILE, customConfig (+18 more)

### Community 324 - "Caveman Compression CLI Command"
Cohesion: 0.07
Nodes (25): next, restored, s, start, withAgent, cb, cmdArgs, { MainDivergedErrorClass } (+17 more)
...
Cohesion: 0.07
Nodes (27): activeIssues, date1, date2, expectedOrder, filtered, filteredIds, filterRecentCompletedIssues(), getOneDayAgo() (+19 more)
...
Cohesion: 0.13
Nodes (22): showAction(), getDiscoveredSessionById(), markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi() (+14 more)

### Community 348 - "Tracker Context Injection on Agent Restart"
Cohesion: 0.16
Nodes (21): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+13 more)
...
Cohesion: 0.11
Nodes (25): applyIssueFeatureClassification(), ApplyIssueFeatureClassificationDeps, buildFeatureClassificationPrompt(), ClassifiedFeature, ClassifiedFeaturePayload, classifyIssueFeatures(), FEATURE_CLASSIFICATION_JSON_SCHEMA, FeatureClassificationPayload (+17 more)
...
Cohesion: 0.11
Nodes (21): mockGetRuntimeForAgent, buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers (+13 more)
...
Cohesion: 0.1
Nodes (26): checkLazyAgent() (17-pattern lazy detection), Claude Code Channels (Experimental), scriptPath, confirmDelivery() (tmux delivery verification), flywheel-change Issue Label, Flywheel Daemon (autonomous self-improvement loop), FLYWHEEL-REPORT.md (living self-improvement changelog), Heartbeat Hook (PostToolUse) (+18 more)

### Community 376 - "Planning Handoff Completion Tests"
Cohesion: 0.14
Nodes (22): onInspectComplete(), onInspectCompletePromise(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise(), getDiffBaseEffect() (+14 more)

### Community 377 - "Dashboard Navigation Layout Tests"
Cohesion: 0.1
Nodes (18): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, loaded, CacheEntry (+10 more)

### Community 378 - "Linear Issue States Tests"
Cohesion: 0.13
Nodes (20): buildAnthropicMessagesUrl(), CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError(), invalidateProbeCache() (+12 more)
...
Cohesion: 0.1
Nodes (26): Beads Agent Workflow (AGENTS.md), Backlog Triage Report 2026-04-30, Command Taxonomy Reorganization (v0.7.0), Deep-Wipe Endpoint (Destructive), Graphify Knowledge Graph, Panopticon CLI, Stash Hygiene Rules, PLANNING.md plan document (+18 more)
...
Cohesion: 0.11
Nodes (20): keyLabel(), maskValue(), ProviderEnvConflict, ProviderEnvOverrideDialog(), ProviderEnvOverrideDialogProps, PROVIDER_ENV_KEYS, atomicWrite(), backupIfNeeded() (+12 more)
...
Cohesion: 0.12
Nodes (21): electron, electron, IPC, result, sendNotification(), callServerApi(), dispatchMenuAction(), IPC (+13 more)

### Community 389 - "Universal Skills Documentation"
Cohesion: 0.12
Nodes (19): status, createWindow(), iconPath, isDevelopment, queryClient, registerIpcHandlers(), resolveServerEntry(), resolveServerStaticDir() (+11 more)
...
Cohesion: 0.1
Nodes (25): Dashboard Server Architecture (Effect + Raw WebSocket), No execSync in Dashboard Server Code, Dashboard Must Use Node 22 (Not Bun), postMergeLifecycle Idempotency Guard, tmux load-buffer + paste-buffer Pattern, Panopticon tmux Socket (-L panopticon), Verification Gate (PAN-174), Cleanup Radius (tmux Scrollback Data Map) (+17 more)
...
Cohesion: 0.18
Nodes (15): addVoice(), addVoicePromise(), clearVoices(), clearVoicesPromise(), deleteVoice(), deleteVoicePromise(), findVoiceById(), findVoiceByIdPromise() (+7 more)

### Community 409 - "Community 409"
Cohesion: 0.13
Nodes (21): assertIssueHasBeads(), assertIssueHasBeadsEffect(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise() (+13 more)
...
Cohesion: 0.1
Nodes (18): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+10 more)
...
Cohesion: 0.09
Nodes (21): mockExec, allLogs, logPath, mockCleanupAllLogs, mockCleanupOldLogs, mockConsoleError, mockConsoleLog, mockExec (+13 more)
...
Cohesion: 0.11
Nodes (19): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+11 more)
...
Cohesion: 0.15
Nodes (19): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, sessionFilePath(), buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions (+11 more)
...
Cohesion: 0.09
Nodes (21): Codex OAuth Authentication, 1. JWT Expiry (Primary), 2. CLIProxy Log Tailing (Secondary), Automatic Retry, Bridging to CLIProxy, code:block1 (~/.panopticon/cliproxy/auth/codex-primary.json), code:block2 (~/.codex/), code:block3 (refresh token has already been used) (+13 more)

### Community 448 - "Community 448"
Cohesion: 0.09
Nodes (22): Alternative Models, Claude Family (USD per million tokens), Context windows — advertised, Cost Analysis, Cost distribution (approximate), Cost — verified pricing per 1M tokens (USD), Detailed Recommendations, For Cost-Sensitive Deployments (+14 more)
...
Cohesion: 0.24
Nodes (21): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+13 more)

### Community 469 - "Community 469"
Cohesion: 0.09
Nodes (17): closeResult, command, ctx, editCalls, labelResult, prResult, calls, ctx (+9 more)

### Community 470 - "Community 470"
Cohesion: 0.09
Nodes (21): agentDir, body, commit, dir, envArg, files, launcher, LEGACY_FIELDS (+13 more)
...
Cohesion: 0.15
Nodes (16): INFERENCE.md Artifact, getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise() (+8 more)

### Community 473 - "Community 473"
Cohesion: 0.11
Nodes (16): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, LAZY_PATTERNS, lazySamples, oldTime, stateFile, STATE_FILE (+8 more)
...
Cohesion: 0.16
Nodes (17): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, TurnDiffFileChange, DiffStatLabel, hasNonZeroStat(), buildTurnDiffTree(), MutableDirectoryNode (+9 more)
...
Cohesion: 0.12
Nodes (11): actual, createSupervisorBackedTmuxSession(), enterTmuxCopyMode(), execFileAsync, existing, launcher, paneInCopyMode(), runTmux() (+3 more)
...
Cohesion: 0.11
Nodes (17): changedFiles, errOutput, fetchMock, mockFetch(), output, HealthCheck, mockExistsSync, mockFetch (+9 more)

### Community 487 - "Community 487"
Cohesion: 0.24
Nodes (16): acquireRestartLock(), acquireRestartLockPromise(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder() (+8 more)

### Community 488 - "Community 488"
Cohesion: 0.1
Nodes (18): makeCostEvent(), db, colNames, cols, db, disabledRow, enabledRow, [row] (+10 more)
...
Cohesion: 0.1
Nodes (20): code:bash (pan start PAN-999 --model claude-sonnet-4-5), code:bash (# Configure settings.json with Kimi API key), code:bash (# Configure settings.json with GLM API key), code:bash (# Configure settings.json with OpenAI API key), code:bash (# Check if router is running), code:bash (# View cost breakdown by provider), Cost Comparison, Direct Provider Issues (+12 more)
...
Cohesion: 0.11
Nodes (13): CostThresholdError, err, estimated, largePath, lines, progressCalls, prompts, samplePath (+5 more)

### Community 518 - "Community 518"
Cohesion: 0.12
Nodes (13): ActivityFeedCard(), ActivityFeedCardProps, ActivitySessionFeedEntry, createObservationFeedSelector(), selectObservationFeed, onSelect, time, entries (+5 more)

### Community 519 - "Community 519"
Cohesion: 0.22
Nodes (17): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+9 more)
...
Cohesion: 0.11
Nodes (16): exec(), execFile(), execMock, capturedCmds, mockCreateReviewArtifactsForIssue, mockEnsureMergeSetForIssue, mockExecFileFn, mockGetAgentState (+8 more)
...
Cohesion: 0.15
Nodes (9): parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv(), log, mocks (+1 more)

### Community 543 - "Community 543"
Cohesion: 0.23
Nodes (14): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), startCommand() (+6 more)
...
Cohesion: 0.14
Nodes (15): FeedTabContent(), SessionFeedTab, useGitFeed(), filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), useMergedFeed(), UseMergedFeedResult, useObservationFeed() (+7 more)
...
Cohesion: 0.18
Nodes (14): workspaceRebuildCommand(), tempDirs, workspace, ensureDevcontainerSync(), pathLeaf(), COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName() (+6 more)
...
Cohesion: 0.16
Nodes (10): activeContinuePath, continuePath, projectRoot, wsDir, alicePos, bobPos, longBody, result (+2 more)
...
Cohesion: 0.16
Nodes (13): PersistedState, readPersisted(), useConversationUiState(), writePersisted(), mockConversation, mockMessages, raw, toggle (+5 more)
...
Cohesion: 0.18
Nodes (10): calls, calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+2 more)
...
Cohesion: 0.21
Nodes (14): deliverQueuedFeedback(), enqueuePendingFeedbackDelivery(), isDeliveryStillRelevant(), markPendingFeedbackDelivered(), processPendingFeedbackDeliveries(), readStore(), writeStore(), delivery (+6 more)
...
Cohesion: 0.18
Nodes (11): GitFeedCard(), GitFeedCardProps, selectGitIcon(), CommentSessionFeedEntry, FileChangeSessionFeedEntry, GitSessionFeedEntry, PlaceholderSessionFeedEntry, SessionFeedEntryBase (+3 more)
...
Cohesion: 0.19
Nodes (12): logSpy, now, output, {
  shadowMock, cvMock, contextMock, healthMock,
  getShadowStateMock, pingAgentMock, getAgentCVMock, getAgentRuntimeStateMock,
}, logSpy, cleanupShadowTestFiles(), { getRuntimeForAgentMock, getAgentHealthMock }, issueId (+4 more)

### Community 642 - "Community 642"
Cohesion: 0.22
Nodes (11): PlanOptions, runDiscoveryPhase(), analyzeComplexity(), ComplexityAnalysis, copyToPRDDirectory(), DiscoveryDecision, executePlan(), generateStateContent() (+3 more)
...
Cohesion: 0.23
Nodes (12): ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle(), TITLE_SCHEMA (+4 more)
...
Cohesion: 0.14
Nodes (13): Available Work Types, code:yaml (models:), code:yaml (models:), code:yaml (models:), code:yaml (models:), code:yaml (models:), code:env (ANTHROPIC_API_KEY=sk-ant-...), Configuration Guide (+5 more)
...
Cohesion: 0.19
Nodes (11): EMPTY_STATES, isSessionFeedTab(), isStubTab(), navigateToFeedEntry(), pushRoute(), readStoredTab(), SessionFeedSidebar(), SessionFeedSidebarProps (+3 more)
...
Cohesion: 0.19
Nodes (11): Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider, OpenAI Provider (Codex/GPT) (+3 more)
...
Cohesion: 0.26
Nodes (10): cleanFile(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand(), PROJECTS_CONFIG_FILE (+2 more)
...
Cohesion: 0.17
Nodes (11): Author allowlist (hard filter), Author + assignee allowlist (hard filter — security-critical), End of run, Flywheel Brief, Human input invariant, Parked labels, Read first, Scope (+3 more)
...
Cohesion: 0.18
Nodes (10): hasCheckpoint(), after, callback, command, commit, files, mockExecCallback, mockResolveProject (+2 more)
...
Cohesion: 0.18
Nodes (11): Detailed role recommendations, Flywheel orchestrator (continuously inventory issues, diagnose pipeline state, emit ranked JSON suggestions), `plan` (exploration + planning), `review.correctness` / `review.performance` / `review.requirements`, `review.security`, `ship` (rebase + verify + push), `subagent:explore` and `subagent:bash`, `test` (+3 more)
...
Cohesion: 0.24
Nodes (10): backfillDiscoveredSessionArrayIndexes(), encodeClaudeProjectDir(), getDatabase(), getDatabasePath(), getPanopticonHome(), initDiscoveredSessionsSchema(), initSchema(), isBunRuntime() (+2 more)
...
Cohesion: 0.2
Nodes (9): file, conversation, { editorState, mockFocus, mockToastError, mockSaveStoredModel }, fetchMock, file, onSend, secondConversation, url (+1 more)

### Community 813 - "Community 813"
Cohesion: 0.36
Nodes (8): EFFORT_LEVELS, EffortLevel, EffortPicker(), EffortPickerProps, loadStoredEffort(), Options, PickerPosition, usePickerPosition()
...
Cohesion: 0.2
Nodes (7): body, ClaudeAuthOverride, putCall, settingsPayload, settingsWithAnthropicEnabled, url, user
...
Cohesion: 0.2
Nodes (10): code:bash (curl http://localhost:3000/api/settings/codex-auth), code:bash (pan config get issue-agent:implementation), code:bash (ls -la ~/.codex/config.json), code:bash (cp ~/.panopticon/cliproxy/auth/codex-primary.json ~/.codex/c), code:bash (pan cliproxy restart), "Codex authentication expired" banner won't go away, No banner but gpt-5.4 agents fail, Re-authenticated but agents still fail (+2 more)
...
Cohesion: 0.2
Nodes (10): Cleanup After Shutdown, code:bash (pan down), code:bash (# Clean up log files), code:bash (# Monitor in one terminal), code:bash (# Stop on user logout), Forceful Shutdown, Graceful Shutdown (default), Graceful vs Forceful Shutdown (+2 more)
...
Cohesion: 0.42
Nodes (4): parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync()

### Community 859 - "Community 859"
Cohesion: 0.22
Nodes (7): BASE_TIME, exitSpy, mailDir, mailFiles, state, stderrSpy, written

### Community 860 - "Community 860"
Cohesion: 0.22
Nodes (8): defaults, first, issueAgentTypes, { models }, second, models, issueAgentTypes, second
...
Cohesion: 0.33
Nodes (7): RoundMarker, deriveRoundMarkers(), TimestampedItem, markers, MESSAGES, meta, markers
...
Cohesion: 0.22
Nodes (9): Aider Polyglot, Berkeley Function-Calling Leaderboard (BFCL), Effective context (RULER / NIAH long-context retrieval) — UNVERIFIED across the board, GPQA-Diamond, HumanEval+ — UNVERIFIED across the board, MMLU-Pro, Performance benchmarks — what's verified, Structured-output (JSON-mode) reliability — UNVERIFIED (+1 more)
...
Cohesion: 0.39
Nodes (6): consolidateSpeakerCues(), decodeHtmlEntities(), ParsedCue, parseTimestamp(), result, vttToMarkdown()

### Community 939 - "Community 939"
Cohesion: 0.25
Nodes (4): IconProps, PROVIDER_COLORS, ProviderDot(), ProviderIcon()

### Community 940 - "Community 940"
Cohesion: 0.32
Nodes (7): createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, createTerminalWindow(), terminalWindows
...
Cohesion: 0.25
Nodes (8): 1. Batch Processing, 1. Prompt caching, 2. Batch processing, 2. Cascade Approach, 3. Cascade, 3. Parallel Processing, 4. Parallel verification on critical decisions, Optimization strategies

### Community 944 - "Community 944"
Cohesion: 0.25
Nodes (8): code:bash (# Create test settings), code:bash (# Test Kimi directly with Claude Code), code:bash (# Update settings to use Kimi for test agent), code:bash (# Add GLM API key to settings), code:bash (# Test GLM directly with Claude Code), Test GLM (Z.AI), Test Kimi K2, Testing Direct Providers

### Community 945 - "Community 945"
Cohesion: 0.36
Nodes (8): SWE-bench benchmark, Claude Opus 4.6, Claude Sonnet 4.5, Gemini 3 Pro, Kimi K2.5, Model Capability Research Prompt, Model Capability Research Framework README, Model Capability Research Summary
...
Cohesion: 0.29
Nodes (6): capturedArgs, capturedCmds, closedBeads, mockExecFileFn, mockExecFn, mockGetVBriefACStatus

### Community 991 - "Community 991"
Cohesion: 0.38
Nodes (4): VoiceMode, VoiceWidget(), useVoiceTranscription(), VoiceMessage
...
Cohesion: 0.29
Nodes (7): code:bash (# Install router if not already installed), code:bash (# Test OpenAI via router), code:bash (# Update router config to include Gemini), code:bash (# Test Gemini via router), Test Google Gemini, Test OpenAI, Testing Router Providers

### Community 1003 - "Community 1003"
Cohesion: 0.29
Nodes (7): code:block15 ([ ] API key configured in settings.json), code:block16 ([ ] claude-code-router installed), code:block17 ([ ] Can switch between providers dynamically), Direct Provider (Kimi/GLM) Testing, Integration Testing, Router Provider (OpenAI/Gemini) Testing, Test Checklist
...
Cohesion: 0.33
Nodes (6): Auto-Shutdown, code:bash (# Clean up stale resources), code:bash (# Clean up stale resources), Manual Triggers, On System Shutdown (systemd), Recovery After Ungraceful Shutdown
...
Cohesion: 0.6
Nodes (4): fetchWithRetry(), isNetworkError(), RETRY_DELAYS, isNetworkError()
...
## Knowledge Gaps
- **14104 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14099 more)
...
- **Why does `execAsync` connect `Workspace Creation and Worktree` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Remote Agent Provisioning on Fly`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Smart Selection Explainer UI`, `Community 642`, `Claude Code Hook Management`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `GitHub App Merge and PR Integration`, `Inspector Panel Terminal UI`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `PRD Archiving and Issue Close Out`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `Remote Workspace Provider Skills`, `VBrief Lifecycle IO and Transitions`, `CLI Commands and Runtime Adapters`, `Docker Stats and Container Resources`, `Command Deck Zone B Session Nodes`, `Specialist Registry and Run Lifecycle`, `Community 544`, `Project Tree Feature Items UI`, `Conversation Service WebSocket RPC`, `Multi-Model Runtime Consolidation PRDs`, `Cloister Config Deep Merge`, `Codex Agent Spawn UI Flow`, `Multi-Tool Sync and MCP Isolation`, `Build Pipeline and Output Structure Docs`, `Project Skills Mirror and Sync`, `Workspace Teardown and Label Cleanup`, `CLI Option Parsing and Fixture Tests`, `Swarm Dispatch and DAG Execution`, `Community 713`, `Skills Merge and Manifest Sync`, `Specialist Commands and VBrief Index`, `Agent Launcher Command Generation`, `Community 468`, `vBRIEF Lifecycle and PRD Workflow`, `Multi-Tracker Adapter Implementations`, `Event Snapshot Cache and State Reducers`, `Fly Machine API Client`, `Traefik DNS and Platform Install Skills`, `Community 476`, `Caveman Hooks and Workspace Setup`, `Issue ID Parsing and Agent Cleanup`, `Agent Activity View Dashboard Components`, `Review Status State Machine`, `CLI Command Set Fixture`, `Community 617`, `Config Migration and Test Agent`, `Project Registration and Test Runner`, `Workspace Teardown and Reopen Tests`, `Planning Handoff Completion Tests`, `Specialist Run Log Lifecycle`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Conversation Service WebSocket RPC` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Universal Skills Documentation`, `Parallel Review Pipeline Dispatch`, `Agent Runtime Spawning`, `Workspace Creation and Worktree`, `Shadow Engineering Observer and Monitoring`, `Specialist Handoff and Planning Spawn`, `Electron Desktop App and Tray`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Dashboard Caching Architecture Docs`, `Remote Workspace Provider Skills`, `Specialist Metadata and Grace Period`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `Dashboard App Sidebar and Metrics`, `Community 812`, `Chat Composer Model Picker`, `Workspace Metadata and Project Config`, `Workspace and Version API Routes`, `Model Selection and Subscription Policy`, `Issue Tracker Polling Service`, `Settings Page Model Override and Auth`, `Community 445`, `System Health and Spawn Guardrails`, `Server Cache Service and Chat Markdown`, `GitHub Webhook Ingestion Handlers`, `Pi Session Cost Parser`, `Multi-Tracker Runtime Adapter Interface`, `Resource Process Discovery and Reporting`, `Community 591`, `Community 594`, `Shadow State Refresh Commands`, `Issue Search Modal and Filter State`, `Cliproxy Process Lifecycle Management`, `Community 475`, `Event Snapshot Cache and State Reducers`, `Community 476`, `Desktop Menu and Auto-Updater Lifecycle`, `Cost Data Migration and Reconciliation`, `Claude OAuth Authentication and Settings`, `Cloister Watchdog and Merge Validation Docs`, `Community 619`, `Reviewer Tree and Command Deck Dashboard`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `specialists` connect `Deacon Patrol and Queue` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Remote Agent Provisioning on Fly`, `Command Deck Overview Tab UI`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Workspace Lifecycle and Config`, `Database Schema and Review Status`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `Remote Workspace Provider Skills`, `Community 409`, `Dialog Actions and System Health UI`, `VBrief Lifecycle IO and Transitions`, `Cost Events Database and WAL Sync`, `External SSE Event Stream and God View`, `Cost Event Aggregation and Retention`, `Model Routing and Specialist Redesign Research`, `Cloister Service Handoff Logging`, `Settings Provider and Model Browser UI`, `Multi-Tool Sync and MCP Isolation`, `Community 441`, `Settings Page Model Override and Auth`, `Issue Lifecycle Service and Tests`, `Resource Process Discovery and Reporting`, `Resource-Allocated Issue Discovery`, `Shadow State Refresh Commands`, `Multi-Tracker Adapter Implementations`, `Community 476`, `Conversation Panel and Chat Phase Types`, `Desktop Menu and Auto-Updater Lifecycle`, `Provider Environment Settings Overlay`, `CLI Command Set Fixture`, `Config Migration and Test Agent`, `Specialist Agent Health Dashboard UI`, `Smee Webhook Proxy Process Management`, `Agent Hook Scripts and Repo Artifact Design`, `Electron Desktop App Launch Scripts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 283 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 283 INFERRED edges - model-reasoned connections that need verification._
- **Are the 244 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 244 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14104 weakly-connected nodes found - possible documentation gaps or missing edges._
