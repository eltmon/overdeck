...
## Corpus Check
- 1887 files · ~3,052,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26748 nodes · 41512 edges · 1268 communities (1220 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `899a52f1`
...
## Communities (1268 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (211): loadStartCommand(), checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand() (+203 more)
...
Cohesion: 0.02
Nodes (114): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (96): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed() (+88 more)
...
Cohesion: 0.03
Nodes (78): parsePiSession(), getPiLauncherFields(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR (+70 more)
...
Cohesion: 0.03
Nodes (86): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), evaluateHealthState() (+78 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (88): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), findWorkspaceRoot(), planFinalizeCommand() (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (77): workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content (+69 more)
...
Cohesion: 0.03
Nodes (86): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, queueAutoCommit() (+78 more)
...
Cohesion: 0.03
Nodes (84): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+76 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (87): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (85): getReviewerSessionName(), parseReviewerSessionName(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+77 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (86): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+78 more)
...
Cohesion: 0.03
Nodes (85): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+77 more)
...
Cohesion: 0.04
Nodes (65): NormalizedTtsDaemonConfig, acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+57 more)
...
Cohesion: 0.04
Nodes (59): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps (+51 more)
...
Cohesion: 0.05
Nodes (75): buildPolyrepoContext(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace() (+67 more)
...
Cohesion: 0.05
Nodes (74): deriveProjectRoot(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), workspacePanPaths(), deleteIssueDraft(), getDraftPath(), getDraftsDir() (+66 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (69): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+61 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (63): cont, doc, projectRoot, specsDir, workspace, fsHooks, path, paths (+55 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (69): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+61 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (70): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions(), readConvoySubRoleTemplate(), reviewerAgentId() (+62 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (70): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+62 more)
...
Cohesion: 0.04
Nodes (56): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+48 more)
...
Cohesion: 0.05
Nodes (63): buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+55 more)
...
Cohesion: 0.04
Nodes (66): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+58 more)
...
Cohesion: 0.04
Nodes (62): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+54 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (61): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+53 more)
...
Cohesion: 0.04
Nodes (55): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+47 more)
...
Cohesion: 0.05
Nodes (58): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+50 more)
...
Cohesion: 0.04
Nodes (54): confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, ConversationFilter, markEnrichmentFailed(), searchFts() (+46 more)
...
Cohesion: 0.05
Nodes (42): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+34 more)
...
Cohesion: 0.04
Nodes (57): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow, dailySpendCache (+49 more)
...
Cohesion: 0.06
Nodes (59): UpsertDiscoveredSessionOpts, validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader() (+51 more)
...
Cohesion: 0.05
Nodes (53): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback() (+45 more)
...
Cohesion: 0.04
Nodes (45): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+37 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (47): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+39 more)
...
Cohesion: 0.07
Nodes (50): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, AGENT_CONVERSATION_PREFIXES, archiveConversation() (+42 more)
...
Cohesion: 0.05
Nodes (37): captureTldrMetrics(), daemonRegistry, execAsync, getPidFilePath(), getTldrMetrics(), LiveDaemonState, readDaemonState(), readLogLines() (+29 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (35): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+27 more)
...
Cohesion: 0.04
Nodes (50): buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI(), EmbedOptions (+42 more)
...
Cohesion: 0.05
Nodes (34): MessagesTimeline, StandaloneTerminal(), StandaloneTerminalProps, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent (+26 more)

### Community 94 - "Community 94"
Cohesion: 0.05
Nodes (39): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+31 more)
...
Cohesion: 0.1
Nodes (50): extractNumber(), extractPrefix(), normalizeIssueId(), parseIssueId(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear() (+42 more)
...
Cohesion: 0.07
Nodes (32): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+24 more)
...
Cohesion: 0.08
Nodes (37): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+29 more)
...
Cohesion: 0.09
Nodes (32): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue() (+24 more)
...
Cohesion: 0.1
Nodes (32): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+24 more)
...
Cohesion: 0.1
Nodes (32): listTestsCommand(), registerTestCommands(), RunOptions, deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPath() (+24 more)
...
Cohesion: 0.16
Nodes (26): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload() (+18 more)
...
Cohesion: 0.13
Nodes (25): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+17 more)
...
Cohesion: 0.15
Nodes (11): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), wipeCommand(), WipeOptions, CanonicalState (+3 more)
...
Cohesion: 0.16
Nodes (4): extractStandardNumber(), extractStandardPrefix(), ParsedIssueId, result
...
Cohesion: 0.21
Nodes (8): calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync, { mockExecAsync }
...
Cohesion: 0.24
Nodes (12): DatabaseError, getSetting(), getSettingEffect(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId(), setFlywheelGloballyPaused(), setSetting() (+4 more)
...
Cohesion: 0.7
Nodes (5): findCutPoint(), findTurnStartIndex(), findValidCutPoints(), isAssistantEntry(), isUserMessageEntry()
...
- **Why does `fetch` connect `Community 56` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 269`, `Community 13`, `Community 15`, `Community 14`, `Community 143`, `Community 18`, `Community 277`, `Community 278`, `Community 150`, `Community 153`, `Community 155`, `Community 28`, `Community 27`, `Community 159`, `Community 162`, `Community 34`, `Community 37`, `Community 38`, `Community 680`, `Community 42`, `Community 686`, `Community 687`, `Community 1073`, `Community 1074`, `Community 50`, `Community 54`, `Community 57`, `Community 570`, `Community 192`, `Community 67`, `Community 196`, `Community 325`, `Community 70`, `Community 454`, `Community 72`, `Community 74`, `Community 331`, `Community 203`, `Community 335`, `Community 84`, `Community 213`, `Community 86`, `Community 87`, `Community 92`, `Community 93`, `Community 737`, `Community 616`, `Community 233`, `Community 106`, `Community 234`, `Community 1138`, `Community 1139`, `Community 244`, `Community 380`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 37` to `Community 35`, `Community 5`, `Community 74`, `Community 107`, `Community 12`, `Community 304`, `Community 17`, `Community 211`, `Community 404`, `Community 23`, `Community 539`, `Community 29`, `Community 30`, `Community 351`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 53` to `Community 0`, `Community 513`, `Community 1`, `Community 6`, `Community 264`, `Community 265`, `Community 9`, `Community 266`, `Community 140`, `Community 13`, `Community 12`, `Community 17`, `Community 18`, `Community 19`, `Community 276`, `Community 25`, `Community 539`, `Community 28`, `Community 33`, `Community 162`, `Community 419`, `Community 35`, `Community 289`, `Community 423`, `Community 40`, `Community 44`, `Community 174`, `Community 46`, `Community 49`, `Community 306`, `Community 180`, `Community 181`, `Community 55`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 192`, `Community 449`, `Community 194`, `Community 450`, `Community 69`, `Community 453`, `Community 73`, `Community 330`, `Community 204`, `Community 333`, `Community 82`, `Community 467`, `Community 84`, `Community 210`, `Community 89`, `Community 97`, `Community 609`, `Community 490`, `Community 108`, `Community 242`, `Community 243`, `Community 378`, `Community 253`, `Community 638`?**
