...
## Corpus Check
- 1915 files · ~3,144,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27454 nodes · 43092 edges · 1300 communities (1245 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `086e36bd`
...
## Communities (1300 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (194): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+186 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (178): annotationsMap, appendAll, boolTag, branch, branchMatch, BREAK, buffer, byReferenceInstances (+170 more)
...
Cohesion: 0.04
Nodes (152): monitorReviewConvoySignals(), pauseFlywheel(), saveResumeSessionId(), performKillAndSpawn(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions (+144 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (139): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, checkAndSuspendIdleAgents(), checkApiErrorAgents() (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (114): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (99): parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS (+91 more)
...
Cohesion: 0.02
Nodes (105): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (120): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), clearStaleCiFeedback(), __dirname, __filename (+112 more)
...
Cohesion: 0.02
Nodes (105): autoResumeStoppedWorkAgents(), isVerifyPausedAgentState(), notifyAgentStatusChanged(), recoverOrphanedAgentsOnce(), getNoResumeMode(), computeAgentEnrichment(), execAsync, getActiveSessionPath() (+97 more)
...
Cohesion: 0.02
Nodes (89): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (98): db, received, store, svc, unsubscribe, adminRouteLayer, getAdminTldrRoute, agentsRouteLayer (+90 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (92): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (91): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+83 more)
...
Cohesion: 0.02
Nodes (81): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+73 more)
...
Cohesion: 0.03
Nodes (70): criteria, doc, projectDoc, projectRoot, workspaceDoc, workspacePath, { projectPath, workspacePath }, promoted (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (81): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+73 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (76): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+68 more)
...
Cohesion: 0.03
Nodes (73): captureTmuxOutput(), REVIEW_SUB_ROLES, reviewerOutputPath(), ReviewerResult, ReviewerState, ReviewSubRole, waitForReviewerOutputs(), waitForReviewerOutputsEffect() (+65 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (82): defaultRunWorkspace(), resolveProjectFromIssue(), getProjectPath(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+74 more)
...
Cohesion: 0.04
Nodes (75): finalizeRunLog(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+67 more)
...
Cohesion: 0.03
Nodes (68): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags() (+60 more)
...
Cohesion: 0.04
Nodes (66): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+58 more)
...
Cohesion: 0.03
Nodes (55): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (75): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+67 more)
...
Cohesion: 0.07
Nodes (78): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), array (+70 more)
...
Cohesion: 0.05
Nodes (65): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), completePlanningArtifacts(), checkPlanStatusEffect(), readWorkspacePlanAsync() (+57 more)
...
Cohesion: 0.05
Nodes (64): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+56 more)
...
Cohesion: 0.06
Nodes (59): embedAction(), confirmCost(), enrichAction(), formatCost(), SearchQuery, showAction(), runWithPool(), WorkPoolStats (+51 more)
...
Cohesion: 0.06
Nodes (58): TmuxConfigMode, buildNewSessionArgs(), buildTmuxArgs(), capturePaneAsync(), confirmDelivery(), createSessionAsync(), pane, result (+50 more)
...
Cohesion: 0.04
Nodes (50): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+42 more)
...
Cohesion: 0.06
Nodes (56): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+48 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (50): CopyConfigOptions, createMemoryCommand(), getPanopticonHome(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers() (+42 more)
...
Cohesion: 0.06
Nodes (29): issues, result, importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService (+21 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (35): estimateCost(), getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR (+27 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (48): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker (+40 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (50): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+42 more)
...
Cohesion: 0.04
Nodes (48): makeTestLayer(), makeTestService(), runWithService(), sentinel, cache, db, loaded, row (+40 more)
...
Cohesion: 0.06
Nodes (44): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+36 more)
...
Cohesion: 0.09
Nodes (55): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyEffect(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+47 more)
...
Cohesion: 0.06
Nodes (39): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+31 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (38): rebuildCache(), appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+30 more)
...
Cohesion: 0.09
Nodes (40): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+32 more)
...
Cohesion: 0.04
Nodes (36): beadsDir, doc, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+28 more)
...
Cohesion: 0.06
Nodes (40): RecoverButton(), BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps (+32 more)
...
Cohesion: 0.05
Nodes (34): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffWorkerPoolProvider(), Tab, FlywheelRunSummary (+26 more)
...
Cohesion: 0.05
Nodes (31): getConversationsConfigAsyncEffect(), AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue(), mapEventToDelta() (+23 more)
...
Cohesion: 0.06
Nodes (27): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode (+19 more)
...
Cohesion: 0.07
Nodes (30): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+22 more)
...
Cohesion: 0.08
Nodes (39): archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated, isEnoent() (+31 more)
...
Cohesion: 0.09
Nodes (40): parseCostThreshold(), addCommentBefore(), anchorIsValid(), captureTldrMetrics(), clone(), createStringifyContext(), format(), formatPropertyKey() (+32 more)
...
Cohesion: 0.09
Nodes (36): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+28 more)
...
Cohesion: 0.11
Nodes (36): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken() (+28 more)

### Community 196 - "Community 196"
Cohesion: 0.06
Nodes (11): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+3 more)
...
Cohesion: 0.15
Nodes (33): extractNumber(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+25 more)
...
Cohesion: 0.09
Nodes (27): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), Handler, PipelineEvent, setPipelineHandler(), getIssueDataService(), getIssueDataService(), getIssueDataService() (+19 more)
...
Cohesion: 0.07
Nodes (27): bridgeCodexAuthToCliproxyEffect(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+19 more)
...
Cohesion: 0.13
Nodes (29): loadConfigAsyncNoMigrationEffect(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId(), getPlatformOpenCommand() (+21 more)
...
Cohesion: 0.09
Nodes (21): addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials(), removeTunnelIngress(), resolveHostnames() (+13 more)
...
Cohesion: 0.11
Nodes (20): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, criteria, doc, result (+12 more)
...
Cohesion: 0.11
Nodes (20): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+12 more)
...
Cohesion: 0.15
Nodes (25): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPathEffect(), hasPRDDraftEffect(), listPRDDrafts(), listPRDDraftsEffect() (+17 more)
...
Cohesion: 0.11
Nodes (21): emitActivityDetailed(), withConcurrencyLimit(), getEventStore(), pollOnce(), AgentOutputServiceState, diffLines(), pollOnce(), RunningAgent (+13 more)
...
Cohesion: 0.09
Nodes (20): cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel, mockClientIssueLabels, mockClientIssues (+12 more)
...
Cohesion: 0.13
Nodes (18): recoverUnhealthyTestStack(), workspaceRebuildCommand(), tempDirs, workspace, DevcontainerRenderResult, ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult (+10 more)
...
Cohesion: 0.15
Nodes (12): after, before, blockers, result, statuses, clearReviewStatus(), DEFAULT_STATUS_FILE, getReviewStatus() (+4 more)
...
Cohesion: 0.17
Nodes (14): registerTestCommands(), runCommand(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+6 more)
...
Cohesion: 0.17
Nodes (13): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir (+5 more)
...
- **Why does `string()` connect `Community 159` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 516`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 1038`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 26`, `Community 539`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 38`, `Community 43`, `Community 44`, `Community 45`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 66`, `Community 68`, `Community 69`, `Community 581`, `Community 72`, `Community 585`, `Community 74`, `Community 587`, `Community 76`, `Community 77`, `Community 73`, `Community 591`, `Community 75`, `Community 83`, `Community 85`, `Community 88`, `Community 90`, `Community 92`, `Community 95`, `Community 97`, `Community 100`, `Community 105`, `Community 113`, `Community 115`, `Community 130`, `Community 134`, `Community 136`, `Community 148`, `Community 150`, `Community 151`, `Community 664`, `Community 669`, `Community 162`, `Community 163`, `Community 168`, `Community 192`, `Community 195`, `Community 196`, `Community 202`, `Community 213`, `Community 235`, `Community 238`, `Community 759`, `Community 274`, `Community 281`, `Community 803`, `Community 293`, `Community 294`, `Community 807`, `Community 809`, `Community 298`, `Community 329`, `Community 331`, `Community 333`, `Community 342`, `Community 344`, `Community 368`, `Community 398`, `Community 400`, `Community 425`, `Community 426`, `Community 939`, `Community 428`, `Community 474`, `Community 490`, `Community 494`, `Community 497`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 2`, `Community 259`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 20`, `Community 21`, `Community 150`, `Community 22`, `Community 24`, `Community 282`, `Community 283`, `Community 34`, `Community 164`, `Community 37`, `Community 36`, `Community 39`, `Community 45`, `Community 47`, `Community 49`, `Community 58`, `Community 61`, `Community 62`, `Community 64`, `Community 192`, `Community 195`, `Community 196`, `Community 67`, `Community 68`, `Community 76`, `Community 334`, `Community 1105`, `Community 81`, `Community 85`, `Community 89`, `Community 476`, `Community 93`, `Community 225`, `Community 99`, `Community 100`, `Community 249`, `Community 102`, `Community 103`, `Community 107`, `Community 236`, `Community 493`, `Community 755`, `Community 759`, `Community 761`, `Community 637`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 64`, `Community 97`, `Community 5`, `Community 294`, `Community 7`, `Community 425`, `Community 45`, `Community 18`, `Community 211`, `Community 30`, `Community 92`, `Community 29`, `Community 158`?**
