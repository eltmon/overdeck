# Graph Report - feature-pan-1381  (2026-05-22)

## Corpus Check
- 1917 files · ~3,144,440 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27459 nodes · 43093 edges · 1312 communities (1258 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06d0883d`
...
## Communities (1312 total, 54 thin omitted)
...
Cohesion: 0.02
Nodes (147): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, PlanningState, ZoneAActionsState (+139 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (167): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+159 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (157): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+149 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (108): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+100 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (93): parsePiSession(), waitForPiAgentReady(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState (+85 more)
...
Cohesion: 0.02
Nodes (103): pruneStaleCheckpointRefs(), WipeOptions, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (108): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), recoverUnhealthyTestStack() (+100 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (92): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+84 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (100): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, EDITOR_LABELS, PanOpenInPickerProps (+92 more)
...
Cohesion: 0.03
Nodes (82): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+74 more)
...
Cohesion: 0.03
Nodes (67): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, DiffStatLabel (+59 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (69): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow (+61 more)
...
Cohesion: 0.04
Nodes (75): STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize, StatusDotStatus, useLiveFlash() (+67 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (75): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+67 more)
...
Cohesion: 0.04
Nodes (75): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+67 more)
...
Cohesion: 0.05
Nodes (75): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), getProjectPanPaths(), completePlanningArtifacts() (+67 more)
...
Cohesion: 0.05
Nodes (76): isClaudeRunningInSession(), buildChildEnv(), buildChildEnvWithoutTmux(), base, result, buildNewSessionArgs(), buildTmuxArgs(), buildTmuxCommandString() (+68 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (62): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+54 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (56): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcp() (+48 more)
...
Cohesion: 0.04
Nodes (59): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, detectHandoffMethod(), HandoffError, HandoffMethod (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (63): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+55 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (57): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+49 more)
...
Cohesion: 0.03
Nodes (60): NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, checkAgentHealthAsync() (+52 more)
...
Cohesion: 0.04
Nodes (56): killPostMergeRoleSessions(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions(), readConvoySubRoleTemplate() (+48 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (48): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, criteria, doc, result (+40 more)
...
Cohesion: 0.05
Nodes (43): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+35 more)
...
Cohesion: 0.06
Nodes (57): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifactEffect() (+49 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (45): calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync, { mockExecAsync } (+37 more)
...
Cohesion: 0.05
Nodes (50): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, result, ActivityContext, awaitingInputFromProjection() (+42 more)
...
Cohesion: 0.03
Nodes (52): containerRestartBackoffMs(), DeaconConfig, DeaconState, getDeaconStatus(), isDeaconRunning(), loadConfig(), config, config1 (+44 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (47): buildSpecialistBaseCommand(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand() (+39 more)
...
Cohesion: 0.05
Nodes (52): arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionByJsonlPath(), getDiscoveredSessionsByIds() (+44 more)
...
Cohesion: 0.09
Nodes (54): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+46 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (35): estimateCost(), getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping() (+27 more)
...
Cohesion: 0.08
Nodes (53): extractNumber(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect() (+45 more)
...
Cohesion: 0.05
Nodes (34): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState() (+26 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (39): rebuildCache(), appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+31 more)
...
Cohesion: 0.04
Nodes (53): UpsertDiscoveredSessionOpts, updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema (+45 more)
...
Cohesion: 0.04
Nodes (45): updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ConversationAboutSummary, deleteConversationFavoriteRoute, execAsync, getClientIp() (+37 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (46): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReviewStatusSnapshotInput (+38 more)
...
Cohesion: 0.07
Nodes (40): dropLingeringPreMergeStashes(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+32 more)
...
Cohesion: 0.07
Nodes (39): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+31 more)
...
Cohesion: 0.05
Nodes (33): getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, ReadModelServiceShape, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+25 more)
...
Cohesion: 0.06
Nodes (37): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+29 more)
...
Cohesion: 0.1
Nodes (40): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+32 more)

### Community 131 - "Community 131"
Cohesion: 0.07
Nodes (33): getWindowDimensionsAsyncEffect(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+25 more)
...
Cohesion: 0.09
Nodes (40): showAction(), getSetting(), getConversationByName(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), buildFilterSql(), ConversationFilter, countDiscoveredSessions() (+32 more)
...
Cohesion: 0.06
Nodes (36): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+28 more)

### Community 157 - "Community 157"
Cohesion: 0.07
Nodes (37): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels() (+29 more)
...
Cohesion: 0.09
Nodes (33): HttpServerResponse, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, AgentAlreadyRunning (+25 more)
...
Cohesion: 0.06
Nodes (30): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), formatAge(), FreshnessIndicator(), Tab (+22 more)

### Community 168 - "Community 168"
Cohesion: 0.1
Nodes (38): listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes() (+30 more)
...
Cohesion: 0.08
Nodes (29): runWithPool(), WorkPoolStats, DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), EmbedProgress, EmbedResult, embedSessions() (+21 more)
...
Cohesion: 0.1
Nodes (34): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), clone(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+26 more)

### Community 226 - "Community 226"
Cohesion: 0.11
Nodes (29): isSynthesisForActiveReviewRun(), healthCommand(), HealthOptions, listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+21 more)
...
Cohesion: 0.09
Nodes (24): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+16 more)

### Community 242 - "Community 242"
Cohesion: 0.07
Nodes (21): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig, GitLabConfig (+13 more)
...
Cohesion: 0.11
Nodes (29): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+21 more)

### Community 245 - "Community 245"
Cohesion: 0.09
Nodes (24): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+16 more)

### Community 246 - "Community 246"
Cohesion: 0.09
Nodes (29): cosineSimilarity(), normalizeFilter(), RawFilter, SearchMode, SearchQuery, SearchResult, searchSessions(), semanticCandidateWindow() (+21 more)
...
Cohesion: 0.12
Nodes (30): FlywheelScope, loadConfigAsyncNoMigrationEffect(), RoleEffort, abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync (+22 more)

### Community 265 - "Community 265"
Cohesion: 0.1
Nodes (26): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+18 more)
...
Cohesion: 0.15
Nodes (22): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+14 more)
...
Cohesion: 0.1
Nodes (20): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+12 more)
...
Cohesion: 0.15
Nodes (27): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+19 more)
...
Cohesion: 0.17
Nodes (18): FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+10 more)
...
Cohesion: 0.18
Nodes (17): updateTtsConfig(), clearConfigCache(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, cloneTtsConfig() (+9 more)
...
Cohesion: 0.18
Nodes (15): AgentRuntimeState, applyOutcome(), checkpointIdentity(), emptyResult(), GetAgentRuntimeState, getAgentRuntimeStateFromEffect(), GetAgentState, getAgentStateFromEffect() (+7 more)
...
Cohesion: 0.17
Nodes (10): pending, withBdMutex(), withWorkspaceBdMutex(), restoreTrackedBeadsExport(), runGit(), spawnerLayer, after, before (+2 more)
...
Cohesion: 0.25
Nodes (7): chalk, exitSpy, identity(), logs, output, parsed, seedSession()
...
Cohesion: 0.33
Nodes (5): chalk, identity(), logs, output, parsed
...
## Knowledge Gaps
- **13568 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13563 more)
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 1049`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 1052`, `Community 40`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 53`, `Community 54`, `Community 55`, `Community 569`, `Community 59`, `Community 61`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 76`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 89`, `Community 603`, `Community 95`, `Community 607`, `Community 99`, `Community 103`, `Community 104`, `Community 123`, `Community 126`, `Community 137`, `Community 138`, `Community 149`, `Community 163`, `Community 684`, `Community 175`, `Community 179`, `Community 201`, `Community 204`, `Community 722`, `Community 726`, `Community 215`, `Community 225`, `Community 243`, `Community 245`, `Community 283`, `Community 294`, `Community 811`, `Community 812`, `Community 818`, `Community 309`, `Community 314`, `Community 324`, `Community 343`, `Community 344`, `Community 358`, `Community 359`, `Community 362`, `Community 894`, `Community 403`, `Community 406`, `Community 408`, `Community 435`, `Community 436`, `Community 949`, `Community 480`, `Community 485`, `Community 488`, `Community 499`, `Community 505`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 3`, `Community 771`, `Community 7`, `Community 10`, `Community 139`, `Community 12`, `Community 525`, `Community 14`, `Community 15`, `Community 655`, `Community 13`, `Community 11`, `Community 19`, `Community 20`, `Community 23`, `Community 280`, `Community 24`, `Community 152`, `Community 27`, `Community 410`, `Community 29`, `Community 158`, `Community 157`, `Community 28`, `Community 33`, `Community 35`, `Community 164`, `Community 550`, `Community 39`, `Community 297`, `Community 42`, `Community 43`, `Community 44`, `Community 178`, `Community 53`, `Community 55`, `Community 952`, `Community 59`, `Community 266`, `Community 72`, `Community 204`, `Community 722`, `Community 212`, `Community 89`, `Community 90`, `Community 91`, `Community 224`, `Community 356`, `Community 230`, `Community 359`, `Community 487`, `Community 362`, `Community 111`, `Community 116`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 548`, `Community 5`, `Community 326`, `Community 7`, `Community 268`, `Community 28`, `Community 49`, `Community 82`, `Community 18`, `Community 434`, `Community 17`, `Community 211`, `Community 60`, `Community 31`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13568 weakly-connected nodes found - possible documentation gaps or missing edges._
