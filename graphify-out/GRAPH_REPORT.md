...
## Corpus Check
- 1573 files · ~2,069,327 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22390 nodes · 33595 edges · 1163 communities (1124 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16a69951`
...
## Communities (1163 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (159): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+151 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (145): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+137 more)
...
Cohesion: 0.03
Nodes (147): killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), computeAgentEnrichment() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (143): readCavemanVariant(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult (+135 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (140): checkPendingTestDispatch(), clearStaleCiFeedback(), resetPostMergeState(), killAllReviewerSessions(), buildTaskPrompt(), buildTestAgentPromptContent(), resolveWorkspaceGitInfo(), buildTestRolePrompt() (+132 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (144): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS (+136 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (132): cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures (+124 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (131): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+123 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (103): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+95 more)
...
Cohesion: 0.03
Nodes (65): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), generateHealthSummary(), getAgentsNeedingAttention() (+57 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (76): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+68 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (90): computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult, items, result, cb, cmdArgs, { MainDivergedErrorClass } (+82 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (82): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+74 more)
...
Cohesion: 0.03
Nodes (72): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+64 more)
...
Cohesion: 0.05
Nodes (71): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), ensurePanDirs() (+63 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (60): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, beadsDir, doc (+52 more)
...
Cohesion: 0.05
Nodes (59): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (60): loadCloisterConfig(), cleanupStaleAgentState(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+52 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (60): emitCoordinatorDied(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+52 more)
...
Cohesion: 0.04
Nodes (59): generateFallbackSummary(), canReplaceTitle(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, deleteConversationFavoriteRoute, execAsync, generateAiTitle(), getCachedFavoritedIds() (+51 more)
...
Cohesion: 0.05
Nodes (48): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+40 more)
...
Cohesion: 0.05
Nodes (51): getReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap() (+43 more)
...
Cohesion: 0.06
Nodes (50): FileStatus, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (49): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+41 more)
...
Cohesion: 0.05
Nodes (38): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), CostDonut(), CostDonutProps, formatBytes() (+30 more)
...
Cohesion: 0.06
Nodes (47): PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync (+39 more)
...
Cohesion: 0.06
Nodes (42): DEFAULT_GATES, calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes (+34 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (39): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildACLookupByTitle(), extractStitchDesigns() (+31 more)
...
Cohesion: 0.08
Nodes (44): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+36 more)
...
Cohesion: 0.09
Nodes (37): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument(), projectPanPaths() (+29 more)
...
Cohesion: 0.08
Nodes (37): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+29 more)

### Community 100 - "Community 100"
Cohesion: 0.05
Nodes (29): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+21 more)
...
Cohesion: 0.11
Nodes (35): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+27 more)
...
Cohesion: 0.07
Nodes (32): shouldAutoStart(), setAgentStoppedNotifier(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+24 more)

### Community 131 - "Community 131"
Cohesion: 0.11
Nodes (29): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+21 more)
...
Cohesion: 0.08
Nodes (33): buildSpecialistBaseCommand(), roleAgentDefinitionPath(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS (+25 more)
...
Cohesion: 0.14
Nodes (31): buildWorkAgentPrompt(), readPlanningContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+23 more)
...
Cohesion: 0.15
Nodes (20): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult, StoppedAgentsBanner(), fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn() (+12 more)
...
Cohesion: 0.13
Nodes (17): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+9 more)
...
Cohesion: 0.21
Nodes (15): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+7 more)
...
Cohesion: 0.22
Nodes (12): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+4 more)
...
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 1`, `Community 132`, `Community 133`, `Community 6`, `Community 775`, `Community 9`, `Community 12`, `Community 13`, `Community 270`, `Community 15`, `Community 400`, `Community 17`, `Community 658`, `Community 659`, `Community 149`, `Community 151`, `Community 28`, `Community 29`, `Community 543`, `Community 31`, `Community 33`, `Community 162`, `Community 35`, `Community 39`, `Community 41`, `Community 426`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 181`, `Community 567`, `Community 56`, `Community 55`, `Community 59`, `Community 572`, `Community 201`, `Community 80`, `Community 341`, `Community 216`, `Community 609`, `Community 98`, `Community 375`, `Community 506`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 164` to `Community 3`, `Community 27`, `Community 13`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 47` to `Community 1044`, `Community 135`?**
