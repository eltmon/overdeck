...
## Corpus Check
- 1745 files · ~2,326,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23910 nodes · 36672 edges · 1196 communities (1148 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb3799b9`
...
## Communities (1196 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (139): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+131 more)
...
Cohesion: 0.03
Nodes (151): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+143 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (135): resolveAutoResumeConfigForIssue(), monitorReviewConvoySignals(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff() (+127 more)
...
Cohesion: 0.03
Nodes (120): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+112 more)
...
Cohesion: 0.02
Nodes (97): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS (+89 more)
...
Cohesion: 0.03
Nodes (97): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, { projectPath, workspacePath }, promoted (+66 more)
...
Cohesion: 0.04
Nodes (78): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (79): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth (+71 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (85): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+77 more)
...
Cohesion: 0.04
Nodes (78): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+70 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (77): queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+69 more)
...
Cohesion: 0.03
Nodes (67): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+59 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (75): closeOutCommand(), CloseOutOptions, getGitHubConfig(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions (+67 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (78): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), getDevrootPath() (+70 more)
...
Cohesion: 0.05
Nodes (68): readWorkspaceContinue(), writeWorkspaceContinue(), findSpecByIssueAsync(), completePlanningArtifacts(), readWorkspacePlanAsync(), beadsDir, doc, badPath (+60 more)
...
Cohesion: 0.03
Nodes (66): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), closeDatabase(), getDatabasePath() (+58 more)
...
Cohesion: 0.05
Nodes (59): embedAction(), showAction(), runWithPool(), WorkPoolStats, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getDiscoveredSessionById(), getDiscoveredStats() (+51 more)
...
Cohesion: 0.05
Nodes (68): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+60 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (69): updateTtsConfig(), estimateCost(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath() (+61 more)
...
Cohesion: 0.05
Nodes (51): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+43 more)
...
Cohesion: 0.04
Nodes (52): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+44 more)
...
Cohesion: 0.04
Nodes (54): cleanupOldEntries(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge(), resetProcessingToQueued() (+46 more)
...
Cohesion: 0.05
Nodes (49): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, result, ActivityContext, awaitingInputFromProjection() (+41 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (50): adminRouteLayer, getAdminTldrRoute, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute (+42 more)
...
Cohesion: 0.06
Nodes (47): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+39 more)
...
Cohesion: 0.07
Nodes (24): issues, result, importTrackerConfig(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+16 more)
...
Cohesion: 0.06
Nodes (50): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+42 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (41): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, findWorkspaceRoot(), planFinalizeCommand() (+33 more)
...
Cohesion: 0.04
Nodes (48): _resetDashboardSessionTokenForTests(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+40 more)
...
Cohesion: 0.06
Nodes (41): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), HandoffConfig, HandoffTriggersConfig (+33 more)
...
Cohesion: 0.09
Nodes (41): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+33 more)
...
Cohesion: 0.05
Nodes (32): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE (+24 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (44): Access, PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+36 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (43): isEligibleForCleanup(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation() (+35 more)
...
Cohesion: 0.1
Nodes (45): acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonAuthToken() (+37 more)
...
Cohesion: 0.05
Nodes (36): ENV_KEYS, EnvSnapshot, agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, issuesRouteLayer, miscRouteLayer, projectsRouteLayer (+28 more)
...
Cohesion: 0.08
Nodes (36): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+28 more)
...
Cohesion: 0.07
Nodes (35): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, findDevrootForProject(), getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig (+27 more)
...
Cohesion: 0.07
Nodes (39): AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock (+31 more)
...
Cohesion: 0.07
Nodes (34): scanForConflictMarkers(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl() (+26 more)
...
Cohesion: 0.08
Nodes (35): resolveModel(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode (+27 more)
...
Cohesion: 0.06
Nodes (33): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+25 more)
...
Cohesion: 0.09
Nodes (33): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+25 more)
...
Cohesion: 0.1
Nodes (32): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+24 more)
...
Cohesion: 0.1
Nodes (4): stopDeacon(), createHandoffEvent(), CloisterService, readStateFile()
...
Cohesion: 0.12
Nodes (29): cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), healthCommand(), HealthOptions, AgentHealth, checkAgentHealthAsync(), formatHealthStatus() (+21 more)
...
Cohesion: 0.11
Nodes (22): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+14 more)
...
Cohesion: 0.13
Nodes (18): getEmbedding(), buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, embedOllama(), embedOpenAI(), EmbedOptions (+10 more)
...
Cohesion: 0.23
Nodes (15): constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders(), hasDashboardInternalToken() (+7 more)
...
Cohesion: 0.17
Nodes (13): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), validBackoffSchedule(), DEFAULT_CLOISTER_CONFIG, HealthThresholds, config (+5 more)
...
Cohesion: 0.15
Nodes (9): CONFIG, hadPackageDir, hadPython, hadVenvDir, killSpy, packageDir, python, spawn (+1 more)
...
## Knowledge Gaps
- **12440 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12435 more)
...
- **Why does `fetch` connect `Community 1` to `Community 129`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 519`, `Community 136`, `Community 137`, `Community 9`, `Community 132`, `Community 135`, `Community 13`, `Community 10`, `Community 15`, `Community 16`, `Community 146`, `Community 147`, `Community 274`, `Community 20`, `Community 22`, `Community 23`, `Community 792`, `Community 18`, `Community 26`, `Community 410`, `Community 27`, `Community 32`, `Community 36`, `Community 677`, `Community 297`, `Community 41`, `Community 427`, `Community 44`, `Community 45`, `Community 46`, `Community 562`, `Community 56`, `Community 58`, `Community 62`, `Community 69`, `Community 72`, `Community 205`, `Community 77`, `Community 208`, `Community 99`, `Community 494`, `Community 239`, `Community 368`, `Community 627`, `Community 631`, `Community 383`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 2` to `Community 32`, `Community 1`, `Community 3`, `Community 228`, `Community 103`, `Community 11`, `Community 365`, `Community 14`, `Community 142`, `Community 557`, `Community 338`, `Community 180`, `Community 24`, `Community 58`, `Community 59`, `Community 30`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `postWithTimeout()` connect `Community 208` to `Community 1`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12440 weakly-connected nodes found - possible documentation gaps or missing edges._
