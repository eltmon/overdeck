...
## Corpus Check
- 1915 files · ~3,142,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27443 nodes · 43051 edges · 1307 communities (1250 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 802 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9337e130`
...
## Communities (1307 total, 57 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (230): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+222 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (176): performKillAndSpawn(), spawnInspectAgent(), renderPrompt(), buildSpecialistBaseCommand(), flywheelAbortCommand(), pauseCommand(), PauseOptions, recoverCommand() (+168 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (135): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+127 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (147): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (152): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (133): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), BootstrapGate(), BootstrapGateProps, callApi() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (101): parsePiSession(), TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (120): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, VerifyingOnMainBadge() (+112 more)
...
Cohesion: 0.02
Nodes (108): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (91): registerTestCommands(), RunOptions, resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError (+83 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (93): checkCommand(), syncCommand(), SyncOptions, ensureExcalidrawMcp(), checkDevrootDeprecation(), cleanupLegacyRuntimeSymlinks(), migrateSyncTargets(), buildManifestFromDirectory() (+85 more)
...
Cohesion: 0.04
Nodes (99): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+91 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (95): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+87 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (92): runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), workspaceDeepCleanCommand() (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (91): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+83 more)
...
Cohesion: 0.02
Nodes (99): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), postAgentMessageLikeRoute(), validateAgentMessageOrigin() (+91 more)
...
Cohesion: 0.04
Nodes (87): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (89): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+81 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (69): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (71): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (80): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+72 more)
...
Cohesion: 0.03
Nodes (77): getHealthThresholdsMs(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, AgentHealth, evaluateHealthState(), formatDuration() (+69 more)
...
Cohesion: 0.04
Nodes (69): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+61 more)
...
Cohesion: 0.03
Nodes (66): cb, cmdArgs, file, mockExec, mockResolveGitHubIssue, prJson, result, buildChildStoriesFromRally() (+58 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (54): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+46 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (60): ViewMode, Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+52 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (62): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+54 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (51): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (59): dropLingeringPreMergeStashes(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+51 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (71): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+63 more)
...
Cohesion: 0.04
Nodes (54): conversationsTab, firstLens, lens, overview, tablist, ProjectRightPaneTabs(), IssueComposer(), IssueWorkbench() (+46 more)
...
Cohesion: 0.04
Nodes (56): CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus(), fetchConversations(), fetchDashboardSettings(), fetchTtsHealth() (+48 more)
...
Cohesion: 0.05
Nodes (51): InlineSparkline(), InlineSparklineProps, BranchNode(), BranchNodeProps, ContainerNode(), ContainerNodeProps, containerStatusColor(), containerStatusToDot() (+43 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (55): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), ClaimTranscriptRangeInput (+47 more)
...
Cohesion: 0.04
Nodes (49): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName(), parseAllSessions() (+41 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (56): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions, execAsync (+48 more)
...
Cohesion: 0.07
Nodes (43): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+35 more)
...
Cohesion: 0.08
Nodes (45): getReviewStatusAsyncEffect(), setReviewStatusAsyncEffect(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckSuite() (+37 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (49): arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionByJsonlPath(), getDiscoveredSessionsByIds() (+41 more)
...
Cohesion: 0.07
Nodes (45): runInline(), CheckpointOperation, CheckpointRequest, result, runOperation(), bind(), claimTranscriptRange(), commitTranscriptRange() (+37 more)
...
Cohesion: 0.07
Nodes (44): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+36 more)
...
Cohesion: 0.07
Nodes (27): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, IssueAggregate, BUDGETS_FILE, checkBudget() (+19 more)
...
Cohesion: 0.06
Nodes (36): EDITOR_LABELS, PanOpenInPickerProps, fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), consumeDashboardBootstrapToken(), createPanRpcProtocolLayer() (+28 more)
...
Cohesion: 0.06
Nodes (41): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth (+33 more)
...
Cohesion: 0.07
Nodes (35): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntry() (+27 more)
...
Cohesion: 0.08
Nodes (10): ensurePlaywrightIsolation(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyApiClient(), effFromPromise() (+2 more)
...
Cohesion: 0.08
Nodes (36): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, checkTtsHealth(), startTtsDaemonFromDashboard() (+28 more)
...
Cohesion: 0.07
Nodes (35): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle() (+27 more)
...
Cohesion: 0.05
Nodes (32): createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads, expectedPrefix (+24 more)
...
Cohesion: 0.09
Nodes (38): embedAction(), SearchQuery, showAction(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), buildFilterSql(), ConversationFilter, countDiscoveredSessions() (+30 more)
...
Cohesion: 0.11
Nodes (36): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth() (+28 more)
...
Cohesion: 0.08
Nodes (29): execAsync, rebaseFeatureBranch(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+21 more)
...
Cohesion: 0.09
Nodes (36): loadReportFlywheelStatus(), getFlywheelRunPayload(), getFlywheelRunsPayload(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata(), deriveRunStatus(), fileExists() (+28 more)
...
Cohesion: 0.09
Nodes (30): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+22 more)
...
Cohesion: 0.14
Nodes (34): archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+26 more)
...
Cohesion: 0.07
Nodes (21): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivitySection, formatModel(), IsolationMode() (+13 more)
...
Cohesion: 0.12
Nodes (34): loadConfigAsyncNoMigrationEffect(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+26 more)
...
Cohesion: 0.07
Nodes (26): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical() (+18 more)
...
Cohesion: 0.08
Nodes (25): getWindowDimensionsAsyncEffect(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+17 more)
...
Cohesion: 0.18
Nodes (30): checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile() (+22 more)
...
Cohesion: 0.08
Nodes (22): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+14 more)
...
Cohesion: 0.1
Nodes (21): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+13 more)
...
Cohesion: 0.11
Nodes (23): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), applyAgentFailure(), DEFAULT_SPECIALIST_CONFIG, findProjectByPathEffect() (+15 more)
...
Cohesion: 0.13
Nodes (22): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+14 more)

### Community 302 - "Community 302"
Cohesion: 0.12
Nodes (16): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+8 more)
...
Cohesion: 0.17
Nodes (14): buildCorrelationMap(), CorrelationResult, sessionFilePath(), buildContinuation(), convertConversationTranscript(), ConvertOptions, ConvertResult, extractClaudeTranscript() (+6 more)
...
Cohesion: 0.14
Nodes (14): bridgeCodexAuthToCliproxyEffect(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute (+6 more)
...
Cohesion: 0.19
Nodes (11): checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache, TaskCompletionCacheEntry (+3 more)
...
Cohesion: 0.19
Nodes (8): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult, Conversation
...
Cohesion: 0.19
Nodes (8): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, checkAgentHealthAsync(), checkAgentHealthEffect(), determineHealthStatusAsync(), determineHealthStatusEffect()
...
Cohesion: 0.23
Nodes (12): array, combine, hash(), number(), optimize(), random(), structureKeys(), [symbol$1]() (+4 more)
...
Cohesion: 0.18
Nodes (10): listener(), clearFlywheelRunGate(), electron, IPC, result, wrapped(), notifyVoiceSettings(), clearFlywheelGate() (+2 more)

### Community 707 - "Community 707"
Cohesion: 0.27
Nodes (11): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), ensureConfigFileAsync(), ensureDirsAsync(), getCliproxyAuthDir(), getCliproxyGeminiCredPath(), parseBridgedGeminiApiKey(), readBridgedGeminiApiKey() (+3 more)
...
Cohesion: 0.22
Nodes (8): isCliproxyRunningEffect(), startCliproxyEffect(), cliproxyRouteLayer, CliproxyStatus, getCliproxyStatusRoute, postCliproxyRestartRoute, refreshStatus(), startCliproxyWatchdog()

### Community 761 - "Community 761"
Cohesion: 0.27
Nodes (8): isRespawnPending(), markRespawnPending(), pendingRespawns, waitForSessionRespawn(), a, mockedSessionExistsEffect, respawn, resultPromise
...
Cohesion: 0.48
Nodes (6): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getPendingSyncCount(), listShadowedIssues()
...
- **Why does `string()` connect `Community 0` to `Community 513`, `Community 1`, `Community 3`, `Community 2`, `Community 5`, `Community 4`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 537`, `Community 25`, `Community 538`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 47`, `Community 48`, `Community 55`, `Community 56`, `Community 58`, `Community 61`, `Community 62`, `Community 63`, `Community 65`, `Community 578`, `Community 579`, `Community 69`, `Community 585`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 83`, `Community 87`, `Community 89`, `Community 93`, `Community 94`, `Community 99`, `Community 119`, `Community 121`, `Community 635`, `Community 637`, `Community 142`, `Community 143`, `Community 148`, `Community 662`, `Community 1175`, `Community 664`, `Community 155`, `Community 156`, `Community 158`, `Community 166`, `Community 168`, `Community 176`, `Community 187`, `Community 702`, `Community 193`, `Community 199`, `Community 200`, `Community 202`, `Community 209`, `Community 213`, `Community 228`, `Community 251`, `Community 252`, `Community 253`, `Community 262`, `Community 285`, `Community 799`, `Community 800`, `Community 289`, `Community 805`, `Community 807`, `Community 301`, `Community 305`, `Community 336`, `Community 345`, `Community 349`, `Community 393`, `Community 395`, `Community 422`, `Community 426`, `Community 945`, `Community 474`, `Community 487`, `Community 492`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 25` to `Community 33`, `Community 2`, `Community 226`, `Community 36`, `Community 422`, `Community 9`, `Community 14`, `Community 143`, `Community 207`, `Community 339`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 58` to `Community 0`, `Community 512`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 396`, `Community 13`, `Community 273`, `Community 17`, `Community 18`, `Community 146`, `Community 276`, `Community 22`, `Community 1175`, `Community 151`, `Community 25`, `Community 24`, `Community 27`, `Community 1176`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 165`, `Community 425`, `Community 43`, `Community 300`, `Community 44`, `Community 301`, `Community 303`, `Community 51`, `Community 55`, `Community 62`, `Community 702`, `Community 192`, `Community 193`, `Community 705`, `Community 199`, `Community 584`, `Community 202`, `Community 79`, `Community 210`, `Community 1107`, `Community 211`, `Community 1108`, `Community 84`, `Community 340`, `Community 83`, `Community 473`, `Community 91`, `Community 348`, `Community 99`, `Community 231`, `Community 108`, `Community 367`, `Community 754`, `Community 242`, `Community 634`, `Community 251`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 223 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 223 INFERRED edges - model-reasoned connections that need verification._
