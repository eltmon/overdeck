...
## Corpus Check
- 1553 files · ~2,063,747 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21645 nodes · 32048 edges · 1135 communities (1098 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 422 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74cc7d33`
...
1. `fetch` - 160 edges
2. `resolveProjectFromIssue()` - 102 edges
...
## Communities (1135 total, 37 thin omitted)
...
Cohesion: 0.02
Nodes (140): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, format(), LiveCounter() (+132 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (136): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (147): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (153): checkStuckWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildTmuxEnvFlags(), initializeSpecialist(), recordWake() (+145 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (125): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+117 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (129): autoResumeStoppedWorkAgents(), setAgentStoppedNotifier(), announceMerge(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+121 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (133): cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes() (+125 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (125): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+117 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (116): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (109): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), buildProviderExportLines() (+101 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (83): parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent, mockKillAgent (+75 more)
...
Cohesion: 0.03
Nodes (81): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+73 more)
...
Cohesion: 0.05
Nodes (90): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs() (+82 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (87): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+79 more)
...
Cohesion: 0.04
Nodes (66): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+58 more)
...
Cohesion: 0.04
Nodes (76): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, computeAgentEnrichment(), getAgentRuntimeStateAsync(), snapshotToRuntimeState(), withConcurrencyLimit() (+68 more)
...
Cohesion: 0.05
Nodes (75): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+67 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (57): criteria, doc, result, after, doc, filename, path, ACCompletionResult (+49 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (54): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+46 more)
...
Cohesion: 0.06
Nodes (57): clearFeedbackFiles(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+49 more)
...
Cohesion: 0.04
Nodes (53): loadCloisterConfig(), cleanupStaleAgentState(), checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync (+45 more)
...
Cohesion: 0.04
Nodes (51): generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+43 more)
...
Cohesion: 0.07
Nodes (48): ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR (+40 more)
...
Cohesion: 0.06
Nodes (49): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory() (+41 more)
...
Cohesion: 0.06
Nodes (41): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL (+33 more)
...
Cohesion: 0.07
Nodes (38): getUnblockedItems(), TERMINAL_STATUSES, buildACLookupByTitle(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, beadsDir, doc (+30 more)
...
Cohesion: 0.07
Nodes (38): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+30 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (19): issues, result, importTrackerConfig(), computePlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+11 more)
...
Cohesion: 0.06
Nodes (26): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+18 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (37): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+29 more)
...
Cohesion: 0.08
Nodes (38): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+30 more)
...
Cohesion: 0.1
Nodes (32): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+24 more)
...
Cohesion: 0.12
Nodes (29): getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig (+21 more)
...
Cohesion: 0.06
Nodes (34): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+26 more)
...
Cohesion: 0.09
Nodes (30): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+22 more)
...
Cohesion: 0.1
Nodes (32): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+24 more)
...
Cohesion: 0.1
Nodes (31): execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+23 more)
...
Cohesion: 0.06
Nodes (31): cleanupOrphanedReviewSessions(), writeStoryFeatureContext(), transitionIssueState(), transitionIssueToInReview(), writeWorkspaceContext(), execMock, mockCreateTracker, mockDropStash (+23 more)
...
Cohesion: 0.1
Nodes (14): getIssueDataService(), getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+6 more)

### Community 183 - "Community 183"
Cohesion: 0.1
Nodes (23): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createRemoteWorkspace(), CreateRemoteWorkspaceOptions, execAsync (+15 more)
...
Cohesion: 0.13
Nodes (25): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+17 more)
...
Cohesion: 0.13
Nodes (25): archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+17 more)
...
Cohesion: 0.14
Nodes (22): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+14 more)
...
Cohesion: 0.18
Nodes (17): WorkspaceDeepCleanOptions, dangerBanner(), DangerousOp, DangerousOpBlockedError, dryRunGitClean(), execAsync, pathLeaf(), runGitCheckoutOverwrite() (+9 more)
...
Cohesion: 0.08
Nodes (24): 6. Agreed End-State, Agent Startup Context, code:yaml (devroot: ~/Projects        # where you launch Claude Code fr), code:json ({), code:json ({), code:bash (pan workspace update MIN-678    # explicit command, only whe), code:block16 (pan workspace create MIN-678), code:block17 (Agent starts on MIN-678 workspace) (+16 more)
...
Cohesion: 0.12
Nodes (18): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, ApproveOptions (+10 more)
...
Cohesion: 0.15
Nodes (13): DEFAULT_MODELS_BY_WORK_TYPE, getEffectiveModelId(), buildMiniMaxFormData(), allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing (+5 more)
...
Cohesion: 0.4
Nodes (9): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+1 more)
...
Cohesion: 0.22
Nodes (5): mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, notify, promise
...
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 1`, `Community 642`, `Community 2`, `Community 636`, `Community 5`, `Community 6`, `Community 263`, `Community 137`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 529`, `Community 146`, `Community 19`, `Community 145`, `Community 22`, `Community 23`, `Community 24`, `Community 27`, `Community 28`, `Community 414`, `Community 35`, `Community 40`, `Community 169`, `Community 42`, `Community 812`, `Community 47`, `Community 49`, `Community 57`, `Community 66`, `Community 967`, `Community 71`, `Community 591`, `Community 592`, `Community 207`, `Community 343`, `Community 103`, `Community 489`, `Community 749`, `Community 124`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 121` to `Community 56`, `Community 4`, `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 812` to `Community 78`?**
