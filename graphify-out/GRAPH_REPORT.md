...
## Corpus Check
- 1754 files · ~2,345,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24096 nodes · 36916 edges · 1198 communities (1148 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c38f3cb`
...
## Communities (1198 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (175): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+167 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (176): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+168 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (126): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (135): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), closeOutCommand(), CloseOutOptions (+127 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (107): BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps (+99 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (122): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+114 more)
...
Cohesion: 0.04
Nodes (109): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+101 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (107): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+99 more)
...
Cohesion: 0.03
Nodes (110): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+102 more)
...
Cohesion: 0.03
Nodes (85): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+77 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (99): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+91 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (100): getTrackerContext(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview() (+92 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (100): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+92 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (84): ActivityView(), DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), derivePlanningIssueId() (+76 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (72): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, first (+64 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (84): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+76 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (83): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (76): importTrackerConfig(), AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (67): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+59 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (74): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier (+66 more)
...
Cohesion: 0.04
Nodes (74): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+66 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (64): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationView() (+56 more)
...
Cohesion: 0.04
Nodes (55): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+47 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (61): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats (+53 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (74): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+66 more)
...
Cohesion: 0.05
Nodes (65): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+57 more)
...
Cohesion: 0.04
Nodes (55): archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, CloisterStatusBar() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (62): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+54 more)
...
Cohesion: 0.04
Nodes (53): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+45 more)
...
Cohesion: 0.04
Nodes (62): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+54 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (63): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), closeDatabase(), getDatabasePath() (+55 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (57): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+49 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (57): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+49 more)
...
Cohesion: 0.04
Nodes (52): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput() (+44 more)
...
Cohesion: 0.04
Nodes (53): DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType, Capability, ModelDef, MODELS_BY_PROVIDER (+45 more)
...
Cohesion: 0.05
Nodes (46): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL (+38 more)
...
Cohesion: 0.07
Nodes (57): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+49 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (50): startPostLaunchSidecars(), startSidecars(), DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveNode22(), resolveScope() (+42 more)
...
Cohesion: 0.07
Nodes (50): Conversation, markConversationEnded(), Access, encodeClaudeProjectDir(), readBridgedCodexCredential(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment() (+42 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (46): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+38 more)
...
Cohesion: 0.07
Nodes (43): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+35 more)
...
Cohesion: 0.07
Nodes (48): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+40 more)
...
Cohesion: 0.05
Nodes (34): estimateCost(), getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR (+26 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (46): AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues. (+38 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (45): TtsDaemonStartResult, CappedBodyReadResult, CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute (+37 more)
...
Cohesion: 0.08
Nodes (40): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocument(), parsePanSpecDocumentAsync(), projectPanPaths() (+32 more)
...
Cohesion: 0.06
Nodes (37): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+29 more)
...
Cohesion: 0.08
Nodes (36): CopyConfigOptions, listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+28 more)
...
Cohesion: 0.08
Nodes (29): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+21 more)
...
Cohesion: 0.06
Nodes (33): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+25 more)
...
Cohesion: 0.08
Nodes (37): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+29 more)
...
Cohesion: 0.1
Nodes (11): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), sshCommand(), execAsync (+3 more)

### Community 143 - "Community 143"
Cohesion: 0.09
Nodes (35): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+27 more)
...
Cohesion: 0.06
Nodes (33): FileStatus, CACHE_MANIFEST, SOURCE_AGENTS_DIR, SOURCE_DEV_SKILLS_DIR, SOURCE_RULES_DIR, SOURCE_SCRIPTS_DIR, copyDirectoryRecursive(), DevrootSyncItem (+25 more)
...
Cohesion: 0.08
Nodes (27): issues, result, getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, DEFAULT_TTLS (+19 more)
...
Cohesion: 0.1
Nodes (20): ConversationPanel(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), PersistedState, useConversationUiState(), useNow() (+12 more)
...
Cohesion: 0.11
Nodes (23): buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps, ResolveAndSpeakOptions (+15 more)
...
Cohesion: 0.12
Nodes (19): workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose, ph (+11 more)

### Community 306 - "Community 306"
Cohesion: 0.26
Nodes (24): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches() (+16 more)

### Community 307 - "Community 307"
Cohesion: 0.13
Nodes (22): createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents() (+14 more)
...
Cohesion: 0.14
Nodes (20): extractTtsEmbedding(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority() (+12 more)
...
Cohesion: 0.14
Nodes (21): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+13 more)
...
Cohesion: 0.19
Nodes (18): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapper(), LauncherConfig, LauncherHarness (+10 more)

### Community 405 - "Community 405"
Cohesion: 0.13
Nodes (14): captureTldrMetrics(), daemonRegistry, getTldrMetrics(), listTldrDaemonServices(), LiveDaemonState, readLogLines(), readMetricsCheckpoint(), TldrDaemonStatus (+6 more)
...
Cohesion: 0.21
Nodes (13): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir (+5 more)
...
Cohesion: 0.27
Nodes (11): buildStatus(), decodeBase64Url(), decodeJwtPayload(), getCodexAuthPath(), getJwtExpiry(), getOpenAIAuthStatusSync(), hasApiKey(), OpenAIAuthStatus (+3 more)
...
## Knowledge Gaps
- **12538 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12533 more)
...
- **Why does `fetch` connect `Community 34` to `Community 640`, `Community 1`, `Community 130`, `Community 2`, `Community 641`, `Community 132`, `Community 5`, `Community 7`, `Community 137`, `Community 138`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 276`, `Community 21`, `Community 534`, `Community 407`, `Community 22`, `Community 153`, `Community 25`, `Community 28`, `Community 30`, `Community 801`, `Community 37`, `Community 294`, `Community 39`, `Community 422`, `Community 38`, `Community 298`, `Community 423`, `Community 44`, `Community 45`, `Community 686`, `Community 687`, `Community 688`, `Community 944`, `Community 52`, `Community 308`, `Community 54`, `Community 53`, `Community 184`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 574`, `Community 575`, `Community 63`, `Community 64`, `Community 68`, `Community 205`, `Community 79`, `Community 594`, `Community 211`, `Community 86`, `Community 600`, `Community 217`, `Community 221`, `Community 97`, `Community 243`, `Community 248`, `Community 1018`, `Community 1019`, `Community 508`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 1` to `Community 0`, `Community 130`, `Community 67`, `Community 26`, `Community 3`, `Community 195`, `Community 34`, `Community 41`, `Community 10`, `Community 108`, `Community 13`, `Community 142`, `Community 14`, `Community 306`, `Community 22`, `Community 24`, `Community 506`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 17` to `Community 32`, `Community 5`, `Community 13`, `Community 15`, `Community 51`, `Community 85`, `Community 23`, `Community 183`, `Community 507`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12538 weakly-connected nodes found - possible documentation gaps or missing edges._
