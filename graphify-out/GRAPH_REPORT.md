...
## Corpus Check
- 1545 files · ~2,062,014 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21544 nodes · 32038 edges · 1118 communities (1083 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 423 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fd70b5b`
...
- `destructiveResetWorkflow()` --calls--> `resetStep`  [INFERRED]
  src/lib/lifecycle/workflows.ts → tests/unit/lib/lifecycle/workflows.test.ts

## Communities (1118 total, 35 thin omitted)
...
Cohesion: 0.03
Nodes (138): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+130 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (110): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, DetailPanelLayoutProps, loadPanelState(), PanelMode (+102 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (129): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay(), dispatchParallelReview() (+121 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (100): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+92 more)
...
Cohesion: 0.04
Nodes (111): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), rotateSpecialistSession(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent() (+103 more)
...
Cohesion: 0.02
Nodes (90): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+82 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (99): checkStuckWorkAgents(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), ActivityEntry, AGENT_PREFIXES (+91 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (99): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig (+91 more)
...
Cohesion: 0.03
Nodes (91): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+83 more)
...
Cohesion: 0.03
Nodes (89): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+81 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (86): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+78 more)
...
Cohesion: 0.04
Nodes (58): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), buildHandoffPrompt(), captureHandoffContext(), HandoffContext (+50 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (70): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+62 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (79): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+71 more)
...
Cohesion: 0.04
Nodes (80): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+72 more)
...
Cohesion: 0.05
Nodes (72): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask, captureBeadsTasks() (+64 more)
...
Cohesion: 0.04
Nodes (59): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (68): changedFiles, errOutput, fetchMock, output, existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills (+60 more)
...
Cohesion: 0.04
Nodes (62): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (71): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+63 more)

### Community 33 - "Community 33"
Cohesion: 0.09
Nodes (70): postMergeLifecycle(), killAllReviewerSessions(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+62 more)
...
Cohesion: 0.05
Nodes (63): spawnSingleReviewer(), resolveSpecialistBaseCommand(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, getAgentRuntimeBaseCommand(), getProviderAuthMode(), getProviderExportsForModel(), panopticonAgentName(), resolveEffectiveHarness() (+55 more)
...
Cohesion: 0.04
Nodes (58): DetailPanelLayout(), loadPinState(), PHASE_CHIP_COLORS, PHASE_LABELS, PipelinePhase, savePinState(), TAB_ID_TO_SESSION_TYPE, TerminalTab (+50 more)
...
Cohesion: 0.04
Nodes (57): loadCloisterConfig(), shouldAutoStart(), cleanupStaleAgentState(), AgentHealth, checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure() (+49 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (56): cleanupAbandonedFeedback(), clearFeedbackFiles(), captureFiles(), buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace() (+48 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (60): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind (+52 more)
...
Cohesion: 0.04
Nodes (47): AIProvider, buildConversationResponse(), getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+39 more)
...
Cohesion: 0.07
Nodes (50): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+42 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (43): parseReviewerSessionName(), withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds() (+35 more)
...
Cohesion: 0.05
Nodes (39): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+31 more)
...
Cohesion: 0.09
Nodes (42): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), LOGS_DIR (+34 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (43): setAgentStoppedNotifier(), clearStuckForks(), listActiveConversations(), markConversationEnded(), getAllActiveQueues(), startCliproxyWatchdog(), attachmentCleanupTimer, es (+35 more)
...
Cohesion: 0.07
Nodes (38): reconcileAndCheckIfMerged(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+30 more)
...
Cohesion: 0.09
Nodes (38): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec(), writeSpec() (+30 more)
...
Cohesion: 0.08
Nodes (34): useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel() (+26 more)
...
Cohesion: 0.08
Nodes (38): Access, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+30 more)
...
Cohesion: 0.07
Nodes (36): startPostLaunchSidecars(), startSidecars(), HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning (+28 more)
...
Cohesion: 0.1
Nodes (30): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+22 more)
...
Cohesion: 0.09
Nodes (27): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded(), evaluateSeverity() (+19 more)
...
Cohesion: 0.14
Nodes (26): healthCommand(), HealthOptions, pendingCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand() (+18 more)
...
Cohesion: 0.1
Nodes (22): invalidateReauthToken(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+14 more)
...
Cohesion: 0.1
Nodes (20): getRuntimeSnapshotSync(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getSharedDb(), initEventStore(), StoredEvent, AgentStateService (+12 more)
...
Cohesion: 0.19
Nodes (23): createCostCommand(), BUDGETS_FILE, checkBudget(), CostBudget, CostSummary, createBudget(), deleteBudget(), formatCost() (+15 more)
...
Cohesion: 0.21
Nodes (22): killCommand(), createFlyProvider(), getRemoteProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile() (+14 more)
...
Cohesion: 0.16
Nodes (16): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+8 more)
...
Cohesion: 0.22
Nodes (16): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+8 more)
...
Cohesion: 0.13
Nodes (12): resetPostMergeState(), kCustom, mockExec, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed (+4 more)
...
- **Why does `fetch` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 260`, `Community 263`, `Community 264`, `Community 521`, `Community 8`, `Community 11`, `Community 13`, `Community 270`, `Community 15`, `Community 19`, `Community 148`, `Community 21`, `Community 22`, `Community 149`, `Community 151`, `Community 28`, `Community 29`, `Community 543`, `Community 31`, `Community 35`, `Community 171`, `Community 172`, `Community 47`, `Community 48`, `Community 50`, `Community 54`, `Community 55`, `Community 60`, `Community 65`, `Community 583`, `Community 584`, `Community 73`, `Community 592`, `Community 736`, `Community 109`, `Community 632`, `Community 127`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 134` to `Community 9`, `Community 26`, `Community 11`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 545`, `Community 34`, `Community 546`, `Community 326`, `Community 11`, `Community 589`, `Community 79`, `Community 17`, `Community 55`, `Community 26`?**
