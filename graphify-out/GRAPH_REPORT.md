# Graph Report - feature-pan-1055  (2026-05-09)

## Corpus Check
- 1544 files · ~2,058,924 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21516 nodes · 31973 edges · 1132 communities (1097 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31437b2e`
...
## Communities (1132 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (145): loadCloisterConfig(), cleanupStaleAgentState(), nudgeIdleWorkAgentsWithOpenBeads(), spawnRebaseAgentForBranch(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+137 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (123): ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS (+115 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (123): readCavemanVariant(), renderPrompt(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), rotateSpecialistSession(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (129): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+121 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (122): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents(), checkHeartbeat() (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (101): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+93 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (107): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+99 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (83): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, RecoverButton() (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (95): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (86): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+78 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (83): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+75 more)
...
Cohesion: 0.03
Nodes (81): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (79): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+71 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (83): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, mockLoadProjectsConfig, mockRunQualityGates (+75 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (87): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (80): autoResumeStoppedWorkAgents(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (80): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), buildManifestFromDirectory() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (77): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+69 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (78): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (71): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTimestamp() (+63 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (74): getCavemanHooksDir(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, NormalizedCavemanConfig (+66 more)
...
Cohesion: 0.03
Nodes (74): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (58): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+50 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (63): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+55 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (57): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, result, ACCompletionResult (+49 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (61): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), beadsDir, doc, badPath (+53 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (58): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+50 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (63): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+55 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (66): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+58 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (55): firstSessionPanel, firstWorkbench, workbench, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+47 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (53): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (61): cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage() (+53 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (55): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+47 more)
...
Cohesion: 0.06
Nodes (55): after, before, blockers, result, statuses, after, row, status (+47 more)
...
Cohesion: 0.07
Nodes (55): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+47 more)
...
Cohesion: 0.06
Nodes (53): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+45 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (41): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), createPiRuntime(), execAsync, createPiFifo(), destroyPiFifo() (+33 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (50): getHealthThresholdsMs(), CostAlert, DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, evaluateHealthState() (+42 more)
...
Cohesion: 0.05
Nodes (46): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+38 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (52): result, getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute (+44 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (41): DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader() (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (49): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), dispatchSwarmWave(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses() (+41 more)
...
Cohesion: 0.06
Nodes (41): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+33 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (37): ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore() (+29 more)
...
Cohesion: 0.06
Nodes (41): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions, RequestReviewResponse (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (40): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), isRemoteAvailable() (+32 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (35): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+27 more)
...
Cohesion: 0.14
Nodes (44): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), CloseIssueOptions (+36 more)
...
Cohesion: 0.09
Nodes (37): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), writeSpecForIssue(), asPanSpecDocument() (+29 more)
...
Cohesion: 0.07
Nodes (21): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+13 more)
...
Cohesion: 0.07
Nodes (31): RoundMarker, fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR (+23 more)
...
Cohesion: 0.06
Nodes (37): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+29 more)
...
Cohesion: 0.07
Nodes (39): Access, AIProvider, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session() (+31 more)
...
Cohesion: 0.07
Nodes (35): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+27 more)
...
Cohesion: 0.1
Nodes (32): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+24 more)

### Community 106 - "Community 106"
Cohesion: 0.06
Nodes (33): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+25 more)
...
Cohesion: 0.06
Nodes (35): entry, { issueId }, { limit }, old, op, ops, recent, result (+27 more)
...
Cohesion: 0.08
Nodes (29): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+21 more)
...
Cohesion: 0.08
Nodes (33): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds() (+25 more)
...
Cohesion: 0.1
Nodes (35): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+27 more)
...
Cohesion: 0.11
Nodes (28): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+20 more)
...
Cohesion: 0.07
Nodes (25): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), PiSpawnTimeout, agentDir (+17 more)
...
Cohesion: 0.1
Nodes (32): archivePlanning(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult, approve() (+24 more)
...
Cohesion: 0.1
Nodes (26): resolveWorkTypeKey(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose() (+18 more)
...
Cohesion: 0.07
Nodes (27): future, id, rows, rows1, rows2, initSchema(), base, cols (+19 more)
...
Cohesion: 0.06
Nodes (20): dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync }, redirectContent, workspacePath (+12 more)
...
Cohesion: 0.08
Nodes (26): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+18 more)

### Community 197 - "Community 197"
Cohesion: 0.11
Nodes (25): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+17 more)
...
Cohesion: 0.09
Nodes (28): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, ListOptions, projectInitCommand(), projectListCommand(), projectRemoveCommand() (+20 more)
...
Cohesion: 0.07
Nodes (25): captureTldrMetrics(), getTldrMetrics(), branch, branchMatch, buffer, cavemanVariant, cost, entry (+17 more)

### Community 214 - "Community 214"
Cohesion: 0.13
Nodes (28): startPostLaunchSidecars(), startSidecars(), systemHealthCommand(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget() (+20 more)
...
Cohesion: 0.09
Nodes (18): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffWorkerPoolProvider() (+10 more)
...
Cohesion: 0.15
Nodes (27): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths() (+19 more)
...
Cohesion: 0.15
Nodes (27): reconcileAndCheckIfMerged(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity() (+19 more)

### Community 237 - "Community 237"
Cohesion: 0.12
Nodes (24): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), reserveSummaryForkSession(), SummaryForkOptions (+16 more)
...
Cohesion: 0.1
Nodes (22): findVendoredDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), checkJqInstalled(), ClaudeSettings, HookConfig, installJq() (+14 more)
...
Cohesion: 0.11
Nodes (24): HandoffContext, createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+16 more)
...
Cohesion: 0.13
Nodes (21): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), getForgeAdapter(), ensureMergeSetForIssue(), upsertMergeSet() (+13 more)
...
Cohesion: 0.17
Nodes (3): IssueDataService, issuesChanged(), validateRallyConfig()
...
Cohesion: 0.09
Nodes (17): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+9 more)
...
Cohesion: 0.11
Nodes (20): setAgentStoppedNotifier(), emitCoordinatorDied(), Handler, notifyPipeline(), PipelineEvent, setPipelineHandler(), after, mockNotifyPipeline (+12 more)
...
Cohesion: 0.15
Nodes (13): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), Tab, NAV_GROUPS, Sidebar() (+5 more)
...
Cohesion: 0.2
Nodes (18): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+10 more)
...
Cohesion: 0.16
Nodes (14): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), exec() (+6 more)

### Community 401 - "Community 401"
Cohesion: 0.18
Nodes (16): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig, LauncherHarness (+8 more)
...
Cohesion: 0.16
Nodes (16): readEvents(), getRetentionStatus(), needsPruning(), pruneOldEvents(), RetentionStats, cache, dates, events (+8 more)
...
Cohesion: 0.14
Nodes (13): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+5 more)
...
Cohesion: 0.28
Nodes (14): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, AgentCV, completeWork(), formatCV() (+6 more)

### Community 423 - "Community 423"
Cohesion: 0.24
Nodes (15): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+7 more)
...
Cohesion: 0.21
Nodes (12): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeOptions, ShadowModeResult, shouldSkipTrackerUpdate() (+4 more)
...
Cohesion: 0.15
Nodes (12): errorSpy, killSpy, logSpy, mockExistsSync, mockLoadConfig, mockOpenSync, mockReadFileSync, mockSpawn (+4 more)
...
Cohesion: 0.29
Nodes (10): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+2 more)
...
Cohesion: 0.22
Nodes (7): base, event, removed, ts, ts1, ts2, ts3
...
## Knowledge Gaps
- **11452 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11447 more)
...
- **Why does `fetch` connect `Community 1` to `Community 3`, `Community 644`, `Community 5`, `Community 9`, `Community 10`, `Community 11`, `Community 141`, `Community 13`, `Community 272`, `Community 273`, `Community 530`, `Community 21`, `Community 22`, `Community 150`, `Community 281`, `Community 154`, `Community 26`, `Community 28`, `Community 155`, `Community 25`, `Community 34`, `Community 35`, `Community 552`, `Community 554`, `Community 44`, `Community 174`, `Community 48`, `Community 55`, `Community 316`, `Community 961`, `Community 67`, `Community 68`, `Community 589`, `Community 590`, `Community 212`, `Community 214`, `Community 88`, `Community 95`, `Community 236`, `Community 750`, `Community 252`, `Community 126`, `Community 639`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 0`, `Community 10`, `Community 115`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 72` to `Community 251`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11452 weakly-connected nodes found - possible documentation gaps or missing edges._
