...
## Corpus Check
- 1747 files · ~2,334,504 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23943 nodes · 36732 edges · 1215 communities (1167 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e940d337`
...
3. `resolveProjectFromIssue()` - 120 edges
...
## Communities (1215 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (208): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+200 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (155): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), clearStaleCiFeedback(), mockLoadProjectsConfig (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (150): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+142 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (144): detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle(), spawnInspectAgent() (+136 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (101): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView (+93 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (102): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets() (+94 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (111): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (104): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+96 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (90): updateConversationTitle(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions (+82 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (75): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, createHandoffEvent() (+67 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (86): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+78 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (106): checkMissingReviewStatuses(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+98 more)
...
Cohesion: 0.02
Nodes (86): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+78 more)
...
Cohesion: 0.02
Nodes (87): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (89): PlanFinalizeOptions, stampPlanForFinalization(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows() (+81 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (89): IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS, OverviewTab, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps (+81 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (95): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), dequeueMerge(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom (+87 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (75): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (90): embedAction(), scan(), RawFilter, SearchMode, SearchQuery, SearchResult, searchSessions(), semanticCandidateWindow() (+82 more)
...
Cohesion: 0.03
Nodes (82): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+74 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (80): checkOrphanedReviewStatuses(), checkStuckReviewing(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+72 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (76): ComposerMode, IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus() (+68 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (60): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+52 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (71): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+63 more)
...
Cohesion: 0.04
Nodes (76): clearFeedbackFiles(), readWorkspacePlanAsync(), findWorkspaceRoot(), planFinalizeCommand(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+68 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (71): DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+63 more)
...
Cohesion: 0.04
Nodes (74): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+66 more)
...
Cohesion: 0.06
Nodes (65): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+57 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (52): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+44 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (54): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+46 more)
...
Cohesion: 0.04
Nodes (57): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader() (+49 more)
...
Cohesion: 0.06
Nodes (58): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+50 more)
...
Cohesion: 0.06
Nodes (59): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+51 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (58): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (56): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+48 more)
...
Cohesion: 0.03
Nodes (56): importTrackerConfig(), result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute (+48 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (57): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest, ManifestEntry (+49 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (54): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl() (+46 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (58): generateFallbackSummary(), readLogTail(), AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions() (+50 more)
...
Cohesion: 0.04
Nodes (48): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+40 more)
...
Cohesion: 0.07
Nodes (52): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+44 more)
...
Cohesion: 0.05
Nodes (36): ensureDefaultConversationModel(), ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+28 more)
...
Cohesion: 0.05
Nodes (43): cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute, postCloisterResumeSpawnsRoute, postCloisterStartRoute (+35 more)
...
Cohesion: 0.06
Nodes (26): issues, result, getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+18 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (40): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+32 more)
...
Cohesion: 0.07
Nodes (43): CLAUDE_PROJECTS_DIR, ClaudeMessage, importSessionToCostLog(), normalizeModelName(), BUDGETS_FILE, calculateCost(), checkBudget(), CostBudget (+35 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (39): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+31 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (39): buildActiveSliceContext(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+31 more)
...
Cohesion: 0.07
Nodes (40): evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb() (+32 more)
...
Cohesion: 0.08
Nodes (31): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, AcceptanceCriterion, createBeadsFromVBrief() (+23 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (38): extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result (+30 more)
...
Cohesion: 0.07
Nodes (33): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceLive (+25 more)
...
Cohesion: 0.09
Nodes (31): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+23 more)

### Community 161 - "Community 161"
Cohesion: 0.07
Nodes (26): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+18 more)
...
Cohesion: 0.1
Nodes (33): Access, PrdLocation, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+25 more)
...
Cohesion: 0.09
Nodes (27): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), TemplatePlaceholders (+19 more)
...
Cohesion: 0.09
Nodes (18): captureTldrMetrics(), daemonRegistry, execAsync, getPidFilePath(), getTldrMetrics(), listTldrDaemonServices(), LiveDaemonState, readDaemonState() (+10 more)
...
Cohesion: 0.08
Nodes (21): getDefaultConversationModel(), VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab (+13 more)

### Community 196 - "Community 196"
Cohesion: 0.07
Nodes (30): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), Handler, PipelineEvent, setPipelineHandler(), clearReviewStatus(), cb, cmdArgs (+22 more)
...
Cohesion: 0.06
Nodes (28): cb, completedState, dispatched, featureWorkspace, ghExecFileMock, implSlot, initial, initialState (+20 more)
...
Cohesion: 0.11
Nodes (23): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+15 more)

### Community 234 - "Community 234"
Cohesion: 0.14
Nodes (28): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+20 more)
...
Cohesion: 0.09
Nodes (21): sentinel, EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore(), openEventDb(), PreparedStatement (+13 more)
...
Cohesion: 0.11
Nodes (26): buildReviewContext(), BuildReviewContextOpts, ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+18 more)
...
Cohesion: 0.12
Nodes (18): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir(), panopticonDir(), PiRuntime (+10 more)
...
Cohesion: 0.21
Nodes (26): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile(), ensureConfigFileAsync() (+18 more)
...
Cohesion: 0.24
Nodes (26): getContainersReferencingWorkspacePath(), stopWorkspaceDocker(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+18 more)

### Community 274 - "Community 274"
Cohesion: 0.12
Nodes (22): checkTtsHealth(), extractTtsEmbedding(), speakTts(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+14 more)
...
Cohesion: 0.11
Nodes (23): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps (+15 more)
...
Cohesion: 0.16
Nodes (10): countContextTokens(), findSessionFile(), getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions() (+2 more)

### Community 319 - "Community 319"
Cohesion: 0.15
Nodes (21): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, parseWalFile(), SyncResult, syncWalFromAllProjects() (+13 more)
...
Cohesion: 0.11
Nodes (12): RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller (+4 more)
...
Cohesion: 0.14
Nodes (17): getEmbedding(), buildEmbeddingText(), embed(), EmbeddingResult, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage() (+9 more)
...
Cohesion: 0.15
Nodes (15): canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode, resolveAllowedHarness() (+7 more)
...
Cohesion: 0.24
Nodes (17): startPostLaunchSidecars(), startSidecars(), recordRestartStatus(), reportHeldRestartLock(), restartCommand(), runFullRestart(), readPlatformConfig(), getSupervisorPort() (+9 more)
...
Cohesion: 0.2
Nodes (14): checkCliproxyPortAsync(), getCliproxyPidPath(), isCliproxyRunning(), isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), stopCliproxy(), stopCliproxyAsync() (+6 more)
...
Cohesion: 0.21
Nodes (13): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+5 more)
...
Cohesion: 0.2
Nodes (11): getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing (+3 more)
...
Cohesion: 0.24
Nodes (10): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), isEligibleForCleanup(), getIssueDataService() (+2 more)
...
## Knowledge Gaps
- **12444 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12439 more)
...
- **Why does `fetch` connect `Community 2` to `Community 387`, `Community 5`, `Community 6`, `Community 8`, `Community 648`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 399`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 153`, `Community 537`, `Community 30`, `Community 291`, `Community 292`, `Community 37`, `Community 419`, `Community 38`, `Community 35`, `Community 41`, `Community 42`, `Community 169`, `Community 812`, `Community 45`, `Community 302`, `Community 691`, `Community 52`, `Community 53`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 165`, `Community 64`, `Community 66`, `Community 195`, `Community 580`, `Community 200`, `Community 201`, `Community 84`, `Community 218`, `Community 603`, `Community 237`, `Community 238`, `Community 118`, `Community 119`, `Community 120`, `Community 383`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 22` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 168`, `Community 233`, `Community 106`, `Community 11`, `Community 45`, `Community 142`, `Community 16`, `Community 273`, `Community 18`, `Community 89`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 19` to `Community 36`, `Community 6`, `Community 105`, `Community 44`, `Community 270`, `Community 16`, `Community 18`, `Community 83`, `Community 28`, `Community 221`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12444 weakly-connected nodes found - possible documentation gaps or missing edges._
