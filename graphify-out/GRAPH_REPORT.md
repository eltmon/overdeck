...
## Corpus Check
- 1749 files · ~2,322,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23831 nodes · 36413 edges · 1212 communities (1162 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8900f53`
...
Cohesion: 0.02
Nodes (137): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, DoubleDialogComponent() (+129 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (134): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+126 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (159): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), ACTIVE_STATUS_PATTERNS, addLog() (+151 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (146): autoResumeStoppedWorkAgents(), detectHandoffMethod(), HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn(), sleep() (+138 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): monitorReviewConvoySignals(), after, before, blockers, result, statuses, after, row (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (121): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+113 more)
...
Cohesion: 0.02
Nodes (101): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+93 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (93): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+85 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (98): resumeCommand(), computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+90 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (107): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+99 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (105): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewSessions() (+97 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (83): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (97): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), getDevrootPath() (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (87): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+79 more)
...
Cohesion: 0.03
Nodes (78): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+70 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (87): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+79 more)
...
Cohesion: 0.04
Nodes (71): cleanupStaleAgentState(), parsePiSession(), sessionExistsAsync(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+63 more)
...
Cohesion: 0.03
Nodes (80): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), backfillDiscoveredSessionArrayIndexes() (+72 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (77): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization() (+69 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (81): DEFAULTS, UIPreferences, useUIPreferences(), DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType (+73 more)
...
Cohesion: 0.04
Nodes (85): updateTtsConfig(), agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options (+77 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (77): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+69 more)
...
Cohesion: 0.05
Nodes (72): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+64 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (73): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+65 more)
...
Cohesion: 0.09
Nodes (73): extractNumber(), calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath() (+65 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (69): checkStuckWorkAgents(), spawnInspectAgent(), buildSpecialistBaseCommand(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, buildAgentLaunchConfig(), getAgentRuntimeBaseCommand(), getProviderAuthMode(), getProviderEnvForModel() (+61 more)
...
Cohesion: 0.04
Nodes (67): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeRoleRunExists(), AgentCrashTracker (+59 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (66): arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding(), FtsRow (+58 more)
...
Cohesion: 0.04
Nodes (57): readLogTail(), RuntimeConversationsConfig, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main() (+49 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (61): Access, extractPrefix(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+53 more)
...
Cohesion: 0.03
Nodes (44): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, fetchMock (+36 more)
...
Cohesion: 0.06
Nodes (49): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig (+41 more)
...
Cohesion: 0.05
Nodes (49): runWithPool(), WorkPoolStats, ConversationFilter, markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+41 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (53): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+45 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (54): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+46 more)
...
Cohesion: 0.07
Nodes (48): ensureExcalidrawMcp(), ensurePlaywrightIsolation(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfig(), changed, config, result, buildClaudeUserSettings() (+40 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (51): ResolveAndSpeakOptions, TtsSpeakMode, TtsSpeakResult, addVoice(), clearVoices(), deleteVoice(), findVoiceById(), findVoiceByName() (+43 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (53): buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatVoiceDetails(), formatVoiceSource(), formatVoicesTable(), listTtsVoices(), mapTtsVoice() (+45 more)
...
Cohesion: 0.07
Nodes (46): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+38 more)
...
Cohesion: 0.08
Nodes (43): deriveProjectRoot(), doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, queueAutoCommit() (+35 more)
...
Cohesion: 0.07
Nodes (40): buildActiveSliceContext(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+32 more)
...
Cohesion: 0.05
Nodes (44): Activity, AgentChannelReply, AgentId, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot, ChannelReplyArtifactRef (+36 more)
...
Cohesion: 0.05
Nodes (37): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+29 more)
...
Cohesion: 0.07
Nodes (25): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+17 more)
...
Cohesion: 0.09
Nodes (36): getTrackerContext(), projectListCommand(), projectShowCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments() (+28 more)
...
Cohesion: 0.1
Nodes (31): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+23 more)
...
Cohesion: 0.11
Nodes (36): Conversation, listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments() (+28 more)
...
Cohesion: 0.08
Nodes (27): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+19 more)
...
Cohesion: 0.07
Nodes (21): inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync (+13 more)
...
Cohesion: 0.08
Nodes (24): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus (+16 more)
...
Cohesion: 0.12
Nodes (18): emitter, onTurn, queue, subscribeVoiceSettings(), isTrustedWebSocketOrigin(), setupVoiceWebSocket(), createGoogleCloudTranscription(), GoogleStreamingRecognizeResponse (+10 more)

### Community 260 - "Community 260"
Cohesion: 0.12
Nodes (24): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions (+16 more)
...
Cohesion: 0.09
Nodes (15): derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient, { rerender }, SessionState (+7 more)

### Community 264 - "Community 264"
Cohesion: 0.11
Nodes (23): DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding(), embed() (+15 more)
...
Cohesion: 0.14
Nodes (22): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync(), uniqueTmpPath() (+14 more)
...
Cohesion: 0.11
Nodes (18): AutoPresoAgentSettings, boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode (+10 more)
...
Cohesion: 0.17
Nodes (19): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+11 more)
...
Cohesion: 0.2
Nodes (18): startPostLaunchSidecars(), startSidecars(), recordRestartStatus(), reportHeldRestartLock(), resolveScope(), restartCommand(), LOGS_DIR, readPlatformConfig() (+10 more)
...
Cohesion: 0.12
Nodes (14): issues, result, loadReviewStatusesForIssues(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+6 more)
...
Cohesion: 0.31
Nodes (7): WipeOptions, extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result
...
Cohesion: 0.4
Nodes (4): chunks, emitter, googleMocks, stream
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 1031`, `Community 263`, `Community 264`, `Community 7`, `Community 9`, `Community 524`, `Community 13`, `Community 8`, `Community 11`, `Community 16`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 282`, `Community 283`, `Community 26`, `Community 798`, `Community 30`, `Community 33`, `Community 34`, `Community 164`, `Community 682`, `Community 427`, `Community 49`, `Community 177`, `Community 51`, `Community 565`, `Community 54`, `Community 187`, `Community 61`, `Community 189`, `Community 64`, `Community 66`, `Community 69`, `Community 592`, `Community 211`, `Community 214`, `Community 215`, `Community 110`, `Community 628`, `Community 629`, `Community 116`, `Community 118`, `Community 634`, `Community 380`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 2` to `Community 33`, `Community 1`, `Community 3`, `Community 35`, `Community 166`, `Community 12`, `Community 15`, `Community 16`, `Community 214`, `Community 55`, `Community 248`, `Community 123`, `Community 29`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 867` to `Community 10`, `Community 92`?**
