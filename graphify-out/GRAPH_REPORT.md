...
## Corpus Check
- 1915 files · ~3,144,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27451 nodes · 43083 edges · 1301 communities (1243 shown, 58 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f00bacdf`
...
## Communities (1301 total, 58 thin omitted)
...
Cohesion: 0.03
Nodes (175): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoff() (+167 more)
...
Cohesion: 0.02
Nodes (149): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+141 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (130): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+122 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (131): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+123 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (129): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+121 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (110): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (111): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (113): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkPendingTestDispatch(), cleanupAbandonedFeedback() (+105 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (104): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions (+96 more)
...
Cohesion: 0.02
Nodes (111): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+103 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (90): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+82 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (100): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ComposerPlugin() (+92 more)
...
Cohesion: 0.02
Nodes (108): dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next (+100 more)
...
Cohesion: 0.03
Nodes (91): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+83 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (96): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+88 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (92): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+84 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (95): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+87 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (89): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+81 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (86): AgentRuntimeState, claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync() (+78 more)
...
Cohesion: 0.03
Nodes (85): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+77 more)
...
Cohesion: 0.04
Nodes (80): string(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+72 more)
...
Cohesion: 0.03
Nodes (79): killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested, cb (+71 more)
...
Cohesion: 0.04
Nodes (60): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcp() (+52 more)
...
Cohesion: 0.04
Nodes (76): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+68 more)
...
Cohesion: 0.04
Nodes (55): createCostCommand(), formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, calculateCost() (+47 more)
...
Cohesion: 0.06
Nodes (60): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+52 more)
...
Cohesion: 0.05
Nodes (58): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth() (+50 more)
...
Cohesion: 0.05
Nodes (52): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+44 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (55): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+47 more)
...
Cohesion: 0.05
Nodes (55): cleanupStaleAgentState(), healthCommand(), HealthOptions, listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+47 more)
...
Cohesion: 0.05
Nodes (51): checkMissingReviewStatuses(), checkPostReviewCommits(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), isReviewSessionForIssue(), killAllReviewSessions(), readConvoySubRoleTemplate() (+43 more)
...
Cohesion: 0.05
Nodes (25): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), normalizeModelName() (+17 more)
...
Cohesion: 0.07
Nodes (47): TrackersConfig, mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker() (+39 more)
...
Cohesion: 0.06
Nodes (41): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest (+33 more)
...
Cohesion: 0.06
Nodes (32): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getUnsyncedHistory() (+24 more)
...
Cohesion: 0.06
Nodes (37): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, FailedMessage, AssistantMessageRow(), formatElapsed() (+29 more)
...
Cohesion: 0.11
Nodes (48): extractNumber(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+40 more)
...
Cohesion: 0.06
Nodes (37): useLiveFlash(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+29 more)
...
Cohesion: 0.06
Nodes (43): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceLive, ReadModelServiceShape (+35 more)
...
Cohesion: 0.07
Nodes (37): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntry() (+29 more)
...
Cohesion: 0.09
Nodes (40): embedAction(), SearchQuery, showAction(), getSetting(), setSetting(), setSettingEffect(), getConversationByName(), aggregateDiscoveredSessionCost() (+32 more)

### Community 121 - "Community 121"
Cohesion: 0.08
Nodes (41): resolveArchiveDir(), pendingTurnFileName(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult (+33 more)
...
Cohesion: 0.09
Nodes (35): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, checkTtsHealth(), startTtsDaemonFromDashboard(), StoredEvent (+27 more)
...
Cohesion: 0.05
Nodes (28): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+20 more)
...
Cohesion: 0.07
Nodes (30): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+22 more)
...
Cohesion: 0.09
Nodes (28): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand(), RunOptions (+20 more)
...
Cohesion: 0.09
Nodes (24): saveConfig(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), isRemoteAvailable(), ProviderType (+16 more)
...
Cohesion: 0.09
Nodes (20): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+12 more)
...
Cohesion: 0.07
Nodes (21): MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient, { rerender } (+13 more)
...
Cohesion: 0.11
Nodes (26): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+18 more)
...
Cohesion: 0.09
Nodes (24): GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, buildContinuation(), convertConversationTranscript(), ConvertOptions, ConvertResult (+16 more)
...
Cohesion: 0.13
Nodes (29): loadConfigAsyncNoMigrationEffect(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+21 more)
...
Cohesion: 0.14
Nodes (28): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+20 more)
...
Cohesion: 0.08
Nodes (17): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig, GitLabConfig (+9 more)
...
Cohesion: 0.08
Nodes (20): EMPTY_HEALTH, MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate, MemoryHealthUpdateOptions, readMemoryHealth(), readMemoryHealthSnapshot() (+12 more)
...
Cohesion: 0.15
Nodes (19): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+11 more)
...
Cohesion: 0.13
Nodes (18): contextMigrateCommand(), AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectRemoveCommand(), SYNC_SOURCES (+10 more)
...
Cohesion: 0.16
Nodes (20): HandoffContext, createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), HANDOFF_LOG_FILE (+12 more)
...
Cohesion: 0.14
Nodes (17): assertIssueHasBeads(), assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect() (+9 more)
...
Cohesion: 0.16
Nodes (14): getForgeAdapter(), ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), execAsync (+6 more)
...
Cohesion: 0.21
Nodes (12): BeadRecord, checkOpenBeads(), checkUncommittedChanges(), errorCode(), execAsync, execFileAsync, isMissingCommand(), isTimeout() (+4 more)
...
- **Why does `string()` connect `Community 30` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 1033`, `Community 10`, `Community 9`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 44`, `Community 45`, `Community 47`, `Community 50`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 580`, `Community 69`, `Community 70`, `Community 71`, `Community 75`, `Community 77`, `Community 589`, `Community 80`, `Community 86`, `Community 91`, `Community 94`, `Community 98`, `Community 104`, `Community 116`, `Community 120`, `Community 121`, `Community 634`, `Community 126`, `Community 141`, `Community 148`, `Community 664`, `Community 666`, `Community 667`, `Community 154`, `Community 161`, `Community 172`, `Community 180`, `Community 189`, `Community 191`, `Community 194`, `Community 196`, `Community 197`, `Community 203`, `Community 206`, `Community 217`, `Community 237`, `Community 248`, `Community 792`, `Community 284`, `Community 796`, `Community 286`, `Community 299`, `Community 300`, `Community 301`, `Community 335`, `Community 338`, `Community 347`, `Community 872`, `Community 366`, `Community 367`, `Community 393`, `Community 419`, `Community 422`, `Community 935`, `Community 455`, `Community 457`, `Community 469`, `Community 488`, `Community 491`, `Community 505`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 3`, `Community 259`, `Community 5`, `Community 6`, `Community 8`, `Community 395`, `Community 11`, `Community 13`, `Community 14`, `Community 271`, `Community 16`, `Community 397`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 150`, `Community 789`, `Community 22`, `Community 27`, `Community 285`, `Community 29`, `Community 288`, `Community 33`, `Community 35`, `Community 39`, `Community 300`, `Community 47`, `Community 53`, `Community 55`, `Community 59`, `Community 12`, `Community 62`, `Community 196`, `Community 457`, `Community 202`, `Community 75`, `Community 77`, `Community 84`, `Community 85`, `Community 88`, `Community 221`, `Community 248`, `Community 234`, `Community 632`, `Community 249`, `Community 123`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 26` to `Community 64`, `Community 419`, `Community 535`, `Community 5`, `Community 36`, `Community 9`, `Community 12`, `Community 205`, `Community 50`, `Community 18`, `Community 340`, `Community 22`, `Community 23`, `Community 314`?**
