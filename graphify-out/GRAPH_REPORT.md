...
## Corpus Check
- 1748 files · ~2,336,575 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23965 nodes · 36770 edges · 1219 communities (1170 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 532 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fc8fbc4`
...
## Communities (1219 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (157): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn(), sleep() (+149 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (157): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (122): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+114 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (135): isEligibleForCleanup(), buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync (+127 more)
...
Cohesion: 0.03
Nodes (86): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+78 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (85): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ViewMode (+77 more)
...
Cohesion: 0.04
Nodes (89): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+81 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (68): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, FailedMessage (+60 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (82): pendingCommand(), after, before, blockers, result, statuses, after, row (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (66): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue (+58 more)
...
Cohesion: 0.04
Nodes (77): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), scheduleDigestGeneration(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist() (+69 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (76): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker (+68 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (62): TurnDiffSummary, WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse (+54 more)
...
Cohesion: 0.04
Nodes (79): sendMessageToAgent(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (61): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, { projectPath, workspacePath }, promoted, specFiles, fsHooks, after (+53 more)
...
Cohesion: 0.05
Nodes (76): buildACLookupByTitle(), buildActiveSliceContext(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readPendingFeedback(), readWorkspacePlanAsync(), WorkAgentPromptContext (+68 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (62): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView, SwarmStateView, INSPECTOR_PANEL_SOURCE (+54 more)
...
Cohesion: 0.03
Nodes (71): computeAgentEnrichment(), isAgentStateServiceInProcess(), setAgentRuntimeMirror(), AgentRuntimeState, getAgentRuntimeStateAsync(), getLatestSessionIdAsync(), snapshotToRuntimeState(), getWorkAgentLifecycleStateAsync() (+63 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (76): agentDir, dir1, dir2, marker, missing, nested, PlanningIssue, invalidateAgentsCache() (+68 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (72): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (70): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+62 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (69): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, ghCliIssue (+61 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (71): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields(), continueDirForWorkspace() (+63 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (63): archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, CloisterStatusBar() (+55 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (64): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+56 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (69): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+61 more)
...
Cohesion: 0.04
Nodes (54): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+46 more)
...
Cohesion: 0.05
Nodes (67): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+59 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (61): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (63): buildWorkAgentPrompt(), getTrackerContext(), readBeadsTasks(), readPlanningContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace() (+55 more)
...
Cohesion: 0.04
Nodes (56): DEFAULTS, UIPreferences, useUIPreferences(), DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType (+48 more)
...
Cohesion: 0.05
Nodes (55): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.08
Nodes (57): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+49 more)
...
Cohesion: 0.05
Nodes (51): adminRouteLayer, getAdminTldrRoute, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute (+43 more)
...
Cohesion: 0.05
Nodes (52): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+44 more)
...
Cohesion: 0.06
Nodes (53): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), getNextSequenceNumber() (+45 more)
...
Cohesion: 0.05
Nodes (48): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+40 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (56): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+48 more)
...
Cohesion: 0.06
Nodes (45): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+37 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (41): makeTestService(), sentinel, createEventStore(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore() (+33 more)
...
Cohesion: 0.08
Nodes (46): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+38 more)
...
Cohesion: 0.08
Nodes (45): killCommand(), KillOptions, destroyRemoteWorkspace(), buildClaudeUserSettings(), bypassPrefixForAgentFlag(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString() (+37 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (45): agentDir, missing, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds(), Jsonish (+37 more)
...
Cohesion: 0.05
Nodes (41): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, readInferenceDocument(), updateInferenceDocument() (+33 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (41): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps (+33 more)
...
Cohesion: 0.06
Nodes (48): Access, readLogTail(), AIProvider, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), validateCwdContainment() (+40 more)
...
Cohesion: 0.07
Nodes (44): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+36 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (46): embedAction(), normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), aggregateDiscoveredSessionCost() (+38 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (32): ConversationTerminalProps, resumeConversation(), StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage (+24 more)
...
Cohesion: 0.06
Nodes (34): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+26 more)
...
Cohesion: 0.08
Nodes (40): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+32 more)
...
Cohesion: 0.06
Nodes (38): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+30 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (34): criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+26 more)
...
Cohesion: 0.07
Nodes (36): getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG (+28 more)
...
Cohesion: 0.05
Nodes (38): agentsRouteLayer, conversationsRouteLayer, issuesRouteLayer, miscRouteLayer, projectsRouteLayer, getRemoteAgentOutputRoute, getRemoteStatusRoute, getRemoteWorkspaceRoute (+30 more)
...
Cohesion: 0.05
Nodes (41): Activity, AgentChannelReply, AgentId, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+33 more)
...
Cohesion: 0.06
Nodes (36): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+28 more)
...
Cohesion: 0.07
Nodes (28): isErrnoException(), readRestartStatus(), RestartStatus, restartStatusPath(), RestartTrigger, writeRestartStatus(), FetchFn, InternalState (+20 more)
...
Cohesion: 0.11
Nodes (31): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR (+23 more)
...
Cohesion: 0.09
Nodes (31): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+23 more)
...
Cohesion: 0.08
Nodes (28): showAction(), getDiscoveredSessionById(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+20 more)
...
Cohesion: 0.08
Nodes (26): firstSessionPanel, firstWorkbench, overview, workbench, IssueComposer(), IssueWorkbench(), IssueWorkbenchProps, CommandDeckSelectionState (+18 more)
...
Cohesion: 0.11
Nodes (28): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHandle (+20 more)
...
Cohesion: 0.07
Nodes (29): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+21 more)

### Community 209 - "Community 209"
Cohesion: 0.06
Nodes (32): ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema, EnrichBodySchema (+24 more)
...
Cohesion: 0.12
Nodes (24): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus (+16 more)

### Community 224 - "Community 224"
Cohesion: 0.07
Nodes (21): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName() (+13 more)
...
Cohesion: 0.11
Nodes (25): scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+17 more)
...
Cohesion: 0.08
Nodes (17): NormalizedTtsDaemonConfig, parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, CONFIG, hadPackageDir (+9 more)
...
Cohesion: 0.08
Nodes (20): ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS, HarnessDecision (+12 more)

### Community 267 - "Community 267"
Cohesion: 0.09
Nodes (23): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+15 more)
...
Cohesion: 0.09
Nodes (21): issues, result, importTrackerConfig(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+13 more)
...
Cohesion: 0.11
Nodes (23): DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, EmbedSessionsOptions, selectSessionIdsForEmbedding(), embed() (+15 more)
...
Cohesion: 0.16
Nodes (23): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), createdAgeMs(), defaultWorkspacePath(), DockerPsJson, escapeRegExp(), evaluateWorkspaceStackHealth(), getWorkspaceStackHealth() (+15 more)
...
Cohesion: 0.16
Nodes (19): clearFeedbackFiles(), readFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), uniqueTmpPath(), workspacePanPaths() (+11 more)
...
Cohesion: 0.14
Nodes (18): CopyConfigOptions, getPanopticonHome(), deliverQueuedFeedback(), enqueuePendingFeedbackDelivery(), FeedbackKind, isDeliveryStillRelevant(), markPendingFeedbackDelivered(), PENDING_FEEDBACK_FILE (+10 more)
...
Cohesion: 0.17
Nodes (15): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), StepResult (+7 more)
...
Cohesion: 0.12
Nodes (15): all, cookie, fetched, filter, inserted, p, pA, params (+7 more)
...
Cohesion: 0.15
Nodes (13): cleanupLabelsGitHub(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel, mockClientIssueLabels (+5 more)
...
Cohesion: 0.18
Nodes (12): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichReviewArtifactBody(), bead (+4 more)
...
Cohesion: 0.2
Nodes (10): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus (+2 more)
...
Cohesion: 0.22
Nodes (7): resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, health, now, projectRoot, workspacePath, resetWorkspaceStackHealthTransitionsForTests()
...
## Knowledge Gaps
- **12456 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12451 more)
...
- **Why does `fetch` connect `Community 30` to `Community 1`, `Community 2`, `Community 131`, `Community 132`, `Community 5`, `Community 6`, `Community 7`, `Community 130`, `Community 515`, `Community 10`, `Community 11`, `Community 12`, `Community 4`, `Community 1038`, `Community 1039`, `Community 16`, `Community 181`, `Community 19`, `Community 20`, `Community 26`, `Community 283`, `Community 28`, `Community 413`, `Community 542`, `Community 289`, `Community 34`, `Community 39`, `Community 40`, `Community 43`, `Community 429`, `Community 430`, `Community 175`, `Community 817`, `Community 307`, `Community 52`, `Community 693`, `Community 54`, `Community 183`, `Community 56`, `Community 57`, `Community 58`, `Community 698`, `Community 59`, `Community 317`, `Community 62`, `Community 699`, `Community 448`, `Community 315`, `Community 66`, `Community 67`, `Community 69`, `Community 585`, `Community 586`, `Community 75`, `Community 205`, `Community 77`, `Community 1103`, `Community 1104`, `Community 208`, `Community 84`, `Community 213`, `Community 90`, `Community 605`, `Community 222`, `Community 223`, `Community 609`, `Community 877`, `Community 248`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 1` to `Community 0`, `Community 3`, `Community 163`, `Community 195`, `Community 358`, `Community 38`, `Community 648`, `Community 9`, `Community 170`, `Community 8`, `Community 75`, `Community 174`, `Community 495`, `Community 18`, `Community 51`, `Community 55`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 19` to `Community 98`, `Community 99`, `Community 68`, `Community 37`, `Community 4`, `Community 8`, `Community 207`, `Community 17`, `Community 21`, `Community 29`, `Community 287`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12456 weakly-connected nodes found - possible documentation gaps or missing edges._
