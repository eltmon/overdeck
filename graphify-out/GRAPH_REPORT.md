...
## Corpus Check
- 1565 files · ~2,061,265 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21626 nodes · 32029 edges · 1134 communities (1094 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c0621f0`
...
## Communities (1134 total, 40 thin omitted)
...
Cohesion: 0.03
Nodes (117): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+109 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (133): setAgentStoppedNotifier(), pendingCommand(), after, before, blockers, result, statuses, after (+125 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (124): autoResumeStoppedWorkAgents(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+116 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (114): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+106 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (102): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSession(), parsePiSessionContent(), ParseResult (+94 more)
...
Cohesion: 0.03
Nodes (116): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt() (+108 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (117): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+109 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (105): cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), waitForReviewerOutputs(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus() (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (104): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+96 more)
...
Cohesion: 0.02
Nodes (84): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+76 more)
...
Cohesion: 0.03
Nodes (87): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName (+79 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (82): CLEAR_ON, postPermissionEventRoute, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+74 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (79): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+71 more)
...
Cohesion: 0.03
Nodes (62): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+54 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (74): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+66 more)
...
Cohesion: 0.04
Nodes (61): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc, result, result (+53 more)
...
Cohesion: 0.06
Nodes (71): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+63 more)
...
Cohesion: 0.04
Nodes (59): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+51 more)
...
Cohesion: 0.07
Nodes (51): PlanFinalizeOptions, stampPlanForFinalization(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), after, continueContent, continueState (+43 more)
...
Cohesion: 0.06
Nodes (52): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+44 more)
...
Cohesion: 0.04
Nodes (45): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), initSchema() (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (48): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), activeDir (+40 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (45): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags() (+37 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (51): { config }, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (46): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+38 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (48): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+40 more)
...
Cohesion: 0.06
Nodes (36): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, WorkLogEntry, AssistantMessageRow(), formatElapsed(), formatTimestamp() (+28 more)
...
Cohesion: 0.06
Nodes (46): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData() (+38 more)
...
Cohesion: 0.07
Nodes (41): startPostLaunchSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), isSmeeRunning() (+33 more)
...
Cohesion: 0.07
Nodes (33): beadsDir, doc, dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync } (+25 more)
...
Cohesion: 0.06
Nodes (38): findWorkspaceRoot(), planFinalizeCommand(), computePlanningState(), badPath, customPlanningDir, dir, doc, filename (+30 more)
...
Cohesion: 0.07
Nodes (34): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+26 more)
...
Cohesion: 0.07
Nodes (33): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+25 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (31): shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+23 more)
...
Cohesion: 0.1
Nodes (34): inferIssueIdFromWorkspace(), readPendingFeedback(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+26 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (33): DEFAULTS, UIPreferences, useUIPreferences(), Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef (+25 more)
...
Cohesion: 0.1
Nodes (30): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+22 more)
...
Cohesion: 0.07
Nodes (33): buildConvoyPrompt(), readConvoySubRoleTemplate(), spawnReviewSubRoleForIssue(), content, dashboardStopIdx, dispatchFailedMatches, downBlockMatch, { mockKillSessionAsync } (+25 more)
...
Cohesion: 0.1
Nodes (34): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+26 more)
...
Cohesion: 0.11
Nodes (30): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), ensurePanDirs() (+22 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (30): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+22 more)
...
Cohesion: 0.11
Nodes (30): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+22 more)
...
Cohesion: 0.1
Nodes (29): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), evaluateSeverity() (+21 more)

### Community 177 - "Community 177"
Cohesion: 0.06
Nodes (32): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES (+24 more)
...
Cohesion: 0.1
Nodes (27): agentDir, missing, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState (+19 more)
...
Cohesion: 0.09
Nodes (16): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+8 more)

### Community 221 - "Community 221"
Cohesion: 0.1
Nodes (18): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), fmtCost(), fmtDuration(), ReviewSummary() (+10 more)
...
Cohesion: 0.22
Nodes (26): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+18 more)
...
Cohesion: 0.09
Nodes (17): readFeatureContext(), WorkAgentPromptContext, writeStoryFeatureContext(), readWorkspaceContext(), mockGetIssue, parentWorkspace, planDoc, written (+9 more)
...
Cohesion: 0.09
Nodes (16): getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller, websocketRpcRouteLayer, watchConversation(), EditorLaunch (+8 more)
...
Cohesion: 0.18
Nodes (13): registerAdminCommands(), registerCloisterCommands(), registerBeadsCommands(), registerConfigCommand(), registerDbCommands(), registerRemoteCommands(), checkJqInstalled(), ClaudeSettings (+5 more)
...
Cohesion: 0.12
Nodes (14): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+6 more)
...
Cohesion: 0.2
Nodes (12): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichReviewArtifactBody(), buildRichPRBody(), ensurePRExists() (+4 more)
...
Cohesion: 0.29
Nodes (12): startSidecars(), readPlatformConfig(), getSupervisorPort(), getSupervisorUrl(), isProcessAlive(), isSupervisorRunning(), readSupervisorPid(), resolveSupervisorBundle() (+4 more)
...
Cohesion: 0.26
Nodes (11): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+3 more)
...
Cohesion: 0.23
Nodes (9): cleanupAllLogs(), cleanupOldLogs(), listProjectsWithSpecialists(), getSpecialistRetention(), cleanupLogsCommand(), resetCommand(), ResetOptions, wakeCommand() (+1 more)
...
Cohesion: 0.21
Nodes (9): PROVIDER_INFO, ProviderPanelProps, ApiKeysConfig, DeprecationWarning, Harness, ModelsConfig, Provider, ProvidersConfig (+1 more)
...
Cohesion: 0.2
Nodes (8): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), ensureResourceConfigLoaded(), readGlobalResourceConfig(), resolveFiniteNumber(), SystemHealthSnapshot, decision
...
## Knowledge Gaps
- **11469 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11464 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 636`, `Community 2`, `Community 6`, `Community 268`, `Community 141`, `Community 524`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 148`, `Community 24`, `Community 25`, `Community 154`, `Community 155`, `Community 26`, `Community 31`, `Community 544`, `Community 33`, `Community 419`, `Community 36`, `Community 803`, `Community 175`, `Community 50`, `Community 53`, `Community 58`, `Community 12`, `Community 63`, `Community 588`, `Community 337`, `Community 217`, `Community 744`, `Community 107`, `Community 628`, `Community 631`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 25` to `Community 37`, `Community 106`, `Community 749`, `Community 81`, `Community 244`, `Community 88`, `Community 187`, `Community 28`, `Community 445`, `Community 63`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 144` to `Community 13`, `Community 525`?**
