...
## Corpus Check
- 1930 files · ~3,154,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27622 nodes · 43424 edges · 1306 communities (1249 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 806 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5c26354`
...
## Communities (1306 total, 57 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (173): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+165 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (173): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+165 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (138): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+130 more)
...
Cohesion: 0.02
Nodes (148): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, PlanningState, ZoneAActionsState (+140 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (120): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (129): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), closeOutCommand(), CloseOutOptions, execFileAsync (+121 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (141): checkStuckWorkAgents(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), parseThinkingDuration(), buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync (+133 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (141): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (100): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+92 more)
...
Cohesion: 0.02
Nodes (114): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+106 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (85): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync() (+77 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (101): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+93 more)
...
Cohesion: 0.02
Nodes (105): confirmHostOverride(), resumeCommand(), ResumeOptions, getRuntimeSnapshot(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror() (+97 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (106): DatabaseError, dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+98 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (99): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), TtsDaemonStartResult, buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram (+91 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (90): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+82 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (93): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+85 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (73): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+65 more)
...
Cohesion: 0.03
Nodes (86): agentDir, dir1, dir2, marker, missing, nested, importTrackerConfig(), pending (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (86): deliverReviewVerdictFeedback(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+78 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (68): ensureOpenAICompatibleProxyRunning(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+60 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (79): checkFailedMergeRetry(), checkPendingTestDispatch(), checkUndispatchedShip(), cleanupAbandonedFeedback(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult (+71 more)
...
Cohesion: 0.06
Nodes (95): add, addCommentBefore(), addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), anchorNames() (+87 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (71): ActivityLevel, ActivitySource, emitActivityDetailedSync(), EmitActivityOptions, emitActivityTtsSync(), EmitDetailedOptions, EmitTtsOptions, normalizeForSpeech() (+63 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (63): PanSpecListOptions, ProjectPanPaths, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path, paths (+55 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (68): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+60 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (79): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+71 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (82): dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), flywheelStartCommand(), parseFlywheelStatusJson(), postFlywheelStatus(), readFlywheelStatusJson(), registerFlywheelCommands() (+74 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (73): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (80): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+72 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (75): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+67 more)
...
Cohesion: 0.03
Nodes (70): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+62 more)
...
Cohesion: 0.04
Nodes (69): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, Handler, PipelineEvent, setPipelineHandlerSync(), ensureManagedTmuxContextOnce(), resolveAndSpeak() (+61 more)
...
Cohesion: 0.04
Nodes (69): claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange(), runInline() (+61 more)
...
Cohesion: 0.03
Nodes (70): CorrelationResult, resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime() (+62 more)
...
Cohesion: 0.05
Nodes (68): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+60 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (66): arrayIndexCondition(), ArrayIndexTarget, buildFilterSql(), CosineSearchResult, cosineSimilarity(), countFtsSessions(), FtsRow, FtsSearchResult (+58 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (51): AutoMergeRow, AutoMergeStatus, cancelPendingAutoMerge(), DbAutoMergeRow, getAutoMergeStatus(), getPendingAutoMerges(), markAutoMergeAborted(), markAutoMergeExecuted() (+43 more)
...
Cohesion: 0.04
Nodes (57): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+49 more)
...
Cohesion: 0.03
Nodes (57): { activeSessions }, agentDir, fortyMinutesAgo, runDetermineHealthStatus(), twentyMinutesAgo, result, checkAgentHealth(), determineHealthStatus() (+49 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (51): ConversationMutations, useAvailableModels(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps (+43 more)
...
Cohesion: 0.05
Nodes (27): stopDeacon(), createHandoffEvent(), performHandoff(), generateHealthSummary(), getAgentsNeedingAttention(), CloisterService, readStateFile(), writeStateFile() (+19 more)
...
Cohesion: 0.04
Nodes (55): listConversations(), markConversationActive(), updateForkStatus(), dismissDevChannelsDialog(), MessageDeliveryFailed, sendRawKeystroke(), waitForClaudePrompt(), aboutSummaryCache (+47 more)
...
Cohesion: 0.04
Nodes (59): assertIssueHasBeads(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue() (+51 more)
...
Cohesion: 0.04
Nodes (49): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getRecentSessionsSync(), getSessionFilesSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync() (+41 more)
...
Cohesion: 0.05
Nodes (49): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+41 more)
...
Cohesion: 0.05
Nodes (46): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+38 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (53): agentDir, missing, snapshot, status, AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), discoverNewAgentIds() (+45 more)
...
Cohesion: 0.07
Nodes (45): checkCompletedButUnsignaledReviews(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise() (+37 more)
...
Cohesion: 0.06
Nodes (48): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), createSummaryFork(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel() (+40 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (43): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+35 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (32): issues, result, getIssueDataService(), getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry (+24 more)

### Community 84 - "Community 84"
Cohesion: 0.05
Nodes (46): closeMemoryFtsDatabases(), runMemoryFtsTransaction(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate (+38 more)
...
Cohesion: 0.05
Nodes (46): buildCorrelationMapSync(), ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+38 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (44): showCommand(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+36 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (47): embedAction(), registerConversationsCommands(), ScanOptions, SearchQuery, showAction(), DatabaseError, getSetting(), getSettingProgram() (+39 more)
...
Cohesion: 0.05
Nodes (37): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+29 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (46): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+38 more)
...
Cohesion: 0.08
Nodes (43): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), startSidecars() (+35 more)
...
Cohesion: 0.07
Nodes (28): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, syncWalFromAllProjects(), IssueAggregate, BUDGETS_FILE (+20 more)
...
Cohesion: 0.06
Nodes (36): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), searchFts(), createConfiguredClaudeApi(), EnrichmentResponse (+28 more)
...
Cohesion: 0.05
Nodes (38): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+30 more)
...
Cohesion: 0.12
Nodes (44): bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxy(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), CliproxyCodexCredentials, CliproxyError (+36 more)
...
Cohesion: 0.08
Nodes (42): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+34 more)
...
Cohesion: 0.07
Nodes (23): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, isTrustedWebSocketOrigin() (+15 more)
...
Cohesion: 0.08
Nodes (36): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+28 more)
...
Cohesion: 0.07
Nodes (39): enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated (+31 more)

### Community 152 - "Community 152"
Cohesion: 0.09
Nodes (34): HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions (+26 more)

### Community 153 - "Community 153"
Cohesion: 0.06
Nodes (29): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfigSync(), GitHubConfig, GitLabConfig, LinearConfig (+21 more)
...
Cohesion: 0.07
Nodes (37): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+29 more)
...
Cohesion: 0.13
Nodes (32): createTracker(), createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv (+24 more)
...
Cohesion: 0.07
Nodes (24): ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), stopTranscriptPoller() (+16 more)
...
Cohesion: 0.08
Nodes (33): after, backupPath, backups, calls, errSpy, exitSpy, original, out (+25 more)
...
Cohesion: 0.05
Nodes (37): Activity, AgentChannelReply, AgentId, AgentResolution, AgentStatus, AutoMergeScheduledSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelReplyArtifactRef (+29 more)
...
Cohesion: 0.06
Nodes (25): getConversationsConfig(), getConversationsConfigSync(), resolveConversationWatchDirs(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload() (+17 more)
...
Cohesion: 0.08
Nodes (30): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration() (+22 more)

### Community 192 - "Community 192"
Cohesion: 0.07
Nodes (23): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth(), HealthSummary (+15 more)
...
Cohesion: 0.12
Nodes (35): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise() (+27 more)
...
Cohesion: 0.1
Nodes (31): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+23 more)
...
Cohesion: 0.09
Nodes (29): deleteHumeConfig(), removeTunnelIngress(), getDefaultWorkspaceConfigSync(), AddReposToWorkspaceOptions, addReposToWorkspacePromise(), AddReposToWorkspaceResult, assignPort(), copyPanopticonSettingsToWorkspaceSync() (+21 more)
...
Cohesion: 0.09
Nodes (28): startPostLaunchSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunningSync(), errorSpy (+20 more)
...
Cohesion: 0.09
Nodes (25): runMemoryFtsStatement(), ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchHit, MemorySearchRow (+17 more)
...
Cohesion: 0.15
Nodes (31): archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+23 more)

### Community 246 - "Community 246"
Cohesion: 0.11
Nodes (28): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+20 more)
...
Cohesion: 0.1
Nodes (18): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+10 more)
...
Cohesion: 0.12
Nodes (23): detectAwaitingInputForAgent(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+15 more)
...
Cohesion: 0.11
Nodes (3): getProjectDirsSync(), ClaudeCodeRuntime, ClaudeCodeRuntimeSync
...
Cohesion: 0.1
Nodes (17): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose (+9 more)
...
Cohesion: 0.14
Nodes (23): extractNumberSync(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult, approve() (+15 more)
...
Cohesion: 0.14
Nodes (21): clearFeedbackFilesPromise(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+13 more)
...
Cohesion: 0.1
Nodes (14): CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistorySync(), getAgentsWithHistorySync(), getAllHealthHistorySync(), getDatabaseStatsSync(), getHealthDatabase(), getHealthHistorySync() (+6 more)
...
Cohesion: 0.17
Nodes (15): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, AgentCV, completeWorkSync(), formatCVSync() (+7 more)
...
Cohesion: 0.13
Nodes (18): getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise(), resolveShadowMode() (+10 more)
...
Cohesion: 0.14
Nodes (18): array, combine, hash(), intIdentify(), intStringify(), number(), optimize(), random() (+10 more)
...
Cohesion: 0.12
Nodes (12): createTerminalWindow(), createWindow(), dispatchMenuAction(), resolveWindowUrl(), showOrCreateWindow(), baseFlywheelStatus, consoleErrors, metrics (+4 more)
...
Cohesion: 0.19
Nodes (10): getSupervisorPortSync(), getSupervisorUrlSync(), isProcessAlive(), isSupervisorRunningSync(), readSupervisorPid(), resolveSupervisorBundle(), startSupervisorProcessSync(), stopSupervisorProcessSync() (+2 more)
...
Cohesion: 0.13
Nodes (4): FlyExecResult, FlyMachine, FlyMachineConfig, toFlyApiError()
...
Cohesion: 0.22
Nodes (5): FlyApiError, client, fetchMock, machine, machines
...
Cohesion: 0.5
Nodes (4): cleanupOldEventsSync(), initHealthDatabase(), openSqliteDb(), _require
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 526`, `Community 15`, `Community 16`, `Community 530`, `Community 19`, `Community 20`, `Community 533`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 555`, `Community 44`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 54`, `Community 61`, `Community 64`, `Community 65`, `Community 582`, `Community 583`, `Community 70`, `Community 73`, `Community 76`, `Community 79`, `Community 82`, `Community 86`, `Community 87`, `Community 88`, `Community 97`, `Community 98`, `Community 102`, `Community 105`, `Community 109`, `Community 110`, `Community 122`, `Community 124`, `Community 135`, `Community 141`, `Community 149`, `Community 150`, `Community 151`, `Community 669`, `Community 161`, `Community 173`, `Community 174`, `Community 198`, `Community 712`, `Community 200`, `Community 206`, `Community 207`, `Community 210`, `Community 221`, `Community 222`, `Community 235`, `Community 244`, `Community 245`, `Community 258`, `Community 278`, `Community 800`, `Community 291`, `Community 293`, `Community 805`, `Community 307`, `Community 311`, `Community 331`, `Community 332`, `Community 343`, `Community 345`, `Community 392`, `Community 393`, `Community 394`, `Community 419`, `Community 421`, `Community 464`, `Community 467`, `Community 483`, `Community 485`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 30` to `Community 418`, `Community 5`, `Community 38`, `Community 553`, `Community 10`, `Community 335`, `Community 16`, `Community 209`, `Community 19`, `Community 20`, `Community 83`, `Community 310`, `Community 87`, `Community 311`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 9`, `Community 10`, `Community 11`, `Community 396`, `Community 269`, `Community 13`, `Community 14`, `Community 17`, `Community 273`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 666`, `Community 157`, `Community 30`, `Community 31`, `Community 34`, `Community 291`, `Community 292`, `Community 39`, `Community 41`, `Community 169`, `Community 43`, `Community 51`, `Community 52`, `Community 61`, `Community 191`, `Community 65`, `Community 68`, `Community 69`, `Community 198`, `Community 71`, `Community 200`, `Community 205`, `Community 78`, `Community 466`, `Community 211`, `Community 82`, `Community 94`, `Community 96`, `Community 225`, `Community 98`, `Community 100`, `Community 244`, `Community 117`, `Community 758`, `Community 636`, `Community 638`?**
