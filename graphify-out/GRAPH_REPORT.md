...
## Corpus Check
- 1545 files · ~2,065,610 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21579 nodes · 32120 edges · 1121 communities (1088 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f75caf5`
...
## Communities (1121 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (184): autoResumeStoppedWorkAgents(), checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+176 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (114): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS (+106 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (131): readCavemanVariant(), renderPrompt(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags(), bumpSessionGeneration() (+123 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (120): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+112 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (109): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+101 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (104): ActivityPanel(), ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists() (+96 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (123): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+115 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (108): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (94): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+86 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (109): checkThinkingSignatureCorruption(), nudgeIdleWorkAgentsWithOpenBeads(), spawnRebaseAgentForBranch(), sendFeedbackToWorkAgent(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+101 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (91): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+83 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (96): setAgentStoppedNotifier(), db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (84): parsePiSession(), getPiLauncherFields(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent (+76 more)
...
Cohesion: 0.03
Nodes (83): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+75 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (84): checkFailedMergeRetry(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (81): resolveSpecialistBaseCommand(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (89): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+81 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (82): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execFile(), kCustom, mockExecFile (+74 more)
...
Cohesion: 0.03
Nodes (55): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, HandoffResult, createHandoffEvent() (+47 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (67): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (76): AwaitingInputDetection, withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+68 more)
...
Cohesion: 0.03
Nodes (65): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (76): archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker() (+68 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (65): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, MOCK_ISSUE (+57 more)
...
Cohesion: 0.06
Nodes (58): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument(), readSpec(), updateSpecStatus() (+50 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (63): buildReviewFeedbackBody(), getFilesChangedFromPR(), getReviewAgents(), ReviewContext, ReviewResult, reviewResultToReviewStatus(), active, activeSessions (+55 more)
...
Cohesion: 0.06
Nodes (61): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+53 more)
...
Cohesion: 0.04
Nodes (47): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentGrid(), AgentGridProps, ConnectionLines() (+39 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (56): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+48 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (51): Access, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session(), find_sessions() (+43 more)
...
Cohesion: 0.06
Nodes (41): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir, doc, after, doc (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (39): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, WorkLogEntry, FailedMessage (+31 more)
...
Cohesion: 0.04
Nodes (36): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+28 more)
...
Cohesion: 0.06
Nodes (41): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+33 more)
...
Cohesion: 0.09
Nodes (39): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+31 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (38): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+30 more)
...
Cohesion: 0.08
Nodes (37): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+29 more)
...
Cohesion: 0.05
Nodes (27): callServerApi(), currentStatus, DEFAULTS, electron, electron_updater, fetchActiveWorkspaces(), iconPath, initializeAutoUpdater() (+19 more)
...
Cohesion: 0.11
Nodes (29): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+21 more)
...
Cohesion: 0.1
Nodes (30): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, ensureResourceConfigLoaded(), evaluateSeverity() (+22 more)
...
Cohesion: 0.13
Nodes (24): writeStoryFeatureContext(), validatePlanMatchesIssue(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+16 more)
...
Cohesion: 0.14
Nodes (21): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+13 more)
...
Cohesion: 0.2
Nodes (20): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+12 more)
...
Cohesion: 0.09
Nodes (18): closeResult, command, ctx, labelResult, prResult, archiveIdx, beadsDir, branchStep (+10 more)

### Community 365 - "Community 365"
Cohesion: 0.12
Nodes (17): ActivityItem(), ActivityPanelProps, ActivityStream, CategoryFilter, fetchActivityREST(), fetchDetailedActivityREST(), fetchGitActivity(), fetchTtsActivityREST() (+9 more)

### Community 366 - "Community 366"
Cohesion: 0.14
Nodes (14): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, DiffStatLabel, hasNonZeroStat(), buildTurnDiffTree(), MutableDirectoryNode, normalizePathSegments(), readStat() (+6 more)
...
Cohesion: 0.13
Nodes (17): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+9 more)
...
Cohesion: 0.12
Nodes (14): ActivityEntry, applyPinWarnings(), mergeActivitiesById(), a1, a2, entries, entry, git (+6 more)
...
Cohesion: 0.33
Nodes (9): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, AGENTS_DIR (+1 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 8`, `Community 522`, `Community 10`, `Community 11`, `Community 142`, `Community 14`, `Community 272`, `Community 145`, `Community 18`, `Community 20`, `Community 22`, `Community 24`, `Community 152`, `Community 26`, `Community 27`, `Community 153`, `Community 29`, `Community 797`, `Community 543`, `Community 32`, `Community 35`, `Community 550`, `Community 43`, `Community 45`, `Community 47`, `Community 176`, `Community 48`, `Community 56`, `Community 60`, `Community 98`, `Community 99`, `Community 744`, `Community 365`, `Community 630`, `Community 633`, `Community 126`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 128` to `Community 9`, `Community 10`, `Community 260`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 35` to `Community 0`, `Community 2`, `Community 4`?**
