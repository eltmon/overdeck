...
## Corpus Check
- 1887 files · ~3,052,887 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26748 nodes · 41512 edges · 1232 communities (1184 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a02e813d`
...
## Communities (1232 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (190): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+182 more)
...
Cohesion: 0.02
Nodes (125): cn(), AgentCard(), AgentCardIssue, AgentCardMeta, AgentCardProps, AgentCardRole, card, name (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (120): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, SwitchModelModal() (+112 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (137): performKillAndSpawn(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand() (+129 more)
...
Cohesion: 0.03
Nodes (126): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (115): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+107 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (91): parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder, checkFn, killed (+83 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (105): checkPostReviewCommits(), monitorReviewConvoySignals(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (104): IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS, OverviewTab, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (103): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig() (+95 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (91): ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+83 more)
...
Cohesion: 0.03
Nodes (87): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+79 more)
...
Cohesion: 0.03
Nodes (80): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+72 more)
...
Cohesion: 0.03
Nodes (99): generateFallbackSummary(), ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle() (+91 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (71): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+63 more)
...
Cohesion: 0.02
Nodes (75): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+67 more)
...
Cohesion: 0.03
Nodes (90): detectMergedSwarmSlots(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+82 more)
...
Cohesion: 0.03
Nodes (96): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession() (+88 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (91): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+83 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (89): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, SearchResult (+81 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (87): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache (+79 more)
...
Cohesion: 0.04
Nodes (79): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+71 more)
...
Cohesion: 0.03
Nodes (69): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, AgentHealth (+61 more)
...
Cohesion: 0.03
Nodes (86): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), completePendingOperation(), ContainerPortBinding, ContainerServiceHealth (+78 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (65): PanSpecListOptions, ProjectPanPaths, { projectPath, workspacePath }, promoted, specFiles, fsHooks, doc, items (+57 more)
...
Cohesion: 0.04
Nodes (76): dismissDevChannelsDialog(), listRunningAgentsAsync(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS (+68 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (53): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+45 more)
...
Cohesion: 0.04
Nodes (32): issues, result, importTrackerConfig(), findProjectsByRallyProject(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+24 more)
...
Cohesion: 0.04
Nodes (65): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+57 more)
...
Cohesion: 0.03
Nodes (65): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+57 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (66): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+58 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (58): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+50 more)
...
Cohesion: 0.06
Nodes (38): createFlyApiClient(), createFlyProvider(), effFromPromise(), execAsync, FlyProvider, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly (+30 more)
...
Cohesion: 0.05
Nodes (57): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+49 more)
...
Cohesion: 0.07
Nodes (61): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+53 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (61): extractNumber(), extractPrefix(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl() (+53 more)
...
Cohesion: 0.06
Nodes (59): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+51 more)
...
Cohesion: 0.04
Nodes (53): startPostLaunchSidecars(), startSidecars(), systemHealthCommand(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive() (+45 more)
...
Cohesion: 0.07
Nodes (60): getMemoryStatus(), writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir(), resolveCheckpointFile() (+52 more)
...
Cohesion: 0.05
Nodes (51): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), isReviewSessionForIssue(), killAllReviewerSessions(), readConvoySubRoleTemplate(), reviewerAgentId() (+43 more)
...
Cohesion: 0.05
Nodes (49): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, emitActivityDetailed(), withConcurrencyLimit(), stopTranscriptPoller(), getIssueDataService() (+41 more)
...
Cohesion: 0.04
Nodes (36): AgentState, __testInternals, buildMemoryIdentity(), ClaudeCodeTranscriptSource, ClaudeCodeTranscriptSourceOptions, createDefaultTranscriptSourceRegistry(), defaultTranscriptSourceRegistry, getActiveTranscriptEntries() (+28 more)
...
Cohesion: 0.07
Nodes (47): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+39 more)
...
Cohesion: 0.05
Nodes (47): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReviewStatusSnapshotInput (+39 more)
...
Cohesion: 0.06
Nodes (45): WorkingSpinner(), AGENT_TOOLS, BASH_TOOLS, FILE_TOOLS, getPhaseLabel(), getWorkingPhase(), isSpinnerPhase(), SEARCH_TOOLS (+37 more)
...
Cohesion: 0.04
Nodes (35): CACHE_MANIFEST, SOURCE_AGENTS_DIR, SOURCE_DEV_SKILLS_DIR, SOURCE_RULES_DIR, SOURCE_SCRIPTS_DIR, DevrootSyncItem, getGitTrackedSkillDirNames(), HookItem (+27 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (44): getFtsRow(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession(), buildEmbeddingText(), embed() (+36 more)
...
Cohesion: 0.06
Nodes (37): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+29 more)
...
Cohesion: 0.05
Nodes (31): announceMerge(), ActivityLevel, ActivitySource, emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle(), EmitDetailedOptions (+23 more)
...
Cohesion: 0.07
Nodes (29): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+21 more)
...
Cohesion: 0.09
Nodes (34): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, startTtsDaemonFromDashboard(), ActivityTtsPayload (+26 more)
...
Cohesion: 0.07
Nodes (25): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+17 more)
...
Cohesion: 0.1
Nodes (4): stopDeacon(), cleanupLegacySpecialistsDirectory(), CloisterService, writeStateFile()
...
Cohesion: 0.11
Nodes (32): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+24 more)
...
Cohesion: 0.12
Nodes (31): loadConfigAsyncNoMigrationEffect(), runDashboardDbJob(), runInline(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync (+23 more)
...
Cohesion: 0.11
Nodes (20): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+12 more)
...
Cohesion: 0.15
Nodes (25): apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect(), generateJWT(), getAppStatus() (+17 more)
...
Cohesion: 0.12
Nodes (19): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+11 more)
...
Cohesion: 0.15
Nodes (18): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths() (+10 more)
...
Cohesion: 0.18
Nodes (10): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+2 more)
...
Cohesion: 0.21
Nodes (13): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+5 more)
...
- **Why does `fetch` connect `Community 0` to `Community 257`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 139`, `Community 12`, `Community 13`, `Community 14`, `Community 401`, `Community 18`, `Community 17`, `Community 402`, `Community 150`, `Community 23`, `Community 25`, `Community 26`, `Community 32`, `Community 33`, `Community 292`, `Community 165`, `Community 37`, `Community 39`, `Community 43`, `Community 44`, `Community 53`, `Community 57`, `Community 190`, `Community 191`, `Community 64`, `Community 321`, `Community 706`, `Community 67`, `Community 66`, `Community 69`, `Community 451`, `Community 712`, `Community 208`, `Community 82`, `Community 85`, `Community 225`, `Community 102`, `Community 105`, `Community 106`, `Community 237`, `Community 239`, `Community 114`, `Community 246`, `Community 122`, `Community 508`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 37` to `Community 32`, `Community 36`, `Community 6`, `Community 42`, `Community 44`, `Community 16`, `Community 84`, `Community 532`, `Community 24`, `Community 409`, `Community 187`, `Community 93`, `Community 216`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 16` to `Community 128`, `Community 1`, `Community 4`, `Community 5`, `Community 134`, `Community 260`, `Community 8`, `Community 11`, `Community 14`, `Community 271`, `Community 274`, `Community 19`, `Community 532`, `Community 149`, `Community 150`, `Community 408`, `Community 25`, `Community 32`, `Community 162`, `Community 35`, `Community 420`, `Community 41`, `Community 556`, `Community 46`, `Community 50`, `Community 51`, `Community 180`, `Community 53`, `Community 56`, `Community 58`, `Community 448`, `Community 321`, `Community 66`, `Community 450`, `Community 320`, `Community 75`, `Community 331`, `Community 206`, `Community 463`, `Community 466`, `Community 83`, `Community 212`, `Community 211`, `Community 89`, `Community 347`, `Community 350`, `Community 98`, `Community 226`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 249`, `Community 104`, `Community 113`, `Community 377`, `Community 509`?**
