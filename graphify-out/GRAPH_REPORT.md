...
## Corpus Check
- 1548 files · ~2,070,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21649 nodes · 32226 edges · 1125 communities (1091 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 431 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3b7fa70`
...
## Communities (1125 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (143): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+135 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (173): checkApiErrorAgents(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash() (+165 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (127): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (144): buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), performSpecialistWake() (+136 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (125): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (137): cleanupSpawnAndOrphanedStashes(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes() (+129 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (121): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTab, OverviewTabSpec (+113 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (130): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+122 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (89): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps (+81 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (101): readCavemanVariant(), renderPrompt(), finalizeRunLog(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration(), clearSessionId() (+93 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (79): parsePiSession(), getPiLauncherFields(), ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime() (+71 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (83): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (93): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+85 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (79): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+71 more)
...
Cohesion: 0.03
Nodes (78): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, AgentCard(), WorkspaceStatusOverviewProps, button, { container }, defaultProps (+70 more)
...
Cohesion: 0.04
Nodes (65): doc, path, after, doc, filename, path, failedState, initialState (+57 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (64): firstSessionPanel, firstWorkbench, overview, workbench, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+56 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (74): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), showCommand() (+66 more)
...
Cohesion: 0.05
Nodes (69): after, before, blockers, result, statuses, after, row, status (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (72): agentDir, dir1, dir2, marker, missing, nested, resolveTrackerType(), cb (+64 more)
...
Cohesion: 0.04
Nodes (67): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex(), isRecentPromptIndex() (+59 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (58): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+50 more)
...
Cohesion: 0.04
Nodes (55): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+47 more)
...
Cohesion: 0.04
Nodes (51): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+43 more)
...
Cohesion: 0.06
Nodes (55): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+47 more)
...
Cohesion: 0.05
Nodes (46): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions (+38 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (46): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+38 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (51): hookCommand(), HookOptions, activeViolations, checkAgentForViolations(), clearOldViolations(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig (+43 more)
...
Cohesion: 0.06
Nodes (40): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+32 more)
...
Cohesion: 0.06
Nodes (41): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), dispatchTestAgentAndNotify() (+33 more)
...
Cohesion: 0.07
Nodes (49): createCostCommand(), BUDGETS_FILE, calculateCost(), checkBudget(), CostBudget, CostSummary, createBudget(), DEFAULT_PRICING (+41 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (42): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+34 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (29): issues, result, importTrackerConfig(), getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry (+21 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (46): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, FileStatus, CACHE_MANIFEST (+38 more)
...
Cohesion: 0.08
Nodes (43): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+35 more)
...
Cohesion: 0.08
Nodes (41): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+33 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (25): buildChildEnvWithoutTmux(), resizeWindowAsync(), getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, watchConversation(), EditorLaunch (+17 more)
...
Cohesion: 0.05
Nodes (44): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (41): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+33 more)
...
Cohesion: 0.08
Nodes (42): archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), activeDir, completedDir, ctx, { mockExecAsync } (+34 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (41): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+33 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (31): ConversationTerminalProps, resumeConversation(), StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TerminalSizeMessage, TerminalSnapshotMessage (+23 more)
...
Cohesion: 0.05
Nodes (29): PlanDialog(), PlanDialogProps, PlanningStatus, StartPlanningResult, Step, MOCK_ISSUE, xterm, PlanSetupScreen() (+21 more)
...
Cohesion: 0.07
Nodes (36): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+28 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (32): RoundMarker, fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR (+24 more)
...
Cohesion: 0.1
Nodes (38): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation() (+30 more)
...
Cohesion: 0.08
Nodes (35): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+27 more)
...
Cohesion: 0.08
Nodes (38): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+30 more)
...
Cohesion: 0.06
Nodes (31): Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+23 more)
...
Cohesion: 0.07
Nodes (33): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), rotateSpecialistSession() (+25 more)
...
Cohesion: 0.07
Nodes (23): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+15 more)
...
Cohesion: 0.11
Nodes (33): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR (+25 more)

### Community 134 - "Community 134"
Cohesion: 0.1
Nodes (34): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+26 more)
...
Cohesion: 0.08
Nodes (28): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+20 more)
...
Cohesion: 0.1
Nodes (31): healthCommand(), HealthOptions, formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+23 more)
...
Cohesion: 0.14
Nodes (28): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace() (+20 more)
...
Cohesion: 0.13
Nodes (23): clearFeedbackFiles(), validatePlanMatchesIssue(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+15 more)
...
Cohesion: 0.13
Nodes (21): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext, serializeHandoffContext() (+13 more)

### Community 293 - "Community 293"
Cohesion: 0.14
Nodes (21): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+13 more)
...
Cohesion: 0.21
Nodes (20): assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), getAttachmentCache(), getAttachmentCacheKey(), getConversationAttachmentDir() (+12 more)
...
Cohesion: 0.25
Nodes (20): destroyRemoteWorkspace(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+12 more)
...
Cohesion: 0.29
Nodes (11): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getShadowState(), getUnsyncedHistory(), needsSync(), updateTrackerStatusCache() (+3 more)
...
Cohesion: 0.29
Nodes (4): DEFAULTS, UIPreferences, useUIPreferences(), SettingsPage()
...
- **Why does `fetch` connect `Community 4` to `Community 2`, `Community 518`, `Community 6`, `Community 8`, `Community 138`, `Community 11`, `Community 139`, `Community 13`, `Community 270`, `Community 271`, `Community 17`, `Community 18`, `Community 19`, `Community 276`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 158`, `Community 543`, `Community 36`, `Community 37`, `Community 39`, `Community 168`, `Community 42`, `Community 171`, `Community 50`, `Community 53`, `Community 56`, `Community 57`, `Community 191`, `Community 64`, `Community 582`, `Community 73`, `Community 83`, `Community 85`, `Community 736`, `Community 97`, `Community 622`, `Community 623`, `Community 112`, `Community 114`, `Community 631`, `Community 633`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 136` to `Community 3`, `Community 292`, `Community 13`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `resolveProjectFromIssue()` connect `Community 7` to `Community 1`, `Community 3`, `Community 5`, `Community 12`, `Community 14`, `Community 16`, `Community 148`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 153`, `Community 29`, `Community 30`, `Community 33`, `Community 35`, `Community 292`, `Community 36`, `Community 42`, `Community 171`, `Community 47`, `Community 48`, `Community 52`, `Community 55`, `Community 65`, `Community 580`, `Community 72`, `Community 223`, `Community 98`, `Community 366`, `Community 368`, `Community 113`, `Community 112`, `Community 634`, `Community 122`?**
