# Graph Report - feature-pan-1044  (2026-05-09)

## Corpus Check
- 1547 files · ~2,063,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21585 nodes · 32023 edges · 1131 communities (1095 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 419 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `560eedc8`
...
## Communities (1131 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (147): cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+139 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (109): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps (+101 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (123): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (127): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+119 more)
...
Cohesion: 0.04
Nodes (109): killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), formatTldrAge(), formatTldrRow() (+101 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (104): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+96 more)
...
Cohesion: 0.03
Nodes (104): setAgentStoppedNotifier(), pendingCommand(), after, before, blockers, result, statuses, after (+96 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (104): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent() (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (99): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+91 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (87): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+79 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (97): isClaudeRunningInSession(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+89 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (79): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+71 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (84): IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS, OverviewTab, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (85): WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId() (+77 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (86): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (68): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+60 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (80): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (74): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, BeadsTask, buildHandoffPrompt() (+66 more)
...
Cohesion: 0.05
Nodes (81): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+73 more)
...
Cohesion: 0.04
Nodes (73): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+65 more)
...
Cohesion: 0.03
Nodes (65): issues, result, importTrackerConfig(), result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (65): findSpecByIssue(), updateSpecStatus(), next, path, read, state, after, continueContent (+57 more)
...
Cohesion: 0.05
Nodes (64): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+56 more)
...
Cohesion: 0.04
Nodes (50): ViewMode, getDefaultConversationModel(), firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry (+42 more)
...
Cohesion: 0.05
Nodes (57): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+49 more)
...
Cohesion: 0.04
Nodes (51): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+43 more)
...
Cohesion: 0.06
Nodes (46): clearFeedbackFiles(), buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+38 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (51): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR (+43 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (54): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ApiDeprecationWarning (+46 more)
...
Cohesion: 0.05
Nodes (32): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+24 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (46): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), badPath, customPlanningDir, dir, doc (+38 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (40): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+32 more)
...
Cohesion: 0.07
Nodes (47): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv() (+39 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (36): DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader() (+28 more)
...
Cohesion: 0.06
Nodes (43): checkFailedMergeRetry(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+35 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (36): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, dbError, deleteCalls, existingBeads (+28 more)
...
Cohesion: 0.06
Nodes (36): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+28 more)
...
Cohesion: 0.06
Nodes (35): getModelCapability(), MODEL_CAPABILITIES, MODEL_DEPRECATIONS, ModelCapability, resolveModelId(), SkillDimension, allModelIds, defaults (+27 more)
...
Cohesion: 0.06
Nodes (34): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+26 more)
...
Cohesion: 0.06
Nodes (28): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover() (+20 more)
...
Cohesion: 0.1
Nodes (33): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), writeSpecForIssue(), asPanSpecDocument() (+25 more)
...
Cohesion: 0.08
Nodes (34): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+26 more)
...
Cohesion: 0.08
Nodes (34): Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds() (+26 more)
...
Cohesion: 0.07
Nodes (29): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+21 more)
...
Cohesion: 0.09
Nodes (31): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+23 more)
...
Cohesion: 0.09
Nodes (33): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+25 more)
...
Cohesion: 0.07
Nodes (23): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DEFAULTS (+15 more)
...
Cohesion: 0.11
Nodes (31): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+23 more)
...
Cohesion: 0.08
Nodes (22): ensureDefaultConversationModel(), ClaudeModelId, FALLBACK_GROUPS, isKnownModel(), knownModelIds, loadStoredModel(), ModelGroup, ModelPicker() (+14 more)
...
Cohesion: 0.08
Nodes (25): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+17 more)
...
Cohesion: 0.11
Nodes (23): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+15 more)

### Community 235 - "Community 235"
Cohesion: 0.17
Nodes (20): Comment, Issue, IssueFilters, IssueNotFoundError, IssueState, IssueTracker, IssueUpdate, NewIssue (+12 more)
...
Cohesion: 0.11
Nodes (22): buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody(), parsePermissionResponseBehavior(), permissionResolutionVerb(), processPermissionResponse(), ProcessPermissionResponseDeps, ProcessPermissionResponseResult (+14 more)
...
Cohesion: 0.12
Nodes (21): getRunLog(), isRunLogActive(), parseLogMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand() (+13 more)
...
Cohesion: 0.17
Nodes (18): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+10 more)
...
Cohesion: 0.22
Nodes (17): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+9 more)
...
Cohesion: 0.27
Nodes (12): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getShadowState(), getUnsyncedHistory(), needsSync(), updateTrackerStatusCache() (+4 more)
...
Cohesion: 0.15
Nodes (12): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+4 more)
...
Cohesion: 0.18
Nodes (10): ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, RuntimeName, AUTH_MODES, cells, decision, HARNESSES (+2 more)
...
Cohesion: 0.27
Nodes (9): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+1 more)
...
Cohesion: 0.32
Nodes (7): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates()
...
## Knowledge Gaps
- **11496 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11491 more)
...
- **Why does `fetch` connect `Community 6` to `Community 641`, `Community 130`, `Community 3`, `Community 132`, `Community 1`, `Community 129`, `Community 7`, `Community 11`, `Community 14`, `Community 16`, `Community 17`, `Community 531`, `Community 20`, `Community 403`, `Community 22`, `Community 147`, `Community 24`, `Community 158`, `Community 31`, `Community 33`, `Community 801`, `Community 37`, `Community 554`, `Community 43`, `Community 42`, `Community 45`, `Community 48`, `Community 177`, `Community 178`, `Community 49`, `Community 52`, `Community 55`, `Community 57`, `Community 60`, `Community 61`, `Community 72`, `Community 200`, `Community 588`, `Community 211`, `Community 213`, `Community 98`, `Community 748`, `Community 111`, `Community 250`, `Community 635`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 220` to `Community 11`, `Community 19`, `Community 5`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 3` to `Community 8`, `Community 2`, `Community 6`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11496 weakly-connected nodes found - possible documentation gaps or missing edges._
