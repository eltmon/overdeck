...
## Corpus Check
- 1546 files · ~2,060,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21557 nodes · 31982 edges · 1121 communities (1085 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b5ba992`
...
## Communities (1121 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (136): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+128 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (142): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (121): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps (+113 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (123): buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+115 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (128): checkFailedMergeRetry(), cleanupAbandonedFeedback(), reconcileStaleMergeStatus(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+120 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (102): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+94 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (124): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+116 more)
...
Cohesion: 0.03
Nodes (110): Access, AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey() (+102 more)
...
Cohesion: 0.03
Nodes (82): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+74 more)
...
Cohesion: 0.03
Nodes (92): checkVerificationReviewContradiction(), emitCoordinatorDied(), spawnReviewCoordinatorSession(), pendingCommand(), after, before, blockers, result (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (88): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (74): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (78): ViewMode, getDefaultConversationModel(), firstSessionPanel, firstWorkbench, overview, workbench, Conversation, ConversationList() (+70 more)
...
Cohesion: 0.04
Nodes (86): isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+78 more)
...
Cohesion: 0.03
Nodes (76): ConversationRow(), ConversationRowProps, PHASE_ICONS, ConversationMutations, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions (+68 more)
...
Cohesion: 0.05
Nodes (69): getTrackerContext(), refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+61 more)
...
Cohesion: 0.06
Nodes (68): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, findSpecByIssue(), updateSpecStatus() (+60 more)
...
Cohesion: 0.04
Nodes (65): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+57 more)
...
Cohesion: 0.05
Nodes (55): setAgentStoppedNotifier(), announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (57): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), FileStatus, ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR (+49 more)
...
Cohesion: 0.05
Nodes (56): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), dropStash() (+48 more)
...
Cohesion: 0.06
Nodes (47): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+39 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (50): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory() (+42 more)
...
Cohesion: 0.06
Nodes (41): checkPendingTestDispatch(), clearStaleCiFeedback(), dispatchTestAgentAndNotify(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks() (+33 more)
...
Cohesion: 0.06
Nodes (39): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+31 more)
...
Cohesion: 0.06
Nodes (44): AIProvider, encodeClaudeProjectDir(), buildConversationResponse(), getCachedMessages(), pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId() (+36 more)
...
Cohesion: 0.06
Nodes (38): beadsDir, doc, AcceptanceCriterion, createBeadsFromVBrief(), CreateBeadsResult, deriveProjectPrefix(), execAsync, execFileAsync (+30 more)
...
Cohesion: 0.06
Nodes (37): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), badPath, customPlanningDir (+29 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (38): writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback(), readFeedback() (+30 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (41): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+33 more)
...
Cohesion: 0.08
Nodes (39): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+31 more)
...
Cohesion: 0.16
Nodes (39): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+31 more)
...
Cohesion: 0.07
Nodes (30): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+22 more)
...
Cohesion: 0.08
Nodes (33): rebuildCache(), getLastEventMetadata(), readEvents(), getRetentionStatus(), needsPruning(), pruneOldEvents(), RetentionStats, agentDir (+25 more)
...
Cohesion: 0.13
Nodes (24): Comment, Issue, IssueFilters, IssueNotFoundError, IssueState, IssueTracker, IssueUpdate, NewIssue (+16 more)
...
Cohesion: 0.11
Nodes (32): autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, dispatchSwarmWave(), ensureSwarmAutoAdvanceLoop(), execAsync (+24 more)
...
Cohesion: 0.09
Nodes (22): ComposerMode, IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus() (+14 more)
...
Cohesion: 0.1
Nodes (20): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), getRenderablePatch(), DiffWorkerPoolProvider(), Tab (+12 more)
...
Cohesion: 0.12
Nodes (20): ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, CLAUDE_PROJECTS_DIR, SessionIndexEntry, ActivitySource, Agent, AgentRuntime (+12 more)
...
Cohesion: 0.12
Nodes (11): EDITOR_LABELS, PanOpenInPickerProps, createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, resetTransport(), RpcClientFactory, SubscribeOptions (+3 more)
...
Cohesion: 0.18
Nodes (16): buildPlanningPrompt(), __dirname, discoverPrdFiles(), ensureTmuxRunning(), execAsync, getPackageVersion(), PlanningIssue, PlanningProgress (+8 more)
...
Cohesion: 0.15
Nodes (7): formatIssueRef(), LinkManager, parseIssueRef(), link, links, newManager, removed
...
Cohesion: 0.18
Nodes (15): listTestsCommand(), registerTestCommands(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+7 more)
...
Cohesion: 0.12
Nodes (11): firstRun, legacyNames, { mockClaudeSkills }, result, secondRun, execSyncMock, first, parsed (+3 more)
...
## Knowledge Gaps
- **11477 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11472 more)
...
- **Why does `fetch` connect `Community 0` to `Community 2`, `Community 130`, `Community 6`, `Community 9`, `Community 266`, `Community 523`, `Community 10`, `Community 12`, `Community 14`, `Community 265`, `Community 272`, `Community 17`, `Community 146`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 155`, `Community 156`, `Community 28`, `Community 27`, `Community 550`, `Community 39`, `Community 48`, `Community 49`, `Community 178`, `Community 179`, `Community 198`, `Community 71`, `Community 585`, `Community 586`, `Community 591`, `Community 86`, `Community 740`, `Community 100`, `Community 104`, `Community 633`, `Community 637`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 10`, `Community 3`, `Community 29`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 12` to `Community 67`, `Community 68`, `Community 261`, `Community 177`, `Community 22`, `Community 342`, `Community 60`, `Community 29`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11477 weakly-connected nodes found - possible documentation gaps or missing edges._
