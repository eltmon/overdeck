...
## Summary
- 33048 nodes · 64098 edges · 1398 communities (1330 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1517 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab7967ef`
...
## Communities (1398 total, 68 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (303): checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents(), checkFailedMergeRetry(), checkFirstCompletionAgents(), checkMassDeath(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses() (+295 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (278): readCavemanVariant(), AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), getSpecialistState() (+270 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (258): loadStartCommand(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffError, HandoffMethod, HandoffOptions, performHandoff() (+250 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.01
Nodes (174): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AgentTellForm(), AgentTellFormProps, BootstrapGate() (+166 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.03
Nodes (189): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription() (+181 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (146): getHealthThresholdsMs(), checkCostLimits(), getCostSummary(), addLog(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), isSynthesisForActiveReviewRun() (+138 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (178): fileExists(), API_ERROR_PATTERNS, archiveReviewerRound(), ReviewerRoundArtifact, getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole (+170 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.01
Nodes (165): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause (+157 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.02
Nodes (139): loadStoredHarness(), ActivityFeedSidebar(), conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview (+131 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (138): isAgentIdleForNudge(), BASE_TIME, exitSpy, loadDeaconWithResumeMock(), mailDir, mailFiles, state, stderrSpy (+130 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (120): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+112 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (122): switchModel(), MenuDivider(), OverflowItem(), ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, CloseOutIssueButton() (+114 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.04
Nodes (136): updateGitHubToInReview(), appendToWal(), appendToWalSync(), resolveWalDir(), killTmuxSession(), content, mockExeca, mockExec (+128 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (145): parseDifficultyLabel(), CloisterStatus, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus() (+137 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (127): src, agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+119 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (125): determineCavemanVariant(), injectCavemanSettings(), addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), DnsSyncMethod, getDnsmasqConfigDir() (+117 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.03
Nodes (125): fmtCost(), PlanningState, ZoneAActionsState, OverviewTab, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps (+117 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.03
Nodes (138): HookEntry, exec(), execFile(), execMock, getActiveSessionModel(), dequeueMerge(), enqueueMerge(), getAllActiveQueues() (+130 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.02
Nodes (119): MODEL_COLORS, agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption (+111 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (118): createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, buildContextMenu(), buildMenuTemplate(), buildTooltip() (+110 more)
...
Cohesion: 0.02
Nodes (118): config, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, DEFAULT_CLOISTER_CONFIG (+110 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (130): buildACLookupByTitle(), buildActiveSliceContext(), inferIssueIdFromWorkspace(), readPendingFeedback(), readWorkspacePlanAsync(), githubTracker, linearTracker, longBody (+122 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (122): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+114 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.02
Nodes (99): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, compactCommand(), CompactOptions (+91 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (92): backup, mockClaudeSkills, backupCleanCommand(), backupListCommand(), contextSyncCommand(), restoreCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname (+84 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (108): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+100 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (100): Work Agent (shown in inspector terminal), DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), copyToClipboard() (+92 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (113): ConversationList(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse, backfillConversationModels() (+105 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.04
Nodes (100): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), createCostCommand(), configCommand() (+92 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (93): ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), normalizeCanonicalState(), PipelineState (+85 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.04
Nodes (97): hasCheckpoint(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+89 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (86): abortSignal(), AgentRuntimeFetchError, emitActivity(), emitAgentEvent(), emitChannelReply(), emitMessageReceived(), emitModelSet(), emitResolution() (+78 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (106): loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneDocsConfig(), cloneRoles() (+98 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (76): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), result, claudePlanningSystemPromptFiles(), clearCacheRoute (+68 more)
...
Cohesion: 0.03
Nodes (100): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+92 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.03
Nodes (97): annotated, before, candidate, check, claimed, defaults, doc, { doc: next } (+89 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.03
Nodes (83): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature() (+75 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.04
Nodes (89): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+81 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.04
Nodes (98): pauseFlywheel(), assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, EmitStatusOptions (+90 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (91): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync(), pendingRequests (+83 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.04
Nodes (92): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), difficultyColor(), isSwarmRecoverAction(), parseFiniteInteger(), printWavePlan(), recoverSwarmCommand() (+84 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.03
Nodes (80): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+72 more)
...
Cohesion: 0.03
Nodes (83): applyEnvironmentOverrides(), deepMerge(), loadCloisterConfig(), loadCloisterConfigAsync(), loadCloisterConfigSync(), saveCloisterConfigSync(), shouldAutoStart(), updateCloisterConfigSync() (+75 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.04
Nodes (85): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+77 more)
...
Cohesion: 0.05
Nodes (77): ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity, writeObservations() (+69 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.05
Nodes (71): LOGS_DIR, acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+63 more)
...
Cohesion: 0.04
Nodes (52): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+44 more)
...
Cohesion: 0.04
Nodes (77): AGENT_DEFINITIONS, AgentCardsPanel(), Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef (+69 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.04
Nodes (67): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+59 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.03
Nodes (75): emitStatusCommand(), parseFlywheelStatusJson(), readFlywheelStatusJson(), registerFlywheelCommands(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId (+67 more)
...
Cohesion: 0.05
Nodes (64): getCavemanExperimentData(), getAdminTldrRoute, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), handleConversationHandoffDoc(), FeatureRegistryListOptions, FeatureRegistryListPayload, featureRegistryRouteLayer (+56 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.06
Nodes (71): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), RawFilter, SearchMode, SearchQuery (+63 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (65): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync, HandoffContextError (+57 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.03
Nodes (61): deleteConversationImage(), sendConversationMessage(), uploadConversationImage(), updateConversationDeliveryMethod(), fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations() (+53 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.06
Nodes (63): content, skillDir, updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest() (+55 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.03
Nodes (76): beads (bd) issue tracking tool, CHANGELOG [0.7.0] Command Taxonomy Reorganization, Cloister lifecycle watchdog, Devroot Pattern for Skill Placement, pan done Command, pan plan Command, pan start Command, pan sync Command (+68 more)

### Community 66 - "GitHub Webhook Ingestion Handlers"
Cohesion: 0.07
Nodes (76): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+68 more)
...
Cohesion: 0.06
Nodes (62): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+54 more)
...
Cohesion: 0.04
Nodes (65): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionByJsonlPath() (+57 more)
...
Cohesion: 0.05
Nodes (55): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), createHandoffPaths(), ensureHandoffsDir() (+47 more)
...
Cohesion: 0.07
Nodes (64): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+56 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.04
Nodes (55): applyStash(), applyStashPromise(), CanonicalStashKind, createNamedStashPromise(), createRecoveryBranchFromStash(), createRecoveryBranchFromStashPromise(), dropStashPromise(), execAsync (+47 more)
...
Cohesion: 0.04
Nodes (54): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl() (+46 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.04
Nodes (46): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, ComplexityModels, DashScopeModel (+38 more)
...
Cohesion: 0.05
Nodes (60): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+52 more)
...
Cohesion: 0.04
Nodes (55): ArchivedConversationResponse, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets() (+47 more)

### Community 92 - "Event Snapshot Cache and State Reducers"
Cohesion: 0.05
Nodes (48): ContextUsage, ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, VoiceMode (+40 more)
...
Cohesion: 0.07
Nodes (43): clearFeedbackFiles(), clearFeedbackFilesPromise(), readFeatureContext(), contextCommand(), ContextOptions, appendSummary(), appendSummarySync(), checkContextBudget() (+35 more)
...
Cohesion: 0.06
Nodes (54): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, blockerIcon(), fetchWorkspace(), forgeApprove(), forgeMerge() (+46 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.06
Nodes (46): TABS, themeButton, VBriefDifficulty, VBriefEdgeType, VBriefInspectionPolicy, VBriefItem, VBriefItemStatus, VBriefPlan (+38 more)
...
Cohesion: 0.07
Nodes (53): planCommand(), PlanOptions, runDiscoveryPhase(), deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect() (+45 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.05
Nodes (39): categorizeToolUse(), CompressedTranscriptDelta, compressEntry(), compressJsonlBuffer(), compressTranscriptDelta(), CompressTranscriptDeltaInput, extractBashCommand(), extractText() (+31 more)

### Community 105 - "Issue Tracker Linking Tests"
Cohesion: 0.06
Nodes (46): delay(), data, mockExistsSync, mockReadFile, mockUnlink, runner, computeRestartDelay(), getSmeeBinaryPath() (+38 more)
...
Cohesion: 0.05
Nodes (52): TtsDaemonStartResult, TtsDaemonStatus, HeaderMap, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice() (+44 more)
...
Cohesion: 0.05
Nodes (43): getDiscoveredSessionById(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi() (+35 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.05
Nodes (41): mockGetRuntimeForAgent, exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+33 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.06
Nodes (49): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostBreakdownData, CostBreakdownModal() (+41 more)

### Community 115 - "Smee Webhook Proxy Process Management"
Cohesion: 0.07
Nodes (41): RoundMarker, fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+33 more)
...
Cohesion: 0.07
Nodes (52): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+44 more)
...
Cohesion: 0.06
Nodes (44): parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues() (+36 more)
...
Cohesion: 0.07
Nodes (49): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+41 more)
...
Cohesion: 0.08
Nodes (41): ensureDashboardBundle(), devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), checkCommand(), checkPrerequisites() (+33 more)

### Community 126 - "Electron Desktop App Launch Scripts"
Cohesion: 0.07
Nodes (40): FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+32 more)
...
Cohesion: 0.06
Nodes (26): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getAllSessionFilesSync(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFilesSync() (+18 more)

### Community 130 - "AI Provider Health Probing"
Cohesion: 0.06
Nodes (46): adminRouteLayer, cloisterRouteLayer, conversationsRouteLayer, diffsRouteLayer, miscRouteLayer, prereqsRouteLayer, getRemoteStatusRoute, getRemoteWorkspaceRoute (+38 more)
...
Cohesion: 0.04
Nodes (45): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+37 more)
...
Cohesion: 0.07
Nodes (36): doneCommand(), DoneOptions, execAsync, isMergeSetMergedIntoTargets(), updateLinearToInReview(), findLinearStateByName(), ActivityLevel, ActivitySource (+28 more)
...
Cohesion: 0.06
Nodes (38): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+30 more)
...
Cohesion: 0.06
Nodes (45): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+37 more)
...
Cohesion: 0.09
Nodes (36): scriptPath, execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise() (+28 more)
...
Cohesion: 0.09
Nodes (39): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, ForkProgressView() (+31 more)
...
Cohesion: 0.08
Nodes (37): configFile, traefikDir, CopyConfigOptions, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR (+29 more)
...
Cohesion: 0.08
Nodes (36): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AgentCardsPanelProps, ApiKeysConfig, WorkTypeOverrides() (+28 more)
...
Cohesion: 0.08
Nodes (32): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), executeCloseOutPromise() (+24 more)
...
Cohesion: 0.07
Nodes (36): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, existingSkillDir, existsInTarget (+28 more)
...
Cohesion: 0.1
Nodes (34): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getHealthEmoji() (+26 more)
...
Cohesion: 0.08
Nodes (31): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+23 more)

### Community 200 - "Dashboard WebSocket RPC Client Transport"
Cohesion: 0.1
Nodes (39): Conversation, listActiveConversations(), markConversationEnded(), setClearedToConvId(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes() (+31 more)
...
Cohesion: 0.08
Nodes (35): eventsFileExists(), getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+27 more)
...
Cohesion: 0.1
Nodes (27): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), getDefaultConfig() (+19 more)
...
Cohesion: 0.1
Nodes (32): computeStaleResets(), hasSessionForSpecialist(), StatusSnapshot, updates, updated, status, callServerApi(), buildMenuTemplate() (+24 more)
...
Cohesion: 0.06
Nodes (28): __dirname, CLI_PATH, __dirname, { stdout }, { stdout, status }, { stdout, stderr }, PACKAGE_ROOT, actual (+20 more)
...
Cohesion: 0.1
Nodes (36): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), captureTldrMetricsSync(), clone(), createStringifyContext(), format(), formatPropertyKey() (+28 more)

### Community 245 - "Dashboard Bootstrap and Projection Cache Specs"
Cohesion: 0.09
Nodes (27): agentDir, missing, AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlMtimePromise(), getAgentJsonlPath() (+19 more)
...
Cohesion: 0.06
Nodes (25): result, activeContinuePath, continuePath, projectRoot, wsDir, cb, cmdArgs, mockExec (+17 more)
...
Cohesion: 0.06
Nodes (31): first, kCustom, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref (+23 more)
...
Cohesion: 0.09
Nodes (23): startRealConversationRoutes(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+15 more)

### Community 301 - "Experimental Channels Toggle Tests"
Cohesion: 0.12
Nodes (27): getArtifactSnapshotPath(), ArtifactLifecycleOptions, ArtifactProvenanceInput, ArtifactValidationError, copyPublishedSnapshot(), createArtifact(), CreateArtifactOptions, decodeHtmlText() (+19 more)

### Community 302 - "OpenRouter Model Classification Service"
Cohesion: 0.11
Nodes (31): listArtifacts(), ArtifactCommandDeps, artifactCreateCommand(), ArtifactCreateOptions, artifactListCommand(), artifactOpenCommand(), artifactPublishCommand(), ArtifactPublishOptions (+23 more)
...
Cohesion: 0.08
Nodes (26): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+18 more)
...
Cohesion: 0.19
Nodes (30): atLineEnd(), charAt(), continueScalar(), getLine(), hasChars(), isEmpty(), lex(), parseAllDocuments() (+22 more)
...
Cohesion: 0.09
Nodes (19): FetchFn, InternalState, LogFn, readWatchdogPersistentState(), SpawnRestart, SpawnRestartResult, SupervisorWatchdog, SupervisorWatchdogConfig (+11 more)
...
Cohesion: 0.15
Nodes (29): arrayPushArray(), atIndentedComment(), blockMap(), blockScalar(), blockSequence(), compose(), document(), documentEnd() (+21 more)
...
Cohesion: 0.14
Nodes (27): ComposerPlugin(), ComposerPromptEditor(), ComposerPromptEditorProps, EditorRefPlugin(), EditorRefPluginProps, filterCommands(), getDraftKey(), InnerPluginProps (+19 more)
...
Cohesion: 0.11
Nodes (23): runMemoryFtsTransaction(), appendJsonl(), appendLocks, findIndexedObservationByteOffset(), findObservationByteOffset(), indexObservation(), inline(), observationMarkdownPath() (+15 more)
...
Cohesion: 0.18
Nodes (18): startPostLaunchSidecars(), startSidecars(), runFullRestart(), getSupervisorPort(), getSupervisorPortSync(), getSupervisorUrl(), getSupervisorUrlSync(), isProcessAlive() (+10 more)
...
Cohesion: 0.09
Nodes (24): src/dashboard/server/routes/command-deck.ts, packages/contracts/src/events.ts, packages/contracts/src/types.ts, AgentRuntimeSnapshot (Effect Schema in contracts), Agent runtime DomainEvents (agent.activity_changed, agent.thinking_started, etc.), PAN-821: Command Deck — Issue Session Tree with Conversation-First Agent Panels, GET /api/projects/:projectKey/session-tree endpoint, SessionNode type (planning/work/review/reviewer/test/merge/legacy) (+16 more)

### Community 450 - "Community 450"
Cohesion: 0.11
Nodes (24): /all-up Flywheel Skill, Awaiting Merge Dashboard Page, check-merged skill, scripts/conv-find.py, conv-lookup skill, crash-investigation skill, dependency-update skill, PRD: Fix-All Flywheel (+16 more)
...
Cohesion: 0.11
Nodes (18): changedFiles, errOutput, fetchMock, mockFetch(), output, HealthCheck, systemHealthCommand(), mockExistsSync (+10 more)
...
Cohesion: 0.13
Nodes (17): src/lib/cloister/inspect-agent.ts, Inspect Specialist checkpoint system (commit-based diff scoping), Inspect Specialist (inspect-agent), PAN-382: Inspect Specialist — Per-Step Verification, Jidoka Principle — never pass a foundation-class defect downstream, pan inspect <issueId> --bead <beadId> CLI command, metadata.requiresInspection per-bead flag, 3-level specialist registry (project, issueId, specialistType:role) (+9 more)
...
Cohesion: 0.12
Nodes (5): CLEAR_ON, postPermissionEventRoute, HookConfig, McpServer, removeHookIfPresent()
...
Cohesion: 0.15
Nodes (11): CLI Command Reference, code:bash (# Link discovered work (old way - two commands)), code:bash (# Label management (supports multiple IDs)), Dependencies, Dependencies & Labels, Dependency Types, Issue Types, Labels (+3 more)
...
Cohesion: 0.32
Nodes (12): DatabaseError, getSetting(), getSettingEffect(), getSettingProgram(), isDeaconGloballyPaused(), isFlywheelGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId() (+4 more)
...
Cohesion: 0.26
Nodes (8): isErrnoException(), readRestartStatus(), readRestartStatusPromise(), RestartStatus, RestartStatusError, restartStatusPath(), RestartTrigger, writeRestartStatusPromise()
...
Cohesion: 0.18
Nodes (9): code:bash (bd init myproject), Contents, Interface-Specific Troubleshooting, JSONL File Not Created, Quick Reference: Common Fixes, Related Documentation, Root Cause, Symptom (+1 more)
...
Cohesion: 0.18
Nodes (11): Auto-planning, code:bash (pan plan PAN-1071), code:bash (pan plan PAN-1071 --auto), code:bash (pan plan finalize), Finalizing (`pan plan finalize`), Planning Workflow, Starting planning, Step 1: Start Planning Session (+3 more)
...
Cohesion: 0.29
Nodes (6): directAgentRestartTypes, getDirectRestartRequest(), RestartRequestDescriptor, RestartRouteInput, reviewRestartTypes, request
...
Cohesion: 0.52
Nodes (4): getCloisterService(), startCommand(), stopCommand(), StopOptions
...
Cohesion: 0.47
Nodes (6): ~/.claude/CLAUDE.md (AI suggestion preferences), knowledge-capture config (.panopticon/knowledge-capture.json), Knowledge Capture Skill, Legacy Codebase Support, refactor-radar config (.panopticon/refactor-radar.json), Refactor Radar Skill
...
Cohesion: 0.67
Nodes (3): code:bash (bd daemon --global=false &), code:bash (#!/bin/bash), Resolution
...
- **Why does `execAsync` connect `CLI Command Taxonomy Reorganization` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Conversation Database and Favorites`, `Inspector Panel Terminal UI`, `Electron Desktop App and Tray`, `Community 528`, `Issue Lifecycle Workflow Execution`, `CLAUDE MD Commands Skills Template`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Issue Service and Data Fetching`, `Dashboard Push Architecture and WebSocket RPC`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `Dashboard HTTP Routes and Admin`, `Beads Dependencies Async Gates and Workflows`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Specialist Handoff Logging and Queue Depth`, `VBrief Beads IO and Plan Finalize`, `Review Round Status Badge UI`, `Dashboard App Sidebar and Metrics`, `Kanban Board UI Screenshots`, `Cloister Service Handoff Logging`, `Community 565`, `Issue Filtering and Model Fallback Tests`, `Settings Page Model Override and Auth`, `Project Skills Mirror and Sync`, `System Health and Spawn Guardrails`, `Workspace Teardown and Label Cleanup`, `Multi Tool Skill Sync Export`, `Activity Panel and VTT Parsing`, `Skills Merge and Manifest Sync`, `Specialist Commands and VBrief Index`, `Issue State Mapping and Workflow Labels`, `Traefik and Docker Workspace Templates`, `Community 598`, `Git Divergence and Conversation Patch Tests`, `Command Deck Screenshots and Branding`, `Claude OAuth Authentication and Settings`, `Review Status State Machine`, `Community 1001`, `Community 491`, `Workspace Teardown and Reopen Tests`, `UI and Diff Preferences Persistence`, `Specialist Pipeline PRDs and Skills`, `Dashboard Bootstrap and Projection Cache Specs`, `Agent Hook Scripts and Repo Artifact Design`, `Vitest Workspace Configuration`, `Spec Readiness Skill and Scoring`, `Electron Desktop App Launch Scripts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Agent List and Handoff Status UI` to `Coding Agent Harness Policy`, `Release Command Parsing Tests`, `Platform Supervisor Startup Lifecycle`, `VBrief Lifecycle IO and Transitions`, `Server Cache Service and Chat Markdown`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Command Deck Zone B Session Nodes` to `Remote Agent Provisioning on Fly`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `AI Provider Health Probing`, `VBrief Plan Builder and Viewer`, `Deacon Patrol and Queue`, `Parallel Review Pipeline Dispatch`, `Agent Session Lifecycle Management`, `Claude Code Hook Management`, `Cloister Service Health and Config`, `Kanban Board Agent Status UI`, `Tmux Terminal Session Management`, `VBrief Lifecycle IO and Transitions`, `Docker Stats and Container Resources`, `Project Tree Feature Items UI`, `Cost Event Aggregation and Retention`, `Agent CV and Show Commands`, `Workspace Metadata and Project Config`, `Context History Logging and Search`, `Workspace and Version API Routes`, `Pan CLI Skills and Lifecycle Verbs`, `Permission Request Bridge and Forwarding`, `Server Cache Service and Chat Markdown`, `Diff Panel Rendering and Theming`, `Agent Types Pipeline Documentation`, `Workspace Teardown and Label Cleanup`, `Swarm Dispatch and DAG Execution`, `Settings Persistence and Model Defaults`, `Pi Session Cost Parser`, `Resource Process Discovery and Reporting`, `Dashboard WebSocket RPC Client Transport`, `Path Constants and Postinstall Setup`, `Model Routing and Complexity Detection`, `CLI Command Taxonomy Reorganization`, `Event Snapshot Cache and State Reducers`, `User Documentation and Provider Guides`, `Conversation Panel and Chat Phase Types`, `Database Settings and Cost Unit Tests`, `Desktop Menu and Auto-Updater Lifecycle`, `CLI Command Set Fixture`, `Community 618`, `Community 491`, `Release and Update CLI Commands`, `Agent Health Monitor States`, `Project Registration and Test Runner`, `UI and Diff Preferences Persistence`, `Smee Webhook Proxy Process Management`, `Merge Set and Review Artifact Creation`, `FPP Policy Violation Detection and Nudging`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14131 weakly-connected nodes found - possible documentation gaps or missing edges._
