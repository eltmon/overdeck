...
## Corpus Check
- 1878 files · ~2,476,827 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26664 nodes · 41415 edges · 1259 communities (1207 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02a673e6`
...
## Communities (1259 total, 52 thin omitted)
...
Cohesion: 0.02
Nodes (188): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents() (+180 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (161): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+153 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (182): monitorReviewConvoySignals(), spawnInspectAgent(), buildSpecialistBaseCommand(), pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+174 more)
...
Cohesion: 0.02
Nodes (127): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+119 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (114): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, RecoverButton(), RecoverButtonProps, SwitchModelModal() (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (124): TurnDiffFileChange, forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset() (+116 more)
...
Cohesion: 0.03
Nodes (115): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+107 more)
...
Cohesion: 0.02
Nodes (92): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+84 more)
...
Cohesion: 0.03
Nodes (97): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), autopresoRouteLayer, backToStagingRoute, readJsonBody (+89 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (92): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+84 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (75): isRunningAgent(), PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps (+67 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (85): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+77 more)
...
Cohesion: 0.03
Nodes (91): getActivity(), listPaneValuesAsyncEffect(), agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), deleteAgentRoute, EMPTY_CONVERSATION (+83 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (94): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), ScanOptions, normalizeFilter(), SearchMode (+86 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (72): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+64 more)
...
Cohesion: 0.03
Nodes (80): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeRoleRunExists() (+72 more)
...
Cohesion: 0.04
Nodes (74): transitionIssueToVerifyingOnMain(), importTrackerConfig(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+66 more)
...
Cohesion: 0.05
Nodes (72): buildPolyrepoContext(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace() (+64 more)
...
Cohesion: 0.03
Nodes (61): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+53 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (75): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache(), cloneRoles() (+67 more)
...
Cohesion: 0.03
Nodes (57): getRuntimeSnapshot(), isAgentStateServiceInProcess(), AgentRuntimeState, AgentState, getAgentRuntimeStateEffect(), getLatestSessionIdEffect(), listRunningAgentsEffect(), snapshotToRuntimeState() (+49 more)
...
Cohesion: 0.04
Nodes (57): getTrackerContext(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+49 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (65): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+57 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (61): cosineSimilarity(), getFtsRow(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession(), chalk (+53 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (59): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+51 more)
...
Cohesion: 0.05
Nodes (54): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions() (+46 more)
...
Cohesion: 0.05
Nodes (53): dropLingeringPreMergeStashes(), cleanupReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), dropStash(), execAsync (+45 more)
...
Cohesion: 0.07
Nodes (57): events, identity, writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir() (+49 more)
...
Cohesion: 0.04
Nodes (56): assertIssueHasBeads(), assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect() (+48 more)
...
Cohesion: 0.05
Nodes (41): FsError, CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterEffect(), createRuntimeRegistry(), getInstalledRuntimes(), getRuntimeAdapter(), getSupportedRuntimes() (+33 more)
...
Cohesion: 0.04
Nodes (49): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+41 more)
...
Cohesion: 0.06
Nodes (43): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse (+35 more)
...
Cohesion: 0.06
Nodes (43): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceShape, ReviewStatusSnapshotInput (+35 more)
...
Cohesion: 0.06
Nodes (42): listSessionNamesAsyncEffect(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync (+34 more)
...
Cohesion: 0.12
Nodes (42): movePrdImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect() (+34 more)

### Community 127 - "Community 127"
Cohesion: 0.05
Nodes (36): agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), deleteDockerContainerRoute, deleteDockerNetworkRoute, deleteDockerVolumeRoute, execAsync, getContainerDetailsRoute (+28 more)
...
Cohesion: 0.06
Nodes (35): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+27 more)
...
Cohesion: 0.07
Nodes (31): sentinel, initWorkspaceDiscoveredSessionsSchema(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), emitReactiveLifecycleEvent(), emitResetMarkerCreated(), emitMemoryHealthChanged() (+23 more)
...
Cohesion: 0.08
Nodes (27): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+19 more)
...
Cohesion: 0.1
Nodes (27): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), RestartLockError, RestartLockHandle (+19 more)
...
Cohesion: 0.11
Nodes (22): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+14 more)

### Community 259 - "Community 259"
Cohesion: 0.11
Nodes (27): DoneOptions, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES, CanonicalStateDefinition, canonicalToTrackerState() (+19 more)
...
Cohesion: 0.09
Nodes (21): execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+13 more)
...
Cohesion: 0.11
Nodes (21): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+13 more)
...
Cohesion: 0.1
Nodes (19): issues, result, loadReviewStatusesForIssues(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+11 more)
...
Cohesion: 0.13
Nodes (14): appendToRunLog(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath(), getRunsDirectory() (+6 more)
...
Cohesion: 0.15
Nodes (12): extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result (+4 more)

### Community 402 - "Community 402"
Cohesion: 0.12
Nodes (15): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, findWorkspacePath(), canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere() (+7 more)
...
Cohesion: 0.15
Nodes (12): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), ReadEventsOptions (+4 more)
...
Cohesion: 0.13
Nodes (18): buildContinuation(), convertConversationTranscript(), ConvertOptions, ConvertResult, extractClaudeTranscript(), extractContentText(), extractPiTranscript(), renderTranscript() (+10 more)

### Community 421 - "Community 421"
Cohesion: 0.13
Nodes (18): buildEmbeddingText(), embed(), EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage() (+10 more)
...
Cohesion: 0.16
Nodes (14): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd() (+6 more)
...
- **Why does `fetch` connect `Community 2` to `Community 1`, `Community 259`, `Community 4`, `Community 6`, `Community 8`, `Community 137`, `Community 138`, `Community 11`, `Community 268`, `Community 12`, `Community 13`, `Community 15`, `Community 272`, `Community 400`, `Community 18`, `Community 17`, `Community 20`, `Community 148`, `Community 21`, `Community 14`, `Community 24`, `Community 153`, `Community 154`, `Community 19`, `Community 31`, `Community 46`, `Community 47`, `Community 181`, `Community 184`, `Community 57`, `Community 441`, `Community 59`, `Community 440`, `Community 319`, `Community 63`, `Community 65`, `Community 66`, `Community 199`, `Community 74`, `Community 83`, `Community 87`, `Community 347`, `Community 91`, `Community 736`, `Community 98`, `Community 739`, `Community 227`, `Community 228`, `Community 237`, `Community 623`, `Community 113`, `Community 245`, `Community 248`, `Community 377`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 24` to `Community 32`, `Community 545`, `Community 100`, `Community 197`, `Community 8`, `Community 9`, `Community 296`, `Community 332`, `Community 19`, `Community 182`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 70` to `Community 1`, `Community 3`, `Community 134`, `Community 263`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 651`, `Community 269`, `Community 14`, `Community 271`, `Community 272`, `Community 19`, `Community 404`, `Community 405`, `Community 33`, `Community 545`, `Community 35`, `Community 167`, `Community 41`, `Community 47`, `Community 48`, `Community 435`, `Community 437`, `Community 438`, `Community 183`, `Community 57`, `Community 317`, `Community 190`, `Community 191`, `Community 196`, `Community 69`, `Community 581`, `Community 71`, `Community 455`, `Community 326`, `Community 452`, `Community 75`, `Community 204`, `Community 77`, `Community 76`, `Community 460`, `Community 203`, `Community 81`, `Community 470`, `Community 87`, `Community 88`, `Community 93`, `Community 94`, `Community 477`, `Community 480`, `Community 324`, `Community 349`, `Community 235`, `Community 374`, `Community 122`?**
