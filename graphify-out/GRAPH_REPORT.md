...
## Corpus Check
- 1745 files · ~2,326,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23900 nodes · 36627 edges · 1171 communities (1122 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 510 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9b8a466`
...
## Communities (1171 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (147): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+139 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (162): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep() (+154 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (131): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+123 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (128): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+120 more)
...
Cohesion: 0.03
Nodes (135): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+127 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (115): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+107 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+114 more)
...
Cohesion: 0.03
Nodes (113): checkPostReviewCommits(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), after, before, blockers, result, statuses (+105 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (107): cleanupStaleAgentState(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+99 more)
...
Cohesion: 0.03
Nodes (111): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+103 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (105): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+97 more)
...
Cohesion: 0.02
Nodes (90): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets() (+82 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (85): ConversationRow(), ConversationRowProps, PHASE_ICONS, ConversationMutations, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (95): embedAction(), ScanOptions, SearchQuery, showAction(), runWithPool(), WorkPoolStats, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy() (+87 more)
...
Cohesion: 0.04
Nodes (96): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename (+88 more)
...
Cohesion: 0.03
Nodes (82): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+74 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (88): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+80 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (92): updateTtsConfig(), agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options (+84 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (81): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+73 more)
...
Cohesion: 0.04
Nodes (79): projectAddCommand(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync, formatDuration(), generateReport() (+71 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (79): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+71 more)
...
Cohesion: 0.04
Nodes (60): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+52 more)
...
Cohesion: 0.04
Nodes (57): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, { projectPath, workspacePath }, promoted, specFiles, fsHooks, result (+49 more)
...
Cohesion: 0.04
Nodes (75): defaults, first, { models }, second, MODEL_DEPRECATIONS, deprecatedIds, resolved, result (+67 more)
...
Cohesion: 0.04
Nodes (65): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+57 more)
...
Cohesion: 0.04
Nodes (62): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses() (+54 more)
...
Cohesion: 0.04
Nodes (58): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand() (+50 more)
...
Cohesion: 0.05
Nodes (58): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), findSpecByIssueAsync(), completePlanningArtifacts(), badPath, doc (+50 more)
...
Cohesion: 0.04
Nodes (43): TurnDiffSummary, DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffPanel(), DiffPanelProps (+35 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (51): SwitchModelModal(), useAvailableModels(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps (+43 more)
...
Cohesion: 0.06
Nodes (56): acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonAuthToken() (+48 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (56): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+48 more)
...
Cohesion: 0.04
Nodes (55): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execAsync, execFileAsync (+47 more)
...
Cohesion: 0.06
Nodes (49): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+41 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (47): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+39 more)
...
Cohesion: 0.06
Nodes (49): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+41 more)
...
Cohesion: 0.07
Nodes (45): getTrackerContext(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+37 more)
...
Cohesion: 0.06
Nodes (27): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+19 more)
...
Cohesion: 0.08
Nodes (44): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+36 more)
...
Cohesion: 0.07
Nodes (33): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+25 more)
...
Cohesion: 0.08
Nodes (39): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+31 more)
...
Cohesion: 0.09
Nodes (36): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+28 more)
...
Cohesion: 0.08
Nodes (19): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig() (+11 more)
...
Cohesion: 0.13
Nodes (27): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+19 more)
...
Cohesion: 0.13
Nodes (25): clearFeedbackFiles(), writeStoryFeatureContext(), validateAndCleanStateFile(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync() (+17 more)
...
Cohesion: 0.32
Nodes (7): readLogTail(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., open
...
## Knowledge Gaps
- **12434 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12429 more)
...
- **Why does `fetch` connect `Community 0` to `Community 3`, `Community 4`, `Community 6`, `Community 135`, `Community 136`, `Community 9`, `Community 11`, `Community 652`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 402`, `Community 19`, `Community 23`, `Community 151`, `Community 28`, `Community 543`, `Community 288`, `Community 289`, `Community 32`, `Community 35`, `Community 36`, `Community 31`, `Community 38`, `Community 42`, `Community 299`, `Community 45`, `Community 46`, `Community 179`, `Community 52`, `Community 53`, `Community 566`, `Community 56`, `Community 830`, `Community 63`, `Community 62`, `Community 65`, `Community 70`, `Community 72`, `Community 201`, `Community 75`, `Community 206`, `Community 81`, `Community 86`, `Community 600`, `Community 601`, `Community 989`, `Community 607`, `Community 239`, `Community 116`, `Community 376`, `Community 767`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 46` to `Community 0`, `Community 1`, `Community 773`, `Community 5`, `Community 41`, `Community 10`, `Community 12`, `Community 13`, `Community 78`, `Community 18`, `Community 178`, `Community 24`, `Community 187`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 291`, `Community 68`, `Community 133`, `Community 104`, `Community 105`, `Community 11`, `Community 13`, `Community 47`, `Community 18`, `Community 58`, `Community 605`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12434 weakly-connected nodes found - possible documentation gaps or missing edges._
