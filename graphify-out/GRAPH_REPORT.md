...
## Corpus Check
- 1548 files · ~2,070,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21649 nodes · 32225 edges · 1112 communities (1080 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 431 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95699d9a`
...
## Communities (1112 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (140): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+132 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (153): checkStuckWorkAgents(), renderPrompt(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), rotateSpecialistSession(), finalizeRunLog(), buildProviderExportLines() (+145 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (149): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+141 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes(), execAsync (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (127): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+119 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (120): checkThinkingSignatureCorruption(), spawnRebaseAgentForBranch(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (118): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, getHealthThresholdsMs() (+110 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (114): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (96): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, PanOpenInPicker() (+88 more)
...
Cohesion: 0.02
Nodes (92): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+84 more)
...
Cohesion: 0.03
Nodes (88): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), HookItem, computeQueuePositionFromStatus(), findPositionInQueue() (+80 more)
...
Cohesion: 0.03
Nodes (71): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+63 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (78): showCommand(), buildPanSpecFilename(), buildPanSpecPath(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), next, path (+70 more)
...
Cohesion: 0.05
Nodes (74): after, before, blockers, result, statuses, after, row, status (+66 more)
...
Cohesion: 0.04
Nodes (69): AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+61 more)
...
Cohesion: 0.05
Nodes (46): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, WorkLogEntry, AssistantMessageRow(), formatElapsed(), formatTimestamp() (+38 more)
...
Cohesion: 0.05
Nodes (25): stopDeacon(), createHandoffEvent(), CloisterService, listener(), writeStateFile(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS (+17 more)
...
Cohesion: 0.07
Nodes (48): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+40 more)
...
Cohesion: 0.04
Nodes (45): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+37 more)
...
Cohesion: 0.07
Nodes (45): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+37 more)
...
Cohesion: 0.05
Nodes (39): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+31 more)
...
Cohesion: 0.05
Nodes (24): buildChildEnvWithoutTmux(), resizeWindowAsync(), getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, EditorLaunch, execAsync (+16 more)
...
Cohesion: 0.09
Nodes (38): writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), deleteIssueDraft(), getDraftPath() (+30 more)
...
Cohesion: 0.06
Nodes (35): setAgentStoppedNotifier(), withConcurrencyLimit(), setPipelineHandler(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp() (+27 more)
...
Cohesion: 0.07
Nodes (35): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentPhase() (+27 more)
...
Cohesion: 0.11
Nodes (31): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+23 more)

### Community 155 - "Community 155"
Cohesion: 0.06
Nodes (32): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+24 more)
...
Cohesion: 0.13
Nodes (31): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+23 more)
...
Cohesion: 0.09
Nodes (23): ComposerMode, IssueComposer(), IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus() (+15 more)
...
Cohesion: 0.13
Nodes (26): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+18 more)
...
Cohesion: 0.13
Nodes (29): isEligibleForCleanup(), clearFeedbackFiles(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), readPendingFeedback(), readPlanningContext(), installGitHooks() (+21 more)
...
Cohesion: 0.13
Nodes (25): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+17 more)
...
Cohesion: 0.13
Nodes (25): CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+17 more)
...
Cohesion: 0.12
Nodes (22): appendToRunLog(), getRunLog(), getRunLogPath(), parseLogMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions (+14 more)
...
Cohesion: 0.15
Nodes (21): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, ListOptions, projectInitCommand(), projectListCommand(), projectRemoveCommand() (+13 more)
...
Cohesion: 0.1
Nodes (20): checkLogSizeLimit(), getRunLogSize(), isRunLogActive(), content, deleted, { filePath }, largeContent, metadata (+12 more)
...
Cohesion: 0.12
Nodes (15): buildACLookupByTitle(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), WorkAgentPromptContext, writeStoryFeatureContext(), readWorkspaceContext(), bdReadyLines (+7 more)
...
Cohesion: 0.23
Nodes (12): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+4 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 133`, `Community 7`, `Community 9`, `Community 267`, `Community 11`, `Community 13`, `Community 14`, `Community 525`, `Community 16`, `Community 273`, `Community 402`, `Community 19`, `Community 12`, `Community 268`, `Community 22`, `Community 23`, `Community 21`, `Community 25`, `Community 795`, `Community 543`, `Community 31`, `Community 420`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 55`, `Community 56`, `Community 189`, `Community 74`, `Community 587`, `Community 80`, `Community 209`, `Community 107`, `Community 749`, `Community 109`, `Community 113`, `Community 628`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 132` to `Community 154`, `Community 12`, `Community 5`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `resolveProjectFromIssue()` connect `Community 2` to `Community 3`, `Community 5`, `Community 9`, `Community 15`, `Community 143`, `Community 17`, `Community 18`, `Community 22`, `Community 154`, `Community 27`, `Community 28`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 48`, `Community 176`, `Community 50`, `Community 51`, `Community 53`, `Community 310`, `Community 55`, `Community 312`, `Community 57`, `Community 58`, `Community 196`, `Community 211`, `Community 92`, `Community 101`, `Community 107`, `Community 113`?**
