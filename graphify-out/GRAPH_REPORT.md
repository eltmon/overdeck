# Graph Report - feature-pan-1148  (2026-05-18)

## Corpus Check
- 1742 files · ~2,320,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23793 nodes · 36356 edges · 1218 communities (1169 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3534df2`
...
3. `resolveProjectFromIssue()` - 119 edges
4. `useDashboardStore` - 65 edges
5. `sessionExistsAsync()` - 59 edges
6. `spawnRun()` - 50 edges
7. `spawnAgent()` - 50 edges
8. `messageAgent()` - 48 edges
9. `runPatrol()` - 48 edges
10. `jsonResponse()` - 48 edges
...
## Communities (1218 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (144): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+136 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (156): autoResumeStoppedWorkAgents(), monitorReviewConvoySignals(), notifyAgentStatusChanged(), nudgeIdleWorkAgentsWithOpenBeads(), recoverOrphanedAgentsOnce(), detectHandoffMethod(), HandoffMethod, HandoffOptions (+148 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (138): checkPostReviewCommits(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), after, row, status, clearWorkspaceStuck() (+130 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (119): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+111 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (112): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, DoubleDialogComponent() (+104 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (133): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (107): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+99 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (111): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (97): resumeCommand(), AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+89 more)
...
Cohesion: 0.03
Nodes (106): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+98 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (101): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), VerificationRunnerOptions (+93 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (79): parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime() (+71 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (94): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, dropLingeringPreMergeStashes() (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (96): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+88 more)
...
Cohesion: 0.02
Nodes (85): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (92): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+84 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (76): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed() (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (79): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocument(), parsePanSpecDocumentAsync(), projectPanPaths() (+71 more)
...
Cohesion: 0.04
Nodes (83): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+75 more)
...
Cohesion: 0.03
Nodes (77): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+69 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (72): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+64 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (78): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, activeRoleRunExists() (+70 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (78): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+70 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (79): checkThinkingSignatureCorruption(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+71 more)
...
Cohesion: 0.04
Nodes (72): checkHeartbeat(), checkStuckReviewing(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve (+64 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (73): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, requireTrustedOrigin(), cliproxyRouteLayer, rejectInvalidOrigin(), conversationsRouteLayer, authorized() (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (75): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync() (+67 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (78): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+70 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (78): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+70 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (72): buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps, ResolveAndSpeakOptions (+64 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (65): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+57 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (69): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+61 more)
...
Cohesion: 0.06
Nodes (67): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+59 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (67): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+59 more)
...
Cohesion: 0.05
Nodes (61): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (49): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, DiffStatLabel, hasNonZeroStat() (+41 more)
...
Cohesion: 0.05
Nodes (55): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses() (+47 more)
...
Cohesion: 0.07
Nodes (54): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+46 more)
...
Cohesion: 0.07
Nodes (51): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+43 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (40): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+32 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (52): Access, readLogTail(), AIProvider, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats() (+44 more)
...
Cohesion: 0.05
Nodes (48): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+40 more)
...
Cohesion: 0.05
Nodes (44): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (39): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), criteria, doc, projectDoc, projectRoot (+31 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (43): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+35 more)
...
Cohesion: 0.04
Nodes (36): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, useDialogDepth() (+28 more)
...
Cohesion: 0.06
Nodes (42): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, collectJsonlFiles() (+34 more)
...
Cohesion: 0.07
Nodes (37): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode, AutoPresoSession (+29 more)
...
Cohesion: 0.09
Nodes (40): embedAction(), ScanOptions, SearchQuery, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), buildFilterSql(), countDiscoveredSessions(), findDiscoveredSessions() (+32 more)
...
Cohesion: 0.05
Nodes (42): Activity, AgentChannelReply, AgentId, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+34 more)
...
Cohesion: 0.08
Nodes (32): ToggleButton(), DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps (+24 more)
...
Cohesion: 0.08
Nodes (35): evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG (+27 more)
...
Cohesion: 0.09
Nodes (33): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, YamlConfig, StoredEvent, ActivityTtsPayload, drainQueue() (+25 more)
...
Cohesion: 0.08
Nodes (34): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+26 more)

### Community 122 - "Community 122"
Cohesion: 0.06
Nodes (26): ChatMessage, MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient (+18 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (30): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+22 more)
...
Cohesion: 0.08
Nodes (31): showAction(), getDiscoveredSessionById(), markEnrichmentFailed(), rowToSession(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+23 more)
...
Cohesion: 0.08
Nodes (24): SearchResult, runWithPool(), WorkPoolStats, ConversationFilter, DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), EmbedProgress (+16 more)
...
Cohesion: 0.08
Nodes (27): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind (+19 more)
...
Cohesion: 0.11
Nodes (31): addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult, LinearComment (+23 more)
...
Cohesion: 0.11
Nodes (29): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+21 more)
...
Cohesion: 0.11
Nodes (31): closeIssue(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), TeardownOptions, WorkflowResult (+23 more)
...
Cohesion: 0.1
Nodes (32): buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatVoiceDetails(), formatVoiceSource(), formatVoicesTable(), listTtsVoices(), mapTtsVoice() (+24 more)

### Community 177 - "Community 177"
Cohesion: 0.07
Nodes (27): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+19 more)

### Community 178 - "Community 178"
Cohesion: 0.11
Nodes (26): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getUnsyncedHistory() (+18 more)
...
Cohesion: 0.13
Nodes (22): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+14 more)

### Community 210 - "Community 210"
Cohesion: 0.11
Nodes (28): constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders(), hasDashboardInternalToken() (+20 more)
...
Cohesion: 0.13
Nodes (25): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHandle (+17 more)
...
Cohesion: 0.1
Nodes (25): snapshot, status, Jsonish, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentResolution(), toAgentStatus() (+17 more)
...
Cohesion: 0.11
Nodes (25): getFtsRow(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession(), buildEmbeddingText(), embed() (+17 more)
...
Cohesion: 0.08
Nodes (20): ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), HARNESS_OPTIONS, HarnessDecision, HarnessPolicyDecisions (+12 more)
...
Cohesion: 0.09
Nodes (22): issues, result, importTrackerConfig(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+14 more)
...
Cohesion: 0.08
Nodes (24): cosineSimilarity(), insertEmbedding(), a, b, bestOlderMatch, chalk, day, emb (+16 more)
...
Cohesion: 0.09
Nodes (21): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+13 more)
...
Cohesion: 0.13
Nodes (24): normalizeFilter(), SearchMode, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult (+16 more)

### Community 288 - "Community 288"
Cohesion: 0.08
Nodes (25): cb, completedState, dispatched, featureWorkspace, implSlot, initial, initialState, jsonBlock (+17 more)
...
Cohesion: 0.1
Nodes (13): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode (+5 more)
...
Cohesion: 0.1
Nodes (20): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+12 more)
...
Cohesion: 0.13
Nodes (22): ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents(), readHandoffEvents() (+14 more)
...
Cohesion: 0.17
Nodes (19): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+11 more)
...
Cohesion: 0.18
Nodes (20): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+12 more)
...
Cohesion: 0.13
Nodes (19): shouldSkipCheckpointReconciliation(), applyEvent(), applyEvents(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), EmbedProgressSnapshot, EnrichProgressSnapshot (+11 more)
...
Cohesion: 0.14
Nodes (15): deriveProjectRoot(), doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, QueuedCommit (+7 more)
...
Cohesion: 0.14
Nodes (16): fetchCost(), fetchSearch(), fetchSessions(), fetchStats(), fetchWorkspaceCost(), CostThresholdDetails, embedSession(), EnrichRequest (+8 more)
...
Cohesion: 0.18
Nodes (14): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), StepResult (+6 more)
...
Cohesion: 0.16
Nodes (12): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute, postCodexReauthStatusRoute (+4 more)
...
Cohesion: 0.19
Nodes (11): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+3 more)
...
Cohesion: 0.21
Nodes (12): DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings(), loadVoiceSettings(), normalizeVoiceSettings(), putVoiceSettingsRoute, readJsonBody, saveVoiceSettings() (+4 more)
...
Cohesion: 0.15
Nodes (12): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+4 more)
...
Cohesion: 0.32
Nodes (12): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath(), readEventsFromLine() (+4 more)
...
Cohesion: 0.17
Nodes (11): StaticVerbBadgeProps, StaticVerbBadgeVariant, StuckVerbBadgeProps, badge, { container }, { container, unmount }, PULSING_VARIANTS, VerbBadge() (+3 more)
...
Cohesion: 0.17
Nodes (10): GitOperation, getActivityByIdRoute, getActivityDetailedRoute, getActivityRoute, getActivityTtsRoute, getGitActivityRoute, getMetricsCostsRoute, getMetricsStuckRoute (+2 more)
...
Cohesion: 0.31
Nodes (9): computeParallelism(), detectDriveType(), DriveType, execAsync, getSystemCapabilities(), measureDriveReadSpeed(), probe(), resetSystemCapabilitiesCache() (+1 more)
...
Cohesion: 0.22
Nodes (7): chalk, cliRows, dashboardRows, logs, output, parsed, seedSessions()
...
Cohesion: 0.25
Nodes (6): chalk, exitSpy, logs, output, parsed, seedSession()
...
Cohesion: 0.25
Nodes (7): Active Pipeline, Cycling Alerts, Flywheel State Snapshot, Infrastructure Gaps, Pattern Ledger, Run 2026-05-17 — Pipeline-Clear Push, Skill Gaps
...
Cohesion: 0.29
Nodes (5): chalk, logs, output, parsed, seedSessions()
...
## Knowledge Gaps
- **12406 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12401 more)
...
- **Why does `fetch` connect `Community 0` to `Community 2`, `Community 3`, `Community 134`, `Community 6`, `Community 646`, `Community 9`, `Community 522`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 285`, `Community 289`, `Community 36`, `Community 165`, `Community 37`, `Community 424`, `Community 43`, `Community 44`, `Community 813`, `Community 47`, `Community 48`, `Community 693`, `Community 570`, `Community 188`, `Community 60`, `Community 62`, `Community 192`, `Community 67`, `Community 68`, `Community 69`, `Community 596`, `Community 85`, `Community 99`, `Community 227`, `Community 108`, `Community 111`, `Community 112`, `Community 114`, `Community 248`, `Community 377`, `Community 122`, `Community 637`, `Community 638`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 160`, `Community 5`, `Community 7`, `Community 39`, `Community 361`, `Community 42`, `Community 11`, `Community 46`, `Community 336`, `Community 23`, `Community 120`, `Community 313`, `Community 28`, `Community 639`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 746` to `Community 8`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12406 weakly-connected nodes found - possible documentation gaps or missing edges._
