...
## Corpus Check
- 1547 files · ~2,059,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21590 nodes · 31952 edges · 1130 communities (1093 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a29630d`
...
- `dispatchParallelReview()` --calls--> `coordinatorSpawnFn`  [INFERRED]
  src/lib/cloister/review-agent.ts → tests/lib/cloister/review-agent.test.ts
- `isEligibleForCleanup()` --calls--> `require`  [INFERRED]
  tests/lib/cloister/deacon-cleanup.test.ts → src/lib/vbrief/builder.ts

## Communities (1130 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (147): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, computeAgentEnrichment(), execAsync, getActiveSessionPath() (+139 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (150): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes(), execAsync (+142 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (134): setAgentStoppedNotifier(), spawnReviewCoordinatorSession(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+126 more)
...
Cohesion: 0.02
Nodes (122): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (114): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (120): readCavemanVariant(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+112 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (95): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+87 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (97): state, EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, BadgeBarProps, fetchPlanning() (+89 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (111): renderPrompt(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags(), bumpSessionGeneration(), clearSessionId() (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (108): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), buildSyncFailureFeedback() (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (111): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, execAsync, getFilesChangedFromPR(), getReviewAgents() (+103 more)
...
Cohesion: 0.03
Nodes (91): loadCloisterConfig(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask, buildHandoffPrompt() (+83 more)
...
Cohesion: 0.03
Nodes (79): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+71 more)
...
Cohesion: 0.06
Nodes (71): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+63 more)
...
Cohesion: 0.05
Nodes (56): criteria, doc, result, doc, path, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+48 more)
...
Cohesion: 0.04
Nodes (56): ViewMode, firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+48 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (60): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+52 more)
...
Cohesion: 0.04
Nodes (49): parseContainerServiceName(), parseIssueIdFromText(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps (+41 more)
...
Cohesion: 0.06
Nodes (50): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), dispatchSwarmWave(), beadsDir, doc, badPath (+42 more)
...
Cohesion: 0.06
Nodes (40): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError() (+32 more)
...
Cohesion: 0.07
Nodes (43): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+35 more)
...
Cohesion: 0.08
Nodes (43): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd(), activeDir, completedDir, ctx (+35 more)
...
Cohesion: 0.07
Nodes (39): detectPlatform(), Platform, evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb() (+31 more)
...
Cohesion: 0.09
Nodes (37): destroyRemoteWorkspace(), ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyProvider(), FlyProviderConfig (+29 more)
...
Cohesion: 0.07
Nodes (36): configShadowCommand(), ShadowOptions, DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse, DASHBOARD_URL, reviewRestartCommand(), ReviewRestartOptions (+28 more)
...
Cohesion: 0.12
Nodes (32): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), LOGS_DIR (+24 more)
...
Cohesion: 0.06
Nodes (20): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, dbError, deleteCalls, existingBeads, expectedPrefix, initCall (+12 more)
...
Cohesion: 0.07
Nodes (27): getAllModels(), getCapabilityMatchScore(), getModelById(), OpenRouterFavoriteModel, DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS (+19 more)
...
Cohesion: 0.12
Nodes (25): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), writeSpecForIssue(), asPanSpecDocument() (+17 more)
...
Cohesion: 0.24
Nodes (22): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses(), killTmuxSessions() (+14 more)
...
Cohesion: 0.13
Nodes (19): CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus(), getShadowStatePath(), markAsSynced(), removeShadowState(), SHADOW_STATE_DIR (+11 more)
...
Cohesion: 0.13
Nodes (14): ENV_FILE_PATH, loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode() (+6 more)
...
Cohesion: 0.11
Nodes (15): MODELS_BY_PROVIDER, ensureDefaultConversationModel(), DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), SettingsConfig, allModelIds, config, defaults (+7 more)
...
## Knowledge Gaps
- **11503 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11498 more)
...
- **Why does `fetch` connect `Community 4` to `Community 640`, `Community 128`, `Community 2`, `Community 5`, `Community 262`, `Community 135`, `Community 8`, `Community 7`, `Community 522`, `Community 267`, `Community 11`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 151`, `Community 26`, `Community 30`, `Community 32`, `Community 163`, `Community 36`, `Community 37`, `Community 42`, `Community 43`, `Community 175`, `Community 49`, `Community 50`, `Community 51`, `Community 54`, `Community 195`, `Community 196`, `Community 81`, `Community 485`, `Community 745`, `Community 105`, `Community 629`, `Community 630`, `Community 124`, `Community 381`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 13`, `Community 6`, `Community 15`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 185` to `Community 242`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11503 weakly-connected nodes found - possible documentation gaps or missing edges._
