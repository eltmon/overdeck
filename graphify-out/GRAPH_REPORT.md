...
## Corpus Check
- 1920 files · ~3,145,417 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27464 nodes · 43090 edges · 1279 communities (1224 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c70e8985`
...
## Communities (1279 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (215): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS (+207 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (179): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+171 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (169): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, captureTldrMetricsSync(), catchCause (+161 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (156): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (139): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (147): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMapSync(), CorrelationResult, generateSmartSummary(), copySessionFromCompactBoundary() (+139 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): containerRestartBackoffMs(), DeaconState, customPromisify, justNow, longAgo, old, recent, restartCalled (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (146): spawnInspectAgentPromise(), buildSpecialistBaseCommand(), sendFeedbackToAgent(), recoverCommand(), RecoverOptions, tellCommand(), reactivateConversationForSpawn(), ActivityEntry (+138 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (113): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+105 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (133): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+125 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (113): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+105 more)
...
Cohesion: 0.02
Nodes (107): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier (+99 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (105): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (112): DatabaseError, dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+104 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (80): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, getAgentSessionsSync(), listSessionsSync() (+72 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+74 more)
...
Cohesion: 0.04
Nodes (92): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+84 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (85): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+77 more)
...
Cohesion: 0.04
Nodes (89): renderPrompt(), getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext() (+81 more)
...
Cohesion: 0.04
Nodes (81): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+73 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (67): cont, doc, projectRoot, specsDir, workspace, { projectPath, workspacePath }, promoted, specFiles (+59 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (82): contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+74 more)
...
Cohesion: 0.06
Nodes (93): add, addCommentBefore(), addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), anchorNames() (+85 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (68): isRunningAgent(), format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase() (+60 more)
...
Cohesion: 0.04
Nodes (34): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+26 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (62): configShadowCommand(), ShadowOptions, destroyRemoteWorkspace(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlagsSync(), readYoloEnv(), resolvePermissionModeSync() (+54 more)
...
Cohesion: 0.05
Nodes (71): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+63 more)
...
Cohesion: 0.04
Nodes (51): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, AssistantMessageRow(), formatElapsed() (+43 more)
...
Cohesion: 0.06
Nodes (62): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+54 more)
...
Cohesion: 0.05
Nodes (58): captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoffPromise(), performKillAndSpawn() (+50 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (57): agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), createAgentStopHandler(), deleteAgentRoute, EMPTY_CONVERSATION (+49 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (55): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+47 more)
...
Cohesion: 0.05
Nodes (49): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, closeMemoryFtsDatabases() (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (45): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+37 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (55): parseWalFile(), SyncResult, syncWalFromAllProjectsPromise(), syncWalFromDirPromise(), AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey() (+47 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (49): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+41 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (45): criteria, doc, result, beadsDir, doc, createCall, createCalls, dbError (+37 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (49): ConversationFilter, markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi() (+41 more)
...
Cohesion: 0.07
Nodes (46): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+38 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (46): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+38 more)
...
Cohesion: 0.06
Nodes (42): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync() (+34 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (51): embedAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+43 more)
...
Cohesion: 0.06
Nodes (49): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact() (+41 more)
...
Cohesion: 0.05
Nodes (35): completeSessionSync(), DEFAULT_DATA, findSessionByIdSync(), getAllIssuesWithCostsSync(), getIssueCostSummarySync(), getIssueSessionsSync(), IssueSessionMap, linkSessionToIssueSync() (+27 more)
...
Cohesion: 0.05
Nodes (42): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+34 more)
...
Cohesion: 0.06
Nodes (45): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+37 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (50): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+42 more)
...
Cohesion: 0.06
Nodes (42): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings() (+34 more)

### Community 103 - "Community 103"
Cohesion: 0.05
Nodes (40): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+32 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (38): startPostLaunchSidecars(), startSidecars(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild() (+30 more)
...
Cohesion: 0.06
Nodes (19): getActiveSessionModelSync(), getProjectDirsSync(), getSessionFilesSync(), normalizeModelName(), parseClaudeSessionSync(), claudeProjectDir, content, lines (+11 more)

### Community 119 - "Community 119"
Cohesion: 0.06
Nodes (37): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+29 more)

### Community 120 - "Community 120"
Cohesion: 0.09
Nodes (44): flywheelAbortCommand(), loadActiveFlywheelStatus(), loadReportFlywheelStatus(), readFlywheelGateSnapshot(), getFlywheelActiveRunId(), isFlywheelGloballyPaused(), getFlywheelRunPayload(), getFlywheelRunsPayload() (+36 more)
...
Cohesion: 0.06
Nodes (35): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+27 more)
...
Cohesion: 0.05
Nodes (41): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse (+33 more)
...
Cohesion: 0.06
Nodes (31): applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModelsSync(), getAvailableModelsSync(), getBestAnthropicAtTier(), getFallbackModelSync() (+23 more)
...
Cohesion: 0.07
Nodes (30): appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir() (+22 more)
...
Cohesion: 0.09
Nodes (34): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsDaemonConfigs(), resolveAndSpeak(), checkTtsHealth(), speakTts(), StoredEvent, ActivityTtsPayload (+26 more)

### Community 161 - "Community 161"
Cohesion: 0.06
Nodes (31): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), parseAllSessionsSync(), AIProvider, calculateCostSync(), CostEntry, DEFAULT_PRICING (+23 more)
...
Cohesion: 0.07
Nodes (29): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+21 more)
...
Cohesion: 0.08
Nodes (29): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+21 more)
...
Cohesion: 0.08
Nodes (37): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+29 more)
...
Cohesion: 0.08
Nodes (33): getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+25 more)

### Community 184 - "Community 184"
Cohesion: 0.13
Nodes (37): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl() (+29 more)
...
Cohesion: 0.09
Nodes (30): DASHBOARD_LOG_FILE, describePid(), execAsync, isTraefikContainerRunningPromise(), killPidsSync(), pidsOnPort(), PlatformConfig, restartCliproxy() (+22 more)
...
Cohesion: 0.08
Nodes (27): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+19 more)
...
Cohesion: 0.08
Nodes (28): deliverReviewVerdictFeedback(), after, callback, command, commit, files, mockExecCallback, mockResolveProject (+20 more)
...
Cohesion: 0.1
Nodes (27): ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), normalizeCanonicalState(), PipelineState (+19 more)
...
Cohesion: 0.09
Nodes (25): GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions (+17 more)
...
Cohesion: 0.08
Nodes (20): execAsync, gatherArtifactsPromise(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, liftMonitoringError(), MonitoringAgentConfig, MonitoringAgentError (+12 more)
...
Cohesion: 0.11
Nodes (22): filterPayload(), array, combine, hash(), intIdentify(), intStringify(), number(), optimize() (+14 more)
...
Cohesion: 0.15
Nodes (19): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+11 more)
...
Cohesion: 0.12
Nodes (18): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+10 more)
...
Cohesion: 0.19
Nodes (17): getVBriefACStatusSync(), syncBeadStatusToVBrief(), BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChanges(), checkUncommittedChangesPromise(), checkVBriefACStatusSync() (+9 more)
...
Cohesion: 0.15
Nodes (16): fetchCost(), fetchStats(), fetchWorkspaceCost(), triggerScan(), CostThresholdDetails, embedSession(), EnrichRequest, enrichSession() (+8 more)
...
Cohesion: 0.18
Nodes (13): sentinel, initWorkspaceDiscoveredSessionsSchema(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore (+5 more)
...
Cohesion: 0.31
Nodes (10): DatabaseError, getSetting(), getSettingProgram(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId(), setFlywheelGloballyPaused(), setSetting() (+2 more)
...
## Knowledge Gaps
- **13598 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13593 more)
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 527`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 44`, `Community 51`, `Community 52`, `Community 54`, `Community 569`, `Community 59`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 81`, `Community 84`, `Community 85`, `Community 94`, `Community 98`, `Community 611`, `Community 610`, `Community 104`, `Community 105`, `Community 111`, `Community 117`, `Community 120`, `Community 132`, `Community 133`, `Community 646`, `Community 144`, `Community 146`, `Community 162`, `Community 167`, `Community 686`, `Community 177`, `Community 690`, `Community 184`, `Community 201`, `Community 202`, `Community 203`, `Community 204`, `Community 209`, `Community 739`, `Community 237`, `Community 238`, `Community 239`, `Community 249`, `Community 778`, `Community 784`, `Community 278`, `Community 297`, `Community 308`, `Community 326`, `Community 336`, `Community 858`, `Community 385`, `Community 386`, `Community 387`, `Community 388`, `Community 391`, `Community 412`, `Community 414`, `Community 435`, `Community 458`, `Community 463`, `Community 476`, `Community 482`, `Community 498`, `Community 500`, `Community 504`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 390`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 274`, `Community 19`, `Community 918`, `Community 22`, `Community 25`, `Community 284`, `Community 29`, `Community 30`, `Community 28`, `Community 33`, `Community 163`, `Community 295`, `Community 168`, `Community 167`, `Community 42`, `Community 39`, `Community 40`, `Community 686`, `Community 46`, `Community 48`, `Community 50`, `Community 310`, `Community 59`, `Community 66`, `Community 67`, `Community 69`, `Community 201`, `Community 331`, `Community 75`, `Community 462`, `Community 209`, `Community 84`, `Community 227`, `Community 101`, `Community 103`, `Community 619`, `Community 240`, `Community 117`, `Community 119`, `Community 249`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 30` to `Community 65`, `Community 546`, `Community 388`, `Community 38`, `Community 8`, `Community 40`, `Community 11`, `Community 14`, `Community 20`, `Community 213`, `Community 25`, `Community 154`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13598 weakly-connected nodes found - possible documentation gaps or missing edges._
