...
## Corpus Check
- 1745 files · ~2,327,335 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23917 nodes · 36689 edges · 1203 communities (1153 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `837a50e5`
...
## Communities (1203 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (139): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (150): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+142 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (159): nudgeIdleWorkAgentsWithOpenBeads(), spawnInspectAgent(), buildSpecialistBaseCommand(), pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+151 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (118): PlanningState, ZoneAActionsState, BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, DetailPanelLayout(), DetailPanelLayoutProps (+110 more)
...
Cohesion: 0.03
Nodes (128): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+120 more)
...
Cohesion: 0.03
Nodes (120): checkMissingReviewStatuses(), cleanupOrphanedReviewSessions(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), monitorReviewConvoySignals(), dropLingeringPreMergeStashes(), buildConvoyPrompt() (+112 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (104): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchSettings() (+96 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (105): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (102): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+94 more)
...
Cohesion: 0.04
Nodes (104): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows() (+96 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (102): SearchResult, adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, constantTimeTokenEqual(), cookieValue() (+94 more)
...
Cohesion: 0.04
Nodes (93): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+85 more)
...
Cohesion: 0.04
Nodes (89): checkPostReviewCommits(), after, before, blockers, result, statuses, after, row (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (75): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, { projectPath, workspacePath }, promoted (+67 more)
...
Cohesion: 0.04
Nodes (89): embedAction(), ScanOptions, normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (75): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails (+67 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (80): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+72 more)
...
Cohesion: 0.04
Nodes (74): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+66 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (75): closeOutCommand(), CloseOutOptions, getGitHubConfig(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+67 more)
...
Cohesion: 0.06
Nodes (73): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+65 more)
...
Cohesion: 0.05
Nodes (61): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+53 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (63): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, cloisterRouteLayer (+55 more)
...
Cohesion: 0.05
Nodes (62): checkHeartbeat(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+54 more)
...
Cohesion: 0.03
Nodes (53): makeTestService(), eightDaysAgo, events, payload, r1, r2, received, recent (+45 more)
...
Cohesion: 0.05
Nodes (51): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt() (+43 more)
...
Cohesion: 0.04
Nodes (49): VoiceMode, VoiceWidget(), Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab (+41 more)
...
Cohesion: 0.03
Nodes (54): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, determineHealthStatusAsync(), clearCacheRoute, ConfirmationRequest (+46 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (52): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+44 more)
...
Cohesion: 0.04
Nodes (51): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), rowToSession(), updateEnrichment() (+43 more)
...
Cohesion: 0.09
Nodes (55): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials (+47 more)
...
Cohesion: 0.05
Nodes (51): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+43 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (45): sentinel, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter (+37 more)
...
Cohesion: 0.06
Nodes (42): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+34 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (46): postMergeLifecycle(), calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths() (+38 more)
...
Cohesion: 0.06
Nodes (37): firstSessionPanel, firstWorkbench, overview, workbench, CommandDeck(), ComposerMode, IssueComposer(), IssueComposerProps (+29 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (50): acquireStartLock(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb() (+42 more)
...
Cohesion: 0.05
Nodes (45): CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute (+37 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (47): Access, readLogTail(), buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats(), getIndexStats() (+39 more)
...
Cohesion: 0.06
Nodes (29): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffWorkerPoolProvider(), Sidebar() (+21 more)
...
Cohesion: 0.08
Nodes (36): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, resolveBundledServerPath() (+28 more)
...
Cohesion: 0.08
Nodes (35): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+27 more)
...
Cohesion: 0.13
Nodes (32): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+24 more)
...
Cohesion: 0.12
Nodes (30): addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult, LinearComment (+22 more)
...
Cohesion: 0.14
Nodes (30): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT() (+22 more)
...
Cohesion: 0.09
Nodes (19): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), fmtCost(), fmtDuration(), ReviewSummary() (+11 more)
...
Cohesion: 0.12
Nodes (25): validateAndCleanStateFile(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+17 more)
...
Cohesion: 0.1
Nodes (26): getTtsDaemonAuthHeaders(), getTtsDaemonAuthToken(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+18 more)
...
Cohesion: 0.15
Nodes (25): captureTmuxOutput(), isMergeAgentRunning(), healthCommand(), HealthOptions, AgentHealth, checkAgentHealthAsync(), formatHealthStatus(), getAgentHealth() (+17 more)
...
Cohesion: 0.11
Nodes (20): formatCost(), formatTimestamp(), MergedSummaryCard(), MergedSummaryCardProps, button, costText, link, onViewLastLog (+12 more)
...
Cohesion: 0.11
Nodes (14): NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), startCliproxyWatchdog(), startSharedPresencePoller(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig (+6 more)
...
Cohesion: 0.26
Nodes (13): ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent(), optionalString(), speakActivityTts() (+5 more)
...
Cohesion: 0.29
Nodes (9): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+1 more)
...
Cohesion: 0.25
Nodes (7): CONFIG, hadPackageDir, hadPython, hadVenvDir, killSpy, packageDir, python
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 131`, `Community 132`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 792`, `Community 411`, `Community 29`, `Community 30`, `Community 289`, `Community 292`, `Community 165`, `Community 38`, `Community 40`, `Community 680`, `Community 43`, `Community 172`, `Community 45`, `Community 300`, `Community 175`, `Community 429`, `Community 48`, `Community 50`, `Community 171`, `Community 55`, `Community 56`, `Community 569`, `Community 62`, `Community 65`, `Community 68`, `Community 70`, `Community 199`, `Community 203`, `Community 597`, `Community 219`, `Community 95`, `Community 224`, `Community 104`, `Community 233`, `Community 631`, `Community 126`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 65` to `Community 159`, `Community 1`, `Community 2`, `Community 5`, `Community 166`, `Community 7`, `Community 200`, `Community 9`, `Community 201`, `Community 13`, `Community 219`, `Community 17`, `Community 21`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `postWithTimeout()` connect `Community 203` to `Community 1`?**
