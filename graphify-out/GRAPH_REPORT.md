...
## Corpus Check
- 1546 files · ~2,060,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21558 nodes · 31983 edges · 1126 communities (1091 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8754a53e`
...
## Communities (1126 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (166): checkPendingTestDispatch(), cleanupSpawnAndOrphanedStashes(), clearStaleCiFeedback(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), captureTmuxOutput(), _closeIssueFailures (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (128): isMergeAgentRunning(), formatFeedbackForAgent(), sendFeedbackToAgent(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+120 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (137): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod (+129 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (128): setAgentStoppedNotifier(), emitCoordinatorDied(), spawnReviewCoordinatorSession(), getAllSpecialistStatus(), SpecialistStatus, after, before, blockers (+120 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (115): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+107 more)
...
Cohesion: 0.02
Nodes (126): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (93): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+85 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (116): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (89): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS (+81 more)
...
Cohesion: 0.03
Nodes (72): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider() (+64 more)
...
Cohesion: 0.05
Nodes (84): closeOutCommand(), CloseOutOptions, getGitHubConfig(), projectListCommand(), projectRemoveCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands() (+76 more)
...
Cohesion: 0.07
Nodes (82): extractPrefix(), calls, { mockExecAsync }, opts, ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (71): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanel(), ConversationPanelProps (+63 more)
...
Cohesion: 0.04
Nodes (44): stopDeacon(), createHandoffEvent(), generateHealthSummary(), getAgentsNeedingAttention(), CloisterService, readStateFile(), listener(), writeStateFile() (+36 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (72): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, showCommand(), findSpecByIssue(), updateSpecStatus() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (68): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (67): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps (+59 more)
...
Cohesion: 0.03
Nodes (63): ConversationRow(), ConversationRowProps, PHASE_ICONS, executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry (+55 more)
...
Cohesion: 0.05
Nodes (68): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+60 more)
...
Cohesion: 0.05
Nodes (67): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+59 more)
...
Cohesion: 0.05
Nodes (52): criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument(), formatAcceptanceCriteria() (+44 more)
...
Cohesion: 0.06
Nodes (57): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+49 more)
...
Cohesion: 0.04
Nodes (46): listFavoritedIds(), removeFavorite(), setFavorite(), ids, initSchema(), base, cols, colsAfter (+38 more)
...
Cohesion: 0.07
Nodes (48): FileStatus, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (43): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+35 more)
...
Cohesion: 0.04
Nodes (42): getActivity(), pending, withBdMutex(), agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, execAsync (+34 more)
...
Cohesion: 0.07
Nodes (44): applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, ConfigCache, ConfigLoadResult, ConversationsConfig, CONVOY_KEY_MIGRATION (+36 more)
...
Cohesion: 0.09
Nodes (38): captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), diffAgainstMain(), diffAgainstMainFiles(), diffCheckpointFiles(), diffCheckpoints() (+30 more)
...
Cohesion: 0.09
Nodes (33): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig, LauncherHarness (+25 more)

### Community 140 - "Community 140"
Cohesion: 0.09
Nodes (29): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+21 more)
...
Cohesion: 0.08
Nodes (30): err, exec(), execFile(), execMock, kCustom, realExecAsync, spawnMock, tmuxCapturePaneAsyncMock (+22 more)
...
Cohesion: 0.1
Nodes (31): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+23 more)

### Community 161 - "Community 161"
Cohesion: 0.1
Nodes (34): autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, dispatchSwarmWave(), ensureSwarmAutoAdvanceLoop(), execAsync (+26 more)
...
Cohesion: 0.08
Nodes (25): makeTestService(), sentinel, createEventStore(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore() (+17 more)
...
Cohesion: 0.12
Nodes (25): killAllReviewSessions(), healthCommand(), HealthOptions, AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile() (+17 more)
...
Cohesion: 0.09
Nodes (15): BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover(), formatCost(), IssueCostBreakdown, MERGING_STATUSES, PIPELINE_STAGES (+7 more)
...
Cohesion: 0.12
Nodes (21): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+13 more)
...
Cohesion: 0.23
Nodes (10): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), doc, path, criticalPath() (+2 more)
...
Cohesion: 0.26
Nodes (10): fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress(), ReopenOptions (+2 more)
...
Cohesion: 0.25
Nodes (4): PersistedState, parsed, raw, { result }
...
## Knowledge Gaps
- **11478 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11473 more)
...
- **Why does `fetch` connect `Community 5` to `Community 3`, `Community 132`, `Community 4`, `Community 6`, `Community 519`, `Community 8`, `Community 11`, `Community 12`, `Community 270`, `Community 15`, `Community 16`, `Community 18`, `Community 148`, `Community 276`, `Community 21`, `Community 20`, `Community 24`, `Community 25`, `Community 149`, `Community 27`, `Community 158`, `Community 798`, `Community 33`, `Community 34`, `Community 36`, `Community 550`, `Community 40`, `Community 44`, `Community 46`, `Community 179`, `Community 180`, `Community 52`, `Community 55`, `Community 584`, `Community 590`, `Community 211`, `Community 478`, `Community 737`, `Community 116`, `Community 247`, `Community 632`, `Community 125`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 128` to `Community 1`, `Community 212`, `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 33` to `Community 32`, `Community 161`, `Community 547`, `Community 10`, `Community 267`, `Community 364`, `Community 47`, `Community 23`, `Community 26`, `Community 478`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11478 weakly-connected nodes found - possible documentation gaps or missing edges._
