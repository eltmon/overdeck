# Graph Report - feature-pan-1312-slot-2  (2026-05-22)

## Corpus Check
- 1878 files · ~2,476,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26673 nodes · 41568 edges · 1273 communities (1221 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cda3fb5b`
...
## Communities (1273 total, 52 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (143): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+135 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (160): resolveAutoResumeConfigForIssue(), monitorReviewConvoySignals(), spawnInspectAgent(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), tellCommand() (+152 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (120): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+112 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (135): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+127 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+129 more)
...
Cohesion: 0.02
Nodes (134): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, getRuntimeSnapshot(), isAgentStateServiceInProcess(), getAgentRuntimeState() (+126 more)
...
Cohesion: 0.02
Nodes (117): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+109 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (114): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+106 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (115): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+107 more)
...
Cohesion: 0.04
Nodes (105): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), normalizeFilter(), SearchMode, SearchQuery (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (100): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+92 more)
...
Cohesion: 0.03
Nodes (95): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier (+87 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (88): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+80 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc (+70 more)
...
Cohesion: 0.03
Nodes (89): checkStuckReviewing(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation() (+81 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (79): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (89): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename, getConflictFiles() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (78): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+70 more)
...
Cohesion: 0.04
Nodes (84): buildActiveSliceContext(), readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization() (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (80): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+72 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (80): buildPolyrepoContext(), projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+72 more)
...
Cohesion: 0.03
Nodes (75): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+67 more)
...
Cohesion: 0.04
Nodes (81): isPaneDeadAsyncEffect(), listPaneValuesAsyncEffect(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId() (+73 more)
...
Cohesion: 0.04
Nodes (66): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+58 more)
...
Cohesion: 0.03
Nodes (68): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+60 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (66): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+58 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (60): transitionIssueToVerifyingOnMain(), importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape (+52 more)
...
Cohesion: 0.06
Nodes (55): startPostLaunchSidecars(), startSidecars(), DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveNode22(), resolveScope() (+47 more)
...
Cohesion: 0.04
Nodes (51): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+43 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (44): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), refreshCommand() (+36 more)
...
Cohesion: 0.05
Nodes (63): inferMemoryProjectId(), retrieveSpawnTimeMemoryContext(), BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts() (+55 more)
...
Cohesion: 0.05
Nodes (51): checkPendingTestDispatch(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, isMergeAgentRunning() (+43 more)
...
Cohesion: 0.07
Nodes (49): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+41 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (46): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+38 more)
...
Cohesion: 0.06
Nodes (43): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+35 more)
...
Cohesion: 0.04
Nodes (52): result, createSessionAsyncEffect(), sendKeysEffect(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute (+44 more)
...
Cohesion: 0.06
Nodes (47): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+39 more)
...
Cohesion: 0.06
Nodes (41): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+33 more)
...
Cohesion: 0.08
Nodes (48): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+40 more)
...
Cohesion: 0.07
Nodes (40): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments() (+32 more)
...
Cohesion: 0.05
Nodes (35): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+27 more)

### Community 101 - "Community 101"
Cohesion: 0.08
Nodes (36): getDevrootPath(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest (+28 more)
...
Cohesion: 0.09
Nodes (33): parsePiSession(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles() (+25 more)
...
Cohesion: 0.08
Nodes (34): registerAdminCommands(), registerCloisterCommands(), compactCommand(), CompactOptions, detectPlatform(), doctorCommand(), execAsync, getOldClosedCount() (+26 more)
...
Cohesion: 0.06
Nodes (18): getActiveSessionModel(), getProjectDirs(), getSessionFiles(), parseClaudeSession(), claudeProjectDir, content, lines, newContent (+10 more)
...
Cohesion: 0.07
Nodes (28): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildSyncFailureFeedback() (+20 more)
...
Cohesion: 0.09
Nodes (33): detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds() (+25 more)
...
Cohesion: 0.07
Nodes (30): BLANKED_PROVIDER_ENV, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode, buildTmuxCommandString(), getTmuxCommand() (+22 more)
...
Cohesion: 0.11
Nodes (35): markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments() (+27 more)
...
Cohesion: 0.13
Nodes (35): archiveWorkspaceArtifactsImpl(), findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearProjectBeadsImpl(), clearShadowState() (+27 more)
...
Cohesion: 0.09
Nodes (30): createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), HANDOFF_LOG_FILE, HandoffEvent (+22 more)
...
Cohesion: 0.07
Nodes (23): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+15 more)
...
Cohesion: 0.14
Nodes (27): GitHubApiError, LinearApiError, config, originalEnv, tracker, AnyTrackerError, Comment, Issue (+19 more)
...
Cohesion: 0.08
Nodes (16): buildMemoryIdentity(), ClaudeCodeTranscriptSource, ClaudeCodeTranscriptSourceOptions, createDefaultTranscriptSourceRegistry(), defaultTranscriptSourceRegistry, getActiveTranscriptEntries(), inferProjectId(), PiTranscriptSource (+8 more)
...
Cohesion: 0.13
Nodes (30): loadResumeSessionId(), loadConfigAsyncNoMigrationEffect(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+22 more)
...
Cohesion: 0.12
Nodes (25): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl(), closeGitHubPr() (+17 more)
...
Cohesion: 0.1
Nodes (24): appendToRunLog(), checkLogSizeLimit(), finalizeRunLog(), getRunLog(), getRunLogPath(), getRunLogSize(), isRunLogActive(), content (+16 more)
...
Cohesion: 0.1
Nodes (20): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+12 more)
...
Cohesion: 0.08
Nodes (20): clearReviewStatus(), cb, cmdArgs, key, mockExec, mockGetPullRequestState, mockIsGitHubAppConfigured, next (+12 more)
...
Cohesion: 0.09
Nodes (18): allOps, divergedOp, execAsync, execFileMock, execMock, ops, opTypes, status (+10 more)
...
Cohesion: 0.18
Nodes (14): readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), workspacePanPaths(), clearFeedback(), readFeedback() (+6 more)
...
Cohesion: 0.16
Nodes (12): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), createBackup(), createBackupTimestamp(), listBackups() (+4 more)
...
Cohesion: 0.14
Nodes (10): createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunsDirectory(), getSpecialistsDir(), listRunLogs(), RunLogEntry (+2 more)
...
Cohesion: 0.13
Nodes (14): cleanupLabelsGitHub(), cleanupMergedLabels(), cleanupMergedLabelsImpl(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel (+6 more)
...
Cohesion: 0.19
Nodes (15): transitionIssueState(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy (+7 more)
...
## Knowledge Gaps
- **13286 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13281 more)
...
- **Why does `fetch` connect `Community 4` to `Community 2`, `Community 3`, `Community 5`, `Community 389`, `Community 7`, `Community 264`, `Community 11`, `Community 12`, `Community 139`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 277`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 154`, `Community 26`, `Community 151`, `Community 30`, `Community 34`, `Community 294`, `Community 41`, `Community 42`, `Community 45`, `Community 47`, `Community 49`, `Community 52`, `Community 57`, `Community 698`, `Community 446`, `Community 448`, `Community 65`, `Community 194`, `Community 64`, `Community 71`, `Community 331`, `Community 75`, `Community 207`, `Community 467`, `Community 341`, `Community 218`, `Community 91`, `Community 357`, `Community 105`, `Community 106`, `Community 234`, `Community 751`, `Community 112`, `Community 119`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 18` to `Community 32`, `Community 358`, `Community 7`, `Community 329`, `Community 205`, `Community 46`, `Community 14`, `Community 558`, `Community 83`, `Community 25`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 291` to `Community 1`, `Community 386`, `Community 5`, `Community 8`, `Community 266`, `Community 267`, `Community 11`, `Community 10`, `Community 14`, `Community 656`, `Community 278`, `Community 25`, `Community 27`, `Community 412`, `Community 160`, `Community 42`, `Community 43`, `Community 558`, `Community 175`, `Community 48`, `Community 49`, `Community 176`, `Community 56`, `Community 57`, `Community 442`, `Community 441`, `Community 59`, `Community 189`, `Community 444`, `Community 63`, `Community 195`, `Community 67`, `Community 582`, `Community 327`, `Community 202`, `Community 75`, `Community 204`, `Community 203`, `Community 462`, `Community 79`, `Community 463`, `Community 81`, `Community 337`, `Community 330`, `Community 468`, `Community 470`, `Community 215`, `Community 89`, `Community 94`, `Community 481`, `Community 356`, `Community 101`, `Community 104`, `Community 491`, `Community 492`, `Community 111`, `Community 241`, `Community 123`, `Community 124`, `Community 254`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13286 weakly-connected nodes found - possible documentation gaps or missing edges._
