# Graph Report - panopticon-cli  (2026-05-24)

## Corpus Check
- 2004 files · ~3,565,522 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 31984 nodes · 61992 edges · 1355 communities (1288 shown, 67 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1304 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff0fc89e`
...
- `waitForHandoffDoc()` --calls--> `Access`  [INFERRED]
  src/lib/conversations/summary-fork.ts → docs/god-view.md

## Communities (1355 total, 67 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (271): loadStartCommand(), pauseFlywheel(), buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffError, HandoffMethod (+263 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (245): loadDeaconWithResumeMock(), addLog(), apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+237 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (222): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+214 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.01
Nodes (192): ActivityView(), CloisterStatus, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus() (+184 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (179): applyEnvironmentOverrides(), getHealthThresholdsMs(), loadCloisterConfig(), loadCloisterConfigSync(), shouldAutoStart(), loadConfig(), stopDeacon(), activeViolations (+171 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (209): Agent Enrichment Service, checkPendingTestDispatch(), CI_FAILED_STATUS, ciBlockedStatus, feedbackDir, mockGetAgentRuntimeState, mockLoadReviewStatuses, mockResolveProjectFromIssue (+201 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (201): ActivitySection, Work Agent (shown in inspector terminal), ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent (+193 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (135): CLAUDE_PROJECTS_DIR, ClaudeMessage, getAllSessionFiles(), getProjectDirs(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles() (+127 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.03
Nodes (181): __dirname, __filename, spawnInspectAgent(), spawnInspectAgentPromise(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand() (+173 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (187): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+179 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (160): API_ERROR_PATTERNS, parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus() (+152 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.01
Nodes (162): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+154 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (150): resolvePreferredEditor(), AquaIcon(), CLionIcon(), DataGripIcon(), DataSpellIcon(), EditorIcon, editorIconFor(), GoLandIcon() (+142 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (162): extractAcceptanceCriteria(), getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle() (+154 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.03
Nodes (176): ConversationList(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel(), buildArchivedConversationFilterSql() (+168 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.02
Nodes (164): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash() (+156 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.03
Nodes (148): createCostCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+140 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (136): conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck(), tablist (+128 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.02
Nodes (123): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+115 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (154): readCavemanVariant(), getSpecialistState(), createSpecialistHandoff(), logSpecialistHandoff(), buildSpecialistCavemanExports(), bumpSessionGeneration(), clearSessionId(), countContextTokens() (+146 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.02
Nodes (138): ActivityViewProps, CostByStage, fetchActivity(), RallyStoriesSection(), statusDotColor(), registerAdminCommands(), archiveCustomState(), CleanupOptions (+130 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.03
Nodes (128): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, wipeCommand(), WipeOptions, Command Deck (Core Concept), appendToWal(), appendToWalSync() (+120 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (134): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+126 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.02
Nodes (135): displayIssues(), getConfiguredTrackers(), listCommand(), PRIORITY_LABELS, dedupeRows(), listCommand(), agentDir, dir1 (+127 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.02
Nodes (129): parseDifficultyLabel(), ModelBreakdown, LiveLastHeard(), BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult (+121 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.03
Nodes (126): clearStaleCiFeedback(), reconcileStaleMergeStatus(), reviewerOutputPath(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState() (+118 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (112): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview() (+104 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.02
Nodes (96): BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, TaskItem(), AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel() (+88 more)
...
Cohesion: 0.02
Nodes (101): MODEL_COLORS, isRunningAgent(), fmtCost(), executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry (+93 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (77): mapGitHubStateToCanonical(), cachedIssue, issues, octokitMocks, result, importTrackerConfig(), RallyConfig, clearCacheRoute (+69 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (97): cosineSimilarity(), showAction(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult (+89 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (104): annotated, before, candidate, check, claimed, defaults, doc, { doc: next } (+96 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.03
Nodes (89): config, DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+81 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (78): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+70 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.04
Nodes (104): estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+96 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (87): transitionIssueToVerifyingOnMain(), getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive (+79 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (87): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), button, { container } (+79 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.05
Nodes (79): switchModel(), ZoneActionStrip(), ZoneActionStripProps, MenuDivider(), OverflowItem(), ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+71 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.04
Nodes (76): mockClaudeSkills, contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getLatestVersion() (+68 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.03
Nodes (80): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature() (+72 more)
...
Cohesion: 0.04
Nodes (81): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+73 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.06
Nodes (83): deriveDotStatus(), presenceToStatus(), useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), useAvailableModels(), AggregateActivityState, AggregateBadge (+75 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.04
Nodes (82): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+74 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (82): updateTtsConfig(), defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath() (+74 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.03
Nodes (74): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+66 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.04
Nodes (77): oldTimestamp, payload, makeTestService(), sentinel, eightDaysAgo, events, makeDb(), payload (+69 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.05
Nodes (69): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+61 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.05
Nodes (72): existingSkillDir, existsInTarget, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync, sourcePath (+64 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.05
Nodes (70): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+62 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.03
Nodes (73): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+65 more)
...
Cohesion: 0.05
Nodes (61): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), logSpy, now, output, {
...
Cohesion: 0.06
Nodes (68): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+60 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.04
Nodes (58): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ensureDefaultConversationModel(), getDefaultConversationModel() (+50 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.05
Nodes (61): determineCavemanVariant(), injectCavemanSettings(), syncDnsToWindows(), createWorkspace(), getDefaultWorkspaceConfig(), getDefaultWorkspaceConfigSync(), ProjectConfig, addReposToWorkspace() (+53 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.04
Nodes (73): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+65 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.03
Nodes (61): IssueStats, cost, db, DB_PATH, CLAUDE_PROJECTS, cost, db, DB_PATH (+53 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (59): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+51 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.05
Nodes (59): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), normalize(), unarchiveConversationCommand() (+51 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.04
Nodes (65): fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), fetchSpecialists(), exitGracePeriod(), GraceCountdownProps, GracePeriodState (+57 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (64): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextValidateCommand(), LayerName, renderLayerForHarness() (+56 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.06
Nodes (65): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+57 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.03
Nodes (73): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, FlywheelAgent, FlywheelAgentStatus (+65 more)
...
Cohesion: 0.04
Nodes (64): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+56 more)
...
Cohesion: 0.1
Nodes (70): killTmuxSession(), extractNumber(), extractNumberSync(), normalizeIssueIdSync(), removeWorktree(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl() (+62 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.04
Nodes (58): ContextUsage, ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, VoiceMode (+50 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.09
Nodes (64): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync() (+56 more)
...
Cohesion: 0.04
Nodes (66): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+58 more)

### Community 75 - "Path Constants and Postinstall Setup"
Cohesion: 0.05
Nodes (55): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+47 more)

### Community 76 - "Cost Recovery Scripts and Latency Tests"
Cohesion: 0.06
Nodes (53): content, mockExeca, clearReviewStatus(), archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), execAsync, findAllWorkspacePaths() (+45 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (54): backup, backupCleanCommand(), backupListCommand(), PACKAGE_ROOT, restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync() (+46 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.04
Nodes (56): applyStash(), applyStashPromise(), CanonicalStashKind, createNamedStashPromise(), createRecoveryBranchFromStash(), createRecoveryBranchFromStashPromise(), dropStashPromise(), execAsync (+48 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.04
Nodes (65): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset) (+57 more)
...
Cohesion: 0.04
Nodes (57): agentDir, missing, result, snapshot, status, missing, filterClosedIssueAgents(), discoverNewAgentIds() (+49 more)
...
Cohesion: 0.05
Nodes (53): output, mockGetAgentHealth, computeStuckCount(), map, mockGetAgentHealth, mockGetCloisterService, mockGetStatus, mockListRunningAgents (+45 more)
...
Cohesion: 0.04
Nodes (45): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, ComplexityModels, DashScopeModel (+37 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.05
Nodes (50): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+42 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.05
Nodes (51): autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions (+43 more)

### Community 88 - "Work Agent Prompt and Reopen Flow"
Cohesion: 0.07
Nodes (53): ensureDashboardBundle(), devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep() (+45 more)

### Community 89 - "Frontend Dashboard Component Tests"
Cohesion: 0.04
Nodes (56): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+48 more)
...
Cohesion: 0.06
Nodes (46): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, ProjectsConfig (+38 more)
...
Cohesion: 0.06
Nodes (48): systemHealthCommand(), delay(), data, mockExistsSync, mockReadFile, mockUnlink, runner, computeRestartDelay() (+40 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.07
Nodes (51): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+43 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.08
Nodes (59): addCommentBefore(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), callVisitor(), clone(), createNode() (+51 more)

### Community 97 - "Conversation Panel and Chat Phase Types"
Cohesion: 0.04
Nodes (50): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, getCloisterAgentsHealthRoute (+42 more)
...
Cohesion: 0.05
Nodes (53): TtsDaemonStartResult, TtsDaemonStatus, HeaderMap, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice() (+45 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.08
Nodes (57): filterPayload(), add, addIn(), anchorNames(), applyReviver(), array, asItemIndex(), assertCollection() (+49 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.08
Nodes (51): planCommand(), PlanOptions, runDiscoveryPhase(), deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect() (+43 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.08
Nodes (47): detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), shellQuote(), verifyMergedBeforeLifecycle(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue() (+39 more)

### Community 103 - "Claude OAuth Authentication and Settings"
Cohesion: 0.05
Nodes (47): runMemoryFtsStatement(), runMemoryFtsTransaction(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate (+39 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.04
Nodes (43): mockGetRuntimeForAgent, exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+35 more)

### Community 105 - "Issue Tracker Linking Tests"
Cohesion: 0.07
Nodes (48): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, ForkProgressView() (+40 more)

### Community 106 - "Release and Update CLI Commands"
Cohesion: 0.06
Nodes (51): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions, execAsync (+43 more)
...
Cohesion: 0.06
Nodes (51): CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage(), ContentBlock, ConversationActivitySummary, ConversationWatchHandle (+43 more)
...
Cohesion: 0.04
Nodes (42): program, first, kCustom, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild (+34 more)

### Community 112 - "TLDR Daemon State Management"
Cohesion: 0.08
Nodes (44): appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs(), cleanupAllLogsSync(), cleanupOldLogs(), cleanupOldLogsSync(), createRunLog() (+36 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.07
Nodes (49): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), adminRouteLayer, cloisterRouteLayer (+41 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.08
Nodes (42): getCavemanExperimentData(), httpHandler(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+34 more)
...
Cohesion: 0.05
Nodes (40): TLDR Daemon - Background Index Manager, captureTldrMetrics(), captureTldrMetricsSync(), daemonRegistry, ensureTldrStateDir(), getStateFilePath(), getTldrMetrics(), getTldrMetricsSync() (+32 more)
...
Cohesion: 0.07
Nodes (42): migrateConfigCommand(), MigrateConfigOptions, needsMigration(), BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), cleanupLegacyRuntimeSymlinksSync(), convertToYamlConfig(), convertToYamlConfigSync() (+34 more)
...
Cohesion: 0.07
Nodes (39): isShadowWorkspace(), execAsync, gatherArtifacts(), gatherArtifactsPromise(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, liftMonitoringError() (+31 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.04
Nodes (15): client, FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+7 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.06
Nodes (47): SkillsList(), PendingOperation, Activity, AgentChannelReply, AgentId, AgentPhase, AgentResolution, AgentStatus (+39 more)
...
Cohesion: 0.07
Nodes (45): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), fetchActivityREST(), fetchDetailedActivityREST() (+37 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.04
Nodes (40): containerRestartBackoffMs(), DEACON_DIR, DeaconConfig, DeaconState, getDeaconStatus(), isDeaconRunning(), config, config1 (+32 more)

### Community 126 - "Electron Desktop App Launch Scripts"
Cohesion: 0.07
Nodes (48): AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, Verification Gate (PAN-174), Beads prerequisite for work agent start (422 without), Review cycle circuit breaker (max 3 auto-requeue), Context digest (cross-dispatch memory for test/merge agents), Convoy - Parallel Review Panel, Deacon health monitor (30s patrol, stuck detection) (+40 more)

### Community 127 - "Specialist Run Log Lifecycle"
Cohesion: 0.07
Nodes (36): applyFallback(), applyFallbackSync(), applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels() (+28 more)

### Community 128 - "Remote Agent Provisioning on Fly"
Cohesion: 0.08
Nodes (46): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+38 more)
...
Cohesion: 0.07
Nodes (40): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps (+32 more)
...
Cohesion: 0.08
Nodes (40): appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), getEventsFile(), getEventsFilePath() (+32 more)

### Community 141 - "Dashboard Screenshots and Brand Assets"
Cohesion: 0.11
Nodes (34): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync(), collectMail() (+26 more)
...
Cohesion: 0.13
Nodes (14): buildClaudeUserSettings(), createFlyApiClient(), createFlyApiClientSync(), effFromPromise(), execAsync, FlyProvider, FlyProviderConfig, mapFlyStateToVmStatus() (+6 more)
...
Cohesion: 0.1
Nodes (37): buildFileDiffRenderKey(), clearDiffParamsFromUrl(), DiffFilePickerList(), DiffPanel(), DiffPanelProps, DiffThemeType, formatShortTimestamp(), getRenderablePatch() (+29 more)
...
Cohesion: 0.07
Nodes (37): detectTestCommand(), detectTestCommandEffect(), detectTestCommandSync(), fileExists(), command, jestConfig, packageJson, testDir (+29 more)
...
Cohesion: 0.07
Nodes (39): ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getSpecialistHandoffStatsPromise(), getTodaySpecialistHandoffs(), readIssueSpecialistHandoffs(), readSpecialistHandoffs() (+31 more)

### Community 163 - "Agent Card Model Defaults Display"
Cohesion: 0.09
Nodes (37): runPreflight(), runStreaming(), getVBriefACStatus(), getVBriefACStatusSync(), readBeadTitleFromJsonl(), syncBeadStatusToVBrief(), syncBeadStatusToVBriefPromise(), beads (+29 more)
...
Cohesion: 0.07
Nodes (37): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), formatDuration(), formatTokens() (+29 more)
...
Cohesion: 0.06
Nodes (36): entry, { issueId }, { limit }, old, op, ops, recent, result (+28 more)
...
Cohesion: 0.06
Nodes (32): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, backfillDiscoveredSessionArrayIndexes() (+24 more)

### Community 171 - "Model Routing and Specialist Redesign Research"
Cohesion: 0.07
Nodes (36): GLOBAL_CONFIG_PATH, detectPlatform(), Platform, evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb() (+28 more)

### Community 172 - "Panopticon Introduction and Pipeline Overview"
Cohesion: 0.07
Nodes (40): getMemoryStatus(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated (+32 more)
...
Cohesion: 0.08
Nodes (40): getFlywheelRunPayload(), getFlywheelRunsPayload(), openFlywheelRunReportForDashboard(), resolveReportOpenRunId(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata() (+32 more)
...
Cohesion: 0.09
Nodes (31): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), getDefaultConfig() (+23 more)
...
Cohesion: 0.05
Nodes (38): cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush, mockMarkWorkspaceStuck, result, cb (+30 more)

### Community 183 - "Review Workflow Command Coordination"
Cohesion: 0.07
Nodes (34): LinearState, ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue (+26 more)
...
Cohesion: 0.11
Nodes (31): isAgentIdleForNudge(), checkStuckAgentRemediation(), evaluateAgent(), evaluateFlywheelOrchestrator(), execFileAsync, firstStuckAt(), hasReadyBeads(), issueIdForAgent() (+23 more)
...
Cohesion: 0.08
Nodes (31): ApiForkMode, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), useConversationMutations() (+23 more)

### Community 202 - "Merge Queue Display and Relative Time Tests"
Cohesion: 0.09
Nodes (35): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, getWorkspaceStackHealth, health, now (+27 more)

### Community 203 - "Desktop App Bridge and Notifications"
Cohesion: 0.12
Nodes (29): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, buildHostOverrideConfirmation(), confirmHostOverride(), swarmCommand() (+21 more)
...
Cohesion: 0.08
Nodes (33): eventsFileExists(), getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+25 more)
...
Cohesion: 0.06
Nodes (26): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession() (+18 more)
...
Cohesion: 0.08
Nodes (32): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+24 more)

### Community 222 - "Caveman File Type Detection CLI"
Cohesion: 0.11
Nodes (33): basenameOfPath(), canonicalizeWindowsDrivePath(), formatWorkspaceRelativePath(), normalizePathSeparators(), splitPathAndPosition(), stripRelativePrefixes(), trimTrailingPathSeparators(), appendLineColumnFromHash() (+25 more)

### Community 223 - "Agent Enrichment and Context Resolution"
Cohesion: 0.07
Nodes (33): registerFlywheelCommands(), postFlywheelPausePayload(), postFlywheelResumePayload(), postFlywheelStartPayload(), subscribeLatestFlywheelStatus(), abort, aborted, briefPath (+25 more)
...
Cohesion: 0.08
Nodes (33): CliproxyCodexCredentials, getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError (+25 more)
...
Cohesion: 0.1
Nodes (30): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), projectShowCommand(), addRepoCommand(), loadRepoGroups() (+22 more)
...
Cohesion: 0.1
Nodes (31): CategoryFilter, onToggle, CategoryFilter, formatContextLength(), formatCost(), ModelCard(), OpenRouterModel, OpenRouterModelBrowser() (+23 more)
...
Cohesion: 0.06
Nodes (30): result, result, dir, event, eventsDir1, eventsDir2, line, lines (+22 more)
...
Cohesion: 0.06
Nodes (25): getActiveSessionModelSync(), claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+17 more)

### Community 275 - "Agent Show Command Tests"
Cohesion: 0.11
Nodes (29): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), setPipelineHandler(), setPipelineHandlerSync(), enrichReviewStatus(), stopTranscriptPoller(), startCliproxyWatchdog() (+21 more)
...
Cohesion: 0.12
Nodes (27): constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+19 more)
...
Cohesion: 0.09
Nodes (32): canUseHarness() Policy Gate, Cloister Lifecycle Orchestrator, CommentMediator Service, @panopticon/contracts Package, Deacon Patrol Daemon, discovered_sessions Table, Effect.js Runtime, HarnessPicker Component (+24 more)
...
Cohesion: 0.1
Nodes (21): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, isTrustedWebSocketOrigin() (+13 more)

### Community 289 - "Specialist Completion Tracking"
Cohesion: 0.13
Nodes (26): updated, buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, broadcastToRenderers(), checkForUpdates() (+18 more)

### Community 290 - "External SSE Event Stream and God View"
Cohesion: 0.1
Nodes (25): SETTINGS_FILE, available, content, defaults, defaults1, defaults2, invalidSettings, settings (+17 more)
...
Cohesion: 0.13
Nodes (27): drainPendingEvents(), envFor(), getDashboardUrl(), handlePanDone(), handleSessionStart(), handleToolExecutionEnd(), handleTurnEnd(), HookEnv (+19 more)

### Community 306 - "God View Real-Time Agent Dashboard"
Cohesion: 0.13
Nodes (10): LRUCache, constructor(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+2 more)
...
Cohesion: 0.07
Nodes (26): body, bytes, claudeProjectDir, db, decodeJsonResponse(), deliverMock, docPath, encodedCwd (+18 more)

### Community 310 - "Skills CLI Command Listing"
Cohesion: 0.13
Nodes (25): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+17 more)

### Community 311 - "Heartbeat Event Ingestion Tests"
Cohesion: 0.1
Nodes (22): ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchRow, normalizeLimit(), normalizeSiblingTokenBudget() (+14 more)

### Community 312 - "GitHub App Registration and Webhook Setup"
Cohesion: 0.08
Nodes (18): NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, CONFIG (+10 more)

### Community 313 - "Python Subagent File Initialization"
Cohesion: 0.11
Nodes (24): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+16 more)
...
Cohesion: 0.09
Nodes (30): Agent Environment Variables (PANOPTICON_AGENT_ID, PANOPTICON_ISSUE_ID, etc.), Bug: Agent ID Fallback uses TMUX_PANE, Bug: Cache Line Tracking (aggregator.ts:124), Bug: Race Condition Concurrent Writes (events.ts), Critical Bugs Found (PAN-81 Implementation), conversation-service.ts (JSONL parser, server), SQLite cost_events Table, Heartbeat Hook (heartbeat-hook bash script) (+22 more)
...
Cohesion: 0.13
Nodes (20): RoundMarker, RoundVerdict, ZoneCConversation(), ZoneCConversationProps, deriveRoundMarkers(), TimestampedItem, deriveRoundData(), getViewKey() (+12 more)
...
Cohesion: 0.15
Nodes (26): HandoffContext, createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync() (+18 more)
...
Cohesion: 0.1
Nodes (17): WorkspaceService, MOCK_PROJECT, mockCreateWorkspace, mockExistsSync, mockLoadProjectsConfig, mockRemoveWorkspace, mockResolveProjectFromIssue, mockStopWorkspaceDocker (+9 more)
...
Cohesion: 0.13
Nodes (21): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsNotFoundError (+13 more)
...
Cohesion: 0.13
Nodes (20): configShadowCommand(), INFERENCE.md Artifact, getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise(), hasProjectShadowConfig(), isShadowModeEnabled() (+12 more)
...
Cohesion: 0.1
Nodes (25): checkLazyAgent() (17-pattern lazy detection), Claude Code Channels (Experimental), confirmDelivery() (tmux delivery verification), flywheel-change Issue Label, Flywheel Daemon (autonomous self-improvement loop), FLYWHEEL-REPORT.md (living self-improvement changelog), Heartbeat Hook (PostToolUse), PAN-709 Self-Improving Flywheel PRD (+17 more)
...
Cohesion: 0.14
Nodes (22): details, startRealConversationRoutes(), validateAgentDeliveryMethodOrigin(), validateOrigin(), addTrustedOrigin(), getHeader(), getTrustedOrigins(), isTrustedOriginForHost() (+14 more)

### Community 381 - "Harness Integration Tests"
Cohesion: 0.18
Nodes (18): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getCloisterService() (+10 more)
...
Cohesion: 0.11
Nodes (22): parseLogMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), allLogs, logPath (+14 more)
...
Cohesion: 0.17
Nodes (18): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, getSupervisorPort(), getSupervisorPortSync(), getSupervisorUrl(), getSupervisorUrlSync(), isProcessAlive() (+10 more)
...
Cohesion: 0.19
Nodes (18): acquireRestartLock(), acquireRestartLockPromise(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolderPromise() (+10 more)

### Community 434 - "Community 434"
Cohesion: 0.13
Nodes (19): electron, electron, IPC, result, execAsync, sendNotification(), callServerApi(), IPC (+11 more)
...
Cohesion: 0.1
Nodes (19): DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType, bridge, DesktopSettings, IPC (+11 more)
...
Cohesion: 0.1
Nodes (16): CLI_PATH, __dirname, { stdout }, { stdout, status }, { stdout, stderr }, actual, CLI_PATH, __dirname (+8 more)
...
Cohesion: 0.15
Nodes (16): ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent(), optionalString(), speakActivityTts() (+8 more)
...
Cohesion: 0.12
Nodes (19): Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider, OpenAI Provider (Codex/GPT) (+11 more)
...
Cohesion: 0.17
Nodes (17): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+9 more)
...
Cohesion: 0.14
Nodes (17): listener(), wrapped(), DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings(), loadVoiceSettings(), normalizeVoiceSettings(), notifyVoiceSettings() (+9 more)
...
Cohesion: 0.22
Nodes (18): spawnFlywheel(), clearFlywheelRunGate(), readFlywheelGateSnapshot(), DatabaseError, getFlywheelActiveRunId(), getSettingEffect(), getSettingProgram(), isDeaconGloballyPaused() (+10 more)
...
Cohesion: 0.14
Nodes (15): FeedTabContent(), SessionFeedTab, useConversationFeed(), useGitFeed(), filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), useMergedFeed(), UseMergedFeedResult (+7 more)
...
Cohesion: 0.18
Nodes (15): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), execAsync, execFileAsync, getBeadDescription(), InspectContext, InspectResult (+7 more)
...
Cohesion: 0.13
Nodes (13): AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode, AutoPresoSnapshot, createWhiteboardSession(), ProcessTranscriptResult, QueuedTranscript, WarmupStatus (+5 more)

### Community 566 - "Community 566"
Cohesion: 0.17
Nodes (11): calls, mockExec, calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions (+3 more)
...
Cohesion: 0.27
Nodes (13): buildStatus(), decodeBase64Url(), decodeJwtPayload(), getCodexAuthPath(), getJwtExpiry(), getOpenAIAuthStatus(), getOpenAIAuthStatusPromise(), getOpenAIAuthStatusSync() (+5 more)
...
Cohesion: 0.14
Nodes (10): dispatchMenuAction(), dispatchMenuAction(), baseFlywheelStatus, consoleErrors, flywheelStatus, metrics, MockWebSocket, status (+2 more)
...
Cohesion: 0.14
Nodes (14): 10. Tracked Issues, 11. Implementation Scope, 3. Real-World Conflict: Mind Your Now, 4. Enterprise / Managed Policy, 5. Path Portability (Completed), 7. Rules: Planned Content, 9. Decisions Log, code:block7 (pan workspace create MIN-678) (+6 more)
...
Cohesion: 0.28
Nodes (11): YamlConfig, cloneTtsConfig(), currentConfig, findProjectRootAsync(), pathExists(), readProjectConfig(), readYamlConfig(), refreshTtsRuntimeConfig() (+3 more)
...
Cohesion: 0.15
Nodes (12): Authoring model: one source, N harnesses, Bundled rules, code:markdown (All agents follow the engineering philosophy: fix root cause), code:block2 (<!-- BEGIN PANOPTICON CONTEXT — managed by `pan sync`; edit ), code:block3 (pan context list                  # show all three layers an), code:block4 (sync-sources/), Layered Context Distribution, Migrating off `sync.devroot` (+4 more)
...
Cohesion: 0.17
Nodes (11): backup, backup1, backup2, backupDir, backups, removed, skillsBackup, sourceDir (+3 more)
...
Cohesion: 0.18
Nodes (7): mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, mockSpawnRun, notify, promise, promise

### Community 736 - "Community 736"
Cohesion: 0.22
Nodes (10): createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, createTerminalWindow(), createWindow(), resolveWindowUrl() (+2 more)
...
Cohesion: 0.33
Nodes (7): resolveServerEntry(), randomHex(), resolvePort(), spawnServer(), startServer(), stopServer(), waitForServer()
...
Cohesion: 0.22
Nodes (8): consoleError, mocks, onNavigateAgent, onNavigateIssue, stateTab, status, statusTab, { unmount }

### Community 837 - "Community 837"
Cohesion: 0.31
Nodes (8): fetchCurrentFlywheelStatus(), FlywheelLeftTab, FlywheelPage(), FlywheelPageProps, formatElapsed(), formatFreshnessAge(), getLastTickFreshness(), getStoredSplitWidth()
...
Cohesion: 0.29
Nodes (6): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNames, mockListSessionNamesAsync, mockMarkConversationEnded, mockListSessionNamesAsync
...
Cohesion: 0.5
Nodes (4): ~/.panopticon/agents/ State Directory, Agent Directory Structure, Planning Agent Directory Naming (planning-<issueId>), Work Agent Directory Naming (agent-<issueId>)
...
## Knowledge Gaps
- **13677 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+13672 more)
...
- **Why does `string()` connect `Merge Agent Post-Merge Lifecycle` to `Agent Session Lifecycle Management`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Health Metrics and Settings Pages`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Git Activity and Runtime Metrics`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `Community 537`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `Project Tree Feature Items UI`, `Review Round Status Badge UI`, `Conversation Service WebSocket RPC`, `Cost Event Aggregation and Retention`, `Chat Composer Model Picker`, `Cloister Config Deep Merge`, `Workspace and Version API Routes`, `Platform Supervisor Startup Lifecycle`, `Multi-Tool Sync and MCP Isolation`, `Permission Request Bridge and Forwarding`, `Server Cache Service and Chat Markdown`, `GitHub Webhook Ingestion Handlers`, `Workspace Teardown and Label Cleanup`, `Swarm Dispatch and DAG Execution`, `Settings Persistence and Model Defaults`, `Multi-Tracker Runtime Adapter Interface`, `Merge Queue and App Settings Database`, `Read Model Enrichment and Agent Snapshots`, `Skills Merge and Manifest Sync`, `Specialist Commands and VBrief Index`, `Model Routing and Complexity Detection`, `Cloister Orchestrator Architecture PRDs`, `CLI Command Taxonomy Reorganization`, `Work Agent Prompt and Reopen Flow`, `Traefik DNS and Platform Install Skills`, `Rally Tracker Adapter Tests`, `Issue ID Parsing and Agent Cleanup`, `Project Config and Team Prefix Resolution`, `Cost Data Migration and Reconciliation`, `Community 616`, `Release and Update CLI Commands`, `Config Migration and Test Agent`, `TLDR Daemon State Management`, `Specialist Agent Prompts and Audit Docs`, `vBRIEF Continue State and Feedback Writing`, `Caveman Hooks and Workspace Setup`, `FPP Policy Violation Detection and Nudging`, `Remote Agent Provisioning on Fly`, `GitHub App Merge and PR Integration`, `Community 658`, `Agent Card Model Defaults Display`, `CLI Command Taxonomy Reorganization PRD`, `Panopticon Introduction and Pipeline Overview`, `Cloister Prompt Loading and Parsing`, `Community 692`, `Review Workflow Command Coordination`, `Community 696`, `Workspace Manager Artifact Migration`, `Merge Queue Display and Relative Time Tests`, `Desktop App Bridge and Notifications`, `Desktop Build and Monorepo Release Tests`, `Cloister Watchdog and Merge Validation Docs`, `Skill Creator Init and Package Scripts`, `System Health Command and CLI Tests`, `Panopticon 1.0 Stabilization Audit`, `Command Deck Overview Playwright Snapshots`, `Model Routing Changelog and Configuration`, `Command Deck Redesign Zone Layout`, `Implementation Gaps Audit and Metrics PRD`, `Agent Enrichment and Phase Detection`, `Skills CLI Command Listing`, `GitHub App Registration and Webhook Setup`, `Community 831`, `Harness Integration Tests`, `Command Deck Sidebar Width Fix`, `CLAUDE MD Commands Skills Template`, `Community 429`, `Community 431`, `Community 433`, `Community 434`, `Community 472`, `Community 473`, `Community 490`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Kanban Board Agent Status UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `GitHub App Merge and PR Integration`, `Dashboard Screenshots and Brand Assets`, `Agent Show Command Tests`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Dashboard Store and Command Palette`, `Community 539`, `CLI Commands and Runtime Adapters`, `Review Round Status Badge UI`, `Command Deck Issue Workbench UI`, `Dashboard Design Docs and Mockups`, `CLI Install DNS and Dev Commands`, `Work Type Routing and Config`, `Specialist Workflow Documentation and Gates`, `Agent Status RPC Contracts`, `Model Selection and Subscription Policy`, `Agent Benchmark Framework and Results`, `Platform Supervisor Startup Lifecycle`, `Settings Provider and Model Browser UI`, `Fly Remote Provider and API Client`, `Settings Page Model Override and Auth`, `Permission Request Bridge and Forwarding`, `Issue Lifecycle Service and Tests`, `Diff Panel Rendering and Theming`, `GitHub Webhook Ingestion Handlers`, `Settings Persistence and Model Defaults`, `Project Repository Resolution`, `Activity Panel and VTT Parsing`, `Effect API Verification Script`, `Beads Issue Tracking Skill Docs`, `Work Done and Rebase Pipeline Tests`, `Issue Tracker Linking Tests`, `Cloister Pipeline Unit Tests`, `Specialist Pipeline PRDs and Skills`, `vBRIEF Continue State and Feedback Writing`, `FPP Policy Violation Detection and Nudging`, `Dashboard Terminal UI Components`, `Cost Event Recording Types`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Database Schema and Review Status` to `Resource-Allocated Issue Discovery`, `Cost Tracking Dashboard Visualization`, `Electron Desktop App Launch Scripts`, `Issue Lifecycle Service and Tests`, `Workspace Reopen and State Reset`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Are the 277 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 277 INFERRED edges - model-reasoned connections that need verification._
- **Are the 240 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 240 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13677 weakly-connected nodes found - possible documentation gaps or missing edges._
