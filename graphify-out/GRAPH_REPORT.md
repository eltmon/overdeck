...
## Corpus Check
- 1556 files · ~2,063,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21693 nodes · 32143 edges · 1141 communities (1106 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 429 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `760e8e5e`
...
## Communities (1141 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (160): clearStaleCiFeedback(), getTrackerContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable() (+152 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (148): killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), getRuntimeSnapshotSync() (+140 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (131): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+123 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (150): readCavemanVariant(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName() (+142 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (124): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+116 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (112): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+104 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (130): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+122 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (105): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (110): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (83): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+75 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (102): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+94 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (89): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (90): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+82 more)
...
Cohesion: 0.03
Nodes (91): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+83 more)
...
Cohesion: 0.03
Nodes (91): reconcileAndCheckIfMerged(), reconcileFalseMerged(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult (+83 more)
...
Cohesion: 0.03
Nodes (59): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+51 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (73): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), findSpecByIssue() (+65 more)
...
Cohesion: 0.05
Nodes (71): spawnReviewCoordinatorSession(), spawnSingleReviewer(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, getAgentRuntimeBaseCommand(), getProviderExportsForModel(), panopticonAgentName(), getClaudePermissionFlags(), getClaudePermissionFlagsString() (+63 more)
...
Cohesion: 0.03
Nodes (70): resetDb(), db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+62 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (68): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+60 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (60): agentDir, envArg, options, state, stateFile, workspace, NormalizedConfig, generateRouterConfigFromWorkTypes() (+52 more)
...
Cohesion: 0.05
Nodes (49): after, doc, filename, path, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefDocument (+41 more)
...
Cohesion: 0.05
Nodes (59): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind (+51 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (54): cleanupAbandonedFeedback(), clearFeedbackFiles(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+46 more)
...
Cohesion: 0.07
Nodes (38): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry (+30 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (54): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials (+46 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (50): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+42 more)
...
Cohesion: 0.07
Nodes (37): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, buildACLookupByTitle(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization() (+29 more)
...
Cohesion: 0.05
Nodes (44): Access, withConcurrencyLimit(), result, getIndexStats(), ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds() (+36 more)
...
Cohesion: 0.06
Nodes (48): getCostsForIssue(), syncCache(), getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+40 more)
...
Cohesion: 0.05
Nodes (40): setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData (+32 more)
...
Cohesion: 0.08
Nodes (40): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+32 more)
...
Cohesion: 0.08
Nodes (19): importTrackerConfig(), computePlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache, PlanningStateCacheEntry, POLL_INTERVALS (+11 more)
...
Cohesion: 0.07
Nodes (38): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+30 more)
...
Cohesion: 0.07
Nodes (33): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+25 more)
...
Cohesion: 0.09
Nodes (35): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+27 more)
...
Cohesion: 0.08
Nodes (26): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping() (+18 more)
...
Cohesion: 0.07
Nodes (35): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName(), parseAllSessions() (+27 more)
...
Cohesion: 0.1
Nodes (33): archivePlanning(), closeIssue(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), TeardownOptions (+25 more)

### Community 141 - "Community 141"
Cohesion: 0.1
Nodes (28): useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel() (+20 more)
...
Cohesion: 0.08
Nodes (30): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+22 more)
...
Cohesion: 0.09
Nodes (27): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+19 more)
...
Cohesion: 0.1
Nodes (26): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, writeWorkspaceContext(), ensureWorkspacePanDir() (+18 more)
...
Cohesion: 0.12
Nodes (26): getHealthEmoji(), getHealthLabel(), getCloisterService(), startCommand(), statusCommand(), StatusOptions, stopCommand(), StopOptions (+18 more)
...
Cohesion: 0.1
Nodes (21): loadCloisterConfig(), cleanupStaleAgentState(), checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync (+13 more)

### Community 223 - "Community 223"
Cohesion: 0.12
Nodes (20): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+12 more)
...
Cohesion: 0.15
Nodes (25): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments(), extractConversationAttachmentPaths(), getAttachmentCache(), getAttachmentCacheKey() (+17 more)
...
Cohesion: 0.14
Nodes (23): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), IssueStats (+15 more)
...
Cohesion: 0.29
Nodes (21): getContainersReferencingWorkspacePath(), stopWorkspaceDocker(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync (+13 more)
...
Cohesion: 0.17
Nodes (20): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions, closeLinearDirect() (+12 more)
...
Cohesion: 0.14
Nodes (11): complexityToModel(), getDefaultModel(), getGlobalRouter(), getSpecialistHarness(), getSpecialistModel(), ModelRouter, ModelRoutingResult, resetGlobalRouter() (+3 more)
...
Cohesion: 0.11
Nodes (19): getRunLog(), isRunLogActive(), content, deleted, { filePath }, largeContent, metadata, oldDate (+11 more)
...
Cohesion: 0.2
Nodes (18): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+10 more)
...
Cohesion: 0.16
Nodes (15): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), SessionRotationResult (+7 more)
...
Cohesion: 0.24
Nodes (3): getProjectDirs(), parseClaudeSession(), ClaudeCodeRuntime
...
Cohesion: 0.18
Nodes (11): ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, RuntimeName, AUTH_MODES, cells, decision (+3 more)
...
Cohesion: 0.33
Nodes (6): StepResult, DevcontainerRenderResult, ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult, pathLeaf()
...
## Knowledge Gaps
- **11557 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11552 more)
...
- **Why does `fetch` connect `Community 4` to `Community 641`, `Community 260`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 527`, `Community 16`, `Community 17`, `Community 18`, `Community 15`, `Community 22`, `Community 151`, `Community 411`, `Community 28`, `Community 31`, `Community 159`, `Community 33`, `Community 41`, `Community 554`, `Community 171`, `Community 43`, `Community 49`, `Community 54`, `Community 55`, `Community 56`, `Community 61`, `Community 191`, `Community 71`, `Community 73`, `Community 595`, `Community 98`, `Community 748`, `Community 125`, `Community 636`, `Community 637`, `Community 126`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 439` to `Community 1`, `Community 339`, `Community 14`, `Community 183`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 15` to `Community 1025`, `Community 191`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11557 weakly-connected nodes found - possible documentation gaps or missing edges._
