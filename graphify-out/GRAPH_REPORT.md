...
## Corpus Check
- 1878 files · ~2,476,563 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26658 nodes · 41387 edges · 1254 communities (1204 shown, 50 thin omitted)
...
## Communities (1254 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (168): performKillAndSpawn(), spawnInspectAgent(), renderPrompt(), buildSpecialistBaseCommand(), pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (152): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+144 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (143): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, useZoneAActions(), ZoneAActionsState (+135 more)
...
Cohesion: 0.02
Nodes (125): loadCloisterConfig(), cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus() (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (114): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (125): TurnDiffFileChange, forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary() (+117 more)
...
Cohesion: 0.03
Nodes (123): embedAction(), confirmCost(), enrichAction(), formatCost(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode() (+115 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (110): checkMissingReviewStatuses(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+102 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (98): BulkAgentWarningDialogProps, CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, PaletteAction, { onNavigate }, user (+90 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (102): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+94 more)
...
Cohesion: 0.02
Nodes (97): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AgentWarningDialogProps (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (102): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), cloisterRouteLayer, getCloisterAgentsHealthRoute (+94 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (94): monitorReviewConvoySignals(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow (+86 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (81): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+70 more)
...
Cohesion: 0.03
Nodes (70): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+62 more)
...
Cohesion: 0.03
Nodes (87): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+79 more)
...
Cohesion: 0.04
Nodes (77): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), addRepoCommand(), AddRepoOptions (+69 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (76): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+68 more)
...
Cohesion: 0.03
Nodes (76): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+68 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (81): ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, WorkhorsesConfig, WorkhorseSlot, MODEL_DEPRECATIONS, deprecatedIds (+73 more)
...
Cohesion: 0.03
Nodes (73): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+65 more)
...
Cohesion: 0.04
Nodes (63): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ChatMarkdown, ConversationPanel() (+55 more)
...
Cohesion: 0.03
Nodes (55): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+47 more)
...
Cohesion: 0.04
Nodes (65): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+57 more)
...
Cohesion: 0.04
Nodes (55): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+47 more)
...
Cohesion: 0.05
Nodes (51): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+43 more)
...
Cohesion: 0.06
Nodes (28): issues, result, importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService (+20 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (53): SensitiveText(), SensitiveTextProps, DEFAULTS, UIPreferences, useUIPreferences(), Capability, ModelDef, MODELS_BY_PROVIDER (+45 more)
...
Cohesion: 0.04
Nodes (45): createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads, expectedPrefix (+37 more)
...
Cohesion: 0.04
Nodes (43): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+35 more)
...
Cohesion: 0.04
Nodes (50): buildEmbeddingText(), embed(), EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage() (+42 more)
...
Cohesion: 0.06
Nodes (31): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getUnsyncedHistory() (+23 more)

### Community 91 - "Community 91"
Cohesion: 0.07
Nodes (49): flywheelAbortCommand(), flywheelReportOpenCommand(), loadReportFlywheelStatus(), openFlywheelRunReport(), resolveReportOpenRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), openFlywheelRunReportForDashboard() (+41 more)
...
Cohesion: 0.07
Nodes (46): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions, execAsync (+38 more)
...
Cohesion: 0.06
Nodes (38): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+30 more)
...
Cohesion: 0.06
Nodes (36): showCommand(), runtime, state, next, path, read, state, activeContinueWriters (+28 more)
...
Cohesion: 0.07
Nodes (42): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPath(), getPRDDraftPathEffect(), hasPRDDraft(), hasPRDDraftEffect() (+34 more)
...
Cohesion: 0.07
Nodes (31): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, detectDriveType (+23 more)

### Community 142 - "Community 142"
Cohesion: 0.05
Nodes (40): decode, decodeCandidate(), ev, bodyToEvent(), decodeDomainEvent, Activity, AgentChannelReply, AgentId (+32 more)
...
Cohesion: 0.07
Nodes (21): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), parseClaudeSession() (+13 more)

### Community 229 - "Community 229"
Cohesion: 0.09
Nodes (21): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile(), getEventsFilePath() (+13 more)
...
Cohesion: 0.16
Nodes (30): movePrdImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+22 more)
...
Cohesion: 0.14
Nodes (29): saveResumeSessionId(), runDashboardDbJob(), WorkerLane, abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync (+21 more)
...
Cohesion: 0.11
Nodes (4): getProjectDirs(), getSessionFiles(), ClaudeCodeRuntime, ClaudeCodeRuntimeEffect
...
Cohesion: 0.12
Nodes (14): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+6 more)
...
Cohesion: 0.12
Nodes (20): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+12 more)
...
Cohesion: 0.11
Nodes (14): fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps, ROLE_META, getViewKey(), PanelView, readView() (+6 more)
...
Cohesion: 0.13
Nodes (20): markAgentStopped(), markAgentStoppedState(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+12 more)
...
Cohesion: 0.27
Nodes (7): ConversationRow(), ConversationRowProps, PHASE_ICONS, useNow(), initial, { result }, { result, unmount }
...
Cohesion: 0.4
Nodes (4): defaults, first, { models }, second
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 11`, `Community 140`, `Community 12`, `Community 14`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 276`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 152`, `Community 26`, `Community 157`, `Community 30`, `Community 44`, `Community 52`, `Community 53`, `Community 54`, `Community 187`, `Community 60`, `Community 63`, `Community 192`, `Community 66`, `Community 323`, `Community 324`, `Community 67`, `Community 197`, `Community 456`, `Community 205`, `Community 722`, `Community 725`, `Community 218`, `Community 92`, `Community 349`, `Community 350`, `Community 99`, `Community 231`, `Community 616`, `Community 497`, `Community 116`, `Community 248`, `Community 377`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 25` to `Community 97`, `Community 34`, `Community 66`, `Community 69`, `Community 38`, `Community 7`, `Community 425`, `Community 114`, `Community 19`, `Community 51`, `Community 150`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 287` to `Community 0`, `Community 128`, `Community 3`, `Community 262`, `Community 263`, `Community 6`, `Community 267`, `Community 140`, `Community 141`, `Community 17`, `Community 274`, `Community 403`, `Community 19`, `Community 406`, `Community 23`, `Community 29`, `Community 158`, `Community 30`, `Community 32`, `Community 33`, `Community 35`, `Community 168`, `Community 424`, `Community 48`, `Community 49`, `Community 53`, `Community 441`, `Community 187`, `Community 62`, `Community 193`, `Community 195`, `Community 68`, `Community 453`, `Community 455`, `Community 329`, `Community 202`, `Community 74`, `Community 76`, `Community 333`, `Community 204`, `Community 458`, `Community 470`, `Community 215`, `Community 90`, `Community 92`, `Community 348`, `Community 478`, `Community 98`, `Community 611`, `Community 228`, `Community 229`, `Community 238`, `Community 113`, `Community 114`, `Community 115`, `Community 374`, `Community 120`, `Community 249`, `Community 125`, `Community 639`?**
