...
## Corpus Check
- 1745 files · ~2,327,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23916 nodes · 36684 edges · 1212 communities (1162 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c852f3d`
...
## Communities (1212 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (192): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+184 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (170): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+162 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (109): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+101 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (112): cleanupStaleAgentState(), containerRestartBackoffMs(), DeaconState, captureTmuxOutput(), isMergeAgentRunning(), customPromisify, justNow, longAgo (+104 more)
...
Cohesion: 0.03
Nodes (110): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+102 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (89): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+81 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (84): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+76 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (89): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+81 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (91): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+83 more)
...
Cohesion: 0.04
Nodes (71): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry (+63 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (88): registerTestCommands(), runCommand(), RunOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (69): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, INSPECTOR_PANEL_SOURCE, state, EDITOR_LABELS, PanOpenInPicker() (+61 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (82): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (75): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+67 more)
...
Cohesion: 0.03
Nodes (72): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+64 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (75): ensureDefaultConversationModel(), DEFAULTS, UIPreferences, useUIPreferences(), PROVIDER_INFO, ProviderPanelProps, DesktopSettings, DesktopSettingsSection() (+67 more)
...
Cohesion: 0.04
Nodes (78): getTrackerContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (62): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, ACCompletionResult (+54 more)
...
Cohesion: 0.03
Nodes (70): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SkillsList() (+62 more)
...
Cohesion: 0.04
Nodes (65): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), loadPinState(), PHASE_CHIP_COLORS (+57 more)
...
Cohesion: 0.04
Nodes (73): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+65 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (68): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+60 more)
...
Cohesion: 0.03
Nodes (64): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, cloisterRouteLayer (+56 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (65): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (66): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, getAllReviewStatusesFromDb() (+58 more)
...
Cohesion: 0.03
Nodes (65): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+57 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (66): embedAction(), normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), showAction() (+58 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (60): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), writeWorkspaceContinue(), completePlanningArtifacts(), readWorkspacePlanAsync(), badPath (+52 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (59): finalizeRunLog(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+51 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (61): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession() (+53 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (58): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl() (+50 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (48): parseContainerServiceName(), parseIssueIdFromText(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem() (+40 more)
...
Cohesion: 0.06
Nodes (49): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+41 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (50): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt() (+42 more)
...
Cohesion: 0.04
Nodes (46): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, getKimiAnthropicBaseUrl(), getProviderEnv(), ProviderAuthType, ProviderName, PROVIDERS, generateRouterConfigFromWorkTypes() (+38 more)
...
Cohesion: 0.07
Nodes (51): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+43 more)
...
Cohesion: 0.05
Nodes (47): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+39 more)
...
Cohesion: 0.05
Nodes (50): constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders(), hasDashboardInternalToken() (+42 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (21): importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+13 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (40): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+32 more)
...
Cohesion: 0.04
Nodes (44): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+36 more)
...
Cohesion: 0.07
Nodes (38): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), extract_embedding(), _get_default_sink_state(), Handler, load_base_model() (+30 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (42): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceShape, SpecialistAgentName (+34 more)
...
Cohesion: 0.05
Nodes (40): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, authorized(), eventsRouteLayer, getEventStreamRoute (+32 more)
...
Cohesion: 0.06
Nodes (34): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+26 more)
...
Cohesion: 0.07
Nodes (41): Platform, evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers() (+33 more)
...
Cohesion: 0.05
Nodes (41): buildConvoyPrompt(), isReviewSessionForIssue(), readConvoySubRoleTemplate(), reviewerAgentId(), reviewerAgentOutputPath(), spawnReviewSubRoleForIssue(), agentSrc, content (+33 more)

### Community 101 - "Community 101"
Cohesion: 0.06
Nodes (39): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), patchConversationTitle() (+31 more)
...
Cohesion: 0.06
Nodes (35): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute, postCodexReauthStatusRoute (+27 more)
...
Cohesion: 0.07
Nodes (41): readLogTail(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock (+33 more)
...
Cohesion: 0.06
Nodes (27): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+19 more)
...
Cohesion: 0.06
Nodes (31): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+23 more)
...
Cohesion: 0.09
Nodes (33): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntry() (+25 more)
...
Cohesion: 0.1
Nodes (27): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText() (+19 more)
...
Cohesion: 0.14
Nodes (27): createTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig, Comment, Issue (+19 more)
...
Cohesion: 0.09
Nodes (34): Access, PrdLocation, readBridgedCodexCredential(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+26 more)
...
Cohesion: 0.1
Nodes (32): applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, isoForStash(), isOlderThanDays(), isSalvageableStash() (+24 more)
...
Cohesion: 0.11
Nodes (29): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync() (+21 more)
...
Cohesion: 0.13
Nodes (30): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity() (+22 more)
...
Cohesion: 0.11
Nodes (20): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, setupVoiceWebSocket() (+12 more)
...
Cohesion: 0.12
Nodes (22): withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+14 more)
...
Cohesion: 0.11
Nodes (23): doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, QueuedCommit, serializer (+15 more)
...
Cohesion: 0.15
Nodes (22): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+14 more)
...
Cohesion: 0.1
Nodes (21): cleanupLabelsGitHub(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel, mockClientIssueLabels (+13 more)
...
Cohesion: 0.15
Nodes (20): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions (+12 more)
...
Cohesion: 0.12
Nodes (12): NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), startCliproxyWatchdog(), startSharedPresencePoller(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig (+4 more)
...
Cohesion: 0.12
Nodes (15): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, getIssueDataService() (+7 more)
...
Cohesion: 0.18
Nodes (16): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), getProject() (+8 more)

### Community 419 - "Community 419"
Cohesion: 0.16
Nodes (16): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdStatus, STATUS_DIRS, statusRoot() (+8 more)
...
Cohesion: 0.18
Nodes (11): data, mockExistsSync, mockReadFile, mockUnlink, runner, LifecycleRunner, PENDING_FILE, PendingLifecycleData (+3 more)
...
Cohesion: 0.17
Nodes (9): sshCommand(), CONFIG, hadPackageDir, hadPython, hadVenvDir, killSpy, packageDir, python (+1 more)
...
Cohesion: 0.2
Nodes (10): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTrackerFromConfig(), getAllTrackers() (+2 more)
...
Cohesion: 0.32
Nodes (6): execAsync, restoreTrackedBeadsExport(), after, before, content, notGit
...
Cohesion: 0.43
Nodes (6): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule()
...
## Knowledge Gaps
- **12442 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12437 more)
...
- **Why does `fetch` connect `Community 6` to `Community 0`, `Community 2`, `Community 131`, `Community 4`, `Community 5`, `Community 390`, `Community 7`, `Community 135`, `Community 265`, `Community 10`, `Community 649`, `Community 12`, `Community 134`, `Community 16`, `Community 17`, `Community 18`, `Community 277`, `Community 534`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 22`, `Community 150`, `Community 36`, `Community 37`, `Community 39`, `Community 425`, `Community 298`, `Community 811`, `Community 301`, `Community 46`, `Community 49`, `Community 692`, `Community 53`, `Community 696`, `Community 184`, `Community 58`, `Community 59`, `Community 63`, `Community 65`, `Community 66`, `Community 579`, `Community 580`, `Community 196`, `Community 68`, `Community 72`, `Community 73`, `Community 458`, `Community 969`, `Community 208`, `Community 210`, `Community 85`, `Community 600`, `Community 604`, `Community 607`, `Community 231`, `Community 109`, `Community 120`, `Community 509`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 0` to `Community 1`, `Community 419`, `Community 6`, `Community 231`, `Community 9`, `Community 12`, `Community 14`, `Community 307`, `Community 308`, `Community 693`, `Community 20`, `Community 186`, `Community 27`, `Community 606`, `Community 31`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `postWithTimeout()` connect `Community 210` to `Community 6`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12442 weakly-connected nodes found - possible documentation gaps or missing edges._
