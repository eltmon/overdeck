...
## Corpus Check
- 1601 files · ~2,079,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22546 nodes · 33844 edges · 1159 communities (1119 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 463 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `852d8417`
...
3. `getDatabase()` - 91 edges
4. `useDashboardStore` - 59 edges
5. `sessionExistsAsync()` - 53 edges
6. `listSessionNamesAsync()` - 52 edges
7. `spawnAgent()` - 50 edges
8. `spawnEphemeralSpecialist()` - 50 edges
9. `killSessionAsync()` - 49 edges
...
## Communities (1159 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (163): readCavemanVariant(), autoResumeStoppedWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), isMergeAgentRunning(), spawnReviewCoordinatorSession(), buildSpecialistBaseCommand(), killCommand(), KillOptions (+155 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (165): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup() (+157 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (151): checkStuckWorkAgents(), cleanupOrphanReviewerSessions(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+143 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (133): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA() (+125 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (119): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+111 more)
...
Cohesion: 0.03
Nodes (112): setAgentStoppedNotifier(), after, before, blockers, result, statuses, after, row (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (109): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents(), checkHeartbeat() (+101 more)
...
Cohesion: 0.02
Nodes (93): ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI, HEALTH_STATE_LABEL, inferIssueId() (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (88): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+80 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (79): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats (+71 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (94): getReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, getAgentRuntimeStateAsync(), snapshotToRuntimeState(), withConcurrencyLimit(), encodeClaudeProjectDir() (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (91): stampPlanForFinalization(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+83 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (86): listTestsCommand(), registerTestCommands(), RunOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+78 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (87): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+79 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (76): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+68 more)
...
Cohesion: 0.05
Nodes (84): closeOutCommand(), CloseOutOptions, getGitHubConfig(), projectListCommand(), projectShowCommand(), runCommand(), wipeCommand(), WipeOptions (+76 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (89): archiveReviewerRound(), buildReviewFeedbackBody(), getFilesChangedFromPR(), getReviewAgents(), isReviewSessionForIssue(), logReviewHistory(), parseReviewerTemplate(), ReviewContext (+81 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (70): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions (+62 more)
...
Cohesion: 0.03
Nodes (73): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (82): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (76): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+68 more)
...
Cohesion: 0.03
Nodes (74): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+66 more)
...
Cohesion: 0.03
Nodes (66): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (58): getUnblockedItems(), TERMINAL_STATUSES, criteria, doc, result, result, ACCompletionResult, checkAllCriteriaCompleted() (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (70): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+62 more)
...
Cohesion: 0.04
Nodes (63): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask (+55 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (60): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+52 more)
...
Cohesion: 0.04
Nodes (53): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+45 more)
...
Cohesion: 0.05
Nodes (53): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+45 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (55): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+47 more)
...
Cohesion: 0.04
Nodes (57): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+49 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (58): applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult, ConversationsConfig (+50 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (47): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (51): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+43 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (53): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+45 more)
...
Cohesion: 0.07
Nodes (46): destroyRemoteWorkspace(), ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, buildClaudeUserSettings(), ClaudeUserSettings (+38 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (50): applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, isoForStash(), isOlderThanDays(), isSalvageableStash() (+42 more)
...
Cohesion: 0.05
Nodes (43): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, computePlanningState(), badPath, customPlanningDir, dir, doc (+35 more)
...
Cohesion: 0.06
Nodes (39): beadsDir, doc, AcceptanceCriterion, createBeadsFromVBrief(), CreateBeadsResult, deriveProjectPrefix(), execAsync, execFileAsync (+31 more)
...
Cohesion: 0.07
Nodes (34): ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps (+26 more)
...
Cohesion: 0.09
Nodes (37): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData() (+29 more)
...
Cohesion: 0.08
Nodes (18): issues, result, importTrackerConfig(), findProjectsByRallyProject(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+10 more)
...
Cohesion: 0.06
Nodes (42): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+34 more)
...
Cohesion: 0.06
Nodes (29): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+21 more)
...
Cohesion: 0.07
Nodes (36): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+28 more)
...
Cohesion: 0.08
Nodes (29): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+21 more)
...
Cohesion: 0.1
Nodes (3): createHandoffEvent(), CloisterService, readStateFile()
...
Cohesion: 0.1
Nodes (30): writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback(), readFeedback() (+22 more)
...
Cohesion: 0.16
Nodes (33): ARCHIVES_DIR, archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+25 more)
...
Cohesion: 0.1
Nodes (33): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath() (+25 more)
...
Cohesion: 0.12
Nodes (30): extractPrefix(), archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close() (+22 more)
...
Cohesion: 0.11
Nodes (25): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractStandardNumber() (+17 more)

### Community 204 - "Community 204"
Cohesion: 0.1
Nodes (29): result, snapshot, status, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentStatus(), toMergeStatus() (+21 more)
...
Cohesion: 0.15
Nodes (27): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, BUDGETS_FILE, checkBudget(), CostBudget (+19 more)
...
Cohesion: 0.11
Nodes (17): applyBurnedTokenOverride(), checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus, CodexAuthUnknown (+9 more)
...
Cohesion: 0.12
Nodes (15): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+7 more)
...
Cohesion: 0.13
Nodes (18): getProjectSpecialistMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs (+10 more)
...
Cohesion: 0.15
Nodes (12): Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan finalize), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Finalizing (`pan plan finalize`), Panopticon Planning Lifecycle (+4 more)
...
Cohesion: 0.17
Nodes (12): Auto-planning, code:bash (pan plan PAN-1071), code:bash (pan plan PAN-1071 --auto), code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Planning Workflow, Starting planning (+4 more)
...
## Knowledge Gaps
- **11924 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11919 more)
...
- **Why does `fetch` connect `Community 5` to `Community 384`, `Community 3`, `Community 388`, `Community 389`, `Community 6`, `Community 134`, `Community 8`, `Community 778`, `Community 266`, `Community 11`, `Community 10`, `Community 12`, `Community 15`, `Community 655`, `Community 17`, `Community 148`, `Community 21`, `Community 20`, `Community 23`, `Community 152`, `Community 26`, `Community 539`, `Community 540`, `Community 28`, `Community 33`, `Community 162`, `Community 34`, `Community 39`, `Community 40`, `Community 45`, `Community 46`, `Community 48`, `Community 564`, `Community 60`, `Community 76`, `Community 82`, `Community 83`, `Community 220`, `Community 604`, `Community 605`, `Community 107`, `Community 112`, `Community 249`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 132` to `Community 8`, `Community 0`, `Community 36`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 32` to `Community 225`, `Community 37`, `Community 14`, `Community 29`, `Community 149`, `Community 56`, `Community 314`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Are the 168 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 168 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11924 weakly-connected nodes found - possible documentation gaps or missing edges._
