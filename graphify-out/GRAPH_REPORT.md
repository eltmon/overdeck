...
## Corpus Check
- 1573 files · ~2,070,272 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22396 nodes · 33608 edges · 1156 communities (1117 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1c9b486`
...
## Communities (1156 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (139): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (161): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+153 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (158): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE (+150 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (152): checkStuckWorkAgents(), __dirname, __filename, InspectResult, spawnInspectAgent(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), getSpecialistHarness() (+144 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (129): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+121 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (111): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state (+103 more)
...
Cohesion: 0.02
Nodes (106): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneAProps, ALL_TABS, OverviewTab (+98 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (120): logNonCanonicalStashesOnStartup(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+112 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (112): checkApiErrorAgents(), cleanupStaleAgentState(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+104 more)
...
Cohesion: 0.04
Nodes (96): readCavemanVariant(), cleanupOrphanReviewerSessions(), renderPrompt(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration(), clearSessionId() (+88 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (82): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (77): parsePiSession(), waitForPiAgentReady(), writePiAgentPrompt(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+69 more)
...
Cohesion: 0.03
Nodes (88): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+80 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (92): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+84 more)
...
Cohesion: 0.03
Nodes (84): cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush, mockMarkWorkspaceStuck, result, execFile() (+76 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (82): closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace() (+74 more)
...
Cohesion: 0.03
Nodes (71): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (79): addRepoCommand(), loadRepoGroups(), resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch() (+71 more)
...
Cohesion: 0.05
Nodes (72): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (73): agentDir, dir1, dir2, marker, missing, nested, resolveTrackerType(), cb (+65 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (65): computeAgentEnrichment(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getActivity(), getAgentRuntimeStateAsync() (+57 more)
...
Cohesion: 0.05
Nodes (59): criteria, doc, result, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument() (+51 more)
...
Cohesion: 0.05
Nodes (66): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+58 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (63): emitCoordinatorDied(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+55 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (58): checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+50 more)
...
Cohesion: 0.04
Nodes (53): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL (+45 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (55): showCommand(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+47 more)
...
Cohesion: 0.06
Nodes (56): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting() (+48 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (46): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization() (+38 more)
...
Cohesion: 0.05
Nodes (50): getReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap() (+42 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (51): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument(), projectPanPaths() (+43 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (53): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execAsync, execFileAsync (+45 more)
...
Cohesion: 0.05
Nodes (51): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+43 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (47): reconcileAndCheckIfMerged(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+39 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (50): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+42 more)
...
Cohesion: 0.06
Nodes (43): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+35 more)
...
Cohesion: 0.06
Nodes (41): setAgentStoppedNotifier(), getAllActiveQueues(), ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitDashboardLifecycle(), EmitDetailedOptions (+33 more)
...
Cohesion: 0.05
Nodes (46): calculateCost(), CostEntry, DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing, anthropicModels, cost (+38 more)
...
Cohesion: 0.08
Nodes (36): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, calls (+28 more)
...
Cohesion: 0.06
Nodes (35): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+27 more)
...
Cohesion: 0.06
Nodes (36): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+28 more)
...
Cohesion: 0.07
Nodes (38): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+30 more)
...
Cohesion: 0.09
Nodes (34): wipeCommand(), CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), LifecycleContext (+26 more)
...
Cohesion: 0.09
Nodes (30): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), commands (+22 more)
...
Cohesion: 0.07
Nodes (31): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCostForIssueFromDb(), getCostsByIssueFromDb() (+23 more)
...
Cohesion: 0.1
Nodes (31): buildInspectPrompt(), detectCompileCommand(), execAsync, getBeadDescription(), InspectContext, onInspectComplete(), execAsync, getCheckpointDir() (+23 more)
...
Cohesion: 0.19
Nodes (31): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload() (+23 more)
...
Cohesion: 0.15
Nodes (28): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+20 more)
...
Cohesion: 0.09
Nodes (22): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+14 more)
...
Cohesion: 0.09
Nodes (19): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+11 more)
...
Cohesion: 0.15
Nodes (20): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdStatus, STATUS_DIRS, statusRoot() (+12 more)
...
Cohesion: 0.19
Nodes (16): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix() (+8 more)
...
Cohesion: 0.19
Nodes (16): readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+8 more)
...
Cohesion: 0.13
Nodes (17): execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs, logPath (+9 more)
...
Cohesion: 0.23
Nodes (13): checkCliproxyPortAsync(), getCliproxyPidPath(), isCliproxyRunning(), isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), restartCliproxyAsync(), stopCliproxy() (+5 more)
...
Cohesion: 0.21
Nodes (12): getAllSpecialistStatus(), LegacySpecialistRuntimeStatus, SpecialistStatus, doneCommand(), DoneOptions, formatStatus(), displaySpecialist(), getRelativeTime() (+4 more)
...
Cohesion: 0.16
Nodes (10): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivitySection, formatModel(), IsolationMode() (+2 more)
...
## Knowledge Gaps
- **11892 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11887 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 129`, `Community 386`, `Community 2`, `Community 773`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 145`, `Community 273`, `Community 148`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 541`, `Community 30`, `Community 35`, `Community 37`, `Community 39`, `Community 41`, `Community 170`, `Community 49`, `Community 50`, `Community 51`, `Community 180`, `Community 569`, `Community 190`, `Community 67`, `Community 210`, `Community 221`, `Community 94`, `Community 610`, `Community 611`, `Community 615`, `Community 236`, `Community 503`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 160` to `Community 3`, `Community 84`, `Community 13`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 39` to `Community 87`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11892 weakly-connected nodes found - possible documentation gaps or missing edges._
