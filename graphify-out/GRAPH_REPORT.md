...
## Corpus Check
- 1552 files · ~2,062,483 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21633 nodes · 32005 edges · 1137 communities (1100 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `708f0738`
...
## Communities (1137 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (142): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, DetailPanelLayoutProps (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (127): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+119 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (121): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+113 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (109): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+101 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (119): readCavemanVariant(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+111 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (132): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+124 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (126): checkFailedMergeRetry(), checkMissingReviewStatuses(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, archiveReviewerRound() (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (108): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (115): checkOrphanedReviewStatuses(), checkStuckReviewing(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), buildProviderExportLines(), buildSpecialistCavemanExports() (+107 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (104): dequeueMerge(), execFileAsync, gitFetch(), gitForcePush(), gitMerge(), gitPush(), gitRevParse(), MainDivergedError (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (96): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+88 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (82): isMergeAgentRunning(), parsePiSession(), ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, sessionExistsAsync(), waitForClaudePrompt() (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (97): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+89 more)
...
Cohesion: 0.03
Nodes (91): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), buildHandoffPrompt() (+83 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (93): autoResumeStoppedWorkAgents(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes() (+85 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (75): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard() (+67 more)
...
Cohesion: 0.03
Nodes (83): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+75 more)
...
Cohesion: 0.05
Nodes (83): dispatchTestAgentAndNotify(), buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (75): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+67 more)
...
Cohesion: 0.05
Nodes (56): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+48 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (61): clearStaleCiFeedback(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+53 more)
...
Cohesion: 0.03
Nodes (44): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, MOCK_ISSUE (+36 more)
...
Cohesion: 0.05
Nodes (63): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+55 more)
...
Cohesion: 0.05
Nodes (40): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+32 more)
...
Cohesion: 0.06
Nodes (43): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), badPath, customPlanningDir, dir (+35 more)
...
Cohesion: 0.06
Nodes (36): firstSessionPanel, firstWorkbench, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps (+28 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (45): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), FileStatus (+37 more)
...
Cohesion: 0.05
Nodes (37): setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitDashboardLifecycle() (+29 more)
...
Cohesion: 0.07
Nodes (44): cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent(), getRecentHealthHistory(), HealthEvent (+36 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (36): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+28 more)

### Community 58 - "Community 58"
Cohesion: 0.15
Nodes (45): extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+37 more)
...
Cohesion: 0.09
Nodes (39): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec(), writeSpec() (+31 more)

### Community 64 - "Community 64"
Cohesion: 0.1
Nodes (42): showCommand(), findSpecByIssue(), updateSpecStatus(), next, path, read, state, appendFeedbackEntry() (+34 more)
...
Cohesion: 0.09
Nodes (32): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc, result, doc (+24 more)
...
Cohesion: 0.07
Nodes (43): Access, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+35 more)
...
Cohesion: 0.08
Nodes (42): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+34 more)
...
Cohesion: 0.08
Nodes (39): calls, { mockExecAsync }, opts, archivePlanning(), closeIssue(), CloseIssueOptions, compactBeads(), CompactBeadsOptions (+31 more)
...
Cohesion: 0.07
Nodes (32): beadsDir, doc, dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync } (+24 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (29): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+21 more)
...
Cohesion: 0.09
Nodes (36): ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), dropStash(), execAsync (+28 more)
...
Cohesion: 0.12
Nodes (31): createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType, ExecResult (+23 more)
...
Cohesion: 0.07
Nodes (32): ClaudeAuthStatus, getClaudeAuthStatus(), parseOAuthPayload(), readKeychainCredentials(), atomicWrite(), backupIfNeeded(), detectProviderEnvConflicts(), findNewestBackup() (+24 more)
...
Cohesion: 0.12
Nodes (33): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+25 more)
...
Cohesion: 0.07
Nodes (24): readFeatureContext(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync (+16 more)
...
Cohesion: 0.13
Nodes (27): healthCommand(), HealthOptions, pendingCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand() (+19 more)
...
Cohesion: 0.11
Nodes (25): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+17 more)
...
Cohesion: 0.15
Nodes (16): cn(), WorkTypeTableProps, SettingsCardSection(), SettingsCardSectionProps, SettingsRow(), SettingsRowProps, ProviderCard(), ProviderCardProps (+8 more)

### Community 280 - "Community 280"
Cohesion: 0.1
Nodes (20): SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRowStatus(), SettingsRowStatusProps, StatusVariant, variantStyles (+12 more)
...
Cohesion: 0.12
Nodes (10): DiffPanel(), DiffPanelProps, DiffThemeType, RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell() (+2 more)
...
Cohesion: 0.22
Nodes (14): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractStandardNumber() (+6 more)
...
Cohesion: 0.33
Nodes (11): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+3 more)
...
Cohesion: 0.2
Nodes (6): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, checkAgentHealthAsync(), determineHealthStatusAsync()
...
Cohesion: 0.2
Nodes (10): transitionIssueState(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy (+2 more)
...
Cohesion: 0.47
Nodes (6): cleanupAllLogs(), cleanupOldLogs(), getSpecialistConfig(), getSpecialistPromptOverride(), getSpecialistRetention(), cleanupLogsCommand()
...
Cohesion: 0.4
Nodes (4): THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps
...
## Knowledge Gaps
- **11529 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11524 more)
...
- **Why does `fetch` connect `Community 2` to `Community 128`, `Community 1`, `Community 642`, `Community 3`, `Community 6`, `Community 7`, `Community 522`, `Community 523`, `Community 13`, `Community 271`, `Community 16`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 24`, `Community 158`, `Community 159`, `Community 30`, `Community 417`, `Community 36`, `Community 549`, `Community 37`, `Community 39`, `Community 40`, `Community 42`, `Community 45`, `Community 46`, `Community 49`, `Community 181`, `Community 182`, `Community 582`, `Community 70`, `Community 591`, `Community 339`, `Community 216`, `Community 744`, `Community 125`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 126` to `Community 4`, `Community 13`, `Community 750`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 23` to `Community 1017`, `Community 117`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11529 weakly-connected nodes found - possible documentation gaps or missing edges._
