# Graph Report - feature-pan-1044  (2026-05-10)

## Corpus Check
- 1547 files · ~2,066,344 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21619 nodes · 32097 edges · 1127 communities (1095 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 424 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58af9858`
...
1. `fetch` - 157 edges
2. `resolveProjectFromIssue()` - 101 edges
3. `getDatabase()` - 89 edges
4. `useDashboardStore` - 59 edges
5. `listSessionNamesAsync()` - 51 edges
6. `spawnEphemeralSpecialist()` - 50 edges
7. `spawnAgent()` - 47 edges
8. `sessionExistsAsync()` - 47 edges
9. `killSessionAsync()` - 47 edges
...
## Communities (1127 total, 32 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (147): autoResumeStoppedWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), spawnRebaseAgentForBranch(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+139 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (129): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+121 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (107): ActivityPanel(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+99 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (113): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+105 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (109): readCavemanVariant(), renderPrompt(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+101 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (98): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+90 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (106): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname (+98 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (86): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+78 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (79): DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens(), InspectorPanel() (+71 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (86): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+78 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (90): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+82 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (90): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+82 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (88): postMergeLifecycle(), wipeCommand(), extractNumber(), extractPrefix(), calls, { mockExecAsync }, opts, archivePlanning() (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (83): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execFile(), kCustom, mockExecFile (+75 more)
...
Cohesion: 0.04
Nodes (75): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+67 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (68): firstSessionPanel, firstWorkbench, overview, workbench, CommandDeck(), IssueComposer(), IssueWorkbench(), IssueWorkbenchProps (+60 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (68): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+60 more)
...
Cohesion: 0.06
Nodes (74): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+66 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (55): CommandDeckProps, ContainerStats, fetchAllSessionTrees(), fetchConversations(), fetchCostsByIssue(), fetchProjects(), fetchRegisteredProjects(), fetchVersion() (+47 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (67): emitCoordinatorDied(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (70): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+62 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (69): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (54): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+46 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (59): DetailPanelLayout(), loadPinState(), PHASE_CHIP_COLORS, PHASE_LABELS, PipelinePhase, savePinState(), TAB_ID_TO_SESSION_TYPE, TerminalTab (+51 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (52): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), AlertOptions, ConfirmOptions, DialogContext, DialogContextValue (+44 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (59): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (59): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (57): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (50): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+42 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (53): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (61): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+53 more)
...
Cohesion: 0.04
Nodes (55): agentDir, envArg, options, state, stateFile, workspace, anthropicModel, anthropicRouter (+47 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (56): checkStuckWorkAgents(), recoverOrphanedAgents(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, getAgentRuntimeBaseCommand(), getProviderExportsForModel(), panopticonAgentName() (+48 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (50): buildContextMenu(), buildMenuTemplate(), buildTooltip(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon(), createWindow() (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (45): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (59): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+51 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (62): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCreatedEvent, AgentCurrentIssueSetEvent (+54 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (52): clearStaleCiFeedback(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand() (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (52): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile() (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (44): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry() (+36 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (43): after, doc, filename, path, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefDocument (+35 more)
...
Cohesion: 0.06
Nodes (46): reconcileAndCheckIfMerged(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+38 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (44): TurnDiffSummary, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+36 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (46): backupCleanCommand(), backupListCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BackupInfo (+38 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (50): createCostCommand(), BUDGETS_FILE, calculateCost(), checkBudget(), CostBudget, CostEntry, CostSummary, createBudget() (+42 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (48): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData(), fetchActivityDataWithContext() (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (45): ensureRemoteWorkspace(), findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace(), isLinearIssue(), IssueOptions (+37 more)
...
Cohesion: 0.06
Nodes (45): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds() (+37 more)
...
Cohesion: 0.05
Nodes (44): archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), callApi(), fetchMetricsSummary(), MetricsSummary (+36 more)
...
Cohesion: 0.06
Nodes (26): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+18 more)
...
Cohesion: 0.07
Nodes (39): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+31 more)
...
Cohesion: 0.08
Nodes (36): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+28 more)
...
Cohesion: 0.07
Nodes (39): announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+31 more)
...
Cohesion: 0.07
Nodes (43): applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, ConfigCache, ConfigLoadResult, ConversationsConfig, CONVOY_KEY_MIGRATION (+35 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (39): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), WipeOptions, AutoCreateStateConfig (+31 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (30): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+22 more)
...
Cohesion: 0.08
Nodes (38): Platform, evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses() (+30 more)
...
Cohesion: 0.07
Nodes (24): DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+16 more)
...
Cohesion: 0.05
Nodes (41): Abort semantics, Acceptance criteria taxonomy, CLI reference, code:block1 (Work agent (Claude, in its own tmux session)), code:yaml (work_types:), code:block2 (.pan/review/<reviewId>/), code:block3 (src/lib/cloister/prompts/review/), code:markdown (# Review Context) (+33 more)
...
Cohesion: 0.07
Nodes (38): Access, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session(), find_sessions() (+30 more)
...
Cohesion: 0.08
Nodes (31): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+23 more)
...
Cohesion: 0.11
Nodes (29): error, mockComment, mockComments, mockIssue, mockIssues, mockOctokit, stateTests, tracker (+21 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (31): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+23 more)
...
Cohesion: 0.08
Nodes (25): getDebugInfo(), getGlobalRouter(), getModel(), getModelId(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter() (+17 more)
...
Cohesion: 0.08
Nodes (28): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+20 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (34): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+26 more)
...
Cohesion: 0.08
Nodes (27): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+19 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (31): ActivityEntry, ActivityItem(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST(), fetchDetailedActivityREST() (+23 more)
...
Cohesion: 0.08
Nodes (25): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), ModelSelectionResult (+17 more)

### Community 149 - "Community 149"
Cohesion: 0.08
Nodes (33): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings() (+25 more)
...
Cohesion: 0.08
Nodes (29): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, deepMerge() (+21 more)
...
Cohesion: 0.06
Nodes (35): Auto-Behaviors, Available MCP Tools, Beads Enforcement, Claude Code Channels (experimental), code:bash (# List all agent sessions), code:typescript (// Correct (in sendKeysAsync):), code:block3 (**PRD:** [`path/to/prd.md`](https link to the file in the re), Commit and Push When Working on Main (+27 more)
...
Cohesion: 0.08
Nodes (30): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+22 more)
...
Cohesion: 0.06
Nodes (31): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+23 more)
...
Cohesion: 0.1
Nodes (25): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+17 more)

### Community 165 - "Community 165"
Cohesion: 0.06
Nodes (34): Activity, AgentChannelReply, AgentId, AgentPhase, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES (+26 more)
...
Cohesion: 0.09
Nodes (27): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), commands (+19 more)

### Community 174 - "Community 174"
Cohesion: 0.07
Nodes (26): Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+18 more)
...
Cohesion: 0.1
Nodes (31): resolveModelId(), applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+23 more)

### Community 184 - "Community 184"
Cohesion: 0.18
Nodes (30): checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile(), ensureDirs(), execAsync (+22 more)

### Community 185 - "Community 185"
Cohesion: 0.13
Nodes (28): resolveBundledServerPath(), resolveNode22(), RestartOptions, runFullRestart(), spawnDashboardDetached(), DASHBOARD_LOG_FILE, execAsync, isTraefikContainerRunning() (+20 more)

### Community 186 - "Community 186"
Cohesion: 0.1
Nodes (28): reconcileStaleMergeStatus(), mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), cleanFile(), configCommand(), execAsync (+20 more)

### Community 187 - "Community 187"
Cohesion: 0.07
Nodes (30): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+22 more)
...
Cohesion: 0.09
Nodes (17): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+9 more)
...
Cohesion: 0.09
Nodes (27): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+19 more)

### Community 218 - "Community 218"
Cohesion: 0.08
Nodes (20): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+12 more)
...
Cohesion: 0.11
Nodes (27): systemHealthCommand(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), errorSpy (+19 more)
...
Cohesion: 0.14
Nodes (13): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+5 more)
...
Cohesion: 0.13
Nodes (25): agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSessionExists (+17 more)
...
Cohesion: 0.15
Nodes (26): markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths(), getAttachmentCache() (+18 more)
...
Cohesion: 0.11
Nodes (22): err, exec(), execFile(), execMock, kCustom, realExecAsync, spawnMock, tmuxCapturePaneAsyncMock (+14 more)

### Community 252 - "Community 252"
Cohesion: 0.15
Nodes (25): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+17 more)

### Community 253 - "Community 253"
Cohesion: 0.09
Nodes (22): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+14 more)

### Community 254 - "Community 254"
Cohesion: 0.1
Nodes (18): RoundMarker, ZoneCConversation(), ZoneCConversationProps, deriveRoundMarkers(), TimestampedItem, resolveWorkTypeKey(), useResolvedModels(), getViewKey() (+10 more)
...
Cohesion: 0.08
Nodes (16): dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync }, redirectContent, workspacePath (+8 more)

### Community 275 - "Community 275"
Cohesion: 0.17
Nodes (25): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+17 more)
...
Cohesion: 0.12
Nodes (19): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+11 more)
...
Cohesion: 0.16
Nodes (20): cleanupAbandonedFeedback(), clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+12 more)
...
Cohesion: 0.09
Nodes (21): Agents in the Panopticon pipeline, Claude Code subagents (NOT Panopticon specialists), code:block1 (pan plan-finalize), code:json ({), code:json ({), continue.vbrief.json Format, CRITICAL: PLANNING ONLY - NO IMPLEMENTATION, Description (+13 more)
...
Cohesion: 0.17
Nodes (12): parsePiSession(), agentDirFor(), PiRuntime, piSessionDirFor(), readReady(), readStoredSessionId(), readyPathFor(), safeReaddir() (+4 more)
...
Cohesion: 0.13
Nodes (14): currentStatus, getUpdateStatus(), initializeAutoUpdater(), onUpdateStatusChange(), startPeriodicChecks(), statusCallbacks, UpdateStatus, UpdateStatusCallback (+6 more)

### Community 371 - "Community 371"
Cohesion: 0.17
Nodes (18): cleanupOldEvents(), CLOISTER_DB_PATH, deleteAgentHistory(), getAgentsWithHistory(), getAllHealthHistory(), getDatabaseStats(), getHealthDatabase(), getHealthHistory() (+10 more)

### Community 372 - "Community 372"
Cohesion: 0.14
Nodes (19): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), ensureConfigFileAsync(), ensureDirsAsync(), getCliproxyAuthDir(), getCliproxyGeminiCredPath(), parseBridgedGeminiApiKey(), readBridgedGeminiApiKey() (+11 more)
...
Cohesion: 0.16
Nodes (16): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+8 more)
...
Cohesion: 0.11
Nodes (16): fetchHealth(), fetchProjectSpecialists(), HealthDashboard(), PROJECT_RUN_STATUS_CONFIG, ProjectSpecialistStatus, STATUS_CONFIG, CostMetrics, fetchCostMetrics() (+8 more)

### Community 381 - "Community 381"
Cohesion: 0.1
Nodes (14): DiffPanel(), DEFAULTS, DiffIndicators, DiffPreferences, DiffRenderMode, HunkSeparators, LineDiffType, LineHoverHighlight (+6 more)
...
Cohesion: 0.11
Nodes (14): exitGracePeriod(), GraceCountdown(), GraceCountdownProps, GracePeriodState, pauseGracePeriod(), resumeGracePeriod(), fetchContextDigest(), fetchGracePeriod() (+6 more)
...
Cohesion: 0.18
Nodes (12): createPiFifo(), destroyPiFifo(), execAsync, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand(), chunks (+4 more)

### Community 407 - "Community 407"
Cohesion: 0.18
Nodes (15): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), rotateSpecialistSession() (+7 more)
...
Cohesion: 0.2
Nodes (17): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), decodeJwtPayload(), getCliproxyCodexCredPath(), getCodexAuthPath(), buildStatus(), decodeBase64Url(), decodeJwtPayload() (+9 more)

### Community 410 - "Community 410"
Cohesion: 0.19
Nodes (16): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+8 more)
...
Cohesion: 0.17
Nodes (13): ALLOWED, canUseHarness(), HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, SubscriptionPlan, RuntimeName, AUTH_MODES (+5 more)

### Community 452 - "Community 452"
Cohesion: 0.19
Nodes (12): EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp(), consolidateSpeakerCues(), decodeHtmlEntities(), formatTimestamp() (+4 more)

### Community 453 - "Community 453"
Cohesion: 0.26
Nodes (15): startPostLaunchSidecars(), startSidecars(), resolveScope(), restartCommand(), readPlatformConfig(), getSupervisorPort(), getSupervisorUrl(), isProcessAlive() (+7 more)
...
Cohesion: 0.13
Nodes (11): mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubRemoveLabel, mockGitHubReopenIssue, mockLinearGetIssue, mockLinearGetTeamStates, mockLinearUpdateState, mockRallyUpdateState (+3 more)
...
Cohesion: 0.23
Nodes (11): getAllSpecialistStatus(), SpecialistStatus, doneCommand(), DoneOptions, formatStatus(), displaySpecialist(), getRelativeTime(), getStatusColor() (+3 more)

### Community 501 - "Community 501"
Cohesion: 0.25
Nodes (4): execAsync, readStateFile(), TldrDaemonService, writeStateFile()
...
Cohesion: 0.14
Nodes (13): code:block1 (┌───────────────────────────────────────────────────────────), code:block2 (┌───────────────────────────────────────────────────────────), Core Concept, ⚠️ DECOUPLING FROM MYN (CRITICAL), DO NOT rely on MYN infrastructure:, If tests pass, commit, Migration checklist (from MYN):, Panopticon: Multi-Agent Orchestration for Claude Code (+5 more)
...
Cohesion: 0.23
Nodes (12): atomicWrite(), backupIfNeeded(), detectProviderEnvConflicts(), findNewestBackup(), injectPanopticonInfraDeny(), injectProviderEnvOverlay(), INVALID_LEGACY_PATTERNS, OverlayResult (+4 more)
...
Cohesion: 0.15
Nodes (12): archiveIdx, beadsDir, branchStep, clearStep, content, ctx, { mockExecAsync }, stepNames (+4 more)
...
Cohesion: 0.15
Nodes (12): DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing, found (+4 more)
...
Cohesion: 0.17
Nodes (11): Agent Types Index, Important distinction: runtime agents vs routed work types, Primary agents, Related docs, Runtime agent inventory, Specialist agents, Support and routing-only types, The big picture (+3 more)
...
Cohesion: 0.2
Nodes (6): dispatchTestAgentAndNotify(), mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, notify, promise
...
Cohesion: 0.2
Nodes (8): build, copyPrompts, dashboardDir, distDir, preservedDashboardDir, preservedRoot, projectRoot, promptsDir
...
Cohesion: 0.24
Nodes (8): callServerApi(), buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, checkForUpdates(), quitAndInstall()

### Community 647 - "Community 647"
Cohesion: 0.22
Nodes (7): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result
...
Cohesion: 0.2
Nodes (10): code:bash (pan plan PAN-3), code:bash (# Agent searches for authentication code), code:markdown (# PAN-3: Add User Authentication), code:bash (# View the plan), Planning Workflow, Step 1: Start Planning Session, Step 2: AI Discovery Phase, Step 3: Interactive Questions (+2 more)
...
Cohesion: 0.5
Nodes (3): mockLoadConfig, mockResolveModelId, settings
...
## Knowledge Gaps
- **11515 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11510 more)
...
- **Why does `fetch` connect `Community 58` to `Community 1025`, `Community 2`, `Community 1026`, `Community 1`, `Community 645`, `Community 646`, `Community 7`, `Community 9`, `Community 394`, `Community 11`, `Community 652`, `Community 395`, `Community 14`, `Community 143`, `Community 15`, `Community 17`, `Community 19`, `Community 276`, `Community 21`, `Community 22`, `Community 283`, `Community 27`, `Community 543`, `Community 544`, `Community 161`, `Community 162`, `Community 163`, `Community 31`, `Community 37`, `Community 45`, `Community 46`, `Community 174`, `Community 47`, `Community 53`, `Community 568`, `Community 185`, `Community 57`, `Community 187`, `Community 958`, `Community 959`, `Community 64`, `Community 461`, `Community 78`, `Community 84`, `Community 217`, `Community 605`, `Community 226`, `Community 240`, `Community 505`, `Community 380`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 132` to `Community 0`, `Community 133`, `Community 7`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 15` to `Community 118`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Are the 156 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 156 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11515 weakly-connected nodes found - possible documentation gaps or missing edges._
