...
## Corpus Check
- 1923 files · ~3,148,572 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27496 nodes · 43142 edges · 1305 communities (1243 shown, 62 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2552e2b0`
...
## Communities (1305 total, 62 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (192): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+184 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (187): monitorReviewConvoySignals(), buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult (+179 more)
...
Cohesion: 0.02
Nodes (146): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+138 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (122): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (112): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+104 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (123): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, RecoverButton(), RecoverButtonProps, SwitchModelModal() (+115 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (123): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback() (+115 more)
...
Cohesion: 0.02
Nodes (107): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), postAgentMessageLikeRoute(), validateAgentMessageOrigin() (+99 more)
...
Cohesion: 0.02
Nodes (91): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+83 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (82): updateConversationTitle(), PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (91): buildPolyrepoContext(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+83 more)
...
Cohesion: 0.03
Nodes (80): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (92): readCavemanVariant(), checkStuckReviewing(), buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync (+84 more)
...
Cohesion: 0.04
Nodes (86): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (83): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), mapVBriefPlanStatusToPanSpec() (+75 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (80): deliverReviewVerdictFeedback(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow (+72 more)
...
Cohesion: 0.03
Nodes (82): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+74 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (76): ActivityFeedSidebar(), conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck() (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (68): ComposerMode, IssueComposerProps, ZoneBActionStripProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny (+60 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (80): buildChildEnvSync(), buildChildEnvWithoutTmuxSync(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, agentState (+72 more)
...
Cohesion: 0.03
Nodes (67): isRunningAgent(), isActiveAgent(), CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (61): contextDiffCommand(), checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand() (+53 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (62): parsePiSessionSync(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync(), SessionIndexEntry, getGlobalRegistry() (+54 more)
...
Cohesion: 0.03
Nodes (65): RoundMarker, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE (+57 more)
...
Cohesion: 0.03
Nodes (56): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+48 more)
...
Cohesion: 0.03
Nodes (72): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+64 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (76): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+68 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (63): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, recordAutoCloseOutFailure(), stopDeacon(), createHandoffEvent() (+55 more)
...
Cohesion: 0.04
Nodes (64): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, getAgentWorkspace(), encodeClaudeProjectDir(), result (+56 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (65): buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), addGitHubComment(), fetchGitHubIssue() (+57 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (66): defaults, first, { models }, second, clearConfigCache(), hasModelCapabilitySync(), MODEL_DEPRECATIONS, deprecatedIds (+58 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (63): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash() (+55 more)
...
Cohesion: 0.05
Nodes (51): createEmptyCache(), rebuildCacheSync(), appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata (+43 more)
...
Cohesion: 0.04
Nodes (58): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+50 more)
...
Cohesion: 0.05
Nodes (49): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+41 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (46): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+38 more)
...
Cohesion: 0.04
Nodes (51): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), SessionUsage, emptyUsage() (+43 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (60): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+52 more)
...
Cohesion: 0.07
Nodes (56): embedAction(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan() (+48 more)
...
Cohesion: 0.04
Nodes (48): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+40 more)
...
Cohesion: 0.05
Nodes (46): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+38 more)
...
Cohesion: 0.07
Nodes (44): destroyRemoteWorkspace(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlagsSync(), readYoloEnv(), resolvePermissionModeSync(), YOLO_FALSE, YOLO_TRUE (+36 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (51): filterPayload(), number(), Platform, parseSummaryObservationCount(), evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry() (+43 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (48): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+40 more)
...
Cohesion: 0.06
Nodes (45): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+37 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (57): addCommentBefore(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), callVisitor(), clone(), createNode() (+49 more)
...
Cohesion: 0.05
Nodes (48): searchSessions(), showAction(), arrayIndexCondition(), ArrayIndexTarget, buildFilterSql(), CosineSearchResult, cosineSimilarity(), countFtsSessions() (+40 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (51): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), hasPRDDraft(), hasPRDDraftPromise(), listPRDDrafts() (+43 more)
...
Cohesion: 0.07
Nodes (44): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+36 more)
...
Cohesion: 0.07
Nodes (22): importTrackerConfig(), computeBeadCounts(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+14 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (55): add, addIn(), anchorNames(), applyReviver(), array, asItemIndex(), assertCollection(), atDocument() (+47 more)
...
Cohesion: 0.05
Nodes (50): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchPlanningData() (+42 more)
...
Cohesion: 0.06
Nodes (43): InlineSparkline(), InlineSparklineProps, resolveWorkTypeKey(), useResolvedModels(), ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory() (+35 more)
...
Cohesion: 0.1
Nodes (49): bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile (+41 more)
...
Cohesion: 0.05
Nodes (47): getTtsDaemonStatus(), waitForTtsDaemonHealthPromise(), CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput (+39 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (45): DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions (+37 more)
...
Cohesion: 0.05
Nodes (44): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitDashboardLifecycleSync(), data, mockExistsSync, mockReadFile, mockUnlink, runner (+36 more)
...
Cohesion: 0.11
Nodes (46): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+38 more)

### Community 113 - "Community 113"
Cohesion: 0.09
Nodes (45): clearFlywheelRunGate(), flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), setFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun() (+37 more)
...
Cohesion: 0.06
Nodes (34): normalizeFilter(), parseRelativeTime(), SearchMode, SearchResult, semanticCandidateWindow(), semanticRerankCandidateLimit(), ConversationFilter, DiscoveredSession (+26 more)

### Community 119 - "Community 119"
Cohesion: 0.07
Nodes (42): recoverUnhealthyTestStack(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise(), getContextDigestPath() (+34 more)
...
Cohesion: 0.07
Nodes (35): appendToRunLogSync(), checkLogSizeLimit(), createRunLogSync(), ensureRunsDirectory(), finalizeRunLogSync(), generateRunId(), getRecentRunLogs(), getRunLogPath() (+27 more)
...
Cohesion: 0.07
Nodes (32): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+24 more)

### Community 147 - "Community 147"
Cohesion: 0.08
Nodes (35): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+27 more)
...
Cohesion: 0.12
Nodes (33): TrackersConfig, createTracker(), createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config (+25 more)
...
Cohesion: 0.09
Nodes (29): addEventToCache(), CostCache, getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync(), IssueStats (+21 more)
...
Cohesion: 0.08
Nodes (25): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+17 more)
...
Cohesion: 0.08
Nodes (34): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+26 more)
...
Cohesion: 0.09
Nodes (28): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, resolveBundledServerPath() (+20 more)
...
Cohesion: 0.09
Nodes (24): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry() (+16 more)
...
Cohesion: 0.12
Nodes (31): loadConfigNoMigration(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+23 more)
...
Cohesion: 0.1
Nodes (18): WipeOptions, cleanupAgentDirectories(), cleanupAgentDirectoriesPromise(), CleanupResult, findOrphanedAgentDirs(), findOrphanedAgentDirsPromise(), getPlanningIssueId(), isLegacyConversationDirectory() (+10 more)
...
Cohesion: 0.08
Nodes (27): bridgeCodexAuthToCliproxy(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError (+19 more)
...
Cohesion: 0.09
Nodes (22): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), runQualityGates(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch() (+14 more)
...
Cohesion: 0.1
Nodes (25): findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding(), embed() (+17 more)

### Community 290 - "Community 290"
Cohesion: 0.13
Nodes (24): clearFeedbackFilesPromise(), inferIssueIdFromWorkspace(), readPendingFeedback(), writeStoryFeatureContext(), FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir() (+16 more)
...
Cohesion: 0.09
Nodes (17): ProjectConfig, after, before, cfg, compose, ph, result, createWorkspacePlaceholdersSync() (+9 more)
...
Cohesion: 0.1
Nodes (22): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+14 more)
...
Cohesion: 0.09
Nodes (17): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfigSync(), GitHubConfig, GitLabConfig, LinearConfig (+9 more)
...
Cohesion: 0.09
Nodes (21): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+13 more)
...
Cohesion: 0.18
Nodes (18): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+10 more)
...
Cohesion: 0.18
Nodes (20): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+12 more)

### Community 427 - "Community 427"
Cohesion: 0.1
Nodes (19): ProviderCard(), PROVIDER_INFO, ProviderPanelProps, ApiKeysConfig, DeprecationWarning, Harness, MemorySettingsConfig, ModelRef (+11 more)
...
Cohesion: 0.14
Nodes (13): createPiFifoPromise(), destroyPiFifoSync(), execAsync, PiFifoError, PiFifoPaths, PiNotReady, shellQuote(), writePiCommandSync() (+5 more)

### Community 445 - "Community 445"
Cohesion: 0.1
Nodes (19): UpsertDiscoveredSessionOpts, parseSearchParams(), all, cookie, fetched, filter, inserted, ORIGIN_ENV_KEYS (+11 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, code:bash (# Stop all Panopticon services), code:bash (# Monitor in one terminal), code:bash (# Clean up stale resources), code:env (# Graceful shutdown timeout (seconds)), Configuration Options, Monitoring Shutdown, More Information (+8 more)
...
Cohesion: 0.2
Nodes (13): ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle(), TITLE_SCHEMA (+5 more)
...
Cohesion: 0.17
Nodes (11): captureTldrMetricsSync(), getTldrMetricsSync(), parse(), parseArrayColumn(), readLogLines(), readMetricsCheckpoint(), listWorkspaceMetadataSync(), body (+3 more)
...
Cohesion: 0.23
Nodes (10): buildInspectPromptPromise(), InspectContext, spawnInspectAgent(), getDiffStats(), inspectCommand(), InspectOptions, registerInspectCommand(), inspect (+2 more)
...
Cohesion: 0.23
Nodes (9): cleanupAllLogsSync(), cleanupOldLogsSync(), listProjectsWithSpecialists(), getSpecialistRetention(), cleanupLogsCommand(), resetCommand(), ResetOptions, wakeCommand() (+1 more)
...
Cohesion: 0.31
Nodes (7): editorIconFor(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, PanRpcProtocolClient, getPreferredEditor(), setPreferredEditor()

### Community 807 - "Community 807"
Cohesion: 0.36
Nodes (8): getAllSpecialistStatus(), LegacySpecialistRuntimeStatus, displaySpecialist(), getRelativeTime(), getStatusColor(), getStatusIcon(), listCommand(), ListOptions
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 537`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 539`, `Community 32`, `Community 34`, `Community 40`, `Community 42`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 559`, `Community 52`, `Community 55`, `Community 58`, `Community 62`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 584`, `Community 75`, `Community 76`, `Community 78`, `Community 590`, `Community 81`, `Community 83`, `Community 87`, `Community 91`, `Community 93`, `Community 98`, `Community 102`, `Community 106`, `Community 107`, `Community 112`, `Community 113`, `Community 120`, `Community 633`, `Community 126`, `Community 140`, `Community 155`, `Community 156`, `Community 670`, `Community 671`, `Community 162`, `Community 164`, `Community 168`, `Community 178`, `Community 1216`, `Community 196`, `Community 709`, `Community 201`, `Community 222`, `Community 223`, `Community 236`, `Community 237`, `Community 285`, `Community 288`, `Community 801`, `Community 290`, `Community 291`, `Community 304`, `Community 316`, `Community 317`, `Community 318`, `Community 320`, `Community 337`, `Community 344`, `Community 351`, `Community 352`, `Community 879`, `Community 372`, `Community 375`, `Community 397`, `Community 403`, `Community 428`, `Community 460`, `Community 487`, `Community 490`, `Community 496`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 18` to `Community 320`, `Community 34`, `Community 67`, `Community 5`, `Community 8`, `Community 425`, `Community 557`, `Community 17`, `Community 211`, `Community 22`, `Community 56`, `Community 90`, `Community 30`, `Community 319`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 4`, `Community 516`, `Community 6`, `Community 8`, `Community 10`, `Community 139`, `Community 12`, `Community 14`, `Community 271`, `Community 16`, `Community 401`, `Community 18`, `Community 148`, `Community 278`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 668`, `Community 540`, `Community 29`, `Community 31`, `Community 30`, `Community 35`, `Community 36`, `Community 165`, `Community 169`, `Community 302`, `Community 52`, `Community 181`, `Community 58`, `Community 65`, `Community 66`, `Community 709`, `Community 69`, `Community 459`, `Community 460`, `Community 76`, `Community 208`, `Community 340`, `Community 90`, `Community 95`, `Community 352`, `Community 353`, `Community 354`, `Community 99`, `Community 223`, `Community 226`, `Community 102`, `Community 104`, `Community 239`, `Community 756`, `Community 374`, `Community 759`, `Community 120`, `Community 121`, `Community 638`?**
