...
## Corpus Check
- 1551 files · ~2,061,827 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21625 nodes · 31998 edges · 1144 communities (1105 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f7516ef`
...
## Communities (1144 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (135): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+127 more)
...
Cohesion: 0.02
Nodes (123): ConversationView(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (127): checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), getActiveParallelReviewIssues(), spawnSingleReviewer(), resolveSpecialistBaseCommand() (+119 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (116): nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+108 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (109): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+101 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (116): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync, getFilesChangedFromPR() (+108 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (104): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+96 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (82): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+74 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (108): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+100 more)
...
Cohesion: 0.04
Nodes (88): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+80 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (72): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps (+64 more)
...
Cohesion: 0.03
Nodes (76): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+68 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (67): ViewMode, firstSessionPanel, firstWorkbench, workbench, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+59 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (77): after, before, blockers, result, statuses, after, row, status (+69 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (75): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (69): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTimestamp() (+61 more)
...
Cohesion: 0.06
Nodes (72): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+64 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (74): clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, WorkhorsesConfig, WorkhorseSlot, MODEL_DEPRECATIONS (+66 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (56): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+48 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (67): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (60): setAgentStoppedNotifier(), sentinel, ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+52 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (66): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (61): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+53 more)
...
Cohesion: 0.06
Nodes (61): showCommand(), findSpecByIssue(), updateSpecStatus(), next, path, read, state, after (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (62): invalidateAgentsCache(), cb, cmdArgs, file, mockExec, mockResolveGitHubIssue, prJson, result (+54 more)
...
Cohesion: 0.06
Nodes (42): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+34 more)
...
Cohesion: 0.05
Nodes (44): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+36 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (54): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR (+46 more)
...
Cohesion: 0.04
Nodes (47): generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+39 more)
...
Cohesion: 0.06
Nodes (46): healthCommand(), HealthOptions, formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+38 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (45): getHealthThresholdsMs(), HandoffResult, AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention() (+37 more)
...
Cohesion: 0.08
Nodes (42): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+34 more)
...
Cohesion: 0.07
Nodes (42): doneCommand(), execAsync, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb() (+34 more)
...
Cohesion: 0.06
Nodes (43): computePlanningState(), badPath, customPlanningDir, dir, doc, filename, item, item2 (+35 more)
...
Cohesion: 0.05
Nodes (44): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+36 more)
...
Cohesion: 0.06
Nodes (34): VBriefDialog(), VBriefDialogProps, fmt(), STATUS_BADGE, VBriefHeader(), VBriefHeaderProps, DIFFICULTY_COLORS, PRIORITY_COLORS (+26 more)

### Community 77 - "Community 77"
Cohesion: 0.09
Nodes (36): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile() (+28 more)
...
Cohesion: 0.08
Nodes (39): calls, { mockExecAsync }, opts, archivePlanning(), CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync (+31 more)
...
Cohesion: 0.07
Nodes (35): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+27 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (37): contextCommand(), ContextOptions, cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, calls (+29 more)
...
Cohesion: 0.08
Nodes (37): autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, dispatchSwarmWave(), ensureSwarmAutoAdvanceLoop(), execAsync (+29 more)
...
Cohesion: 0.07
Nodes (33): checkApiErrorAgents(), cleanupOrphanedReviewSessions(), killAllReviewSessions(), cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory() (+25 more)
...
Cohesion: 0.06
Nodes (31): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+23 more)
...
Cohesion: 0.08
Nodes (30): parseReviewerSessionName(), encodeClaudeProjectDir(), result, pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId(), resolveJsonlPath() (+22 more)
...
Cohesion: 0.12
Nodes (30): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), DASHBOARD_LOG_FILE (+22 more)
...
Cohesion: 0.09
Nodes (15): getIssueDataService(), getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+7 more)

### Community 179 - "Community 179"
Cohesion: 0.1
Nodes (31): Access, ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+23 more)
...
Cohesion: 0.12
Nodes (27): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+19 more)
...
Cohesion: 0.09
Nodes (29): AIProvider, buildConversationResponse(), getCachedMessages(), activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock, ConversationActivitySummary (+21 more)

### Community 202 - "Community 202"
Cohesion: 0.11
Nodes (28): checkMissingReviewStatuses(), checkPendingTestDispatch(), getTrackerContext(), detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable(), openCommand(), fetchIssueWithComments() (+20 more)
...
Cohesion: 0.13
Nodes (14): countContextTokens(), findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions() (+6 more)
...
Cohesion: 0.14
Nodes (28): markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments() (+20 more)
...
Cohesion: 0.14
Nodes (25): postMergeLifecycle(), CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+17 more)
...
Cohesion: 0.12
Nodes (25): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+17 more)
...
Cohesion: 0.11
Nodes (25): HandoffContext, createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+17 more)
...
Cohesion: 0.22
Nodes (25): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+17 more)
...
Cohesion: 0.13
Nodes (20): withConcurrencyLimit(), ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+12 more)
...
Cohesion: 0.14
Nodes (22): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig() (+14 more)
...
Cohesion: 0.15
Nodes (21): spawnReviewCoordinatorSession(), determineModel(), resolveModel(), createSessionAsync(), setOptionAsync(), buildPlanningPrompt(), __dirname, discoverPrdFiles() (+13 more)
...
Cohesion: 0.12
Nodes (18): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+10 more)

### Community 333 - "Community 333"
Cohesion: 0.15
Nodes (19): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+11 more)
...
Cohesion: 0.13
Nodes (18): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), VBriefMergeConflictError (+10 more)
...
Cohesion: 0.14
Nodes (17): cleanupOldEntries(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+9 more)

### Community 357 - "Community 357"
Cohesion: 0.12
Nodes (15): issues, result, importTrackerConfig(), getCanonicalStatus(), mapRallyStateToCanonical(), planningStateCache, PlanningStateCacheEntry, POLL_INTERVALS (+7 more)
...
Cohesion: 0.09
Nodes (17): resetPostMergeState(), kCustom, mockExec, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed (+9 more)
...
Cohesion: 0.15
Nodes (9): loadCloisterConfig(), shouldAutoStart(), cleanupStaleAgentState(), { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, checkAgentHealthAsync() (+1 more)
...
Cohesion: 0.18
Nodes (10): checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, needsSessionRotation(), exec(), execMock, kCustom, mockGetAgentState, mockGetRuntimeForAgent (+2 more)
...
## Knowledge Gaps
- **11524 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11519 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 128`, `Community 2`, `Community 643`, `Community 644`, `Community 131`, `Community 5`, `Community 6`, `Community 8`, `Community 649`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 144`, `Community 276`, `Community 277`, `Community 534`, `Community 20`, `Community 152`, `Community 25`, `Community 154`, `Community 26`, `Community 32`, `Community 420`, `Community 37`, `Community 42`, `Community 559`, `Community 176`, `Community 47`, `Community 54`, `Community 55`, `Community 56`, `Community 192`, `Community 202`, `Community 76`, `Community 337`, `Community 216`, `Community 751`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 130` to `Community 336`, `Community 10`, `Community 4`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 20` to `Community 1026`, `Community 46`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11524 weakly-connected nodes found - possible documentation gaps or missing edges._
