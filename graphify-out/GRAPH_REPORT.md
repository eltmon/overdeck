...
## Corpus Check
- 1878 files · ~2,476,864 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26664 nodes · 41408 edges · 1262 communities (1213 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78d18817`
...
## Communities (1262 total, 49 thin omitted)
...
Cohesion: 0.03
Nodes (193): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoff() (+185 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (156): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (136): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+128 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (142): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+134 more)
...
Cohesion: 0.03
Nodes (122): TurnDiffFileChange, normalize(), unarchiveConversationCommand(), generateFallbackSummary(), generateSummaryForFork(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel() (+114 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (112): checkMissingReviewStatuses(), cleanupOrphanedReviewSessions(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt() (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (109): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+101 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (103): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+95 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (101): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+93 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (85): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (108): embedAction(), confirmCost(), enrichAction(), formatCost(), RawFilter, SearchMode, SearchQuery, searchSessions() (+100 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (94): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, SwitchModelModal(), SwitchModelModalProps, WorkspaceStatusOverview() (+86 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (95): ensureDefaultConversationModel(), CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings() (+87 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (90): getDefaultConversationModel(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+82 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (76): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (92): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), cloisterRouteLayer, getCloisterAgentsHealthRoute (+84 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (89): AgentRuntimeState, detectPlatform(), Platform, agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), deleteAgentRoute, EMPTY_CONVERSATION (+81 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (72): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc (+64 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (82): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocumentFromString() (+74 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (75): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), cleanupLegacyRuntimeSymlinks() (+67 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (82): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+74 more)
...
Cohesion: 0.04
Nodes (83): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+75 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (71): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+63 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (79): defaults, first, { models }, second, MODEL_DEPRECATIONS, deprecatedIds, resolved, result (+71 more)
...
Cohesion: 0.05
Nodes (75): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+67 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (66): transitionIssueToVerifyingOnMain(), importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (69): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+61 more)
...
Cohesion: 0.04
Nodes (68): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+60 more)
...
Cohesion: 0.04
Nodes (61): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+53 more)
...
Cohesion: 0.03
Nodes (54): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+46 more)
...
Cohesion: 0.06
Nodes (55): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+47 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (49): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+41 more)
...
Cohesion: 0.04
Nodes (55): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+47 more)
...
Cohesion: 0.05
Nodes (65): postAgentMessageLikeRoute(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader() (+57 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (41): parsePiSession(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles() (+33 more)
...
Cohesion: 0.06
Nodes (55): buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+47 more)
...
Cohesion: 0.05
Nodes (56): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+48 more)
...
Cohesion: 0.04
Nodes (45): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, useIssueCostStream(), comparePipelineIssues() (+37 more)
...
Cohesion: 0.07
Nodes (46): assertSafeAgentId(), assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+38 more)
...
Cohesion: 0.04
Nodes (53): result, createSessionAsyncEffect(), resizeWindowAsyncEffect(), sendKeysEffect(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync (+45 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (33): SETTINGS_FILE, getKimiAnthropicBaseUrl(), getProviderEnv(), ProviderAuthType, ProviderName, PROVIDERS, generateRouterConfigFromWorkTypes(), Provider (+25 more)
...
Cohesion: 0.05
Nodes (40): RestartLockHandle, allowedOrigin(), applyCors(), heldRestartMessage(), LOG_FILE, platformConfig, sendJson(), server (+32 more)
...
Cohesion: 0.05
Nodes (37): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), ReadEventsOptions (+29 more)
...
Cohesion: 0.06
Nodes (25): issues, result, loadReviewStatusesForIssues(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+17 more)
...
Cohesion: 0.07
Nodes (37): checkStuckWorkAgents(), parseThinkingDuration(), buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext (+29 more)
...
Cohesion: 0.08
Nodes (41): resolveArchiveDir(), resolveStatusFile(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput (+33 more)
...
Cohesion: 0.08
Nodes (31): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+23 more)
...
Cohesion: 0.11
Nodes (39): archiveWorkspaceArtifactsImpl(), findAllWorkspacePaths(), findWorkspacePath(), applyLabelGitHubImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), execAsync, buildPlaceholders() (+31 more)
...
Cohesion: 0.07
Nodes (33): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+25 more)
...
Cohesion: 0.08
Nodes (26): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, findWorkspacePath(), ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd() (+18 more)
...
Cohesion: 0.09
Nodes (23): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry() (+15 more)
...
Cohesion: 0.09
Nodes (11): buildChildEnvWithoutTmux(), BunPtyProcess, isBun(), NodePtyProcess, PtyProcess, spawnPtyImmediate(), TerminalService, TerminalServiceLive (+3 more)
...
Cohesion: 0.16
Nodes (16): readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths(), writeWorkspaceContinue() (+8 more)
...
Cohesion: 0.23
Nodes (14): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockError (+6 more)
...
Cohesion: 0.27
Nodes (7): isErrnoException(), readRestartStatus(), RestartStatus, RestartStatusError, restartStatusPath(), RestartTrigger, writeRestartStatus()
...
Cohesion: 0.31
Nodes (8): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), normalizePermissionInputPreview(), PermissionPayloadValidationError, utf8ByteLength()
...
- **Why does `fetch` connect `Community 3` to `Community 1`, `Community 259`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 275`, `Community 149`, `Community 279`, `Community 24`, `Community 27`, `Community 157`, `Community 30`, `Community 424`, `Community 41`, `Community 43`, `Community 173`, `Community 45`, `Community 688`, `Community 52`, `Community 54`, `Community 56`, `Community 443`, `Community 60`, `Community 62`, `Community 63`, `Community 192`, `Community 198`, `Community 74`, `Community 459`, `Community 76`, `Community 207`, `Community 83`, `Community 217`, `Community 90`, `Community 733`, `Community 350`, `Community 96`, `Community 738`, `Community 740`, `Community 230`, `Community 621`, `Community 112`, `Community 250`, `Community 382`, `Community 127`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 21` to `Community 35`, `Community 4`, `Community 99`, `Community 7`, `Community 423`, `Community 206`, `Community 307`, `Community 86`, `Community 22`, `Community 406`, `Community 25`, `Community 154`, `Community 27`, `Community 29`, `Community 543`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 290` to `Community 2`, `Community 261`, `Community 6`, `Community 262`, `Community 264`, `Community 267`, `Community 652`, `Community 18`, `Community 146`, `Community 20`, `Community 22`, `Community 23`, `Community 407`, `Community 155`, `Community 27`, `Community 543`, `Community 161`, `Community 34`, `Community 39`, `Community 41`, `Community 426`, `Community 175`, `Community 51`, `Community 52`, `Community 181`, `Community 440`, `Community 442`, `Community 571`, `Community 189`, `Community 192`, `Community 64`, `Community 66`, `Community 69`, `Community 454`, `Community 71`, `Community 327`, `Community 75`, `Community 76`, `Community 460`, `Community 332`, `Community 204`, `Community 203`, `Community 209`, `Community 461`, `Community 84`, `Community 473`, `Community 90`, `Community 475`, `Community 218`, `Community 89`, `Community 95`, `Community 480`, `Community 352`, `Community 110`, `Community 111`, `Community 113`, `Community 501`, `Community 249`, `Community 379`?**
