...
## Corpus Check
- 1566 files · ~2,061,686 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21631 nodes · 32040 edges · 1137 communities (1098 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff960599`
...
## Communities (1137 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (198): cleanupStaleAgentState(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep() (+190 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (135): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+127 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (154): checkPostReviewCommits(), setAgentStoppedNotifier(), after, before, blockers, result, statuses, after (+146 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (161): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+153 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (134): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+126 more)
...
Cohesion: 0.03
Nodes (128): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkFirstCompletionAgents() (+120 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (103): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), Conversation, ConversationList(), ConversationListProps (+95 more)
...
Cohesion: 0.03
Nodes (92): waitForPiAgentReady(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder, checkFn (+84 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (96): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+88 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (101): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, AwaitingInputDetection, encodeClaudeProjectDir(), PrdLocation (+93 more)
...
Cohesion: 0.04
Nodes (86): killAllReviewSessions(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+78 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (76): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+68 more)
...
Cohesion: 0.04
Nodes (72): checkDeadEndAgents(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback(), agentDir, mockGetAgentRuntimeState, mockGetAgentState (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (75): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+67 more)
...
Cohesion: 0.07
Nodes (79): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath() (+71 more)
...
Cohesion: 0.04
Nodes (61): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+53 more)
...
Cohesion: 0.04
Nodes (62): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState() (+54 more)
...
Cohesion: 0.04
Nodes (50): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+42 more)
...
Cohesion: 0.06
Nodes (62): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+54 more)
...
Cohesion: 0.05
Nodes (54): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), ensurePanDirs() (+46 more)
...
Cohesion: 0.05
Nodes (54): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, migrateSyncTargets(), FileStatus (+46 more)
...
Cohesion: 0.06
Nodes (46): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, activeRoleRunExists(), AgentCrashTracker (+38 more)
...
Cohesion: 0.07
Nodes (41): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), wipeCommand(), WipeOptions, extractNumber(), extractPrefix() (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (41): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec() (+33 more)
...
Cohesion: 0.05
Nodes (38): SETTINGS_FILE, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config (+30 more)
...
Cohesion: 0.07
Nodes (38): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+30 more)
...
Cohesion: 0.13
Nodes (43): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+35 more)
...
Cohesion: 0.07
Nodes (35): TurnDiffSummary, ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+27 more)
...
Cohesion: 0.07
Nodes (34): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+26 more)
...
Cohesion: 0.08
Nodes (21): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+13 more)
...
Cohesion: 0.1
Nodes (23): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), getForgeAdapter(), {
  execMock,
...
Cohesion: 0.17
Nodes (18): clearFeedbackFiles(), readWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+10 more)
...
Cohesion: 0.11
Nodes (12): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, resetTransport(), RpcClientFactory (+4 more)
...
- **Why does `fetch` connect `Community 5` to `Community 1`, `Community 2`, `Community 261`, `Community 7`, `Community 8`, `Community 522`, `Community 267`, `Community 12`, `Community 10`, `Community 14`, `Community 16`, `Community 145`, `Community 146`, `Community 18`, `Community 21`, `Community 22`, `Community 26`, `Community 27`, `Community 541`, `Community 413`, `Community 31`, `Community 801`, `Community 34`, `Community 165`, `Community 550`, `Community 166`, `Community 37`, `Community 40`, `Community 46`, `Community 49`, `Community 51`, `Community 181`, `Community 58`, `Community 957`, `Community 588`, `Community 80`, `Community 227`, `Community 104`, `Community 746`, `Community 629`, `Community 631`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 36`, `Community 548`, `Community 217`, `Community 589`, `Community 114`, `Community 53`, `Community 25`, `Community 58`, `Community 28`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 131` to `Community 20`, `Community 12`?**
