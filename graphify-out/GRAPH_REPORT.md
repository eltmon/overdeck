...
## Corpus Check
- 1878 files · ~2,476,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26665 nodes · 41408 edges · 1255 communities (1205 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `333a3548`
...
## Communities (1255 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (248): resolveAutoResumeConfigForIssue(), monitorReviewConvoySignals(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions (+240 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (148): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+140 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (150): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+142 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (121): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+113 more)
...
Cohesion: 0.03
Nodes (89): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, TmuxError, agentState, callOrder, checkFn (+81 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (110): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+102 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (109): checkMissingReviewStatuses(), checkPostReviewCommits(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+101 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (94): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+86 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (95): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+87 more)
...
Cohesion: 0.03
Nodes (86): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+78 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (99): PlanningState, ZoneAActionsState, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS (+91 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (88): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+80 more)
...
Cohesion: 0.03
Nodes (84): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+76 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (94): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), cleanFile(), configCommand() (+86 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (100): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), RawFilter, SearchMode, SearchQuery (+92 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (83): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (84): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+76 more)
...
Cohesion: 0.04
Nodes (87): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+79 more)
...
Cohesion: 0.03
Nodes (75): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+67 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (83): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+75 more)
...
Cohesion: 0.04
Nodes (83): isPaneDeadAsyncEffect(), listPaneValuesAsyncEffect(), listSessionNamesAsyncEffect(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+75 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (78): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+70 more)
...
Cohesion: 0.04
Nodes (76): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+68 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (78): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+70 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (79): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+71 more)
...
Cohesion: 0.03
Nodes (65): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+57 more)
...
Cohesion: 0.05
Nodes (66): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+58 more)
...
Cohesion: 0.04
Nodes (51): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, FsError (+43 more)
...
Cohesion: 0.05
Nodes (47): configShadowCommand(), ShadowOptions, getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions (+39 more)
...
Cohesion: 0.05
Nodes (48): cn(), MetricStrip(), MetricStripProps, MetricStripTile, MetricDeltaDirection, MetricTile(), MetricTileDelta, MetricTileProps (+40 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (52): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearStaleCiFeedback(), agentDir, mockGetAgentRuntimeState, mockGetAgentState (+44 more)
...
Cohesion: 0.06
Nodes (46): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+38 more)
...
Cohesion: 0.05
Nodes (44): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+36 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (44): getDefaultConversationModel(), VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab (+36 more)
...
Cohesion: 0.04
Nodes (44): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+36 more)
...
Cohesion: 0.08
Nodes (49): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), requireTrustedOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+41 more)
...
Cohesion: 0.05
Nodes (42): announceMerge(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+34 more)
...
Cohesion: 0.06
Nodes (39): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, closeMemoryFtsDatabases() (+31 more)
...
Cohesion: 0.08
Nodes (45): sshCommand(), CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult (+37 more)
...
Cohesion: 0.07
Nodes (42): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+34 more)
...
Cohesion: 0.05
Nodes (40): agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, authorized(), eventsRouteLayer, getEventStreamRoute, getEventVersionRoute, getHeader() (+32 more)
...
Cohesion: 0.06
Nodes (30): SearchResult, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue(), mapEventToDelta() (+22 more)
...
Cohesion: 0.07
Nodes (24): TranscriptCheckpoint, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), stopTranscriptPoller() (+16 more)
...
Cohesion: 0.07
Nodes (22): AgentRuntimeState, listRunningAgentsEffect(), applyDeadSessionReset(), buildMemoryIdentity(), ClaudeCodeTranscriptSource, ClaudeCodeTranscriptSourceOptions, createDefaultTranscriptSourceRegistry(), defaultTranscriptSourceRegistry (+14 more)
...
Cohesion: 0.1
Nodes (30): getGlobalConfigPath(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority() (+22 more)
...
Cohesion: 0.08
Nodes (25): sentinel, markAgentStateServiceInProcess(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore (+17 more)
...
Cohesion: 0.09
Nodes (26): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), getAllActiveQueues(), PipelineEvent, setPipelineHandler(), startCliproxyWatchdog(), attachmentCleanupTimer, buildAgentStatusChangedPayload() (+18 more)
...
Cohesion: 0.12
Nodes (30): FlywheelScope, RoleEffort, abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+22 more)
...
Cohesion: 0.1
Nodes (18): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), ReadEventsOptions, replaceEventsFile() (+10 more)
...
Cohesion: 0.1
Nodes (20): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+12 more)
...
Cohesion: 0.13
Nodes (17): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerNetwork, DockerPsRaw, DockerStatsCollector, DockerStatsRaw (+9 more)
...
Cohesion: 0.17
Nodes (15): writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback() (+7 more)
...
Cohesion: 0.15
Nodes (11): MetricSignal, costSub, costTile, costValue, icon, negativeDelta, positiveDelta, strip (+3 more)
...
Cohesion: 0.2
Nodes (9): agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), log, mockAppendFile, mockGetAgentStateAsync, mockMkdir, mockStopAgentAsync (+1 more)
...
Cohesion: 0.29
Nodes (8): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged()
...
Cohesion: 0.27
Nodes (6): code:block13 (Side Quest Workflow:), code:block14 (Main task: Adding user profiles), code:block23 (Unblocking Workflow:), code:block24 (Situation: bd ready shows nothing), Side Quest Handling {#side-quests}, Unblocking Work {#unblocking}
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 4`, `Community 6`, `Community 263`, `Community 8`, `Community 11`, `Community 908`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 21`, `Community 406`, `Community 23`, `Community 153`, `Community 26`, `Community 27`, `Community 154`, `Community 29`, `Community 25`, `Community 288`, `Community 160`, `Community 36`, `Community 40`, `Community 42`, `Community 43`, `Community 685`, `Community 52`, `Community 438`, `Community 56`, `Community 61`, `Community 62`, `Community 63`, `Community 192`, `Community 65`, `Community 67`, `Community 70`, `Community 328`, `Community 200`, `Community 74`, `Community 337`, `Community 210`, `Community 81`, `Community 88`, `Community 218`, `Community 730`, `Community 221`, `Community 734`, `Community 99`, `Community 613`, `Community 232`, `Community 489`, `Community 233`, `Community 113`, `Community 381`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 16` to `Community 33`, `Community 35`, `Community 100`, `Community 4`, `Community 36`, `Community 10`, `Community 45`, `Community 303`, `Community 304`, `Community 209`, `Community 83`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 50` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 264`, `Community 9`, `Community 10`, `Community 265`, `Community 13`, `Community 17`, `Community 274`, `Community 20`, `Community 21`, `Community 277`, `Community 24`, `Community 25`, `Community 32`, `Community 161`, `Community 36`, `Community 165`, `Community 423`, `Community 40`, `Community 45`, `Community 48`, `Community 562`, `Community 435`, `Community 52`, `Community 437`, `Community 180`, `Community 55`, `Community 192`, `Community 64`, `Community 450`, `Community 69`, `Community 453`, `Community 326`, `Community 201`, `Community 333`, `Community 78`, `Community 334`, `Community 464`, `Community 465`, `Community 207`, `Community 466`, `Community 468`, `Community 337`, `Community 87`, `Community 94`, `Community 102`, `Community 112`, `Community 242`, `Community 122`, `Community 251`, `Community 380`?**
