...
## Corpus Check
- 1548 files · ~2,065,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21611 nodes · 32058 edges · 1132 communities (1096 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 419 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c39af48a`
...
- `validateCwdContainment()` --calls--> `stat`  [INFERRED]
  src/dashboard/server/routes/conversations.ts → scripts/record-cost-event.ts

## Communities (1132 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (166): readCavemanVariant(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (154): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), doneCommand(), DoneOptions, execAsync, getGitHubConfig() (+146 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (152): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes(), execAsync (+144 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (140): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkFirstCompletionAgents() (+132 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (131): setAgentStoppedNotifier(), after, before, blockers, result, statuses, after, row (+123 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (133): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), buildMergeAgentMemory(), checkAndRotateIfNeeded() (+125 more)
...
Cohesion: 0.02
Nodes (119): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+111 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (102): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+94 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (112): checkDeadEndAgents(), clearStaleCiFeedback(), dispatchTestAgentAndNotify(), buildPolyrepoContext(), buildWorkAgentPrompt(), getTrackerContext(), readPlanningContext(), closeOutCommand() (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (90): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+82 more)
...
Cohesion: 0.03
Nodes (85): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+77 more)
...
Cohesion: 0.03
Nodes (69): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+61 more)
...
Cohesion: 0.03
Nodes (69): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+61 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (77): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+69 more)
...
Cohesion: 0.03
Nodes (70): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTimestamp() (+62 more)
...
Cohesion: 0.05
Nodes (68): killCommand(), KillOptions, destroyRemoteWorkspace(), getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+60 more)
...
Cohesion: 0.04
Nodes (60): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), beadsDir, doc, badPath (+52 more)
...
Cohesion: 0.05
Nodes (61): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+53 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (48): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+40 more)
...
Cohesion: 0.06
Nodes (58): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+50 more)
...
Cohesion: 0.04
Nodes (45): future, id, rows, rows1, rows2, initSchema(), base, cols (+37 more)
...
Cohesion: 0.06
Nodes (29): issues, result, importTrackerConfig(), getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry (+21 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (45): checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus(), registerInstallCommand() (+37 more)
...
Cohesion: 0.06
Nodes (38): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), getAllSessionTreesRoute (+30 more)
...
Cohesion: 0.06
Nodes (32): agentDir, envArg, options, state, stateFile, workspace, NormalizedConfig, getDebugInfo() (+24 more)
...
Cohesion: 0.07
Nodes (35): clearFeedbackFiles(), buildACLookupByTitle(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+27 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (29): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover() (+21 more)
...
Cohesion: 0.08
Nodes (37): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+29 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (36): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec() (+28 more)
...
Cohesion: 0.06
Nodes (35): ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, agentState, callOrder, checkFn, killed, mockGetAgentState (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.08
Nodes (39): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData() (+31 more)
...
Cohesion: 0.16
Nodes (39): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions, closeLinearDirect() (+31 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (29): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+21 more)
...
Cohesion: 0.08
Nodes (26): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+18 more)
...
Cohesion: 0.11
Nodes (28): closeIssue(), closeResult, command, ctx, labelResult, prResult, approve(), buildResult() (+20 more)
...
Cohesion: 0.08
Nodes (25): cleanupLabelsGitHub(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel, mockClientIssueLabels (+17 more)

### Community 204 - "Community 204"
Cohesion: 0.15
Nodes (19): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir(), panopticonDir(), PiRuntime (+11 more)
...
Cohesion: 0.09
Nodes (25): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, __dirname, __filename (+17 more)
...
Cohesion: 0.12
Nodes (24): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), startPostLaunchSidecars() (+16 more)
...
Cohesion: 0.1
Nodes (15): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+7 more)
...
Cohesion: 0.16
Nodes (25): markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), getAttachmentCache(), getAttachmentCacheKey() (+17 more)
...
Cohesion: 0.11
Nodes (16): CloisterStatusBar(), getRenderablePatch(), DiffWorkerPoolProvider(), Tab, NAV_GROUPS, Sidebar(), SidebarProps, Theme (+8 more)
...
Cohesion: 0.19
Nodes (14): getForgeAdapter(), ensureMergeSetForIssue(), getMergeSet(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue() (+6 more)
...
Cohesion: 0.23
Nodes (12): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), NormalizedCavemanConfig (+4 more)
...
Cohesion: 0.3
Nodes (13): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath(), readEventsFromLine() (+5 more)
...
Cohesion: 0.14
Nodes (12): compressSrc, destDir, dir, hookFiles, hooksDir, keys, mockFileURLToPath, mockHomedir (+4 more)
...
Cohesion: 0.2
Nodes (8): CostEvent, colNames, cols, db, disabledRow, enabledRow, [row], rows
...
Cohesion: 0.6
Nodes (5): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation()
...
## Knowledge Gaps
- **11514 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11509 more)
...
- **Why does `fetch` connect `Community 7` to `Community 1`, `Community 389`, `Community 6`, `Community 10`, `Community 395`, `Community 12`, `Community 14`, `Community 270`, `Community 144`, `Community 17`, `Community 528`, `Community 16`, `Community 20`, `Community 23`, `Community 25`, `Community 154`, `Community 26`, `Community 31`, `Community 32`, `Community 36`, `Community 165`, `Community 39`, `Community 41`, `Community 42`, `Community 51`, `Community 57`, `Community 72`, `Community 330`, `Community 79`, `Community 593`, `Community 594`, `Community 597`, `Community 229`, `Community 754`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 126` to `Community 0`, `Community 11`, `Community 206`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 16` to `Community 88`, `Community 1019`?**
