...
## Corpus Check
- 1887 files · ~3,052,729 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26749 nodes · 41510 edges · 1287 communities (1233 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce7b69d8`
...
## Communities (1287 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (197): monitorReviewConvoySignals(), buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent() (+189 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (185): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+177 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (165): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (121): getTrackerContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+113 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (102): parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS (+94 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (126): buildPolyrepoContext(), killCommand(), KillOptions, registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions (+118 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (107): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+99 more)
...
Cohesion: 0.03
Nodes (83): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+75 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (108): embedAction(), confirmCost(), enrichAction(), formatCost(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode() (+100 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (90): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+82 more)
...
Cohesion: 0.03
Nodes (98): copySessionFromCompactBoundary(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult, canReplaceTitle() (+90 more)
...
Cohesion: 0.02
Nodes (83): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+75 more)
...
Cohesion: 0.03
Nodes (88): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+80 more)
...
Cohesion: 0.03
Nodes (81): getHealthThresholdsMs(), checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, AgentHealth (+73 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (80): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (81): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+73 more)
...
Cohesion: 0.04
Nodes (80): listPaneValuesAsyncEffect(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields() (+72 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (74): applyAgentUnpaused(), clearAgentPausedAsync(), clearAgentPausedEffect(), clearAgentTroubledEffect(), getAgentStateEffect(), isAgentPauseClear(), recordAgentFailureEffect(), saveAgentStateEffect() (+66 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (59): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+51 more)
...
Cohesion: 0.04
Nodes (57): fsHooks, path, paths, after, doc, filename, path, getPackageVersion() (+49 more)
...
Cohesion: 0.04
Nodes (67): readCavemanVariant(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+59 more)
...
Cohesion: 0.03
Nodes (66): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+58 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (65): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+57 more)
...
Cohesion: 0.04
Nodes (56): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+48 more)
...
Cohesion: 0.05
Nodes (51): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (56): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+48 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (58): makeTestLayer(), makeTestService(), runWithService(), sentinel, eightDaysAgo, events, payload, r1 (+50 more)
...
Cohesion: 0.06
Nodes (62): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+54 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (56): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+48 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (57): getMemoryStatus(), events, identity, writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir() (+49 more)
...
Cohesion: 0.07
Nodes (55): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, createSummaryFork(), AGENT_CONVERSATION_PREFIXES (+47 more)
...
Cohesion: 0.09
Nodes (53): extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect() (+45 more)
...
Cohesion: 0.05
Nodes (40): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+32 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (29): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+21 more)
...
Cohesion: 0.06
Nodes (45): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest, ManifestEntry (+37 more)
...
Cohesion: 0.06
Nodes (48): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+40 more)
...
Cohesion: 0.05
Nodes (48): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceShape (+40 more)
...
Cohesion: 0.06
Nodes (40): createHumeConfig(), deleteHumeConfig(), humeFetch(), content, d, existingDir, lines, oldDir (+32 more)
...
Cohesion: 0.07
Nodes (41): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+33 more)
...
Cohesion: 0.08
Nodes (37): insertCostEvent(), ExtractedPayload, fetchFn, provider, result, StubExtractionProvider, AnthropicExtractionProvider, AnthropicCompatibleResponse (+29 more)
...
Cohesion: 0.06
Nodes (39): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), killPostMergeRoleSessions(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), isReviewSessionForIssue(), killAllReviewerSessions() (+31 more)
...
Cohesion: 0.09
Nodes (43): flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus (+35 more)

### Community 107 - "Community 107"
Cohesion: 0.07
Nodes (37): ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), execAsync (+29 more)
...
Cohesion: 0.07
Nodes (28): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getUnsyncedHistory() (+20 more)
...
Cohesion: 0.07
Nodes (34): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntry() (+26 more)
...
Cohesion: 0.07
Nodes (33): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+25 more)
...
Cohesion: 0.06
Nodes (36): BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute, getFlywheelConversationRoute (+28 more)
...
Cohesion: 0.06
Nodes (28): ActivityLevel, ActivitySource, emitActivityEntry(), EmitActivityOptions, emitDashboardLifecycle(), EmitDetailedOptions, EmitTtsOptions, data (+20 more)
...
Cohesion: 0.07
Nodes (29): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardMutationJsonHeaders(), dashboardSessionUrl() (+21 more)
...
Cohesion: 0.08
Nodes (36): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchPlanningData() (+28 more)
...
Cohesion: 0.07
Nodes (25): HumeApiError, HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials() (+17 more)
...
Cohesion: 0.1
Nodes (31): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+23 more)
...
Cohesion: 0.07
Nodes (24): SearchResult, getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+16 more)
...
Cohesion: 0.07
Nodes (29): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+21 more)

### Community 207 - "Community 207"
Cohesion: 0.11
Nodes (33): postAgentMessageLikeRoute(), validateAgentMessageOrigin(), rejectInvalidOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+25 more)
...
Cohesion: 0.12
Nodes (32): loadConfigAsyncNoMigrationEffect(), runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+24 more)
...
Cohesion: 0.1
Nodes (26): Access, getIndexStats(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+18 more)
...
Cohesion: 0.07
Nodes (23): markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), saveSessionId(), agentId, dir, lifecycle, sessionExistsSpy (+15 more)
...
Cohesion: 0.08
Nodes (24): buildACLookupByTitle(), buildActiveSliceContext(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback(), WorkAgentPromptContext (+16 more)
...
Cohesion: 0.1
Nodes (5): getProjectDirs(), getSessionFiles(), parseClaudeSession(), ClaudeCodeRuntime, ClaudeCodeRuntimeEffect
...
Cohesion: 0.09
Nodes (25): getTtsDaemonAuthHeaders(), getTtsDaemonAuthToken(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+17 more)
...
Cohesion: 0.08
Nodes (25): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired, CodexAuthMissing (+17 more)
...
Cohesion: 0.13
Nodes (17): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, resolveBundledServerPath() (+9 more)
...
Cohesion: 0.14
Nodes (19): readFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths() (+11 more)
...
Cohesion: 0.13
Nodes (19): cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+11 more)

### Community 363 - "Community 363"
Cohesion: 0.12
Nodes (22): AutoCreateStateConfig, CANONICAL_STATES, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS, getLinearStateName(), getStateLabel() (+14 more)
...
Cohesion: 0.12
Nodes (19): emitActivityDetailed(), withConcurrencyLimit(), getEventStore(), pollOnce(), AgentOutputServiceState, diffLines(), pollOnce(), serviceState (+11 more)
...
Cohesion: 0.12
Nodes (12): NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv() (+4 more)
...
Cohesion: 0.15
Nodes (17): getCavemanHooksDir(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript() (+9 more)
...
Cohesion: 0.13
Nodes (14): runCostSync(), CostEvent, parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), insertCostEvents(), colNames (+6 more)
...
Cohesion: 0.12
Nodes (13): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+5 more)
...
Cohesion: 0.13
Nodes (3): FlyExecResult, FlyMachine, FlyMachineConfig
...
Cohesion: 0.22
Nodes (9): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), CanonicalState, mapGitHubStateToCanonical(), mocks (+1 more)
...
Cohesion: 0.28
Nodes (9): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, listSessionNamesAsync() (+1 more)
...
- **Why does `fetch` connect `Community 2` to `Community 256`, `Community 129`, `Community 4`, `Community 390`, `Community 8`, `Community 9`, `Community 138`, `Community 267`, `Community 10`, `Community 12`, `Community 271`, `Community 16`, `Community 18`, `Community 532`, `Community 661`, `Community 149`, `Community 22`, `Community 24`, `Community 153`, `Community 26`, `Community 283`, `Community 27`, `Community 158`, `Community 31`, `Community 33`, `Community 34`, `Community 38`, `Community 43`, `Community 44`, `Community 45`, `Community 50`, `Community 188`, `Community 700`, `Community 63`, `Community 327`, `Community 329`, `Community 73`, `Community 74`, `Community 204`, `Community 77`, `Community 79`, `Community 465`, `Community 339`, `Community 86`, `Community 342`, `Community 92`, `Community 101`, `Community 230`, `Community 359`, `Community 233`, `Community 123`, `Community 750`, `Community 751`, `Community 753`, `Community 245`, `Community 635`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 33` to `Community 257`, `Community 388`, `Community 552`, `Community 201`, `Community 13`, `Community 174`, `Community 17`, `Community 51`, `Community 19`, `Community 22`, `Community 23`, `Community 28`, `Community 254`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 63` to `Community 0`, `Community 385`, `Community 1`, `Community 1156`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 137`, `Community 138`, `Community 270`, `Community 271`, `Community 14`, `Community 145`, `Community 274`, `Community 19`, `Community 277`, `Community 278`, `Community 534`, `Community 22`, `Community 157`, `Community 30`, `Community 159`, `Community 552`, `Community 44`, `Community 173`, `Community 175`, `Community 435`, `Community 52`, `Community 309`, `Community 436`, `Community 61`, `Community 447`, `Community 193`, `Community 69`, `Community 70`, `Community 71`, `Community 200`, `Community 198`, `Community 77`, `Community 334`, `Community 461`, `Community 78`, `Community 337`, `Community 338`, `Community 462`, `Community 467`, `Community 85`, `Community 88`, `Community 344`, `Community 478`, `Community 480`, `Community 482`, `Community 98`, `Community 486`, `Community 108`, `Community 109`, `Community 241`, `Community 244`, `Community 501`, `Community 120`, `Community 636`, `Community 637`, `Community 255`?**
