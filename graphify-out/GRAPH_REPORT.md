# Graph Report - panopticon-cli  (2026-05-11)

## Corpus Check
- 1553 files · ~2,055,540 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23475 nodes · 42920 edges · 1150 communities (1101 shown, 49 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 658 edges (avg confidence: 0.81)
...
1. `specialists` - 257 edges
2. `ConversationEvent` - 232 edges
3. `execAsync` - 224 edges
4. `fetch` - 181 edges
5. `KanbanBoard()` - 136 edges
6. `config` - 121 edges
7. `resolveProjectFromIssue()` - 119 edges
8. `getDatabase()` - 110 edges
9. `Command Deck` - 94 edges
10. `result` - 91 edges
...
- `fetch` --calls--> `pan done Command`  [INFERRED]
  src/dashboard/frontend/src/components/__tests__/TerminalPanel.test.tsx → docs/QUICK-REFERENCE.md
- `readGlobalResourceConfig()` --calls--> `Access`  [INFERRED]
  src/dashboard/server/services/system-health-service.ts → docs/god-view.md
- `requestReviewCommand()` --calls--> `Color`  [INFERRED]
  src/cli/commands/request-review.ts → design/style-guide/STYLE-GUIDE.md
- `statusCommand()` --calls--> `Color`  [INFERRED]
  src/cli/commands/cloister/status.ts → design/style-guide/STYLE-GUIDE.md

## Communities (1150 total, 49 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (211): patrolWorkAgentResolutions(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+203 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (152): ~/.panopticon/agents/ State Directory, Agent Directory Structure, getHealthThresholdsMs(), HealthThresholds, loadCloisterConfig(), cleanupStaleAgentState(), getDeaconLogs(), getLastPatrolResult() (+144 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.03
Nodes (173): readCavemanVariant(), cleanupOrphanReviewerSessions(), getSpecialistState(), createSpecialistHandoff(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration() (+165 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (151): backup, bundledFrontendIndex, bundledServer, child, composeFile, configContent, configFile, containerCheck (+143 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (133): ActivityView(), getModelStyle(), ModelBadge(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), BootstrapGate() (+125 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (158): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), killOrphanedWorkspaceProcesses(), recoverOrphanedAgents(), startDeacon(), archiveReviewerRound(), buildReviewFeedbackBody() (+150 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.03
Nodes (147): cleanupSpawnAndOrphanedStashes(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+139 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (131): CloisterStatus, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), ActivityEntry, AgentList(), AgentListProps (+123 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.03
Nodes (136): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, fmtCost(), ALL_TABS (+128 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.03
Nodes (138): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), createCostCommand(), getGitHubConfig(), installGitHooks(), determineWorkspaceLocation() (+130 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.03
Nodes (114): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), config, AutoActions, AutoRestartConfig (+106 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.03
Nodes (92): getProjectDirs(), getSessionFiles(), parseClaudeSession(), parsePiSession(), parseSessionFile(), abortSignal(), emitActivity(), emitAgentEvent() (+84 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.03
Nodes (124): EventMetadata, ReadEventsOptions, PendingOperation, authorized(), formatFrame(), getEventStreamRoute, getEventVersionRoute, getHeader() (+116 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.03
Nodes (115): getActiveSessionModel(), cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing() (+107 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.03
Nodes (115): addLog(), apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry(), checkFirstCompletionAgents(), checkHeartbeat() (+107 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (99): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+91 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.05
Nodes (106): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+98 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.04
Nodes (93): BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getLatestVersion(), isNewer(), updateCommand() (+85 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.04
Nodes (93): AgentCard(), AgentCardProps, AgentPhase, AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps, Capability, CAPABILITY_INFO (+85 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.04
Nodes (91): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+83 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.04
Nodes (99): parseDifficultyLabel(), LiveLastHeard(), stalenessClass(), BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult (+91 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.04
Nodes (86): ModelGroup, fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+78 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.04
Nodes (95): determineCavemanVariant(), injectCavemanSettings(), syncDnsToWindows(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, ProjectConfig (+87 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (85): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), onPlan, fetchOutput() (+77 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (98): detectProviderEnvConflicts(), clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, WorkhorsesConfig, WorkhorseSlot (+90 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.05
Nodes (92): checkPendingTestDispatch(), checkStuckWorkAgents(), spawnInspectAgent(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistBaseCommand(), buildTmuxEnvFlags() (+84 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.05
Nodes (91): Command Deck (Core Concept), Access, getAgentRuntimeStateAsync(), snapshotToRuntimeState(), withConcurrencyLimit(), canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere() (+83 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.05
Nodes (73): Work Agent (shown in inspector terminal), PlanningState, useZoneAActions(), ZoneAActionsState, CodexAuthBanner(), copyToClipboard(), formatCost(), InspectorPanel() (+65 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.04
Nodes (81): canonicalStatus(), emitEvent(), findLinearState(), GITHUB_STATE_LABELS, IssueLifecycle, IssueLifecycleLive, IssueLifecycleShape, IssueLifecycleWithClientLive (+73 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (76): IssueStats, calculateCost(), CostEntry, DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing, anthropicModels (+68 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.05
Nodes (86): ensureDashboardBundle(), traefikDir, doctorCommand(), devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig() (+78 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.04
Nodes (73): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ConversationPanel(), ConversationPanelProps (+65 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.05
Nodes (76): pendingCommand(), after, before, blockers, result, statuses, after, row (+68 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (84): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+76 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.04
Nodes (71): onToggle, ReviewButtonInput, ReviewButtonState, cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps (+63 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.04
Nodes (80): mockGetAgentHealth, CapabilityStats, DailyStats, fetchRuntimeMetrics(), formatCost(), formatDuration(), formatPercent(), getRuntimeIcon() (+72 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.05
Nodes (71): parseContainerServiceName(), parseIssueIdFromText(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), defaultExpandedFromState(), FeatureContextMenu() (+63 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.06
Nodes (66): configShadowCommand(), ShadowOptions, planCommand(), PlanOptions, runDiscoveryPhase(), refreshCommand(), refreshFromLinear(), RefreshOptions (+58 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.04
Nodes (65): DeaconLogEntry, SpecialistHealthState, firstSessionPanel, firstWorkbench, overview, renderCommandDeck(), workbench, DeaconLogEntry (+57 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.05
Nodes (58): registerAdminCommands(), showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand() (+50 more)
...
Cohesion: 0.06
Nodes (62): stampPlanForFinalization(), vBRIEF Lifecycle, formatDate(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), after, continueContent (+54 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.08
Nodes (55): switchModel(), ZoneActionStrip(), ZoneActionStripProps, MenuDivider(), OverflowItem(), ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+47 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.06
Nodes (59): getCavemanExperimentData(), httpHandler(), ReadModelServiceLive, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+51 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.06
Nodes (64): checkApiErrorAgents(), REVIEW_SUB_ROLES, reviewerOutputPath(), ReviewerResult, ReviewerState, ReviewSubRole, waitForReviewerOutputs(), WaitForReviewerOutputsOpts (+56 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.05
Nodes (54): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, MOCK_ISSUE, xterm, SkillsList(), formatBytes(), KillButton(), severityClasses() (+46 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.06
Nodes (62): PRIORITY_LABELS, buildChildStoriesFromRally(), cleanupAgentStateDirs(), closeIssuePullRequest(), execAsync, execFileAsync, FetchDiscussionsDeps, fetchIssuePullRequest() (+54 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.03
Nodes (58): future, id, rows, rows1, rows2, dir, event, eventsDir1 (+50 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.05
Nodes (51): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, debounce(), isMac, TerminalSizeMessage, TerminalSnapshotMessage, checkbox (+43 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.07
Nodes (57): forkCommand(), ForkOptions, CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps() (+49 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.08
Nodes (8): normalizeIssueId(), GitHubTracker, parseIssueNumber(), GitLabTracker, LinearTracker, escapeQueryValue(), RallyTracker, validateRallyId()

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.05
Nodes (52): next, restored, s, start, withAgent, activeSpec, agent2, baseAgent (+44 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.05
Nodes (57): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+49 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.05
Nodes (51): logSpy, now, output, payload, {
  shadowMock, cvMock, contextMock, healthMock,
  getShadowStateMock, pingAgentMock, getAgentCVMock, getAgentRuntimeStateMock,
}, workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, activeIssues (+43 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.05
Nodes (55): Agent Enrichment Service, agentDir, missing, result, snapshot, status, AgentEnrichment, computeAgentEnrichment() (+47 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.06
Nodes (56): buildReleaseNotesMarkdown(), contractsPackageJsonPath, desktopPackageJsonPath, __dirname, ensureCleanTree(), ensureMainBranch(), ensureTagDoesNotExist(), __filename (+48 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.08
Nodes (53): buildACLookupByTitle(), difficultyColor(), dryRun(), printWavePlan(), SpawnOptions, evaluateSpawnGuardrails(), autoAdvanceInFlight, buildSlotPrompt() (+45 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.06
Nodes (45): TABS, themeButton, VBriefDifficulty, VBriefEdgeType, VBriefItem, VBriefItemStatus, VBriefPlan, VBriefPriority (+37 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.07
Nodes (50): setAgentStoppedNotifier(), setPipelineHandler(), updated, EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+42 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.09
Nodes (45): error, RemoteProviderConfig, IssueNotFound, getTrackerKeyFromConfig(), config, originalEnv, tracker, error (+37 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.06
Nodes (52): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST() (+44 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.08
Nodes (52): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+44 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (55): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset) (+47 more)
...
Cohesion: 0.07
Nodes (30): ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS, cacheKey(), ChatMarkdown, ChatMarkdownErrorBoundary, ChatMarkdownProps, CodeBlock() (+22 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.05
Nodes (35): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BUCKET_STAGES, BucketedFeature, bucketFeature(), CostBadge() (+27 more)

### Community 66 - "GitHub Webhook Ingestion Handlers"
Cohesion: 0.07
Nodes (46): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+38 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.05
Nodes (43): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+35 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.07
Nodes (48): cleanupOldEvents(), CLOISTER_DB_PATH, deleteAgentHistory(), getAgentsWithHistory(), getAllHealthHistory(), getDatabaseStats(), getHealthDatabase(), getHealthHistory() (+40 more)

### Community 69 - "Swarm Dispatch and DAG Execution"
Cohesion: 0.09
Nodes (22): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), findProjectsByRallyProject(), scheduleNext(), computePlanningState() (+14 more)
...
Cohesion: 0.06
Nodes (44): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+36 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.06
Nodes (42): Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, loadSort(), loadTab() (+34 more)

### Community 73 - "Merge Queue and App Settings Database"
Cohesion: 0.09
Nodes (45): startPostLaunchSidecars(), startSidecars(), resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart() (+37 more)
...
Cohesion: 0.06
Nodes (42): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+34 more)

### Community 76 - "Cost Recovery Scripts and Latency Tests"
Cohesion: 0.04
Nodes (38): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile (+30 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (43): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCostForIssueFromDb(), getCostsByIssueFromDb() (+35 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.05
Nodes (42): CavemanVariant, PANOPTICON_HOME, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule (+34 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.13
Nodes (47): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset() (+39 more)

### Community 80 - "Skills Merge and Manifest Sync"
Cohesion: 0.04
Nodes (45): result, clearCacheRoute, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute, getDeaconPauseRoute (+37 more)
...
Cohesion: 0.07
Nodes (45): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+37 more)

### Community 85 - "Conversation Compaction and Fork Pipeline"
Cohesion: 0.09
Nodes (41): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), clearHook(), collectMail(), generateFixedPointPrompt(), getHook() (+33 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.1
Nodes (16): getIsolatedPlaywrightMcpConfig(), createFlyApiClient(), FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, execAsync, FlyProvider (+8 more)
...
Cohesion: 0.07
Nodes (46): AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, Verification Gate (PAN-174), Beads prerequisite for work agent start (422 without), Review cycle circuit breaker (max 3 auto-requeue), Context digest (cross-dispatch memory for test/merge agents), Convoy - Parallel Review Panel, Deacon health monitor (30s patrol, stuck detection) (+38 more)

### Community 92 - "Event Snapshot Cache and State Reducers"
Cohesion: 0.08
Nodes (39): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ActionKey (+31 more)

### Community 93 - "User Documentation and Provider Guides"
Cohesion: 0.06
Nodes (44): CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock, ConversationActivitySummary, ConversationWatchHandle, discoverSessionFile() (+36 more)

### Community 94 - "Traefik DNS and Platform Install Skills"
Cohesion: 0.07
Nodes (41): initialState, deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts() (+33 more)
...
Cohesion: 0.05
Nodes (45): Abort semantics, Acceptance criteria taxonomy, CLI reference, code:block1 (work role completes beads and signals done), code:yaml (work_types:), code:block2 (roles/review.md), code:block3 (.claude/agents/), code:markdown (# Verdict: APPROVED | CHANGES_REQUESTED | FAILED) (+37 more)
...
Cohesion: 0.05
Nodes (36): beadsDir, doc, makePlanWithAC(), doc, path, badPath, customPlanningDir, dir (+28 more)
...
Cohesion: 0.08
Nodes (35): SETTINGS_FILE, available, content, defaults, defaults1, defaults2, invalidSettings, settings (+27 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.09
Nodes (31): getGlobalRouter(), NormalizedConfig, ModelProvider, getAvailableModels(), selectModel(), getDebugInfo(), getGlobalRouter(), getModel() (+23 more)
...
Cohesion: 0.09
Nodes (39): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, blockerIcon(), fetchWorkspace(), forgeApprove(), forgeMerge() (+31 more)
...
Cohesion: 0.05
Nodes (34): skills, claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+26 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.08
Nodes (34): GLOBAL_CONFIG_PATH, detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample (+26 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.08
Nodes (28): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+20 more)
...
Cohesion: 0.08
Nodes (37): doneCommand(), DoneOptions, execAsync, isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+29 more)

### Community 128 - "Remote Agent Provisioning on Fly"
Cohesion: 0.14
Nodes (36): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+28 more)

### Community 129 - "Claude Code Hook Management"
Cohesion: 0.11
Nodes (37): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, showCommand(), continue-state.ts (+29 more)
...
Cohesion: 0.08
Nodes (33): MODEL_COLORS, executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity() (+25 more)

### Community 137 - "Shadow Engineering Observer and Monitoring"
Cohesion: 0.11
Nodes (31): TurnDiffSummary, buildFileDiffRenderKey(), clearDiffParamsFromUrl(), DiffFilePickerList(), DiffPanel(), DiffPanelProps, DiffThemeType, formatShortTimestamp() (+23 more)

### Community 138 - "Model Fallback and Routing"
Cohesion: 0.07
Nodes (28): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, allModels, anthropicOnly, TIER_RANK, calculateSkillScore() (+20 more)

### Community 139 - "GitHub App Merge and PR Integration"
Cohesion: 0.11
Nodes (32): writeStoryFeatureContext(), contextCommand(), ContextOptions, appendSummary(), checkContextBudget(), ContextBudget, estimateTokens(), generateSummaryEntry() (+24 more)
...
Cohesion: 0.08
Nodes (39): Agent Audit Report (2026-04-13), Build Pipeline Documentation, buildTaskPrompt() (specialist prompt dispatch), Merge Queue (SQLite-backed, per-project), dist/ Output Structure, Electron Desktop App (apps/desktop), inspect-agent (Specialist Per-Bead Verification), merge-agent (Specialist Merge Operations) (+31 more)

### Community 146 - "Skill Sync Mirror Tests"
Cohesion: 0.08
Nodes (35): ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getTodaySpecialistHandoffs(), readIssueSpecialistHandoffs(), readSpecialistHandoffs(), SpecialistHandoff (+27 more)

### Community 147 - "PRD Draft and Pan Directory Management"
Cohesion: 0.07
Nodes (33): AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, displayModelRef(), fetchAvailableModels(), fetchSettings(), isWorkhorseRef(), modelExists() (+25 more)

### Community 148 - "Claude Session JSONL Parsing and Costs"
Cohesion: 0.08
Nodes (33): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), closeDatabase(), getDatabasePath() (+25 more)
...
Cohesion: 0.13
Nodes (33): content, mockExeca, clearReviewStatus(), ApproveOptions, ArchiveOptions, DeepWipeOptions, getLinearApiKey(), LifecycleContext (+25 more)

### Community 155 - "Chat Composer Slash Command Editor"
Cohesion: 0.11
Nodes (35): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+27 more)
...
Cohesion: 0.1
Nodes (34): migrateConfigCommand(), MigrateConfigOptions, needsMigration(), BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings() (+26 more)

### Community 158 - "Specialist Handoff Logging and Queue Depth"
Cohesion: 0.08
Nodes (33): delay(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isSmeeProcessRunning(), isSmeeRunning(), errorSpy (+25 more)

### Community 159 - "Specialist Registry and Run Lifecycle"
Cohesion: 0.05
Nodes (36): Auto-Behaviors, Available MCP Tools, Beads Enforcement, Claude Code Channels (experimental), code:bash (# List all agent sessions), code:typescript (// Correct (in sendKeysAsync):), code:block3 (**PRD:** [`path/to/prd.md`](https link to the file in the re), Commit and Push When Working on Main (+28 more)
...
Cohesion: 0.1
Nodes (21): src, stripped, topLevelAwaits, buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, buildTmuxArgs() (+13 more)

### Community 165 - "Workspace Service and Agent Spawner Tests"
Cohesion: 0.06
Nodes (34): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, DomainEvent, AgentOutput (+26 more)
...
Cohesion: 0.06
Nodes (35): Advanced Features, bd vs TodoWrite, Beads - Persistent Task Memory for AI Agents, CLI Reference, Close & Reopen, code:bash (# Link beads issue to GitHub issue PAN-84), code:bash (bd show <id> --json              # Full issue details), code:bash (bd close <id> --reason "Completed" --json) (+27 more)
...
Cohesion: 0.13
Nodes (30): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+22 more)
...
Cohesion: 0.07
Nodes (26): config, env, mockExistsSync, mockExistsSync, mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateAsync (+18 more)
...
Cohesion: 0.11
Nodes (28): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, readInferenceDocument(), updateInferenceDocument() (+20 more)

### Community 197 - "Multi Tool Skill Sync Export"
Cohesion: 0.07
Nodes (15): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, client, FlyApiClient (+7 more)

### Community 198 - "Pi Session Cost Parser"
Cohesion: 0.07
Nodes (29): cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush, mockMarkWorkspaceStuck, result, cb (+21 more)
...
Cohesion: 0.06
Nodes (31): Backend Frameworks, code:yaml (projects:), code:bash (# Create workspace (uses configuration from projects.yaml)), code:yaml (services:), code:yaml (projects:), code:yaml (projects:), code:yaml (projects:), code:bash (cat ~/.panopticon/projects.yaml) (+23 more)
...
Cohesion: 0.16
Nodes (28): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), insertCostEvent(), insertCostEvents(), BUDGETS_FILE (+20 more)

### Community 205 - "Fix-All Flywheel Operational Docs"
Cohesion: 0.12
Nodes (29): reconcileAndCheckIfMerged(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), approveCommand(), cancelCommand(), collectInFlightRows() (+21 more)
...
Cohesion: 0.06
Nodes (30): Available Commands, Available Skills, Code Review, code:bash (# 1. Initialize Panopticon), code:bash (# 1. Optionally create a plan first), code:bash (# List all workspaces), Configuration, Configuration Files (+22 more)
...
Cohesion: 0.06
Nodes (30): Available TLDR Tools, Beads Tasks, code:block1 (1. Agent needs to understand auth.ts), code:bash (node -e "const fs=require('fs'); const p='.pan/spec.vbrief.j), code:bash (git fetch origin main && git rebase origin/main), code:bash (pan done {{ISSUE_ID}} -c "Work already complete from previou), code:json ({), code:bash (npm test                                         # Run tests) (+22 more)
...
Cohesion: 0.09
Nodes (25): TriageOptions, triage priority scoring matrix (P0-P4), analyzeIssue(), sortByPriority(), issues, options, result, results (+17 more)

### Community 217 - "Git Divergence and Conversation Patch Tests"
Cohesion: 0.14
Nodes (20): EventRouter(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, CacheEntry, loadSnapshotFromCache(), saveSnapshotToCache(), serialize() (+12 more)
...
Cohesion: 0.11
Nodes (24): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+16 more)

### Community 221 - "Fly Machine API Client"
Cohesion: 0.07
Nodes (29): 2026-04-12 — Run 1, 2026-04-12 — Run 2, 2026-04-12 — Run 3, 2026-04-13 — Run 4, 2026-04-13 — Run 8, 2026-04-14 — Run 9, Bug Log Template, code:block1 (### BUG: [Short description]) (+21 more)
...
Cohesion: 0.09
Nodes (26): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), SessionUsage, emptyUsage() (+18 more)
...
Cohesion: 0.12
Nodes (23): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+15 more)

### Community 229 - "Work Done and Rebase Pipeline Tests"
Cohesion: 0.17
Nodes (21): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), _get_default_sink_state(), Handler, load_base_model(), load_design_model() (+13 more)

### Community 230 - "Workspace Backup and Restore Commands"
Cohesion: 0.1
Nodes (22): getWindowDimensionsAsync(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+14 more)

### Community 231 - "Agent Activity View Dashboard Components"
Cohesion: 0.11
Nodes (25): AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+17 more)
...
Cohesion: 0.11
Nodes (20): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+12 more)
...
Cohesion: 0.13
Nodes (26): resolveModelId(), applyFallback(), applyTierAwareFallback(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+18 more)

### Community 247 - "Label Cleanup and Workflow Lifecycle Tests"
Cohesion: 0.1
Nodes (25): defaults, first, issueAgentTypes, { models }, second, models, getAllWorkTypes(), getWorkTypeMetadata() (+17 more)

### Community 248 - "Pi Extension Session Event Handlers"
Cohesion: 0.08
Nodes (24): conv, created, list, body, bytes, claudeProjectDir, conv, created (+16 more)
...
Cohesion: 0.07
Nodes (27): Agent Enrichment Service, API, Bulk apply, code:yaml (cloister:), code:bash (tsx scripts/deacon-ignore-bulk.ts --prefix MIN --states "in ), Configuration, Data model, Deacon Health Monitoring & Stuck Detection (+19 more)
...
Cohesion: 0.11
Nodes (25): result2, companionInTarget, contentAfterFirst, dstScript, gitCwd, gitManifestDir, manifest, manifestAfterFirst (+17 more)

### Community 260 - "System Health Command and CLI Tests"
Cohesion: 0.08
Nodes (11): build, cliPromptsDir, copyPrompts, dashboardDir, distDir, preservedDashboardDir, preservedRoot, projectRoot (+3 more)

### Community 261 - "Project Setup and Polyrepo Workspace PRDs"
Cohesion: 0.08
Nodes (18): getUnblockedItems(), TERMINAL_STATUSES, makeDoc(), first, found, path, paths, read (+10 more)
...
Cohesion: 0.07
Nodes (26): 1. Test Coverage, 2. No Blocking Operations, 3. No Dead Code, 4. Error Handling, 5. Type Safety, 6. Temporal Dead Zone (TDZ), Acceptance Criteria (from vBRIEF plan) — MANDATORY GATE, APPROVED (rare — only for PERFECT code) (+18 more)
...
Cohesion: 0.07
Nodes (27): code:bash (pan start PAN-999 --model claude-sonnet-4-5), code:bash (# Configure settings.json with Kimi API key), code:bash (# Configure settings.json with GLM API key), code:bash (# Configure settings.json with OpenAI API key), code:bash (# Check if router is running), code:block15 ([ ] API key configured in settings.json), code:block16 ([ ] claude-code-router installed), code:block17 ([ ] Can switch between providers dynamically) (+19 more)

### Community 277 - "PTY Terminal Service and XTerminal Tests"
Cohesion: 0.14
Nodes (23): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), makeMergeSet() (+15 more)

### Community 278 - "Feature Metadata Badge and Modal Components"
Cohesion: 0.1
Nodes (19): changedFiles, errOutput, fetchMock, mockFetch(), output, consoleLogs, edges, mockGetStatus (+11 more)

### Community 279 - "Dashboard Caching Architecture Docs"
Cohesion: 0.17
Nodes (24): Conversation, listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), getAttachmentCache() (+16 more)
...
Cohesion: 0.27
Nodes (24): killTmuxSession(), removeWorktree(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync (+16 more)

### Community 285 - "Model Routing Changelog and Configuration"
Cohesion: 0.14
Nodes (21): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), getTrackerContext() (+13 more)

### Community 286 - "Command Deck Redesign Zone Layout"
Cohesion: 0.21
Nodes (23): killCommand(), KillOptions, destroyRemoteWorkspace(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput() (+15 more)
...
Cohesion: 0.09
Nodes (25): ~/.panopticon.env (API Keys), CLI Work Types, API Keys Env File (~/.panopticon.env), Cloudflare Tunnel Workspace Integration, Configuration Fallback Strategy (provider disabled fallback), Global Config File (~/.panopticon/config.yaml), Panopticon Configuration Guide, Hume EVI Workspace Integration (BYOLLM voice AI) (+17 more)
...
Cohesion: 0.11
Nodes (25): /all-up Flywheel Skill, Awaiting Merge Dashboard Page, check-merged skill, ~/.claude/CLAUDE.md (AI suggestion preferences), scripts/conv-find.py, conv-lookup skill, crash-investigation skill, dependency-update skill (+17 more)

### Community 301 - "Experimental Channels Toggle Tests"
Cohesion: 0.08
Nodes (25): 1. Read Enforcer (`PreToolUse` on `Read`), 2. Post-Edit Notify (`PostToolUse` on `Edit|Write`), 3. MCP Server, Architecture, Build Triggers, CLI Commands, code:block1 (PROJECT ROOT (main branch)), code:block2 (┌─────────────────────────┐) (+17 more)

### Community 302 - "OpenRouter Model Classification Service"
Cohesion: 0.08
Nodes (22): TLDR Token-Efficient Code Analysis, TLDR bypass rules (size, extension, offset), TLDR context token savings (90-95%), Agent Guidance, Architecture & Design, Configuration, Documentation Maintenance, External Integrations (+14 more)

### Community 303 - "Issue Cost Resolution and Normalization"
Cohesion: 0.09
Nodes (19): electron, electron, IPC, result, result, cb, cmdArgs, mockExec (+11 more)
...
Cohesion: 0.11
Nodes (12): removed, formatIssueRef(), LinkDirection, LinkManager, LinkStore, parseIssueRef(), link, links (+4 more)
...
Cohesion: 0.08
Nodes (23): Bead Description (What Was Asked), BLOCKED — Any check fails, Check 1: Spec Fidelity, Check 2: Constraint Compliance, Check 3: Compile + Smoke, code:bash (cd {{workspacePath}}), code:bash (# Check workspace CLAUDE.md), code:bash (# Example: check for prohibited imports) (+15 more)

### Community 322 - "Test Global Setup Bootstrap"
Cohesion: 0.08
Nodes (23): Agents in the Panopticon pipeline, Claude Code subagents (NOT Panopticon roles), Claude Code subagents (NOT Panopticon specialists), code:block1 (pan plan-finalize), code:json ({), code:json ({), continue.vbrief.json Format, CRITICAL: PLANNING ONLY - NO IMPLEMENTATION (+15 more)
...
Cohesion: 0.09
Nodes (23): 6. Agreed End-State, Agent Startup Context, code:block10 (pan sync), code:block11 (pan sync), code:yaml (devroot: ~/Projects        # where you launch Claude Code fr), code:json ({), code:json ({), code:bash (pan workspace update MIN-678    # explicit command, only whe) (+15 more)
...
Cohesion: 0.15
Nodes (19): beads, capturedArgs, err, mockExecFileFn, mockExecFn, hiddenDir, mockExecFn, subA (+11 more)

### Community 350 - "Rally WSAPI Query Parser Fix"
Cohesion: 0.16
Nodes (19): CostLimitsConfig, checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted (+11 more)
...
Cohesion: 0.13
Nodes (20): API_ERROR_PATTERNS, REVIEWER_ROLES, API_ERROR_PATTERNS, BuildReviewerNodesOptions, detectApiError(), extractReviewerRole(), findLatestReviewRunDir(), readReviewerRounds() (+12 more)

### Community 354 - "Agent Health Runtime State Tests"
Cohesion: 0.14
Nodes (18): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), commands (+10 more)
...
Cohesion: 0.09
Nodes (21): Bead ID vs Issue ID, Beads Quick Reference for Panopticon Agents, code:bash (bd list --issue PAN-116), code:bash (# Option 1: Search in title (most common)), code:bash (# Find ALL beads for PAN-116 (including closed)), code:bash (# By status), code:bash (# Start work on a bead), code:bash (# ❌ WRONG) (+13 more)
...
Cohesion: 0.18
Nodes (19): PROVIDER_ENV_UNSETS, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+11 more)

### Community 364 - "Gemini Model Work Type Analysis"
Cohesion: 0.14
Nodes (18): mockGetRuntimeForAgent, buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation() (+10 more)

### Community 365 - "Agent Health Monitor States"
Cohesion: 0.15
Nodes (19): CliproxyCodexCredentials, CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthUnknown, CodexAuthValid, cleanupExpiredReauthSessions() (+11 more)
...
Cohesion: 0.1
Nodes (20): 13 Dashboard Views, Architecture at a Glance, code:bash (npx @panctl/cli), code:block2 (Issue         PRD           Agent         Review        Test), Command Deck, Contributing, Documentation, How It Works (+12 more)
...
Cohesion: 0.17
Nodes (21): Dashboard HTTP route rename /api/work/* → /api/issues/* /api/review/* /api/show/* /api/admin/* (PAN-705 Phase 4.5), First-launch upgrade announcement banner — renders migration table (PAN-705 Phase 4.5), Five-Bucket CLI Taxonomy (PAN-705 decision), pan admin — plumbing namespace (PAN-705), pan show <id> — unified observation command (PAN-705 Phase 2), pan work command — legacy junk drawer problem, PAN-705 Phase 1 — Scaffolding (non-breaking, new commands alongside old), PAN-705 Phase 2 — Collapse commands (pan show, pan review, pan issues, pan plan) (+13 more)
...
Cohesion: 0.17
Nodes (17): deliverQueuedFeedback(), enqueuePendingFeedbackDelivery(), FeedbackKind, isDeliveryStillRelevant(), markPendingFeedbackDelivered(), PENDING_FEEDBACK_FILE, PendingFeedbackDelivery, PendingFeedbackStore (+9 more)

### Community 378 - "Linear Issue States Tests"
Cohesion: 0.1
Nodes (19): TranscriptEntry, branch, branchMatch, buffer, cavemanVariant, cost, entry, input (+11 more)

### Community 379 - "Issue Beads Enforcement Tests"
Cohesion: 0.19
Nodes (19): reconcileFalseMerged(), configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+11 more)

### Community 380 - "Cost Event Recording Types"
Cohesion: 0.12
Nodes (15): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+7 more)

### Community 381 - "Harness Integration Tests"
Cohesion: 0.19
Nodes (17): CLAUDE_DIR, createClaudeAdapter(), createRuntimeRegistry(), getInstalledRuntimes(), getRuntimeAdapter(), getSupportedRuntimes(), isRuntimeInstalled(), AgentMessage (+9 more)

### Community 382 - "Dashboard Tailwind CSS Config"
Cohesion: 0.21
Nodes (17): execFileAsync, gitFetch(), gitForcePush(), gitMerge(), gitPush(), gitRevParse(), appendGitOperation(), badObjectErr (+9 more)
...
Cohesion: 0.1
Nodes (19): Ad-Hoc Speak (For Agents), Architecture, code:block1 (pan dashboard            pan-tts subscriber          qwen-tt), code:bash (cd skills/pan-tts/scripts), code:yaml (endpoint: http://127.0.0.1:3000/events/stream), code:bash (# one-shot foreground run (smoke test)), code:bash (./scripts/say.sh "Build is green, ready for review."), Configuration (+11 more)
...
Cohesion: 0.11
Nodes (16): closeResult, command, ctx, labelResult, prResult, calls, ctx, mockClientCreateIssueLabel (+8 more)

### Community 396 - "Multi-Agent Orchestration PRD"
Cohesion: 0.11
Nodes (16): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skillsToSync, sourcePath (+8 more)

### Community 397 - "PRD Pipeline Test Marker"
Cohesion: 0.16
Nodes (15): ForgeType, buildMergeSetForIssue(), getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue() (+7 more)

### Community 398 - "Planning Completion Trace Investigation"
Cohesion: 0.16
Nodes (15): getForgeAdapter(), exec(), {
  execMock,
  getPullRequestStateMock,
  isGitHubAppConfiguredMock,
  mergePullRequestWithAppMock,
  parsePullRequestRefMock,
}, kCustom, mergePromise, withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody() (+7 more)
...
Cohesion: 0.15
Nodes (17): keyLabel(), maskValue(), ProviderEnvConflict, ProviderEnvOverrideDialog(), ProviderEnvOverrideDialogProps, PROVIDER_ENV_KEYS, atomicWrite(), backupIfNeeded() (+9 more)
...
Cohesion: 0.21
Nodes (15): extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), ParsedIssueId, result, applyLabelLinear(), cleanupLabelsGitHub() (+7 more)
...
Cohesion: 0.12
Nodes (16): agentDir, agentResult, beadsDir, branchResult, clearResult, content, legacyDir, legacyResult (+8 more)
...
Cohesion: 0.13
Nodes (14): AvailableModel, AvailableModelsResponse, fetchAvailableModels(), fetchSettings(), PROVIDER_LABELS, saveWorkhorse(), SettingsResponse, WORKHORSE_SLOTS (+6 more)

### Community 434 - "Community 434"
Cohesion: 0.18
Nodes (15): details, validateOrigin(), getHeader(), getTrustedOrigins(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin(), appendResolutionEvents (+7 more)
...
Cohesion: 0.12
Nodes (16): Acceptance Criteria, code:block1 (┌───────────────────────────────────────────┐), Docs are part of every fix, Exit Criteria for a Single Run, Goals, Main must always be clean, Non-goals, PRD: Fix-All Flywheel (+8 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, code:bash (# Stop all Panopticon services), code:bash (# Method 1: Separate commands), code:bash (# Clean up stale resources), code:env (# Graceful shutdown timeout (seconds)), Configuration Options, More Information, Next Steps (+8 more)
...
Cohesion: 0.31
Nodes (15): applyClosedOutLabel(), applyLabelGitHub(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), CloseIssueOptions, closeLinearDirect() (+7 more)

### Community 457 - "Community 457"
Cohesion: 0.12
Nodes (14): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+6 more)
...
Cohesion: 0.15
Nodes (13): data, mockExistsSync, mockReadFile, mockUnlink, runner, mockUnlinkSync, mockReadFileSync, LifecycleRunner (+5 more)
...
Cohesion: 0.25
Nodes (14): detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable(), openCommand(), EditorLaunch, execAsync, getFileManagerCommand(), isCommandAvailable() (+6 more)
...
Cohesion: 0.24
Nodes (13): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+5 more)

### Community 479 - "Community 479"
Cohesion: 0.13
Nodes (14): ACTIVITY_RESPONSE, AGENTS_RESPONSE, COSTS_RESPONSE, DISCUSSIONS_RESPONSE, ISSUES_RESPONSE, PLANNING_RESPONSE, PR_DIFF_RESPONSE, PR_RESPONSE (+6 more)
...
Cohesion: 0.19
Nodes (10): expectedExits, killChildTree(), port, requiredFiles, restartQueue, shutdown(), stopApp(), watchedDirectories (+2 more)
...
Cohesion: 0.29
Nodes (13): decodeJwtPayload(), buildStatus(), decodeBase64Url(), decodeJwtPayload(), getCodexAuthPath(), getJwtExpiry(), getOpenAIAuthStatus(), getOpenAIAuthStatusSync() (+5 more)

### Community 502 - "Community 502"
Cohesion: 0.14
Nodes (12): kCustom, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed (+4 more)
...
Cohesion: 0.14
Nodes (14): code:bash (pan plan PAN-3), code:bash (# Agent searches for authentication code), code:markdown (# PAN-3: Add User Authentication), code:bash (# View the plan), code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Planning Workflow (+6 more)
...
Cohesion: 0.14
Nodes (13): 1. Read the context manifest first, 2. Wait for convoy output files, 3. Read available reviewer reports, 4. Synthesize the verdict, 5. Write the synthesis report, 6. Signal review status, Boundaries, code:bash (tmux -L panopticon has-session -t "agent-<issueId>-review-<s) (+5 more)

### Community 531 - "Community 531"
Cohesion: 0.15
Nodes (14): AgentStatus — starting | running | stopped | error | unknown, contracts/src/events.ts — DomainEvent definitions, @panctl/contracts — shared event schemas, RPC types, reducers (v0.8.20), contracts/src/rpc.ts — WS_METHODS, PanRpcGroup, RPC method names, contracts/src/types.ts — AgentStatus, AgentPhase, SpecialistType, Harness primitives, Panopticon Electron App — bin panctl, extraResources server.js + public, Node 22+, @panctl/desktop — Panopticon Desktop Electron App (v0.8.20), Harness type — claude-code | pi (PAN-636) (+6 more)

### Community 532 - "Community 532"
Cohesion: 0.14
Nodes (13): Conversation Forking, Plain Fork Mode, Summary Fork Mode, Conversation Forks, Developer Notes, Fork Modes, Fork Options, Model Switching (+5 more)
...
Cohesion: 0.22
Nodes (10): calls, mockExec, calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync (+2 more)

### Community 535 - "Community 535"
Cohesion: 0.15
Nodes (9): customPromisify, justNow, longAgo, old, recent, restartCalled, state, STATE_FILE (+1 more)
...
Cohesion: 0.15
Nodes (13): Cost Savings, Full Codebase Analysis (2026-02-21), Hook Performance, Key Findings, Method Breakdown, Per-File Results (top 15 by savings), Quality Gates, Real-World Agent Lifecycle Validation (2026-02-21) (+5 more)
...
Cohesion: 0.17
Nodes (10): files, bin, binPath, content, desktopDir, devDeps, engines, files (+2 more)

### Community 562 - "Community 562"
Cohesion: 0.18
Nodes (11): DEFAULT_GATES, calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes (+3 more)

### Community 563 - "Community 563"
Cohesion: 0.29
Nodes (10): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichPRBody(), readBeadsFromJsonl(), bead (+2 more)

### Community 564 - "Community 564"
Cohesion: 0.17
Nodes (11): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+3 more)
...
Cohesion: 0.17
Nodes (11): After Reopening, code:bash (pan reopen PAN-123), code:bash (curl -X POST http://localhost:3011/api/issues/PAN-123/reopen), Do NOT Use `pan done` Until Re-Work Is Complete, How to Reopen, Reopen Issue for Re-Work, Via CLI (recommended for agents/supervisors), Via Dashboard API (+3 more)
...
Cohesion: 0.17
Nodes (12): Agent System, Build & Development, Configuration & Models, Development, External Integrations & Event Stream, General Topics, Infrastructure, Monitoring & Cost (+4 more)
...
Cohesion: 0.27
Nodes (9): execAsync, rebaseFeatureBranch(), RebaseResult, execAsync, RebaseAllResult, rebaseAndPushRepos(), rebaseOneRepo(), RebaseResult (+1 more)

### Community 599 - "Community 599"
Cohesion: 0.38
Nodes (9): clearRunningAgentsCache(), getCachedRunningAgents(), runningAgentsCache, sweepExpired(), firstAgents, firstPromise, listAgents, secondAgents (+1 more)

### Community 600 - "Community 600"
Cohesion: 0.18
Nodes (10): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+2 more)
...
Cohesion: 0.18
Nodes (10): code:bash (curl -s -X POST {{API_URL}}/api/specialists/done \), code:bash (curl -s -X POST {{API_URL}}/api/specialists/done \), Hard Rules, Merge Task — {{ISSUE_ID}}, PHASE 1 — SYNC & BASELINE (before merge), PHASE 2 — MERGE, PHASE 3 — VERIFY, PHASE 4 — DECIDE (+2 more)
...
Cohesion: 0.29
Nodes (8): PersistedState, readPersisted(), useConversationUiState(), writePersisted(), parsed, parsed, raw, { result }
...
Cohesion: 0.2
Nodes (9): Basic Usage, code:bash (# Start planning session for an issue), Dashboard Planning Interface, More Information, Overview, Panopticon Planning Workflow, Related Skills, What is AI Planning? (+1 more)

### Community 669 - "Community 669"
Cohesion: 0.2
Nodes (9): code:bash (cd /home/eltmon/Projects/panopticon-cli && npm run build), code:bash (pan up), code:bash (curl -s http://localhost:3011/api/health | head -1), code:bash (cd /home/eltmon/Projects/panopticon-cli && npm run build && ), Important Notes, Pan Reload, Quick One-Liner, Steps (+1 more)
...
Cohesion: 0.31
Nodes (7): ClaudeAuthStatus, getClaudeAuthStatus(), parseOAuthPayload(), readKeychainCredentials(), raw, result, raw
...
Cohesion: 0.22
Nodes (9): code:bash (# Import issues from JSONL), code:bash (# Migrate databases after version upgrade), code:bash (# List all running daemons), code:bash (# Manual sync (force immediate export/import/commit/push)), Daemon Management, Database Management, Import/Export, Migration (+1 more)
...
Cohesion: 0.22
Nodes (8): Boundaries, code:bash (npm test), Completion, Deep gate: `inspect-deep`, Jidoka Inspection Gates, Panopticon Work Role, Per-Bead Workflow, Universal gate: `inspect`
...
Cohesion: 0.25
Nodes (3): PendingCompletion, _pendingCompletions, SpecialistCompletionResult

### Community 744 - "Community 744"
Cohesion: 0.39
Nodes (7): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged()

### Community 745 - "Community 745"
Cohesion: 0.32
Nodes (6): detectTestCommand(), command, jestConfig, packageJson, testDir, PackageJson
...
Cohesion: 0.25
Nodes (7): RallyApiConfig, RallyCreateConfig, RallyCreateResult, RallyQueryConfig, RallyQueryResult, RallyUpdateConfig, RallyUpdateResult

### Community 748 - "Community 748"
Cohesion: 0.25
Nodes (5): after, doc, filename, path, readDoc()
...
Cohesion: 0.25
Nodes (7): Agent Directory Structure, Cleanup, code:bash (# Preview orphaned directories), Legacy Directories, Specialists Do Not Use Agent Directories, Standard Directory Contents, Valid Directory Naming Patterns
...
Cohesion: 0.25
Nodes (7): code:bash (pan admin cloister <subcommand>), code:block2 (pan admin cloister status          # Show watchdog state), pan admin cloister, See Also, Usage, What It Does, When to Use
...
Cohesion: 0.25
Nodes (7): code:bash (pan review <subcommand>), code:block2 (pan review pending              # List completed work awaiti), pan review, See Also, Usage, What It Does, When to Use
...
Cohesion: 0.25
Nodes (7): Boundaries, code:bash (npm run typecheck), Human-Merge Invariant, Inputs, Panopticon Ship Role, Shipping Workflow, Verification Contract
...
Cohesion: 0.29
Nodes (7): Agent Workflow, Checkpoint System, CLI Reference, code:bash (# After closing a bead), code:bash (pan inspect <issueId> --bead <beadId>           # Request in), Inspect Specialist (PAN-382), What Inspect Checks
...
Cohesion: 0.29
Nodes (7): Advanced Usage, code:bash (# Force kill all processes), code:bash (# Stop only dashboard (keep API running)), code:bash (# Stop services and all workspace containers), Force Stop, Stop and Clean Up Workspaces, Stop Specific Services
...
Cohesion: 0.33
Nodes (5): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNamesAsync, mockMarkConversationEnded, mockListSessionNamesAsync

### Community 884 - "Community 884"
Cohesion: 0.33
Nodes (3): agent, LEGACY_TEMPLATE_FLAVORS, REVIEW_FLAVORS
...
Cohesion: 0.33
Nodes (5): code:bash (pan close <issue-id>), pan close, See Also, What It Does, When to Use
...
Cohesion: 0.33
Nodes (5): Boundaries, Browser UAT Contract, Inputs, Panopticon Test Role, Verification Workflow
...
Cohesion: 0.53
Nodes (6): AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), CloisterBanner Component, TopologyView Component (agent relationship graph)
...
Cohesion: 0.4
Nodes (4): { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues, output, mockIssue
...
Cohesion: 0.4
Nodes (4): Boundaries, Outputs, Panopticon Planning Agent, Process
...
Cohesion: 0.4
Nodes (5): Background vs Foreground, Check Running Processes, code:bash (# Using pan), code:bash (# Background (default) - services run as daemons), Process Management
...
Cohesion: 0.4
Nodes (5): code:bash (pan down), code:bash (pan down --force), Forceful Shutdown, Graceful Shutdown (default), Graceful vs Forceful Shutdown
...
Cohesion: 0.4
Nodes (5): Flywheel Active Pipeline (Run 15), Flywheel Infrastructure Gaps & Pattern Ledger, Fix-All Flywheel Run Log, FLYWHEEL-STATE.md (Living Document), Operation Fix-All (Mass Agent Oversight)

### Community 1006 - "Community 1006"
Cohesion: 0.5
Nodes (5): pan plan-finalize command, plan skill, spec-to-plan pipeline, vBRIEF spec.vbrief.json schema, write-spec skill
...
Cohesion: 0.67
Nodes (3): After Planning, code:bash (# Create workspace with plan), code:bash (# Agent reads plan)

### Community 1063 - "Community 1063"
Cohesion: 0.67
Nodes (3): High-Quality Plan, Needs Improvement, Plan Quality Indicators
...
## Knowledge Gaps
- **10717 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+10712 more)
...
- **Why does `ConversationEvent` connect `Health Metrics and Settings Pages` to `Agent Session Lifecycle Management`, `Remote Agent Provisioning on Fly`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Specialist Handoff and Planning Spawn`, `Conversation Database and Favorites`, `Inspector Panel Terminal UI`, `Electron Desktop App and Tray`, `Issue Service and Data Fetching`, `Tmux Terminal Session Management`, `Claude Session JSONL Parsing and Costs`, `Git Activity and Runtime Metrics`, `Dashboard Caching Architecture Docs`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `Chat Composer Slash Command Editor`, `GodView Socket and Activity Feed`, `Cost Calculation and Token Usage`, `Command Deck Issue Workbench UI`, `Workspace Service and Agent Spawner Tests`, `CLI Install DNS and Dev Commands`, `Conversation Service WebSocket RPC`, `Agent Status RPC Contracts`, `Chat Composer Model Picker`, `Community 431`, `Model Selection and Subscription Policy`, `Prerequisite Tool Installation Registry`, `Community 434`, `VBrief Task Readiness and Beads IO`, `Issue Tracker Polling Service`, `Fly Remote Provider and API Client`, `GitHub Webhook Ingestion Handlers`, `Multi Tool Skill Sync Export`, `Resource Process Discovery and Reporting`, `Conversation Compaction and Fork Pipeline`, `Dashboard Mutation Origin Validation`, `User Documentation and Provider Guides`, `Planning Dialog Confirm Replacement`, `Specialist Agent Prompts and Audit Docs`, `Pi Extension Session Event Handlers`, `Dashboard Navigation Layout Tests`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Deacon Patrol and Queue` to `Diagnostic and Incident Response Skills`, `Specialist Handoff and Planning Spawn`, `OpenAI Auth and Cliproxy Bridge`, `Multi-Tracker Adapter Implementations`, `System Health and Spawn Guardrails`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `specialists` connect `Command Deck Overview Tab UI` to `Agent Session Lifecycle Management`, `Remote Agent Provisioning on Fly`, `Merge Agent Post-Merge Lifecycle`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Project Setup and Polyrepo Workspace PRDs`, `Specialist Handoff and Planning Spawn`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Skill Sync Mirror Tests`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `Chat Composer Slash Command Editor`, `Community 412`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Cost Events Database and WAL Sync`, `VBrief Beads IO and Plan Finalize`, `Work Type Routing and Config`, `Git Push Operations and Approval`, `Dashboard App Sidebar and Metrics`, `Chat Composer Model Picker`, `Settings UI Redesign Design Spec`, `Model Selection and Subscription Policy`, `Codex Agent Spawn UI Flow`, `Community 563`, `VBrief Task Readiness and Beads IO`, `Multi-Tool Sync and MCP Isolation`, `GitHub Webhook Ingestion Handlers`, `Settings Persistence and Model Defaults`, `Path Constants and Postinstall Setup`, `Command Deck UI Design Specs`, `Plan DAG Visualization and Beads Panel`, `Workspace Pan Directory State Management`, `Traefik DNS and Platform Install Skills`, `Plan Difficulty Estimation Tests`, `Contracts Types RPC and Desktop Package`, `Cost Data Migration and Reconciliation`, `Planning Dialog Confirm Replacement`, `Gemini Model Work Type Analysis`, `Specialist Agent Health Dashboard UI`, `Label Cleanup and Workflow Lifecycle Tests`, `Dashboard Terminal UI Components`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 179 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 179 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _10717 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Agent Session Lifecycle Management` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._
- **Should `Merge Agent Post-Merge Lifecycle` be split into smaller, more focused modules?**
  _Cohesion score 0.02 - nodes in this community are weakly interconnected._