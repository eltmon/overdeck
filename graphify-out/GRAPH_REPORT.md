...
## Corpus Check
- 1878 files · ~2,476,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26673 nodes · 41554 edges · 1283 communities (1230 shown, 53 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2f6be52`
...
## Communities (1283 total, 53 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (147): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+139 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (143): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+135 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (137): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+129 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (149): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+141 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (125): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (127): buildActiveSliceContext(), readWorkspacePlanAsync(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun() (+119 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (98): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+90 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): checkMissingReviewStatuses(), checkPostReviewCommits(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (114): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult, onInspectComplete() (+106 more)
...
Cohesion: 0.02
Nodes (95): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+87 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (100): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+92 more)
...
Cohesion: 0.03
Nodes (91): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier (+83 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (83): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+75 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (73): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+65 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (86): readCavemanVariant(), checkHeartbeat(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+78 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (73): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+65 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (88): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+80 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (80): transitionIssueToVerifyingOnMain(), importTrackerConfig(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+72 more)
...
Cohesion: 0.03
Nodes (87): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+79 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (81): detectMergedSwarmSlots(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (72): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (83): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+75 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (82): isPaneDeadAsyncEffect(), listPaneValuesAsyncEffect(), listSessionNamesAsyncEffect(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (72): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+64 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (74): buildPolyrepoContext(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), workspaceDeepCleanCommand() (+66 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (79): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+71 more)
...
Cohesion: 0.05
Nodes (69): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+61 more)
...
Cohesion: 0.04
Nodes (76): estimateCost(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+68 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (46): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName() (+38 more)
...
Cohesion: 0.03
Nodes (66): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+58 more)
...
Cohesion: 0.06
Nodes (70): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+62 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (63): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearStaleCiFeedback() (+55 more)
...
Cohesion: 0.05
Nodes (56): ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent() (+48 more)
...
Cohesion: 0.04
Nodes (53): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), ConnectionLinesProps, CostDonut() (+45 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (57): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+49 more)
...
Cohesion: 0.04
Nodes (38): countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), syncTranscriptPollerRegistry(), activeA (+30 more)
...
Cohesion: 0.05
Nodes (49): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError, serializeHandoffContext() (+41 more)
...
Cohesion: 0.09
Nodes (52): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+44 more)
...
Cohesion: 0.04
Nodes (53): result, createSessionAsyncEffect(), killSessionAsyncEffect(), sendKeysEffect(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync (+45 more)
...
Cohesion: 0.09
Nodes (52): extractNumber(), extractPrefix(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl() (+44 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (46): runMemoryFtsStatement(), runMemoryFtsTransaction(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate (+38 more)
...
Cohesion: 0.05
Nodes (37): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, ConversationsConfig (+29 more)
...
Cohesion: 0.08
Nodes (35): FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), workspacePanPaths(), clearFeedback() (+27 more)
...
Cohesion: 0.07
Nodes (38): checkUndispatchedShip(), activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt(), cleanupLegacySpecialistsDirectory(), CLOISTER_STATE_FILE, CloisterDomainEventLike, CloisterEventListener (+30 more)
...
Cohesion: 0.07
Nodes (40): getMemoryStatus(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult (+32 more)
...
Cohesion: 0.06
Nodes (21): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSession(), parsePiSessionContent(), ParseResult (+13 more)
...
Cohesion: 0.08
Nodes (28): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+20 more)
...
Cohesion: 0.1
Nodes (34): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+26 more)
...
Cohesion: 0.07
Nodes (25): SearchResult, DiscoveredSession, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+17 more)
...
Cohesion: 0.12
Nodes (33): getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), spawnFlywheelAgent(), loadConfigAsyncNoMigrationEffect(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus() (+25 more)
...
Cohesion: 0.14
Nodes (24): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId() (+16 more)
...
Cohesion: 0.1
Nodes (15): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, after, before, cfg, compose, ph (+7 more)
...
Cohesion: 0.12
Nodes (14): waitForPiAgentReady(), createPiFifo(), execAsync, PiFifoError, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand() (+6 more)
...
Cohesion: 0.12
Nodes (15): AgentHealth, checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache (+7 more)
...
Cohesion: 0.15
Nodes (15): getForgeAdapter(), ensureMergeSetForIssue(), getMergeSet(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue() (+7 more)
...
- **Why does `fetch` connect `Community 1` to `Community 384`, `Community 2`, `Community 261`, `Community 6`, `Community 5`, `Community 9`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 277`, `Community 22`, `Community 25`, `Community 153`, `Community 26`, `Community 32`, `Community 34`, `Community 39`, `Community 557`, `Community 46`, `Community 47`, `Community 49`, `Community 51`, `Community 56`, `Community 441`, `Community 184`, `Community 699`, `Community 443`, `Community 61`, `Community 193`, `Community 1091`, `Community 196`, `Community 325`, `Community 67`, `Community 69`, `Community 72`, `Community 585`, `Community 71`, `Community 206`, `Community 82`, `Community 84`, `Community 89`, `Community 220`, `Community 221`, `Community 350`, `Community 94`, `Community 100`, `Community 234`, `Community 110`, `Community 115`, `Community 629`, `Community 506`, `Community 381`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 19` to `Community 65`, `Community 866`, `Community 5`, `Community 552`, `Community 204`, `Community 175`, `Community 18`, `Community 20`, `Community 53`, `Community 23`, `Community 27`, `Community 28`, `Community 62`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 109` to `Community 0`, `Community 3`, `Community 264`, `Community 266`, `Community 11`, `Community 267`, `Community 13`, `Community 654`, `Community 271`, `Community 20`, `Community 149`, `Community 278`, `Community 23`, `Community 410`, `Community 157`, `Community 30`, `Community 29`, `Community 32`, `Community 37`, `Community 167`, `Community 168`, `Community 552`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 175`, `Community 176`, `Community 440`, `Community 63`, `Community 191`, `Community 579`, `Community 196`, `Community 324`, `Community 71`, `Community 458`, `Community 330`, `Community 331`, `Community 205`, `Community 462`, `Community 334`, `Community 202`, `Community 460`, `Community 333`, `Community 83`, `Community 84`, `Community 461`, `Community 471`, `Community 217`, `Community 90`, `Community 218`, `Community 92`, `Community 89`, `Community 479`, `Community 484`, `Community 102`, `Community 107`, `Community 116`, `Community 378`, `Community 251`, `Community 126`?**
