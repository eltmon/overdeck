...
## Corpus Check
- 1754 files · ~2,345,317 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24093 nodes · 36913 edges · 1203 communities (1157 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `394f7cda`
...
## Communities (1203 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (210): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+202 more)
...
Cohesion: 0.02
Nodes (113): ArtifactLinks(), ArtifactLinksProps, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView (+105 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (133): spawnInspectAgent(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), ActivityEntry, AGENT_PREFIXES, AgentLaunchConfig (+125 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (125): monitorReviewConvoySignals(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), pendingCommand(), after, before, blockers, result (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (124): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (118): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+110 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (114): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (121): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+113 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (96): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (114): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+106 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (104): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), autoResumeStoppedWorkAgents(), notifyAgentStatusChanged() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (97): ensureDefaultConversationModel(), CodexAuthBanner(), DiffPanel(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus() (+89 more)
...
Cohesion: 0.04
Nodes (94): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+86 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (84): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+76 more)
...
Cohesion: 0.03
Nodes (80): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (87): readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContinue(), readWorkspaceContinueAsync() (+79 more)
...
Cohesion: 0.04
Nodes (89): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+81 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (71): cont, doc, projectRoot, specsDir, workspace, criteria, doc, result (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (75): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+67 more)
...
Cohesion: 0.04
Nodes (71): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions (+63 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (84): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache (+76 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (78): checkStuckReviewing(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+70 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (87): updateTtsConfig(), agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options (+79 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (77): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+69 more)
...
Cohesion: 0.03
Nodes (79): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+71 more)
...
Cohesion: 0.03
Nodes (66): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+58 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (75): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+67 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (71): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl() (+63 more)
...
Cohesion: 0.04
Nodes (63): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+55 more)
...
Cohesion: 0.04
Nodes (62): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+54 more)
...
Cohesion: 0.06
Nodes (56): cvCommand(), CVOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+48 more)
...
Cohesion: 0.04
Nodes (61): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader() (+53 more)
...
Cohesion: 0.05
Nodes (58): generateFallbackSummary(), readLogTail(), buildConversationResponse(), getCachedMessages(), handleConversationMessage(), isPiSessionFile(), analyze_session(), find_sessions() (+50 more)
...
Cohesion: 0.07
Nodes (52): isEligibleForCleanup(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+44 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (52): forkCommand(), ForkOptions, CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps() (+44 more)
...
Cohesion: 0.07
Nodes (23): importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+15 more)
...
Cohesion: 0.07
Nodes (44): readFeatureContext(), deriveProjectRoot(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), uniqueTmpPath(), workspacePanPaths() (+36 more)
...
Cohesion: 0.07
Nodes (45): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+37 more)
...
Cohesion: 0.07
Nodes (43): calls, { mockExecAsync }, opts, archivePlanning(), CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync (+35 more)
...
Cohesion: 0.08
Nodes (40): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+32 more)
...
Cohesion: 0.07
Nodes (27): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv() (+19 more)
...
Cohesion: 0.09
Nodes (33): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue() (+25 more)
...
Cohesion: 0.08
Nodes (31): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, findDevrootForProject(), getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig (+23 more)
...
Cohesion: 0.07
Nodes (22): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName() (+14 more)
...
Cohesion: 0.1
Nodes (25): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+17 more)
...
Cohesion: 0.11
Nodes (11): DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffRouteSearch (+3 more)
...
Cohesion: 0.15
Nodes (19): addPanopticonHookIfMissing(), checkJqInstalled(), ClaudeSettings, HookConfig, installJq(), isHookConfigured(), McpServer, setupHooksCommand() (+11 more)
...
Cohesion: 0.24
Nodes (17): bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload(), ensureConfigFileAsync() (+9 more)
...
Cohesion: 0.21
Nodes (13): checkCliproxyPortAsync(), execAsync, isCliproxyRunning(), isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), restartCliproxyAsync(), stopCliproxy() (+5 more)
...
Cohesion: 0.14
Nodes (13): Adding New Integrations, Cloudflare Tunnels, code:yaml (models:), code:env (ANTHROPIC_API_KEY=sk-ant-...), code:yaml (workspace:), code:yaml (workspace:), code:yaml (env_file:), Configuration Guide (+5 more)
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 138`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 282`, `Community 26`, `Community 797`, `Community 413`, `Community 672`, `Community 673`, `Community 291`, `Community 35`, `Community 677`, `Community 37`, `Community 40`, `Community 41`, `Community 682`, `Community 43`, `Community 44`, `Community 171`, `Community 46`, `Community 431`, `Community 173`, `Community 50`, `Community 565`, `Community 182`, `Community 61`, `Community 62`, `Community 64`, `Community 193`, `Community 69`, `Community 199`, `Community 72`, `Community 81`, `Community 215`, `Community 238`, `Community 117`, `Community 119`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 11` to `Community 0`, `Community 1`, `Community 290`, `Community 3`, `Community 131`, `Community 38`, `Community 198`, `Community 72`, `Community 10`, `Community 394`, `Community 77`, `Community 15`, `Community 17`, `Community 147`, `Community 215`, `Community 249`, `Community 155`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 32`, `Community 33`, `Community 66`, `Community 70`, `Community 262`, `Community 8`, `Community 170`, `Community 15`, `Community 495`, `Community 19`, `Community 380`?**
