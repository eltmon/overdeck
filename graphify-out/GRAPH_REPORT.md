...
## Corpus Check
- 1754 files · ~2,345,199 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24089 nodes · 36901 edges · 1195 communities (1147 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c57b2952`
...
## Communities (1195 total, 48 thin omitted)
...
Cohesion: 0.02
Nodes (142): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (165): monitorReviewConvoySignals(), performKillAndSpawn(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription() (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (146): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+138 more)
...
Cohesion: 0.02
Nodes (107): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView, SwarmStateView, INSPECTOR_PANEL_SOURCE (+99 more)
...
Cohesion: 0.03
Nodes (117): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (117): checkApiErrorAgents(), cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus() (+109 more)
...
Cohesion: 0.03
Nodes (119): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+111 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (108): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+100 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (109): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+101 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (80): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (99): confirmHostOverride(), resumeCommand(), ResumeOptions, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath() (+91 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (84): parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent, mockKillAgent (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (83): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+75 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (98): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+90 more)
...
Cohesion: 0.02
Nodes (84): SensitiveText(), SensitiveTextProps, DEFAULTS, UIPreferences, useUIPreferences(), DesktopSettings, DesktopSettingsSection(), isDesktopApp() (+76 more)
...
Cohesion: 0.03
Nodes (83): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SkillsList() (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (84): embedAction(), confirmCost(), enrichAction(), formatCost(), registerConversationsCommands(), scanAction(), collectJsonlFiles(), discoverJsonlFiles() (+76 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (83): readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContext(), writeWorkspaceContext() (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (77): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+69 more)
...
Cohesion: 0.05
Nodes (75): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields(), continueDirForWorkspace() (+67 more)
...
Cohesion: 0.05
Nodes (71): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+63 more)
...
Cohesion: 0.05
Nodes (70): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest, ManifestEntry (+62 more)
...
Cohesion: 0.04
Nodes (60): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkPendingTestDispatch() (+52 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (55): ConversationRow(), ConversationRowProps, PHASE_ICONS, ConversationMutations, useNow(), AggregateActivityState, AggregateBadge, buildActivitySummary() (+47 more)
...
Cohesion: 0.05
Nodes (66): migrateConfigCommand(), MigrateConfigOptions, BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions (+58 more)
...
Cohesion: 0.05
Nodes (62): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+54 more)
...
Cohesion: 0.04
Nodes (50): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, DiffStatLabel (+42 more)
...
Cohesion: 0.04
Nodes (55): CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions (+47 more)
...
Cohesion: 0.05
Nodes (59): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+51 more)
...
Cohesion: 0.05
Nodes (61): getTrackerContext(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand() (+53 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (60): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, parseWalFile(), SyncResult, syncWalFromAllProjects() (+52 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (55): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+47 more)
...
Cohesion: 0.09
Nodes (57): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+49 more)
...
Cohesion: 0.05
Nodes (55): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+47 more)
...
Cohesion: 0.05
Nodes (52): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeRoleRunExists(), AgentCrashTracker (+44 more)
...
Cohesion: 0.05
Nodes (47): agentDir, missing, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds(), Jsonish (+39 more)
...
Cohesion: 0.06
Nodes (50): Access, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session() (+42 more)
...
Cohesion: 0.08
Nodes (46): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, execAsync (+38 more)
...
Cohesion: 0.07
Nodes (19): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), sshCommand(), execAsync (+11 more)
...
Cohesion: 0.07
Nodes (38): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), startPostLaunchSidecars() (+30 more)
...
Cohesion: 0.07
Nodes (35): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+27 more)
...
Cohesion: 0.07
Nodes (34): isEligibleForCleanup(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), deleteWorkspaceMetadata(), getIssueDataService(), getIssueDataService(), getIssueDataService(), getIssueDataService() (+26 more)
...
Cohesion: 0.11
Nodes (34): listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments() (+26 more)
...
Cohesion: 0.06
Nodes (31): cb, completedState, dispatched, featureWorkspace, ghExecFileMock, { handler, dispose }, implSlot, initial (+23 more)
...
Cohesion: 0.09
Nodes (20): AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, fetchAvailableModels(), fetchSettings(), ModelPickerProps, ModelRef, PROVIDER_LABELS (+12 more)
...
Cohesion: 0.16
Nodes (16): createCommand(), COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand() (+8 more)
...
Cohesion: 0.35
Nodes (9): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+1 more)
...
Cohesion: 0.33
Nodes (5): PlanningIssue, baseIssue, featureIssue, issue, storyIssue
...
## Knowledge Gaps
- **12534 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12529 more)
...
- **Why does `fetch` connect `Community 0` to `Community 513`, `Community 1`, `Community 132`, `Community 4`, `Community 6`, `Community 133`, `Community 9`, `Community 10`, `Community 139`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 788`, `Community 21`, `Community 25`, `Community 283`, `Community 156`, `Community 30`, `Community 671`, `Community 32`, `Community 163`, `Community 421`, `Community 424`, `Community 41`, `Community 43`, `Community 558`, `Community 46`, `Community 176`, `Community 48`, `Community 50`, `Community 54`, `Community 56`, `Community 186`, `Community 582`, `Community 70`, `Community 200`, `Community 71`, `Community 72`, `Community 75`, `Community 76`, `Community 589`, `Community 73`, `Community 335`, `Community 79`, `Community 81`, `Community 204`, `Community 222`, `Community 359`, `Community 113`, `Community 1014`, `Community 633`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 17` to `Community 0`, `Community 65`, `Community 2`, `Community 35`, `Community 290`, `Community 3`, `Community 8`, `Community 12`, `Community 80`, `Community 18`, `Community 52`, `Community 85`, `Community 54`, `Community 185`, `Community 155`, `Community 222`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `resolveProjectFromIssue()` connect `Community 35` to `Community 385`, `Community 2`, `Community 3`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 401`, `Community 146`, `Community 17`, `Community 20`, `Community 18`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 34`, `Community 37`, `Community 41`, `Community 46`, `Community 49`, `Community 52`, `Community 186`, `Community 59`, `Community 62`, `Community 66`, `Community 68`, `Community 73`, `Community 83`, `Community 86`, `Community 92`, `Community 221`, `Community 103`, `Community 112`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12534 weakly-connected nodes found - possible documentation gaps or missing edges._
