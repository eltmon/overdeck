...
## Corpus Check
- 1567 files · ~2,058,070 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21611 nodes · 32031 edges · 1122 communities (1088 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 415 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02962a57`
...
## Communities (1122 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (142): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (138): checkStuckWorkAgents(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+130 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (128): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+120 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (113): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+105 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (118): checkOrphanedReviewStatuses(), checkStuckReviewing(), patrolWorkAgentResolutions(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions (+110 more)
...
Cohesion: 0.03
Nodes (116): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+108 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (105): isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+97 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (88): parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent, mockKillAgent (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (104): loadCloisterConfig(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask, captureBeadsTasks() (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (97): agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, issuesRouteLayer, miscRouteLayer, specialistsRouteLayer, workspacesRouteLayer, DomainServicesLive (+89 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (92): autoResumeStoppedWorkAgents(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync (+84 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (82): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, formatBytes() (+74 more)
...
Cohesion: 0.03
Nodes (66): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+58 more)
...
Cohesion: 0.03
Nodes (71): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+63 more)
...
Cohesion: 0.05
Nodes (74): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (70): ExcalidrawElementLike, adminRouteLayer, getAdminTldrRoute, autopresoRouteLayer, backToStagingRoute, readJsonBody, resetRoute, startRoute (+62 more)
...
Cohesion: 0.04
Nodes (50): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+42 more)
...
Cohesion: 0.05
Nodes (52): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+44 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (54): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+46 more)
...
Cohesion: 0.06
Nodes (54): FileStatus, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR (+46 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (46): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus() (+38 more)
...
Cohesion: 0.07
Nodes (53): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+45 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (51): ConversationRow(), ConversationRowProps, PHASE_ICONS, ConversationMutations, executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS (+43 more)
...
Cohesion: 0.04
Nodes (48): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+40 more)
...
Cohesion: 0.04
Nodes (48): computePlanningState(), badPath, customPlanningDir, dir, doc, filename, item, item2 (+40 more)
...
Cohesion: 0.06
Nodes (36): buildACLookupByTitle(), inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), WorkAgentPromptContext, writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext() (+28 more)
...
Cohesion: 0.06
Nodes (39): withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+31 more)
...
Cohesion: 0.07
Nodes (38): dispatchTestAgentAndNotify(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand() (+30 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (39): healthCommand(), HealthOptions, pendingCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand() (+31 more)
...
Cohesion: 0.08
Nodes (39): setAgentStoppedNotifier(), CopyConfigOptions, clearStuckForks(), markConversationEnded(), getPanopticonHome(), setPipelineHandler(), startCliproxyWatchdog(), attachmentCleanupTimer (+31 more)
...
Cohesion: 0.06
Nodes (33): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+25 more)
...
Cohesion: 0.09
Nodes (29): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, createBeadsFromVBrief(), CreateBeadsResult (+21 more)
...
Cohesion: 0.11
Nodes (31): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+23 more)
...
Cohesion: 0.06
Nodes (28): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+20 more)
...
Cohesion: 0.06
Nodes (28): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+20 more)
...
Cohesion: 0.09
Nodes (33): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+25 more)
...
Cohesion: 0.08
Nodes (31): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentPhase() (+23 more)
...
Cohesion: 0.12
Nodes (28): archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+20 more)
...
Cohesion: 0.11
Nodes (20): CostBreakdownData, CostBreakdownModal(), CostBreakdownModalProps, formatCost(), formatTokens(), ModelBreakdown, STAGE_CONFIG, StageBreakdown (+12 more)
...
Cohesion: 0.13
Nodes (14): getTrackerContext(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress() (+6 more)
...
Cohesion: 0.11
Nodes (19): checkLogSizeLimit(), getRunLogSize(), content, deleted, { filePath }, largeContent, metadata, oldDate (+11 more)
...
Cohesion: 0.22
Nodes (17): appendToRunLog(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs() (+9 more)
...
## Knowledge Gaps
- **11479 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11474 more)
...
- **Why does `fetch` connect `Community 2` to `Community 3`, `Community 132`, `Community 5`, `Community 264`, `Community 136`, `Community 265`, `Community 12`, `Community 15`, `Community 272`, `Community 16`, `Community 18`, `Community 530`, `Community 19`, `Community 149`, `Community 22`, `Community 17`, `Community 26`, `Community 28`, `Community 158`, `Community 799`, `Community 33`, `Community 34`, `Community 37`, `Community 555`, `Community 44`, `Community 43`, `Community 47`, `Community 52`, `Community 53`, `Community 184`, `Community 56`, `Community 74`, `Community 589`, `Community 590`, `Community 106`, `Community 492`, `Community 749`, `Community 108`, `Community 121`, `Community 123`, `Community 637`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 134` to `Community 1`, `Community 9`, `Community 15`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 799` to `Community 527`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11479 weakly-connected nodes found - possible documentation gaps or missing edges._
