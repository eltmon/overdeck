...
## Corpus Check
- 1548 files · ~2,043,565 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21744 nodes · 32289 edges · 1134 communities (1098 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1309c65`
...
## Communities (1134 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (144): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+136 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (136): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (116): PlanningState, ZoneAActionsState, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState (+108 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (126): readCavemanVariant(), renderPrompt(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+118 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (125): checkMissingReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview() (+117 more)
...
Cohesion: 0.04
Nodes (109): checkStuckWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+101 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (117): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+109 more)
...
Cohesion: 0.03
Nodes (99): autoResumeStoppedWorkAgents(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+91 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (81): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+73 more)
...
Cohesion: 0.03
Nodes (84): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (77): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+69 more)
...
Cohesion: 0.03
Nodes (74): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+66 more)
...
Cohesion: 0.03
Nodes (81): HookItem, computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult, items, result, execFile(), kCustom (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (81): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), cleanupLegacyRuntimeSymlinks() (+73 more)
...
Cohesion: 0.03
Nodes (54): ConversationTerminalProps, resumeConversation(), PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult (+46 more)
...
Cohesion: 0.05
Nodes (72): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, findSpecByIssue(), updateSpecStatus() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (66): getUnblockedItems(), TERMINAL_STATUSES, dispatchSwarmWave(), computePlanningState(), criteria, doc, result, beadsDir (+58 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (70): buildReviewBaseCommand(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, buildAgentLaunchConfig(), getAgentRuntimeBaseCommand(), getProviderAuthMode(), getProviderEnvForModel() (+62 more)
...
Cohesion: 0.04
Nodes (58): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+50 more)
...
Cohesion: 0.05
Nodes (63): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+55 more)
...
Cohesion: 0.05
Nodes (58): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), buildTestRolePrompt(), dashboardApiUrl() (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (61): Access, withConcurrencyLimit(), getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+53 more)
...
Cohesion: 0.04
Nodes (55): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+47 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (59): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+51 more)
...
Cohesion: 0.06
Nodes (46): result, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefDocument, VBriefEdge, VBriefEdgeType, VBriefItem (+38 more)
...
Cohesion: 0.03
Nodes (53): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, determineHealthStatusAsync(), clearCacheRoute, ConfirmationRequest (+45 more)
...
Cohesion: 0.07
Nodes (53): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+45 more)
...
Cohesion: 0.06
Nodes (46): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+38 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (44): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile() (+36 more)
...
Cohesion: 0.06
Nodes (35): CompactBoundary, ProposedPlan, WorkLogEntry, FailedMessage, AssistantMessageRow(), formatElapsed(), formatTimestamp(), isReviewerContextMessage() (+27 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (42): agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, evaluateSpawnGuardrails(), execAsync, formatLeakedSpecialistSummary(), getAgentActivityRoute (+34 more)
...
Cohesion: 0.1
Nodes (39): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+31 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (32): firstSessionPanel, firstWorkbench, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps (+24 more)
...
Cohesion: 0.09
Nodes (35): CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath(), readEvents() (+27 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (34): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+26 more)
...
Cohesion: 0.05
Nodes (27): dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync }, redirectContent, workspacePath (+19 more)
...
Cohesion: 0.08
Nodes (21): TurnDiffSummary, DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+13 more)
...
Cohesion: 0.08
Nodes (28): setAgentStoppedNotifier(), getAllActiveQueues(), setPipelineHandler(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+20 more)
...
Cohesion: 0.11
Nodes (27): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+19 more)

### Community 171 - "Community 171"
Cohesion: 0.1
Nodes (30): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+22 more)
...
Cohesion: 0.09
Nodes (27): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, collectSessionTreeNodes(), API_ERROR_PATTERNS, buildReviewerNodes() (+19 more)
...
Cohesion: 0.18
Nodes (30): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), deleteBranches() (+22 more)
...
Cohesion: 0.12
Nodes (27): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), installGitHooks(), determineWorkspaceLocation() (+19 more)
...
Cohesion: 0.11
Nodes (25): HandoffContext, ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents() (+17 more)
...
Cohesion: 0.15
Nodes (18): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+10 more)
...
Cohesion: 0.13
Nodes (16): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ConversationEvent, TurnDiffFileChange, DiffStatLabel, hasNonZeroStat(), buildTurnDiffTree(), MutableDirectoryNode (+8 more)
...
Cohesion: 0.18
Nodes (20): appendCostEvent(), eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+12 more)
...
Cohesion: 0.1
Nodes (17): ChatMessage, MessagesTimeline, RoundMarker, deriveRoundMarkers(), TimestampedItem, markers, MESSAGES, meta (+9 more)
...
Cohesion: 0.1
Nodes (15): DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, ghCliIssue, githubApiIssue, githubOpenIssue (+7 more)
...
Cohesion: 0.2
Nodes (14): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput() (+6 more)
...
Cohesion: 0.33
Nodes (5): ToolFlash(), ToolFlashProps, { getByTestId }, { rerender, getByTestId }, { rerender, getByTestId, queryByTestId }
...
Cohesion: 0.5
Nodes (4): ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult, pathLeaf()
...
## Knowledge Gaps
- **11575 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11570 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 644`, `Community 133`, `Community 5`, `Community 134`, `Community 8`, `Community 4`, `Community 10`, `Community 12`, `Community 13`, `Community 19`, `Community 20`, `Community 533`, `Community 532`, `Community 28`, `Community 29`, `Community 30`, `Community 157`, `Community 160`, `Community 161`, `Community 38`, `Community 422`, `Community 42`, `Community 811`, `Community 44`, `Community 558`, `Community 48`, `Community 49`, `Community 52`, `Community 181`, `Community 55`, `Community 57`, `Community 58`, `Community 69`, `Community 71`, `Community 594`, `Community 595`, `Community 599`, `Community 90`, `Community 96`, `Community 753`, `Community 252`, `Community 126`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 156`, `Community 13`, `Community 6`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 142` to `Community 253`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11575 weakly-connected nodes found - possible documentation gaps or missing edges._
