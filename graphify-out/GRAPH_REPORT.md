...
## Corpus Check
- 1546 files · ~2,060,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21556 nodes · 31981 edges · 1142 communities (1107 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `051b851d`
...
## Communities (1142 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (179): readCavemanVariant(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+171 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (145): ViewMode, Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+137 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (101): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS (+93 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (136): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+128 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (121): cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+113 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, archiveReviewerRound(), buildReviewFeedbackBody() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (104): loadCloisterConfig(), cleanupStaleAgentState(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+96 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (90): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (100): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (84): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+76 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (82): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+74 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (87): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+79 more)
...
Cohesion: 0.03
Nodes (72): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps (+64 more)
...
Cohesion: 0.04
Nodes (79): finalizeRunLog(), buildSpecialistCavemanExports(), bumpSessionGeneration(), clearSessionId(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist() (+71 more)
...
Cohesion: 0.05
Nodes (64): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, buildTaskPrompt(), buildTestAgentPromptContent(), resolveWorkspaceGitInfo(), cleanFile(), configCommand() (+56 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (62): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+54 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (56): firstSessionPanel, firstWorkbench, overview, workbench, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps (+48 more)
...
Cohesion: 0.05
Nodes (51): doc, path, ACCompletionResult, criticalPath(), Wave, WaveItem, isRFC3339DateTime(), toRFC3339() (+43 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (58): emitCoordinatorDied(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+50 more)
...
Cohesion: 0.06
Nodes (60): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+52 more)
...
Cohesion: 0.06
Nodes (57): spawnReviewCoordinatorSession(), spawnSingleReviewer(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), destroyCommand(), updateCommand(), useConfigCommand() (+49 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (46): AgentCard(), AgentCardProps, LastHeardCounter(), PHASE_COLORS, stalenessColor(), STATUS_GLOW, STATUS_ICONS, AgentGrid() (+38 more)
...
Cohesion: 0.06
Nodes (50): getHealthThresholdsMs(), CostAlert, DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, AgentHealth (+42 more)
...
Cohesion: 0.07
Nodes (45): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, calls (+37 more)
...
Cohesion: 0.06
Nodes (42): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+34 more)
...
Cohesion: 0.05
Nodes (44): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions (+36 more)
...
Cohesion: 0.04
Nodes (41): listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getClientIp(), getConversationDiffFullRoute (+33 more)
...
Cohesion: 0.05
Nodes (45): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings() (+37 more)
...
Cohesion: 0.05
Nodes (45): calculateCost(), DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing, anthropicModels, cost, entries (+37 more)
...
Cohesion: 0.08
Nodes (39): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync, formatDuration(), generateReport(), parseTestOutput() (+31 more)
...
Cohesion: 0.1
Nodes (34): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), writeSpecForIssue(), asPanSpecDocument() (+26 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (33): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+25 more)
...
Cohesion: 0.06
Nodes (33): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+25 more)
...
Cohesion: 0.08
Nodes (34): content, d, existingDir, lines, oldDir, result, skillDir, getDefaultWorkspaceConfig() (+26 more)
...
Cohesion: 0.1
Nodes (35): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+27 more)

### Community 140 - "Community 140"
Cohesion: 0.08
Nodes (27): ComposerMode, IssueComposer(), IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult, StoppedAgentsBanner() (+19 more)
...
Cohesion: 0.12
Nodes (31): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+23 more)
...
Cohesion: 0.1
Nodes (30): CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult, approve() (+22 more)
...
Cohesion: 0.1
Nodes (31): Access, PrdLocation, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+23 more)
...
Cohesion: 0.16
Nodes (28): destroyRemoteWorkspace(), getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+20 more)
...
Cohesion: 0.22
Nodes (26): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+18 more)
...
Cohesion: 0.12
Nodes (23): HandoffContext, createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+15 more)
...
Cohesion: 0.17
Nodes (20): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+12 more)
...
Cohesion: 0.08
Nodes (18): containerRestartBackoffMs(), DeaconState, setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+10 more)
...
Cohesion: 0.15
Nodes (18): criteria, doc, result, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument(), formatAcceptanceCriteria(), getVBriefACStatus() (+10 more)
...
- **Why does `fetch` connect `Community 1` to `Community 132`, `Community 5`, `Community 646`, `Community 7`, `Community 9`, `Community 650`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 140`, `Community 146`, `Community 19`, `Community 20`, `Community 278`, `Community 23`, `Community 24`, `Community 538`, `Community 156`, `Community 157`, `Community 28`, `Community 287`, `Community 31`, `Community 34`, `Community 42`, `Community 557`, `Community 45`, `Community 559`, `Community 48`, `Community 183`, `Community 67`, `Community 195`, `Community 80`, `Community 81`, `Community 602`, `Community 93`, `Community 94`, `Community 752`, `Community 502`, `Community 127`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 129` to `Community 0`, `Community 7`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 23` to `Community 38`, `Community 8`, `Community 174`, `Community 562`, `Community 563`, `Community 348`, `Community 598`, `Community 22`, `Community 380`, `Community 758`, `Community 347`, `Community 92`?**
