...
## Corpus Check
- 1545 files · ~2,065,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21579 nodes · 32124 edges · 1129 communities (1094 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc02bd74`
...
## Communities (1129 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (178): checkApiErrorAgents(), checkStuckWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (125): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+117 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (143): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), patrolWorkAgentResolutions(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod (+135 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (127): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+119 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (115): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, format(), LiveCounter() (+107 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (132): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+124 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (106): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+98 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (117): checkPostReviewCommits(), setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (107): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+99 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (106): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+98 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (110): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+102 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (109): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+101 more)
...
Cohesion: 0.03
Nodes (79): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+71 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (60): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, createHandoffEvent(), generateHealthSummary() (+52 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (79): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+71 more)
...
Cohesion: 0.04
Nodes (75): checkPendingTestDispatch(), dispatchTestAgentAndNotify(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions, BUNDLED_HOOKS_DIR, __dirname (+67 more)
...
Cohesion: 0.03
Nodes (71): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+63 more)
...
Cohesion: 0.03
Nodes (60): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+52 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (71): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+63 more)
...
Cohesion: 0.06
Nodes (69): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument(), projectPanPaths() (+61 more)
...
Cohesion: 0.04
Nodes (58): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+50 more)
...
Cohesion: 0.04
Nodes (56): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+48 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (52): criteria, doc, result, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), formatAcceptanceCriteria() (+44 more)
...
Cohesion: 0.05
Nodes (58): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+50 more)
...
Cohesion: 0.05
Nodes (43): firstSessionPanel, firstWorkbench, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), ZoneBActionStrip() (+35 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (45): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (42): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, calls (+34 more)
...
Cohesion: 0.08
Nodes (44): isEligibleForCleanup(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+36 more)
...
Cohesion: 0.06
Nodes (41): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+33 more)
...
Cohesion: 0.09
Nodes (39): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+31 more)
...
Cohesion: 0.06
Nodes (27): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+19 more)
...
Cohesion: 0.11
Nodes (30): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, destroyPiFifo() (+22 more)
...
Cohesion: 0.1
Nodes (36): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, getDefaultWorkspaceConfig(), HumeConfig, replacePlaceholders(), addReposToWorkspace() (+28 more)
...
Cohesion: 0.11
Nodes (36): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd(), activeDir, completedDir (+28 more)
...
Cohesion: 0.09
Nodes (34): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), next (+26 more)
...
Cohesion: 0.09
Nodes (26): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+18 more)
...
Cohesion: 0.07
Nodes (32): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+24 more)
...
Cohesion: 0.11
Nodes (32): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+24 more)
...
Cohesion: 0.1
Nodes (27): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError(), invalidateProbeCache() (+19 more)
...
Cohesion: 0.12
Nodes (28): resolveBundledServerPath(), resolveNode22(), resolveScope(), RestartOptions, spawnDashboardDetached(), DASHBOARD_LOG_FILE, execAsync, isTraefikContainerRunning() (+20 more)

### Community 182 - "Community 182"
Cohesion: 0.1
Nodes (29): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+21 more)
...
Cohesion: 0.13
Nodes (25): clearFeedbackFiles(), writeStoryFeatureContext(), validatePlanMatchesIssue(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+17 more)
...
Cohesion: 0.1
Nodes (21): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+13 more)

### Community 222 - "Community 222"
Cohesion: 0.12
Nodes (22): AwaitingInputDetection, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+14 more)

### Community 223 - "Community 223"
Cohesion: 0.11
Nodes (26): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentPhase() (+18 more)
...
Cohesion: 0.15
Nodes (23): cleanupOrphanedReviewSessions(), killAllReviewSessions(), healthCommand(), HealthOptions, AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+15 more)
...
Cohesion: 0.16
Nodes (18): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions, closeLinearDirect() (+10 more)
...
Cohesion: 0.16
Nodes (12): getPiLauncherFields(), createPiFifo(), execAsync, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand(), chunks (+4 more)
...
Cohesion: 0.1
Nodes (12): first, found, path, paths, read, second, sessions, updated (+4 more)
...
Cohesion: 0.11
Nodes (14): ensureDefaultConversationModel(), buildMiniMaxFormData(), SettingsConfig, WORK_TYPE_CATEGORIES, allModelIds, config, defaults, DEPRECATED_MODEL_IDS (+6 more)
...
Cohesion: 0.15
Nodes (13): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, StepResult (+5 more)
...
Cohesion: 0.29
Nodes (7): callServerApi(), buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, onUpdateStatusChange()
...
Cohesion: 0.5
Nodes (3): FIXTURES, result, unknownLogs
...
- **Why does `fetch` connect `Community 8` to `Community 641`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 12`, `Community 13`, `Community 15`, `Community 528`, `Community 17`, `Community 278`, `Community 24`, `Community 154`, `Community 155`, `Community 157`, `Community 30`, `Community 158`, `Community 29`, `Community 802`, `Community 37`, `Community 169`, `Community 41`, `Community 44`, `Community 47`, `Community 50`, `Community 179`, `Community 180`, `Community 181`, `Community 54`, `Community 62`, `Community 193`, `Community 72`, `Community 88`, `Community 99`, `Community 102`, `Community 748`, `Community 123`, `Community 637`, `Community 638`, `Community 639`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 121` to `Community 0`, `Community 20`, `Community 12`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 5` to `Community 8`, `Community 2`, `Community 7`?**
