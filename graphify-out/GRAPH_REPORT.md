...
## Corpus Check
- 2097 files · ~3,702,370 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33263 nodes · 64539 edges · 1408 communities (1340 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1530 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61814fe2`
...
## Communities (1408 total, 68 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (299): loadDeaconWithResumeMock(), addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+291 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.01
Nodes (260): isCoordinatorAliveAsync(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+252 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (257): readCavemanVariant(), AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), getSpecialistState(), buildDigestPrompt() (+249 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (215): loadStartCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), unpauseCommand(), decode, decodeCandidate(), ev (+207 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (192): parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Command Deck (Core Concept), Access, computeAgentEnrichment(), computeAgentEnrichmentPromise(), execAsync (+184 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (163): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), BootstrapGate(), BootstrapGateProps (+155 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (113): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getActiveSessionModelSync(), getAllSessionFiles(), getAllSessionFilesSync(), getProjectDirs() (+105 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.03
Nodes (179): checkStuckWorkAgents(), buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), __dirname, execAsync, execFileAsync, __filename (+171 more)
...
Cohesion: 0.02
Nodes (163): fetchActivity(), updateConversationDeliveryMethod(), CloisterStatus, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), ActivityEntry (+155 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.03
Nodes (146): switchModel(), ZoneActionStripProps, OverviewTab, ArtifactLinks(), formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps (+138 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (132): config, DEFAULT_AUTO_RESUME_CONFIG, BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity() (+124 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (140): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), ListOptions, listStatesCommand(), listTeamStates(), bundledFrontendIndex (+132 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (120): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+112 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (146): archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), cleanupReviewTempStashPromise() (+138 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (115): ComposerMode, deriveComposerMode(), IssueComposer(), IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip() (+107 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.03
Nodes (136): pruneStaleCheckpointRefs(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+128 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (119): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+111 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.02
Nodes (138): parseDifficultyLabel(), LiveLastHeard(), BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+130 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (125): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+117 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.03
Nodes (127): HookEntry, DatabaseError, cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject() (+119 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.03
Nodes (113): determineCavemanVariant(), injectCavemanSettings(), addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), DnsSyncMethod, getDnsmasqConfigDir() (+105 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.02
Nodes (116): createTerminalWindow(), MockWindow, openTerminalWindow(), setAlwaysOnTop(), terminalWindows, win, buildContextMenu(), buildMenuTemplate() (+108 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.04
Nodes (117): approveCommand(), cancelCommand(), completeCommand(), formatTransition(), getProjectPath(), pad(), printRowsTable(), proposeCommand() (+109 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (91): DeaconLogEntry, getDeaconLogs(), getDeaconStatus(), getLastPatrolResult(), isDeaconRunning(), PatrolResult, stopDeacon(), mockGetRuntimeForAgent (+83 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.02
Nodes (93): ZoneBActionStrip(), AgentTellForm(), AgentTellFormProps, SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps (+85 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (109): after, before, blockers, result, statuses, after, row, status (+101 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.04
Nodes (107): buildPolyrepoContext(), createCostCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects() (+99 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.04
Nodes (104): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), CopyConfigOptions, db, makeTestLayer(), makeTestService(), received (+96 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (112): getSortKey(), sortConversations(), SortOption, FavoriteType, TitleSource, ids, ALLOWED_UPLOAD_MIME_TYPES, checkUploadRateLimit() (+104 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.02
Nodes (93): ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent(), classifierIssue() (+85 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.04
Nodes (105): ChatMessage, CompactBoundary, ContextUsage, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ComposerFooter() (+97 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (110): findProjectRoot(), estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+102 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.03
Nodes (106): annotated, before, candidate, check, claimed, defaults, doc, { doc: next } (+98 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (94): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+86 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (96): Work Agent (shown in inspector terminal), DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), copyToClipboard() (+88 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (94): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+86 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (83): healths, CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health (+75 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.07
Nodes (101): killTmuxSession(), content, mockExeca, clearReviewStatus(), removeWorktree(), archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl() (+93 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.04
Nodes (95): extractAcceptanceCriteria(), buildACLookupByTitle(), readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning() (+87 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.04
Nodes (78): mockClaudeSkills, contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion() (+70 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.04
Nodes (91): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+83 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.03
Nodes (91): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, deriveStageStatuses(), formatCost() (+83 more)
...
Cohesion: 0.03
Nodes (91): clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, WorkhorsesConfig, WorkhorseSlot (+83 more)
...
Cohesion: 0.03
Nodes (69): DrawerActivityRail(), pickDefaultDrawerAgent(), agents, DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates() (+61 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.04
Nodes (88): PRIORITY_LABELS, reopenWorkspaceStatePromise(), PlanningIssue, cb, mockExec, mockResolveGitHubIssue, prJson, result (+80 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.04
Nodes (80): ActivityFeedSidebar(), conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck() (+72 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.03
Nodes (78): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, exec(), execMock, execResponses, kCustom, mockIsRunning (+70 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.04
Nodes (88): details, updateConversationsConfig(), startRealConversationRoutes(), postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), rejectInvalidOrigin(), constantTimeTokenEqual() (+80 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.04
Nodes (77): defaults, first, issueAgentTypes, { models }, second, anthropicModel, anthropicRouter, apiKeys (+69 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.04
Nodes (72): InlineSparkline(), InlineSparklineProps, format(), LiveCounter(), LiveCounterProps, REVIEWER_STYLE, ReviewerRole, RoleBadge() (+64 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.04
Nodes (68): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), makeMergeSet() (+60 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.03
Nodes (79): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), db (+71 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.05
Nodes (75): LinearState, program, transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive (+67 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.05
Nodes (64): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), INFERENCE.md Artifact, result (+56 more)
...
Cohesion: 0.05
Nodes (76): traefikDir, devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), sleep(), waitForHealth() (+68 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (72): onToggle, cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize (+64 more)
...
Cohesion: 0.03
Nodes (70): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl() (+62 more)
...
Cohesion: 0.05
Nodes (72): ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity, writeObservations() (+64 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.03
Nodes (71): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+63 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.06
Nodes (63): skills, updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), hashFile() (+55 more)
...
Cohesion: 0.05
Nodes (60): startPostLaunchSidecars(), startSidecars(), runFullRestart(), systemHealthCommand(), delay(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath() (+52 more)
...
Cohesion: 0.04
Nodes (61): Conversation, ConversationListProps, fetchConversations(), ListTab, loadSort(), loadTab(), SORT_LABELS, updateConversationTitle() (+53 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.06
Nodes (63): resolveNode22(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError (+55 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.05
Nodes (62): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextValidateCommand(), LayerName, renderLayerForHarness() (+54 more)
...
Cohesion: 0.06
Nodes (54): { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues, output, error, createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker() (+46 more)

### Community 74 - "Checkpoint Capture and Diff Routes"
Cohesion: 0.05
Nodes (45): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getCloisterService() (+37 more)

### Community 75 - "Path Constants and Postinstall Setup"
Cohesion: 0.05
Nodes (64): createRegistryCommand(), formatRegistryEntry(), formatRegistryList(), formatRow(), parsePositiveInteger(), RegistryListCommandOptions, RegistryShowCommandOptions, RegistryTagCommandOptions (+56 more)

### Community 76 - "Cost Recovery Scripts and Latency Tests"
Cohesion: 0.04
Nodes (57): callApi(), CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, EMPTY_SEARCH, ExcerptSegment, fetchPaletteSearch() (+49 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (52): { projectPath, workspacePath }, promoted, specFiles, fsHooks, TABS, themeButton, VBriefDifficulty, VBriefDocument (+44 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.03
Nodes (65): existingSkillDir, existsInTarget, mockPanopticonSkills, nonSkillDir, skillDir, skillsToSync, sourcePath, stats (+57 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.05
Nodes (69): Agent Audit Report (2026-04-13), AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), buildTaskPrompt() (specialist prompt dispatch), Verification Gate (PAN-174), CloisterBanner Component (+61 more)

### Community 80 - "Skills Merge and Manifest Sync"
Cohesion: 0.03
Nodes (53): IssueStats, cost, db, DB_PATH, CLAUDE_PROJECTS, cost, db, DB_PATH (+45 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.04
Nodes (49): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, ComplexityModels, DashScopeModel (+41 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.05
Nodes (63): createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE (+55 more)
...
Cohesion: 0.05
Nodes (56): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+48 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.06
Nodes (63): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput (+55 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.04
Nodes (56): adminRouteLayer, getAdminTldrRoute, conversationsRouteLayer, FeatureRegistryListOptions, FeatureRegistryListPayload, featureRegistryRouteLayer, getFeatureRegistryListPayload(), listFeatureRegistryRoute (+48 more)
...
Cohesion: 0.05
Nodes (52): ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS, cacheKey(), ChatMarkdown, ChatMarkdownErrorBoundary, ChatMarkdownProps, CodeBlock() (+44 more)

### Community 92 - "Event Snapshot Cache and State Reducers"
Cohesion: 0.07
Nodes (30): getGitHubConfig(), cachedIssue, issues, octokitMocks, result, importTrackerConfig(), GitHubConfig, RallyConfig (+22 more)
...
Cohesion: 0.07
Nodes (59): handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+51 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.05
Nodes (56): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+48 more)

### Community 97 - "Conversation Panel and Chat Phase Types"
Cohesion: 0.05
Nodes (60): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), ConfigOptions, createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+52 more)

### Community 98 - "Database Settings and Cost Unit Tests"
Cohesion: 0.05
Nodes (41): listener(), wrapped(), chunks, emitter, googleMocks, stream, emitter, onTurn (+33 more)
...
Cohesion: 0.06
Nodes (57): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+49 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.06
Nodes (47): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), delay() (+39 more)

### Community 103 - "Claude OAuth Authentication and Settings"
Cohesion: 0.08
Nodes (62): filterPayload(), add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), array (+54 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.06
Nodes (51): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+43 more)
...
Cohesion: 0.06
Nodes (49): customPromisify, justNow, longAgo, old, recent, restartCalled, state, STATE_FILE (+41 more)
...
Cohesion: 0.06
Nodes (48): Claude Code Channels (Experimental), scriptPath, execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge() (+40 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.04
Nodes (22): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, client, FlyApiClient (+14 more)
...
Cohesion: 0.04
Nodes (50): oldTimestamp, sentinel, eightDaysAgo, events, makeDb(), payload, r1, r2 (+42 more)

### Community 112 - "TLDR Daemon State Management"
Cohesion: 0.04
Nodes (55): ScheduleAutoMergeInput, ScheduleAutoMergeResult, announceAutoMergeCancelled(), announceAutoMergeScheduled(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), AutoMergeCancelDeps, AutoMergeScheduleDeps (+47 more)
...
Cohesion: 0.06
Nodes (48): getCavemanExperimentData(), httpHandler(), HttpServerResponse, ReadModelServiceLive, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions (+40 more)

### Community 116 - "Merge Set and Review Artifact Creation"
Cohesion: 0.07
Nodes (56): addCommentBefore(), ALIAS, anchorIsValid(), atDocument(), callVisitor(), clone(), constructor(), createNode() (+48 more)
...
Cohesion: 0.06
Nodes (53): PendingOperation, decodeLayersResponse, decodePreviewRequest, decodePreviewResponse, decodeSaveRequest, decodeSyncRequest, parsed, preview (+45 more)
...
Cohesion: 0.08
Nodes (49): AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+41 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.06
Nodes (38): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+30 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.06
Nodes (42): betterSqlite3Path, createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime() (+34 more)

### Community 123 - "TTS Daemon and Pi Extension Supervisor"
Cohesion: 0.07
Nodes (48): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+40 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.08
Nodes (46): isEligibleForCleanup(), installGitHooks(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync (+38 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.07
Nodes (46): deriveProjectRoot(), doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending (+38 more)

### Community 126 - "Electron Desktop App Launch Scripts"
Cohesion: 0.1
Nodes (38): hookCommand(), HookOptions, checkAgentForViolations(), generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync() (+30 more)
...
Cohesion: 0.09
Nodes (41): detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace() (+33 more)
...
Cohesion: 0.06
Nodes (38): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, debounce(), isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage (+30 more)

### Community 131 - "Rally Tracker API Integration"
Cohesion: 0.05
Nodes (42): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+34 more)
...
Cohesion: 0.07
Nodes (47): getArtifactStatus(), listArtifacts(), ArtifactCommandDeps, artifactCreateCommand(), ArtifactCreateOptions, artifactListCommand(), artifactOpenCommand(), artifactPublishCommand() (+39 more)
...
Cohesion: 0.06
Nodes (35): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), EFFORT_LEVELS, EffortLevel, EffortPicker() (+27 more)

### Community 136 - "Parallel Code Review Prompt Templates"
Cohesion: 0.04
Nodes (37): isTaskReadySync(), beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+29 more)

### Community 137 - "Shadow Engineering Observer and Monitoring"
Cohesion: 0.05
Nodes (44): CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute (+36 more)
...
Cohesion: 0.06
Nodes (46): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+38 more)
...
Cohesion: 0.08
Nodes (37): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatus(), getMigrationStatusSync() (+29 more)

### Community 151 - "Dashboard Server Architecture Guidelines"
Cohesion: 0.05
Nodes (40): registerFlywheelCommands(), flywheelRouteLayer, getAutoMergeProblemPayload(), postFlywheelPausePayload(), postFlywheelResumePayload(), postFlywheelStartPayload(), abort, aborted (+32 more)
...
Cohesion: 0.08
Nodes (42): doneCommand(), DoneOptions, execAsync, isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+34 more)

### Community 157 - "Test Agent Dispatch and Recovery Tests"
Cohesion: 0.09
Nodes (43): advanceBudgetRecord(), DEFAULT_DOCS_CONFIG, docsBudgetKey(), DocsBudgetRecord, DocsBudgetState, DocsDisableEntry, DocsDisableState, DocsGateReason (+35 more)
...
Cohesion: 0.05
Nodes (39): CI_FAILED_STATUS, ciBlockedStatus, feedbackDir, mockGetAgentRuntimeState, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSendKeysAsync, mockSessionExists (+31 more)

### Community 160 - "Doctor Health Check and Path Resolution"
Cohesion: 0.05
Nodes (33): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, mockExistsSync (+25 more)
...
Cohesion: 0.08
Nodes (42): flywheelAbortCommand(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata(), deriveRunStatus() (+34 more)
...
Cohesion: 0.07
Nodes (42): CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage(), ContentBlock, ConversationActivitySummary, ConversationWatchHandle (+34 more)
...
Cohesion: 0.11
Nodes (40): listTestsCommand(), deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath() (+32 more)

### Community 180 - "Project Living Memory PRD"
Cohesion: 0.05
Nodes (35): PANOPTICON_HOME, Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config, config1 (+27 more)
...
Cohesion: 0.08
Nodes (40): isRecord(), isSubagentHookPayload(), SubagentHookPayload, enqueuePipeline, getTranscriptSize, registerTranscript, response, statTranscript (+32 more)

### Community 183 - "Review Workflow Command Coordination"
Cohesion: 0.11
Nodes (38): deriveDotStatus(), presenceToStatus(), useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), useAvailableModels(), activityToStatus(), capitalize() (+30 more)
...
Cohesion: 0.06
Nodes (32): mockFetch(), cb, cmdArgs, cmdStr, inline, issueCommentsJson, linearGetComments, linearGetIssueId (+24 more)

### Community 187 - "Self Improving Flywheel and Agent Messaging"
Cohesion: 0.07
Nodes (33): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+25 more)
...
Cohesion: 0.06
Nodes (29): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+21 more)

### Community 193 - "Workflow Orchestration and vBRIEF Research"
Cohesion: 0.08
Nodes (35): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel() (+27 more)

### Community 194 - "Agent Types Pipeline Documentation"
Cohesion: 0.06
Nodes (31): ensuredLabels, mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubEnsureLabel, mockGitHubRemoveLabel, mockGitHubReopenIssue, mockLinearGetIssue, mockLinearGetTeamStates (+23 more)

### Community 195 - "Tmux Capture Pane Elimination PRD"
Cohesion: 0.1
Nodes (32): isAgentIdleForNudge(), StuckRemediationConfig, evaluateAgent(), evaluateFlywheelOrchestrator(), execFileAsync, firstStuckAt(), hasReadyBeads(), issueIdForAgent() (+24 more)
...
Cohesion: 0.08
Nodes (36): after, backupPath, backups, calls, errSpy, exitSpy, original, out (+28 more)
...
Cohesion: 0.11
Nodes (26): contextCommand(), ContextOptions, appendSummary(), appendSummarySync(), checkContextBudget(), checkContextBudgetSync(), ContextBudget, estimateTokens() (+18 more)

### Community 208 - "Agent Launcher Command Generation"
Cohesion: 0.08
Nodes (37): CliproxyCodexCredentials, getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned (+29 more)
...
Cohesion: 0.12
Nodes (29): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, confirmDropRecovery(), isSwarmRecoverAction(), recoverSwarmCommand() (+21 more)

### Community 217 - "Git Divergence and Conversation Patch Tests"
Cohesion: 0.09
Nodes (35): getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), detectBranch() (+27 more)
...
Cohesion: 0.07
Nodes (23): ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), syncTranscriptPollerRegistry() (+15 more)
...
Cohesion: 0.07
Nodes (26): derivePlanningIssueId(), fetchOutput(), popoutTerminal(), TerminalPanel(), TerminalPanelProps, agent, queryClient, renderTerminalPanel() (+18 more)

### Community 228 - "Desktop Build and Monorepo Release Tests"
Cohesion: 0.08
Nodes (34): ACTIVITY_SOURCE_OPTIONS, AGENT_CATEGORIES, AgentCategory, AgentDef, DEFAULT_VOICE_HARDWARE_SETTINGS, DEFAULT_VOICE_SETTINGS, fetchMiniMaxDefaults(), fetchOpenRouterCatalog() (+26 more)

### Community 229 - "Work Done and Rebase Pipeline Tests"
Cohesion: 0.11
Nodes (37): defaultFlywheelPrompt(), flywheelRunConfigurationSection(), getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), spawnFlywheelAgent(), startFlywheelRun(), abortFlywheelRunForDashboard() (+29 more)
...
Cohesion: 0.06
Nodes (24): closeResult, command, ctx, editCalls, labelResult, prResult, archiveIdx, beadsDir (+16 more)
...
Cohesion: 0.13
Nodes (32): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateTokens() (+24 more)
...
Cohesion: 0.1
Nodes (30): activeViolations, clearOldViolations(), clearOldViolationsEffect(), clearOldViolationsSync(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig, FPPViolationType (+22 more)
...
Cohesion: 0.11
Nodes (32): appendSystemPromptFile(), drainPendingEvents(), envFor(), getDashboardUrl(), handlePanDone(), handleSessionBriefingContext(), handleSessionStart(), handleToolExecutionEnd() (+24 more)

### Community 264 - "God View Agent Cards and Activity Tree"
Cohesion: 0.09
Nodes (28): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), stripFrontmatter(), syncSkillsToTools(), syncSkillsToToolsSync() (+20 more)

### Community 265 - "Issue Triage Agent and Analysis"
Cohesion: 0.07
Nodes (28): output, calls, logSpy, now, output, payload, {
...
Cohesion: 0.1
Nodes (30): GLOBAL_CONFIG_PATH, Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds() (+22 more)
...
Cohesion: 0.09
Nodes (26): appendFreshBriefingUpdate(), AppendFreshBriefingUpdateInput, AppendFreshBriefingUpdateResult, briefingFilePath(), BriefingSessionMarker, buildBriefingUpdateBlock(), escapeBriefingContent(), isNotFound() (+18 more)

### Community 280 - "vBRIEF Types Builder and Viewer"
Cohesion: 0.07
Nodes (25): activeContinuePath, continuePath, projectRoot, wsDir, agentDir, agentResult, beadsDir, branchResult (+17 more)
...
Cohesion: 0.12
Nodes (28): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+20 more)
...
Cohesion: 0.11
Nodes (31): injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook(), updateTtsConfig() (+23 more)
...
Cohesion: 0.08
Nodes (21): CleanResult, execAsync, WorkspaceInfo, WorkspaceService, WorkspaceServiceLive, WorkspaceServiceShape, MOCK_PROJECT, mockCreateWorkspace (+13 more)
...
Cohesion: 0.12
Nodes (26): getArtifactSnapshotPath(), ArtifactLifecycleOptions, ArtifactProvenanceInput, ArtifactValidationError, copyPublishedSnapshot(), createArtifact(), CreateArtifactOptions, decodeHtmlText() (+18 more)
...
Cohesion: 0.08
Nodes (27): Codex OAuth Authentication, Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider (+19 more)
...
Cohesion: 0.1
Nodes (25): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, settings, FIXTURES_DIR (+17 more)
...
Cohesion: 0.07
Nodes (14): build, cliPromptsDir, copyCavemanAssets(), copyCloisterPrompts(), copyMatching(), copyPrompts, dashboardDir, distDir (+6 more)
...
Cohesion: 0.1
Nodes (20): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+12 more)

### Community 328 - "Testing Guide and Conventions Docs"
Cohesion: 0.18
Nodes (27): createFlyProvider(), getRemoteProvider(), ProviderType, RemoteProvider, RemoteProviderConfig, AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext() (+19 more)
...
Cohesion: 0.07
Nodes (25): DEACON_DIR, DeaconConfig, DeaconState, config, config1, config2, CONFIG_FILE, customConfig (+17 more)

### Community 349 - "Effect Route Handler Idiomatic Rewrite"
Cohesion: 0.12
Nodes (22): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsError (+14 more)
...
Cohesion: 0.08
Nodes (23): next, restored, s, start, withAgent, cb, cmdArgs, key (+15 more)
...
Cohesion: 0.11
Nodes (19): ActivityFeedCard(), ActivityFeedCardProps, BucketSection(), BucketSectionProps, ActivitySessionFeedEntry, CommentSessionFeedEntry, FileChangeSessionFeedEntry, PlaceholderSessionFeedEntry (+11 more)

### Community 378 - "Linear Issue States Tests"
Cohesion: 0.14
Nodes (22): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+14 more)

### Community 379 - "Issue Beads Enforcement Tests"
Cohesion: 0.13
Nodes (20): ensureOpenAICompatibleProxyRunning(), buildAnthropicMessagesUrl(), CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+12 more)

### Community 380 - "Cost Event Recording Types"
Cohesion: 0.1
Nodes (20): collectLifecycleRows(), rowCreatedDate(), resolvePlanLocation(), VBriefInvalidFormatError, VBriefMergeConflictError, VBriefMergeConflictTaggedError, VBriefReadError, buildProjectIndex() (+12 more)
...
Cohesion: 0.15
Nodes (20): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), EnrichmentApiConfig (+12 more)
...
Cohesion: 0.09
Nodes (19): ensureDefaultConversationModel(), ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness (+11 more)

### Community 393 - "End-to-End Test Fixture"
Cohesion: 0.13
Nodes (19): beads, capturedArgs, err, mockExecFileFn, mockExecFn, BeadRecord, checkOpenBeads(), checkOpenBeadsPromise() (+11 more)
...
Cohesion: 0.11
Nodes (21): CostEntry, DEFAULT_PRICING, ModelPricing, anthropicModels, cost, haikuPricing, mockEntries, opusPricing (+13 more)
...
Cohesion: 0.2
Nodes (16): backup, backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), createBackup() (+8 more)

### Community 446 - "Community 446"
Cohesion: 0.14
Nodes (20): assertIssueHasBeads(), assertIssueHasBeadsEffect(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise() (+12 more)

### Community 447 - "Community 447"
Cohesion: 0.15
Nodes (20): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+12 more)

### Community 448 - "Community 448"
Cohesion: 0.14
Nodes (18): startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), LIFECYCLE_EVENT_TYPES, onEvent() (+10 more)
...
Cohesion: 0.09
Nodes (21): MODELS_BY_PROVIDER, Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, buildMiniMaxFormData(), buildTtsAutosavePayload() (+13 more)

### Community 452 - "Community 452"
Cohesion: 0.18
Nodes (18): clearFeedbackFiles(), clearFeedbackFilesPromise(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+10 more)

### Community 453 - "Community 453"
Cohesion: 0.15
Nodes (19): getUnblockedItemsEffect(), isTaskReadyEffect(), extractAcceptanceCriteria(), criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted() (+11 more)
...
Cohesion: 0.09
Nodes (21): TranscriptEntry, AIProvider, branch, branchMatch, buffer, cavemanVariant, cost, entry (+13 more)
...
Cohesion: 0.1
Nodes (16): NormalizedTtsDaemonConfig, parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdogConfig, TtsWatchdogStatus, CONFIG, hadPackageDir, hadPython (+8 more)

### Community 492 - "Community 492"
Cohesion: 0.1
Nodes (18): CostEvent, appendToWal(), appendToWalSync(), resolveWalDir(), dir, event, eventsDir1, eventsDir2 (+10 more)
...
Cohesion: 0.13
Nodes (19): fetchCurrentFlywheelStatus(), fetchPendingAutoMerges(), FLYWHEEL_CONFIG_QUERY_KEY, FlywheelConfig, FlywheelConfigPatch, FlywheelLeftTab, FlywheelPage(), FlywheelPageProps (+11 more)

### Community 495 - "Community 495"
Cohesion: 0.18
Nodes (19): checkCommand(), execAsync, getMissingToolsForFeature(), INSTALLABLE_TOOLS, installBeads(), installMkcert(), installOx(), InstallResult (+11 more)
...
Cohesion: 0.17
Nodes (14): canonicalPrdSubdir(), canonicalPrdSubdirSync(), findDraftPrd(), findDraftPrdSync(), findPrdAnywhere(), findPrdAnywhereSync(), findPrdAtStatus(), findPrdAtStatusSync() (+6 more)
...
Cohesion: 0.17
Nodes (15): ApiKeysConfig, ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanel(), ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS (+7 more)
...
Cohesion: 0.13
Nodes (14): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+6 more)
...
Cohesion: 0.11
Nodes (15): cache, capped, cpuList, events, lines, memFree, memTotal, result (+7 more)
...
Cohesion: 0.21
Nodes (14): planCommand(), PlanOptions, runDiscoveryPhase(), analyzeComplexity(), ComplexityAnalysis, copyToPRDDirectory(), DiscoveryDecision, executePlan() (+6 more)

### Community 564 - "Community 564"
Cohesion: 0.17
Nodes (15): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+7 more)
...
Cohesion: 0.15
Nodes (14): FeedTabContent(), SessionFeedTab, useGitFeed(), filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), useMergedFeed(), UseMergedFeedResult, duplicate (+6 more)
...
Cohesion: 0.14
Nodes (14): actual, captureCommandHelp(), captureHelp(), __dirname, expected, FIXTURE_PATH, plural, singular (+6 more)
...
Cohesion: 0.12
Nodes (15): allLogs, logPath, mockCleanupAllLogs, mockCleanupOldLogs, mockConsoleError, mockConsoleLog, mockExec, mockExit (+7 more)
...
Cohesion: 0.19
Nodes (10): mockExec, calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+2 more)

### Community 623 - "Community 623"
Cohesion: 0.25
Nodes (13): getDefaultTtsDaemonConfig(), mergeTtsDaemonConfigs(), YamlConfig, cloneTtsConfig(), currentConfig, findProjectRootAsync(), pathExists(), readProjectConfig() (+5 more)
...
Cohesion: 0.17
Nodes (15): checkLazyAgent() (17-pattern lazy detection), confirmDelivery() (tmux delivery verification), flywheel-change Issue Label, Flywheel Daemon (autonomous self-improvement loop), FLYWHEEL-REPORT.md (living self-improvement changelog), Heartbeat Hook (PostToolUse), PAN-709 Self-Improving Flywheel PRD, PAN-798 Research & Audits Document (+7 more)

### Community 648 - "Community 648"
Cohesion: 0.22
Nodes (12): TestConfig, execAsync, formatDuration(), generateReport(), parseTestOutput(), RunTestsOptions, runTestsPromise(), runTestSuite() (+4 more)
...
Cohesion: 0.27
Nodes (12): abortSignal(), AgentRuntimeFetchError, emitActivity(), emitAgentEvent(), emitChannelReply(), emitMessageReceived(), emitModelSet(), emitResolution() (+4 more)
...
Cohesion: 0.22
Nodes (9): ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, bar, { container } (+1 more)
...
Cohesion: 0.15
Nodes (12): C.1 Update `isReviewPipelineStuck` in `src/dashboard/frontend/src/lib/pipeline-state.ts`, C.2 Add recovery indicator helpers to `KanbanBoard.tsx`, C.3 Add pulsing border and recovery badge to the card, C.4 Add recovery badge in the card header, C.6 Style compliance, C. Frontend: Kanban Card Recovery Indicators, code:typescript (export function isReviewPipelineStuck(status?: PipelineState), code:typescript (export function isReviewPipelineStuck(status?: PipelineState) (+4 more)
...
Cohesion: 0.17
Nodes (11): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+3 more)

### Community 762 - "Community 762"
Cohesion: 0.17
Nodes (11): first, kCustom, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref (+3 more)
...
Cohesion: 0.18
Nodes (10): card, commitLink, metrics, onNavigateAgent, onNavigateIssue, rows, status, suggestions (+2 more)
...
Cohesion: 0.18
Nodes (9): code:bash (# In directory: /Users/name/Google Drive/...), Contents, Database Errors on Cloud Storage, Interface-Specific Troubleshooting, Quick Reference: Common Fixes, Related Documentation, Root Cause, Symptom (+1 more)
...
Cohesion: 0.18
Nodes (11): Auto-planning, code:bash (pan plan PAN-1071), code:bash (pan plan PAN-1071 --auto), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Planning Workflow, Starting planning, Step 1: Start Planning Session (+3 more)
...
Cohesion: 0.18
Nodes (9): Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan finalize), Finalizing (`pan plan finalize`), Panopticon Planning Lifecycle, Related commands, See also (+1 more)
...
Cohesion: 0.22
Nodes (7): { activeSessions }, agentDir, fortyMinutesAgo, runDetermineHealthStatus(), twentyMinutesAgo, determineHealthStatus(), determineHealthStatusAsync()
...
Cohesion: 0.29
Nodes (8): dashboardBaseUrl(), mergeCancelCommand(), readErrorMessage(), registerMergeCommands(), cancel, merge, mocks, program
...
Cohesion: 0.22
Nodes (6): activeDir, completedDir, ctx, { mockExecAsync }, result, wsPath
...
Cohesion: 0.31
Nodes (7): EnrichedReviewStatus, enrichReviewStatusFromSessions(), enrichReviewStatusPromise(), mostRecentByTimestamp(), parseReviewerTimestamp(), parseTrailingTimestamp(), ReviewEnrichmentError
...
Cohesion: 0.22
Nodes (7): IssueRow(), IssueRowProps, MetricStrip(), MetricTile(), MetricTileProps, TILE_TONE_CLASS, VERB_CLASS
...
Cohesion: 0.33
Nodes (7): PersistedState, readPersisted(), useConversationUiState(), writePersisted(), parsed, raw, { result }
...
Cohesion: 0.39
Nodes (6): asString(), firstLine(), summarizeToolInputForWorkLog(), truncate(), long, result
...
Cohesion: 0.25
Nodes (6): CLI_PATH, __dirname, { stdout }, { stdout, status }, { stdout, stderr }, CLI_PATH
...
Cohesion: 0.38
Nodes (6): getLiveIssueCostForIssue(), LIVE_AGENT_STATUSES, normalizeIssueId(), normalizePositiveCost(), ResolvedIssueHeadlineCost, ResolveIssueHeadlineCostOptions
...
Cohesion: 0.33
Nodes (5): registerSwarmCommands(), mocks, program, recover, swarm
...
Cohesion: 0.33
Nodes (6): code:bash (# Wrong location (cloud sync)), code:bash (mv ~/Google\ Drive/project ~/Repos/project), code:bash (bd init myproject), code:bash (bd import < issues-backup.jsonl), code:bash (# Don't initialize bd in cloud-synced directory), Resolution
...
Cohesion: 0.33
Nodes (5): command, jetBrainsCommands, mockExecAsync, mockSpawn, program
...
Cohesion: 0.5
Nodes (3): inspect, { mockResolveProjectFromIssue, mockSpawnInspectAgent, mockGetDiffBase, mockGetDiffStats }, program
...
Cohesion: 0.67
Nodes (3): C.5 Update `phaseLabel` to show recovery state, code:typescript (const phaseLabel =), code:typescript (const phaseLabel =)
...
## Knowledge Gaps
- **14217 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14212 more)
...
- **Why does `ConversationEvent` connect `Command Deck Zone B Session Nodes` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Community 513`, `Specialist Handoff and Planning Spawn`, `Core Project Docs and Scripts`, `Conversation Database and Favorites`, `Inspector Panel Terminal UI`, `Electron Desktop App and Tray`, `Health Metrics and Settings Pages`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `Project Tree Feature Items UI`, `Cloister Config Deep Merge`, `Context History Logging and Search`, `Turn Diff File Change Tree UI`, `Project Resolution and Review Enrichment`, `VBrief Task Readiness and Beads IO`, `Community 565`, `Platform Supervisor Startup Lifecycle`, `Issue Tracker Polling Service`, `Fly Remote Provider and API Client`, `Settings Page Model Override and Auth`, `Issue Lifecycle Service and Tests`, `Pending Feedback Queue Delivery`, `Agent List and Handoff Status UI`, `Workspace Teardown and Label Cleanup`, `Swarm Dispatch and DAG Execution`, `Activity Panel and VTT Parsing`, `Community 598`, `CLI Command Taxonomy Reorganization`, `Command Deck Action Registry Pipeline`, `Rally Tracker Adapter Tests`, `Cost Data Migration and Reconciliation`, `Cloister Pipeline Unit Tests`, `Specialist Agent Prompts and Audit Docs`, `Agent Hook Scripts and Repo Artifact Design`, `Review Debug Script`, `TTS Daemon and Pi Extension Supervisor`, `Electron Desktop App Launch Scripts`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `specialists` connect `Command Deck Overview Tab UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Specialist Handoff and Planning Spawn`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Kanban Board Agent Status UI`, `Health Metrics and Settings Pages`, `Workspace Lifecycle and Config`, `Database Schema and Review Status`, `VBrief Lifecycle IO and Transitions`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `AI Model Capability Research Framework`, `Community 415`, `Cost Events Database and WAL Sync`, `Cost Event Aggregation and Retention`, `Issue Cost Resolution and Normalization`, `Model Selection and Subscription Policy`, `Project Resolution and Review Enrichment`, `Codex Agent Spawn UI Flow`, `VBrief Task Readiness and Beads IO`, `Fly Remote Provider and API Client`, `Community 446`, `Specialist Commands and VBrief Index`, `Model Routing and Complexity Detection`, `Issue Search Modal and Filter State`, `Conversation Compaction and Fork Pipeline`, `CLI Command Taxonomy Reorganization`, `Issue Tracker Linking Tests`, `Specialist Agent Health Dashboard UI`, `Smee Webhook Proxy Process Management`, `Agent Hook Scripts and Repo Artifact Design`, `TTS Daemon and Pi Extension Supervisor`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `string()` connect `Agent Session Lifecycle Management` to `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Health Metrics and Settings Pages`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Dashboard HTTP Routes and Admin`, `Dashboard Store and Command Palette`, `VBrief Lifecycle IO and Transitions`, `Docker Stats and Container Resources`, `VBrief Beads IO and Plan Finalize`, `Project Tree Feature Items UI`, `CLI Install DNS and Dev Commands`, `Cost Event Aggregation and Retention`, `Chat Messages Timeline Rendering`, `Work Type Routing and Config`, `Chat Composer Model Picker`, `Workspace Metadata and Project Config`, `Cloister Service Handoff Logging`, `Model Selection and Subscription Policy`, `Project Resolution and Review Enrichment`, `Community 562`, `Community 563`, `Platform Supervisor Startup Lifecycle`, `Settings Provider and Model Browser UI`, `Community 569`, `Fly Remote Provider and API Client`, `Settings Page Model Override and Auth`, `Permission Request Bridge and Forwarding`, `Issue Lifecycle Service and Tests`, `System Health and Spawn Guardrails`, `Server Cache Service and Chat Markdown`, `Diff Panel Rendering and Theming`, `GitHub Webhook Ingestion Handlers`, `GitHub Client and Agent Spawner`, `Settings Persistence and Model Defaults`, `Resource Process Discovery and Reporting`, `Checkpoint Capture and Diff Routes`, `Conversation Compaction and Fork Pipeline`, `Cloister Orchestrator Architecture PRDs`, `Community 1113`, `Frontend Dashboard Component Tests`, `Community 601`, `User Documentation and Provider Guides`, `Traefik DNS and Platform Install Skills`, `Conversation Panel and Chat Phase Types`, `Database Settings and Cost Unit Tests`, `Desktop Menu and Auto-Updater Lifecycle`, `Project Config and Team Prefix Resolution`, `Claude OAuth Authentication and Settings`, `Specialist Agent Health Dashboard UI`, `Cloister Pipeline Unit Tests`, `TLDR Daemon State Management`, `Specialist Pipeline PRDs and Skills`, `Merge Set and Review Artifact Creation`, `TTS Daemon and Pi Extension Supervisor`, `Reviewer Tree and Command Deck Dashboard`, `Agent Health Event Persistence`, `Specialist Run Log Lifecycle`, `Remote Agent Provisioning on Fly`, `Rally Tracker API Integration`, `Conversation Attachment Lifecycle Management`, `Issue Lifecycle Workflow Execution`, `Agent CV and Show Commands`, `Community 688`, `Work Done Preflight Validation`, `Community 693`, `Git Forge PR and MR Artifact Creation`, `Tmux Capture Pane Elimination PRD`, `Dashboard WebSocket RPC Client Transport`, `Community 725`, `Community 727`, `Dashboard Bootstrap and Projection Cache Specs`, `Community 769`, `Project Setup and Polyrepo Workspace PRDs`, `AI Model Capability Research Framework`, `Implementation Gaps Audit and Metrics PRD`, `Multi-Model Runtime Consolidation PRDs`, `Git Rebase and Conflict Resolution`, `Community 827`, `t3code Architecture Alignment Research`, `Community 873`, `Dashboard Header Skeleton Component`, `Smart Selection Explainer UI`, `Universal Skills Documentation`, `End-to-End Test Fixture`, `Community 410`, `Community 442`, `Community 444`, `Community 446`, `Community 452`, `Community 453`, `Community 482`, `Community 494`, `Community 495`, `Community 510`, `Community 511`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14217 weakly-connected nodes found - possible documentation gaps or missing edges._
