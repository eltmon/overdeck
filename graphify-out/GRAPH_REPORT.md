...
## Summary
- 26663 nodes · 41424 edges · 1246 communities (1195 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 505 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10228a9b`
...
## Communities (1246 total, 51 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (169): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+161 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (166): ConversationList(), updateConversationTitle(), fetchConversations(), GeneralConversation, GeneralSectionProps, CommandDeck(), CommandDeckProps, ContainerStats (+158 more)
...
Cohesion: 0.02
Nodes (134): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+126 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (136): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+128 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (101): execAsync, rebaseFeatureBranch(), RebaseResult, parsePiSession(), getPiLauncherFields(), waitForPiAgentReady(), openBrowser(), runCommand() (+93 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (125): DrawerBeadsList(), PhaseTimeline(), adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails() (+117 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (123): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+115 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (122): spawnInspectAgent(), buildSpecialistBaseCommand(), generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), listConversations(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, buildAgentLaunchConfig() (+114 more)
...
Cohesion: 0.03
Nodes (116): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (103): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+95 more)
...
Cohesion: 0.02
Nodes (103): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+95 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (88): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (109): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+101 more)
...
Cohesion: 0.02
Nodes (101): AgentRuntimeState, detectPlatform(), Platform, agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle() (+93 more)
...
Cohesion: 0.03
Nodes (80): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc, path (+72 more)
...
Cohesion: 0.02
Nodes (81): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+73 more)
...
Cohesion: 0.03
Nodes (89): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+81 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (85): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+77 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (80): buildPolyrepoContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+72 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (87): estimateCost(), defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig (+79 more)
...
Cohesion: 0.04
Nodes (78): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext(), readFeatureContext() (+70 more)
...
Cohesion: 0.05
Nodes (70): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+62 more)
...
Cohesion: 0.03
Nodes (51): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+43 more)
...
Cohesion: 0.07
Nodes (71): extractNumber(), extractPrefix(), archivePlanning(), archiveWorkspaceArtifactsImpl(), execAsync, movePrdImpl(), applyClosedOutLabel(), applyLabelGitHub() (+63 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (61): addRepoCommand(), AddRepoOptions, convertToSshUrl(), CreateOptions, DestroyOptions, encodeBeadsVersion(), execAsync, getBeadsVersion() (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (56): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+48 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (62): finalizeRunLog(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+54 more)
...
Cohesion: 0.05
Nodes (58): VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions() (+50 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (58): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+50 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (58): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+50 more)
...
Cohesion: 0.04
Nodes (52): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+44 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (58): getMemoryStatus(), events, identity, writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir() (+50 more)
...
Cohesion: 0.06
Nodes (52): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+44 more)
...
Cohesion: 0.07
Nodes (53): embedAction(), SearchQuery, showAction(), runWithPool(), WorkPoolStats, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), ConversationFilter (+45 more)
...
Cohesion: 0.06
Nodes (52): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+44 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (45): conversationsTab, firstLens, lens, overview, tablist, ComposerMode, IssueComposer(), IssueComposerProps (+37 more)
...
Cohesion: 0.05
Nodes (42): ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent(), classifierIssue(), CostBadge(), CostBreakdownPopover() (+34 more)
...
Cohesion: 0.05
Nodes (48): agentDir, missing, snapshot, status, AgentEnrichment, ReviewStatus, discoverNewAgentIds(), Jsonish (+40 more)
...
Cohesion: 0.06
Nodes (46): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+38 more)
...
Cohesion: 0.06
Nodes (44): parseContainerServiceName(), parseIssueIdFromText(), listSessionNamesAsync(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues() (+36 more)
...
Cohesion: 0.07
Nodes (41): logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind (+33 more)
...
Cohesion: 0.04
Nodes (41): ActivityLevel, ActivitySource, emitActivityEntry(), EmitActivityOptions, emitActivityTts(), EmitDetailedOptions, EmitTtsOptions, normalizeForSpeech() (+33 more)
...
Cohesion: 0.07
Nodes (45): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), detectFirstAvailableEditor(), Editor (+37 more)
...
Cohesion: 0.09
Nodes (44): clearFlywheelRunGate(), flywheelAbortCommand(), startFlywheelRun(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRunForDashboard(), abortFlywheelRun() (+36 more)
...
Cohesion: 0.07
Nodes (45): arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding(), FtsRow (+37 more)
...
Cohesion: 0.1
Nodes (35): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+27 more)
...
Cohesion: 0.06
Nodes (38): BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute, getFlywheelConversationRoute (+30 more)
...
Cohesion: 0.07
Nodes (39): findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), deleteBranchesImpl() (+31 more)
...
Cohesion: 0.07
Nodes (35): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels() (+27 more)
...
Cohesion: 0.13
Nodes (32): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset() (+24 more)
...
Cohesion: 0.07
Nodes (30): inferIssueIdFromWorkspace(), readPendingFeedback(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths() (+22 more)
...
Cohesion: 0.08
Nodes (22): configShadowCommand(), ShadowOptions, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus() (+14 more)
...
Cohesion: 0.08
Nodes (31): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), Handler, PipelineEvent, setPipelineHandler(), closeMemoryFtsDatabases(), stopTranscriptPoller(), getIssueDataService() (+23 more)
...
Cohesion: 0.08
Nodes (28): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, Access (+20 more)
...
Cohesion: 0.08
Nodes (27): sentinel, emitReactiveLifecycleEvent(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore (+19 more)
...
Cohesion: 0.14
Nodes (27): GitHubApiError, LinearApiError, config, originalEnv, tracker, TrackerConfig, AnyTrackerError, Comment (+19 more)
...
Cohesion: 0.11
Nodes (26): determineModel(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapper(), LauncherConfig (+18 more)
...
Cohesion: 0.09
Nodes (16): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+8 more)
...
Cohesion: 0.13
Nodes (30): saveResumeSessionId(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId(), getPlatformOpenCommand() (+22 more)

### Community 255 - "Community 255"
Cohesion: 0.13
Nodes (30): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken() (+22 more)
...
Cohesion: 0.13
Nodes (17): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+9 more)
...
Cohesion: 0.13
Nodes (18): FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+10 more)
...
Cohesion: 0.13
Nodes (18): BASE_TIME, loadAgents(), loadDeaconWithResumeMock(), saveStoppedAgent(), state, updated, workspaceFor(), AgentRuntimeFetchError (+10 more)
...
Cohesion: 0.28
Nodes (7): EditorLaunch, execAsync, getFileManagerCommand(), isCommandAvailable(), PanOpenLive, PanOpenShape, resolveEditorLaunch()
...
Cohesion: 0.33
Nodes (4): chalk, logs, output, parsed
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 263`, `Community 7`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 154`, `Community 286`, `Community 158`, `Community 31`, `Community 33`, `Community 32`, `Community 37`, `Community 679`, `Community 39`, `Community 170`, `Community 684`, `Community 45`, `Community 436`, `Community 55`, `Community 58`, `Community 59`, `Community 65`, `Community 453`, `Community 70`, `Community 203`, `Community 333`, `Community 334`, `Community 335`, `Community 206`, `Community 80`, `Community 79`, `Community 211`, `Community 85`, `Community 470`, `Community 727`, `Community 90`, `Community 97`, `Community 611`, `Community 232`, `Community 235`, `Community 243`, `Community 125`, `Community 381`, `Community 255`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 21` to `Community 32`, `Community 64`, `Community 3`, `Community 35`, `Community 102`, `Community 70`, `Community 9`, `Community 10`, `Community 300`, `Community 301`, `Community 302`, `Community 845`, `Community 179`, `Community 27`, `Community 93`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 5` to `Community 0`, `Community 2`, `Community 4`, `Community 264`, `Community 265`, `Community 10`, `Community 12`, `Community 17`, `Community 18`, `Community 19`, `Community 275`, `Community 26`, `Community 154`, `Community 32`, `Community 36`, `Community 39`, `Community 425`, `Community 42`, `Community 169`, `Community 45`, `Community 177`, `Community 179`, `Community 180`, `Community 57`, `Community 60`, `Community 189`, `Community 61`, `Community 448`, `Community 321`, `Community 449`, `Community 451`, `Community 64`, `Community 322`, `Community 198`, `Community 328`, `Community 72`, `Community 330`, `Community 201`, `Community 465`, `Community 82`, `Community 209`, `Community 85`, `Community 87`, `Community 88`, `Community 473`, `Community 350`, `Community 101`, `Community 103`, `Community 105`, `Community 492`, `Community 110`, `Community 244`, `Community 245`, `Community 124`, `Community 255`?**
