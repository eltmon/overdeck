...
## Corpus Check
- 1920 files · ~3,144,942 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27466 nodes · 43092 edges · 1297 communities (1241 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28952cd8`
...
Cohesion: 0.01
Nodes (155): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+147 more)
...
Cohesion: 0.02
Nodes (140): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+132 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (148): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+140 more)
...
Cohesion: 0.03
Nodes (161): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgentPromise() (+153 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (136): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+128 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (148): generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+140 more)
...
Cohesion: 0.02
Nodes (111): MessagesTimeline, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (125): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, adminRouteLayer (+117 more)
...
Cohesion: 0.02
Nodes (112): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, isStale(), PHASE_CONFIG, recentActionObservations() (+104 more)
...
Cohesion: 0.03
Nodes (81): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync() (+73 more)
...
Cohesion: 0.02
Nodes (94): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+86 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (98): captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoffPromise(), performKillAndSpawn(), sleep() (+90 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (99): getReviewerSessionName(), parseReviewerSessionName(), Access, getAgentWorkspace(), encodeClaudeProjectDir(), getIssueDataService(), ActivityContext, awaitingInputFromProjection() (+91 more)
...
Cohesion: 0.03
Nodes (89): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (90): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+82 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (68): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (84): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), mapVBriefPlanStatusToPanSpec() (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (88): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState() (+80 more)
...
Cohesion: 0.03
Nodes (84): agentDir, dir1, dir2, marker, missing, nested, _resetDashboardSessionTokenForTests(), cb (+76 more)
...
Cohesion: 0.04
Nodes (73): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue() (+65 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (75): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+67 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (37): issues, result, importTrackerConfig(), findProjectsByRallyProject(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+29 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (73): registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+65 more)
...
Cohesion: 0.03
Nodes (76): recordAutoCloseOutFailure(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+68 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (72): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, createHandoffEvent(), performHandoff() (+64 more)
...
Cohesion: 0.03
Nodes (64): DeaconState, captureTmuxOutput(), isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent (+56 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (68): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+60 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (63): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+55 more)
...
Cohesion: 0.04
Nodes (71): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), ResolveAndSpeakDeps (+63 more)
...
Cohesion: 0.04
Nodes (54): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, deleteHumeConfig(), content, d, existingDir, lines (+46 more)
...
Cohesion: 0.05
Nodes (66): InspectContext, onInspectCompletePromise(), spawnInspectAgent(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise() (+58 more)
...
Cohesion: 0.03
Nodes (52): ConversationTerminalProps, StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage (+44 more)
...
Cohesion: 0.04
Nodes (55): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+47 more)
...
Cohesion: 0.04
Nodes (50): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+42 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (49): findDiscoveredSessionIds(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi() (+41 more)
...
Cohesion: 0.06
Nodes (57): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+49 more)
...
Cohesion: 0.05
Nodes (48): buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+40 more)
...
Cohesion: 0.06
Nodes (52): FsError, deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), hasPRDDraft(), hasPRDDraftPromise() (+44 more)
...
Cohesion: 0.08
Nodes (49): addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckRunPromise(), handleCheckSuite(), handleCheckSuitePromise() (+41 more)
...
Cohesion: 0.05
Nodes (45): fetchMessages(), resumeConversation(), updateConversationDeliveryMethod(), fetchConversations(), resumeConversation(), archiveConversation(), favoriteConversation(), stopConversation() (+37 more)
...
Cohesion: 0.06
Nodes (41): criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+33 more)
...
Cohesion: 0.05
Nodes (40): deliverReviewVerdictFeedback(), backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), base, cols, colsAfter, colsBefore (+32 more)
...
Cohesion: 0.11
Nodes (47): extractNumberSync(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect() (+39 more)
...
Cohesion: 0.08
Nodes (42): forkCommand(), ForkOptions, embedAction(), SearchQuery, showAction(), createSummaryFork(), getSetting(), getConversationById() (+34 more)
...
Cohesion: 0.07
Nodes (40): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+32 more)
...
Cohesion: 0.07
Nodes (33): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+25 more)

### Community 136 - "Community 136"
Cohesion: 0.05
Nodes (40): BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute, getFlywheelConversationRoute (+32 more)
...
Cohesion: 0.1
Nodes (37): contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+29 more)
...
Cohesion: 0.07
Nodes (32): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntrySync() (+24 more)
...
Cohesion: 0.05
Nodes (39): CLI Distribution Strategy, code:yaml (# Your original docker-compose.yml), code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]) (+31 more)
...
Cohesion: 0.08
Nodes (24): configShadowCommand(), ShadowOptions, ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfigSync(), GitHubConfig (+16 more)
...
Cohesion: 0.12
Nodes (24): ComposerMode, IssueComposer(), IssueComposerProps, retryPendingSpawn(), fetchMock, clearPendingCodexReauthSession(), clearPendingCodexSpawn(), currentPendingSpawn() (+16 more)
...
Cohesion: 0.09
Nodes (20): FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType, execAsync, initCommand() (+12 more)
...
Cohesion: 0.13
Nodes (29): loadConfigNoMigration(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+21 more)
...
Cohesion: 0.12
Nodes (23): clearFeedbackFilesPromise(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+15 more)
...
Cohesion: 0.12
Nodes (17): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand(), projectShowCommand() (+9 more)
...
Cohesion: 0.1
Nodes (17): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, fetchAvailableModels(), fetchClaudeAuth(), PROVIDER_LABELS, providerForModel(), providerWarning() (+9 more)
...
Cohesion: 0.11
Nodes (18): compose(), end(), getErrorPos(), next(), parse(), parseAllDocuments(), parseArrayColumn(), parseOptions() (+10 more)
...
Cohesion: 0.16
Nodes (16): array, combine, compareObjects(), hash(), isEqual(), number(), optimize(), random() (+8 more)
...
Cohesion: 0.2
Nodes (6): EventRouter(), error, replayPromise, request, snapshot, unsubscribe
...
- **Why does `string()` connect `Community 4` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 529`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 39`, `Community 40`, `Community 41`, `Community 44`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 60`, `Community 61`, `Community 573`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 77`, `Community 84`, `Community 86`, `Community 88`, `Community 90`, `Community 91`, `Community 95`, `Community 100`, `Community 101`, `Community 105`, `Community 106`, `Community 618`, `Community 115`, `Community 120`, `Community 136`, `Community 1162`, `Community 659`, `Community 152`, `Community 155`, `Community 159`, `Community 167`, `Community 168`, `Community 169`, `Community 178`, `Community 695`, `Community 188`, `Community 195`, `Community 211`, `Community 215`, `Community 746`, `Community 238`, `Community 239`, `Community 783`, `Community 274`, `Community 788`, `Community 789`, `Community 794`, `Community 288`, `Community 290`, `Community 291`, `Community 293`, `Community 304`, `Community 324`, `Community 334`, `Community 355`, `Community 358`, `Community 871`, `Community 384`, `Community 386`, `Community 388`, `Community 413`, `Community 442`, `Community 447`, `Community 449`, `Community 450`, `Community 466`, `Community 479`, `Community 480`, `Community 501`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 88` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 1162`, `Community 265`, `Community 12`, `Community 269`, `Community 1163`, `Community 15`, `Community 16`, `Community 11`, `Community 19`, `Community 23`, `Community 24`, `Community 27`, `Community 156`, `Community 29`, `Community 287`, `Community 33`, `Community 34`, `Community 36`, `Community 41`, `Community 432`, `Community 179`, `Community 308`, `Community 55`, `Community 695`, `Community 698`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 449`, `Community 195`, `Community 67`, `Community 69`, `Community 579`, `Community 1095`, `Community 72`, `Community 201`, `Community 1094`, `Community 327`, `Community 451`, `Community 200`, `Community 77`, `Community 336`, `Community 466`, `Community 90`, `Community 219`, `Community 354`, `Community 99`, `Community 230`, `Community 104`, `Community 747`, `Community 238`, `Community 239`, `Community 241`, `Community 626`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 36` to `Community 65`, `Community 34`, `Community 386`, `Community 8`, `Community 41`, `Community 40`, `Community 11`, `Community 44`, `Community 202`, `Community 306`, `Community 25`, `Community 26`, `Community 91`?**
