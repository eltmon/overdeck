...
## Corpus Check
- 1648 files · ~2,236,467 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23356 nodes · 35603 edges · 1189 communities (1152 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 487 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81331f32`
...
1. `fetch` - 181 edges
2. `resolveProjectFromIssue()` - 126 edges
3. `getDatabase()` - 94 edges
4. `useDashboardStore` - 61 edges
5. `sessionExistsAsync()` - 60 edges
6. `killSessionAsync()` - 54 edges
7. `spawnRun()` - 52 edges
8. `spawnAgent()` - 52 edges
9. `listSessionNamesAsync()` - 52 edges
10. `messageAgent()` - 51 edges
...
## Communities (1189 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (238): checkApiErrorAgents(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), cleanupAbandonedFeedback(), cleanupOrphanedReviewSessions(), isMergeAgentRunning(), archiveReviewerRound() (+230 more)
...
Cohesion: 0.02
Nodes (139): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+131 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (148): checkCompletedButUnsignaledReviews(), spawnInspectAgent(), sendFeedbackToWorkAgent(), spawnReviewCoordinatorSession(), getSpecialistHarness(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), recoverCommand() (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (139): killCommand(), KillOptions, pauseCommand(), PauseOptions, resetSessionCommand(), resumeCommand(), unpauseCommand(), untroubledCommand() (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (144): readCavemanVariant(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (127): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, approveCommand(), cancelCommand() (+119 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (126): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt() (+118 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (87): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, HandoffResult (+79 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (87): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+79 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (91): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+83 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (111): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+103 more)
...
Cohesion: 0.03
Nodes (105): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+97 more)
...
Cohesion: 0.03
Nodes (78): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, { projectPath, workspacePath }, promoted (+70 more)
...
Cohesion: 0.04
Nodes (83): checkPendingTestDispatch(), monitorReviewConvoySignals(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (81): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+73 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (92): dequeueMerge(), execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock } (+84 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (80): buildACLookupByTitle(), buildActiveSliceContext(), inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), readWorkspacePlanAsync(), WorkAgentPromptContext, writeStoryFeatureContext() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (71): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (66): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (67): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanelProps (+59 more)
...
Cohesion: 0.05
Nodes (74): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (58): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+50 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (65): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), AutoActions, AutoRestartConfig (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.09
Nodes (72): extractNumber(), ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd() (+64 more)
...
Cohesion: 0.04
Nodes (65): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+57 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (60): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+52 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (65): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (61): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+53 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (63): createCostCommand(), formatIssueCostAggregate(), aggregate, output, CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions() (+55 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (51): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+43 more)
...
Cohesion: 0.05
Nodes (62): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+54 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (58): FileStatus, AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR (+50 more)
...
Cohesion: 0.06
Nodes (56): deriveProjectRoot(), doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, queueAutoCommit() (+48 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (58): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+50 more)
...
Cohesion: 0.04
Nodes (52): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions (+44 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (51): Access, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats(), stat (+43 more)
...
Cohesion: 0.07
Nodes (51): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+43 more)
...
Cohesion: 0.05
Nodes (41): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+33 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (42): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, listener(), electron (+34 more)
...
Cohesion: 0.06
Nodes (34): getWindowDimensionsAsync(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getReauthSessionToken(), invalidateReauthToken() (+26 more)
...
Cohesion: 0.07
Nodes (37): useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel() (+29 more)
...
Cohesion: 0.09
Nodes (44): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), isEligibleForCleanup(), buildWorkAgentPrompt() (+36 more)
...
Cohesion: 0.05
Nodes (32): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, createCall, dbError (+24 more)
...
Cohesion: 0.05
Nodes (34): SETTINGS_FILE, Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config, config1 (+26 more)
...
Cohesion: 0.06
Nodes (39): agentDir, body, dir, envArg, launcher, LEGACY_FIELDS, legacyFields, options (+31 more)
...
Cohesion: 0.07
Nodes (35): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+27 more)
...
Cohesion: 0.1
Nodes (34): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), isRemoteAvailable() (+26 more)
...
Cohesion: 0.06
Nodes (29): ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption, updateConversationTitle() (+21 more)

### Community 145 - "Community 145"
Cohesion: 0.06
Nodes (30): ViewMode, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS (+22 more)
...
Cohesion: 0.07
Nodes (24): getModelsByProvider(), getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, resetGlobalRouter(), apiKeys (+16 more)
...
Cohesion: 0.08
Nodes (29): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+21 more)

### Community 182 - "Community 182"
Cohesion: 0.09
Nodes (32): result, snapshot, status, ReadModelServiceLive, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentPhase() (+24 more)
...
Cohesion: 0.11
Nodes (31): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, health, now, projectRoot (+23 more)

### Community 185 - "Community 185"
Cohesion: 0.1
Nodes (26): ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+18 more)
...
Cohesion: 0.09
Nodes (31): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+23 more)

### Community 197 - "Community 197"
Cohesion: 0.12
Nodes (31): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths() (+23 more)
...
Cohesion: 0.12
Nodes (28): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+20 more)
...
Cohesion: 0.11
Nodes (26): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+18 more)
...
Cohesion: 0.07
Nodes (27): 10. References, 1. Problem, 2. Goal, 3. Non-Goals, 4.1 Information Architecture, 4.2 Five Surfaces (canonical mockups), 4.3 Shared Primitives, 4.4 Verb Badges (+19 more)
...
Cohesion: 0.09
Nodes (24): badPath, customPlanningDir, dir, doc, draftPath, filename, item, item2 (+16 more)
...
Cohesion: 0.15
Nodes (19): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+11 more)
...
Cohesion: 0.24
Nodes (6): execAsync, getPidFilePath(), readDaemonState(), readStateFile(), TldrDaemonService, writeStateFile()
...
Cohesion: 0.26
Nodes (14): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, readPlatformConfig(), getSupervisorPort(), getSupervisorUrl(), isProcessAlive(), isSupervisorRunning() (+6 more)
...
Cohesion: 0.16
Nodes (13): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+5 more)
...
Cohesion: 0.15
Nodes (10): calls, { mockExecAsync }, opts, activeDir, completedDir, ctx, { mockExecAsync }, result (+2 more)
...
Cohesion: 0.2
Nodes (8): evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), SystemHealthSnapshot, decision, now
...
Cohesion: 0.2
Nodes (9): createSessionAsync, dir, emitActivityEntry, legacyDir, rawState, state, validDir, warnSpy (+1 more)
...
Cohesion: 0.36
Nodes (8): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09, Flywheel State Snapshot, Infrastructure Gaps, Pattern Ledger, Run 2026-05-17 — Pipeline-Clear Push, Skill Gaps
...
## Knowledge Gaps
- **12277 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12272 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 7`, `Community 264`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 143`, `Community 16`, `Community 17`, `Community 786`, `Community 18`, `Community 660`, `Community 145`, `Community 144`, `Community 15`, `Community 24`, `Community 25`, `Community 26`, `Community 662`, `Community 284`, `Community 29`, `Community 663`, `Community 160`, `Community 34`, `Community 35`, `Community 547`, `Community 166`, `Community 38`, `Community 41`, `Community 55`, `Community 56`, `Community 571`, `Community 59`, `Community 574`, `Community 65`, `Community 195`, `Community 69`, `Community 198`, `Community 78`, `Community 852`, `Community 85`, `Community 399`, `Community 352`, `Community 229`, `Community 113`, `Community 1013`, `Community 118`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 7` to `Community 0`, `Community 1`, `Community 3`, `Community 35`, `Community 4`, `Community 6`, `Community 43`, `Community 171`, `Community 11`, `Community 20`, `Community 153`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 169` to `Community 3`, `Community 91`, `Community 12`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Are the 180 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 180 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12277 weakly-connected nodes found - possible documentation gaps or missing edges._
