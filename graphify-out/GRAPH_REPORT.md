...
## Corpus Check
- 1541 files · ~2,054,449 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21471 nodes · 31831 edges · 1117 communities (1081 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 420 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `754460d7`
...
## Communities (1117 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (139): checkApiErrorAgents(), checkMissingReviewStatuses(), announceMerge(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (102): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, DoubleDialogComponent() (+94 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (114): nudgeIdleWorkAgentsWithOpenBeads(), performKillAndSpawn(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), getRuntimeSnapshotSync() (+106 more)
...
Cohesion: 0.03
Nodes (80): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), buildHandoffPrompt(), HandoffContext, detectHandoffMethod() (+72 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (114): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (99): checkOrphanedReviewStatuses(), checkStuckReviewing(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), buildProviderExportLines(), buildTaskPrompt() (+91 more)
...
Cohesion: 0.03
Nodes (78): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+70 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (83): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+75 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (77): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+69 more)
...
Cohesion: 0.04
Nodes (84): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (75): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (78): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+70 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (74): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (72): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (71): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, fetchOutput() (+63 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (74): checkPostReviewCommits(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (75): dismissDevChannelsDialog(), buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+67 more)
...
Cohesion: 0.03
Nodes (66): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (61): firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+53 more)
...
Cohesion: 0.03
Nodes (69): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+61 more)
...
Cohesion: 0.04
Nodes (56): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (64): generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES (+56 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (64): captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename, getConflictFiles() (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (46): destroyRemoteWorkspace(), ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyApiClient(), FlyApiClient (+38 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (63): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+55 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (55): abortReviewCommand(), DASHBOARD_URL, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+47 more)
...
Cohesion: 0.04
Nodes (51): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+43 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (54): checkStuckWorkAgents(), cleanupOrphanReviewerSessions(), isAgentActiveInTmux(), parseThinkingDuration(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, capturePaneAsync() (+46 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (55): shouldAutoStart(), setAgentStoppedNotifier(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+47 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (55): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs() (+47 more)
...
Cohesion: 0.05
Nodes (58): clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS, resolveModelId(), allModelIds, defaults, deprecatedIds, resolved (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (43): ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps (+35 more)
...
Cohesion: 0.07
Nodes (44): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (35): TurnDiffSummary, ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+27 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (39): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, beadsDir, doc (+31 more)
...
Cohesion: 0.08
Nodes (43): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, determineWorkspaceLocation() (+35 more)
...
Cohesion: 0.05
Nodes (34): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, useDialogDepth() (+26 more)
...
Cohesion: 0.07
Nodes (38): getTrackerContext(), detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable(), openCommand(), fetchIssueWithComments(), findLocalWorkspace(), formatComments() (+30 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (42): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), spawnMergeAgentForBranches(), ensureReviewTempStash(), autoRevertMerge(), applyStash(), buildStashMessage(), CanonicalStashKind (+34 more)
...
Cohesion: 0.06
Nodes (36): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult (+28 more)
...
Cohesion: 0.09
Nodes (35): BLANKED_PROVIDER_ENV, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType (+27 more)
...
Cohesion: 0.12
Nodes (34): canonicalPrdSubdir(), archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd(), activeDir, completedDir (+26 more)
...
Cohesion: 0.06
Nodes (28): content, createTestDb(), db, event, goodLine, history, ids, latest (+20 more)
...
Cohesion: 0.09
Nodes (28): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), commands (+20 more)
...
Cohesion: 0.08
Nodes (29): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+21 more)
...
Cohesion: 0.11
Nodes (23): withConcurrencyLimit(), ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+15 more)
...
Cohesion: 0.13
Nodes (13): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+5 more)
...
Cohesion: 0.15
Nodes (21): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), killCommand(), KillOptions (+13 more)
...
Cohesion: 0.16
Nodes (21): markAgentStoppedState(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue() (+13 more)
...
Cohesion: 0.15
Nodes (17): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+9 more)
...
Cohesion: 0.17
Nodes (16): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), findDraftPrd() (+8 more)
...
Cohesion: 0.16
Nodes (14): resolveSpecialistBaseCommand(), ALLOWED, canUseHarness(), HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, SubscriptionPlan, RuntimeName (+6 more)
...
Cohesion: 0.14
Nodes (12): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), setReauthSessionName(), DesktopSettings (+4 more)
...
Cohesion: 0.24
Nodes (14): checkFailedMergeRetry(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent() (+6 more)
...
## Knowledge Gaps
- **11444 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11439 more)
...
- **Why does `fetch` connect `Community 22` to `Community 0`, `Community 643`, `Community 387`, `Community 3`, `Community 133`, `Community 7`, `Community 8`, `Community 136`, `Community 13`, `Community 17`, `Community 18`, `Community 529`, `Community 530`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 29`, `Community 30`, `Community 33`, `Community 161`, `Community 162`, `Community 35`, `Community 37`, `Community 421`, `Community 38`, `Community 554`, `Community 43`, `Community 173`, `Community 49`, `Community 50`, `Community 52`, `Community 183`, `Community 952`, `Community 56`, `Community 55`, `Community 60`, `Community 64`, `Community 65`, `Community 196`, `Community 75`, `Community 590`, `Community 591`, `Community 79`, `Community 595`, `Community 340`, `Community 489`, `Community 250`, `Community 747`, `Community 371`, `Community 122`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 134` to `Community 194`, `Community 2`, `Community 7`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 26` to `Community 353`, `Community 41`, `Community 553`, `Community 75`, `Community 11`, `Community 271`, `Community 369`, `Community 51`, `Community 53`, `Community 313`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11444 weakly-connected nodes found - possible documentation gaps or missing edges._
