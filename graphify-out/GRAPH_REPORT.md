...
## Corpus Check
- 1878 files · ~2,475,748 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26636 nodes · 41327 edges · 1249 communities (1198 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f4265f3`
...
## Communities (1249 total, 51 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (220): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+212 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (155): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (147): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+139 more)
...
Cohesion: 0.03
Nodes (174): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep() (+166 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (139): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+131 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (134): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+126 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (141): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (121): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+113 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (116): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (127): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+119 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (124): buildActiveSliceContext(), readWorkspacePlanAsync(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun() (+116 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (112): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash() (+104 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (98): isRunningAgent(), format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase() (+90 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (103): cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+95 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (105): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+97 more)
...
Cohesion: 0.02
Nodes (86): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (86): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AgentWarningDialogProps, applyReviewStateToIssue() (+78 more)
...
Cohesion: 0.03
Nodes (96): dequeueMerge(), enqueueMerge(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next, remaining (+88 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (73): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+65 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (85): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+77 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (80): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), extractStitchDesigns(), matchBeadToAC() (+72 more)
...
Cohesion: 0.03
Nodes (78): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+70 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (80): detectMergedSwarmSlots(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (80): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+72 more)
...
Cohesion: 0.05
Nodes (81): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+73 more)
...
Cohesion: 0.03
Nodes (64): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+56 more)
...
Cohesion: 0.04
Nodes (64): announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+56 more)
...
Cohesion: 0.04
Nodes (56): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, syncWalFromAllProjects(), IssueAggregate, BUDGETS_FILE (+48 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (70): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+62 more)
...
Cohesion: 0.03
Nodes (67): DEFAULT_FLYWHEEL_CONFIG, fetchFlywheelConversation(), fetchJson(), findFlywheelConversation(), FlywheelConversationPane(), FlywheelConversationPaneProps, FlywheelPaneViewMode, FlywheelRoleConfig (+59 more)
...
Cohesion: 0.05
Nodes (57): indexDailySummary(), closeMemoryFtsDatabases(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema() (+49 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (52): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), doneCommand(), DoneOptions, execAsync (+44 more)
...
Cohesion: 0.06
Nodes (49): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+41 more)
...
Cohesion: 0.08
Nodes (45): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig(), getRemoteProvider() (+37 more)
...
Cohesion: 0.07
Nodes (45): buildWorkAgentPrompt(), inferIssueIdFromWorkspace(), readPendingFeedback(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace() (+37 more)
...
Cohesion: 0.07
Nodes (41): sshCommand(), CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult (+33 more)
...
Cohesion: 0.06
Nodes (32): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+24 more)
...
Cohesion: 0.07
Nodes (38): healthCommand(), HealthOptions, listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile() (+30 more)

### Community 118 - "Community 118"
Cohesion: 0.05
Nodes (33): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+25 more)
...
Cohesion: 0.06
Nodes (34): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), createConfiguredClaudeApi() (+26 more)
...
Cohesion: 0.07
Nodes (27): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+19 more)
...
Cohesion: 0.07
Nodes (29): conversationsTab, firstLens, lens, overview, tablist, ComposerMode, IssueComposer(), IssueComposerProps (+21 more)
...
Cohesion: 0.1
Nodes (33): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+25 more)
...
Cohesion: 0.12
Nodes (33): extractNumber(), extractPrefix(), applyLabelLinearImpl(), closeLinearDirectImpl(), cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabelsImpl(), execAsync (+25 more)
...
Cohesion: 0.08
Nodes (31): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), getAllActiveQueues(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+23 more)
...
Cohesion: 0.1
Nodes (30): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+22 more)
...
Cohesion: 0.1
Nodes (27): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockError (+19 more)

### Community 197 - "Community 197"
Cohesion: 0.15
Nodes (27): LinearApiError, config, originalEnv, tracker, TrackerConfig, AnyTrackerError, Comment, Issue (+19 more)
...
Cohesion: 0.08
Nodes (23): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+15 more)
...
Cohesion: 0.1
Nodes (18): EDITOR_LABELS, PanOpenInPickerProps, consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardMutationJsonHeaders(), dashboardSessionUrl(), DEFAULT_RETRY_DELAY, ensureDashboardSession() (+10 more)
...
Cohesion: 0.12
Nodes (22): NormalizedTtsDaemonConfig, extractTtsEmbedding(), speakTts(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+14 more)
...
Cohesion: 0.14
Nodes (13): createPiFifo(), destroyPiFifo(), execAsync, PiFifoError, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand() (+5 more)
...
Cohesion: 0.13
Nodes (16): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+8 more)
...
Cohesion: 0.14
Nodes (15): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect(), readBeadsFromJsonl() (+7 more)
...
Cohesion: 0.15
Nodes (8): parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, log, mocks, watchdog
...
- **Why does `fetch` connect `Community 3` to `Community 1`, `Community 2`, `Community 255`, `Community 6`, `Community 7`, `Community 10`, `Community 266`, `Community 12`, `Community 16`, `Community 145`, `Community 18`, `Community 19`, `Community 21`, `Community 278`, `Community 22`, `Community 150`, `Community 26`, `Community 27`, `Community 283`, `Community 28`, `Community 31`, `Community 34`, `Community 35`, `Community 39`, `Community 41`, `Community 49`, `Community 50`, `Community 51`, `Community 55`, `Community 58`, `Community 188`, `Community 445`, `Community 61`, `Community 63`, `Community 322`, `Community 71`, `Community 200`, `Community 340`, `Community 725`, `Community 86`, `Community 94`, `Community 224`, `Community 609`, `Community 233`, `Community 107`, `Community 369`, `Community 244`, `Community 245`, `Community 127`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 32`, `Community 36`, `Community 5`, `Community 199`, `Community 12`, `Community 398`, `Community 80`, `Community 81`, `Community 532`, `Community 152`, `Community 89`, `Community 314`, `Community 28`, `Community 25`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `useDashboardStore` connect `Community 5` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 10`, `Community 14`, `Community 145`, `Community 18`, `Community 21`, `Community 22`, `Community 26`, `Community 39`, `Community 52`, `Community 182`, `Community 446`, `Community 447`, `Community 71`, `Community 232`?**
