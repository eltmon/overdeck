# Graph Report - feature-pan-1189  (2026-05-19)

## Corpus Check
- 1777 files · ~2,357,739 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24389 nodes · 37526 edges · 1210 communities (1164 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 546 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29d3f2ef`
...
4. `sessionExistsAsync()` - 65 edges
5. `useDashboardStore` - 65 edges
6. `spawnRun()` - 52 edges
7. `jsonResponse()` - 51 edges
8. `spawnAgent()` - 50 edges
...
## Communities (1210 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (169): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+161 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (140): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+132 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (172): monitorReviewConvoySignals(), spawnInspectAgent(), renderPrompt(), resolveWorkspaceForIssue(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand() (+164 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (158): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+150 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (121): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+113 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (122): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (104): ensureDefaultConversationModel(), CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn() (+96 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (104): getHealthThresholdsMs(), checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeViolations (+96 more)
...
Cohesion: 0.02
Nodes (90): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+82 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (90): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+82 more)
...
Cohesion: 0.04
Nodes (75): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry (+67 more)
...
Cohesion: 0.03
Nodes (90): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), AutoActions, AutoRestartConfig (+82 more)
...
Cohesion: 0.03
Nodes (77): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, CostEvent, CostStreamResponse, fetchCostStream(), useCostStream() (+69 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (83): listener(), electron, IPC, result, wrapped(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (68): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+60 more)
...
Cohesion: 0.04
Nodes (78): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+70 more)
...
Cohesion: 0.08
Nodes (74): calls, { mockExecAsync }, opts, ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths() (+66 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (71): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress() (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (67): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+59 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (66): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+58 more)
...
Cohesion: 0.05
Nodes (76): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelReport(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+68 more)
...
Cohesion: 0.05
Nodes (70): { config }, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+62 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (65): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+57 more)
...
Cohesion: 0.05
Nodes (70): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+62 more)
...
Cohesion: 0.03
Nodes (50): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, useDialogDepth() (+42 more)
...
Cohesion: 0.07
Nodes (67): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+59 more)
...
Cohesion: 0.07
Nodes (60): startPostLaunchSidecars(), startSidecars(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild() (+52 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (32): stopDeacon(), createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+24 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (65): constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders(), hasDashboardInternalToken() (+57 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (45): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+37 more)
...
Cohesion: 0.05
Nodes (49): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHandle (+41 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (55): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, checkAgentHealthAsync(), determineHealthStatusAsync(), clearCacheRoute (+47 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (54): DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR, FEEDBACK_LOG (+46 more)
...
Cohesion: 0.06
Nodes (52): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+44 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (55): embedAction(), scan(), ScanOptions, SearchQuery, runWithPool(), WorkPoolStats, setSetting(), aggregateDiscoveredSessionCost() (+47 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (50): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+42 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (46): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+38 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (43): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+35 more)
...
Cohesion: 0.06
Nodes (48): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+40 more)
...
Cohesion: 0.06
Nodes (51): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+43 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (51): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks() (+43 more)
...
Cohesion: 0.05
Nodes (49): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, collectJsonlFiles() (+41 more)
...
Cohesion: 0.08
Nodes (49): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId() (+41 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (39): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+31 more)
...
Cohesion: 0.06
Nodes (45): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+37 more)
...
Cohesion: 0.08
Nodes (41): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+33 more)
...
Cohesion: 0.06
Nodes (41): AvailableModel, AvailableModelsResponse, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels(), fetchSettings() (+33 more)
...
Cohesion: 0.07
Nodes (38): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+30 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (42): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+34 more)
...
Cohesion: 0.05
Nodes (38): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+30 more)
...
Cohesion: 0.08
Nodes (41): Access, readBridgedCodexCredential(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+33 more)

### Community 115 - "Community 115"
Cohesion: 0.05
Nodes (43): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES (+35 more)
...
Cohesion: 0.09
Nodes (40): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+32 more)

### Community 129 - "Community 129"
Cohesion: 0.08
Nodes (30): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, AcceptanceCriterion, createBeadsFromVBrief() (+22 more)
...
Cohesion: 0.08
Nodes (32): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceShape (+24 more)
...
Cohesion: 0.07
Nodes (32): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+24 more)
...
Cohesion: 0.1
Nodes (33): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, health, now, projectRoot (+25 more)

### Community 173 - "Community 173"
Cohesion: 0.1
Nodes (32): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+24 more)
...
Cohesion: 0.13
Nodes (30): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, IssueAggregate, AIProvider, BUDGETS_FILE (+22 more)
...
Cohesion: 0.13
Nodes (5): sshCommand(), execAsync, FlyProvider, mapFlyStateToVmStatus(), spawn
...
Cohesion: 0.08
Nodes (20): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller (+12 more)
...
Cohesion: 0.11
Nodes (24): AwaitingInputDetection, withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+16 more)
...
Cohesion: 0.14
Nodes (25): CopyConfigOptions, getPanopticonHome(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments() (+17 more)

### Community 262 - "Community 262"
Cohesion: 0.12
Nodes (19): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsSection(), SettingsSectionProps, ProviderCard(), ProviderCardProps, THINKING_LEVEL_LABELS (+11 more)
...
Cohesion: 0.14
Nodes (22): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+14 more)
...
Cohesion: 0.1
Nodes (21): execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs, logPath (+13 more)
...
Cohesion: 0.11
Nodes (17): EDITOR_LABELS, PanOpenInPickerProps, consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardSessionUrl(), DEFAULT_RETRY_DELAY, ensureDashboardSession(), makePanRpcClient (+9 more)
...
Cohesion: 0.11
Nodes (22): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp(), startCliproxyWatchdog() (+14 more)
...
Cohesion: 0.1
Nodes (20): SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow(), SettingsRowProps, SettingsRowStatus(), SettingsRowStatusProps (+12 more)
...
Cohesion: 0.1
Nodes (19): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+11 more)
...
Cohesion: 0.14
Nodes (20): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+12 more)
...
Cohesion: 0.18
Nodes (13): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+5 more)
...
Cohesion: 0.12
Nodes (16): code:bash (pan flywheel start), code:bash (pan flywheel start), code:bash (pan flywheel status), code:bash (pan flywheel pause), code:bash (pan flywheel emit-status --file latest.json), code:bash (pan flywheel report), Commands, Emit Status (+8 more)
...
Cohesion: 0.2
Nodes (9): Default Flywheel Brief, End-of-run report, Human input invariant, Operating loop, Role taxonomy, Scope, Source material, Status contract (+1 more)
...
Cohesion: 0.25
Nodes (7): Brief authoring, code:text (${PANOPTICON_HOME:-~/.panopticon}/flywheel/runs/<RUN-ID>/), Flywheel, Lifecycle, Settings → Roles → Flywheel, Skill → CLI → API → UI map, Status contract
...
Cohesion: 0.25
Nodes (7): End of run, Entrypoint, Hardcoding them here would override the user's per-role settings., No `model:` or `effort:` pin — Cloister resolves these from config.yaml roles.flywheel., Panopticon Flywheel Role, Substrate bug policy, Tick loop
...
Cohesion: 0.29
Nodes (6): Active Pipeline, Cycling Alerts, Flywheel State — 2026-05-18 (Run 1), Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
## Knowledge Gaps
- **12656 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12651 more)
...
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 130`, `Community 3`, `Community 131`, `Community 134`, `Community 6`, `Community 8`, `Community 393`, `Community 10`, `Community 1035`, `Community 12`, `Community 11`, `Community 14`, `Community 652`, `Community 18`, `Community 20`, `Community 23`, `Community 25`, `Community 414`, `Community 30`, `Community 34`, `Community 40`, `Community 41`, `Community 298`, `Community 299`, `Community 44`, `Community 429`, `Community 302`, `Community 47`, `Community 48`, `Community 49`, `Community 304`, `Community 179`, `Community 181`, `Community 694`, `Community 57`, `Community 698`, `Community 58`, `Community 59`, `Community 66`, `Community 68`, `Community 70`, `Community 71`, `Community 584`, `Community 77`, `Community 207`, `Community 93`, `Community 224`, `Community 611`, `Community 230`, `Community 876`, `Community 877`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 3` to `Community 0`, `Community 2`, `Community 66`, `Community 36`, `Community 9`, `Community 173`, `Community 206`, `Community 16`, `Community 22`, `Community 86`, `Community 24`, `Community 25`, `Community 183`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 23` to `Community 129`, `Community 65`, `Community 390`, `Community 39`, `Community 8`, `Community 650`, `Community 43`, `Community 301`, `Community 16`, `Community 17`, `Community 277`, `Community 92`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 206 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 206 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12656 weakly-connected nodes found - possible documentation gaps or missing edges._
