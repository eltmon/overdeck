# Graph Report - feature-pan-1385  (2026-05-22)

## Corpus Check
- 1919 files · ~3,141,834 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28272 nodes · 47309 edges · 1281 communities (1226 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 951 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4ca6d3e`
...
## Communities (1281 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (258): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+250 more)
...
Cohesion: 0.01
Nodes (151): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+143 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (150): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+142 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (109): checkCostLimits(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+101 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (112): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (140): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+132 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (127): TurnDiffFileChange, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork() (+119 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (118): pruneStaleCheckpointRefs(), WipeOptions, CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut() (+110 more)
...
Cohesion: 0.03
Nodes (122): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+114 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (117): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash() (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (123): recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge (+115 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (116): ABOUT_SCHEMA, invokeClaudeStructured(), sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle(), TITLE_SCHEMA (+108 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (103): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, content (+95 more)
...
Cohesion: 0.04
Nodes (109): checkStuckWorkAgents(), buildInspectPrompt(), __dirname, __filename, InspectResult, spawnInspectAgent(), spawnInspectAgentPromise(), killPostMergeRoleSessions() (+101 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (99): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+91 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (99): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+91 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (104): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+96 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (83): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, criteria (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (97): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), runCommand(), RunOptions (+89 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (108): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxyEffect(), bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig() (+100 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (104): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), findLocalWorkspace(), DASHBOARD_URL (+96 more)
...
Cohesion: 0.03
Nodes (77): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+69 more)
...
Cohesion: 0.02
Nodes (95): HookItem, computeQueuePositionFromStatus(), computeQueuePositionFromStatusSync(), findPositionInQueue(), findPositionInQueueSync(), QueuePositionResult, items, result (+87 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (97): AgentRuntimeState, claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints() (+89 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (93): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, encodeClaudeProjectDir(), getIssueDataService(), ActivityContext (+85 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (95): agentDir, dir1, dir2, marker, missing, nested, PlanningIssue, invalidateAgentsCache() (+87 more)
...
Cohesion: 0.03
Nodes (85): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+77 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (82): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+74 more)
...
Cohesion: 0.03
Nodes (81): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+73 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (82): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+74 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (68): checkCommand(), syncCommand(), SyncOptions, createBackup(), createBackupSync(), createBackupTimestamp(), ensureExcalidrawMcp(), ensureExcalidrawMcpSync() (+60 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (84): estimateCost(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+76 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (76): shellQuote(), verifyMergedBeforeLifecycle(), getTrackerContext(), projectListCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), formatComments() (+68 more)
...
Cohesion: 0.03
Nodes (71): EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues() (+63 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (76): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), ModelRef, RoleConfig (+68 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (74): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), completePlanningArtifacts(), checkPlanStatus() (+66 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (72): embedAction(), scanAction(), scan(), ScanProgress, RawFilter, SearchMode, SearchQuery, SearchResult (+64 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (66): checkThinkingSignatureCorruption(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+58 more)
...
Cohesion: 0.07
Nodes (77): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+69 more)
...
Cohesion: 0.05
Nodes (54): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+46 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (53): doneCommand(), DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb() (+45 more)
...
Cohesion: 0.05
Nodes (62): finalizeRunLog(), finalizeRunLogSync(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+54 more)
...
Cohesion: 0.05
Nodes (55): AgentEnrichment, computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise() (+47 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (52): destroyRemoteWorkspace(), buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), getClaudePermissionFlagsStringSync(), getClaudePermissionFlagsSync() (+44 more)
...
Cohesion: 0.04
Nodes (48): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+40 more)
...
Cohesion: 0.08
Nodes (52): getReviewStatusAsyncEffect(), setReviewStatusAsyncEffect(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckRunPromise() (+44 more)
...
Cohesion: 0.04
Nodes (41): SETTINGS_FILE, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config (+33 more)
...
Cohesion: 0.03
Nodes (55): importTrackerConfig(), result, setDeaconGloballyPaused(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute (+47 more)
...
Cohesion: 0.08
Nodes (50): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+42 more)
...
Cohesion: 0.07
Nodes (40): createCostCommand(), formatIssueCostAggregate(), BUDGETS_FILE, checkBudget(), checkBudgetSync(), CostBudget, CostSummary, createBudget() (+32 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (53): contextMigrateCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+45 more)
...
Cohesion: 0.05
Nodes (40): categorizeToolUse(), CompressedTranscriptDelta, compressEntry(), compressJsonlBuffer(), compressTranscriptDelta(), CompressTranscriptDeltaInput, extractBashCommand(), extractText() (+32 more)

### Community 86 - "Community 86"
Cohesion: 0.04
Nodes (51): DEFAULTS, UIPreferences, useUIPreferences(), Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef (+43 more)
...
Cohesion: 0.04
Nodes (48): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, collectJsonlFiles(), discoverJsonlFiles() (+40 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (51): array, combine, hash(), number(), optimize(), random(), structureKeys(), [symbol$1]() (+43 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (33): CapabilityModelId, getModelCapability(), getModelCapabilitySync(), getValueScore(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension (+25 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (37): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+29 more)
...
Cohesion: 0.07
Nodes (48): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+40 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (50): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+42 more)
...
Cohesion: 0.04
Nodes (41): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), base, cols, colsAfter, colsBefore, correctedPath (+33 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (45): appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs(), cleanupAllLogsSync(), cleanupOldLogs(), cleanupOldLogsSync(), createRunLog() (+37 more)
...
Cohesion: 0.07
Nodes (43): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+35 more)

### Community 104 - "Community 104"
Cohesion: 0.06
Nodes (46): archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir, ctx, { mockExecAsync } (+38 more)
...
Cohesion: 0.08
Nodes (44): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+36 more)
...
Cohesion: 0.05
Nodes (39): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+31 more)
...
Cohesion: 0.07
Nodes (31): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+23 more)

### Community 115 - "Community 115"
Cohesion: 0.09
Nodes (31): agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo(), createPiFifoPromise(), destroyPiFifo(), destroyPiFifoSync() (+23 more)
...
Cohesion: 0.05
Nodes (33): getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+25 more)

### Community 126 - "Community 126"
Cohesion: 0.06
Nodes (42): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+34 more)
...
Cohesion: 0.07
Nodes (33): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+25 more)
...
Cohesion: 0.05
Nodes (32): ClaudePermissionMode, ConversationsConfig, ConversationsEnrichmentConfig, DEFAULT_CONFIG, findDevrootForProject(), findDevrootForProjectSync(), getConversationsConfig(), getConversationsConfigAsync() (+24 more)
...
Cohesion: 0.08
Nodes (33): GIT_PATTERNS, scanGitPatterns(), MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen (+25 more)
...
Cohesion: 0.08
Nodes (36): checkCompletedButUnsignaledReviews(), REVIEW_SUB_ROLES, reviewerOutputPath(), ReviewerResult, ReviewerState, ReviewSubRole, waitForReviewerOutputs(), waitForReviewerOutputsEffect() (+28 more)
...
Cohesion: 0.08
Nodes (35): buildInspectPromptPromise(), execAsync, getBeadDescription(), InspectContext, onInspectComplete(), onInspectCompletePromise(), execAsync, getCheckpointDir() (+27 more)
...
Cohesion: 0.08
Nodes (16): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getActiveSessionModelSync(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles() (+8 more)
...
Cohesion: 0.08
Nodes (22): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSession(), parsePiSessionContent(), parsePiSessionSync() (+14 more)
...
Cohesion: 0.09
Nodes (30): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+22 more)
...
Cohesion: 0.07
Nodes (23): evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth(), HealthSummary, needsAttention() (+15 more)
...
Cohesion: 0.09
Nodes (31): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), resolveAlsoSyncTools(), resolveAlsoSyncToolsSync(), runMultiToolSync() (+23 more)
...
Cohesion: 0.09
Nodes (25): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise() (+17 more)
...
Cohesion: 0.09
Nodes (24): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials (+16 more)
...
Cohesion: 0.13
Nodes (33): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+25 more)

### Community 232 - "Community 232"
Cohesion: 0.1
Nodes (22): getHealthThresholdsMs(), loadCloisterConfig(), loadCloisterConfigSync(), shouldAutoStart(), AgentHealth, ModelRouter, checkAllTriggers(), checkAllTriggersPromise() (+14 more)
...
Cohesion: 0.11
Nodes (25): FsError, CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterEffect(), createClaudeAdapterSync(), createRuntimeRegistry(), getInstalledRuntimes(), getInstalledRuntimesPromise() (+17 more)
...
Cohesion: 0.09
Nodes (30): DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+22 more)
...
Cohesion: 0.11
Nodes (33): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), captureTldrMetricsSync(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+25 more)
...
Cohesion: 0.11
Nodes (28): buildReviewContext(), BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles() (+20 more)
...
Cohesion: 0.11
Nodes (22): appendCostEvent(), appendCostEventSync(), deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+14 more)
...
Cohesion: 0.08
Nodes (19): loadConfigNoMigration(), NormalizedTtsDaemonConfig, isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus (+11 more)

### Community 270 - "Community 270"
Cohesion: 0.08
Nodes (29): calculateCost(), calculateCostSync(), CostEntry, DEFAULT_PRICING, getPricing(), getPricingSync(), logUsage(), logUsageSync() (+21 more)
...
Cohesion: 0.09
Nodes (12): GitHubTracker, octokitToEffect(), octokitToProgram(), parseIssueNumber(), error, mockComment, mockComments, mockIssue (+4 more)
...
Cohesion: 0.08
Nodes (21): ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS, HarnessDecision (+13 more)
...
Cohesion: 0.12
Nodes (23): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+15 more)
...
Cohesion: 0.13
Nodes (22): forkCommand(), ForkOptions, buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, getConversationByClaudeSessionId(), getConversationById(), getConversationByName() (+14 more)
...
Cohesion: 0.17
Nodes (19): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+11 more)

### Community 336 - "Community 336"
Cohesion: 0.14
Nodes (22): eventsFileExists(), getLastEventMetadata(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+14 more)
...
Cohesion: 0.17
Nodes (19): startPostLaunchSidecars(), startSidecars(), runFullRestart(), LOGS_DIR, getSupervisorPort(), getSupervisorPortSync(), getSupervisorUrl(), getSupervisorUrlSync() (+11 more)
...
Cohesion: 0.16
Nodes (24): HandoffContext, ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE (+16 more)

### Community 349 - "Community 349"
Cohesion: 0.13
Nodes (20): rebuildCache(), readEvents(), readEventsSync(), getRetentionStatus(), getRetentionStatusSync(), needsPruning(), needsPruningSync(), pruneOldEvents() (+12 more)
...
Cohesion: 0.12
Nodes (20): getEmbedding(), buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI() (+12 more)
...
Cohesion: 0.15
Nodes (18): openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, ActivitySource (+10 more)
...
Cohesion: 0.13
Nodes (17): findVendoredDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), FsNotFoundError, compressSrc, destDir, dir (+9 more)
...
Cohesion: 0.22
Nodes (17): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+9 more)
...
Cohesion: 0.11
Nodes (13): estimateEnrichmentCost(), err, estimated, largePath, lines, progressCalls, prompts, samplePath (+5 more)
...
Cohesion: 0.11
Nodes (13): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue, mockSpawnAgent (+5 more)
...
Cohesion: 0.15
Nodes (12): pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutex(), withWorkspaceBdMutexPromise(), restoreTrackedBeadsExport(), runGit(), spawnerLayer (+4 more)

### Community 496 - "Community 496"
Cohesion: 0.15
Nodes (15): clearRunningAgentsCache(), getCachedRunningAgents(), ListAgentsEffect, ListAgentsProgram, RunningAgent, RunningAgents, runningAgentsCache, sweepExpired() (+7 more)
...
Cohesion: 0.12
Nodes (12): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue, mockSpawnAgent (+4 more)
...
Cohesion: 0.13
Nodes (11): autoCloseOut(), sweepAutoCloseOutCache(), execFileMock, mockCloseOut, mockEmitActivityEntry, mockLoadCloisterConfig, mockLoadReviewStatuses, mockResolveGitHubIssue (+3 more)

### Community 547 - "Community 547"
Cohesion: 0.15
Nodes (11): CostEvent, appendToWal(), appendToWalSync(), resolveWalDir(), colNames, cols, db, disabledRow (+3 more)
...
Cohesion: 0.33
Nodes (8): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromAllProjectsPromise(), syncWalFromDir(), syncWalFromDirPromise(), insertCostEvents()
...
Cohesion: 0.18
Nodes (6): execFileMock, postMergeLifecycleMock, readContinueStateEffectMock, readContinueStateProgramMock, readdirSyncMock, resolveGitHubIssueMock
...
Cohesion: 0.18
Nodes (8): body, ClaudeAuthOverride, picker, putCall, settings, settingsPayload, settingsWithAnthropicEnabled, user
...
Cohesion: 0.24
Nodes (7): agentToConversation(), DrawerAgentSession(), DrawerAgentSessionProps, ENDED_AGENT_STATUSES, isEndedAgent(), pickDefaultDrawerAgent(), agents
...
Cohesion: 0.33
Nodes (5): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNames, mockListSessionNamesEffect, mockMarkConversationEnded
...
Cohesion: 0.4
Nodes (4): electron, IPC, result, wrapped()
...
## Knowledge Gaps
- **13600 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13595 more)
...
- **Why does `string()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 570`, `Community 571`, `Community 59`, `Community 64`, `Community 65`, `Community 576`, `Community 70`, `Community 72`, `Community 77`, `Community 81`, `Community 84`, `Community 87`, `Community 88`, `Community 89`, `Community 94`, `Community 98`, `Community 103`, `Community 104`, `Community 114`, `Community 116`, `Community 118`, `Community 1145`, `Community 127`, `Community 646`, `Community 144`, `Community 152`, `Community 153`, `Community 161`, `Community 686`, `Community 184`, `Community 185`, `Community 192`, `Community 193`, `Community 213`, `Community 247`, `Community 249`, `Community 258`, `Community 776`, `Community 777`, `Community 269`, `Community 783`, `Community 289`, `Community 301`, `Community 334`, `Community 335`, `Community 338`, `Community 344`, `Community 345`, `Community 858`, `Community 859`, `Community 392`, `Community 394`, `Community 415`, `Community 416`, `Community 433`, `Community 435`, `Community 462`, `Community 466`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 21` to `Community 32`, `Community 37`, `Community 134`, `Community 7`, `Community 41`, `Community 11`, `Community 45`, `Community 28`, `Community 54`, `Community 24`, `Community 316`, `Community 317`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 131`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 395`, `Community 13`, `Community 15`, `Community 16`, `Community 528`, `Community 18`, `Community 19`, `Community 21`, `Community 280`, `Community 281`, `Community 26`, `Community 27`, `Community 24`, `Community 417`, `Community 33`, `Community 35`, `Community 36`, `Community 163`, `Community 162`, `Community 34`, `Community 168`, `Community 38`, `Community 42`, `Community 172`, `Community 301`, `Community 45`, `Community 694`, `Community 56`, `Community 185`, `Community 58`, `Community 59`, `Community 65`, `Community 67`, `Community 70`, `Community 75`, `Community 81`, `Community 86`, `Community 219`, `Community 92`, `Community 740`, `Community 100`, `Community 231`, `Community 617`, `Community 235`, `Community 110`, `Community 499`, `Community 245`, `Community 246`, `Community 250`, `Community 127`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Are the 262 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 262 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13600 weakly-connected nodes found - possible documentation gaps or missing edges._
