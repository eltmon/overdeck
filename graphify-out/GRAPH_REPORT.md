# Graph Report - feature-pan-1312-slot-6  (2026-05-22)

## Corpus Check
- 1887 files · ~3,052,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26749 nodes · 41510 edges · 1279 communities (1226 shown, 53 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba35fe49`
...
## Communities (1279 total, 53 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (167): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+159 more)
...
Cohesion: 0.02
Nodes (151): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+143 more)
...
Cohesion: 0.04
Nodes (151): checkPendingTestDispatch(), spawnInspectAgent(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), dispatchTestAgentAndNotifyEffect(), DispatchTestAgentResult, TestDispatchError (+143 more)
...
Cohesion: 0.03
Nodes (91): parsePiSession(), waitForPiAgentReady(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder, checkFn (+83 more)
...
Cohesion: 0.02
Nodes (108): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+100 more)
...
Cohesion: 0.03
Nodes (112): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+104 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (117): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), clearStaleCiFeedback(), buildDigestPrompt(), deleteContextDigest() (+109 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (94): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (80): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+72 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (102): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute (+94 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (92): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (93): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+85 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (89): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (95): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+87 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (71): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+63 more)
...
Cohesion: 0.03
Nodes (93): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+85 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (69): ComposerMode, IssueComposerProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (84): buildActiveSliceContext(), resolveProjectFromIssue(), listPaneValuesAsyncEffect(), getProjectPath(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt() (+76 more)
...
Cohesion: 0.04
Nodes (70): RecoverButton(), RecoverButtonProps, WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal() (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (66): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+58 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (54): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+46 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (74): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist() (+66 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (72): dismissDevChannelsDialog(), isClaudeRunningInSession(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS (+64 more)
...
Cohesion: 0.04
Nodes (34): issues, result, importTrackerConfig(), findProjectsByRallyProject(), loadReviewStatusesForIssues(), CACHE_DB_PATH, CacheEntry, CacheService (+26 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (77): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+69 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (71): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), PROVIDER_INFO, ProviderPanelProps, Capability, ModelDef (+63 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (63): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+55 more)
...
Cohesion: 0.05
Nodes (66): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, encodeBeadsVersion() (+58 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (53): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+45 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (66): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+58 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (66): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+58 more)
...
Cohesion: 0.06
Nodes (64): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+56 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (58): transitionIssueState(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy (+50 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (62): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (64): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+56 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (52): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+44 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (53): confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, ConversationFilter, markEnrichmentFailed(), searchFts() (+45 more)
...
Cohesion: 0.06
Nodes (63): getMemoryStatus(), writeObservationRecord(), writeStatus(), writeDecision(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir() (+55 more)
...
Cohesion: 0.04
Nodes (53): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+45 more)
...
Cohesion: 0.06
Nodes (56): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+48 more)
...
Cohesion: 0.04
Nodes (45): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+37 more)
...
Cohesion: 0.04
Nodes (51): future, id, rows, rows1, rows2, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema() (+43 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (47): StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED (+39 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (46): getReviewStatusFromDbEffect(), BlockerReason, getReviewStatusAsync(), setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos() (+38 more)
...
Cohesion: 0.05
Nodes (43): conversationsTab, firstLens, lens, overview, tablist, CommandDeck(), ProjectRightPaneTabs(), IssueComposer() (+35 more)
...
Cohesion: 0.06
Nodes (42): ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), stepFailed(), TeardownOptions, WorkflowResult (+34 more)
...
Cohesion: 0.05
Nodes (36): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+28 more)
...
Cohesion: 0.06
Nodes (37): cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+29 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (26): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles() (+18 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (36): execAsync, rebaseFeatureBranch(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+28 more)
...
Cohesion: 0.06
Nodes (39): checkMissingReviewStatuses(), killPostMergeRoleSessions(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+31 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (30): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+22 more)
...
Cohesion: 0.09
Nodes (44): clearFlywheelRunGate(), flywheelAbortCommand(), getFlywheelActiveRunId(), isFlywheelGloballyPaused(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate() (+36 more)

### Community 100 - "Community 100"
Cohesion: 0.05
Nodes (34): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), formatAge(), FreshnessIndicator(), Tab (+26 more)
...
Cohesion: 0.09
Nodes (39): destroyRemoteWorkspace(), createFlyProvider(), execAsync, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider() (+31 more)
...
Cohesion: 0.07
Nodes (36): dropLingeringPreMergeStashes(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence() (+28 more)
...
Cohesion: 0.05
Nodes (39): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute (+31 more)
...
Cohesion: 0.1
Nodes (33): insertCostEvent(), extractedTurn(), AnthropicExtractionProvider, AnthropicCompatibleResponse, CliproxyExtractionProvider, FetchFn, extractWithProviderPolicy(), getTodayMemoryExtractionSpendUsd() (+25 more)
...
Cohesion: 0.06
Nodes (29): ActivityEntry, BeadTask, beadTitle(), DrawerActivityItem, DrawerBeadItem, DrawerBeadStatus, DrawerData, DrawerIssueSubscription (+21 more)
...
Cohesion: 0.08
Nodes (35): getTrackerContext(), projectShowCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken() (+27 more)
...
Cohesion: 0.11
Nodes (40): archiveWorkspaceArtifactsImpl(), findAllWorkspacePaths(), findWorkspacePath(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), execAsync (+32 more)
...
Cohesion: 0.07
Nodes (34): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+26 more)

### Community 159 - "Community 159"
Cohesion: 0.09
Nodes (36): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+28 more)

### Community 160 - "Community 160"
Cohesion: 0.08
Nodes (27): getDefaultWorkspaceConfig(), addReposToWorkspace(), AddReposToWorkspaceOptions, AddReposToWorkspaceResult, assignPort(), copyPanopticonSettingsToWorkspace(), copyProjectTemplateDirs(), createWorkspace() (+19 more)
...
Cohesion: 0.08
Nodes (29): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration(), generateReport() (+21 more)
...
Cohesion: 0.08
Nodes (32): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings() (+24 more)
...
Cohesion: 0.11
Nodes (32): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+24 more)
...
Cohesion: 0.1
Nodes (26): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), IssueStats (+18 more)
...
Cohesion: 0.12
Nodes (31): FlywheelScope, loadConfigAsyncNoMigrationEffect(), RoleEffort, runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting() (+23 more)
...
Cohesion: 0.11
Nodes (20): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+12 more)
...
Cohesion: 0.1
Nodes (31): getCostsForIssue(), Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+23 more)
...
Cohesion: 0.14
Nodes (29): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken() (+21 more)
...
Cohesion: 0.1
Nodes (18): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, buildClaudeUserSettings(), bypassPrefixForAgentFlag() (+10 more)
...
Cohesion: 0.1
Nodes (25): DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, EmbedSessionsOptions, selectSessionIdsForEmbedding() (+17 more)
...
Cohesion: 0.13
Nodes (23): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherConfig (+15 more)
...
Cohesion: 0.12
Nodes (22): NormalizedTtsDaemonConfig, checkTtsHealth(), speakTts(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+14 more)
...
Cohesion: 0.13
Nodes (15): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRunLog(), getRunLogPath() (+7 more)
...
Cohesion: 0.12
Nodes (10): FsError, DEFAULT_STORE, formatIssueRef(), LinkDirection, LinkManager, LinkStore, parseIssueRef(), pathExists() (+2 more)
...
Cohesion: 0.13
Nodes (18): recoverUnhealthyTestStack(), workspaceRebuildCommand(), StepResult, tempDirs, workspace, ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult (+10 more)
...
Cohesion: 0.13
Nodes (18): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+10 more)
...
Cohesion: 0.14
Nodes (18): REVIEW_SUB_ROLES, reviewerOutputPath(), ReviewerResult, ReviewerState, ReviewSubRole, waitForReviewerOutputs(), waitForReviewerOutputsEffect(), WaitForReviewerOutputsOpts (+10 more)
...
Cohesion: 0.13
Nodes (11): isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv(), readWatchdogConfig() (+3 more)
...
Cohesion: 0.11
Nodes (19): getRecentRunLogs(), listRunLogs(), content, deleted, { filePath }, largeContent, metadata, oldDate (+11 more)
...
Cohesion: 0.11
Nodes (11): ProjectConfig, after, before, cfg, compose, ph, result, createWorkspacePlaceholders() (+3 more)
...
Cohesion: 0.2
Nodes (10): BeadRecord, checkOpenBeads(), checkUncommittedChanges(), errorCode(), execAsync, execFileAsync, isMissingCommand(), isTimeout() (+2 more)
...
Cohesion: 0.22
Nodes (12): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+4 more)
...
Cohesion: 0.29
Nodes (8): CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, listSessionNamesAsync(), names
...
## Knowledge Gaps
- **13317 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13312 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 386`, `Community 5`, `Community 262`, `Community 6`, `Community 8`, `Community 9`, `Community 13`, `Community 270`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 24`, `Community 282`, `Community 154`, `Community 28`, `Community 29`, `Community 159`, `Community 544`, `Community 33`, `Community 35`, `Community 293`, `Community 38`, `Community 167`, `Community 37`, `Community 48`, `Community 50`, `Community 51`, `Community 58`, `Community 571`, `Community 188`, `Community 445`, `Community 62`, `Community 446`, `Community 67`, `Community 203`, `Community 77`, `Community 335`, `Community 81`, `Community 92`, `Community 356`, `Community 742`, `Community 230`, `Community 622`, `Community 239`, `Community 240`, `Community 499`, `Community 127`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 35`, `Community 5`, `Community 10`, `Community 42`, `Community 79`, `Community 17`, `Community 49`, `Community 307`, `Community 23`, `Community 87`, `Community 25`, `Community 61`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 354` to `Community 3`, `Community 4`, `Community 646`, `Community 7`, `Community 264`, `Community 137`, `Community 266`, `Community 523`, `Community 12`, `Community 265`, `Community 270`, `Community 10`, `Community 11`, `Community 17`, `Community 19`, `Community 278`, `Community 30`, `Community 160`, `Community 39`, `Community 424`, `Community 41`, `Community 169`, `Community 48`, `Community 50`, `Community 51`, `Community 308`, `Community 442`, `Community 443`, `Community 61`, `Community 63`, `Community 65`, `Community 195`, `Community 196`, `Community 329`, `Community 202`, `Community 76`, `Community 77`, `Community 461`, `Community 334`, `Community 80`, `Community 337`, `Community 83`, `Community 212`, `Community 213`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 473`, `Community 480`, `Community 353`, `Community 482`, `Community 483`, `Community 615`, `Community 238`, `Community 250`, `Community 123`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13317 weakly-connected nodes found - possible documentation gaps or missing edges._
