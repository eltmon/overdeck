...
## Corpus Check
- 1548 files · ~2,060,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21601 nodes · 31969 edges · 1135 communities (1098 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5904b93`
...
Cohesion: 0.02
Nodes (158): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+150 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (115): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+107 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (105): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+97 more)
...
Cohesion: 0.03
Nodes (124): nudgeIdleWorkAgentsWithOpenBeads(), sendFeedbackToWorkAgent(), resolveSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand() (+116 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (114): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+106 more)
...
Cohesion: 0.04
Nodes (110): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+102 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (85): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+77 more)
...
Cohesion: 0.03
Nodes (89): getConversationByClaudeSessionId(), getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute (+81 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (82): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (76): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+68 more)
...
Cohesion: 0.03
Nodes (78): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatus, CloisterStatusBar() (+70 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (87): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+79 more)
...
Cohesion: 0.03
Nodes (73): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+65 more)
...
Cohesion: 0.04
Nodes (80): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+72 more)
...
Cohesion: 0.03
Nodes (67): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (67): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+59 more)
...
Cohesion: 0.05
Nodes (74): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+66 more)
...
Cohesion: 0.04
Nodes (67): checkFailedMergeRetry(), reconcileAndCheckIfMerged(), reconcileFalseMerged(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+59 more)
...
Cohesion: 0.04
Nodes (54): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult (+46 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (45): buildChildEnvWithoutTmux(), getWindowDimensionsAsync(), resizeWindowAsync(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute (+37 more)
...
Cohesion: 0.05
Nodes (52): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, isAgentStateServiceInProcess(), getAgentRuntimeStateAsync(), snapshotToRuntimeState(), withConcurrencyLimit() (+44 more)
...
Cohesion: 0.06
Nodes (48): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (47): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), buildTaskPrompt(), buildTestAgentPromptContent(), resolveWorkspaceGitInfo(), dispatchTestAgentAndNotify() (+39 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (44): killCommand(), KillOptions, saveConfig(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p (+36 more)
...
Cohesion: 0.05
Nodes (37): setAgentStoppedNotifier(), CopyConfigOptions, ENV_KEYS, EnvSnapshot, clearStuckForks(), listActiveConversations(), markConversationEnded(), emitDashboardLifecycle() (+29 more)
...
Cohesion: 0.08
Nodes (41): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument() (+33 more)
...
Cohesion: 0.04
Nodes (39): pending, withBdMutex(), agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, execAsync, getAgentActivityRoute (+31 more)
...
Cohesion: 0.09
Nodes (38): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+30 more)
...
Cohesion: 0.09
Nodes (34): ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData(), fetchActivityDataWithContext() (+26 more)
...
Cohesion: 0.14
Nodes (20): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry() (+12 more)
...
Cohesion: 0.08
Nodes (22): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+14 more)
...
Cohesion: 0.11
Nodes (12): getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb(), RateLimitInfo (+4 more)
...
Cohesion: 0.12
Nodes (27): CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+19 more)
...
Cohesion: 0.12
Nodes (17): cleanupPiTransientFiles(), execAsync, createPiFifo(), destroyPiFifo(), execAsync, PiFifoPaths, PiNotReady, shellQuote() (+9 more)
...
Cohesion: 0.28
Nodes (22): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches() (+14 more)
...
Cohesion: 0.12
Nodes (16): issues, result, importTrackerConfig(), getCanonicalStatus(), mapRallyStateToCanonical(), planningStateCache, PlanningStateCacheEntry, POLL_INTERVALS (+8 more)
...
Cohesion: 0.17
Nodes (13): parsePiSession(), agentDirFor(), agentsDir(), heartbeatsDir(), panopticonDir(), PiRuntime, piSessionDirFor(), readReady() (+5 more)
...
Cohesion: 0.13
Nodes (18): parseLogMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, actual, allLogs, logPath (+10 more)
...
Cohesion: 0.14
Nodes (15): execAsync, LABELS_TO_REMOVE, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), LifecycleContext (+7 more)
...
Cohesion: 0.22
Nodes (16): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath() (+8 more)
...
Cohesion: 0.2
Nodes (15): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, listProjects(), execAsync, formatDuration(), generateReport() (+7 more)
...
Cohesion: 0.15
Nodes (14): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+6 more)
...
Cohesion: 0.23
Nodes (9): readCavemanVariant(), buildSpecialistCavemanExports(), buildCavemanExports(), NormalizedCavemanConfig, baseConfig, mockReadVariant, baseConfig, config (+1 more)
...
Cohesion: 0.29
Nodes (5): ensureResourceConfigLoaded(), readGlobalResourceConfig(), resolveFiniteNumber(), SystemHealthSnapshot, decision
...
## Knowledge Gaps
- **11509 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11504 more)
...
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 260`, `Community 5`, `Community 8`, `Community 9`, `Community 266`, `Community 11`, `Community 267`, `Community 13`, `Community 14`, `Community 527`, `Community 16`, `Community 17`, `Community 18`, `Community 23`, `Community 24`, `Community 152`, `Community 153`, `Community 29`, `Community 33`, `Community 35`, `Community 548`, `Community 39`, `Community 173`, `Community 174`, `Community 48`, `Community 51`, `Community 56`, `Community 73`, `Community 78`, `Community 207`, `Community 748`, `Community 379`, `Community 632`, `Community 121`, `Community 634`, `Community 123`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 122` to `Community 17`, `Community 4`, `Community 7`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 49` to `Community 242`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11509 weakly-connected nodes found - possible documentation gaps or missing edges._
