# Graph Report - feature-pan-1312-slot-7  (2026-05-22)

## Corpus Check
- 1914 files · ~3,138,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28436 nodes · 47733 edges · 1305 communities (1250 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 894 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75af51f8`
...
1. `string()` - 240 edges
2. `fetch` - 203 edges
3. `resolveProjectFromIssueSync()` - 127 edges
4. `resolveProjectFromIssue()` - 126 edges
5. `getDatabase()` - 121 edges
6. `sessionExists()` - 95 edges
7. `useDashboardStore` - 87 edges
8. `FsError` - 80 edges
9. `getAgentStateSync()` - 71 edges
10. `spawnRun()` - 70 edges
...
## Communities (1305 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (230): loadStartCommand(), autoResumeStoppedWorkAgents(), checkCompletedButUnsignaledReviews(), checkFirstCompletionAgents(), checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), checkThinkingSignatureCorruption() (+222 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (209): checkMissingReviewStatuses(), clearStaleCiFeedback(), resolveWorkspaceForIssue(), buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig() (+201 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (185): fetchMessages(), resumeConversation(), updateConversationDeliveryMethod(), sendPlanAction(), fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation() (+177 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (161): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+153 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (169): loadDeaconWithResumeMock(), loadCloisterConfig(), loadCloisterConfigSync(), shouldAutoStart(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState (+161 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (133): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (123): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+115 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (131): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+123 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (111): pruneStaleCheckpointRefs(), getReviewerSessionName(), parseReviewerSessionName(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets() (+103 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (112): detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (104): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (103): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+95 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (91): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+83 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (96): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+88 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (91): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+83 more)
...
Cohesion: 0.02
Nodes (96): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+88 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (108): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), assertIssueHasBeads(), assertIssueHasBeadsEffect(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError (+100 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (103): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+95 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (98): copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+90 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (90): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensureExcalidrawMcpSync() (+82 more)
...
Cohesion: 0.03
Nodes (77): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+69 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (93): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrEffect (+85 more)
...
Cohesion: 0.03
Nodes (101): estimateCost(), agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS (+93 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (72): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (85): EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues() (+77 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (86): computeAgentEnrichment(), computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise() (+78 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (78): SwitchModelModal(), SwitchModelModalProps, WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS (+70 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (86): restoreCommand(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+78 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (92): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+84 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (74): loadConfigNoMigration(), acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+66 more)
...
Cohesion: 0.03
Nodes (67): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+59 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (65): { projectPath, workspacePath }, promoted, specFiles, doc, path, fsHooks, doc, items (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (78): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+70 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (80): logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash() (+72 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (80): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), listFeatureWorkspaces(), recoverUnhealthyTestStack(), contextMigrateCommand() (+72 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (75): importTrackerConfig(), result, Access, checkAgentHealthAsync(), checkAgentHealthEffect(), determineHealthStatusAsync(), determineHealthStatusEffect(), clearCacheRoute (+67 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (69): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+61 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (71): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+63 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (61): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (69): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions (+61 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (71): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+63 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (67): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl() (+59 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (67): pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutex(), withWorkspaceBdMutexPromise(), cb, cmdArgs, file (+59 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (70): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+62 more)
...
Cohesion: 0.05
Nodes (67): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks() (+59 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (63): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+55 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (62): assertSafeAgentId(), assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer (+54 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (70): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+62 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (64): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+56 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (62): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+54 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (62): after, row, status, clearWorkspaceStuck(), getHistoryFromDb(), getReviewStatusFromDb(), getReviewStatusFromDbSync(), markWorkspaceStuck() (+54 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (67): readWorkspacePlanAsync(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), collectInFlightRows(), rowCreatedDate() (+59 more)
...
Cohesion: 0.07
Nodes (69): add, addIn(), addMergeToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex(), assertCollection() (+61 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (59): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromAllProjectsPromise(), syncWalFromDir(), syncWalFromDirPromise(), AgentRollup (+51 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (61): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+53 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (55): buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), hashFileSync() (+47 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (56): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessions(), getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), parseAllSessionsSync() (+48 more)
...
Cohesion: 0.05
Nodes (23): getActiveSessionModel(), getActiveSessionModelSync(), getProjectDirs(), getProjectDirsSync(), getSessionFiles(), getSessionFilesSync(), parseClaudeSession(), parseClaudeSessionSync() (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.1
Nodes (57): bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyPromise(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortPromise(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+49 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (54): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+46 more)
...
Cohesion: 0.08
Nodes (53): BlockerReason, getReviewStatusAsyncEffect(), setReviewStatusAsyncEffect(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+45 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (43): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, BUDGETS_FILE, checkBudget(), checkBudgetSync() (+35 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (46): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle() (+38 more)
...
Cohesion: 0.06
Nodes (55): cleanupAbandonedFeedback(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+47 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (53): appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs(), cleanupAllLogsSync(), cleanupOldLogs(), cleanupOldLogsSync(), createRunLog() (+45 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (52): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+44 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (48): getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig (+40 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (13): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+5 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (33): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+25 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (53): healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride() (+45 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (45): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+37 more)
...
Cohesion: 0.05
Nodes (44): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+36 more)
...
Cohesion: 0.07
Nodes (43): appendCostEvent(), appendCostEventSync(), deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+35 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (49): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+41 more)

### Community 86 - "Community 86"
Cohesion: 0.04
Nodes (19): createFlyApiClient(), createFlyApiClientSync(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client (+11 more)
...
Cohesion: 0.05
Nodes (36): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+28 more)

### Community 89 - "Community 89"
Cohesion: 0.05
Nodes (50): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceShape (+42 more)
...
Cohesion: 0.05
Nodes (30): getModelCapability(), getModelCapabilitySync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping() (+22 more)
...
Cohesion: 0.07
Nodes (39): insertCostEvent(), queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath (+31 more)
...
Cohesion: 0.04
Nodes (52): UpsertDiscoveredSessionOpts, updateConversationsConfig(), updateConversationsConfigAsync(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer (+44 more)

### Community 97 - "Community 97"
Cohesion: 0.06
Nodes (41): resolveEnrichmentModel(), applyFallback(), applyFallbackSync(), applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProviders(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES (+33 more)
...
Cohesion: 0.04
Nodes (42): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+34 more)

### Community 101 - "Community 101"
Cohesion: 0.06
Nodes (39): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+31 more)
...
Cohesion: 0.09
Nodes (31): parsePiSessionSync(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), heartbeatsDir() (+23 more)
...
Cohesion: 0.07
Nodes (37): runQualityGates(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult (+29 more)
...
Cohesion: 0.06
Nodes (43): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+35 more)
...
Cohesion: 0.1
Nodes (37): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+29 more)

### Community 119 - "Community 119"
Cohesion: 0.08
Nodes (35): createHumeConfig(), deleteHumeConfig(), getDefaultWorkspaceConfig(), getDefaultWorkspaceConfigSync(), replacePlaceholders(), AddReposToWorkspaceOptions, addReposToWorkspacePromise(), AddReposToWorkspaceResult (+27 more)
...
Cohesion: 0.09
Nodes (38): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+30 more)
...
Cohesion: 0.06
Nodes (31): configShadowCommand(), ShadowOptions, ClaudePermissionMode, ConversationsConfig, ConversationsEnrichmentConfig, DEFAULT_CONFIG, findDevrootForProject(), findDevrootForProjectSync() (+23 more)

### Community 133 - "Community 133"
Cohesion: 0.07
Nodes (35): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatus(), getMigrationStatusSync() (+27 more)
...
Cohesion: 0.05
Nodes (38): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+30 more)
...
Cohesion: 0.07
Nodes (38): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+30 more)

### Community 138 - "Community 138"
Cohesion: 0.05
Nodes (41): adminRouteLayer, agentsRouteLayer, cliproxyRouteLayer, commandDeckRouteLayer, conversationsRouteLayer, miscRouteLayer, projectsRouteLayer, swarmRouteLayer (+33 more)
...
Cohesion: 0.07
Nodes (37): detectPlatform(), Platform, evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample (+29 more)

### Community 145 - "Community 145"
Cohesion: 0.07
Nodes (33): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl (+25 more)
...
Cohesion: 0.08
Nodes (41): resolveArchiveDir(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult (+33 more)

### Community 148 - "Community 148"
Cohesion: 0.07
Nodes (32): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+24 more)

### Community 149 - "Community 149"
Cohesion: 0.09
Nodes (41): getFlywheelRunPayload(), getFlywheelRunsPayload(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata(), deriveRunStatus(), fileExists(), FlywheelCurrentStatusOptions (+33 more)
...
Cohesion: 0.07
Nodes (33): ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityDetailedSync(), EmitActivityOptions, emitActivityTts(), emitActivityTtsSync(), emitDashboardLifecycle() (+25 more)
...
Cohesion: 0.06
Nodes (32): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+24 more)

### Community 154 - "Community 154"
Cohesion: 0.1
Nodes (39): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+31 more)

### Community 155 - "Community 155"
Cohesion: 0.07
Nodes (22): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, setupVoiceWebSocket() (+14 more)
...
Cohesion: 0.05
Nodes (40): execAsync, execFileAsync, getModelsResolveRoute, getProjectSpecialistContextRoute, getProjectSpecialistGraceRoute, getProjectSpecialistLatestLogRoute, getProjectSpecialistRunRoute, getProjectSpecialistRunsRoute (+32 more)
...
Cohesion: 0.09
Nodes (34): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, checkTtsHealth(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload (+26 more)

### Community 169 - "Community 169"
Cohesion: 0.08
Nodes (36): eventsFileExists(), getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+28 more)

### Community 170 - "Community 170"
Cohesion: 0.07
Nodes (29): createClaudeCodeRuntime(), createClaudeCodeRuntimeSync(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime() (+21 more)
...
Cohesion: 0.09
Nodes (39): addCommentBefore(), addPairToJSMap(), anchorIsValid(), captureTldrMetrics(), clone(), createStringifyContext(), escapeTagName(), format() (+31 more)

### Community 183 - "Community 183"
Cohesion: 0.08
Nodes (33): setupCavemanCompressScripts(), after, backupPath, backups, calls, errSpy, exitSpy, original (+25 more)
...
Cohesion: 0.08
Nodes (29): CapabilityStats, clearMetrics(), clearMetricsSync(), DailyStats, DEFAULT_METRICS, getAggregatedMetrics(), getAggregatedMetricsSync(), getAllRuntimeMetrics() (+21 more)
...
Cohesion: 0.11
Nodes (30): acquireRestartLock(), acquireRestartLockPromise(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder() (+22 more)
...
Cohesion: 0.09
Nodes (33): activeViolations, checkAgentForViolations(), clearOldViolations(), clearOldViolationsEffect(), clearOldViolationsSync(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig (+25 more)
...
Cohesion: 0.06
Nodes (36): Activity, AgentChannelReply, AgentId, AgentResolution, AgentStatus, CHANNEL_REPLY_KIND_VALUES, ChannelReplyArtifactRef, ChannelReplyKind (+28 more)
...
Cohesion: 0.07
Nodes (18): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSession(), parsePiSessionContent(), ParseResult (+10 more)

### Community 210 - "Community 210"
Cohesion: 0.08
Nodes (29): clearFeedbackFiles(), clearFeedbackFilesPromise(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+21 more)

### Community 211 - "Community 211"
Cohesion: 0.08
Nodes (22): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+14 more)

### Community 212 - "Community 212"
Cohesion: 0.09
Nodes (27): canonicalPrdSubdir(), canonicalPrdSubdirSync(), findDraftPrd(), findDraftPrdSync(), findPrdAnywhere(), findPrdAnywhereSync(), findPrdAtStatus(), findPrdAtStatusSync() (+19 more)

### Community 213 - "Community 213"
Cohesion: 0.09
Nodes (6): effFromPromise(), execAsync, FlyProvider, { execAsyncMock, spawnMock, mockApi }, fly, p
...
Cohesion: 0.1
Nodes (4): generateHealthSummary(), getAgentsNeedingAttention(), CloisterService, readStateFile()
...
Cohesion: 0.11
Nodes (33): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+25 more)

### Community 220 - "Community 220"
Cohesion: 0.09
Nodes (23): CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync(), getAllHealthHistory(), getAllHealthHistorySync() (+15 more)

### Community 221 - "Community 221"
Cohesion: 0.1
Nodes (24): FsError, CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterEffect(), createClaudeAdapterSync(), createRuntimeRegistry(), getInstalledRuntimes(), getInstalledRuntimesPromise() (+16 more)
...
Cohesion: 0.14
Nodes (33): deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathEffect() (+25 more)
...
Cohesion: 0.1
Nodes (26): getCavemanHooksDir(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript() (+18 more)

### Community 248 - "Community 248"
Cohesion: 0.1
Nodes (20): CanonicalState, createShadowState(), createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatusPromise(), getShadowState(), getShadowStatePath(), getShadowStatePromise() (+12 more)
...
Cohesion: 0.08
Nodes (26): readLogTail(), appendJsonl(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., activePtyHubs (+18 more)

### Community 260 - "Community 260"
Cohesion: 0.1
Nodes (24): err, exec(), execFile(), execMock, kCustom, prompt, spawnRunMock, tmuxCapturePaneAsyncMock (+16 more)

### Community 261 - "Community 261"
Cohesion: 0.13
Nodes (22): dangerBanner(), DangerousGitOpError, DangerousOp, DangerousOpBlockedError, dryRunGitClean(), dryRunGitCleanPromise(), execAsync, pathLeaf() (+14 more)

### Community 262 - "Community 262"
Cohesion: 0.09
Nodes (26): approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifact() (+18 more)
...
Cohesion: 0.08
Nodes (23): AgentState, __testInternals, clearRunningAgentsCache(), getCachedRunningAgents(), ListAgentsEffect, RunningAgent, RunningAgents, runningAgentsCache (+15 more)

### Community 271 - "Community 271"
Cohesion: 0.13
Nodes (27): extractNumber(), applyLabelLinearImpl(), clearProjectBeadsImpl(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, stepFailed() (+19 more)

### Community 272 - "Community 272"
Cohesion: 0.1
Nodes (22): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, ResolvedWorkspace, ReverseMapCache, encodeClaudeProjectDir(), pathExists() (+14 more)
...
Cohesion: 0.11
Nodes (30): composeAlias(), composeCollection(), composeDoc(), composeEmptyNode(), composeNode(), composeScalar(), containsNewline(), doubleQuotedValue() (+22 more)
...
Cohesion: 0.14
Nodes (29): apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect(), generateInstallationTokenPromise(), generateJWT() (+21 more)
...
Cohesion: 0.15
Nodes (29): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), clearShadowStateImpl(), deleteBranches(), deleteBranchesImpl(), execAsync (+21 more)
...
Cohesion: 0.11
Nodes (26): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl(), closeGitHubPr() (+18 more)
...
Cohesion: 0.14
Nodes (28): abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId(), getPlatformOpenCommand() (+20 more)

### Community 310 - "Community 310"
Cohesion: 0.13
Nodes (21): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+13 more)

### Community 311 - "Community 311"
Cohesion: 0.09
Nodes (19): createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, AgentTemplateConfig, DatabaseConfig, DnsConfig (+11 more)

### Community 312 - "Community 312"
Cohesion: 0.11
Nodes (19): getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise(), resolveShadowMode() (+11 more)

### Community 313 - "Community 313"
Cohesion: 0.1
Nodes (23): collectLifecycleRows(), VBriefInvalidFormatError, VBriefMergeConflictError, VBriefMergeConflictTaggedError, resolveVBriefDir(), buildProjectIndex(), findVBriefByIssue(), findVBriefByIssueAsync() (+15 more)
...
Cohesion: 0.14
Nodes (19): after, before, blockers, result, statuses, clearReviewStatus(), clearReviewStatusSync(), DEFAULT_STATUS_FILE (+11 more)

### Community 317 - "Community 317"
Cohesion: 0.09
Nodes (21): DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getReviewStatusesFromDb(), rowToReviewStatus(), setDeaconIgnored(), all (+13 more)
...
Cohesion: 0.07
Nodes (26): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+18 more)

### Community 327 - "Community 327"
Cohesion: 0.13
Nodes (23): onInspectComplete(), onInspectCompletePromise(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise(), getDiffBaseEffect() (+15 more)
...
Cohesion: 0.07
Nodes (17): archiveIdx, beadsDir, branchStep, clearStep, closeIdx, commands, content, ctx (+9 more)
...
Cohesion: 0.16
Nodes (23): CostLimitsConfig, checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted (+15 more)

### Community 332 - "Community 332"
Cohesion: 0.1
Nodes (26): applyEvent(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxMemoryObservationsPerIssue(), getMaxTurnDiffSummariesPerAgent(), MemoryHealthSnapshot, MemoryReadModelState (+18 more)
...
Cohesion: 0.14
Nodes (23): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+15 more)

### Community 350 - "Community 350"
Cohesion: 0.15
Nodes (24): createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE (+16 more)

### Community 351 - "Community 351"
Cohesion: 0.08
Nodes (25): Agent Guidance, Agent System, Architecture & Design, Build & Development, Configuration, Configuration & Models, Development, Documentation Maintenance (+17 more)
...
Cohesion: 0.13
Nodes (18): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry(), resolveWindowUrl() (+10 more)
...
Cohesion: 0.08
Nodes (20): CostEvent, dir, event, eventsDir1, eventsDir2, line, lines, mockListProjects (+12 more)
...
Cohesion: 0.15
Nodes (19): getForgeAdapter(), ensureMergeSetForIssue(), ensureMergeSetForIssueSync(), upsertMergeSet(), upsertMergeSetSync(), withRepoArtifactUrl(), withRepoArtifactUrlSync(), withRepoState() (+11 more)

### Community 379 - "Community 379"
Cohesion: 0.22
Nodes (23): createFlyProvider(), getRemoteProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+15 more)
...
Cohesion: 0.11
Nodes (14): after, before, cfg, compose, ph, result, createWorkspacePlaceholders(), createWorkspacePlaceholdersSync() (+6 more)
...
Cohesion: 0.12
Nodes (14): cleanupPiTransientFiles(), createPiFifo(), createPiFifoPromise(), destroyPiFifo(), destroyPiFifoSync(), execAsync, PiFifoError, PiNotReady (+6 more)
...
Cohesion: 0.09
Nodes (20): isReviewSessionForIssue(), agentSrc, content, dashboardStopIdx, dirtyIdx, dispatchFailedMatches, downBlockMatch, guardMatch (+12 more)

### Community 428 - "Community 428"
Cohesion: 0.19
Nodes (20): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxyPromise(), bridgeCodexAuthToCliproxySync(), decodeJwtPayload(), getCliproxyCodexCredPath(), getCodexAuthPath(), buildStatus() (+12 more)
...
Cohesion: 0.11
Nodes (18): computeStuckCount(), map, mockGetAgentHealth, mockGetCloisterService, mockGetStatus, mockListRunningAgents, mockLoadReviewStatuses, buildAgentIssueMap() (+10 more)

### Community 444 - "Community 444"
Cohesion: 0.19
Nodes (14): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), createBackup(), createBackupSync() (+6 more)
...
Cohesion: 0.11
Nodes (17): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), cleanupMergedLabelsImpl(), execAsync, LABELS_TO_REMOVE, calls, ctx (+9 more)

### Community 449 - "Community 449"
Cohesion: 0.18
Nodes (13): buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), getClaudePermissionFlagsStringSync(), getClaudePermissionFlagsSync(), readYoloEnv() (+5 more)

### Community 450 - "Community 450"
Cohesion: 0.13
Nodes (10): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, loadPanopticonEnv(), loadPanopticonEnvSync(), parseEnvFile(), ServerConfig, ServerConfigError (+2 more)
...
Cohesion: 0.25
Nodes (14): scanGitPatterns(), execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise() (+6 more)

### Community 460 - "Community 460"
Cohesion: 0.12
Nodes (17): deriveProjectRoot(), doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending (+9 more)
...
Cohesion: 0.13
Nodes (16): findVendoredDir(), getCavemanSkillsDir(), setupCavemanHooks(), FsNotFoundError, compressSrc, destDir, dir, hookFiles (+8 more)
...
Cohesion: 0.13
Nodes (12): future, id, rows, rows1, rows2, GitActivityDbError, GitOperation, GitOperationFilter (+4 more)
...
Cohesion: 0.12
Nodes (16): actual, allLogs, logPath, mockCleanupAllLogs, mockCleanupOldLogs, mockConsoleError, mockConsoleLog, mockExec (+8 more)

### Community 512 - "Community 512"
Cohesion: 0.2
Nodes (14): ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchHit, MemorySearchRow, normalizeLimit() (+6 more)

### Community 513 - "Community 513"
Cohesion: 0.12
Nodes (14): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateAsync, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue (+6 more)
...
Cohesion: 0.23
Nodes (13): addTunnelIngress(), addTunnelIngressPromise(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials(), removeTunnelIngress() (+5 more)
...
Cohesion: 0.15
Nodes (14): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute, postCodexReauthStatusRoute (+6 more)

### Community 541 - "Community 541"
Cohesion: 0.12
Nodes (13): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateAsync, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue (+5 more)
...
Cohesion: 0.12
Nodes (14): Basic Usage, Cleanup After Shutdown, code:bash (# Stop all Panopticon services), code:bash (# Method 1: Separate commands), code:bash (# Clean up log files), More Information, Next Steps, Overview (+6 more)
...
Cohesion: 0.15
Nodes (12): MainDivergedError, badObjectErr, cmd, exec(), execFile(), execMock, fetchErr, kCustom (+4 more)
...
Cohesion: 0.24
Nodes (14): addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), DnsSyncMethod, ensureBaseDomain(), execAsync, getDnsmasqConfigDir() (+6 more)

### Community 559 - "Community 559"
Cohesion: 0.24
Nodes (11): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getUnsyncedHistory(), needsSync(), updateTrackerStatusCache(), formatDate() (+3 more)
...
Cohesion: 0.16
Nodes (14): appendCostEvent(), appendToWal(), ensureEventsFile(), extractPrefix(), getCostsDir(), getEventsFile(), insertCostEvent(), listProjects() (+6 more)

### Community 586 - "Community 586"
Cohesion: 0.25
Nodes (12): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestsPromise(), runTestSuite() (+4 more)

### Community 587 - "Community 587"
Cohesion: 0.16
Nodes (12): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+4 more)
...
Cohesion: 0.15
Nodes (12): entry, { issueId }, { limit }, old, op, ops, recent, result (+4 more)
...
Cohesion: 0.17
Nodes (9): getDisplayStatus(), getPendingSyncCountPromise(), listShadowedIssues(), id, id1, id2, result, TEST_SHADOW_STATE_DIR (+1 more)
...
Cohesion: 0.23
Nodes (7): computeQueuePositionFromStatus(), computeQueuePositionFromStatusSync(), findPositionInQueue(), findPositionInQueueSync(), QueuePositionResult, items, result
...
Cohesion: 0.18
Nodes (10): first, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile (+2 more)
...
Cohesion: 0.18
Nodes (9): content, d, existingDir, lines, oldDir, result, skillDir, ensurePanGitignore() (+1 more)
...
Cohesion: 0.18
Nodes (6): execFileMock, postMergeLifecycleMock, readContinueStateAsyncMock, readContinueStateEffectMock, readdirSyncMock, resolveGitHubIssueMock
...
Cohesion: 0.18
Nodes (9): code:bash (bd daemon), Contents, Daemon Won't Start, Interface-Specific Troubleshooting, Quick Reference: Common Fixes, Related Documentation, Root Cause, Symptom (+1 more)
...
Cohesion: 0.2
Nodes (8): correctness, dir, liveSet, name, reviewRunDir, SESSION_NAME, synthesis, workspacePath
...
Cohesion: 0.29
Nodes (8): detectTestCommand(), detectTestCommandEffect(), detectTestCommandSync(), fileExists(), command, jestConfig, packageJson, testDir
...
Cohesion: 0.22
Nodes (7): GIT_PATTERNS, MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen
...
Cohesion: 0.22
Nodes (8): file, future, jsonl, missing, newer, older, past, txt
...
Cohesion: 0.22
Nodes (8): agentDir, dir1, dir2, marker, missing, nested, cleanupAgentStateDirs(), removeCompletionMarker()
...
Cohesion: 0.25
Nodes (4): mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnRun, notify
...
Cohesion: 0.25
Nodes (4): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo
...
Cohesion: 0.29
Nodes (6): calls, logSpy, now, output, payload, {
...
Cohesion: 0.29
Nodes (7): requestReviewCommand(), 13. Icons, code:block31 (Default:  18px (w-[18px] h-[18px])), code:block32 (Command Deck:  Compass), Color, Nav Icons, Sizing
...
Cohesion: 0.33
Nodes (5): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNamesAsync, mockListSessionNamesEffect, mockMarkConversationEnded
...
Cohesion: 0.7
Nodes (4): getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand()
...
Cohesion: 0.4
Nodes (5): cleanupOldEvents(), cleanupOldEventsSync(), initHealthDatabase(), openSqliteDb(), _require
...
Cohesion: 0.4
Nodes (3): mockLoadReviewStatuses, mockOnIssueStateChange, STALE_TS

### Community 1102 - "Community 1102"
Cohesion: 0.6
Nodes (4): cavemanCompressCommand(), execAsync, getCavemanCompressDir(), registerCavemanCommands()
...
Cohesion: 0.67
Nodes (3): code:bash (# In your project directory), code:bash (# If you don't want daemon to pull from remote), Resolution
...
## Knowledge Gaps
- **13619 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13614 more)
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 537`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 37`, `Community 41`, `Community 43`, `Community 557`, `Community 45`, `Community 47`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 71`, `Community 73`, `Community 74`, `Community 588`, `Community 78`, `Community 79`, `Community 80`, `Community 83`, `Community 85`, `Community 86`, `Community 90`, `Community 101`, `Community 107`, `Community 113`, `Community 119`, `Community 120`, `Community 127`, `Community 136`, `Community 145`, `Community 147`, `Community 148`, `Community 150`, `Community 663`, `Community 151`, `Community 154`, `Community 155`, `Community 171`, `Community 182`, `Community 183`, `Community 701`, `Community 193`, `Community 194`, `Community 210`, `Community 219`, `Community 249`, `Community 260`, `Community 262`, `Community 263`, `Community 269`, `Community 271`, `Community 283`, `Community 796`, `Community 289`, `Community 802`, `Community 810`, `Community 314`, `Community 346`, `Community 354`, `Community 357`, `Community 377`, `Community 401`, `Community 404`, `Community 407`, `Community 430`, `Community 459`, `Community 497`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 1`, `Community 34`, `Community 101`, `Community 71`, `Community 328`, `Community 329`, `Community 39`, `Community 73`, `Community 15`, `Community 17`, `Community 210`, `Community 313`, `Community 538`, `Community 222`, `Community 30`, `Community 57`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 1`, `Community 134`, `Community 263`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 1037`, `Community 16`, `Community 21`, `Community 22`, `Community 151`, `Community 536`, `Community 152`, `Community 26`, `Community 27`, `Community 285`, `Community 29`, `Community 287`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 164`, `Community 296`, `Community 41`, `Community 172`, `Community 55`, `Community 311`, `Community 56`, `Community 57`, `Community 701`, `Community 61`, `Community 64`, `Community 194`, `Community 67`, `Community 461`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 86`, `Community 92`, `Community 225`, `Community 102`, `Community 103`, `Community 106`, `Community 748`, `Community 238`, `Community 755`, `Community 633`, `Community 127`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 218 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 218 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13619 weakly-connected nodes found - possible documentation gaps or missing edges._
