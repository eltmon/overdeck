...
## Corpus Check
- 1574 files · ~2,071,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22401 nodes · 33630 edges · 1160 communities (1121 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8beffb88`
...
## Communities (1160 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (177): performKillAndSpawn(), buildSpecialistBaseCommand(), healthCommand(), HealthOptions, pendingCommand(), recoverCommand(), RecoverOptions, resetSessionCommand() (+169 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (137): ConversationRow(), ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+129 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (154): archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS (+146 more)
...
Cohesion: 0.02
Nodes (121): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+113 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (133): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (107): BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode (+99 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (97): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), IssueWorkbenchProps, ZoneA(), ZoneAProps (+89 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (87): DeaconState, isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent, restartCalled (+79 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (112): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (103): readCavemanVariant(), getSpecialistHarness(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTmuxEnvFlags(), bumpSessionGeneration(), clearSessionId() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (83): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+75 more)
...
Cohesion: 0.04
Nodes (73): getDefaultConversationModel(), ForkModal(), ForkModalProps, useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps (+65 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (90): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (80): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+72 more)
...
Cohesion: 0.03
Nodes (74): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (79): loadCloisterConfig(), checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (74): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+66 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (78): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (80): spawnSingleReviewer(), killCommand(), KillOptions, {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, buildAgentLaunchConfig(), getAgentRuntimeBaseCommand(), getProviderExportsForModel(), panopticonAgentName() (+72 more)
...
Cohesion: 0.03
Nodes (74): resetPostMergeState(), agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache() (+66 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (68): after, before, blockers, result, statuses, after, row, status (+60 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (72): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (72): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+64 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (52): after, doc, filename, path, isRFC3339DateTime(), toRFC3339(), VBRIEF_INSPECTION_POLICIES, VBriefDifficulty (+44 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (52): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), dispatchSwarmWave() (+44 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (59): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+51 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (60): issues, result, importTrackerConfig(), result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync (+52 more)
...
Cohesion: 0.08
Nodes (55): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument() (+47 more)
...
Cohesion: 0.06
Nodes (44): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (50): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (52): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (52): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds() (+44 more)
...
Cohesion: 0.04
Nodes (47): buildTaskPrompt(), buildTestAgentPromptContent(), resolveWorkspaceGitInfo(), err, exec(), execFile(), execMock, kCustom (+39 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (47): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), next (+39 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (43): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand() (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (47): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+39 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (44): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+36 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (48): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+40 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (44): listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getCachedFavoritedIds(), getClientIp() (+36 more)
...
Cohesion: 0.05
Nodes (39): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), CostDonut(), CostDonutProps, formatBytes() (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (42): InlineSparkline(), InlineSparklineProps, useLiveFlash(), ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory(), activityToStatus() (+34 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (48): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+40 more)
...
Cohesion: 0.07
Nodes (45): wipeCommand(), archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir (+37 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (35): DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout() (+27 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (47): Access, getAgentJsonlMtime(), readFileTail(), encodeClaudeProjectDir(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), pathExists() (+39 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (43): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+35 more)
...
Cohesion: 0.09
Nodes (40): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), restoreTrackedBeadsExport(), updateGitHubToInReview(), updateLinearToInReview() (+32 more)
...
Cohesion: 0.07
Nodes (35): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+27 more)
...
Cohesion: 0.05
Nodes (39): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+31 more)
...
Cohesion: 0.06
Nodes (37): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), SessionUsage (+29 more)
...
Cohesion: 0.09
Nodes (37): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+29 more)
...
Cohesion: 0.07
Nodes (24): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+16 more)
...
Cohesion: 0.1
Nodes (31): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+23 more)
...
Cohesion: 0.09
Nodes (31): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+23 more)
...
Cohesion: 0.07
Nodes (28): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+20 more)

### Community 187 - "Community 187"
Cohesion: 0.08
Nodes (25): ensureDefaultConversationModel(), ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider() (+17 more)
...
Cohesion: 0.07
Nodes (20): button, { container }, defaultProps, makeMutation(), makeSyncMutation(), onDismissPending, onKillSuccess, onPlan (+12 more)
...
Cohesion: 0.09
Nodes (27): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+19 more)
...
Cohesion: 0.12
Nodes (23): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+15 more)
...
Cohesion: 0.1
Nodes (24): AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS, getLinearStateName() (+16 more)
...
Cohesion: 0.14
Nodes (21): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions (+13 more)
...
Cohesion: 0.19
Nodes (21): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), CloseIssueOptions (+13 more)

### Community 324 - "Community 324"
Cohesion: 0.27
Nodes (21): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+13 more)
...
Cohesion: 0.14
Nodes (15): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+7 more)
...
Cohesion: 0.18
Nodes (17): checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost() (+9 more)
...
Cohesion: 0.13
Nodes (13): fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress(), reopenWorkspaceState() (+5 more)
...
Cohesion: 0.22
Nodes (4): getAllSessionFiles(), getProjectDirs(), getSessionFiles(), ClaudeCodeRuntime
...
Cohesion: 0.29
Nodes (13): getVBriefACStatus(), BeadRecord, checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode(), execAsync, execFileAsync (+5 more)
...
Cohesion: 0.18
Nodes (12): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+4 more)
...
Cohesion: 0.22
Nodes (12): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+4 more)
...
Cohesion: 0.15
Nodes (12): Auto-planning, Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071 --auto), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Panopticon Planning Lifecycle (+4 more)
...
Cohesion: 0.38
Nodes (6): analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., open
...
- **Why does `fetch` connect `Community 3` to `Community 1`, `Community 2`, `Community 4`, `Community 133`, `Community 774`, `Community 7`, `Community 135`, `Community 11`, `Community 396`, `Community 13`, `Community 17`, `Community 658`, `Community 19`, `Community 660`, `Community 20`, `Community 22`, `Community 152`, `Community 28`, `Community 30`, `Community 37`, `Community 38`, `Community 551`, `Community 40`, `Community 41`, `Community 46`, `Community 52`, `Community 184`, `Community 185`, `Community 61`, `Community 577`, `Community 68`, `Community 75`, `Community 76`, `Community 208`, `Community 89`, `Community 98`, `Community 99`, `Community 228`, `Community 105`, `Community 245`, `Community 124`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 143` to `Community 0`, `Community 18`, `Community 11`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 37` to `Community 1041`, `Community 548`?**
