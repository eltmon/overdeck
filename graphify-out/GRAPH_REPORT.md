...
## Corpus Check
- 1878 files · ~2,476,747 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26658 nodes · 41397 edges · 1266 communities (1213 shown, 53 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff800465`
...
## Communities (1266 total, 53 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (181): spawnInspectAgent(), buildSpecialistBaseCommand(), pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions, tellCommand(), unpauseCommand() (+173 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (155): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews() (+147 more)
...
Cohesion: 0.02
Nodes (124): monitorReviewConvoySignals(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), pendingCommand(), after, before, blockers, result (+116 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (108): checkApiErrorAgents(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+100 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (118): TurnDiffFileChange, forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset() (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (86): loadCloisterConfig(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+78 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (111): checkMissingReviewStatuses(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (107): autoResumeStoppedWorkAgents(), isVerifyPausedAgentState(), notifyAgentStatusChanged(), resetSessionCommand(), confirmHostOverride(), resumeCommand(), ResumeOptions, computeAgentEnrichment() (+99 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (105): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (102): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+94 more)
...
Cohesion: 0.02
Nodes (97): EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues() (+89 more)
...
Cohesion: 0.02
Nodes (90): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ViewMode (+82 more)
...
Cohesion: 0.03
Nodes (81): PanSpecListOptions, ProjectPanPaths, criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles (+73 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (74): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+66 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (83): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+75 more)
...
Cohesion: 0.03
Nodes (87): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+79 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (83): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), getTtsDaemonAuthToken(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate() (+75 more)
...
Cohesion: 0.03
Nodes (88): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute (+80 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (80): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), wipeCommand(), WipeOptions, addRepoCommand() (+72 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (70): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (80): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+72 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (70): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+62 more)
...
Cohesion: 0.03
Nodes (66): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (83): embedAction(), confirmCost(), enrichAction(), formatCost(), ScanOptions, SearchQuery, searchSessions(), runWithPool() (+75 more)
...
Cohesion: 0.03
Nodes (64): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (80): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding (+72 more)
...
Cohesion: 0.03
Nodes (71): cosineSimilarity(), getEmbedding(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), rowToSession() (+63 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (70): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+62 more)
...
Cohesion: 0.04
Nodes (62): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+54 more)
...
Cohesion: 0.03
Nodes (54): StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED (+46 more)
...
Cohesion: 0.03
Nodes (58): getNoResumeMode(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result (+50 more)
...
Cohesion: 0.05
Nodes (52): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl() (+44 more)
...
Cohesion: 0.06
Nodes (60): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+52 more)
...
Cohesion: 0.05
Nodes (46): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+38 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (56): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+48 more)
...
Cohesion: 0.05
Nodes (55): updateMemoryHealth(), EnqueueStatusRollup, enqueueStatusRollupEvent(), findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup(), pendingTurnFileName() (+47 more)
...
Cohesion: 0.07
Nodes (35): parsePiSession(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles() (+27 more)
...
Cohesion: 0.09
Nodes (51): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+43 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (37): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime(), createPiFifo() (+29 more)
...
Cohesion: 0.07
Nodes (46): insertCostEvent(), extractedTurn(), areMemoryObservationsEnabled(), booleanOrDefault(), defaultMemorySettings(), getMemoryRollupPendingThreshold(), getMemoryWorkerConcurrency(), isMemoryPromptTimeInjectionEnabled() (+38 more)
...
Cohesion: 0.05
Nodes (53): generateFallbackSummary(), AIProvider, buildConversationResponse(), getCachedMessages(), handleConversationMessage(), isPiSessionFile(), activeCompactions, buildContinuationSummary() (+45 more)
...
Cohesion: 0.04
Nodes (51): UpsertDiscoveredSessionOpts, ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+43 more)

### Community 86 - "Community 86"
Cohesion: 0.1
Nodes (49): extractNumber(), extractPrefix(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl() (+41 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (41): doc, path, actionableDoc(), activePipelineStatus(), ActiveSlice, ActiveSliceOptions, buildPipelineMirrorFromStatus(), CompiledGlob (+33 more)
...
Cohesion: 0.05
Nodes (40): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl() (+32 more)
...
Cohesion: 0.06
Nodes (44): detectPlatform(), Platform, listPaneValuesAsyncEffect(), evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv() (+36 more)
...
Cohesion: 0.07
Nodes (43): listSessionNamesAsyncEffect(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync (+35 more)
...
Cohesion: 0.06
Nodes (34): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+26 more)
...
Cohesion: 0.07
Nodes (34): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+26 more)

### Community 125 - "Community 125"
Cohesion: 0.07
Nodes (33): conversationsTab, firstLens, lens, overview, tablist, CommandDeck(), ComposerMode, IssueComposer() (+25 more)
...
Cohesion: 0.08
Nodes (38): closeMemoryFtsDatabases(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime() (+30 more)
...
Cohesion: 0.06
Nodes (37): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+29 more)
...
Cohesion: 0.07
Nodes (27): getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG (+19 more)

### Community 153 - "Community 153"
Cohesion: 0.06
Nodes (33): ComposerPlugin(), ComposerPromptEditor(), ComposerPromptEditorProps, EditorRefPluginProps, filterCommands(), getDraftKey(), InnerPluginProps, loadDraft() (+25 more)
...
Cohesion: 0.07
Nodes (36): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+28 more)
...
Cohesion: 0.08
Nodes (26): getDefaultWorkspaceConfig(), addReposToWorkspace(), AddReposToWorkspaceOptions, AddReposToWorkspaceResult, assignPort(), copyProjectTemplateDirs(), createWorkspace(), createWorktree() (+18 more)
...
Cohesion: 0.07
Nodes (28): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, createRecoveryCoordinator(), EventClassification (+20 more)
...
Cohesion: 0.08
Nodes (24): execAsync, rebaseFeatureBranch(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+16 more)
...
Cohesion: 0.1
Nodes (29): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+21 more)
...
Cohesion: 0.1
Nodes (23): cn(), IssueCard, IssueCardPriority, IssueCardProps, PRIORITY_ACCENT_CLASSES, SettingsCardSection(), SettingsCardSectionProps, TopBar() (+15 more)
...
Cohesion: 0.12
Nodes (29): activePlanWriters, applyTaskOperation(), applyTaskOperationToPlanFileAsync(), assertSingleWriterAsync(), applyTaskOperationToPlanFile(), assertSingleWriter(), readPlanFile(), releasePlanWriter() (+21 more)
...
Cohesion: 0.11
Nodes (3): createFlyApiClient(), effFromPromise(), FlyProvider
...
Cohesion: 0.11
Nodes (25): Access, getIndexStats(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+17 more)

### Community 247 - "Community 247"
Cohesion: 0.13
Nodes (30): runDashboardDbJob(), WorkerLane, abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+22 more)
...
Cohesion: 0.07
Nodes (26): printActiveSliceForIssue(), annotated, before, candidate, check, claimed, defaults, doc (+18 more)
...
Cohesion: 0.17
Nodes (23): GitHubApiError, LinearApiError, AnyTrackerError, Comment, Issue, IssueFilters, IssueNotFoundError, IssueState (+15 more)

### Community 277 - "Community 277"
Cohesion: 0.1
Nodes (27): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloseOutConfig, CostLimitsConfig, CostTrackingConfig, deepMerge() (+19 more)
...
Cohesion: 0.12
Nodes (23): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+15 more)

### Community 288 - "Community 288"
Cohesion: 0.09
Nodes (22): SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow(), SettingsRowProps, SettingsRowStatus(), SettingsRowStatusProps (+14 more)
...
Cohesion: 0.12
Nodes (26): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+18 more)
...
Cohesion: 0.11
Nodes (21): checkFailedMergeRetry(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+13 more)
...
Cohesion: 0.16
Nodes (19): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+11 more)
...
Cohesion: 0.11
Nodes (19): importTrackerConfig(), computeBeadCounts(), getCachedPlanningState(), PLANNING_FINISHED_STATUSES, planningStateCache, PlanningStateCacheEntry, planningStateRefreshInFlight, POLL_INTERVALS (+11 more)
...
Cohesion: 0.09
Nodes (8): FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine, machines
...
Cohesion: 0.12
Nodes (10): TrackerType, DEFAULT_STORE, formatIssueRef(), LinkDirection, LinkManager, LinkStore, parseIssueRef(), pathExists() (+2 more)

### Community 353 - "Community 353"
Cohesion: 0.12
Nodes (21): markAgentStopped(), markAgentStoppedState(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+13 more)
...
Cohesion: 0.09
Nodes (17): agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockGetWorkspaceStackHealth, mockLoadReviewStatuses, mockRebuildWorkspaceStack, mockResolveProjectFromIssue (+9 more)
...
Cohesion: 0.15
Nodes (18): validateAndCleanStateFile(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths() (+10 more)
...
Cohesion: 0.12
Nodes (10): ProjectConfig, after, before, cfg, compose, ph, result, createWorkspacePlaceholders() (+2 more)
...
- **Why does `fetch` connect `Community 11` to `Community 1`, `Community 258`, `Community 3`, `Community 2`, `Community 135`, `Community 136`, `Community 9`, `Community 524`, `Community 12`, `Community 14`, `Community 13`, `Community 16`, `Community 17`, `Community 146`, `Community 19`, `Community 20`, `Community 21`, `Community 18`, `Community 23`, `Community 153`, `Community 154`, `Community 25`, `Community 29`, `Community 30`, `Community 32`, `Community 292`, `Community 38`, `Community 167`, `Community 680`, `Community 43`, `Community 1075`, `Community 51`, `Community 52`, `Community 56`, `Community 570`, `Community 188`, `Community 573`, `Community 62`, `Community 64`, `Community 67`, `Community 325`, `Community 455`, `Community 200`, `Community 75`, `Community 332`, `Community 208`, `Community 218`, `Community 90`, `Community 220`, `Community 735`, `Community 96`, `Community 224`, `Community 233`, `Community 109`, `Community 381`, `Community 638`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 18` to `Community 33`, `Community 37`, `Community 39`, `Community 40`, `Community 270`, `Community 15`, `Community 47`, `Community 334`, `Community 306`, `Community 410`, `Community 244`, `Community 87`, `Community 25`, `Community 58`, `Community 223`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 187` to `Community 0`, `Community 640`, `Community 1`, `Community 259`, `Community 3`, `Community 5`, `Community 6`, `Community 262`, `Community 257`, `Community 135`, `Community 268`, `Community 269`, `Community 15`, `Community 275`, `Community 405`, `Community 277`, `Community 24`, `Community 152`, `Community 25`, `Community 27`, `Community 411`, `Community 28`, `Community 542`, `Community 159`, `Community 36`, `Community 168`, `Community 42`, `Community 43`, `Community 170`, `Community 304`, `Community 50`, `Community 56`, `Community 58`, `Community 188`, `Community 69`, `Community 70`, `Community 453`, `Community 199`, `Community 456`, `Community 458`, `Community 75`, `Community 331`, `Community 81`, `Community 89`, `Community 90`, `Community 92`, `Community 478`, `Community 351`, `Community 352`, `Community 94`, `Community 232`, `Community 107`, `Community 620`, `Community 495`, `Community 497`, `Community 123`, `Community 380`?**
