# Graph Report - feature-pan-1048  (2026-05-09)

## Corpus Check
- 1548 files · ~2,043,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21741 nodes · 32286 edges · 1148 communities (1112 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9dd586c`
...
1. `fetch` - 164 edges
2. `resolveProjectFromIssue()` - 104 edges
3. `getDatabase()` - 89 edges
4. `useDashboardStore` - 56 edges
5. `spawnEphemeralSpecialist()` - 52 edges
6. `listSessionNamesAsync()` - 50 edges
7. `spawnAgent()` - 48 edges
8. `sessionExistsAsync()` - 48 edges
9. `killSessionAsync()` - 46 edges
10. `runPatrol()` - 45 edges
...
- `isEligibleForCleanup()` --calls--> `require`  [INFERRED]
  tests/lib/cloister/deacon-cleanup.test.ts → src/lib/vbrief/builder.ts
- `fetchActiveWorkspaces()` --calls--> `fetch`  [INFERRED]
  apps/desktop/src/menu.ts → src/dashboard/frontend/src/components/__tests__/TerminalPanel.test.tsx

## Communities (1148 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (142): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt() (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (127): readCavemanVariant(), checkPendingTestDispatch(), buildReviewBaseCommand(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildTestRolePrompt(), dashboardApiUrl() (+119 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (131): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+123 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (117): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+109 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (128): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+120 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (95): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, DetailPanelLayoutProps, loadPanelState(), PanelMode (+87 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (75): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (100): buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+92 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (107): checkOrphanedReviewStatuses(), checkStuckReviewing(), renderPrompt(), getActiveParallelReviewIssues(), buildProviderExportLines(), buildSpecialistBaseCommand(), buildSpecialistCavemanExports(), buildTaskPrompt() (+99 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (87): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+79 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (95): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+87 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (89): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+81 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (82): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (75): getDefaultConversationModel(), firstSessionPanel, firstWorkbench, workbench, Conversation, ConversationList(), ConversationListProps, fetchConversations() (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (82): ChatMarkdown, ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (80): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+72 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (85): isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (83): reconcileFalseMerged(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog (+75 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (74): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (76): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+68 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (76): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (62): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+54 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (72): after, before, blockers, result, statuses, after, row, status (+64 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (65): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+57 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (79): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+71 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (73): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext, showCommand() (+65 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (71): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+63 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (53): updateConversationTitle(), ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+45 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (60): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks() (+52 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (60): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig() (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (56): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (55): DetailPanelLayout(), loadPinState(), PHASE_CHIP_COLORS, PHASE_LABELS, PipelinePhase, savePinState(), TAB_ID_TO_SESSION_TYPE, TerminalTab (+47 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (43): CloisterStatusBar(), DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffPanel(), DiffPanelProps (+35 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (57): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+49 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (50): doc, path, criticalPath(), WaveItem, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefDocument (+42 more)
...
Cohesion: 0.03
Nodes (64): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (45): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+37 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (59): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+51 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (56): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory() (+48 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (45): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentGrid(), AgentGridProps, ConnectionLines() (+37 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (45): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+37 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (48): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+40 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (47): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+39 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (50): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+42 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (46): createConversation(), initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index (+38 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (13): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+5 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (48): parseContainerServiceName(), parseIssueIdFromText(), getIssueDataService(), fetchProjectTree(), getIssueDataService(), getIssueDataService(), getSharedIssueService(), isBenchmarkMode (+40 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (42): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+34 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (42): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+34 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (48): result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (39): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+31 more)
...
Cohesion: 0.05
Nodes (46): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCavemanExperimentData(), getCostForIssueFromDb() (+38 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (41): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError() (+33 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (40): withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+32 more)
...
Cohesion: 0.07
Nodes (39): InlineSparkline(), InlineSparklineProps, ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory(), activityToStatus(), capitalize() (+31 more)
...
Cohesion: 0.09
Nodes (31): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo(), destroyPiFifo(), execAsync (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (44): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+36 more)
...
Cohesion: 0.09
Nodes (43): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry (+35 more)

### Community 68 - "Community 68"
Cohesion: 0.13
Nodes (44): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+36 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (43): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+35 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (40): entry, { issueId }, { limit }, old, op, ops, recent, result (+32 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (40): wipeCommand(), calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync (+32 more)
...
Cohesion: 0.07
Nodes (36): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ActionKey (+28 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (17): issues, result, importTrackerConfig(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache (+9 more)
...
Cohesion: 0.06
Nodes (36): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, generateRouterConfigFromWorkTypes() (+28 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (42): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv() (+34 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (38): computePlanningState(), badPath, customPlanningDir, dir, doc, filename, item, item2 (+30 more)

### Community 86 - "Community 86"
Cohesion: 0.15
Nodes (41): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+33 more)
...
Cohesion: 0.05
Nodes (41): execAsync, execFileAsync, firePostMergeLifecycle(), getModelsResolveRoute, getProjectPathForIssue(), getProjectSpecialistContextRoute, getProjectSpecialistGraceRoute, getProjectSpecialistLatestLogRoute (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.05
Nodes (29): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TerminalSizeMessage, TerminalSnapshotMessage, checkbox, consoleErrorSpy (+21 more)
...
Cohesion: 0.09
Nodes (39): setAgentStoppedNotifier(), clearStuckForks(), listActiveConversations(), markConversationEnded(), setPipelineHandler(), startCliproxyWatchdog(), attachmentCleanupTimer, es (+31 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (39): Access, ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+31 more)
...
Cohesion: 0.08
Nodes (25): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), daemonRegistry (+17 more)

### Community 103 - "Community 103"
Cohesion: 0.06
Nodes (34): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+26 more)
...
Cohesion: 0.08
Nodes (36): CLAUDE_DIR, createClaudeAdapter(), createRuntimeRegistry(), getInstalledRuntimes(), getRuntimeAdapter(), getSupportedRuntimes(), isRuntimeInstalled(), AgentMessage (+28 more)
...
Cohesion: 0.07
Nodes (34): createSpecialistHandoff(), ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getTodaySpecialistHandoffs(), logSpecialistHandoff(), readIssueSpecialistHandoffs() (+26 more)

### Community 115 - "Community 115"
Cohesion: 0.05
Nodes (38): DomainEvent, AgentOutput, ChatMessage, CompactBoundary, ConversationEvent, ConversationResponse, DeepWipeRpc, GetAvailableEditorsRpc (+30 more)
...
Cohesion: 0.12
Nodes (32): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+24 more)

### Community 123 - "Community 123"
Cohesion: 0.11
Nodes (30): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+22 more)

### Community 124 - "Community 124"
Cohesion: 0.08
Nodes (34): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+26 more)

### Community 125 - "Community 125"
Cohesion: 0.08
Nodes (27): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping() (+19 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (24): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth(), HealthSummary (+16 more)

### Community 127 - "Community 127"
Cohesion: 0.08
Nodes (31): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+23 more)
...
Cohesion: 0.07
Nodes (32): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST() (+24 more)

### Community 131 - "Community 131"
Cohesion: 0.1
Nodes (36): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+28 more)
...
Cohesion: 0.07
Nodes (30): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+22 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (26): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry() (+18 more)

### Community 139 - "Community 139"
Cohesion: 0.1
Nodes (27): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+19 more)
...
Cohesion: 0.1
Nodes (26): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), _get_default_sink_state(), Handler, load_base_model(), load_design_model() (+18 more)

### Community 147 - "Community 147"
Cohesion: 0.12
Nodes (31): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), DASHBOARD_LOG_FILE (+23 more)

### Community 148 - "Community 148"
Cohesion: 0.11
Nodes (32): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+24 more)
...
Cohesion: 0.08
Nodes (33): buildConversationResponse(), getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., activitySummaryCache (+25 more)
...
Cohesion: 0.11
Nodes (29): healthCommand(), HealthOptions, pendingCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand() (+21 more)
...
Cohesion: 0.08
Nodes (28): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS, EffortLevel (+20 more)

### Community 158 - "Community 158"
Cohesion: 0.08
Nodes (22): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize() (+14 more)

### Community 159 - "Community 159"
Cohesion: 0.07
Nodes (31): SearchFilters, SearchResult, useSearch(), UseSearchOptions, fetchIssues(), SearchModal(), SearchModalProps, PRIORITY_COLORS (+23 more)

### Community 160 - "Community 160"
Cohesion: 0.1
Nodes (31): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+23 more)
...
Cohesion: 0.09
Nodes (31): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+23 more)

### Community 169 - "Community 169"
Cohesion: 0.09
Nodes (31): checkFailedMergeRetry(), cleanupAbandonedFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent() (+23 more)

### Community 170 - "Community 170"
Cohesion: 0.11
Nodes (30): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+22 more)

### Community 171 - "Community 171"
Cohesion: 0.07
Nodes (26): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, formatCost(), IssueHeader(), IssueHeaderProps (+18 more)

### Community 172 - "Community 172"
Cohesion: 0.06
Nodes (33): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+25 more)
...
Cohesion: 0.06
Nodes (18): callServerApi(), currentStatus, DEFAULTS, electron, electron_updater, fetchActiveWorkspaces(), iconPath, IPC (+10 more)

### Community 182 - "Community 182"
Cohesion: 0.07
Nodes (28): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+20 more)

### Community 183 - "Community 183"
Cohesion: 0.08
Nodes (30): CLAUDE_PROJECTS_DIR, ClaudeMessage, importSessionToCostLog(), normalizeModelName(), calculateCost(), CostEntry, DEFAULT_PRICING, getPricing() (+22 more)

### Community 184 - "Community 184"
Cohesion: 0.12
Nodes (27): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, CloseOutContext (+19 more)
...
Cohesion: 0.1
Nodes (28): activeViolations, checkAgentForViolations(), clearOldViolations(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig, FPPViolationType, getActiveViolations() (+20 more)
...
Cohesion: 0.13
Nodes (29): captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), diffAgainstMain(), diffAgainstMainFiles(), diffCheckpointFiles(), diffCheckpoints() (+21 more)

### Community 195 - "Community 195"
Cohesion: 0.08
Nodes (24): sentinel, markAgentStateServiceInProcess(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore(), openEventDb() (+16 more)

### Community 196 - "Community 196"
Cohesion: 0.08
Nodes (27): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+19 more)
...
Cohesion: 0.1
Nodes (28): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), resolveAlsoSyncTools(), runMultiToolSync(), stripFrontmatter() (+20 more)

### Community 204 - "Community 204"
Cohesion: 0.07
Nodes (19): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+11 more)

### Community 205 - "Community 205"
Cohesion: 0.11
Nodes (29): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+21 more)

### Community 206 - "Community 206"
Cohesion: 0.14
Nodes (28): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+20 more)

### Community 207 - "Community 207"
Cohesion: 0.07
Nodes (25): SensitiveText(), SensitiveTextProps, DEFAULTS, UIPreferences, useUIPreferences(), getEffectiveModelId(), AGENT_CATEGORIES, AgentCategory (+17 more)
...
Cohesion: 0.17
Nodes (21): Comment, Issue, IssueFilters, IssueNotFoundError, IssueState, IssueTracker, IssueUpdate, NewIssue (+13 more)

### Community 219 - "Community 219"
Cohesion: 0.14
Nodes (29): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+21 more)
...
Cohesion: 0.13
Nodes (24): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft() (+16 more)

### Community 246 - "Community 246"
Cohesion: 0.15
Nodes (23): BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, COMMANDS_DIR, CONFIG_FILE (+15 more)

### Community 247 - "Community 247"
Cohesion: 0.08
Nodes (23): body, bytes, claudeProjectDir, conv, created, delivery, encodedCwd, getTrustedOrigins() (+15 more)

### Community 248 - "Community 248"
Cohesion: 0.12
Nodes (9): CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb(), RateLimitInfo, _require (+1 more)
...
Cohesion: 0.13
Nodes (21): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+13 more)
...
Cohesion: 0.1
Nodes (23): getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter(), apiKeys (+15 more)
...
Cohesion: 0.14
Nodes (22): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile(), getEventsFilePath() (+14 more)
...
Cohesion: 0.13
Nodes (21): envFor(), handlePanDone(), handleSessionStart(), handleToolExecutionEnd(), handleTurnEnd(), HookEnv, PanopticonPaths, panopticonPathsFor() (+13 more)
...
Cohesion: 0.17
Nodes (18): workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, dangerBanner(), DangerousOp, DangerousOpBlockedError, dryRunGitClean(), execAsync, pathLeaf() (+10 more)
...
Cohesion: 0.09
Nodes (23): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+15 more)

### Community 276 - "Community 276"
Cohesion: 0.09
Nodes (15): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, MOCK_ISSUE (+7 more)
...
Cohesion: 0.1
Nodes (21): ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitDashboardLifecycle(), EmitDetailedOptions, EmitTtsOptions, normalizeForSpeech() (+13 more)
...
Cohesion: 0.13
Nodes (16): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), fname, parts, root, after (+8 more)

### Community 294 - "Community 294"
Cohesion: 0.14
Nodes (21): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+13 more)
...
Cohesion: 0.17
Nodes (19): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+11 more)
...
Cohesion: 0.1
Nodes (13): getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, watchConversation(), EditorLaunch, execAsync, getFileManagerCommand() (+5 more)
...
Cohesion: 0.09
Nodes (18): PiSpawnTimeout, agentDir, beats, breakdown, content, dir, err, FIXTURE_LINEAR (+10 more)

### Community 337 - "Community 337"
Cohesion: 0.12
Nodes (10): formatIssueRef(), LinkDirection, LinkManager, LinkStore, parseIssueRef(), link, links, newManager (+2 more)

### Community 338 - "Community 338"
Cohesion: 0.17
Nodes (8): getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions(), parseClaudeSession(), ClaudeCodeRuntime
...
Cohesion: 0.09
Nodes (22): Auto-Sync, code:block61 (~/.panopticon/skills/*     →  ~/.claude/skills/           # ), code:toml ([sync]), code:typescript (type SyncTargetState =), code:bash ($ pan sync), code:bash (pan sync                    # Default: detect, backup if nee), code:block66 (~/.panopticon/backups/), code:json ({) (+14 more)
...
Cohesion: 0.11
Nodes (9): getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig (+1 more)

### Community 351 - "Community 351"
Cohesion: 0.17
Nodes (18): CostLimitsConfig, checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted (+10 more)

### Community 352 - "Community 352"
Cohesion: 0.13
Nodes (19): BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard(), getBridgeLogPath() (+11 more)

### Community 353 - "Community 353"
Cohesion: 0.1
Nodes (20): AIProvider, branch, branchMatch, buffer, cavemanVariant, cost, entry, input (+12 more)

### Community 354 - "Community 354"
Cohesion: 0.1
Nodes (17): fail, failLayer, githubLayer, layer, mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubRemoveLabel, mockGitHubReopenIssue (+9 more)

### Community 355 - "Community 355"
Cohesion: 0.12
Nodes (17): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+9 more)
...
Cohesion: 0.12
Nodes (14): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+6 more)
...
Cohesion: 0.22
Nodes (3): escapeQueryValue(), RallyTracker, validateRallyId()

### Community 368 - "Community 368"
Cohesion: 0.14
Nodes (13): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView() (+5 more)
...
Cohesion: 0.19
Nodes (18): APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+10 more)

### Community 382 - "Community 382"
Cohesion: 0.18
Nodes (17): cleanupOldEvents(), CLOISTER_DB_PATH, deleteAgentHistory(), getAgentsWithHistory(), getAllHealthHistory(), getDatabaseStats(), getHealthDatabase(), getHealthHistory() (+9 more)

### Community 383 - "Community 383"
Cohesion: 0.16
Nodes (16): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), rotateSpecialistSession() (+8 more)

### Community 384 - "Community 384"
Cohesion: 0.19
Nodes (17): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+9 more)

### Community 385 - "Community 385"
Cohesion: 0.11
Nodes (17): CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health, healths (+9 more)
...
Cohesion: 0.21
Nodes (17): AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir(), inferIssueId() (+9 more)
...
Cohesion: 0.12
Nodes (13): button, { container }, defaultProps, makeMutation(), makeSyncMutation(), onDismissPending, onKillSuccess, onPlan (+5 more)
...
Cohesion: 0.12
Nodes (15): capturedCmds, mockCreateReviewArtifactsForIssue, mockEnsureMergeSetForIssue, mockExecFileFn, mockExecFn, mockGetAgentState, mockGetDashboardApiUrl, mockGetVBriefACStatus (+7 more)
...
Cohesion: 0.18
Nodes (13): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveWindowUrl() (+5 more)
...
Cohesion: 0.14
Nodes (10): ensureDefaultConversationModel(), FALLBACK_GROUPS, ModelGroup, PickerModel, PROVIDER_LABELS, SettingsConfig, BadgeProps, CostWarningBadge() (+2 more)
...
Cohesion: 0.2
Nodes (13): cleanupStaleLocks(), execAsync, findGitLockFiles(), getWorkspaceGitInfo(), hasRunningGitProcesses(), hasStaleLocks(), execAsync, indexLock (+5 more)

### Community 441 - "Community 441"
Cohesion: 0.2
Nodes (14): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+6 more)
...
Cohesion: 0.17
Nodes (14): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+6 more)

### Community 448 - "Community 448"
Cohesion: 0.17
Nodes (14): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength(), buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody() (+6 more)
...
Cohesion: 0.15
Nodes (8): fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, client, makeQueryClient(), messages, renderPanel()
...
Cohesion: 0.18
Nodes (13): processPermissionResponse(), getHeader(), getTrustedOrigins(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin(), appendResolutionEvents, deliverDecision (+5 more)
...
Cohesion: 0.13
Nodes (15): code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:bash (npx panopticon install), code:bash (npx panopticon install --minimal), Current MYN Architecture (Reference), Dynamic Config Generation, Installation Flow, Minimal Install (No Traefik) (+7 more)
...
Cohesion: 0.23
Nodes (11): getForgeAdapter(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), execAsync, getRepoWorkspacePath(), repoHasChanges() (+3 more)
...
Cohesion: 0.18
Nodes (11): err, exec(), execFile(), execMock, kCustom, prompt, realExecAsync, spawnMock (+3 more)

### Community 535 - "Community 535"
Cohesion: 0.15
Nodes (11): mockClearConfigCache, mockLoadConfig, mockMergeConfigs, mockReadFile, mockReloadGlobalRouter, mockResolveModelId, mockWriteFile, result (+3 more)
...
Cohesion: 0.23
Nodes (10): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+2 more)
...
Cohesion: 0.32
Nodes (8): getHealthEmoji(), getHealthLabel(), getCloisterService(), startCommand(), statusCommand(), StatusOptions, stopCommand(), StopOptions

### Community 561 - "Community 561"
Cohesion: 0.29
Nodes (9): getDefaultModel(), getGlobalRouter(), getSpecialistHarness(), getSpecialistModel(), ModelRoutingResult, resetGlobalRouter(), routeTask(), warnSpy (+1 more)

### Community 562 - "Community 562"
Cohesion: 0.24
Nodes (10): analyzeIssue(), sortByPriority(), issues, options, result, results, sorted, triageMultiple() (+2 more)

### Community 563 - "Community 563"
Cohesion: 0.17
Nodes (11): failedState, initialState, jsonBlock, nextState, parsed, PLAN_DOC, prompt, sameWaveDoc (+3 more)
...
Cohesion: 0.3
Nodes (11): abortSignal(), emitActivity(), emitAgentEvent(), emitChannelReply(), emitMessageReceived(), emitModelSet(), emitResolution(), emitWaitingClear() (+3 more)
...
Cohesion: 0.18
Nodes (7): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile
...
Cohesion: 0.18
Nodes (9): build, cliPromptsDir, copyPrompts, dashboardDir, distDir, preservedDashboardDir, preservedRoot, projectRoot (+1 more)
...
Cohesion: 0.18
Nodes (8): first, found, path, paths, read, second, sessions, updated
...
Cohesion: 0.2
Nodes (6): mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, mockSpawnRun, notify, promise

### Community 641 - "Community 641"
Cohesion: 0.29
Nodes (8): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), bead, beads, plan
...
Cohesion: 0.22
Nodes (9): applyBurnedTokenOverride(), checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus, CodexAuthUnknown (+1 more)

### Community 645 - "Community 645"
Cohesion: 0.22
Nodes (6): captureTldrMetrics(), getTldrMetrics(), checkpoint, checkpointFile, metrics, noTldrWorkspace

### Community 646 - "Community 646"
Cohesion: 0.31
Nodes (9): atomicWrite(), backupIfNeeded(), detectProviderEnvConflicts(), findNewestBackup(), injectProviderEnvOverlay(), OverlayResult, PROVIDER_ENV_KEYS, ProviderEnvConflict (+1 more)

### Community 647 - "Community 647"
Cohesion: 0.2
Nodes (9): createdIssue, mockAssignee, mockClient, mockComment, mockIssue, mockLabels, mockState, stateTests (+1 more)

### Community 648 - "Community 648"
Cohesion: 0.27
Nodes (8): formatCost(), formatTimestamp(), MergedSummaryCard(), MergedSummaryCardProps, button, costText, link, onViewLastLog

### Community 649 - "Community 649"
Cohesion: 0.2
Nodes (9): ComposerFooter(), conversation, { editorState, mockFocus, mockToastError, mockSaveStoredModel }, fetchMock, file, onSend, secondConversation, url (+1 more)

### Community 650 - "Community 650"
Cohesion: 0.2
Nodes (8): merge, mergeAgent, pollSpecialistStatus(), review, reviewAgent, SpecialistStatus, test, testAgent
...
Cohesion: 0.36
Nodes (8): getAllSpecialistStatus(), SpecialistStatus, displaySpecialist(), getRelativeTime(), getStatusColor(), getStatusIcon(), listCommand(), ListOptions
...
Cohesion: 0.36
Nodes (8): buildContextMenu(), buildTooltip(), createTray(), createTrayIcon(), getDesktopSettings(), refreshTrayStatus(), resolveResourcePath(), sendNotification()

### Community 755 - "Community 755"
Cohesion: 0.25
Nodes (8): deepClone(), enableAutoStart(), handleAutoStartNag(), loadDesktopSettings(), saveDesktopSettings(), settingsPath(), showFirstLaunchDialog(), updateDesktopSetting()

### Community 756 - "Community 756"
Cohesion: 0.36
Nodes (6): ClaudeAuthStatus, getClaudeAuthStatus(), parseOAuthPayload(), readKeychainCredentials(), raw, result
...
Cohesion: 0.29
Nodes (8): appendBridgeLog(), handlePermissionRequestNotification(), handleUnixPost(), normalizePermissionRequest(), parsePermissionRequestNotification(), pushChannelNotification(), pushPermissionDecisionNotification(), forwarder

### Community 761 - "Community 761"
Cohesion: 0.29
Nodes (5): log(), LOG_FILE, server, shutdown(), SUPERVISOR_PORT
...
Cohesion: 0.29
Nodes (6): activeBeadsIgnore, activePlanningBeadsIgnore, content, gitignorePath, lines, ROOT
...
Cohesion: 0.48
Nodes (6): execAsync, RebaseAllResult, rebaseAndPushRepos(), rebaseOneRepo(), RebaseResult, tryResolvePlanningConflicts()
...
Cohesion: 0.33
Nodes (5): detectTestCommand(), command, jestConfig, packageJson, testDir
...
Cohesion: 0.29
Nodes (6): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput

### Community 823 - "Community 823"
Cohesion: 0.33
Nodes (6): decode, decodeCandidate(), ev, bodyToEvent(), isChannelReplyKind(), normalizeChannelReplyPayload()
...
Cohesion: 0.29
Nodes (6): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09, Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.29
Nodes (6): Boundaries, Human-Merge Invariant, Inputs, Model Routing Contract, Panopticon Review Role, Review Process
...
Cohesion: 0.33
Nodes (5): deletedDir, drafts, info, path, result
...
Cohesion: 0.33
Nodes (5): globalSettings, hookPath, result, validHookPath, workspaceSettings
...
Cohesion: 0.33
Nodes (5): listener(), electron, IPC, result, wrapped()

### Community 913 - "Community 913"
Cohesion: 0.33
Nodes (3): agent, REVIEW_FLAVORS, source
...
Cohesion: 0.33
Nodes (5): closeResult, command, ctx, labelResult, prResult
...
Cohesion: 0.33
Nodes (6): `ccr` Utility Script, code:bash (# Direct execution (recommended)), code:bash (# Make executable (if needed)), `pan` Commands (Panopticon management), Part 9: Commands, `work` Commands (Agent/work management)
...
Cohesion: 0.4
Nodes (3): CLI_DIST, __dirname, ROOT
...
Cohesion: 0.4
Nodes (5): randomHex(), resolvePort(), resolveServerEntry(), spawnServer(), startServer()

### Community 974 - "Community 974"
Cohesion: 0.4
Nodes (5): createTerminalWindow(), createWindow(), dispatchMenuAction(), resolveWindowUrl(), showOrCreateWindow()
...
Cohesion: 0.5
Nodes (4): buildMenuTemplate(), configureApplicationMenu(), onUpdateStatusChange(), rebuildMenu()

### Community 1042 - "Community 1042"
Cohesion: 0.67
Nodes (3): execAsync, rebaseFeatureBranch(), RebaseResult
...
## Knowledge Gaps
- **11572 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11567 more)
...
- **Why does `fetch` connect `Community 3` to `Community 128`, `Community 130`, `Community 642`, `Community 2`, `Community 9`, `Community 650`, `Community 11`, `Community 13`, `Community 14`, `Community 269`, `Community 19`, `Community 147`, `Community 21`, `Community 22`, `Community 23`, `Community 538`, `Community 27`, `Community 156`, `Community 157`, `Community 30`, `Community 159`, `Community 34`, `Community 418`, `Community 168`, `Community 813`, `Community 46`, `Community 48`, `Community 49`, `Community 52`, `Community 181`, `Community 54`, `Community 566`, `Community 450`, `Community 195`, `Community 75`, `Community 76`, `Community 207`, `Community 84`, `Community 597`, `Community 217`, `Community 352`, `Community 754`, `Community 124`, `Community 381`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 447` to `Community 1`, `Community 12`, `Community 25`, `Community 561`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 34` to `Community 37`, `Community 293`, `Community 170`, `Community 206`, `Community 17`, `Community 563`, `Community 84`, `Community 85`, `Community 600`, `Community 25`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Are the 163 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 163 INFERRED edges - model-reasoned connections that need verification._
- **Are the 3 inferred relationships involving `spawnEphemeralSpecialist()` (e.g. with `loadContextDigest()` and `createRunLog()`) actually correct?**
  _`spawnEphemeralSpecialist()` has 3 INFERRED edges - model-reasoned connections that need verification._
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11572 weakly-connected nodes found - possible documentation gaps or missing edges._
