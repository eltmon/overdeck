...
## Corpus Check
- 1547 files · ~2,062,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21578 nodes · 32011 edges · 1128 communities (1092 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 419 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5f4dbc3`
...
## Communities (1128 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (149): checkFailedMergeRetry(), checkPendingTestDispatch(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, captureTmuxOutput() (+141 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (118): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), BootstrapGate(), BootstrapGateProps, CloisterStatus (+110 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (114): PlanningState, ZoneAActionsState, state, EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, SwitchModelModal(), SwitchModelModalProps (+106 more)
...
Cohesion: 0.02
Nodes (134): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+126 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (92): CostLimitsConfig, checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted (+84 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (111): checkStuckWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (120): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+112 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (110): renderPrompt(), resolveSpecialistBaseCommand(), finalizeRunLog(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+102 more)
...
Cohesion: 0.03
Nodes (96): Access, encodeClaudeProjectDir(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+88 more)
...
Cohesion: 0.03
Nodes (86): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+78 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (80): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+72 more)
...
Cohesion: 0.03
Nodes (88): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (71): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+63 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (80): extractNumber(), extractPrefix(), calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (70): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+62 more)
...
Cohesion: 0.03
Nodes (74): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+66 more)
...
Cohesion: 0.05
Nodes (70): workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch() (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (70): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+62 more)
...
Cohesion: 0.06
Nodes (70): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+62 more)
...
Cohesion: 0.06
Nodes (62): findSpecByIssue(), updateSpecStatus(), next, path, read, state, after, continueContent (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (59): generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (51): doc, path, ACCompletionResult, criticalPath(), WaveItem, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty (+43 more)
...
Cohesion: 0.05
Nodes (60): cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage() (+52 more)
...
Cohesion: 0.07
Nodes (58): spawnSingleReviewer(), destroyRemoteWorkspace(), getProviderExportsForModel(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript() (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (53): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+45 more)
...
Cohesion: 0.05
Nodes (49): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+41 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (46): beadsDir, doc, dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync } (+38 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (49): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs() (+41 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (49): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig() (+41 more)
...
Cohesion: 0.06
Nodes (48): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory() (+40 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (37): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, AssistantMessageRow(), formatElapsed() (+29 more)
...
Cohesion: 0.06
Nodes (44): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+36 more)
...
Cohesion: 0.06
Nodes (44): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand() (+36 more)
...
Cohesion: 0.07
Nodes (44): backupCleanCommand(), backupListCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BackupInfo (+36 more)
...
Cohesion: 0.06
Nodes (41): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+33 more)
...
Cohesion: 0.06
Nodes (44): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds() (+36 more)
...
Cohesion: 0.05
Nodes (35): getDefaultConversationModel(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+27 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (39): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+31 more)
...
Cohesion: 0.08
Nodes (45): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest (+37 more)
...
Cohesion: 0.07
Nodes (40): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+32 more)
...
Cohesion: 0.09
Nodes (36): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile(), getEventsFilePath() (+28 more)
...
Cohesion: 0.07
Nodes (35): shouldAutoStart(), setAgentStoppedNotifier(), announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+27 more)
...
Cohesion: 0.09
Nodes (32): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji(), getHealthLabel() (+24 more)

### Community 132 - "Community 132"
Cohesion: 0.07
Nodes (35): AIProvider, buildConversationResponse(), getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+27 more)
...
Cohesion: 0.08
Nodes (26): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+18 more)
...
Cohesion: 0.08
Nodes (26): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus (+18 more)

### Community 138 - "Community 138"
Cohesion: 0.07
Nodes (22): format(), LiveCounter(), LiveCounterProps, BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover(), formatCost() (+14 more)
...
Cohesion: 0.08
Nodes (30): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+22 more)
...
Cohesion: 0.12
Nodes (29): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+21 more)
...
Cohesion: 0.12
Nodes (30): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace() (+22 more)
...
Cohesion: 0.13
Nodes (29): listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments() (+21 more)
...
Cohesion: 0.1
Nodes (17): ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps (+9 more)
...
Cohesion: 0.11
Nodes (18): FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, ProviderType, execAsync, initCommand(), InitOptions (+10 more)
...
Cohesion: 0.09
Nodes (19): CostEvent, dir, event, eventsDir1, eventsDir2, line, lines, parsed (+11 more)
...
Cohesion: 0.18
Nodes (17): clearFeedbackFiles(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+9 more)
...
Cohesion: 0.11
Nodes (11): PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, EditorLaunch, execAsync, getFileManagerCommand(), isCommandAvailable(), PanOpen (+3 more)
...
Cohesion: 0.19
Nodes (12): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+4 more)
...
## Knowledge Gaps
- **11491 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11486 more)
...
- **Why does `fetch` connect `Community 3` to `Community 1`, `Community 2`, `Community 4`, `Community 135`, `Community 9`, `Community 137`, `Community 11`, `Community 525`, `Community 13`, `Community 401`, `Community 18`, `Community 275`, `Community 19`, `Community 21`, `Community 22`, `Community 151`, `Community 26`, `Community 29`, `Community 30`, `Community 160`, `Community 33`, `Community 419`, `Community 43`, `Community 47`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 182`, `Community 312`, `Community 56`, `Community 59`, `Community 60`, `Community 61`, `Community 67`, `Community 584`, `Community 585`, `Community 79`, `Community 81`, `Community 86`, `Community 743`, `Community 631`, `Community 251`, `Community 637`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 133` to `Community 9`, `Community 6`, `Community 183`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 29` to `Community 419`, `Community 195`, `Community 548`, `Community 134`, `Community 40`, `Community 41`, `Community 748`, `Community 366`, `Community 591`, `Community 20`, `Community 346`, `Community 27`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11491 weakly-connected nodes found - possible documentation gaps or missing edges._
