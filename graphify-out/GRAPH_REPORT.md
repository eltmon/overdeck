...
## Corpus Check
- 1933 files · ~3,155,709 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27650 nodes · 43476 edges · 1299 communities (1245 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 808 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17a84c1d`
...
## Communities (1299 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (190): logNonCanonicalStashesOnStartup(), recordAutoCloseOutFailure(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue() (+182 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (144): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+136 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (157): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf, catchTag$1 (+149 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (160): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (152): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (156): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+148 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (128): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+120 more)
...
Cohesion: 0.03
Nodes (143): BASE_TIME, loadAgents(), loadDeaconWithResumeMock(), saveStoppedAgent(), state, updated, workspaceFor(), buildInspectPrompt() (+135 more)
...
Cohesion: 0.02
Nodes (121): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+113 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (118): containerRestartBackoffMs(), DeaconState, isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent (+110 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (105): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+97 more)
...
Cohesion: 0.03
Nodes (89): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (104): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+96 more)
...
Cohesion: 0.03
Nodes (104): transitionIssueToVerifyingOnMain(), getCavemanExperimentData(), httpHandler(), HttpServerResponse, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+96 more)
...
Cohesion: 0.04
Nodes (103): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+95 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (99): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+91 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (95): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+87 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (99): assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue(), queryBeadsForIssuePromise() (+91 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (87): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext() (+79 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (82): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AgentWarningDialogProps, applyReviewStateToIssue() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (62): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), ensureLogDir(), ensureLogDirAsync() (+54 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (71): checkCommand(), syncCommand(), SyncOptions, ensureExcalidrawMcpSync(), ensurePlaywrightIsolationSync(), checkDevrootDeprecation(), cleanupLegacyRuntimeSymlinksSync(), migrateSyncTargetsSync() (+63 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (80): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+72 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (87): getTtsDaemonAuthHeaders(), TtsDaemonStatus, buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+79 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (79): registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+71 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (82): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+74 more)
...
Cohesion: 0.03
Nodes (73): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+65 more)
...
Cohesion: 0.04
Nodes (61): { projectPath, workspacePath }, promoted, specFiles, fsHooks, path, paths, after, doc (+53 more)
...
Cohesion: 0.03
Nodes (67): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, emitDashboardLifecycleSync(), data, mockExistsSync, mockReadFile, mockUnlink (+59 more)
...
Cohesion: 0.03
Nodes (69): pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutexPromise(), restoreTrackedBeadsExport(), runGit(), spawnerLayer, agentsCache (+61 more)
...
Cohesion: 0.04
Nodes (72): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+64 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (62): criteria, doc, result, beadsDir, doc, createCall, createCalls, dbError (+54 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (57): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+49 more)
...
Cohesion: 0.04
Nodes (61): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, getAgentWorkspace(), encodeClaudeProjectDir(), result, pathExists() (+53 more)
...
Cohesion: 0.06
Nodes (48): AutoMergeRow, AutoMergeStatus, cancelPendingAutoMerge(), DbAutoMergeRow, getAutoMergeStatus(), getPendingAutoMerges(), markAutoMergeAborted(), markAutoMergeExecuted() (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (53): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildInspectPromptPromise(), InspectContext, spawnInspectAgent() (+45 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (47): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+39 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (56): monitorReviewConvoySignals(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise() (+48 more)
...
Cohesion: 0.04
Nodes (46): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, EDITOR_LABELS, PanOpenInPickerProps (+38 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (56): canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+48 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (54): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, reopenWorkspaceStatePromise() (+46 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (57): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin() (+49 more)
...
Cohesion: 0.05
Nodes (25): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getAllSessionFilesSync(), getProjectDirsSync(), getRecentSessionsSync(), getSessionFilesSync(), importSessionToCostLog() (+17 more)
...
Cohesion: 0.05
Nodes (51): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+43 more)
...
Cohesion: 0.06
Nodes (43): conversationsTab, firstLens, lens, overview, tablist, ProjectRightPaneTabs(), ComposerMode, IssueComposer() (+35 more)
...
Cohesion: 0.05
Nodes (52): getCostsForIssueSync(), Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+44 more)
...
Cohesion: 0.06
Nodes (39): rebuildCacheSync(), appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir() (+31 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (48): number(), Platform, evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), captureTheme() (+40 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (45): buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+37 more)
...
Cohesion: 0.05
Nodes (42): parseContainerServiceName(), parseIssueIdFromText(), useAvailableModels(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu() (+34 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (30): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+22 more)
...
Cohesion: 0.05
Nodes (44): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+36 more)
...
Cohesion: 0.09
Nodes (47): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting(), setSetting() (+39 more)
...
Cohesion: 0.06
Nodes (43): parseContainerServiceNameSync(), parseIssueIdFromTextSync(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh() (+35 more)
...
Cohesion: 0.07
Nodes (40): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+32 more)

### Community 106 - "Community 106"
Cohesion: 0.05
Nodes (29): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore() (+21 more)
...
Cohesion: 0.08
Nodes (44): flywheelAbortCommand(), getFlywheelRunPayload(), getFlywheelRunsPayload(), openFlywheelRunReportForDashboard(), resolveReportOpenRunId(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus (+36 more)

### Community 117 - "Community 117"
Cohesion: 0.07
Nodes (34): archivePlanning(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+26 more)
...
Cohesion: 0.06
Nodes (39): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+31 more)
...
Cohesion: 0.06
Nodes (34): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), searchFts(), createConfiguredClaudeApi(), EnrichmentResponse, enrichSession() (+26 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (42): resolveArchiveDir(), resolveStatusFile(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput (+34 more)
...
Cohesion: 0.07
Nodes (36): deleteHumeConfig(), content, d, existingDir, lines, oldDir, result, skillDir (+28 more)

### Community 137 - "Community 137"
Cohesion: 0.07
Nodes (38): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+30 more)
...
Cohesion: 0.1
Nodes (37): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+29 more)
...
Cohesion: 0.07
Nodes (28): isErrnoException(), readRestartStatusPromise(), RestartStatus, RestartStatusError, restartStatusPath(), RestartTrigger, writeRestartStatus(), writeRestartStatusPromise() (+20 more)
...
Cohesion: 0.07
Nodes (32): renderLayerForHarness(), assembleWorkspaceContext(), claude, out, pf, WorkspaceContextInput, HARNESS_MARKERS, HarnessMarker (+24 more)
...
Cohesion: 0.08
Nodes (34): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+26 more)
...
Cohesion: 0.08
Nodes (32): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration() (+24 more)
...
Cohesion: 0.09
Nodes (31): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji() (+23 more)
...
Cohesion: 0.1
Nodes (25): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), IssueStats (+17 more)
...
Cohesion: 0.07
Nodes (23): NormalizedTtsDaemonConfig, hasTtsDaemonState(), isTtsDaemonManuallyStopped(), startTtsDaemon(), startTtsDaemonFromDashboard(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog (+15 more)
...
Cohesion: 0.09
Nodes (28): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+20 more)
...
Cohesion: 0.12
Nodes (29): AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, CLAUDE_MD_TEMPLATES (+21 more)
...
Cohesion: 0.14
Nodes (32): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+24 more)

### Community 235 - "Community 235"
Cohesion: 0.12
Nodes (29): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), resolveAndSpeak(), speakTts(), ActivityTtsPayload, drainQueue() (+21 more)
...
Cohesion: 0.1
Nodes (27): forkCommand(), ForkOptions, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset() (+19 more)
...
Cohesion: 0.09
Nodes (23): ARCHIVES_DIR, canonicalPrdSubdirSync(), findDraftPrdSync(), findPrdAnywhereSync(), findPrdAtStatusSync(), PrdFormat, PrdLocation, PrdStatus (+15 more)
...
Cohesion: 0.1
Nodes (25): CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript() (+17 more)
...
Cohesion: 0.13
Nodes (24): buildQueryExpansionCacheKey(), buildQueryExpansionPrompt(), CachedQueryExpansionResult, clearQueryExpansionCache(), expandMemoryQuery(), expansionCache, fallback(), getCachedExpansion() (+16 more)
...
Cohesion: 0.11
Nodes (14): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, after, before, cfg, compose, ph (+6 more)
...
Cohesion: 0.15
Nodes (19): clearFeedbackFilesPromise(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+11 more)

### Community 361 - "Community 361"
Cohesion: 0.16
Nodes (23): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), deleteBranchesImpl(), execAsync, isDockerContainerProcess() (+15 more)

### Community 362 - "Community 362"
Cohesion: 0.12
Nodes (19): recoverUnhealthyTestStack(), workspaceRebuildCommand(), StepResult, tempDirs, workspace, DevcontainerRenderResult, EnsureDevcontainerInput, EnsureDevcontainerResult (+11 more)
...
Cohesion: 0.13
Nodes (16): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerStaticDir(), resolveWindowUrl() (+8 more)
...
Cohesion: 0.13
Nodes (21): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+13 more)
...
Cohesion: 0.16
Nodes (18): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+10 more)
...
Cohesion: 0.14
Nodes (19): spawnReviewSubRoleForIssue(), REVIEW_SUB_ROLES, reviewerOutputPath(), ReviewerResult, ReviewerState, ReviewSubRole, waitForReviewerOutputs(), WaitForReviewerOutputsOpts (+11 more)
...
Cohesion: 0.12
Nodes (16): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), cleanupMergedLabelsImpl(), execAsync, LABELS_TO_REMOVE, calls, ctx (+8 more)
...
Cohesion: 0.13
Nodes (17): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+9 more)

### Community 472 - "Community 472"
Cohesion: 0.13
Nodes (18): fetchCost(), fetchSearch(), fetchSessions(), fetchStats(), fetchWorkspaceCost(), triggerScan(), CostThresholdDetails, embedSession() (+10 more)
...
Cohesion: 0.23
Nodes (13): pauseFlywheel(), clearFlywheelRunGate(), flywheelPauseCommand(), pauseFlywheelRun(), readFlywheelGateSnapshot(), DatabaseError, getFlywheelActiveRunId(), getSettingProgram() (+5 more)
...
Cohesion: 0.19
Nodes (10): criteria, doc, projectDoc, projectRoot, workspaceDoc, workspacePath, AutoSynthesizeResult, extractAcceptanceCriteriaFromIssue() (+2 more)
...
Cohesion: 0.21
Nodes (12): AgentHealth, checkAllTriggersPromise(), checkStuckEscalation(), checkTaskCompletion(), checkTaskCompletionPromise(), checkTestFailure(), detectTestFailure(), execAsync (+4 more)
...
Cohesion: 0.26
Nodes (11): writeFeedbackFile(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, deliverReviewVerdictFeedbackPromise(), DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+3 more)
...
Cohesion: 0.2
Nodes (10): cleanupGitignoreSync(), cleanupWorkspaceGitignoreSync(), content, gitignorePath, headerMatches, newContent, result, skills (+2 more)

### Community 707 - "Community 707"
Cohesion: 0.2
Nodes (5): EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfigSync(), changed, config, result
...
## Knowledge Gaps
- **13668 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13663 more)
...
- **Why does `string()` connect `Community 5` to `Community 0`, `Community 2`, `Community 3`, `Community 8`, `Community 9`, `Community 1034`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 526`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 38`, `Community 42`, `Community 43`, `Community 45`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 571`, `Community 60`, `Community 59`, `Community 61`, `Community 63`, `Community 574`, `Community 66`, `Community 67`, `Community 69`, `Community 72`, `Community 73`, `Community 75`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 91`, `Community 92`, `Community 97`, `Community 98`, `Community 100`, `Community 101`, `Community 110`, `Community 116`, `Community 632`, `Community 133`, `Community 136`, `Community 657`, `Community 152`, `Community 664`, `Community 157`, `Community 158`, `Community 159`, `Community 161`, `Community 173`, `Community 195`, `Community 708`, `Community 205`, `Community 209`, `Community 234`, `Community 236`, `Community 752`, `Community 755`, `Community 247`, `Community 257`, `Community 271`, `Community 792`, `Community 281`, `Community 798`, `Community 293`, `Community 306`, `Community 325`, `Community 329`, `Community 333`, `Community 358`, `Community 360`, `Community 361`, `Community 364`, `Community 878`, `Community 388`, `Community 393`, `Community 394`, `Community 397`, `Community 422`, `Community 469`, `Community 472`, `Community 482`, `Community 490`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 256`, `Community 1`, `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 395`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 24`, `Community 27`, `Community 32`, `Community 36`, `Community 804`, `Community 38`, `Community 295`, `Community 42`, `Community 172`, `Community 44`, `Community 49`, `Community 50`, `Community 307`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 195`, `Community 69`, `Community 72`, `Community 203`, `Community 205`, `Community 206`, `Community 1104`, `Community 80`, `Community 247`, `Community 92`, `Community 223`, `Community 224`, `Community 99`, `Community 621`, `Community 750`, `Community 752`, `Community 628`, `Community 119`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 36` to `Community 576`, `Community 33`, `Community 0`, `Community 9`, `Community 202`, `Community 43`, `Community 394`, `Community 13`, `Community 80`, `Community 19`, `Community 117`, `Community 22`, `Community 23`, `Community 60`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13668 weakly-connected nodes found - possible documentation gaps or missing edges._
