...
## Corpus Check
- 1748 files · ~2,319,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23831 nodes · 36413 edges · 1189 communities (1144 shown, 45 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8beb4e2`
...
## Communities (1189 total, 45 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (152): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+144 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (153): detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle(), spawnInspectAgent() (+145 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (136): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (140): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+132 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (125): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+117 more)
...
Cohesion: 0.02
Nodes (116): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+108 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (80): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext (+72 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (109): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+101 more)
...
Cohesion: 0.03
Nodes (109): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+101 more)
...
Cohesion: 0.03
Nodes (98): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+90 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (85): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (92): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows() (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (84): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (86): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), PROVIDER_INFO, ProviderPanelProps, DesktopSettings, DesktopSettingsSection() (+78 more)
...
Cohesion: 0.02
Nodes (86): resumeCommand(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), AgentRuntimeState, getActivity() (+78 more)
...
Cohesion: 0.04
Nodes (87): monitorReviewConvoySignals(), pendingCommand(), after, before, blockers, result, statuses, after (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (59): clientMock, octokitMock, result, states, mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix (+51 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (81): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+73 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (85): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+77 more)
...
Cohesion: 0.04
Nodes (64): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+56 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (83): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+75 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (63): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, { projectPath, workspacePath }, promoted, specFiles, fsHooks, first (+55 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (72): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTimestamp() (+64 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (75): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (67): ViewMode, Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+59 more)
...
Cohesion: 0.04
Nodes (69): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+61 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (73): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+65 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (71): buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps, ResolveAndSpeakOptions (+63 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (68): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+60 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (64): isMergeAgentRunning(), healthCommand(), HealthOptions, buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+56 more)
...
Cohesion: 0.03
Nodes (61): firstSessionPanel, firstWorkbench, overview, workbench, IssueComposer(), IssueWorkbench(), IssueWorkbenchProps, ZoneA() (+53 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (62): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+54 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (70): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+62 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (58): buildACLookupByTitle(), criteria, doc, result, beadsDir, doc, createCall, createCalls (+50 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (53): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+45 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (60): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+52 more)
...
Cohesion: 0.05
Nodes (60): clearStaleCiFeedback(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand() (+52 more)
...
Cohesion: 0.04
Nodes (59): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels(), getAvailableModels() (+51 more)
...
Cohesion: 0.06
Nodes (52): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getShadowModeFromEnv(), getShadowModeStatus() (+44 more)
...
Cohesion: 0.06
Nodes (55): isEligibleForCleanup(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+47 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (49): runWithPool(), WorkPoolStats, markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+41 more)
...
Cohesion: 0.06
Nodes (56): readWorkspacePlanAsync(), readWorkspaceContinueAsync(), writeWorkspaceContinue(), findSpecByIssue(), findSpecByIssueAsync(), completePlanningArtifacts(), readWorkspacePlanAsync(), badPath (+48 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (50): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+42 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (56): embedAction(), ScanOptions, searchSessions(), showAction(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), arrayIndexCondition(), ArrayIndexTarget (+48 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (55): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, IssueAggregate, BUDGETS_FILE, calculateCost() (+47 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (56): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+48 more)
...
Cohesion: 0.06
Nodes (50): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+42 more)
...
Cohesion: 0.05
Nodes (50): parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow (+42 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (51): listSessionNamesAsync(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace() (+43 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (47): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector, DockerStatsRaw (+39 more)
...
Cohesion: 0.04
Nodes (45): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, getRemoteAgentOutputRoute (+37 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (50): cleanupOldEvents(), CLOISTER_DB_PATH, deleteAgentHistory(), getAgentsWithHistory(), getAllHealthHistory(), getDatabaseStats(), getHealthDatabase(), getHealthHistory() (+42 more)
...
Cohesion: 0.07
Nodes (46): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+38 more)
...
Cohesion: 0.07
Nodes (42): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult (+34 more)
...
Cohesion: 0.06
Nodes (42): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), HandoffConfig, HandoffTriggersConfig (+34 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (42): destroyRemoteWorkspace(), buildClaudeUserSettings(), bypassPrefixForAgentFlag(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode() (+34 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (44): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+36 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (43): deriveProjectRoot(), doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, QueuedCommit (+35 more)
...
Cohesion: 0.09
Nodes (35): cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+27 more)
...
Cohesion: 0.07
Nodes (33): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), AgentEnrichment, EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+25 more)

### Community 134 - "Community 134"
Cohesion: 0.07
Nodes (32): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), cleanupExpiredReauthSessions() (+24 more)
...
Cohesion: 0.1
Nodes (31): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, extractTtsEmbedding(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+23 more)

### Community 149 - "Community 149"
Cohesion: 0.1
Nodes (34): closeIssue(), execAsync, LABELS_TO_REMOVE, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey() (+26 more)
...
Cohesion: 0.09
Nodes (33): ContainerStats, detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample (+25 more)
...
Cohesion: 0.09
Nodes (35): buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatVoiceDetails(), formatVoiceSource(), formatVoicesTable(), listTtsVoices(), mapTtsVoice() (+27 more)

### Community 160 - "Community 160"
Cohesion: 0.1
Nodes (35): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+27 more)
...
Cohesion: 0.1
Nodes (33): Access, buildChildEnv(), readBridgedCodexCredential(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync (+25 more)
...
Cohesion: 0.11
Nodes (31): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+23 more)
...
Cohesion: 0.14
Nodes (29): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+21 more)
...
Cohesion: 0.07
Nodes (20): RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession(), getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName() (+12 more)
...
Cohesion: 0.09
Nodes (27): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), execAsync, parseValidationOutput(), QualityGateResult (+19 more)
...
Cohesion: 0.1
Nodes (13): getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+5 more)
...
Cohesion: 0.11
Nodes (24): DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding() (+16 more)

### Community 254 - "Community 254"
Cohesion: 0.1
Nodes (23): ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle(), EmitDetailedOptions (+15 more)
...
Cohesion: 0.14
Nodes (21): ComposerMode, IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus() (+13 more)
...
Cohesion: 0.25
Nodes (25): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches() (+17 more)
...
Cohesion: 0.14
Nodes (16): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsRow(), SettingsRowProps, SettingsSection(), SettingsSectionProps, ProviderCardProps (+8 more)
...
Cohesion: 0.13
Nodes (17): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry(), resolveWindowUrl() (+9 more)
...
Cohesion: 0.16
Nodes (19): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+11 more)
...
Cohesion: 0.14
Nodes (17): getCavemanHooksDir(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), readCavemanVariant(), buildSpecialistCavemanExports(), buildCavemanExports(), NormalizedCavemanConfig (+9 more)
...
Cohesion: 0.14
Nodes (15): findVendoredDir(), getCavemanSkillsDir(), setupCavemanHooks(), compressSrc, destDir, dir, hookFiles, hooksDir (+7 more)
...
Cohesion: 0.17
Nodes (14): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), DEFAULT_CLOISTER_CONFIG, HealthThresholds (+6 more)
...
Cohesion: 0.2
Nodes (13): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), tempDirs (+5 more)
...
Cohesion: 0.24
Nodes (9): postMergeLifecycle(), markAgentStoppedState(), calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync (+1 more)
...
Cohesion: 0.2
Nodes (10): CostThresholdDetails, embedSession(), EnrichRequest, enrichSession(), fetchSession(), formatDate(), fromRpcSession(), Props (+2 more)
...
Cohesion: 0.22
Nodes (8): resetPostMergeState(), mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed
...
Cohesion: 0.33
Nodes (7): ensureExcalidrawMcp(), ensurePlaywrightIsolation(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfig(), changed, config, result
...
Cohesion: 0.25
Nodes (5): AgentStateService, AgentStateServiceLive, AgentStateServiceShape, RUNTIME_EVENT_TYPES, UpsertStmt
...
Cohesion: 0.4
Nodes (5): input, makeClient(), mockConversation, onViewModeChange, renderPanel()
...
## Knowledge Gaps
- **12425 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12420 more)
...
- **Why does `fetch` connect `Community 2` to `Community 128`, `Community 0`, `Community 256`, `Community 259`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 784`, `Community 17`, `Community 16`, `Community 20`, `Community 22`, `Community 406`, `Community 24`, `Community 25`, `Community 150`, `Community 27`, `Community 668`, `Community 30`, `Community 288`, `Community 33`, `Community 423`, `Community 552`, `Community 553`, `Community 42`, `Community 43`, `Community 173`, `Community 176`, `Community 49`, `Community 51`, `Community 54`, `Community 576`, `Community 65`, `Community 64`, `Community 197`, `Community 581`, `Community 69`, `Community 72`, `Community 201`, `Community 75`, `Community 93`, `Community 617`, `Community 618`, `Community 362`, `Community 489`, `Community 241`, `Community 116`, `Community 253`, `Community 127`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 576` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 8`, `Community 14`, `Community 149`, `Community 23`, `Community 33`, `Community 289`, `Community 40`, `Community 168`, `Community 46`, `Community 186`, `Community 706`, `Community 73`, `Community 74`, `Community 75`, `Community 210`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 716` to `Community 18`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12425 weakly-connected nodes found - possible documentation gaps or missing edges._
