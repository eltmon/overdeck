...
## Corpus Check
- 1548 files · ~2,070,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21652 nodes · 32241 edges · 1121 communities (1084 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 431 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9acd91e5`
...
## Communities (1121 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (131): nudgeIdleWorkAgentsWithOpenBeads(), resolveSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), getRuntimeSnapshotSync() (+123 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (131): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), calls (+123 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (100): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, PanOpenInPicker() (+92 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (122): buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), performSpecialistWake() (+114 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (112): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+104 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (125): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+117 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (123): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+115 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (108): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (103): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (89): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), firstSessionPanel, firstWorkbench, overview (+81 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (93): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (95): adminRouteLayer, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+87 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (80): parsePiSession(), getPiLauncherFields(), ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime() (+72 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (83): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (82): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (72): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+64 more)
...
Cohesion: 0.03
Nodes (79): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execFile(), kCustom, mockExecFile (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (77): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+69 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (77): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AddOptions, BUNDLED_HOOKS_DIR (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (64): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+56 more)
...
Cohesion: 0.03
Nodes (69): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (73): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), showCommand() (+65 more)
...
Cohesion: 0.05
Nodes (72): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+64 more)
...
Cohesion: 0.05
Nodes (54): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, doc, path, result, criticalPath(), WaveItem (+46 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (64): setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (56): ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI, HEALTH_STATE_LABEL, inferIssueId() (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (67): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (51): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+43 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (61): Access, AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+53 more)
...
Cohesion: 0.05
Nodes (52): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+44 more)
...
Cohesion: 0.05
Nodes (58): cleanupOrphanedReviewSessions(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash() (+50 more)
...
Cohesion: 0.04
Nodes (52): canReplaceTitle(), listConversations(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+44 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (53): runCostSync(), CostEvent, parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow (+45 more)
...
Cohesion: 0.06
Nodes (48): getHealthThresholdsMs(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, evaluateHealthState(), formatDuration() (+40 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (40): DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout() (+32 more)
...
Cohesion: 0.05
Nodes (43): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, OverviewTab (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (44): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+36 more)
...
Cohesion: 0.04
Nodes (45): computeAgentEnrichment(), isAgentStateServiceInProcess(), getAgentRuntimeStateAsync(), snapshotToRuntimeState(), agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION (+37 more)
...
Cohesion: 0.06
Nodes (45): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+37 more)
...
Cohesion: 0.06
Nodes (40): clearStaleCiFeedback(), dispatchTestAgentAndNotify(), getTrackerContext(), detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable(), openCommand(), fetchIssueWithComments() (+32 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (40): dispatchSwarmWave(), criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult (+32 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (45): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+37 more)
...
Cohesion: 0.05
Nodes (32): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+24 more)
...
Cohesion: 0.09
Nodes (45): destroyRemoteWorkspace(), getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, buildChannelsArgs(), buildCommand() (+37 more)
...
Cohesion: 0.06
Nodes (38): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (40): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, buildACLookupByTitle() (+32 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (20): issues, result, importTrackerConfig(), computePlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+12 more)
...
Cohesion: 0.06
Nodes (38): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+30 more)
...
Cohesion: 0.07
Nodes (43): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+35 more)
...
Cohesion: 0.07
Nodes (41): systemHealthCommand(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), isSmeeRunning() (+33 more)
...
Cohesion: 0.1
Nodes (37): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+29 more)
...
Cohesion: 0.09
Nodes (36): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath(), readEvents() (+28 more)
...
Cohesion: 0.08
Nodes (38): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+30 more)
...
Cohesion: 0.08
Nodes (34): AIProvider, buildConversationResponse(), getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+26 more)
...
Cohesion: 0.08
Nodes (29): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+21 more)
...
Cohesion: 0.08
Nodes (28): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, getAllWorkTypes(), getWorkTypeMetadata() (+20 more)

### Community 159 - "Community 159"
Cohesion: 0.08
Nodes (32): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings() (+24 more)

### Community 160 - "Community 160"
Cohesion: 0.08
Nodes (27): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+19 more)
...
Cohesion: 0.09
Nodes (18): captureTldrMetrics(), daemonRegistry, ensureTldrStateDir(), execAsync, getStateFilePath(), getTldrMetrics(), hashWorkspacePath(), readStateFile() (+10 more)
...
Cohesion: 0.09
Nodes (26): cleanupOrphanReviewerSessions(), getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, buildReviewerNodes() (+18 more)

### Community 203 - "Community 203"
Cohesion: 0.12
Nodes (28): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+20 more)
...
Cohesion: 0.09
Nodes (21): ModelOverrideModal(), AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+13 more)
...
Cohesion: 0.1
Nodes (17): ConversationTerminalProps, resumeConversation(), StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TerminalSizeMessage, TerminalSnapshotMessage (+9 more)
...
Cohesion: 0.14
Nodes (18): after, before, blockers, result, statuses, computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult (+10 more)
...
Cohesion: 0.21
Nodes (18): healthCommand(), HealthOptions, listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile() (+10 more)

### Community 352 - "Community 352"
Cohesion: 0.1
Nodes (20): TldrSessionMetrics, branch, branchMatch, buffer, cavemanVariant, cost, entry, input (+12 more)
...
Cohesion: 0.12
Nodes (13): loadCloisterConfig(), cleanupStaleAgentState(), detectTestCommand(), command, jestConfig, packageJson, testDir, { activeSessions } (+5 more)
...
Cohesion: 0.19
Nodes (14): listTestsCommand(), registerTestCommands(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+6 more)
...
Cohesion: 0.23
Nodes (12): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+4 more)
...
Cohesion: 0.26
Nodes (12): handleConversationMessage(), activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings(), isCompacting() (+4 more)
...
Cohesion: 0.6
Nodes (4): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand()
...
## Knowledge Gaps
- **11518 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11513 more)
...
- **Why does `fetch` connect `Community 4` to `Community 640`, `Community 132`, `Community 5`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 530`, `Community 20`, `Community 21`, `Community 277`, `Community 278`, `Community 149`, `Community 24`, `Community 26`, `Community 22`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 162`, `Community 163`, `Community 551`, `Community 45`, `Community 47`, `Community 53`, `Community 54`, `Community 183`, `Community 59`, `Community 63`, `Community 67`, `Community 594`, `Community 90`, `Community 19`, `Community 741`, `Community 113`, `Community 633`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 131` to `Community 0`, `Community 13`, `Community 23`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `resolveProjectFromIssue()` connect `Community 55` to `Community 0`, `Community 5`, `Community 6`, `Community 8`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 31`, `Community 160`, `Community 33`, `Community 37`, `Community 38`, `Community 49`, `Community 52`, `Community 56`, `Community 58`, `Community 446`, `Community 66`, `Community 67`, `Community 203`, `Community 77`, `Community 78`, `Community 97`, `Community 492`, `Community 113`, `Community 246`, `Community 122`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11518 weakly-connected nodes found - possible documentation gaps or missing edges._
