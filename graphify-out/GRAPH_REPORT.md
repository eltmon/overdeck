...
## Corpus Check
- 1553 files · ~2,063,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21639 nodes · 32010 edges · 1136 communities (1100 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d242475`
...
## Communities (1136 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (134): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+126 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (129): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+121 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (132): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (134): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+126 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (107): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec (+99 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (108): formatFeedbackForAgent(), sendFeedbackToAgent(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+100 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (114): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (108): checkOrphanedReviewStatuses(), checkStuckReviewing(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (97): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+89 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (84): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+76 more)
...
Cohesion: 0.03
Nodes (75): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+67 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (81): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (79): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+71 more)
...
Cohesion: 0.04
Nodes (66): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+58 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (70): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+62 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (75): killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache() (+67 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (72): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+64 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (58): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+50 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (66): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (67): showCommand(), findSpecByIssue(), updateSpecStatus(), next, path, read, state, after (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (60): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+52 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (66): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+58 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (62): issues, result, importTrackerConfig(), result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync (+54 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (65): postMergeLifecycle(), markAgentStoppedState(), extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker() (+57 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (62): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (63): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (62): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+54 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (49): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, result, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty, VBriefEdge (+41 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (47): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, AssistantMessageRow(), formatElapsed() (+39 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (58): captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename, getConflictFiles() (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (51): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), beadsDir, doc, badPath (+43 more)
...
Cohesion: 0.04
Nodes (52): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+44 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (55): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), FileStatus (+47 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (55): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+47 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (44): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL, applyDagreLayout() (+36 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (49): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap() (+41 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (50): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+42 more)
...
Cohesion: 0.07
Nodes (41): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo() (+33 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (48): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions (+40 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (44): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+36 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (54): Access, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (49): setAgentStoppedNotifier(), announceMerge(), clearStuckForks(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (52): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow, DailyTrend (+44 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (48): getHealthThresholdsMs(), CostAlert, DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, evaluateHealthState() (+40 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (49): checkPendingTestDispatch(), clearStaleCiFeedback(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions (+41 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (49): resetDb(), db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+41 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (47): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+39 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (45): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+37 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (43): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), refreshCommand() (+35 more)
...
Cohesion: 0.12
Nodes (47): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+39 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (34): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind (+26 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (41): doneCommand(), DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+33 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (39): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+31 more)
...
Cohesion: 0.05
Nodes (36): updateConversationTitle(), DialogProvider(), critical, { mockConfirmAndKill, mockRefreshDashboardState }, { mockToastError, mockUseSystemHealth, hookState }, { rerender, queryClient }, toastCall, button (+28 more)
...
Cohesion: 0.06
Nodes (29): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+21 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (39): reconcileAndCheckIfMerged(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+31 more)
...
Cohesion: 0.05
Nodes (35): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+27 more)
...
Cohesion: 0.08
Nodes (42): spawnReviewCoordinatorSession(), spawnSingleReviewer(), getProviderExportsForModel(), resolveModel(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand() (+34 more)
...
Cohesion: 0.07
Nodes (26): countContextTokens(), findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions() (+18 more)
...
Cohesion: 0.08
Nodes (39): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+31 more)
...
Cohesion: 0.06
Nodes (34): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+26 more)
...
Cohesion: 0.07
Nodes (33): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+25 more)
...
Cohesion: 0.1
Nodes (37): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+29 more)

### Community 115 - "Community 115"
Cohesion: 0.09
Nodes (33): checkApiErrorAgents(), cleanupStaleAgentState(), isMergeAgentRunning(), healthCommand(), HealthOptions, { activeSessions }, agentDir, fortyMinutesAgo (+25 more)

### Community 116 - "Community 116"
Cohesion: 0.08
Nodes (27): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+19 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (25): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv() (+17 more)
...
Cohesion: 0.1
Nodes (34): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+26 more)
...
Cohesion: 0.11
Nodes (33): destroyRemoteWorkspace(), getManagedTmuxSocketName(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider() (+25 more)
...
Cohesion: 0.09
Nodes (35): dropLingeringPreMergeStashes(), applyStash(), CanonicalStashKind, createRecoveryBranchFromStash(), dropStash(), execAsync, getNextReviewTempSequence(), isoForStash() (+27 more)
...
Cohesion: 0.07
Nodes (27): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), doc, path, after (+19 more)
...
Cohesion: 0.08
Nodes (32): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+24 more)
...
Cohesion: 0.11
Nodes (29): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument(), projectPanPaths() (+21 more)
...
Cohesion: 0.1
Nodes (22): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+14 more)

### Community 183 - "Community 183"
Cohesion: 0.09
Nodes (30): DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES, CanonicalState (+22 more)
...
Cohesion: 0.11
Nodes (31): autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, dispatchSwarmWave(), ensureSwarmAutoAdvanceLoop(), execAsync (+23 more)
...
Cohesion: 0.11
Nodes (25): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError(), invalidateProbeCache() (+17 more)
...
Cohesion: 0.14
Nodes (26): AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR (+18 more)
...
Cohesion: 0.12
Nodes (25): cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, writeStoryFeatureContext() (+17 more)
...
Cohesion: 0.1
Nodes (27): getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., activitySummaryCache, claudeProjectDir() (+19 more)
...
Cohesion: 0.15
Nodes (26): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), getAttachmentCache() (+18 more)
...
Cohesion: 0.1
Nodes (22): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+14 more)

### Community 250 - "Community 250"
Cohesion: 0.08
Nodes (25): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+17 more)

### Community 251 - "Community 251"
Cohesion: 0.11
Nodes (23): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+15 more)
...
Cohesion: 0.12
Nodes (20): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose (+12 more)
...
Cohesion: 0.15
Nodes (20): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), getTrackerContext() (+12 more)
...
Cohesion: 0.19
Nodes (16): killAllReviewSessions(), cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir (+8 more)
...
Cohesion: 0.2
Nodes (16): checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlertLevel, CostData, CostDataPersisted, getAgentCost(), getCostSummary() (+8 more)
...
Cohesion: 0.12
Nodes (16): cancelIssueWorkflow(), deepWipe(), destructiveResetWorkflow(), archiveIdx, beadsDir, branchStep, clearStep, content (+8 more)

### Community 419 - "Community 419"
Cohesion: 0.18
Nodes (15): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput() (+7 more)
...
Cohesion: 0.24
Nodes (13): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+5 more)
...
Cohesion: 0.23
Nodes (12): HandoffContext, createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+4 more)
...
Cohesion: 0.17
Nodes (8): dbError, deleteCalls, existingBeads, expectedPrefix, initCall, { mockExecAsync }, redirectContent, workspacePath
...
Cohesion: 0.22
Nodes (9): err, exec(), execFile(), execMock, kCustom, realExecAsync, spawnMock, tmuxCapturePaneAsyncMock (+1 more)
...
Cohesion: 0.22
Nodes (8): resetPostMergeState(), kCustom, mockExec, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed
...
## Knowledge Gaps
- **11533 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11528 more)
...
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 1`, `Community 640`, `Community 641`, `Community 4`, `Community 645`, `Community 6`, `Community 136`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 270`, `Community 276`, `Community 21`, `Community 532`, `Community 23`, `Community 20`, `Community 151`, `Community 27`, `Community 30`, `Community 31`, `Community 160`, `Community 161`, `Community 417`, `Community 35`, `Community 552`, `Community 554`, `Community 44`, `Community 47`, `Community 181`, `Community 183`, `Community 57`, `Community 60`, `Community 68`, `Community 71`, `Community 202`, `Community 84`, `Community 93`, `Community 106`, `Community 749`, `Community 241`, `Community 249`, `Community 639`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 124` to `Community 313`, `Community 5`, `Community 9`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 44` to `Community 1016`, `Community 49`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 159 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 159 INFERRED edges - model-reasoned connections that need verification._
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11533 weakly-connected nodes found - possible documentation gaps or missing edges._
