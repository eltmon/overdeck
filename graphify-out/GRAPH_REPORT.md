...
## Corpus Check
- 1878 files · ~2,476,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26660 nodes · 41397 edges · 1249 communities (1197 shown, 52 thin omitted)
...
## Communities (1249 total, 52 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (178): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (154): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+146 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (174): monitorReviewConvoySignals(), spawnInspectAgent(), renderPrompt(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), unpauseCommand() (+166 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (133): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+125 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (144): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+136 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (129): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+121 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (102): parsePiSession(), ProcessSpawnError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState (+94 more)
...
Cohesion: 0.02
Nodes (103): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (97): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS (+89 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (77): loadCloisterConfig(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+69 more)
...
Cohesion: 0.02
Nodes (91): ensureDefaultConversationModel(), getDefaultConversationModel(), conversationsTab, firstLens, lens, overview, tablist, Conversation (+83 more)
...
Cohesion: 0.02
Nodes (101): emitActivityDetailed(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cliproxyRouteLayer, cloisterRouteLayer (+93 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (100): AgentRuntimeState, agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), createAgentStopHandler(), deleteAgentRoute (+92 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (88): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+80 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (87): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (87): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), listTestsCommand(), registerTestCommands() (+79 more)
...
Cohesion: 0.04
Nodes (90): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+82 more)
...
Cohesion: 0.03
Nodes (81): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+73 more)
...
Cohesion: 0.03
Nodes (85): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+77 more)
...
Cohesion: 0.03
Nodes (74): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+66 more)
...
Cohesion: 0.04
Nodes (66): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+58 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (77): agentDir, dir1, dir2, marker, missing, nested, listSessionNamesAsyncEffect(), cb (+69 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (74): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+66 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (69): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+61 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (63): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+55 more)
...
Cohesion: 0.03
Nodes (58): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (60): CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationView(), ConversationViewProps (+52 more)
...
Cohesion: 0.04
Nodes (51): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+43 more)
...
Cohesion: 0.05
Nodes (53): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl() (+45 more)
...
Cohesion: 0.04
Nodes (53): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt() (+45 more)
...
Cohesion: 0.04
Nodes (51): buildConvoyPrompt(), buildReviewRolePrompt(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions(), readConvoySubRoleTemplate() (+43 more)
...
Cohesion: 0.06
Nodes (57): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+49 more)
...
Cohesion: 0.09
Nodes (50): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+42 more)
...
Cohesion: 0.06
Nodes (38): criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+30 more)
...
Cohesion: 0.04
Nodes (34): AgentState, __testInternals, buildMemoryIdentity(), ClaudeCodeTranscriptSource, ClaudeCodeTranscriptSourceOptions, createDefaultTranscriptSourceRegistry(), defaultTranscriptSourceRegistry, getActiveTranscriptEntries() (+26 more)
...
Cohesion: 0.06
Nodes (39): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl() (+31 more)
...
Cohesion: 0.08
Nodes (46): flywheelAbortCommand(), loadActiveFlywheelStatus(), getFlywheelActiveRunId(), getFlywheelCurrentPayload(), getFlywheelRunPayload(), getFlywheelRunsPayload(), readCurrentFlywheelStatusForDashboard(), abortFlywheelRun() (+38 more)
...
Cohesion: 0.07
Nodes (36): dropLingeringPreMergeStashes(), cleanupReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), dropStash(), execAsync (+28 more)

### Community 115 - "Community 115"
Cohesion: 0.05
Nodes (33): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+25 more)
...
Cohesion: 0.07
Nodes (39): getMemoryStatus(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated (+31 more)
...
Cohesion: 0.06
Nodes (35): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute (+27 more)
...
Cohesion: 0.08
Nodes (28): execAsync, rebaseFeatureBranch(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+20 more)
...
Cohesion: 0.07
Nodes (31): ConversationPanel(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), ConversationMutations, useNow(), formatRelativeTime() (+23 more)
...
Cohesion: 0.11
Nodes (30): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), checkTtsHealth(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue() (+22 more)
...
Cohesion: 0.07
Nodes (25): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical() (+17 more)
...
Cohesion: 0.12
Nodes (32): isFlywheelDevcontainerRuntime(), saveResumeSessionId(), spawnFlywheelAgent(), runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting() (+24 more)
...
Cohesion: 0.15
Nodes (31): applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync, cleanupLabelsGitHub() (+23 more)

### Community 242 - "Community 242"
Cohesion: 0.09
Nodes (24): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, buildContinuation() (+16 more)
...
Cohesion: 0.13
Nodes (26): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), loadResumeSessionId() (+18 more)
...
Cohesion: 0.1
Nodes (26): appendToRunLog(), checkLogSizeLimit(), createRunLog(), finalizeRunLog(), generateRunId(), getRunLog(), getRunLogPath(), getRunLogSize() (+18 more)
...
Cohesion: 0.12
Nodes (19): checkFailedMergeRetry(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+11 more)

### Community 358 - "Community 358"
Cohesion: 0.14
Nodes (19): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+11 more)
...
Cohesion: 0.17
Nodes (18): archivePlanning(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult, approve() (+10 more)
...
Cohesion: 0.13
Nodes (13): cleanupAllLogs(), cleanupOldLogs(), ensureRunsDirectory(), getRecentRunLogs(), getRunsDirectory(), getSpecialistsDir(), listRunLogs(), RunLogEntry (+5 more)
...
Cohesion: 0.17
Nodes (16): readWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback() (+8 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 384`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 269`, `Community 15`, `Community 16`, `Community 270`, `Community 146`, `Community 276`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 676`, `Community 37`, `Community 36`, `Community 39`, `Community 41`, `Community 45`, `Community 46`, `Community 49`, `Community 182`, `Community 55`, `Community 58`, `Community 59`, `Community 61`, `Community 190`, `Community 64`, `Community 461`, `Community 337`, `Community 722`, `Community 212`, `Community 726`, `Community 87`, `Community 86`, `Community 92`, `Community 478`, `Community 480`, `Community 226`, `Community 229`, `Community 614`, `Community 101`, `Community 232`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 36` to `Community 68`, `Community 38`, `Community 7`, `Community 8`, `Community 41`, `Community 200`, `Community 43`, `Community 78`, `Community 14`, `Community 305`, `Community 309`, `Community 215`, `Community 414`, `Community 31`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 266` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 264`, `Community 265`, `Community 10`, `Community 13`, `Community 14`, `Community 271`, `Community 20`, `Community 21`, `Community 277`, `Community 279`, `Community 29`, `Community 30`, `Community 159`, `Community 32`, `Community 158`, `Community 37`, `Community 168`, `Community 41`, `Community 42`, `Community 45`, `Community 565`, `Community 55`, `Community 443`, `Community 59`, `Community 189`, `Community 190`, `Community 187`, `Community 445`, `Community 67`, `Community 68`, `Community 70`, `Community 198`, `Community 199`, `Community 458`, `Community 76`, `Community 334`, `Community 462`, `Community 82`, `Community 85`, `Community 86`, `Community 90`, `Community 474`, `Community 91`, `Community 351`, `Community 352`, `Community 482`, `Community 122`, `Community 109`, `Community 242`, `Community 117`, `Community 250`, `Community 383`?**
