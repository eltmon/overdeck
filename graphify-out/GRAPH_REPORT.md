# Graph Report - feature-pan-1048  (2026-05-10)

## Corpus Check
- 1545 files · ~2,048,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21881 nodes · 32601 edges · 1141 communities (1104 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 443 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7539611b`
...
## Communities (1141 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (116): getHealthThresholdsMs(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeViolations, checkAgentForViolations() (+108 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (132): nudgeIdleWorkAgentsWithOpenBeads(), isMergeAgentRunning(), buildReviewBaseCommand(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand() (+124 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (132): checkOrphanedReviewStatuses(), checkStuckReviewing(), killOrphanedWorkspaceProcesses(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (116): autoResumeStoppedWorkAgents(), checkPendingTestDispatch(), setAgentStoppedNotifier(), emitCoordinatorDied(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), mockResolveProjectFromIssue (+108 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (106): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+98 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (113): buildTaskPrompt(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+105 more)
...
Cohesion: 0.03
Nodes (95): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+87 more)
...
Cohesion: 0.03
Nodes (113): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+105 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (90): IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS, OverviewTab, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps (+82 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (96): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (93): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+85 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (89): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatus, CloisterStatusBar() (+81 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (87): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+79 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (82): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS (+74 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (78): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+70 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (81): cvCommand(), CVOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (79): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (71): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), RuntimeRegistry, setGlobalRegistry() (+63 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (91): reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+83 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (69): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+61 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (74): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+66 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (82): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask, captureBeadsTasks(), captureFiles() (+74 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (78): buildTestAgentPromptContent(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (66): RoundMarker, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE (+58 more)
...
Cohesion: 0.04
Nodes (62): doc, path, first, found, path, paths, read, second (+54 more)
...
Cohesion: 0.04
Nodes (72): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+64 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (76): resetPostMergeState(), killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested (+68 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (71): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (73): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+65 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (62): firstSessionPanel, firstWorkbench, workbench, Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey() (+54 more)
...
Cohesion: 0.04
Nodes (63): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+55 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (62): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (58): ConversationRow(), ConversationRowProps, PHASE_ICONS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR (+50 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (51): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, PanOpenInPicker() (+43 more)
...
Cohesion: 0.05
Nodes (56): dropLingeringPreMergeStashes(), cleanupReviewTempStash(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), dropStash() (+48 more)
...
Cohesion: 0.05
Nodes (42): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText() (+34 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (48): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+40 more)
...
Cohesion: 0.06
Nodes (41): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+33 more)
...
Cohesion: 0.06
Nodes (40): ToggleButton(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps (+32 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (48): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+40 more)
...
Cohesion: 0.06
Nodes (35): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind (+27 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (43): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+35 more)
...
Cohesion: 0.14
Nodes (46): extractNumber(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions (+38 more)
...
Cohesion: 0.08
Nodes (43): checkStuckWorkAgents(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript() (+35 more)
...
Cohesion: 0.06
Nodes (26): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState() (+18 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (38): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), ReviewStatus (+30 more)
...
Cohesion: 0.09
Nodes (15): importTrackerConfig(), computePlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache, PlanningStateCacheEntry, POLL_INTERVALS (+7 more)
...
Cohesion: 0.08
Nodes (39): Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+31 more)
...
Cohesion: 0.09
Nodes (39): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+31 more)

### Community 100 - "Community 100"
Cohesion: 0.06
Nodes (32): AIProvider, buildConversationResponse(), getCachedMessages(), extractIssueIdFromSession(), getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer (+24 more)
...
Cohesion: 0.12
Nodes (31): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+23 more)
...
Cohesion: 0.07
Nodes (32): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+24 more)
...
Cohesion: 0.12
Nodes (32): rebuildCache(), appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+24 more)

### Community 154 - "Community 154"
Cohesion: 0.09
Nodes (29): ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), PipelineState, ZoneAInput (+21 more)
...
Cohesion: 0.07
Nodes (26): captureTldrMetrics(), getTldrMetrics(), TldrSessionMetrics, branch, branchMatch, buffer, cavemanVariant, cost (+18 more)
...
Cohesion: 0.11
Nodes (26): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+18 more)
...
Cohesion: 0.11
Nodes (24): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG, ensureResourceConfigLoaded(), evaluateSeverity(), getDockerStatsCollector() (+16 more)
...
Cohesion: 0.14
Nodes (24): archivePlanning(), closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+16 more)
...
Cohesion: 0.14
Nodes (20): AwaitingInputDetection, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+12 more)
...
Cohesion: 0.14
Nodes (12): daemonRegistry, ensureTldrStateDir(), execAsync, getStateFilePath(), hashWorkspacePath(), readStateFile(), TLDR_STATE_DIR, TldrDaemonService (+4 more)

### Community 290 - "Community 290"
Cohesion: 0.16
Nodes (23): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+15 more)
...
Cohesion: 0.13
Nodes (21): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+13 more)
...
Cohesion: 0.14
Nodes (20): generateFallbackSummary(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., activeCompactions, buildContinuationSummary() (+12 more)
...
Cohesion: 0.24
Nodes (9): criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument(), formatAcceptanceCriteria() (+1 more)
...
Cohesion: 0.18
Nodes (9): future, id, rows, rows1, rows2, GitOperationFilter, GitOperationStatus, GitOperationType (+1 more)
...
Cohesion: 0.25
Nodes (8): detectPlatform(), Platform, collectAgentProcesses(), execAsync, readProcessTable(), readProcMemory(), readProcMemoryDarwin(), readProcMemoryLinux()
...
Cohesion: 0.29
Nodes (6): after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, processResetReviewPipeline(), setReviewStatus()
...
Cohesion: 0.4
Nodes (4): SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, onSessionEnded
...
## Knowledge Gaps
- **11637 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11632 more)
...
- **Why does `fetch` connect `Community 11` to `Community 3`, `Community 4`, `Community 637`, `Community 6`, `Community 7`, `Community 10`, `Community 395`, `Community 13`, `Community 526`, `Community 15`, `Community 144`, `Community 272`, `Community 145`, `Community 16`, `Community 14`, `Community 21`, `Community 27`, `Community 155`, `Community 412`, `Community 29`, `Community 33`, `Community 290`, `Community 548`, `Community 37`, `Community 40`, `Community 555`, `Community 45`, `Community 46`, `Community 47`, `Community 177`, `Community 49`, `Community 63`, `Community 195`, `Community 207`, `Community 593`, `Community 94`, `Community 99`, `Community 101`, `Community 488`, `Community 750`, `Community 123`, `Community 125`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 124` to `Community 1`, `Community 15`, `Community 23`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 4` to `Community 1024`, `Community 0`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11637 weakly-connected nodes found - possible documentation gaps or missing edges._
