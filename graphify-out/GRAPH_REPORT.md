...
## Corpus Check
- 1543 files · ~2,058,892 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21569 nodes · 31930 edges · 1140 communities (1104 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9881277f`
...
## Communities (1140 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (142): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (111): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+103 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (110): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+102 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (126): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents(), checkHeartbeat() (+118 more)
...
Cohesion: 0.04
Nodes (120): checkOrphanedReviewStatuses(), checkStuckReviewing(), buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (115): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+107 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (117): reconcileAndCheckIfMerged(), reconcileFalseMerged(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), APP_DIR (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (112): checkStuckWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+104 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (120): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, archiveReviewerRound(), buildReviewFeedbackBody() (+112 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (100): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+92 more)
...
Cohesion: 0.04
Nodes (78): parsePiSession(), ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry() (+70 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (99): autoResumeStoppedWorkAgents(), cleanupSpawnAndOrphanedStashes(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname (+91 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (81): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+73 more)
...
Cohesion: 0.04
Nodes (65): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, doc, path (+57 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (78): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+70 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (70): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+62 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (75): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (70): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), configShadowCommand() (+62 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (79): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), updateConversationCost(), cleanupOldHealthEvents() (+71 more)
...
Cohesion: 0.05
Nodes (73): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), execAsync, serializeHandoffContext(), showCommand(), findSpecByIssue() (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (69): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+61 more)
...
Cohesion: 0.03
Nodes (73): resetPostMergeState(), agentDir, dir1, dir2, marker, missing, nested, cb (+65 more)
...
Cohesion: 0.05
Nodes (60): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+52 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (56): checkMissingReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback(), dispatchTestAgentAndNotify(), getTrackerContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig() (+48 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (60): getHealthThresholdsMs(), CostAlert, HandoffResult, AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth() (+52 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (53): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationView() (+45 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (25): issues, result, importTrackerConfig(), findProjectsByRallyProject(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+17 more)
...
Cohesion: 0.04
Nodes (49): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+41 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (57): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+49 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (51): getGitHubClient(), GitHubClient, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment, GitHubIssue, GitHubLabel (+43 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (44): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL (+36 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (58): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), CloseIssueOptions (+50 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (44): firstSessionPanel, firstWorkbench, workbench, CommandDeck(), ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (57): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, ConfigCache, ConfigLoadResult, ConversationsConfig (+49 more)
...
Cohesion: 0.07
Nodes (52): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest (+44 more)
...
Cohesion: 0.07
Nodes (50): checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus(), listSkills() (+42 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (41): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), CostDonut(), CostDonutProps, GodViewPage() (+33 more)
...
Cohesion: 0.08
Nodes (46): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+38 more)
...
Cohesion: 0.07
Nodes (48): createCostCommand(), BUDGETS_FILE, calculateCost(), checkBudget(), CostBudget, CostEntry, CostSummary, createBudget() (+40 more)
...
Cohesion: 0.04
Nodes (43): getActivity(), agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, evaluateSpawnGuardrails(), execAsync, formatLeakedSpecialistSummary() (+35 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (44): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+36 more)
...
Cohesion: 0.08
Nodes (41): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+33 more)
...
Cohesion: 0.08
Nodes (42): runCommand(), destroyCommand(), migrateRemoteToLocal(), resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, useConfigCommand(), buildChannelsArgs() (+34 more)
...
Cohesion: 0.07
Nodes (27): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+19 more)
...
Cohesion: 0.06
Nodes (36): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+28 more)
...
Cohesion: 0.06
Nodes (34): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CostLimitsConfig, CostTrackingConfig, deepMerge(), HandoffConfig, HandoffTriggersConfig (+26 more)
...
Cohesion: 0.08
Nodes (39): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+31 more)
...
Cohesion: 0.09
Nodes (37): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile(), getEventsFilePath() (+29 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (37): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput() (+29 more)
...
Cohesion: 0.06
Nodes (31): updateConversationTitle(), DialogProvider(), button, { container }, defaultProps, makeMutation(), makeSyncMutation(), onDismissPending (+23 more)
...
Cohesion: 0.07
Nodes (27): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), ModelSelectionResult (+19 more)
...
Cohesion: 0.1
Nodes (30): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, AgentAlreadyRunning (+22 more)
...
Cohesion: 0.08
Nodes (33): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+25 more)
...
Cohesion: 0.08
Nodes (33): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+25 more)
...
Cohesion: 0.06
Nodes (30): CloisterConfig, DEFAULT_CLOISTER_CONFIG, HealthThresholds, customConfig, thresholds, CloisterEvent, setCloisterService(), capturedEvents (+22 more)
...
Cohesion: 0.09
Nodes (33): Access, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), stat, activitySummaryCache (+25 more)
...
Cohesion: 0.12
Nodes (31): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), determineWorkspaceLocation(), ensureRemoteWorkspace() (+23 more)

### Community 163 - "Community 163"
Cohesion: 0.08
Nodes (27): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+19 more)

### Community 164 - "Community 164"
Cohesion: 0.1
Nodes (33): isCoordinatorAliveAsync(), listPaneValuesAsync(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, ensureSwarmAutoAdvanceLoop() (+25 more)

### Community 165 - "Community 165"
Cohesion: 0.1
Nodes (27): future, id, rows, rows1, rows2, execFileAsync, gitFetch(), gitForcePush() (+19 more)
...
Cohesion: 0.1
Nodes (24): withConcurrencyLimit(), ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+16 more)

### Community 168 - "Community 168"
Cohesion: 0.1
Nodes (32): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+24 more)
...
Cohesion: 0.11
Nodes (29): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+21 more)
...
Cohesion: 0.1
Nodes (26): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError(), invalidateProbeCache() (+18 more)
...
Cohesion: 0.13
Nodes (27): healthCommand(), HealthOptions, formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+19 more)
...
Cohesion: 0.08
Nodes (21): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+13 more)
...
Cohesion: 0.06
Nodes (26): allOps, divergedOp, execAsync, execFileMock, execMock, ops, opTypes, status (+18 more)
...
Cohesion: 0.09
Nodes (25): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions (+17 more)
...
Cohesion: 0.08
Nodes (20): CostEvent, dir, event, eventsDir1, eventsDir2, line, lines, parsed (+12 more)

### Community 281 - "Community 281"
Cohesion: 0.12
Nodes (22): appendToRunLog(), getRunLog(), getRunLogPath(), isRunLogActive(), execAsync, listLogsCommand(), logsCommand(), LogsOptions (+14 more)

### Community 282 - "Community 282"
Cohesion: 0.11
Nodes (18): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, VERDICT_COLOR, VERDICT_LABEL, fmtCost() (+10 more)
...
Cohesion: 0.11
Nodes (20): setAgentStoppedNotifier(), spawnReviewCoordinatorSession(), Handler, notifyPipeline(), PipelineEvent, setPipelineHandler(), after, mockNotifyPipeline (+12 more)

### Community 304 - "Community 304"
Cohesion: 0.13
Nodes (18): IPC, initializeNotifications(), registerNotificationHandlers(), deepClone(), DEFAULTS, DesktopSettings, getDesktopSettings(), loadDesktopSettings() (+10 more)
...
Cohesion: 0.13
Nodes (18): ProjectConfig, after, before, cfg, compose, ph, result, createWorkspacePlaceholders() (+10 more)
...
Cohesion: 0.11
Nodes (16): checkForUpdates(), currentStatus, downloadUpdate(), getUpdateStatus(), initializeAutoUpdater(), quitAndInstall(), startPeriodicChecks(), statusCallbacks (+8 more)
...
Cohesion: 0.1
Nodes (20): checkLogSizeLimit(), getRunLogSize(), parseLogMetadata(), content, deleted, { filePath }, largeContent, metadata (+12 more)

### Community 345 - "Community 345"
Cohesion: 0.11
Nodes (18): ActivityItem(), ActivityPanelProps, ActivityStream, CategoryFilter, fetchActivityREST(), fetchDetailedActivityREST(), fetchGitActivity(), fetchTtsActivityREST() (+10 more)
...
Cohesion: 0.16
Nodes (14): ToolFlash(), ToolFlashProps, deriveDotStatus(), formatDuration(), isErrorStatus(), isReviewerRole(), presenceToStatus(), REVIEWER_ROLES (+6 more)
...
Cohesion: 0.12
Nodes (17): cancelIssueWorkflow(), deepWipe(), destructiveResetWorkflow(), resetToTodo(), archiveIdx, beadsDir, branchStep, clearStep (+9 more)
...
Cohesion: 0.12
Nodes (14): ActivityEntry, ActivityPanel(), applyPinWarnings(), a1, a2, entries, entry, git (+6 more)

### Community 416 - "Community 416"
Cohesion: 0.16
Nodes (11): RoundVerdict, resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps (+3 more)
...
Cohesion: 0.17
Nodes (13): ComposerPlugin(), ComposerPromptEditor(), ComposerPromptEditorProps, EditorRefPluginProps, filterCommands(), getDraftKey(), InnerPluginProps, loadDraft() (+5 more)
...
Cohesion: 0.26
Nodes (13): cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunsDirectory(), getSpecialistsDir() (+5 more)
...
Cohesion: 0.15
Nodes (7): ReopenOptions, ReopenResult, activeContinuePath, { continuePath }, projectRoot, updated, wsDir
...
Cohesion: 0.17
Nodes (10): cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getReauthSessionToken(), invalidateReauthToken(), postCodexReauthRoute (+2 more)
...
Cohesion: 0.15
Nodes (12): Basic Usage, code:bash (# Start planning session for an issue), Dashboard Planning Interface, High-Quality Plan, More Information, Needs Improvement, Overview, Panopticon Planning Workflow (+4 more)
...
Cohesion: 0.26
Nodes (11): callServerApi(), resolveResourcePath(), AgentStatus, buildContextMenu(), buildTooltip(), createTray(), createTrayIcon(), destroyTray() (+3 more)
...
Cohesion: 0.17
Nodes (10): getRootRect, localStorageMock, match, menu, mockEditor, mockOnCommandKeyDown, mockRange, mockSelection (+2 more)
...
Cohesion: 0.25
Nodes (9): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, isDevelopment, resolveWindowUrl(), ROOT_DIR, showOrCreateWindow() (+1 more)
...
Cohesion: 0.2
Nodes (9): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+1 more)

### Community 595 - "Community 595"
Cohesion: 0.27
Nodes (8): postMergeLifecycle(), calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }
...
Cohesion: 0.33
Nodes (6): buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, onUpdateStatusChange()
...
Cohesion: 0.43
Nodes (7): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), groupItemsByWave(), Wave
...
Cohesion: 0.25
Nodes (7): kCustom, mockExec, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed
...
## Knowledge Gaps
- **11494 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11489 more)
...
- **Why does `fetch` connect `Community 0` to `Community 896`, `Community 2`, `Community 131`, `Community 4`, `Community 7`, `Community 9`, `Community 267`, `Community 11`, `Community 14`, `Community 15`, `Community 527`, `Community 16`, `Community 18`, `Community 150`, `Community 151`, `Community 24`, `Community 25`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 676`, `Community 551`, `Community 39`, `Community 556`, `Community 44`, `Community 303`, `Community 178`, `Community 179`, `Community 187`, `Community 72`, `Community 969`, `Community 74`, `Community 202`, `Community 593`, `Community 82`, `Community 345`, `Community 105`, `Community 747`, `Community 753`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 123` to `Community 8`, `Community 14`, `Community 23`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 16` to `Community 164`, `Community 261`, `Community 7`, `Community 553`, `Community 363`, `Community 364`, `Community 48`, `Community 23`, `Community 28`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11494 weakly-connected nodes found - possible documentation gaps or missing edges._
