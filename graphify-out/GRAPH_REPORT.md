...
## Corpus Check
- 1552 files · ~2,049,778 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21724 nodes · 32229 edges · 1143 communities (1106 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f209a347`
...
5. `spawnEphemeralSpecialist()` - 51 edges
...
## Communities (1143 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (122): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+114 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (137): readCavemanVariant(), checkFailedMergeRetry(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, HandoffResult (+129 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (137): setAgentStoppedNotifier(), spawnReviewCoordinatorSession(), after, before, blockers, result, statuses, after (+129 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (132): checkStuckReviewing(), renderPrompt(), finalizeRunLog(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+124 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (122): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (97): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+89 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (105): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+97 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (115): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+107 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (103): loadCloisterConfig(), cleanupStaleAgentState(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (82): criteria, doc, result, dbError, deleteCalls, existingBeads, expectedPrefix, initCall (+74 more)
...
Cohesion: 0.04
Nodes (90): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask, captureBeadsTasks() (+82 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (88): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (86): CopyConfigOptions, BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation() (+78 more)
...
Cohesion: 0.03
Nodes (76): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (87): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+79 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (78): ChatMarkdown, ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, CostEvent, CostStreamResponse, fetchCostStream() (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (76): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SkillsList() (+68 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (75): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+67 more)
...
Cohesion: 0.03
Nodes (69): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (71): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+63 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (70): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+62 more)
...
Cohesion: 0.03
Nodes (66): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+58 more)
...
Cohesion: 0.04
Nodes (56): importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment, GitHubIssue (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (62): cleanupAbandonedFeedback(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage() (+54 more)
...
Cohesion: 0.05
Nodes (55): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HealthSummary, getActiveParallelReviewIssues(), activeRoleRunExists() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (51): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+43 more)
...
Cohesion: 0.05
Nodes (43): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+35 more)
...
Cohesion: 0.06
Nodes (49): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+41 more)
...
Cohesion: 0.07
Nodes (49): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+41 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (49): calls, { mockExecAsync }, opts, ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), findWorkspacePath(), activeDir (+41 more)
...
Cohesion: 0.08
Nodes (44): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+36 more)
...
Cohesion: 0.15
Nodes (44): extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+36 more)
...
Cohesion: 0.09
Nodes (40): rebuildCache(), appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+32 more)
...
Cohesion: 0.07
Nodes (31): DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout() (+23 more)
...
Cohesion: 0.06
Nodes (31): getShowHealthRoute, getShowRoute, getShowShadowRoute, showRouteLayer, createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent() (+23 more)
...
Cohesion: 0.06
Nodes (35): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, generateRouterConfigFromWorkTypes() (+27 more)
...
Cohesion: 0.05
Nodes (32): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, useDialogDepth() (+24 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (40): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+32 more)
...
Cohesion: 0.09
Nodes (34): doneCommand(), execAsync, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb() (+26 more)
...
Cohesion: 0.09
Nodes (32): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+24 more)
...
Cohesion: 0.08
Nodes (27): ModelProvider, getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter() (+19 more)

### Community 138 - "Community 138"
Cohesion: 0.08
Nodes (17): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+9 more)
...
Cohesion: 0.14
Nodes (30): killCommand(), KillOptions, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+22 more)
...
Cohesion: 0.1
Nodes (26): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentResolution() (+18 more)
...
Cohesion: 0.1
Nodes (26): updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS (+18 more)
...
Cohesion: 0.13
Nodes (23): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions (+15 more)
...
Cohesion: 0.09
Nodes (23): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), agentState (+15 more)
...
Cohesion: 0.1
Nodes (19): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+11 more)

### Community 274 - "Community 274"
Cohesion: 0.13
Nodes (19): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+11 more)
...
Cohesion: 0.13
Nodes (16): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+8 more)
...
Cohesion: 0.15
Nodes (17): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+9 more)
...
Cohesion: 0.11
Nodes (18): parseLogMetadata(), content, deleted, { filePath }, largeContent, metadata, oldDate, oldPath (+10 more)
...
Cohesion: 0.18
Nodes (13): checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache, TaskCompletionCacheEntry (+5 more)
...
Cohesion: 0.14
Nodes (13): DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), SettingsConfig, allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing (+5 more)
...
## Knowledge Gaps
- **11570 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11565 more)
...
- **Why does `fetch` connect `Community 6` to `Community 0`, `Community 2`, `Community 130`, `Community 131`, `Community 5`, `Community 7`, `Community 648`, `Community 9`, `Community 10`, `Community 11`, `Community 143`, `Community 16`, `Community 15`, `Community 530`, `Community 18`, `Community 20`, `Community 19`, `Community 534`, `Community 282`, `Community 27`, `Community 157`, `Community 33`, `Community 34`, `Community 420`, `Community 166`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 556`, `Community 177`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 193`, `Community 964`, `Community 593`, `Community 338`, `Community 214`, `Community 598`, `Community 226`, `Community 750`, `Community 238`, `Community 127`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 154` to `Community 1`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 15` to `Community 129`, `Community 1022`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11570 weakly-connected nodes found - possible documentation gaps or missing edges._
