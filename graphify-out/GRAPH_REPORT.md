...
## Corpus Check
- 1878 files · ~2,476,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26661 nodes · 41414 edges · 1258 communities (1208 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 505 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e6c4ff8b`
...
## Communities (1258 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (169): ConversationList(), fetchConversations(), GeneralConversation, GeneralSectionProps, CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+161 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (171): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult (+163 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (127): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (140): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+132 more)
...
Cohesion: 0.02
Nodes (119): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+111 more)
...
Cohesion: 0.02
Nodes (111): checkPostReviewCommits(), pendingCommand(), after, before, blockers, result, statuses, after (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (116): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash() (+108 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (97): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+89 more)
...
Cohesion: 0.03
Nodes (110): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+102 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (102): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+94 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (105): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (98): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), readWorkspacePlanAsync(), writeStoryFeatureContext() (+90 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (101): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+93 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (95): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+87 more)
...
Cohesion: 0.02
Nodes (97): detectMergedSwarmSlots(), reconcileAndCheckIfMerged(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+89 more)
...
Cohesion: 0.03
Nodes (93): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+85 more)
...
Cohesion: 0.03
Nodes (83): renderPrompt(), inferMemoryProjectId(), retrieveSpawnTimeMemoryContext(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (85): buildPolyrepoContext(), projectListCommand(), projectShowCommand(), listTestsCommand(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions (+77 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (67): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials (+59 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (69): ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent() (+61 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (87): embedAction(), confirmCost(), enrichAction(), formatCost(), scan(), ScanOptions, normalizeFilter(), SearchMode (+79 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (77): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+69 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (79): readCavemanVariant(), checkStuckReviewing(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve (+71 more)
...
Cohesion: 0.04
Nodes (63): DrawerTabPlaceholder(), tabLabel(), PanSpecListOptions, ProjectPanPaths, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+55 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (81): dequeueMerge(), ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth (+73 more)
...
Cohesion: 0.03
Nodes (68): AgentRuntimeState, clearAgentPausedEffect(), clearAgentTroubledEffect(), getAgentStateEffect(), listRunningAgentsEffect(), recordAgentFailureEffect(), saveAgentStateEffect(), setAgentPausedEffect() (+60 more)
...
Cohesion: 0.05
Nodes (62): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+54 more)
...
Cohesion: 0.04
Nodes (63): resetDb(), resetDb(), closeDatabase(), DatabaseError, getDatabasePath(), isBunRuntime(), _require, resetDatabase() (+55 more)
...
Cohesion: 0.03
Nodes (57): loadCloisterConfig(), cleanupStaleAgentState(), { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, checkAgentHealthAsync() (+49 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (50): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError, serializeHandoffContext() (+42 more)
...
Cohesion: 0.05
Nodes (50): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest, ManifestEntry (+42 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (52): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, startDeacon(), activeRoleRunExists(), AgentCrashTracker (+44 more)
...
Cohesion: 0.04
Nodes (55): TranscriptClaimTrigger, buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput (+47 more)
...
Cohesion: 0.05
Nodes (44): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+36 more)
...
Cohesion: 0.06
Nodes (46): conversationsTab, firstLens, lens, overview, tablist, ComposerMode, IssueComposer(), IssueComposerProps (+38 more)
...
Cohesion: 0.06
Nodes (44): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+36 more)
...
Cohesion: 0.05
Nodes (53): Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+45 more)

### Community 77 - "Community 77"
Cohesion: 0.09
Nodes (54): extractNumber(), extractPrefix(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl() (+46 more)
...
Cohesion: 0.06
Nodes (39): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult, onInspectComplete() (+31 more)
...
Cohesion: 0.05
Nodes (27): estimateCost(), getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId, calculateSkillScore(), formatSelectionResults() (+19 more)
...
Cohesion: 0.08
Nodes (34): FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), workspacePanPaths(), clearFeedback(), readFeedback() (+26 more)
...
Cohesion: 0.07
Nodes (26): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+18 more)
...
Cohesion: 0.08
Nodes (34): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+26 more)
...
Cohesion: 0.06
Nodes (26): RoundMarker, ZoneCConversation(), ZoneCConversationProps, deriveRoundMarkers(), TimestampedItem, getViewKey(), PanelView, readView() (+18 more)
...
Cohesion: 0.07
Nodes (23): SearchResult, DiscoveredSession, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+15 more)
...
Cohesion: 0.11
Nodes (24): checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, execAsync, getCliproxyPidPath() (+16 more)

### Community 244 - "Community 244"
Cohesion: 0.09
Nodes (23): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+15 more)
...
Cohesion: 0.09
Nodes (19): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), base, cols, colsAfter, colsBefore, correctedPath (+11 more)
...
Cohesion: 0.09
Nodes (18): columns, db, divergedRows, id, indexes, indexNames, names, pushRows (+10 more)
...
Cohesion: 0.21
Nodes (10): checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache, TaskCompletionCacheEntry (+2 more)
...
Cohesion: 0.48
Nodes (12): detectPlatformAsset(), ensureConfigFile(), ensureDirs(), getCliproxyBinary(), getCliproxyConfigPath(), getCliproxyDir(), getCliproxyLogPath(), installCliproxy() (+4 more)
...
- **Why does `fetch` connect `Community 0` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 264`, `Community 9`, `Community 522`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 279`, `Community 408`, `Community 25`, `Community 152`, `Community 155`, `Community 157`, `Community 31`, `Community 160`, `Community 42`, `Community 1067`, `Community 684`, `Community 44`, `Community 45`, `Community 46`, `Community 52`, `Community 55`, `Community 56`, `Community 442`, `Community 444`, `Community 191`, `Community 63`, `Community 193`, `Community 64`, `Community 196`, `Community 68`, `Community 71`, `Community 328`, `Community 73`, `Community 74`, `Community 81`, `Community 212`, `Community 88`, `Community 92`, `Community 94`, `Community 96`, `Community 100`, `Community 617`, `Community 233`, `Community 117`, `Community 382`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 31` to `Community 32`, `Community 33`, `Community 6`, `Community 41`, `Community 74`, `Community 11`, `Community 14`, `Community 306`, `Community 51`, `Community 210`, `Community 62`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 116` to `Community 640`, `Community 1`, `Community 4`, `Community 7`, `Community 11`, `Community 269`, `Community 270`, `Community 13`, `Community 14`, `Community 18`, `Community 402`, `Community 274`, `Community 24`, `Community 25`, `Community 26`, `Community 155`, `Community 156`, `Community 28`, `Community 162`, `Community 35`, `Community 421`, `Community 40`, `Community 41`, `Community 44`, `Community 173`, `Community 53`, `Community 182`, `Community 56`, `Community 441`, `Community 440`, `Community 191`, `Community 194`, `Community 66`, `Community 326`, `Community 327`, `Community 458`, `Community 459`, `Community 204`, `Community 205`, `Community 79`, `Community 337`, `Community 211`, `Community 83`, `Community 469`, `Community 86`, `Community 471`, `Community 91`, `Community 94`, `Community 96`, `Community 353`, `Community 99`, `Community 240`, `Community 497`, `Community 114`, `Community 115`, `Community 243`, `Community 126`, `Community 380`, `Community 254`?**
