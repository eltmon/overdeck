# Graph Report - feature-pan-1312  (2026-05-22)

## Corpus Check
- 1915 files · ~3,138,383 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28137 nodes · 47117 edges · 1302 communities (1246 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 945 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57bb0b84`
...
5. `sessionExists()` - 95 edges
6. `useDashboardStore` - 87 edges
7. `FsError` - 80 edges
8. `getAgentStateSync()` - 71 edges
9. `spawnRun()` - 70 edges
10. `sessionExistsAsyncEffect()` - 69 edges
...
## Communities (1302 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (234): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+226 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (197): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoff(), performHandoffPromise(), performKillAndSpawn() (+189 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (154): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+146 more)
...
Cohesion: 0.02
Nodes (137): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (152): checkStuckWorkAgents(), isAgentActiveInTmux(), isAgentActiveInTmuxEffect(), parseThinkingDuration(), captureTmuxOutput(), AgentStatusOptions, analyzeSession(), detectStatus() (+144 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (137): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+129 more)
...
Cohesion: 0.02
Nodes (99): parsePiSession(), parsePiSessionSync(), ProcessSpawnError, TmuxError, agentState, callOrder, checkFn, killed (+91 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (143): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+135 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (123): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+115 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (122): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+114 more)
...
Cohesion: 0.03
Nodes (103): configShadowCommand(), ShadowOptions, devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22() (+95 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (103): contextSyncCommand(), checkCommand(), syncCommand(), SyncOptions, applyManagedRegion(), ensureExcalidrawMcp(), ensureExcalidrawMcpSync(), ensurePlaywrightIsolation() (+95 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (100): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), ensureRemoteWorkspace(), findWorkspaceWithLocation() (+92 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (102): DatabaseError, dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+94 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (85): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, callApi(), CommandPalette() (+77 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (92): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+84 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (88): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+80 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (76): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (91): readCavemanVariant(), buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers (+83 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (92): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+84 more)
...
Cohesion: 0.02
Nodes (77): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+69 more)
...
Cohesion: 0.03
Nodes (73): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+65 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (88): emitActivityDetailed(), emitActivityDetailedSync(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+80 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (92): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), ModelRef, RoleConfig (+84 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (74): runQualityGates(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult (+66 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (85): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle() (+77 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (80): startPostLaunchSidecars(), startSidecars(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild() (+72 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (74): loadConfigAsyncNoMigration(), acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+66 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (65): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+57 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (75): agentStatusCommand(), healthCommand(), HealthOptions, pendingCommand(), recoverCommand(), RecoverOptions, AgentEnrichment, AgentState (+67 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (74): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+66 more)
...
Cohesion: 0.04
Nodes (64): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+56 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (75): loadCloisterConfig(), loadCloisterConfigEffect(), autoCloseOut(), sweepAutoCloseOutCache(), { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo (+67 more)
...
Cohesion: 0.03
Nodes (73): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+65 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (74): resetDb(), db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+66 more)
...
Cohesion: 0.04
Nodes (70): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+62 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (74): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields(), continueDirForWorkspace() (+66 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (32): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getActiveSessionModelSync(), getAllSessionFilesSync(), getProjectDirs(), getProjectDirsSync(), getRecentSessions() (+24 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (63): embedAction(), confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding() (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (71): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrEffect, renderTemplate() (+63 more)
...
Cohesion: 0.04
Nodes (62): PlanningState, ZoneAActionsState, SwitchModelModal(), SwitchModelModalProps, VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, ActionKey (+54 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (73): { config }, Role, applyEnvironmentFallbacks(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+65 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (59): getDefaultConversationModel(), conversationsTab, firstLens, lens, overview, tablist, ConversationList(), ForkModal() (+51 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (67): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionByJsonlPath() (+59 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (64): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), applyStashPromise(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createNamedStashPromise() (+56 more)
...
Cohesion: 0.05
Nodes (63): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextValidateCommand(), LayerName, renderLayerForHarness() (+55 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (64): extractNumber(), extractNumberSync(), extractPrefixSync(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl() (+56 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (61): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+53 more)
...
Cohesion: 0.04
Nodes (60): ABOUT_SCHEMA, sanitizeTitle(), serializeConversationTranscript(), summarizeFirstMessageTitle(), summarizeTranscriptAbout(), summarizeTranscriptTitle(), TITLE_SCHEMA, TranscriptMessage (+52 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (52): appendCostEvent(), CostEvent, deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+44 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (48): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+40 more)
...
Cohesion: 0.06
Nodes (60): AgentRuntimeState, claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync() (+52 more)
...
Cohesion: 0.06
Nodes (58): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand() (+50 more)
...
Cohesion: 0.06
Nodes (45): createCostCommand(), formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, checkBudget() (+37 more)
...
Cohesion: 0.07
Nodes (53): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile() (+45 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (51): listTestsCommand(), registerTestCommands(), RunOptions, addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots() (+43 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (51): contextMigrateCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+43 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (45): buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsSync(), readYoloEnv(), resolvePermissionMode(), resolvePermissionModeSync() (+37 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (26): defaultMemoryExtractionWorkerPool, defaultMemoryPipelineWorkerPool, earliestOffset(), enqueueMemoryExtractionJob(), enqueueReconciledMemoryExtractionJobs(), MemoryExtractionJob, MemoryExtractionJobResult, MemoryExtractionWorkerPool (+18 more)

### Community 77 - "Community 77"
Cohesion: 0.1
Nodes (54): systemHealthCommand(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials (+46 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (48): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+40 more)
...
Cohesion: 0.06
Nodes (47): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+39 more)
...
Cohesion: 0.05
Nodes (47): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl() (+39 more)
...
Cohesion: 0.05
Nodes (31): estimateCost(), getModelCapability(), getModelCapabilitySync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults() (+23 more)

### Community 87 - "Community 87"
Cohesion: 0.06
Nodes (48): number(), detectPlatform(), Platform, evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv() (+40 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (48): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+40 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (46): computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), isSmeeProcessRunningSync(), isSmeeRunning() (+38 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (44): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+36 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (42): ensureDefaultConversationModel(), fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted (+34 more)
...
Cohesion: 0.06
Nodes (41): GIT_PATTERNS, scanGitPatterns(), MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen (+33 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (40): applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProviders(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP (+32 more)
...
Cohesion: 0.08
Nodes (49): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+41 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (49): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting(), setSetting() (+41 more)
...
Cohesion: 0.05
Nodes (42): entry, { issueId }, { limit }, old, op, ops, recent, result (+34 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (48): clearFlywheelRunGate(), flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), setFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun() (+40 more)
...
Cohesion: 0.07
Nodes (46): usageToCostEvents(), buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset() (+38 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (38): createHumeConfig(), deleteHumeConfig(), getDefaultWorkspaceConfigSync(), replacePlaceholders(), addReposToWorkspace(), AddReposToWorkspaceOptions, addReposToWorkspacePromise(), AddReposToWorkspaceResult (+30 more)
...
Cohesion: 0.05
Nodes (41): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+33 more)
...
Cohesion: 0.06
Nodes (42): TranscriptClaimTrigger, buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput (+34 more)
...
Cohesion: 0.1
Nodes (38): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+30 more)
...
Cohesion: 0.08
Nodes (37): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), executeCloseOutPromise() (+29 more)
...
Cohesion: 0.09
Nodes (43): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+35 more)
...
Cohesion: 0.09
Nodes (41): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+33 more)

### Community 128 - "Community 128"
Cohesion: 0.12
Nodes (33): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync(), collectMail() (+25 more)
...
Cohesion: 0.06
Nodes (29): CanonicalState, createShadowState(), createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus(), getDisplayStatusPromise(), getShadowStatePath(), getShadowStatePromise() (+21 more)
...
Cohesion: 0.08
Nodes (36): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, checkTtsHealth(), speakTts(), startTtsDaemonFromDashboard() (+28 more)

### Community 150 - "Community 150"
Cohesion: 0.08
Nodes (40): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+32 more)
...
Cohesion: 0.12
Nodes (40): atLineEnd(), charAt(), compose(), continueScalar(), end(), getLine(), hasChars(), isEmpty() (+32 more)

### Community 157 - "Community 157"
Cohesion: 0.07
Nodes (34): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry (+26 more)
...
Cohesion: 0.08
Nodes (36): appendCostEventSync(), eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+28 more)

### Community 164 - "Community 164"
Cohesion: 0.07
Nodes (36): createDatabase(), databases, getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement, memoryFtsWorkerSource(), migrateMemoryFtsBranchColumn() (+28 more)
...
Cohesion: 0.08
Nodes (28): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+20 more)
...
Cohesion: 0.07
Nodes (31): approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifact() (+23 more)
...
Cohesion: 0.08
Nodes (29): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl (+21 more)
...
Cohesion: 0.13
Nodes (31): createTracker(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker (+23 more)

### Community 181 - "Community 181"
Cohesion: 0.05
Nodes (33): doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending, QueuedCommit (+25 more)
...
Cohesion: 0.09
Nodes (26): captureCheckpoint(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteCheckpointPromise(), deleteLegacyCheckpointRefs(), deleteLegacyCheckpointRefsPromise() (+18 more)
...
Cohesion: 0.08
Nodes (34): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), isDockerContainerProcess(), killOrphanedProcesses(), killTmuxSessions() (+26 more)
...
Cohesion: 0.07
Nodes (21): SETTINGS_FILE, ApiKeysConfig, ComplexityLevel, ComplexityModels, deepMerge(), DEFAULT_SETTINGS, getAgentCommand(), getAgentCommandSync() (+13 more)
...
Cohesion: 0.07
Nodes (24): SearchResult, DiscoveredSession, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+16 more)

### Community 218 - "Community 218"
Cohesion: 0.06
Nodes (34): updateConversationsConfig(), updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema (+26 more)

### Community 219 - "Community 219"
Cohesion: 0.11
Nodes (29): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+21 more)
...
Cohesion: 0.08
Nodes (29): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+21 more)
...
Cohesion: 0.09
Nodes (29): ExtractedPayload, fetchFn, provider, result, StubExtractionProvider, appendJsonl(), buildQueryExpansionCacheKey(), buildQueryExpansionPrompt() (+21 more)
...
Cohesion: 0.09
Nodes (25): ActivityLevel, ActivitySource, emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitActivityTtsSync(), emitDashboardLifecycle(), emitDashboardLifecycleSync() (+17 more)
...
Cohesion: 0.1
Nodes (33): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), clone(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+25 more)
...
Cohesion: 0.14
Nodes (31): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+23 more)

### Community 258 - "Community 258"
Cohesion: 0.11
Nodes (23): CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterEffect(), createClaudeAdapterSync(), createRuntimeRegistry(), getInstalledRuntimes(), getInstalledRuntimesPromise(), getRuntimeAdapter() (+15 more)
...
Cohesion: 0.11
Nodes (27): buildReviewContext(), BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles() (+19 more)
...
Cohesion: 0.13
Nodes (24): onInspectComplete(), onInspectCompletePromise(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise(), getDiffBase() (+16 more)

### Community 298 - "Community 298"
Cohesion: 0.12
Nodes (19): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatus(), getMigrationStatusSync() (+11 more)

### Community 299 - "Community 299"
Cohesion: 0.12
Nodes (22): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+14 more)
...
Cohesion: 0.13
Nodes (20): createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration(), generateReport() (+12 more)
...
Cohesion: 0.11
Nodes (15): ProjectConfig, after, before, cfg, compose, ph, result, createWorkspacePlaceholders() (+7 more)
...
Cohesion: 0.13
Nodes (13): wipeCommand(), WipeOptions, extractPrefix(), extractStandardNumber(), extractStandardNumberSync(), extractStandardPrefix(), extractStandardPrefixSync(), normalizeIssueId() (+5 more)
...
Cohesion: 0.17
Nodes (16): after, before, blockers, result, statuses, clearReviewStatus(), clearReviewStatusSync(), DEFAULT_STATUS_FILE (+8 more)
...
Cohesion: 0.16
Nodes (19): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapper(), generateLauncherWrapperSync(), LauncherConfig (+11 more)
...
Cohesion: 0.15
Nodes (14): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+6 more)
...
Cohesion: 0.19
Nodes (17): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, resolveBareNumericId() (+9 more)
...
Cohesion: 0.13
Nodes (20): parseLogMetadata(), getProjectSpecialistMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual (+12 more)
...
Cohesion: 0.14
Nodes (18): assertIssueHasBeadsEffect(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue() (+10 more)
...
Cohesion: 0.15
Nodes (16): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+8 more)

### Community 437 - "Community 437"
Cohesion: 0.2
Nodes (19): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxySync(), decodeJwtPayload(), getCliproxyCodexCredPath(), getCodexAuthPath(), buildStatus(), decodeBase64Url() (+11 more)
...
Cohesion: 0.21
Nodes (13): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), createBackup(), createBackupSync() (+5 more)
...
Cohesion: 0.13
Nodes (12): getOpenAICompatibleProxyBaseUrl(), getKimiAnthropicBaseUrl(), getProviderEnv(), getProviderEnvSync(), ProviderAuthType, ProviderName, PROVIDERS, AnthropicModel (+4 more)
...
Cohesion: 0.13
Nodes (11): ReopenError, ReopenOptions, ReopenResult, reopenWorkspaceState(), reopenWorkspaceStatePromise(), activeContinuePath, continuePath, projectRoot (+3 more)
...
Cohesion: 0.11
Nodes (12): AgentTemplateConfig, DnsConfig, DockerConfig, EnvConfig, getDefaultWorkspaceConfig(), PortConfig, ProjectsConfig, RepoConfig (+4 more)
...
Cohesion: 0.22
Nodes (18): assertSafeAgentId(), deleteAllCheckpoints(), deleteAllCheckpointsPromise(), deleteCheckpoint(), diffCheckpointFiles(), diffCheckpointFilesPromise(), diffCheckpoints(), diffCheckpointsPromise() (+10 more)
...
Cohesion: 0.17
Nodes (14): AgentHealth, checkAllTriggers(), checkAllTriggersPromise(), checkStuckEscalation(), checkTaskCompletion(), checkTaskCompletionPromise(), checkTestFailure(), detectTestFailure() (+6 more)
...
Cohesion: 0.22
Nodes (13): ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchRow, normalizeLimit(), normalizeSiblingTokenBudget() (+5 more)

### Community 526 - "Community 526"
Cohesion: 0.16
Nodes (14): clearRunningAgentsCache(), getCachedRunningAgents(), ListAgentsEffect, RunningAgent, RunningAgents, runningAgentsCache, sweepExpired(), firstAgents (+6 more)
...
Cohesion: 0.23
Nodes (14): addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), detectDnsSyncMethod(), DnsSyncMethod, execAsync, getDnsmasqConfigDir() (+6 more)
...
Cohesion: 0.13
Nodes (12): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockSpawnAgent, mockSpawnPlanningSession (+4 more)
...
Cohesion: 0.19
Nodes (11): readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), appendSession(), readSessions() (+3 more)
...
Cohesion: 0.24
Nodes (13): generateFallbackSummary(), handleConversationMessage(), activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings() (+5 more)
...
Cohesion: 0.14
Nodes (7): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, ModelId
...
Cohesion: 0.14
Nodes (13): shouldSkipCheckpointReconciliation(), isTerminalTurnDiffSummaryStatus(), agentIds, baseTimestamp, checkpoints, deleteLegacyCheckpointRefs, diffCheckpointFiles, encoder (+5 more)

### Community 586 - "Community 586"
Cohesion: 0.14
Nodes (11): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockSpawnAgent, mockSpawnPlanningSession (+3 more)
...
Cohesion: 0.22
Nodes (8): HookItem, computeQueuePositionFromStatus(), computeQueuePositionFromStatusSync(), findPositionInQueue(), findPositionInQueueSync(), QueuePositionResult, items, result
...
Cohesion: 0.18
Nodes (7): createFlyApiClient(), createFlyApiClientSync(), FlyApiError, client, fetchMock, machine, machines

### Community 660 - "Community 660"
Cohesion: 0.18
Nodes (9): CostMetrics, fetchCostMetrics(), fetchMetricsSummary(), MetricsPage(), MetricsSummary, fetchTldrStatus(), TldrDaemonStatus, TldrServiceStatus() (+1 more)
...
Cohesion: 0.25
Nodes (10): markConversationEnded(), encodeClaudeProjectDir(), AgentStateFile, backfillOrphanedSpecialistConversations(), findClaudeSessionUuid(), NON_AGENT_PREFIXES, pollConversations(), scheduleNext() (+2 more)
...
Cohesion: 0.18
Nodes (9): diffAgainstMain(), diffAgainstMainFiles(), diffsRouteLayer, getDiffsRoute, getFullDiffRoute, getTurnDiffRoute, getVsMainDiffRoute, postTestCheckpointRoute (+1 more)
...
Cohesion: 0.24
Nodes (10): array, combine, compareObjects(), hash(), isEqual(), optimize(), random(), structure() (+2 more)
...
Cohesion: 0.2
Nodes (5): execFileMock, postMergeLifecycleMock, readContinueStateEffectMock, readdirSyncMock, resolveGitHubIssueMock

### Community 754 - "Community 754"
Cohesion: 0.27
Nodes (8): InspectContext, getDiffStats(), inspectCommand(), InspectOptions, registerInspectCommand(), inspect, { mockResolveProjectFromIssue, mockSpawnInspectAgent, mockGetDiffBase, mockGetDiffStats }, program

### Community 755 - "Community 755"
Cohesion: 0.2
Nodes (6): actual, capture, FakeBridgeOptions, parsed, socketPath, token
...
Cohesion: 0.2
Nodes (10): assertSafeAgentIdEffect(), captureCheckpointEffect(), deleteAllCheckpointsEffect(), deleteCheckpointEffect(), diffCheckpointFilesEffect(), diffCheckpointsEffect(), diffCheckpointToHeadEffect(), getCheckpointTimestampEffect() (+2 more)
...
Cohesion: 0.2
Nodes (9): code:bash (bd dep add issue-2 issue-1 --type blocks), Contents, Dependencies Not Persisting, Interface-Specific Troubleshooting, Quick Reference: Common Fixes, Related Documentation, Root Cause (Fixed in v0.15.0+), Symptom (+1 more)
...
Cohesion: 0.6
Nodes (4): DatabaseError, getSettingEffect(), isDeaconGloballyPaused(), isFlywheelGloballyPaused()
...
Cohesion: 0.4
Nodes (4): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNamesEffect, mockMarkConversationEnded
...
Cohesion: 0.5
Nodes (3): getShowHealthRoute, getShowRoute, getShowShadowRoute
...
Cohesion: 0.5
Nodes (4): code:bash (ps aux | grep "bd daemon"), code:bash (# Instead of: bd --no-daemon dep add ...), code:bash (cat .beads/issues.jsonl | jq '.dependencies'), Still Not Working?
...
## Knowledge Gaps
- **13566 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13561 more)
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 524`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 38`, `Community 553`, `Community 42`, `Community 44`, `Community 45`, `Community 47`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 576`, `Community 577`, `Community 64`, `Community 68`, `Community 69`, `Community 71`, `Community 588`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 87`, `Community 89`, `Community 95`, `Community 97`, `Community 99`, `Community 102`, `Community 105`, `Community 106`, `Community 115`, `Community 123`, `Community 129`, `Community 138`, `Community 139`, `Community 1168`, `Community 657`, `Community 146`, `Community 148`, `Community 150`, `Community 663`, `Community 176`, `Community 178`, `Community 700`, `Community 191`, `Community 192`, `Community 207`, `Community 219`, `Community 221`, `Community 750`, `Community 249`, `Community 250`, `Community 259`, `Community 260`, `Community 269`, `Community 799`, `Community 800`, `Community 802`, `Community 331`, `Community 341`, `Community 359`, `Community 361`, `Community 388`, `Community 393`, `Community 417`, `Community 431`, `Community 463`, `Community 476`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 35` to `Community 0`, `Community 257`, `Community 260`, `Community 7`, `Community 391`, `Community 135`, `Community 9`, `Community 523`, `Community 11`, `Community 12`, `Community 13`, `Community 1168`, `Community 17`, `Community 1169`, `Community 659`, `Community 660`, `Community 19`, `Community 22`, `Community 20`, `Community 280`, `Community 24`, `Community 26`, `Community 282`, `Community 25`, `Community 23`, `Community 30`, `Community 31`, `Community 32`, `Community 287`, `Community 159`, `Community 33`, `Community 36`, `Community 165`, `Community 38`, `Community 40`, `Community 299`, `Community 47`, `Community 52`, `Community 55`, `Community 700`, `Community 707`, `Community 67`, `Community 69`, `Community 583`, `Community 330`, `Community 1100`, `Community 77`, `Community 78`, `Community 339`, `Community 342`, `Community 91`, `Community 223`, `Community 103`, `Community 107`, `Community 236`, `Community 751`, `Community 239`, `Community 630`, `Community 631`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 26` to `Community 225`, `Community 2`, `Community 40`, `Community 9`, `Community 10`, `Community 45`, `Community 527`, `Community 16`, `Community 81`, `Community 30`, `Community 29`, `Community 190`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 259 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 259 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13566 weakly-connected nodes found - possible documentation gaps or missing edges._
