...
## Corpus Check
- 1548 files · ~2,060,524 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21599 nodes · 31960 edges · 1153 communities (1115 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `917adca5`
...
5. `listSessionNamesAsync()` - 50 edges
...
## Communities (1153 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (134): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+126 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (175): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), cleanupOrphanedReviewSessions(), cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE (+167 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (146): checkFirstCompletionAgents(), isAgentIdleForNudge(), nudgeIdleWorkAgentsWithOpenBeads(), patrolWorkAgentResolutions(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName() (+138 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (123): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+115 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (125): checkPostReviewCommits(), setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (100): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+92 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (94): fetchConversations(), GeneralConversation, GeneralSectionProps, CavemanExperimentRow, CostsPage(), CostsResponse, DailyTrend, ExperimentsResponse (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (102): readCavemanVariant(), checkStuckReviewing(), cleanupOrphanReviewerSessions(), finalizeRunLog(), buildSpecialistCavemanExports(), bumpSessionGeneration(), clearSessionId(), countContextTokens() (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (100): checkDeadEndAgents(), checkFailedMergeRetry(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (95): checkApiErrorAgents(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+87 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (100): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkHeartbeat(), checkMassDeath() (+92 more)
...
Cohesion: 0.03
Nodes (93): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+85 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (90): reconcileAndCheckIfMerged(), reconcileFalseMerged(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile, after (+82 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (78): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+70 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (70): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+62 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (68): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, SwitchModelModal() (+60 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (80): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (76): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (80): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), cleanupLegacyRuntimeSymlinks() (+72 more)
...
Cohesion: 0.03
Nodes (62): ViewMode, CommandDeckProps, ContainerStats, fetchAllSessionTrees(), fetchConversations(), fetchCostsByIssue(), fetchProjects(), fetchRegisteredProjects() (+54 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (69): agentStatusCommand(), AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (71): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, approveCommand(), cancelCommand() (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (67): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+59 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (67): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+59 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (55): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState() (+47 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (51): criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), formatAcceptanceCriteria(), isRFC3339DateTime() (+43 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (64): agentDir, dir1, dir2, marker, missing, nested, buildChildStoriesFromRally(), buildLifecycleContext() (+56 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (60): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+52 more)
...
Cohesion: 0.04
Nodes (51): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+43 more)
...
Cohesion: 0.06
Nodes (57): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+49 more)
...
Cohesion: 0.03
Nodes (60): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCreatedEvent, AgentCurrentIssueSetEvent (+52 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (50): autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation() (+42 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (45): ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel() (+37 more)
...
Cohesion: 0.06
Nodes (52): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig, LauncherHarness (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (44): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, readInferenceDocument(), updateInferenceDocument() (+36 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (48): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd() (+40 more)
...
Cohesion: 0.06
Nodes (40): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+32 more)
...
Cohesion: 0.05
Nodes (35): EventRouter(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase (+27 more)
...
Cohesion: 0.05
Nodes (37): firstSessionPanel, firstWorkbench, workbench, CommandDeck(), IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps (+29 more)
...
Cohesion: 0.05
Nodes (38): Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (35): cn(), WorkTypeTableProps, SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps (+27 more)
...
Cohesion: 0.15
Nodes (44): extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue() (+36 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (42): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+34 more)
...
Cohesion: 0.06
Nodes (38): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+30 more)
...
Cohesion: 0.09
Nodes (40): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+32 more)
...
Cohesion: 0.09
Nodes (36): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec(), writeSpec() (+28 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (38): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), dispatchSwarmWave(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses() (+30 more)
...
Cohesion: 0.1
Nodes (34): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+26 more)
...
Cohesion: 0.11
Nodes (29): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir() (+21 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (29): ComposerMode, IssueComposer(), IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps (+21 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (31): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+23 more)
...
Cohesion: 0.1
Nodes (37): checkStuckWorkAgents(), renderPrompt(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), buildTaskPrompt(), buildTestAgentPromptContent(), resolveWorkspaceGitInfo(), closeOutCommand() (+29 more)

### Community 100 - "Community 100"
Cohesion: 0.06
Nodes (35): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+27 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (31): cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getReauthSessionToken(), invalidateReauthToken(), postCodexReauthRoute (+23 more)
...
Cohesion: 0.07
Nodes (22): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+14 more)
...
Cohesion: 0.1
Nodes (36): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+28 more)
...
Cohesion: 0.08
Nodes (25): ModelProvider, getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter() (+17 more)
...
Cohesion: 0.09
Nodes (30): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+22 more)
...
Cohesion: 0.07
Nodes (27): SETTINGS_FILE, config, config1, config2, configDir, configPath, content, googleProvider (+19 more)
...
Cohesion: 0.12
Nodes (26): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractNumber() (+18 more)
...
Cohesion: 0.08
Nodes (27): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+19 more)

### Community 183 - "Community 183"
Cohesion: 0.09
Nodes (23): withConcurrencyLimit(), ActivityContext, buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute, getIssueDataService() (+15 more)

### Community 184 - "Community 184"
Cohesion: 0.11
Nodes (31): Access, getAgentRuntimeStateAsync(), ActivityContext, closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData() (+23 more)
...
Cohesion: 0.07
Nodes (25): cache, db, loaded, row, rows, savedRow, snapshot, DbAdapter (+17 more)

### Community 193 - "Community 193"
Cohesion: 0.14
Nodes (28): captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), diffAgainstMain(), diffAgainstMainFiles(), diffCheckpointFiles(), diffCheckpoints() (+20 more)
...
Cohesion: 0.11
Nodes (27): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+19 more)
...
Cohesion: 0.11
Nodes (24): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError(), invalidateProbeCache() (+16 more)
...
Cohesion: 0.11
Nodes (25): ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), PipelineState, ZoneAInput (+17 more)

### Community 209 - "Community 209"
Cohesion: 0.06
Nodes (26): companionInTarget, contentAfterFirst, dstScript, gitCwd, gitManifestDir, manifest, manifestAfterFirst, result (+18 more)
...
Cohesion: 0.1
Nodes (25): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentResolution() (+17 more)
...
Cohesion: 0.15
Nodes (26): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths() (+18 more)
...
Cohesion: 0.11
Nodes (21): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose (+13 more)
...
Cohesion: 0.12
Nodes (21): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+13 more)
...
Cohesion: 0.1
Nodes (20): result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions, detectApiError(), extractReviewerRole(), findLatestReviewRunDir(), readReviewerRounds() (+12 more)
...
Cohesion: 0.13
Nodes (17): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+9 more)
...
Cohesion: 0.09
Nodes (18): after, continueContent, continueState, copied, doc, filename, found, log (+10 more)
...
Cohesion: 0.1
Nodes (13): PlanDialog(), PlanDialogProps, PlanningStatus, StartPlanningResult, Step, MOCK_ISSUE, xterm, PlanSetupScreen() (+5 more)
...
Cohesion: 0.13
Nodes (16): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly (+8 more)
...
Cohesion: 0.17
Nodes (18): clearFeedbackFiles(), validatePlanMatchesIssue(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+10 more)
...
Cohesion: 0.21
Nodes (19): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+11 more)
...
Cohesion: 0.21
Nodes (19): isEligibleForCleanup(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation() (+11 more)
...
Cohesion: 0.16
Nodes (15): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+7 more)
...
Cohesion: 0.24
Nodes (16): startPostLaunchSidecars(), startSidecars(), resolveScope(), restartCommand(), LOGS_DIR, readPlatformConfig(), getSupervisorPort(), getSupervisorUrl() (+8 more)
...
Cohesion: 0.12
Nodes (12): makeTestLayer(), mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubRemoveLabel, mockGitHubReopenIssue, mockLinearGetIssue, mockLinearGetTeamStates, mockLinearUpdateState (+4 more)
...
Cohesion: 0.18
Nodes (12): ALLOWED, canUseHarness(), HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, AuthMode, RuntimeName, AUTH_MODES, cells (+4 more)
...
Cohesion: 0.14
Nodes (13): DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), WORK_TYPE_CATEGORIES, allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing (+5 more)
...
Cohesion: 0.17
Nodes (10): future, id, rows, rows1, rows2, GitOperation, GitOperationFilter, GitOperationStatus (+2 more)
...
Cohesion: 0.32
Nodes (10): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+2 more)
...
Cohesion: 0.3
Nodes (10): encodeClaudeProjectDir(), pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId(), resolveJsonlPath(), ResolveJsonlPathOptions, arr (+2 more)
...
Cohesion: 0.18
Nodes (9): getActivityByIdRoute, getActivityDetailedRoute, getActivityRoute, getActivityTtsRoute, getGitActivityRoute, getMetricsCostsRoute, getMetricsStuckRoute, getMetricsSummaryRoute (+1 more)
...
Cohesion: 0.18
Nodes (10): agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSessionExists (+2 more)
...
Cohesion: 0.22
Nodes (9): computeStuckCount(), map, mockGetAgentHealth, mockGetCloisterService, mockGetStatus, mockListRunningAgents, mockLoadReviewStatuses, buildAgentIssueMap() (+1 more)
...
Cohesion: 0.27
Nodes (9): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength() (+1 more)
...
Cohesion: 0.75
Nodes (7): execFileAsync, gitFetch(), gitForcePush(), gitMerge(), gitPush(), gitRevParse(), appendGitOperation()
...
Cohesion: 0.25
Nodes (7): cb, cmdArgs, file, mockExec, mockResolveGitHubIssue, prJson, result
...
Cohesion: 0.38
Nodes (6): getIssueDataService(), getIssueDataService(), getIssueDataService(), getSharedIssueService(), startSharedIssueService(), loadTrackerIssues()
...
Cohesion: 0.53
Nodes (5): getHeader(), getTrustedOrigins(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin()
...
Cohesion: 0.4
Nodes (3): wipeCommand(), WipeOptions, resetToTodo()
...
## Knowledge Gaps
- **11508 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11503 more)
...
- **Why does `fetch` connect `Community 6` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 262`, `Community 650`, `Community 11`, `Community 268`, `Community 12`, `Community 14`, `Community 15`, `Community 653`, `Community 908`, `Community 20`, `Community 149`, `Community 533`, `Community 23`, `Community 534`, `Community 26`, `Community 29`, `Community 31`, `Community 32`, `Community 161`, `Community 34`, `Community 41`, `Community 171`, `Community 172`, `Community 45`, `Community 48`, `Community 561`, `Community 49`, `Community 57`, `Community 65`, `Community 70`, `Community 205`, `Community 598`, `Community 599`, `Community 603`, `Community 94`, `Community 100`, `Community 492`, `Community 758`, `Community 122`, `Community 379`, `Community 127`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 25`, `Community 2`, `Community 11`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 182` to `Community 242`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11508 weakly-connected nodes found - possible documentation gaps or missing edges._
