...
## Corpus Check
- 1914 files · ~3,141,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27693 nodes · 44040 edges · 1289 communities (1233 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 802 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40f1c6ba`
...
4. `getDatabase()` - 121 edges
5. `useDashboardStore` - 87 edges
6. `FsError` - 80 edges
7. `sessionExistsAsyncEffect()` - 69 edges
8. `sessionExistsAsync()` - 67 edges
9. `cn()` - 65 edges
10. `spawnRun()` - 59 edges
...
## Communities (1289 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (229): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), autoResumeStoppedWorkAgents(), isVerifyPausedAgentState(), notifyAgentStatusChanged() (+221 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (201): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+193 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (167): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+159 more)
...
Cohesion: 0.01
Nodes (152): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+144 more)
...
Cohesion: 0.02
Nodes (133): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+125 more)
...
Cohesion: 0.02
Nodes (139): cleanupStaleAgentState(), containerRestartBackoffMs(), DeaconState, monitorReviewConvoySignals(), captureTmuxOutput(), isMergeAgentRunning(), customPromisify, justNow (+131 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (127): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, AwaitingInputDetection, AwaitingInputReason, compactPrompt() (+119 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (123): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier (+115 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (119): importTrackerConfig(), AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+111 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (100): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), confirmHostOverride(), countBeadsTasks() (+92 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (107): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+99 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (96): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+88 more)
...
Cohesion: 0.03
Nodes (85): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+77 more)
...
Cohesion: 0.02
Nodes (99): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+91 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (101): printActiveSliceForIssue(), annotated, before, candidate, check, claimed, defaults, doc (+93 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (93): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+85 more)
...
Cohesion: 0.04
Nodes (89): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+81 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (85): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+77 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (85): projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions (+77 more)
...
Cohesion: 0.03
Nodes (77): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps (+69 more)
...
Cohesion: 0.03
Nodes (80): agentDir, dir1, dir2, marker, missing, nested, pending, withBdMutex() (+72 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (71): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+63 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (63): NormalizedTtsDaemonConfig, acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+55 more)
...
Cohesion: 0.04
Nodes (63): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime() (+55 more)
...
Cohesion: 0.04
Nodes (67): buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+59 more)
...
Cohesion: 0.04
Nodes (72): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+64 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (59): PanSpecListOptions, ProjectPanPaths, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path, paths (+51 more)
...
Cohesion: 0.05
Nodes (70): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), completePlanningArtifacts(), checkPlanStatusEffect(), readWorkspacePlanAsync() (+62 more)
...
Cohesion: 0.03
Nodes (63): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt(), cleanupLegacySpecialistsDirectory() (+55 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (58): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+50 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (69): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+61 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (66): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+58 more)

### Community 52 - "Community 52"
Cohesion: 0.03
Nodes (71): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+63 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (61): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+53 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (57): confirmCost(), enrichAction(), formatCost(), showAction(), runWithPool(), WorkPoolStats, findDiscoveredSessionIds(), getDiscoveredSessionById() (+49 more)
...
Cohesion: 0.05
Nodes (49): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc (+41 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (62): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+54 more)

### Community 58 - "Community 58"
Cohesion: 0.03
Nodes (58): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+50 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (54): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+46 more)
...
Cohesion: 0.06
Nodes (16): issues, result, findProjectsByRallyProject(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+8 more)
...
Cohesion: 0.04
Nodes (47): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+39 more)
...
Cohesion: 0.07
Nodes (45): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+37 more)
...
Cohesion: 0.08
Nodes (46): getReviewStatusAsyncEffect(), setReviewStatusAsync(), setReviewStatusAsyncEffect(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+38 more)
...
Cohesion: 0.05
Nodes (51): resetDb(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv, created, list (+43 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (58): addCommentBefore(), ALIAS, anchorIsValid(), atDocument(), callVisitor(), captureTldrMetrics(), clone(), constructor() (+50 more)
...
Cohesion: 0.09
Nodes (54): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyNonBlocking(), bridgeGeminiAuthToCliproxyNonBlocking(), buildCliproxyConfig(), checkCliproxyPortNonBlocking(), cliproxyCatch(), CliproxyCodexCredentials (+46 more)
...
Cohesion: 0.05
Nodes (45): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+37 more)
...
Cohesion: 0.04
Nodes (51): UpsertDiscoveredSessionOpts, updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema (+43 more)
...
Cohesion: 0.07
Nodes (32): wipeCommand(), WipeOptions, CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut() (+24 more)
...
Cohesion: 0.05
Nodes (42): entry, { issueId }, { limit }, old, op, ops, recent, resetDb() (+34 more)
...
Cohesion: 0.09
Nodes (46): clearFlywheelRunGate(), flywheelAbortCommand(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate(), decodeFlywheelRunId (+38 more)

### Community 104 - "Community 104"
Cohesion: 0.06
Nodes (35): ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), TeardownOptions, WorkflowResult, approve() (+27 more)

### Community 105 - "Community 105"
Cohesion: 0.1
Nodes (47): movePrdImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeRallyDirectImpl(), execAsync, cleanupLabelsGitHub() (+39 more)
...
Cohesion: 0.06
Nodes (33): content, d, existingDir, lines, oldDir, result, skillDir, getDefaultWorkspaceConfig() (+25 more)
...
Cohesion: 0.08
Nodes (10): ensureExcalidrawMcp(), ensurePlaywrightIsolation(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfig(), changed, config, result, effFromPromise() (+2 more)
...
Cohesion: 0.07
Nodes (28): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+20 more)

### Community 141 - "Community 141"
Cohesion: 0.08
Nodes (40): getConversationByClaudeSessionId(), isRecord(), isSubagentHookPayload(), SubagentHookPayload, enqueuePipeline, getTranscriptSize, registerTranscript, response (+32 more)
...
Cohesion: 0.06
Nodes (27): appendJsonl(), ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling() (+19 more)
...
Cohesion: 0.07
Nodes (31): clearFeedbackFiles(), readWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths() (+23 more)
...
Cohesion: 0.09
Nodes (6): stopDeacon(), createHandoffEvent(), CloisterService, readStateFile(), writeStateFile(), closeDatabase()
...
Cohesion: 0.1
Nodes (33): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+25 more)
...
Cohesion: 0.07
Nodes (23): getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+15 more)
...
Cohesion: 0.1
Nodes (26): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+18 more)
...
Cohesion: 0.09
Nodes (18): ProjectConfig, StepResult, after, before, cfg, compose, ph, result (+10 more)
...
Cohesion: 0.1
Nodes (17): RoundMarker, deriveRoundMarkers(), TimestampedItem, resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView() (+9 more)
...
Cohesion: 0.11
Nodes (22): setupCavemanCompressScripts(), after, backupPath, backups, calls, errSpy, exitSpy, original (+14 more)
...
Cohesion: 0.14
Nodes (17): FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+9 more)
...
}, kCustom, mergePromise, withRepoArtifactUrl(), withRepoState(), createReviewArtifactsForIssue(), execAsync (+6 more)
...
Cohesion: 0.1
Nodes (15): ExtractedPayload, fallback, identity, primary, provider, recordHealth, result, TestProvider (+7 more)
...
Cohesion: 0.13
Nodes (17): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect(), readBeadsFromJsonl() (+9 more)
...
Cohesion: 0.17
Nodes (13): archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir (+5 more)
...
Cohesion: 0.12
Nodes (13): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateAsync, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockSpawnAgent (+5 more)
...
Cohesion: 0.13
Nodes (12): mockDeepWipe, mockExistsSync, mockGetAgentState, mockGetAgentStateAsync, mockGetAgentStateEffect, mockMessageAgent, mockMkdir, mockSpawnAgent (+4 more)
...
Cohesion: 0.18
Nodes (11): addPanopticonHookIfMissing(), ClaudeSettings, HookConfig, installJq(), isHookConfigured(), McpServer, SetupHooksOptions, added (+3 more)
...
Cohesion: 0.2
Nodes (12): bucketByTime(), classifyTimeBucket(), isSameLocalDay(), TimeBucketed, toDate(), buckets, Item, now (+4 more)
...
## Knowledge Gaps
- **13604 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13599 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 29`, `Community 31`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 43`, `Community 44`, `Community 48`, `Community 50`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 568`, `Community 58`, `Community 59`, `Community 60`, `Community 63`, `Community 68`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 84`, `Community 85`, `Community 86`, `Community 89`, `Community 93`, `Community 100`, `Community 103`, `Community 105`, `Community 106`, `Community 116`, `Community 123`, `Community 130`, `Community 137`, `Community 652`, `Community 142`, `Community 654`, `Community 153`, `Community 155`, `Community 165`, `Community 190`, `Community 191`, `Community 192`, `Community 201`, `Community 205`, `Community 743`, `Community 233`, `Community 242`, `Community 273`, `Community 794`, `Community 795`, `Community 289`, `Community 300`, `Community 302`, `Community 320`, `Community 322`, `Community 323`, `Community 333`, `Community 336`, `Community 379`, `Community 382`, `Community 406`, `Community 411`, `Community 443`, `Community 446`, `Community 447`, `Community 484`, `Community 489`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 42` to `Community 194`, `Community 35`, `Community 165`, `Community 38`, `Community 37`, `Community 104`, `Community 522`, `Community 44`, `Community 303`, `Community 208`, `Community 19`, `Community 56`, `Community 25`, `Community 29`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 7` to `Community 1`, `Community 2`, `Community 385`, `Community 5`, `Community 6`, `Community 10`, `Community 267`, `Community 13`, `Community 272`, `Community 16`, `Community 18`, `Community 17`, `Community 23`, `Community 24`, `Community 28`, `Community 156`, `Community 543`, `Community 160`, `Community 289`, `Community 34`, `Community 161`, `Community 33`, `Community 42`, `Community 43`, `Community 44`, `Community 172`, `Community 432`, `Community 53`, `Community 54`, `Community 695`, `Community 58`, `Community 191`, `Community 192`, `Community 63`, `Community 64`, `Community 448`, `Community 324`, `Community 447`, `Community 67`, `Community 322`, `Community 335`, `Community 80`, `Community 209`, `Community 337`, `Community 84`, `Community 94`, `Community 225`, `Community 102`, `Community 744`, `Community 622`, `Community 242`, `Community 123`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 217 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 217 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13604 weakly-connected nodes found - possible documentation gaps or missing edges._
