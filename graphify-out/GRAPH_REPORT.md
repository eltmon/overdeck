...
## Summary
- 28272 nodes · 47309 edges · 1288 communities (1233 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 951 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8ef3a7d`
...
## Communities (1288 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (228): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+220 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (174): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+166 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (164): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+156 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (171): cleanupSpawnAndOrphanedStashes(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performHandoffPromise() (+163 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (168): buildInspectPrompt(), __dirname, __filename, InspectResult, spawnInspectAgent(), spawnInspectAgentPromise(), killPostMergeRoleSessions(), buildSpecialistBaseCommand() (+160 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (159): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+151 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (125): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+117 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (140): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise() (+132 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (142): TurnDiffFileChange, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork() (+134 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (129): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+121 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (140): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+132 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (118): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneA(), ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, OverviewTab (+110 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (124): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+116 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (116): WipeOptions, extractNumber(), extractNumberSync(), extractPrefix(), extractPrefixSync(), extractStandardNumber(), extractStandardNumberSync(), extractStandardPrefix() (+108 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (100): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+92 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (105): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, content (+97 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (92): checkCostLimits(), checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (114): tableCell(), string(), buildChildEnv(), buildChildEnvSync(), buildChildEnvWithoutTmux(), buildChildEnvWithoutTmuxSync(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS (+106 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (117): detectMergedSwarmSlots(), reconcileAndCheckIfMerged(), recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), buildShipPreparationPrompt() (+109 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (101): transitionIssueToVerifyingOnMain(), importTrackerConfig(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+93 more)
...
Cohesion: 0.03
Nodes (108): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, agentsRouteLayer, postAgentMessageLikeRoute() (+100 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (75): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+67 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (89): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed() (+81 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (98): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+90 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (105): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), findLocalWorkspace(), DASHBOARD_URL (+97 more)
...
Cohesion: 0.04
Nodes (95): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), runCommand(), RunOptions (+87 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (99): extractAcceptanceCriteria(), getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES (+91 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (76): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions, DialogContext (+68 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (94): HookItem, computeQueuePositionFromStatus(), computeQueuePositionFromStatusSync(), findPositionInQueue(), findPositionInQueueSync(), QueuePositionResult, items, result (+86 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (88): checkStuckWorkAgents(), parseThinkingDuration(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+80 more)
...
Cohesion: 0.03
Nodes (73): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (72): checkCommand(), syncCommand(), SyncOptions, createBackup(), createBackupSync(), createBackupTimestamp(), ensureExcalidrawMcp(), ensureExcalidrawMcpSync() (+64 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (84): AgentRuntimeState, claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints() (+76 more)
...
Cohesion: 0.04
Nodes (77): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+69 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (78): agentDir, dir1, dir2, marker, missing, nested, PlanningIssue, invalidateAgentsCache() (+70 more)
...
Cohesion: 0.06
Nodes (86): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), anchorNames(), applyReviver() (+78 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (63): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+55 more)
...
Cohesion: 0.03
Nodes (68): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+60 more)
...
Cohesion: 0.04
Nodes (15): createFlyApiClient(), createFlyApiClientSync(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client (+7 more)
...
Cohesion: 0.04
Nodes (60): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+52 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (61): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, encodeClaudeProjectDir(), result, pathExists() (+53 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (55): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+47 more)

### Community 56 - "Community 56"
Cohesion: 0.03
Nodes (64): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionsByIds() (+56 more)
...
Cohesion: 0.04
Nodes (55): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+47 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (49): doneCommand(), DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+41 more)
...
Cohesion: 0.07
Nodes (56): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile() (+48 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (51): destroyRemoteWorkspace(), buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), getClaudePermissionFlagsStringSync(), getClaudePermissionFlagsSync() (+43 more)
...
Cohesion: 0.05
Nodes (62): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+54 more)
...
Cohesion: 0.06
Nodes (54): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+46 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (51): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+43 more)
...
Cohesion: 0.06
Nodes (51): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+43 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (46): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+38 more)
...
Cohesion: 0.06
Nodes (29): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getActiveSessionModelSync(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles() (+21 more)
...
Cohesion: 0.05
Nodes (39): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel(), getDefaultConversationModel() (+31 more)
...
Cohesion: 0.08
Nodes (51): ScanOptions, normalizeFilter(), RawFilter, SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+43 more)
...
Cohesion: 0.08
Nodes (44): shellQuote(), verifyMergedBeforeLifecycle(), getTrackerContext(), projectListCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), formatComments() (+36 more)
...
Cohesion: 0.06
Nodes (42): detectPlatform(), Platform, evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), buildLeakedSpecialists() (+34 more)
...
Cohesion: 0.05
Nodes (34): SearchResult, getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+26 more)
...
Cohesion: 0.08
Nodes (40): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+32 more)
...
Cohesion: 0.08
Nodes (37): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+29 more)
...
Cohesion: 0.06
Nodes (32): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+24 more)
...
Cohesion: 0.07
Nodes (40): AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock (+32 more)
...
Cohesion: 0.1
Nodes (33): CostCache, getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir(), getCostsForIssue(), getCostsForIssueSync() (+25 more)
...
Cohesion: 0.12
Nodes (37): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+29 more)

### Community 186 - "Community 186"
Cohesion: 0.09
Nodes (30): getDiscoveredSessionById(), markEnrichmentFailed(), searchFts(), updateEnrichment(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+22 more)
...
Cohesion: 0.09
Nodes (31): evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji(), getHealthLabel(), getMultipleAgentHealth() (+23 more)
...
Cohesion: 0.1
Nodes (18): parsePiSession(), parsePiSessionSync(), agentDirFor(), agentsDir(), PiRuntime, PiRuntimeSync, piSessionDirFor(), readReady() (+10 more)
...
Cohesion: 0.09
Nodes (29): embedAction(), runWithPool(), WorkPoolStats, DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult (+21 more)
...
Cohesion: 0.08
Nodes (26): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), createConfiguredClaudeApi(), EnrichSessionOptions, CostThresholdError (+18 more)
...
Cohesion: 0.11
Nodes (19): cleanupPiTransientFiles(), execAsync, createPiFifo(), createPiFifoPromise(), destroyPiFifo(), destroyPiFifoSync(), execAsync, PiFifoError (+11 more)

### Community 253 - "Community 253"
Cohesion: 0.18
Nodes (32): atLineEnd(), charAt(), compose(), continueScalar(), end(), getLine(), hasChars(), isEmpty() (+24 more)
...
Cohesion: 0.08
Nodes (21): ConversationTerminalProps, resumeConversation(), StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage (+13 more)
...
Cohesion: 0.1
Nodes (31): addCommentBefore(), captureTldrMetrics(), captureTldrMetricsSync(), clone(), createStringifyContext(), formatPropertyKey(), getErrorPos(), getTagObject() (+23 more)
...
Cohesion: 0.07
Nodes (21): cancelIssueWorkflow(), deepWipe(), destructiveResetWorkflow(), resetToTodo(), archiveIdx, beadsDir, branchStep, clearStep (+13 more)

### Community 269 - "Community 269"
Cohesion: 0.11
Nodes (21): appendCostEvent(), appendCostEventSync(), deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+13 more)
...
Cohesion: 0.12
Nodes (23): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), executeCloseOutPromise() (+15 more)
...
Cohesion: 0.13
Nodes (24): addEventToCache(), createEmptyCache(), rebuildCache(), rebuildCacheSync(), readEvents(), readEventsSync(), getRetentionStatus(), getRetentionStatusSync() (+16 more)
...
Cohesion: 0.15
Nodes (21): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, getSmeeBinaryPath(), startSmeeProcess(), startSmeeProcessSync(), getSupervisorPort(), getSupervisorPortSync() (+13 more)
...
Cohesion: 0.1
Nodes (3): getProjectDirs(), ClaudeCodeRuntime, ClaudeCodeRuntimeEffect

### Community 329 - "Community 329"
Cohesion: 0.14
Nodes (22): eventsFileExists(), getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+14 more)
...
Cohesion: 0.11
Nodes (8): clientMock, octokitMock, result, states, GitHubTracker, octokitToEffect(), octokitToProgram(), parseIssueNumber()
...
Cohesion: 0.18
Nodes (19): ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, heartbeatsDir(), panopticonDir(), PiSpawnConfig (+11 more)
...
Cohesion: 0.13
Nodes (12): loadConfigNoMigration(), NormalizedTtsDaemonConfig, hasTtsDaemonState(), isTtsDaemonManuallyStopped(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig (+4 more)
...
Cohesion: 0.1
Nodes (20): execAsync, logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs, logPath, mockCleanupAllLogs (+12 more)
...
Cohesion: 0.17
Nodes (18): forkCommand(), ForkOptions, getConversationByClaudeSessionId(), getConversationById(), rowToConversation(), sessionFilePath(), buildContinuation(), convertConversationTranscript() (+10 more)

### Community 432 - "Community 432"
Cohesion: 0.14
Nodes (18): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+10 more)
...
Cohesion: 0.13
Nodes (11): calls, claimRange, commitRange, compress, emitObservationCreated, extract, maybeTriggerRollup, releaseRange (+3 more)
...
- **Why does `string()` connect `Community 17` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 50`, `Community 51`, `Community 56`, `Community 57`, `Community 58`, `Community 571`, `Community 572`, `Community 576`, `Community 67`, `Community 69`, `Community 73`, `Community 80`, `Community 81`, `Community 85`, `Community 87`, `Community 90`, `Community 93`, `Community 97`, `Community 101`, `Community 114`, `Community 115`, `Community 118`, `Community 123`, `Community 644`, `Community 136`, `Community 141`, `Community 150`, `Community 153`, `Community 684`, `Community 685`, `Community 1198`, `Community 177`, `Community 185`, `Community 186`, `Community 187`, `Community 188`, `Community 207`, `Community 737`, `Community 243`, `Community 776`, `Community 777`, `Community 266`, `Community 286`, `Community 287`, `Community 311`, `Community 327`, `Community 333`, `Community 338`, `Community 342`, `Community 343`, `Community 388`, `Community 390`, `Community 412`, `Community 413`, `Community 430`, `Community 434`, `Community 447`, `Community 466`, `Community 477`, `Community 1015`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 23` to `Community 34`, `Community 38`, `Community 6`, `Community 10`, `Community 12`, `Community 268`, `Community 50`, `Community 214`, `Community 26`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 1` to `Community 128`, `Community 131`, `Community 6`, `Community 392`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 142`, `Community 529`, `Community 18`, `Community 20`, `Community 277`, `Community 278`, `Community 23`, `Community 24`, `Community 25`, `Community 21`, `Community 26`, `Community 29`, `Community 30`, `Community 161`, `Community 33`, `Community 37`, `Community 166`, `Community 42`, `Community 684`, `Community 44`, `Community 300`, `Community 51`, `Community 692`, `Community 53`, `Community 185`, `Community 186`, `Community 58`, `Community 60`, `Community 61`, `Community 67`, `Community 73`, `Community 332`, `Community 464`, `Community 84`, `Community 86`, `Community 87`, `Community 216`, `Community 94`, `Community 95`, `Community 231`, `Community 616`, `Community 104`, `Community 241`, `Community 242`, `Community 500`, `Community 255`?**
