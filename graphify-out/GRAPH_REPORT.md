...
## Corpus Check
- 1542 files · ~2,037,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21771 nodes · 32339 edges · 1128 communities (1093 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 435 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8fcfbce`
...
5. `spawnEphemeralSpecialist()` - 53 edges
...
## Communities (1128 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (134): readCavemanVariant(), checkPendingTestDispatch(), buildReviewBaseCommand(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), buildTestRolePrompt(), dashboardApiUrl() (+126 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (141): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+133 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): setAgentStoppedNotifier(), spawnReviewCoordinatorSession(), CopyConfigOptions, after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (111): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+103 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (119): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+111 more)
...
Cohesion: 0.03
Nodes (124): buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), performSpecialistWake() (+116 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (119): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync, getFilesChangedFromPR() (+111 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (106): backupCleanCommand(), backupListCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BUNDLED_GIT_HOOKS_DIR (+98 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (109): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+101 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (89): format(), LiveCounter(), LiveCounterProps, PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel() (+81 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (91): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+83 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (95): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (77): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+69 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (87): configShadowCommand(), ShadowOptions, contextCommand(), ContextOptions, cvCommand(), CVOptions, refreshCommand(), refreshFromLinear() (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (78): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AGENT_ICONS, AgentWarningDialogProps (+70 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (87): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+79 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (75): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+67 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (89): listTestsCommand(), registerTestCommands(), RunOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (87): reconcileFalseMerged(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile, after, body (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (86): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (76): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+68 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (77): dismissDevChannelsDialog(), isClaudeRunningInSession(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS (+69 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (68): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+60 more)
...
Cohesion: 0.06
Nodes (73): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+65 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (69): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), findSpecByIssue() (+61 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (68): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+60 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (54): fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS (+46 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (61): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+53 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (64): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+56 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (61): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), loadPinState(), PHASE_CHIP_COLORS (+53 more)
...
Cohesion: 0.05
Nodes (62): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (56): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, computePlanningState(), beadsDir, doc, badPath, customPlanningDir (+48 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (53): criteria, doc, result, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument() (+45 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (57): generateFallbackSummary(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (65): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+57 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (58): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), dropStash() (+50 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (43): parsePiSession(), createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), agentDirFor() (+35 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (47): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+39 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (51): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (58): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (51): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (49): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+41 more)
...
Cohesion: 0.06
Nodes (49): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+41 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (42): withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+34 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (43): LiveLastHeard(), stalenessClass(), executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth (+35 more)
...
Cohesion: 0.06
Nodes (48): Access, encodeClaudeProjectDir(), buildConversationResponse(), getCachedMessages(), validateCwdContainment(), pathExists(), pickFreshestSessionId(), readOptional() (+40 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (42): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+34 more)
...
Cohesion: 0.06
Nodes (29): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffWorkerPoolProvider() (+21 more)
...
Cohesion: 0.08
Nodes (34): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+26 more)
...
Cohesion: 0.08
Nodes (26): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+18 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (38): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+30 more)
...
Cohesion: 0.12
Nodes (30): createTracker(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker (+22 more)
...
Cohesion: 0.07
Nodes (30): createPiFifo(), destroyPiFifo(), execAsync, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand(), PiSpawnTimeout (+22 more)
...
Cohesion: 0.06
Nodes (26): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+18 more)
...
Cohesion: 0.09
Nodes (35): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+27 more)
...
Cohesion: 0.06
Nodes (32): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+24 more)
...
Cohesion: 0.1
Nodes (3): stopDeacon(), CloisterService, writeStateFile()
...
Cohesion: 0.09
Nodes (20): captureTldrMetrics(), daemonRegistry, ensureTldrStateDir(), execAsync, getStateFilePath(), getTldrMetrics(), hashWorkspacePath(), listTldrDaemonServices() (+12 more)
...
Cohesion: 0.08
Nodes (33): cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent(), getRecentHealthHistory(), HealthEvent (+25 more)

### Community 161 - "Community 161"
Cohesion: 0.08
Nodes (31): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+23 more)
...
Cohesion: 0.1
Nodes (28): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), ARCHIVES_DIR (+20 more)
...
Cohesion: 0.13
Nodes (28): archivePlanning(), closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+20 more)
...
Cohesion: 0.09
Nodes (22): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+14 more)
...
Cohesion: 0.1
Nodes (26): HandoffContext, createHandoffEvent(), ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+18 more)
...
Cohesion: 0.09
Nodes (25): calculateCost(), DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing, anthropicModels, cost, entries (+17 more)
...
Cohesion: 0.13
Nodes (20): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+12 more)
...
Cohesion: 0.08
Nodes (20): allOps, divergedOp, execAsync, execFileMock, execMock, ops, opTypes, status (+12 more)
...
Cohesion: 0.11
Nodes (13): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, PanRpcProtocolClient, resetTransport() (+5 more)
...
Cohesion: 0.15
Nodes (19): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), buildSyncFailureFeedback() (+11 more)
...
Cohesion: 0.34
Nodes (19): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+11 more)

### Community 354 - "Community 354"
Cohesion: 0.11
Nodes (16): MessagesTimeline, RoundMarker, deriveRoundMarkers(), TimestampedItem, markers, MESSAGES, meta, divider (+8 more)
...
Cohesion: 0.15
Nodes (12): ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView(), SessionPanel() (+4 more)
...
Cohesion: 0.14
Nodes (15): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel (+7 more)
...
Cohesion: 0.19
Nodes (13): getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), resolveProjectReposFromResolvedIssue(), projectConfig (+5 more)

### Community 405 - "Community 405"
Cohesion: 0.19
Nodes (14): getForgeAdapter(), buildMergeSetForIssue(), ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue() (+6 more)
...
Cohesion: 0.28
Nodes (15): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions, closeLinearDirect() (+7 more)
...
Cohesion: 0.15
Nodes (12): code:block24 (Worker Agent completes work), Getting Help, Optional, Panopticon Usage Guide, Platform Support, Required, Requirements, Specialist Types (+4 more)
...
Cohesion: 0.15
Nodes (12): After Planning, Basic Usage, code:bash (# Start planning session for an issue), code:bash (# Create workspace with plan), code:bash (# Agent reads plan), Dashboard Planning Interface, More Information, Overview (+4 more)
...
Cohesion: 0.17
Nodes (11): agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSessionExists (+3 more)
...
Cohesion: 0.2
Nodes (7): loadCloisterConfig(), { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, determineModel(), determineHealthStatusAsync()
...
Cohesion: 0.33
Nodes (11): getVBriefACStatus(), checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode(), execAsync, execFileAsync, isMissingCommand() (+3 more)
...
Cohesion: 0.18
Nodes (10): ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, StepResult, TeardownOptions, WorkflowResult, EnsureDevcontainerInput (+2 more)
...
## Knowledge Gaps
- **11592 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11587 more)
...
- **Why does `fetch` connect `Community 4` to `Community 2`, `Community 3`, `Community 5`, `Community 133`, `Community 7`, `Community 8`, `Community 136`, `Community 266`, `Community 12`, `Community 525`, `Community 14`, `Community 13`, `Community 16`, `Community 142`, `Community 18`, `Community 19`, `Community 152`, `Community 24`, `Community 30`, `Community 31`, `Community 35`, `Community 36`, `Community 38`, `Community 551`, `Community 427`, `Community 48`, `Community 179`, `Community 51`, `Community 53`, `Community 58`, `Community 59`, `Community 61`, `Community 67`, `Community 589`, `Community 79`, `Community 81`, `Community 739`, `Community 369`, `Community 631`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 134` to `Community 0`, `Community 16`, `Community 28`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 2` to `Community 4`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 164 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 164 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11592 weakly-connected nodes found - possible documentation gaps or missing edges._
