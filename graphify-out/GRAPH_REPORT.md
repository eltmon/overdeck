# Graph Report - feature-pan-1053  (2026-05-15)

## Corpus Check
- 1614 files · ~2,173,580 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22889 nodes · 34625 edges · 1170 communities (1129 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 474 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `45445966`
...
## Communities (1170 total, 41 thin omitted)
...
Cohesion: 0.03
Nodes (160): __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent(), spawnReviewCoordinatorSession(), spawnSingleReviewer() (+152 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (134): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+126 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (115): PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, CodexAuthBanner(), formatCost() (+107 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (132): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+124 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (147): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash() (+139 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (138): checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState() (+130 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (133): cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+125 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (134): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+126 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (105): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (103): showCommand(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (97): isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+89 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (82): parsePiSession(), waitForPiAgentReady(), writePiAgentPrompt(), agentState, callOrder, checkFn, killed, mockGetAgentState (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (101): DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan(), swarmCommand(), taskOperation() (+93 more)
...
Cohesion: 0.04
Nodes (85): checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand() (+77 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (79): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider() (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (73): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+65 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (80): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+72 more)
...
Cohesion: 0.07
Nodes (83): calls, { mockExecAsync }, opts, ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths() (+75 more)
...
Cohesion: 0.05
Nodes (83): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (78): getTrackerContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart(), findLocalWorkspace() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (78): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+70 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (78): setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+70 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (70): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+62 more)
...
Cohesion: 0.04
Nodes (71): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+63 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (73): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+65 more)
...
Cohesion: 0.04
Nodes (73): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+65 more)
...
Cohesion: 0.05
Nodes (59): configShadowCommand(), ShadowOptions, shadowCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand() (+51 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (64): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+56 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (62): loadCloisterConfig(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffContext (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (53): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+45 more)
...
Cohesion: 0.04
Nodes (54): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+46 more)
...
Cohesion: 0.05
Nodes (54): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+46 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (47): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+39 more)
...
Cohesion: 0.04
Nodes (50): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+42 more)
...
Cohesion: 0.06
Nodes (47): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (49): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+41 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (45): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+37 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (39): AutoPresoSession, emitter, emitter, onTurn, getHeader(), getTrustedOrigins(), isTrustedOriginForHost(), normalizeOrigin() (+31 more)
...
Cohesion: 0.05
Nodes (41): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL (+33 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (49): Access, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session() (+41 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (45): checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus(), AGENTS_DIR (+37 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (35): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, fetchMock (+27 more)
...
Cohesion: 0.08
Nodes (40): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+32 more)
...
Cohesion: 0.07
Nodes (39): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+31 more)
...
Cohesion: 0.06
Nodes (40): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+32 more)
...
Cohesion: 0.04
Nodes (28): beadsDir, doc, createCall, dbError, deleteCalls, doc, existingBeads, expectedPrefix (+20 more)
...
Cohesion: 0.07
Nodes (39): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+31 more)
...
Cohesion: 0.06
Nodes (34): ClaudeAuthStatus, getClaudeAuthStatus(), parseOAuthPayload(), readKeychainCredentials(), getAvailableModelsRoute, getClaudeAuthRoute, getHarnessPolicyRoute, getMiniMaxDefaultsRoute (+26 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (31): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+23 more)
...
Cohesion: 0.06
Nodes (34): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, deleteDockerContainerRoute (+26 more)
...
Cohesion: 0.07
Nodes (30): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+22 more)
...
Cohesion: 0.07
Nodes (28): RoundMarker, fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR (+20 more)
...
Cohesion: 0.05
Nodes (37): Activity, AgentChannelReply, AgentId, AgentPhase, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES (+29 more)
...
Cohesion: 0.09
Nodes (29): activeViolations, checkAgentForViolations(), clearOldViolations(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig, FPPViolationType, getActiveViolations() (+21 more)
...
Cohesion: 0.07
Nodes (28): SETTINGS_FILE, config, config1, config2, configDir, configPath, content, googleProvider (+20 more)
...
Cohesion: 0.1
Nodes (28): buildReviewContext(), BuildReviewContextOpts, ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+20 more)
...
Cohesion: 0.11
Nodes (23): withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+15 more)
...
Cohesion: 0.12
Nodes (27): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+19 more)
...
Cohesion: 0.11
Nodes (25): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+17 more)
...
Cohesion: 0.13
Nodes (23): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+15 more)
...
Cohesion: 0.13
Nodes (21): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+13 more)
...
Cohesion: 0.12
Nodes (23): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl() (+15 more)
...
Cohesion: 0.17
Nodes (23): assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), getAttachmentCache(), getAttachmentCacheKey(), getConversationAttachmentDir() (+15 more)
...
Cohesion: 0.09
Nodes (15): AgentState, __testInternals, dir, legacyDir, rawState, state, validDir, warnSpy (+7 more)

### Community 352 - "Community 352"
Cohesion: 0.1
Nodes (20): Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), allModelIds (+12 more)
...
Cohesion: 0.12
Nodes (17): buildPermissionActivityDetails(), buildPermissionWaitingMessage(), parsePermissionResponseBehavior(), permissionResolutionVerb(), processPermissionResponse(), ProcessPermissionResponseDeps, ProcessPermissionResponseResult, redactPermissionInputPreview() (+9 more)
...
Cohesion: 0.17
Nodes (16): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput() (+8 more)
...
Cohesion: 0.19
Nodes (12): AutoPresoControls(), AutoPresoView(), Excalidraw, ExcalidrawApiLike, TranscriptPanel(), AutoPresoMessage, AutoPresoMode, ExcalidrawElementLike (+4 more)
...
Cohesion: 0.25
Nodes (12): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+4 more)
...
Cohesion: 0.15
Nodes (12): Auto-planning, Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071), code:bash (pan plan PAN-1071 --auto), Panopticon Planning Lifecycle, Related commands (+4 more)
...
## Knowledge Gaps
- **12075 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12070 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 776`, `Community 137`, `Community 135`, `Community 9`, `Community 13`, `Community 14`, `Community 399`, `Community 16`, `Community 20`, `Community 660`, `Community 22`, `Community 663`, `Community 26`, `Community 155`, `Community 540`, `Community 29`, `Community 28`, `Community 287`, `Community 31`, `Community 289`, `Community 546`, `Community 547`, `Community 37`, `Community 170`, `Community 47`, `Community 48`, `Community 178`, `Community 53`, `Community 58`, `Community 571`, `Community 62`, `Community 191`, `Community 832`, `Community 213`, `Community 611`, `Community 615`, `Community 112`, `Community 113`, `Community 246`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 7` to `Community 160`, `Community 1`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 15`, `Community 48`, `Community 21`, `Community 55`, `Community 58`, `Community 29`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 144` to `Community 1`, `Community 6`, `Community 14`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12075 weakly-connected nodes found - possible documentation gaps or missing edges._
