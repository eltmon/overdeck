...
## Corpus Check
- 1621 files · ~2,206,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23008 nodes · 34800 edges · 1180 communities (1138 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `854894d0`
...
## Communities (1180 total, 42 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (175): __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent(), renderPrompt(), spawnSingleReviewer() (+167 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (159): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+151 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (136): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (142): archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, DEFAULT_REVIEW_AGENTS, execAsync, getFilesChangedFromPR() (+134 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (105): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+97 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (100): ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS, resumeConversation() (+92 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (101): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), emergencyStop(), fetchCloisterStatus(), fetchConversations() (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (107): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+99 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (98): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+90 more)
...
Cohesion: 0.04
Nodes (97): readWorkspacePlanAsync(), readWorkspaceContinue(), readWorkspaceContinueAsync(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), writeWorkspaceContinueAsync() (+89 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (80): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+72 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (89): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, requireTrustedOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+81 more)
...
Cohesion: 0.05
Nodes (86): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), buildPanSpecFilename() (+78 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (81): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (74): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (70): getUnblockedItems(), TERMINAL_STATUSES, criteria, doc, result, fsHooks, first, found (+62 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (70): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+62 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (82): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+74 more)
...
Cohesion: 0.03
Nodes (70): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+62 more)
...
Cohesion: 0.05
Nodes (83): closeOutCommand(), CloseOutOptions, getGitHubConfig(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+75 more)
...
Cohesion: 0.04
Nodes (77): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+69 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (64): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, getPipelineCallToAction(), IssueCard(), shouldShowAgentDoneBadge() (+56 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (78): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync (+70 more)
...
Cohesion: 0.04
Nodes (75): autoResumeStoppedWorkAgents(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+67 more)
...
Cohesion: 0.03
Nodes (64): ChatMarkdown, firstSessionPanel, firstWorkbench, overview, workbench, IssueComposer(), IssueWorkbench(), IssueWorkbenchProps (+56 more)
...
Cohesion: 0.04
Nodes (65): registerAdminCommands(), existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (66): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+58 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (62): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists() (+54 more)
...
Cohesion: 0.04
Nodes (54): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCardProps, LastHeardCounter(), PHASE_COLORS (+46 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (64): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+56 more)
...
Cohesion: 0.04
Nodes (63): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+55 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (45): TurnDiffSummary, DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffPanel(), DiffPanelProps (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (52): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+44 more)
...
Cohesion: 0.04
Nodes (49): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir, doc, createCall, dbError (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (59): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+51 more)
...
Cohesion: 0.04
Nodes (54): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, useIssueCostStream(), discussionsResult (+46 more)
...
Cohesion: 0.06
Nodes (55): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+47 more)
...
Cohesion: 0.05
Nodes (45): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+37 more)
...
Cohesion: 0.05
Nodes (32): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef() (+24 more)
...
Cohesion: 0.06
Nodes (37): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps, formatCost() (+29 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (45): AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues. (+37 more)
...
Cohesion: 0.08
Nodes (42): rebuildCache(), appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir() (+34 more)
...
Cohesion: 0.06
Nodes (32): cleanupExpiredReauthSessions(), codexAuthRouteLayer, findExistingLiveReauthSession(), getCodexAuthRoute, getCodexReauthStatusRoute, getReauthSessionToken(), invalidateReauthToken(), postCodexReauthRoute (+24 more)
...
Cohesion: 0.07
Nodes (23): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+15 more)
...
Cohesion: 0.07
Nodes (34): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+26 more)
...
Cohesion: 0.07
Nodes (36): getAllSpecialistStatus(), LegacySpecialistRuntimeStatus, SpecialistStatus, err, exec(), execFile(), execMock, kCustom (+28 more)
...
Cohesion: 0.07
Nodes (36): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+28 more)
...
Cohesion: 0.08
Nodes (38): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+30 more)
...
Cohesion: 0.09
Nodes (37): applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence(), isoForStash() (+29 more)
...
Cohesion: 0.07
Nodes (35): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult (+27 more)
...
Cohesion: 0.09
Nodes (33): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+25 more)
...
Cohesion: 0.09
Nodes (30): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute, readJsonBody (+22 more)
...
Cohesion: 0.1
Nodes (33): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+25 more)
...
Cohesion: 0.13
Nodes (26): shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+18 more)
...
Cohesion: 0.07
Nodes (27): setAgentStoppedNotifier(), setPipelineHandler(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+19 more)
...
Cohesion: 0.14
Nodes (30): reconcileAndCheckIfMerged(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus() (+22 more)
...
Cohesion: 0.08
Nodes (18): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, AgentInfoSectionProps, agent, onSyncMain, workspace, WorkspaceInfo (+10 more)

### Community 226 - "Community 226"
Cohesion: 0.14
Nodes (28): listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments() (+20 more)
...
Cohesion: 0.11
Nodes (21): withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+13 more)
...
Cohesion: 0.14
Nodes (24): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+16 more)
...
Cohesion: 0.12
Nodes (18): buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody(), parsePermissionResponseBehavior(), permissionResolutionVerb(), processPermissionResponse(), ProcessPermissionResponseDeps, ProcessPermissionResponseResult (+10 more)
...
Cohesion: 0.16
Nodes (14): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), refreshCommand() (+6 more)

### Community 416 - "Community 416"
Cohesion: 0.15
Nodes (15): buildSpecialistBaseCommand(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode (+7 more)
...
Cohesion: 0.12
Nodes (15): agentDir, body, dir, envArg, launcher, LEGACY_FIELDS, legacyFields, options (+7 more)
...
Cohesion: 0.22
Nodes (11): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeOptions, ShadowModeResult, shouldSkipTrackerUpdate() (+3 more)
...
Cohesion: 0.29
Nodes (6): el, { getByTestId }, { getByTestId, rerender }, { getByText }, onClick, { queryByTestId }
...
## Knowledge Gaps
- **12143 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12138 more)
...
- **Why does `fetch` connect `Community 6` to `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 138`, `Community 11`, `Community 13`, `Community 785`, `Community 17`, `Community 18`, `Community 276`, `Community 21`, `Community 403`, `Community 663`, `Community 23`, `Community 153`, `Community 154`, `Community 155`, `Community 28`, `Community 281`, `Community 30`, `Community 31`, `Community 162`, `Community 36`, `Community 38`, `Community 42`, `Community 555`, `Community 556`, `Community 44`, `Community 50`, `Community 52`, `Community 185`, `Community 60`, `Community 189`, `Community 62`, `Community 576`, `Community 580`, `Community 581`, `Community 77`, `Community 211`, `Community 352`, `Community 19`, `Community 231`, `Community 232`, `Community 105`, `Community 111`, `Community 22`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 30` to `Community 1`, `Community 2`, `Community 3`, `Community 164`, `Community 6`, `Community 7`, `Community 40`, `Community 110`, `Community 15`, `Community 211`, `Community 26`, `Community 28`, `Community 126`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 146` to `Community 89`, `Community 2`, `Community 17`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12143 weakly-connected nodes found - possible documentation gaps or missing edges._
