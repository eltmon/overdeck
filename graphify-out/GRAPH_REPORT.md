...
## Corpus Check
- 2096 files · ~3,648,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33254 nodes · 64529 edges · 1418 communities (1349 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1530 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fcf79bd8`
...
## Communities (1418 total, 69 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.02
Nodes (302): autoResumeStoppedWorkAgents(), cleanupSpawnAndOrphanedStashes(), monitorReviewConvoySignals(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffError, HandoffMethod (+294 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (227): changedFiles, errOutput, fetchMock, output, logNonCanonicalStashesOnStartup(), spawnInspectAgent(), announceMerge(), buildShipPreparationPrompt() (+219 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (242): readCavemanVariant(), getSpecialistState(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise() (+234 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (228): isAgentIdleForNudge(), addLog(), apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+220 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (215): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+207 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (207): extractAcceptanceCriteria(), getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES (+199 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (142): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getActiveSessionModelSync(), getAllSessionFiles(), getProjectDirs(), getProjectDirsSync(), getRecentSessions() (+134 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (187): Work Agent (shown in inspector terminal), switchModel(), ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent (+179 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.02
Nodes (185): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkVerificationReviewContradiction(), clearStaleCiFeedback(), reconcileAndCheckIfMerged() (+177 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (146): ~/.panopticon/agents/ State Directory, Agent Directory Structure, getCostSummary(), checkStuckReviewing(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult() (+138 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (180): ActivityViewProps, CostByStage, RallyStoriesSection(), statusDotColor(), registerAdminCommands(), showHelp(), startCommand(), statusCommand() (+172 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (151): ActivityView(), ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+143 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.01
Nodes (163): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause, catchIf (+155 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (155): API_ERROR_PATTERNS, Command Deck (Core Concept), appendToWal(), appendToWalSync(), resolveWalDir(), Access, AwaitingInputDetection, detectAwaitingInputForAgent() (+147 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (167): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+159 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (148): checkPendingTestDispatch(), buildInspectPromptPromise(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription(), spawnReviewCoordinatorSession() (+140 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (132): ComposerFooter(), ComposerFooterProps, PendingImage, ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS (+124 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (158): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPostReviewCommits(), recoverUnhealthyTestStack(), archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody() (+150 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.03
Nodes (128): ComposerMode, deriveComposerMode(), IssueComposer(), IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip() (+120 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.02
Nodes (127): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+119 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.03
Nodes (143): detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), getTrackerContext(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand() (+135 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.02
Nodes (147): parseDifficultyLabel(), LiveLastHeard(), BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, TaskItem(), AC_STATUS_ICONS (+139 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.02
Nodes (124): buildFileDiffRenderKey(), clearDiffParamsFromUrl(), DiffFilePickerList(), DiffPanel(), DiffPanelProps, DiffThemeType, formatShortTimestamp(), getRenderablePatch() (+116 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (127): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+119 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.02
Nodes (101): AgentTellForm(), AgentTellFormProps, SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS (+93 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.03
Nodes (134): TurnDiffFileChange, ConversationListProps, getSortKey(), loadSort(), loadTab(), SORT_LABELS, sortConversations(), SortOption (+126 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.02
Nodes (109): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+101 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (112): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), onPlan, derivePlanningIssueId() (+104 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (107): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+99 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (101): killOrphanedWorkspaceProcesses(), isCoordinatorAliveAsync(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+93 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.04
Nodes (94): mockClaudeSkills, BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), ensureExcalidrawMcp() (+86 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (104): createMemoryCommand(), ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity (+96 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.04
Nodes (111): confirmDropRecovery(), difficultyColor(), dryRun(), isSwarmRecoverAction(), printWavePlan(), recoverSwarmCommand(), registerSwarmCommands(), SWARM_RECOVER_ACTIONS (+103 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (103): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+95 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.02
Nodes (94): ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent(), classifierIssue() (+86 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (103): createDocsCommand(), DocsQueryOptions, printDocsQueryResult(), chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources() (+95 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (75): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), result, findProjectsByRallyProject(), claudePlanningSystemPromptFiles() (+67 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (104): uniqueTmpPath(), writeWorkspaceContinue(), annotated, before, candidate, check, claimed, defaults (+96 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.03
Nodes (106): estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneDocsConfig() (+98 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.03
Nodes (95): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+87 more)
...
Cohesion: 0.02
Nodes (93): fetchActivity(), deleteConversationImage(), sendConversationMessage(), uploadConversationImage(), updateConversationDeliveryMethod(), CloisterStatus, fetchConversations(), fetchConversations() (+85 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (92): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+84 more)
...
Cohesion: 0.03
Nodes (81): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+73 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (75): getModelStyle(), ModelBadge(), Framer Motion animation library, ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS (+67 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.03
Nodes (77): mockGetAgentHealth, entry, { issueId }, { limit }, old, op, ops, recent (+69 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.04
Nodes (75): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment (+67 more)
...
Cohesion: 0.04
Nodes (69): determineCavemanVariant(), injectCavemanSettings(), syncDnsToWindows(), createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError (+61 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.04
Nodes (80): AgentCard(), AgentCardProps, AgentPhase, AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps, Capability, CAPABILITY_INFO (+72 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.03
Nodes (59): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+51 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.04
Nodes (81): updateTtsConfig(), clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, updateConversationsConfigAsync() (+73 more)

### Community 53 - "Config Loading and Merging"
Cohesion: 0.05
Nodes (70): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+62 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.04
Nodes (69): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+61 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.05
Nodes (74): config, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+66 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.05
Nodes (70): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+62 more)
...
Cohesion: 0.03
Nodes (69): ScheduleAutoMergeInput, ScheduleAutoMergeResult, announceAutoMergeCancelled(), announceAutoMergeScheduled(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), AutoMergeCancelDeps, AutoMergeScheduleDeps (+61 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (67): Agent Enrichment Service, agentDir, missing, result, snapshot, status, AgentEnrichment, missing (+59 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.05
Nodes (58): RoundMarker, format(), LiveCounter(), LiveCounterProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps (+50 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.06
Nodes (64): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+56 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.06
Nodes (55): { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues, output, error, RemoteProviderConfig, IssueNotFound, createTrackerFromConfig(), getAllTrackers() (+47 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.04
Nodes (66): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionByJsonlPath() (+58 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (61): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, debounce(), isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage (+53 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.04
Nodes (62): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+54 more)

### Community 66 - "GitHub Webhook Ingestion Handlers"
Cohesion: 0.04
Nodes (62): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+54 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.04
Nodes (71): beads (bd) issue tracking tool, CHANGELOG [0.7.0] Command Taxonomy Reorganization, Cloister lifecycle watchdog, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command (+63 more)
...
Cohesion: 0.08
Nodes (14): normalizeIssueId(), constructor(), GitHubTracker, octokitToEffect(), octokitToProgram(), parseIssueNumber(), GitLabTracker, notImplemented() (+6 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.07
Nodes (47): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), cleanupTestFiles(), getUniqueId(), id, result (+39 more)
...
Cohesion: 0.1
Nodes (58): bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError, CliproxyGeminiCredentials (+50 more)
...
Cohesion: 0.08
Nodes (53): BlockerReason, getReviewStatusAsync(), setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+45 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.05
Nodes (59): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+51 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.07
Nodes (66): parseFiniteInteger(), filterPayload(), add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver() (+58 more)

### Community 79 - "Resource-Allocated Issue Discovery"
Cohesion: 0.06
Nodes (64): Agent Audit Report (2026-04-13), AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, buildTaskPrompt() (specialist prompt dispatch), Verification Gate (PAN-174), Beads prerequisite for work agent start (422 without), Review cycle circuit breaker (max 3 auto-requeue), Context digest (cross-dispatch memory for test/merge agents) (+56 more)

### Community 80 - "Skills Merge and Manifest Sync"
Cohesion: 0.05
Nodes (49): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), delay() (+41 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.05
Nodes (44): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, ComplexityModels, DashScopeModel (+36 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.05
Nodes (49): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+41 more)

### Community 83 - "Issue Search Modal and Filter State"
Cohesion: 0.06
Nodes (57): cancelPending(), clearAllPending(), getActionableAutoMerge(), getPendingAutoMerge(), listActionableAutoMerges(), listActiveAutoMerges(), listDuePendingAutoMerges(), listPendingAutoMerges() (+49 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.04
Nodes (54): formatIssueCostAggregate(), aggregate, output, AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend (+46 more)

### Community 85 - "Conversation Compaction and Fork Pipeline"
Cohesion: 0.06
Nodes (51): getCavemanExperimentData(), httpHandler(), HttpServerResponse, ReadModelServiceLive, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+43 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.05
Nodes (56): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), ConfigOptions, createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+48 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.04
Nodes (54): future, id, rows, rows1, rows2, dir, event, eventsDir1 (+46 more)

### Community 88 - "Work Agent Prompt and Reopen Flow"
Cohesion: 0.07
Nodes (55): planCommand(), PlanOptions, runDiscoveryPhase(), listTestsCommand(), deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo() (+47 more)

### Community 89 - "Frontend Dashboard Component Tests"
Cohesion: 0.07
Nodes (48): updateGitHubToInReview(), content, mockExeca, extractNumber(), extractNumberSync(), clearReviewStatus(), applyLabelLinearImpl(), CloseIssueOptions (+40 more)

### Community 90 - "Cliproxy Process Lifecycle Management"
Cohesion: 0.05
Nodes (34): CapabilityModelId, getModelCapability(), getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, allModels (+26 more)

### Community 91 - "Multi-Tracker Adapter Implementations"
Cohesion: 0.05
Nodes (54): PendingOperation, PanFeedbackFile, decodeLayersResponse, decodePreviewRequest, decodePreviewResponse, decodeSaveRequest, decodeSyncRequest, parsed (+46 more)

### Community 92 - "Event Snapshot Cache and State Reducers"
Cohesion: 0.07
Nodes (51): details, startRealConversationRoutes(), validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+43 more)
...
Cohesion: 0.06
Nodes (44): TABS, themeButton, VBriefDifficulty, VBriefEdge, VBriefEdgeType, VBriefInspectionPolicy, VBriefPlan, VBriefPriority (+36 more)
...
Cohesion: 0.05
Nodes (48): ProjectData, next, restored, s, start, withAgent, createRecoveryCoordinator(), EventClassification (+40 more)
...
Cohesion: 0.07
Nodes (48): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+40 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.06
Nodes (52): CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage(), ContentBlock, ConversationActivitySummary, ConversationWatchHandle (+44 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.08
Nodes (34): BUDGETS_FILE, checkBudget(), checkBudgetSync(), CostBudget, CostSummary, createBudget(), createBudgetSync(), deleteBudget() (+26 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.07
Nodes (38): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, AnthropicExtractionProvider (+30 more)

### Community 103 - "Claude OAuth Authentication and Settings"
Cohesion: 0.08
Nodes (50): ScanOptions, normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), aggregateDiscoveredSessionCost() (+42 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.05
Nodes (49): getTtsDaemonAuthHeaders(), CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute (+41 more)
...
Cohesion: 0.08
Nodes (39): startPostLaunchSidecars(), startSidecars(), systemHealthCommand(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget() (+31 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.06
Nodes (42): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+34 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.06
Nodes (44): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), createTerminalWindow(), MockWindow, openTerminalWindow(), setAlwaysOnTop(), terminalWindows, win (+36 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.04
Nodes (42): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, delay() (+34 more)
...
Cohesion: 0.06
Nodes (43): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, existingSkillDir, existsInTarget (+35 more)

### Community 112 - "TLDR Daemon State Management"
Cohesion: 0.08
Nodes (43): ensureDashboardBundle(), devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep() (+35 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.06
Nodes (46): formatRelativeTime(), discussionsResult, feed, items, rows, date, fiftyNineMin, fiftyNineS (+38 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.08
Nodes (46): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+38 more)
...
Cohesion: 0.07
Nodes (37): applyFallback(), applyFallbackSync(), applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels() (+29 more)

### Community 117 - "Specialist Agent Prompts and Audit Docs"
Cohesion: 0.06
Nodes (43): PACKAGE_ROOT, ARCHIVES_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR (+35 more)

### Community 118 - "Agent Hook Scripts and Repo Artifact Design"
Cohesion: 0.06
Nodes (38): listener(), wrapped(), chunks, emitter, googleMocks, stream, emitter, onTurn (+30 more)

### Community 119 - "vBRIEF Continue State and Feedback Writing"
Cohesion: 0.06
Nodes (45): adminRouteLayer, codexAuthRouteLayer, conversationsRouteLayer, diffsRouteLayer, miscRouteLayer, prereqsRouteLayer, getRemoteStatusRoute, getRemoteWorkspaceRoute (+37 more)

### Community 120 - "Caveman Hooks and Workspace Setup"
Cohesion: 0.09
Nodes (46): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+38 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.05
Nodes (41): calls, mockExec, calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions (+33 more)
...
Cohesion: 0.07
Nodes (44): ArtifactCommandDeps, artifactCreateCommand(), ArtifactCreateOptions, artifactListCommand(), artifactOpenCommand(), ArtifactPublishOptions, artifactShareCommand(), ArtifactShareOptions (+36 more)

### Community 134 - "Configuration Documentation"
Cohesion: 0.06
Nodes (34): AgentState, appendChannelDeliveryLog(), deliverAgentMessage(), panopticonHomeForChannels(), panopticonHomeForSockets(), __testInternals, FeedbackKind, isDeliveryStillRelevant() (+26 more)

### Community 135 - "Core Project Docs and Scripts"
Cohesion: 0.06
Nodes (36): getWindowDimensions(), getWindowDimensionsAsync(), resizeWindow(), invalidateReauthToken(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer (+28 more)
...
Cohesion: 0.1
Nodes (42): decodeFlywheelRunId, defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId(), pauseFlywheel() (+34 more)
...
Cohesion: 0.05
Nodes (33): IssueStats, cost, db, DB_PATH, CLAUDE_PROJECTS, cost, db, DB_PATH (+25 more)

### Community 147 - "PRD Draft and Pan Directory Management"
Cohesion: 0.07
Nodes (43): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+35 more)

### Community 148 - "Claude Session JSONL Parsing and Costs"
Cohesion: 0.14
Nodes (13): createFlyApiClient(), createFlyApiClientSync(), effFromPromise(), execAsync, FlyProvider, FlyProviderConfig, mapFlyStateToVmStatus(), { execAsyncMock, spawnMock, mockApi } (+5 more)

### Community 149 - "Shadow Mode Issue Tracking"
Cohesion: 0.1
Nodes (43): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+35 more)
...
Cohesion: 0.09
Nodes (45): addCommentBefore(), ALIAS, anchorIsValid(), callVisitor(), createNode(), createNodeAnchors(), createPair(), createPairs() (+37 more)
...
Cohesion: 0.08
Nodes (33): assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpointsEffect() (+25 more)

### Community 159 - "Specialist Registry and Run Lifecycle"
Cohesion: 0.07
Nodes (39): after, backupPath, backups, calls, errSpy, exitSpy, original, out (+31 more)

### Community 160 - "Doctor Health Check and Path Resolution"
Cohesion: 0.08
Nodes (41): getFlywheelCurrentPayload(), getFlywheelRunPayload(), getFlywheelRunsPayload(), openFlywheelRunReportForDashboard(), readCurrentFlywheelStatusForDashboard(), resolveReportOpenRunId(), decodeFlywheelRunId, decodeFlywheelStatus (+33 more)

### Community 161 - "Feature Context and Planning Session Spawn"
Cohesion: 0.05
Nodes (34): beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads (+26 more)

### Community 162 - "Cloister Service Start Stop Status"
Cohesion: 0.05
Nodes (36): skills, claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+28 more)

### Community 163 - "Agent Card Model Defaults Display"
Cohesion: 0.07
Nodes (37): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+29 more)

### Community 164 - "Command Deck Issue Workbench UI"
Cohesion: 0.09
Nodes (33): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), executeCloseOutPromise(), findWorkspacePath() (+25 more)
...
Cohesion: 0.05
Nodes (35): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config, config1 (+27 more)

### Community 168 - "Agent CV and Show Commands"
Cohesion: 0.07
Nodes (38): ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getSpecialistHandoffStatsPromise(), getTodaySpecialistHandoffs(), readIssueSpecialistHandoffs(), readSpecialistHandoffs() (+30 more)

### Community 169 - "Git Push Operations and Approval"
Cohesion: 0.06
Nodes (30): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession() (+22 more)
...
Cohesion: 0.09
Nodes (39): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST() (+31 more)
...
Cohesion: 0.08
Nodes (24): ArtifactIndexOptions, ArtifactIndexRepository, ArtifactRow, assertValidSlug(), computeArtifactPendingChanges(), CreateArtifactInput, generateArtifactSlug(), getArtifactIndexPath() (+16 more)

### Community 183 - "Review Workflow Command Coordination"
Cohesion: 0.09
Nodes (34): SETTINGS_FILE, available, content, defaults, defaults1, defaults2, invalidSettings, settings (+26 more)
...
Cohesion: 0.11
Nodes (39): defaultFlywheelPrompt(), flywheelRunConfigurationSection(), getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), spawnFlywheelAgent(), startFlywheelRun(), abortFlywheelRunForDashboard() (+31 more)
...
Cohesion: 0.09
Nodes (27): ensureOpenAICompatibleProxyRunning(), buildAnthropicMessagesUrl(), CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+19 more)

### Community 193 - "Workflow Orchestration and vBRIEF Research"
Cohesion: 0.16
Nodes (39): killTmuxSession(), removeWorktree(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir() (+31 more)

### Community 194 - "Agent Types Pipeline Documentation"
Cohesion: 0.11
Nodes (38): Conversation, listActiveConversations(), markConversationEnded(), setClearedToConvId(), handleConversationImageUpload(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments() (+30 more)
...
Cohesion: 0.06
Nodes (40): ~/.panopticon.env (API Keys), CLI Work Types, API Keys Env File (~/.panopticon.env), Cloudflare Tunnel Workspace Integration, Configuration Fallback Strategy (provider disabled fallback), Global Config File (~/.panopticon/config.yaml), Panopticon Configuration Guide, Hume EVI Workspace Integration (BYOLLM voice AI) (+32 more)
...
Cohesion: 0.07
Nodes (24): countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), stopTranscriptPoller() (+16 more)
...
Cohesion: 0.07
Nodes (34): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+26 more)
...
Cohesion: 0.15
Nodes (26): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync(), collectMail() (+18 more)
...
Cohesion: 0.09
Nodes (29): showAction(), getDiscoveredSessionById(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+21 more)

### Community 216 - "Dashboard Mutation Origin Validation"
Cohesion: 0.06
Nodes (35): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+27 more)
...
Cohesion: 0.1
Nodes (33): apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect(), generateInstallationTokenPromise(), generateJWT() (+25 more)

### Community 225 - "Diagnostic and Incident Response Skills"
Cohesion: 0.08
Nodes (28): ProjectsConfig, addTunnelIngress(), addTunnelIngressPromise(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials() (+20 more)

### Community 226 - "Contracts Types RPC and Desktop Package"
Cohesion: 0.06
Nodes (32): conv, created, list, body, bytes, claudeProjectDir, conv, created (+24 more)
...
Cohesion: 0.07
Nodes (32): Codex OAuth Authentication, Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider (+24 more)
...
Cohesion: 0.06
Nodes (33): initialState, cb, completedState, dispatched, failedState, featureWorkspace, ghArgs, ghExecFileMock (+25 more)

### Community 233 - "Multi-Model Settings E2E Tests"
Cohesion: 0.09
Nodes (30): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), resolveAlsoSyncTools(), runMultiToolSync(), stripFrontmatter() (+22 more)

### Community 234 - "Cloister Watchdog and Merge Validation Docs"
Cohesion: 0.09
Nodes (31): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir(), migrateAgent() (+23 more)
...
Cohesion: 0.09
Nodes (28): appendFreshBriefingUpdate(), AppendFreshBriefingUpdateInput, AppendFreshBriefingUpdateResult, briefingFilePath(), BriefingSessionMarker, buildBriefingUpdateBlock(), ensureSessionContextBriefingFile(), escapeBriefingContent() (+20 more)

### Community 238 - "Workspace Teardown and Reopen Tests"
Cohesion: 0.06
Nodes (11): client, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine (+3 more)

### Community 239 - "File and Editor Open Commands"
Cohesion: 0.1
Nodes (32): activeViolations, checkAgentForViolations(), clearOldViolations(), clearOldViolationsEffect(), clearOldViolationsSync(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig (+24 more)
...
Cohesion: 0.09
Nodes (25): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir() (+17 more)

### Community 242 - "OpenAI Auth and Cliproxy Bridge"
Cohesion: 0.06
Nodes (30): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, validateEstimatedCost(), corruptLines (+22 more)
...
Cohesion: 0.12
Nodes (29): getArtifactSnapshotPath(), ArtifactLifecycleOptions, ArtifactProvenanceInput, ArtifactValidationError, copyPublishedSnapshot(), createArtifact(), CreateArtifactOptions, decodeHtmlText() (+21 more)

### Community 259 - "Work Reopen Command Tests"
Cohesion: 0.1
Nodes (31): ArtifactIndexEntry, resolveArtifactThumbnailUrl(), artifactDomain(), ArtifactRouteBody, ArtifactRouteDeps, ArtifactRouteResult, artifactsRouteLayer, ArtifactThumbnailPayload (+23 more)

### Community 260 - "System Health Command and CLI Tests"
Cohesion: 0.08
Nodes (30): embedAction(), DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), getDiscoveredStats(), UpsertDiscoveredSessionOpts, EmbedProgress, EmbedResult, embedSessions() (+22 more)

### Community 261 - "Project Setup and Polyrepo Workspace PRDs"
Cohesion: 0.06
Nodes (33): updateConversationsConfig(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+25 more)

### Community 262 - "Panopticon 1.0 Stabilization Audit"
Cohesion: 0.08
Nodes (23): CleanResult, execAsync, WorkspaceInfo, WorkspaceService, WorkspaceServiceLive, WorkspaceServiceShape, runEffect(), MOCK_PROJECT (+15 more)

### Community 263 - "tmux Async Delivery and Terminal Performance"
Cohesion: 0.08
Nodes (31): CliproxyCodexCredentials, applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+23 more)
...
Cohesion: 0.13
Nodes (31): appendSystemPromptFile(), drainPendingEvents(), envFor(), getDashboardUrl(), handlePanDone(), handleSessionBriefingContext(), handleSessionStart(), handleToolExecutionEnd() (+23 more)

### Community 278 - "Feature Metadata Badge and Modal Components"
Cohesion: 0.09
Nodes (21): TLDR Daemon - Background Index Manager, captureTldrMetrics(), captureTldrMetricsSync(), daemonRegistry, ensureTldrStateDir(), getStateFilePath(), getTldrMetrics(), getTldrMetricsSync() (+13 more)
...
Cohesion: 0.08
Nodes (21): ConversationsConfig, ConversationsEnrichmentConfig, findDevrootForProject(), findDevrootForProjectSync(), getConversationsConfig(), getConversationsConfigAsync(), getConversationsConfigSync(), getDevrootPathSync() (+13 more)
...
Cohesion: 0.1
Nodes (28): GLOBAL_CONFIG_PATH, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+20 more)

### Community 288 - "Hook Ordering and Lifecycle Tests"
Cohesion: 0.1
Nodes (24): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+16 more)
...
Cohesion: 0.06
Nodes (32): code:yaml (# Your original docker-compose.yml), code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]), code:toml ([project]) (+24 more)
...
Cohesion: 0.14
Nodes (30): FailedMessage, AssistantMessageRow(), asString(), CompactBoundaryDivider(), CompactingIndicator(), ContextMessageBlock(), formatElapsed(), formatTimestamp() (+22 more)
...
Cohesion: 0.11
Nodes (26): buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), resolveAndSpeak() (+18 more)

### Community 300 - "Git Rebase and Conflict Resolution"
Cohesion: 0.1
Nodes (24): getLinearClient(), LinearClient, LinearClientError, LinearClientLive, LinearClientOptionalLive, LinearClientShape, LinearComment, LinearIssue (+16 more)
...
Cohesion: 0.12
Nodes (24): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPane(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+16 more)

### Community 315 - "DAG Visualization and Tasks Panel"
Cohesion: 0.1
Nodes (15): MockRallyArtifact, RallyApiMock, compoundQueries, mock, sampleArtifacts, typeQueries, RallyApiConfig, RallyCreateConfig (+7 more)

### Community 316 - "Fly.io Remote Provider Migration"
Cohesion: 0.07
Nodes (29): flywheelAbortCommand(), flywheelPauseCommand(), flywheelResumeCommand(), formatGateSnapshot(), registerFlywheelCommands(), abort, aborted, briefPath (+21 more)

### Community 317 - "Directive Flow DAG Issue Overview"
Cohesion: 0.1
Nodes (20): DEFAULT_AUTO_RESUME_CONFIG, config, customConfig, invalidEntryConfig, nonArrayConfig, thresholds, warn, captureEnv() (+12 more)

### Community 318 - "Workspace Reopen and State Reset"
Cohesion: 0.12
Nodes (23): configShadowCommand(), ShadowOptions, INFERENCE.md Artifact, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary() (+15 more)
...
Cohesion: 0.18
Nodes (27): int, build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), extract_embedding(), _get_default_sink_state(), load_base_model() (+19 more)

### Community 327 - "Dashboard Motion Animation Catalog"
Cohesion: 0.1
Nodes (26): defaults, first, issueAgentTypes, { models }, second, models, getAllWorkTypes(), getWorkTypeMetadata() (+18 more)

### Community 328 - "Testing Guide and Conventions Docs"
Cohesion: 0.13
Nodes (9): LRUCache, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb(), RateLimitInfo (+1 more)

### Community 329 - "Rally Feature Planning Hierarchy UX"
Cohesion: 0.15
Nodes (22): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), getDefaultConfig() (+14 more)

### Community 330 - "Multi-Tool Skill Sync Config Migration"
Cohesion: 0.1
Nodes (27): AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS, getLinearStateName() (+19 more)
...
Cohesion: 0.11
Nodes (25): CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, computeMessageDurationStart(), deriveMessagesTimelineRows(), EstimateHeightInput (+17 more)
...
Cohesion: 0.08
Nodes (23): closeResult, command, ctx, editCalls, labelResult, prResult, cleanupLabelsGitHub(), cleanupLabelsLinear() (+15 more)
...
Cohesion: 0.12
Nodes (25): onInspectComplete(), onInspectCompletePromise(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise(), getDiffBaseEffect() (+17 more)
...
Cohesion: 0.1
Nodes (24): approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifact(), createReviewArtifactEffect() (+16 more)
...
Cohesion: 0.12
Nodes (22): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsNotFoundError (+14 more)

### Community 366 - "Workspace Status Display Skill"
Cohesion: 0.07
Nodes (24): healths, CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health (+16 more)

### Community 367 - "Work Completion Checklist Skill"
Cohesion: 0.12
Nodes (25): companionInTarget, contentAfterFirst, dstScript, gitCwd, gitManifestDir, manifest, manifestAfterFirst, result (+17 more)

### Community 368 - "GitHub CLI Reference Skill"
Cohesion: 0.08
Nodes (21): AC_STATUS_COLORS, AC_STATUS_SYMBOL, applyDagreLayout(), DIFFICULTY_LABELS, EMPTY_ARRAY, GATE_LABELS, GATE_STATUS_COLORS, gateStatusFromReview() (+13 more)
...
Cohesion: 0.11
Nodes (22): TriageOptions, triage priority scoring matrix (P0-P4), analyzeIssue(), sortByPriority(), issues, options, result, results (+14 more)

### Community 383 - "Dashboard PostCSS Configuration"
Cohesion: 0.16
Nodes (25): HandoffContext, ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE (+17 more)
...
Cohesion: 0.1
Nodes (19): AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory(), ROLE_VALUES (+11 more)

### Community 386 - "Dashboard Vite Environment Types"
Cohesion: 0.1
Nodes (26): appendCostEvent(), appendCostEventSync(), appendToWal(), appendToWalSync(), clone(), ensureEventsFile(), extractPrefix(), extractPrefixSync() (+18 more)
...
Cohesion: 0.22
Nodes (24): createFlyProvider(), getRemoteProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+16 more)

### Community 394 - "Handoff Flow Test Fixture"
Cohesion: 0.19
Nodes (17): cvCommand(), CVOptions, AgentCV, completeWork(), completeWorkSync(), formatCV(), formatCVSync(), getAgentCV() (+9 more)

### Community 395 - "Specialist Flow Test Fixture"
Cohesion: 0.17
Nodes (22): checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost() (+14 more)
...
Cohesion: 0.11
Nodes (15): mockFetch(), ApiKeyValidationResult, classifyModel(), detectThinkingSupport(), ModelCache, OpenRouterModel, OpenRouterService, OpenRouterServiceLive (+7 more)
...
Cohesion: 0.11
Nodes (10): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, FlyApiClient, mockSystemHealth (+2 more)

### Community 419 - "Community 419"
Cohesion: 0.16
Nodes (17): after, before, blockers, result, statuses, DEFAULT_STATUS_FILE, clearReviewStatus(), clearReviewStatusSync() (+9 more)
...
Cohesion: 0.22
Nodes (17): diffPatchFilesAgainstHead(), diffPatchSinceCommit(), findCommitAtTime(), execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise() (+9 more)
...
Cohesion: 0.11
Nodes (20): CostEntry, DEFAULT_PRICING, ModelPricing, anthropicModels, cost, haikuPricing, mockEntries, opusPricing (+12 more)

### Community 477 - "Community 477"
Cohesion: 0.15
Nodes (18): main(), print_usage(), build_compress_prompt(), build_fix_prompt(), call_claude(), compress_file(), Strip outer ```markdown ... ``` fence when it wraps the entire output., strip_llm_wrapper() (+10 more)
...
Cohesion: 0.14
Nodes (17): ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), LIFECYCLE_EVENT_TYPES, onEvent(), optionalString() (+9 more)

### Community 481 - "Community 481"
Cohesion: 0.11
Nodes (18): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+10 more)

### Community 482 - "Community 482"
Cohesion: 0.22
Nodes (15): backup, backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), createBackup() (+7 more)

### Community 483 - "Community 483"
Cohesion: 0.12
Nodes (20): fetchCurrentFlywheelStatus(), fetchPendingAutoMerges(), FLYWHEEL_CONFIG_QUERY_KEY, FlywheelConfig, FlywheelConfigPatch, FlywheelLeftTab, FlywheelPage(), FlywheelPageProps (+12 more)
...
Cohesion: 0.24
Nodes (21): normalizeIssueIdSync(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+13 more)
...
Cohesion: 0.11
Nodes (22): AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), CloisterBanner Component, modelDefaults.ts (frontend model defaults), pan done Command (signals completion, triggers pipeline), planning-agent (Primary Planning Agent) (+14 more)
...
Cohesion: 0.1
Nodes (20): TranscriptEntry, AIProvider, branch, branchMatch, buffer, cavemanVariant, cost, entry (+12 more)
...
Cohesion: 0.11
Nodes (18): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+10 more)

### Community 499 - "Community 499"
Cohesion: 0.11
Nodes (14): IconProps, PROVIDER_COLORS, ProviderDot(), ProviderIcon(), AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState, ConversationFeedCard() (+6 more)
...
Cohesion: 0.17
Nodes (16): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, TurnDiffFileChange, DiffStatLabel, hasNonZeroStat(), buildTurnDiffTree(), MutableDirectoryNode (+8 more)

### Community 502 - "Community 502"
Cohesion: 0.17
Nodes (16): err, BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChangesPromise(), checkVBriefACStatusSync(), errorCode(), execAsync (+8 more)
...
Cohesion: 0.12
Nodes (20): Abort, code:bash (pan flywheel start), code:bash (pan flywheel start), code:bash (pan flywheel config --get), code:bash (pan flywheel status), code:bash (pan flywheel pause), code:bash (pan flywheel abort), code:bash (pan flywheel emit-status --file latest.json) (+12 more)
...
Cohesion: 0.1
Nodes (21): src/lib/cloister/inspect-agent.ts, Inspect Specialist checkpoint system (commit-based diff scoping), Inspect Specialist (inspect-agent), PAN-382: Inspect Specialist — Per-Step Verification, Jidoka Principle — never pass a foundation-class defect downstream, pan inspect <issueId> --bead <beadId> CLI command, metadata.requiresInspection per-bead flag, Playwright MCP server integration for UAT (+13 more)
...
Cohesion: 0.12
Nodes (10): getAllMergeSetsFromDb(), ensureMergeSetForIssue(), getAllMergeSets(), getAllMergeSetsSync(), getMergeSet(), MergeSetGateStatus, MergeSetRebaseStatus, MergeSetRepoMergeStatus (+2 more)

### Community 517 - "Community 517"
Cohesion: 0.15
Nodes (15): ArtifactThumbnailOptions, ArtifactThumbnailPlaceholder, ArtifactThumbnailRenderer, ArtifactThumbnailResult, defaultRawArtifactUrl(), escapeXml(), fileExists(), getArtifactThumbnailDir() (+7 more)
...
Cohesion: 0.13
Nodes (11): NormalizedTtsDaemonConfig, parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv(), readWatchdogConfig() (+3 more)
...
Cohesion: 0.1
Nodes (20): 6. Agreed End-State, Agent Startup Context, code:yaml (devroot: ~/Projects        # where you launch Claude Code fr), code:json ({), code:json ({), code:bash (pan workspace update MIN-678    # explicit command, only whe), code:block16 (pan workspace create MIN-678), code:block17 (Agent starts on MIN-678 workspace) (+12 more)
...
Cohesion: 0.37
Nodes (17): display_title(), extract_text_fragments(), extract_tool_names(), find_by_id(), format_cost(), get_db(), get_session_summary(), iter_session_messages() (+9 more)
...
Cohesion: 0.11
Nodes (15): ChatMessage, entries, ChatMessage, entries, messages, workLog, divider, dividers (+7 more)

### Community 538 - "Community 538"
Cohesion: 0.11
Nodes (17): agentDir, agentResult, beadsDir, branchResult, clearResult, content, legacyDir, legacyResult (+9 more)
...
Cohesion: 0.11
Nodes (18): About the Name, code:typescript (interface ContextBudget {), Context Budget Manager, Core Insight, ⚠️ DECOUPLING FROM MYN (CRITICAL), DO NOT rely on MYN infrastructure:, Executive Summary, If tests pass, commit (+10 more)
...
Cohesion: 0.12
Nodes (17): Auto-planning, code:bash (pan plan PAN-1071), code:bash (pan plan PAN-1071 --auto), code:bash (pan plan finalize), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Finalizing (`pan plan finalize`), Panopticon Planning Lifecycle (+9 more)

### Community 553 - "Community 553"
Cohesion: 0.25
Nodes (19): assertSafeAgentId(), assertSafeAgentIdProgram(), deleteAllCheckpoints(), deleteAllCheckpointsPromise(), deleteCheckpoint(), diffCheckpointFiles(), diffCheckpointFilesPromise(), diffCheckpoints() (+11 more)
...
Cohesion: 0.25
Nodes (16): inferIssueId(), buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset() (+8 more)

### Community 558 - "Community 558"
Cohesion: 0.22
Nodes (15): getForgeAdapter(), ensureMergeSetForIssueSync(), upsertMergeSetSync(), withRepoArtifactUrl(), withRepoArtifactUrlSync(), withRepoState(), withRepoStateSync(), buildRichReviewArtifactBody() (+7 more)
...
Cohesion: 0.16
Nodes (15): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), makeMergeSet() (+7 more)
...
Cohesion: 0.16
Nodes (14): useConversationFeed(), useGitFeed(), filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), useMergedFeed(), UseMergedFeedResult, useObservationFeed(), duplicate (+6 more)
...
Cohesion: 0.23
Nodes (15): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), EditorLaunch, execAsync (+7 more)
...
Cohesion: 0.14
Nodes (17): packages/contracts/src/types.ts, src/lib/cloister/deacon.ts, A/B testing for caveman (caveman_variant in workspace metadata + cost events), CAVEMAN_DEFAULT_MODE env var for per-agent-type intensity, Caveman hooks (SessionStart + UserPromptSubmit) for output token reduction, PAN-611: Caveman Integration — Agent Output Token Reduction, PAN-798: Tmux capture-pane Audit (22 call sites, 70+ patterns), 22 tmux capture-pane call sites across 12 files (+9 more)
...
Cohesion: 0.17
Nodes (11): withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutex(), withWorkspaceBdMutexPromise(), restoreTrackedBeadsExport(), runGit(), spawnerLayer, after (+3 more)
...
Cohesion: 0.24
Nodes (14): sessionFilePath(), buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions, ConvertResult, extractClaudeTranscript(), extractContentText() (+6 more)
...
Cohesion: 0.17
Nodes (11): ActivityFeedCard(), ActivityFeedCardProps, ActivitySessionFeedEntry, CommentSessionFeedEntry, FileChangeSessionFeedEntry, PlaceholderSessionFeedEntry, SessionFeedEntryBase, SessionFeedEntryKind (+3 more)

### Community 633 - "Community 633"
Cohesion: 0.23
Nodes (14): addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), detectDnsSyncMethod(), DnsSyncMethod, ensureBaseDomain(), getDnsmasqConfigDir() (+6 more)
...
Cohesion: 0.18
Nodes (12): EMPTY_STATES, FeedTabContent(), isSessionFeedTab(), isStubTab(), navigateToFeedEntry(), pushRoute(), readStoredTab(), SessionFeedSidebar() (+4 more)

### Community 656 - "Community 656"
Cohesion: 0.21
Nodes (10): ContextUsage, ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, bar (+2 more)
...
Cohesion: 0.28
Nodes (10): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromAllProjectsPromise(), syncWalFromDir(), syncWalFromDirPromise(), insertCostEvent() (+2 more)
...
Cohesion: 0.19
Nodes (10): DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType, bridge, DesktopSettings, IPC (+2 more)
...
Cohesion: 0.15
Nodes (9): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile (+1 more)
...
Cohesion: 0.15
Nodes (12): adaptFlywheelAgent(), normalizeRole(), card, commitLink, metrics, onNavigateAgent, onNavigateIssue, rows (+4 more)

### Community 706 - "Community 706"
Cohesion: 0.15
Nodes (11): cancelButton, consoleError, fetchMock, mocks, onNavigateAgent, onNavigateIssue, requireUat, stateTab (+3 more)
...
Cohesion: 0.17
Nodes (13): Baseline-Aware Test Validation, Baseline-Aware Test Validation (pre/post merge comparison), Cloister Emergency Stop (kills all agents), Fixed Point Principle (FPP) Violation Detection, HandoffContext Interface (context preservation across model handoffs), Cloister Agent Handoff Mechanisms (kill-spawn, specialist-wake), Cloister Heartbeat System (passive + active hybrid), Cloister Merge Validation Pipeline (+5 more)

### Community 731 - "Community 731"
Cohesion: 0.24
Nodes (9): _extract_code_blocks(), _extract_headings(), _extract_urls(), Caveman Compression Validator  Checks that a compressed file preserves all URLs,, Validate that the compressed file preserves all URLs, code blocks, and     headi, validate(), ValidationResult, ValidationResult (+1 more)

### Community 732 - "Community 732"
Cohesion: 0.39
Nodes (3): Handler, validate_text_field(), handlers

### Community 733 - "Community 733"
Cohesion: 0.17
Nodes (11): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+3 more)

### Community 734 - "Community 734"
Cohesion: 0.35
Nodes (10): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+2 more)
...
Cohesion: 0.21
Nodes (9): fetchGitFeedEntries(), GitActivityEntry, GitFeedFetchResult, mapGitActivityToFeedEntry(), UseGitFeedResult, entries, error, result (+1 more)

### Community 739 - "Community 739"
Cohesion: 0.2
Nodes (12): compose(), decorate(), end(), getErrorPos(), next(), parseAllDocuments(), parseOptions(), parsePrelude() (+4 more)
...
Cohesion: 0.25
Nodes (9): readContextPercent(), ids, agentDir(), AGENTS_DIR, cleanup(), ctxFile(), id, ids (+1 more)

### Community 783 - "Community 783"
Cohesion: 0.24
Nodes (8): ConversationFeedRow, fetchConversations(), mapConversationsToFeedEntries(), mapConversationToFeedEntry(), mapHarnessToAgent(), UseConversationFeedResult, entries, useQueryMock
...
Cohesion: 0.2
Nodes (10): client, input, input1, input2, makeClient(), mockConversation, patchCalls, pendingResponses (+2 more)
...
Cohesion: 0.24
Nodes (8): HealthCheck, mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output, mockGetDashboardApiUrl
...
Cohesion: 0.31
Nodes (8): MergeSet, execAsync, RebaseAllResult, rebaseAndPushRepos(), rebaseAndPushReposPromise(), RebaseError, rebaseOneRepo(), tryResolvePlanningConflicts()
...
Cohesion: 0.2
Nodes (8): content, d, existingDir, lines, oldDir, result, skillDir, ensurePanGitignoreSync()
...
Cohesion: 0.25
Nodes (7): Hook, hook, newOrder, originalOrder, reorderedHook, success, TEST_HOOK_FILE

### Community 961 - "Community 961"
Cohesion: 0.25
Nodes (7): baseFlywheelStatus, consoleErrors, flywheelStatus, metrics, status, statusPane, suggestionsSection
...
Cohesion: 0.25
Nodes (7): diffAgainstMain(), diffAgainstMainFiles(), getDiffsRoute, getFullDiffRoute, getTurnDiffRoute, getVsMainDiffRoute, postTestCheckpointRoute
...
Cohesion: 0.38
Nodes (6): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), PermissionPayloadValidationError, utf8ByteLength()

### Community 1016 - "Community 1016"
Cohesion: 0.33
Nodes (5): readWorkspaceFileEffect(), outside, prefix, projectPath, runReadWorkspaceFile()

### Community 1017 - "Community 1017"
Cohesion: 0.33
Nodes (5): eventStoreLayerFor(), {
  execMock,
  execBehaviorMock,
  existsSyncMock,
  getReviewStatusMock,
...
}, headCall, postRequestReview(), stdout
...
Cohesion: 0.33
Nodes (4): body, content, { frontmatter, body }, splitFrontmatter()
...
Cohesion: 0.47
Nodes (5): hiddenDir, mockExecFn, subA, subB, checkUncommittedChanges()
...
Cohesion: 0.5
Nodes (5): Build Pipeline Documentation, dist/ Output Structure, Electron Desktop App (apps/desktop), tsdown Bundler (CLI/Server/Contracts), Vite Dashboard Frontend Build
...
Cohesion: 0.5
Nodes (4): code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Step 6: Approve or Revise
...
Cohesion: 0.67
Nodes (3): Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c)
...
## Knowledge Gaps
- **14213 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14208 more)
...
- **Why does `ConversationEvent` connect `Dialog Actions and System Health UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Configuration Documentation`, `Workspace Creation and Worktree`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Event Store Domain Services`, `Electron Desktop App and Tray`, `Health Metrics and Settings Pages`, `Workspace Lifecycle and Config`, `Community 789`, `Dashboard Store and Command Palette`, `CLI Commands and Runtime Adapters`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Specialist Handoff Logging and Queue Depth`, `Cost Events Database and WAL Sync`, `CLI Install DNS and Dev Commands`, `Work Type Routing and Config`, `Git Push Operations and Approval`, `Dashboard App Sidebar and Metrics`, `Cloister Config Deep Merge`, `Platform Supervisor Startup Lifecycle`, `Permission Request Bridge and Forwarding`, `GitHub Webhook Ingestion Handlers`, `Agent Types Pipeline Documentation`, `Post-Merge Auto Deploy Pipeline`, `Skills Merge and Manifest Sync`, `Dashboard Event Reducers Tests`, `Conversation Compaction and Fork Pipeline`, `Community 472`, `Multi-Tracker Adapter Implementations`, `Event Snapshot Cache and State Reducers`, `Traefik DNS and Platform Install Skills`, `Community 608`, `Rally Tracker Adapter Tests`, `Database Settings and Cost Unit Tests`, `Contracts Types RPC and Desktop Package`, `Issue ID Parsing and Agent Cleanup`, `Community 484`, `Specialist Agent Health Dashboard UI`, `Workspace Teardown and Reopen Tests`, `Specialist Pipeline PRDs and Skills`, `Cost Event Storage and WAL Tests`, `Specialist Agent Prompts and Audit Docs`, `vBRIEF Continue State and Feedback Writing`, `Caveman Hooks and Workspace Setup`, `Dashboard Tailwind CSS Config`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `string()` connect `Issue Service and Data Fetching` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Community 517`, `Agent Runtime Spawning`, `Community 518`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Inspector Panel Terminal UI`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Workspace Lifecycle and Config`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Dashboard HTTP Routes and Admin`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `Review Round Status Badge UI`, `Dashboard Design Docs and Mockups`, `Cost Event Aggregation and Retention`, `Chat Messages Timeline Rendering`, `Work Type Routing and Config`, `Agent Status RPC Contracts`, `Chat Composer Model Picker`, `Community 557`, `Cloister Config Deep Merge`, `Cloister Service Handoff Logging`, `Model Selection and Subscription Policy`, `Codex Agent Spawn UI Flow`, `VBrief Task Readiness and Beads IO`, `Config Loading and Merging`, `Fly Remote Provider and API Client`, `Settings Page Model Override and Auth`, `Issue Lifecycle Service and Tests`, `Community 573`, `Server Cache Service and Chat Markdown`, `GitHub Webhook Ingestion Handlers`, `Multi-Tracker Runtime Adapter Interface`, `Checkpoint Capture and Diff Routes`, `Cost Recovery Scripts and Latency Tests`, `Read Model Enrichment and Agent Snapshots`, `Issue Search Modal and Filter State`, `Cloister Orchestrator Architecture PRDs`, `Work Agent Prompt and Reopen Flow`, `Command Deck Action Registry Pipeline`, `Community 607`, `Community 1125`, `Claude OAuth Authentication and Settings`, `Release and Update CLI Commands`, `Cloister Pipeline Unit Tests`, `TLDR Daemon State Management`, `Cost Event Storage and WAL Tests`, `Caveman Hooks and Workspace Setup`, `Remote Agent Provisioning on Fly`, `Conversation Attachment Lifecycle Management`, `Configuration Documentation`, `Core Project Docs and Scripts`, `Community 656`, `Shadow Mode Issue Tracking`, `Remote Workspace Provider Skills`, `Specialist Registry and Run Lifecycle`, `CLI Command Taxonomy Reorganization PRD`, `Model Routing and Specialist Redesign Research`, `Review Workflow Command Coordination`, `Community 695`, `Issue Filtering and Model Fallback Tests`, `Workflow Orchestration and vBRIEF Research`, `Community 707`, `JSONL Path Resolution and Activity Fetching`, `Community 1244`, `Community 737`, `Community 738`, `Agent Activity View Dashboard Components`, `Workspace Teardown and Reopen Tests`, `Pending Lifecycle Event Processing`, `CLI Entry Point and Build Scripts`, `Community 1283`, `Community 785`, `Specialist Completion Tracking`, `Agent Queue Position Calculation`, `Git Rebase and Conflict Resolution`, `DAG Visualization and Tasks Panel`, `Fly.io Remote Provider Migration`, `Interactive Terminal Panel Integration`, `Community 886`, `Dashboard Vite Environment Types`, `Community 446`, `Community 448`, `Community 449`, `Community 450`, `Community 472`, `Community 483`, `Community 484`, `Community 500`, `Community 502`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `specialists` connect `Command Deck Overview Tab UI` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Event Store Domain Services`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Issue Service and Data Fetching`, `Shadow Mode Issue Tracking`, `Git Activity and Runtime Metrics`, `Command Deck Zone B Session Nodes`, `Cost Events Database and WAL Sync`, `VBrief Beads IO and Plan Finalize`, `CLI Install DNS and Dev Commands`, `Cost Event Aggregation and Retention`, `Workspace Config Sync and Skill Definitions`, `Work Type Routing and Config`, `Specialist Workflow Documentation and Gates`, `Agent CV and Show Commands`, `Chat Composer Model Picker`, `Cloister Config Deep Merge`, `Settings Provider and Model Browser UI`, `Pending Feedback Queue Delivery`, `Swarm Dispatch and DAG Execution`, `Dashboard Motion Animation Catalog`, `Specialist Commands and VBrief Index`, `Model Routing and Complexity Detection`, `Conversation Compaction and Fork Pipeline`, `Caveman Skill Compression Validation`, `Community 472`, `Multi-Tracker Adapter Implementations`, `Community 481`, `Community 484`, `Project Config and Team Prefix Resolution`, `Specialist Agent Health Dashboard UI`, `Cost Event Storage and WAL Tests`, `Specialist Agent Prompts and Audit Docs`, `vBRIEF Continue State and Feedback Writing`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 290 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 290 INFERRED edges - model-reasoned connections that need verification._
- **Are the 246 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 246 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14213 weakly-connected nodes found - possible documentation gaps or missing edges._
