# Graph Report - feature-pan-1053  (2026-05-16)

## Corpus Check
- 1616 files · ~2,175,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22912 nodes · 34660 edges · 1182 communities (1141 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 474 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec7f224d`
...
1. `fetch` - 174 edges
2. `resolveProjectFromIssue()` - 117 edges
3. `getDatabase()` - 93 edges
4. `useDashboardStore` - 61 edges
5. `sessionExistsAsync()` - 58 edges
6. `killSessionAsync()` - 53 edges
7. `listSessionNamesAsync()` - 52 edges
8. `spawnAgent()` - 51 edges
9. `spawnEphemeralSpecialist()` - 50 edges
10. `spawnRun()` - 48 edges
...
## Communities (1182 total, 41 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (150): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (136): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (154): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), spawnInspectAgent(), resolveSpecialistBaseCommand(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync (+146 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (156): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash() (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (138): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+130 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (119): reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+111 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (103): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+95 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (97): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+89 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (113): readCavemanVariant(), checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), getActiveParallelReviewIssues(), scheduleDigestGeneration(), buildProviderExportLines(), buildSpecialistCavemanExports() (+105 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (105): AutoPresoSession, adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin() (+97 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (116): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (89): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+81 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (89): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (100): DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan(), swarmCommand(), taskOperation() (+92 more)
...
Cohesion: 0.03
Nodes (89): getReviewerSessionName(), Access, withConcurrencyLimit(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer (+81 more)
...
Cohesion: 0.03
Nodes (75): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (85): showCommand(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+77 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (75): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (81): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+73 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (80): clearFeedbackFiles(), buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (66): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, doc, path (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (80): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+72 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (73): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+65 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (82): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+74 more)
...
Cohesion: 0.03
Nodes (72): resetPostMergeState(), agentDir, dir1, dir2, marker, missing, nested, cb (+64 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (66): Conversation, listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getClientIp() (+58 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (64): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), FileStatus, AGENTS_DIR, ARCHIVES_DIR, BIN_DIR (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (61): loadCloisterConfig(), cleanupStaleAgentState(), AgentHealth, checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure() (+53 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (52): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+44 more)
...
Cohesion: 0.06
Nodes (66): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (68): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+60 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (60): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+52 more)
...
Cohesion: 0.05
Nodes (59): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (60): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+52 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (57): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (39): emitter, emitter, onTurn, getHeader(), getTrustedOrigins(), isTrustedOriginForHost(), normalizeOrigin(), validateOrigin() (+31 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (54): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+46 more)
...
Cohesion: 0.05
Nodes (53): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+45 more)
...
Cohesion: 0.05
Nodes (52): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, getDebugInfo(), getGlobalRouter() (+44 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (47): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+39 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (55): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+47 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (37): StandaloneTerminal(), StandaloneTerminalProps, fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, ContextMenuState, isMac (+29 more)
...
Cohesion: 0.05
Nodes (47): checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker (+39 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (46): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+38 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (50): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry (+42 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (50): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+42 more)
...
Cohesion: 0.05
Nodes (49): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+41 more)
...
Cohesion: 0.06
Nodes (43): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError() (+35 more)
...
Cohesion: 0.07
Nodes (41): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+33 more)
...
Cohesion: 0.08
Nodes (39): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+31 more)
...
Cohesion: 0.05
Nodes (42): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+34 more)
...
Cohesion: 0.06
Nodes (44): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+36 more)
...
Cohesion: 0.05
Nodes (35): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), createCall, dbError, deleteCalls, doc (+27 more)
...
Cohesion: 0.06
Nodes (31): CodexAuthBanner(), PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step (+23 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (32): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir() (+24 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (35): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+27 more)
...
Cohesion: 0.08
Nodes (28): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), daemonRegistry (+20 more)
...
Cohesion: 0.07
Nodes (34): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+26 more)
...
Cohesion: 0.07
Nodes (36): AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, displayModelRef(), fetchAvailableModels(), fetchSettings(), isWorkhorseRef(), modelExists() (+28 more)
...
Cohesion: 0.1
Nodes (36): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+28 more)

### Community 120 - "Community 120"
Cohesion: 0.09
Nodes (35): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+27 more)
...
Cohesion: 0.12
Nodes (35): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+27 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (28): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime(), PiSpawnTimeout (+20 more)

### Community 124 - "Community 124"
Cohesion: 0.1
Nodes (35): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart(), findLocalWorkspace(), findProjectRoot() (+27 more)
...
Cohesion: 0.07
Nodes (28): setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, getAllActiveQueues(), setPipelineHandler(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions() (+20 more)

### Community 132 - "Community 132"
Cohesion: 0.09
Nodes (33): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+25 more)

### Community 133 - "Community 133"
Cohesion: 0.07
Nodes (29): killCommand(), KillOptions, resetSessionCommand(), resumeCommand(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror (+21 more)
...
Cohesion: 0.09
Nodes (31): healthCommand(), HealthOptions, listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile() (+23 more)

### Community 158 - "Community 158"
Cohesion: 0.06
Nodes (24): criteria, doc, projectDoc, projectRoot, workspaceDoc, workspacePath, mockGetIssue, parentWorkspace (+16 more)
...
Cohesion: 0.1
Nodes (33): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+25 more)

### Community 167 - "Community 167"
Cohesion: 0.07
Nodes (28): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, cleanupLabelsGitHub() (+20 more)
...
Cohesion: 0.07
Nodes (32): findProjectsByRallyProject(), loadProjectsConfig(), extractIssuePrefix(), GitHubIssueResolution, GitHubRepoConfig, isGitHubIssue(), IssueResolution, NonGitHubResolution (+24 more)
...
Cohesion: 0.15
Nodes (28): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+20 more)
...
Cohesion: 0.11
Nodes (28): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+20 more)
...
Cohesion: 0.1
Nodes (25): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+17 more)

### Community 229 - "Community 229"
Cohesion: 0.07
Nodes (29): CLI Distribution Strategy, code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:bash (# First time - zero install), code:bash (# pan init adds to ~/.bashrc or ~/.zshrc:) (+21 more)
...
Cohesion: 0.13
Nodes (26): closeIssue(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+18 more)

### Community 242 - "Community 242"
Cohesion: 0.07
Nodes (27): cb, completedState, dispatched, failedState, featureWorkspace, implSlot, initial, initialState (+19 more)
...
Cohesion: 0.08
Nodes (24): body, bytes, claudeProjectDir, conv, created, deliverMock, delivery, encodedCwd (+16 more)
...
Cohesion: 0.07
Nodes (23): after, before, completedAt, content, first, handoff, handoff1, handoff2 (+15 more)

### Community 255 - "Community 255"
Cohesion: 0.11
Nodes (24): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl() (+16 more)
...
Cohesion: 0.16
Nodes (3): IssueDataService, issuesChanged(), mapRallyStateToCanonical()
...
Cohesion: 0.1
Nodes (23): badPath, customPlanningDir, dir, doc, filename, item, item2, lifecyclePlan (+15 more)
...
Cohesion: 0.09
Nodes (23): 1. Read the context manifest first, 1. Review the shared context first, 2. Spawn convoy reviewers, 2. Wait for convoy signals, 3. Read available reviewer reports, 3. Wait for convoy output files, 4. Read available reviewer reports, 4. Synthesize the verdict (+15 more)
...
Cohesion: 0.11
Nodes (19): NormalizedChannelPermissionRequestFields, buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody(), parsePermissionResponseBehavior(), permissionResolutionVerb(), processPermissionResponse(), ProcessPermissionResponseDeps (+11 more)

### Community 361 - "Community 361"
Cohesion: 0.13
Nodes (19): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+11 more)
...
Cohesion: 0.1
Nodes (19): Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, buildMiniMaxFormData(), allModelIds, config (+11 more)
...
Cohesion: 0.18
Nodes (18): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+10 more)

### Community 378 - "Community 378"
Cohesion: 0.16
Nodes (13): beadsDir, doc, getVBriefACStatus(), checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode(), execAsync (+5 more)
...
Cohesion: 0.18
Nodes (16): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+8 more)

### Community 412 - "Community 412"
Cohesion: 0.12
Nodes (15): getBridgeLogPath(), getPanopticonHome(), getSocketPath(), startUnixListener(), BRIDGE_ENTRY, entry, exitPromise, lines (+7 more)
...
Cohesion: 0.14
Nodes (9): ReopenOptions, ReopenResult, reopenWorkspaceState(), activeContinuePath, continuePath, projectRoot, updated, wsDir (+1 more)
...
Cohesion: 0.17
Nodes (14): transitionIssueState(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy (+6 more)
...
Cohesion: 0.22
Nodes (13): runCommand(), execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite() (+5 more)
...
Cohesion: 0.2
Nodes (11): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), bead, beads (+3 more)
...
Cohesion: 0.14
Nodes (13): agentDir, body, envArg, launcher, LEGACY_FIELDS, legacyFields, options, reloaded (+5 more)
...
Cohesion: 0.15
Nodes (12): Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Panopticon Planning Lifecycle, Related commands (+4 more)
...
Cohesion: 0.3
Nodes (11): createSpecialistHandoff(), ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getTodaySpecialistHandoffs(), logSpecialistHandoff(), readIssueSpecialistHandoffs() (+3 more)
...
Cohesion: 0.31
Nodes (10): buildContinuation(), convertConversationTranscript(), ConvertOptions, ConvertResult, extractClaudeTranscript(), extractContentText(), extractPiTranscript(), renderTranscript() (+2 more)
...
Cohesion: 0.2
Nodes (10): Auto-Behaviors, code:block7 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), Continue State, Dashboard Viewer, Legacy paths, Lifecycle Directories, Status is a JSON field, not a directory, The five-artifact model (PAN-967 + PAN-946) (+2 more)
...
Cohesion: 0.2
Nodes (9): Code Review: Requirements Coverage, code:markdown (# Requirements Coverage Review - <timestamp>), Inputs from your spawn prompt, Method, Output format, Scope, Severity and evidence, TLDR: prefer code summaries over full reads (+1 more)
...
Cohesion: 0.31
Nodes (8): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), normalizePermissionInputPreview(), utf8ByteLength(), forwarder
...
Cohesion: 0.42
Nodes (8): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName()

### Community 719 - "Community 719"
Cohesion: 0.22
Nodes (8): kCustom, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile, parsed
...
Cohesion: 0.43
Nodes (7): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09, Flywheel State Snapshot, Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.29
Nodes (6): listener(), electron, IPC, result, wrapped(), notifyVoiceSettings()
...
Cohesion: 0.29
Nodes (7): Auto-Start (skip planning), code:bash (pan plan <id>), code:bash (pan start <id> --auto), code:typescript (// Correct (in sendKeysAsync):), Interactive (default), Planning Modes, tmux Message Delivery
...
Cohesion: 0.83
Nodes (4): cleanupAllLogs(), cleanupOldLogs(), getSpecialistRetention(), cleanupLogsCommand()
...
Cohesion: 0.5
Nodes (4): Auto (non-interactive), code:bash (pan plan <id> --auto), code:block8 (**PRD:** [`path/to/prd.md`](https link to the file in the re), Issue Creation from PRDs
...
## Knowledge Gaps
- **12089 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12084 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 257`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 142`, `Community 16`, `Community 785`, `Community 141`, `Community 19`, `Community 277`, `Community 22`, `Community 408`, `Community 24`, `Community 666`, `Community 156`, `Community 159`, `Community 31`, `Community 551`, `Community 46`, `Community 48`, `Community 53`, `Community 57`, `Community 58`, `Community 186`, `Community 577`, `Community 68`, `Community 581`, `Community 840`, `Community 718`, `Community 85`, `Community 346`, `Community 225`, `Community 361`, `Community 620`, `Community 117`, `Community 255`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 5` to `Community 225`, `Community 2`, `Community 3`, `Community 196`, `Community 4`, `Community 38`, `Community 167`, `Community 170`, `Community 43`, `Community 10`, `Community 719`, `Community 18`, `Community 20`, `Community 53`, `Community 345`, `Community 122`, `Community 29`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 461` to `Community 11`, `Community 2`, `Community 578`, `Community 51`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 173 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 173 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12089 weakly-connected nodes found - possible documentation gaps or missing edges._
