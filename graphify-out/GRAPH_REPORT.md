...
## Corpus Check
- 1747 files · ~2,335,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23953 nodes · 36751 edges · 1202 communities (1153 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `820729c7`
...
## Communities (1202 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (201): checkCompletedButUnsignaledReviews(), cleanupStaleAgentState(), monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+193 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (156): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+148 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (136): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (112): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+104 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (135): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+127 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (122): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, adminRouteLayer (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (118): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execAsync, restoreTrackedBeadsExport() (+110 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (113): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+105 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (116): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), resetPostMergeState(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash() (+108 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (91): parsePiSession(), getPiLauncherFields(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (88): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView (+80 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (99): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (102): IssueWorkbenchProps, ZoneA(), ZoneAProps, ZoneCConversation(), ZoneCConversationProps, ALL_TABS, OverviewTab, OverviewTabSpec (+94 more)
...
Cohesion: 0.03
Nodes (86): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (102): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getTrackerContext(), doneCommand(), DoneOptions, execAsync (+94 more)
...
Cohesion: 0.02
Nodes (93): ensureDefaultConversationModel(), CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings() (+85 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (80): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+72 more)
...
Cohesion: 0.04
Nodes (74): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc (+66 more)
...
Cohesion: 0.04
Nodes (82): checkApiErrorAgents(), captureTmuxOutput(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+74 more)
...
Cohesion: 0.03
Nodes (61): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+53 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (70): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization() (+62 more)
...
Cohesion: 0.04
Nodes (71): readCavemanVariant(), checkStuckReviewing(), finalizeRunLog(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist() (+63 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (77): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+69 more)
...
Cohesion: 0.04
Nodes (76): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+68 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (67): agentStatusCommand(), AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+59 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (65): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+57 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (70): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+62 more)
...
Cohesion: 0.04
Nodes (71): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+63 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (72): defaults, first, { models }, second, RoleConfig, RolesConfig, TtsDaemonConfig, ALLOWED_SUB_ROLES (+64 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (64): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+56 more)
...
Cohesion: 0.04
Nodes (63): generateFallbackSummary(), Access, AIProvider, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), validateCwdContainment() (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (54): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, activeRoleRunExists() (+46 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (52): buildActiveSliceContext(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readPendingFeedback(), readWorkspacePlanAsync(), WorkAgentPromptContext, cont (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (55): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl() (+47 more)
...
Cohesion: 0.05
Nodes (53): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+45 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (50): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, withConcurrencyLimit(), result, ActivityContext (+42 more)
...
Cohesion: 0.06
Nodes (49): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, content, d, existingDir, lines, oldDir (+41 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (50): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+42 more)
...
Cohesion: 0.06
Nodes (50): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+42 more)
...
Cohesion: 0.06
Nodes (42): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+34 more)
...
Cohesion: 0.06
Nodes (49): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+41 more)
...
Cohesion: 0.05
Nodes (41): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+33 more)
...
Cohesion: 0.05
Nodes (39): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+31 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (39): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+31 more)
...
Cohesion: 0.09
Nodes (44): buildWorkAgentPrompt(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+36 more)
...
Cohesion: 0.06
Nodes (46): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+38 more)
...
Cohesion: 0.07
Nodes (36): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+28 more)
...
Cohesion: 0.06
Nodes (32): estimateCost(), getModelCapability(), MODEL_CAPABILITIES, MODEL_DEPRECATIONS, ModelCapability, SkillDimension, deprecatedIds, resolved (+24 more)
...
Cohesion: 0.14
Nodes (39): ARCHIVES_DIR, archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync (+31 more)
...
Cohesion: 0.07
Nodes (29): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+21 more)
...
Cohesion: 0.11
Nodes (29): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR (+21 more)
...
Cohesion: 0.09
Nodes (31): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+23 more)
...
Cohesion: 0.11
Nodes (28): clearFeedbackFiles(), readFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync(), uniqueTmpPath() (+20 more)
...
Cohesion: 0.1
Nodes (27): GIT_PATTERNS, scanGitPatterns(), MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen (+19 more)
...
Cohesion: 0.08
Nodes (23): makeTestService(), sentinel, createEventStore(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore() (+15 more)
...
Cohesion: 0.12
Nodes (29): archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+21 more)
...
Cohesion: 0.09
Nodes (20): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), HARNESS_OPTIONS, HarnessDecision (+12 more)
...
Cohesion: 0.15
Nodes (15): beadsDir, doc, getVBriefACStatus(), BeadRecord, checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode() (+7 more)
...
Cohesion: 0.11
Nodes (16): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+8 more)
...
Cohesion: 0.1
Nodes (13): mockGetIssue, parentWorkspace, planDoc, specsDir, written, first, found, path (+5 more)
...
Cohesion: 0.18
Nodes (18): Role, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapper(), LauncherConfig (+10 more)
...
Cohesion: 0.15
Nodes (12): consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardSessionUrl(), DEFAULT_RETRY_DELAY, ensureDashboardSession(), makePanRpcClient, PanRpcProtocolClient, resetTransport() (+4 more)
...
## Knowledge Gaps
- **12449 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12444 more)
...
- **Why does `fetch` connect `Community 1` to `Community 636`, `Community 128`, `Community 2`, `Community 3`, `Community 12`, `Community 397`, `Community 14`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 16`, `Community 22`, `Community 282`, `Community 26`, `Community 28`, `Community 285`, `Community 798`, `Community 415`, `Community 31`, `Community 417`, `Community 30`, `Community 295`, `Community 40`, `Community 42`, `Community 171`, `Community 43`, `Community 46`, `Community 686`, `Community 944`, `Community 56`, `Community 59`, `Community 571`, `Community 61`, `Community 63`, `Community 191`, `Community 64`, `Community 195`, `Community 68`, `Community 70`, `Community 198`, `Community 209`, `Community 597`, `Community 88`, `Community 97`, `Community 104`, `Community 114`, `Community 115`, `Community 380`, `Community 637`, `Community 127`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 56` to `Community 0`, `Community 1`, `Community 162`, `Community 4`, `Community 166`, `Community 6`, `Community 8`, `Community 683`, `Community 15`, `Community 112`, `Community 52`, `Community 55`, `Community 23`, `Community 24`, `Community 410`, `Community 190`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 20` to `Community 192`, `Community 193`, `Community 37`, `Community 6`, `Community 263`, `Community 361`, `Community 16`, `Community 49`, `Community 379`, `Community 23`, `Community 504`, `Community 378`, `Community 27`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12449 weakly-connected nodes found - possible documentation gaps or missing edges._
