...
## Corpus Check
- 1544 files · ~2,059,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21524 nodes · 32003 edges · 1129 communities (1096 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 422 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a16073b`
...
## Communities (1129 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (166): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (122): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+114 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (110): getDefaultConversationModel(), ForkModal(), ForkModalProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps (+102 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (124): setAgentStoppedNotifier(), emitCoordinatorDied(), dispatchTestAgentAndNotify(), pendingCommand(), mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist, notify (+116 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (117): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+109 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (132): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+124 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (105): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ViewMode, firstSessionPanel, firstWorkbench (+97 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (126): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay(), dispatchParallelReview() (+118 more)
...
Cohesion: 0.04
Nodes (104): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (85): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (78): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, PlanDialog() (+70 more)
...
Cohesion: 0.03
Nodes (75): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (79): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (68): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+60 more)
...
Cohesion: 0.03
Nodes (76): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (76): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+68 more)
...
Cohesion: 0.04
Nodes (66): WorkLogEntry, ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage() (+58 more)
...
Cohesion: 0.05
Nodes (57): criteria, doc, result, doc, path, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria() (+49 more)
...
Cohesion: 0.04
Nodes (49): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+41 more)
...
Cohesion: 0.03
Nodes (61): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+53 more)
...
Cohesion: 0.04
Nodes (59): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+51 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (52): loadCloisterConfig(), isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent, restartCalled (+44 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (51): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, beadsDir, doc (+43 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (56): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+48 more)
...
Cohesion: 0.06
Nodes (54): closeOutCommand(), CloseOutOptions, getGitHubConfig(), projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand() (+46 more)
...
Cohesion: 0.05
Nodes (55): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT (+47 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (50): checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus(), DASHBOARD_URL (+42 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (42): parsePiSession(), getPiLauncherFields(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync (+34 more)
...
Cohesion: 0.06
Nodes (50): spawnReviewCoordinatorSession(), spawnSingleReviewer(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, getAgentRuntimeBaseCommand(), getProviderExportsForModel(), panopticonAgentName(), getClaudePermissionFlags(), getClaudePermissionFlagsString() (+42 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (51): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (46): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+38 more)

### Community 46 - "Community 46"
Cohesion: 0.08
Nodes (48): isEligibleForCleanup(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+40 more)
...
Cohesion: 0.06
Nodes (48): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+40 more)
...
Cohesion: 0.06
Nodes (43): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeViolations, checkAgentForViolations(), clearOldViolations(), DEFAULT_FPP_CONFIG (+35 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (37): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), writeSpecForIssue() (+29 more)
...
Cohesion: 0.08
Nodes (32): agentDir, missing, result, snapshot, status, withConcurrencyLimit(), discoverNewAgentIds(), ReadModelServiceShape (+24 more)
...
Cohesion: 0.06
Nodes (22): callServerApi(), currentStatus, DEFAULTS, electron, electron_updater, fetchActiveWorkspaces(), iconPath, initializeAutoUpdater() (+14 more)
...
Cohesion: 0.07
Nodes (23): EventRouter(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache() (+15 more)

### Community 147 - "Community 147"
Cohesion: 0.07
Nodes (23): RoundMarker, ZoneCConversation(), ZoneCConversationProps, deriveRoundMarkers(), TimestampedItem, resolveWorkTypeKey(), useResolvedModels(), fmtCost() (+15 more)
...
Cohesion: 0.12
Nodes (26): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+18 more)
...
Cohesion: 0.1
Nodes (21): CloisterStatusBar(), DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), getRenderablePatch(), DiffWorkerPoolProvider() (+13 more)
...
Cohesion: 0.13
Nodes (27): archivePlanning(), closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+19 more)
...
Cohesion: 0.09
Nodes (21): ensureDefaultConversationModel(), AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS, HarnessDecision (+13 more)
...
Cohesion: 0.16
Nodes (22): registerAdminCommands(), registerCloisterCommands(), compactCommand(), CompactOptions, detectPlatform(), doctorCommand(), execAsync, getOldClosedCount() (+14 more)
...
Cohesion: 0.15
Nodes (20): shadowCommand(), CanonicalState, getDisplayStatus(), getShadowState(), getShadowStatePath(), getUnsyncedHistory(), markAsSynced(), needsSync() (+12 more)
...
Cohesion: 0.16
Nodes (24): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+16 more)
...
Cohesion: 0.18
Nodes (22): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+14 more)
...
Cohesion: 0.11
Nodes (20): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+12 more)
...
## Knowledge Gaps
- **11456 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11451 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 136`, `Community 137`, `Community 265`, `Community 10`, `Community 12`, `Community 11`, `Community 14`, `Community 527`, `Community 144`, `Community 16`, `Community 274`, `Community 526`, `Community 15`, `Community 21`, `Community 20`, `Community 23`, `Community 18`, `Community 22`, `Community 156`, `Community 29`, `Community 546`, `Community 34`, `Community 166`, `Community 39`, `Community 552`, `Community 45`, `Community 49`, `Community 72`, `Community 79`, `Community 84`, `Community 103`, `Community 231`, `Community 747`, `Community 236`, `Community 628`, `Community 629`, `Community 635`, `Community 126`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 0`, `Community 10`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 23` to `Community 352`, `Community 33`, `Community 26`, `Community 58`, `Community 550`, `Community 103`, `Community 365`, `Community 24`, `Community 186`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11456 weakly-connected nodes found - possible documentation gaps or missing edges._
