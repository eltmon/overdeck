...
## Corpus Check
- 1915 files · ~3,142,405 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27451 nodes · 43075 edges · 1274 communities (1218 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 802 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48c26229`
...
## Communities (1274 total, 56 thin omitted)
...
Cohesion: 0.01
Nodes (158): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+150 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (177): spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions (+169 more)
...
Cohesion: 0.02
Nodes (135): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE (+127 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (141): PlanningState, ZoneAActionsState, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+133 more)
...
Cohesion: 0.02
Nodes (119): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, isStale(), PHASE_CONFIG, recentActionObservations() (+111 more)
...
Cohesion: 0.02
Nodes (101): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+93 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (94): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+86 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (99): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS (+91 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (99): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+91 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (89): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (109): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, bridgeCodexAuthToCliproxyEffect(), adminRouteLayer (+101 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (89): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+81 more)
...
Cohesion: 0.03
Nodes (98): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+90 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (92): confirmHostOverride(), resumeCommand(), ResumeOptions, computeAgentEnrichment(), isAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getAgentRuntimeStateEffect() (+84 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (92): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError (+84 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (91): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+83 more)
...
Cohesion: 0.03
Nodes (85): getHealthThresholdsMs(), checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted (+77 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (98): dequeueMerge(), enqueueMerge(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next, remaining (+90 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (90): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+82 more)
...
Cohesion: 0.03
Nodes (86): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+78 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (79): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), cleanFile(), configCommand(), execAsync (+71 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (71): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (66): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), cleanupAgentDirectories() (+58 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (80): generateSummaryForFork(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+72 more)
...
Cohesion: 0.04
Nodes (68): ComposerMode, IssueComposerProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request (+60 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (86): updateTtsConfig(), estimateCost(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig (+78 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (72): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+64 more)
...
Cohesion: 0.05
Nodes (69): buildPolyrepoContext(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace() (+61 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (73): buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, buildNewSessionArgs() (+65 more)
...
Cohesion: 0.05
Nodes (68): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+60 more)
...
Cohesion: 0.05
Nodes (63): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+55 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (59): EDITOR_LABELS, PanOpenInPickerProps, fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), adaptFlywheelAgent(), AGENT_STATUS_MAP (+51 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (60): captureFiles(), buildActiveSliceContext(), inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), WorkAgentPromptContext, cont, doc (+52 more)
...
Cohesion: 0.04
Nodes (58): DeaconState, isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent, restartCalled (+50 more)
...
Cohesion: 0.04
Nodes (63): queryCostEvents(), TranscriptClaimTrigger, costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath (+55 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (59): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, encodeClaudeProjectDir(), result, pathExists(), pickFreshestSessionId() (+51 more)
...
Cohesion: 0.07
Nodes (66): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials (+58 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (53): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+45 more)
...
Cohesion: 0.06
Nodes (64): buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), addGitHubComment(), fetchGitHubIssue() (+56 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (30): stopDeacon(), getAgentsNeedingAttention(), CloisterService, readStateFile(), writeStateFile(), listRunningAgents(), agentState, callOrder (+22 more)
...
Cohesion: 0.05
Nodes (49): confirmCost(), enrichAction(), formatCost(), showAction(), getDiscoveredSessionById(), markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt() (+41 more)
...
Cohesion: 0.05
Nodes (58): array, combine, compareObjects(), hash(), isEqual(), number(), optimize(), random() (+50 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (38): GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension (+30 more)
...
Cohesion: 0.05
Nodes (55): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+47 more)
...
Cohesion: 0.05
Nodes (52): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext, HandoffContextError (+44 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (47): AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+39 more)
...
Cohesion: 0.04
Nodes (45): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+37 more)

### Community 82 - "Community 82"
Cohesion: 0.07
Nodes (33): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, destroyPiFifo() (+25 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (48): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+40 more)
...
Cohesion: 0.04
Nodes (51): result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute (+43 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (48): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceShape, ReviewStatusSnapshotInput (+40 more)
...
Cohesion: 0.04
Nodes (51): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect(), readBeadsFromJsonl() (+43 more)
...
Cohesion: 0.07
Nodes (38): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult, onInspectComplete() (+30 more)
...
Cohesion: 0.06
Nodes (35): CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, AssistantMessageRow(), formatElapsed(), formatTimestamp(), isReviewerContextMessage() (+27 more)
...
Cohesion: 0.06
Nodes (35): sentinel, markAgentStateServiceInProcess(), emitReactiveLifecycleEvent(), emitResetMarkerCreated(), emitMemoryHealthChanged(), enqueueStatusRollupEvent(), emitMemoryObservationCreated(), emitStatusUpdatedEvent() (+27 more)
...
Cohesion: 0.09
Nodes (43): flywheelAbortCommand(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata() (+35 more)
...
Cohesion: 0.06
Nodes (32): ApproveOptions, ArchiveOptions, DeepWipeOptions, WorkflowResult, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep() (+24 more)
...
Cohesion: 0.05
Nodes (32): AgentState, __testInternals, clearRunningAgentsCache(), getCachedRunningAgents(), ListAgentsEffect, RunningAgent, RunningAgents, runningAgentsCache (+24 more)
...
Cohesion: 0.09
Nodes (37): embedAction(), SearchQuery, getSetting(), getConversationByName(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), ConversationFilter, getDiscoveredStats() (+29 more)
...
Cohesion: 0.05
Nodes (32): deleteReviewStatus(), all, blockers, entry, history, result, row, rows (+24 more)
...
Cohesion: 0.06
Nodes (35): updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+27 more)
...
Cohesion: 0.07
Nodes (27): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), Tab, FlywheelRunSummary, NAV_GROUPS (+19 more)
...
Cohesion: 0.07
Nodes (15): clientMock, octokitMock, result, states, GitHubTracker, octokitToEffect(), parseIssueNumber(), error (+7 more)
...
Cohesion: 0.15
Nodes (32): extractNumber(), archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl() (+24 more)

### Community 245 - "Community 245"
Cohesion: 0.12
Nodes (28): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+20 more)
...
Cohesion: 0.14
Nodes (27): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPath(), getPRDDraftPathEffect(), hasPRDDraft(), hasPRDDraftEffect() (+19 more)
...
Cohesion: 0.15
Nodes (24): apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect(), generateJWT(), getAppStatus() (+16 more)
...
Cohesion: 0.12
Nodes (17): calls, { mockExecAsync }, opts, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync, { mockExecAsync } (+9 more)
...
Cohesion: 0.16
Nodes (18): writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+10 more)
...
Cohesion: 0.11
Nodes (15): StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED (+7 more)
...
Cohesion: 0.15
Nodes (8): WipeOptions, extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result
...
Cohesion: 0.16
Nodes (14): getForgeAdapter(), buildMergeSetForIssue(), ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), createReviewArtifactsForIssue(), execAsync (+6 more)
...
Cohesion: 0.19
Nodes (3): createFlyApiClient(), execAsync, FlyProvider
...
Cohesion: 0.16
Nodes (12): buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), dispatchTestAgentAndNotifyEffect(), DispatchTestAgentResult, TestDispatchError, mockResolveProjectFromIssue, mockSetReviewStatus (+4 more)
...
Cohesion: 0.2
Nodes (13): BeadRecord, checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode(), execAsync, execFileAsync, isMissingCommand() (+5 more)
...
Cohesion: 0.29
Nodes (6): bead, beads, plan, specsDir, writeMainSpec(), ws123
...
Cohesion: 0.53
Nodes (5): normalize(), unarchiveConversationCommand(), listArchivedConversations(), unarchiveConversation(), requireTrustedMutationOrigin()
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 518`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 538`, `Community 28`, `Community 541`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 38`, `Community 40`, `Community 43`, `Community 49`, `Community 50`, `Community 563`, `Community 52`, `Community 53`, `Community 54`, `Community 51`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 62`, `Community 66`, `Community 68`, `Community 70`, `Community 71`, `Community 75`, `Community 76`, `Community 77`, `Community 80`, `Community 83`, `Community 85`, `Community 603`, `Community 92`, `Community 96`, `Community 98`, `Community 101`, `Community 103`, `Community 123`, `Community 124`, `Community 128`, `Community 644`, `Community 134`, `Community 140`, `Community 141`, `Community 153`, `Community 159`, `Community 165`, `Community 166`, `Community 180`, `Community 189`, `Community 198`, `Community 201`, `Community 202`, `Community 209`, `Community 212`, `Community 732`, `Community 734`, `Community 225`, `Community 244`, `Community 248`, `Community 249`, `Community 770`, `Community 258`, `Community 775`, `Community 292`, `Community 293`, `Community 294`, `Community 327`, `Community 328`, `Community 335`, `Community 380`, `Community 909`, `Community 405`, `Community 409`, `Community 422`, `Community 440`, `Community 459`, `Community 470`, `Community 474`, `Community 478`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 31` to `Community 133`, `Community 38`, `Community 519`, `Community 7`, `Community 9`, `Community 50`, `Community 211`, `Community 308`, `Community 21`, `Community 405`, `Community 24`, `Community 26`, `Community 95`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 3`, `Community 643`, `Community 5`, `Community 6`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 267`, `Community 12`, `Community 11`, `Community 14`, `Community 13`, `Community 16`, `Community 147`, `Community 20`, `Community 21`, `Community 22`, `Community 279`, `Community 27`, `Community 31`, `Community 160`, `Community 35`, `Community 292`, `Community 37`, `Community 164`, `Community 40`, `Community 49`, `Community 53`, `Community 57`, `Community 65`, `Community 68`, `Community 70`, `Community 76`, `Community 333`, `Community 338`, `Community 213`, `Community 95`, `Community 224`, `Community 98`, `Community 611`, `Community 226`, `Community 107`, `Community 111`, `Community 119`, `Community 249`, `Community 123`, `Community 124`, `Community 381`, `Community 126`?**
