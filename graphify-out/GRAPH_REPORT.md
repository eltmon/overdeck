...
## Corpus Check
- 1555 files · ~2,065,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21683 nodes · 32098 edges · 1139 communities (1104 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 425 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b61073f`
...
## Communities (1139 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (137): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+129 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (137): readCavemanVariant(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+129 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (115): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+107 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (129): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+121 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (110): killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), getRuntimeSnapshotSync() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (111): isMergeAgentRunning(), spawnReviewCoordinatorSession(), healthCommand(), HealthOptions, dismissDevChannelsDialog(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux() (+103 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (111): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (79): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (81): format(), LiveCounter(), LiveCounterProps, PlanningState, ZoneAActionsState, state, EDITOR_LABELS, PanOpenInPicker() (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (96): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (81): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+73 more)
...
Cohesion: 0.03
Nodes (79): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+71 more)
...
Cohesion: 0.03
Nodes (89): checkFailedMergeRetry(), checkPendingTestDispatch(), clearStaleCiFeedback(), reconcileAndCheckIfMerged(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+81 more)
...
Cohesion: 0.03
Nodes (73): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+65 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (75): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (64): firstSessionPanel, firstWorkbench, workbench, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus() (+56 more)
...
Cohesion: 0.05
Nodes (72): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (65): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+57 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (67): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+59 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (56): getUnblockedItems(), TERMINAL_STATUSES, criteria, doc, result, result, ACCompletionResult, checkAllCriteriaCompleted() (+48 more)
...
Cohesion: 0.06
Nodes (67): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+59 more)
...
Cohesion: 0.04
Nodes (62): shouldAutoStart(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (59): generateFallbackSummary(), generateSummaryForFork(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, deleteConversationFavoriteRoute, execAsync (+51 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (60): Access, withConcurrencyLimit(), getIssueDataService(), ActivityContext, closedIssuesCache, costCache, execAsync, execFileAsync (+52 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (58): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+50 more)
...
Cohesion: 0.06
Nodes (61): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (52): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, capturePaneAsync(), confirmDelivery(), getWindowDimensionsAsync(), result (+44 more)
...
Cohesion: 0.07
Nodes (46): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile() (+38 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (47): buildACLookupByTitle(), computePlanningState(), beadsDir, doc, AcceptanceCriterion, extractACFromDocument(), createBeadsFromVBrief(), CreateBeadsResult (+39 more)
...
Cohesion: 0.07
Nodes (47): buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+39 more)
...
Cohesion: 0.05
Nodes (46): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+38 more)
...
Cohesion: 0.08
Nodes (20): issues, result, importTrackerConfig(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache (+12 more)
...
Cohesion: 0.07
Nodes (41): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+33 more)

### Community 68 - "Community 68"
Cohesion: 0.12
Nodes (45): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+37 more)
...
Cohesion: 0.08
Nodes (39): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, ApproveOptions (+31 more)
...
Cohesion: 0.09
Nodes (6): stopDeacon(), generateHealthSummary(), getAgentsNeedingAttention(), CloisterService, readStateFile(), writeStateFile()
...
Cohesion: 0.06
Nodes (32): Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+24 more)
...
Cohesion: 0.11
Nodes (30): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, ensureShadowStateDir(), getDisplayStatus(), getShadowState() (+22 more)
...
Cohesion: 0.07
Nodes (22): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+14 more)

### Community 135 - "Community 135"
Cohesion: 0.08
Nodes (35): buildConversationResponse(), getCachedMessages(), validateCwdContainment(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+27 more)
...
Cohesion: 0.09
Nodes (33): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth(), HealthSummary (+25 more)

### Community 142 - "Community 142"
Cohesion: 0.06
Nodes (25): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TerminalSizeMessage, TerminalSnapshotMessage, checkbox, consoleErrorSpy (+17 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (31): resetDb(), resetDb(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), closeDatabase(), getDatabasePath() (+23 more)
...
Cohesion: 0.08
Nodes (28): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, deepMerge() (+20 more)
...
Cohesion: 0.09
Nodes (30): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectInitCommand(), projectListCommand() (+22 more)
...
Cohesion: 0.14
Nodes (28): listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments() (+20 more)
...
Cohesion: 0.13
Nodes (24): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+16 more)
...
Cohesion: 0.14
Nodes (21): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+13 more)
...
Cohesion: 0.14
Nodes (21): appendCostEvent(), deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath(), readEventsFromLine() (+13 more)
...
Cohesion: 0.24
Nodes (23): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+15 more)
...
Cohesion: 0.22
Nodes (18): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+10 more)
...
Cohesion: 0.16
Nodes (11): getRenderablePatch(), DiffWorkerPoolProvider(), Theme, ThemeState, useTheme, buildPatchCacheKey(), DIFF_THEME_NAMES, DiffThemeName (+3 more)
...
Cohesion: 0.24
Nodes (15): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+7 more)

### Community 447 - "Community 447"
Cohesion: 0.17
Nodes (14): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength(), buildPermissionActivityDetails(), buildPermissionWaitingMessage(), parsePermissionResponseBehavior() (+6 more)

### Community 448 - "Community 448"
Cohesion: 0.17
Nodes (10): resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps, cards (+2 more)
...
Cohesion: 0.18
Nodes (13): normalizePermissionRequestBody(), getHeader(), getTrustedOrigins(), normalizeOrigin(), _resetTrustedOriginsForTests(), validateOrigin(), appendResolutionEvents, deliverDecision (+5 more)
...
Cohesion: 0.21
Nodes (12): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+4 more)
...
Cohesion: 0.4
Nodes (4): fetchOutput(), sendMessage(), TerminalView(), TerminalViewProps
...
## Knowledge Gaps
- **11555 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11550 more)
...
- **Why does `fetch` connect `Community 0` to `Community 129`, `Community 2`, `Community 644`, `Community 132`, `Community 133`, `Community 7`, `Community 646`, `Community 9`, `Community 10`, `Community 267`, `Community 12`, `Community 11`, `Community 6`, `Community 15`, `Community 529`, `Community 530`, `Community 18`, `Community 20`, `Community 149`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 30`, `Community 35`, `Community 420`, `Community 168`, `Community 47`, `Community 51`, `Community 180`, `Community 54`, `Community 56`, `Community 62`, `Community 63`, `Community 67`, `Community 198`, `Community 970`, `Community 971`, `Community 203`, `Community 77`, `Community 590`, `Community 591`, `Community 592`, `Community 350`, `Community 107`, `Community 754`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 131` to `Community 16`, `Community 11`, `Community 4`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 592` to `Community 526`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 162 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 162 INFERRED edges - model-reasoned connections that need verification._
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11555 weakly-connected nodes found - possible documentation gaps or missing edges._
