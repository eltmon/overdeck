...
## Corpus Check
- 1621 files · ~2,205,987 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23004 nodes · 34795 edges · 1183 communities (1143 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `485114d6`
...
## Communities (1183 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (160): checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand() (+152 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (149): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS (+141 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (120): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+112 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (121): ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+113 more)
...
Cohesion: 0.04
Nodes (125): readCavemanVariant(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), __dirname, execAsync, __filename, getBeadDescription() (+117 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (110): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+102 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (93): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+85 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (95): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, requireTrustedOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (97): setAgentStoppedNotifier(), spawnReviewCoordinatorSession(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+89 more)
...
Cohesion: 0.04
Nodes (97): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+89 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (88): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (92): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+84 more)
...
Cohesion: 0.03
Nodes (89): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+81 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (85): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+77 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (67): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), RuntimeRegistry, setGlobalRegistry() (+59 more)
...
Cohesion: 0.03
Nodes (78): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState() (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (66): criteria, doc, result, fsHooks, first, found, path, paths (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (74): closeOutCommand(), CloseOutOptions, getGitHubConfig(), wipeCommand(), WipeOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl() (+66 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (64): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+56 more)
...
Cohesion: 0.04
Nodes (61): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (72): extractNumber(), calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (69): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress() (+61 more)
...
Cohesion: 0.04
Nodes (66): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (59): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+51 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (62): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile() (+54 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (53): PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, SkillsList() (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (50): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+42 more)
...
Cohesion: 0.05
Nodes (50): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, emitter, emitter (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (62): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind (+54 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (55): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (57): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+49 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (60): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+52 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (51): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, RecoverButton(), RecoverButtonProps, ResetIssueButton(), ResetIssueButtonProps, useResetIssue() (+43 more)
...
Cohesion: 0.06
Nodes (54): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), readWorkspaceContinueAsync() (+46 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (55): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe() (+47 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (59): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, parseWalFile(), SyncResult, syncWalFromAllProjects() (+51 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (61): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+53 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (49): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+41 more)
...
Cohesion: 0.04
Nodes (54): loadCloisterConfig(), cleanupStaleAgentState(), AgentHealth, checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure() (+46 more)
...
Cohesion: 0.04
Nodes (41): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (47): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+39 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (54): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+46 more)
...
Cohesion: 0.07
Nodes (52): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+44 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (44): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+36 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (51): Access, AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), pathExists(), getIndexStats() (+43 more)
...
Cohesion: 0.05
Nodes (44): agentDir, body, dir, envArg, launcher, LEGACY_FIELDS, legacyFields, options (+36 more)
...
Cohesion: 0.06
Nodes (47): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+39 more)
...
Cohesion: 0.08
Nodes (42): isEligibleForCleanup(), installGitHooks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+34 more)
...
Cohesion: 0.07
Nodes (40): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+32 more)

### Community 77 - "Community 77"
Cohesion: 0.09
Nodes (41): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+33 more)
...
Cohesion: 0.04
Nodes (45): execAsync, execFileAsync, firePostMergeLifecycle(), getModelsResolveRoute, getProjectPathForIssue(), getProjectSpecialistContextRoute, getProjectSpecialistGraceRoute, getProjectSpecialistLatestLogRoute (+37 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (39): doneCommand(), DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+31 more)
...
Cohesion: 0.07
Nodes (39): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+31 more)
...
Cohesion: 0.1
Nodes (32): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), listBackups(), restoreBackup(), ARCHIVES_DIR (+24 more)
...
Cohesion: 0.08
Nodes (30): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+22 more)
...
Cohesion: 0.12
Nodes (32): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), TRAEFIK_DIR (+24 more)

### Community 147 - "Community 147"
Cohesion: 0.09
Nodes (32): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), reserveSummaryForkSession(), SummaryForkOptions (+24 more)
...
Cohesion: 0.08
Nodes (24): getWindowDimensionsAsync(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+16 more)
...
Cohesion: 0.14
Nodes (24): config, originalEnv, tracker, Comment, Issue, IssueFilters, IssueNotFoundError, IssueState (+16 more)
...
Cohesion: 0.09
Nodes (31): DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+23 more)

### Community 177 - "Community 177"
Cohesion: 0.11
Nodes (32): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+24 more)
...
Cohesion: 0.11
Nodes (29): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+21 more)
...
Cohesion: 0.12
Nodes (26): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, extractPrefix() (+18 more)
...
Cohesion: 0.1
Nodes (29): result, snapshot, status, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentPhase(), toAgentStatus() (+21 more)
...
Cohesion: 0.14
Nodes (29): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity() (+21 more)
...
Cohesion: 0.13
Nodes (17): daemonRegistry, ensureTldrStateDir(), execAsync, getPidFilePath(), getStateFilePath(), hashWorkspacePath(), listTldrDaemonServices(), LiveDaemonState (+9 more)
...
Cohesion: 0.12
Nodes (23): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getProxyPathname() (+15 more)
...
Cohesion: 0.09
Nodes (13): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), getAllTrackers() (+5 more)
...
Cohesion: 0.1
Nodes (18): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+10 more)
...
Cohesion: 0.22
Nodes (18): healthCommand(), HealthOptions, pendingCommand(), listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+10 more)
...
Cohesion: 0.15
Nodes (15): emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSessionContent(), ParseResult, PiEntry, PiGenericEntry (+7 more)
...
Cohesion: 0.15
Nodes (10): getRenderablePatch(), DiffWorkerPoolProvider(), Theme, ThemeState, buildPatchCacheKey(), DIFF_THEME_NAMES, DiffThemeName, fnv1a32() (+2 more)
...
Cohesion: 0.16
Nodes (14): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichPRBody(), ensurePRExists() (+6 more)
...
Cohesion: 0.21
Nodes (12): applyEvent(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxTurnDiffSummariesPerAgent(), INITIAL_READ_MODEL_STATE, isTerminalTurnDiffSummaryStatus(), omitTurnDiffSummariesForAgent() (+4 more)
...
Cohesion: 0.15
Nodes (12): shouldSkipCheckpointReconciliation(), agentIds, baseTimestamp, checkpoints, deleteLegacyCheckpointRefs, diffCheckpointFiles, encoder, getCheckpointTimestamp (+4 more)
...
Cohesion: 0.2
Nodes (9): AgentEnrichment, withConcurrencyLimit(), toAgentResolution(), toRole(), EnrichmentServiceState, pollOnce(), serviceState, startAgentEnrichmentService() (+1 more)
...
Cohesion: 0.27
Nodes (8): decode, decodeCandidate(), ev, bodyToEvent(), bodyToEvent(), decodeDomainEvent, isChannelReplyKind(), normalizeChannelReplyPayload()
...
## Knowledge Gaps
- **12139 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12134 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 3`, `Community 7`, `Community 9`, `Community 138`, `Community 779`, `Community 10`, `Community 13`, `Community 398`, `Community 11`, `Community 16`, `Community 146`, `Community 19`, `Community 21`, `Community 23`, `Community 281`, `Community 155`, `Community 27`, `Community 285`, `Community 29`, `Community 34`, `Community 547`, `Community 35`, `Community 164`, `Community 45`, `Community 48`, `Community 176`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 188`, `Community 575`, `Community 191`, `Community 71`, `Community 73`, `Community 205`, `Community 350`, `Community 94`, `Community 229`, `Community 614`, `Community 615`, `Community 618`, `Community 234`, `Community 116`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 16` to `Community 0`, `Community 1`, `Community 33`, `Community 4`, `Community 229`, `Community 38`, `Community 122`, `Community 6`, `Community 12`, `Community 14`, `Community 207`, `Community 121`, `Community 26`, `Community 27`, `Community 189`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 161` to `Community 0`, `Community 10`, `Community 61`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 174 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 174 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12139 weakly-connected nodes found - possible documentation gaps or missing edges._
