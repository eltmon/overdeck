...
## Corpus Check
- 1915 files · ~3,142,344 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27457 nodes · 43100 edges · 1328 communities (1273 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 802 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `872626bb`
...
## Communities (1328 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (206): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents() (+198 more)
...
Cohesion: 0.03
Nodes (168): monitorReviewConvoySignals(), performKillAndSpawn(), buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult (+160 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (101): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+93 more)
...
Cohesion: 0.03
Nodes (116): buildActiveSliceContext(), printActiveSliceForIssue(), uniqueTmpPath(), writeWorkspaceContinue(), annotated, before, candidate, check (+108 more)
...
Cohesion: 0.02
Nodes (100): confirmHostOverride(), resumeCommand(), ResumeOptions, computeAgentEnrichment(), getRuntimeSnapshot(), isAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror() (+92 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (95): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), AddOptions, installGitHooks(), ListOptions (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (99): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+91 more)
...
Cohesion: 0.03
Nodes (82): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+74 more)
...
Cohesion: 0.03
Nodes (85): containerRestartBackoffMs(), DeaconState, customPromisify, justNow, longAgo, old, recent, restartCalled (+77 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (70): ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent() (+62 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (68): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+60 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (82): captureFiles(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition() (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (65): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, CLAUDE_PROJECTS_DIR, ClaudeMessage, importSessionToCostLog() (+57 more)
...
Cohesion: 0.03
Nodes (71): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), ensureDefaultConversationModel(), getDefaultConversationModel() (+63 more)
...
Cohesion: 0.03
Nodes (68): ViewMode, VoiceMode, VoiceWidget(), Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey() (+60 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (85): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+77 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (78): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding (+70 more)
...
Cohesion: 0.05
Nodes (76): AgentRuntimeState, claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync() (+68 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (65): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+57 more)
...
Cohesion: 0.05
Nodes (64): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+56 more)
...
Cohesion: 0.03
Nodes (59): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext, HandoffContextError (+51 more)
...
Cohesion: 0.03
Nodes (59): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt(), cleanupLegacySpecialistsDirectory() (+51 more)
...
Cohesion: 0.05
Nodes (48): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+40 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (60): uploadConversationImage(), fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop() (+52 more)
...
Cohesion: 0.04
Nodes (54): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), ConnectionLinesProps, CostDonut() (+46 more)
...
Cohesion: 0.05
Nodes (60): scheduleDigestGeneration(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+52 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (58): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, encodeBeadsVersion() (+50 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (59): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+51 more)
...
Cohesion: 0.04
Nodes (48): ConfirmationDialog(), ConfirmationDialogProps, ConfirmationRequest, DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation() (+40 more)
...
Cohesion: 0.04
Nodes (53): canReplaceTitle(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ConversationAboutSummary, deleteConversationFavoriteRoute (+45 more)
...
Cohesion: 0.09
Nodes (59): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), asItemIndex(), assertCollection() (+51 more)
...
Cohesion: 0.05
Nodes (47): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailed(), AgentEnrichment, withConcurrencyLimit(), Handler, PipelineEvent, setPipelineHandler() (+39 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (50): deriveProjectRoot(), doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending (+42 more)
...
Cohesion: 0.04
Nodes (40): isRunningAgent(), isActiveAgent(), CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult (+32 more)
...
Cohesion: 0.06
Nodes (45): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), destroyCommand(), useConfigCommand() (+37 more)
...
Cohesion: 0.08
Nodes (50): ScanOptions, RawFilter, SearchMode, SearchQuery, SearchResult, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+42 more)
...
Cohesion: 0.05
Nodes (40): conversationsTab, firstLens, lens, overview, tablist, ProjectRightPaneTabs(), IssueComposer(), IssueWorkbench() (+32 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (39): showAction(), ConversationFilter, getDiscoveredSessionById(), markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+31 more)

### Community 92 - "Community 92"
Cohesion: 0.05
Nodes (42): isReviewSessionForIssue(), agentSrc, content, dashboardStopIdx, dirtyIdx, dispatchFailedMatches, downBlockMatch, guardMatch (+34 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (46): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+38 more)
...
Cohesion: 0.05
Nodes (44): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceLive, ReadModelServiceShape (+36 more)
...
Cohesion: 0.06
Nodes (37): registerTestCommands(), runCommand(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+29 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (21): getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions(), parseClaudeSession(), claudeProjectDir (+13 more)
...
Cohesion: 0.05
Nodes (37): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+29 more)
...
Cohesion: 0.06
Nodes (41): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+33 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (27): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, getKimiAnthropicBaseUrl(), getProviderEnv(), ProviderAuthType, ProviderName, PROVIDERS, AnthropicModel (+19 more)
...
Cohesion: 0.06
Nodes (29): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig, GitLabConfig (+21 more)

### Community 130 - "Community 130"
Cohesion: 0.06
Nodes (33): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+25 more)
...
Cohesion: 0.07
Nodes (33): applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, isoForStash(), isOlderThanDays(), isSalvageableStash() (+25 more)
...
Cohesion: 0.06
Nodes (28): ActionBar(), ActionBarProps, AgentCard(), AgentCardProps, LastHeardCounter(), ROLE_COLORS, stalenessColor(), STATUS_GLOW (+20 more)

### Community 167 - "Community 167"
Cohesion: 0.1
Nodes (39): Conversation, listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment() (+31 more)
...
Cohesion: 0.08
Nodes (29): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+21 more)
...
Cohesion: 0.07
Nodes (34): scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+26 more)
...
Cohesion: 0.11
Nodes (38): addCommentBefore(), ALIAS, anchorIsValid(), callVisitor(), clone(), createStringifyContext(), format(), formatPropertyKey() (+30 more)
...
Cohesion: 0.06
Nodes (26): ActivityLevel, ActivitySource, emitActivityEntry(), EmitActivityOptions, emitActivityTts(), EmitDetailedOptions, EmitTtsOptions, normalizeForSpeech() (+18 more)
...
Cohesion: 0.09
Nodes (29): cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+21 more)
...
Cohesion: 0.09
Nodes (23): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry(), resolveServerStaticDir() (+15 more)
...
Cohesion: 0.13
Nodes (29): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPath(), getPRDDraftPathEffect(), hasPRDDraft(), hasPRDDraftEffect() (+21 more)
...
Cohesion: 0.12
Nodes (25): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+17 more)
...
Cohesion: 0.14
Nodes (21): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+13 more)
...
Cohesion: 0.1
Nodes (22): queryBeadsForIssue(), readBeadsFromJsonl(), MergeSetRepoState, withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), execAsync (+14 more)
...
Cohesion: 0.14
Nodes (25): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+17 more)
...
Cohesion: 0.14
Nodes (12): createTracker(), createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv (+4 more)

### Community 385 - "Community 385"
Cohesion: 0.13
Nodes (22): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+14 more)
...
Cohesion: 0.13
Nodes (17): workspaceRebuildCommand(), tempDirs, workspace, DevcontainerRenderResult, ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult, pathLeaf() (+9 more)
...
Cohesion: 0.14
Nodes (13): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+5 more)
...
Cohesion: 0.13
Nodes (13): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeError, ShadowModeOptions, ShadowModeResult (+5 more)
...
Cohesion: 0.12
Nodes (20): array, combine, compareObjects(), hash(), intIdentify(), intStringify(), isEqual(), number() (+12 more)
...
Cohesion: 0.17
Nodes (11): captureTldrMetrics(), getTldrMetrics(), parse(), parseArrayColumn(), readLogLines(), readMetricsCheckpoint(), listWorkspaceMetadata(), body (+3 more)
...
Cohesion: 0.32
Nodes (6): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssueEffect()
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 528`, `Community 18`, `Community 17`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 33`, `Community 35`, `Community 1060`, `Community 36`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 47`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 575`, `Community 64`, `Community 576`, `Community 67`, `Community 68`, `Community 72`, `Community 75`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 599`, `Community 88`, `Community 89`, `Community 91`, `Community 95`, `Community 96`, `Community 607`, `Community 608`, `Community 114`, `Community 123`, `Community 128`, `Community 130`, `Community 139`, `Community 656`, `Community 145`, `Community 154`, `Community 155`, `Community 156`, `Community 166`, `Community 170`, `Community 1195`, `Community 683`, `Community 685`, `Community 178`, `Community 180`, `Community 183`, `Community 189`, `Community 201`, `Community 206`, `Community 209`, `Community 212`, `Community 726`, `Community 214`, `Community 216`, `Community 233`, `Community 236`, `Community 248`, `Community 772`, `Community 261`, `Community 273`, `Community 300`, `Community 302`, `Community 816`, `Community 821`, `Community 312`, `Community 313`, `Community 826`, `Community 331`, `Community 351`, `Community 361`, `Community 385`, `Community 411`, `Community 440`, `Community 964`, `Community 455`, `Community 473`, `Community 487`, `Community 489`, `Community 501`, `Community 510`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 12` to `Community 33`, `Community 5`, `Community 902`, `Community 552`, `Community 75`, `Community 332`, `Community 364`, `Community 16`, `Community 18`, `Community 83`, `Community 438`, `Community 24`, `Community 28`, `Community 61`, `Community 222`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 41` to `Community 385`, `Community 3`, `Community 772`, `Community 4`, `Community 261`, `Community 263`, `Community 773`, `Community 9`, `Community 778`, `Community 10`, `Community 12`, `Community 654`, `Community 15`, `Community 272`, `Community 146`, `Community 147`, `Community 19`, `Community 277`, `Community 22`, `Community 25`, `Community 412`, `Community 30`, `Community 33`, `Community 165`, `Community 37`, `Community 40`, `Community 42`, `Community 1195`, `Community 44`, `Community 43`, `Community 1194`, `Community 50`, `Community 53`, `Community 55`, `Community 315`, `Community 60`, `Community 317`, `Community 192`, `Community 201`, `Community 459`, `Community 77`, `Community 206`, `Community 81`, `Community 213`, `Community 86`, `Community 214`, `Community 728`, `Community 472`, `Community 473`, `Community 91`, `Community 606`, `Community 223`, `Community 352`, `Community 98`, `Community 99`, `Community 101`, `Community 1127`, `Community 488`, `Community 489`, `Community 362`, `Community 235`, `Community 234`, `Community 238`, `Community 249`, `Community 380`?**
