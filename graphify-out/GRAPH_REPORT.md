...
## Corpus Check
- 1573 files · ~2,069,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22387 nodes · 33580 edges · 1151 communities (1112 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab98c4b4`
...
5. `listSessionNamesAsync()` - 53 edges
...
## Communities (1151 total, 39 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (160): autoResumeStoppedWorkAgents(), checkFailedMergeRetry(), patrolWorkAgentResolutions(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+152 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (154): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+146 more)
...
Cohesion: 0.02
Nodes (130): shouldAutoStart(), setAgentStoppedNotifier(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (131): readCavemanVariant(), checkStuckReviewing(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, HandoffResult (+123 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (105): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, SwitchModelModal(), SwitchModelModalProps, WorkspaceStatusOverview() (+97 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (125): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+117 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (80): checkDeadEndAgents(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult (+72 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (109): checkApiErrorAgents(), isMergeAgentRunning(), killAllReviewSessions(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+101 more)
...
Cohesion: 0.02
Nodes (108): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (103): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+95 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (110): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkFirstCompletionAgents(), checkHeartbeat(), checkMassDeath() (+102 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (90): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+82 more)
...
Cohesion: 0.03
Nodes (83): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+75 more)
...
Cohesion: 0.04
Nodes (89): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+81 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (71): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneA(), ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip() (+63 more)
...
Cohesion: 0.02
Nodes (89): cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush, mockMarkWorkspaceStuck, result, execFile() (+81 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (79): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (87): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), applyClosedOutLabel(), applyLabelGitHub() (+79 more)
...
Cohesion: 0.03
Nodes (74): ALL_TABS, OverviewTab, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse (+66 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (68): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+60 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (76): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, showCommand(), deleteContinueFile(), getContinueFilePath() (+68 more)
...
Cohesion: 0.06
Nodes (75): spawnInspectAgent(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), getSpecialistHarness(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), assertCodexAuthReadyForModel(), {
  mockLoadYamlConfig,
...
Cohesion: 0.03
Nodes (59): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+51 more)
...
Cohesion: 0.04
Nodes (62): doc, path, failedState, initialState, jsonBlock, nextState, parsed, PLAN_DOC (+54 more)
...
Cohesion: 0.06
Nodes (65): closeOutCommand(), CloseOutOptions, getGitHubConfig(), wipeCommand(), WipeOptions, AddRepoOptions, convertToSshUrl(), createCommand() (+57 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (56): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+48 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (54): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+46 more)
...
Cohesion: 0.05
Nodes (59): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+51 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (53): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, getDebugInfo(), getGlobalRouter() (+45 more)
...
Cohesion: 0.05
Nodes (53): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+45 more)
...
Cohesion: 0.08
Nodes (42): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile() (+34 more)
...
Cohesion: 0.13
Nodes (41): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile() (+33 more)
...
Cohesion: 0.1
Nodes (38): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+30 more)
...
Cohesion: 0.08
Nodes (39): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+31 more)
...
Cohesion: 0.11
Nodes (32): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+24 more)
...
Cohesion: 0.1
Nodes (34): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), extractNumber() (+26 more)
...
Cohesion: 0.11
Nodes (27): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir(), panopticonDir(), PiRuntime (+19 more)
...
Cohesion: 0.06
Nodes (26): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), createCall (+18 more)
...
Cohesion: 0.09
Nodes (32): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+24 more)
...
Cohesion: 0.07
Nodes (22): ensureDefaultConversationModel(), getDefaultConversationModel(), ForkModal(), ForkModalProps, ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS (+14 more)
...
Cohesion: 0.1
Nodes (29): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, ensureResourceConfigLoaded(), evaluateSeverity() (+21 more)
...
Cohesion: 0.08
Nodes (22): ClaudeModelId, FALLBACK_GROUPS, HARNESS_DEFAULT_MODEL, isKnownModel(), knownModelIds, loadStoredHarness(), loadStoredModel(), ModelGroup (+14 more)

### Community 204 - "Community 204"
Cohesion: 0.08
Nodes (26): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+18 more)
...
Cohesion: 0.1
Nodes (25): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+17 more)
...
Cohesion: 0.11
Nodes (23): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError(), invalidateProbeCache() (+15 more)
...
Cohesion: 0.11
Nodes (13): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv() (+5 more)
...
Cohesion: 0.14
Nodes (19): writeWorkspaceContext(), ensureWorkspacePanDir(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback(), writeFeedback() (+11 more)
...
Cohesion: 0.1
Nodes (18): parseValidationOutput(), QualityGateResult, QualityGateRunOptions, afterCommit, beforeCommit, execAsync, revertedCommit, scriptPath (+10 more)
...
Cohesion: 0.18
Nodes (12): addPanopticonHookIfMissing(), checkJqInstalled(), ClaudeSettings, HookConfig, installJq(), isHookConfigured(), McpServer, setupHooksCommand() (+4 more)
...
Cohesion: 0.14
Nodes (13): archiveIdx, beadsDir, branchStep, clearStep, content, ctx, { mockExecAsync }, resetStep (+5 more)
...
Cohesion: 0.31
Nodes (6): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus()
...
Cohesion: 0.29
Nodes (8): Auto (non-interactive), Auto-Start (skip planning), code:bash (pan plan <id> --auto), code:bash (pan start <id> --auto), code:block8 (**PRD:** [`path/to/prd.md`](https link to the file in the re), Interactive (default), Issue Creation from PRDs, Planning Modes
...
Cohesion: 0.67
Nodes (3): code:bash (pan plan <id>), code:typescript (// Correct (in sendKeysAsync):), tmux Message Delivery
...
## Knowledge Gaps
- **11890 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11885 more)
...
- **Why does `fetch` connect `Community 2` to `Community 1`, `Community 642`, `Community 643`, `Community 3`, `Community 5`, `Community 134`, `Community 388`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 149`, `Community 534`, `Community 151`, `Community 24`, `Community 25`, `Community 23`, `Community 27`, `Community 32`, `Community 38`, `Community 39`, `Community 47`, `Community 688`, `Community 50`, `Community 52`, `Community 181`, `Community 53`, `Community 57`, `Community 62`, `Community 66`, `Community 204`, `Community 337`, `Community 94`, `Community 223`, `Community 106`, `Community 235`, `Community 760`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 160` to `Community 0`, `Community 13`, `Community 143`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 9` to `Community 131`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11890 weakly-connected nodes found - possible documentation gaps or missing edges._
