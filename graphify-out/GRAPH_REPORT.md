...
## Corpus Check
- 1621 files · ~2,206,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23011 nodes · 34804 edges · 1175 communities (1137 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `816d1c2c`
...
## Communities (1175 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (170): checkStuckWorkAgents(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult (+162 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (103): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext (+95 more)
...
Cohesion: 0.03
Nodes (133): ComplexityLevel, checkOrphanedReviewStatuses(), checkStuckReviewing(), cleanupOrphanReviewerSessions(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles() (+125 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (114): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ViewMode (+106 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (124): restoreCommand(), showCommand(), cont, doc, projectRoot, specsDir, workspace, deleteContinueFile() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): checkFailedMergeRetry(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (103): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+95 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (114): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+106 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (116): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (85): ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (86): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+78 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (97): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+89 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (102): DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan(), swarmCommand(), taskOperation() (+94 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (81): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+73 more)
...
Cohesion: 0.04
Nodes (91): listTestsCommand(), registerTestCommands(), RunOptions, resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig() (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (77): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+69 more)
...
Cohesion: 0.03
Nodes (83): AgentHealth, checkAllTriggers(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (88): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath() (+80 more)
...
Cohesion: 0.03
Nodes (80): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, requireTrustedOrigin(), cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+72 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (78): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+70 more)
...
Cohesion: 0.04
Nodes (65): criteria, doc, result, doc, path, fsHooks, first, found (+57 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (71): clearFeedbackFiles(), getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+63 more)
...
Cohesion: 0.04
Nodes (71): isEligibleForCleanup(), buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+63 more)
...
Cohesion: 0.05
Nodes (72): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+64 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (74): killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache() (+66 more)
...
Cohesion: 0.04
Nodes (66): generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+58 more)
...
Cohesion: 0.07
Nodes (52): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+44 more)
...
Cohesion: 0.05
Nodes (46): setAgentStoppedNotifier(), getAllActiveQueues(), emitDashboardLifecycle(), data, mockExistsSync, mockReadFile, mockUnlink, runner (+38 more)
...
Cohesion: 0.06
Nodes (35): ComposerMode, IssueComposerProps, CodexAuthBanner(), PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse (+27 more)
...
Cohesion: 0.08
Nodes (41): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (40): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+32 more)
...
Cohesion: 0.06
Nodes (39): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, planCommand(), PlanOptions, DASHBOARD_URL, RequestReviewOptions (+31 more)
...
Cohesion: 0.09
Nodes (38): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+30 more)
...
Cohesion: 0.07
Nodes (37): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, listener(), electron (+29 more)
...
Cohesion: 0.07
Nodes (38): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+30 more)
...
Cohesion: 0.07
Nodes (29): firstSessionPanel, firstWorkbench, overview, workbench, IssueComposer(), IssueWorkbench(), IssueWorkbenchProps, ZoneA() (+21 more)
...
Cohesion: 0.09
Nodes (22): captureTldrMetrics(), daemonRegistry, ensureTldrStateDir(), execAsync, getPidFilePath(), getStateFilePath(), getTldrMetrics(), hashWorkspacePath() (+14 more)
...
Cohesion: 0.09
Nodes (34): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+26 more)
...
Cohesion: 0.14
Nodes (29): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, IssueAggregate, BUDGETS_FILE, checkBudget() (+21 more)
...
Cohesion: 0.08
Nodes (21): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+13 more)
...
Cohesion: 0.1
Nodes (24): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), NormalizedCavemanConfig (+16 more)
...
Cohesion: 0.16
Nodes (24): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments(), extractConversationAttachmentPaths(), getAttachmentCache(), getAttachmentCacheKey() (+16 more)
...
Cohesion: 0.2
Nodes (15): setupCavemanCompressScripts(), addPanopticonHookIfMissing(), checkJqInstalled(), HookConfig, installJq(), isHookConfigured(), McpServer, setupHooksCommand() (+7 more)
...
Cohesion: 0.19
Nodes (12): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeOptions, ShadowModeResult, id (+4 more)
...
Cohesion: 0.12
Nodes (15): DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing, found (+7 more)
...
- **Why does `fetch` connect `Community 8` to `Community 2`, `Community 260`, `Community 4`, `Community 10`, `Community 11`, `Community 12`, `Community 141`, `Community 13`, `Community 15`, `Community 784`, `Community 16`, `Community 17`, `Community 401`, `Community 662`, `Community 24`, `Community 281`, `Community 26`, `Community 155`, `Community 28`, `Community 156`, `Community 25`, `Community 31`, `Community 669`, `Community 291`, `Community 548`, `Community 547`, `Community 166`, `Community 41`, `Community 45`, `Community 48`, `Community 57`, `Community 58`, `Community 187`, `Community 572`, `Community 63`, `Community 191`, `Community 579`, `Community 67`, `Community 68`, `Community 842`, `Community 204`, `Community 77`, `Community 85`, `Community 91`, `Community 99`, `Community 617`, `Community 109`, `Community 114`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 12` to `Community 0`, `Community 33`, `Community 2`, `Community 5`, `Community 6`, `Community 39`, `Community 8`, `Community 9`, `Community 16`, `Community 115`, `Community 20`, `Community 21`, `Community 22`, `Community 153`, `Community 30`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 3` to `Community 0`, `Community 11`, `Community 14`?**
