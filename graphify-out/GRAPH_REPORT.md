...
## Corpus Check
- 1746 files · ~2,332,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23916 nodes · 36683 edges · 1188 communities (1139 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 531 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d99ae3c0`
...
## Communities (1188 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (164): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+156 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (161): checkMissingReviewStatuses(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+153 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeViolations (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (128): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, INSPECTOR_PANEL_SOURCE, state, EDITOR_LABELS, PanOpenInPicker() (+120 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (150): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+142 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (129): autoResumeStoppedWorkAgents(), resetSessionCommand(), confirmHostOverride(), resumeCommand(), ResumeOptions, unpauseCommand(), untroubledCommand(), computeAgentEnrichment() (+121 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (122): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+114 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (127): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent() (+119 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (102): cleanupOldEvents(), CLOISTER_DB_PATH, deleteAgentHistory(), getAgentsWithHistory(), getAllHealthHistory(), getDatabaseStats(), getHealthDatabase(), getHealthHistory() (+94 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (102): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+94 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (104): ensureDefaultConversationModel(), fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (111): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue() (+103 more)
...
Cohesion: 0.02
Nodes (86): EventRouter(), buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets() (+78 more)
...
Cohesion: 0.04
Nodes (70): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, first (+62 more)
...
Cohesion: 0.05
Nodes (85): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), ensureExcalidrawMcp() (+77 more)
...
Cohesion: 0.03
Nodes (79): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), AutoActions, AutoRestartConfig (+71 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (65): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+57 more)
...
Cohesion: 0.05
Nodes (75): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (68): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+60 more)
...
Cohesion: 0.04
Nodes (70): checkHeartbeat(), checkStuckReviewing(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve (+62 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (71): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+63 more)
...
Cohesion: 0.05
Nodes (67): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+59 more)
...
Cohesion: 0.05
Nodes (64): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+56 more)
...
Cohesion: 0.05
Nodes (61): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+53 more)
...
Cohesion: 0.05
Nodes (59): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+51 more)
...
Cohesion: 0.05
Nodes (49): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection() (+41 more)
...
Cohesion: 0.07
Nodes (23): issues, result, importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged() (+15 more)
...
Cohesion: 0.07
Nodes (49): deriveProjectRoot(), doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, queueAutoCommit() (+41 more)
...
Cohesion: 0.06
Nodes (47): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+39 more)
...
Cohesion: 0.05
Nodes (38): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+30 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (49): Access, readBridgedCodexCredential(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+41 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (47): checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus(), registerInstallCommand() (+39 more)
...
Cohesion: 0.05
Nodes (42): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+34 more)
...
Cohesion: 0.05
Nodes (40): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+32 more)
...
Cohesion: 0.04
Nodes (48): ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema, EnrichBodySchema (+40 more)
...
Cohesion: 0.08
Nodes (32): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult (+24 more)
...
Cohesion: 0.05
Nodes (39): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+31 more)
...
Cohesion: 0.1
Nodes (34): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, resolveBareNumericId() (+26 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (38): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments() (+30 more)
...
Cohesion: 0.08
Nodes (33): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+25 more)

### Community 147 - "Community 147"
Cohesion: 0.11
Nodes (37): buildWorkAgentPrompt(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync (+29 more)
...
Cohesion: 0.1
Nodes (26): beadsDir, doc, AcceptanceCriterion, createBeadsFromVBrief(), CreateBeadsResult, deriveProjectPrefix(), execAsync, execFileAsync (+18 more)
...
Cohesion: 0.07
Nodes (22): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), normalizeConversationFilter(), PanRpcLayer (+14 more)
...
Cohesion: 0.09
Nodes (24): buildACLookupByTitle(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), WorkAgentPromptContext (+16 more)
...
Cohesion: 0.08
Nodes (16): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), derivePlanningIssueId(), fetchOutput(), TerminalPanel() (+8 more)

### Community 245 - "Community 245"
Cohesion: 0.13
Nodes (26): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+18 more)
...
Cohesion: 0.13
Nodes (23): clearFeedbackFiles(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), uniqueTmpPath(), workspacePanPaths(), writeWorkspaceContinueAsync(), clearFeedback() (+15 more)
...
Cohesion: 0.13
Nodes (26): archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+18 more)
...
Cohesion: 0.11
Nodes (20): listener(), electron, IPC, result, wrapped(), DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings() (+12 more)
...
Cohesion: 0.16
Nodes (19): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+11 more)
...
Cohesion: 0.16
Nodes (15): embed(), EmbeddingResult, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage(), normalizeEmbedding(), emb (+7 more)
...
Cohesion: 0.21
Nodes (15): extractTtsEmbedding(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent() (+7 more)
...
Cohesion: 0.16
Nodes (13): emitDashboardLifecycle(), data, mockExistsSync, mockReadFile, mockUnlink, runner, defaultLifecycleRunner(), LifecycleRunner (+5 more)
...
Cohesion: 0.17
Nodes (11): ReadModelServiceLive, appended, body, effect, layer, mockEventStore, program, routeEffect (+3 more)
...
## Knowledge Gaps
- **12435 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12430 more)
...
- **Why does `fetch` connect `Community 0` to `Community 256`, `Community 1`, `Community 131`, `Community 132`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 786`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 293`, `Community 294`, `Community 39`, `Community 423`, `Community 44`, `Community 303`, `Community 176`, `Community 562`, `Community 179`, `Community 59`, `Community 63`, `Community 65`, `Community 66`, `Community 67`, `Community 70`, `Community 200`, `Community 73`, `Community 74`, `Community 202`, `Community 588`, `Community 206`, `Community 103`, `Community 363`, `Community 365`, `Community 241`, `Community 626`, `Community 244`, `Community 116`, `Community 632`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 1` to `Community 0`, `Community 4`, `Community 69`, `Community 5`, `Community 7`, `Community 42`, `Community 139`, `Community 302`, `Community 177`, `Community 114`, `Community 243`, `Community 52`, `Community 22`, `Community 472`, `Community 28`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 21` to `Community 258`, `Community 37`, `Community 102`, `Community 295`, `Community 490`, `Community 11`, `Community 60`, `Community 29`, `Community 274`, `Community 20`, `Community 793`, `Community 188`, `Community 61`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12435 weakly-connected nodes found - possible documentation gaps or missing edges._
