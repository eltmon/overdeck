...
## Corpus Check
- 2080 files · ~3,633,643 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33035 nodes · 64072 edges · 1415 communities (1347 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1515 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae604204`
...
## Communities (1415 total, 68 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (246): ~/.panopticon/agents/ State Directory, Agent Directory Structure, getHealthThresholdsMs(), HealthThresholds, checkCostLimits(), getCostSummary(), DeaconLogEntry, getDeaconLogs() (+238 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.01
Nodes (258): loadStartCommand(), pauseFlywheel(), agentStatusCommand(), flywheelAbortCommand(), resetSessionCommand(), confirmHostOverride(), resumeCommand(), ResumeOptions (+250 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (196): resolveAutoResumeConfigForIssue(), addLog(), apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+188 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.03
Nodes (180): buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffError, HandoffMethod, HandoffOptions, performHandoff() (+172 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (191): archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), cleanupReviewTempStashPromise() (+183 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (178): logNonCanonicalStashesOnStartup(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures (+170 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (181): displayIssues(), getConfiguredTrackers(), listCommand(), approveCommand(), cancelCommand(), collectLifecycleRows(), completeCommand(), dedupeRows() (+173 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (179): ActivityFeedSidebar(), ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, applySessionTreeDelta() (+171 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.01
Nodes (162): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause, catchIf (+154 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.03
Nodes (187): readCavemanVariant(), checkHeartbeat(), getSpecialistState(), finalizeRunLogSync(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent() (+179 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (147): cleanupAbandonedFeedback(), cleanupStaleAgentState(), isMergeAgentRunning(), waitForReviewerOutputs(), waitForReviewerOutputsPromise(), AgentStatusOptions, analyzeSession(), detectStatus() (+139 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.03
Nodes (128): Work Agent (shown in inspector terminal), switchModel(), IssueWorkbench(), IssueWorkbenchProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneA() (+120 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (148): CloisterStatus, TaskContext, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), ActivityEntry, AgentList() (+140 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (153): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+145 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (120): SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS, BeadTask, IssueActionDialogHost() (+112 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.02
Nodes (139): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+131 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (118): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+110 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (106): DrawerActivityRail(), agentToConversation(), DrawerAgentSession(), DrawerAgentSessionProps, ENDED_AGENT_STATUSES, isEndedAgent(), pickDefaultDrawerAgent(), agents (+98 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.02
Nodes (115): isRunningAgent(), ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent() (+107 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.02
Nodes (132): parseDifficultyLabel(), LiveLastHeard(), BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult (+124 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.03
Nodes (124): Command Deck (Core Concept), Access, buildChildEnv(), withConcurrencyLimit(), encodeClaudeProjectDir(), findProjectByPathEffect(), findProjectByTeamEffect(), findProjectsByRallyProject() (+116 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.02
Nodes (104): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+96 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (118): extractAcceptanceCriteria(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle() (+110 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (108): transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientShape, GitHubComment, GitHubIssue (+100 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (109): relativeTime(), ShowOptions, adminRouteLayer, getAdminTldrRoute, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), autopresoRouteLayer, backToStagingRoute (+101 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.04
Nodes (99): embedAction(), normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), showAction() (+91 more)
...
Cohesion: 0.03
Nodes (108): estimateCost(), Role, loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+100 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (105): annotated, before, candidate, check, claimed, defaults, doc, { doc: next } (+97 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.05
Nodes (97): buildPolyrepoContext(), createCostCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects() (+89 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (101): PRIORITY_LABELS, RallyConfig, resolveTrackerType(), PlanningIssue, cb, cmdArgs, { MainDivergedErrorClass }, mockExec (+93 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.04
Nodes (105): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+97 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (86): Tab, FlywheelRunSummary, NAV_GROUPS, NavGroup, NavItem, PHASE_DOT_CLASSES, PHASE_LABELS, PIPELINE_PHASES (+78 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.04
Nodes (107): TurnDiffFileChange, ConversationList(), canReplaceTitle(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse (+99 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (97): config, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+89 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.04
Nodes (94): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+86 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.04
Nodes (86): determineCavemanVariant(), injectCavemanSettings(), addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), DnsSyncMethod, getDnsmasqConfigDir() (+78 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (95): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+87 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.04
Nodes (96): confirmDropRecovery(), difficultyColor(), isSwarmRecoverAction(), printWavePlan(), recoverSwarmCommand(), registerSwarmCommands(), SWARM_RECOVER_ACTIONS, SwarmCommandOptions (+88 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.03
Nodes (74): ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first, second (+66 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.04
Nodes (85): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), onPlan, button (+77 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.04
Nodes (76): mockClaudeSkills, contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion() (+68 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.03
Nodes (88): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+80 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.03
Nodes (92): EventMetadata, ReadEventsOptions, authorized(), eventsRouteLayer, formatFrame(), getEventStreamRoute, getEventVersionRoute, getHeader() (+84 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.03
Nodes (91): updateTtsConfig(), clearConfigCache(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, WorkhorsesConfig, WorkhorseSlot (+83 more)
...
Cohesion: 0.04
Nodes (78): getGlobalRouter(), defaults, first, issueAgentTypes, { models }, second, anthropicModel, anthropicRouter (+70 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.05
Nodes (77): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+69 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.05
Nodes (73): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+65 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.04
Nodes (70): conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck(), tablist (+62 more)
...
Cohesion: 0.03
Nodes (65): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+57 more)
...
Cohesion: 0.04
Nodes (86): Agent Audit Report (2026-04-13), AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, buildTaskPrompt() (specialist prompt dispatch) (+78 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.05
Nodes (65): calls, content, mockExeca, mockExec, calls, { mockExecAsync }, opts, clearReviewStatus() (+57 more)
...
Cohesion: 0.04
Nodes (62): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+54 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.03
Nodes (67): changedFiles, errOutput, fetchMock, output, mockGetRuntimeForAgent, exec(), execMock, execResponses (+59 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.05
Nodes (72): ComplianceWarningMarkers, readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity, writeObservations(), writeComplianceWarningMarkers() (+64 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (68): AlertDialogContent(), AlertOptions, ConfirmDialogContent(), ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+60 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.05
Nodes (40): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), getGitHubConfig(), mapGitHubStateToCanonical(), cachedIssue (+32 more)
...
Cohesion: 0.04
Nodes (69): Agent Enrichment Service, agentDir, missing, result, snapshot, status, AgentEnrichment, missing (+61 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.05
Nodes (71): handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+63 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.05
Nodes (67): traefikDir, devCommand(), checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult (+59 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.06
Nodes (65): PROVIDER_ENV_UNSETS, buildClaudeUserSettings(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), getClaudePermissionFlagsStringSync(), getClaudePermissionFlagsSync() (+57 more)

### Community 66 - "GitHub Webhook Ingestion Handlers"
Cohesion: 0.1
Nodes (73): killTmuxSession(), extractNumber(), extractPrefix(), removeWorktree(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear() (+65 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.04
Nodes (55): StandaloneTerminal(), StandaloneTerminalProps, derivePlanningIssueId(), fetchOutput(), popoutTerminal(), TerminalPanel(), TerminalPanelProps, agent (+47 more)
...
Cohesion: 0.05
Nodes (56): detectMergedSwarmSlots(), execFileAsync, getAutoCloseOutCanonicalState(), listFeatureWorkspaces(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments() (+48 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.05
Nodes (59): cleanupOldEvents(), cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistory(), deleteAgentHistorySync(), getAgentsWithHistory(), getAgentsWithHistorySync() (+51 more)
...
Cohesion: 0.04
Nodes (66): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset) (+58 more)

### Community 74 - "Checkpoint Capture and Diff Routes"
Cohesion: 0.1
Nodes (61): bridgeGeminiAuthToCliproxy(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError (+53 more)

### Community 75 - "Path Constants and Postinstall Setup"
Cohesion: 0.06
Nodes (57): getCavemanExperimentData(), rows, httpHandler(), HttpServerResponse, ReadModelServiceLive, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape (+49 more)

### Community 76 - "Cost Recovery Scripts and Latency Tests"
Cohesion: 0.05
Nodes (63): getCachedMessages(), isPiSessionFile(), CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage(), ContentBlock (+55 more)

### Community 77 - "Activity Panel and VTT Parsing"
Cohesion: 0.04
Nodes (48): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ensureDefaultConversationModel(), getDefaultConversationModel() (+40 more)
...
Cohesion: 0.04
Nodes (57): future, id, rows, rows1, rows2, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema() (+49 more)
...
Cohesion: 0.04
Nodes (53): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+45 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.06
Nodes (49): RoundMarker, fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+41 more)

### Community 83 - "Issue Search Modal and Filter State"
Cohesion: 0.08
Nodes (53): buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), hashFile(), hashFileSync(), Manifest (+45 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.05
Nodes (46): getTrackerConfig(), getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageState, checkDevrootDeprecation() (+38 more)
...
Cohesion: 0.05
Nodes (53): resetDb(), resetDb(), resetDatabase(), ExtractedPayload, fallback, identity, primary, provider (+45 more)

### Community 88 - "Work Agent Prompt and Reopen Flow"
Cohesion: 0.03
Nodes (59): loadComplianceMode(), UpsertDiscoveredSessionOpts, getConversationsConfig(), getConversationsConfigAsync(), getConversationsConfigSync(), loadConfigNoMigration(), resolveConversationWatchDirs(), updateConversationsConfig() (+51 more)
...
Cohesion: 0.05
Nodes (49): ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS, cacheKey(), ChatMarkdown, ChatMarkdownErrorBoundary, ChatMarkdownProps, CodeBlock() (+41 more)
...
Cohesion: 0.05
Nodes (56): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+48 more)

### Community 94 - "Traefik DNS and Platform Install Skills"
Cohesion: 0.03
Nodes (59): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, AgentOutput, ContextUsage (+51 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.07
Nodes (60): addCommentBefore(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), callVisitor(), clone(), createNode() (+52 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.05
Nodes (48): delay(), data, mockExistsSync, mockReadFile, mockUnlink, runner, computeRestartDelay(), getSmeeBinaryPath() (+40 more)
...
Cohesion: 0.05
Nodes (46): createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, ProjectsConfig, TestConfig, execAsync (+38 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.04
Nodes (55): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+47 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.06
Nodes (49): createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, updated, attachmentCleanupTimer, n (+41 more)
...
Cohesion: 0.05
Nodes (47): agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockGetWorkspaceStackHealth, mockLoadReviewStatuses, mockRebuildWorkspaceStack (+39 more)

### Community 105 - "Issue Tracker Linking Tests"
Cohesion: 0.04
Nodes (44): { projectPath, workspacePath }, promoted, specFiles, beads, createCall, createCalls, dbError, deleteCalls (+36 more)

### Community 106 - "Release and Update CLI Commands"
Cohesion: 0.08
Nodes (57): parseFiniteInteger(), filterPayload(), add, addIn(), anchorNames(), applyReviver(), array, asItemIndex() (+49 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.06
Nodes (44): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+36 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.07
Nodes (48): appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs(), cleanupAllLogsSync(), cleanupOldLogs(), cleanupOldLogsSync(), createRunLog() (+40 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.06
Nodes (43): TABS, themeButton, VBriefDifficulty, VBriefEdgeType, VBriefInspectionPolicy, VBriefItem, VBriefItemStatus, VBriefPlan (+35 more)
...
Cohesion: 0.08
Nodes (51): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+43 more)
...
Cohesion: 0.06
Nodes (37): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+29 more)
...
Cohesion: 0.07
Nodes (43): BeadsTask, captureBeadsTasks(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContext, HandoffContextError, serializeHandoffContext() (+35 more)
...
Cohesion: 0.07
Nodes (45): __dirname, ensureDashboardBundle(), killPort(), sleep(), waitForHealth(), waitForHttp200(), waitForPortFree(), LOGS_DIR (+37 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.09
Nodes (45): deriveDotStatus(), formatDuration(), isErrorStatus(), isReviewerRole(), presenceToStatus(), ZoneB(), ZoneBProps, formatDuration() (+37 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.04
Nodes (50): result, claudePlanningSystemPromptFiles(), clearCacheRoute, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute (+42 more)

### Community 123 - "TTS Daemon and Pi Extension Supervisor"
Cohesion: 0.04
Nodes (41): first, kCustom, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref (+33 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.05
Nodes (47): getTtsDaemonAuthHeaders(), HeaderMap, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput (+39 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.08
Nodes (42): resolveNode22(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError (+34 more)

### Community 126 - "Electron Desktop App Launch Scripts"
Cohesion: 0.1
Nodes (11): normalizeIssueId(), GitHubTracker, octokitToEffect(), octokitToProgram(), parseIssueNumber(), GitLabTracker, notImplemented(), escapeQueryValue() (+3 more)

### Community 127 - "Specialist Run Log Lifecycle"
Cohesion: 0.07
Nodes (48): PendingOperation, AgentChannelReply, AgentPhase, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+40 more)

### Community 128 - "Remote Agent Provisioning on Fly"
Cohesion: 0.06
Nodes (42): electron, electron, IPC, result, SETTINGS_FILE, available, content, defaults (+34 more)

### Community 129 - "Claude Code Hook Management"
Cohesion: 0.04
Nodes (41): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile (+33 more)
...
Cohesion: 0.04
Nodes (37): IssueStats, cost, db, DB_PATH, CLAUDE_PROJECTS, cost, db, DB_PATH (+29 more)

### Community 132 - "Conversation Smart Compaction"
Cohesion: 0.08
Nodes (40): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinks(), cleanupLegacyRuntimeSymlinksSync(), convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders() (+32 more)
...
Cohesion: 0.07
Nodes (37): getActivityByIdRoute, getActivityDetailedRoute, getActivityRoute, getActivityTtsRoute, getGitActivityRoute, getMetricsCostsRoute, getMetricsStuckRoute, getMetricsSummaryRoute (+29 more)
...
Cohesion: 0.08
Nodes (39): compactCommand(), CompactOptions, detectPlatform(), execAsync, getOldClosedCount(), isBdAvailable(), statsCommand(), upgradeCommand() (+31 more)
...
Cohesion: 0.07
Nodes (41): createSpecialistHandoff(), ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getSpecialistHandoffStatsPromise(), getTodaySpecialistHandoffs(), logSpecialistHandoff() (+33 more)
...
Cohesion: 0.07
Nodes (37): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+29 more)
...
Cohesion: 0.1
Nodes (8): getProjectDirs(), parseClaudeSession(), parsePiSession(), parseSessionFile(), MOCK_RUNTIME, ClaudeCodeRuntime, PiRuntime, PiRuntimeEffect
...
Cohesion: 0.06
Nodes (33): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, AutoResumeConfig (+25 more)
...
Cohesion: 0.09
Nodes (39): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+31 more)
...
Cohesion: 0.05
Nodes (34): PANOPTICON_HOME, Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config, config1 (+26 more)
...
Cohesion: 0.08
Nodes (37): onToggle, CategoryFilter, formatContextLength(), formatCost(), ModelCard(), OpenRouterModel, OpenRouterModelBrowser(), OpenRouterModelBrowserProps (+29 more)
...
Cohesion: 0.08
Nodes (38): isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync, getCachedResourceAllocatedIssues(), getResourceDetailIdentifiers() (+30 more)
...
Cohesion: 0.08
Nodes (38): doneCommand(), DoneOptions, execAsync, isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+30 more)

### Community 190 - "Agent Grid Dashboard UI Components"
Cohesion: 0.1
Nodes (31): isAgentIdleForNudge(), StuckRemediationConfig, checkStuckAgentRemediation(), evaluateAgent(), evaluateFlywheelOrchestrator(), execFileAsync, firstStuckAt(), hasReadyBeads() (+23 more)
...
Cohesion: 0.11
Nodes (38): deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathEffect() (+30 more)
...
Cohesion: 0.11
Nodes (36): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise(), getContextDigestPath(), getContextDirectory() (+28 more)
...
Cohesion: 0.07
Nodes (26): parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdogConfig, TtsWatchdogStatus, FetchFn, InternalState, LogFn, parsePositiveIntEnv() (+18 more)

### Community 214 - "Caveman Skill Compression Validation"
Cohesion: 0.07
Nodes (23): countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), syncTranscriptPollerRegistry() (+15 more)
...
Cohesion: 0.1
Nodes (28): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+20 more)
...
Cohesion: 0.09
Nodes (25): configShadowCommand(), ShadowOptions, INFERENCE.md Artifact, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), loadPanopticonEnvSync() (+17 more)

### Community 226 - "Contracts Types RPC and Desktop Package"
Cohesion: 0.08
Nodes (33): bufferToFloat32Array(), BuildConfig, buildDocsIndex(), BuildDocsIndexOptions, BuildDocsIndexResult, createDocsEmbeddingFunction(), createDocsIndexSchema(), DEFAULT_CONFIG (+25 more)

### Community 227 - "Command Deck Screenshots and Branding"
Cohesion: 0.09
Nodes (15): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getAllSessionFiles(), getAllSessionFilesSync(), getProjectDirsSync(), getRecentSessions() (+7 more)
...
Cohesion: 0.1
Nodes (33): chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources(), DEFAULT_DOCS_CONFIG, discoverDocsCorpusSources(), discoverMarkdownUnder() (+25 more)

### Community 234 - "Cloister Watchdog and Merge Validation Docs"
Cohesion: 0.1
Nodes (33): ActivityEntry, ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST(), fetchDetailedActivityREST() (+25 more)
...
Cohesion: 0.11
Nodes (33): advanceBudgetRecord(), DEFAULT_DOCS_CONFIG, docsBudgetKey(), DocsBudgetRecord, DocsBudgetState, DocsDisableEntry, DocsDisableState, DocsGateReason (+25 more)

### Community 243 - "Electron Desktop App Docs"
Cohesion: 0.11
Nodes (33): appendSystemPromptFile(), drainPendingEvents(), envFor(), getDashboardUrl(), handlePanDone(), handleSessionBriefingContext(), handleSessionStart(), handleToolExecutionEnd() (+25 more)
...
Cohesion: 0.08
Nodes (22): TLDR Daemon - Background Index Manager, captureTldrMetrics(), captureTldrMetricsSync(), daemonRegistry, ensureTldrStateDir(), getStateFilePath(), getTldrMetrics(), getTldrMetricsSync() (+14 more)
...
Cohesion: 0.06
Nodes (34): CLI Distribution Strategy, code:yaml (# Your original docker-compose.yml), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]), code:toml ([project]), code:bash (# First time - zero install), code:bash (# pan init adds to ~/.bashrc or ~/.zshrc:) (+26 more)
...
Cohesion: 0.07
Nodes (31): oldTimestamp, sentinel, eightDaysAgo, events, payload, r1, r2, received (+23 more)
...
Cohesion: 0.11
Nodes (26): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), executeCloseOutPromise(), findWorkspacePath() (+18 more)
...
Cohesion: 0.11
Nodes (24): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel() (+16 more)
...
Cohesion: 0.1
Nodes (27): createDocsCommand(), DocsQueryOptions, printDocsQueryResult(), DocsDocKind, applyDocsQueryBounds(), centroidVector(), ChunkRow, countTokens() (+19 more)
...
Cohesion: 0.13
Nodes (11): LRUCache, openSqliteDb(), constructor(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+3 more)
...
Cohesion: 0.11
Nodes (26): API_ERROR_PATTERNS, getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, REVIEWER_ROLES, name, API_ERROR_PATTERNS (+18 more)
...
Cohesion: 0.07
Nodes (21): result, activeContinuePath, continuePath, projectRoot, wsDir, cb, cmdArgs, mockExec (+13 more)
...
Cohesion: 0.09
Nodes (27): readConfig(), captureTldrMetrics(), captureTldrMetricsSync(), compose(), decorate(), end(), getErrorPos(), getTldrMetrics() (+19 more)

### Community 327 - "Dashboard Motion Animation Catalog"
Cohesion: 0.1
Nodes (25): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), ensureOpenAICompatibleProxyRunningPromise() (+17 more)
...
Cohesion: 0.14
Nodes (21): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getCloisterService() (+13 more)

### Community 330 - "Multi-Tool Skill Sync Config Migration"
Cohesion: 0.12
Nodes (24): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+16 more)
...
Cohesion: 0.09
Nodes (18): mockLoadProjectsConfig, WorkspaceService, MOCK_PROJECT, mockCreateWorkspace, mockExistsSync, mockLoadProjectsConfig, mockRemoveWorkspace, mockResolveProjectFromIssue (+10 more)
...
Cohesion: 0.08
Nodes (26): activeIssues, date1, date2, expectedOrder, filtered, filteredIds, filterRecentCompletedIssues(), getOneDayAgo() (+18 more)
...
Cohesion: 0.18
Nodes (21): startPostLaunchSidecars(), startSidecars(), restartCommand(), runFullRestart(), readPlatformConfig(), readPlatformConfigSync(), getSupervisorPort(), getSupervisorPortSync() (+13 more)

### Community 365 - "Agent Health Monitor States"
Cohesion: 0.18
Nodes (25): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHook(), checkHookSync(), clearHook(), clearHookSync(), generateFixedPointPrompt() (+17 more)
...
Cohesion: 0.14
Nodes (23): addPanopticonHookIfMissing(), checkJqInstalled(), ClaudeSettings, getRtkReleaseAsset(), installJq(), installRtk(), isHookConfigured(), readInstalledRtkVersion() (+15 more)
...
Cohesion: 0.11
Nodes (23): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+15 more)

### Community 386 - "Dashboard Vite Environment Types"
Cohesion: 0.17
Nodes (21): clearFeedbackFiles(), clearFeedbackFilesPromise(), FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+13 more)
...
Cohesion: 0.08
Nodes (5): FlyExecResult, FlyMachine, FlyMachineConfig, toFlyApiError(), ExecResult
...
Cohesion: 0.15
Nodes (24): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), createdAgeMs(), defaultWorkspacePath(), DockerPsJson, escapeRegExp(), evaluateWorkspaceStackHealth() (+16 more)
...
Cohesion: 0.12
Nodes (13): collectMail(), collectMailSync(), getHookDir(), getMailDir(), initHook(), initHookSync(), sendMail(), sendMailSync() (+5 more)

### Community 420 - "Community 420"
Cohesion: 0.13
Nodes (7): states, clientMock, octokitMock, result, states, linearCall(), LinearTracker

### Community 421 - "Community 421"
Cohesion: 0.13
Nodes (12): appendToWal(), appendToWalSync(), resolveWalDir(), extractPrefixSync(), extractStandardNumber(), extractStandardNumberSync(), extractStandardPrefix(), extractStandardPrefixSync() (+4 more)

### Community 422 - "Community 422"
Cohesion: 0.1
Nodes (22): entry, { issueId }, { limit }, old, op, ops, recent, result (+14 more)
...
Cohesion: 0.13
Nodes (16): emitter, onTurn, queue, subscribeVoiceSettings(), isTrustedWebSocketOrigin(), setupVoiceWebSocket(), createMoonshineTranscription(), ITurnEmitter (+8 more)
...
Cohesion: 0.15
Nodes (21): details, startRealConversationRoutes(), validateAgentDeliveryMethodOrigin(), validateOrigin(), addTrustedOrigin(), getHeader(), getTrustedOrigins(), isTrustedOriginForHost() (+13 more)

### Community 428 - "Community 428"
Cohesion: 0.17
Nodes (21): checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost(), getDailyTotal() (+13 more)

### Community 429 - "Community 429"
Cohesion: 0.17
Nodes (23): ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE, HandoffEvent (+15 more)

### Community 430 - "Community 430"
Cohesion: 0.15
Nodes (21): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+13 more)
...
Cohesion: 0.08
Nodes (23): Appendix: exe.dev CLI Reference, CLI Reference, code:bash (# Authentication), Comparison, Cost Analysis, Documentation Updates, exe.dev Pricing, Future Enhancements (+15 more)
...
Cohesion: 0.09
Nodes (13): NormalizedTtsDaemonConfig, TtsWatchdog, CONFIG, hadPackageDir, hadPython, hadVenvDir, killSpy, packageDir (+5 more)
...
Cohesion: 0.11
Nodes (18): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSessionContent(), parsePiSessionSync(), ParseResult (+10 more)

### Community 464 - "Community 464"
Cohesion: 0.11
Nodes (21): getProjectSpecialistMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), allLogs, logPath (+13 more)
...
Cohesion: 0.15
Nodes (17): startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent(), optionalString() (+9 more)
...
Cohesion: 0.15
Nodes (17): createWarmupUserMessage(), ExcalidrawElement, finiteNumber(), normalizeElements(), normalizeExcalidrawElement(), randomId(), randomNonce(), extractKeywords() (+9 more)

### Community 495 - "Community 495"
Cohesion: 0.15
Nodes (17): InlineSparkline(), InlineSparklineProps, BranchNode(), BranchNodeProps, ContainerNode(), ContainerNodeProps, containerStatusColor(), containerStatusToDot() (+9 more)
...
Cohesion: 0.13
Nodes (18): makeDb(), cache, db, loaded, row, rows, savedRow, snapshot (+10 more)

### Community 504 - "Community 504"
Cohesion: 0.13
Nodes (14): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, CacheEntry, clearSnapshotCache() (+6 more)
...
Cohesion: 0.09
Nodes (16): createSessionAsync, dir, emitActivityEntry, legacyDir, projectConfig, rawState, resolvedProject, state (+8 more)

### Community 510 - "Community 510"
Cohesion: 0.13
Nodes (16): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode, AutoPresoSession (+8 more)

### Community 511 - "Community 511"
Cohesion: 0.17
Nodes (17): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, sessionFilePath(), buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions (+9 more)
...
Cohesion: 0.18
Nodes (15): getVBriefACStatusSync(), BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChangesPromise(), checkVBriefACStatusSync(), errorCode(), execAsync (+7 more)
...
Cohesion: 0.23
Nodes (13): backup, backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync(), listBackups() (+5 more)
...
Cohesion: 0.11
Nodes (17): CI_FAILED_STATUS, ciBlockedStatus, feedbackDir, mockGetAgentRuntimeState, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSendKeysAsync, mockSessionExists (+9 more)
...
Cohesion: 0.22
Nodes (16): makeTestService(), initWorkspaceDiscoveredSessionsSchema(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), createEventStore(), EventRow (+8 more)
...
Cohesion: 0.19
Nodes (13): recoverUnhealthyTestStack(), workspaceRebuildCommand(), tempDirs, workspace, COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose() (+5 more)

### Community 613 - "Community 613"
Cohesion: 0.28
Nodes (4): effFromPromise(), execAsync, mapFlyStateToVmStatus(), getStatus()

### Community 614 - "Community 614"
Cohesion: 0.15
Nodes (4): FlyApiClient, mockSystemHealth, pill, requests
...
Cohesion: 0.24
Nodes (14): getRuntimeSnapshot(), getRuntimeSnapshotSync(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getSharedDb(), StoredEvent, AgentStateService (+6 more)
...
Cohesion: 0.2
Nodes (13): ActivityItem(), formatTimestamp(), inferCategory(), levelBadgeClass(), TtsItem(), ActivityItem, consolidateSpeakerCues(), decodeHtmlEntities() (+5 more)
...
Cohesion: 0.14
Nodes (12): mockCreateReviewArtifactsForIssue, mockEnsureMergeSetForIssue, mockGetAgentState, mockGetDashboardApiUrl, mockGetReviewStatus, mockRebaseAndPushRepos, mockSaveAgentRuntimeState, mockSaveAgentState (+4 more)

### Community 670 - "Community 670"
Cohesion: 0.18
Nodes (8): getIsolatedPlaywrightMcpConfig(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, RemoteError, VmInfo, VmStatus
...
Cohesion: 0.19
Nodes (12): runPreflight(), runStreaming(), checkVBriefACStatus(), capturedCmds, mockGetVBriefACStatus, capturedArgs, capturedCmds, closedBeads (+4 more)

### Community 710 - "Community 710"
Cohesion: 0.17
Nodes (11): DocsEmbeddingInput, getDefaultDocsConfig(), docsConfig(), docsConfig(), docsConfig(), fetchMock, json, markdown (+3 more)
...
Cohesion: 0.18
Nodes (12): mockGetAgentHealth, computeStuckCount(), map, mockGetAgentHealth, mockGetCloisterService, mockGetStatus, mockListRunningAgents, mockLoadReviewStatuses (+4 more)

### Community 716 - "Community 716"
Cohesion: 0.24
Nodes (12): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+4 more)
...
Cohesion: 0.26
Nodes (11): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+3 more)
...
Cohesion: 0.17
Nodes (9): calls, ctx, mockClientCreateIssueLabel, mockClientIssueLabels, mockClientIssues, { mockExecAsync, mockGetLinearApiKey }, mockIssueLabels, mockIssueUpdate (+1 more)

### Community 748 - "Community 748"
Cohesion: 0.17
Nodes (8): client, createFlyApiClient(), createFlyApiClientSync(), FlyApiError, client, fetchMock, machine, machines
...
Cohesion: 0.17
Nodes (12): code:bash (pan plan finalize), code:bash (pan plan done PAN-1071), code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Completing planning (`pan plan done`), Finalizing (`pan plan finalize`), Planning Workflow (+4 more)
...
Cohesion: 0.25
Nodes (9): ids, id, agentDir(), AGENTS_DIR, cleanup(), ctxFile(), id, ids (+1 more)

### Community 800 - "Community 800"
Cohesion: 0.18
Nodes (9): resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, getWorkspaceStackHealth, health, now, projectRoot, workspacePath, inferIssueIdFromStackContainerName() (+1 more)
...
Cohesion: 0.18
Nodes (9): Auto-planning, Available commands, Basic Usage, code:bash (pan plan <id> [--auto] [--model <model>] [--harness claude-c), code:bash (pan plan PAN-1071 --auto), Panopticon Planning Lifecycle, Related commands, See also (+1 more)
...
Cohesion: 0.31
Nodes (9): recordDocsTelemetry(), getDocsBudgetStatePath(), getDocsDir(), getDocsDisableStatePath(), getDocsIndexPath(), getDocsPaths(), getDocsTelemetryPath(), resolvePackageRootForDir() (+1 more)
...
Cohesion: 0.22
Nodes (7): closeResult, command, ctx, editCalls, labelResult, prResult, prResult

### Community 894 - "Community 894"
Cohesion: 0.28
Nodes (8): BASE_TIME, loadAgents(), loadDeaconWithResumeMock(), notifications, saveStoppedAgent(), state, updated, workspaceFor()
...
Cohesion: 0.22
Nodes (8): decodeLayersResponse, decodePreviewRequest, decodePreviewResponse, decodeSaveRequest, decodeSyncRequest, parsed, preview, save
...
Cohesion: 0.36
Nodes (6): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request
...
Cohesion: 0.29
Nodes (6): chunks, emitter, googleMocks, stream, createGoogleCloudTranscription(), GoogleStreamingRecognizeResponse
...
Cohesion: 0.29
Nodes (6): createWhiteboardSession(), run, session, signals, snapshot, warmup
...
## Knowledge Gaps
- **14121 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14116 more)
...
- **Why does `specialists` connect `Conversation Database and Favorites` to `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Agent Snapshot and Event Types`, `Inspector Panel Terminal UI`, `Event Store Domain Services`, `PRD Archiving and Issue Close Out`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Dashboard HTTP Routes and Admin`, `VBrief Lifecycle IO and Transitions`, `Agent Inspect Checkpoint Management`, `CLI Commands and Runtime Adapters`, `Cost Events Database and WAL Sync`, `Specialist Completion Tracking`, `Project Tree Feature Items UI`, `Review Round Status Badge UI`, `Community 421`, `Git Push Operations and Approval`, `Specialist Workflow Documentation and Gates`, `Workspace Metadata and Project Config`, `Cloister Service Handoff Logging`, `Specialist Context Digest Generation`, `Community 558`, `Pan CLI Skills and Lifecycle Verbs`, `Issue Tracker Polling Service`, `Diff Panel Rendering and Theming`, `Agent List and Handoff Status UI`, `GitHub Webhook Ingestion Handlers`, `Spec to Plan Pipeline Skills`, `Pi Session Cost Parser`, `Path Constants and Postinstall Setup`, `Community 464`, `Community 468`, `Frontend Dashboard Component Tests`, `Event Snapshot Cache and State Reducers`, `User Documentation and Provider Guides`, `Command Deck Screenshots and Branding`, `PTY Terminal Hub WebSocket Streaming`, `Specialist Agent Health Dashboard UI`, `Community 505`, `TLDR Daemon State Management`, `Pending Lifecycle Event Processing`, `Specialist Agent Prompts and Audit Docs`, `FPP Policy Violation Detection and Nudging`, `Specialist Run Log Lifecycle`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `VBrief Beads IO and Plan Finalize` to `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Rally Tracker API Integration`, `Deacon Patrol and Queue`, `Configuration Documentation`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Electron Desktop App and Tray`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `VBrief Lifecycle IO and Transitions`, `Community 537`, `Specialist Metadata and Grace Period`, `CLI Commands and Runtime Adapters`, `Cost Events Database and WAL Sync`, `Community 419`, `Cost Event Aggregation and Retention`, `Agent CV and Show Commands`, `Git Push Operations and Approval`, `Dashboard App Sidebar and Metrics`, `Community 427`, `Cloister Config Deep Merge`, `Cloister Service Handoff Logging`, `Pan CLI Skills and Lifecycle Verbs`, `VBrief Task Readiness and Beads IO`, `Review Workflow Command Coordination`, `Settings Page Model Override and Auth`, `Server Cache Service and Chat Markdown`, `Diff Panel Rendering and Theming`, `Agent List and Handoff Status UI`, `Pi Session Cost Parser`, `Cost Recovery Scripts and Latency Tests`, `Activity Panel and VTT Parsing`, `Model Routing and Complexity Detection`, `Issue Search Modal and Filter State`, `Cloister Orchestrator Architecture PRDs`, `CLI Command Taxonomy Reorganization`, `Traefik DNS and Platform Install Skills`, `Rally WSAPI Query Parser Fix`, `Issue ID Parsing and Agent Cleanup`, `Desktop Build and Monorepo Release Tests`, `Community 748`, `Cloister Pipeline Unit Tests`, `Cost Event Storage and WAL Tests`, `Electron Desktop App Docs`, `Agent Hook Scripts and Repo Artifact Design`, `Community 505`, `Specialist Run Log Lifecycle`, `Community 511`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Electron Desktop App and Tray` to `Test Global Setup Bootstrap`, `Merge Queue and App Settings Database`, `Inspector Panel Terminal UI`, `Config Loading and Merging`, `Tracker Context Injection on Agent Restart`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14121 weakly-connected nodes found - possible documentation gaps or missing edges._
