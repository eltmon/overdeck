...
## Corpus Check
- 1621 files · ~2,206,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23010 nodes · 34802 edges · 1163 communities (1123 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26e9e078`
...
## Communities (1163 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (159): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), checkStuckReviewing(), cleanupOrphanedReviewSessions(), killOrphanedWorkspaceProcesses(), monitorReviewConvoySignals(), archiveReviewerRound(), buildConvoyPrompt() (+151 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (139): buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), performSpecialistWake() (+131 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (123): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (120): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+112 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (110): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (118): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (95): getDefaultConversationModel(), ForkModal(), ForkModalProps, useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps (+87 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin() (+104 more)
...
Cohesion: 0.03
Nodes (114): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+106 more)
...
Cohesion: 0.04
Nodes (110): checkStuckWorkAgents(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext (+102 more)
...
Cohesion: 0.04
Nodes (106): stampPlanForFinalization(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition() (+98 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (91): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+83 more)
...
Cohesion: 0.04
Nodes (95): renderPrompt(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration(), clearSessionId(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist() (+87 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (77): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard() (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (82): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+74 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (71): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, fsHooks, result (+63 more)
...
Cohesion: 0.04
Nodes (76): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+68 more)
...
Cohesion: 0.03
Nodes (67): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+59 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (65): ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (70): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+62 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (56): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry (+48 more)
...
Cohesion: 0.04
Nodes (53): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, AC_STATUS_ICONS, BeadsResponse (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (66): generateFallbackSummary(), canReplaceTitle(), updateForkStatus(), MessageDeliveryFailed, waitForClaudePrompt(), ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute (+58 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (68): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl() (+60 more)
...
Cohesion: 0.05
Nodes (60): clearFeedbackFiles(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir() (+52 more)
...
Cohesion: 0.04
Nodes (56): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe() (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (59): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+51 more)
...
Cohesion: 0.05
Nodes (49): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, chunks, emitter (+41 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (55): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+47 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (56): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), createSummaryFork(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused() (+48 more)
...
Cohesion: 0.05
Nodes (51): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection() (+43 more)
...
Cohesion: 0.06
Nodes (50): backupCleanCommand(), backupListCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BackupInfo (+42 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (56): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), continueDirForWorkspace(), createSlotWorktree() (+48 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (54): applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence(), isoForStash() (+46 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (43): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+35 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (51): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceLive (+43 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (47): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+39 more)
...
Cohesion: 0.06
Nodes (50): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+42 more)
...
Cohesion: 0.06
Nodes (45): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, cont, doc, projectRoot (+37 more)
...
Cohesion: 0.05
Nodes (44): calculateCost(), DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing, anthropicModels, cost, entries (+36 more)
...
Cohesion: 0.07
Nodes (34): cn(), WorkTypeTableProps, SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps (+26 more)
...
Cohesion: 0.05
Nodes (23): getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller, websocketRpcRouteLayer, watchConversation(), EditorLaunch (+15 more)
...
Cohesion: 0.07
Nodes (27): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles() (+19 more)
...
Cohesion: 0.1
Nodes (38): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+30 more)
...
Cohesion: 0.1
Nodes (30): buildReviewContext(), BuildReviewContextOpts, ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+22 more)
...
Cohesion: 0.12
Nodes (28): CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+20 more)
...
Cohesion: 0.09
Nodes (24): ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps (+16 more)
...
Cohesion: 0.15
Nodes (23): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+15 more)
...
Cohesion: 0.14
Nodes (21): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+13 more)

### Community 297 - "Community 297"
Cohesion: 0.11
Nodes (19): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, ApproveOptions (+11 more)
...
Cohesion: 0.12
Nodes (11): createTracker(), createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv (+3 more)
...
Cohesion: 0.09
Nodes (18): createCall, dbError, deleteCalls, doc, existingBeads, expectedPrefix, initCall, metadata (+10 more)
...
Cohesion: 0.12
Nodes (18): after, backupPath, backups, calls, errSpy, exitSpy, original, out (+10 more)
...
Cohesion: 0.21
Nodes (13): listTestsCommand(), registerTestCommands(), RunOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+5 more)
...
Cohesion: 0.19
Nodes (10): addPanopticonHookIfMissing(), ClaudeSettings, HookConfig, isHookConfigured(), McpServer, SetupHooksOptions, added, first (+2 more)
...
Cohesion: 0.27
Nodes (9): getCavemanHooksDir(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), NormalizedCavemanConfig, baseModes, mockGetHooksDir, settings (+1 more)
...
Cohesion: 0.33
Nodes (8): findVendoredDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), checkJqInstalled(), installJq(), setupHooksCommand(), pruneBackupsSync()
...
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 4`, `Community 5`, `Community 774`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 395`, `Community 654`, `Community 142`, `Community 15`, `Community 17`, `Community 274`, `Community 277`, `Community 21`, `Community 22`, `Community 24`, `Community 281`, `Community 26`, `Community 27`, `Community 156`, `Community 157`, `Community 30`, `Community 31`, `Community 29`, `Community 546`, `Community 34`, `Community 40`, `Community 49`, `Community 55`, `Community 56`, `Community 570`, `Community 186`, `Community 573`, `Community 189`, `Community 65`, `Community 324`, `Community 199`, `Community 200`, `Community 84`, `Community 96`, `Community 228`, `Community 115`, `Community 116`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 9` to `Community 0`, `Community 1`, `Community 344`, `Community 3`, `Community 296`, `Community 297`, `Community 10`, `Community 14`, `Community 16`, `Community 241`, `Community 50`, `Community 24`, `Community 25`, `Community 56`, `Community 124`, `Community 158`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 53` to `Community 1`, `Community 15`?**
