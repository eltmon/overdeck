...
## Corpus Check
- 1542 files · ~2,037,654 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21779 nodes · 32356 edges · 1131 communities (1096 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 435 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3331ac74`
...
## Communities (1131 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (198): readCavemanVariant(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+190 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (118): ConversationView(), AgentList(), formatTimeAgo(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage() (+110 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (111): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+103 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (110): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+102 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (122): checkStuckReviewing(), renderPrompt(), getActiveParallelReviewIssues(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (124): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (91): firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+83 more)
...
Cohesion: 0.02
Nodes (103): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (80): LiveLastHeard(), stalenessClass(), ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS (+72 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (100): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), extractNumber() (+92 more)
...
Cohesion: 0.03
Nodes (94): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker() (+86 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (87): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (86): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (69): parsePiSession(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry (+61 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (89): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+81 more)
...
Cohesion: 0.04
Nodes (83): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (84): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+76 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (76): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), determineWorkspaceLocation(), ensureRemoteWorkspace() (+68 more)
...
Cohesion: 0.04
Nodes (64): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, after, doc (+56 more)
...
Cohesion: 0.04
Nodes (67): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (78): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+70 more)
...
Cohesion: 0.05
Nodes (77): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), getDevrootPath() (+69 more)
...
Cohesion: 0.04
Nodes (69): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffContext, HandoffResult (+61 more)
...
Cohesion: 0.04
Nodes (70): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), beadsDir, doc, badPath (+62 more)
...
Cohesion: 0.04
Nodes (66): archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), ActivityEntry, AgentListProps (+58 more)
...
Cohesion: 0.04
Nodes (64): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, mockLoadProjectsConfig, mockRunQualityGates (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (63): killAllReviewerSessions(), findSpecByIssue(), updateSpecStatus(), runDestructiveIssueLifecycle(), next, path, read, state (+55 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (55): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, RecoverButton(), RecoverButtonProps, ResetIssueButton() (+47 more)
...
Cohesion: 0.05
Nodes (53): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, getAgentRuntimeStateAsync(), withConcurrencyLimit(), listSessionNamesAsync(), fetchActivityDataWithContext() (+45 more)
...
Cohesion: 0.06
Nodes (60): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+52 more)
...
Cohesion: 0.05
Nodes (47): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+39 more)
...
Cohesion: 0.08
Nodes (21): issues, result, importTrackerConfig(), findProjectsByRallyProject(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+13 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (40): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+32 more)
...
Cohesion: 0.06
Nodes (38): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceLive (+30 more)
...
Cohesion: 0.07
Nodes (40): Access, AIProvider, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session() (+32 more)
...
Cohesion: 0.1
Nodes (35): clearFeedbackFiles(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+27 more)
...
Cohesion: 0.08
Nodes (36): getIssueDataService(), ActivityContext, closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData(), fetchPlanningData() (+28 more)
...
Cohesion: 0.15
Nodes (29): killCommand(), KillOptions, destroyRemoteWorkspace(), getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+21 more)
...
Cohesion: 0.07
Nodes (24): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+16 more)
...
Cohesion: 0.09
Nodes (21): setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, setPipelineHandler(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp() (+13 more)
...
Cohesion: 0.15
Nodes (27): captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), diffAgainstMain(), diffAgainstMainFiles(), diffCheckpointFiles(), diffCheckpoints() (+19 more)
...
Cohesion: 0.11
Nodes (25): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+17 more)
...
Cohesion: 0.13
Nodes (18): fname, parts, root, VBriefMergeConflictError, findLegacyVBriefByIssue(), parseVBriefFilename(), resolveVBriefDir(), VBRIEF_LIFECYCLE_DIRS (+10 more)
...
Cohesion: 0.08
Nodes (19): first, found, path, paths, read, second, sessions, updated (+11 more)
...
Cohesion: 0.1
Nodes (13): ReadModelService, getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, EditorLaunch, execAsync, getFileManagerCommand() (+5 more)
...
Cohesion: 0.15
Nodes (17): TrackersConfig, mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker() (+9 more)
...
Cohesion: 0.15
Nodes (14): getForgeAdapter(), {
  execMock,
  getPullRequestStateMock,
  isGitHubAppConfiguredMock,
  mergePullRequestWithAppMock,
  parsePullRequestRefMock,
}, kCustom, mergePromise, withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue() (+6 more)
...
- **Why does `fetch` connect `Community 33` to `Community 1025`, `Community 1`, `Community 130`, `Community 3`, `Community 129`, `Community 518`, `Community 263`, `Community 6`, `Community 519`, `Community 7`, `Community 11`, `Community 13`, `Community 14`, `Community 144`, `Community 146`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 539`, `Community 156`, `Community 410`, `Community 545`, `Community 546`, `Community 801`, `Community 39`, `Community 44`, `Community 174`, `Community 49`, `Community 50`, `Community 436`, `Community 57`, `Community 186`, `Community 187`, `Community 59`, `Community 61`, `Community 958`, `Community 959`, `Community 66`, `Community 581`, `Community 333`, `Community 82`, `Community 96`, `Community 481`, `Community 739`, `Community 230`, `Community 363`, `Community 629`, `Community 380`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 136` to `Community 176`, `Community 0`, `Community 11`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 66`, `Community 34`, `Community 37`, `Community 106`, `Community 543`, `Community 332`, `Community 309`, `Community 286`, `Community 31`?**
