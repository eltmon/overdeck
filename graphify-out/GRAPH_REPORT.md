# Graph Report - feature-pan-1194  (2026-05-18)

## Corpus Check
- 1754 files · ~2,344,411 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24081 nodes · 36883 edges · 1221 communities (1175 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dba4ada4`
...
1. `fetch` - 204 edges
2. `getDatabase()` - 126 edges
3. `resolveProjectFromIssue()` - 121 edges
4. `useDashboardStore` - 65 edges
5. `sessionExistsAsync()` - 59 edges
6. `spawnRun()` - 50 edges
7. `spawnAgent()` - 50 edges
8. `jsonResponse()` - 49 edges
9. `messageAgent()` - 48 edges
10. `runPatrol()` - 48 edges
...
## Communities (1221 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (174): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+166 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (142): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (119): checkApiErrorAgents(), cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus() (+111 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (119): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+111 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (116): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+108 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (120): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (101): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (106): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+98 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (108): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+100 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (81): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+73 more)
...
Cohesion: 0.02
Nodes (83): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (89): EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp(), execFile(), kCustom, mockExecFile (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (76): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc, result, beadsDir (+68 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (70): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), criteria, doc, projectDoc, projectRoot (+62 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (81): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, formatBytes() (+73 more)
...
Cohesion: 0.03
Nodes (71): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ViewMode (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (65): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, SwarmRuntimeSection(), SwarmSlotView (+57 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (80): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+72 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (79): after, before, blockers, result, statuses, after, row, status (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (76): readCavemanVariant(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+68 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (78): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+70 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (66): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+58 more)
...
Cohesion: 0.05
Nodes (63): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (64): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), loadPinState(), PHASE_CHIP_COLORS (+56 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (70): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields(), continueDirForWorkspace() (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (60): ConversationView(), ActivityPanel(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove() (+52 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (63): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+55 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (62): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (67): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+59 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (55): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+47 more)
...
Cohesion: 0.03
Nodes (74): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+66 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (64): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+56 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (56): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+48 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (59): startPostLaunchSidecars(), startSidecars(), dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild() (+51 more)
...
Cohesion: 0.04
Nodes (54): ids, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter (+46 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (60): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+52 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (64): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+56 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (63): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+55 more)
...
Cohesion: 0.05
Nodes (59): Access, encodeClaudeProjectDir(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), pathExists(), pickFreshestSessionId() (+51 more)
...
Cohesion: 0.04
Nodes (53): result, getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute (+45 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (55): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+47 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (48): adminRouteLayer, getAdminTldrRoute, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute (+40 more)
...
Cohesion: 0.05
Nodes (49): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+41 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (48): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+40 more)
...
Cohesion: 0.06
Nodes (48): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+40 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (55): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+47 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (46): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+38 more)
...
Cohesion: 0.07
Nodes (49): getTrackerContext(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview() (+41 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (45): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+37 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (48): clearFeedbackFiles(), readWorkspacePlanAsync(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync(), uniqueTmpPath() (+40 more)
...
Cohesion: 0.06
Nodes (50): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+42 more)
...
Cohesion: 0.06
Nodes (30): parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, FetchFn, InternalState, LogFn (+22 more)
...
Cohesion: 0.06
Nodes (40): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL (+32 more)
...
Cohesion: 0.04
Nodes (47): DomainEvent, AgentOutput, ChatMessage, CompactBoundary, ConversationCostTotals, ConversationEvent, ConversationResponse, DeepWipeRpc (+39 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (45): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy() (+37 more)
...
Cohesion: 0.05
Nodes (38): FileStatus, CACHE_MANIFEST, SOURCE_AGENTS_DIR, SOURCE_DEV_SKILLS_DIR, SOURCE_RULES_DIR, SOURCE_SCRIPTS_DIR, DevrootSyncItem, getGitTrackedSkillDirNames() (+30 more)
...
Cohesion: 0.07
Nodes (32): FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig(), getRemoteProvider(), isRemoteAvailable(), ProviderType (+24 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (37): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+29 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (38): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+30 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (38): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+30 more)
...
Cohesion: 0.06
Nodes (27): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+19 more)

### Community 113 - "Community 113"
Cohesion: 0.07
Nodes (31): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+23 more)

### Community 114 - "Community 114"
Cohesion: 0.05
Nodes (42): Activity, AgentChannelReply, AgentId, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot, ChannelReplyArtifactRef (+34 more)
...
Cohesion: 0.1
Nodes (34): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR (+26 more)

### Community 129 - "Community 129"
Cohesion: 0.06
Nodes (34): ActivityEntry, ActivityItem(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST(), fetchDetailedActivityREST() (+26 more)
...
Cohesion: 0.06
Nodes (18): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, getIssueDataService() (+10 more)

### Community 147 - "Community 147"
Cohesion: 0.09
Nodes (32): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+24 more)
...
Cohesion: 0.07
Nodes (33): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+25 more)
...
Cohesion: 0.13
Nodes (33): getDevrootPath(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry (+25 more)

### Community 163 - "Community 163"
Cohesion: 0.1
Nodes (28): shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus(), getShadowState(), getShadowStatePath(), getUnsyncedHistory() (+20 more)
...
Cohesion: 0.09
Nodes (34): PrdLocation, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+26 more)
...
Cohesion: 0.09
Nodes (33): getLastEventMetadata(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir() (+25 more)
...
Cohesion: 0.07
Nodes (30): Agent Grid, code:block1 (┌────────────────────────────────────────────────────┐), code:css (--gv-bg: #0a0e1a          /* Dark navy background */), Components, Dependencies, Design System, Focus View, God View — Real-time Agent Activity Command Center (+22 more)

### Community 176 - "Community 176"
Cohesion: 0.11
Nodes (32): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest() (+24 more)

### Community 177 - "Community 177"
Cohesion: 0.08
Nodes (28): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+20 more)

### Community 178 - "Community 178"
Cohesion: 0.06
Nodes (34): ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema, EnrichBodySchema (+26 more)
...
Cohesion: 0.06
Nodes (31): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, validateEstimatedCost() (+23 more)
...
Cohesion: 0.1
Nodes (30): applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+22 more)

### Community 200 - "Community 200"
Cohesion: 0.06
Nodes (30): cb, completedState, dispatched, featureWorkspace, ghExecFileMock, implSlot, initial, initialState (+22 more)

### Community 201 - "Community 201"
Cohesion: 0.12
Nodes (27): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHandle (+19 more)

### Community 202 - "Community 202"
Cohesion: 0.09
Nodes (28): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceShape, SpecialistAgentName (+20 more)
...
Cohesion: 0.1
Nodes (30): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+22 more)

### Community 205 - "Community 205"
Cohesion: 0.07
Nodes (22): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName() (+14 more)
...
Cohesion: 0.14
Nodes (4): execAsync, FlyProvider, mapFlyStateToVmStatus(), spawn
...
Cohesion: 0.09
Nodes (27): AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+19 more)
...
Cohesion: 0.06
Nodes (31): Available TLDR Tools, Beads Tasks, code:block1 (1. Agent needs to understand auth.ts), code:bash (node -e "const fs=require('fs'); const p='.pan/spec.vbrief.j), code:bash (git fetch origin main && git rebase origin/main), code:bash (pan done {{ISSUE_ID}} -c "Work already complete from previou), code:json ({), code:bash (npm test                                         # Run tests) (+23 more)
...
Cohesion: 0.1
Nodes (27): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, ensureResourceConfigLoaded(), evaluateSeverity() (+19 more)

### Community 229 - "Community 229"
Cohesion: 0.14
Nodes (28): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker() (+20 more)
...
Cohesion: 0.07
Nodes (28): agentsRouteLayer, cliproxyRouteLayer, conversationsRouteLayer, issuesRouteLayer, miscRouteLayer, swarmRouteLayer, workspacesRouteLayer, allowDashboardSessionCors() (+20 more)
...
Cohesion: 0.12
Nodes (24): buildCorrelationMap(), CorrelationResult, scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget() (+16 more)
...
Cohesion: 0.09
Nodes (18): RoundMarker, RoundData, ZoneCConversation(), ZoneCConversationProps, fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps (+10 more)
...
Cohesion: 0.12
Nodes (26): CloseIssueOptions, DeepWipeOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+18 more)

### Community 267 - "Community 267"
Cohesion: 0.09
Nodes (16): MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient, { rerender } (+8 more)
...
Cohesion: 0.17
Nodes (25): handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir() (+17 more)
...
Cohesion: 0.14
Nodes (20): NormalizedTtsDaemonConfig, startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority() (+12 more)
...
Cohesion: 0.28
Nodes (23): cleanupLabelsGitHub(), cleanupMergedLabels(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync (+15 more)

### Community 332 - "Community 332"
Cohesion: 0.12
Nodes (18): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, execAsync (+10 more)
...
Cohesion: 0.09
Nodes (20): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+12 more)

### Community 357 - "Community 357"
Cohesion: 0.17
Nodes (17): ZoneBActionStrip(), ZoneBActionStripProps, RestartResult, StoppedAgentsBanner(), retryPendingSpawn(), clearPendingCodexReauthSession(), clearPendingCodexSpawn(), currentPendingSpawn() (+9 more)
...
Cohesion: 0.19
Nodes (19): healthCommand(), HealthOptions, pendingCommand(), listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+11 more)
...
Cohesion: 0.18
Nodes (19): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+11 more)
...
Cohesion: 0.12
Nodes (17): badPath, doc, draftPath, item, item2, makePlanDoc(), other, panDir (+9 more)
...
Cohesion: 0.15
Nodes (19): CapabilityStats, clearMetrics(), DailyStats, DEFAULT_METRICS, getAggregatedMetrics(), getAllRuntimeMetrics(), getIssueTasks(), getRecentTasks() (+11 more)
...
Cohesion: 0.12
Nodes (15): importTrackerConfig(), getCachedPlanningState(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache, PlanningStateCacheEntry, planningStateRefreshInFlight, POLL_INTERVALS (+7 more)

### Community 417 - "Community 417"
Cohesion: 0.14
Nodes (17): buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage() (+9 more)
...
Cohesion: 0.16
Nodes (15): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), refreshCommand() (+7 more)
...
Cohesion: 0.26
Nodes (15): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, AgentCV, completeWork(), formatCV() (+7 more)
...
Cohesion: 0.18
Nodes (16): readInferenceDocument(), execAsync, generateObservation(), generateObserverPrompt(), ObserverAgentConfig, pollPRs(), postPRComment(), PRInfo (+8 more)
...
Cohesion: 0.16
Nodes (11): consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardSessionUrl(), DEFAULT_RETRY_DELAY, ensureDashboardSession(), makePanRpcClient, resetTransport(), resolveRpcUrl() (+3 more)
...
Cohesion: 0.11
Nodes (16): _resetDashboardSessionTokenForTests(), all, cookie, fetched, filter, inserted, p, pA (+8 more)
...
Cohesion: 0.15
Nodes (14): doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, QueuedCommit, serializer (+6 more)
...
Cohesion: 0.17
Nodes (13): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichPRBody(), readBeadsFromJsonl() (+5 more)
...
Cohesion: 0.15
Nodes (13): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute, postCodexReauthStatusRoute (+5 more)
...
Cohesion: 0.12
Nodes (15): 1. Review the shared context first, 2. Wait for convoy signals, 3. Read available reviewer reports, 4. Synthesize the verdict, 5. Write the synthesis report, 6. Signal review status, Boundaries, code:markdown (# Review Synthesis — <issueId> — <timestamp>) (+7 more)
...
Cohesion: 0.19
Nodes (12): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, updateInferenceDocument(), artifacts (+4 more)
...
Cohesion: 0.24
Nodes (11): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), tempDirs (+3 more)
...
Cohesion: 0.17
Nodes (10): issues, result, CACHE_DB_PATH, CacheEntry, DEFAULT_TTLS, L1Entry, openSqliteDb(), RateLimitInfo (+2 more)
...
Cohesion: 0.17
Nodes (10): evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), defaultThresholds(), getResourceConfig(), SystemHealthSnapshot (+2 more)
...
Cohesion: 0.28
Nodes (7): decode, decodeCandidate(), ev, bodyToEvent(), decodeDomainEvent, isChannelReplyKind(), normalizeChannelReplyPayload()
...
Cohesion: 0.29
Nodes (6): Active Pipeline, Cycling Alerts, Flywheel State — 2026-05-18 (Run 1 of all-up-with-twist), Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.47
Nodes (5): detectPlatform(), Platform, getHealthPollTtlMs(), readCpuPercent(), readLoadAverage()
...
Cohesion: 0.4
Nodes (4): DASHBOARD_URL, resetReviewCommand(), ResetReviewOptions, { resetSessionMock, fetchMock }
...
## Knowledge Gaps
- **12532 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12527 more)
...
- **Why does `fetch` connect `Community 24` to `Community 129`, `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 267`, `Community 14`, `Community 15`, `Community 16`, `Community 527`, `Community 18`, `Community 147`, `Community 660`, `Community 1044`, `Community 21`, `Community 407`, `Community 20`, `Community 25`, `Community 29`, `Community 414`, `Community 31`, `Community 417`, `Community 33`, `Community 34`, `Community 165`, `Community 550`, `Community 39`, `Community 37`, `Community 41`, `Community 298`, `Community 43`, `Community 301`, `Community 173`, `Community 302`, `Community 177`, `Community 434`, `Community 433`, `Community 825`, `Community 58`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 65`, `Community 67`, `Community 708`, `Community 198`, `Community 710`, `Community 455`, `Community 454`, `Community 74`, `Community 206`, `Community 80`, `Community 595`, `Community 596`, `Community 979`, `Community 88`, `Community 474`, `Community 357`, `Community 622`, `Community 240`, `Community 883`, `Community 247`, `Community 504`, `Community 124`, `Community 254`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 20` to `Community 0`, `Community 128`, `Community 2`, `Community 3`, `Community 1`, `Community 7`, `Community 8`, `Community 331`, `Community 332`, `Community 12`, `Community 174`, `Community 214`, `Community 215`, `Community 24`, `Community 25`, `Community 62`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 14` to `Community 64`, `Community 5`, `Community 7`, `Community 200`, `Community 10`, `Community 12`, `Community 13`, `Community 662`, `Community 411`, `Community 28`, `Community 63`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12532 weakly-connected nodes found - possible documentation gaps or missing edges._
