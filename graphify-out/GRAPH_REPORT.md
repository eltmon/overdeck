...
## Corpus Check
- 1744 files · ~2,321,245 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23800 nodes · 36367 edges · 1202 communities (1154 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c056ee71`
...
## Communities (1202 total, 48 thin omitted)
...
Cohesion: 0.02
Nodes (172): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+164 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (164): autoResumeStoppedWorkAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), notifyAgentStatusChanged(), nudgeIdleWorkAgentsWithOpenBeads(), recoverOrphanedAgentsOnce(), buildHandoffPrompt() (+156 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (139): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+131 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (126): ActivityView(), ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage() (+118 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (142): checkPostReviewCommits(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), after, before, blockers, result (+134 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (100): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, INSPECTOR_PANEL_SOURCE, state (+92 more)
...
Cohesion: 0.03
Nodes (109): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+101 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (96): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses (+88 more)
...
Cohesion: 0.02
Nodes (96): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+88 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (95): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+87 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (87): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+79 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (86): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+78 more)
...
Cohesion: 0.03
Nodes (85): TurnDiffFileChange, forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset() (+77 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (89): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+81 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (73): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), derivePlanningIssueId(), TerminalPanel() (+65 more)
...
Cohesion: 0.04
Nodes (86): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+78 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (69): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+61 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (72): readCavemanVariant(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+64 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (76): workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d (+68 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (75): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+67 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (77): dequeueMerge(), ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+69 more)
...
Cohesion: 0.05
Nodes (74): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+66 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (73): clearFeedbackFiles(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths() (+65 more)
...
Cohesion: 0.03
Nodes (66): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+58 more)
...
Cohesion: 0.05
Nodes (24): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+16 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (65): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), confirmHostOverride(), countBeadsTasks() (+57 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (54): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+46 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (47): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+39 more)
...
Cohesion: 0.05
Nodes (51): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+43 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (55): NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, result, getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), clearCacheRoute (+47 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (58): createCostCommand(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getAllSessionFiles(), getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions() (+50 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (41): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+33 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (45): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, OverviewTab (+37 more)
...
Cohesion: 0.06
Nodes (52): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+44 more)
...
Cohesion: 0.08
Nodes (47): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+39 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (49): formatIssueCostAggregate(), aggregate, output, AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (46): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), cont (+38 more)
...
Cohesion: 0.06
Nodes (48): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+40 more)
...
Cohesion: 0.05
Nodes (46): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+38 more)
...
Cohesion: 0.05
Nodes (43): arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding(), FtsRow (+35 more)
...
Cohesion: 0.07
Nodes (35): criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+27 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (44): Access, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats(), getIndexStats(), stat (+36 more)
...
Cohesion: 0.06
Nodes (38): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), AutoActions, AutoRestartConfig (+30 more)
...
Cohesion: 0.1
Nodes (31): CopyConfigOptions, listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, BACKUPS_DIR, BIN_DIR (+23 more)
...
Cohesion: 0.09
Nodes (33): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+25 more)
...
Cohesion: 0.08
Nodes (34): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels(), getAvailableModels() (+26 more)

### Community 144 - "Community 144"
Cohesion: 0.1
Nodes (30): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+22 more)
...
Cohesion: 0.09
Nodes (32): detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG (+24 more)
...
Cohesion: 0.09
Nodes (34): buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatVoiceDetails(), formatVoiceSource(), formatVoicesTable(), listTtsVoices(), mapTtsVoice() (+26 more)
...
Cohesion: 0.08
Nodes (19): countContextTokens(), findSessionFile(), getActiveSessionModel(), getProjectDirs(), getSessionFiles(), parseClaudeSession(), claudeProjectDir, content (+11 more)
...
Cohesion: 0.09
Nodes (32): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+24 more)

### Community 167 - "Community 167"
Cohesion: 0.09
Nodes (27): AwaitingInputDetection, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+19 more)
...
Cohesion: 0.08
Nodes (25): confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, createConfiguredClaudeApi(), EnrichSessionOptions, CostThresholdError (+17 more)

### Community 178 - "Community 178"
Cohesion: 0.06
Nodes (27): content, createTestDb(), db, event, goodLine, history, ids, latest (+19 more)

### Community 179 - "Community 179"
Cohesion: 0.1
Nodes (30): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), ARCHIVES_DIR (+22 more)
...
Cohesion: 0.07
Nodes (21): SearchResult, DiscoveredSession, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer (+13 more)
...
Cohesion: 0.09
Nodes (21): FetchFn, InternalState, LogFn, parsePositiveIntEnv(), readWatchdogConfig(), readWatchdogPersistentState(), SpawnRestart, SupervisorWatchdog (+13 more)

### Community 202 - "Community 202"
Cohesion: 0.12
Nodes (26): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHandle (+18 more)
...
Cohesion: 0.11
Nodes (25): embedAction(), findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getDiscoveredStats(), buildEmbeddingText(), EmbedProgress, EmbedResult, embedSessions() (+17 more)
...
Cohesion: 0.09
Nodes (25): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+17 more)
...
Cohesion: 0.09
Nodes (24): ALLOWED, canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, getKimiAnthropicBaseUrl() (+16 more)
...
Cohesion: 0.13
Nodes (28): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+20 more)

### Community 240 - "Community 240"
Cohesion: 0.08
Nodes (22): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+14 more)
...
Cohesion: 0.1
Nodes (13): DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+5 more)
...
Cohesion: 0.14
Nodes (21): collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode, ScanOptions (+13 more)
...
Cohesion: 0.2
Nodes (20): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+12 more)
...
Cohesion: 0.16
Nodes (13): DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsRow(), SettingsRowProps, SettingsSection() (+5 more)
...
Cohesion: 0.18
Nodes (10): ProviderCard(), ProviderCardProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps, StatusDot(), StatusDotProps (+2 more)
...
Cohesion: 0.29
Nodes (9): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), tempDirs (+1 more)
...
Cohesion: 0.38
Nodes (5): PhaseGlyph(), PhaseGlyphPhase, PhaseGlyphProps, renderGlyph(), glyph
...
Cohesion: 0.5
Nodes (4): execAsync, pending, withBdMutex(), withWorkspaceBdMutex()
...
## Knowledge Gaps
- **12408 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12403 more)
...
- **Why does `fetch` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 262`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 397`, `Community 14`, `Community 19`, `Community 791`, `Community 23`, `Community 24`, `Community 26`, `Community 155`, `Community 156`, `Community 29`, `Community 28`, `Community 285`, `Community 414`, `Community 34`, `Community 35`, `Community 165`, `Community 41`, `Community 45`, `Community 432`, `Community 51`, `Community 52`, `Community 568`, `Community 57`, `Community 569`, `Community 189`, `Community 61`, `Community 62`, `Community 194`, `Community 68`, `Community 70`, `Community 596`, `Community 223`, `Community 224`, `Community 228`, `Community 360`, `Community 635`, `Community 239`, `Community 115`, `Community 116`, `Community 631`, `Community 379`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 29` to `Community 128`, `Community 0`, `Community 2`, `Community 1`, `Community 5`, `Community 9`, `Community 10`, `Community 334`, `Community 239`, `Community 17`, `Community 18`, `Community 179`, `Community 145`, `Community 22`, `Community 28`, `Community 382`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 726` to `Community 15`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12408 weakly-connected nodes found - possible documentation gaps or missing edges._
