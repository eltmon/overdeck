# Graph Report - feature-pan-913  (2026-05-12)

## Corpus Check
- 1574 files · ~2,071,491 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22401 nodes · 33630 edges · 1160 communities (1120 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e10ad43f`
...
1. `fetch` - 167 edges
2. `resolveProjectFromIssue()` - 111 edges
3. `getDatabase()` - 90 edges
4. `useDashboardStore` - 59 edges
5. `listSessionNamesAsync()` - 54 edges
6. `sessionExistsAsync()` - 53 edges
7. `spawnAgent()` - 51 edges
8. `spawnEphemeralSpecialist()` - 51 edges
9. `killSessionAsync()` - 50 edges
10. `messageAgent()` - 46 edges
...
- `upsertReviewStatus()` --calls--> `upsert()`  [INFERRED]
  src/lib/database/review-status-db.ts → tests/unit/lib/database.test.ts

## Communities (1160 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (159): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+151 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (160): checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), killOrphanedWorkspaceProcesses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt() (+152 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (128): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+120 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (130): checkFailedMergeRetry(), clearStaleCiFeedback(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile() (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (126): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+118 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (96): getDefaultConversationModel(), ConversationRow(), ForkModal(), ForkModalProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip() (+88 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (96): parsePiSession(), waitForPiAgentReady(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder (+88 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (98): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+90 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (102): readCavemanVariant(), getSpecialistHarness(), buildSpecialistCavemanExports(), bumpSessionGeneration(), clearSessionId(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist() (+94 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (85): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+77 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (81): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+73 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (86): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+78 more)
...
Cohesion: 0.04
Nodes (84): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+76 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (74): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ProjectOverview(), AgentOutputPanel(), AgentOutputPanelProps (+66 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (91): resetPostMergeState(), agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache() (+83 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (86): dequeueMerge(), assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execFile() (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (83): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+75 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (83): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+75 more)
...
Cohesion: 0.04
Nodes (79): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (67): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, AgentCard(), BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal() (+59 more)
...
Cohesion: 0.04
Nodes (80): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+72 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (66): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+58 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (65): loadCloisterConfig(), checkPendingTestDispatch(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+57 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (67): isEligibleForCleanup(), clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace() (+59 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (65): after, before, blockers, result, statuses, after, row, status (+57 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (55): criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), formatAcceptanceCriteria(), isRFC3339DateTime() (+47 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (58): SkillsList(), formatBytes(), severityClasses(), SystemHealthPill(), critical, { mockConfirmAndKill, mockRefreshDashboardState }, { mockToastError, mockUseSystemHealth, hookState }, { rerender, queryClient } (+50 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (60): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument() (+52 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (67): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+59 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (49): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+41 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (55): generateSummaryForFork(), canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (53): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+45 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (48): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+40 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (43): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+35 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (58): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel(), clearStuckForks(), listArchivedConversationNames() (+50 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (59): applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult, ConversationsConfig (+51 more)
...
Cohesion: 0.05
Nodes (43): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), CostDonut(), CostDonutProps, GodViewPage() (+35 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (51): runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), AgentRollup, CavemanExperimentRow, DailyTrend (+43 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (45): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (51): applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence(), isoForStash(), isOlderThanDays() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (47): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+39 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (33): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+25 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (45): withConcurrencyLimit(), result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+37 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (50): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+42 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (46): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+38 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (44): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+36 more)
...
Cohesion: 0.07
Nodes (45): backupCleanCommand(), backupListCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BackupInfo (+37 more)
...
Cohesion: 0.06
Nodes (43): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), next (+35 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (48): Access, getAgentJsonlMtime(), readFileTail(), encodeClaudeProjectDir(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), pathExists() (+40 more)
...
Cohesion: 0.06
Nodes (39): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+31 more)
...
Cohesion: 0.12
Nodes (46): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+38 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (44): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+36 more)
...
Cohesion: 0.04
Nodes (41): agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, evaluateSpawnGuardrails(), execAsync, formatLeakedSpecialistSummary(), getAgentActivityRoute (+33 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (43): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+35 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (34): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+26 more)
...
Cohesion: 0.04
Nodes (44): execAsync, execFileAsync, firePostMergeLifecycle(), getModelsResolveRoute, getProjectPathForIssue(), getProjectSpecialistContextRoute, getProjectSpecialistGraceRoute, getProjectSpecialistLatestLogRoute (+36 more)

### Community 74 - "Community 74"
Cohesion: 0.09
Nodes (43): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+35 more)
...
Cohesion: 0.08
Nodes (38): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+30 more)
...
Cohesion: 0.05
Nodes (46): Abort semantics, Acceptance criteria taxonomy, CLI reference, code:block1 (work role completes beads and signals done), code:yaml (work_types:), code:block2 (roles/), code:markdown (# Verdict: APPROVED | CHANGES_REQUESTED | FAILED), code:yaml (workhorses:) (+38 more)
...
Cohesion: 0.06
Nodes (36): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, readInferenceDocument(), updateInferenceDocument() (+28 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (38): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+30 more)
...
Cohesion: 0.07
Nodes (37): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), injectCavemanSettings() (+29 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (29): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BUCKET_STAGES, BucketedFeature, bucketFeature(), CostBadge() (+21 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (40): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+32 more)
...
Cohesion: 0.08
Nodes (33): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, AcceptanceCriterion, createBeadsFromVBrief() (+25 more)
...
Cohesion: 0.06
Nodes (37): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+29 more)
...
Cohesion: 0.1
Nodes (35): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), restoreTrackedBeadsExport(), updateGitHubToInReview(), updateLinearToInReview() (+27 more)

### Community 102 - "Community 102"
Cohesion: 0.07
Nodes (38): authStatusVariant(), AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, displayModelRef(), fetchAvailableModels(), fetchSettings(), formatExpiry() (+30 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (33): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+25 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (34): useLiveFlash(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose() (+26 more)
...
Cohesion: 0.08
Nodes (30): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus (+22 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (36): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+28 more)
...
Cohesion: 0.05
Nodes (41): 1. Algorithmic Complexity, 2. Database & Query Performance, 3. Memory Management, 4. Network & I/O, 5. Frontend Performance, 6. Caching, 7. Concurrency & Parallelism, 8. Resource Usage (+33 more)

### Community 116 - "Community 116"
Cohesion: 0.07
Nodes (37): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+29 more)
...
Cohesion: 0.08
Nodes (34): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+26 more)
...
Cohesion: 0.07
Nodes (32): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), badPath, customPlanningDir, dir (+24 more)
...
Cohesion: 0.06
Nodes (30): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+22 more)

### Community 131 - "Community 131"
Cohesion: 0.06
Nodes (33): setAgentStoppedNotifier(), getAllActiveQueues(), setPipelineHandler(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp() (+25 more)
...
Cohesion: 0.06
Nodes (28): resumeCommand(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), getAgentRuntimeStateAsync(), saveSessionId() (+20 more)
...
Cohesion: 0.1
Nodes (30): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession() (+22 more)

### Community 144 - "Community 144"
Cohesion: 0.13
Nodes (33): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+25 more)
...
Cohesion: 0.07
Nodes (26): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), ModelSelectionResult (+18 more)

### Community 151 - "Community 151"
Cohesion: 0.1
Nodes (27): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), _get_default_sink_state(), Handler, load_base_model(), load_design_model() (+19 more)
...
Cohesion: 0.09
Nodes (30): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+22 more)
...
Cohesion: 0.07
Nodes (30): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+22 more)

### Community 160 - "Community 160"
Cohesion: 0.07
Nodes (31): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+23 more)
...
Cohesion: 0.06
Nodes (35): Activity, AgentChannelReply, AgentId, AgentPhase, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES (+27 more)
...
Cohesion: 0.08
Nodes (29): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, getAllWorkTypes(), getWorkTypeMetadata() (+21 more)

### Community 167 - "Community 167"
Cohesion: 0.08
Nodes (24): getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter(), apiKeys (+16 more)
...
Cohesion: 0.09
Nodes (29): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+21 more)

### Community 170 - "Community 170"
Cohesion: 0.13
Nodes (31): killCommand(), KillOptions, buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode() (+23 more)
...
Cohesion: 0.08
Nodes (27): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+19 more)
...
Cohesion: 0.11
Nodes (28): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+20 more)
...
Cohesion: 0.14
Nodes (3): execAsync, FlyProvider, mapFlyStateToVmStatus()

### Community 209 - "Community 209"
Cohesion: 0.09
Nodes (28): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+20 more)

### Community 210 - "Community 210"
Cohesion: 0.09
Nodes (27): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength(), buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody() (+19 more)

### Community 211 - "Community 211"
Cohesion: 0.19
Nodes (30): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState() (+22 more)

### Community 212 - "Community 212"
Cohesion: 0.14
Nodes (30): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+22 more)

### Community 213 - "Community 213"
Cohesion: 0.1
Nodes (13): getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+5 more)
...
Cohesion: 0.07
Nodes (29): 1. Logic Errors, 2. Null/Undefined Handling, 3. Edge Cases, 4. Type Safety, 5. Data Flow, 6. Consistency and Completeness, Acceptance criteria classification, Code Review: Correctness (+21 more)
...
Cohesion: 0.09
Nodes (18): EventRouter(), CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize(), createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY (+10 more)
...
Cohesion: 0.08
Nodes (18): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+10 more)
...
Cohesion: 0.11
Nodes (23): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex(), isRecentPromptIndex() (+15 more)

### Community 255 - "Community 255"
Cohesion: 0.14
Nodes (9): defectQuery, hrQuery, mockCreate, mockQuery, mockUpdate, tracker, escapeQueryValue(), RallyTracker (+1 more)

### Community 256 - "Community 256"
Cohesion: 0.1
Nodes (25): AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS, findLinearStateByName() (+17 more)
...
Cohesion: 0.08
Nodes (22): ensureDefaultConversationModel(), Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData() (+14 more)

### Community 259 - "Community 259"
Cohesion: 0.16
Nodes (25): listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), getAttachmentCache() (+17 more)
...
Cohesion: 0.14
Nodes (11): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+3 more)

### Community 277 - "Community 277"
Cohesion: 0.11
Nodes (15): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv() (+7 more)
...
Cohesion: 0.08
Nodes (22): CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health, healths (+14 more)

### Community 288 - "Community 288"
Cohesion: 0.15
Nodes (24): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+16 more)

### Community 289 - "Community 289"
Cohesion: 0.13
Nodes (19): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+11 more)
...
Cohesion: 0.1
Nodes (17): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+9 more)

### Community 305 - "Community 305"
Cohesion: 0.1
Nodes (15): getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller, websocketRpcRouteLayer, watchConversation(), EditorLaunch (+7 more)

### Community 306 - "Community 306"
Cohesion: 0.11
Nodes (20): ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitDashboardLifecycle(), EmitDetailedOptions, EmitTtsOptions, normalizeForSpeech() (+12 more)

### Community 307 - "Community 307"
Cohesion: 0.08
Nodes (23): Beads Enforcement, Claude Code Channels (experimental), Commit and Push When Working on Main, CRITICAL: Deep-Wipe Destroys Everything — NEVER Run Without Explicit User Confirmation, CRITICAL: Deliver Complete Features — No Partial Implementations, CRITICAL: JSONL Session Files Are Sacred — NEVER Delete, CRITICAL: Never Do Agent Work — Fix the System, CRITICAL: Never Work Around Broken Things — Fix Them (+15 more)
...
Cohesion: 0.11
Nodes (15): fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress(), ReopenOptions (+7 more)
...
Cohesion: 0.1
Nodes (20): wipeCommand(), buildResult(), cancelIssueWorkflow(), close(), deepWipe(), destructiveResetWorkflow(), resetToTodo(), archiveIdx (+12 more)
...
Cohesion: 0.14
Nodes (18): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), rotateSpecialistSession() (+10 more)
...
Cohesion: 0.1
Nodes (20): About the Name, code:block1 (┌───────────────────────────────────────────────────────────), code:block2 (┌───────────────────────────────────────────────────────────), Core Concept, Core Insight, ⚠️ DECOUPLING FROM MYN (CRITICAL), DO NOT rely on MYN infrastructure:, Executive Summary (+12 more)
...
Cohesion: 0.1
Nodes (20): Acceptance Criteria taxonomy (directive), Code Review: Requirements Coverage, code:bash (gh issue view <ISSUE_ID> --json title,body,labels), code:bash (gh pr view <PR_URL> --json body,title), code:bash (gh pr diff <PR_URL> --name-only 2>/dev/null || git diff --na), code:markdown (# Requirements Coverage Review - <timestamp>), Consolidate, Important Guidelines (+12 more)
...
Cohesion: 0.16
Nodes (18): Role, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherAgentType, LauncherConfig (+10 more)

### Community 381 - "Community 381"
Cohesion: 0.15
Nodes (14): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+6 more)
...
Cohesion: 0.1
Nodes (18): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+10 more)
...
Cohesion: 0.23
Nodes (17): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+9 more)
...
Cohesion: 0.22
Nodes (17): closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect(), closeRallyDirect(), closeViaDirect(), closeViaTracker(), execAsync (+9 more)

### Community 401 - "Community 401"
Cohesion: 0.12
Nodes (16): AvailableModel, AvailableModelsResponse, fetchAvailableModels(), fetchSettings(), PROVIDER_LABELS, providerForModel(), providerWarning(), saveWorkhorse() (+8 more)

### Community 402 - "Community 402"
Cohesion: 0.13
Nodes (16): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getCodexReauthStatusRoute, getExistingLiveReauthSession(), getLiveReauthSession(), hasExistingLiveReauthSession() (+8 more)
...
Cohesion: 0.11
Nodes (17): 1. Read the context manifest first, 2. Spawn convoy reviewers, 3. Wait for convoy output files, 4. Read available reviewer reports, 5. Synthesize the verdict, 6. Write the synthesis report, 7. Signal review status, Boundaries (+9 more)
...
Cohesion: 0.18
Nodes (15): getCheckpointDir(), getCheckpointPath(), getLastCheckpoint(), InspectCheckpoint, InspectCheckpointFile, loadCheckpoints(), PANOPTICON_HOME, saveCheckpoint() (+7 more)

### Community 433 - "Community 433"
Cohesion: 0.29
Nodes (15): healthCommand(), HealthOptions, AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile(), handleStuckAgent() (+7 more)

### Community 435 - "Community 435"
Cohesion: 0.15
Nodes (14): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel (+6 more)
...
Cohesion: 0.12
Nodes (16): Code Review: Synthesis, code:block1 (# Verdict: APPROVED), code:markdown (# Verdict: CHANGES_REQUESTED), code:json ({), code:block4 (REVIEW_RESULT: APPROVED), Cross-referencing, Deduplication, Output: `synthesis.json` (+8 more)
...
Cohesion: 0.12
Nodes (13): after, afterItem, afterSub, before, completedTime, doc, item, planPath (+5 more)
...
Cohesion: 0.13
Nodes (11): createCall, dbError, deleteCalls, doc, existingBeads, expectedPrefix, initCall, metadata (+3 more)
...
Cohesion: 0.16
Nodes (12): build, cliPromptsDir, copyCavemanAssets(), copyCloisterPrompts(), copyMatching(), copyPrompts, dashboardDir, distDir (+4 more)
...
Cohesion: 0.15
Nodes (12): agentDir, mockDispatchParallelReview, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSessionExists (+4 more)
...
Cohesion: 0.26
Nodes (12): generateFallbackSummary(), activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings(), isCompacting() (+4 more)

### Community 553 - "Community 553"
Cohesion: 0.17
Nodes (13): Auto (non-interactive), Auto-Start (skip planning), code:bash (pan plan <id>), code:bash (pan plan <id> --auto), code:bash (pan start <id> --auto), code:typescript (// Correct (in sendKeysAsync):), code:block7 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), code:block8 (**PRD:** [`path/to/prd.md`](https link to the file in the re) (+5 more)
...
Cohesion: 0.15
Nodes (12): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+4 more)
...
Cohesion: 0.17
Nodes (11): 1. Role file — `roles/*.md`, 2. Panopticon pipeline agent — `agents/pan-*-agent.md`, 3. Claude Code subagent — `.claude/agents/*.md`, Adding a new role or sub-role, code:block1 (Cloister decides to spawn (role, subRole?)), File shapes you will see, How a run actually gets the right instructions, Roles: Panopticon's Agent Definition Primitive (+3 more)
...
Cohesion: 0.2
Nodes (10): cleanupGitignore(), cleanupWorkspaceGitignore(), content, gitignorePath, headerMatches, newContent, result, skills (+2 more)
...
Cohesion: 0.25
Nodes (8): buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, checkForUpdates(), onUpdateStatusChange(), quitAndInstall()
...
Cohesion: 0.29
Nodes (9): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+1 more)
...
Cohesion: 0.18
Nodes (11): code:bash (pan plan PAN-1071), code:bash (pan plan finalize), code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Finalizing (`pan plan finalize`), Planning Workflow, Starting planning, Step 1: Start Planning Session (+3 more)
...
Cohesion: 0.18
Nodes (10): Boundaries, code:bash (npm run typecheck), Hardcoding it here would override the user's config and force everyone onto a, Human-Merge Invariant, Inputs, No `model:` pin — Cloister resolves the model from config.yaml (roles.ship.model)., Panopticon Ship Role, Shipping Workflow (+2 more)
...
Cohesion: 0.2
Nodes (9): kCustom, mockExec, mockExecAsync, mockExecResult, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile (+1 more)
...
Cohesion: 0.22
Nodes (8): Code Review: Performance, code:markdown (# Performance Review - <timestamp>), Inputs from your spawn prompt, Method, Output format, Scope, Severity and evidence, Write contract

### Community 765 - "Community 765"
Cohesion: 0.22
Nodes (8): Code Review: Security, code:markdown (# Security Review - <timestamp>), Inputs from your spawn prompt, Method, Output format, Scope, Severity and evidence, Write contract

### Community 766 - "Community 766"
Cohesion: 0.22
Nodes (8): Code Review: Correctness, code:markdown (# Correctness Review - <timestamp>), Inputs from your spawn prompt, Method, Output format, Scope, Severity and evidence, Write contract

### Community 767 - "Community 767"
Cohesion: 0.22
Nodes (8): Code Review: Requirements Coverage, code:markdown (# Requirements Coverage Review - <timestamp>), Inputs from your spawn prompt, Method, Output format, Scope, Severity and evidence, Write contract

### Community 768 - "Community 768"
Cohesion: 0.22
Nodes (8): Boundaries, Browser UAT Contract, Hardcoding it here would override the user's config and force everyone onto a, Inputs, No `model:` pin — Cloister resolves the model from config.yaml (roles.test.model)., Panopticon Test Role, single model, defeating the per-role model configurability the dashboard exposes., Verification Workflow

### Community 769 - "Community 769"
Cohesion: 0.22
Nodes (8): Boundaries, Hardcoding it here would override the user's config and force everyone onto a, No `model:` pin — Cloister resolves the model from config.yaml (roles.plan.model)., Outputs, Panopticon Planning Agent, Process, single model, defeating the per-role model configurability the dashboard exposes., State model
...
Cohesion: 0.43
Nodes (7): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09 (late), Flywheel State Snapshot, Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.43
Nodes (5): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result
...
Cohesion: 0.29
Nodes (4): body, content, { frontmatter, body }, inspectAgentSource
...
Cohesion: 0.29
Nodes (7): Auto-Behaviors, Continue State, Dashboard Viewer, Legacy paths, Lifecycle Directories, The five-artifact model (PAN-967 + PAN-946), vBRIEF Plans & Lifecycle
...
## Knowledge Gaps
- **11887 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11882 more)
...
- **Why does `fetch` connect `Community 2` to `Community 1`, `Community 130`, `Community 773`, `Community 7`, `Community 9`, `Community 10`, `Community 140`, `Community 14`, `Community 142`, `Community 401`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 280`, `Community 25`, `Community 29`, `Community 158`, `Community 159`, `Community 30`, `Community 35`, `Community 551`, `Community 40`, `Community 43`, `Community 45`, `Community 49`, `Community 50`, `Community 54`, `Community 58`, `Community 59`, `Community 187`, `Community 577`, `Community 67`, `Community 84`, `Community 610`, `Community 611`, `Community 100`, `Community 101`, `Community 102`, `Community 110`, `Community 111`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 152` to `Community 0`, `Community 9`, `Community 157`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 43` to `Community 1040`, `Community 549`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Are the 166 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 166 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11887 weakly-connected nodes found - possible documentation gaps or missing edges._
