...
## Corpus Check
- 1746 files · ~2,321,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23808 nodes · 36381 edges · 1200 communities (1153 shown, 47 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b252b9b0`
...
## Communities (1200 total, 47 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (170): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+162 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (120): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+112 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (149): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+141 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (120): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+112 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (104): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+96 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (121): spawnInspectAgent(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), ActivityEntry, AGENT_PREFIXES, AgentLaunchConfig (+113 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (112): cleanupStaleAgentState(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+104 more)
...
Cohesion: 0.03
Nodes (85): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+77 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (72): checkCostLimits(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext (+64 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (96): autoResumeStoppedWorkAgents(), notifyAgentStatusChanged(), recoverOrphanedAgentsOnce(), getNoResumeMode(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, resumeCommand(), AgentRuntimeState (+88 more)
...
Cohesion: 0.02
Nodes (89): ActivityView(), ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps (+81 more)
...
Cohesion: 0.03
Nodes (88): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), DEFAULTS (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): EDITOR_LABELS, PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed() (+64 more)
...
Cohesion: 0.04
Nodes (68): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc (+60 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (84): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), completePendingOperation(), ContainerPortBinding, ContainerServiceHealth (+76 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (85): embedAction(), ScanOptions, normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+77 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (72): buildHandoffPrompt(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (76): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+68 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (81): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (74): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), findSpecByIssueAsync(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocument() (+66 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (65): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationViewProps (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (82): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (83): estimateCost(), defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig (+75 more)
...
Cohesion: 0.04
Nodes (77): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+69 more)
...
Cohesion: 0.04
Nodes (61): cn(), PhaseGlyph(), PhaseGlyphPhase, PhaseGlyphProps, renderGlyph(), glyph, glyphPhaseForHeader(), PhaseHeader() (+53 more)
...
Cohesion: 0.05
Nodes (65): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+57 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (66): generateFallbackSummary(), canReplaceTitle(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode() (+58 more)
...
Cohesion: 0.06
Nodes (59): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+51 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (60): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), patchConversationTitle() (+52 more)
...
Cohesion: 0.05
Nodes (51): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt() (+43 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (57): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+49 more)
...
Cohesion: 0.06
Nodes (48): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), buildActiveSliceContext() (+40 more)
...
Cohesion: 0.07
Nodes (22): issues, result, importTrackerConfig(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+14 more)
...
Cohesion: 0.06
Nodes (44): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+36 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (47): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+39 more)
...
Cohesion: 0.04
Nodes (43): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, conversationsRouteLayer, authorized(), eventsRouteLayer, getEventStreamRoute, getEventVersionRoute (+35 more)
...
Cohesion: 0.07
Nodes (41): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+33 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (42): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), HandoffConfig (+34 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (40): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+32 more)
...
Cohesion: 0.12
Nodes (42): extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result (+34 more)
...
Cohesion: 0.05
Nodes (42): cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute, postCloisterResumeSpawnsRoute, postCloisterStartRoute (+34 more)
...
Cohesion: 0.09
Nodes (44): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+36 more)

### Community 93 - "Community 93"
Cohesion: 0.04
Nodes (45): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+37 more)
...
Cohesion: 0.09
Nodes (36): doCommit(), execAsync, flush(), flushAutoCommits(), FlushResult, pending, queueAutoCommit(), QueuedCommit (+28 more)
...
Cohesion: 0.09
Nodes (33): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), NormalizedTtsDaemonConfig, StoredEvent, ActivityTtsPayload, drainQueue() (+25 more)
...
Cohesion: 0.15
Nodes (36): postMergeLifecycle(), archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir (+28 more)
...
Cohesion: 0.07
Nodes (27): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, VERDICT_COLOR, VERDICT_LABEL, fmtCost() (+19 more)
...
Cohesion: 0.1
Nodes (30): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, AgentAlreadyRunning, AgentStartError (+22 more)
...
Cohesion: 0.09
Nodes (30): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, ConversationsConfig (+22 more)
...
Cohesion: 0.1
Nodes (25): beadsDir, doc, AcceptanceCriterion, createBeadsFromVBrief(), deriveProjectPrefix(), execAsync, execFileAsync, getVBriefACStatus() (+17 more)
...
Cohesion: 0.09
Nodes (27): ConversationPanel(), updateConversationTitle(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), useNow(), AGENT_TOOLS (+19 more)
...
Cohesion: 0.1
Nodes (24): scanForConflictMarkers(), err, exec(), execFile(), execMock, kCustom, prompt, spawnRunMock (+16 more)
...
Cohesion: 0.1
Nodes (23): wipeCommand(), WipeOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), deepWipe() (+15 more)
...
Cohesion: 0.08
Nodes (23): content, createTestDb(), db, event, goodLine, history, ids, latest (+15 more)
...
Cohesion: 0.14
Nodes (16): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+8 more)

### Community 395 - "Community 395"
Cohesion: 0.12
Nodes (11): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller (+3 more)
...
Cohesion: 0.19
Nodes (16): checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost(), getCostSummary() (+8 more)
...
Cohesion: 0.12
Nodes (12): inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), WorkAgentPromptContext, bdReadyLines, template, templatePath, mockGetIssue (+4 more)
...
Cohesion: 0.18
Nodes (14): ForgeType, getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), resolveProjectReposFromResolvedIssue() (+6 more)
...
Cohesion: 0.19
Nodes (13): DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings(), loadVoiceSettings(), normalizeVoiceSettings(), putVoiceSettingsRoute, readJsonBody, requireTrustedOrigin() (+5 more)
...
Cohesion: 0.21
Nodes (10): execAsync, pending, withBdMutex(), withWorkspaceBdMutex(), execAsync, restoreTrackedBeadsExport(), after, before (+2 more)
...
Cohesion: 0.24
Nodes (9): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, resolveBundledServerPath() (+1 more)
...
## Knowledge Gaps
- **12411 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12406 more)
...
- **Why does `fetch` connect `Community 0` to `Community 640`, `Community 1`, `Community 3`, `Community 134`, `Community 7`, `Community 9`, `Community 137`, `Community 524`, `Community 13`, `Community 14`, `Community 15`, `Community 144`, `Community 17`, `Community 18`, `Community 12`, `Community 20`, `Community 22`, `Community 27`, `Community 30`, `Community 415`, `Community 800`, `Community 36`, `Community 38`, `Community 294`, `Community 296`, `Community 681`, `Community 684`, `Community 172`, `Community 47`, `Community 48`, `Community 49`, `Community 176`, `Community 303`, `Community 53`, `Community 568`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 198`, `Community 202`, `Community 592`, `Community 80`, `Community 212`, `Community 597`, `Community 97`, `Community 115`, `Community 1015`, `Community 120`, `Community 121`, `Community 379`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 134` to `Community 0`, `Community 66`, `Community 2`, `Community 5`, `Community 6`, `Community 69`, `Community 8`, `Community 72`, `Community 682`, `Community 79`, `Community 47`, `Community 147`, `Community 52`, `Community 21`, `Community 23`, `Community 26`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 863` to `Community 11`, `Community 93`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12411 weakly-connected nodes found - possible documentation gaps or missing edges._
