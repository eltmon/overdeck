...
## Corpus Check
- 1542 files · ~2,037,567 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21769 nodes · 32332 edges · 1138 communities (1103 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 435 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af820e42`
...
## Communities (1138 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (146): checkFailedMergeRetry(), clearStaleCiFeedback(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+138 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (140): buildReviewBaseCommand(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), initializeSpecialist(), killCommand(), KillOptions (+132 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (119): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA() (+111 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (118): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+110 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (134): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFirstCompletionAgents() (+126 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (122): checkApiErrorAgents(), checkOrphanedReviewStatuses(), checkStuckReviewing(), renderPrompt(), getActiveParallelReviewIssues(), finalizeRunLog(), buildProviderExportLines(), buildTaskPrompt() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (102): ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS, resumeConversation() (+94 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (119): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+111 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (85): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (104): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+96 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (80): format(), LiveCounter(), LiveCounterProps, PlanningState, ZoneAActionsState, state, PanOpenInPicker(), AgentCard() (+72 more)
...
Cohesion: 0.02
Nodes (78): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+70 more)
...
Cohesion: 0.04
Nodes (81): checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), pendingCommand(), after, before, blockers (+73 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (80): stampPlanForFinalization(), restoreCommand(), showCommand(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), next, path (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (81): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (73): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+65 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (61): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentGrid() (+53 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (67): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+59 more)
...
Cohesion: 0.04
Nodes (68): ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle(), EmitDetailedOptions (+60 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (66): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (69): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+61 more)
...
Cohesion: 0.08
Nodes (68): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (60): CopyConfigOptions, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+52 more)
...
Cohesion: 0.05
Nodes (52): doc, path, after, doc, filename, path, criticalPath(), WaveItem (+44 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (64): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+56 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (60): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+52 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (60): MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getCachedFavoritedIds(), getClientIp(), getConversationDiffFullRoute (+52 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (60): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt(), cleanupLegacySpecialistsDirectory() (+52 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (58): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+50 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (54): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+46 more)
...
Cohesion: 0.04
Nodes (47): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+39 more)
...
Cohesion: 0.05
Nodes (54): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), doProbe(), formatProbeError() (+46 more)
...
Cohesion: 0.05
Nodes (53): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig() (+45 more)
...
Cohesion: 0.05
Nodes (47): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+39 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (46): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, computePlanningState(), beadsDir, doc, createBeadsFromVBrief(), CreateBeadsResult (+38 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (47): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+39 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (42): config, originalEnv, tracker, TrackerConfig, error, mockComment, mockComments, mockIssue (+34 more)
...
Cohesion: 0.06
Nodes (37): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime() (+29 more)
...
Cohesion: 0.07
Nodes (39): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+31 more)
...
Cohesion: 0.07
Nodes (43): ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData(), fetchActivityDataWithContext() (+35 more)
...
Cohesion: 0.06
Nodes (39): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+31 more)
...
Cohesion: 0.06
Nodes (27): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+19 more)
...
Cohesion: 0.08
Nodes (18): issues, result, importTrackerConfig(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache (+10 more)

### Community 76 - "Community 76"
Cohesion: 0.08
Nodes (41): closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+33 more)
...
Cohesion: 0.06
Nodes (37): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+29 more)
...
Cohesion: 0.06
Nodes (32): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), selectAllModels() (+24 more)
...
Cohesion: 0.07
Nodes (30): useLiveFlash(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem() (+22 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (35): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+27 more)
...
Cohesion: 0.09
Nodes (35): ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence(), isoForStash() (+27 more)

### Community 130 - "Community 130"
Cohesion: 0.11
Nodes (34): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+26 more)

### Community 131 - "Community 131"
Cohesion: 0.1
Nodes (30): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+22 more)
...
Cohesion: 0.08
Nodes (26): ModelSelectionResult, getDebugInfo(), getGlobalRouter(), getModel(), getModelId(), hasOverride(), ModelResolutionResult, reloadGlobalRouter() (+18 more)
...
Cohesion: 0.1
Nodes (30): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+22 more)
...
Cohesion: 0.1
Nodes (34): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem (+26 more)
...
Cohesion: 0.11
Nodes (30): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+22 more)
...
Cohesion: 0.07
Nodes (20): getSharedDb(), StoredEvent, getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, AgentStateService, AgentStateServiceLive (+12 more)
...
Cohesion: 0.09
Nodes (22): ComposerMode, IssueComposer(), IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, RestartResult, StoppedAgentsBanner(), retryPendingSpawn() (+14 more)
...
Cohesion: 0.11
Nodes (21): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+13 more)
...
Cohesion: 0.1
Nodes (12): getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+4 more)
...
Cohesion: 0.14
Nodes (27): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+19 more)
...
Cohesion: 0.09
Nodes (18): pickBestSession(), sessionMatchesFilter(), caret, fetchMock, onCleanupOrphanedResources, onSelect, onSelectSession, placeholder (+10 more)
...
Cohesion: 0.15
Nodes (25): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+17 more)
...
Cohesion: 0.13
Nodes (18): createRemoteWorkspace(), CreateRemoteWorkspaceOptions, execAsync, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider() (+10 more)
...
Cohesion: 0.12
Nodes (19): ChatMessage, CompactBoundary, ConversationEvent, WorkLogEntry, computeMessageDurationStart(), deriveMessagesTimelineRows(), deriveTimelineEntries(), EstimateHeightInput (+11 more)
...
Cohesion: 0.14
Nodes (16): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+8 more)
...
Cohesion: 0.17
Nodes (11): saveConfig(), execAsync, initCommand(), InitOptions, resourcesCommand(), ResourcesOptions, VmResources, execAsync (+3 more)
...
Cohesion: 0.26
Nodes (14): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath() (+6 more)
...
Cohesion: 0.19
Nodes (14): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectInitCommand(), projectListCommand() (+6 more)
...
Cohesion: 0.36
Nodes (8): fetchIssueWithComments(), findLocalWorkspace(), formatComments(), LinearComment, reopenCommand(), ReopenOptions, transitionToInProgress(), reopenWorkspaceState()
...
Cohesion: 0.6
Nodes (5): cleanupAllLogs(), cleanupOldLogs(), listProjectsWithSpecialists(), getSpecialistRetention(), cleanupLogsCommand()
...
Cohesion: 0.4
Nodes (4): ProposedPlan, PlanCard(), PlanCardProps, sendPlanAction()
...
## Knowledge Gaps
- **11591 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11586 more)
...
- **Why does `fetch` connect `Community 3` to `Community 2`, `Community 132`, `Community 133`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 526`, `Community 525`, `Community 275`, `Community 147`, `Community 22`, `Community 23`, `Community 282`, `Community 29`, `Community 418`, `Community 36`, `Community 37`, `Community 39`, `Community 808`, `Community 169`, `Community 42`, `Community 47`, `Community 52`, `Community 181`, `Community 182`, `Community 196`, `Community 966`, `Community 75`, `Community 588`, `Community 80`, `Community 81`, `Community 87`, `Community 216`, `Community 217`, `Community 745`, `Community 111`, `Community 241`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 128` to `Community 1`, `Community 12`, `Community 57`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 29` to `Community 130`, `Community 194`, `Community 552`, `Community 12`, `Community 46`, `Community 271`, `Community 16`, `Community 374`, `Community 24`, `Community 217`, `Community 158`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11591 weakly-connected nodes found - possible documentation gaps or missing edges._
