...
## Corpus Check
- 1923 files · ~3,148,811 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27497 nodes · 43147 edges · 1331 communities (1274 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `401b958c`
...
1. `string()` - 241 edges
2. `fetch` - 201 edges
3. `resolveProjectFromIssueSync()` - 126 edges
...
- `pathExists()` --calls--> `Access`  [INFERRED]
  src/dashboard/server/routes/projects.ts → docs/god-view.md

## Communities (1331 total, 57 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (159): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf, catchTag$1 (+151 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (175): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+167 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (156): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, conversationsTab, firstLens, lens (+148 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (135): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+127 more)
...
Cohesion: 0.04
Nodes (144): spawnInspectAgentPromise(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), reactivateConversationForSpawn(), ActivityEntry, AGENT_PREFIXES (+136 more)
...
Cohesion: 0.03
Nodes (117): captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (124): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+116 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (100): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+92 more)
...
Cohesion: 0.02
Nodes (94): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+86 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (83): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+75 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (100): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+92 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (82): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (75): parsePiSessionSync(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync(), SessionIndexEntry, getGlobalRegistry() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (80): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (92): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+84 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (91): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename, getConflictFiles() (+83 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (98): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+90 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (59): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), performHandoff(), activeRoleRunExists() (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (91): agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS, legacyFields (+83 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (86): getTtsDaemonAuthHeaders(), TtsDaemonStatus, buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+78 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (76): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+68 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (77): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+69 more)
...
Cohesion: 0.04
Nodes (62): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+54 more)
...
Cohesion: 0.03
Nodes (74): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+66 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (66): AgentState, __testInternals, agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), createAgentStopHandler() (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (58): fsHooks, path, paths, after, doc, filename, path, getPackageVersion() (+50 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (67): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+59 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (82): add, addCommentBefore(), addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), applyReviver() (+74 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (67): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+59 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (62): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl() (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (60): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), doneCommand(), DoneOptions, execAsync (+52 more)
...
Cohesion: 0.04
Nodes (62): PlanningState, ZoneAActionsState, VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, ActionKey, ActionLayout, derivePipelineState() (+54 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (62): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, checkPlanStatus(), readWorkspacePlanAsync(), resolvePlanLocation() (+54 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (61): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (60): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailedSync(), AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), withConcurrencyLimit(), Handler (+52 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (59): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+51 more)
...
Cohesion: 0.04
Nodes (59): CodexAuthBanner(), DiffPanel(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), useDiffPreferences() (+51 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (63): getTrackerContext(), projectListCommand(), projectShowCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments() (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (46): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+38 more)
...
Cohesion: 0.04
Nodes (58): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+50 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (60): writeObservationRecord(), writeStatus(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), ensureParentDir(), resolveArchiveDir() (+52 more)
...
Cohesion: 0.04
Nodes (42): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, MODEL_DEPRECATIONS, ModelCapability, SkillDimension (+34 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (54): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContextError, serializeHandoffContext() (+46 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (55): embedAction(), normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), aggregateDiscoveredSessionCost() (+47 more)
...
Cohesion: 0.04
Nodes (53): listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), ConversationAboutSummary (+45 more)
...
Cohesion: 0.06
Nodes (55): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+47 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (26): importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+18 more)
...
Cohesion: 0.06
Nodes (49): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+41 more)
...
Cohesion: 0.05
Nodes (42): queryCostEvents(), getPanopticonHome(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+34 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (43): rebuildCacheSync(), appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir() (+35 more)
...
Cohesion: 0.06
Nodes (46): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+38 more)
...
Cohesion: 0.05
Nodes (44): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+36 more)
...
Cohesion: 0.05
Nodes (44): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+36 more)
...
Cohesion: 0.07
Nodes (43): updateCommand(), buildManifestFromDirectory(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFileSync(), Manifest (+35 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (45): buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoffPromise() (+37 more)
...
Cohesion: 0.05
Nodes (43): criteria, doc, result, createCall, createCalls, dbError, deleteCalls, doc (+35 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (38): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+30 more)
...
Cohesion: 0.05
Nodes (42): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatusSync(), hasLegacySettingsSync(), LEGACY_SETTINGS_PATH (+34 more)
...
Cohesion: 0.08
Nodes (40): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+32 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (41): clearFeedbackFilesPromise(), FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+33 more)
...
Cohesion: 0.06
Nodes (42): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+34 more)
...
Cohesion: 0.05
Nodes (41): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus (+33 more)
...
Cohesion: 0.09
Nodes (39): createTracker(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker (+31 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (36): archivePlanning(), CloseIssueOptions, ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult (+28 more)
...
Cohesion: 0.07
Nodes (43): registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+35 more)
...
Cohesion: 0.05
Nodes (41): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+33 more)
...
Cohesion: 0.06
Nodes (41): scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+33 more)
...
Cohesion: 0.11
Nodes (46): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+38 more)

### Community 109 - "Community 109"
Cohesion: 0.07
Nodes (39): appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogsSync(), cleanupOldLogsSync(), createRunLogSync(), ensureRunsDirectory(), finalizeRunLogSync(), generateRunId() (+31 more)
...
Cohesion: 0.07
Nodes (41): evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb() (+33 more)
...
Cohesion: 0.06
Nodes (35): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+27 more)

### Community 120 - "Community 120"
Cohesion: 0.05
Nodes (32): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+24 more)
...
Cohesion: 0.06
Nodes (40): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), autoRevertMergePromise(), DEFAULT_GATES, execAsync (+32 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (37): deleteHumeConfig(), content, d, existingDir, lines, oldDir, result, skillDir (+29 more)

### Community 127 - "Community 127"
Cohesion: 0.06
Nodes (39): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+31 more)
...
Cohesion: 0.09
Nodes (42): flywheelAbortCommand(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata() (+34 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (41): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+33 more)
...
Cohesion: 0.07
Nodes (39): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+31 more)
...
Cohesion: 0.08
Nodes (36): InlineSparkline(), InlineSparklineProps, ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory(), activityToStatus(), capitalize() (+28 more)

### Community 138 - "Community 138"
Cohesion: 0.07
Nodes (36): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), createSummaryFork(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel() (+28 more)
...
Cohesion: 0.07
Nodes (39): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+31 more)
...
Cohesion: 0.07
Nodes (28): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+20 more)

### Community 152 - "Community 152"
Cohesion: 0.08
Nodes (34): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+26 more)

### Community 153 - "Community 153"
Cohesion: 0.09
Nodes (32): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+24 more)
...
Cohesion: 0.08
Nodes (39): EnqueueStatusRollup, findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup(), pendingTurnFileName(), pendingTurnRangeKey(), readPendingTurns() (+31 more)
...
Cohesion: 0.08
Nodes (35): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, autopresoRouteLayer, backToStagingRoute (+27 more)
...
Cohesion: 0.07
Nodes (27): recordAutoCloseOutFailure(), announceMerge(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), ActivityLevel (+19 more)

### Community 163 - "Community 163"
Cohesion: 0.09
Nodes (34): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, resolveAndSpeak(), speakTts(), StoredEvent, ActivityTtsPayload (+26 more)
...
Cohesion: 0.06
Nodes (36): getAgentRollup(), getCavemanExperimentData(), getCostForIssueFromDb(), getCostsByIssueFromDb(), getDailyTrends(), getModelBreakdownForIssue(), getModelRollup(), getStageBreakdownForIssue() (+28 more)
...
Cohesion: 0.09
Nodes (30): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync() (+22 more)
...
Cohesion: 0.08
Nodes (32): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+24 more)

### Community 179 - "Community 179"
Cohesion: 0.09
Nodes (33): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+25 more)
...
Cohesion: 0.07
Nodes (29): confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, ConversationFilter, findDiscoveredSessionIds(), createConfiguredClaudeApi() (+21 more)
...
Cohesion: 0.06
Nodes (36): getConversationsConfig(), getConversationsConfigSync(), resolveConversationWatchDirs(), updateConversationsConfig(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema (+28 more)

### Community 197 - "Community 197"
Cohesion: 0.07
Nodes (23): TranscriptCheckpoint, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), syncTranscriptPollerRegistry() (+15 more)
...
Cohesion: 0.08
Nodes (24): saveConfigSync(), execAsync, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType (+16 more)
...
Cohesion: 0.08
Nodes (20): DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell() (+12 more)
...
Cohesion: 0.12
Nodes (34): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise() (+26 more)

### Community 209 - "Community 209"
Cohesion: 0.07
Nodes (32): cleanupOldHealthEvents(), DatabaseError, deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent(), getRecentHealthHistory() (+24 more)
...
Cohesion: 0.06
Nodes (34): Activity, AgentChannelReply, AgentId, AgentStatus, CHANNEL_REPLY_KIND_VALUES, ChannelReplyArtifactRef, ChannelReplyKind, ClaudeChannelPermissionBehavior (+26 more)
...
Cohesion: 0.08
Nodes (33): anchorNames(), array, combine, compareArrays(), compareBoth(), compareRecords(), createAlias(), equals() (+25 more)
...
Cohesion: 0.07
Nodes (21): ActivitySection, formatModel(), IsolationMode(), IsolationModeProps, TYPE_STYLES, ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS (+13 more)
...
Cohesion: 0.07
Nodes (22): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), claudeProjectDir (+14 more)
...
Cohesion: 0.09
Nodes (31): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchPlanningData() (+23 more)
...
Cohesion: 0.09
Nodes (26): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions (+18 more)
...
Cohesion: 0.1
Nodes (26): CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript() (+18 more)
...
Cohesion: 0.09
Nodes (23): ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchHit, MemorySearchRow, normalizeLimit() (+15 more)

### Community 265 - "Community 265"
Cohesion: 0.09
Nodes (27): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+19 more)
...
Cohesion: 0.1
Nodes (5): getProjectDirsSync(), getSessionFilesSync(), parseClaudeSessionSync(), ClaudeCodeRuntime, ClaudeCodeRuntimeSync
...
Cohesion: 0.1
Nodes (26): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+18 more)
...
Cohesion: 0.09
Nodes (23): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact(), CreateReviewArtifactInput, CreateReviewArtifactResult (+15 more)
...
Cohesion: 0.12
Nodes (22): ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+14 more)
...
Cohesion: 0.1
Nodes (17): after, before, cfg, compose, ph, result, createWorkspacePlaceholdersSync(), DevcontainerRenderOptions (+9 more)
...
Cohesion: 0.08
Nodes (21): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, searchFts(), enrichSession() (+13 more)

### Community 307 - "Community 307"
Cohesion: 0.15
Nodes (26): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), hasPRDDraft(), hasPRDDraftPromise(), listPRDDrafts() (+18 more)
...
Cohesion: 0.12
Nodes (23): generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+15 more)

### Community 310 - "Community 310"
Cohesion: 0.11
Nodes (23): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex(), isRecentPromptIndex() (+15 more)
...
Cohesion: 0.16
Nodes (19): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+11 more)

### Community 345 - "Community 345"
Cohesion: 0.12
Nodes (18): beadsDir, doc, syncBeadStatusToVBrief(), BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChanges(), checkUncommittedChangesPromise() (+10 more)
...
Cohesion: 0.11
Nodes (19): writeFeedbackFile(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult (+11 more)

### Community 356 - "Community 356"
Cohesion: 0.11
Nodes (20): parseWalFile(), SyncResult, syncWalFromAllProjectsPromise(), syncWalFromDirPromise(), AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey() (+12 more)
...
Cohesion: 0.13
Nodes (18): getForgeAdapter(), {
  execMock,
  getPullRequestStateMock,
  isGitHubAppConfiguredMock,
  mergePullRequestWithAppMock,
  parsePullRequestRefMock,
}, kCustom, mergePromise, ensureMergeSetForIssueSync(), upsertMergeSetSync(), withRepoArtifactUrlSync(), withRepoStateSync() (+10 more)

### Community 404 - "Community 404"
Cohesion: 0.13
Nodes (16): dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next (+8 more)
...
Cohesion: 0.16
Nodes (17): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), EnrichmentApiConfig (+9 more)
...
Cohesion: 0.13
Nodes (18): assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue(), queryBeadsForIssuePromise() (+10 more)
...
Cohesion: 0.13
Nodes (14): STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize, StatusDotStatus, fmtCost() (+6 more)
...
Cohesion: 0.14
Nodes (16): AgentHealth, checkAllTriggersPromise(), checkStuckEscalation(), checkTaskCompletion(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache (+8 more)
...
Cohesion: 0.15
Nodes (11): resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps, cards (+3 more)

### Community 506 - "Community 506"
Cohesion: 0.17
Nodes (15): buildCorrelationMapSync(), CorrelationResult, sessionFilePath(), buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions, ConvertResult (+7 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, code:bash (# Stop all Panopticon services), code:bash (# Method 1: Separate commands), code:bash (# Monitor in one terminal), code:bash (# Clean up stale resources), Monitoring Shutdown, More Information, Next Steps (+8 more)
...
Cohesion: 0.16
Nodes (12): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), SYNC_SOURCES, deletedDir, path (+4 more)
...
Cohesion: 0.15
Nodes (4): collectMailSync(), getHookDir(), getMailDir(), Hook
...
Cohesion: 0.23
Nodes (13): DatabaseError, getSetting(), getSettingProgram(), isDeaconGloballyPaused(), isFlywheelGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId(), setFlywheelGloballyPaused() (+5 more)
...
Cohesion: 0.35
Nodes (12): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHookSync(), clearHookSync(), generateFixedPointPromptSync(), getHookFile(), getHookSync() (+4 more)

### Community 654 - "Community 654"
Cohesion: 0.28
Nodes (9): getHealthEmoji(), getHealthLabel(), getCloisterService(), startCommand(), statusCommand(), StatusOptions, stopCommand(), StopOptions (+1 more)
...
Cohesion: 0.17
Nodes (6): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule
...
Cohesion: 0.2
Nodes (9): authorized(), eventsRouteLayer, getEventStreamRoute, getEventVersionRoute, getHeader(), isPublicEventType(), matchesFilter(), PUBLIC_CATALOG (+1 more)
...
Cohesion: 0.2
Nodes (10): code:bash (# If project has override skill, this skill is permanently d), code:javascript (// Pseudocode for decision), code:bash (mkdir -p .claude/skills/knowledge-capture), code:bash (# Ensure directory exists), Invocation Protocol, Step 0: Check for Permanent Override, Step 2: Respect Cooldowns and Dismissals, Step 3: Present to User (+2 more)
...
Cohesion: 0.36
Nodes (6): editorIconFor(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, getPreferredEditor(), setPreferredEditor()
...
Cohesion: 0.48
Nodes (6): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand()
...
Cohesion: 0.29
Nodes (6): hook, newOrder, originalOrder, reorderedHook, success, TEST_HOOK_FILE
...
Cohesion: 0.29
Nodes (5): fixedNow, resolvedModels, reviewRow, runtimeById, workRow
...
Cohesion: 0.5
Nodes (4): execFile(), kCustom, mockExecFile, isBranchAlreadyRebased()
...
## Knowledge Gaps
- **13599 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13594 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 523`, `Community 12`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 1057`, `Community 34`, `Community 33`, `Community 36`, `Community 37`, `Community 550`, `Community 44`, `Community 45`, `Community 47`, `Community 49`, `Community 52`, `Community 55`, `Community 56`, `Community 59`, `Community 60`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 69`, `Community 72`, `Community 73`, `Community 77`, `Community 79`, `Community 80`, `Community 597`, `Community 85`, `Community 87`, `Community 89`, `Community 607`, `Community 97`, `Community 98`, `Community 103`, `Community 104`, `Community 108`, `Community 109`, `Community 125`, `Community 126`, `Community 129`, `Community 130`, `Community 131`, `Community 646`, `Community 154`, `Community 156`, `Community 162`, `Community 165`, `Community 169`, `Community 1195`, `Community 686`, `Community 687`, `Community 185`, `Community 194`, `Community 208`, `Community 722`, `Community 1239`, `Community 224`, `Community 225`, `Community 240`, `Community 242`, `Community 250`, `Community 288`, `Community 289`, `Community 290`, `Community 301`, `Community 816`, `Community 817`, `Community 309`, `Community 821`, `Community 322`, `Community 342`, `Community 344`, `Community 345`, `Community 349`, `Community 350`, `Community 377`, `Community 899`, `Community 406`, `Community 409`, `Community 433`, `Community 448`, `Community 460`, `Community 464`, `Community 465`, `Community 485`, `Community 499`, `Community 501`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 32` to `Community 96`, `Community 162`, `Community 4`, `Community 6`, `Community 41`, `Community 80`, `Community 17`, `Community 210`, `Community 61`, `Community 25`, `Community 406`, `Community 55`, `Community 345`, `Community 27`, `Community 573`, `Community 30`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 44` to `Community 1`, `Community 2`, `Community 3`, `Community 772`, `Community 6`, `Community 776`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 656`, `Community 16`, `Community 274`, `Community 407`, `Community 24`, `Community 23`, `Community 282`, `Community 157`, `Community 32`, `Community 162`, `Community 35`, `Community 164`, `Community 37`, `Community 169`, `Community 1194`, `Community 1195`, `Community 45`, `Community 46`, `Community 432`, `Community 49`, `Community 48`, `Community 304`, `Community 179`, `Community 59`, `Community 61`, `Community 574`, `Community 448`, `Community 194`, `Community 72`, `Community 79`, `Community 208`, `Community 81`, `Community 722`, `Community 211`, `Community 465`, `Community 85`, `Community 727`, `Community 88`, `Community 90`, `Community 346`, `Community 91`, `Community 605`, `Community 484`, `Community 485`, `Community 229`, `Community 1127`, `Community 360`, `Community 241`, `Community 505`, `Community 250`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Are the 219 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 219 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13599 weakly-connected nodes found - possible documentation gaps or missing edges._
