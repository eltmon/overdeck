...
## Corpus Check
- 1557 files · ~2,064,124 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21712 nodes · 32189 edges · 1140 communities (1102 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 431 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46924e67`
...
## Communities (1140 total, 38 thin omitted)
...
Cohesion: 0.02
Nodes (128): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+120 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (139): readCavemanVariant(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), patrolWorkAgentResolutions(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues() (+131 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (112): firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+104 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (123): nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, HandoffResult, performHandoff() (+115 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (131): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+123 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (127): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), ensureReviewTempStash() (+119 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (87): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, PanOpenInPicker(), RecoverButton(), RecoverButtonProps (+79 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (104): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+96 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (96): checkPostReviewCommits(), getAllSpecialistStatus(), SpecialistStatus, after, before, blockers, result, statuses (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (82): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+74 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (96): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), VerificationRunnerOptions (+88 more)
...
Cohesion: 0.03
Nodes (80): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanel(), ConversationPanelProps (+72 more)
...
Cohesion: 0.03
Nodes (78): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+70 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (77): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+69 more)
...
Cohesion: 0.04
Nodes (72): setAgentStoppedNotifier(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+64 more)
...
Cohesion: 0.03
Nodes (66): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (60): RoundMarker, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE (+52 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (70): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, createHandoffEvent(), ensureLogDir() (+62 more)
...
Cohesion: 0.05
Nodes (68): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions (+60 more)
...
Cohesion: 0.04
Nodes (66): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+58 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (64): listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getCachedFavoritedIds(), getClientIp() (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (63): dismissDevChannelsDialog(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+55 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (59): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+51 more)
...
Cohesion: 0.05
Nodes (51): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+43 more)
...
Cohesion: 0.04
Nodes (58): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+50 more)
...
Cohesion: 0.04
Nodes (53): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+45 more)
...
Cohesion: 0.07
Nodes (52): configShadowCommand(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation() (+44 more)
...
Cohesion: 0.05
Nodes (52): cleanupOrphanedReviewSessions(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, isoForStash(), isOlderThanDays() (+44 more)
...
Cohesion: 0.07
Nodes (42): calls, { mockExecAsync }, opts, archivePlanning(), CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync (+34 more)
...
Cohesion: 0.08
Nodes (41): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+33 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (28): DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+20 more)
...
Cohesion: 0.08
Nodes (41): Access, getAgentRuntimeStateAsync(), encodeClaudeProjectDir(), PrdLocation, ActivityContext, closedIssuesCache, costCache, execAsync (+33 more)
...
Cohesion: 0.08
Nodes (34): registerAdminCommands(), registerCloisterCommands(), registerBeadsCommands(), registerConfigCommand(), ShadowOptions, registerDbCommands(), deepMerge(), DEFAULT_CONFIG (+26 more)
...
Cohesion: 0.08
Nodes (24): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName() (+16 more)

### Community 100 - "Community 100"
Cohesion: 0.06
Nodes (35): executeHandoff(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR (+27 more)
...
Cohesion: 0.11
Nodes (34): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+26 more)
...
Cohesion: 0.06
Nodes (32): ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption, updateConversationTitle() (+24 more)
...
Cohesion: 0.11
Nodes (36): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+28 more)
...
Cohesion: 0.18
Nodes (36): archiveWorkspaceArtifacts(), findWorkspacePath(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+28 more)
...
Cohesion: 0.11
Nodes (30): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+22 more)
...
Cohesion: 0.1
Nodes (13): getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+5 more)
...
Cohesion: 0.1
Nodes (20): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+12 more)
...
Cohesion: 0.12
Nodes (24): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+16 more)
...
Cohesion: 0.1
Nodes (22): CapabilityStats, DailyStats, fetchRuntimeMetrics(), formatCost(), formatDuration(), formatPercent(), getSuccessColor(), MetricsResponse (+14 more)
...
Cohesion: 0.1
Nodes (21): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, ReadModelServiceLive (+13 more)
...
Cohesion: 0.12
Nodes (19): ProjectConfig, StepResult, after, before, cfg, compose, ph, result (+11 more)
...
Cohesion: 0.15
Nodes (17): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), getTrackerContext() (+9 more)
...
Cohesion: 0.17
Nodes (14): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), useCodexAutoRetry() (+6 more)
...
## Knowledge Gaps
- **11564 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11559 more)
...
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 385`, `Community 3`, `Community 132`, `Community 6`, `Community 136`, `Community 9`, `Community 10`, `Community 137`, `Community 12`, `Community 397`, `Community 269`, `Community 526`, `Community 13`, `Community 15`, `Community 17`, `Community 149`, `Community 277`, `Community 21`, `Community 25`, `Community 31`, `Community 545`, `Community 546`, `Community 161`, `Community 163`, `Community 35`, `Community 550`, `Community 420`, `Community 47`, `Community 49`, `Community 183`, `Community 55`, `Community 57`, `Community 64`, `Community 965`, `Community 73`, `Community 590`, `Community 214`, `Community 100`, `Community 488`, `Community 745`, `Community 106`, `Community 104`, `Community 240`, `Community 639`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 133` to `Community 24`, `Community 1`, `Community 4`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 17` to `Community 120`, `Community 1019`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11564 weakly-connected nodes found - possible documentation gaps or missing edges._
