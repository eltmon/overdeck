...
## Corpus Check
- 1616 files · ~2,175,022 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22909 nodes · 34656 edges · 1171 communities (1131 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 474 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `916a8225`
...
## Communities (1171 total, 40 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (177): checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState() (+169 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (150): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+142 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (174): addLog(), checkDeadEndAgents(), checkFirstCompletionAgents(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkPostReviewCommits(), checkStuckReviewing(), checkStuckWorkAgents() (+166 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (159): checkMissingReviewStatuses(), killOrphanedWorkspaceProcesses(), resetPostMergeState(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE (+151 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (124): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+116 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (124): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures (+116 more)
...
Cohesion: 0.04
Nodes (95): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+87 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (77): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+69 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (90): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+82 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (92): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (94): ACTIVE_STATUS_PATTERNS, API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkHeartbeat(), checkMassDeath(), checkReadyForMergeStuck() (+86 more)
...
Cohesion: 0.03
Nodes (79): DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, formatBytes(), severityClasses(), SystemHealthPill() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (76): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (86): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+78 more)
...
Cohesion: 0.04
Nodes (71): getUnblockedItems(), TERMINAL_STATUSES, buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocument() (+63 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (79): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (66): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+58 more)
...
Cohesion: 0.04
Nodes (72): setAgentStoppedNotifier(), announceMerge(), spawnReviewCoordinatorSession(), pendingCommand(), getAllReviewStatusesFromDb(), ActivityLevel, ActivitySource, emitActivityDetailed() (+64 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (77): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, HandoffResult (+69 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (60): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), PlanningState, ZoneAActionsState, CodexAuthBanner(), PlanDialog() (+52 more)
...
Cohesion: 0.03
Nodes (72): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+64 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (72): migrateConfigCommand(), MigrateConfigOptions, BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions (+64 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (66): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTimestamp() (+58 more)
...
Cohesion: 0.04
Nodes (58): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), criteria, doc, result, beadsDir (+50 more)
...
Cohesion: 0.04
Nodes (65): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearStaleCiFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+57 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (68): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+60 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (50): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+42 more)
...
Cohesion: 0.04
Nodes (58): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+50 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (59): FileStatus, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR (+51 more)
...
Cohesion: 0.05
Nodes (64): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+56 more)
...
Cohesion: 0.04
Nodes (53): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+45 more)
...
Cohesion: 0.05
Nodes (54): ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile, getTrackerContext() (+46 more)
...
Cohesion: 0.06
Nodes (44): AutoPresoSession, emitter, emitter, onTurn, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin() (+36 more)
...
Cohesion: 0.04
Nodes (54): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName(), parseAllSessions() (+46 more)
...
Cohesion: 0.06
Nodes (44): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+36 more)
...
Cohesion: 0.06
Nodes (41): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+33 more)
...
Cohesion: 0.1
Nodes (43): BlockerReason, setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckSuite() (+35 more)
...
Cohesion: 0.08
Nodes (38): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+30 more)
...
Cohesion: 0.08
Nodes (39): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+31 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (26): captureTldrMetrics(), daemonRegistry, ensureTldrStateDir(), execAsync, getPidFilePath(), getStateFilePath(), getTldrMetrics(), hashWorkspacePath() (+18 more)
...
Cohesion: 0.06
Nodes (31): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+23 more)
...
Cohesion: 0.1
Nodes (37): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand() (+29 more)
...
Cohesion: 0.05
Nodes (34): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+26 more)
...
Cohesion: 0.16
Nodes (40): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+32 more)
...
Cohesion: 0.1
Nodes (34): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity() (+26 more)
...
Cohesion: 0.08
Nodes (29): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getHistoryFromDb(), getReviewStatusFromDb() (+21 more)
...
Cohesion: 0.12
Nodes (23): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), formatTldrAge() (+15 more)
...
Cohesion: 0.09
Nodes (19): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+11 more)
...
Cohesion: 0.09
Nodes (18): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+10 more)
...
Cohesion: 0.12
Nodes (10): createTrackerFromConfig(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker (+2 more)
...
Cohesion: 0.15
Nodes (16): buildSpecialistBaseCommand(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode (+8 more)
...
Cohesion: 0.67
Nodes (3): getReviewStatusFromDbAsync(), getReviewStatusAsync(), refreshMergeStateFromGitHub()
...
## Knowledge Gaps
- **12087 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12082 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 392`, `Community 8`, `Community 779`, `Community 654`, `Community 15`, `Community 16`, `Community 655`, `Community 146`, `Community 18`, `Community 20`, `Community 402`, `Community 662`, `Community 23`, `Community 24`, `Community 281`, `Community 26`, `Community 27`, `Community 408`, `Community 542`, `Community 31`, `Community 162`, `Community 34`, `Community 37`, `Community 38`, `Community 43`, `Community 44`, `Community 565`, `Community 54`, `Community 569`, `Community 61`, `Community 62`, `Community 63`, `Community 838`, `Community 76`, `Community 77`, `Community 78`, `Community 83`, `Community 85`, `Community 348`, `Community 94`, `Community 19`, `Community 99`, `Community 996`, `Community 103`, `Community 126`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 5` to `Community 0`, `Community 2`, `Community 99`, `Community 3`, `Community 35`, `Community 4`, `Community 162`, `Community 40`, `Community 12`, `Community 13`, `Community 17`, `Community 145`, `Community 180`, `Community 116`, `Community 24`, `Community 91`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 22` to `Community 0`, `Community 6`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12087 weakly-connected nodes found - possible documentation gaps or missing edges._
