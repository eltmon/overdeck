...
## Corpus Check
- 1878 files · ~2,478,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26667 nodes · 41475 edges · 1258 communities (1204 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7cb32b21`
...
## Communities (1258 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (166): monitorReviewConvoySignals(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), pendingCommand(), after, before, blockers (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (177): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgent(), resolveWorkspaceForIssue() (+169 more)
...
Cohesion: 0.02
Nodes (130): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (134): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById() (+126 more)
...
Cohesion: 0.02
Nodes (113): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+105 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (92): isMergeAgentRunning(), parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder, checkFn (+84 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (97): ComposerMode, IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip() (+89 more)
...
Cohesion: 0.02
Nodes (104): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (98): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+90 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (107): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+99 more)
...
Cohesion: 0.04
Nodes (105): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+97 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (95): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+87 more)
...
Cohesion: 0.03
Nodes (90): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), clearStaleCiFeedback(), FeedbackWriteError (+82 more)
...
Cohesion: 0.02
Nodes (80): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+72 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (89): checkMissingReviewStatuses(), checkPostReviewCommits(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+81 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (91): buildPolyrepoContext(), projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+83 more)
...
Cohesion: 0.03
Nodes (72): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+64 more)
...
Cohesion: 0.03
Nodes (87): detectMergedSwarmSlots(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+79 more)
...
Cohesion: 0.03
Nodes (77): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+69 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (88): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef (+80 more)
...
Cohesion: 0.04
Nodes (68): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+60 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (71): InlineSparkline(), InlineSparklineProps, BranchNode(), BranchNodeProps, ContainerNode(), ContainerNodeProps, containerStatusColor(), containerStatusToDot() (+63 more)
...
Cohesion: 0.03
Nodes (64): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+56 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (74): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+66 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (68): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+60 more)
...
Cohesion: 0.05
Nodes (71): getPanopticonHome(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+63 more)
...
Cohesion: 0.04
Nodes (76): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute (+68 more)
...
Cohesion: 0.04
Nodes (74): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+66 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (57): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+49 more)
...
Cohesion: 0.03
Nodes (63): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+55 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (65): countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR (+57 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (63): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, agentStopRoute() (+55 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (64): extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+56 more)
...
Cohesion: 0.05
Nodes (35): EMPTY_HEALTH, MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate, MemoryHealthUpdateOptions, readMemoryHealth(), readMemoryHealthSnapshot() (+27 more)
...
Cohesion: 0.05
Nodes (60): generateFallbackSummary(), AIProvider, appendJsonl(), readTranscriptSlice(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session() (+52 more)
...
Cohesion: 0.05
Nodes (34): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton() (+26 more)
...
Cohesion: 0.06
Nodes (50): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPathEffect(), hasPRDDraftEffect(), listPRDDrafts(), listPRDDraftsEffect() (+42 more)
...
Cohesion: 0.04
Nodes (52): UpsertDiscoveredSessionOpts, ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+44 more)
...
Cohesion: 0.05
Nodes (38): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+30 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (44): VerifyingOnMainBadge(), WorkspaceStatusOverviewProps, ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions() (+36 more)
...
Cohesion: 0.04
Nodes (35): beadsDir, doc, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+27 more)

### Community 99 - "Community 99"
Cohesion: 0.06
Nodes (38): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+30 more)
...
Cohesion: 0.09
Nodes (36): assertSafeAgentId(), assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+28 more)
...
Cohesion: 0.06
Nodes (40): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+32 more)
...
Cohesion: 0.06
Nodes (27): activeA, activeB, clearIntervalSpy, enqueue, extract, getActiveTranscriptEntries, poller, readTranscriptSlice (+19 more)
...
Cohesion: 0.08
Nodes (32): clearFeedbackFiles(), writeStoryFeatureContext(), FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+24 more)

### Community 137 - "Community 137"
Cohesion: 0.08
Nodes (39): resolveArchiveDir(), enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult (+31 more)
...
Cohesion: 0.08
Nodes (31): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+23 more)
...
Cohesion: 0.07
Nodes (30): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+22 more)
...
Cohesion: 0.09
Nodes (27): AgentEnrichment, computeAgentEnrichment(), listRunningAgentsAsync(), withConcurrencyLimit(), findAgentStateBySessionId(), resolveAgentState(), getEventStore(), EnrichmentServiceState (+19 more)

### Community 225 - "Community 225"
Cohesion: 0.1
Nodes (30): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+22 more)
...
Cohesion: 0.14
Nodes (29): runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+21 more)
...
Cohesion: 0.1
Nodes (22): makeTestService(), sentinel, initWorkspaceDiscoveredSessionsSchema(), markAgentStateServiceInProcess(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent() (+14 more)
...
Cohesion: 0.15
Nodes (11): cleanupAllLogs(), cleanupOldLogs(), ensureRunsDirectory(), getRecentRunLogs(), getRunsDirectory(), getSpecialistsDir(), listRunLogs(), RunLogMetadata (+3 more)
...
Cohesion: 0.2
Nodes (16): speakTts(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), onEvent() (+8 more)
...
Cohesion: 0.13
Nodes (11): StoredEvent, ActivityItem, callSummarizer(), flush(), OpenAIChatCompletion, startTtsSummarizer(), state, SummarizerState (+3 more)
...
Cohesion: 0.15
Nodes (6): createFlyApiClient(), FlyApiError, client, fetchMock, machine, machines
...
## Knowledge Gaps
- **13277 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13272 more)
...
- **Why does `fetch` connect `Community 54` to `Community 0`, `Community 513`, `Community 258`, `Community 3`, `Community 4`, `Community 128`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 268`, `Community 13`, `Community 15`, `Community 16`, `Community 20`, `Community 149`, `Community 23`, `Community 24`, `Community 26`, `Community 155`, `Community 27`, `Community 30`, `Community 31`, `Community 160`, `Community 32`, `Community 36`, `Community 1065`, `Community 1066`, `Community 683`, `Community 687`, `Community 48`, `Community 431`, `Community 563`, `Community 55`, `Community 60`, `Community 445`, `Community 446`, `Community 63`, `Community 64`, `Community 192`, `Community 321`, `Community 193`, `Community 68`, `Community 71`, `Community 330`, `Community 203`, `Community 81`, `Community 83`, `Community 345`, `Community 89`, `Community 94`, `Community 736`, `Community 225`, `Community 99`, `Community 228`, `Community 613`, `Community 100`, `Community 229`, `Community 1130`, `Community 1131`, `Community 236`, `Community 373`, `Community 636`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 32` to `Community 98`, `Community 35`, `Community 36`, `Community 5`, `Community 4`, `Community 136`, `Community 40`, `Community 43`, `Community 204`, `Community 175`, `Community 81`, `Community 25`, `Community 415`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 136` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 261`, `Community 7`, `Community 135`, `Community 11`, `Community 12`, `Community 13`, `Community 269`, `Community 15`, `Community 18`, `Community 22`, `Community 25`, `Community 28`, `Community 414`, `Community 159`, `Community 160`, `Community 36`, `Community 37`, `Community 425`, `Community 44`, `Community 428`, `Community 174`, `Community 46`, `Community 559`, `Community 429`, `Community 430`, `Community 53`, `Community 55`, `Community 443`, `Community 444`, `Community 317`, `Community 190`, `Community 448`, `Community 67`, `Community 70`, `Community 71`, `Community 326`, `Community 327`, `Community 460`, `Community 79`, `Community 82`, `Community 468`, `Community 84`, `Community 212`, `Community 213`, `Community 89`, `Community 108`, `Community 368`, `Community 371`, `Community 121`, `Community 122`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13277 weakly-connected nodes found - possible documentation gaps or missing edges._
