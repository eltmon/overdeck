# Graph Report - feature-pan-1053  (2026-05-17)

## Corpus Check
- 1621 files · ~2,206,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23011 nodes · 34804 edges · 1175 communities (1134 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83121248`
...
## Communities (1175 total, 41 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (171): checkCompletedButUnsignaledReviews(), checkThinkingSignatureCorruption(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), buildSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand() (+163 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (153): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS (+145 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (140): readCavemanVariant(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), spawnInspectAgent(), spawnRebaseAgentForBranch(), renderPrompt(), spawnSingleReviewer() (+132 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (94): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent() (+86 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (108): PlanningState, ZoneAActionsState, DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost() (+100 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (108): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+100 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (96): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+88 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (117): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (94): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+86 more)
...
Cohesion: 0.02
Nodes (94): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+86 more)
...
Cohesion: 0.03
Nodes (95): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (96): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (93): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), buildPanSpecFilename() (+85 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (88): readWorkspacePlanAsync(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), writeWorkspaceContext(), ensureWorkspacePanDir() (+80 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (77): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+69 more)
...
Cohesion: 0.04
Nodes (65): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, fsHooks, after (+57 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (81): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+73 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (79): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+71 more)
...
Cohesion: 0.05
Nodes (76): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (75): addRepoCommand(), loadRepoGroups(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d (+67 more)
...
Cohesion: 0.05
Nodes (71): clearFeedbackFiles(), buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+63 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (75): killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested, resolveTrackerType() (+67 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (61): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+53 more)
...
Cohesion: 0.08
Nodes (72): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), applyClosedOutLabel() (+64 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (51): destroyRemoteWorkspace(), createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client (+43 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (59): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, MonitoringAgentConfig, readInferenceDocument(), updateInferenceDocument() (+51 more)
...
Cohesion: 0.06
Nodes (59): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+51 more)
...
Cohesion: 0.05
Nodes (60): logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+52 more)
...
Cohesion: 0.06
Nodes (54): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+46 more)
...
Cohesion: 0.04
Nodes (52): canReplaceTitle(), getConversationByName(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+44 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (53): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (49): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (48): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+40 more)
...
Cohesion: 0.07
Nodes (45): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+37 more)
...
Cohesion: 0.06
Nodes (41): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand() (+33 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (41): setAgentStoppedNotifier(), getAllActiveQueues(), setPipelineHandler(), clearReviewStatus(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp() (+33 more)
...
Cohesion: 0.07
Nodes (40): agentDir, missing, result, snapshot, status, withConcurrencyLimit(), discoverNewAgentIds(), ReadModelServiceShape (+32 more)
...
Cohesion: 0.05
Nodes (30): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage, checkbox (+22 more)
...
Cohesion: 0.06
Nodes (37): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+29 more)
...
Cohesion: 0.07
Nodes (33): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, listener(), electron (+25 more)
...
Cohesion: 0.12
Nodes (34): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+26 more)
...
Cohesion: 0.11
Nodes (26): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir(), panopticonDir(), PiRuntime (+18 more)
...
Cohesion: 0.11
Nodes (28): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+20 more)
...
Cohesion: 0.11
Nodes (23): AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+15 more)
...
Cohesion: 0.1
Nodes (20): Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, buildMiniMaxFormData(), WORK_TYPE_CATEGORIES, allModelIds (+12 more)
...
Cohesion: 0.12
Nodes (12): EDITOR_LABELS, PanOpenInPickerProps, createPanRpcProtocolLayer(), DEFAULT_RETRY_DELAY, makePanRpcClient, PanRpcProtocolClient, resetTransport(), RpcClientFactory (+4 more)
...
## Knowledge Gaps
- **12145 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12140 more)
...
- **Why does `fetch` connect `Community 5` to `Community 1`, `Community 262`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 396`, `Community 397`, `Community 14`, `Community 12`, `Community 785`, `Community 18`, `Community 19`, `Community 145`, `Community 20`, `Community 23`, `Community 27`, `Community 29`, `Community 670`, `Community 159`, `Community 160`, `Community 32`, `Community 33`, `Community 35`, `Community 549`, `Community 170`, `Community 47`, `Community 48`, `Community 50`, `Community 54`, `Community 56`, `Community 188`, `Community 573`, `Community 62`, `Community 572`, `Community 191`, `Community 68`, `Community 581`, `Community 201`, `Community 73`, `Community 844`, `Community 82`, `Community 90`, `Community 96`, `Community 621`, `Community 109`, `Community 118`, `Community 119`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 14` to `Community 0`, `Community 1`, `Community 34`, `Community 132`, `Community 5`, `Community 7`, `Community 40`, `Community 15`, `Community 52`, `Community 21`, `Community 246`, `Community 22`, `Community 54`, `Community 27`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 13` to `Community 16`, `Community 0`, `Community 10`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12145 weakly-connected nodes found - possible documentation gaps or missing edges._
