...
## Corpus Check
- 1544 files · ~2,039,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21750 nodes · 32301 edges · 1122 communities (1085 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc21d608`
...
## Communities (1122 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (130): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+122 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (129): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+121 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (110): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename() (+102 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (107): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+99 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (117): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask, captureBeadsTasks(), captureFiles() (+109 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (116): checkPendingTestDispatch(), nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), captureHandoffContext(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod (+108 more)
...
Cohesion: 0.02
Nodes (118): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+110 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (112): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+104 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (109): reconcileAndCheckIfMerged(), reconcileFalseMerged(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), APP_DIR (+101 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (101): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+93 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (105): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+97 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (106): checkOrphanedReviewStatuses(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), renderPrompt(), getActiveParallelReviewIssues(), cleanupLegacySpecialistsDirectory(), scheduleDigestGeneration() (+98 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (98): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+90 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (92): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (81): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+73 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (73): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+65 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (76): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard() (+68 more)
...
Cohesion: 0.04
Nodes (84): spawnReviewCoordinatorSession(), pendingCommand(), after, before, blockers, result, statuses, after (+76 more)
...
Cohesion: 0.03
Nodes (67): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+59 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (68): firstSessionPanel, firstWorkbench, workbench, Conversation, ConversationList(), ConversationListProps, fetchConversations(), getSortKey() (+60 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (76): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand() (+68 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (70): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+62 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (72): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, issues, result, importTrackerConfig(), result (+64 more)
...
Cohesion: 0.03
Nodes (68): resetSessionCommand(), resumeCommand(), getRuntimeSnapshotSync(), mirror, setAgentRuntimeMirror(), getActivity(), getLatestSessionId(), getSessionId() (+60 more)
...
Cohesion: 0.03
Nodes (70): agentDir, dir1, dir2, marker, missing, nested, resolveTrackerType(), invalidateAgentsCache() (+62 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (63): cleanupAbandonedFeedback(), clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace() (+55 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (61): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, ghCliIssue (+53 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (57): setAgentStoppedNotifier(), announceMerge(), CopyConfigOptions, clearStuckForks(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry() (+49 more)
...
Cohesion: 0.06
Nodes (55): getHealthThresholdsMs(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, AgentHealth, evaluateHealthState() (+47 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (50): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (49): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+41 more)
...
Cohesion: 0.05
Nodes (46): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ZoneCConversation() (+38 more)
...
Cohesion: 0.04
Nodes (50): ChatMarkdown, ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, CostEvent, CostStreamResponse, fetchCostStream() (+42 more)
...
Cohesion: 0.05
Nodes (48): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+40 more)
...
Cohesion: 0.04
Nodes (47): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+39 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (50): postMergeLifecycle(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+42 more)
...
Cohesion: 0.06
Nodes (48): getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+40 more)
...
Cohesion: 0.07
Nodes (45): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+37 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (38): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry() (+30 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (34): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo(), destroyPiFifo(), execAsync (+26 more)
...
Cohesion: 0.08
Nodes (40): doneCommand(), DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+32 more)
...
Cohesion: 0.05
Nodes (30): EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, button, { container }, defaultProps, makeMutation(), makeSyncMutation() (+22 more)
...
Cohesion: 0.05
Nodes (37): formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions, TldrIndexEntry, tldrIndexStatusCommand() (+29 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (42): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind (+34 more)
...
Cohesion: 0.07
Nodes (36): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+28 more)
...
Cohesion: 0.08
Nodes (32): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceLive (+24 more)
...
Cohesion: 0.12
Nodes (34): killCommand(), KillOptions, destroyRemoteWorkspace(), getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+26 more)
...
Cohesion: 0.07
Nodes (28): fmt(), STATUS_BADGE, VBriefHeader(), VBriefHeaderProps, DIFFICULTY_COLORS, PRIORITY_COLORS, STATUS_COLORS, VBriefItemCard() (+20 more)
...
Cohesion: 0.09
Nodes (32): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+24 more)
...
Cohesion: 0.1
Nodes (28): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+20 more)
...
Cohesion: 0.12
Nodes (31): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+23 more)
...
Cohesion: 0.12
Nodes (21): wipeCommand(), WipeOptions, extractNumber(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId() (+13 more)
...
Cohesion: 0.12
Nodes (20): killAllReviewSessions(), cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir (+12 more)
...
Cohesion: 0.13
Nodes (22): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+14 more)
...
Cohesion: 0.14
Nodes (19): transitionIssueState(), transitionIssueToInProgress(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker (+11 more)
...
Cohesion: 0.1
Nodes (19): isOlderThanDays(), execMock, mockCreateTracker, mockDropStash, mockFindWorkspacePath, mockGetAgentState, mockGetProject, mockGetReviewStatus (+11 more)
...
Cohesion: 0.2
Nodes (9): resetPostMergeState(), kCustom, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile (+1 more)
...
Cohesion: 0.33
Nodes (5): identifyOrphanedReviewingIssues(), parseSpecialistAgentSession(), active, result, statuses
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 3`, `Community 517`, `Community 134`, `Community 133`, `Community 7`, `Community 9`, `Community 137`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 273`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 406`, `Community 537`, `Community 29`, `Community 32`, `Community 34`, `Community 164`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 49`, `Community 186`, `Community 187`, `Community 188`, `Community 574`, `Community 62`, `Community 575`, `Community 65`, `Community 67`, `Community 83`, `Community 92`, `Community 734`, `Community 109`, `Community 878`, `Community 245`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 146` to `Community 4`, `Community 5`, `Community 15`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 2` to `Community 4`, `Community 581`, `Community 136`, `Community 9`, `Community 109`, `Community 46`, `Community 23`, `Community 24`?**
