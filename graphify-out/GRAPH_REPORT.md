# Graph Report - feature-pan-1055  (2026-05-10)

## Corpus Check
- 1548 files · ~2,069,726 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21647 nodes · 32214 edges · 1137 communities (1103 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef23b1d1`
...
## Communities (1137 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (150): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (133): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+125 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (117): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+109 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (132): checkPendingTestDispatch(), buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+124 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (95): getHealthThresholdsMs(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, HandoffResult (+87 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (131): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+123 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (117): killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), computeAgentEnrichment() (+109 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (116): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+108 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (100): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (92): ActivityPanel(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+84 more)
...
Cohesion: 0.03
Nodes (104): cleanupSpawnAndOrphanedStashes(), reconcileAndCheckIfMerged(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (98): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+90 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (93): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+85 more)
...
Cohesion: 0.02
Nodes (83): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+75 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (94): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+86 more)
...
Cohesion: 0.03
Nodes (72): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (81): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, BeadsTask, captureBeadsTasks(), captureFiles() (+73 more)
...
Cohesion: 0.04
Nodes (62): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+54 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (76): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync, formatDuration(), generateReport(), parseTestOutput() (+68 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (66): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (67): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+59 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (71): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (70): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+62 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (54): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+46 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (29): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+21 more)
...
Cohesion: 0.05
Nodes (63): clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS, resolveModelId(), allModelIds, defaults, deprecatedIds, resolved (+55 more)
...
Cohesion: 0.05
Nodes (47): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, FailedMessage, AssistantMessageRow(), formatElapsed() (+39 more)
...
Cohesion: 0.05
Nodes (48): buildConversationResponse(), getCachedMessages(), validateCwdContainment(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+40 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (53): clearStaleCiFeedback(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand() (+45 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (54): Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+46 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (49): resolveSpecialistBaseCommand(), getProviderAuthMode(), resolveEffectiveHarness(), ALLOWED, canUseHarness(), HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, buildChannelsArgs() (+41 more)
...
Cohesion: 0.07
Nodes (47): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+39 more)

### Community 42 - "Community 42"
Cohesion: 0.09
Nodes (50): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+42 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (44): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+36 more)
...
Cohesion: 0.07
Nodes (45): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+37 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (49): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execAsync, execFileAsync, firePostMergeLifecycle() (+41 more)
...
Cohesion: 0.06
Nodes (43): agentDir, missing, result, snapshot, status, withConcurrencyLimit(), discoverNewAgentIds(), ReadModelServiceShape (+35 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (41): eightDaysAgo, events, payload, r1, r2, received, recent, remaining (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (40): result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+32 more)
...
Cohesion: 0.06
Nodes (37): DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse, DASHBOARD_URL, resetReviewCommand(), ResetReviewOptions, { resetSessionMock, fetchMock }, deepMerge() (+29 more)

### Community 59 - "Community 59"
Cohesion: 0.09
Nodes (40): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+32 more)
...
Cohesion: 0.08
Nodes (34): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+26 more)
...
Cohesion: 0.06
Nodes (34): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), badPath, customPlanningDir, dir, doc (+26 more)
...
Cohesion: 0.06
Nodes (32): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+24 more)
...
Cohesion: 0.06
Nodes (32): fmt(), STATUS_BADGE, VBriefHeader(), VBriefHeaderProps, DIFFICULTY_COLORS, PRIORITY_COLORS, STATUS_COLORS, VBriefItemCard() (+24 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (31): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+23 more)
...
Cohesion: 0.14
Nodes (39): bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile() (+31 more)
...
Cohesion: 0.08
Nodes (33): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+25 more)
...
Cohesion: 0.1
Nodes (28): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, heartbeatsDir(), panopticonDir(), PiRuntime (+20 more)
...
Cohesion: 0.12
Nodes (34): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType, getConversationByClaudeSessionId() (+26 more)
...
Cohesion: 0.07
Nodes (29): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, ModelId, getAllWorkTypes() (+21 more)
...
Cohesion: 0.08
Nodes (26): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime(), RuntimeRegistry (+18 more)
...
Cohesion: 0.09
Nodes (33): AgentEnrichment, execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+25 more)

### Community 136 - "Community 136"
Cohesion: 0.06
Nodes (36): Activity, AgentChannelReply, AgentId, AgentPhase, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES (+28 more)
...
Cohesion: 0.07
Nodes (32): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCostForIssueFromDb(), getCostsByIssueFromDb() (+24 more)
...
Cohesion: 0.11
Nodes (29): resolveBundledServerPath(), resolveNode22(), resolveScope(), RestartOptions, spawnDashboardDetached(), LOGS_DIR, DASHBOARD_LOG_FILE, execAsync (+21 more)
...
Cohesion: 0.07
Nodes (31): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+23 more)
...
Cohesion: 0.12
Nodes (28): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR (+20 more)
...
Cohesion: 0.12
Nodes (27): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+19 more)

### Community 178 - "Community 178"
Cohesion: 0.11
Nodes (29): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+21 more)

### Community 179 - "Community 179"
Cohesion: 0.06
Nodes (26): content, db, event, goodLine, history, ids, latest, lines (+18 more)
...
Cohesion: 0.09
Nodes (24): dispatchTestAgentAndNotify(), getTrackerContext(), detectFirstAvailableEditor(), getFileManagerCommand(), isCommandAvailable(), openCommand(), fetchIssueWithComments(), findLocalWorkspace() (+16 more)

### Community 186 - "Community 186"
Cohesion: 0.09
Nodes (28): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+20 more)
...
Cohesion: 0.07
Nodes (21): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+13 more)
...
Cohesion: 0.12
Nodes (27): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+19 more)
...
Cohesion: 0.14
Nodes (14): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog() (+6 more)
...
Cohesion: 0.14
Nodes (26): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+18 more)
...
Cohesion: 0.12
Nodes (26): wipeCommand(), archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close() (+18 more)
...
Cohesion: 0.18
Nodes (25): createCostCommand(), runCostSync(), BUDGETS_FILE, checkBudget(), CostBudget, CostSummary, createBudget(), deleteBudget() (+17 more)

### Community 247 - "Community 247"
Cohesion: 0.1
Nodes (22): setAgentStoppedNotifier(), getAllActiveQueues(), setPipelineHandler(), EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp() (+14 more)
...
Cohesion: 0.14
Nodes (24): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+16 more)
...
Cohesion: 0.12
Nodes (10): GitHubTracker, parseIssueNumber(), error, mockComment, mockComments, mockIssue, mockIssues, mockOctokit (+2 more)
...
Cohesion: 0.29
Nodes (22): findAllWorkspacePaths(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess() (+14 more)
...
Cohesion: 0.2
Nodes (20): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+12 more)
...
Cohesion: 0.09
Nodes (18): PipelinePhaseInput, { activeSession }, { activeSession, availableTerminals }, { availableTerminals }, correctnessTab, dead, initialInput, input (+10 more)

### Community 336 - "Community 336"
Cohesion: 0.11
Nodes (12): fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, onSessionEnded (+4 more)
...
Cohesion: 0.14
Nodes (18): execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs, logPath (+10 more)
...
Cohesion: 0.18
Nodes (13): getPiLauncherFields(), createPiFifo(), destroyPiFifo(), execAsync, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand() (+5 more)
...
Cohesion: 0.28
Nodes (15): startPostLaunchSidecars(), startSidecars(), restartCommand(), runFullRestart(), readPlatformConfig(), getSupervisorPort(), getSupervisorUrl(), isProcessAlive() (+7 more)
...
Cohesion: 0.14
Nodes (13): MODELS_BY_PROVIDER, DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), allModelIds, config, defaults, DEPRECATED_MODEL_IDS, existing (+5 more)
...
Cohesion: 0.15
Nodes (8): RallyApiConfig, RallyCreateConfig, RallyCreateResult, RallyQueryConfig, RallyQueryResult, RallyRestApi, RallyUpdateConfig, RallyUpdateResult
...
Cohesion: 0.19
Nodes (8): getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps, cards, { unmount }, writeView()
...
Cohesion: 0.43
Nodes (7): Active Pipeline, Cycling Alerts, Flywheel State — Run 2026-05-09, Flywheel State — Run 2026-05-09 (late), Infrastructure Gaps, Pattern Ledger, Skill Gaps
...
Cohesion: 0.6
Nodes (4): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting()
...
Cohesion: 0.5
Nodes (4): decode, decodeCandidate(), ev, bodyToEvent()
...
## Knowledge Gaps
- **11519 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11514 more)
...
- **Why does `fetch` connect `Community 1` to `Community 5`, `Community 134`, `Community 7`, `Community 648`, `Community 9`, `Community 8`, `Community 10`, `Community 15`, `Community 530`, `Community 275`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 533`, `Community 25`, `Community 153`, `Community 532`, `Community 20`, `Community 28`, `Community 24`, `Community 29`, `Community 32`, `Community 162`, `Community 164`, `Community 39`, `Community 554`, `Community 175`, `Community 47`, `Community 49`, `Community 54`, `Community 185`, `Community 58`, `Community 958`, `Community 191`, `Community 65`, `Community 336`, `Community 593`, `Community 594`, `Community 599`, `Community 89`, `Community 221`, `Community 751`, `Community 151`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 124` to `Community 19`, `Community 6`, `Community 15`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `resolveProjectFromIssue()` connect `Community 185` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 135`, `Community 11`, `Community 12`, `Community 13`, `Community 141`, `Community 16`, `Community 17`, `Community 19`, `Community 151`, `Community 25`, `Community 26`, `Community 28`, `Community 36`, `Community 37`, `Community 41`, `Community 44`, `Community 45`, `Community 46`, `Community 177`, `Community 50`, `Community 178`, `Community 53`, `Community 54`, `Community 59`, `Community 66`, `Community 97`, `Community 364`, `Community 493`, `Community 247`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 157 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 157 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11519 weakly-connected nodes found - possible documentation gaps or missing edges._
