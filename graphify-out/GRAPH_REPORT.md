...
## Corpus Check
- 2122 files · ~3,724,570 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33610 nodes · 65177 edges · 1417 communities (1348 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1544 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fa6c568`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Agent Session Lifecycle Management|Agent Session Lifecycle Management]]
- [[_COMMUNITY_Merge Agent Post-Merge Lifecycle|Merge Agent Post-Merge Lifecycle]]
- [[_COMMUNITY_Command Deck Overview Tab UI|Command Deck Overview Tab UI]]
- [[_COMMUNITY_Deacon Patrol and Queue|Deacon Patrol and Queue]]
- [[_COMMUNITY_VBrief Plan Builder and Viewer|VBrief Plan Builder and Viewer]]
- [[_COMMUNITY_Agent Runtime Spawning|Agent Runtime Spawning]]
- [[_COMMUNITY_Parallel Review Pipeline Dispatch|Parallel Review Pipeline Dispatch]]
- [[_COMMUNITY_Specialist Handoff and Planning Spawn|Specialist Handoff and Planning Spawn]]
- [[_COMMUNITY_Workspace Creation and Worktree|Workspace Creation and Worktree]]
- [[_COMMUNITY_Conversation Database and Favorites|Conversation Database and Favorites]]
- [[_COMMUNITY_Agent Snapshot and Event Types|Agent Snapshot and Event Types]]
- [[_COMMUNITY_Cloister Service Health and Config|Cloister Service Health and Config]]
- [[_COMMUNITY_Inspector Panel Terminal UI|Inspector Panel Terminal UI]]
- [[_COMMUNITY_Event Store Domain Services|Event Store Domain Services]]
- [[_COMMUNITY_Kanban Board Agent Status UI|Kanban Board Agent Status UI]]
- [[_COMMUNITY_Electron Desktop App and Tray|Electron Desktop App and Tray]]
- [[_COMMUNITY_Health Metrics and Settings Pages|Health Metrics and Settings Pages]]
- [[_COMMUNITY_Issue Service and Data Fetching|Issue Service and Data Fetching]]
- [[_COMMUNITY_Workspace Lifecycle and Config|Workspace Lifecycle and Config]]
- [[_COMMUNITY_Tmux Terminal Session Management|Tmux Terminal Session Management]]
- [[_COMMUNITY_Database Schema and Review Status|Database Schema and Review Status]]
- [[_COMMUNITY_Git Activity and Runtime Metrics|Git Activity and Runtime Metrics]]
- [[_COMMUNITY_Dashboard HTTP Routes and Admin|Dashboard HTTP Routes and Admin]]
- [[_COMMUNITY_Dashboard Store and Command Palette|Dashboard Store and Command Palette]]
- [[_COMMUNITY_VBrief Lifecycle IO and Transitions|VBrief Lifecycle IO and Transitions]]
- [[_COMMUNITY_Dialog Actions and System Health UI|Dialog Actions and System Health UI]]
- [[_COMMUNITY_Specialist Metadata and Grace Period|Specialist Metadata and Grace Period]]
- [[_COMMUNITY_CLI Commands and Runtime Adapters|CLI Commands and Runtime Adapters]]
- [[_COMMUNITY_Docker Stats and Container Resources|Docker Stats and Container Resources]]
- [[_COMMUNITY_Command Deck Zone B Session Nodes|Command Deck Zone B Session Nodes]]
- [[_COMMUNITY_GodView Socket and Activity Feed|GodView Socket and Activity Feed]]
- [[_COMMUNITY_Cost Calculation and Token Usage|Cost Calculation and Token Usage]]
- [[_COMMUNITY_Cost Events Database and WAL Sync|Cost Events Database and WAL Sync]]
- [[_COMMUNITY_VBrief Beads IO and Plan Finalize|VBrief Beads IO and Plan Finalize]]
- [[_COMMUNITY_Project Tree Feature Items UI|Project Tree Feature Items UI]]
- [[_COMMUNITY_Review Round Status Badge UI|Review Round Status Badge UI]]
- [[_COMMUNITY_Conversation Service WebSocket RPC|Conversation Service WebSocket RPC]]
- [[_COMMUNITY_Dashboard Design Docs and Mockups|Dashboard Design Docs and Mockups]]
- [[_COMMUNITY_CLI Install DNS and Dev Commands|CLI Install DNS and Dev Commands]]
- [[_COMMUNITY_Cost Event Aggregation and Retention|Cost Event Aggregation and Retention]]
- [[_COMMUNITY_Chat Messages Timeline Rendering|Chat Messages Timeline Rendering]]
- [[_COMMUNITY_Work Type Routing and Config|Work Type Routing and Config]]
- [[_COMMUNITY_Agent Status RPC Contracts|Agent Status RPC Contracts]]
- [[_COMMUNITY_Dashboard App Sidebar and Metrics|Dashboard App Sidebar and Metrics]]
- [[_COMMUNITY_Chat Composer Model Picker|Chat Composer Model Picker]]
- [[_COMMUNITY_Cloister Config Deep Merge|Cloister Config Deep Merge]]
- [[_COMMUNITY_Workspace Metadata and Project Config|Workspace Metadata and Project Config]]
- [[_COMMUNITY_Cloister Service Handoff Logging|Cloister Service Handoff Logging]]
- [[_COMMUNITY_Workspace and Version API Routes|Workspace and Version API Routes]]
- [[_COMMUNITY_Model Selection and Subscription Policy|Model Selection and Subscription Policy]]
- [[_COMMUNITY_Project Resolution and Review Enrichment|Project Resolution and Review Enrichment]]
- [[_COMMUNITY_Codex Agent Spawn UI Flow|Codex Agent Spawn UI Flow]]
- [[_COMMUNITY_VBrief Task Readiness and Beads IO|VBrief Task Readiness and Beads IO]]
- [[_COMMUNITY_Config Loading and Merging|Config Loading and Merging]]
- [[_COMMUNITY_Platform Supervisor Startup Lifecycle|Platform Supervisor Startup Lifecycle]]
- [[_COMMUNITY_Settings Provider and Model Browser UI|Settings Provider and Model Browser UI]]
- [[_COMMUNITY_Multi-Tool Sync and MCP Isolation|Multi-Tool Sync and MCP Isolation]]
- [[_COMMUNITY_Issue Tracker Polling Service|Issue Tracker Polling Service]]
- [[_COMMUNITY_Fly Remote Provider and API Client|Fly Remote Provider and API Client]]
- [[_COMMUNITY_Settings Page Model Override and Auth|Settings Page Model Override and Auth]]
- [[_COMMUNITY_Permission Request Bridge and Forwarding|Permission Request Bridge and Forwarding]]
- [[_COMMUNITY_Issue Lifecycle Service and Tests|Issue Lifecycle Service and Tests]]
- [[_COMMUNITY_System Health and Spawn Guardrails|System Health and Spawn Guardrails]]
- [[_COMMUNITY_Server Cache Service and Chat Markdown|Server Cache Service and Chat Markdown]]
- [[_COMMUNITY_Diff Panel Rendering and Theming|Diff Panel Rendering and Theming]]
- [[_COMMUNITY_Agent List and Handoff Status UI|Agent List and Handoff Status UI]]
- [[_COMMUNITY_GitHub Webhook Ingestion Handlers|GitHub Webhook Ingestion Handlers]]
- [[_COMMUNITY_GitHub Client and Agent Spawner|GitHub Client and Agent Spawner]]
- [[_COMMUNITY_Workspace Teardown and Label Cleanup|Workspace Teardown and Label Cleanup]]
- [[_COMMUNITY_Swarm Dispatch and DAG Execution|Swarm Dispatch and DAG Execution]]
- [[_COMMUNITY_Settings Persistence and Model Defaults|Settings Persistence and Model Defaults]]
- [[_COMMUNITY_Multi-Tracker Runtime Adapter Interface|Multi-Tracker Runtime Adapter Interface]]
- [[_COMMUNITY_Resource Process Discovery and Reporting|Resource Process Discovery and Reporting]]
- [[_COMMUNITY_Merge Queue and App Settings Database|Merge Queue and App Settings Database]]
- [[_COMMUNITY_Checkpoint Capture and Diff Routes|Checkpoint Capture and Diff Routes]]
- [[_COMMUNITY_Path Constants and Postinstall Setup|Path Constants and Postinstall Setup]]
- [[_COMMUNITY_Cost Recovery Scripts and Latency Tests|Cost Recovery Scripts and Latency Tests]]
- [[_COMMUNITY_Activity Panel and VTT Parsing|Activity Panel and VTT Parsing]]
- [[_COMMUNITY_Read Model Enrichment and Agent Snapshots|Read Model Enrichment and Agent Snapshots]]
- [[_COMMUNITY_Resource-Allocated Issue Discovery|Resource-Allocated Issue Discovery]]
- [[_COMMUNITY_Skills Merge and Manifest Sync|Skills Merge and Manifest Sync]]
- [[_COMMUNITY_Specialist Commands and VBrief Index|Specialist Commands and VBrief Index]]
- [[_COMMUNITY_Model Routing and Complexity Detection|Model Routing and Complexity Detection]]
- [[_COMMUNITY_Issue Search Modal and Filter State|Issue Search Modal and Filter State]]
- [[_COMMUNITY_Plan DAG Visualization and Beads Panel|Plan DAG Visualization and Beads Panel]]
- [[_COMMUNITY_Conversation Compaction and Fork Pipeline|Conversation Compaction and Fork Pipeline]]
- [[_COMMUNITY_Cloister Orchestrator Architecture PRDs|Cloister Orchestrator Architecture PRDs]]
- [[_COMMUNITY_CLI Command Taxonomy Reorganization|CLI Command Taxonomy Reorganization]]
- [[_COMMUNITY_Work Agent Prompt and Reopen Flow|Work Agent Prompt and Reopen Flow]]
- [[_COMMUNITY_Frontend Dashboard Component Tests|Frontend Dashboard Component Tests]]
- [[_COMMUNITY_Cliproxy Process Lifecycle Management|Cliproxy Process Lifecycle Management]]
- [[_COMMUNITY_Multi-Tracker Adapter Implementations|Multi-Tracker Adapter Implementations]]
- [[_COMMUNITY_Event Snapshot Cache and State Reducers|Event Snapshot Cache and State Reducers]]
- [[_COMMUNITY_User Documentation and Provider Guides|User Documentation and Provider Guides]]
- [[_COMMUNITY_Traefik DNS and Platform Install Skills|Traefik DNS and Platform Install Skills]]
- [[_COMMUNITY_Command Deck Action Registry Pipeline|Command Deck Action Registry Pipeline]]
- [[_COMMUNITY_Rally Tracker Adapter Tests|Rally Tracker Adapter Tests]]
- [[_COMMUNITY_Conversation Panel and Chat Phase Types|Conversation Panel and Chat Phase Types]]
- [[_COMMUNITY_Database Settings and Cost Unit Tests|Database Settings and Cost Unit Tests]]
- [[_COMMUNITY_Desktop Menu and Auto-Updater Lifecycle|Desktop Menu and Auto-Updater Lifecycle]]
- [[_COMMUNITY_Issue ID Parsing and Agent Cleanup|Issue ID Parsing and Agent Cleanup]]
- [[_COMMUNITY_Project Config and Team Prefix Resolution|Project Config and Team Prefix Resolution]]
- [[_COMMUNITY_Cost Data Migration and Reconciliation|Cost Data Migration and Reconciliation]]
- [[_COMMUNITY_Claude OAuth Authentication and Settings|Claude OAuth Authentication and Settings]]
- [[_COMMUNITY_PTY Terminal Hub WebSocket Streaming|PTY Terminal Hub WebSocket Streaming]]
- [[_COMMUNITY_Issue Tracker Linking Tests|Issue Tracker Linking Tests]]
- [[_COMMUNITY_Release and Update CLI Commands|Release and Update CLI Commands]]
- [[_COMMUNITY_Config Migration and Test Agent|Config Migration and Test Agent]]
- [[_COMMUNITY_Specialist Agent Health Dashboard UI|Specialist Agent Health Dashboard UI]]
- [[_COMMUNITY_Cloister Pipeline Unit Tests|Cloister Pipeline Unit Tests]]
- [[_COMMUNITY_Project Registration and Test Runner|Project Registration and Test Runner]]
- [[_COMMUNITY_Issue Planning and Tracker Resolution|Issue Planning and Tracker Resolution]]
- [[_COMMUNITY_TLDR Daemon State Management|TLDR Daemon State Management]]
- [[_COMMUNITY_Specialist Pipeline PRDs and Skills|Specialist Pipeline PRDs and Skills]]
- [[_COMMUNITY_Cost Event Storage and WAL Tests|Cost Event Storage and WAL Tests]]
- [[_COMMUNITY_Smee Webhook Proxy Process Management|Smee Webhook Proxy Process Management]]
- [[_COMMUNITY_Merge Set and Review Artifact Creation|Merge Set and Review Artifact Creation]]
- [[_COMMUNITY_Specialist Agent Prompts and Audit Docs|Specialist Agent Prompts and Audit Docs]]
- [[_COMMUNITY_Agent Hook Scripts and Repo Artifact Design|Agent Hook Scripts and Repo Artifact Design]]
- [[_COMMUNITY_vBRIEF Continue State and Feedback Writing|vBRIEF Continue State and Feedback Writing]]
- [[_COMMUNITY_Caveman Hooks and Workspace Setup|Caveman Hooks and Workspace Setup]]
- [[_COMMUNITY_FPP Policy Violation Detection and Nudging|FPP Policy Violation Detection and Nudging]]
- [[_COMMUNITY_Dashboard Terminal UI Components|Dashboard Terminal UI Components]]
- [[_COMMUNITY_TTS Daemon and Pi Extension Supervisor|TTS Daemon and Pi Extension Supervisor]]
- [[_COMMUNITY_Reviewer Tree and Command Deck Dashboard|Reviewer Tree and Command Deck Dashboard]]
- [[_COMMUNITY_Agent Health Event Persistence|Agent Health Event Persistence]]
- [[_COMMUNITY_Electron Desktop App Launch Scripts|Electron Desktop App Launch Scripts]]
- [[_COMMUNITY_Specialist Run Log Lifecycle|Specialist Run Log Lifecycle]]
- [[_COMMUNITY_Remote Agent Provisioning on Fly|Remote Agent Provisioning on Fly]]
- [[_COMMUNITY_Claude Code Hook Management|Claude Code Hook Management]]
- [[_COMMUNITY_AI Provider Health Probing|AI Provider Health Probing]]
- [[_COMMUNITY_Rally Tracker API Integration|Rally Tracker API Integration]]
- [[_COMMUNITY_Conversation Smart Compaction|Conversation Smart Compaction]]
- [[_COMMUNITY_Conversation Attachment Lifecycle Management|Conversation Attachment Lifecycle Management]]
- [[_COMMUNITY_Configuration Documentation|Configuration Documentation]]
- [[_COMMUNITY_Core Project Docs and Scripts|Core Project Docs and Scripts]]
- [[_COMMUNITY_Parallel Code Review Prompt Templates|Parallel Code Review Prompt Templates]]
- [[_COMMUNITY_Shadow Engineering Observer and Monitoring|Shadow Engineering Observer and Monitoring]]
- [[_COMMUNITY_Model Fallback and Routing|Model Fallback and Routing]]
- [[_COMMUNITY_GitHub App Merge and PR Integration|GitHub App Merge and PR Integration]]
- [[_COMMUNITY_Operational CLI Skills and WSL Infra|Operational CLI Skills and WSL Infra]]
- [[_COMMUNITY_Dashboard Screenshots and Brand Assets|Dashboard Screenshots and Brand Assets]]
- [[_COMMUNITY_UI Design Assets and Screen Exports|UI Design Assets and Screen Exports]]
- [[_COMMUNITY_Issue State Mapping and Workflow Labels|Issue State Mapping and Workflow Labels]]
- [[_COMMUNITY_Issue Lifecycle Workflow Execution|Issue Lifecycle Workflow Execution]]
- [[_COMMUNITY_PRD Archiving and Issue Close Out|PRD Archiving and Issue Close Out]]
- [[_COMMUNITY_Skill Sync Mirror Tests|Skill Sync Mirror Tests]]
- [[_COMMUNITY_PRD Draft and Pan Directory Management|PRD Draft and Pan Directory Management]]
- [[_COMMUNITY_Claude Session JSONL Parsing and Costs|Claude Session JSONL Parsing and Costs]]
- [[_COMMUNITY_Shadow Mode Issue Tracking|Shadow Mode Issue Tracking]]
- [[_COMMUNITY_Command Deck Resource Discovery API|Command Deck Resource Discovery API]]
- [[_COMMUNITY_Dashboard Server Architecture Guidelines|Dashboard Server Architecture Guidelines]]
- [[_COMMUNITY_Remote Workspace Provider Skills|Remote Workspace Provider Skills]]
- [[_COMMUNITY_Agent Inspect Checkpoint Management|Agent Inspect Checkpoint Management]]
- [[_COMMUNITY_Specialist Log Viewing and Cleanup|Specialist Log Viewing and Cleanup]]
- [[_COMMUNITY_Chat Composer Slash Command Editor|Chat Composer Slash Command Editor]]
- [[_COMMUNITY_Dashboard Entry Point and Cost Formatting|Dashboard Entry Point and Cost Formatting]]
- [[_COMMUNITY_Test Agent Dispatch and Recovery Tests|Test Agent Dispatch and Recovery Tests]]
- [[_COMMUNITY_Specialist Handoff Logging and Queue Depth|Specialist Handoff Logging and Queue Depth]]
- [[_COMMUNITY_Specialist Registry and Run Lifecycle|Specialist Registry and Run Lifecycle]]
- [[_COMMUNITY_Doctor Health Check and Path Resolution|Doctor Health Check and Path Resolution]]
- [[_COMMUNITY_Feature Context and Planning Session Spawn|Feature Context and Planning Session Spawn]]
- [[_COMMUNITY_Cloister Service Start Stop Status|Cloister Service Start Stop Status]]
- [[_COMMUNITY_Agent Card Model Defaults Display|Agent Card Model Defaults Display]]
- [[_COMMUNITY_Command Deck Issue Workbench UI|Command Deck Issue Workbench UI]]
- [[_COMMUNITY_Workspace Service and Agent Spawner Tests|Workspace Service and Agent Spawner Tests]]
- [[_COMMUNITY_CLI Command Taxonomy Reorganization PRD|CLI Command Taxonomy Reorganization PRD]]
- [[_COMMUNITY_Dangerous Git Operations Safety Guards|Dangerous Git Operations Safety Guards]]
- [[_COMMUNITY_Agent CV and Show Commands|Agent CV and Show Commands]]
- [[_COMMUNITY_Git Push Operations and Approval|Git Push Operations and Approval]]
- [[_COMMUNITY_Specialist Workflow Documentation and Gates|Specialist Workflow Documentation and Gates]]
- [[_COMMUNITY_Model Routing and Specialist Redesign Research|Model Routing and Specialist Redesign Research]]
- [[_COMMUNITY_Panopticon Introduction and Pipeline Overview|Panopticon Introduction and Pipeline Overview]]
- [[_COMMUNITY_Cloister Prompt Loading and Parsing|Cloister Prompt Loading and Parsing]]
- [[_COMMUNITY_Specialist Context Digest Generation|Specialist Context Digest Generation]]
- [[_COMMUNITY_Agent Cost Monitoring and Limit Enforcement|Agent Cost Monitoring and Limit Enforcement]]
- [[_COMMUNITY_Context History Logging and Search|Context History Logging and Search]]
- [[_COMMUNITY_Turn Diff File Change Tree UI|Turn Diff File Change Tree UI]]
- [[_COMMUNITY_Prerequisite Tool Installation Registry|Prerequisite Tool Installation Registry]]
- [[_COMMUNITY_Pan CLI Skills and Lifecycle Verbs|Pan CLI Skills and Lifecycle Verbs]]
- [[_COMMUNITY_Project Living Memory PRD|Project Living Memory PRD]]
- [[_COMMUNITY_Work Done Preflight Validation|Work Done Preflight Validation]]
- [[_COMMUNITY_Skill Sync and Legacy Skill Removal|Skill Sync and Legacy Skill Removal]]
- [[_COMMUNITY_Review Workflow Command Coordination|Review Workflow Command Coordination]]
- [[_COMMUNITY_Issue Filtering and Model Fallback Tests|Issue Filtering and Model Fallback Tests]]
- [[_COMMUNITY_Git Forge PR and MR Artifact Creation|Git Forge PR and MR Artifact Creation]]
- [[_COMMUNITY_Linear API Client Integration|Linear API Client Integration]]
- [[_COMMUNITY_Self Improving Flywheel and Agent Messaging|Self Improving Flywheel and Agent Messaging]]
- [[_COMMUNITY_Workspace Manager Artifact Migration|Workspace Manager Artifact Migration]]
- [[_COMMUNITY_Project Skills Mirror and Sync|Project Skills Mirror and Sync]]
- [[_COMMUNITY_Agent Grid Dashboard UI Components|Agent Grid Dashboard UI Components]]
- [[_COMMUNITY_Codex Authentication and Credential Management|Codex Authentication and Credential Management]]
- [[_COMMUNITY_Pending Feedback Queue Delivery|Pending Feedback Queue Delivery]]
- [[_COMMUNITY_Workflow Orchestration and vBRIEF Research|Workflow Orchestration and vBRIEF Research]]
- [[_COMMUNITY_Agent Types Pipeline Documentation|Agent Types Pipeline Documentation]]
- [[_COMMUNITY_Tmux Capture Pane Elimination PRD|Tmux Capture Pane Elimination PRD]]
- [[_COMMUNITY_CLI Option Parsing and Fixture Tests|CLI Option Parsing and Fixture Tests]]
- [[_COMMUNITY_Multi Tool Skill Sync Export|Multi Tool Skill Sync Export]]
- [[_COMMUNITY_Pi Session Cost Parser|Pi Session Cost Parser]]
- [[_COMMUNITY_Cost Session Map and Issue Totals|Cost Session Map and Issue Totals]]
- [[_COMMUNITY_Dashboard WebSocket RPC Client Transport|Dashboard WebSocket RPC Client Transport]]
- [[_COMMUNITY_Project Repository Resolution|Project Repository Resolution]]
- [[_COMMUNITY_Merge Queue Display and Relative Time Tests|Merge Queue Display and Relative Time Tests]]
- [[_COMMUNITY_Desktop App Bridge and Notifications|Desktop App Bridge and Notifications]]
- [[_COMMUNITY_Command Deck UI Design Specs|Command Deck UI Design Specs]]
- [[_COMMUNITY_Fix-All Flywheel Operational Docs|Fix-All Flywheel Operational Docs]]
- [[_COMMUNITY_CLI Init and Shell Configuration|CLI Init and Shell Configuration]]
- [[_COMMUNITY_Verification Runner and Sync Pipeline|Verification Runner and Sync Pipeline]]
- [[_COMMUNITY_Agent Launcher Command Generation|Agent Launcher Command Generation]]
- [[_COMMUNITY_Deacon Cleanup and Agent Status Tests|Deacon Cleanup and Agent Status Tests]]
- [[_COMMUNITY_Cloister Service Health Tests|Cloister Service Health Tests]]
- [[_COMMUNITY_Shadow State Refresh Commands|Shadow State Refresh Commands]]
- [[_COMMUNITY_Issue Tracker Factory and Priority|Issue Tracker Factory and Priority]]
- [[_COMMUNITY_Dashboard Event Reducers Tests|Dashboard Event Reducers Tests]]
- [[_COMMUNITY_Caveman Skill Compression Validation|Caveman Skill Compression Validation]]
- [[_COMMUNITY_JSONL Path Resolution and Activity Fetching|JSONL Path Resolution and Activity Fetching]]
- [[_COMMUNITY_Dashboard Mutation Origin Validation|Dashboard Mutation Origin Validation]]
- [[_COMMUNITY_Git Divergence and Conversation Patch Tests|Git Divergence and Conversation Patch Tests]]
- [[_COMMUNITY_LLM Work Type Fit Research|LLM Work Type Fit Research]]
- [[_COMMUNITY_Beads Issue Tracking Skill Docs|Beads Issue Tracking Skill Docs]]
- [[_COMMUNITY_Workspace Pan Directory State Management|Workspace Pan Directory State Management]]
- [[_COMMUNITY_Fly Machine API Client|Fly Machine API Client]]
- [[_COMMUNITY_Caveman File Type Detection CLI|Caveman File Type Detection CLI]]
- [[_COMMUNITY_Agent Enrichment and Context Resolution|Agent Enrichment and Context Resolution]]
- [[_COMMUNITY_Cost Tracking Architecture Docs|Cost Tracking Architecture Docs]]
- [[_COMMUNITY_Diagnostic and Incident Response Skills|Diagnostic and Incident Response Skills]]
- [[_COMMUNITY_Contracts Types RPC and Desktop Package|Contracts Types RPC and Desktop Package]]
- [[_COMMUNITY_Command Deck Screenshots and Branding|Command Deck Screenshots and Branding]]
- [[_COMMUNITY_Desktop Build and Monorepo Release Tests|Desktop Build and Monorepo Release Tests]]
- [[_COMMUNITY_Work Done and Rebase Pipeline Tests|Work Done and Rebase Pipeline Tests]]
- [[_COMMUNITY_Workspace Backup and Restore Commands|Workspace Backup and Restore Commands]]
- [[_COMMUNITY_Agent Activity View Dashboard Components|Agent Activity View Dashboard Components]]
- [[_COMMUNITY_Provider Environment Settings Overlay|Provider Environment Settings Overlay]]
- [[_COMMUNITY_Multi-Model Settings E2E Tests|Multi-Model Settings E2E Tests]]
- [[_COMMUNITY_Cloister Watchdog and Merge Validation Docs|Cloister Watchdog and Merge Validation Docs]]
- [[_COMMUNITY_Review Test Merge Pipeline Docs|Review Test Merge Pipeline Docs]]
- [[_COMMUNITY_Parallel Code Review Skills|Parallel Code Review Skills]]
- [[_COMMUNITY_Git Lock File Utilities|Git Lock File Utilities]]
- [[_COMMUNITY_Workspace Teardown and Reopen Tests|Workspace Teardown and Reopen Tests]]
- [[_COMMUNITY_File and Editor Open Commands|File and Editor Open Commands]]
- [[_COMMUNITY_UI and Diff Preferences Persistence|UI and Diff Preferences Persistence]]
- [[_COMMUNITY_Pending Lifecycle Event Processing|Pending Lifecycle Event Processing]]
- [[_COMMUNITY_OpenAI Auth and Cliproxy Bridge|OpenAI Auth and Cliproxy Bridge]]
- [[_COMMUNITY_Electron Desktop App Docs|Electron Desktop App Docs]]
- [[_COMMUNITY_Agent Prompt Hardening and Decision Locking|Agent Prompt Hardening and Decision Locking]]
- [[_COMMUNITY_Dashboard Bootstrap and Projection Cache Specs|Dashboard Bootstrap and Projection Cache Specs]]
- [[_COMMUNITY_Release Pipeline and CLIProxy Docs|Release Pipeline and CLIProxy Docs]]
- [[_COMMUNITY_Label Cleanup and Workflow Lifecycle Tests|Label Cleanup and Workflow Lifecycle Tests]]
- [[_COMMUNITY_Pi Extension Session Event Handlers|Pi Extension Session Event Handlers]]
- [[_COMMUNITY_Skill Creator Init and Package Scripts|Skill Creator Init and Package Scripts]]
- [[_COMMUNITY_vBRIEF Plan Format and Lifecycle|vBRIEF Plan Format and Lifecycle]]
- [[_COMMUNITY_Active Planning PRDs and vBRIEF Integration|Active Planning PRDs and vBRIEF Integration]]
- [[_COMMUNITY_Agent Completion Detection and Cleanup|Agent Completion Detection and Cleanup]]
- [[_COMMUNITY_Spec Readiness Skill and Scoring|Spec Readiness Skill and Scoring]]
- [[_COMMUNITY_Traefik and Docker Workspace Templates|Traefik and Docker Workspace Templates]]
- [[_COMMUNITY_Specialist Agent Pipeline and Commands|Specialist Agent Pipeline and Commands]]
- [[_COMMUNITY_Specialist Pipeline Dashboard UI|Specialist Pipeline Dashboard UI]]
- [[_COMMUNITY_CLI Entry Point and Build Scripts|CLI Entry Point and Build Scripts]]
- [[_COMMUNITY_Command Deck Resource Discovery|Command Deck Resource Discovery]]
- [[_COMMUNITY_Work Reopen Command Tests|Work Reopen Command Tests]]
- [[_COMMUNITY_System Health Command and CLI Tests|System Health Command and CLI Tests]]
- [[_COMMUNITY_Project Setup and Polyrepo Workspace PRDs|Project Setup and Polyrepo Workspace PRDs]]
- [[_COMMUNITY_Panopticon 1.0 Stabilization Audit|Panopticon 1.0 Stabilization Audit]]
- [[_COMMUNITY_tmux Async Delivery and Terminal Performance|tmux Async Delivery and Terminal Performance]]
- [[_COMMUNITY_God View Agent Cards and Activity Tree|God View Agent Cards and Activity Tree]]
- [[_COMMUNITY_Issue Triage Agent and Analysis|Issue Triage Agent and Analysis]]
- [[_COMMUNITY_Ephemeral Specialist UI Tests|Ephemeral Specialist UI Tests]]
- [[_COMMUNITY_Running Agents Cache Service|Running Agents Cache Service]]
- [[_COMMUNITY_Cost Tracking Hooks and Reconciliation|Cost Tracking Hooks and Reconciliation]]
- [[_COMMUNITY_Conversation Panel and Timeline PRDs|Conversation Panel and Timeline PRDs]]
- [[_COMMUNITY_Mission Control and Message Persistence PRDs|Mission Control and Message Persistence PRDs]]
- [[_COMMUNITY_Dashboard Push Architecture and WebSocket RPC|Dashboard Push Architecture and WebSocket RPC]]
- [[_COMMUNITY_Beads Chemistry Patterns and Agent Tracking|Beads Chemistry Patterns and Agent Tracking]]
- [[_COMMUNITY_Command Deck Overview Playwright Snapshots|Command Deck Overview Playwright Snapshots]]
- [[_COMMUNITY_Issue Tracker Admin State Management|Issue Tracker Admin State Management]]
- [[_COMMUNITY_Agent Show Command Tests|Agent Show Command Tests]]
- [[_COMMUNITY_Environment File Loading and API Keys|Environment File Loading and API Keys]]
- [[_COMMUNITY_PTY Terminal Service and XTerminal Tests|PTY Terminal Service and XTerminal Tests]]
- [[_COMMUNITY_Feature Metadata Badge and Modal Components|Feature Metadata Badge and Modal Components]]
- [[_COMMUNITY_Dashboard Caching Architecture Docs|Dashboard Caching Architecture Docs]]
- [[_COMMUNITY_vBRIEF Types Builder and Viewer|vBRIEF Types Builder and Viewer]]
- [[_COMMUNITY_Conversation Terminal Integration Refactor|Conversation Terminal Integration Refactor]]
- [[_COMMUNITY_God View Dashboard Layout and API|God View Dashboard Layout and API]]
- [[_COMMUNITY_Beads Dependencies Async Gates and Workflows|Beads Dependencies Async Gates and Workflows]]
- [[_COMMUNITY_AI Model Capability Research Framework|AI Model Capability Research Framework]]
- [[_COMMUNITY_Model Routing Changelog and Configuration|Model Routing Changelog and Configuration]]
- [[_COMMUNITY_Command Deck Redesign Zone Layout|Command Deck Redesign Zone Layout]]
- [[_COMMUNITY_Issue Triage State Persistence|Issue Triage State Persistence]]
- [[_COMMUNITY_Hook Ordering and Lifecycle Tests|Hook Ordering and Lifecycle Tests]]
- [[_COMMUNITY_Specialist Completion Tracking|Specialist Completion Tracking]]
- [[_COMMUNITY_External SSE Event Stream and God View|External SSE Event Stream and God View]]
- [[_COMMUNITY_Implementation Gaps Audit and Metrics PRD|Implementation Gaps Audit and Metrics PRD]]
- [[_COMMUNITY_Remote Workspace Parity and Migration PRDs|Remote Workspace Parity and Migration PRDs]]
- [[_COMMUNITY_Multi-Model Runtime Consolidation PRDs|Multi-Model Runtime Consolidation PRDs]]
- [[_COMMUNITY_Test Failure Fix PRDs and Infrastructure|Test Failure Fix PRDs and Infrastructure]]
- [[_COMMUNITY_Dashboard Resources Panel and Settings UI|Dashboard Resources Panel and Settings UI]]
- [[_COMMUNITY_Workspace Config Sync and Skill Definitions|Workspace Config Sync and Skill Definitions]]
- [[_COMMUNITY_Caveman Variant Config and Specialist Tests|Caveman Variant Config and Specialist Tests]]
- [[_COMMUNITY_Agent Queue Position Calculation|Agent Queue Position Calculation]]
- [[_COMMUNITY_Kanban Board UI Screenshots|Kanban Board UI Screenshots]]
- [[_COMMUNITY_Git Rebase and Conflict Resolution|Git Rebase and Conflict Resolution]]
- [[_COMMUNITY_Experimental Channels Toggle Tests|Experimental Channels Toggle Tests]]
- [[_COMMUNITY_OpenRouter Model Classification Service|OpenRouter Model Classification Service]]
- [[_COMMUNITY_Issue Cost Resolution and Normalization|Issue Cost Resolution and Normalization]]
- [[_COMMUNITY_Settings UI Redesign Design Spec|Settings UI Redesign Design Spec]]
- [[_COMMUNITY_Fizzy Kanban Visual Pipeline Integration|Fizzy Kanban Visual Pipeline Integration]]
- [[_COMMUNITY_God View Real-Time Agent Dashboard|God View Real-Time Agent Dashboard]]
- [[_COMMUNITY_Agent Enrichment and Phase Detection|Agent Enrichment and Phase Detection]]
- [[_COMMUNITY_TTS Sidecar Audio Notification System|TTS Sidecar Audio Notification System]]
- [[_COMMUNITY_Agent Benchmark Framework and Results|Agent Benchmark Framework and Results]]
- [[_COMMUNITY_Skills CLI Command Listing|Skills CLI Command Listing]]
- [[_COMMUNITY_Heartbeat Event Ingestion Tests|Heartbeat Event Ingestion Tests]]
- [[_COMMUNITY_GitHub App Registration and Webhook Setup|GitHub App Registration and Webhook Setup]]
- [[_COMMUNITY_Python Subagent File Initialization|Python Subagent File Initialization]]
- [[_COMMUNITY_Build Pipeline and Output Structure Docs|Build Pipeline and Output Structure Docs]]
- [[_COMMUNITY_DAG Visualization and Tasks Panel|DAG Visualization and Tasks Panel]]
- [[_COMMUNITY_Fly.io Remote Provider Migration|Fly.io Remote Provider Migration]]
- [[_COMMUNITY_Directive Flow DAG Issue Overview|Directive Flow DAG Issue Overview]]
- [[_COMMUNITY_Workspace Reopen and State Reset|Workspace Reopen and State Reset]]
- [[_COMMUNITY_t3code Architecture Alignment Research|t3code Architecture Alignment Research]]
- [[_COMMUNITY_Skill and Subagent Creator Templates|Skill and Subagent Creator Templates]]
- [[_COMMUNITY_Spec to Plan Pipeline Skills|Spec to Plan Pipeline Skills]]
- [[_COMMUNITY_Test Global Setup Bootstrap|Test Global Setup Bootstrap]]
- [[_COMMUNITY_Agent Feedback Delivery and Logging|Agent Feedback Delivery and Logging]]
- [[_COMMUNITY_Caveman Compression CLI Command|Caveman Compression CLI Command]]
- [[_COMMUNITY_Zone C Dashboard Tab Tests|Zone C Dashboard Tab Tests]]
- [[_COMMUNITY_Specialist Run Log Viewer|Specialist Run Log Viewer]]
- [[_COMMUNITY_Dashboard Motion Animation Catalog|Dashboard Motion Animation Catalog]]
- [[_COMMUNITY_Testing Guide and Conventions Docs|Testing Guide and Conventions Docs]]
- [[_COMMUNITY_Rally Feature Planning Hierarchy UX|Rally Feature Planning Hierarchy UX]]
- [[_COMMUNITY_Multi-Tool Skill Sync Config Migration|Multi-Tool Skill Sync Config Migration]]
- [[_COMMUNITY_Root Artifact Cleanup Policy|Root Artifact Cleanup Policy]]
- [[_COMMUNITY_Post-Merge Auto Deploy Pipeline|Post-Merge Auto Deploy Pipeline]]
- [[_COMMUNITY_Interactive Terminal Panel Integration|Interactive Terminal Panel Integration]]
- [[_COMMUNITY_Agent Lifecycle Status Skills|Agent Lifecycle Status Skills]]
- [[_COMMUNITY_Session Health Monitoring and Thresholds|Session Health Monitoring and Thresholds]]
- [[_COMMUNITY_Merge Approval and Idempotency Guard|Merge Approval and Idempotency Guard]]
- [[_COMMUNITY_Agents Dashboard UI Redesign Mockups|Agents Dashboard UI Redesign Mockups]]
- [[_COMMUNITY_Cost Tracking Dashboard Visualization|Cost Tracking Dashboard Visualization]]
- [[_COMMUNITY_Release Command Parsing Tests|Release Command Parsing Tests]]
- [[_COMMUNITY_Effect API Verification Script|Effect API Verification Script]]
- [[_COMMUNITY_TSX Extension LLM TLDR Patch|TSX Extension LLM TLDR Patch]]
- [[_COMMUNITY_Budget Display Widget Components|Budget Display Widget Components]]
- [[_COMMUNITY_Config Copy CLI Command|Config Copy CLI Command]]
- [[_COMMUNITY_Frontend Fetch Retry with Backoff|Frontend Fetch Retry with Backoff]]
- [[_COMMUNITY_vBRIEF Lifecycle and PRD Workflow|vBRIEF Lifecycle and PRD Workflow]]
- [[_COMMUNITY_Git Checkout Hook Workspace Guard|Git Checkout Hook Workspace Guard]]
- [[_COMMUNITY_Planning Agent Spawn Failure Visibility|Planning Agent Spawn Failure Visibility]]
- [[_COMMUNITY_Tracker Context Injection on Agent Restart|Tracker Context Injection on Agent Restart]]
- [[_COMMUNITY_Effect Route Handler Idiomatic Rewrite|Effect Route Handler Idiomatic Rewrite]]
- [[_COMMUNITY_Rally WSAPI Query Parser Fix|Rally WSAPI Query Parser Fix]]
- [[_COMMUNITY_Convoy Parallel Agent Synthesis|Convoy Parallel Agent Synthesis]]
- [[_COMMUNITY_Agent Work Skill Conventions|Agent Work Skill Conventions]]
- [[_COMMUNITY_Plan Difficulty Estimation Tests|Plan Difficulty Estimation Tests]]
- [[_COMMUNITY_Agent Health Runtime State Tests|Agent Health Runtime State Tests]]
- [[_COMMUNITY_Stitch React Component Template|Stitch React Component Template]]
- [[_COMMUNITY_Desktop Build Configuration|Desktop Build Configuration]]
- [[_COMMUNITY_Caveman Language Compression|Caveman Language Compression]]
- [[_COMMUNITY_Coding Agent Harness Policy|Coding Agent Harness Policy]]
- [[_COMMUNITY_Issue Tracker Project Resolution|Issue Tracker Project Resolution]]
- [[_COMMUNITY_Review Status State Machine|Review Status State Machine]]
- [[_COMMUNITY_CLI Command Set Fixture|CLI Command Set Fixture]]
- [[_COMMUNITY_Synced Skills List Fixture|Synced Skills List Fixture]]
- [[_COMMUNITY_Planning Dialog Confirm Replacement|Planning Dialog Confirm Replacement]]
- [[_COMMUNITY_Gemini Model Work Type Analysis|Gemini Model Work Type Analysis]]
- [[_COMMUNITY_Agent Health Monitor States|Agent Health Monitor States]]
- [[_COMMUNITY_Workspace Status Display Skill|Workspace Status Display Skill]]
- [[_COMMUNITY_Work Completion Checklist Skill|Work Completion Checklist Skill]]
- [[_COMMUNITY_GitHub CLI Reference Skill|GitHub CLI Reference Skill]]
- [[_COMMUNITY_Docker DotNet Template|Docker DotNet Template]]
- [[_COMMUNITY_Library Test Suite Docs|Library Test Suite Docs]]
- [[_COMMUNITY_Zone C Tabs UI Issue|Zone C Tabs UI Issue]]
- [[_COMMUNITY_Convoys Page UI Reference|Convoys Page UI Reference]]
- [[_COMMUNITY_Commit Lint Configuration|Commit Lint Configuration]]
- [[_COMMUNITY_Vitest Workspace Configuration|Vitest Workspace Configuration]]
- [[_COMMUNITY_Review Debug Script|Review Debug Script]]
- [[_COMMUNITY_Planning Handoff Completion Tests|Planning Handoff Completion Tests]]
- [[_COMMUNITY_Dashboard Navigation Layout Tests|Dashboard Navigation Layout Tests]]
- [[_COMMUNITY_Linear Issue States Tests|Linear Issue States Tests]]
- [[_COMMUNITY_Issue Beads Enforcement Tests|Issue Beads Enforcement Tests]]
- [[_COMMUNITY_Cost Event Recording Types|Cost Event Recording Types]]
- [[_COMMUNITY_Harness Integration Tests|Harness Integration Tests]]
- [[_COMMUNITY_Dashboard Tailwind CSS Config|Dashboard Tailwind CSS Config]]
- [[_COMMUNITY_Dashboard PostCSS Configuration|Dashboard PostCSS Configuration]]
- [[_COMMUNITY_Dashboard Playwright Test Config|Dashboard Playwright Test Config]]
- [[_COMMUNITY_Dashboard Frontend Vite Config|Dashboard Frontend Vite Config]]
- [[_COMMUNITY_Dashboard Vite Environment Types|Dashboard Vite Environment Types]]
- [[_COMMUNITY_Dashboard Header Skeleton Component|Dashboard Header Skeleton Component]]
- [[_COMMUNITY_Smart Selection Explainer UI|Smart Selection Explainer UI]]
- [[_COMMUNITY_Universal Skills Documentation|Universal Skills Documentation]]
- [[_COMMUNITY_Convoy Parallel Runs Concept|Convoy Parallel Runs Concept]]
- [[_COMMUNITY_JSONL Session File Protection|JSONL Session File Protection]]
- [[_COMMUNITY_Multi-Model Agent Routing|Multi-Model Agent Routing]]
- [[_COMMUNITY_End-to-End Test Fixture|End-to-End Test Fixture]]
- [[_COMMUNITY_Handoff Flow Test Fixture|Handoff Flow Test Fixture]]
- [[_COMMUNITY_Specialist Flow Test Fixture|Specialist Flow Test Fixture]]
- [[_COMMUNITY_Multi-Agent Orchestration PRD|Multi-Agent Orchestration PRD]]
- [[_COMMUNITY_PRD Pipeline Test Marker|PRD Pipeline Test Marker]]
- [[_COMMUNITY_Planning Completion Trace Investigation|Planning Completion Trace Investigation]]
- [[_COMMUNITY_Command Deck Sidebar Width Fix|Command Deck Sidebar Width Fix]]
- [[_COMMUNITY_Review Agent Feedback Planning|Review Agent Feedback Planning]]
- [[_COMMUNITY_CLAUDE MD Commands Skills Template|CLAUDE MD Commands Skills Template]]
- [[_COMMUNITY_Configuration Precedence Documentation|Configuration Precedence Documentation]]
- [[_COMMUNITY_LLM Model Research Summary|LLM Model Research Summary]]
...
1. `string()` - 317 edges
2. `specialists` - 257 edges
3. `fetch` - 249 edges
4. `ConversationEvent` - 232 edges
5. `execAsync` - 224 edges
6. `resolveProjectFromIssue()` - 151 edges
7. `KanbanBoard()` - 138 edges
8. `resolveProjectFromIssueSync()` - 129 edges
9. `config` - 121 edges
10. `getDatabase()` - 118 edges

## Surprising Connections (you probably didn't know these)
- `exists()` --calls--> `Access`  [INFERRED]
  tests/unit/dashboard/server/routes/context.test.ts → docs/god-view.md
...
## Communities (1417 total, 69 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (289): ComplexityLevel, cleanupSpawnAndOrphanedStashes(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise() (+281 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (236): readCavemanVariant(), checkFailedMergeRetry(), getSpecialistState(), createSpecialistHandoff(), appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs() (+228 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.01
Nodes (188): ActivityView(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket (+180 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (194): isAgentIdleForNudge(), StuckRemediationConfig, addLog(), apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+186 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (169): ~/.panopticon/agents/ State Directory, Agent Directory Structure, checkCostLimits(), getCostSummary(), checkPendingTestDispatch(), checkUndispatchedShip(), activeViolations, checkAgentForViolations() (+161 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (190): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter() (+182 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (125): getProjectDirsSync(), getSessionFiles(), parseClaudeSession(), parseClaudeSessionSync(), SessionUsage, emptyUsage(), isAssistantMessage(), isMessage() (+117 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.03
Nodes (197): __dirname, __filename, spawnInspectAgent(), spawnInspectAgentPromise(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildProviderExportLines() (+189 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.01
Nodes (159): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, calculateCost(), catchCause, catchIf (+151 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (169): checkCompletedButUnsignaledReviews(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPostReviewCommits(), checkStuckReviewing(), killOrphanedWorkspaceProcesses(), archiveReviewerRound(), buildConvoyPrompt() (+161 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (139): checkApiErrorAgents(), cleanupAbandonedFeedback(), cleanupStaleAgentState(), isMergeAgentRunning(), isCoordinatorAliveAsync(), agentStatusCommand(), AgentStatusOptions, analyzeSession() (+131 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (118): DrawerActivityRail(), ArtifactFilter, ArtifactSort, artifactTitle(), sortArtifacts(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS (+110 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.03
Nodes (129): Work Agent (shown in inspector terminal), switchModel(), ComposerMode, deriveComposerMode(), IssueComposer(), IssueComposerProps, PlanningState, useZoneAActions() (+121 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.05
Nodes (140): pruneCheckpointRefsForAgents(), postMergeLifecycle(), killTmuxSession(), content, mockExeca, CloseOutContext, CloseOutError, CloseOutResult (+132 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.02
Nodes (149): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+141 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (118): determineCavemanVariant(), injectCavemanSettings(), createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch() (+110 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (116): artifactTabs, dialogActionKeys, IssueActionDialogState, IssueActionLayout, PostActionInput, ActionKey, ActionLayout, derivePipelineState() (+108 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.03
Nodes (133): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+125 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.03
Nodes (116): mockClaudeSkills, contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion() (+108 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (118): transitionIssueToVerifyingOnMain(), getCavemanExperimentData(), rows, httpHandler(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape (+110 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.02
Nodes (130): parseDifficultyLabel(), LiveLastHeard(), BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+122 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.02
Nodes (112): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+104 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.02
Nodes (101): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+93 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (115): ActivityViewProps, CostByStage, fetchActivity(), RallyStoriesSection(), statusDotColor(), registerAdminCommands(), archiveCustomState(), CleanupOptions (+107 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.04
Nodes (109): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), createCostCommand(), cleanFile() (+101 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.04
Nodes (111): detectMergedSwarmSlots(), parseSlotBranch(), approveCommand(), cancelCommand(), completeCommand(), formatTransition(), getProjectPath(), pad() (+103 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.04
Nodes (108): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+100 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (115): execFileAsync, reconcileStaleMergeStatus(), captureFiles(), confirmDropRecovery(), difficultyColor(), dryRun(), isSwarmRecoverAction(), printActiveSliceForIssue() (+107 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (104): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), derivePlanningIssueId(), fetchOutput() (+96 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.04
Nodes (112): API_ERROR_PATTERNS, Command Deck (Core Concept), Access, DEFAULT_SPECIALIST_CONFIG, findProjectByPathEffect(), findProjectByTeamEffect(), getProjectEffect(), hasProjectsEffect() (+104 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (109): logNonCanonicalStashesOnStartup(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+101 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.04
Nodes (107): extractAcceptanceCriteria(), writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), spawnWorkAgent(), stampPlanForFinalization() (+99 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (108): EventMetadata, ReadEventsOptions, tailEvents(), tailEventsSync(), authorized(), formatFrame(), getEventStreamRoute, getEventVersionRoute (+100 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.03
Nodes (107): taskOperation(), annotated, before, candidate, check, claimed, defaults, doc (+99 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (90): getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, compactCommand(), CompactOptions, detectPlatform() (+82 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (101): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, adminRouteLayer (+93 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.04
Nodes (91): config, DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig (+83 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.03
Nodes (92): updateConversationDeliveryMethod(), CloisterStatus, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchAllSessionTrees(), fetchConversations(), fetchCostsByIssue() (+84 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.04
Nodes (101): findProjectRoot(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+93 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.04
Nodes (76): planCommand(), PlanOptions, runDiscoveryPhase(), refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), isLinearIssue() (+68 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.03
Nodes (82): mockGetAgentHealth, entry, { issueId }, { limit }, old, op, ops, recent (+74 more)

### Community 41 - "Work Type Routing and Config"
Cohesion: 0.03
Nodes (75): AC_STATUS_COLORS, AC_STATUS_SYMBOL, applyDagreLayout(), DIFFICULTY_LABELS, EMPTY_ARRAY, GATE_LABELS, GATE_STATUS_COLORS, gateStatusFromReview() (+67 more)

### Community 42 - "Agent Status RPC Contracts"
Cohesion: 0.04
Nodes (87): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+79 more)

### Community 43 - "Dashboard App Sidebar and Metrics"
Cohesion: 0.04
Nodes (86): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+78 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.04
Nodes (89): updateTtsConfig(), defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath() (+81 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (85): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+77 more)

### Community 46 - "Workspace Metadata and Project Config"
Cohesion: 0.03
Nodes (77): ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent(), classifierIssue() (+69 more)

### Community 47 - "Cloister Service Handoff Logging"
Cohesion: 0.03
Nodes (77): Agent Enrichment Service, AgentState, listRunningAgentsAsync(), __testInternals, withConcurrencyLimit(), GLOBAL_CONFIG_PATH, evaluateAgentStartGate(), hasActiveAgentGateOrRetry() (+69 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.04
Nodes (81): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextValidateCommand(), LayerName (+73 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.04
Nodes (78): PRIORITY_LABELS, PlanningIssue, mockExec, prJson, result, buildChildStoriesFromRally(), buildLifecycleContext(), cleanupAgentStateDirs() (+70 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.03
Nodes (84): getSortKey(), sortConversations(), SortOption, ConversationRowProps, ids, ALLOWED_UPLOAD_MIME_TYPES, checkUploadRateLimit(), deleteConversationFavoriteRoute (+76 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.04
Nodes (65): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), makeMergeSet() (+57 more)

### Community 52 - "VBrief Task Readiness and Beads IO"
Cohesion: 0.05
Nodes (72): parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus() (+64 more)
...
Cohesion: 0.05
Nodes (69): hookCommand(), HookOptions, after, backupPath, backups, calls, errSpy, exitSpy (+61 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.05
Nodes (72): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+64 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.05
Nodes (72): platformConfig, __dirname, ensureDashboardBundle(), killPort(), resolveNode22(), sleep(), waitForHealth(), waitForHttp200() (+64 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.06
Nodes (67): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+59 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.05
Nodes (66): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), createHandoffPaths(), ensureHandoffsDir() (+58 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (66): anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult, explorationResult (+58 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.04
Nodes (81): Agent Audit Report (2026-04-13), AgentDetailPanel Component (slide-out detail), AgentsPage Component (unified agents view), Agents Page Redesign Spec, Agents Redesign (Custom HTML mockup), AI Memory Layer Research: mem0 and Adoption Strategy for Panopticon, BMAD Method — Full Agile AI Lifecycle Framework, Build Pipeline Documentation (+73 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.05
Nodes (62): createMemoryCommand(), ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity (+54 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (65): startPostLaunchSidecars(), startSidecars(), delay(), LOGS_DIR, computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget() (+57 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.05
Nodes (52): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getHealthEmoji() (+44 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (66): conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck(), tablist (+58 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.05
Nodes (77): defaultFlywheelPrompt(), flywheelRunConfigurationSection(), getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), spawnFlywheelAgent(), startFlywheelRun(), loadConfigAsyncNoMigration() (+69 more)

### Community 66 - "GitHub Webhook Ingestion Handlers"
Cohesion: 0.03
Nodes (56): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), uploadConversationImage(), ensureDefaultConversationModel(), getDefaultConversationModel(), EFFORT_LEVELS (+48 more)

### Community 67 - "GitHub Client and Agent Spawner"
Cohesion: 0.03
Nodes (60): IssueStats, cost, db, DB_PATH, CLAUDE_PROJECTS, cost, db, DB_PATH (+52 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.04
Nodes (52): ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, ClaudeCredentialParseError, getKimiAnthropicBaseUrl(), getProviderEnv() (+44 more)

### Community 69 - "Swarm Dispatch and DAG Execution"
Cohesion: 0.04
Nodes (72): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), ConfigOptions, createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStats, decodeFlywheelStatus, emitStatusCommand() (+64 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.04
Nodes (62): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+54 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.07
Nodes (64): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+56 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.05
Nodes (65): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityDetailedSync(), EmitActivityOptions (+57 more)

### Community 73 - "Merge Queue and App Settings Database"
Cohesion: 0.06
Nodes (59): contextCommand(), ContextOptions, CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps() (+51 more)

### Community 74 - "Checkpoint Capture and Diff Routes"
Cohesion: 0.05
Nodes (54): configShadowCommand(), ShadowOptions, BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename (+46 more)

### Community 75 - "Path Constants and Postinstall Setup"
Cohesion: 0.07
Nodes (75): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+67 more)
...
Cohesion: 0.05
Nodes (66): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact() (+58 more)

### Community 78 - "Read Model Enrichment and Agent Snapshots"
Cohesion: 0.06
Nodes (63): getAutoCloseOutCanonicalState(), shellQuote(), verifyMergedBeforeLifecycle(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace() (+55 more)
...
Cohesion: 0.04
Nodes (51): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+43 more)

### Community 81 - "Specialist Commands and VBrief Index"
Cohesion: 0.06
Nodes (64): listTestsCommand(), deletePRDDraft(), deletePRDDraftEffect(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftInfoPromise(), getPRDDraftPath() (+56 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.03
Nodes (45): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+37 more)

### Community 83 - "Issue Search Modal and Filter State"
Cohesion: 0.05
Nodes (66): appendJsonl(), readTranscriptSlice(), getCachedMessages(), isPiSessionFile(), CLAUDE_PROJECTS, activitySummaryCache, claudeProjectDir(), compactOffsetCache (+58 more)

### Community 84 - "Plan DAG Visualization and Beads Panel"
Cohesion: 0.06
Nodes (58): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+50 more)
...
Cohesion: 0.05
Nodes (60): applicableLayers(), assertPathInside(), buildContextCatalog(), buildContextLayerState(), contentForLayer(), ContextCatalog, contextDirForFile(), ContextLayerState (+52 more)
...
Cohesion: 0.05
Nodes (53): backup, backupCleanCommand(), backupListCommand(), PACKAGE_ROOT, restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync() (+45 more)

### Community 89 - "Frontend Dashboard Component Tests"
Cohesion: 0.1
Nodes (58): systemHealthCommand(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError (+50 more)

### Community 90 - "Cliproxy Process Lifecycle Management"
Cohesion: 0.06
Nodes (59): cancelPending(), clearAllPending(), getActionableAutoMerge(), getPendingAutoMerge(), listActionableAutoMerges(), listActiveAutoMerges(), listDuePendingAutoMerges(), listPendingAutoMerges() (+51 more)

### Community 91 - "Multi-Tracker Adapter Implementations"
Cohesion: 0.07
Nodes (46): error, IssueNotFound, config, originalEnv, tracker, error, mockComment, mockComments (+38 more)

### Community 92 - "Event Snapshot Cache and State Reducers"
Cohesion: 0.04
Nodes (56): agentDir, missing, result, snapshot, status, missing, filterClosedIssueAgents(), discoverNewAgentIds() (+48 more)

### Community 93 - "User Documentation and Provider Guides"
Cohesion: 0.07
Nodes (43): formatIssueCostAggregate(), aggregate, output, importSessionToCostLog(), IssueAggregate, BUDGETS_FILE, checkBudget(), checkBudgetSync() (+35 more)

### Community 94 - "Traefik DNS and Platform Install Skills"
Cohesion: 0.04
Nodes (60): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+52 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.08
Nodes (52): getReviewStatusAsync(), setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckRunPromise() (+44 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.06
Nodes (48): RoundMarker, fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+40 more)

### Community 97 - "Conversation Panel and Chat Phase Types"
Cohesion: 0.06
Nodes (54): ComposerFooter(), ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+46 more)

### Community 98 - "Database Settings and Cost Unit Tests"
Cohesion: 0.06
Nodes (59): listInWindow(), decodeFlywheelStats, getFlywheelStatsPayload(), bucketForRun(), bugRateStatus(), complexityBucketForItemCount(), computeBugRateCriterion(), computeCriterion1() (+51 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.04
Nodes (51): cb, cmdArgs, cmdStr, inline, issueCommentsJson, linearGetComments, linearGetIssueId, mockExec (+43 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.06
Nodes (43): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, ExtractedPayload (+35 more)

### Community 101 - "Project Config and Team Prefix Resolution"
Cohesion: 0.04
Nodes (51): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, execAsync, parseValidationOutput() (+43 more)

### Community 102 - "Cost Data Migration and Reconciliation"
Cohesion: 0.07
Nodes (54): details, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+46 more)

### Community 103 - "Claude OAuth Authentication and Settings"
Cohesion: 0.04
Nodes (60): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command, pan wipe Command (Destructive Reset) (+52 more)

### Community 104 - "PTY Terminal Hub WebSocket Streaming"
Cohesion: 0.04
Nodes (35): estimateCost(), CapabilityModelId, getModelCapability(), getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension (+27 more)

### Community 105 - "Issue Tracker Linking Tests"
Cohesion: 0.04
Nodes (56): ScheduleAutoMergeInput, ScheduleAutoMergeResult, announceAutoMergeCancelled(), announceAutoMergeScheduled(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), AutoMergeCancelDeps, AutoMergeScheduleDeps (+48 more)

### Community 106 - "Release and Update CLI Commands"
Cohesion: 0.06
Nodes (46): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+38 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.06
Nodes (51): ArtifactIndexEntry, ArtifactThumbnailOptions, ArtifactThumbnailPlaceholder, ArtifactThumbnailRenderer, ArtifactThumbnailResult, defaultRawArtifactUrl(), escapeXml(), fileExists() (+43 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.06
Nodes (54): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+46 more)
...
Cohesion: 0.05
Nodes (43): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), RuntimeConversationsConfig, ReadModelServiceShape (+35 more)

### Community 111 - "Issue Planning and Tracker Resolution"
Cohesion: 0.04
Nodes (49): calls, logSpy, now, output, payload, {
  shadowMock, cvMock, contextMock, healthMock,
  getShadowStateMock, pingAgentMock, getAgentCVMock, getAgentRuntimeStateMock,
}, activeIssues, date1 (+41 more)

### Community 112 - "TLDR Daemon State Management"
Cohesion: 0.07
Nodes (50): InlineSparkline(), InlineSparklineProps, buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb() (+42 more)

### Community 113 - "Specialist Pipeline PRDs and Skills"
Cohesion: 0.06
Nodes (44): betterSqlite3Path, closeMemoryFtsDatabases(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema() (+36 more)

### Community 114 - "Cost Event Storage and WAL Tests"
Cohesion: 0.04
Nodes (48): flywheelAbortCommand(), registerFlywheelCommands(), at(), flywheelRouteLayer, getAutoMergeProblemPayload(), postFlywheelPausePayload(), postFlywheelResumePayload(), postFlywheelStartPayload() (+40 more)

### Community 115 - "Smee Webhook Proxy Process Management"
Cohesion: 0.05
Nodes (48): cosineSimilarity(), normalizeFilter(), RawFilter, SearchMode, SearchResult, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+40 more)

### Community 116 - "Merge Set and Review Artifact Creation"
Cohesion: 0.05
Nodes (48): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+40 more)

### Community 117 - "Specialist Agent Prompts and Audit Docs"
Cohesion: 0.06
Nodes (40): StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, debounce(), isMac (+32 more)
...
Cohesion: 0.06
Nodes (43): electron, electron, IPC, result, SETTINGS_FILE, available, content, defaults (+35 more)

### Community 121 - "FPP Policy Violation Detection and Nudging"
Cohesion: 0.08
Nodes (44): devCommand(), checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions, PrereqResult, printPrereqStatus() (+36 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.06
Nodes (38): ContextUsage, ContextUsageIndicator(), ContextUsageIndicatorProps, formatCompactCount(), formatPercent(), getUsageTone(), UsageTone, VoiceMode (+30 more)

### Community 123 - "TTS Daemon and Pi Extension Supervisor"
Cohesion: 0.05
Nodes (45): oldTimestamp, sentinel, eightDaysAgo, events, makeDb(), payload, r1, r2 (+37 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.08
Nodes (42): appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEvents(), deduplicateEventsSync(), ensureEventsFile(), getEventsFile(), getEventsFilePath() (+34 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.09
Nodes (18): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), GitHubConfig, RallyConfig, scheduleNext() (+10 more)

### Community 126 - "Electron Desktop App Launch Scripts"
Cohesion: 0.04
Nodes (48): result, claudePlanningSystemPromptFiles(), clearCacheRoute, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute (+40 more)

### Community 127 - "Specialist Run Log Lifecycle"
Cohesion: 0.09
Nodes (48): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+40 more)

### Community 128 - "Remote Agent Provisioning on Fly"
Cohesion: 0.07
Nodes (46): ActivityEntry, ActivityItem(), ActivityPanel(), ActivityPanelProps, ActivityStream, applyPinWarnings(), CategoryFilter, fetchActivityREST() (+38 more)

### Community 129 - "Claude Code Hook Management"
Cohesion: 0.07
Nodes (41): migrateConfigCommand(), MigrateConfigOptions, migrateCommand(), BACKUP_SETTINGS_PATH, cleanupLegacyRuntimeSymlinksSync(), convertToYamlConfig(), convertToYamlConfigSync(), detectEnabledProviders() (+33 more)
...
Cohesion: 0.08
Nodes (48): writeConfig(), writeJsonFile(), makePanopticonHome(), openFlywheelStatsPage(), writeMarker(), getTtsDaemonAuthTokenPromise(), installTtsSystemdUnitPromise(), saveProjectMappings() (+40 more)

### Community 132 - "Conversation Smart Compaction"
Cohesion: 0.04
Nodes (14): FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine (+6 more)

### Community 133 - "Conversation Attachment Lifecycle Management"
Cohesion: 0.05
Nodes (35): FlywheelSubstrateBug, FlywheelSubstrateBugFiledBy, FlywheelSubstrateBugRow, FlywheelSubstrateBugStatus, getByIssueId(), markFixed(), upsert(), UpsertFlywheelSubstrateBugInput (+27 more)

### Community 134 - "Configuration Documentation"
Cohesion: 0.04
Nodes (46): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+38 more)

### Community 135 - "Core Project Docs and Scripts"
Cohesion: 0.07
Nodes (36): resolveModelId(), applyTierAwareFallback(), applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP (+28 more)

### Community 136 - "Parallel Code Review Prompt Templates"
Cohesion: 0.09
Nodes (38): checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost(), getDailyTotal() (+30 more)

### Community 137 - "Shadow Engineering Observer and Monitoring"
Cohesion: 0.04
Nodes (43): mockConfig, mockGetIssue, parentWorkspace, planDoc, specsDir, written, mockGetIssue, agentMocks (+35 more)
...
Cohesion: 0.1
Nodes (44): decodeFlywheelRunId, defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId(), pauseFlywheel() (+36 more)
...
Cohesion: 0.05
Nodes (43): HeaderMap, CappedBodyReadResult, CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute (+35 more)
...
Cohesion: 0.07
Nodes (40): ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getSpecialistHandoffStatsPromise(), getTodaySpecialistHandoffs(), readIssueSpecialistHandoffs(), readSpecialistHandoffs() (+32 more)

### Community 152 - "Remote Workspace Provider Skills"
Cohesion: 0.06
Nodes (39): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+31 more)

### Community 153 - "Agent Inspect Checkpoint Management"
Cohesion: 0.07
Nodes (42): addCycleDuration(), completedPassed(), createPipelineRunMetricsReader(), createPipelineRunStatsInputsReader(), derivePipelineRunMetrics(), derivePipelineRunMetricsFromEvents(), derivePipelineRunStatsInputs(), derivePipelineRunStatsInputsFromEvents() (+34 more)
...
Cohesion: 0.05
Nodes (42): Codex OAuth Authentication, Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider (+34 more)
...
Cohesion: 0.05
Nodes (28): activeA, activeB, clearIntervalSpy, enqueue, extract, getActiveTranscriptEntries, poller, readTranscriptSlice (+20 more)

### Community 162 - "Cloister Service Start Stop Status"
Cohesion: 0.11
Nodes (36): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+28 more)

### Community 163 - "Agent Card Model Defaults Display"
Cohesion: 0.05
Nodes (43): TranscriptEntry, AIProvider, calculateCostSync(), CostEntry, DEFAULT_PRICING, getPricingSync(), logUsageSync(), ModelPricing (+35 more)

### Community 164 - "Command Deck Issue Workbench UI"
Cohesion: 0.13
Nodes (14): createFlyApiClient(), createFlyApiClientSync(), effFromPromise(), execAsync, FlyProvider, FlyProviderConfig, mapFlyStateToVmStatus(), { execAsyncMock, spawnMock, mockApi } (+6 more)

### Community 165 - "Workspace Service and Agent Spawner Tests"
Cohesion: 0.07
Nodes (40): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+32 more)

### Community 166 - "CLI Command Taxonomy Reorganization PRD"
Cohesion: 0.08
Nodes (38): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps (+30 more)

### Community 167 - "Dangerous Git Operations Safety Guards"
Cohesion: 0.07
Nodes (39): resetDb(), resetDb(), closeDatabase(), resetDatabase(), ExtractedPayload, fallback, identity, primary (+31 more)
...
Cohesion: 0.06
Nodes (38): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+30 more)
...
Cohesion: 0.08
Nodes (36): runPreflight(), runStreaming(), beads, capturedArgs, err, mockExecFileFn, mockExecFn, hiddenDir (+28 more)
...
Cohesion: 0.11
Nodes (39): StatusDotStatus, deriveDotStatus(), presenceToStatus(), useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), useAvailableModels(), activityToStatus() (+31 more)

### Community 185 - "Git Forge PR and MR Artifact Creation"
Cohesion: 0.05
Nodes (34): __dirname, CLI_PATH, __dirname, { stdout }, { stdout, status }, { stdout, stderr }, actual, captureCommandHelp() (+26 more)
...
Cohesion: 0.08
Nodes (40): enqueueStatusRollupEvent(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput, CommitStatusRollupResult, EmitStatusUpdated (+32 more)
...
Cohesion: 0.09
Nodes (34): getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), detectBranch(), detectFilesChanged(), detectPrUrl(), detectPrUrlForRepo(), execAsync (+26 more)

### Community 190 - "Agent Grid Dashboard UI Components"
Cohesion: 0.07
Nodes (39): bufferToFloat32Array(), BuildConfig, buildDocsIndex(), BuildDocsIndexOptions, BuildDocsIndexResult, createDocsEmbeddingFunction(), createDocsIndexSchema(), DEFAULT_CONFIG (+31 more)
...
Cohesion: 0.1
Nodes (38): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+30 more)

### Community 193 - "Workflow Orchestration and vBRIEF Research"
Cohesion: 0.07
Nodes (36): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir() (+28 more)

### Community 194 - "Agent Types Pipeline Documentation"
Cohesion: 0.09
Nodes (39): embedAction(), ScanOptions, SearchQuery, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), buildFilterSql(), countDiscoveredSessions(), findDiscoveredSessions() (+31 more)
...
Cohesion: 0.13
Nodes (31): int, build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), extract_embedding(), _get_default_sink_state(), Handler (+23 more)
...
Cohesion: 0.07
Nodes (37): MODEL_COLORS, executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, AgentPauseFields, clearTroubledAgent() (+29 more)

### Community 206 - "CLI Init and Shell Configuration"
Cohesion: 0.05
Nodes (40): getConversationsConfig(), getConversationsConfigAsync(), getConversationsConfigSync(), resolveConversationWatchDirs(), updateConversationsConfig(), updateConversationsConfigAsync(), ConfigResponseSchema, ConversationsConfigBodySchema (+32 more)

### Community 207 - "Verification Runner and Sync Pipeline"
Cohesion: 0.08
Nodes (37): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+29 more)
...
Cohesion: 0.09
Nodes (29): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, createRecoveryCoordinator(), EventClassification (+21 more)
...
Cohesion: 0.06
Nodes (40): CLIProxy component, API Server (port 3002/3002), Dashboard Frontend (port 3001), Traefik reverse proxy, pan install command, pan up / pan down commands, Skill Sync (pan sync to AI tools), Test suite configuration (backend/frontend/e2e) (+32 more)

### Community 222 - "Caveman File Type Detection CLI"
Cohesion: 0.06
Nodes (31): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+23 more)

### Community 223 - "Agent Enrichment and Context Resolution"
Cohesion: 0.11
Nodes (35): basenameOfPath(), canonicalizeWindowsDrivePath(), formatWorkspaceRelativePath(), normalizePathSeparators(), splitPathAndPosition(), stripRelativePrefixes(), trimTrailingPathSeparators(), appendLineColumnFromHash() (+27 more)

### Community 224 - "Cost Tracking Architecture Docs"
Cohesion: 0.08
Nodes (35): isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues(), discoverResourceAllocatedIssuesFresh(), execFileAsync, GhPullRequest, hasRecentActivity() (+27 more)

### Community 225 - "Diagnostic and Incident Response Skills"
Cohesion: 0.05
...
### Community 226 - "Contracts Types RPC and Desktop Package"
Cohesion: 0.05
...
### Community 227 - "Command Deck Screenshots and Branding"
Cohesion: 0.05
...
### Community 228 - "Desktop Build and Monorepo Release Tests"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (38): 10. Insufficient Logging & Monitoring, 1. Injection Attacks, 2. Authentication & Authorization, 3. Sensitive Data Exposure, 4. XML External Entities (XXE), 5. Broken Access Control, 6. Security Misconfiguration, 7. Cross-Site Scripting (XSS) (+30 more)
...
Cohesion: 0.14
Nodes (38): readConfig(), atLineEnd(), charAt(), compose(), continueScalar(), decorate(), end(), getLine() (+30 more)

### Community 232 - "Provider Environment Settings Overlay"
Cohesion: 0.08
Nodes (33): eventsFileExists(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir(), migrateAgent() (+25 more)
...
Cohesion: 0.09
Nodes (37): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), captureTldrMetricsSync(), clone(), createStringifyContext(), format(), formatPropertyKey() (+29 more)

### Community 240 - "UI and Diff Preferences Persistence"
Cohesion: 0.1
Nodes (26): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+18 more)

### Community 241 - "Pending Lifecycle Event Processing"
Cohesion: 0.13
Nodes (32): createFlyProvider(), getRemoteProvider(), isRemoteAvailable(), ProviderType, RemoteProvider, RemoteProviderConfig, AGENTS_DIR, buildRemoteTmuxCommand() (+24 more)

### Community 242 - "OpenAI Auth and Cliproxy Bridge"
Cohesion: 0.08
Nodes (31): createDocsCommand(), DocsQueryOptions, printDocsQueryResult(), DocsEmbeddingInput, applyDocsQueryBounds(), centroidVector(), ChunkRow, countTokens() (+23 more)

### Community 243 - "Electron Desktop App Docs"
Cohesion: 0.1
Nodes (31): computeStaleResets(), hasSessionForSpecialist(), StatusSnapshot, updates, updated, callServerApi(), buildMenuTemplate(), configureApplicationMenu() (+23 more)
...
Cohesion: 0.06
Nodes (32): next, restored, s, start, withAgent, cb, cmdArgs, { MainDivergedErrorClass } (+24 more)

### Community 248 - "Pi Extension Session Event Handlers"
Cohesion: 0.06
Nodes (22): AgentTellForm(), AgentTellFormProps, SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS (+14 more)
...
Cohesion: 0.06
Nodes (31): dir, event, eventsDir1, eventsDir2, line, lines, makeCostEvent(), mockListProjects (+23 more)

### Community 252 - "Agent Completion Detection and Cleanup"
Cohesion: 0.08
Nodes (32): CliproxyCodexCredentials, applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+24 more)

### Community 253 - "Spec Readiness Skill and Scoring"
Cohesion: 0.06
Nodes (23): closeResult, command, ctx, editCalls, labelResult, prResult, archiveIdx, beadsDir (+15 more)
...
Cohesion: 0.07
Nodes (35): Claude Haiku 4.5 Work Type Fit Analysis, Claude Haiku 4.5 (claude-haiku-4-5-20251001), Claude Opus 4.6 Work Type Fit Analysis, Claude Opus 4.6 (claude-opus-4-6), Claude Opus 4.7 (claude-opus-4-7), Claude Sonnet 4.6 Work Type Fit Analysis, Claude Sonnet 4.6 (claude-sonnet-4-6), Gemini 3.1 Pro Preview Work Type Fit Analysis (+27 more)
...
Cohesion: 0.09
Nodes (27): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), childEnv, expectedExits (+19 more)

### Community 269 - "Conversation Panel and Timeline PRDs"
Cohesion: 0.07
Nodes (26): activeContinuePath, continuePath, projectRoot, wsDir, agentDir, agentResult, beadsDir, branchResult (+18 more)
...
Cohesion: 0.11
Nodes (33): getArtifactStatus(), listArtifacts(), resolveArtifactUrl(), ArtifactCommandDeps, artifactCreateCommand(), ArtifactCreateOptions, artifactListCommand(), artifactOpenCommand() (+25 more)
...
Cohesion: 0.11
Nodes (31): chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources(), DEFAULT_DOCS_CONFIG, discoverDocsCorpusSources(), discoverMarkdownUnder() (+23 more)

### Community 274 - "Issue Tracker Admin State Management"
Cohesion: 0.1
Nodes (28): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo() (+20 more)

### Community 275 - "Agent Show Command Tests"
Cohesion: 0.09
Nodes (28): execAsync, rebaseFeatureBranch(), rebaseFeatureBranchPromise(), RebaseResult, CheckpointError, ConfigError, ConfigParseError, FsNotFoundError (+20 more)

### Community 276 - "Environment File Loading and API Keys"
Cohesion: 0.1
Nodes (30): buildReviewContext(), BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, flattenAC(), getChangedFiles(), getCurrentBranch() (+22 more)
...
Cohesion: 0.11
Nodes (30): PROVIDER_ENV_UNSETS, Role, DEFAULT_CONFIG, buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand() (+22 more)

### Community 280 - "vBRIEF Types Builder and Viewer"
Cohesion: 0.1
Nodes (29): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+21 more)
...
Cohesion: 0.06
Nodes (34): CLI Distribution Strategy, code:yaml (# Your original docker-compose.yml), code:bash (pan workspace create my-feature --template node-fullstack), code:block102 (~/.panopticon/templates/), code:toml ([template]), code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:bash (# First time - zero install) (+26 more)
...
Cohesion: 0.07
Nodes (26): exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result, spawnRunMock (+18 more)

### Community 293 - "Multi-Model Runtime Consolidation PRDs"
Cohesion: 0.1
Nodes (25): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+17 more)
...
Cohesion: 0.09
Nodes (25): confirmCost(), enrichAction(), formatCost(), ConversationFilter, findDiscoveredSessionIds(), createConfiguredClaudeApi(), EnrichSessionOptions, CostThresholdError (+17 more)

### Community 298 - "Agent Queue Position Calculation"
Cohesion: 0.09
Nodes (27): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), stripFrontmatter(), syncSkillsToTools(), syncSkillsToToolsSync() (+19 more)
...
Cohesion: 0.14
Nodes (31): buildReleaseNotesMarkdown(), contractsPackageJsonPath, desktopPackageJsonPath, __dirname, ensureCleanTree(), ensureMainBranch(), ensureTagDoesNotExist(), __filename (+23 more)

### Community 306 - "God View Real-Time Agent Dashboard"
Cohesion: 0.1
...
### Community 307 - "Agent Enrichment and Phase Detection"
Cohesion: 0.12
Nodes (11): LRUCache, formatProbeError(), constructor(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+3 more)

### Community 308 - "TTS Sidecar Audio Notification System"
Cohesion: 0.08
Nodes (28): DEFAULT_FLYWHEEL_CONFIG, fetchFlywheelConversation(), fetchJson(), findFlywheelConversation(), FlywheelConversationPane(), FlywheelConversationPaneProps, FlywheelPaneViewMode, FlywheelRoleConfig (+20 more)

### Community 309 - "Agent Benchmark Framework and Results"
Cohesion: 0.14
Nodes (28): makeTestService(), initWorkspaceDiscoveredSessionsSchema(), getRuntimeSnapshotSync(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), emitResetMarkerCreated(), emitMemoryHealthChanged() (+20 more)

### Community 310 - "Skills CLI Command Listing"
Cohesion: 0.12
Nodes (26): AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPane(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex() (+18 more)
...
Cohesion: 0.14
Nodes (23): execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise(), gitPush() (+15 more)
...
Cohesion: 0.09
Nodes (20): FetchFn, InternalState, LogFn, readWatchdogPersistentState(), SpawnRestart, SpawnRestartResult, SupervisorWatchdog, SupervisorWatchdogConfig (+12 more)

### Community 318 - "Workspace Reopen and State Reset"
Cohesion: 0.08
Nodes (19): NormalizedTtsDaemonConfig, parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, parsePositiveIntEnv(), readWatchdogConfig() (+11 more)
...
Cohesion: 0.1
Nodes (26): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), ensureOpenAICompatibleProxyRunningPromise() (+18 more)
...
Cohesion: 0.07
Nodes (27): healths, CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health (+19 more)
...
Cohesion: 0.09
Nodes (30): Agent Status Badge System, Agent Card — Grid View Component, Agents Page — Cloister Section Header, Agents Page — Deploy Agent CTA Button, Agents Page — Filter Button, Agents Page — KPI Stats Bar, Agents Page — Left Navigation Sidebar, Agents Page — Custom Right Panel (Results + Chart) (+22 more)
...
Cohesion: 0.12
Nodes (24): ArtifactLifecycleOptions, ArtifactProvenanceInput, ArtifactValidationError, copyPublishedSnapshot(), createArtifact(), CreateArtifactOptions, decodeHtmlText(), extractArtifactTitle() (+16 more)

### Community 341 - "TSX Extension LLM TLDR Patch"
Cohesion: 0.1
Nodes (24): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, settings, FIXTURES_DIR (+16 more)
...
Cohesion: 0.08
Nodes (29): Cloister lifecycle watchdog, src/lib/cloister/inspect-agent.ts, Inspect Specialist checkpoint system (commit-based diff scoping), Inspect Specialist (inspect-agent), PAN-382: Inspect Specialist — Per-Step Verification, Jidoka Principle — never pass a foundation-class defect downstream, pan inspect <issueId> --bead <beadId> CLI command, metadata.requiresInspection per-bead flag (+21 more)
...
Cohesion: 0.07
Nodes (23): desktopVersion, __dirname, repoRoot, rootVersion, desktopDir, __dirname, pkg, pkgPath (+15 more)

### Community 361 - "CLI Command Set Fixture"
Cohesion: 0.08
Nodes (25): actionSets, createQueryClient(), drawerActionBar(), drawerIssueActionIds(), drawerUi(), fetchMock, first, firstArtifact (+17 more)
...
Cohesion: 0.14
Nodes (27): createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE (+19 more)

### Community 365 - "Agent Health Monitor States"
Cohesion: 0.14
Nodes (23): getDiscoveredSessionById(), getFtsRow(), markEnrichmentFailed(), replaceFtsRow(), updateEnrichment(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+15 more)

### Community 366 - "Workspace Status Display Skill"
Cohesion: 0.08
Nodes (21): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, searchFts(), EnrichmentResponse (+13 more)

### Community 367 - "Work Completion Checklist Skill"
Cohesion: 0.11
Nodes (24): DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, EmbedSessionsOptions, selectSessionIdsForEmbedding(), embed() (+16 more)

### Community 368 - "GitHub CLI Reference Skill"
Cohesion: 0.07
Nodes (25): rowToSession(), upsertDiscoveredSession(), chalk, cliRows, dashboardRows, identity(), logs, output (+17 more)

### Community 369 - "Docker DotNet Template"
Cohesion: 0.1
Nodes (18): WorkspaceService, runEffect(), MOCK_PROJECT, mockCreateWorkspace, mockExistsSync, mockLoadProjectsConfig, mockRemoveWorkspace, mockResolveProjectFromIssue (+10 more)

### Community 370 - "Library Test Suite Docs"
Cohesion: 0.12
Nodes (26): result2, companionInTarget, contentAfterFirst, dstScript, gitCwd, gitManifestDir, manifest, manifestAfterFirst (+18 more)
...
Cohesion: 0.11
Nodes (21): buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+13 more)
...
Cohesion: 0.11
Nodes (23): runMemoryFtsTransaction(), appendLocks, findIndexedObservationByteOffset(), findObservationByteOffset(), indexObservation(), inline(), observationMarkdownPath(), readOptional() (+15 more)

### Community 396 - "Multi-Agent Orchestration PRD"
Cohesion: 0.14
Nodes (23): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+15 more)

### Community 397 - "PRD Pipeline Test Marker"
Cohesion: 0.16
Nodes (17): addVoice(), addVoicePromise(), clearVoices(), clearVoicesPromise(), deleteVoice(), deleteVoicePromise(), findVoiceById(), findVoiceByIdPromise() (+9 more)
...
Cohesion: 0.1
Nodes (21): changedFiles, errOutput, fetchMock, output, err, exec(), execFile(), execMock (+13 more)
...
Cohesion: 0.15
Nodes (24): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), createdAgeMs(), defaultWorkspacePath(), DockerPsJson, escapeRegExp(), evaluateWorkspaceStackHealth(), execFileAsync (+16 more)

### Community 405 - "Community 405"
Cohesion: 0.15
Nodes (18): after, before, blockers, result, statuses, DEFAULT_STATUS_FILE, clearReviewStatus(), clearReviewStatusSync() (+10 more)

### Community 406 - "Community 406"
Cohesion: 0.13
Nodes (22): assertIssueHasBeads(), assertIssueHasBeadsEffect(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise() (+14 more)
...
Cohesion: 0.1
Nodes (23): Abort, code:bash (pan flywheel start), code:text (Flywheel stats (30d)), code:bash (pan flywheel config --get), code:bash (pan flywheel status), code:bash (pan flywheel pause), code:bash (pan flywheel abort), code:bash (pan flywheel emit-status --file latest.json) (+15 more)
...
Cohesion: 0.12
Nodes (20): ArtifactIndexOptions, ArtifactRow, CreateArtifactInput, generateArtifactSlug(), getArtifactIndexPath(), getArtifactsDir(), getArtifactSnapshotDir(), getArtifactSnapshotPath() (+12 more)

### Community 429 - "Community 429"
Cohesion: 0.24
Nodes (22): appendBodyFileFlag(), appendBodyFlag(), appendHereDoc(), appendStdinBody(), buildTrailer(), buildUpdatedInput(), containsFlywheelRunId(), findFlag() (+14 more)

### Community 430 - "Community 430"
Cohesion: 0.11
Nodes (18): collectLifecycleRows(), rowCreatedDate(), VBriefInvalidFormatError, VBriefMergeConflictError, VBriefMergeConflictTaggedError, buildProjectIndex(), findVBriefByIssue(), findVBriefByIssueAsync() (+10 more)
...
Cohesion: 0.18
Nodes (17): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), formatBrief(), formatDate(), formatIds() (+9 more)

### Community 434 - "Community 434"
Cohesion: 0.13
Nodes (19): checkTtsHealth(), startTtsDaemonFromDashboard(), ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority(), LIFECYCLE_EVENT_TYPES (+11 more)

### Community 435 - "Community 435"
Cohesion: 0.13
Nodes (21): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues, output, dedupeRows() (+13 more)
...
Cohesion: 0.21
Nodes (23): arrayPushArray(), atIndentedComment(), blockMap(), blockScalar(), blockSequence(), document(), documentEnd(), findNonEmptyIndex() (+15 more)
...
Cohesion: 0.15
Nodes (18): buildAnthropicMessagesUrl(), CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), invalidateProbeCache(), invalidateProbeCacheSync() (+10 more)
...
Cohesion: 0.12
Nodes (21): fetchCurrentFlywheelStatus(), fetchPendingAutoMerges(), FLYWHEEL_CONFIG_QUERY_KEY, FlywheelConfig, FlywheelConfigPatch, FlywheelLeftTab, FlywheelPage(), FlywheelPageProps (+13 more)
...
Cohesion: 0.09
Nodes (23): src/dashboard/server/routes/command-deck.ts, packages/contracts/src/events.ts, packages/contracts/src/types.ts, AgentRuntimeSnapshot (Effect Schema in contracts), Agent runtime DomainEvents (agent.activity_changed, agent.thinking_started, etc.), PAN-821: Command Deck — Issue Session Tree with Conversation-First Agent Panels, GET /api/projects/:projectKey/session-tree endpoint, SessionNode type (planning/work/review/reviewer/test/merge/legacy) (+15 more)

### Community 489 - "Community 489"
Cohesion: 0.12
Nodes (23): bd CLI tool (beads), Beads Async Gates Documentation, Beads Batch Operations Documentation, Beads Boundaries: bd vs TodoWrite Decision Guide, Beads CLI Command Reference, Beads Compaction Survival (context recovery), beads-completion-check skill, Beads Dependency Type: blocks (hard blocker) (+15 more)
...
Cohesion: 0.09
Nodes (21): branch, branchMatch, buffer, cavemanVariant, cost, entry, input, lines (+13 more)

### Community 494 - "Community 494"
Cohesion: 0.09
Nodes (20): allLogs, logPath, mockCleanupAllLogs, mockCleanupOldLogs, mockConsoleError, mockConsoleLog, mockExec, mockExit (+12 more)

### Community 495 - "Community 495"
Cohesion: 0.22
Nodes (20): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), decodeJwtPayload(), getCliproxyCodexCredPath(), getCodexAuthPath(), buildStatus() (+12 more)

### Community 496 - "Community 496"
Cohesion: 0.15
Nodes (8): MockRallyArtifact, RallyApiMock, compoundQueries, mock, sampleArtifacts, typeQueries, RallyRestApi, trackerErr()

### Community 497 - "Community 497"
Cohesion: 0.12
Nodes (18): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+10 more)
...
Cohesion: 0.09
Nodes (21): Auth mode is exclusive, Claude Code (default), code:bash (npm install -g @mariozechner/pi-coding-agent), code:bash (cd packages/pi-extension && npm run build), Harnesses, Implementation, Installing Pi, Multi-provider via Pi vs CLIProxy (+13 more)
...
Cohesion: 0.1
Nodes (16): agentsDir, config, env, mockExistsSync, mocks, result, tempDirs, HealthCheck (+8 more)

### Community 507 - "Community 507"
Cohesion: 0.11
Nodes (15): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, LAZY_PATTERNS, lazySamples, oldTime, stateFile, STATE_FILE (+7 more)

### Community 508 - "Community 508"
Cohesion: 0.17
Nodes (20): CavemanExperimentRow, CostsPage(), CostsResponse, DailyTrend, ExperimentsResponse, ExperimentsView(), fetchCosts(), fetchExperiments() (+12 more)

### Community 509 - "Community 509"
Cohesion: 0.1
Nodes (7): isEligibleForCleanup(), validateAndCleanStateFile(), getIssueDataService(), build, getPackageVersion(), PlanBuilder, require
...
Cohesion: 0.17
Nodes (18): deliverQueuedFeedback(), enqueuePendingFeedbackDelivery(), FeedbackKind, isDeliveryStillRelevant(), markPendingFeedbackDelivered(), PENDING_FEEDBACK_FILE, PendingFeedbackDelivery, PendingFeedbackStore (+10 more)
...
Cohesion: 0.1
Nodes (18): UpsertDiscoveredSessionOpts, all, cookie, fetched, filter, inserted, ORIGIN_ENV_KEYS, p (+10 more)
...
Cohesion: 0.11
Nodes (18): agentDir, dir1, dir2, marker, missing, nested, backup, backup1 (+10 more)

### Community 527 - "Community 527"
Cohesion: 0.1
Nodes (19): Architecture, CLI Commands, code:bash (# 1. Implement feature), code:bash (# List all specialists with status), code:toml ([specialists.review_agent]), code:typescript (type Priority = 'urgent' | 'high' | 'normal' | 'low';), Configuration, Deacon Health Monitor (+11 more)
...
Cohesion: 0.17
Nodes (16): DeepWipeDialog(), DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, StepRow(), WipeState, getSubStepIcon() (+8 more)

### Community 539 - "Community 539"
Cohesion: 0.16
Nodes (17): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), execAsync, execFileAsync, getBeadDescription(), InspectContext, InspectResult (+9 more)

### Community 540 - "Community 540"
Cohesion: 0.17
Nodes (15): appendChannelDeliveryLog(), deliverAgentMessage(), deliverAgentPermissionDecision(), getBridgeHttpAgent(), panopticonHomeForChannels(), panopticonHomeForSockets(), postUnixSocketJson(), actual (+7 more)

### Community 541 - "Community 541"
Cohesion: 0.15
Nodes (17): agentMocks, agentState, eventStoreLayerFor(), fsMocks, interventionMocks, issueIdMocks, issueServiceMock, lifecycleMocks (+9 more)
...
Cohesion: 0.16
Nodes (17): Claude Code Channels (Experimental), confirmDelivery() (tmux delivery verification), Heartbeat Hook (PostToolUse), PAN-798 Research & Audits Document, PAN-800 — tmux Hook Replacement, PTY Hub Ring Buffer (WebSocket terminal snapshot), execFileAsync, hooksLog (+9 more)

### Community 558 - "Community 558"
Cohesion: 0.14
Nodes (7): countCompleteLines(), isSuccessfulExtractionResult(), registerTranscriptForPolling(), startTranscriptPoller(), syncTranscriptPollerRegistry(), TranscriptPoller, unregisterTranscriptForPolling()

### Community 559 - "Community 559"
Cohesion: 0.11
Nodes (18): parseFiniteInteger(), filterPayload(), array, combine, intIdentify(), intStringify(), number(), optimize() (+10 more)
...
Cohesion: 0.18
Nodes (15): BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, TaskItem(), AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel() (+7 more)
...
Cohesion: 0.12
Nodes (15): allOps, divergedOp, execAsync, execFileMock, execMock, ops, opTypes, status (+7 more)
...
Cohesion: 0.12
Nodes (14): cache, capped, cpuList, events, lines, memFree, memTotal, result (+6 more)
...
Cohesion: 0.15
Nodes (12): AutoMergeEligibility, AutoMergeEligibilityDeps, BLOCKER_LABELS, execFileAsync, getIssueLabels(), isAutoMergeEligible(), parsePullRequestUrl(), PullRequestLookup (+4 more)

### Community 577 - "Community 577"
Cohesion: 0.18
Nodes (14): asPanRpcError(), isInsidePath(), LANGUAGE_BY_EXTENSION, languageForPath(), readCappedFile(), readWorkspaceFile(), readWorkspaceFileEffect(), selectRequestedLines() (+6 more)
...
Cohesion: 0.12
Nodes (15): file, url, conversation, { editorState, mockFocus, mockToastError, mockSaveStoredModel }, fetchMock, file, onSend, secondConversation (+7 more)
...
Cohesion: 0.23
Nodes (14): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, cloneTtsConfig(), currentConfig, findProjectRootAsync(), pathExists() (+6 more)

### Community 607 - "Community 607"
Cohesion: 0.2
Nodes (11): mockFetch(), ApiKeyValidationResult, classifyModel(), detectThinkingSupport(), ModelCache, OpenRouterModel, OpenRouterService, OpenRouterServiceLive (+3 more)
...
Cohesion: 0.18
Nodes (14): buildStrikePrompt(), ensureStrikeWorktree(), execAsync, planStrike(), runOne(), strikeCommand(), StrikeOptions, StrikePlan (+6 more)
...
Cohesion: 0.12
Nodes (14): bridge, DesktopSettings, IPC, NotificationEventType, Window, ArcProps, GroupProps, HTMLMotionProps (+6 more)
...
Cohesion: 0.12
Nodes (13): claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile, projectDirName (+5 more)
...
Cohesion: 0.15
Nodes (16): src/lib/cloister/deacon.ts, A/B testing for caveman (caveman_variant in workspace metadata + cost events), CAVEMAN_DEFAULT_MODE env var for per-agent-type intensity, Caveman hooks (SessionStart + UserPromptSubmit) for output token reduction, PAN-611: Caveman Integration — Agent Output Token Reduction, PAN-798: Tmux capture-pane Audit (22 call sites, 70+ patterns), 22 tmux capture-pane call sites across 12 files, checkLazyAgent() — stuck detection (34 regexes, high-risk) (+8 more)
...
Cohesion: 0.17
Nodes (13): EMPTY_STATES, FeedTabContent(), isSessionFeedTab(), isStubTab(), navigateToFeedEntry(), pushRoute(), readStoredTab(), SessionFeedSidebar() (+5 more)

### Community 641 - "Community 641"
Cohesion: 0.13
Nodes (13): cancelButton, consoleError, fetchMock, mocks, onNavigateAgent, onNavigateIssue, requireUat, stateTab (+5 more)

### Community 642 - "Community 642"
Cohesion: 0.2
Nodes (13): clearRunningAgentsCache(), ListAgentsProgram, RunningAgent, RunningAgents, runningAgentsCache, sweepExpired(), firstAgents, firstPromise (+5 more)

### Community 643 - "Community 643"
Cohesion: 0.16
Nodes (13): decodeFlywheelStats, encodeFlywheelStats, FlywheelStats, FlywheelStatsCriteria, FlywheelStatsCriterion, FlywheelStatsCriterionStatus, FlywheelStatsCriterionValue, FlywheelStatsCriterionValueObject (+5 more)
...
Cohesion: 0.22
Nodes (15): Code Drift Check (Review → Test), Deacon Auto-loads Workspace CLAUDE.md, Human Clicks Merge Gate, Planning Agent CLAUDE.md Sources, PLANNING_PROMPT as CLI Message Flag File, Project Overlay CLAUDE.md, Skip Tests When No Code Drift, Specialist CLAUDE.md Sources (Spawn in DEVROOT) (+7 more)
...
Cohesion: 0.14
Nodes (12): ApiSettingsConfig, mockClearConfigCache, mockLoadConfig, mockMergeConfigs, mockReadFile, mockResolveModelId, mockWriteFile, openaiIds (+4 more)

### Community 667 - "Community 667"
Cohesion: 0.14
Nodes (9): card, eventStore, fetchImpl, hookOutput, issueBody, poller, projectRoot, stats (+1 more)
...
Cohesion: 0.19
Nodes (10): ActivityFeedCard(), ActivityFeedCardProps, ActivitySessionFeedEntry, CommentSessionFeedEntry, FileChangeSessionFeedEntry, PlaceholderSessionFeedEntry, SessionFeedEntryBase, SessionFeedEntryKind (+2 more)

### Community 671 - "Community 671"
Cohesion: 0.16
Nodes (11): SessionFeedTab, filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), UseMergedFeedResult, duplicate, entries, first, hookSources (+3 more)

### Community 672 - "Community 672"
Cohesion: 0.21
Nodes (12): CRITERION_EXPLANATIONS, fetchFlywheelStats(), FlywheelStatsCard(), FlywheelStatsPanel(), formatCriterionValue(), formatObjectValue(), formatScalar(), formatSince() (+4 more)
...
Cohesion: 0.14
Nodes (13): 1. Role file — `roles/*.md`, 2. Panopticon pipeline agent — `agents/pan-*-agent.md`, 3. Claude Code subagent — `.claude/agents/*.md`, Adding a new role or sub-role, code:block1 (Cloister decides to spawn (role, subRole?)), File shapes you will see, How a run actually gets the right instructions, Roles: Panopticon's Agent Definition Primitive (+5 more)
...
Cohesion: 0.14
Nodes (13): Acceptance Criteria, code:block3 ({ iss: "panopticon-cli.com", sub: "<github-user-id>", login,), Design Goals, Files Likely Touched, Goal, Host Role & Handoff, Identity & GitHub OAuth, Implementation Phases (sequencing within PAN-658) (+5 more)
...
Cohesion: 0.15
Nodes (12): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+4 more)
...
Cohesion: 0.19
Nodes (10): AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState, ConversationFeedCard(), ConversationFeedCardProps, readAgentState(), STATUS_DOT_COLORS, ConversationSessionFeedEntry (+2 more)

### Community 717 - "Community 717"
Cohesion: 0.21
Nodes (10): fetchGitFeedEntries(), GitActivityEntry, GitFeedFetchResult, mapGitActivityToFeedEntry(), useGitFeed(), UseGitFeedResult, entries, error (+2 more)

### Community 718 - "Community 718"
Cohesion: 0.15
Nodes (9): dispatchMenuAction(), baseFlywheelStatus, consoleErrors, flywheelStatus, metrics, MockWebSocket, status, statusPane (+1 more)
...
Cohesion: 0.17
Nodes (11): existingSkillDir, existsInTarget, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync, sourcePath (+3 more)

### Community 742 - "Community 742"
Cohesion: 0.24
Nodes (8): isErrnoException(), readRestartStatusPromise(), RestartStatus, RestartStatusError, restartStatusPath(), RestartTrigger, writeRestartStatus(), writeRestartStatusPromise()
...
Cohesion: 0.17
Nodes (10): merge, mergeAgent, pollSpecialistApiStatus(), pollSpecialistStatus(), review, reviewAgent, SpecialistApiStatus, SpecialistStatus (+2 more)

### Community 745 - "Community 745"
Cohesion: 0.17
Nodes (9): PromptError, baseReviewVars, baseVars, __filename, fm, local, PROMPTS_DIR, remote (+1 more)

### Community 746 - "Community 746"
Cohesion: 0.23
Nodes (9): ConversationFeedRow, fetchConversations(), mapConversationsToFeedEntries(), mapConversationToFeedEntry(), mapHarnessToAgent(), useConversationFeed(), UseConversationFeedResult, entries (+1 more)

### Community 747 - "Community 747"
Cohesion: 0.2
Nodes (9): BucketSection(), BucketSectionProps, SessionFeedEntry, activity, buttons, conversation, git, now (+1 more)
...
Cohesion: 0.18
Nodes (11): Brief authoring, code:text (---), code:text (${PANOPTICON_HOME:-~/.panopticon}/flywheel/runs/<RUN-ID>/), Flywheel, Lifecycle, Reading the Stats panel, Settings → Roles → Flywheel, Skill → CLI → API → UI map (+3 more)
...
Cohesion: 0.17
Nodes (12): Auto-planning, code:bash (pan plan PAN-1071 --auto), code:bash (pan plan finalize), code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Finalizing (`pan plan finalize`), Planning Workflow (+4 more)
...
Cohesion: 0.2
Nodes (8): bodyDir, bodyPath, command, { env }, outputFor(), payload(), result, tempDirs
...
Cohesion: 0.2
Nodes (8): CUSTOM_VOICE_PRESETS, playPreset(), PlayPresetInput, savePreset(), SavePresetInput, VoicePreset, VoicePresetsTab(), user
...
Cohesion: 0.25
Nodes (9): dashboardBaseUrl(), mergeCancelCommand(), readErrorMessage(), registerMergeCommands(), cancel, merge, mocks, program (+1 more)

### Community 797 - "Community 797"
Cohesion: 0.2
Nodes (8): FeatureRegistryListOptions, FeatureRegistryListPayload, featureRegistryRouteLayer, getFeatureRegistryListPayload(), listFeatureRegistryRoute, listEntries, calls, entry
...
Cohesion: 0.2
Nodes (8): resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, getWorkspaceStackHealth, health, now, projectRoot, workspacePath, resetWorkspaceStackHealthTransitionsForTests()

### Community 843 - "Community 843"
Cohesion: 0.29
Nodes (8): EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), enrichReviewStatusPromise(), mostRecentByTimestamp(), parseReviewerTimestamp(), parseTrailingTimestamp(), ReviewEnrichmentError

### Community 844 - "Community 844"
Cohesion: 0.2
Nodes (6): debug, hookSources, now, onClose, onPopState, section
...
Cohesion: 0.22
Nodes (7): bashMatcher, body, content, { frontmatter }, { frontmatter, body }, hooks, splitFrontmatter()
...
Cohesion: 0.31
Nodes (6): GitFeedCard(), GitFeedCardProps, selectGitIcon(), GitSessionFeedEntry, onSelect, time

### Community 889 - "Community 889"
Cohesion: 0.28
Nodes (8): createTerminalWindow(), MockWindow, openTerminalWindow(), setAlwaysOnTop(), terminalWindows, win, createTerminalWindow(), terminalWindows

### Community 890 - "Community 890"
Cohesion: 0.22
Nodes (7): chalk, exitSpy, identity(), logs, MockCostThresholdError, mockEnrichSessions, output

### Community 891 - "Community 891"
Cohesion: 0.22
Nodes (8): columns, db, fixed, indexes, inserted, repolled, table, updated

### Community 892 - "Community 892"
Cohesion: 0.22
Nodes (9): Auto-Behaviors, code:block7 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), Continue State, Dashboard Viewer, Legacy paths, Lifecycle Directories, Status is a JSON field, not a directory, The four-artifact model (PAN-1124: single-spec-on-main) (+1 more)
...
Cohesion: 0.22
Nodes (8): Agent Directory Structure, Cleanup, code:bash (# Preview orphaned directories), Delivery artifacts, Legacy Directories, Specialists Do Not Use Agent Directories, Standard Directory Contents, Valid Directory Naming Patterns
...
Cohesion: 0.22
Nodes (9): attribution and attributableIndex, ChatGPT-specific markup: citeturn, iturn, code:block3 ([[Category:AfC submissions by date/<0030Fri, 13 Jun 2025 08:), code:block4 ([[Category:American hip hop musicians]]), code:block5 ([[Category:American hip-hop musicians]]), Markup, Non-existent or out-of-place categories and "see also" pages, Reference markup bugs: contentReference, oaicite, oai_citation, attached_file, grok_card (+1 more)

### Community 927 - "Community 927"
Cohesion: 0.22
Nodes (9): Didactic, editorializing disclaimers, Leads treating Wikipedia lists or broad article titles as proper nouns, Outline-like conclusions about challenges and future prospects, Promotional and advertisement-like language, Regression to the Mean, Summaries and conclusions, Superficial analyses, Undue emphasis on notability, attribution, and media coverage (+1 more)

### Community 928 - "Community 928"
Cohesion: 0.22
Nodes (9): Excessive synonym variance / elegant variation, False ranges, Language and Grammar, Negative parallelisms, Outlines of negatives, Overused "AI vocabulary" words, Rule of three, Title case in section headings (+1 more)

### Community 929 - "Community 929"
Cohesion: 0.22
Nodes (8): II. Elementary Rules Of Usage, Rule 1. Form the possessive singular of nouns by adding 's., Rule 2. In a series of three or more terms with a single conjunction, use a comma after each term except the last., Rule 3. Enclose parenthetic expressions between commas., Rule 4. Place a comma before a conjunction introducing a co-ordinate clause., Rule 5. Do not join independent clauses by a comma., Rule 6. Do not break sentences in two., Rule 7. A participial phrase at the beginning of a sentence must refer to the grammatical subject.
...
Cohesion: 0.22
Nodes (9): Cleanup After Shutdown, code:bash (pan down), code:bash (# Clean up log files), code:bash (# Monitor in one terminal), Forceful Shutdown, Graceful Shutdown (default), Graceful vs Forceful Shutdown, Hung Shutdown (+1 more)
...
Cohesion: 0.22
Nodes (8): Boundaries, Bypass shape, code:bash (git fetch origin main), code:bash (git checkout main), code:bash (npm run typecheck && npm test), No `model:` pin — Cloister resolves the model from config.yaml (roles.strike.model)., Panopticon Strike Role, Workflow

### Community 958 - "Community 958"
Cohesion: 0.22
Nodes (8): Discretion on parked items (decide, don't delegate), End of run, Entrypoint, No `model:` pin — Cloister resolves it from config.yaml roles.flywheel., Panopticon Flywheel Role, Status vs State, Substrate bug policy, Tick loop

### Community 959 - "Community 959"
Cohesion: 0.22
Nodes (9): GET /api/activity/:issueId — aggregate all agent sessions for an issue, GET/POST /api/planning/:issueId — planning artifact management, PAN-161: Mission Control — unified monitoring view and Shadow Engineering, MissionControl frontend component tree, .planning/ directory structure for workspace artifacts, Shadow Engineering — Monitoring and Observer agents for human workflow observation, ConversationPanel.tsx — current optimistic state handler for prompts, Local outbox — durable SQLite store for pending/failed conversation prompts (+1 more)
...
Cohesion: 0.25
Nodes (5): card, cards, fetchMock, insufficientStats, stats

### Community 968 - "Community 968"
Cohesion: 0.32
Nodes (7): cleanupSession(), conversationDir(), createSessionCalls, launcher, launcherFor(), socketDir, socketPath

### Community 969 - "Community 969"
Cohesion: 0.25
Nodes (6): chalk, identity(), mockWatchDirs, p, scanSpy, sessions
...
Cohesion: 0.25
Nodes (7): Known caveats — PAN-1336 (operator handles these by hand until it lands), Operating loop, Options, pan swarm, Prerequisite, See also, Slot agents are issue-tied and dashboard-visible
...
Cohesion: 0.29
Nodes (8): Dashboard API Caching Architecture, ~/.panopticon/cache.db (tracker cache database), CacheService (two-layer SQLite + in-memory), PAN-428 Codex Feedback (dashboard architecture review), IssueDataService (background poller), IssueDataService (existing centralized issue pipeline), TrackerConfig Service, useSocketIssues Hook (Socket.io frontend)

### Community 1012 - "Community 1012"
Cohesion: 0.25
Nodes (8): God View Activity Feed, God View Agent Grid, GET /api/agents/:id/files, GET /api/godview/system-health, GET /api/agents/:id/timeline, God View Dashboard, God View CSS Design System (theme.css), God View Focus View Overlay

### Community 1013 - "Community 1013"
Cohesion: 0.32
Nodes (8): checkLazyAgent() (17-pattern lazy detection), flywheel-change Issue Label, Flywheel Daemon (autonomous self-improvement loop), FLYWHEEL-REPORT.md (living self-improvement changelog), PAN-709 Self-Improving Flywheel PRD, retro-agent (post-merge retrospective agent), Skill audience field (operator | agent | both), waiting-on-human Agent State

### Community 1014 - "Community 1014"
Cohesion: 0.36
Nodes (8): Command Deck — Callout 01: Conversation + Composer, Command Deck — Callout 02: Tabbed Overview/Dashboard, Command Deck Terminology Map — Architecture Schematic (PAN-830), Command Deck — Top Navigation Bar, Command Deck — Zone A: Issue Header, Command Deck — Zone B: Agent Context, Command Deck — Zone C: Main Body (Dual Panel), PAN-830 — Unified Command Deck Redesign Issue

### Community 1015 - "Community 1015"
Cohesion: 0.43
Nodes (5): matchMemoryFirstTriggerPhrases(), matchMemoryFirstTriggers(), MEMORY_FIRST_TRIGGERS, MemoryFirstTrigger, MemoryFirstTriggerMatch
...
Cohesion: 0.29
Nodes (7): Curly quotation marks and apostrophes, Emojis, Excessive use of boldface, Inline-header vertical lists, Overuse of em dashes, Punctuation and Formatting, Subject lines
...
Cohesion: 0.29
Nodes (6): Cancel, code:bash (pan merge cancel <id>), code:bash (pan merge cancel PAN-123), Commands, Guardrails, pan merge
...
Cohesion: 0.33
Nodes (5): pan workspace create command, # panopticon-auto hosts file marker, Windows hosts file (C:\Windows\System32\drivers\etc\hosts), WSL2 hosts sync mechanism, WSL2 Hosts Sync README

### Community 1122 - "Community 1122"
Cohesion: 0.4
Nodes (6): addEndtoBlockProps(), createScalarToken(), setBlockScalarValue(), setFlowScalarValue(), setScalarValue(), stringifyString()
...
Cohesion: 0.4
Nodes (3): createWorkspace(), JsonBody, { resolveProjectFromIssueMock, spawnInspectAgentMock }
...
Cohesion: 0.5
Nodes (4): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified()
...
Cohesion: 0.83
Nodes (3): execFileAsync, openBrowser(), runCommand()
...
Cohesion: 0.67
Nodes (3): code:bash (pan plan PAN-1071), Starting planning, Step 1: Start Planning Session
...
## Knowledge Gaps
- **14363 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+14358 more)
...
- **Why does `ConversationEvent` connect `Project Resolution and Review Enrichment` to `Agent Session Lifecycle Management`, `Command Deck Overview Tab UI`, `Rally Tracker API Integration`, `Deacon Patrol and Queue`, `Specialist Handoff and Planning Spawn`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Community 521`, `Inspector Panel Terminal UI`, `Kanban Board Agent Status UI`, `Workspace Lifecycle and Config`, `Dashboard Caching Architecture Docs`, `Dashboard Store and Command Palette`, `Docker Stats and Container Resources`, `Command Deck Zone B Session Nodes`, `Cost Events Database and WAL Sync`, `Review Round Status Badge UI`, `Dashboard Design Docs and Mockups`, `CLI Install DNS and Dev Commands`, `Dangerous Git Operations Safety Guards`, `Work Type Routing and Config`, `Agent Status RPC Contracts`, `VBrief Task Readiness and Beads IO`, `Platform Supervisor Startup Lifecycle`, `Review Workflow Command Coordination`, `Fly Remote Provider and API Client`, `Project Skills Mirror and Sync`, `Pending Feedback Queue Delivery`, `GitHub Webhook Ingestion Handlers`, `GitHub Client and Agent Spawner`, `Community 579`, `Multi-Tracker Runtime Adapter Interface`, `Resource Process Discovery and Reporting`, `Skills Merge and Manifest Sync`, `Issue Search Modal and Filter State`, `Work Agent Prompt and Reopen Flow`, `Rally Tracker Adapter Tests`, `Conversation Panel and Chat Phase Types`, `Cost Data Migration and Reconciliation`, `Community 615`, `Specialist Agent Health Dashboard UI`, `Project Registration and Test Runner`, `TLDR Daemon State Management`, `Community 498`, `vBRIEF Continue State and Feedback Writing`, `Dashboard Terminal UI Components`, `Harness Integration Tests`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `string()` connect `Conversation Database and Favorites` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Agent Snapshot and Event Types`, `Community 522`, `Cloister Service Health and Config`, `Event Store Domain Services`, `Inspector Panel Terminal UI`, `Electron Desktop App and Tray`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Git Activity and Runtime Metrics`, `Dashboard HTTP Routes and Admin`, `VBrief Lifecycle IO and Transitions`, `Dialog Actions and System Health UI`, `CLI Commands and Runtime Adapters`, `Community 540`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Cost Calculation and Token Usage`, `VBrief Beads IO and Plan Finalize`, `Project Tree Feature Items UI`, `Dashboard Design Docs and Mockups`, `Cost Event Aggregation and Retention`, `Dashboard App Sidebar and Metrics`, `Chat Composer Model Picker`, `Community 559`, `Model Selection and Subscription Policy`, `Codex Agent Spawn UI Flow`, `Platform Supervisor Startup Lifecycle`, `Multi-Tool Sync and MCP Isolation`, `Issue Tracker Polling Service`, `System Health and Spawn Guardrails`, `Server Cache Service and Chat Markdown`, `Community 576`, `Community 577`, `Swarm Dispatch and DAG Execution`, `Settings Persistence and Model Defaults`, `Resource Process Discovery and Reporting`, `Merge Queue and App Settings Database`, `Path Constants and Postinstall Setup`, `Activity Panel and VTT Parsing`, `Read Model Enrichment and Agent Snapshots`, `Model Routing and Complexity Detection`, `Plan DAG Visualization and Beads Panel`, `CLI Command Taxonomy Reorganization`, `Frontend Dashboard Component Tests`, `Cliproxy Process Lifecycle Management`, `Event Snapshot Cache and State Reducers`, `Command Deck Action Registry Pipeline`, `Community 609`, `Community 1122`, `Database Settings and Cost Unit Tests`, `Project Config and Team Prefix Resolution`, `Issue Tracker Linking Tests`, `Config Migration and Test Agent`, `Cloister Pipeline Unit Tests`, `TLDR Daemon State Management`, `Cost Event Storage and WAL Tests`, `Smee Webhook Proxy Process Management`, `Caveman Hooks and Workspace Setup`, `FPP Policy Violation Detection and Nudging`, `Dashboard Terminal UI Components`, `Specialist Run Log Lifecycle`, `Conversation Smart Compaction`, `Issue State Mapping and Workflow Labels`, `Community 672`, `Workspace Service and Agent Spawner Tests`, `Work Done Preflight Validation`, `Self Improving Flywheel and Agent Messaging`, `Workspace Manager Artifact Migration`, `Project Skills Mirror and Sync`, `Agent Grid Dashboard UI Components`, `Codex Authentication and Credential Management`, `Workflow Orchestration and vBRIEF Research`, `Agent Types Pipeline Documentation`, `Community 710`, `Community 717`, `Community 718`, `CLI Init and Shell Configuration`, `Verification Runner and Sync Pipeline`, `Community 1241`, `Community 749`, `File and Editor Open Commands`, `Label Cleanup and Workflow Lifecycle Tests`, `Cost Tracking Hooks and Reconciliation`, `Dashboard Push Architecture and WebSocket RPC`, `Feature Metadata Badge and Modal Components`, `Community 796`, `God View Real-Time Agent Dashboard`, `Build Pipeline and Output Structure Docs`, `Fly.io Remote Provider Migration`, `Directive Flow DAG Issue Overview`, `Workspace Reopen and State Reset`, `t3code Architecture Alignment Research`, `Agent Health Monitor States`, `GitHub CLI Reference Skill`, `Community 890`, `Cost Event Recording Types`, `Community 404`, `Community 406`, `Community 426`, `Community 431`, `Community 433`, `Community 969`, `Community 461`, `Community 467`, `Community 468`, `Community 496`, `Community 498`, `Community 508`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Dashboard Store and Command Palette` to `Dashboard Design Docs and Mockups`, `Issue Tracker Project Resolution`, `Claude OAuth Authentication and Settings`, `Release Command Parsing Tests`, `Permission Request Bridge and Forwarding`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Are the 295 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 295 INFERRED edges - model-reasoned connections that need verification._
- **Are the 247 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 247 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _14363 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Agent Session Lifecycle Management` be split into smaller, more focused modules?**
