...
## Corpus Check
- 1745 files · ~2,325,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23888 nodes · 36601 edges · 1217 communities (1169 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 510 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cccd170a`
...
## Communities (1217 total, 48 thin omitted)
...
Cohesion: 0.03
Nodes (162): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+154 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (130): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, DetailPanelLayoutProps, loadPanelState(), PanelMode (+122 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (114): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+106 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (137): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (119): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+111 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (108): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+100 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (114): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (95): parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder, checkFn (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (111): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+103 more)
...
Cohesion: 0.03
Nodes (88): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+80 more)
...
Cohesion: 0.03
Nodes (84): ComposerMode, IssueComposer(), IssueComposerProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus() (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (81): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (82): checkApiErrorAgents(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (68): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+60 more)
...
Cohesion: 0.03
Nodes (68): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (69): embedAction(), ScanOptions, SearchQuery, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), ConversationFilter, countDiscoveredSessions(), findDiscoveredSessionIds() (+61 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (58): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+50 more)
...
Cohesion: 0.04
Nodes (70): readCavemanVariant(), finalizeRunLog(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (59): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (61): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+53 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (70): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, buildFilterSql(), CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet() (+62 more)
...
Cohesion: 0.03
Nodes (69): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+61 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (73): updateTtsConfig(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (55): { projectPath, workspacePath }, promoted, specFiles, doc, path, fsHooks, isRFC3339DateTime(), toRFC3339() (+47 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (60): clearFeedbackFiles(), buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+52 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (63): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+55 more)
...
Cohesion: 0.04
Nodes (61): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+53 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (58): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), writeWorkspaceContinue(), completePlanningArtifacts(), badPath, doc (+50 more)
...
Cohesion: 0.06
Nodes (55): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_RULES_DIR (+47 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (49): checkPendingTestDispatch(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult (+41 more)
...
Cohesion: 0.05
Nodes (48): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (49): DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+41 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (47): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+39 more)
...
Cohesion: 0.06
Nodes (47): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+39 more)
...
Cohesion: 0.06
Nodes (35): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, AssistantMessageRow(), formatElapsed(), formatTimestamp(), isReviewerContextMessage() (+27 more)
...
Cohesion: 0.09
Nodes (41): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+33 more)

### Community 67 - "Community 67"
Cohesion: 0.12
Nodes (46): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials (+38 more)
...
Cohesion: 0.08
Nodes (41): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+33 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (44): Access, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats() (+36 more)
...
Cohesion: 0.08
Nodes (33): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), extract_embedding(), _get_default_sink_state(), Handler, load_base_model() (+25 more)
...
Cohesion: 0.07
Nodes (37): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+29 more)
...
Cohesion: 0.09
Nodes (39): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+31 more)
...
Cohesion: 0.1
Nodes (42): acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonAuthToken() (+34 more)
...
Cohesion: 0.07
Nodes (34): agentDir, missing, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds(), Jsonish (+26 more)
...
Cohesion: 0.09
Nodes (34): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+26 more)
...
Cohesion: 0.09
Nodes (31): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, encodeBeadsVersion() (+23 more)
...
Cohesion: 0.11
Nodes (30): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+22 more)

### Community 184 - "Community 184"
Cohesion: 0.07
Nodes (25): getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), saveSessionId(), agentId, dir (+17 more)

### Community 185 - "Community 185"
Cohesion: 0.1
Nodes (32): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath() (+24 more)
...
Cohesion: 0.14
Nodes (30): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus() (+22 more)
...
Cohesion: 0.1
Nodes (26): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+18 more)
...
Cohesion: 0.11
Nodes (17): DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsRow(), SettingsRowProps, SettingsSection() (+9 more)
...
Cohesion: 0.16
Nodes (26): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+18 more)
...
Cohesion: 0.13
Nodes (21): checkTtsHealth(), speakTts(), startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+13 more)
...
Cohesion: 0.1
Nodes (20): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+12 more)
...
Cohesion: 0.1
Nodes (22): ClaudePermissionMode, ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, findDevrootForProject(), getConversationsConfig(), getConversationsConfigAsync() (+14 more)
...
Cohesion: 0.11
Nodes (14): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+6 more)
...
Cohesion: 0.16
Nodes (17): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+9 more)
...
Cohesion: 0.15
Nodes (20): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+12 more)
...
Cohesion: 0.16
Nodes (16): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+8 more)
...
Cohesion: 0.13
Nodes (10): isTtsDaemonManuallyStopped(), startCliproxyWatchdog(), startSharedPresencePoller(), readTtsWatchdogConfig(), TtsWatchdog, TtsWatchdogConfig, TtsWatchdogStatus, log (+2 more)
...
Cohesion: 0.17
Nodes (16): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+8 more)
...
Cohesion: 0.13
Nodes (17): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus (+9 more)
...
Cohesion: 0.2
Nodes (10): EventRouter(), CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize(), bigSnapshot, err (+2 more)
...
## Knowledge Gaps
- **12429 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12424 more)
...
- **Why does `fetch` connect `Community 0` to `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 1035`, `Community 12`, `Community 13`, `Community 270`, `Community 394`, `Community 650`, `Community 15`, `Community 18`, `Community 11`, `Community 20`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 154`, `Community 29`, `Community 288`, `Community 35`, `Community 297`, `Community 43`, `Community 172`, `Community 813`, `Community 46`, `Community 302`, `Community 428`, `Community 690`, `Community 50`, `Community 54`, `Community 55`, `Community 57`, `Community 697`, `Community 59`, `Community 62`, `Community 448`, `Community 195`, `Community 580`, `Community 67`, `Community 199`, `Community 215`, `Community 603`, `Community 608`, `Community 106`, `Community 235`, `Community 115`, `Community 117`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 4` to `Community 0`, `Community 1`, `Community 162`, `Community 39`, `Community 9`, `Community 205`, `Community 14`, `Community 47`, `Community 143`, `Community 369`, `Community 17`, `Community 19`, `Community 370`, `Community 343`, `Community 215`, `Community 27`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 98`, `Community 291`, `Community 36`, `Community 40`, `Community 11`, `Community 14`, `Community 21`, `Community 56`, `Community 92`, `Community 30`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12429 weakly-connected nodes found - possible documentation gaps or missing edges._
