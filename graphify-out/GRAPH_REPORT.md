...
## Corpus Check
- 1574 files · ~2,071,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22398 nodes · 33617 edges · 1164 communities (1126 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f546e20`
...
## Communities (1164 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (179): buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), performSpecialistWake() (+171 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (120): DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens(), InspectorPanel() (+112 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (132): fetchMessages(), resumeConversation(), fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation() (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (137): loadCloisterConfig(), shouldAutoStart(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+129 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (140): archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+132 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (134): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures (+126 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (105): setAgentStoppedNotifier(), emitCoordinatorDied(), spawnReviewCoordinatorSession(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+97 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (90): parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState, mockGetRuntimeForAgent, mockKillAgent (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (84): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+76 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (81): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+73 more)
...
Cohesion: 0.03
Nodes (92): readCavemanVariant(), getSpecialistHarness(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), bumpSessionGeneration(), clearSessionId(), DEFAULT_SPECIALISTS (+84 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (95): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+87 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (87): checkFailedMergeRetry(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearStaleCiFeedback(), DeaconLogEntry, getDeaconLogs() (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (72): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+64 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SkillsList() (+66 more)
...
Cohesion: 0.03
Nodes (72): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+64 more)
...
Cohesion: 0.04
Nodes (67): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), CommandDeck(), CommandDeckProps (+59 more)
...
Cohesion: 0.03
Nodes (74): agentDir, dir1, dir2, marker, missing, nested, PlanningIssue, invalidateAgentsCache() (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (71): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+63 more)
...
Cohesion: 0.03
Nodes (61): resetSessionCommand(), resumeCommand(), mirror, setAgentRuntimeMirror(), getLatestSessionId(), saveSessionId(), assertCanResumeSession(), getWorkAgentLifecycleState() (+53 more)
...
Cohesion: 0.05
Nodes (58): criteria, doc, result, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument(), formatAcceptanceCriteria() (+50 more)
...
Cohesion: 0.06
Nodes (59): healthCommand(), HealthOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+51 more)
...
Cohesion: 0.04
Nodes (59): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, CloisterHealth, fetchActivity(), formatDuration() (+51 more)
...
Cohesion: 0.04
Nodes (52): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+44 more)
...
Cohesion: 0.05
Nodes (53): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), badPath, customPlanningDir, dir, doc (+45 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (51): DetailPanelLayout(), formatCost(), formatTimestamp(), MergedSummaryCard(), MergedSummaryCardProps, button, costText, link (+43 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (56): isEligibleForCleanup(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+48 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (46): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentGrid(), AgentGridProps, ConnectionLines() (+38 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (55): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, AIProvider, BUDGETS_FILE, calculateCost() (+47 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (49): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+41 more)
...
Cohesion: 0.06
Nodes (49): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+41 more)
...
Cohesion: 0.05
Nodes (40): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+32 more)
...
Cohesion: 0.07
Nodes (19): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, execAsync, FlyProvider, FlyProviderConfig (+11 more)
...
Cohesion: 0.06
Nodes (36): ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps (+28 more)
...
Cohesion: 0.06
Nodes (38): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, FORK_STEPS, MessagesResponse, PHASE_ICONS, RoundMarker (+30 more)
...
Cohesion: 0.06
Nodes (29): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffWorkerPoolProvider() (+21 more)
...
Cohesion: 0.08
Nodes (35): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.05
Nodes (30): ComposerFooter(), getDefaultConversationModel(), ForkModal(), ForkModalProps, PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef() (+22 more)
...
Cohesion: 0.06
Nodes (29): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, createCall, dbError, deleteCalls (+21 more)
...
Cohesion: 0.1
Nodes (36): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), AGENT_CONVERSATION_PREFIXES, archiveConversation() (+28 more)
...
Cohesion: 0.08
Nodes (34): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+26 more)
...
Cohesion: 0.1
Nodes (32): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, CloseOutContext (+24 more)
...
Cohesion: 0.06
Nodes (31): getAllModels(), getCapabilityMatchScore(), getModelById(), OpenRouterFavoriteModel, DEFAULTS, UIPreferences, useUIPreferences(), DesktopSettings (+23 more)
...
Cohesion: 0.07
Nodes (30): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, ModelId, getAllWorkTypes() (+22 more)
...
Cohesion: 0.12
Nodes (33): killCommand(), KillOptions, destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode() (+25 more)
...
Cohesion: 0.08
Nodes (26): ModelProvider, ModelSelectionResult, getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter() (+18 more)
...
Cohesion: 0.13
Nodes (32): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry, readManifest() (+24 more)
...
Cohesion: 0.12
Nodes (30): wipeCommand(), archivePlanning(), closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close() (+22 more)

### Community 188 - "Community 188"
Cohesion: 0.07
Nodes (24): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), AgentState (+16 more)
...
Cohesion: 0.1
Nodes (27): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+19 more)
...
Cohesion: 0.11
Nodes (29): PrdLocation, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+21 more)
...
Cohesion: 0.08
Nodes (24): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+16 more)
...
Cohesion: 0.12
Nodes (22): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), getForgeAdapter(), ensureMergeSetForIssue() (+14 more)
...
Cohesion: 0.13
Nodes (19): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdStatus, STATUS_DIRS, statusRoot() (+11 more)
...
Cohesion: 0.13
Nodes (22): HandoffContext, ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents() (+14 more)
...
Cohesion: 0.13
Nodes (21): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+13 more)

### Community 326 - "Community 326"
Cohesion: 0.09
Nodes (21): MODELS_BY_PROVIDER, Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData() (+13 more)
...
Cohesion: 0.13
Nodes (15): ENV_FILE_PATH, loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode() (+7 more)
...
Cohesion: 0.14
Nodes (15): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, ApproveOptions (+7 more)
...
Cohesion: 0.2
Nodes (18): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+10 more)
...
Cohesion: 0.16
Nodes (15): CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), utf8ByteLength(), buildPermissionActivityDetails(), buildPermissionWaitingMessage(), normalizePermissionRequestBody() (+7 more)
...
Cohesion: 0.17
Nodes (12): resolvePlanLocation(), VBriefMergeConflictError, VBriefLifecycleDir, buildProjectIndex(), findVBriefByIssueAsync(), FoundVBriefAsync, getOrBuildIndex(), IndexEntry (+4 more)
...
Cohesion: 0.24
Nodes (11): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions (+3 more)
...
- **Why does `fetch` connect `Community 2` to `Community 129`, `Community 1`, `Community 130`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 396`, `Community 397`, `Community 142`, `Community 783`, `Community 15`, `Community 17`, `Community 14`, `Community 19`, `Community 20`, `Community 277`, `Community 21`, `Community 276`, `Community 28`, `Community 285`, `Community 159`, `Community 32`, `Community 545`, `Community 34`, `Community 35`, `Community 45`, `Community 47`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 190`, `Community 63`, `Community 66`, `Community 70`, `Community 993`, `Community 611`, `Community 612`, `Community 507`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 167` to `Community 8`, `Community 0`, `Community 188`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 10` to `Community 117`?**
