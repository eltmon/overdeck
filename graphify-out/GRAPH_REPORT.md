...
## Corpus Check
- 1545 files · ~2,065,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21579 nodes · 32124 edges · 1125 communities (1092 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c4848c6`
...
## Communities (1125 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (156): nudgeIdleWorkAgentsWithOpenBeads(), sendFeedbackToWorkAgent(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+148 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (132): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+124 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (119): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens() (+111 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (140): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+132 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (122): setAgentStoppedNotifier(), emitCoordinatorDied(), spawnReviewCoordinatorSession(), dispatchTestAgentAndNotify(), pendingCommand(), mockResolveProjectFromIssue, mockSetReviewStatus, mockSpawnEphemeralSpecialist (+114 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (128): reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname (+120 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (111): ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (121): readCavemanVariant(), spawnRebaseAgentForBranch(), rotateSpecialistSession(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+113 more)
...
Cohesion: 0.03
Nodes (89): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+81 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (74): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, createHandoffEvent(), generateHealthSummary() (+66 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (92): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (84): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+76 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (86): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (75): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (74): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (66): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), criteria, doc, result (+58 more)
...
Cohesion: 0.05
Nodes (77): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), cleanupLegacyRuntimeSymlinks() (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (71): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+63 more)
...
Cohesion: 0.04
Nodes (65): AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient(), GitHubClient (+57 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (72): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+64 more)
...
Cohesion: 0.03
Nodes (66): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (69): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem (+61 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (59): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (59): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (67): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+59 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (63): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+55 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (61): generateFallbackSummary(), generateSummaryForFork(), canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute (+53 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (46): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+38 more)
...
Cohesion: 0.05
Nodes (52): checkPendingTestDispatch(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename (+44 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (50): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (47): makeTestService(), sentinel, eightDaysAgo, events, payload, r1, r2, received (+39 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (51): createCostCommand(), runCostSync(), BUDGETS_FILE, calculateCost(), checkBudget(), CostBudget, CostEntry, CostSummary (+43 more)

### Community 40 - "Community 40"
Cohesion: 0.08
Nodes (48): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+40 more)
...
Cohesion: 0.07
Nodes (45): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), buildACLookupByTitle(), buildPolyrepoContext() (+37 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (45): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+37 more)
...
Cohesion: 0.06
Nodes (45): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+37 more)
...
Cohesion: 0.08
Nodes (44): useConfigCommand(), createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, getDefaultWorkspaceConfig(), HumeConfig, ProjectConfig (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (22): issues, result, importTrackerConfig(), computePlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+14 more)
...
Cohesion: 0.07
Nodes (37): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+29 more)
...
Cohesion: 0.12
Nodes (45): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials (+37 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (37): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+29 more)
...
Cohesion: 0.07
Nodes (37): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+29 more)
...
Cohesion: 0.06
Nodes (36): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+28 more)
...
Cohesion: 0.05
Nodes (35): db, makeTestLayer(), received, runWithService(), store, svc, unsubscribe, deleteDockerContainerRoute (+27 more)
...
Cohesion: 0.08
Nodes (26): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv() (+18 more)

### Community 98 - "Community 98"
Cohesion: 0.08
Nodes (36): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), ARCHIVES_DIR (+28 more)
...
Cohesion: 0.11
Nodes (27): parsePiSession(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), PiRuntime, piSessionDirFor(), PiSpawnConfig (+19 more)
...
Cohesion: 0.1
Nodes (32): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+24 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (29): firstSessionPanel, firstWorkbench, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps (+21 more)
...
Cohesion: 0.06
Nodes (35): initSchema(), base, cols, colsAfter, colsBefore, correctedPath, index, names (+27 more)
...
Cohesion: 0.06
Nodes (23): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+15 more)

### Community 134 - "Community 134"
Cohesion: 0.11
Nodes (31): writeStoryFeatureContext(), validatePlanMatchesIssue(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+23 more)
...
Cohesion: 0.07
Nodes (17): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+9 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (25): getTrackerContext(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync (+17 more)
...
Cohesion: 0.08
Nodes (29): CapabilityStats, DailyStats, fetchRuntimeMetrics(), formatCost(), formatDuration(), formatPercent(), getSuccessColor(), MetricsResponse (+21 more)
...
Cohesion: 0.08
Nodes (30): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+22 more)
...
Cohesion: 0.08
Nodes (20): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+12 more)
...
Cohesion: 0.1
Nodes (30): resolveModelId(), applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+22 more)
...
Cohesion: 0.14
Nodes (28): reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getAppStatus(), getBotIdentity(), getCommitCheckState() (+20 more)
...
Cohesion: 0.13
Nodes (26): closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+18 more)
...
Cohesion: 0.11
Nodes (25): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentPhase() (+17 more)

### Community 233 - "Community 233"
Cohesion: 0.12
Nodes (27): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+19 more)
...
Cohesion: 0.1
Nodes (17): ensureDefaultConversationModel(), WorkTypeOverridesProps, WorkTypeTable(), WorkTypeTableProps, PROVIDER_INFO, ProviderPanelProps, ApiKeysConfig, DeprecationWarning (+9 more)
...
Cohesion: 0.25
Nodes (25): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState() (+17 more)
...
Cohesion: 0.12
Nodes (18): getPiLauncherFields(), cleanupPiTransientFiles(), execAsync, createPiFifo(), destroyPiFifo(), execAsync, PiFifoPaths, PiNotReady (+10 more)
...
Cohesion: 0.14
Nodes (20): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+12 more)
...
Cohesion: 0.13
Nodes (6): clientMock, octokitMock, result, states, GitHubTracker, parseIssueNumber()

### Community 296 - "Community 296"
Cohesion: 0.17
Nodes (22): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+14 more)
...
Cohesion: 0.11
Nodes (19): result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions, detectApiError(), extractReviewerRole(), findLatestReviewRunDir(), readReviewerRounds() (+11 more)
...
Cohesion: 0.12
Nodes (20): DEFAULT_GATES, calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes (+12 more)
...
Cohesion: 0.21
Nodes (17): closeGitHubDirect(), closeGitHubPr(), CloseIssueOptions, closeLinearDirect(), closeRallyDirect(), closeViaDirect(), closeViaTracker(), execAsync (+9 more)
...
Cohesion: 0.11
Nodes (17): content, deleted, { filePath }, largeContent, metadata, oldDate, oldPath, path (+9 more)
...
Cohesion: 0.22
Nodes (11): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), buildRichPRBody(), ensurePRExists(), readBeadsFromJsonl() (+3 more)
...
Cohesion: 0.15
Nodes (12): actual, allLogs, logPath, mockConsoleError, mockConsoleLog, mockExec, mockExit, mockRuns (+4 more)
...
Cohesion: 0.25
Nodes (8): calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync }, LifecycleContext
...
Cohesion: 0.18
Nodes (10): agentIds, baseTimestamp, checkpoints, diffCheckpointFiles, encoder, getCheckpointTimestamp, listCheckpoints, startedAt (+2 more)
...
## Knowledge Gaps
- **11486 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11481 more)
...
- **Why does `fetch` connect `Community 7` to `Community 1`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 141`, `Community 142`, `Community 15`, `Community 13`, `Community 16`, `Community 17`, `Community 276`, `Community 20`, `Community 22`, `Community 154`, `Community 155`, `Community 157`, `Community 29`, `Community 803`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 180`, `Community 57`, `Community 316`, `Community 191`, `Community 74`, `Community 594`, `Community 595`, `Community 599`, `Community 217`, `Community 104`, `Community 748`, `Community 123`, `Community 126`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 0`, `Community 64`, `Community 13`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 4` to `Community 8`, `Community 6`, `Community 7`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11486 weakly-connected nodes found - possible documentation gaps or missing edges._
