...
## Corpus Check
- 1915 files · ~3,144,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27454 nodes · 43092 edges · 1303 communities (1250 shown, 53 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e426d70`
...
## Communities (1303 total, 53 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (184): ComposerMode, IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneAProps, ZoneActionStrip(), ZoneActionStripProps (+176 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (160): annotationsMap, appendAll, boolTag, branch, branchMatch, BREAK, buffer, byReferenceInstances (+152 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (162): ConversationList(), fetchConversations(), GeneralConversation, GeneralSectionProps, CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+154 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (171): checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), pauseFlywheel(), saveResumeSessionId(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand() (+163 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (139): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (124): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+116 more)
...
Cohesion: 0.03
Nodes (88): parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder, checkFn, killed (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (103): ArtifactLinksProps, EventRouter(), error, replayPromise, request, snapshot, unsubscribe, EDITOR_LABELS (+95 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (102): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (92): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+84 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (110): db, received, store, svc, unsubscribe, adminRouteLayer, getAdminTldrRoute, agentsRouteLayer (+102 more)
...
Cohesion: 0.03
Nodes (83): criteria, doc, result, beadsDir, doc, { projectPath, workspacePath }, promoted, specFiles (+75 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (99): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+91 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (83): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+75 more)
...
Cohesion: 0.03
Nodes (87): checkMissingReviewStatuses(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, buildConvoyPrompt(), buildReviewRolePrompt() (+79 more)
...
Cohesion: 0.03
Nodes (83): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), TtsDaemonStatus, buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate() (+75 more)
...
Cohesion: 0.02
Nodes (81): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+73 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (81): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+73 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (83): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+75 more)
...
Cohesion: 0.04
Nodes (79): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC() (+71 more)
...
Cohesion: 0.03
Nodes (67): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, FailedMessage (+59 more)
...
Cohesion: 0.04
Nodes (81): defaultRunWorkspace(), resolveProjectFromIssue(), getProjectPath(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+73 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (75): checkStuckReviewing(), finalizeRunLog(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+67 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (73): BLANKED_PROVIDER_ENV, buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, TmuxConfigMode (+65 more)
...
Cohesion: 0.04
Nodes (60): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+52 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (58): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcp() (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (52): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+44 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (62): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+54 more)
...
Cohesion: 0.07
Nodes (80): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), anchorNames(), applyReviver() (+72 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (74): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+66 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (60): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanelProps (+52 more)
...
Cohesion: 0.04
Nodes (57): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+49 more)
...
Cohesion: 0.05
Nodes (61): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+53 more)
...
Cohesion: 0.04
Nodes (62): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage() (+54 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (62): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, Access, checkAgentHealthAsync(), checkAgentHealthEffect() (+54 more)
...
Cohesion: 0.06
Nodes (61): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+53 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (56): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), contextMigrateCommand(), AddOptions, installGitHooks() (+48 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (59): AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+51 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (60): writeObservationRecord(), writeStatus(), writeDecision(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), ensureParentDir() (+52 more)
...
Cohesion: 0.03
Nodes (46): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL, applyDagreLayout() (+38 more)
...
Cohesion: 0.05
Nodes (51): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), doneCommand(), DoneOptions, execAsync (+43 more)
...
Cohesion: 0.09
Nodes (55): systemHealthCommand(), bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyEffect(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch() (+47 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (52): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+44 more)
...
Cohesion: 0.05
Nodes (49): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceShape (+41 more)
...
Cohesion: 0.07
Nodes (43): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest (+35 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (44): getReviewerSessionName(), result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+36 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (44): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+36 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (44): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+36 more)
...
Cohesion: 0.05
Nodes (44): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+36 more)
...
Cohesion: 0.05
Nodes (36): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), DiffWorkerPoolProvider(), formatAge(), FreshnessIndicator() (+28 more)
...
Cohesion: 0.07
Nodes (46): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), decodeFlywheelStatus, EmitStatusOptions, execAsync, FlywheelGateSnapshot, flywheelPauseCommand() (+38 more)
...
Cohesion: 0.09
Nodes (47): clearFlywheelRunGate(), flywheelAbortCommand(), loadReportFlywheelStatus(), startFlywheelRun(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun() (+39 more)
...
Cohesion: 0.06
Nodes (43): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+35 more)

### Community 98 - "Community 98"
Cohesion: 0.09
Nodes (46): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting(), getConversationByName() (+38 more)
...
Cohesion: 0.06
Nodes (36): captureTmuxOutput(), capturePaneAsyncEffect(), getWindowDimensionsAsyncEffect(), captureAgentOutputBeforeKill(), waitForClaudeReady(), activePtyHubs, addClientToHub(), broadcastToHub() (+28 more)
...
Cohesion: 0.05
Nodes (33): SearchResult, getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+25 more)
...
Cohesion: 0.06
Nodes (33): ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle(), EmitDetailedOptions (+25 more)

### Community 119 - "Community 119"
Cohesion: 0.06
Nodes (42): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), clearReviewStatus(), getIssueDataService(), cb, cmdArgs, key, mockExec (+34 more)

### Community 120 - "Community 120"
Cohesion: 0.08
Nodes (39): registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+31 more)
...
Cohesion: 0.06
Nodes (28): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState() (+20 more)
...
Cohesion: 0.07
Nodes (38): checkStuckWorkAgents(), parseThinkingDuration(), inferMemoryProjectId(), retrieveSpawnTimeMemoryContext(), roleAgentDefinitionPath(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK (+30 more)

### Community 133 - "Community 133"
Cohesion: 0.06
Nodes (40): dashboardBaseUrl(), emitStatusCommand(), flywheelStartCommand(), parseFlywheelStatusJson(), postFlywheelStatus(), readFlywheelStatusJson(), registerFlywheelCommands(), getFlywheelConversationPayload() (+32 more)
...
Cohesion: 0.06
Nodes (31): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+23 more)
...
Cohesion: 0.07
Nodes (32): conversationsTab, firstLens, lens, overview, tablist, ProjectRightPaneTabs(), IssueComposer(), IssueWorkbench() (+24 more)
...
Cohesion: 0.07
Nodes (32): assembleWorkspaceContext(), claude, out, pf, WorkspaceContextInput, HARNESS_MARKERS, HarnessMarker, KNOWN_HARNESS_MARKERS (+24 more)

### Community 161 - "Community 161"
Cohesion: 0.09
Nodes (39): parseCostThreshold(), addCommentBefore(), array, clone(), combine, createStringifyContext(), format(), formatPropertyKey() (+31 more)
...
Cohesion: 0.1
Nodes (32): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsDaemonConfigs(), YamlConfig, StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+24 more)
...
Cohesion: 0.11
Nodes (34): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+26 more)

### Community 185 - "Community 185"
Cohesion: 0.09
Nodes (29): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, buildChannelsArgs(), buildCommand() (+21 more)
...
Cohesion: 0.11
Nodes (37): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken() (+29 more)
...
Cohesion: 0.05
Nodes (33): makeTestLayer(), makeTestService(), runWithService(), eightDaysAgo, events, payload, r1, r2 (+25 more)
...
Cohesion: 0.09
Nodes (30): LOGS_DIR, DASHBOARD_LOG_FILE, describePid(), execAsync, isTraefikContainerRunning(), killPidsSync(), pidsOnPort(), PlatformConfig (+22 more)
...
Cohesion: 0.14
Nodes (35): extractNumber(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+27 more)
...
Cohesion: 0.09
Nodes (26): execAsync, rebaseFeatureBranch(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials (+18 more)
...
Cohesion: 0.08
Nodes (27): WorkLogEntry, ConversationPanel(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), PersistedState, useConversationUiState() (+19 more)
...
Cohesion: 0.09
Nodes (23): saveConfig(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), ProviderType, execAsync (+15 more)
...
Cohesion: 0.11
Nodes (3): stopDeacon(), createHandoffEvent(), CloisterService

### Community 230 - "Community 230"
Cohesion: 0.06
Nodes (33): updateConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+25 more)

### Community 231 - "Community 231"
Cohesion: 0.09
Nodes (28): embedAction(), runWithPool(), WorkPoolStats, DiscoveredSession, findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult (+20 more)

### Community 232 - "Community 232"
Cohesion: 0.08
Nodes (27): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+19 more)
...
Cohesion: 0.08
Nodes (28): bridgeCodexAuthToCliproxyEffect(), getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError (+20 more)
...
Cohesion: 0.08
Nodes (26): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockGetWorkspaceStackHealth, mockLoadReviewStatuses (+18 more)

### Community 247 - "Community 247"
Cohesion: 0.09
Nodes (25): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), createConfiguredClaudeApi(), EnrichSessionOptions, CostThresholdError, EnrichOptions (+17 more)
...
Cohesion: 0.09
Nodes (23): ARCHIVES_DIR, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+15 more)
...
Cohesion: 0.07
Nodes (28): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, Effort, fetchAvailableModels(), fetchClaudeAuth() (+20 more)
...
Cohesion: 0.08
Nodes (24): approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifactEffect(), CreateReviewArtifactInput, CreateReviewArtifactResult (+16 more)
...
Cohesion: 0.11
Nodes (23): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, EnrichedReviewStatus (+15 more)

### Community 269 - "Community 269"
Cohesion: 0.08
Nodes (23): ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS (+15 more)
...
Cohesion: 0.17
Nodes (25): handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments() (+17 more)
...
Cohesion: 0.1
Nodes (23): captureTldrMetrics(), compose(), decorate(), end(), getErrorPos(), getTldrMetrics(), next(), parse() (+15 more)
...
Cohesion: 0.22
Nodes (24): destroyRemoteWorkspace(), getManagedTmuxSocketName(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile() (+16 more)
...
Cohesion: 0.12
Nodes (19): recoverUnhealthyTestStack(), workspaceRebuildCommand(), StepResult, tempDirs, workspace, DevcontainerRenderResult, ensureDevcontainer(), EnsureDevcontainerInput (+11 more)
...
Cohesion: 0.11
Nodes (19): withConcurrencyLimit(), AgentOutputServiceState, diffLines(), pollOnce(), RunningAgent, serviceState, splitLines(), startAgentOutputService() (+11 more)
...
Cohesion: 0.1
Nodes (17): markAgentStateServiceInProcess(), mirror, setAgentRuntimeMirror(), saveSessionId(), agentId, dir, lifecycle, sessionExistsSpy (+9 more)
...
Cohesion: 0.13
Nodes (14): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+6 more)
...
Cohesion: 0.13
Nodes (16): handleAutoStartNag(), showFirstLaunchDialog(), deepClone(), DEFAULTS, DesktopSettings, loadDesktopSettings(), NotificationEventType, saveDesktopSettings() (+8 more)
...
Cohesion: 0.13
Nodes (9): wipeCommand(), WipeOptions, extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId() (+1 more)
...
Cohesion: 0.14
Nodes (11): getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeError, ShadowModeOptions, ShadowModeResult (+3 more)
...
Cohesion: 0.13
Nodes (16): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+8 more)
...
Cohesion: 0.22
Nodes (17): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), killOrphanedProcesses(), killTmuxSessions(), pruneCheckpointRefs() (+9 more)
...
Cohesion: 0.12
Nodes (17): compareObjects(), getRedacted(), hasProperty, isCause(), isContext(), isDieReason(), isEffect(), isEqual() (+9 more)
...
Cohesion: 0.22
Nodes (14): generateFallbackSummary(), handleConversationMessage(), extractConversationAttachmentPaths(), activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens() (+6 more)
...
Cohesion: 0.16
Nodes (12): after, callback, command, commit, files, mockExecCallback, mockResolveProject, mockSpawnReviewRoleForIssue (+4 more)
...
Cohesion: 0.36
Nodes (8): DatabaseError, getSettingEffect(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId(), setFlywheelGloballyPaused(), setSetting(), setSettingEffect()
...
## Knowledge Gaps
- **13565 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13560 more)
...
- **Why does `string()` connect `Community 161` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 516`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 1040`, `Community 17`, `Community 18`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 41`, `Community 46`, `Community 47`, `Community 49`, `Community 562`, `Community 51`, `Community 54`, `Community 55`, `Community 60`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 582`, `Community 73`, `Community 587`, `Community 588`, `Community 77`, `Community 78`, `Community 592`, `Community 83`, `Community 84`, `Community 91`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 119`, `Community 121`, `Community 636`, `Community 127`, `Community 132`, `Community 133`, `Community 138`, `Community 140`, `Community 148`, `Community 662`, `Community 669`, `Community 166`, `Community 168`, `Community 178`, `Community 188`, `Community 196`, `Community 197`, `Community 203`, `Community 204`, `Community 207`, `Community 216`, `Community 245`, `Community 246`, `Community 258`, `Community 259`, `Community 286`, `Community 803`, `Community 293`, `Community 295`, `Community 807`, `Community 809`, `Community 296`, `Community 306`, `Community 308`, `Community 321`, `Community 338`, `Community 340`, `Community 349`, `Community 350`, `Community 371`, `Community 373`, `Community 401`, `Community 405`, `Community 941`, `Community 431`, `Community 446`, `Community 492`, `Community 498`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 257`, `Community 258`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 22`, `Community 23`, `Community 153`, `Community 154`, `Community 283`, `Community 28`, `Community 29`, `Community 284`, `Community 27`, `Community 162`, `Community 35`, `Community 37`, `Community 38`, `Community 295`, `Community 294`, `Community 43`, `Community 48`, `Community 178`, `Community 188`, `Community 60`, `Community 62`, `Community 66`, `Community 67`, `Community 197`, `Community 70`, `Community 712`, `Community 74`, `Community 207`, `Community 82`, `Community 83`, `Community 86`, `Community 89`, `Community 477`, `Community 99`, `Community 228`, `Community 232`, `Community 234`, `Community 494`, `Community 496`, `Community 119`, `Community 761`, `Community 637`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 14` to `Community 320`, `Community 6`, `Community 7`, `Community 74`, `Community 77`, `Community 78`, `Community 15`, `Community 146`, `Community 212`, `Community 373`, `Community 23`, `Community 26`, `Community 30`, `Community 31`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13565 weakly-connected nodes found - possible documentation gaps or missing edges._
