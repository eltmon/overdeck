# Graph Report - feature-pan-1418  (2026-05-23)

## Corpus Check
- 1980 files · ~3,187,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28278 nodes · 44602 edges · 1336 communities (1281 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 831 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52f5b44c`
...
1. `string()` - 256 edges
2. `fetch` - 208 edges
3. `resolveProjectFromIssueSync()` - 128 edges
4. `useDashboardStore` - 98 edges
5. `FsError` - 81 edges
6. `getAgentStateSync()` - 71 edges
7. `sessionExists()` - 69 edges
8. `jsonResponse()` - 59 edges
9. `spawnRun()` - 56 edges
10. `spawnAgent()` - 55 edges
...
- `handoffPreconditionFallbackReason()` --calls--> `Access`  [INFERRED]
  src/lib/conversations/summary-fork.ts → docs/god-view.md
- `getIndexStats()` --calls--> `Access`  [INFERRED]
  src/dashboard/server/routes/misc.ts → docs/god-view.md

## Communities (1336 total, 55 thin omitted)
...
Cohesion: 0.01
Nodes (139): ConversationView(), AgentOutputPanel(), deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+131 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (172): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+164 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, ZoneA() (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (146): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription(), InspectResult (+138 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (129): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+121 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (106): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+98 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (95): activeAgent, cafSpy, client, menu, onNavigateToIssues, rafSpy, scrollSpy, tiles (+87 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (108): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+100 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (91): AgentTellForm(), AgentTellFormProps, PanOpenInPicker(), SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (93): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (102): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand() (+94 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (76): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync() (+68 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (100): EDITOR_LABELS, PanOpenInPickerProps, ArchivedConversationResponse, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets() (+92 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (96): getTrackerContext(), contextMigrateCommand(), AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand() (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (92): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+84 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (95): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+87 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (95): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+87 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (90): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+82 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (82): ViewMode, conversationsTab, firstLens, lens, overview, tablist, ConversationList(), ApiForkMode (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (87): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+79 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (86): appendChannelDeliveryLog(), applyAgentFailure(), applyAgentPaused(), applyAgentUnpaused(), clearAgentPaused(), clearAgentTroubled(), deliverAgentMessage(), deliverAgentPermissionDecision() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (90): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+82 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (86): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), ResolveAndSpeakDeps (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (70): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+62 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (81): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (63): { projectPath, workspacePath }, promoted, specFiles, fsHooks, doc, items, path, paths (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (74): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+66 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (78): activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields(), continueDirForWorkspace() (+70 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (73): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+65 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (69): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, createHandoffEvent(), performHandoff(), activeRoleRunExists(), AgentCrashTracker (+61 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (71): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (68): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+60 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (79): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), AutoMergeConfig, backupGlobalConfig(), CavemanConfig, CavemanMode (+71 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (84): ActivityDetailedEvent, ActivityEntryEvent, ActivityTtsEvent, ActivityUpdatedEvent, AgentActivityChangedEvent, AgentChannelReplyEvent, AgentCompletedEvent, AgentCreatedEvent (+76 more)
...
Cohesion: 0.04
Nodes (68): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+60 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (66): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+58 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (68): readCavemanVariant(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+60 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (62): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+54 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (65): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+57 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (69): importTrackerConfig(), result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute (+61 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (66): listConversations(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse, backfillConversationModels(), ConversationAboutSummary, deleteConversationFavoriteRoute (+58 more)
...
Cohesion: 0.05
Nodes (51): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (63): claim(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, resolvePendingDir() (+55 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (55): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+47 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (63): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (62): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback(), readPlanningContext() (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (40): countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), stopTranscriptPoller(), syncTranscriptPollerRegistry() (+32 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (49): AutoMergeRow, AutoMergeStatus, cancelPendingAutoMerge(), DbAutoMergeRow, getAutoMergeStatus(), getPendingAutoMerges(), markAutoMergeAborted(), markAutoMergeExecuted() (+41 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (52): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+44 more)
...
Cohesion: 0.05
Nodes (59): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+51 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (57): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+49 more)
...
Cohesion: 0.03
Nodes (48): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL (+40 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (62): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+54 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (57): fetchMessages(), resumeConversation(), updateConversationDeliveryMethod(), sendPlanAction(), ApiForkMode, archiveConversation(), ConversationMutations, favoriteConversation() (+49 more)
...
Cohesion: 0.06
Nodes (56): embedAction(), scan(), SearchQuery, showAction(), runWithPool(), WorkPoolStats, aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy() (+48 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (52): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), delay() (+44 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (49): buildManifestFromDirectory(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFileSync(), Manifest, ManifestEntry (+41 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (49): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+41 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (56): buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+48 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (56): applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+48 more)
...
Cohesion: 0.06
Nodes (59): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+51 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (54): array, combine, hash(), number(), optimize(), random(), structure(), structureKeys() (+46 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (43): appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+35 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (46): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+38 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (52): agentDir, missing, snapshot, status, AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), discoverNewAgentIds() (+44 more)

### Community 73 - "Community 73"
Cohesion: 0.04
Nodes (46): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+38 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (54): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+46 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (52): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+44 more)
...
Cohesion: 0.05
Nodes (51): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+43 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (45): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+37 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (51): BlockerReason, setReviewStatus(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckRunPromise() (+43 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (36): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore() (+28 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (44): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, FORK_STEPS, MessagesResponse, PHASE_ICONS, RoundMarker (+36 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (34): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode (+26 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (52): assertSafeAgentId(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+44 more)
...
Cohesion: 0.06
Nodes (44): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+36 more)
...
Cohesion: 0.1
Nodes (52): bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+44 more)

### Community 89 - "Community 89"
Cohesion: 0.04
Nodes (53): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, AgentOutput, ChatMessage (+45 more)

### Community 90 - "Community 90"
Cohesion: 0.07
Nodes (44): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+36 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (42): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+34 more)

### Community 92 - "Community 92"
Cohesion: 0.05
Nodes (41): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+33 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (45): parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), fetchProjectTree(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues() (+37 more)
...
Cohesion: 0.05
Nodes (43): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+35 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (43): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth() (+35 more)

### Community 97 - "Community 97"
Cohesion: 0.05
Nodes (39): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+31 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (38): recordAutoCloseOutFailure(), ActivityLevel, ActivitySource, emitActivityDetailedSync(), emitActivityEntrySync(), EmitActivityOptions, emitActivityTtsSync(), EmitDetailedOptions (+30 more)

### Community 99 - "Community 99"
Cohesion: 0.06
Nodes (44): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels() (+36 more)

### Community 100 - "Community 100"
Cohesion: 0.06
Nodes (40): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), CombinedCommitStatus, CombinedCommitStatusCheck, commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact() (+32 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (34): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+26 more)

### Community 102 - "Community 102"
Cohesion: 0.05
Nodes (36): RestartLockHandle, allowedOrigin(), applyCors(), heldRestartMessage(), LOG_FILE, platformConfig, sendJson(), server (+28 more)

### Community 103 - "Community 103"
Cohesion: 0.06
Nodes (42): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration() (+34 more)

### Community 104 - "Community 104"
Cohesion: 0.05
Nodes (42): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+34 more)
...
Cohesion: 0.07
Nodes (30): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, syncWalFromAllProjects(), IssueAggregate, BUDGETS_FILE (+22 more)

### Community 107 - "Community 107"
Cohesion: 0.07
Nodes (47): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise() (+39 more)

### Community 108 - "Community 108"
Cohesion: 0.06
Nodes (41): computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunningSync(), isSmeeRunningSync(), errorSpy (+33 more)

### Community 109 - "Community 109"
Cohesion: 0.04
Nodes (48): 1. Batch Processing, 1. Prompt caching, 2. Batch processing, 2. Cascade Approach, 3. Cascade, 3. Parallel Processing, 4. Parallel verification on critical decisions, Aider Polyglot (+40 more)
...
Cohesion: 0.06
Nodes (42): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+34 more)

### Community 114 - "Community 114"
Cohesion: 0.06
Nodes (34): ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, TeardownOptions, WorkflowResult, approve(), buildResult() (+26 more)

### Community 115 - "Community 115"
Cohesion: 0.09
Nodes (45): flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus (+37 more)

### Community 116 - "Community 116"
Cohesion: 0.07
Nodes (45): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), applyStashPromise(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createNamedStashPromise() (+37 more)
...
Cohesion: 0.08
Nodes (29): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHookSync(), clearHookSync(), collectMailSync(), generateFixedPointPromptSync(), getHookDir() (+21 more)

### Community 122 - "Community 122"
Cohesion: 0.05
Nodes (31): SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage (+23 more)
...
Cohesion: 0.11
Nodes (46): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), asItemIndex(), assertCollection() (+38 more)
...
Cohesion: 0.05
Nodes (31): SearchResult, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+23 more)

### Community 133 - "Community 133"
Cohesion: 0.07
Nodes (33): withBdMutexPromise(), withWorkspaceBdMutexPromise(), criteria, doc, result, beadsDir, doc, AcceptanceCriterion (+25 more)

### Community 134 - "Community 134"
Cohesion: 0.06
Nodes (34): getWindowDimensions(), startRealConversationRoutes(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub (+26 more)
...
Cohesion: 0.08
Nodes (40): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig (+32 more)

### Community 138 - "Community 138"
Cohesion: 0.09
Nodes (36): CopyConfigOptions, listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR (+28 more)

### Community 139 - "Community 139"
Cohesion: 0.08
Nodes (39): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+31 more)

### Community 140 - "Community 140"
Cohesion: 0.06
Nodes (31): applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModelsSync(), getAvailableModelsSync() (+23 more)

### Community 141 - "Community 141"
Cohesion: 0.05
Nodes (37): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+29 more)
...
Cohesion: 0.06
Nodes (33): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), AIProvider, calculateCostSync() (+25 more)
...
Cohesion: 0.08
Nodes (35): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+27 more)

### Community 152 - "Community 152"
Cohesion: 0.07
Nodes (40): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir(), compactOffsetCache, computeContextUsage(), ContentBlock (+32 more)
...
Cohesion: 0.07
Nodes (37): createSpecialistHandoff(), ensureLogDir(), getLiveQueueDepth(), getSpecialistHandoffLogFile(), getSpecialistHandoffStats(), getSpecialistHandoffStatsPromise(), getTodaySpecialistHandoffs(), logSpecialistHandoff() (+29 more)

### Community 159 - "Community 159"
Cohesion: 0.07
Nodes (34): execAsync, gatherArtifactsPromise(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, liftMonitoringError(), MonitoringAgentConfig, MonitoringAgentError (+26 more)

### Community 160 - "Community 160"
Cohesion: 0.06
Nodes (38): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute (+30 more)

### Community 161 - "Community 161"
Cohesion: 0.06
Nodes (37): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+29 more)
...
Cohesion: 0.07
Nodes (38): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+30 more)
...
Cohesion: 0.08
Nodes (30): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+22 more)

### Community 167 - "Community 167"
Cohesion: 0.06
Nodes (37): autoRevertMerge(), autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult (+29 more)

### Community 168 - "Community 168"
Cohesion: 0.06
Nodes (37): registerFlywheelCommands(), decodeFlywheelStatus, getFlywheelConversationPayload(), postFlywheelPausePayload(), postFlywheelResumePayload(), postFlywheelStartPayload(), postFlywheelStatusPayload(), subscribeLatestFlywheelStatus() (+29 more)
...
Cohesion: 0.06
Nodes (31): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatusSync(), hasLegacySettingsSync(), LEGACY_SETTINGS_PATH (+23 more)

### Community 171 - "Community 171"
Cohesion: 0.09
Nodes (34): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), resolveAndSpeak(), speakTts(), StoredEvent, ActivityTtsPayload (+26 more)
...
Cohesion: 0.09
Nodes (33): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+25 more)

### Community 175 - "Community 175"
Cohesion: 0.07
Nodes (26): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+18 more)
...
Cohesion: 0.07
Nodes (25): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, loadPanopticonEnvSync(), parseEnvFile(), getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary() (+17 more)

### Community 178 - "Community 178"
Cohesion: 0.12
Nodes (32): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+24 more)

### Community 179 - "Community 179"
Cohesion: 0.07
Nodes (32): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), createConfiguredClaudeApi() (+24 more)
...
Cohesion: 0.08
Nodes (33): deleteHumeConfig(), removeTunnelIngress(), getDefaultWorkspaceConfigSync(), AddReposToWorkspaceOptions, addReposToWorkspacePromise(), AddReposToWorkspaceResult, assignPort(), copyPanopticonSettingsToWorkspaceSync() (+25 more)

### Community 188 - "Community 188"
Cohesion: 0.1
Nodes (29): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync() (+21 more)

### Community 189 - "Community 189"
Cohesion: 0.09
Nodes (29): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+21 more)
...
Cohesion: 0.05
Nodes (26): AgentState, __testInternals, createSessionAsync, dir, emitActivityEntry, legacyDir, projectConfig, rawState (+18 more)
...
Cohesion: 0.09
Nodes (36): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData() (+28 more)
...
Cohesion: 0.11
Nodes (30): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+22 more)

### Community 207 - "Community 207"
Cohesion: 0.07
Nodes (32): ActionKey, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions(), normalizeCanonicalState(), ZoneAInput, ZoneBInput (+24 more)

### Community 208 - "Community 208"
Cohesion: 0.08
Nodes (17): issues, result, getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService (+9 more)
...
Cohesion: 0.06
Nodes (36): Activity, AgentChannelReply, AgentId, AgentResolution, AgentStatus, AutoMergeScheduledSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelReplyArtifactRef (+28 more)
...
Cohesion: 0.06
Nodes (10): FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock, machine (+2 more)
...
Cohesion: 0.1
Nodes (4): stopDeacon(), CloisterService, readStateFile(), writeStateFile()

### Community 222 - "Community 222"
Cohesion: 0.09
Nodes (31): activeViolations, checkAgentForViolations(), clearOldViolations(), clearOldViolationsSync(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig, FPPViolationType (+23 more)

### Community 223 - "Community 223"
Cohesion: 0.1
Nodes (30): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+22 more)

### Community 224 - "Community 224"
Cohesion: 0.09
Nodes (32): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+24 more)
...
Cohesion: 0.09
Nodes (24): startCommand(), stopCommand(), syncAuthCommand(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig() (+16 more)
...
Cohesion: 0.1
Nodes (29): runFullRestart(), DASHBOARD_LOG_FILE, describePid(), execAsync, isTraefikContainerRunningPromise(), killPidsSync(), pidsOnPort(), PlatformConfig (+21 more)

### Community 239 - "Community 239"
Cohesion: 0.09
Nodes (25): execAsync, rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, CheckpointError (+17 more)

### Community 240 - "Community 240"
Cohesion: 0.08
Nodes (22): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, StepResult, after, before, cfg (+14 more)
...
Cohesion: 0.06
Nodes (29): body, bytes, claudeProjectDir, conv, created, db, deliverMock, docPath (+21 more)
...
Cohesion: 0.1
Nodes (26): clearFeedbackFilesPromise(), readFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+18 more)

### Community 255 - "Community 255"
Cohesion: 0.09
Nodes (29): categorizeToolUse(), CompressedTranscriptDelta, compressEntry(), compressJsonlBuffer(), compressTranscriptDelta(), CompressTranscriptDeltaInput, extractBashCommand(), extractText() (+21 more)
...
Cohesion: 0.09
Nodes (25): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+17 more)

### Community 258 - "Community 258"
Cohesion: 0.13
Nodes (4): IssueDataService, issuesChanged(), mapRallyStateToCanonical(), validateRallyConfig()

### Community 259 - "Community 259"
Cohesion: 0.09
Nodes (27): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions (+19 more)

### Community 260 - "Community 260"
Cohesion: 0.08
Nodes (21): NormalizedTtsDaemonConfig, hasTtsDaemonState(), isTtsDaemonManuallyStopped(), startTtsDaemon(), startTtsDaemonFromDashboard(), parseTtsWatchdogIntEnv(), readTtsWatchdogConfig(), TtsWatchdog (+13 more)
...
Cohesion: 0.09
Nodes (26): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), stripFrontmatter(), syncSkillsToToolsSync(), syncToAider() (+18 more)

### Community 269 - "Community 269"
Cohesion: 0.09
Nodes (23): canonicalPrdSubdirSync(), findDraftPrdSync(), findPrdAnywhereSync(), findPrdAtStatusSync(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+15 more)

### Community 270 - "Community 270"
Cohesion: 0.13
Nodes (31): saveResumeSessionId(), loadConfigNoMigration(), runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync (+23 more)

### Community 271 - "Community 271"
Cohesion: 0.08
Nodes (26): searchFts(), buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI() (+18 more)
...
Cohesion: 0.11
Nodes (4): createFlyApiClientSync(), effFromPromise(), execAsync, FlyProvider
...
Cohesion: 0.1
Nodes (19): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+11 more)

### Community 282 - "Community 282"
Cohesion: 0.13
Nodes (23): workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, dangerBanner(), DangerousGitOpError, DangerousOp, DangerousOpBlockedError, dryRunGitClean(), dryRunGitCleanPromise() (+15 more)

### Community 283 - "Community 283"
Cohesion: 0.12
Nodes (28): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+20 more)

### Community 284 - "Community 284"
Cohesion: 0.1
Nodes (28): BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+20 more)

### Community 285 - "Community 285"
Cohesion: 0.06
Nodes (25): beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls, existingBeads (+17 more)

### Community 286 - "Community 286"
Cohesion: 0.1
Nodes (6): getActiveSessionModelSync(), getProjectDirsSync(), getSessionFilesSync(), parseClaudeSessionSync(), ClaudeCodeRuntime, ClaudeCodeRuntimeSync

### Community 287 - "Community 287"
Cohesion: 0.09
Nodes (23): runMemoryFtsStatement(), ageInDays(), buildIdentityPredicate(), buildMatchQuery(), extractQueryTerms(), HIGH_SIGNAL_TAGS, MemorySearchRow, normalizeLimit() (+15 more)

### Community 288 - "Community 288"
Cohesion: 0.08
Nodes (28): bridgeCodexAuthToCliproxy(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError (+20 more)

### Community 289 - "Community 289"
Cohesion: 0.11
Nodes (26): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), buildCorrelationMapSync(), CorrelationResult (+18 more)
...
Cohesion: 0.12
Nodes (17): contextCommand(), ContextOptions, appendSummarySync(), checkContextBudgetSync(), ContextBudget, estimateTokensSync(), generateSummaryEntry(), getHistoryDir() (+9 more)

### Community 300 - "Community 300"
Cohesion: 0.09
Nodes (20): CapabilityStats, clearMetricsSync(), DailyStats, DEFAULT_METRICS, getAggregatedMetricsSync(), getAllRuntimeMetricsSync(), getIssueTasksSync(), getRecentTasksSync() (+12 more)

### Community 301 - "Community 301"
Cohesion: 0.12
Nodes (28): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise(), getContextDigestPath(), getContextDirectory() (+20 more)

### Community 302 - "Community 302"
Cohesion: 0.1
Nodes (18): cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistorySync(), getAgentsWithHistorySync(), getAllHealthHistorySync(), getDatabaseStatsSync(), getHealthDatabase() (+10 more)
...
Cohesion: 0.12
Nodes (24): detectAwaitingInputForAgent(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+16 more)
...
Cohesion: 0.11
Nodes (24): AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex(), isRecentPromptIndex() (+16 more)

### Community 311 - "Community 311"
Cohesion: 0.14
Nodes (28): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+20 more)

### Community 312 - "Community 312"
Cohesion: 0.09
Nodes (28): applyEvent(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxMemoryObservationsPerIssue(), getMaxTurnDiffSummariesPerAgent(), MemoryHealthSnapshot, MemoryReadModelState (+20 more)
...
Cohesion: 0.12
Nodes (22): FsError, CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterSync(), createRuntimeRegistry(), getInstalledRuntimesPromise(), getRuntimeAdapter(), getSupportedRuntimes() (+14 more)

### Community 324 - "Community 324"
Cohesion: 0.09
Nodes (12): linearCall(), LinearTracker, constructorTracker, createdIssue, mockAssignee, mockClient, mockComment, mockIssue (+4 more)

### Community 325 - "Community 325"
Cohesion: 0.08
Nodes (19): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+11 more)
...
Cohesion: 0.13
Nodes (23): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapperSync(), LauncherConfig, LauncherHarness (+15 more)
...
Cohesion: 0.15
Nodes (25): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), hasPRDDraft(), hasPRDDraftPromise(), listPRDDrafts() (+17 more)

### Community 339 - "Community 339"
Cohesion: 0.13
Nodes (23): execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise(), gitPushPromise() (+15 more)
...
Cohesion: 0.07
Nodes (26): Agent Auto-Resume Gates, Beads Enforcement, Claude Code Channels (experimental), Claude Code Channels (experimental legacy fallback), Commit and Push When Working on Main, CRITICAL: Deep-Wipe Destroys Everything — NEVER Run Without Explicit User Confirmation, CRITICAL: Deliver Complete Features — No Partial Implementations, CRITICAL: JSONL Session Files Are Sacred — NEVER Delete (+18 more)
...
Cohesion: 0.08
Nodes (25): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+17 more)

### Community 357 - "Community 357"
Cohesion: 0.12
Nodes (19): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry(), resolveWindowUrl() (+11 more)
...
Cohesion: 0.11
Nodes (20): childEnv, expectedExits, killChildTree(), killChildTreeByPid(), port, requiredFiles, restartQueue, shutdown() (+12 more)
...
Cohesion: 0.1
Nodes (23): captureTldrMetricsSync(), compose(), decorate(), end(), getErrorPos(), getTldrMetricsSync(), next(), parse() (+15 more)
...
Cohesion: 0.12
Nodes (18): DatabaseError, dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+10 more)

### Community 367 - "Community 367"
Cohesion: 0.12
Nodes (16): ForgeType, buildMergeSetForIssueSync(), getRepoForge(), inferProjectForgeSync(), normalizeForgeSync(), resolveConfiguredReposSync(), ResolvedProjectRepo, resolveProjectReposForIssueSync() (+8 more)
...
Cohesion: 0.12
Nodes (15): completeSessionSync(), DEFAULT_DATA, findSessionByIdSync(), getAllIssuesWithCostsSync(), getIssueCostSummarySync(), getIssueSessionsSync(), IssueSessionMap, linkSessionToIssueSync() (+7 more)

### Community 371 - "Community 371"
Cohesion: 0.11
Nodes (23): parseLogMetadata(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual, allLogs (+15 more)
...
Cohesion: 0.12
Nodes (7): clientMock, octokitMock, result, states, GitHubTracker, octokitToProgram(), parseIssueNumber()

### Community 387 - "Community 387"
Cohesion: 0.14
Nodes (22): onInspectCompletePromise(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getCurrentHeadPromise(), getDiffBase(), getDiffBasePromise() (+14 more)
...
Cohesion: 0.13
Nodes (16): appendToRunLogSync(), checkLogSizeLimit(), createRunLogSync(), ensureRunsDirectory(), finalizeRunLogSync(), generateRunId(), getRunLogPath(), getRunLogSize() (+8 more)

### Community 390 - "Community 390"
Cohesion: 0.14
Nodes (20): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+12 more)

### Community 391 - "Community 391"
Cohesion: 0.08
Nodes (21): activeBytes, assistantLine, buffer, content, existingFiles, firstLine, fixture, fixturePath (+13 more)

### Community 392 - "Community 392"
Cohesion: 0.23
Nodes (23): destroyRemoteWorkspace(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs() (+15 more)
...
Cohesion: 0.08
Nodes (23): Claude Code subagents (NOT Panopticon roles), code:block1 (pan plan finalize), code:json ({), code:json ({), continue.vbrief.json Format, CRITICAL: PLANNING ONLY - NO IMPLEMENTATION, Description, Difficulty Estimation (+15 more)

### Community 416 - "Community 416"
Cohesion: 0.09
Nodes (22): branch, branchMatch, buffer, cavemanVariant, cost, entry, input, lines (+14 more)
...
Cohesion: 0.17
Nodes (22): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), deleteBranchesImpl(), execAsync, isDockerContainerProcess() (+14 more)
...
Cohesion: 0.09
Nodes (19): agentStateDir, closeIssueMock, commands, execMock, fixtureRoot, graphifyRefreshIndex, movePrdMock, planningStateDir (+11 more)
...
Cohesion: 0.1
Nodes (21): actionSets, createQueryClient(), drawerActionBar(), drawerIssueActionIds(), drawerUi(), fetchMock, first, issue (+13 more)
...
Cohesion: 0.12
Nodes (17): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), sshCommand(), runModelSummaryPromise() (+9 more)
...
Cohesion: 0.1
Nodes (20): agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS, legacyFields (+12 more)
...
Cohesion: 0.11
Nodes (19): getRecentRunLogs(), listRunLogsSync(), content, deleted, { filePath }, largeContent, metadata, oldDate (+11 more)
...
Cohesion: 0.15
Nodes (17): CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript() (+9 more)
...
Cohesion: 0.14
Nodes (17): assertIssueHasBeads(), assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue() (+9 more)

### Community 489 - "Community 489"
Cohesion: 0.17
Nodes (17): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+9 more)
...
Cohesion: 0.13
Nodes (15): AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState, ConversationFeedCard(), ConversationFeedCardProps, readAgentState(), STATUS_DOT_COLORS, CommentSessionFeedEntry (+7 more)
...
Cohesion: 0.12
Nodes (16): activeAgent, address, agent, drawerActionBar, feature, frontendRoot, issue, newContext() (+8 more)
...
Cohesion: 0.16
Nodes (15): EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), enrichReviewStatusPromise(), mostRecentByTimestamp(), parseReviewerTimestamp(), parseTrailingTimestamp(), ReviewEnrichmentError (+7 more)

### Community 506 - "Community 506"
Cohesion: 0.18
Nodes (11): after, before, blockers, result, statuses, clearReviewStatusSync(), DEFAULT_STATUS_FILE, getReviewStatusSync() (+3 more)

### Community 507 - "Community 507"
Cohesion: 0.2
Nodes (16): syncBeadStatusToVBrief(), BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChanges(), checkUncommittedChangesPromise(), checkVBriefACStatusSync(), errorCode() (+8 more)

### Community 508 - "Community 508"
Cohesion: 0.2
Nodes (17): ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent() (+9 more)

### Community 509 - "Community 509"
Cohesion: 0.19
Nodes (12): startPostLaunchSidecars(), startSidecars(), getSupervisorPortSync(), getSupervisorUrlSync(), isProcessAlive(), isSupervisorRunningSync(), readSupervisorPid(), resolveSupervisorBundle() (+4 more)
...
Cohesion: 0.16
Nodes (15): cleanupStaleLocksPromise(), execAsync, findGitLockFiles(), getWorkspaceGitInfo(), getWorkspaceGitInfoPromise(), hasRunningGitProcesses(), hasStaleLocks(), hasStaleLocksPromise() (+7 more)
...
Cohesion: 0.11
Nodes (14): ensuredLabels, makeTestLayer(), mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubEnsureLabel, mockGitHubRemoveLabel, mockGitHubReopenIssue, mockLinearGetIssue (+6 more)
...
Cohesion: 0.12
Nodes (16): Cleanup After Shutdown, code:bash (# Method 1: Separate commands), code:bash (# Clean up log files), code:bash (# Clean up stale resources), code:env (# Graceful shutdown timeout (seconds)), Configuration Options, More Information, Next Steps (+8 more)
...
Cohesion: 0.21
Nodes (9): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackupsSync(), createBackupSync(), createBackupTimestamp(), listBackupsSync() (+1 more)
...
Cohesion: 0.16
Nodes (14): clearRunningAgentsCache(), getCachedRunningAgents(), ListAgentsProgram, RunningAgent, RunningAgents, runningAgentsCache, sweepExpired(), firstAgents (+6 more)

### Community 562 - "Community 562"
Cohesion: 0.18
Nodes (9): buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlagsSync(), readYoloEnv(), resolvePermissionModeSync(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+1 more)
...
Cohesion: 0.18
Nodes (13): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), HealthThresholds, config (+5 more)

### Community 579 - "Community 579"
Cohesion: 0.13
Nodes (10): DeaconState, customPromisify, justNow, longAgo, old, recent, restartCalled, state (+2 more)

### Community 580 - "Community 580"
Cohesion: 0.17
Nodes (12): emitDashboardLifecycleSync(), data, mockExistsSync, mockReadFile, mockUnlink, runner, LifecycleRunner, PENDING_FILE (+4 more)
...
Cohesion: 0.13
Nodes (12): mockDeepWipe, mockExistsSync, mockGetAgentState, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue, mockSpawnAgent, mockSpawnPlanningSession (+4 more)
...
Cohesion: 0.16
Nodes (14): appendCostEventSync(), appendToWalSync(), ensureEventsFile(), extractPrefixSync(), getCostsDir(), getEventsFile(), insertCostEvent(), listProjectsSync() (+6 more)
...
Cohesion: 0.34
Nodes (12): acquireRestartLockPromise(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolderPromise(), RestartLockError (+4 more)
...
Cohesion: 0.14
Nodes (12): dir, event, eventsDir1, eventsDir2, line, lines, mockListProjects, parsed (+4 more)
...
Cohesion: 0.14
Nodes (11): mockDeepWipe, mockExistsSync, mockGetAgentState, mockMessageAgent, mockMkdir, mockResolveProjectFromIssue, mockSpawnAgent, mockSpawnPlanningSession (+3 more)
...
Cohesion: 0.15
Nodes (12): resetPostMergeState(), first, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref (+4 more)
...
Cohesion: 0.28
Nodes (12): buildStatus(), decodeBase64Url(), decodeJwtPayload(), getCodexAuthPath(), getJwtExpiry(), getOpenAIAuthStatusPromise(), getOpenAIAuthStatusSync(), hasApiKey() (+4 more)
...
Cohesion: 0.15
Nodes (12): Conversation Forks, Developer Notes, Fork Modes, Fork Options, Handoff (agent-authored), Handoff Prompt Template, Model Switching, Plain Fork (+4 more)
...
Cohesion: 0.17
Nodes (8): dispatchMenuAction(), baseFlywheelStatus, consoleErrors, metrics, MockWebSocket, status, statusPane, suggestionsSection

### Community 689 - "Community 689"
Cohesion: 0.17
Nodes (7): runVerificationForIssue(), commands, {
  execMock,
  setReviewStatusMock,
  getReviewStatusMock,
  runQualityGatesMock,
...
Cohesion: 0.29
Nodes (10): cleanupAgentDirectories(), cleanupAgentDirectoriesPromise(), CleanupResult, findOrphanedAgentDirs(), findOrphanedAgentDirsPromise(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:bash (pan merge --help), code:bash (pan merge cancel <issueId>), code:text (Cancelled auto-merge for PAN-1234), code:text (Usage: pan merge [options] [command]), code:text (Usage: pan merge cancel [options] <issueId>), Help surface, Merge Flow Guidance, Output and exit codes (+3 more)
...
Cohesion: 0.25
Nodes (9): InspectContext, spawnInspectAgent(), getDiffStats(), inspectCommand(), InspectOptions, registerInspectCommand(), inspect, { mockResolveProjectFromIssue, mockSpawnInspectAgent, mockGetDiffBase, mockGetDiffStats } (+1 more)
...
Cohesion: 0.22
Nodes (6): { activeSessions }, agentDir, fortyMinutesAgo, runDetermineHealthStatus(), twentyMinutesAgo, determineHealthStatus()

### Community 784 - "Community 784"
Cohesion: 0.2
Nodes (5): execFileMock, postMergeLifecycleMock, readContinueStateProgramMock, readdirSyncMock, resolveGitHubIssueMock
...
Cohesion: 0.2
Nodes (9): colNames, cols, columns, db, indexes, names, row, stuckCol (+1 more)
...
Cohesion: 0.2
Nodes (8): GIT_PATTERNS, scanGitPatterns(), MainDivergedError, mockAppendGitOperation, mockEmitActivityEntry, mockEmitDashboardLifecycle, pattern, seen

### Community 789 - "Community 789"
Cohesion: 0.2
Nodes (8): activityResult, costsResult, costStreamResult, discussionsResult, planningResult, planningSummaryResult, prResult, reviewStatusResult
...
Cohesion: 0.28
Nodes (7): detectTestCommand(), detectTestCommandSync(), fileExists(), command, jestConfig, packageJson, testDir
...
Cohesion: 0.25
Nodes (5): BIN_DIR, __dirname, HOOKS_SOURCE_DIR, NATIVE_MODULES, PACKAGE_ROOT
...
Cohesion: 0.32
Nodes (5): ActivityFeedCard(), ActivityFeedCardProps, ActivitySessionFeedEntry, onSelect, time
...
Cohesion: 0.25
Nodes (7): Agent Directory Structure, Cleanup, code:bash (# Preview orphaned directories), Delivery artifacts, Legacy Directories, Standard Directory Contents, Valid Directory Naming Patterns
...
Cohesion: 0.33
Nodes (5): Auto-Merge, code:yaml (merge:), Gate behavior, Settings, Where to configure it
...
Cohesion: 0.6
Nodes (5): cleanupAllLogsSync(), cleanupOldLogsSync(), listProjectsWithSpecialists(), getSpecialistRetention(), cleanupLogsCommand()
...
Cohesion: 0.4
Nodes (4): mockCleanupUnreferencedConversationAttachments, mockListActiveConversations, mockListSessionNames, mockMarkConversationEnded
...
## Knowledge Gaps
- **13949 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13944 more)
...
- **Why does `string()` connect `Community 2` to `Community 0`, `Community 1`, `Community 512`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 519`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 37`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 53`, `Community 54`, `Community 56`, `Community 58`, `Community 61`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 71`, `Community 583`, `Community 74`, `Community 77`, `Community 79`, `Community 84`, `Community 88`, `Community 90`, `Community 92`, `Community 608`, `Community 610`, `Community 100`, `Community 102`, `Community 104`, `Community 616`, `Community 106`, `Community 107`, `Community 108`, `Community 115`, `Community 116`, `Community 127`, `Community 133`, `Community 150`, `Community 662`, `Community 159`, `Community 161`, `Community 167`, `Community 168`, `Community 175`, `Community 1200`, `Community 176`, `Community 688`, `Community 179`, `Community 178`, `Community 694`, `Community 696`, `Community 187`, `Community 699`, `Community 198`, `Community 206`, `Community 217`, `Community 736`, `Community 224`, `Community 238`, `Community 254`, `Community 257`, `Community 260`, `Community 267`, `Community 272`, `Community 311`, `Community 830`, `Community 833`, `Community 324`, `Community 325`, `Community 339`, `Community 357`, `Community 360`, `Community 369`, `Community 386`, `Community 389`, `Community 390`, `Community 912`, `Community 419`, `Community 425`, `Community 449`, `Community 463`, `Community 475`, `Community 488`, `Community 489`, `Community 493`, `Community 507`, `Community 509`, `Community 511`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 59` to `Community 256`, `Community 1`, `Community 2`, `Community 3`, `Community 258`, `Community 5`, `Community 6`, `Community 8`, `Community 137`, `Community 10`, `Community 13`, `Community 15`, `Community 272`, `Community 18`, `Community 659`, `Community 20`, `Community 19`, `Community 790`, `Community 24`, `Community 26`, `Community 31`, `Community 161`, `Community 162`, `Community 166`, `Community 424`, `Community 169`, `Community 298`, `Community 46`, `Community 559`, `Community 1200`, `Community 50`, `Community 179`, `Community 51`, `Community 55`, `Community 56`, `Community 696`, `Community 58`, `Community 697`, `Community 447`, `Community 448`, `Community 67`, `Community 326`, `Community 76`, `Community 81`, `Community 87`, `Community 217`, `Community 90`, `Community 92`, `Community 223`, `Community 736`, `Community 99`, `Community 228`, `Community 740`, `Community 103`, `Community 615`, `Community 359`, `Community 107`, `Community 493`, `Community 238`, `Community 1135`, `Community 1134`, `Community 372`, `Community 244`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 26` to `Community 225`, `Community 133`, `Community 5`, `Community 7`, `Community 41`, `Community 48`, `Community 16`, `Community 114`, `Community 53`, `Community 25`, `Community 28`, `Community 285`, `Community 31`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Are the 234 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 234 INFERRED edges - model-reasoned connections that need verification._
- **Are the 207 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 207 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13949 weakly-connected nodes found - possible documentation gaps or missing edges._
