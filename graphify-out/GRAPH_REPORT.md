...
## Corpus Check
- 1920 files · ~3,144,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27462 nodes · 43088 edges · 1311 communities (1252 shown, 59 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17e8b623`
...
## Communities (1311 total, 59 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (185): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+177 more)
...
Cohesion: 0.03
Nodes (169): monitorReviewConvoySignals(), spawnInspectAgentPromise(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand() (+161 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (135): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+127 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (161): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+153 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (118): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (111): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (137): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (128): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+120 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (106): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+98 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (110): containerRestartBackoffMs(), DeaconState, captureTmuxOutput(), isMergeAgentRunning(), customPromisify, justNow, longAgo, old (+102 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (104): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTab, OverviewTabSpec (+96 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (103): fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted, putCall (+95 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (87): updateConversationTitle(), useZoneAActions(), ZoneAProps, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+79 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (92): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+84 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (101): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename, getConflictFiles() (+93 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (93): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+85 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (71): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), captureHandoffContext(), detectHandoffMethod() (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (89): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (98): DatabaseError, dequeueMerge(), enqueueMerge(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next (+90 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (94): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+86 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (91): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+83 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (82): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+74 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (78): PlanningState, ZoneAActionsState, SwitchModelModal(), VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, classifyStreamLine(), DrawerActiveAgent() (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (74): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+66 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (83): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+75 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (69): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+61 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (76): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+68 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (81): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+73 more)
...
Cohesion: 0.04
Nodes (71): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+63 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (72): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+64 more)
...
Cohesion: 0.04
Nodes (70): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+62 more)
...
Cohesion: 0.04
Nodes (70): readCavemanVariant(), finalizeRunLogSync(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+62 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (57): parsePiSessionSync(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (56): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (65): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+57 more)
...
Cohesion: 0.04
Nodes (73): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+65 more)
...
Cohesion: 0.05
Nodes (69): defaults, first, { models }, second, clearConfigCache(), ModelRef, WorkhorsesConfig, WorkhorseSlot (+61 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (62): buildPolyrepoContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+54 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (53): deleteHumeConfig(), content, d, existingDir, lines, oldDir, result, skillDir (+45 more)
...
Cohesion: 0.04
Nodes (56): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), clearFeedbackFiles(), FeedbackWriteError (+48 more)
...
Cohesion: 0.06
Nodes (55): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+47 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (58): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailedSync(), AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), withConcurrencyLimit(), clearReviewStatus() (+50 more)
...
Cohesion: 0.06
Nodes (53): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+45 more)
...
Cohesion: 0.05
Nodes (45): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), compactBeadsImpl(), CompactBeadsOptions, execAsync (+37 more)
...
Cohesion: 0.05
Nodes (57): array, combine, compareObjects(), hash(), isEqual(), number(), optimize(), random() (+49 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (56): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy() (+48 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (53): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+45 more)
...
Cohesion: 0.06
Nodes (54): detectAwaitingInputForAgent(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+46 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (48): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+40 more)
...
Cohesion: 0.05
Nodes (24): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getProjectDirsSync(), getRecentSessionsSync(), getSessionFilesSync(), normalizeModelName(), parseAllSessionsSync() (+16 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (54): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+46 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (50): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+42 more)
...
Cohesion: 0.05
Nodes (49): HealthCheck, systemHealthCommand(), mockExistsSync, mockFetch, mockGetDashboardApiUrl, mockIsCliproxyRunning, mockIsSmeeProcessRunning, output (+41 more)

### Community 71 - "Community 71"
Cohesion: 0.04
Nodes (37): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore() (+29 more)
...
Cohesion: 0.07
Nodes (43): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+35 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (56): addCommentBefore(), addMergeToJSMap(), ALIAS, anchorIsValid(), callVisitor(), captureTldrMetricsSync(), createNode(), createNodeAnchors() (+48 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (47): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+39 more)
...
Cohesion: 0.06
Nodes (43): confirmCost(), enrichAction(), formatCost(), markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt() (+35 more)
...
Cohesion: 0.06
Nodes (43): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+35 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (44): reopenWorkspaceStatePromise(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+36 more)
...
Cohesion: 0.07
Nodes (33): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, importSessionToCostLog(), syncWalFromAllProjects(), IssueAggregate (+25 more)

### Community 90 - "Community 90"
Cohesion: 0.07
Nodes (37): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, AnthropicExtractionProvider (+29 more)
...
Cohesion: 0.05
Nodes (45): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceLive, ReadModelServiceShape (+37 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (51): add, addIn(), addPairToJSMap(), anchorNames(), applyReviver(), asItemIndex(), assertCollection(), atDocument() (+43 more)
...
Cohesion: 0.11
Nodes (48): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+40 more)
...
Cohesion: 0.08
Nodes (42): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+34 more)
...
Cohesion: 0.06
Nodes (37): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+29 more)
...
Cohesion: 0.07
Nodes (38): appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogsSync(), cleanupOldLogsSync(), createRunLogSync(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+30 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (37): createDatabase(), databases, getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement, memoryFtsWorkerSource(), migrateMemoryFtsBranchColumn() (+29 more)
...
Cohesion: 0.06
Nodes (27): SETTINGS_FILE, getKimiAnthropicBaseUrl(), getProviderEnvSync(), ProviderAuthType, ProviderName, PROVIDERS, AnthropicModel, ApiKeysConfig (+19 more)
...
Cohesion: 0.05
Nodes (34): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+26 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (37): embedAction(), findEnrichedSessionIdsMissingEmbedding(), searchFts(), buildEmbeddingText(), EmbedProgress, EmbedResult, embedSessions(), EmbedSessionsOptions (+29 more)
...
Cohesion: 0.08
Nodes (37): getTrackerContext(), projectListCommand(), projectShowCommand(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments() (+29 more)
...
Cohesion: 0.1
Nodes (36): destroyRemoteWorkspace(), createFlyProvider(), execAsync, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider() (+28 more)
...
Cohesion: 0.07
Nodes (31): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+23 more)
...
Cohesion: 0.08
Nodes (34): getHealthThresholdsMs(), evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke() (+26 more)
...
Cohesion: 0.13
Nodes (32): GitHubApiError, LinearApiError, getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv (+24 more)

### Community 160 - "Community 160"
Cohesion: 0.07
Nodes (36): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+28 more)
...
Cohesion: 0.08
Nodes (30): useAvailableModels(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem() (+22 more)
...
Cohesion: 0.09
Nodes (32): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+24 more)
...
Cohesion: 0.09
Nodes (29): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssuePromise(), SyncResult, syncSingleRepo(), VerificationRunnerOptions (+21 more)
...
Cohesion: 0.08
Nodes (31): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+23 more)
...
Cohesion: 0.08
Nodes (23): execAsync, rebaseFeatureBranchPromise(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+15 more)
...
Cohesion: 0.08
Nodes (25): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+17 more)

### Community 220 - "Community 220"
Cohesion: 0.1
Nodes (28): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+20 more)
...
Cohesion: 0.12
Nodes (32): getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), loadConfigNoMigration(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting() (+24 more)
...
Cohesion: 0.07
Nodes (23): recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), announceMerge(), ActivityLevel, ActivitySource, emitActivityEntrySync(), EmitActivityOptions, emitActivityTtsSync() (+15 more)
...
Cohesion: 0.1
Nodes (14): getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+6 more)

### Community 244 - "Community 244"
Cohesion: 0.08
Nodes (24): issues, result, importTrackerConfig(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+16 more)
...
Cohesion: 0.09
Nodes (18): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+10 more)
...
Cohesion: 0.08
Nodes (24): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+16 more)
...
Cohesion: 0.08
Nodes (25): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, BuildReviewerNodesOptions, CONVOY_REVIEWER_ROLES (+17 more)
...
Cohesion: 0.13
Nodes (27): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId() (+19 more)
...
Cohesion: 0.09
Nodes (26): doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending, QueuedCommit (+18 more)
...
Cohesion: 0.14
Nodes (28): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise() (+20 more)
...
Cohesion: 0.11
Nodes (25): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContextError (+17 more)

### Community 284 - "Community 284"
Cohesion: 0.08
Nodes (26): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), parseRelativeTime(), UpsertDiscoveredSessionOpts, parseSearchParams() (+18 more)
...
Cohesion: 0.1
Nodes (21): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact(), CreateReviewArtifactInput, CreateReviewArtifactResult (+13 more)
...
Cohesion: 0.07
Nodes (20): AgentState, __testInternals, createSessionAsync, dir, emitActivityEntry, legacyDir, projectConfig, rawState (+12 more)

### Community 315 - "Community 315"
Cohesion: 0.09
Nodes (25): calculateCostSync(), DEFAULT_PRICING, getPricingSync(), logUsageSync(), ModelPricing, anthropicModels, cost, entries (+17 more)
...
Cohesion: 0.12
Nodes (22): generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+14 more)
...
Cohesion: 0.14
Nodes (21): resolveAndSpeak(), extractTtsEmbedding(), speakTts(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts() (+13 more)
...
Cohesion: 0.14
Nodes (22): clearFeedbackFilesPromise(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue() (+14 more)
...
Cohesion: 0.12
Nodes (16): cleanupPiTransientFiles(), execAsync, createPiFifoPromise(), destroyPiFifoSync(), execAsync, PiFifoError, PiFifoPaths, PiNotReady (+8 more)
...
Cohesion: 0.12
Nodes (17): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerStaticDir(), resolveWindowUrl() (+9 more)
...
Cohesion: 0.14
Nodes (20): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+12 more)
...
Cohesion: 0.13
Nodes (18): InlineSparkline(), InlineSparklineProps, BranchNode(), BranchNodeProps, ContainerNode(), ContainerNodeProps, containerStatusColor(), containerStatusToDot() (+10 more)
...
Cohesion: 0.17
Nodes (16): startPostLaunchSidecars(), startSidecars(), resolveScope(), restartCommand(), runFullRestart(), readPlatformConfigSync(), getSupervisorPortSync(), getSupervisorUrlSync() (+8 more)
...
Cohesion: 0.11
Nodes (19): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), sshCommand(), runModelSummaryPromise() (+11 more)
...
Cohesion: 0.2
Nodes (4): escapeQueryValue(), RallyTracker, trackerErr(), validateRallyId()
...
Cohesion: 0.11
Nodes (17): Access, Agent Grid, code:block1 (┌────────────────────────────────────────────────────┐), code:css (--gv-bg: #0a0e1a          /* Dark navy background */), Components, Dependencies, Design System, Focus View (+9 more)
...
Cohesion: 0.21
Nodes (15): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), cloneTtsConfig(), currentConfig, findProjectRootAsync() (+7 more)
...
Cohesion: 0.27
Nodes (11): formatBrief(), formatDate(), formatIds(), formatTable(), truncate(), registerConversationsCommands(), listAction(), RawFilter (+3 more)

### Community 514 - "Community 514"
Cohesion: 0.14
Nodes (15): bridgeCodexAuthToCliproxy(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession(), postCodexReauthRoute (+7 more)
...
Cohesion: 0.17
Nodes (11): saveConfigSync(), execAsync, initCommand(), InitOptions, resourcesCommand(), ResourcesOptions, VmResources, execAsync (+3 more)

### Community 543 - "Community 543"
Cohesion: 0.23
Nodes (15): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathSync(), hasPRDDraftPromise(), listPRDDrafts() (+7 more)
...
Cohesion: 0.18
Nodes (10): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), wipeCommand(), CanonicalState, mapGitHubStateToCanonical() (+2 more)
...
Cohesion: 0.16
Nodes (13): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+5 more)
...
Cohesion: 0.19
Nodes (11): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectRemoveCommand(), SYNC_SOURCES, initializeProjectsConfigSync() (+3 more)

### Community 632 - "Community 632"
Cohesion: 0.19
Nodes (12): writeStoryFeatureContext(), transitionIssueState(), transitionIssueToInReview(), writeWorkspaceContext(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix (+4 more)
...
Cohesion: 0.29
Nodes (9): markConversationEnded(), AgentStateFile, backfillOrphanedSpecialistConversations(), findClaudeSessionUuid(), NON_AGENT_PREFIXES, pollConversations(), scheduleNext(), SPECIALIST_ROLES (+1 more)
...
Cohesion: 0.33
Nodes (8): MergeSet, execAsync, RebaseAllResult, rebaseAndPushReposPromise(), RebaseError, rebaseOneRepo(), RebaseResult, tryResolvePlanningConflicts()
...
Cohesion: 0.22
Nodes (8): DEFAULT_AUTO_RESUME_CONFIG, HealthThresholds, config, customConfig, invalidEntryConfig, nonArrayConfig, thresholds, warn
...
Cohesion: 0.25
Nodes (4): clientMock, octokitMock, result, states
...
Cohesion: 0.29
Nodes (6): defectQuery, hrQuery, mockCreate, mockQuery, mockUpdate, tracker
...
Cohesion: 0.33
Nodes (4): execFileMock, failures, ops, pushFail
...
## Knowledge Gaps
- **13596 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13591 more)
...
- **Why does `string()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 513`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 536`, `Community 537`, `Community 538`, `Community 26`, `Community 27`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 40`, `Community 41`, `Community 45`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 562`, `Community 563`, `Community 54`, `Community 561`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 63`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 79`, `Community 80`, `Community 83`, `Community 86`, `Community 87`, `Community 89`, `Community 93`, `Community 96`, `Community 109`, `Community 110`, `Community 632`, `Community 124`, `Community 125`, `Community 126`, `Community 129`, `Community 141`, `Community 149`, `Community 671`, `Community 675`, `Community 167`, `Community 179`, `Community 189`, `Community 204`, `Community 232`, `Community 241`, `Community 756`, `Community 762`, `Community 253`, `Community 282`, `Community 284`, `Community 286`, `Community 800`, `Community 801`, `Community 808`, `Community 298`, `Community 312`, `Community 316`, `Community 337`, `Community 339`, `Community 342`, `Community 371`, `Community 373`, `Community 889`, `Community 396`, `Community 397`, `Community 419`, `Community 423`, `Community 453`, `Community 454`, `Community 472`, `Community 484`, `Community 487`, `Community 489`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 641`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 274`, `Community 23`, `Community 280`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 156`, `Community 26`, `Community 31`, `Community 32`, `Community 422`, `Community 296`, `Community 41`, `Community 44`, `Community 176`, `Community 50`, `Community 51`, `Community 54`, `Community 57`, `Community 189`, `Community 452`, `Community 453`, `Community 70`, `Community 202`, `Community 206`, `Community 83`, `Community 87`, `Community 219`, `Community 221`, `Community 94`, `Community 97`, `Community 369`, `Community 241`, `Community 756`, `Community 761`, `Community 252`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 33`, `Community 6`, `Community 9`, `Community 205`, `Community 397`, `Community 179`, `Community 20`, `Community 244`, `Community 342`, `Community 86`, `Community 56`, `Community 22`, `Community 26`, `Community 566`, `Community 317`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13596 weakly-connected nodes found - possible documentation gaps or missing edges._
