...
## Corpus Check
- 1555 files · ~2,062,871 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21688 nodes · 32116 edges · 1144 communities (1108 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 426 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `149482fb`
...
1. `fetch` - 163 edges
2. `resolveProjectFromIssue()` - 103 edges
...
## Communities (1144 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (133): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbenchProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneA() (+125 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (123): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+115 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (135): readCavemanVariant(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), killCommand(), KillOptions, recoverCommand(), RecoverOptions (+127 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (137): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+129 more)
...
Cohesion: 0.04
Nodes (124): checkOrphanedReviewStatuses(), checkStuckReviewing(), renderPrompt(), getActiveParallelReviewIssues(), finalizeRunLog(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (123): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview() (+115 more)
...
Cohesion: 0.03
Nodes (105): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (85): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+77 more)
...
Cohesion: 0.06
Nodes (90): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd() (+82 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (77): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (75): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), CodexAuthBanner() (+67 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (82): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (79): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (70): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (78): checkVerificationReviewContradiction(), pendingCommand(), after, before, blockers, result, statuses, after (+70 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (79): isMergeAgentRunning(), dismissDevChannelsDialog(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (76): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+68 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (72): checkFailedMergeRetry(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (73): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument() (+65 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (69): setAgentStoppedNotifier(), announceMerge(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (70): dequeueMerge(), ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+62 more)
...
Cohesion: 0.04
Nodes (70): clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS, allModelIds, defaults, deprecatedIds, resolved, result (+62 more)
...
Cohesion: 0.04
Nodes (62): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+54 more)
...
Cohesion: 0.06
Nodes (67): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+59 more)
...
Cohesion: 0.04
Nodes (56): DetailPanelLayout(), loadPinState(), PHASE_CHIP_COLORS, PHASE_LABELS, PipelinePhase, savePinState(), TAB_ID_TO_SESSION_TYPE, TerminalTab (+48 more)
...
Cohesion: 0.05
Nodes (48): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), badPath, customPlanningDir, dir (+40 more)
...
Cohesion: 0.06
Nodes (50): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+42 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (48): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (44): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+36 more)
...
Cohesion: 0.06
Nodes (41): withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+33 more)
...
Cohesion: 0.07
Nodes (35): DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader() (+27 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (47): Access, canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus (+39 more)
...
Cohesion: 0.08
Nodes (44): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+36 more)
...
Cohesion: 0.06
Nodes (38): buildConversationResponse(), getCachedMessages(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files., getProjectIssuePrefixes() (+30 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (41): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+33 more)
...
Cohesion: 0.1
Nodes (41): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), DASHBOARD_LOG_FILE (+33 more)
...
Cohesion: 0.09
Nodes (38): wipeCommand(), WipeOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName() (+30 more)
...
Cohesion: 0.09
Nodes (35): ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), execAsync, getNextReviewTempSequence() (+27 more)
...
Cohesion: 0.09
Nodes (27): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+19 more)
...
Cohesion: 0.11
Nodes (28): startPostLaunchSidecars(), startSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning() (+20 more)

### Community 211 - "Community 211"
Cohesion: 0.12
Nodes (13): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName() (+5 more)
...
Cohesion: 0.15
Nodes (25): healthCommand(), HealthOptions, formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+17 more)
...
Cohesion: 0.12
Nodes (17): firstSessionPanel, firstWorkbench, workbench, CommandDeck(), IssueWorkbench(), CommandDeckSelectionState, CommandDeckSelectionStore, initialState (+9 more)
...
Cohesion: 0.22
Nodes (19): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace() (+11 more)
...
Cohesion: 0.14
Nodes (11): cache, db, loaded, row, rows, savedRow, snapshot, CacheRow (+3 more)
...
Cohesion: 0.21
Nodes (11): cleanupOldEntries(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge(), resetProcessingToQueued() (+3 more)
...
Cohesion: 0.22
Nodes (8): ProviderCard(), ProviderCardProps, THINKING_LEVEL_LABELS, THINKING_LEVELS, ThinkingLevelSlider(), ThinkingLevelSliderProps, StatusDot(), StatusDotProps
...
## Knowledge Gaps
- **11556 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11551 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 1`, `Community 134`, `Community 7`, `Community 135`, `Community 9`, `Community 521`, `Community 10`, `Community 522`, `Community 13`, `Community 270`, `Community 6`, `Community 16`, `Community 17`, `Community 19`, `Community 276`, `Community 25`, `Community 26`, `Community 157`, `Community 158`, `Community 413`, `Community 32`, `Community 36`, `Community 166`, `Community 40`, `Community 43`, `Community 45`, `Community 176`, `Community 49`, `Community 817`, `Community 53`, `Community 438`, `Community 59`, `Community 73`, `Community 587`, `Community 591`, `Community 209`, `Community 86`, `Community 222`, `Community 751`, `Community 248`, `Community 249`, `Community 638`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 133` to `Community 2`, `Community 10`, `Community 149`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 817` to `Community 104`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11556 weakly-connected nodes found - possible documentation gaps or missing edges._
