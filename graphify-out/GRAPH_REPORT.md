# Graph Report - feature-pan-1059  (2026-05-11)

## Corpus Check
- 1564 files · ~2,060,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21623 nodes · 32025 edges · 1152 communities (1116 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7eedcc22`
...
5. `spawnAgent()` - 49 edges
6. `sessionExistsAsync()` - 49 edges
7. `listSessionNamesAsync()` - 45 edges
8. `runPatrol()` - 45 edges
9. `useConfirm()` - 44 edges
10. `messageAgent()` - 43 edges
...
## Communities (1152 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (132): nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+124 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (112): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+104 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (123): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkFirstCompletionAgents() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (93): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+85 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (90): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel() (+82 more)
...
Cohesion: 0.03
Nodes (100): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+92 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (80): parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, AuthMode, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime() (+72 more)
...
Cohesion: 0.03
Nodes (80): checkDeadEndAgents(), checkFailedMergeRetry(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), clearStaleCiFeedback(), reconcileAndCheckIfMerged(), clearFeedbackFiles(), getNextSequenceNumber() (+72 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (73): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+65 more)
...
Cohesion: 0.04
Nodes (81): setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (81): dequeueMerge(), ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), completePendingOperation(), ContainerPortBinding (+73 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (83): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash() (+75 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (70): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CodexAuthBanner(), ConfirmationDialog() (+62 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (72): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, computePlanningState(), beadsDir (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (66): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+58 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (69): killCommand(), KillOptions, resetSessionCommand(), resumeCommand(), computeAgentEnrichment(), getRuntimeSnapshotSync(), isAgentStateServiceInProcess(), mirror (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (75): resetPostMergeState(), killAllReviewerSessions(), agentDir, dir1, dir2, marker, missing, nested (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (59): criteria, doc, result, after, doc, filename, path, ACCompletionResult (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (70): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+62 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (61): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+53 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (54): ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue (+46 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (60): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, useIssueCostStream(), link (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (54): ChangedFilesTree, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, AssistantMessageRow() (+46 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (63): listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getCachedFavoritedIds(), getClientIp() (+55 more)
...
Cohesion: 0.07
Nodes (57): BlockerReason, getReviewStatusAsync(), setReviewStatusAsync(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (53): ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI, HEALTH_STATE_LABEL, inferIssueId() (+45 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (53): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), next (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (57): Access, encodeClaudeProjectDir(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), pathExists(), pickFreshestSessionId() (+49 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (56): createCostCommand(), runCostSync(), parseWalFile(), SyncResult, syncWalFromAllProjects(), syncWalFromDir(), insertCostEvents(), BUDGETS_FILE (+48 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (53): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+45 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (53): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+45 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (51): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+43 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (50): PROVIDER_INFO, ProviderPanelProps, DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType, Capability (+42 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (48): future, id, rows, rows1, rows2, initSchema(), base, cols (+40 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (42): EMPTY_DIRECTORY_OVERRIDES, DiffStatLabel, hasNonZeroStat(), cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps (+34 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (54): defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig (+46 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (48): healthCommand(), HealthOptions, formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+40 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (43): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+35 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (48): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+40 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (48): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument() (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (41): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), CostDonut(), CostDonutProps, formatBytes() (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (52): { config }, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+44 more)
...
Cohesion: 0.04
Nodes (45): ENV_KEYS, EnvSnapshot, adminRouteLayer, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+37 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (46): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+38 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (43): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS (+35 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (44): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+36 more)
...
Cohesion: 0.05
Nodes (45): agentDir, missing, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds(), ReadModelServiceShape (+37 more)
...
Cohesion: 0.07
Nodes (44): CavemanVariant, determineCavemanVariant(), injectCavemanSettings(), readCavemanVariant(), buildSpecialistCavemanExports(), buildCavemanExports(), NormalizedCavemanConfig, createHumeConfig() (+36 more)
...
Cohesion: 0.07
Nodes (38): reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync (+30 more)
...
Cohesion: 0.08
Nodes (41): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions (+33 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (37): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+29 more)
...
Cohesion: 0.08
Nodes (40): calls, { mockExecAsync }, opts, closeIssue(), compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+32 more)
...
Cohesion: 0.08
Nodes (37): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample (+29 more)
...
Cohesion: 0.06
Nodes (31): sentinel, markAgentStateServiceInProcess(), authorized(), eventsRouteLayer, getEventStreamRoute, getEventVersionRoute, getHeader(), PUBLIC_CATALOG (+23 more)
...
Cohesion: 0.06
Nodes (27): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+19 more)

### Community 102 - "Community 102"
Cohesion: 0.1
Nodes (14): importTrackerConfig(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache, PlanningStateCacheEntry, POLL_INTERVALS, TrackerState (+6 more)
...
Cohesion: 0.17
Nodes (38): getContainersReferencingWorkspacePath(), stopWorkspaceDocker(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr() (+30 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (28): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, VERDICT_COLOR, VERDICT_LABEL, ZoneCConversation() (+20 more)

### Community 109 - "Community 109"
Cohesion: 0.05
Nodes (39): Auto-Behaviors, Available MCP Tools, Beads Enforcement, Claude Code Channels (experimental), code:bash (# List all agent sessions), code:typescript (// Correct (in sendKeysAsync):), code:block3 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), code:block4 (**PRD:** [`path/to/prd.md`](https link to the file in the re) (+31 more)
...
Cohesion: 0.08
Nodes (34): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+26 more)
...
Cohesion: 0.07
Nodes (24): ACTIVE_AGENT_STATUSES, BUCKET_STAGES, BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover(), formatCost(), hasActiveAgentSignal() (+16 more)

### Community 127 - "Community 127"
Cohesion: 0.08
Nodes (29): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+21 more)

### Community 128 - "Community 128"
Cohesion: 0.07
Nodes (28): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+20 more)
...
Cohesion: 0.05
Nodes (37): DomainEvent, AgentOutput, ChatMessage, CompactBoundary, ConversationEvent, ConversationResponse, DeepWipeRpc, GetAvailableEditorsRpc (+29 more)
...
Cohesion: 0.07
Nodes (35): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+27 more)
...
Cohesion: 0.08
Nodes (32): autoRevertMerge(), DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation() (+24 more)
...
Cohesion: 0.1
Nodes (29): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+21 more)

### Community 154 - "Community 154"
Cohesion: 0.07
Nodes (26): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+18 more)
...
Cohesion: 0.07
Nodes (31): entry, { issueId }, { limit }, old, op, ops, recent, result (+23 more)

### Community 161 - "Community 161"
Cohesion: 0.14
Nodes (32): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffAgainstMain(), diffAgainstMainFiles() (+24 more)
...
Cohesion: 0.08
Nodes (28): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+20 more)
...
Cohesion: 0.11
Nodes (29): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), ARCHIVES_DIR (+21 more)

### Community 184 - "Community 184"
Cohesion: 0.07
Nodes (25): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, formatCost(), IssueHeader(), IssueHeaderProps (+17 more)

### Community 185 - "Community 185"
Cohesion: 0.11
Nodes (29): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+21 more)

### Community 186 - "Community 186"
Cohesion: 0.06
Nodes (32): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+24 more)
...
Cohesion: 0.13
Nodes (28): AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, CLAUDE_MD_TEMPLATES (+20 more)
...
Cohesion: 0.09
Nodes (27): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+19 more)
...
Cohesion: 0.12
Nodes (25): useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel() (+17 more)
...
Cohesion: 0.11
Nodes (23): ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+15 more)
...
Cohesion: 0.1
Nodes (23): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), checkJqInstalled(), ClaudeSettings, HookConfig (+15 more)
...
Cohesion: 0.09
Nodes (24): ClaudeAuthStatus, getClaudeAuthStatus(), parseOAuthPayload(), readKeychainCredentials(), getAvailableModelsRoute, getClaudeAuthRoute, getHarnessPolicyRoute, getMiniMaxDefaultsRoute (+16 more)

### Community 255 - "Community 255"
Cohesion: 0.15
Nodes (23): extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId(), result (+15 more)
...
Cohesion: 0.13
Nodes (19): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), getForgeAdapter(), withRepoArtifactUrl(), withRepoState() (+11 more)
...
Cohesion: 0.12
Nodes (22): execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+14 more)

### Community 302 - "Community 302"
Cohesion: 0.17
Nodes (22): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace() (+14 more)
...
Cohesion: 0.1
Nodes (19): applyBurnedTokenOverride(), checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus, CodexAuthUnknown (+11 more)
...
Cohesion: 0.12
Nodes (16): buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo(), commands (+8 more)

### Community 341 - "Community 341"
Cohesion: 0.14
Nodes (18): CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus(), getShadowStatePath(), markAsSynced(), removeShadowState(), SHADOW_STATE_DIR (+10 more)
...
Cohesion: 0.09
Nodes (21): Claude Code subagents (NOT Panopticon roles), code:block1 (pan plan-finalize), code:json ({), code:json ({), continue.vbrief.json Format, CRITICAL: PLANNING ONLY - NO IMPLEMENTATION, Description, Difficulty Estimation (+13 more)
...
Cohesion: 0.22
Nodes (15): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, getShadowState() (+7 more)
...
Cohesion: 0.19
Nodes (16): readWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), clearFeedback() (+8 more)
...
Cohesion: 0.12
Nodes (16): agentDir, body, LEGACY_FIELDS, legacyFields, options, reloaded, response, Role (+8 more)

### Community 392 - "Community 392"
Cohesion: 0.16
Nodes (14): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags() (+6 more)
...
Cohesion: 0.18
Nodes (14): getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), resolveProjectReposFromResolvedIssue(), projectConfig (+6 more)
...
Cohesion: 0.14
Nodes (13): currentStatus, getUpdateStatus(), initializeAutoUpdater(), startPeriodicChecks(), statusCallbacks, UpdateStatus, UpdateStatusCallback, autoUpdater (+5 more)
...
Cohesion: 0.18
Nodes (16): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherWrapper(), LauncherConfig, LauncherHarness, LauncherSpawnMode (+8 more)
...
Cohesion: 0.15
Nodes (14): InlineSparkline(), InlineSparklineProps, ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory(), ContextMenuContent(), ContextMenuDestructiveItem() (+6 more)
...
Cohesion: 0.12
Nodes (14): content, dashboardStopIdx, dispatchFailedMatches, downBlockMatch, { mockKillSessionAsync }, pendingMatches, requestReviewMatch, rerunBlockMatch (+6 more)
...
Cohesion: 0.12
Nodes (13): deleteDockerContainerRoute, deleteDockerNetworkRoute, deleteDockerVolumeRoute, execAsync, getContainerDetailsRoute, getContainerHistoryRoute, getContainerLogsRoute, getResourcesRoute (+5 more)
...
Cohesion: 0.12
Nodes (15): code:block1 (work role completes beads and signals done), code:block2 (roles/), code:markdown (# Verdict: APPROVED | CHANGES_REQUESTED | FAILED), code:yaml (workhorses:), Dashboard restart invariant, Instruction layout, Invariants, Model and harness configuration (+7 more)
...
Cohesion: 0.21
Nodes (9): configShadowCommand(), ShadowOptions, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), parseEnvFile(), getPendingSyncCount() (+1 more)
...
Cohesion: 0.14
Nodes (13): Available subcommands, code:block1 (pan plan finalize [-w <path>] [--json]   # Materialize plan ), code:bash (cd workspaces/planning-pan-1072), code:bash (pan plan finalize -w workspaces/planning-pan-1072 --json), code:bash (pan plan done PAN-1072), Completing planning (`pan plan done`), Finalizing (`pan plan finalize`), How a planning session actually starts (+5 more)
...
Cohesion: 0.19
Nodes (10): buildTurnDiffTree(), MutableDirectoryNode, normalizePathSegments(), readStat(), SORT_LOCALE_OPTIONS, toTreeNodes(), TurnDiffStat, TurnDiffTreeDirectoryNode (+2 more)
...
Cohesion: 0.27
Nodes (11): HandoffContext, ensureLogDir(), getHandoffStats(), getPendingVerificationHandoffs(), HANDOFF_LOG_FILE, HandoffEvent, logHandoffEvent(), readAgentHandoffEvents() (+3 more)
...
Cohesion: 0.18
Nodes (10): agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockLoadReviewStatuses, mockResolveProjectFromIssue, mockSessionExists, mockSetReviewStatus (+2 more)
...
Cohesion: 0.2
Nodes (9): STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize, StatusDotStatus, el (+1 more)
...
Cohesion: 0.2
Nodes (8): content, d, existingDir, lines, oldDir, result, skillDir, ensurePanGitignore()
...
Cohesion: 0.38
Nodes (6): getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), getSharedIssueService(), startSharedIssueService(), loadTrackerIssues()
...
Cohesion: 0.4
Nodes (4): after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }
...
Cohesion: 0.4
Nodes (3): fixedNow, resolvedModels, runtimeById
...
## Knowledge Gaps
- **11467 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11462 more)
...
- **Why does `fetch` connect `Community 1` to `Community 128`, `Community 769`, `Community 129`, `Community 3`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 145`, `Community 17`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 152`, `Community 156`, `Community 158`, `Community 31`, `Community 544`, `Community 37`, `Community 38`, `Community 43`, `Community 428`, `Community 818`, `Community 51`, `Community 182`, `Community 55`, `Community 56`, `Community 57`, `Community 571`, `Community 62`, `Community 67`, `Community 90`, `Community 606`, `Community 607`, `Community 97`, `Community 611`, `Community 102`, `Community 361`, `Community 123`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 20` to `Community 32`, `Community 45`, `Community 13`, `Community 16`, `Community 277`, `Community 570`, `Community 284`, `Community 62`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 136` to `Community 154`, `Community 5`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Are the 160 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 160 INFERRED edges - model-reasoned connections that need verification._
- **Are the 6 inferred relationships involving `spawnAgent()` (e.g. with `writeStoryFeatureContext()` and `getTldrDaemonService()`) actually correct?**
  _`spawnAgent()` has 6 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11467 weakly-connected nodes found - possible documentation gaps or missing edges._
