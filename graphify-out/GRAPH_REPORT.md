# Graph Report - feature-pan-913  (2026-05-10)

## Corpus Check
- 1544 files · ~2,062,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21561 nodes · 32042 edges · 1135 communities (1102 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 423 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `997a3383`
...
6. `spawnEphemeralSpecialist()` - 51 edges
...
- `fetchActiveWorkspaces()` --calls--> `fetch`  [INFERRED]
  apps/desktop/dist-electron/main.js → src/dashboard/frontend/src/components/__tests__/TerminalPanel.test.tsx

## Communities (1135 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (149): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+141 more)
...
Cohesion: 0.04
Nodes (139): readCavemanVariant(), spawnRebaseAgentForBranch(), sendFeedbackToWorkAgent(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTmuxEnvFlags() (+131 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (108): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+100 more)
...
Cohesion: 0.02
Nodes (122): archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay(), dispatchParallelReview() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (97): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+89 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (111): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (108): autoResumeStoppedWorkAgents(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync (+100 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (91): formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (97): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+89 more)
...
Cohesion: 0.04
Nodes (97): checkStuckReviewing(), buildHandoffPrompt(), serializeHandoffContext(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff() (+89 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (90): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, encodeClaudeProjectDir(), ActivityContext, awaitingInputFromProjection() (+82 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (72): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+64 more)
...
Cohesion: 0.03
Nodes (76): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (84): AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace() (+76 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (73): firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+65 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (76): cvCommand(), CVOptions, healthCommand(), HealthOptions, pendingCommand(), relativeTime(), showCommand(), ShowOptions (+68 more)
...
Cohesion: 0.03
Nodes (69): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+61 more)
...
Cohesion: 0.04
Nodes (74): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+66 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (73): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+65 more)
...
Cohesion: 0.03
Nodes (68): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (72): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+64 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (61): setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData (+53 more)
...
Cohesion: 0.05
Nodes (51): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState() (+43 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (62): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), YamlConfig (+54 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (58): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath() (+50 more)
...
Cohesion: 0.06
Nodes (58): addRepoCommand(), AddRepoOptions, convertToSshUrl(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync, getBeadsVersion() (+50 more)
...
Cohesion: 0.05
Nodes (57): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), dropStash() (+49 more)
...
Cohesion: 0.04
Nodes (51): generateSummaryForFork(), canReplaceTitle(), getConversationByName(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES (+43 more)
...
Cohesion: 0.07
Nodes (54): createCostCommand(), CLAUDE_PROJECTS_DIR, ClaudeMessage, importSessionToCostLog(), normalizeModelName(), BUDGETS_FILE, calculateCost(), checkBudget() (+46 more)
...
Cohesion: 0.06
Nodes (28): issues, result, importTrackerConfig(), getIssueDataService(), getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH (+20 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (44): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, getAllReviewStatusesFromDb(), getHistoryFromDb(), getReviewStatusFromDb() (+36 more)
...
Cohesion: 0.08
Nodes (42): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), createBackup(), createBackupTimestamp(), listBackups() (+34 more)
...
Cohesion: 0.12
Nodes (45): bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload() (+37 more)
...
Cohesion: 0.06
Nodes (33): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, NormalizedConfig (+25 more)
...
Cohesion: 0.08
Nodes (41): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+33 more)
...
Cohesion: 0.06
Nodes (36): cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getCodexReauthStatusRoute, getLiveReauthSession(), hasExistingLiveReauthSession(), postCodexReauthRoute (+28 more)
...
Cohesion: 0.1
Nodes (37): destroyRemoteWorkspace(), getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode, createFlyProvider() (+29 more)
...
Cohesion: 0.1
Nodes (38): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+30 more)
...
Cohesion: 0.07
Nodes (37): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, shouldSkipCheckpointReconciliation() (+29 more)
...
Cohesion: 0.1
Nodes (31): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+23 more)
...
Cohesion: 0.06
Nodes (24): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+16 more)
...
Cohesion: 0.13
Nodes (33): updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry (+25 more)

### Community 141 - "Community 141"
Cohesion: 0.07
Nodes (32): DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation(), runQualityGates() (+24 more)
...
Cohesion: 0.09
Nodes (27): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildSyncFailureFeedback(), execAsync, getSyncTargetBranch() (+19 more)
...
Cohesion: 0.1
Nodes (25): deepMerge(), DEFAULT_CONFIG, findDevrootForProject(), GitHubConfig, GitLabConfig, LinearConfig, loadConfig(), RallyConfig (+17 more)
...
Cohesion: 0.11
Nodes (26): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, next, path (+18 more)
...
Cohesion: 0.24
Nodes (25): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+17 more)
...
Cohesion: 0.14
Nodes (22): clearFeedbackFiles(), validatePlanMatchesIssue(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+14 more)
...
Cohesion: 0.08
Nodes (21): fetchProjectSpecialists(), fetchRunLogs(), formatDate(), ProjectSpecialist, ProjectSpecialistCard(), ProjectSpecialistCardProps, ProjectSpecialistMetadata, RunLogEntry (+13 more)
...
Cohesion: 0.17
Nodes (18): buildTmuxCommandString(), setOptionAsync(), buildPlanningPrompt(), __dirname, discoverPrdFiles(), ensureTmuxRunning(), execAsync, getPackageVersion() (+10 more)
...
Cohesion: 0.19
Nodes (19): installGitHooks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation() (+11 more)
...
Cohesion: 0.17
Nodes (14): ForgeType, getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), projectConfig (+6 more)
...
Cohesion: 0.27
Nodes (13): bridgeCodexAuthToCliproxy(), buildStatus(), decodeBase64Url(), decodeJwtPayload(), getCodexAuthPath(), getJwtExpiry(), getOpenAIAuthStatus(), getOpenAIAuthStatusSync() (+5 more)
...
Cohesion: 0.24
Nodes (11): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+3 more)
...
Cohesion: 0.15
Nodes (11): deleteReviewStatus(), all, blockers, entry, history, result, row, rows (+3 more)
...
Cohesion: 0.42
Nodes (8): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft()
...
## Knowledge Gaps
- **11485 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11480 more)
...
- **Why does `fetch` connect `Community 1` to `Community 640`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 138`, `Community 11`, `Community 268`, `Community 267`, `Community 14`, `Community 16`, `Community 18`, `Community 275`, `Community 531`, `Community 21`, `Community 530`, `Community 23`, `Community 22`, `Community 28`, `Community 157`, `Community 30`, `Community 34`, `Community 554`, `Community 177`, `Community 49`, `Community 51`, `Community 52`, `Community 184`, `Community 957`, `Community 191`, `Community 70`, `Community 589`, `Community 209`, `Community 594`, `Community 352`, `Community 97`, `Community 231`, `Community 744`, `Community 635`, `Community 126`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 2`, `Community 11`, `Community 212`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 71` to `Community 245`?**
