...
## Corpus Check
- 1544 files · ~2,039,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21750 nodes · 32306 edges · 1143 communities (1107 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3db3feb`
...
## Communities (1143 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (132): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), patrolWorkAgentResolutions(), buildShipPreparationPrompt(), defaultWorkspaceForIssue(), spawnMergeAgentForBranches(), spawnRebaseAgentForBranch() (+124 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (111): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+103 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (116): readCavemanVariant(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand() (+108 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (97): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+89 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (94): parsePiSession(), ALLOWED, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, agentState, callOrder, checkFn, killed (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (120): checkApiErrorAgents(), checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (113): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkDeadEndAgents() (+105 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (104): checkFailedMergeRetry(), reconcileAndCheckIfMerged(), reconcileFalseMerged(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+96 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (91): checkPostReviewCommits(), spawnReviewCoordinatorSession(), getAllSpecialistStatus(), SpecialistStatus, after, before, blockers, result (+83 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (80): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+72 more)
...
Cohesion: 0.03
Nodes (91): setAgentStoppedNotifier(), announceMerge(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname (+83 more)
...
Cohesion: 0.04
Nodes (89): checkStuckWorkAgents(), isAgentActiveInTmux(), parseThinkingDuration(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (74): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (86): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (70): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState() (+62 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (74): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, formatBytes() (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (68): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+60 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (72): cleanupOrphanReviewerSessions(), getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), ActivityContext, closedIssuesCache (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (63): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ContainerSection() (+55 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (62): firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats, fetchAllSessionTrees() (+54 more)
...
Cohesion: 0.05
Nodes (68): clearFeedbackFiles(), buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (75): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+67 more)
...
Cohesion: 0.04
Nodes (56): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+48 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (64): ActivityEntry, activityLog, ApprovePushResult, checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute, deleteWorkspaceStashRoute (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (65): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+57 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (63): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeRoleRunExists(), AgentCrashTracker, buildReactiveRolePrompt() (+55 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (65): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+57 more)
...
Cohesion: 0.05
Nodes (62): cleanupOrphanedReviewSessions(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), execAsync, postGitHubPRReview(), applyStash(), buildStashMessage() (+54 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (53): cvCommand(), CVOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand() (+45 more)
...
Cohesion: 0.05
Nodes (63): Role, applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache, ConfigLoadResult (+55 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (57): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+49 more)
...
Cohesion: 0.04
Nodes (47): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCardProps, LastHeardCounter(), PHASE_COLORS (+39 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (56): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+48 more)
...
Cohesion: 0.05
Nodes (50): archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, emergencyStop() (+42 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (46): abortReviewCommand(), DASHBOARD_URL, configShadowCommand(), ShadowOptions, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL (+38 more)
...
Cohesion: 0.08
Nodes (19): issues, result, importTrackerConfig(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), planningStateCache (+11 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (25): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyApiClient(), FlyApiClient, FlyApiError (+17 more)
...
Cohesion: 0.07
Nodes (42): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+34 more)
...
Cohesion: 0.06
Nodes (33): getDefaultConversationModel(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (35): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+27 more)
...
Cohesion: 0.1
Nodes (35): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec() (+27 more)
...
Cohesion: 0.07
Nodes (39): Access, buildConversationResponse(), getCachedMessages(), validateCwdContainment(), getIndexStats(), getIndexStats(), analyze_session(), find_sessions() (+31 more)
...
Cohesion: 0.09
Nodes (37): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd(), activeDir, completedDir (+29 more)
...
Cohesion: 0.06
Nodes (34): entry, { issueId }, { limit }, old, op, ops, recent, result (+26 more)
...
Cohesion: 0.09
Nodes (34): roleAgentDefinitionPath(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType (+26 more)
...
Cohesion: 0.11
Nodes (28): Comment, Issue, IssueFilters, IssueNotFoundError, IssueState, IssueTracker, IssueUpdate, NewIssue (+20 more)
...
Cohesion: 0.08
Nodes (31): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentResolution() (+23 more)
...
Cohesion: 0.08
Nodes (21): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, loadPanopticonEnv(), parseEnvFile(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig() (+13 more)
...
Cohesion: 0.09
Nodes (28): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+20 more)
...
Cohesion: 0.1
Nodes (27): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+19 more)
...
Cohesion: 0.13
Nodes (27): BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR, CLAUDE_MD_TEMPLATES, COMMANDS_DIR (+19 more)
...
Cohesion: 0.15
Nodes (11): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getProjectDirs(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName() (+3 more)
...
Cohesion: 0.21
Nodes (22): destroyRemoteWorkspace(), createFlyProvider(), getRemoteProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile() (+14 more)
...
Cohesion: 0.1
Nodes (12): getProjectIssuePrefixes(), PanRpcLayer, sharedPresencePoller, websocketRpcRouteLayer, EditorLaunch, execAsync, getFileManagerCommand(), isCommandAvailable() (+4 more)
...
Cohesion: 0.13
Nodes (16): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+8 more)
...
Cohesion: 0.18
Nodes (13): cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge() (+5 more)
...
Cohesion: 0.16
Nodes (12): ApproveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), StepResult, TeardownOptions, WorkflowResult, DevcontainerRenderResult (+4 more)
...
Cohesion: 0.2
Nodes (10): execFile(), kCustom, mockExecFile, buildRichPRBody(), ensurePRExists(), execFileAsync, getContainerStatusAsync(), getMrUrlAsync() (+2 more)
...
Cohesion: 0.22
Nodes (6): after, before, cfg, compose, ph, result
...
Cohesion: 0.25
Nodes (6): future, id, rows, rows1, rows2, listGitOperations()
...
## Knowledge Gaps
- **11578 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11573 more)
...
- **Why does `fetch` connect `Community 48` to `Community 1`, `Community 130`, `Community 643`, `Community 388`, `Community 387`, `Community 390`, `Community 134`, `Community 8`, `Community 9`, `Community 650`, `Community 133`, `Community 12`, `Community 644`, `Community 5`, `Community 1039`, `Community 399`, `Community 15`, `Community 18`, `Community 1040`, `Community 532`, `Community 533`, `Community 22`, `Community 279`, `Community 21`, `Community 26`, `Community 28`, `Community 30`, `Community 158`, `Community 36`, `Community 422`, `Community 679`, `Community 40`, `Community 554`, `Community 43`, `Community 812`, `Community 45`, `Community 558`, `Community 46`, `Community 49`, `Community 50`, `Community 55`, `Community 56`, `Community 57`, `Community 63`, `Community 64`, `Community 65`, `Community 973`, `Community 974`, `Community 77`, `Community 78`, `Community 84`, `Community 85`, `Community 218`, `Community 367`, `Community 497`, `Community 250`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 128` to `Community 9`, `Community 2`, `Community 19`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 8` to `Community 0`, `Community 48`, `Community 5`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11578 weakly-connected nodes found - possible documentation gaps or missing edges._
