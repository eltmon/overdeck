...
## Corpus Check
- 1878 files · ~2,476,867 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26664 nodes · 41418 edges · 1255 communities (1206 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `efb6b494`
...
5. `FsError` - 80 edges
6. `sessionExistsAsync()` - 65 edges
7. `cn()` - 64 edges
8. `jsonResponse()` - 56 edges
9. `spawnRun()` - 53 edges
10. `spawnAgent()` - 52 edges
...
## Communities (1255 total, 49 thin omitted)
...
Cohesion: 0.01
Nodes (153): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+145 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (138): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, ZoneAProps (+130 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (157): spawnInspectAgent(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), tellCommand(), getRuntimeSnapshot(), ActivityEntry (+149 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (146): resolveAutoResumeConfigForIssue(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents() (+138 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (115): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+107 more)
...
Cohesion: 0.03
Nodes (112): deriveProjectRoot(), doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (110): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), monitorReviewConvoySignals(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt() (+102 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (86): buildACLookupByTitle(), criteria, doc, result, beadsDir, doc, { projectPath, workspacePath }, promoted (+78 more)
...
Cohesion: 0.02
Nodes (95): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (79): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+71 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (93): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+85 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (76): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (90): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+82 more)
...
Cohesion: 0.03
Nodes (95): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+87 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (86): ConversationPanel(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations() (+78 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (75): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+67 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (92): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+84 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (88): TurnDiffFileChange, canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync (+80 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (84): embedAction(), showAction(), runWithPool(), WorkPoolStats, getSetting(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), ConversationFilter (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (78): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+70 more)
...
Cohesion: 0.03
Nodes (74): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (67): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+59 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (76): buildPolyrepoContext(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), workspaceDeepCleanCommand() (+68 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (67): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+59 more)
...
Cohesion: 0.03
Nodes (62): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, planCommand(), PlanOptions (+54 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (76): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks() (+68 more)
...
Cohesion: 0.05
Nodes (73): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+65 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (72): readCavemanVariant(), checkStuckReviewing(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+64 more)
...
Cohesion: 0.03
Nodes (52): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+44 more)
...
Cohesion: 0.04
Nodes (50): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), configShadowCommand() (+42 more)
...
Cohesion: 0.04
Nodes (59): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+51 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (57): buildActiveSliceContext(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readPendingFeedback(), readWorkspacePlanAsync(), WorkAgentPromptContext, printActiveSliceForIssue() (+49 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (60): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+52 more)
...
Cohesion: 0.07
Nodes (63): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+55 more)
...
Cohesion: 0.04
Nodes (61): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+53 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (64): getMemoryStatus(), resolvePendingDir(), EnqueueStatusRollup, enqueueStatusRollupEvent(), findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup() (+56 more)
...
Cohesion: 0.05
Nodes (52): checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, isMergeAgentRunning(), activeRoleRunExists() (+44 more)
...
Cohesion: 0.07
Nodes (50): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+42 more)
...
Cohesion: 0.04
Nodes (39): estimateCost(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, getModelCapability(), MODEL_CAPABILITIES, ModelCapability (+31 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (55): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+47 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (48): assertSafeAgentId(), assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+40 more)
...
Cohesion: 0.07
Nodes (52): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+44 more)
...
Cohesion: 0.06
Nodes (58): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+50 more)
...
Cohesion: 0.05
Nodes (38): captureTldrMetrics(), daemonRegistry, execAsync, getPidFilePath(), getTldrMetrics(), listTldrDaemonServices(), LiveDaemonState, readDaemonState() (+30 more)
...
Cohesion: 0.07
Nodes (35): parsePiSession(), ProcessSpawnError, TmuxError, createSessionAsyncEffect(), CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir() (+27 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (23): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions(), parseClaudeSession() (+15 more)
...
Cohesion: 0.07
Nodes (46): insertCostEvent(), areMemoryObservationsEnabled(), booleanOrDefault(), clearMemorySettingsCache(), defaultMemorySettings(), getMemoryRollupPendingThreshold(), getMemoryWorkerConcurrency(), isMemoryPromptTimeInjectionEnabled() (+38 more)
...
Cohesion: 0.06
Nodes (24): importTrackerConfig(), findProjectsByRallyProject(), loadReviewStatusesForIssues(), computeBeadCounts(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+16 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (47): buildWorkAgentPrompt(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+39 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (42): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+34 more)
...
Cohesion: 0.04
Nodes (51): result, resizeWindowAsyncEffect(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute (+43 more)
...
Cohesion: 0.06
Nodes (45): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+37 more)
...
Cohesion: 0.07
Nodes (41): killCommand(), KillOptions, pauseCommand(), PauseOptions, unpauseCommand(), untroubledCommand(), clearAgentPaused(), clearAgentTroubled() (+33 more)

### Community 103 - "Community 103"
Cohesion: 0.06
Nodes (38): execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir(), getPendingQuestions() (+30 more)
...
Cohesion: 0.06
Nodes (43): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailed(), closeMemoryFtsDatabases(), stopTranscriptPoller(), getIssueDataService(), getIssueDataService(), getIssueDataService() (+35 more)
...
Cohesion: 0.06
Nodes (32): content, d, existingDir, lines, oldDir, result, skillDir, getDefaultWorkspaceConfig() (+24 more)

### Community 118 - "Community 118"
Cohesion: 0.05
Nodes (37): queryCostEvents(), TranscriptClaimTrigger, costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath (+29 more)
...
Cohesion: 0.07
Nodes (33): buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+25 more)
...
Cohesion: 0.07
Nodes (31): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+23 more)
...
Cohesion: 0.08
Nodes (33): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry (+25 more)
...
Cohesion: 0.08
Nodes (26): execAsync, rebaseFeatureBranch(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+18 more)
...
Cohesion: 0.06
Nodes (24): MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient, { rerender } (+16 more)
...
Cohesion: 0.07
Nodes (27): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), agentDir, mockGetAgentRuntimeState, mockGetAgentState, mockGetTmuxSessionName, mockGetWorkspaceStackHealth, mockLoadReviewStatuses (+19 more)

### Community 213 - "Community 213"
Cohesion: 0.07
Nodes (23): RuntimeConversationsConfig, ReadModelServiceShape, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+15 more)
...
Cohesion: 0.08
Nodes (27): importSessionToCostLog(), normalizeModelName(), calculateCost(), CostEntry, DEFAULT_PRICING, getPricing(), logUsage(), ModelPricing (+19 more)
...
Cohesion: 0.07
Nodes (23): agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), deleteDockerContainerRoute, deleteDockerNetworkRoute, deleteDockerVolumeRoute, execAsync, getContainerDetailsRoute (+15 more)
...
Cohesion: 0.2
Nodes (26): extractNumber(), extractPrefix(), applyLabelLinearImpl(), closeLinearDirectImpl(), cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabelsImpl(), execAsync (+18 more)
...
Cohesion: 0.13
Nodes (16): dangerBanner(), DangerousGitOpError, DangerousOp, DangerousOpBlockedError, execAsync, pathLeaf(), runGitCheckoutOverwrite(), runGitClean() (+8 more)
...
Cohesion: 0.1
Nodes (18): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, AgentTemplateConfig, DnsConfig, DockerConfig (+10 more)
...
Cohesion: 0.12
Nodes (20): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+12 more)
...
Cohesion: 0.17
Nodes (21): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), deleteBranchesImpl(), execAsync, isDockerContainerProcess() (+13 more)
...
Cohesion: 0.13
Nodes (16): emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSessionContent(), ParseResult, PiEntry, PiGenericEntry (+8 more)

### Community 447 - "Community 447"
Cohesion: 0.19
Nodes (13): writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), workspacePanPaths(), clearFeedback(), readFeedback(), appendSession() (+5 more)
...
Cohesion: 0.12
Nodes (9): readFeatureContext(), readWorkspaceContext(), mockGetIssue, parentWorkspace, planDoc, specsDir, written, path (+1 more)

### Community 489 - "Community 489"
Cohesion: 0.12
Nodes (14): getBridgeLogPath(), getPanopticonHome(), BRIDGE_ENTRY, entry, exitPromise, forwarder, lines, logPath (+6 more)
...
Cohesion: 0.14
Nodes (12): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, findWorkspacePath(), ApproveOptions, ArchiveOptions, DeepWipeOptions (+4 more)
...
Cohesion: 0.38
Nodes (9): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), IssueDraftInfo, listIssueDrafts() (+1 more)

### Community 736 - "Community 736"
Cohesion: 0.27
Nodes (9): handlePermissionRequestNotification(), normalizePermissionRequest(), parsePermissionRequestNotification(), CHANNEL_PERMISSION_LIMITS, normalizeChannelPermissionRequestFields(), NormalizedChannelPermissionRequestFields, normalizePermissionInputPreview(), PermissionPayloadValidationError (+1 more)
...
- **Why does `fetch` connect `Community 2` to `Community 1`, `Community 258`, `Community 3`, `Community 516`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 272`, `Community 273`, `Community 17`, `Community 147`, `Community 16`, `Community 21`, `Community 22`, `Community 145`, `Community 152`, `Community 26`, `Community 27`, `Community 28`, `Community 156`, `Community 288`, `Community 33`, `Community 35`, `Community 37`, `Community 41`, `Community 686`, `Community 431`, `Community 48`, `Community 566`, `Community 186`, `Community 59`, `Community 60`, `Community 192`, `Community 449`, `Community 322`, `Community 68`, `Community 71`, `Community 203`, `Community 81`, `Community 82`, `Community 214`, `Community 90`, `Community 92`, `Community 228`, `Community 231`, `Community 107`, `Community 620`, `Community 239`, `Community 119`, `Community 378`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 11` to `Community 419`, `Community 36`, `Community 37`, `Community 488`, `Community 9`, `Community 8`, `Community 202`, `Community 300`, `Community 46`, `Community 82`, `Community 23`, `Community 151`, `Community 536`, `Community 29`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 284` to `Community 641`, `Community 259`, `Community 131`, `Community 5`, `Community 6`, `Community 261`, `Community 265`, `Community 9`, `Community 397`, `Community 273`, `Community 18`, `Community 401`, `Community 534`, `Community 536`, `Community 27`, `Community 157`, `Community 30`, `Community 33`, `Community 35`, `Community 37`, `Community 41`, `Community 43`, `Community 45`, `Community 429`, `Community 49`, `Community 562`, `Community 184`, `Community 57`, `Community 59`, `Community 445`, `Community 446`, `Community 447`, `Community 191`, `Community 318`, `Community 195`, `Community 323`, `Community 72`, `Community 201`, `Community 200`, `Community 75`, `Community 76`, `Community 331`, `Community 467`, `Community 470`, `Community 89`, `Community 90`, `Community 348`, `Community 93`, `Community 735`, `Community 97`, `Community 99`, `Community 103`, `Community 106`, `Community 238`, `Community 117`, `Community 374`, `Community 248`, `Community 127`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13279 weakly-connected nodes found - possible documentation gaps or missing edges._
