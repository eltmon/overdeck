...
## Corpus Check
- 1878 files · ~2,476,602 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26661 nodes · 41420 edges · 1261 communities (1213 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 505 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d565691a`
...
## Communities (1261 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (187): buildHandoffPrompt(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn() (+179 more)
...
Cohesion: 0.02
Nodes (119): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+111 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (128): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+120 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (113): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+105 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (123): checkMissingReviewStatuses(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync (+115 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (116): captureTmuxOutput(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+108 more)
...
Cohesion: 0.02
Nodes (122): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+114 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (113): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+105 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (114): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+106 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (106): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+98 more)
...
Cohesion: 0.03
Nodes (90): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+82 more)
...
Cohesion: 0.02
Nodes (84): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+76 more)
...
Cohesion: 0.03
Nodes (83): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+75 more)
...
Cohesion: 0.04
Nodes (82): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (84): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+76 more)
...
Cohesion: 0.04
Nodes (59): DrawerTabPlaceholder(), tabLabel(), PanSpecListOptions, ProjectPanPaths, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+51 more)
...
Cohesion: 0.03
Nodes (62): RoundMarker, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE (+54 more)
...
Cohesion: 0.05
Nodes (67): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+59 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (70): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase() (+62 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (71): Access, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+63 more)
...
Cohesion: 0.05
Nodes (67): getTrackerContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+59 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (67): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession() (+59 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (60): buildActiveSliceContext(), readFeatureContext(), readWorkspacePlanAsync(), WorkAgentPromptContext, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+52 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (61): loadCloisterConfig(), checkUndispatchedShip(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, AgentHealth (+53 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (51): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, criteria, doc, result (+43 more)
...
Cohesion: 0.05
Nodes (63): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession() (+55 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (49): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), createQueryClient(), drawerUi(), fetchMock, first, issue (+41 more)
...
Cohesion: 0.04
Nodes (47): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+39 more)
...
Cohesion: 0.04
Nodes (52): cleanupOldEntries(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry, removeMerge(), resetProcessingToQueued() (+44 more)
...
Cohesion: 0.05
Nodes (59): generateFallbackSummary(), appendJsonl(), readTranscriptSlice(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions() (+51 more)
...
Cohesion: 0.07
Nodes (52): dashboardBundleMtimeMs(), parseHealthTimeout(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate, dashboardBundleCandidates() (+44 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (47): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+39 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (57): writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir(), resolveCheckpointFile(), resolveFtsDbPath() (+49 more)
...
Cohesion: 0.06
Nodes (52): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector, DockerStatsRaw (+44 more)
...
Cohesion: 0.06
Nodes (41): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), listTestsCommand(), registerTestCommands() (+33 more)
...
Cohesion: 0.06
Nodes (50): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride() (+42 more)
...
Cohesion: 0.06
Nodes (44): ContainerStats, detectPlatform(), Platform, evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv() (+36 more)
...
Cohesion: 0.07
Nodes (38): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, retryPendingSpawn(), fetchMock, CommandDeckSelectionState (+30 more)
...
Cohesion: 0.09
Nodes (45): clearFlywheelRunGate(), flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate() (+37 more)
...
Cohesion: 0.06
Nodes (36): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), buildTestRolePrompt(), dashboardApiUrl() (+28 more)
...
Cohesion: 0.07
Nodes (27): doneCommand(), getForgeAdapter(), ensureMergeSetForIssue(), MergeSet, MergeSetGateStatus, MergeSetRebaseStatus, MergeSetRepoMergeStatus, MergeSetStatus (+19 more)
...
Cohesion: 0.06
Nodes (29): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+21 more)
...
Cohesion: 0.07
Nodes (32): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+24 more)
...
Cohesion: 0.06
Nodes (32): ensureDefaultConversationModel(), fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted (+24 more)
...
Cohesion: 0.07
Nodes (30): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), EnrichmentApiConfig (+22 more)

### Community 158 - "Community 158"
Cohesion: 0.08
Nodes (33): DrawerVerificationGates(), DrawerVerificationGateStatus, ActionKey, ActionLayout, derivePipelineState(), flattenActions(), getZoneAActions(), getZoneBActions() (+25 more)
...
Cohesion: 0.06
Nodes (10): ConfigError, FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+2 more)
...
Cohesion: 0.08
Nodes (29): readPendingFeedback(), validateAndCleanStateFile(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), workspacePanPaths() (+21 more)

### Community 188 - "Community 188"
Cohesion: 0.14
Nodes (36): extractNumber(), extractPrefix(), archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl() (+28 more)
...
Cohesion: 0.08
Nodes (16): issues, result, getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService (+8 more)
...
Cohesion: 0.1
Nodes (27): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, recordReloadStatus(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge() (+19 more)
...
Cohesion: 0.07
Nodes (18): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, comparePipelineIssues(), filterMatchesShipModifier() (+10 more)
...
Cohesion: 0.13
Nodes (20): getRunLog(), getRunLogPath(), execAsync, listLogsCommand(), logsCommand(), LogsOptions, tailLogCommand(), actual (+12 more)
...
Cohesion: 0.17
Nodes (18): ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, getLinearApiKey(), TeardownOptions, WorkflowResult, approve() (+10 more)
...
Cohesion: 0.1
Nodes (18): { container }, emptyState, ledger, pan1Ledger, pan1Row, pan2Ledger, pan2Row, pan6Row (+10 more)
...
Cohesion: 0.15
Nodes (15): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+7 more)
...
Cohesion: 0.18
Nodes (10): StaticVerbBadgeProps, StaticVerbBadgeVariant, StuckVerbBadgeProps, badge, { container }, { container, unmount }, PULSING_VARIANTS, VerbBadge() (+2 more)
...
- **Why does `fetch` connect `Community 48` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 10`, `Community 11`, `Community 266`, `Community 13`, `Community 14`, `Community 524`, `Community 400`, `Community 273`, `Community 145`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 150`, `Community 24`, `Community 151`, `Community 27`, `Community 157`, `Community 34`, `Community 36`, `Community 1068`, `Community 44`, `Community 47`, `Community 49`, `Community 689`, `Community 50`, `Community 54`, `Community 184`, `Community 440`, `Community 61`, `Community 573`, `Community 64`, `Community 321`, `Community 194`, `Community 73`, `Community 74`, `Community 459`, `Community 204`, `Community 83`, `Community 86`, `Community 346`, `Community 736`, `Community 97`, `Community 738`, `Community 227`, `Community 99`, `Community 226`, `Community 224`, `Community 231`, `Community 621`, `Community 1134`, `Community 1135`, `Community 241`, `Community 375`, `Community 253`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 34` to `Community 33`, `Community 422`, `Community 9`, `Community 73`, `Community 203`, `Community 44`, `Community 187`, `Community 46`, `Community 303`, `Community 16`, `Community 80`, `Community 302`, `Community 59`, `Community 29`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 185` to `Community 0`, `Community 2`, `Community 643`, `Community 261`, `Community 262`, `Community 5`, `Community 136`, `Community 397`, `Community 14`, `Community 16`, `Community 18`, `Community 23`, `Community 156`, `Community 285`, `Community 30`, `Community 286`, `Community 157`, `Community 420`, `Community 165`, `Community 38`, `Community 300`, `Community 44`, `Community 174`, `Community 175`, `Community 49`, `Community 436`, `Community 439`, `Community 56`, `Community 187`, `Community 320`, `Community 194`, `Community 578`, `Community 454`, `Community 71`, `Community 201`, `Community 329`, `Community 75`, `Community 458`, `Community 77`, `Community 205`, `Community 80`, `Community 213`, `Community 86`, `Community 472`, `Community 474`, `Community 90`, `Community 92`, `Community 347`, `Community 94`, `Community 95`, `Community 348`, `Community 481`, `Community 238`, `Community 111`, `Community 112`, `Community 251`, `Community 114`, `Community 371`, `Community 250`, `Community 123`?**
