...
## Corpus Check
- 1548 files · ~2,060,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21599 nodes · 31962 edges · 1140 communities (1103 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `661383eb`
...
## Communities (1140 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (119): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+111 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (148): readCavemanVariant(), renderPrompt(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildMergeAgentMemory(), execAsync, MemoryTiers (+140 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (143): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+135 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (119): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+111 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (125): shouldAutoStart(), setAgentStoppedNotifier(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+117 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (113): spawnRebaseAgentForBranch(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand() (+105 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (102): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+94 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (100): ViewMode, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (93): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+85 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (103): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes(), execAsync (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (82): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+74 more)
...
Cohesion: 0.03
Nodes (72): format(), LiveCounter(), LiveCounterProps, PlanningState, ZoneAActionsState, state, EDITOR_LABELS, PanOpenInPicker() (+64 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (73): cn(), WorkTypeTableProps, SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps (+65 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (78): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+70 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (68): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost(), formatTokens() (+60 more)
...
Cohesion: 0.03
Nodes (63): firstSessionPanel, firstWorkbench, workbench, CommandDeck(), IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps (+55 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (71): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+63 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (69): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+61 more)
...
Cohesion: 0.03
Nodes (63): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (68): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (72): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, showCommand(), findSpecByIssue() (+64 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (64): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, formatCost(), IssueHeader(), IssueHeaderProps (+56 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (71): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+63 more)
...
Cohesion: 0.06
Nodes (70): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, updateCommand(), cleanupLegacyRuntimeSymlinks() (+62 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (57): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, computePlanningState(), beadsDir, doc, dbError, deleteCalls (+49 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (61): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+53 more)
...
Cohesion: 0.06
Nodes (61): createCostCommand(), runCostSync(), CLAUDE_PROJECTS_DIR, ClaudeMessage, importSessionToCostLog(), normalizeModelName(), parseWalFile(), SyncResult (+53 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (51): InlineSparkline(), InlineSparklineProps, resolveWorkTypeKey(), useResolvedModels(), BranchNode(), BranchNodeProps, ContainerNode(), ContainerNodeProps (+43 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (54): checkFailedMergeRetry(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, mockLoadProjectsConfig, mockRunQualityGates (+46 more)
...
Cohesion: 0.05
Nodes (51): checkPendingTestDispatch(), clearStaleCiFeedback(), getAllSpecialistStatus(), SpecialistStatus, dispatchTestAgentAndNotify(), closeOutCommand(), CloseOutOptions, getGitHubConfig() (+43 more)
...
Cohesion: 0.04
Nodes (48): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+40 more)
...
Cohesion: 0.07
Nodes (42): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument() (+34 more)
...
Cohesion: 0.07
Nodes (44): DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+36 more)
...
Cohesion: 0.14
Nodes (43): applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue(), closeLinearDirect() (+35 more)
...
Cohesion: 0.06
Nodes (37): agentDir, envArg, options, state, stateFile, workspace, SpawnOptions, generateRouterConfigFromWorkTypes() (+29 more)
...
Cohesion: 0.06
Nodes (30): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+22 more)
...
Cohesion: 0.07
Nodes (35): wipeCommand(), calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync (+27 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (37): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback() (+29 more)
...
Cohesion: 0.08
Nodes (36): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample (+28 more)
...
Cohesion: 0.05
Nodes (36): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+28 more)
...
Cohesion: 0.1
Nodes (31): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+23 more)
...
Cohesion: 0.08
Nodes (27): ComposerMode, IssueComposer(), IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps (+19 more)
...
Cohesion: 0.1
Nodes (33): pendingCommand(), AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR (+25 more)
...
Cohesion: 0.07
Nodes (32): SearchFilters, SearchResult, useSearch(), UseSearchOptions, fetchIssues(), SearchModal(), SearchModalProps, PRIORITY_COLORS (+24 more)

### Community 147 - "Community 147"
Cohesion: 0.12
Nodes (31): captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), diffAgainstMain(), diffAgainstMainFiles(), diffCheckpointFiles(), diffCheckpoints() (+23 more)
...
Cohesion: 0.09
Nodes (32): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+24 more)
...
Cohesion: 0.12
Nodes (28): WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId, parseIssueId() (+20 more)
...
Cohesion: 0.1
Nodes (14): getIssueDataService(), getIssueDataService(), getIssueDataService(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+6 more)

### Community 190 - "Community 190"
Cohesion: 0.09
Nodes (27): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, getCurrentVersion() (+19 more)
...
Cohesion: 0.11
Nodes (27): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+19 more)

### Community 200 - "Community 200"
Cohesion: 0.08
Nodes (23): sentinel, EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore(), openEventDb(), PreparedStatement (+15 more)
...
Cohesion: 0.14
Nodes (28): Conversation, listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments() (+20 more)
...
Cohesion: 0.12
Nodes (23): clearFeedbackFiles(), readFeatureContext(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+15 more)
...
Cohesion: 0.19
Nodes (21): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+13 more)
...
Cohesion: 0.19
Nodes (7): getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions(), parseClaudeSession(), ClaudeCodeRuntime

### Community 343 - "Community 343"
Cohesion: 0.11
Nodes (14): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+6 more)
...
Cohesion: 0.2
Nodes (19): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+11 more)
...
Cohesion: 0.14
Nodes (18): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectInitCommand(), projectListCommand() (+10 more)
...
Cohesion: 0.16
Nodes (16): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, useIssueCostStream(), BreakdownRow (+8 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, Cleanup After Shutdown, code:bash (# Stop all Panopticon services), code:bash (# Clean up log files), code:bash (# Monitor in one terminal), code:env (# Graceful shutdown timeout (seconds)), Configuration Options, Monitoring Shutdown (+8 more)
...
Cohesion: 0.21
Nodes (13): getForgeAdapter(), ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), execAsync (+5 more)
...
Cohesion: 0.12
Nodes (13): getActiveSessionModel(), claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+5 more)
...
Cohesion: 0.21
Nodes (8): execAsync, initCommand(), InitOptions, resourcesCommand(), ResourcesOptions, VmResources, statusCommand(), StatusOptions
...
Cohesion: 0.18
Nodes (10): DASHBOARD_URL, requestReviewCommand(), RequestReviewOptions, RequestReviewResponse, 13. Icons, code:block31 (Default:  18px (w-[18px] h-[18px])), code:block32 (Command Deck:  Compass), Color (+2 more)
...
Cohesion: 0.22
Nodes (9): calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes, kCustom (+1 more)
...
Cohesion: 0.22
Nodes (8): DEFAULT_MEMORY_TIERS, exec(), execMock, kCustom, mockGetAgentState, mockGetRuntimeForAgent, mockRuntime, result
...
- **Why does `fetch` connect `Community 8` to `Community 129`, `Community 3`, `Community 4`, `Community 644`, `Community 6`, `Community 131`, `Community 264`, `Community 9`, `Community 393`, `Community 11`, `Community 7`, `Community 525`, `Community 14`, `Community 18`, `Community 146`, `Community 19`, `Community 24`, `Community 26`, `Community 154`, `Community 156`, `Community 29`, `Community 32`, `Community 545`, `Community 33`, `Community 34`, `Community 551`, `Community 43`, `Community 176`, `Community 48`, `Community 51`, `Community 53`, `Community 56`, `Community 58`, `Community 966`, `Community 327`, `Community 200`, `Community 73`, `Community 75`, `Community 590`, `Community 591`, `Community 600`, `Community 487`, `Community 360`, `Community 747`, `Community 118`, `Community 119`, `Community 376`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 128` to `Community 25`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 185` to `Community 245`?**
