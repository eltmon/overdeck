# Graph Report - feature-pan-1312-slot-4  (2026-05-22)

## Corpus Check
- 1887 files · ~3,052,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26748 nodes · 41512 edges · 1263 communities (1215 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d071e03`
...
10. `sessionExistsAsyncEffect()` - 51 edges
...
## Communities (1263 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (174): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, checkAndSuspendIdleAgents(), checkApiErrorAgents() (+166 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (178): monitorReviewConvoySignals(), spawnInspectAgent(), buildSpecialistBaseCommand(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand() (+170 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (139): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+131 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (134): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+126 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (104): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision (+96 more)
...
Cohesion: 0.03
Nodes (123): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+115 more)
...
Cohesion: 0.04
Nodes (111): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+103 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (90): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+82 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (84): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+76 more)
...
Cohesion: 0.03
Nodes (87): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+79 more)
...
Cohesion: 0.03
Nodes (93): getReviewerSessionName(), parseReviewerSessionName(), buildChildEnv(), withConcurrencyLimit(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache (+85 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (70): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+62 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (79): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed() (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (92): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+84 more)
...
Cohesion: 0.04
Nodes (85): buildPolyrepoContext(), projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+77 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (84): autoResumeStoppedWorkAgents(), isVerifyPausedAgentState(), notifyAgentStatusChanged(), recoverOrphanedAgentsOnce(), getNoResumeMode(), clearAgentPausedEffect(), clearAgentTroubledEffect(), getAgentStateEffect() (+76 more)
...
Cohesion: 0.03
Nodes (84): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+76 more)
...
Cohesion: 0.04
Nodes (83): buildActiveSliceContext(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields() (+75 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (66): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+58 more)
...
Cohesion: 0.03
Nodes (59): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), DRAWER_TABS, DrawerTabs(), DrawerVerificationGates(), DrawerActivityPanel(), DrawerTabPlaceholder() (+51 more)
...
Cohesion: 0.03
Nodes (67): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+59 more)
...
Cohesion: 0.03
Nodes (71): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), ExtractedPayload (+63 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (58): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, importSessionToCostLog(), normalizeModelName(), syncWalFromAllProjects() (+50 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (59): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+51 more)
...
Cohesion: 0.05
Nodes (69): __dirname, __filename, isStringArray(), loadPromptFrontmatter(), ParsedPrompt, parsePrompt(), PromptError, PromptFrontmatter (+61 more)
...
Cohesion: 0.04
Nodes (64): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+56 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (50): ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+42 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (56): insertCostEvent(), queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath (+48 more)
...
Cohesion: 0.04
Nodes (51): AgentRuntimeState, AgentState, getAgentRuntimeStateEffect(), __testInternals, applyOutcome(), checkpointIdentity(), emptyResult(), GetAgentRuntimeState (+43 more)
...
Cohesion: 0.04
Nodes (57): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions(), readConvoySubRoleTemplate(), reviewerAgentId() (+49 more)
...
Cohesion: 0.04
Nodes (52): isRunningAgent(), format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase() (+44 more)
...
Cohesion: 0.04
Nodes (50): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+42 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (55): SearchResult, getConversationsConfigAsyncEffect(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema (+47 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (61): UpsertDiscoveredSessionOpts, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+53 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (45): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), beadsDir, doc, createCall (+37 more)
...
Cohesion: 0.09
Nodes (55): extractNumber(), extractPrefix(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl() (+47 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (54): TranscriptClaimTrigger, EnqueueStatusRollup, findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup(), pendingTurnFileName(), pendingTurnRangeKey() (+46 more)
...
Cohesion: 0.07
Nodes (54): getMemoryStatus(), readStatus(), assertMemorySafeSegment(), assertUnderMemoryBase(), resolveArchiveDir(), resolveCheckpointFile(), resolveFtsDbPath(), resolveIssueMemoryRoot() (+46 more)
...
Cohesion: 0.06
Nodes (45): backupCleanCommand(), backupListCommand(), pendingCommand(), restoreCommand(), listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand() (+37 more)
...
Cohesion: 0.05
Nodes (23): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles(), parseAllSessions() (+15 more)
...
Cohesion: 0.06
Nodes (41): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus() (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.05
Nodes (42): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+34 more)

### Community 93 - "Community 93"
Cohesion: 0.05
Nodes (43): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), HealthThresholds, config (+35 more)
...
Cohesion: 0.04
Nodes (36): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, comparePipelineIssues(), filterMatchesShipModifier() (+28 more)

### Community 101 - "Community 101"
Cohesion: 0.06
Nodes (34): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+26 more)

### Community 102 - "Community 102"
Cohesion: 0.06
Nodes (48): AIProvider, appendJsonl(), readTranscriptSlice(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions() (+40 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (44): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+36 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (47): clearFlywheelRunGate(), flywheelAbortCommand(), loadReportFlywheelStatus(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate() (+39 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (40): dropLingeringPreMergeStashes(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash() (+32 more)
...
Cohesion: 0.06
Nodes (34): execAsync, rebaseFeatureBranch(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, CheckpointError (+26 more)
...
Cohesion: 0.06
Nodes (37): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, ensureWorkspacePanDir() (+29 more)
...
Cohesion: 0.05
Nodes (34): captureTldrMetrics(), daemonRegistry, getTldrMetrics(), listTldrDaemonServices(), LiveDaemonState, readLogLines(), readMetricsCheckpoint(), TldrDaemonStatus (+26 more)
...
Cohesion: 0.06
Nodes (32): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier(), getFallbackModel() (+24 more)

### Community 130 - "Community 130"
Cohesion: 0.06
Nodes (32): CloseIssueOptions, ApproveOptions, DeepWipeOptions, WorkflowResult, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep() (+24 more)
...
Cohesion: 0.08
Nodes (32): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+24 more)
...
Cohesion: 0.09
Nodes (34): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, startTtsDaemonFromDashboard(), StoredEvent (+26 more)
...
Cohesion: 0.09
Nodes (29): handleAutoStartNag(), showFirstLaunchDialog(), createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment (+21 more)

### Community 171 - "Community 171"
Cohesion: 0.08
Nodes (26): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+18 more)
...
Cohesion: 0.1
Nodes (34): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+26 more)
...
Cohesion: 0.11
Nodes (33): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, completePlanningArtifacts(), checkPlanStatusEffect(), readWorkspacePlanAsync() (+25 more)
...
Cohesion: 0.08
Nodes (32): snapshot, status, AgentEnrichment, Jsonish, ReadModelServiceShape, ReviewStatusSnapshotInput, SpecialistAgentName, SpecialistLifecycleState (+24 more)
...
Cohesion: 0.08
Nodes (31): AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir(), inferIssueId() (+23 more)
...
Cohesion: 0.1
Nodes (31): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+23 more)
...
Cohesion: 0.1
Nodes (26): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+18 more)
...
Cohesion: 0.12
Nodes (24): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials (+16 more)
...
Cohesion: 0.11
Nodes (21): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+13 more)
...
Cohesion: 0.12
Nodes (21): FsError, CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterEffect(), createRuntimeRegistry(), getInstalledRuntimes(), getRuntimeAdapter(), getSupportedRuntimes() (+13 more)

### Community 293 - "Community 293"
Cohesion: 0.11
Nodes (25): runMemoryFtsTransaction(), appendLocks, findIndexedObservationByteOffset(), findObservationByteOffset(), indexObservation(), inline(), observationMarkdownPath(), readOptional() (+17 more)
...
Cohesion: 0.16
Nodes (25): Conversation, handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments() (+17 more)
...
Cohesion: 0.19
Nodes (20): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffCheckpointFiles(), diffCheckpoints() (+12 more)
...
Cohesion: 0.15
Nodes (10): CONFIG, hadPackageDir, hadPython, hadVenvDir, killSpy, packageDir, python, scriptPath (+2 more)
...
Cohesion: 0.26
Nodes (10): pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId(), resolveJsonlPath(), ResolveJsonlPathOptions, arr, encoded (+2 more)
...
Cohesion: 0.22
Nodes (6): computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult, items, result, ReviewStatus
...
## Knowledge Gaps
- **13316 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13311 more)
...
- **Why does `fetch` connect `Community 53` to `Community 0`, `Community 642`, `Community 3`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 272`, `Community 18`, `Community 20`, `Community 21`, `Community 150`, `Community 280`, `Community 152`, `Community 153`, `Community 28`, `Community 158`, `Community 35`, `Community 36`, `Community 163`, `Community 40`, `Community 681`, `Community 171`, `Community 1068`, `Community 1067`, `Community 45`, `Community 687`, `Community 47`, `Community 44`, `Community 307`, `Community 52`, `Community 568`, `Community 440`, `Community 189`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 194`, `Community 69`, `Community 327`, `Community 457`, `Community 203`, `Community 460`, `Community 335`, `Community 211`, `Community 212`, `Community 84`, `Community 87`, `Community 728`, `Community 91`, `Community 736`, `Community 96`, `Community 100`, `Community 617`, `Community 234`, `Community 235`, `Community 107`, `Community 236`, `Community 1134`, `Community 1135`, `Community 245`, `Community 379`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 21` to `Community 33`, `Community 130`, `Community 99`, `Community 34`, `Community 6`, `Community 210`, `Community 115`, `Community 180`, `Community 404`, `Community 22`, `Community 87`, `Community 405`, `Community 539`, `Community 29`, `Community 62`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 292` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 7`, `Community 265`, `Community 10`, `Community 267`, `Community 268`, `Community 269`, `Community 400`, `Community 149`, `Community 22`, `Community 23`, `Community 150`, `Community 25`, `Community 539`, `Community 157`, `Community 30`, `Community 544`, `Community 32`, `Community 39`, `Community 424`, `Community 42`, `Community 171`, `Community 174`, `Community 49`, `Community 52`, `Community 437`, `Community 180`, `Community 59`, `Community 189`, `Community 191`, `Community 455`, `Community 456`, `Community 73`, `Community 458`, `Community 459`, `Community 201`, `Community 77`, `Community 334`, `Community 79`, `Community 207`, `Community 469`, `Community 86`, `Community 473`, `Community 90`, `Community 93`, `Community 350`, `Community 607`, `Community 96`, `Community 352`, `Community 98`, `Community 610`, `Community 233`, `Community 109`, `Community 115`, `Community 244`, `Community 378`, `Community 124`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13316 weakly-connected nodes found - possible documentation gaps or missing edges._
