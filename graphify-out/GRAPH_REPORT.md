...
## Corpus Check
- 1919 files · ~3,146,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27467 nodes · 43112 edges · 1275 communities (1220 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 799 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4347b79`
...
## Communities (1275 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (194): detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+186 more)
...
Cohesion: 0.02
Nodes (153): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+145 more)
...
Cohesion: 0.02
Nodes (132): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+124 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (131): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+123 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (114): classifyStreamLine(), DrawerActiveAgent(), formatSpend(), STREAM_LINE_COLOR_CLASS, StreamLineKind, stuckHours(), verbBadgeForAgent(), DrawerActivityRail() (+106 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (122): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions() (+114 more)
...
Cohesion: 0.03
Nodes (92): parsePiSession(), getPiLauncherFields(), waitForPiAgentReady(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+84 more)
...
Cohesion: 0.02
Nodes (98): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+90 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (102): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+94 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (102): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+94 more)
...
Cohesion: 0.03
Nodes (91): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult (+83 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (97): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+89 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (98): DatabaseError, dequeueMerge(), enqueueMerge(), getAllActiveQueues(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+90 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (98): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+90 more)
...
Cohesion: 0.03
Nodes (86): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+78 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (92): queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+84 more)
...
Cohesion: 0.03
Nodes (77): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+69 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (81): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+73 more)
...
Cohesion: 0.03
Nodes (86): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+78 more)
...
Cohesion: 0.04
Nodes (74): buildPolyrepoContext(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+66 more)
...
Cohesion: 0.05
Nodes (75): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+67 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (74): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+66 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (62): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcp() (+54 more)
...
Cohesion: 0.03
Nodes (66): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, activeRoleRunExists(), AgentCrashTracker (+58 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (78): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+70 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (51): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+43 more)
...
Cohesion: 0.04
Nodes (51): ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+43 more)
...
Cohesion: 0.05
Nodes (56): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, ExtractedPayload (+48 more)
...
Cohesion: 0.04
Nodes (48): AgentRuntimeState, AgentState, __testInternals, applyOutcome(), checkpointIdentity(), emptyResult(), GetAgentRuntimeState, GetAgentState (+40 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (65): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+57 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (63): resetDb(), db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+55 more)
...
Cohesion: 0.04
Nodes (48): beadsDir, doc, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+40 more)
...
Cohesion: 0.07
Nodes (59): embedAction(), SearchQuery, showAction(), runWithPool(), WorkPoolStats, getSetting(), setSetting(), setSettingEffect() (+51 more)
...
Cohesion: 0.07
Nodes (60): getMemoryStatus(), writeObservationRecord(), writeStatus(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), ensureParentDir() (+52 more)
...
Cohesion: 0.05
Nodes (47): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+39 more)
...
Cohesion: 0.04
Nodes (56): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect(), readBeadsFromJsonl() (+48 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (48): destroyRemoteWorkspace(), saveConfig(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig() (+40 more)
...
Cohesion: 0.05
Nodes (53): EnqueueStatusRollup, findExistingPendingTurn(), inFlightRollups, loadThreshold(), maybeTriggerStatusRollup(), pendingTurnFileName(), pendingTurnRangeKey(), readPendingTurns() (+45 more)
...
Cohesion: 0.05
Nodes (46): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+38 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (46): buildActiveSliceContext(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+38 more)
...
Cohesion: 0.05
Nodes (46): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata (+38 more)
...
Cohesion: 0.08
Nodes (51): flywheelAbortCommand(), flywheelStatusCommand(), loadActiveFlywheelStatus(), DatabaseError, getFlywheelActiveRunId(), getSettingEffect(), isDeaconGloballyPaused(), isFlywheelGloballyPaused() (+43 more)
...
Cohesion: 0.06
Nodes (44): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl() (+36 more)
...
Cohesion: 0.06
Nodes (38): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), wipeCommand(), WipeOptions, applyAgentFailure() (+30 more)
...
Cohesion: 0.05
Nodes (31): estimateCost(), CapabilityModelId, getModelCapability(), getValueScore(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId (+23 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (45): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+37 more)
...
Cohesion: 0.05
Nodes (39): bridgeCodexAuthToCliproxyEffect(), getWindowDimensionsAsyncEffect(), cleanupExpiredReauthSessions(), codexAuthRouteLayer, consumeReauthTerminalToken(), getCodexAuthRoute, getExistingLiveReauthSession(), getLiveReauthSession() (+31 more)
...
Cohesion: 0.07
Nodes (47): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+39 more)
...
Cohesion: 0.07
Nodes (39): updateTtsConfig(), getGlobalConfigPath(), NormalizedTtsDaemonConfig, startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue() (+31 more)
...
Cohesion: 0.07
Nodes (34): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+26 more)
...
Cohesion: 0.09
Nodes (42): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback(), readPlanningContext(), confirmHostOverride() (+34 more)
...
Cohesion: 0.06
Nodes (31): GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, getKimiAnthropicBaseUrl(), getProviderEnv(), ProviderAuthType, ProviderName (+23 more)
...
Cohesion: 0.09
Nodes (7): CloisterService, identifyOrphanedReviewingIssues(), parseSpecialistAgentSession(), writeStateFile(), active, result, statuses
...
Cohesion: 0.09
Nodes (32): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsDir(), getCostsForIssue() (+24 more)
...
Cohesion: 0.07
Nodes (39): Access, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+31 more)
...
Cohesion: 0.08
Nodes (31): writeStoryFeatureContext(), FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+23 more)
...
Cohesion: 0.06
Nodes (36): assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, FlywheelActionDeps, flywheelRouteLayer, FlywheelStatusResponse, getFlywheelBriefRoute (+28 more)
...
Cohesion: 0.08
Nodes (39): addCommentBefore(), anchorIsValid(), backfillDiscoveredSessionArrayIndexes(), captureTldrMetrics(), clone(), createStringifyContext(), encodeClaudeProjectDir(), format() (+31 more)
...
Cohesion: 0.08
Nodes (31): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+23 more)
...
Cohesion: 0.12
Nodes (30): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+22 more)

### Community 181 - "Community 181"
Cohesion: 0.07
Nodes (28): readFeatureContext(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync (+20 more)
...
Cohesion: 0.09
Nodes (27): ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+19 more)
...
Cohesion: 0.09
Nodes (26): ConversationPanel(), ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), PersistedState, useConversationUiState(), useNow() (+18 more)

### Community 223 - "Community 223"
Cohesion: 0.09
Nodes (29): contextMigrateCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+21 more)
...
Cohesion: 0.12
Nodes (31): loadConfigAsyncNoMigrationEffect(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot, getActiveRunId() (+23 more)
...
Cohesion: 0.09
Nodes (28): snapshot, status, Jsonish, ReadModelServiceShape, ReviewStatusSnapshotInput, SpecialistAgentName, SpecialistLifecycleState, toAgentResolution() (+20 more)
...
Cohesion: 0.14
Nodes (26): extractNumber(), closeLinearDirectImpl(), ApproveOptions, ArchiveOptions, DeepWipeOptions, DeepWipeProgress, stepFailed(), TeardownOptions (+18 more)
...
Cohesion: 0.1
Nodes (24): AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgent(), detectAwaitingInputFromPane(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey(), isCurrentPromptIndex() (+16 more)
...
Cohesion: 0.1
Nodes (17): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+9 more)
...
Cohesion: 0.1
Nodes (16): assertSafeAgentIdEffect(), captureCheckpointEffect(), CheckpointGitResult, checkpointSpawnerLayer, deleteAllCheckpointsEffect(), deleteCheckpointEffect(), diffCheckpointFilesEffect(), diffCheckpointsEffect() (+8 more)
...
Cohesion: 0.15
Nodes (26): archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), execAsync, cleanupLabelsGitHub(), cleanupLabelsLinear() (+18 more)
...
Cohesion: 0.11
Nodes (19): sentinel, markAgentStateServiceInProcess(), emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore (+11 more)
...
Cohesion: 0.13
Nodes (18): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+10 more)
...
Cohesion: 0.19
Nodes (19): findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), killOrphanedProcesses() (+11 more)
...
Cohesion: 0.18
Nodes (18): createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), HANDOFF_LOG_FILE, HandoffEvent (+10 more)
...
Cohesion: 0.21
Nodes (19): assertSafeAgentId(), captureCheckpoint(), checkpointRef(), deleteAllCheckpoints(), deleteCheckpoint(), deleteLegacyCheckpointRefs(), diffCheckpointFiles(), diffCheckpoints() (+11 more)
...
Cohesion: 0.13
Nodes (8): ReopenError, ReopenOptions, ReopenResult, activeContinuePath, continuePath, projectRoot, updated, wsDir
...
Cohesion: 0.15
Nodes (8): MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient, { rerender }
...
Cohesion: 0.5
Nodes (5): getDatabase(), getDatabasePath(), getPanopticonHome(), isBunRuntime(), _require
...
## Knowledge Gaps
- **13571 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13566 more)
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 41`, `Community 44`, `Community 50`, `Community 53`, `Community 55`, `Community 56`, `Community 570`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 574`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 73`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 92`, `Community 93`, `Community 611`, `Community 104`, `Community 105`, `Community 109`, `Community 1134`, `Community 133`, `Community 648`, `Community 649`, `Community 143`, `Community 152`, `Community 155`, `Community 159`, `Community 164`, `Community 172`, `Community 686`, `Community 174`, `Community 180`, `Community 184`, `Community 193`, `Community 194`, `Community 199`, `Community 204`, `Community 219`, `Community 244`, `Community 246`, `Community 248`, `Community 773`, `Community 775`, `Community 778`, `Community 271`, `Community 306`, `Community 307`, `Community 327`, `Community 330`, `Community 339`, `Community 385`, `Community 387`, `Community 388`, `Community 409`, `Community 410`, `Community 444`, `Community 465`, `Community 1004`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 29` to `Community 192`, `Community 34`, `Community 35`, `Community 326`, `Community 8`, `Community 10`, `Community 409`, `Community 209`, `Community 82`, `Community 84`, `Community 21`, `Community 25`, `Community 59`, `Community 159`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 281`, `Community 151`, `Community 28`, `Community 29`, `Community 160`, `Community 544`, `Community 32`, `Community 35`, `Community 294`, `Community 40`, `Community 686`, `Community 46`, `Community 49`, `Community 53`, `Community 444`, `Community 66`, `Community 68`, `Community 204`, `Community 461`, `Community 210`, `Community 84`, `Community 91`, `Community 93`, `Community 478`, `Community 733`, `Community 224`, `Community 97`, `Community 225`, `Community 104`, `Community 618`, `Community 109`, `Community 248`, `Community 124`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13571 weakly-connected nodes found - possible documentation gaps or missing edges._
