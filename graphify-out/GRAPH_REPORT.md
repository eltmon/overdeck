...
## Corpus Check
- 1572 files · ~2,066,541 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22367 nodes · 33544 edges · 1146 communities (1108 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `beee7d66`
...
## Communities (1146 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (168): readCavemanVariant(), performKillAndSpawn(), postMergeLifecycle(), killCommand(), KillOptions, recoverCommand(), RecoverOptions, resetSessionCommand() (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (144): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+136 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (128): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+120 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (151): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+143 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (112): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state (+104 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (116): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+108 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (133): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+125 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (122): spawnInspectAgent(), renderPrompt(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags(), bumpSessionGeneration() (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (95): isMergeAgentRunning(), parsePiSession(), getPiLauncherFields(), waitForPiAgentReady(), agentState, callOrder, checkFn, killed (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (111): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+103 more)
...
Cohesion: 0.04
Nodes (74): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), AlertOptions (+66 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (80): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+72 more)
...
Cohesion: 0.04
Nodes (77): setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (72): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (73): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+65 more)
...
Cohesion: 0.04
Nodes (74): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask (+66 more)
...
Cohesion: 0.04
Nodes (57): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+49 more)
...
Cohesion: 0.04
Nodes (52): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, WorkLogEntry (+44 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (53): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+45 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (54): doc, path, criticalPath(), Wave, WaveItem, isRFC3339DateTime(), toRFC3339(), VBRIEF_INSPECTION_POLICIES (+46 more)
...
Cohesion: 0.05
Nodes (44): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+36 more)
...
Cohesion: 0.07
Nodes (59): spawnSingleReviewer(), resolveSpecialistBaseCommand(), buildSpecialistBaseCommand(), assertCodexAuthReadyForModel(), {
  mockLoadYamlConfig,
  mockGetProviderForModel,
  mockGetProviderEnv,
  mockOpenAIAuthStatus,
  mockBridgeGeminiAuth,
}, buildAgentLaunchConfig(), checkAndSetupHooks(), determineModel() (+51 more)
...
Cohesion: 0.09
Nodes (54): stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), parsePanSpecDocument() (+46 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (57): cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+49 more)
...
Cohesion: 0.05
Nodes (53): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), ReviewStatus (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (48): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (49): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+41 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (41): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, computePlanningState(), beadsDir (+33 more)
...
Cohesion: 0.06
Nodes (45): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+37 more)
...
Cohesion: 0.06
Nodes (48): PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+40 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (40): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+32 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (48): Access, AIProvider, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats() (+40 more)
...
Cohesion: 0.05
Nodes (41): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+33 more)
...
Cohesion: 0.08
Nodes (41): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getDevrootPath(), cleanupLegacyRuntimeSymlinks() (+33 more)
...
Cohesion: 0.11
Nodes (39): destroyRemoteWorkspace(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType (+31 more)
...
Cohesion: 0.05
Nodes (41): Auto-Behaviors, Available MCP Tools, Beads Enforcement, Claude Code Channels (experimental), code:bash (# List all agent sessions), code:typescript (// Correct (in sendKeysAsync):), code:block3 (draft (in .pan/drafts/*.md) ──► proposed ──► approved ──► ac), code:block4 (**PRD:** [`path/to/prd.md`](https link to the file in the re) (+33 more)
...
Cohesion: 0.14
Nodes (37): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+29 more)
...
Cohesion: 0.07
Nodes (25): ModelSelectionResult, getDebugInfo(), getGlobalRouter(), getModel(), hasOverride(), ModelResolutionResult, reloadGlobalRouter(), resetGlobalRouter() (+17 more)
...
Cohesion: 0.1
Nodes (31): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, showCommand(), next (+23 more)
...
Cohesion: 0.14
Nodes (31): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), hashFile(), Manifest, ManifestEntry, readManifest() (+23 more)
...
Cohesion: 0.1
Nodes (29): ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR (+21 more)
...
Cohesion: 0.11
Nodes (27): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+19 more)
...
Cohesion: 0.08
Nodes (26): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), ensurePanDirs() (+18 more)
...
Cohesion: 0.1
Nodes (26): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+18 more)
...
Cohesion: 0.12
Nodes (23): criteria, doc, result, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument() (+15 more)
...
Cohesion: 0.22
Nodes (8): IssueComposer(), composer, input, makeQueryClient(), mockFetch, notice, sendBtn, Wrapper()
...
## Knowledge Gaps
- **11888 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11883 more)
...
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 136`, `Community 10`, `Community 11`, `Community 394`, `Community 13`, `Community 12`, `Community 650`, `Community 16`, `Community 17`, `Community 20`, `Community 534`, `Community 151`, `Community 28`, `Community 30`, `Community 287`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 561`, `Community 562`, `Community 52`, `Community 54`, `Community 55`, `Community 183`, `Community 61`, `Community 62`, `Community 83`, `Community 601`, `Community 604`, `Community 223`, `Community 106`, `Community 107`, `Community 116`, `Community 766`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 144` to `Community 0`, `Community 13`, `Community 23`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 16` to `Community 558`, `Community 1031`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11888 weakly-connected nodes found - possible documentation gaps or missing edges._
