# Graph Report - feature-pan-1382  (2026-05-22)

## Corpus Check
- 1915 files · ~3,144,459 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27451 nodes · 43083 edges · 1301 communities (1245 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5beaf07a`
...
1. `string()` - 243 edges
2. `fetch` - 199 edges
3. `resolveProjectFromIssue()` - 126 edges
4. `useDashboardStore` - 87 edges
5. `FsError` - 80 edges
6. `sessionExistsAsyncEffect()` - 69 edges
7. `jsonResponse()` - 56 edges
8. `spawnRun()` - 55 edges
9. `spawnAgent()` - 53 edges
10. `messageAgent()` - 50 edges
...
## Communities (1301 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (189): WorkLogEntry, ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage() (+181 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (213): addLog(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents(), checkFailedMergeRetry(), checkFirstCompletionAgents(), checkMassDeath(), checkMissingReviewStatuses(), checkOrphanedReviewStatuses() (+205 more)
...
Cohesion: 0.02
Nodes (151): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, isStale(), PHASE_CONFIG, recentActionObservations() (+143 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (161): forkCommand(), ForkOptions, buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+153 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (116): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+108 more)
...
Cohesion: 0.02
Nodes (123): ACTIVE_STATUS_PATTERNS, API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkHeartbeat() (+115 more)
...
Cohesion: 0.03
Nodes (92): parsePiSession(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+84 more)
...
Cohesion: 0.03
Nodes (88): isRunningAgent(), PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps (+80 more)
...
Cohesion: 0.03
Nodes (84): criteria, doc, result, beadsDir, doc, { projectPath, workspacePath }, promoted, specFiles (+76 more)
...
Cohesion: 0.02
Nodes (90): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+82 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (96): assertIssueHasBeads(), assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect() (+88 more)
...
Cohesion: 0.04
Nodes (78): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), updateCommand() (+70 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (86): BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (82): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (95): updateTtsConfig(), agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS (+87 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (73): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), getTrackerContext(), projectListCommand(), projectShowCommand() (+65 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (79): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+71 more)
...
Cohesion: 0.03
Nodes (82): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+74 more)
...
Cohesion: 0.03
Nodes (85): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+77 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (78): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+70 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (80): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, buildActiveSliceContext(), writeStoryFeatureContext(), findWorkspaceRoot() (+72 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (63): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+55 more)
...
Cohesion: 0.03
Nodes (73): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+65 more)
...
Cohesion: 0.07
Nodes (80): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), array (+72 more)
...
Cohesion: 0.04
Nodes (61): queryCostEvents(), TranscriptClaimTrigger, costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath (+53 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (60): finalizeRunLog(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+52 more)
...
Cohesion: 0.04
Nodes (56): checkApiErrorAgents(), killPostMergeRoleSessions(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions() (+48 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (57): dropLingeringPreMergeStashes(), ensureReviewTempStash(), execAsync, applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash() (+49 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (44): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (55): getAutoCloseOutCanonicalState(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand() (+47 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (57): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+49 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (59): AgentRuntimeState, claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync() (+51 more)
...
Cohesion: 0.06
Nodes (59): events, identity, writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir() (+51 more)
...
Cohesion: 0.06
Nodes (55): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+47 more)
...
Cohesion: 0.03
Nodes (60): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), normalizeFilter(), parseRelativeTime(), UpsertDiscoveredSessionOpts (+52 more)
...
Cohesion: 0.04
Nodes (50): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, collectJsonlFiles(), discoverJsonlFiles() (+42 more)
...
Cohesion: 0.08
Nodes (46): BlockerReason, getReviewStatusAsyncEffect(), setReviewStatusAsyncEffect(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun() (+38 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (52): result, setDeaconGloballyPaused(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute (+44 more)

### Community 70 - "Community 70"
Cohesion: 0.04
Nodes (45): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), base, cols, colsAfter, colsBefore, correctedPath (+37 more)
...
Cohesion: 0.05
Nodes (48): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReadModelServiceLive, ReadModelServiceShape (+40 more)
...
Cohesion: 0.06
Nodes (36): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, FailedMessage (+28 more)
...
Cohesion: 0.06
Nodes (38): startPostLaunchSidecars(), startSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning() (+30 more)
...
Cohesion: 0.07
Nodes (41): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+33 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (47): RawFilter, SearchMode, SearchQuery, SearchResult, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting() (+39 more)
...
Cohesion: 0.11
Nodes (47): extractNumber(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+39 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (40): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings() (+32 more)
...
Cohesion: 0.07
Nodes (38): runtime, state, next, path, read, state, activeContinueWriters, appendFeedbackEntry() (+30 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (37): embedAction(), confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, ConversationFilter, DiscoveredSession (+29 more)
...
Cohesion: 0.05
Nodes (37): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), formatBytes(), GaugeProps (+29 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (44): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), rejectInvalidOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+36 more)
...
Cohesion: 0.05
Nodes (32): getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+24 more)
...
Cohesion: 0.06
Nodes (33): conversationsTab, firstLens, lens, overview, tablist, ProjectRightPaneTabs(), ComposerMode, IssueComposer() (+25 more)
...
Cohesion: 0.08
Nodes (39): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, encodeBeadsVersion() (+31 more)
...
Cohesion: 0.06
Nodes (31): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+23 more)
...
Cohesion: 0.07
Nodes (31): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+23 more)

### Community 147 - "Community 147"
Cohesion: 0.07
Nodes (32): execAsync, gatherArtifacts(), generateBasicInference(), generateMonitoringPrompt(), InferenceDocument, liftMonitoringError(), MonitoringAgentConfig, MonitoringAgentError (+24 more)
...
Cohesion: 0.09
Nodes (34): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, startTtsDaemonFromDashboard(), StoredEvent, ActivityTtsPayload (+26 more)
...
Cohesion: 0.09
Nodes (31): HandoffContext, createHandoffEvent(), ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsEffect(), HANDOFF_LOG_FILE (+23 more)

### Community 195 - "Community 195"
Cohesion: 0.09
Nodes (36): addCommentBefore(), anchorIsValid(), captureTldrMetrics(), clone(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+28 more)
...
Cohesion: 0.09
Nodes (29): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+21 more)
...
Cohesion: 0.1
Nodes (28): InspectContext, onInspectComplete(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getDiffBase(), getDiffBaseEffect() (+20 more)
...
Cohesion: 0.09
Nodes (25): execAsync, rebaseFeatureBranch(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, CheckpointError (+17 more)
...
Cohesion: 0.09
Nodes (24): getWindowDimensionsAsyncEffect(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+16 more)
...
Cohesion: 0.09
Nodes (19): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+11 more)
...
Cohesion: 0.09
Nodes (19): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, after, before, cfg, compose, ph (+11 more)
...
Cohesion: 0.08
Nodes (26): bridgeCodexAuthToCliproxyEffect(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthCheckError, CodexAuthExpired (+18 more)
...
Cohesion: 0.13
Nodes (24): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherConfig (+16 more)

### Community 280 - "Community 280"
Cohesion: 0.1
Nodes (24): sentinel, initWorkspaceDiscoveredSessionsSchema(), emitReactiveLifecycleEvent(), emitResetMarkerCreated(), emitMemoryHealthChanged(), enqueueStatusRollupEvent(), emitMemoryObservationCreated(), emitStatusUpdatedEvent() (+16 more)
...
Cohesion: 0.08
Nodes (18): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfig(), getConversationsConfigAsync(), GitHubConfig, GitLabConfig (+10 more)
...
Cohesion: 0.09
Nodes (28): applyEvent(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxMemoryObservationsPerIssue(), getMaxTurnDiffSummariesPerAgent(), isTerminalTurnDiffSummaryStatus(), MemoryHealthSnapshot (+20 more)
...
Cohesion: 0.15
Nodes (26): deletePRDDraft(), deletePRDDraftEffect(), getPRDDraftInfo(), getPRDDraftInfoEffect(), getPRDDraftPath(), getPRDDraftPathEffect(), hasPRDDraft(), hasPRDDraftEffect() (+18 more)
...
Cohesion: 0.14
Nodes (27): resetDb(), resetDb(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase() (+19 more)
...
Cohesion: 0.12
Nodes (18): saveConfig(), { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig(), getRemoteProvider(), isRemoteAvailable(), ProviderType (+10 more)
...
Cohesion: 0.18
Nodes (26): arrayPushArray(), atIndentedComment(), blockMap(), blockScalar(), blockSequence(), document(), documentEnd(), findNonEmptyIndex() (+18 more)
...
Cohesion: 0.15
Nodes (20): validateAndCleanStateFile(), FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+12 more)
...
Cohesion: 0.11
Nodes (13): createRemoteWorkspace(), CreateRemoteWorkspaceOptions, execAsync, RemoteWorkspaceError, FlyProviderConfig, ExecResult, RemoteError, RemoteProvider (+5 more)
...
Cohesion: 0.13
Nodes (19): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+11 more)
...
Cohesion: 0.09
Nodes (19): execMock, mockCreateTracker, mockDropStash, mockFindWorkspacePath, mockGetAgentState, mockGetProject, mockGetReviewStatus, mockIsOlderThanDays (+11 more)

### Community 417 - "Community 417"
Cohesion: 0.13
Nodes (19): getEmbedding(), buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI() (+11 more)
...
Cohesion: 0.19
Nodes (19): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+11 more)
...
Cohesion: 0.14
Nodes (16): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectRemoveCommand(), SYNC_SOURCES, deletedDir (+8 more)
...
Cohesion: 0.13
Nodes (15): computeMessageDurationStart(), deriveMessagesTimelineRows(), deriveTimelineEntries(), EstimateHeightInput, estimateMessagesTimelineRowHeight(), MessagesTimelineRow, TimelineEntry, entries (+7 more)
...
Cohesion: 0.17
Nodes (13): ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), execAsync, getRepoWorkspacePath() (+5 more)
...
Cohesion: 0.16
Nodes (14): EnrichedReviewStatus, enrichReviewStatus(), enrichReviewStatusFromSessions(), mostRecentByTimestamp(), parseReviewerTimestamp(), parseTrailingTimestamp(), ReviewEnrichmentError, consolidateSpeakerCues() (+6 more)
...
Cohesion: 0.13
Nodes (15): compose(), decorate(), end(), parse(), parseAllDocuments(), parseArrayColumn(), parseOptions(), parsePrelude() (+7 more)

### Community 501 - "Community 501"
Cohesion: 0.26
Nodes (10): formatBrief(), formatDate(), formatIds(), formatTable(), truncate(), registerConversationsCommands(), listAction(), scanAction() (+2 more)
...
Cohesion: 0.2
Nodes (11): BeadRecord, checkOpenBeads(), checkUncommittedChanges(), errorCode(), execAsync, execFileAsync, isMissingCommand(), isTimeout() (+3 more)
...
Cohesion: 0.14
Nodes (11): insertCostEvent(), ExtractedPayload, fallback, identity, primary, provider, recordHealth, result (+3 more)
...
Cohesion: 0.29
Nodes (8): MergeSet, execAsync, RebaseAllResult, rebaseAndPushRepos(), RebaseError, rebaseOneRepo(), RebaseResult, tryResolvePlanningConflicts()

### Community 745 - "Community 745"
Cohesion: 0.38
Nodes (9): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+1 more)
...
## Knowledge Gaps
- **13563 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13558 more)
...
- **Why does `string()` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 525`, `Community 13`, `Community 17`, `Community 530`, `Community 19`, `Community 20`, `Community 533`, `Community 21`, `Community 23`, `Community 18`, `Community 22`, `Community 26`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 45`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 55`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 576`, `Community 66`, `Community 68`, `Community 586`, `Community 78`, `Community 79`, `Community 81`, `Community 87`, `Community 89`, `Community 91`, `Community 93`, `Community 97`, `Community 102`, `Community 105`, `Community 106`, `Community 630`, `Community 124`, `Community 131`, `Community 147`, `Community 660`, `Community 662`, `Community 159`, `Community 160`, `Community 167`, `Community 178`, `Community 186`, `Community 195`, `Community 196`, `Community 199`, `Community 200`, `Community 201`, `Community 218`, `Community 224`, `Community 749`, `Community 751`, `Community 278`, `Community 791`, `Community 792`, `Community 280`, `Community 796`, `Community 296`, `Community 329`, `Community 331`, `Community 339`, `Community 341`, `Community 361`, `Community 362`, `Community 363`, `Community 389`, `Community 931`, `Community 421`, `Community 445`, `Community 447`, `Community 459`, `Community 501`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 1`, `Community 257`, `Community 4`, `Community 6`, `Community 8`, `Community 393`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 19`, `Community 149`, `Community 280`, `Community 281`, `Community 28`, `Community 156`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 419`, `Community 39`, `Community 47`, `Community 51`, `Community 55`, `Community 60`, `Community 61`, `Community 447`, `Community 196`, `Community 200`, `Community 202`, `Community 206`, `Community 85`, `Community 342`, `Community 87`, `Community 90`, `Community 223`, `Community 95`, `Community 225`, `Community 104`, `Community 105`, `Community 745`, `Community 749`, `Community 753`, `Community 627`, `Community 255`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 17` to `Community 34`, `Community 258`, `Community 4`, `Community 36`, `Community 10`, `Community 13`, `Community 528`, `Community 209`, `Community 307`, `Community 20`, `Community 21`, `Community 59`, `Community 62`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Are the 221 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 221 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13563 weakly-connected nodes found - possible documentation gaps or missing edges._
