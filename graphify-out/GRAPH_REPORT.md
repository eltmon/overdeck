...
## Corpus Check
- 1930 files · ~3,154,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27623 nodes · 43433 edges · 1321 communities (1265 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 806 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b81252b8`
...
## Communities (1321 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (148): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+140 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (170): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+162 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (141): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+133 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (154): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgentPromise() (+146 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (104): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision (+96 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, RecoverButton() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (107): ConversationView(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket (+99 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (126): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+118 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (119): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+111 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (109): captureTmuxOutput(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+101 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (104): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), postAgentMessageLikeRoute() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (83): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps, AlertOptions, ConfirmOptions (+75 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (88): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (97): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand(), RunOptions (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (92): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+84 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (92): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, content (+84 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (91): ViewMode, conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck() (+83 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (89): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+81 more)
...
Cohesion: 0.03
Nodes (77): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, path (+69 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (93): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+85 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (75): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+67 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (91): Access, getAgentWorkspace(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+83 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (62): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, createHandoffEvent(), ensureLogDir() (+54 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (86): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs() (+78 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (81): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), displayIssues() (+73 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (77): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+69 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (75): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+67 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (70): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+62 more)
...
Cohesion: 0.04
Nodes (68): recordAutoCloseOutFailure(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview() (+60 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (34): issues, result, importTrackerConfig(), findProjectsByRallyProject(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+26 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (74): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+66 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (80): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), AutoMergeConfig, backupGlobalConfig(), CavemanConfig, CavemanMode (+72 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (74): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+66 more)
...
Cohesion: 0.05
Nodes (59): contextCommand(), ContextOptions, cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand() (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (71): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+63 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (66): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+58 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (68): cosineSimilarity(), showAction(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult (+60 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (67): BLANKED_PROVIDER_ENV, buildChildEnvSync(), buildChildEnvWithoutTmuxSync(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+59 more)
...
Cohesion: 0.05
Nodes (64): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, completePlanningArtifacts(), checkPlanStatus(), readWorkspacePlanAsync() (+56 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (58): registerAdminCommands(), registerCloisterCommands(), registerBeadsCommands(), configShadowCommand(), registerConfigCommand(), ShadowOptions, cleanFile(), configCommand() (+50 more)
...
Cohesion: 0.03
Nodes (61): pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutexPromise(), agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), buildStoppedAgentLifecycle() (+53 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (51): checkCommand(), syncCommand(), SyncOptions, ensureExcalidrawMcpSync(), ensurePlaywrightIsolationSync(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfigSync(), changed (+43 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (53): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+45 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (52): AutoMergeRow, AutoMergeStatus, cancelPendingAutoMerge(), DbAutoMergeRow, getAutoMergeStatus(), getPendingAutoMerges(), markAutoMergeAborted(), markAutoMergeExecuted() (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (63): buildCorrelationMapSync(), CorrelationResult, embedAction(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir() (+55 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (59): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+51 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (70): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+62 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (55): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+47 more)
...
Cohesion: 0.06
Nodes (58): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), autopresoRouteLayer (+50 more)
...
Cohesion: 0.04
Nodes (50): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+42 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (49): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand(), projectShowCommand() (+41 more)
...
Cohesion: 0.07
Nodes (58): getMemoryStatus(), writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir(), resolveCheckpointFile() (+50 more)
...
Cohesion: 0.04
Nodes (54): canReplaceTitle(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+46 more)
...
Cohesion: 0.04
Nodes (48): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), EFFORT_LEVELS (+40 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (25): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getProjectDirsSync(), getRecentSessionsSync(), getSessionFilesSync(), importSessionToCostLog(), normalizeModelName() (+17 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (53): aggregate, output, AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError (+45 more)

### Community 68 - "Community 68"
Cohesion: 0.04
Nodes (51): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+43 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (48): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+40 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (45): destroyRemoteWorkspace(), buildClaudeUserSettingsSync(), ClaudeUserSettings, getClaudePermissionFlagsStringSync(), getClaudePermissionFlagsSync(), readYoloEnv(), resolvePermissionModeSync(), YOLO_FALSE (+37 more)
...
Cohesion: 0.05
Nodes (47): sentinel, resolveAndSpeak(), emitResetMarkerCreated(), emitMemoryHealthChanged(), enqueueStatusRollupEvent(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), speakTts() (+39 more)

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (55): bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxy(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials (+47 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (41): createMemoryCommand(), queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary() (+33 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (46): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+38 more)
...
Cohesion: 0.07
Nodes (54): assertSafeAgentId(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+46 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (50): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+42 more)
...
Cohesion: 0.06
Nodes (53): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+45 more)
...
Cohesion: 0.04
Nodes (51): result, setDeaconGloballyPaused(), clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute (+43 more)
...
Cohesion: 0.04
Nodes (36): SETTINGS_FILE, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, config (+28 more)

### Community 87 - "Community 87"
Cohesion: 0.04
Nodes (36): StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState, isMac, TERMINAL_PROFILE_ENABLED (+28 more)
...
Cohesion: 0.06
Nodes (41): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+33 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (42): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+34 more)
...
Cohesion: 0.07
Nodes (40): clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, writeStoryFeatureContext() (+32 more)
...
Cohesion: 0.06
Nodes (41): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings() (+33 more)
...
Cohesion: 0.05
Nodes (39): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+31 more)

### Community 106 - "Community 106"
Cohesion: 0.06
Nodes (29): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode (+21 more)

### Community 107 - "Community 107"
Cohesion: 0.05
Nodes (38): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+30 more)
...
Cohesion: 0.06
Nodes (37): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+29 more)

### Community 113 - "Community 113"
Cohesion: 0.1
Nodes (38): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), createTrackerFromConfig() (+30 more)
...
Cohesion: 0.09
Nodes (44): flywheelAbortCommand(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata() (+36 more)
...
Cohesion: 0.08
Nodes (27): createCostCommand(), formatIssueCostAggregate(), runCostSync(), syncWalFromAllProjects(), BUDGETS_FILE, checkBudgetSync(), CostBudget, CostSummary (+19 more)

### Community 120 - "Community 120"
Cohesion: 0.05
Nodes (32): SearchResult, DiscoveredSession, RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+24 more)
...
Cohesion: 0.06
Nodes (42): appendJsonl(), readTranscriptSlice(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir(), compactOffsetCache (+34 more)
...
Cohesion: 0.07
Nodes (32): getWindowDimensions(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+24 more)

### Community 137 - "Community 137"
Cohesion: 0.07
Nodes (32): ensureOpenAICompatibleProxyRunning(), buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+24 more)
...
Cohesion: 0.08
Nodes (31): ComposerMode, IssueComposer(), IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, RestartResult, StoppedAgentsBanner(), retryPendingSpawn() (+23 more)
...
Cohesion: 0.07
Nodes (29): archivePlanning(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+21 more)
...
Cohesion: 0.08
Nodes (34): setupCavemanCompressScripts(), after, backupPath, backups, calls, errSpy, exitSpy, original (+26 more)
...
Cohesion: 0.09
Nodes (36): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+28 more)

### Community 163 - "Community 163"
Cohesion: 0.08
Nodes (35): doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending, queueAutoCommit() (+27 more)
...
Cohesion: 0.09
Nodes (34): detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG (+26 more)
...
Cohesion: 0.06
Nodes (29): ConversationFilter, searchFts(), createConfiguredClaudeApi(), EnrichmentResponse, enrichSession(), CostThresholdError, EnrichOptions, EnrichProgress (+21 more)
...
Cohesion: 0.1
Nodes (28): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync() (+20 more)
...
Cohesion: 0.09
Nodes (31): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji() (+23 more)
...
Cohesion: 0.06
Nodes (11): createFlyApiClientSync(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+3 more)

### Community 192 - "Community 192"
Cohesion: 0.12
Nodes (29): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+21 more)
...
Cohesion: 0.12
Nodes (23): hookCommand(), HookOptions, generateRecoveryPrompt(), checkHookSync(), clearHookSync(), collectMailSync(), generateFixedPointPromptSync(), getHookDir() (+15 more)
...
Cohesion: 0.14
Nodes (35): extractNumberSync(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+27 more)
...
Cohesion: 0.07
Nodes (24): getDefaultConversationModel(), VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab (+16 more)

### Community 205 - "Community 205"
Cohesion: 0.08
Nodes (29): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+21 more)
...
Cohesion: 0.09
Nodes (26): execAsync, rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatus(), getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials (+18 more)
...
Cohesion: 0.07
Nodes (24): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+16 more)

### Community 223 - "Community 223"
Cohesion: 0.08
Nodes (28): emitActivityDetailedSync(), AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), withConcurrencyLimit(), getEventStore(), EnrichmentServiceState, pollOnce() (+20 more)

### Community 224 - "Community 224"
Cohesion: 0.12
Nodes (33): getLocalFlywheelRunDir(), loadResumeSessionId(), saveResumeSessionId(), loadConfigNoMigration(), resolveModel(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus() (+25 more)

### Community 225 - "Community 225"
Cohesion: 0.1
Nodes (28): forkCommand(), ForkOptions, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset() (+20 more)
...
Cohesion: 0.1
Nodes (33): addCommentBefore(), anchorIsValid(), captureTldrMetricsSync(), clone(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+25 more)

### Community 237 - "Community 237"
Cohesion: 0.12
Nodes (32): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+24 more)
...
Cohesion: 0.09
Nodes (22): canonicalPrdSubdirSync(), findDraftPrdSync(), findPrdAnywhereSync(), findPrdAtStatusSync(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+14 more)
...
Cohesion: 0.12
Nodes (3): effFromPromise(), execAsync, FlyProvider
...
Cohesion: 0.12
Nodes (29): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), generateContextDigestPromise(), getContextDigestPath(), getContextDirectory() (+21 more)
...
Cohesion: 0.09
Nodes (24): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), CombinedCommitStatus, CombinedCommitStatusCheck, commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact() (+16 more)
...
Cohesion: 0.07
Nodes (18): callApi(), CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, EMPTY_SEARCH, ExcerptSegment, fetchPaletteSearch() (+10 more)
...
Cohesion: 0.1
Nodes (25): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), ResolveAndSpeakDeps (+17 more)

### Community 283 - "Community 283"
Cohesion: 0.09
Nodes (22): EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate, MemoryHealthUpdateOptions, readMemoryHealth() (+14 more)

### Community 284 - "Community 284"
Cohesion: 0.11
Nodes (26): buildReport(), categorizeProcesses(), ClaudeProcess, detectRole(), formatGb(), formatMb(), getClaudeProcesses(), getHeavyProcesses() (+18 more)
...
Cohesion: 0.1
Nodes (18): NormalizedTtsDaemonConfig, getTtsDaemonStatus(), hasTtsDaemonState(), isTtsDaemonManuallyStopped(), startTtsDaemon(), waitForTtsDaemonHealthPromise(), checkTtsHealth(), startTtsDaemonFromDashboard() (+10 more)
...
Cohesion: 0.11
Nodes (24): findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding(), embed(), EmbeddingProviderName (+16 more)

### Community 300 - "Community 300"
Cohesion: 0.09
Nodes (17): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), ActivityLevel, ActivitySource, EmitActivityOptions (+9 more)

### Community 301 - "Community 301"
Cohesion: 0.1
Nodes (23): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), Handler, PipelineEvent, setPipelineHandlerSync(), ensureManagedTmuxContextOnce(), stopTranscriptPoller(), attachmentCleanupTimer (+15 more)
...
Cohesion: 0.09
Nodes (21): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+13 more)
...
Cohesion: 0.13
Nodes (22): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapperSync(), LauncherConfig, LauncherHarness (+14 more)

### Community 316 - "Community 316"
Cohesion: 0.14
Nodes (26): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), collectDockerContainerLifecycleSnapshot(), createdAgeMs(), defaultWorkspacePath(), DockerPsJson, escapeRegExp() (+18 more)
...
Cohesion: 0.1
Nodes (11): GitHubTracker, octokitToProgram(), parseIssueNumber(), error, mockComment, mockComments, mockIssue, mockIssues (+3 more)
...
Cohesion: 0.14
Nodes (25): apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise(), generateJWT(), getAppStatus() (+17 more)

### Community 343 - "Community 343"
Cohesion: 0.1
Nodes (21): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+13 more)
...
Cohesion: 0.14
Nodes (23): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, isFlywheelDevcontainerRuntime(), parseRunId() (+15 more)
...
Cohesion: 0.11
Nodes (23): AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition, canonicalToTrackerState(), cleanupWorkflowLabels(), DEFAULT_STATE_MAPPINGS, getLinearStateName() (+15 more)

### Community 354 - "Community 354"
Cohesion: 0.11
Nodes (22): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, deliverReviewVerdictFeedbackPromise(), DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl() (+14 more)
...
Cohesion: 0.1
Nodes (14): ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS, cacheKey(), ChatMarkdownErrorBoundary, ChatMarkdownProps, CodeBlockProps, ErrorBoundaryState (+6 more)
...
Cohesion: 0.11
Nodes (18): writeFeedbackFile(), buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), runVerificationForIssuePromise(), SyncResult (+10 more)
...
Cohesion: 0.11
Nodes (17): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, encodeClaudeProjectDir() (+9 more)
...
Cohesion: 0.13
Nodes (18): recoverUnhealthyTestStack(), workspaceRebuildCommand(), StepResult, tempDirs, workspace, EnsureDevcontainerInput, EnsureDevcontainerResult, ensureDevcontainerSync() (+10 more)
...
Cohesion: 0.19
Nodes (22): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+14 more)

### Community 409 - "Community 409"
Cohesion: 0.1
Nodes (13): ActivityView(), MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient (+5 more)
...
Cohesion: 0.11
Nodes (19): compose(), decorate(), end(), getErrorPos(), next(), parse(), parseAllDocuments(), parseArrayColumn() (+11 more)
...
Cohesion: 0.09
Nodes (15): first, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref, mockWriteFile (+7 more)
...
Cohesion: 0.13
Nodes (9): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, loadPanopticonEnvSync(), parseEnvFile(), ServerConfig, ServerConfigError, ServerConfigLayer (+1 more)
...
Cohesion: 0.14
Nodes (14): ensureDefaultConversationModel(), fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted (+6 more)
...
Cohesion: 0.11
Nodes (19): compareArrays(), compareBoth(), compareObjects(), equals(), getRedacted(), hasProperty, isCause(), isContext() (+11 more)

### Community 484 - "Community 484"
Cohesion: 0.18
Nodes (13): startPostLaunchSidecars(), startSidecars(), LOGS_DIR, getSupervisorPortSync(), getSupervisorUrlSync(), isProcessAlive(), isSupervisorRunningSync(), readSupervisorPid() (+5 more)
...
Cohesion: 0.2
Nodes (18): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), isDockerContainerProcess(), killOrphanedProcesses(), killTmuxSessions() (+10 more)

### Community 487 - "Community 487"
Cohesion: 0.13
Nodes (16): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise(), findWorkspacePath(), isBranchMerged() (+8 more)
...
Cohesion: 0.16
Nodes (16): cleanupStaleLocks(), cleanupStaleLocksPromise(), execAsync, findGitLockFiles(), getWorkspaceGitInfo(), getWorkspaceGitInfoPromise(), hasRunningGitProcesses(), hasStaleLocks() (+8 more)
...
Cohesion: 0.16
Nodes (12): buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), dispatchTestAgentAndNotifyPromise(), DispatchTestAgentResult, TestDispatchError, mockResolveProjectFromIssue, mockSetReviewStatus (+4 more)
...
Cohesion: 0.14
Nodes (14): RestartLockHandle, allowedOrigin(), applyCors(), heldRestartMessage(), LOG_FILE, platformConfig, sendJson(), server (+6 more)
...
Cohesion: 0.13
Nodes (15): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), DEFAULT_GATES, runQualityGates(), calls, cmd (+7 more)
...
Cohesion: 0.17
Nodes (13): detectForgeFromPrUrl(), ForgeCommandError, ForgeTimeoutError, getCombinedCommitStatus(), getPrLabels(), isExecTimeoutError(), requirePrUrl(), runForgeJsonCommand() (+5 more)
...
Cohesion: 0.21
Nodes (12): checkAllTriggersPromise(), checkStuckEscalation(), checkTaskCompletion(), checkTaskCompletionPromise(), checkTestFailure(), detectTestFailure(), execAsync, taskCompletionCache (+4 more)
...
Cohesion: 0.22
Nodes (9): scanForConflictMarkers(), err, exec(), execFile(), execMock, kCustom, prompt, spawnRunMock (+1 more)
...
Cohesion: 0.24
Nodes (6): HookItem, computeQueuePositionFromStatusSync(), findPositionInQueueSync(), QueuePositionResult, items, result
...
Cohesion: 0.27
Nodes (8): InspectContext, spawnInspectAgent(), inspectCommand(), InspectOptions, registerInspectCommand(), inspect, { mockResolveProjectFromIssue, mockSpawnInspectAgent, mockGetDiffBase, mockGetDiffStats }, program
...
Cohesion: 0.22
Nodes (7): setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData
...
Cohesion: 0.28
Nodes (7): readContextPercent(), agentDir(), AGENTS_DIR, cleanup(), ctxFile(), id, ids
...
Cohesion: 0.25
Nodes (7): cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush, mockMarkWorkspaceStuck, result
...
Cohesion: 0.24
Nodes (7): code:block10 (pan sync), code:block11 (pan sync), code:block19 (~/.claude/skills/my-override/               ← WINS (personal), code:block20 (~/.claude/skills/my-override/               ← WINS (personal), code:block21 (workspace/.claude/skills/session-health/   ← MYN template ve), Precedence in Practice, What `pan sync` Does: Today vs End-State
...
Cohesion: 0.6
Nodes (5): reconcileAndCheckIfMerged(), reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), getPullRequestState(), isGitHubAppConfigured()
...
## Knowledge Gaps
- **13654 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13649 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 525`, `Community 13`, `Community 15`, `Community 16`, `Community 14`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 568`, `Community 569`, `Community 57`, `Community 60`, `Community 61`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 80`, `Community 82`, `Community 597`, `Community 600`, `Community 91`, `Community 92`, `Community 95`, `Community 1119`, `Community 97`, `Community 100`, `Community 115`, `Community 119`, `Community 130`, `Community 139`, `Community 140`, `Community 149`, `Community 160`, `Community 161`, `Community 162`, `Community 677`, `Community 684`, `Community 191`, `Community 192`, `Community 202`, `Community 203`, `Community 722`, `Community 225`, `Community 236`, `Community 237`, `Community 239`, `Community 256`, `Community 777`, `Community 272`, `Community 281`, `Community 284`, `Community 295`, `Community 298`, `Community 300`, `Community 822`, `Community 316`, `Community 317`, `Community 319`, `Community 321`, `Community 340`, `Community 341`, `Community 351`, `Community 354`, `Community 372`, `Community 901`, `Community 406`, `Community 408`, `Community 412`, `Community 437`, `Community 467`, `Community 469`, `Community 470`, `Community 484`, `Community 489`, `Community 502`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 20` to `Community 320`, `Community 321`, `Community 32`, `Community 7`, `Community 43`, `Community 300`, `Community 19`, `Community 148`, `Community 21`, `Community 211`, `Community 408`, `Community 25`, `Community 92`, `Community 30`, `Community 95`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 2` to `Community 770`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 137`, `Community 778`, `Community 12`, `Community 140`, `Community 142`, `Community 271`, `Community 16`, `Community 15`, `Community 18`, `Community 17`, `Community 276`, `Community 20`, `Community 22`, `Community 151`, `Community 152`, `Community 409`, `Community 529`, `Community 411`, `Community 410`, `Community 157`, `Community 29`, `Community 28`, `Community 32`, `Community 31`, `Community 162`, `Community 296`, `Community 300`, `Community 45`, `Community 303`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 57`, `Community 60`, `Community 191`, `Community 65`, `Community 13`, `Community 72`, `Community 204`, `Community 722`, `Community 469`, `Community 342`, `Community 343`, `Community 471`, `Community 90`, `Community 91`, `Community 226`, `Community 105`, `Community 490`, `Community 107`, `Community 238`, `Community 404`, `Community 114`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 224 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 224 INFERRED edges - model-reasoned connections that need verification._
- **Are the 202 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 202 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13654 weakly-connected nodes found - possible documentation gaps or missing edges._
