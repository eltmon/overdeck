# Graph Report - feature-pan-1312-slot-8  (2026-05-22)

## Corpus Check
- 1878 files · ~2,476,763 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26658 nodes · 41386 edges · 1257 communities (1205 shown, 52 thin omitted)
...
## Communities (1257 total, 52 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (162): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+154 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (177): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+169 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (155): adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus, BUG_STATUS_CLASS, FlywheelStatusDetails(), FlywheelStatusDetailsProps, formatMemory() (+147 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (171): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+163 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (143): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+135 more)
...
Cohesion: 0.02
Nodes (121): checkApiErrorAgents(), checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt() (+113 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (123): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+115 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (122): buildCorrelationMap(), CorrelationResult, embedAction(), confirmCost(), enrichAction(), formatCost(), scanAction(), collectJsonlFiles() (+114 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (117): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+109 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (111): TurnDiffFileChange, forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork() (+103 more)
...
Cohesion: 0.03
Nodes (95): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (90): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (94): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+86 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (86): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+78 more)
...
Cohesion: 0.02
Nodes (101): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, agentStopRoute(), createAgentStopHandler(), invalidateAgentsCache(), cloisterRouteLayer, getCloisterAgentsHealthRoute (+93 more)
...
Cohesion: 0.03
Nodes (90): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+82 more)
...
Cohesion: 0.03
Nodes (92): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+84 more)
...
Cohesion: 0.03
Nodes (94): execFile(), kCustom, mockExecFile, after, body, result, { saveAgentRuntimeStateMock, getAgentRuntimeStateMock }, ActivityEntry (+86 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (88): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+80 more)
...
Cohesion: 0.04
Nodes (84): buildPolyrepoContext(), projectListCommand(), projectShowCommand(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+76 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (62): parsePiSession(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+54 more)
...
Cohesion: 0.02
Nodes (68): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+60 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (79): runCostSync(), buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset() (+71 more)
...
Cohesion: 0.04
Nodes (75): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+67 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (64): computeBeadCounts(), { projectPath, workspacePath }, promoted, specFiles, fsHooks, doc, items, path (+56 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (83): resolveProjectFromIssue(), listPaneValuesAsyncEffect(), listSessionNamesAsyncEffect(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput() (+75 more)
...
Cohesion: 0.04
Nodes (71): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+63 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (78): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks(), createConversation(), FavoriteType (+70 more)
...
Cohesion: 0.04
Nodes (60): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+52 more)
...
Cohesion: 0.04
Nodes (72): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+64 more)
...
Cohesion: 0.04
Nodes (62): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, pathExistsAsync(), result, pathExists() (+54 more)
...
Cohesion: 0.05
Nodes (68): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+60 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (54): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+46 more)
...
Cohesion: 0.04
Nodes (66): detectPlatform(), Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG (+58 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (52): cleanupAbandonedFeedback(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+44 more)
...
Cohesion: 0.04
Nodes (40): ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), RegisteredTranscript, registerTranscriptForPolling(), startTranscriptPoller(), stopTranscriptPoller() (+32 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (58): AgentRuntimeState, agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), deleteAgentRoute, EMPTY_CONVERSATION, evaluateAgentStartGate() (+50 more)
...
Cohesion: 0.06
Nodes (50): killCommand(), KillOptions, buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+42 more)
...
Cohesion: 0.05
Nodes (43): CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow(), formatElapsed() (+35 more)
...
Cohesion: 0.06
Nodes (48): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+40 more)
...
Cohesion: 0.09
Nodes (51): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+43 more)
...
Cohesion: 0.04
Nodes (49): cosineSimilarity(), getFtsRow(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), updateEnrichment(), upsertDiscoveredSession(), chalk (+41 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (49): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), after, backupPath, backups (+41 more)
...
Cohesion: 0.04
Nodes (51): buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, EmbedHttpError, embedOllama(), embedOpenAI(), EmbedOptions (+43 more)
...
Cohesion: 0.07
Nodes (22): importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache (+14 more)
...
Cohesion: 0.06
Nodes (46): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+38 more)
...
Cohesion: 0.07
Nodes (43): detectMergedSwarmSlots(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+35 more)
...
Cohesion: 0.07
Nodes (41): getMemoryStatus(), enqueueStatusRollupEvent(), pendingTurnFileName(), archiveStatus(), buildStatusRollupPrompt(), clearPendingTurns(), commitStatusRollup(), CommitStatusRollupInput (+33 more)
...
Cohesion: 0.12
Nodes (37): applyLabelGitHubImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), execAsync, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearProjectBeadsImpl() (+29 more)
...
Cohesion: 0.08
Nodes (28): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContextError (+20 more)
...
Cohesion: 0.07
Nodes (22): SearchResult, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue(), mapEventToDelta() (+14 more)
...
Cohesion: 0.08
Nodes (11): BUDGETS_FILE, checkBudget(), CostBudget, CostSummary, createBudget(), deleteBudget(), getAllBudgets(), getBudget() (+3 more)
...
Cohesion: 0.11
Nodes (28): getAgentStateAsync(), markAgentStopped(), markAgentStoppedState(), recordAgentFailureAsync(), saveAgentStateAsync(), setAgentDeliveryMethod(), setAgentPausedAsync(), applyClosedOutLabel() (+20 more)

### Community 243 - "Community 243"
Cohesion: 0.1
Nodes (19): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), ReadEventsOptions (+11 more)
...
Cohesion: 0.1
Nodes (24): CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readCavemanVariant() (+16 more)
...
Cohesion: 0.07
Nodes (23): entry, { issueId }, { limit }, old, op, ops, recent, result (+15 more)
...
Cohesion: 0.1
Nodes (19): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), getShadowModeStatus(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled() (+11 more)
...
Cohesion: 0.17
Nodes (24): extractNumber(), extractPrefix(), archivePlanning(), applyLabelLinearImpl(), closeLinearDirectImpl(), cleanupLabelsLinear(), stepFailed(), approve() (+16 more)

### Community 294 - "Community 294"
Cohesion: 0.1
Nodes (16): resolveWorkTypeKey(), useResolvedModels(), fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps, ROLE_META, getViewKey() (+8 more)
...
Cohesion: 0.12
Nodes (22): runMemoryFtsTransaction(), appendLocks, findIndexedObservationByteOffset(), findObservationByteOffset(), indexObservation(), inline(), observationMarkdownPath(), readOptional() (+14 more)
...
Cohesion: 0.13
Nodes (19): rebuildCache(), getEventsFilePath(), getLastEventMetadata(), readEvents(), getRetentionStatus(), needsPruning(), pruneOldEvents(), RetentionStats (+11 more)
...
Cohesion: 0.14
Nodes (12): createPiFifo(), execAsync, PiFifoError, PiFifoPaths, PiNotReady, shellQuote(), writePiCommand(), chunks (+4 more)
...
Cohesion: 0.18
Nodes (3): getProjectDirs(), getSessionFiles(), ClaudeCodeRuntime
...
Cohesion: 0.12
Nodes (15): cleanupLabelsGitHub(), cleanupMergedLabels(), cleanupMergedLabelsImpl(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel (+7 more)
...
Cohesion: 0.15
Nodes (9): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), parseClaudeSession(), getCostFile() (+1 more)

### Community 494 - "Community 494"
Cohesion: 0.21
Nodes (15): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, formatCost(), generateReport(), getCurrentDateString() (+7 more)
...
Cohesion: 0.25
Nodes (9): pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+1 more)
...
Cohesion: 0.33
Nodes (9): DatabaseError, getSettingEffect(), isDeaconGloballyPaused(), isFlywheelGloballyPaused(), setDeaconGloballyPaused(), setFlywheelActiveRunId(), setFlywheelGloballyPaused(), setSetting() (+1 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 257`, `Community 2`, `Community 131`, `Community 5`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 400`, `Community 17`, `Community 19`, `Community 148`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 30`, `Community 35`, `Community 294`, `Community 48`, `Community 177`, `Community 53`, `Community 438`, `Community 437`, `Community 62`, `Community 65`, `Community 67`, `Community 68`, `Community 69`, `Community 197`, `Community 330`, `Community 207`, `Community 208`, `Community 86`, `Community 728`, `Community 221`, `Community 95`, `Community 96`, `Community 616`, `Community 105`, `Community 108`, `Community 237`, `Community 375`, `Community 126`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 35` to `Community 33`, `Community 417`, `Community 292`, `Community 36`, `Community 7`, `Community 42`, `Community 13`, `Community 51`, `Community 21`, `Community 86`, `Community 55`, `Community 312`, `Community 24`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 56` to `Community 256`, `Community 257`, `Community 3`, `Community 259`, `Community 4`, `Community 6`, `Community 131`, `Community 264`, `Community 10`, `Community 13`, `Community 16`, `Community 145`, `Community 401`, `Community 19`, `Community 21`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 37`, `Community 421`, `Community 51`, `Community 52`, `Community 53`, `Community 439`, `Community 55`, `Community 187`, `Community 62`, `Community 193`, `Community 66`, `Community 451`, `Community 322`, `Community 195`, `Community 454`, `Community 325`, `Community 72`, `Community 456`, `Community 76`, `Community 78`, `Community 467`, `Community 469`, `Community 85`, `Community 88`, `Community 90`, `Community 91`, `Community 347`, `Community 608`, `Community 229`, `Community 107`, `Community 493`, `Community 240`, `Community 369`, `Community 114`, `Community 241`, `Community 243`, `Community 245`?**
