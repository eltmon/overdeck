...
## Corpus Check
- 1546 files · ~2,047,864 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21874 nodes · 32563 edges · 1148 communities (1115 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 438 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfb1e895`
...
## Communities (1148 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (135): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, format(), LiveCounter(), LiveCounterProps (+127 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (154): closeOutCommand(), CloseOutOptions, getGitHubConfig(), killCommand(), KillOptions, determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+146 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (126): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (133): checkStuckWorkAgents(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), formatTldrAge(), formatTldrRow(), readContextPercent() (+125 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (129): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+121 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (140): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+132 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (128): readCavemanVariant(), checkStuckReviewing(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+120 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (102): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+94 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (108): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes() (+100 more)
...
Cohesion: 0.03
Nodes (94): loadCloisterConfig(), cleanupStaleAgentState(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffContext, HandoffResult (+86 more)
...
Cohesion: 0.03
Nodes (92): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+84 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (88): DEFAULT_GATES, buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue(), SyncResult, syncSingleRepo() (+80 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (69): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+61 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (85): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), buildReviewBaseCommand(), spawnSingleReviewer(), getSpecialistHarness(), resolveSpecialistBaseCommand(), buildProviderExportLines(), buildSpecialistBaseCommand() (+77 more)
...
Cohesion: 0.04
Nodes (74): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+66 more)
...
Cohesion: 0.05
Nodes (81): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+73 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (76): checkVerificationReviewContradiction(), setAgentStoppedNotifier(), announceMerge(), getReviewStatusFromDb(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry() (+68 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (73): clearStaleCiFeedback(), reconcileAndCheckIfMerged(), doneCommand(), AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks() (+65 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (63): ActionBar(), ActionBarProps, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentGrid() (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (72): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+64 more)
...
Cohesion: 0.04
Nodes (65): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+57 more)
...
Cohesion: 0.05
Nodes (69): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+61 more)
...
Cohesion: 0.04
Nodes (56): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+48 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (51): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+43 more)
...
Cohesion: 0.04
Nodes (51): agentDir, envArg, options, state, stateFile, workspace, anthropicModel, anthropicRouter (+43 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (48): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, FailedMessage, AssistantMessageRow() (+40 more)
...
Cohesion: 0.06
Nodes (56): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR (+48 more)
...
Cohesion: 0.05
Nodes (49): ChatMarkdown, ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, CostEvent, CostStreamResponse, fetchCostStream() (+41 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (51): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+43 more)
...
Cohesion: 0.08
Nodes (45): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument() (+37 more)
...
Cohesion: 0.07
Nodes (45): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findWorkspacePath(), movePrd(), activeDir, completedDir, ctx (+37 more)
...
Cohesion: 0.07
Nodes (44): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+36 more)
...
Cohesion: 0.06
Nodes (34): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime(), PiSpawnTimeout (+26 more)
...
Cohesion: 0.07
Nodes (39): pendingCommand(), after, before, blockers, result, statuses, after, row (+31 more)
...
Cohesion: 0.06
Nodes (40): computePlanningState(), badPath, customPlanningDir, dir, doc, filename, item, item2 (+32 more)
...
Cohesion: 0.16
Nodes (41): extractNumber(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubPr(), closeIssue() (+33 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (36): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, SpecialistAgentName (+28 more)
...
Cohesion: 0.09
Nodes (33): getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+25 more)
...
Cohesion: 0.11
Nodes (31): Access, AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions() (+23 more)
...
Cohesion: 0.1
Nodes (29): startPostLaunchSidecars(), startSidecars(), systemHealthCommand(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive() (+21 more)
...
Cohesion: 0.11
Nodes (24): withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+16 more)
...
Cohesion: 0.12
Nodes (26): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+18 more)
...
Cohesion: 0.14
Nodes (27): listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments() (+19 more)
...
Cohesion: 0.12
Nodes (20): workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose, ph (+12 more)
...
Cohesion: 0.11
Nodes (22): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+14 more)
...
Cohesion: 0.18
Nodes (16): dangerBanner(), DangerousOp, DangerousOpBlockedError, dryRunGitClean(), execAsync, pathLeaf(), runGitCheckoutOverwrite(), runGitClean() (+8 more)
...
Cohesion: 0.15
Nodes (15): mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy, createTracker(), getAllTrackers() (+7 more)
...
Cohesion: 0.31
Nodes (12): deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo(), getIssueDraftPath(), hasIssueDraft(), listIssueDrafts(), readIssueDraft() (+4 more)
...
Cohesion: 0.4
Nodes (3): SessionPanel(), cards, { unmount }
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 2`, `Community 130`, `Community 132`, `Community 5`, `Community 644`, `Community 7`, `Community 8`, `Community 11`, `Community 525`, `Community 270`, `Community 15`, `Community 17`, `Community 19`, `Community 26`, `Community 28`, `Community 285`, `Community 415`, `Community 33`, `Community 34`, `Community 37`, `Community 165`, `Community 41`, `Community 42`, `Community 555`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 53`, `Community 61`, `Community 192`, `Community 72`, `Community 75`, `Community 206`, `Community 335`, `Community 593`, `Community 102`, `Community 378`, `Community 764`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 155` to `Community 3`, `Community 11`, `Community 6`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `resetDb()` connect `Community 90` to `Community 243`?**
