...
## Corpus Check
- 1742 files · ~2,324,037 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23849 nodes · 36502 edges · 1193 communities (1148 shown, 45 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 508 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2df1f56a`
...
## Communities (1193 total, 45 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (168): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (146): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+138 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (171): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), ACTIVE_STATUS_PATTERNS, addLog() (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (142): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+134 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (147): checkPendingTestDispatch(), buildSpecialistBaseCommand(), buildTestRolePrompt(), dashboardApiUrl(), dispatchTestAgentAndNotify(), killCommand(), KillOptions, pauseCommand() (+139 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (123): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+115 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (120): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), getDefaultConversationModel() (+112 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (126): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+118 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (93): parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder, checkFn (+85 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (94): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+86 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (108): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewSessions() (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (99): execAsync, restoreTrackedBeadsExport(), HookItem, computeQueuePositionFromStatus(), findPositionInQueue(), QueuePositionResult, items, result (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (99): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+91 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (98): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+90 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (104): buildHostOverrideConfirmation(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), parseFiniteInteger(), printActiveSliceForIssue(), printWavePlan() (+96 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (83): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+75 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (91): getReviewerSessionName(), parseReviewerSessionName(), Access, withConcurrencyLimit(), pathExistsAsync(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (88): ensureDefaultConversationModel(), fetchSettings(), isIssueTtsMuted(), normalizeIssueId(), putSettings(), setIssueTtsMuted(), fetchMock, muted (+80 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (72): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, { projectPath, workspacePath }, promoted (+64 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (87): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, agentsRouteLayer, validateAgentDeliveryMethodOrigin() (+79 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (90): extractNumber(), extractPrefix(), calls, { mockExecAsync }, opts, execAsync, getContainersReferencingWorkspacePath(), removeWorkspace() (+82 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (83): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+75 more)
...
Cohesion: 0.04
Nodes (78): listTestsCommand(), registerTestCommands(), RunOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, execAsync (+70 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (80): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+72 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (81): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (70): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContinue(), writeWorkspaceContinue(), completePlanningArtifacts(), beadsDir (+62 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (72): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+64 more)
...
Cohesion: 0.04
Nodes (74): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+66 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (73): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (65): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), confirmCost(), enrichAction(), formatCost() (+57 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (74): estimateCost(), { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode (+66 more)
...
Cohesion: 0.05
Nodes (61): scheduleDigestGeneration(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (62): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+54 more)
...
Cohesion: 0.03
Nodes (58): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused() (+50 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (60): embedAction(), ScanOptions, SearchQuery, showAction(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), ConversationFilter, findDiscoveredSessionIds() (+52 more)
...
Cohesion: 0.04
Nodes (57): buildCorrelationMap(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl() (+49 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (59): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+51 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (54): getTrackerContext(), displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock } (+46 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (45): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, PlanDAGViewer(), VBriefDocument (+37 more)
...
Cohesion: 0.05
Nodes (56): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+48 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (57): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_RULES_DIR (+49 more)
...
Cohesion: 0.07
Nodes (49): destroyRemoteWorkspace(), buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+41 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (47): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+39 more)
...
Cohesion: 0.06
Nodes (26): issues, result, importTrackerConfig(), findProjectsByRallyProject(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged() (+18 more)
...
Cohesion: 0.05
Nodes (50): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+42 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (48): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+40 more)
...
Cohesion: 0.06
Nodes (49): addVoice(), clearVoices(), deleteVoice(), findVoiceById(), findVoiceByName(), getTtsVoicesPath(), loadVoices(), saveVoices() (+41 more)
...
Cohesion: 0.06
Nodes (43): InlineSparkline(), InlineSparklineProps, listeners, useSharedTick(), ContainerNode(), containerStatusColor(), containerStatusToDot(), formatMemory() (+35 more)
...
Cohesion: 0.04
Nodes (45): cosineSimilarity(), insertEmbedding(), rowToSession(), upsertDiscoveredSession(), chalk, cliRows, dashboardRows, logs (+37 more)
...
Cohesion: 0.04
Nodes (50): _resetDashboardSessionTokenForTests(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema (+42 more)
...
Cohesion: 0.07
Nodes (42): clearState(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonPython(), getTtsDaemonStatus(), getTtsDaemonVenvDir(), hasCudaGpu() (+34 more)

### Community 77 - "Community 77"
Cohesion: 0.07
Nodes (44): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+36 more)
...
Cohesion: 0.07
Nodes (45): buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails(), formatVoiceSource() (+37 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (40): planCommand(), PlanOptions, DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse, DASHBOARD_URL, resetReviewCommand(), ResetReviewOptions (+32 more)

### Community 84 - "Community 84"
Cohesion: 0.04
Nodes (48): DomainEvent, AgentOutput, ChatMessage, CompactBoundary, ConversationCostTotals, ConversationEvent, ConversationResponse, DeepWipeRpc (+40 more)
...
Cohesion: 0.07
Nodes (40): NormalizedTtsDaemonConfig, buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps (+32 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (37): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+29 more)
...
Cohesion: 0.07
Nodes (39): showCommand(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+31 more)
...
Cohesion: 0.05
Nodes (36): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+28 more)
...
Cohesion: 0.06
Nodes (42): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfig(), detectEnabledProviders(), getMigrationStatus(), hasLegacySettings(), LEGACY_SETTINGS_PATH (+34 more)
...
Cohesion: 0.09
Nodes (40): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+32 more)
...
Cohesion: 0.07
Nodes (37): detectPlatform(), Platform, evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses() (+29 more)
...
Cohesion: 0.09
Nodes (39): renderPrompt(), roleAgentDefinitionPath(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherScript() (+31 more)

### Community 121 - "Community 121"
Cohesion: 0.08
Nodes (31): ComposerMode, IssueComposer(), IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, CodexAuthBanner(), SensitiveText(), SensitiveTextProps (+23 more)

### Community 122 - "Community 122"
Cohesion: 0.05
Nodes (42): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, AgentStatus, CHANNEL_REPLY_KIND_VALUES (+34 more)
...
Cohesion: 0.06
Nodes (31): AgentCard(), AgentCardProps, LastHeardCounter(), ROLE_COLORS, stalenessColor(), STATUS_GLOW, STATUS_ICONS, AgentGrid() (+23 more)
...
Cohesion: 0.07
Nodes (31): applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), CliproxyCodexCredentials, CodexAuthBurned, CodexAuthExpired, CodexAuthMissing, CodexAuthStatus (+23 more)
...
Cohesion: 0.09
Nodes (32): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTier, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels(), getAvailableModels() (+24 more)
...
Cohesion: 0.09
Nodes (29): AvailableModel, AvailableModelsResponse, DEFAULT_WORKHORSES, displayModelRef(), fetchAvailableModels(), fetchSettings(), isWorkhorseRef(), modelExists() (+21 more)

### Community 208 - "Community 208"
Cohesion: 0.12
Nodes (29): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+21 more)
...
Cohesion: 0.12
Nodes (26): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinueAsync(), uniqueTmpPath(), validateWorkspaceContinueState() (+18 more)
...
Cohesion: 0.12
Nodes (23): WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged() (+15 more)
...
Cohesion: 0.15
Nodes (19): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback() (+11 more)
...
Cohesion: 0.13
Nodes (16): findVendoredDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), compressSrc, destDir, dir, hookFiles (+8 more)
...
Cohesion: 0.18
Nodes (15): cleanupStaleLocks(), execAsync, findGitLockFiles(), getWorkspaceGitInfo(), hasRunningGitProcesses(), hasStaleLocks(), execAsync, indexLock (+7 more)
...
Cohesion: 0.17
Nodes (14): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+6 more)
...
Cohesion: 0.22
Nodes (15): addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), detectDnsSyncMethod(), DnsSyncMethod, execAsync, getDnsmasqConfigDir() (+7 more)
...
Cohesion: 0.14
Nodes (13): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+5 more)
...
Cohesion: 0.22
Nodes (7): RolesPanel(), workhorsesWithDefaults(), body, putCall, settingsPayload, url, user
...
## Knowledge Gaps
- **12414 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12409 more)
...
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 3`, `Community 131`, `Community 6`, `Community 136`, `Community 9`, `Community 12`, `Community 14`, `Community 15`, `Community 400`, `Community 17`, `Community 18`, `Community 790`, `Community 23`, `Community 22`, `Community 278`, `Community 27`, `Community 284`, `Community 28`, `Community 673`, `Community 419`, `Community 35`, `Community 421`, `Community 677`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 170`, `Community 557`, `Community 558`, `Community 50`, `Community 54`, `Community 57`, `Community 62`, `Community 64`, `Community 195`, `Community 67`, `Community 198`, `Community 584`, `Community 72`, `Community 76`, `Community 207`, `Community 208`, `Community 83`, `Community 90`, `Community 97`, `Community 354`, `Community 231`, `Community 620`, `Community 621`, `Community 1014`, `Community 121`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 50` to `Community 0`, `Community 64`, `Community 2`, `Community 4`, `Community 38`, `Community 10`, `Community 172`, `Community 47`, `Community 51`, `Community 20`, `Community 21`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `bodyToEvent()` connect `Community 724` to `Community 13`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12414 weakly-connected nodes found - possible documentation gaps or missing edges._
