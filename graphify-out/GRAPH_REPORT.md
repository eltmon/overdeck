...
## Corpus Check
- 1542 files · ~2,037,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21770 nodes · 32335 edges · 1142 communities (1108 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 435 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8571754c`
...
## Communities (1142 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (174): checkApiErrorAgents(), checkFirstCompletionAgents(), checkStuckWorkAgents(), isAgentIdleForNudge(), nudgeIdleWorkAgentsWithOpenBeads(), patrolWorkAgentResolutions(), killCommand(), KillOptions (+166 more)
...
Cohesion: 0.02
Nodes (126): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, BeadsDialog() (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (131): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+123 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (146): readCavemanVariant(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+138 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (146): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+138 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (135): checkMissingReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+127 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (129): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkHeartbeat() (+121 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (107): reconcileAndCheckIfMerged(), reconcileFalseMerged(), BLANKED_PROVIDER_ENV, buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base (+99 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (97): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+89 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (82): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+74 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (75): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+67 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (80): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+72 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (89): checkPostReviewCommits(), spawnReviewCoordinatorSession(), pendingCommand(), after, before, blockers, result, statuses (+81 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (90): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult (+82 more)
...
Cohesion: 0.08
Nodes (79): calls, { mockExecAsync }, opts, ARCHIVES_DIR, canonicalPrdSubdir(), findPrdAtStatus(), statusRoot(), archivePlanning() (+71 more)
...
Cohesion: 0.05
Nodes (73): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AddOptions, BUNDLED_HOOKS_DIR (+65 more)
...
Cohesion: 0.03
Nodes (65): firstSessionPanel, firstWorkbench, workbench, CommandDeck(), IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps (+57 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (65): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+57 more)
...
Cohesion: 0.04
Nodes (67): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+59 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (61): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState() (+53 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (66): showCommand(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), next, path, read, state (+58 more)
...
Cohesion: 0.05
Nodes (49): after, doc, filename, path, ACCompletionResult, isRFC3339DateTime(), toRFC3339(), VBriefDifficulty (+41 more)
...
Cohesion: 0.06
Nodes (57): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig (+49 more)
...
Cohesion: 0.05
Nodes (55): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig() (+47 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (46): parsePiSession(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo(), destroyPiFifo(), execAsync (+38 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (55): normalize(), unarchiveConversationCommand(), getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), archiveConversation(), backfillConversationModel() (+47 more)
...
Cohesion: 0.05
Nodes (53): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffContext, HandoffResult, createHandoffEvent(), ensureLogDir() (+45 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (46): changedFiles, errOutput, fetchMock, output, abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL (+38 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (50): setAgentStoppedNotifier(), announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitActivityTts(), emitDashboardLifecycle() (+42 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (52): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execAsync, execFileAsync, firePostMergeLifecycle() (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (50): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+42 more)
...
Cohesion: 0.06
Nodes (43): checkDeadEndAgents(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile() (+35 more)
...
Cohesion: 0.06
Nodes (46): getIssueDataService(), ActivityContext, closedIssuesCache, costCache, execAsync, execFileAsync, fetchActivityData(), fetchActivityDataWithContext() (+38 more)
...
Cohesion: 0.08
Nodes (42): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+34 more)
...
Cohesion: 0.06
Nodes (37): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+29 more)
...
Cohesion: 0.1
Nodes (32): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), parsePanSpecDocument(), readSpec(), writeSpec(), asPanSpecDocument(), isPanSpecStatus() (+24 more)
...
Cohesion: 0.06
Nodes (25): readFeatureContext(), WorkAgentPromptContext, writeStoryFeatureContext(), readWorkspaceContext(), dbError, deleteCalls, existingBeads, expectedPrefix (+17 more)
...
Cohesion: 0.08
Nodes (32): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceLive, ReadModelServiceShape (+24 more)
...
Cohesion: 0.11
Nodes (31): BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR (+23 more)
...
Cohesion: 0.09
Nodes (27): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), formatTldrAge() (+19 more)
...
Cohesion: 0.12
Nodes (30): Conversation, listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments() (+22 more)
...
Cohesion: 0.12
Nodes (24): registerAdminCommands(), registerCloisterCommands(), compactCommand(), CompactOptions, detectPlatform(), doctorCommand(), execAsync, getOldClosedCount() (+16 more)
...
Cohesion: 0.09
Nodes (23): getReauthSessionToken(), invalidateReauthToken(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub (+15 more)
...
Cohesion: 0.1
Nodes (15): ZoneCConversation(), ZoneCConversationProps, fmtCost(), fmtDuration(), ReviewSummary(), ReviewSummaryProps, ROLE_META, getViewKey() (+7 more)
...
Cohesion: 0.17
Nodes (24): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync (+16 more)
...
Cohesion: 0.16
Nodes (19): clearFeedbackFiles(), inferIssueIdFromWorkspace(), readPendingFeedback(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+11 more)

### Community 313 - "Community 313"
Cohesion: 0.14
Nodes (19): buildACLookupByTitle(), criteria, doc, result, checkAllCriteriaCompleted(), extractAcceptanceCriteria(), extractACFromDocument(), formatAcceptanceCriteria() (+11 more)
...
Cohesion: 0.13
Nodes (18): archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates(), getTrackerContext() (+10 more)
...
Cohesion: 0.16
Nodes (21): exitGracePeriod(), findActiveRegistryKey(), getProjectSpecialistMetadata(), getRunMetadata(), incrementProjectRunCount(), initSpecialistsDirectory(), listProjectsWithSpecialists(), listSessionFiles() (+13 more)
...
Cohesion: 0.16
Nodes (15): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), exec() (+7 more)
...
Cohesion: 0.29
Nodes (9): pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId(), resolveJsonlPath(), ResolveJsonlPathOptions, arr, encoded (+1 more)
...
Cohesion: 0.43
Nodes (7): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext()
...
Cohesion: 0.33
Nodes (6): findDraftPrd(), findPrdAnywhere(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS
...
- **Why does `fetch` connect `Community 1` to `Community 384`, `Community 128`, `Community 2`, `Community 3`, `Community 6`, `Community 264`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 141`, `Community 272`, `Community 19`, `Community 143`, `Community 533`, `Community 534`, `Community 17`, `Community 21`, `Community 30`, `Community 421`, `Community 422`, `Community 40`, `Community 43`, `Community 44`, `Community 174`, `Community 559`, `Community 46`, `Community 53`, `Community 61`, `Community 63`, `Community 70`, `Community 208`, `Community 594`, `Community 595`, `Community 95`, `Community 749`, `Community 498`, `Community 116`, `Community 127`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 125` to `Community 0`, `Community 754`, `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 13` to `Community 1`, `Community 4`, `Community 6`?**
