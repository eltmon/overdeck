...
## Corpus Check
- 1564 files · ~2,060,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21621 nodes · 32016 edges · 1132 communities (1097 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bdd808fc`
...
Cohesion: 0.02
Nodes (139): PlanningState, ZoneAActionsState, BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, BulkAgentWarningDialogProps, DetailPanelLayout() (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (122): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+114 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (115): patrolWorkAgentResolutions(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+107 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (111): setAgentStoppedNotifier(), pendingCommand(), after, before, blockers, result, statuses, after (+103 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (115): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+107 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (96): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, emergencyStop(), fetchCloisterStatus(), fetchConversations(), startCloister() (+88 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (100): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+92 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (84): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions, ConfirmOptions, DialogContext (+76 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (92): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (86): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ViewMode (+78 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (87): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData (+79 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (91): reconcileFalseMerged(), dequeueMerge(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile, after (+83 more)
...
Cohesion: 0.04
Nodes (71): parsePiSession(), getPiLauncherFields(), waitForPiAgentReady(), writePiAgentPrompt(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry() (+63 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (81): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+73 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (89): cleanupStaleAgentState(), captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost() (+81 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (76): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (77): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (83): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, readConvoySubRoleTemplate() (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (73): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+65 more)
...
Cohesion: 0.04
Nodes (66): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (79): calls, { mockExecAsync }, opts, archivePlanning(), archiveWorkspaceArtifacts(), findAllWorkspacePaths(), findWorkspacePath(), applyClosedOutLabel() (+71 more)
...
Cohesion: 0.06
Nodes (74): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+66 more)
...
Cohesion: 0.04
Nodes (68): agentDir, body, LEGACY_FIELDS, legacyFields, options, reloaded, response, { config } (+60 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (59): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), DEFAULTS, UIPreferences (+51 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (61): checkStuckReviewing(), scheduleDigestGeneration(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+53 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (52): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+44 more)
...
Cohesion: 0.05
Nodes (55): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+47 more)
...
Cohesion: 0.04
Nodes (55): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+47 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (52): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, announceMerge(), activeRoleRunExists(), AgentCrashTracker (+44 more)
...
Cohesion: 0.06
Nodes (49): CopyConfigOptions, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_RULES_DIR (+41 more)
...
Cohesion: 0.05
Nodes (40): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+32 more)
...
Cohesion: 0.05
Nodes (29): createFlyApiClient(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+21 more)
...
Cohesion: 0.07
Nodes (44): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+36 more)
...
Cohesion: 0.06
Nodes (31): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+23 more)
...
Cohesion: 0.08
Nodes (37): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+29 more)
...
Cohesion: 0.09
Nodes (37): clearFeedbackFiles(), writeStoryFeatureContext(), validatePlanMatchesIssue(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+29 more)
...
Cohesion: 0.06
Nodes (34): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ActionKey (+26 more)
...
Cohesion: 0.1
Nodes (30): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, result, AcceptanceCriterion (+22 more)
...
Cohesion: 0.08
Nodes (28): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), fname, parts, root, after (+20 more)
...
Cohesion: 0.05
Nodes (36): DomainEvent, AgentOutput, ChatMessage, CompactBoundary, ConversationEvent, ConversationResponse, DeepWipeRpc, GetAvailableEditorsRpc (+28 more)
...
Cohesion: 0.09
Nodes (26): withConcurrencyLimit(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree() (+18 more)
...
Cohesion: 0.07
Nodes (25): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+17 more)
...
Cohesion: 0.1
Nodes (32): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+24 more)
...
Cohesion: 0.09
Nodes (14): getIssueDataService(), getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+6 more)
...
Cohesion: 0.11
Nodes (24): beadsDir, doc, createBeadsFromVBrief(), CreateBeadsResult, deriveProjectPrefix(), execAsync, execFileAsync, getVBriefACStatus() (+16 more)
...
Cohesion: 0.11
Nodes (24): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+16 more)
...
Cohesion: 0.12
Nodes (24): snapshot, status, ReadModelServiceShape, SpecialistAgentName, SpecialistLifecycleState, toAgentResolution(), toAgentStatus(), toMergeStatus() (+16 more)
...
Cohesion: 0.14
Nodes (19): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+11 more)
...
Cohesion: 0.18
Nodes (22): handleConversationImageUpload(), safeUploadExtension(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths() (+14 more)
...
Cohesion: 0.17
Nodes (19): onInspectComplete(), execAsync, getCheckpointDir(), getCheckpointPath(), getCurrentHead(), getDiffBase(), getLastCheckpoint(), InspectCheckpoint (+11 more)
...
Cohesion: 0.26
Nodes (19): createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile(), getRemoteTmuxBaseArgs(), isRemoteAgentRunning() (+11 more)
...
## Knowledge Gaps
- **11466 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11461 more)
...
- **Why does `fetch` connect `Community 5` to `Community 0`, `Community 128`, `Community 130`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 526`, `Community 527`, `Community 16`, `Community 17`, `Community 146`, `Community 275`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 154`, `Community 155`, `Community 29`, `Community 31`, `Community 549`, `Community 37`, `Community 808`, `Community 555`, `Community 44`, `Community 45`, `Community 46`, `Community 179`, `Community 51`, `Community 52`, `Community 56`, `Community 57`, `Community 66`, `Community 74`, `Community 75`, `Community 79`, `Community 91`, `Community 98`, `Community 99`, `Community 754`, `Community 638`, `Community 639`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 105` to `Community 96`, `Community 352`, `Community 198`, `Community 263`, `Community 552`, `Community 74`, `Community 11`, `Community 366`, `Community 79`, `Community 120`, `Community 27`, `Community 444`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 137` to `Community 10`, `Community 166`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11466 weakly-connected nodes found - possible documentation gaps or missing edges._
