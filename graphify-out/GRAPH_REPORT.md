...
## Corpus Check
- 1927 files · ~3,150,586 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27541 nodes · 43235 edges · 1293 communities (1238 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9df4a634`
...
Cohesion: 0.02
Nodes (218): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+210 more)
...
Cohesion: 0.01
Nodes (147): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+139 more)
...
Cohesion: 0.02
Nodes (163): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork() (+155 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (166): checkThinkingSignatureCorruption(), pauseFlywheel(), saveResumeSessionId(), buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename (+158 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (141): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+133 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (114): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (125): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+117 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (116): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (128): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+120 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (113): autoRevertMerge(), autoRevertMergePromise(), execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation() (+105 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (87): parsePiSessionSync(), ProcessSpawnError, ProcessTimeoutError, TmuxError, GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS (+79 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (106): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+98 more)
...
Cohesion: 0.03
Nodes (96): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+88 more)
...
Cohesion: 0.02
Nodes (93): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+85 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (92): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), recoverUnhealthyTestStack() (+84 more)
...
Cohesion: 0.04
Nodes (69): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (81): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+73 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (73): buildACLookupByTitle(), PanSpecListOptions, ProjectPanPaths, criteria, doc, result, { projectPath, workspacePath }, promoted (+65 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (93): logNonCanonicalStashesOnStartup(), recordAutoCloseOutFailure(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise() (+85 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (88): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+80 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (72): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), cleanupAgentDirectories() (+64 more)
...
Cohesion: 0.04
Nodes (73): PlanningState, ZoneAActionsState, SwitchModelModal(), SwitchModelModalProps, VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, classifyStreamLine() (+65 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (81): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand() (+73 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (77): buildPolyrepoContext(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+69 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (70): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+62 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (73): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (80): buildWorkAgentPrompt(), getTrackerContext(), inferIssueIdFromWorkspace(), readBeadsTasks(), readPendingFeedback(), readPlanningContext(), doneCommand(), DoneOptions (+72 more)
...
Cohesion: 0.04
Nodes (69): checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+61 more)
...
Cohesion: 0.04
Nodes (72): defaults, first, { models }, second, getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig (+64 more)
...
Cohesion: 0.08
Nodes (76): add, addCommentBefore(), addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorIsValid(), applyReviver() (+68 more)
...
Cohesion: 0.05
Nodes (65): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin() (+57 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (63): embedAction(), normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), showAction() (+55 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (60): getReviewerSessionName(), parseReviewerSessionName(), Access, getAgentWorkspace(), encodeClaudeProjectDir(), result, pathExists(), pickFreshestSessionId() (+52 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (55): fetchFlywheelState(), FlywheelStatePane(), FlywheelStatePayload, formatLastModified(), adaptFlywheelAgent(), AGENT_STATUS_MAP, AgentRole, AgentStatus (+47 more)
...
Cohesion: 0.04
Nodes (14): createFlyApiClientSync(), FlyApiClient, FlyApiError, FlyExecResult, FlyMachine, FlyMachineConfig, client, fetchMock (+6 more)
...
Cohesion: 0.06
Nodes (59): getMemoryStatus(), events, identity, writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir() (+51 more)
...
Cohesion: 0.06
Nodes (51): extractStitchDesigns(), matchBeadToAC(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig (+43 more)
...
Cohesion: 0.04
Nodes (50): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS (+42 more)
...
Cohesion: 0.05
Nodes (48): clearFeedbackFilesPromise(), execAsync, rebaseFeatureBranchPromise(), RebaseResult, readFeatureContext(), openBrowser(), runCommand(), ClaudeAuthStatus (+40 more)
...
Cohesion: 0.06
Nodes (56): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+48 more)
...
Cohesion: 0.07
Nodes (46): destroyRemoteWorkspace(), saveConfigSync(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider() (+38 more)
...
Cohesion: 0.07
Nodes (24): importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+16 more)
...
Cohesion: 0.06
Nodes (48): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+40 more)

### Community 94 - "Community 94"
Cohesion: 0.05
Nodes (41): buildActiveSliceContext(), cont, doc, projectRoot, specsDir, workspace, runtime, state (+33 more)
...
Cohesion: 0.05
Nodes (30): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId (+22 more)
...
Cohesion: 0.06
Nodes (38): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+30 more)
...
Cohesion: 0.06
Nodes (31): appendJsonl(), ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling() (+23 more)
...
Cohesion: 0.06
Nodes (32): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), Tab, FlywheelRunSummary, NAV_GROUPS (+24 more)
...
Cohesion: 0.07
Nodes (37): WorkingSpinner(), isSpinnerPhase(), toolNameToPhase(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel() (+29 more)
...
Cohesion: 0.07
Nodes (41): anchorNames(), array, captureTldrMetricsSync(), combine, compareArrays(), compareBoth(), compareObjects(), compareRecords() (+33 more)
...
Cohesion: 0.09
Nodes (33): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+25 more)
...
Cohesion: 0.06
Nodes (32): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), calculateCostSync(), CostEntry (+24 more)

### Community 155 - "Community 155"
Cohesion: 0.07
Nodes (21): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, setupVoiceWebSocket() (+13 more)
...
Cohesion: 0.08
Nodes (31): contextMigrateCommand(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+23 more)
...
Cohesion: 0.14
Nodes (34): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyLabelLinearImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), compactBeadsImpl(), execAsync, cleanupLabelsGitHub() (+26 more)
...
Cohesion: 0.08
Nodes (26): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), createConfiguredClaudeApi(), enrichSession(), EnrichSessionOptions, CostThresholdError (+18 more)
...
Cohesion: 0.09
Nodes (28): AIProvider, activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock, ConversationActivitySummary, ConversationWatchHandle, discoverSessionFile() (+20 more)
...
Cohesion: 0.2
Nodes (27): systemHealthCommand(), checkCliproxyPortTask(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile() (+19 more)
...
Cohesion: 0.1
Nodes (23): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), IMAGE_EXTENSIONS, MarkdownFileLink (+15 more)

### Community 287 - "Community 287"
Cohesion: 0.1
Nodes (19): canonicalPrdSubdirSync(), findDraftPrdSync(), findPrdAnywhereSync(), findPrdAtStatusSync(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+11 more)

### Community 288 - "Community 288"
Cohesion: 0.11
Nodes (25): normalizeIssueIdSync(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect(), closeGitHubDirectImpl() (+17 more)
...
Cohesion: 0.17
Nodes (27): arrayPushArray(), atIndentedComment(), blockMap(), blockScalar(), blockSequence(), document(), documentEnd(), findNonEmptyIndex() (+19 more)
...
Cohesion: 0.15
Nodes (23): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+15 more)
...
Cohesion: 0.15
Nodes (7): WipeOptions, extractPrefixSync(), extractStandardNumberSync(), extractStandardPrefixSync(), ParsedIssueId, parseIssueIdSync(), result
...
Cohesion: 0.14
Nodes (14): childEnv, expectedExits, killChildTree(), killChildTreeByPid(), port, requiredFiles, restartQueue, shutdown() (+6 more)
...
Cohesion: 0.15
Nodes (11): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivitySection, formatModel(), IsolationMode() (+3 more)
...
Cohesion: 0.14
Nodes (12): cleanupOldHealthEvents(), DatabaseError, deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory(), getHealthHistory(), getLatestHealthEvent(), getRecentHealthHistory() (+4 more)
...
Cohesion: 0.18
Nodes (10): cb, cmdArgs, key, mockExec, mockGetPullRequestState, mockIsGitHubAppConfigured, next, result (+2 more)
...
Cohesion: 0.32
Nodes (6): startApp(), desktopDir, __dirname, resolveElectronPath(), child, childEnv
...
Cohesion: 0.38
Nodes (6): sshCommand(), runModelSummaryPromise(), runPiModelSummary(), buildSpawnEnvForModel(), spawn, resolveSidecarBinary()
...
Cohesion: 0.5
Nodes (4): getDefaultValue(), getRef(), getReferenceUnsafe(), setContext()
...
## Knowledge Gaps
- **13611 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13606 more)
...
- **Why does `string()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 531`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 31`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 45`, `Community 46`, `Community 48`, `Community 51`, `Community 52`, `Community 54`, `Community 57`, `Community 60`, `Community 61`, `Community 65`, `Community 580`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 80`, `Community 82`, `Community 92`, `Community 93`, `Community 94`, `Community 99`, `Community 103`, `Community 104`, `Community 117`, `Community 659`, `Community 148`, `Community 150`, `Community 151`, `Community 152`, `Community 155`, `Community 159`, `Community 161`, `Community 171`, `Community 188`, `Community 706`, `Community 197`, `Community 214`, `Community 215`, `Community 216`, `Community 232`, `Community 240`, `Community 270`, `Community 272`, `Community 786`, `Community 274`, `Community 275`, `Community 791`, `Community 303`, `Community 304`, `Community 308`, `Community 339`, `Community 868`, `Community 871`, `Community 363`, `Community 364`, `Community 387`, `Community 389`, `Community 391`, `Community 392`, `Community 415`, `Community 417`, `Community 419`, `Community 448`, `Community 479`, `Community 481`, `Community 486`, `Community 493`, `Community 510`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 24` to `Community 36`, `Community 550`, `Community 38`, `Community 392`, `Community 872`, `Community 10`, `Community 205`, `Community 307`, `Community 308`, `Community 21`, `Community 149`, `Community 84`, `Community 29`, `Community 94`, `Community 31`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 2`, `Community 7`, `Community 8`, `Community 9`, `Community 393`, `Community 11`, `Community 10`, `Community 13`, `Community 14`, `Community 271`, `Community 272`, `Community 15`, `Community 18`, `Community 19`, `Community 274`, `Community 22`, `Community 23`, `Community 24`, `Community 28`, `Community 31`, `Community 160`, `Community 289`, `Community 417`, `Community 33`, `Community 35`, `Community 40`, `Community 553`, `Community 47`, `Community 54`, `Community 55`, `Community 57`, `Community 61`, `Community 701`, `Community 66`, `Community 69`, `Community 70`, `Community 335`, `Community 84`, `Community 341`, `Community 214`, `Community 343`, `Community 216`, `Community 219`, `Community 95`, `Community 231`, `Community 488`, `Community 490`, `Community 108`, `Community 240`, `Community 628`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13611 weakly-connected nodes found - possible documentation gaps or missing edges._
