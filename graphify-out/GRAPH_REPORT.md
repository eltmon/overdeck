...
## Corpus Check
- 1545 files · ~2,065,648 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21579 nodes · 32120 edges · 1115 communities (1081 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8016a81`
...
## Communities (1115 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (132): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+124 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (124): ActivityPanel(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+116 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (141): logNonCanonicalStashesOnStartup(), announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, dropLingeringPreMergeStashes() (+133 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (103): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, HandoffConfig (+95 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (125): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+117 more)
...
Cohesion: 0.03
Nodes (101): PlanningState, ZoneAActionsState, ArtifactLinks(), ArtifactLinksProps, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (119): autoResumeStoppedWorkAgents(), nudgeIdleWorkAgentsWithOpenBeads(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+111 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (123): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), checkStuckReviewing(), spawnRebaseAgentForBranch(), renderPrompt(), getActiveParallelReviewIssues(), rotateSpecialistSession(), buildProviderExportLines() (+115 more)
...
Cohesion: 0.02
Nodes (107): getRuntimeSnapshotSync(), markAgentStateServiceInProcess(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute (+99 more)
...
Cohesion: 0.03
Nodes (115): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkDeadEndAgents(), checkFailedMergeRetry(), checkFirstCompletionAgents() (+107 more)
...
Cohesion: 0.04
Nodes (96): readCavemanVariant(), spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), recoverCommand() (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (95): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+87 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (69): parsePiSession(), getPiLauncherFields(), CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent() (+61 more)
...
Cohesion: 0.04
Nodes (85): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content, d, existingDir, lines (+77 more)
...
Cohesion: 0.03
Nodes (69): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+61 more)
...
Cohesion: 0.06
Nodes (86): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+78 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (63): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, DASHBOARD_URL, difficultyColor(), dryRun(), printWavePlan(), swarmCommand() (+55 more)
...
Cohesion: 0.04
Nodes (62): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), loadPinState(), PHASE_CHIP_COLORS (+54 more)
...
Cohesion: 0.04
Nodes (60): err, exec(), execFile(), execMock, kCustom, realExecAsync, spawnMock, tmuxCapturePaneAsyncMock (+52 more)
...
Cohesion: 0.05
Nodes (58): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+50 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (63): clearConfigCache(), getGlobalConfigPath(), YamlConfig, MODEL_DEPRECATIONS, resolveModelId(), allModelIds, defaults, deprecatedIds (+55 more)
...
Cohesion: 0.04
Nodes (40): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+32 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (46): canReplaceTitle(), listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle() (+38 more)
...
Cohesion: 0.05
Nodes (42): setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, ActivityLevel, ActivitySource, emitActivityDetailed(), EmitActivityOptions, emitDashboardLifecycle() (+34 more)
...
Cohesion: 0.06
Nodes (46): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+38 more)
...
Cohesion: 0.08
Nodes (38): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+30 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (38): ActivityEntry, CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI, HEALTH_STATE_LABEL, inferIssueId() (+30 more)
...
Cohesion: 0.08
Nodes (39): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+31 more)
...
Cohesion: 0.07
Nodes (36): agentDir, missing, result, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, toAgentPhase() (+28 more)
...
Cohesion: 0.08
Nodes (36): buildConversationResponse(), getCachedMessages(), validateCwdContainment(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues., Find all session files. (+28 more)
...
Cohesion: 0.11
Nodes (29): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowState(), ensureShadowStateDir(), getDisplayStatus() (+21 more)

### Community 134 - "Community 134"
Cohesion: 0.08
Nodes (27): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, OverviewTab (+19 more)
...
Cohesion: 0.08
Nodes (23): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize() (+15 more)

### Community 144 - "Community 144"
Cohesion: 0.09
Nodes (29): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent(), buildSyncFailureFeedback() (+21 more)
...
Cohesion: 0.09
Nodes (27): readBeadTitleFromJsonl(), syncBeadStatusToVBrief(), after, afterItem, afterSub, before, completedTime, doc (+19 more)
...
Cohesion: 0.07
Nodes (27): agentDir, envArg, options, state, stateFile, workspace, anthropicModel, anthropicRouter (+19 more)
...
Cohesion: 0.12
Nodes (25): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+17 more)
...
Cohesion: 0.1
Nodes (21): WorkTypeOverridesProps, WorkTypeTable(), WorkTypeTableProps, ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanelProps, THINKING_LEVEL_LABELS (+13 more)
...
Cohesion: 0.09
Nodes (23): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), MODEL_COLORS, ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanelProps (+15 more)
...
Cohesion: 0.09
Nodes (19): AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), Harness, HARNESS_OPTIONS, HarnessDecision, HarnessPolicyDecisions (+11 more)
...
Cohesion: 0.12
Nodes (19): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry() (+11 more)
...
Cohesion: 0.16
Nodes (20): clearFeedbackFiles(), writeStoryFeatureContext(), validatePlanMatchesIssue(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue() (+12 more)
...
- **Why does `fetch` connect `Community 4` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 9`, `Community 267`, `Community 11`, `Community 141`, `Community 13`, `Community 527`, `Community 18`, `Community 274`, `Community 19`, `Community 21`, `Community 151`, `Community 152`, `Community 153`, `Community 25`, `Community 26`, `Community 24`, `Community 547`, `Community 35`, `Community 39`, `Community 42`, `Community 45`, `Community 175`, `Community 49`, `Community 53`, `Community 67`, `Community 591`, `Community 86`, `Community 92`, `Community 743`, `Community 365`, `Community 631`, `Community 123`, `Community 637`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 124` to `Community 13`, `Community 14`, `Community 7`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `notifyPipeline()` connect `Community 35` to `Community 8`, `Community 4`, `Community 5`, `Community 14`?**
