...
## Corpus Check
- 1915 files · ~3,143,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27441 nodes · 43037 edges · 1297 communities (1243 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 800 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3640e4f`
...
5. `FsError` - 80 edges
6. `sessionExistsAsyncEffect()` - 68 edges
...
## Communities (1297 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (271): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+263 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (241): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+233 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (223): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+215 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (160): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation() (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (158): anchorNames(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+150 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (140): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+132 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (114): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS (+106 more)
...
Cohesion: 0.03
Nodes (124): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+116 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (97): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+89 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (92): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), criteria, doc, result (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (109): executeHandoff(), HandoffPanel(), HandoffPanelProps, MODEL_COLORS, ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth (+101 more)
...
Cohesion: 0.03
Nodes (80): parsePiSession(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry() (+72 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (105): adminRouteLayer, getAdminTldrRoute, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+97 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (92): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+84 more)
...
Cohesion: 0.03
Nodes (87): claimTranscriptRangeAsync(), commitTranscriptRangeAsync(), getTranscriptCheckpointAsync(), listTranscriptCheckpointsAsync(), pendingRequests, postWorkerRequest(), releaseTranscriptRangeAsync(), runInline() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (76): createHumeConfig(), deleteHumeConfig(), HumeApiError, humeFetch(), HumeResult, content, d, existingDir (+68 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (86): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+78 more)
...
Cohesion: 0.03
Nodes (90): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+82 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (65): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (83): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+75 more)
...
Cohesion: 0.03
Nodes (63): SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe() (+55 more)
...
Cohesion: 0.04
Nodes (67): runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), workspaceDeepCleanCommand() (+59 more)
...
Cohesion: 0.04
Nodes (71): detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoff(), performKillAndSpawn(), sleep() (+63 more)
...
Cohesion: 0.04
Nodes (75): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+67 more)
...
Cohesion: 0.04
Nodes (52): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcp() (+44 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (63): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+55 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (66): getUnblockedItems(), getUnblockedItemsEffect(), isTaskReady(), isTaskReadyEffect(), TERMINAL_STATUSES, getProjectPanPaths(), completePlanningArtifacts(), checkPlanStatusEffect() (+58 more)
...
Cohesion: 0.03
Nodes (60): { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result, setDeaconGloballyPaused(), checkAgentHealthAsync(), checkAgentHealthEffect() (+52 more)
...
Cohesion: 0.05
Nodes (55): TtsDaemonStartResult, TtsDaemonStatus, addVoice(), clearVoices(), deleteVoice(), findVoiceById(), findVoiceByName(), getTtsVoicesPath() (+47 more)
...
Cohesion: 0.05
Nodes (58): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+50 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (52): startPostLaunchSidecars(), startSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning() (+44 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (59): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting(), setSetting() (+51 more)
...
Cohesion: 0.03
Nodes (61): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), parseRelativeTime(), UpsertDiscoveredSessionOpts, updateConversationsConfigAsyncEffect() (+53 more)
...
Cohesion: 0.04
Nodes (50): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+42 more)
...
Cohesion: 0.04
Nodes (54): listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), ConversationAboutSummary (+46 more)
...
Cohesion: 0.05
Nodes (41): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+33 more)

### Community 69 - "Community 69"
Cohesion: 0.08
Nodes (61): add, addIn(), addPairToJSMap(), applyReviver(), array, asItemIndex(), assertCollection(), atDocument() (+53 more)
...
Cohesion: 0.06
Nodes (44): buildManifestFromDirectory(), collectSourceFiles(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFile(), Manifest, ManifestEntry (+36 more)
...
Cohesion: 0.07
Nodes (42): assertSafeAgentId(), assertSafeAgentIdEffect(), captureCheckpoint(), captureCheckpointEffect(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+34 more)
...
Cohesion: 0.07
Nodes (50): buildReviewContext(), BuildReviewContextOpts, ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+42 more)
...
Cohesion: 0.06
Nodes (41): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, closeMemoryFtsDatabases() (+33 more)
...
Cohesion: 0.05
Nodes (37): hasCheckpoint(), backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), base, cols, colsAfter, colsBefore (+29 more)
...
Cohesion: 0.08
Nodes (49): addCommentBefore(), addMergeToJSMap(), ALIAS, anchorIsValid(), callVisitor(), clone(), composeCollection(), createStringifyContext() (+41 more)
...
Cohesion: 0.05
Nodes (34): SearchResult, DiscoveredSession, getConversationsConfigAsyncEffect(), RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload() (+26 more)
...
Cohesion: 0.07
Nodes (35): embedAction(), confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, ConversationFilter, findDiscoveredSessionIds() (+27 more)
...
Cohesion: 0.06
Nodes (36): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+28 more)
...
Cohesion: 0.08
Nodes (36): cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote(), detectWorkspaceLocation() (+28 more)
...
Cohesion: 0.08
Nodes (34): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult, onInspectComplete() (+26 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (35): dropLingeringPreMergeStashes(), applyStash(), buildStashMessage(), CanonicalStashKind, createRecoveryBranchFromStash(), execAsync, isoForStash(), isOlderThanDays() (+27 more)
...
Cohesion: 0.06
Nodes (38): AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey(), DailyTrend, DatabaseError, DbCostRow, DbIssueSummaryRow (+30 more)
...
Cohesion: 0.09
Nodes (35): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), checkTtsHealth(), startTtsDaemonFromDashboard(), StoredEvent (+27 more)
...
Cohesion: 0.1
Nodes (38): markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), isInsideRoot() (+30 more)
...
Cohesion: 0.11
Nodes (35): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth() (+27 more)
...
Cohesion: 0.08
Nodes (30): ComplexityLevel, BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync (+22 more)
...
Cohesion: 0.06
Nodes (25): ChatMessage, MessagesTimeline, derivePlanningIssueId(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, queryClient (+17 more)
...
Cohesion: 0.12
Nodes (33): contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+25 more)
...
Cohesion: 0.08
Nodes (29): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak() (+21 more)

### Community 189 - "Community 189"
Cohesion: 0.09
Nodes (24): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, complexityToModel(), detectComplexity(), detectComplexityFromEstimate(), detectComplexityFromFileCount() (+16 more)
...
Cohesion: 0.07
Nodes (24): ensureDefaultConversationModel(), getDefaultConversationModel(), ForkModal(), ForkModalProps, ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS (+16 more)

### Community 193 - "Community 193"
Cohesion: 0.09
Nodes (29): resolveWorkTypeKey(), useResolvedModels(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence() (+21 more)
...
Cohesion: 0.09
Nodes (29): getIssueDataService(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp() (+21 more)
...
Cohesion: 0.14
Nodes (34): movePrdImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+26 more)
...
Cohesion: 0.1
Nodes (29): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+21 more)
...
Cohesion: 0.09
Nodes (22): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdLocation, PrdStatus, STATUS_DIRS (+14 more)
...
Cohesion: 0.11
Nodes (31): composeAlias(), composeDoc(), composeEmptyNode(), composeNode(), composeScalar(), containsNewline(), doubleQuotedValue(), emptyScalarPosition() (+23 more)
...
Cohesion: 0.13
Nodes (29): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenEffect() (+21 more)
...
Cohesion: 0.1
Nodes (22): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody() (+14 more)
...
Cohesion: 0.14
Nodes (21): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), findLinearStateByName() (+13 more)
...
Cohesion: 0.11
Nodes (21): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+13 more)
...
Cohesion: 0.1
Nodes (19): readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState(), workspacePanPaths(), writeWorkspaceContinue(), WorkspaceContinueState, WorkspacePanPaths, mirrorTaskOperationToContinueFileAsync() (+11 more)

### Community 353 - "Community 353"
Cohesion: 0.13
Nodes (19): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+11 more)
...
Cohesion: 0.14
Nodes (20): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+12 more)

### Community 385 - "Community 385"
Cohesion: 0.11
Nodes (18): importTrackerConfig(), computeBeadCounts(), getCachedPlanningState(), PLANNING_FINISHED_STATUSES, planningStateCache, PlanningStateCacheEntry, planningStateRefreshInFlight, POLL_INTERVALS (+10 more)
...
Cohesion: 0.14
Nodes (17): recoverUnhealthyTestStack(), workspaceRebuildCommand(), tempDirs, workspace, ensureDevcontainer(), EnsureDevcontainerInput, EnsureDevcontainerResult, pathLeaf() (+9 more)
...
Cohesion: 0.12
Nodes (10): ENV_KEYS, EnvSnapshot, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), parseEnvFile(), ServerConfig, ServerConfigError (+2 more)
...
Cohesion: 0.12
Nodes (18): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+10 more)
...
Cohesion: 0.09
Nodes (17): clearReviewStatus(), cb, cmdArgs, key, mockExec, mockGetPullRequestState, mockIsGitHubAppConfigured, next (+9 more)
...
Cohesion: 0.14
Nodes (10): getShadowModeStatus(), hasProjectShadowConfig(), isShadowModeEnabled(), resolveShadowMode(), ShadowModeError, ShadowModeOptions, ShadowModeResult, id (+2 more)
...
Cohesion: 0.15
Nodes (14): assertIssueHasBeadsEffect(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadsForIssue(), queryBeadsForIssueEffect(), readBeadsFromJsonl() (+6 more)
...
Cohesion: 0.29
Nodes (10): formatBrief(), formatDate(), formatIds(), formatTable(), truncate(), registerConversationsCommands(), listAction(), RawFilter (+2 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 1034`, `Community 10`, `Community 12`, `Community 525`, `Community 13`, `Community 11`, `Community 524`, `Community 17`, `Community 18`, `Community 19`, `Community 527`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 35`, `Community 38`, `Community 39`, `Community 43`, `Community 51`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 578`, `Community 67`, `Community 69`, `Community 70`, `Community 582`, `Community 72`, `Community 73`, `Community 71`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 92`, `Community 96`, `Community 630`, `Community 120`, `Community 126`, `Community 142`, `Community 143`, `Community 665`, `Community 157`, `Community 181`, `Community 187`, `Community 702`, `Community 196`, `Community 201`, `Community 216`, `Community 227`, `Community 229`, `Community 239`, `Community 753`, `Community 242`, `Community 755`, `Community 253`, `Community 277`, `Community 791`, `Community 800`, `Community 289`, `Community 802`, `Community 301`, `Community 303`, `Community 320`, `Community 332`, `Community 352`, `Community 353`, `Community 382`, `Community 386`, `Community 415`, `Community 447`, `Community 449`, `Community 450`, `Community 466`, `Community 498`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 1024`, `Community 1`, `Community 5`, `Community 6`, `Community 264`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 269`, `Community 14`, `Community 13`, `Community 270`, `Community 17`, `Community 18`, `Community 145`, `Community 20`, `Community 21`, `Community 278`, `Community 23`, `Community 150`, `Community 154`, `Community 155`, `Community 27`, `Community 413`, `Community 30`, `Community 37`, `Community 38`, `Community 44`, `Community 301`, `Community 174`, `Community 47`, `Community 433`, `Community 10`, `Community 53`, `Community 57`, `Community 59`, `Community 702`, `Community 64`, `Community 450`, `Community 196`, `Community 72`, `Community 73`, `Community 1103`, `Community 85`, `Community 89`, `Community 217`, `Community 107`, `Community 242`, `Community 627`, `Community 243`, `Community 119`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 12` to `Community 352`, `Community 33`, `Community 66`, `Community 547`, `Community 385`, `Community 7`, `Community 10`, `Community 45`, `Community 78`, `Community 205`, `Community 304`, `Community 79`, `Community 19`, `Community 26`?**
