...
## Summary
- 33048 nodes · 64098 edges · 1393 communities (1326 shown, 67 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1517 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3b0a857`
...
## Communities (1393 total, 67 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (283): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+275 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (298): readCavemanVariant(), AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), getSpecialistState() (+290 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.01
Nodes (218): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), BootstrapGate(), BootstrapGateProps, callApi() (+210 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (256): isAgentIdleForNudge(), addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews() (+248 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (219): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription() (+211 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (190): logNonCanonicalStashesOnStartup(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge (+182 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.02
Nodes (185): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync, HandoffContextError (+177 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (176): switchModel(), parseDifficultyLabel(), useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, MenuDivider(), OverflowItem() (+168 more)
...
Cohesion: 0.02
Nodes (171): fileExists(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, REVIEWER_ROLES, Command Deck (Core Concept), Access, computeAgentEnrichment() (+163 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (132): getHealthThresholdsMs(), checkCostLimits(), getCostSummary(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon() (+124 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (159): archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), buildReviewRolePrompt(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), cleanupReviewTempStashPromise() (+151 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.02
Nodes (143): format(), LiveCounter(), LiveCounterProps, fmtCost(), PlanningState, ALL_TABS, OverviewTab, OverviewTabSpec (+135 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.03
Nodes (155): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+147 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.03
Nodes (124): determineCavemanVariant(), injectCavemanSettings(), addDnsEntry(), addDnsmasqEntry(), addHostsFileEntry(), addWsl2HostEntry(), DnsSyncMethod, getDnsmasqConfigDir() (+116 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (141): HookEntry, AddRepoOptions, CreateOptions, DestroyOptions, RepoGroups, UpdateOptions, UseConfigOptions, YAML (+133 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.03
Nodes (127): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+119 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.03
Nodes (116): checkApiErrorAgents(), isCoordinatorAliveAsync(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+108 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.03
Nodes (119): getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), writeStoryFeatureContext() (+111 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.02
Nodes (114): config, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, DEFAULT_CLOISTER_CONFIG (+106 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.04
Nodes (122): getCloisterService(), startCommand(), stopCommand(), StopOptions, buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC() (+114 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.03
Nodes (123): PRIORITY_LABELS, agentDir, dir1, dir2, marker, missing, nested, dir1 (+115 more)
...
Cohesion: 0.03
Nodes (103): abortSignal(), AgentRuntimeFetchError, emitActivity(), emitAgentEvent(), emitChannelReply(), emitMessageReceived(), emitModelSet(), emitResolution() (+95 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.06
Nodes (114): updateGitHubToInReview(), killTmuxSession(), content, mockExeca, mockExec, extractNumber(), extractNumberSync(), extractPrefix() (+106 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.02
Nodes (83): SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS, BeadTask, IssueActionDialogHost() (+75 more)
...
Cohesion: 0.04
Nodes (103): hasCheckpoint(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+95 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.04
Nodes (112): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger(), printWavePlan() (+104 more)

### Community 29 - "Command Deck Zone B Session Nodes"
Cohesion: 0.03
Nodes (99): loadStoredHarness(), conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck() (+91 more)

### Community 30 - "GodView Socket and Activity Feed"
Cohesion: 0.03
Nodes (98): Work Agent (shown in inspector terminal), DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), copyToClipboard() (+90 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.03
Nodes (79): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), result, claudePlanningSystemPromptFiles(), clearCacheRoute (+71 more)
...
Cohesion: 0.03
Nodes (108): estimateCost(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneDocsConfig() (+100 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.04
Nodes (95): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+87 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.03
Nodes (98): createDocsCommand(), DocsQueryOptions, printDocsQueryResult(), chunkFor(), chunkMarkdown(), ChunkMarkdownOptions, corpusConfig(), dedupeSources() (+90 more)
...
Cohesion: 0.03
Nodes (92): clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig, updateConversationsConfigAsync(), WorkhorsesConfig (+84 more)
...
Cohesion: 0.04
Nodes (81): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+73 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.04
Nodes (70): mockClaudeSkills, BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, getLatestVersion(), isNewer() (+62 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (79): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, SETTINGS_FILE (+71 more)
...
Cohesion: 0.05
Nodes (77): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssue(), getCostsByIssueSync(), getCostsDir() (+69 more)
...
Cohesion: 0.04
Nodes (81): AgentCard(), AgentCardProps, AgentPhase, getModelStyle(), ModelBadge(), AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps (+73 more)
...
Cohesion: 0.05
Nodes (73): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+65 more)

### Community 54 - "Platform Supervisor Startup Lifecycle"
Cohesion: 0.05
Nodes (68): startPostLaunchSidecars(), startSidecars(), restartCommand(), runFullRestart(), delay(), data, mockExistsSync, mockReadFile (+60 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.05
Nodes (74): ComplianceWarningMarkers, loadComplianceMode(), readComplianceWarningMarkers(), resolveComplianceAdvisoryWarning(), ResolveComplianceAdvisoryWarningInput, resolveComplianceWarningMarkersFile(), identity, writeObservations() (+66 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.04
Nodes (69): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+61 more)
...
Cohesion: 0.03
Nodes (76): decodeFlywheelStatus, emitStatusCommand(), parseFlywheelStatusJson(), readFlywheelStatusJson(), registerFlywheelCommands(), validateFlywheelStatusPayload(), assertExistingPathInsideRoot(), assertWritePathInsideRoot() (+68 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.05
Nodes (68): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+60 more)

### Community 60 - "Permission Request Bridge and Forwarding"
Cohesion: 0.03
Nodes (56): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+48 more)

### Community 61 - "Issue Lifecycle Service and Tests"
Cohesion: 0.04
Nodes (63): buildContextMenu(), buildMenuTemplate(), buildTooltip(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createTray(), createTrayIcon() (+55 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.03
Nodes (69): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, buildFilterSql(), CosineSearchResult, cosineSimilarity(), countFtsSessions(), FtsRow (+61 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.06
Nodes (63): skillDir, skills, updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest() (+55 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (64): DeepWipeDialog(), DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, StepRow(), WipeState, PlanDialogProps (+56 more)

### Community 65 - "Agent List and Handoff Status UI"
Cohesion: 0.05
Nodes (66): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+58 more)
...
Cohesion: 0.06
Nodes (53): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), logSpy, now, output, payload (+45 more)

### Community 71 - "Multi-Tracker Runtime Adapter Interface"
Cohesion: 0.05
Nodes (57): backup, backupCleanCommand(), backupListCommand(), CopyConfigOptions, PACKAGE_ROOT, restoreCommand(), BackupInfo, cleanOldBackups() (+49 more)

### Community 72 - "Resource Process Discovery and Reporting"
Cohesion: 0.04
Nodes (62): adminRouteLayer, getAdminTldrRoute, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute, postCloisterEmergencyStopRoute (+54 more)

### Community 73 - "Merge Queue and App Settings Database"
Cohesion: 0.03
Nodes (60): autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions (+52 more)
...
Cohesion: 0.05
Nodes (59): applyEnvironmentOverrides(), deepMerge(), loadCloisterConfig(), loadCloisterConfigAsync(), loadCloisterConfigSync(), saveCloisterConfigSync(), shouldAutoStart(), updateCloisterConfigSync() (+51 more)
...
Cohesion: 0.04
Nodes (61): Agent Enrichment Service, result, snapshot, status, filterClosedIssueAgents(), getClosedIssueIdsForReadSource(), IssueReadSourceState, Jsonish (+53 more)
...
Cohesion: 0.05
Nodes (58): AlertDialogContent(), AlertOptions, ConfirmDialogContent(), ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+50 more)

### Community 83 - "Issue Search Modal and Filter State"
Cohesion: 0.04
Nodes (56): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, loadSort() (+48 more)
...
Cohesion: 0.05
Nodes (51): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), delay(), findLastCompactBoundaryOffset() (+43 more)

### Community 87 - "CLI Command Taxonomy Reorganization"
Cohesion: 0.04
Nodes (63): CHANGELOG [0.7.0] Command Taxonomy Reorganization, Devroot Pattern for Skill Placement, pan done Command, pan plan Command, pan start Command, pan sync Command, pan tell Command, pan up Command (+55 more)
...
Cohesion: 0.05
Nodes (18): CLAUDE_PROJECTS_DIR, ClaudeMessage, getAllSessionFilesSync(), getProjectDirs(), getProjectDirsSync(), getRecentSessions(), getRecentSessionsSync(), getSessionFiles() (+10 more)
...
Cohesion: 0.08
Nodes (51): setReviewStatusAsync(), warnSpy, addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRun(), handleCheckRunPromise() (+43 more)

### Community 94 - "Traefik DNS and Platform Install Skills"
Cohesion: 0.07
Nodes (45): clearFeedbackFiles(), clearFeedbackFilesPromise(), contextCommand(), ContextOptions, appendSummary(), appendSummarySync(), checkContextBudget(), checkContextBudgetSync() (+37 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.05
Nodes (49): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), indexDailySummary() (+41 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.06
Nodes (48): TABS, themeButton, VBriefDifficulty, VBriefEdge, VBriefEdgeType, VBriefInspectionPolicy, VBriefItem, VBriefItemStatus (+40 more)
...
Cohesion: 0.05
Nodes (48): ACTIVE_AGENT_STATUSES, agentForFeature(), BUCKET_STAGES, BucketedFeature, bucketFeature(), bucketFeaturePhase(), classifierAgent(), classifierIssue() (+40 more)
...
Cohesion: 0.07
Nodes (61): addCommentBefore(), addMergeToJSMap(), ALIAS, anchorIsValid(), atDocument(), callVisitor(), clone(), constructor() (+53 more)
...
Cohesion: 0.05
Nodes (54): MODEL_COLORS, CloisterStatus, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus() (+46 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.07
Nodes (52): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), handleConversationHandoffDoc(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+44 more)
...
Cohesion: 0.05
Nodes (46): ConversationFilter, markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi() (+38 more)

### Community 110 - "Project Registration and Test Runner"
Cohesion: 0.05
Nodes (49): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl() (+41 more)
...
Cohesion: 0.05
Nodes (53): ResolveAndSpeakOptions, TtsSpeakMode, TtsSpeakResult, HeaderMap, CappedBodyReadResult, checkTtsHealth(), CheckTtsHealthOptions, clearTtsVoices() (+45 more)
...
Cohesion: 0.05
Nodes (40): ActivityFeedCard(), ActivityFeedCardProps, BucketSection(), BucketSectionProps, AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState, ConversationFeedCard() (+32 more)
...
Cohesion: 0.06
Nodes (39): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+31 more)

### Community 122 - "Dashboard Terminal UI Components"
Cohesion: 0.06
Nodes (36): pruneStaleCheckpointRefs(), appendToWal(), appendToWalSync(), resolveWalDir(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep (+28 more)
...
Cohesion: 0.07
Nodes (50): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+42 more)
...
Cohesion: 0.05
Nodes (42): EMPTY_STATES, FeedTabContent(), isSessionFeedTab(), isStubTab(), navigateToFeedEntry(), pushRoute(), readStoredTab(), SessionFeedSidebar() (+34 more)
...
Cohesion: 0.1
Nodes (51): add, addIn(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex(), assertCollection() (+43 more)
...
Cohesion: 0.08
Nodes (38): fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL, STATUS_ANIM_CLASS (+30 more)
...
Cohesion: 0.06
Nodes (37): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, next, restored (+29 more)
...
Cohesion: 0.06
Nodes (35): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+27 more)
...
Cohesion: 0.11
Nodes (36): devCommand(), ensureDashboardBundle(), killPort(), checkCommand(), checkPrerequisites(), copyDirectoryRecursive(), installCommand(), InstallOptions (+28 more)
...
Cohesion: 0.09
Nodes (36): getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), cleanFile(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects() (+28 more)
...
Cohesion: 0.07
Nodes (35): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, existingSkillDir, existsInTarget (+27 more)
...
Cohesion: 0.06
Nodes (28): RuntimeConversationsConfig, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession(), filterDomainEventForIssue() (+20 more)
...
Cohesion: 0.08
Nodes (34): HealthEvent, STATE_COLORS, AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration() (+26 more)
...
Cohesion: 0.07
Nodes (33): buildActiveSliceContext(), inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), readWorkspacePlanAsync(), githubTracker, linearTracker, longBody (+25 more)
...
Cohesion: 0.06
Nodes (27): result, activeContinuePath, continuePath, projectRoot, wsDir, cb, cmdArgs, mockExec (+19 more)
...
Cohesion: 0.09
Nodes (25): DatabaseError, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet() (+17 more)
...
Cohesion: 0.12
Nodes (29): checkCliproxyPortAsync(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, installCliproxyEffect(), isCliproxyRunning() (+21 more)
...
Cohesion: 0.08
Nodes (24): mockLoadProjectsConfig, CleanResult, execAsync, WorkspaceInfo, WorkspaceService, WorkspaceServiceLive, WorkspaceServiceShape, runEffectFail() (+16 more)
...
Cohesion: 0.1
Nodes (29): AgentStateIssue, cleanupAgentDirectories(), cleanupAgentDirectoriesPromise(), cleanupClosedIssueAgentDirectories(), cleanupClosedIssueAgentDirectoriesPromise(), CleanupResult, ClosedIssueAgentCleanupResult, ClosedIssueAgentDir (+21 more)
...
Cohesion: 0.06
Nodes (26): getActiveSessionModelSync(), claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+18 more)
...
Cohesion: 0.1
Nodes (29): onToggle, CategoryFilter, formatContextLength(), formatCost(), ModelCard(), OpenRouterModel, OpenRouterModelBrowser(), OpenRouterModelBrowserProps (+21 more)
...
Cohesion: 0.13
Nodes (28): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), createSummaryFork(), SummaryForkMode (+20 more)
...
Cohesion: 0.14
Nodes (24): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), fetchMock (+16 more)
...
Cohesion: 0.09
Nodes (27): DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), getEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, EmbedSessionsOptions (+19 more)
...
Cohesion: 0.13
Nodes (27): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+19 more)
...
Cohesion: 0.11
Nodes (24): exec(), execFile(), execMock, buildSyncFailureFeedback(), execAsync, getSyncTargetBranch(), resolveGitDirs(), runVerificationForIssue() (+16 more)
...
Cohesion: 0.13
Nodes (22): err, getVBriefACStatusSync(), hiddenDir, mockExecFn, subA, subB, BeadRecord, checkOpenBeads() (+14 more)
...
Cohesion: 0.13
Nodes (23): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+15 more)
...
Cohesion: 0.13
Nodes (20): INFERENCE.md Artifact, getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), getShadowModeSummaryPromise(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise() (+12 more)
...
Cohesion: 0.16
Nodes (19): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), addAlias() (+11 more)
...
Cohesion: 0.09
Nodes (20): ensureDefaultConversationModel(), ALLOWED, AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness (+12 more)
...
Cohesion: 0.09
Nodes (19): ACTIVE_STATUS_PATTERNS, ACTIVE_STATUS_PATTERNS, agentDir, isEligibleForCleanup(), LAZY_PATTERNS, lazySamples, oldTime, stateFile (+11 more)
...
Cohesion: 0.1
Nodes (18): healths, CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health (+10 more)
...
Cohesion: 0.13
Nodes (20): .planning-complete — Planning Completion Marker File, PAN-208: Stale Planning State Causes Premature Planning Complete on Restart, Smart Ctrl+C (copy if selection, else interrupt) in XTerminal, PAN-34: Terminal Copy/Paste Support in XTerminal, src/dashboard/frontend/src/components/BeadsTasksPanel.tsx — Graph/List Toggle, src/dashboard/frontend/src/components/PlanDAG.tsx — ReactFlow DAG Component, PAN-388: vBRIEF Integration — Structured Plans, Programmatic Beads, DAG Visualization, src/lib/cloister/specialists.ts — Post-Planning vBRIEF Converter (+12 more)
...
Cohesion: 0.13
Nodes (16): runPreflight(), runStreaming(), beads, capturedArgs, err, mockExecFileFn, mockExecFn, checkVBriefACStatus() (+8 more)
...
Cohesion: 0.12
Nodes (17): ChatMarkdown Component (react-markdown + Shiki), ConversationPanel Component, MessagesTimeline Component (T3Code mirror), GET /api/activity/:issueId — aggregate all agent sessions for an issue, GET/POST /api/planning/:issueId — planning artifact management, PAN-161: Mission Control — unified monitoring view and Shadow Engineering, MissionControl frontend component tree, .planning/ directory structure for workspace artifacts (+9 more)
...
Cohesion: 0.15
Nodes (10): fetchProjectSpecialists(), fetchRunLogs(), formatDate(), ProjectSpecialist, ProjectSpecialistCardProps, ProjectSpecialistMetadata, RunLogEntry, STATUS_COLORS (+2 more)
...
Cohesion: 0.17
Nodes (12): code:bash (pan plan PAN-1071), code:bash (pan plan done PAN-1071), code:bash (# Accept the plan and create workspace), code:bash (# Send feedback to planning agent), code:bash (# Exit planning session), Completing planning (`pan plan done`), Planning Workflow, Starting planning (+4 more)
...
Cohesion: 0.22
Nodes (6): DEFAULT_CONFIG, lastActivity(), mocks, NOW, runtime(), state()
...
Cohesion: 0.18
Nodes (10): backup, backup1, backup2, backupDir, backups, skillsBackup, sourceDir, t1 (+2 more)
...
Cohesion: 0.27
Nodes (9): isDeliveryStillRelevant(), processPendingFeedbackDeliveries(), delivery, deliver, getAgentState, getStatus, loadStatuses, setupQueueFile() (+1 more)
...
Cohesion: 0.22
Nodes (9): Auto-Shutdown, code:bash (# Monitor in one terminal), code:bash (# Stop on user logout), code:bash (# Clean up stale resources), code:bash (# Clean up stale resources), Manual Triggers, Monitoring Shutdown, On System Shutdown (systemd) (+1 more)
...
Cohesion: 0.29
Nodes (7): Cleanup After Shutdown, code:bash (pan down), code:bash (# Clean up log files), Forceful Shutdown, Graceful Shutdown (default), Graceful vs Forceful Shutdown, Hung Shutdown
...
Cohesion: 0.33
Nodes (3): { projectPath, workspacePath }, promoted, specFiles
...
- **Why does `execAsync` connect `Self Improving Flywheel and Agent Messaging` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Agent Runtime Spawning`, `Parallel Review Pipeline Dispatch`, `Conversation Database and Favorites`, `Agent Snapshot and Event Types`, `Cloister Service Health and Config`, `Kanban Board Agent Status UI`, `Electron Desktop App and Tray`, `Health Metrics and Settings Pages`, `Skill Sync Mirror Tests`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Claude Session JSONL Parsing and Costs`, `Feature Metadata Badge and Modal Components`, `Dashboard Store and Command Palette`, `VBrief Lifecycle IO and Transitions`, `Git Activity and Runtime Metrics`, `Specialist Metadata and Grace Period`, `Docker Stats and Container Resources`, `Community 542`, `Specialist Handoff Logging and Queue Depth`, `Cost Calculation and Token Usage`, `Community 548`, `Cloister Config Deep Merge`, `Turn Diff File Change Tree UI`, `Pending Feedback Queue Delivery`, `Workflow Orchestration and vBRIEF Research`, `GitHub Client and Agent Spawner`, `Merge Queue and App Settings Database`, `Path Constants and Postinstall Setup`, `Cost Recovery Scripts and Latency Tests`, `Interactive Terminal Panel Integration`, `Root Artifact Cleanup Policy`, `Multi-Tracker Adapter Implementations`, `Convoy Parallel Agent Synthesis`, `Agent Work Skill Conventions`, `Community 486`, `Multi-Model Settings E2E Tests`, `vBRIEF Plan Format and Lifecycle`, `Agent Health Monitor States`, `TLDR Daemon State Management`, `UI and Diff Preferences Persistence`, `Label Cleanup and Workflow Lifecycle Tests`, `Pi Extension Session Event Handlers`, `Dashboard Terminal UI Components`, `TTS Daemon and Pi Extension Supervisor`, `Community 508`, `Dashboard PostCSS Configuration`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `CLI Command Taxonomy Reorganization` to `Multi-Tool Skill Sync Config Migration`, `Resource-Allocated Issue Discovery`, `Health Metrics and Settings Pages`, `VBrief Task Readiness and Beads IO`, `Rally WSAPI Query Parser Fix`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Specialist Metadata and Grace Period` to `Agent Session Lifecycle Management`, `Merge Agent Post-Merge Lifecycle`, `Command Deck Overview Tab UI`, `Rally Tracker API Integration`, `VBrief Plan Builder and Viewer`, `Conversation Attachment Lifecycle Management`, `Deacon Patrol and Queue`, `Specialist Handoff and Planning Spawn`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Health Metrics and Settings Pages`, `Issue Service and Data Fetching`, `Beads Dependencies Async Gates and Workflows`, `Command Deck Zone B Session Nodes`, `VBrief Beads IO and Plan Finalize`, `Project Tree Feature Items UI`, `Community 422`, `Git Push Operations and Approval`, `Agent Status RPC Contracts`, `Kanban Board UI Screenshots`, `Cloister Config Deep Merge`, `Context History Logging and Search`, `Turn Diff File Change Tree UI`, `Community 816`, `Issue Tracker Polling Service`, `Self Improving Flywheel and Agent Messaging`, `Server Cache Service and Chat Markdown`, `Agent List and Handoff Status UI`, `GitHub Webhook Ingestion Handlers`, `GitHub Client and Agent Spawner`, `Workspace Teardown and Label Cleanup`, `Multi-Tracker Runtime Adapter Interface`, `Resource Process Discovery and Reporting`, `Cost Session Map and Issue Totals`, `Community 715`, `Resource-Allocated Issue Discovery`, `Model Routing and Complexity Detection`, `Issue Search Modal and Filter State`, `Cloister Orchestrator Architecture PRDs`, `Rally Tracker Adapter Tests`, `Conversation Panel and Chat Phase Types`, `Database Settings and Cost Unit Tests`, `Desktop Build Configuration`, `Community 486`, `Config Migration and Test Agent`, `Docker DotNet Template`, `Specialist Agent Prompts and Audit Docs`, `Agent Hook Scripts and Repo Artifact Design`, `Agent Health Event Persistence`?**
