...
## Corpus Check
- 1563 files · ~2,056,869 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21580 nodes · 31966 edges · 1128 communities (1095 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 415 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e6fdbf6`
...
## Communities (1128 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (168): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), dropLingeringPreMergeStashes(), postMergeLifecycle(), resetPostMergeState(), spawnMergeAgentForBranches(), archiveReviewerRound(), buildReviewFeedbackBody() (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (125): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+117 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (111): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+103 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (123): fetchConversations(), fetchConversations(), GeneralConversation, GeneralSectionProps, summaryForkConversation(), unfavoriteConversation(), fetchWorkspace(), forgeApprove() (+115 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (107): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+99 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (122): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), buildProviderExportLines(), buildSpecialistCavemanExports(), buildTaskPrompt(), buildTestAgentPromptContent(), buildTmuxEnvFlags() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (126): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkFirstCompletionAgents(), checkHeartbeat() (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (108): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (102): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+94 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (101): resolveSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), resumeCommand(), tellCommand(), getRuntimeSnapshotSync(), markAgentStateServiceInProcess() (+93 more)
...
Cohesion: 0.03
Nodes (94): Access, withConcurrencyLimit(), encodeClaudeProjectDir(), getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache (+86 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (93): checkApiErrorAgents(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+85 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (92): checkVerificationReviewContradiction(), pendingCommand(), formatTldrAge(), formatTldrRow(), readContextPercent(), readTldrIndexData(), statusCommand(), StatusOptions (+84 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (90): captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename, getConflictFiles() (+82 more)
...
Cohesion: 0.03
Nodes (79): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (87): reconcileAndCheckIfMerged(), getPullRequestState(), isGitHubAppConfigured(), execFile(), kCustom, mockExecFile, after, body (+79 more)
...
Cohesion: 0.03
Nodes (78): checkDeadEndAgents(), checkFailedMergeRetry(), checkPendingTestDispatch(), clearStaleCiFeedback(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions (+70 more)
...
Cohesion: 0.04
Nodes (74): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+66 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (74): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+66 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (59): criteria, doc, result, doc, path, AcceptanceCriterion, ACCompletionResult, checkAllCriteriaCompleted() (+51 more)
...
Cohesion: 0.05
Nodes (71): closeOutCommand(), CloseOutOptions, getGitHubConfig(), runCommand(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+63 more)
...
Cohesion: 0.06
Nodes (66): showCommand(), findSpecByIssue(), updateSpecStatus(), next, path, read, state, after (+58 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (58): changedFiles, errOutput, fetchMock, output, githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig (+50 more)
...
Cohesion: 0.05
Nodes (58): setAgentStoppedNotifier(), announceMerge(), agentStatusCommand(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions (+50 more)
...
Cohesion: 0.06
Nodes (53): killCommand(), KillOptions, destroyRemoteWorkspace(), getClaudePermissionFlags(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+45 more)
...
Cohesion: 0.06
Nodes (48): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, getShadowModeFromEnv() (+40 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (46): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, result, createBeadsFromVBrief(), CreateBeadsResult (+38 more)
...
Cohesion: 0.07
Nodes (49): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+41 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (50): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+42 more)
...
Cohesion: 0.06
Nodes (39): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, FailedMessage, AssistantMessageRow() (+31 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (44): BYTE_UNITS, ContainerHistory, ContainerStats, DockerNetwork, DockerStatsCollector, DockerStatsRaw, DockerVolume, execAsync (+36 more)
...
Cohesion: 0.04
Nodes (42): after, row, status, initSchema(), base, cols, colsAfter, colsBefore (+34 more)
...
Cohesion: 0.05
Nodes (36): buildMenuTemplate(), callServerApi(), configureApplicationMenu(), createTerminalWindow(), createWindow(), currentStatus, DEFAULTS, dispatchMenuAction() (+28 more)
...
Cohesion: 0.07
Nodes (46): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+38 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (43): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, getDefaultWorkspaceConfig(), HumeConfig, ProjectConfig, replacePlaceholders() (+35 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (44): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+36 more)
...
Cohesion: 0.05
Nodes (41): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+33 more)
...
Cohesion: 0.13
Nodes (43): bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), checkCliproxyPortAsync(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload() (+35 more)
...
Cohesion: 0.06
Nodes (33): ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity(), fetchCloisterStatus(), fetchProjectSpecialists(), formatTimeAgo() (+25 more)
...
Cohesion: 0.07
Nodes (28): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, ModelId, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping() (+20 more)
...
Cohesion: 0.09
Nodes (35): spawnReviewCoordinatorSession(), buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherAgentType (+27 more)
...
Cohesion: 0.11
Nodes (32): listSkills(), parseSkillFrontmatter(), SkillMeta, skillsCommand(), ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR (+24 more)
...
Cohesion: 0.12
Nodes (31): resolveBundledServerPath(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions, runFullRestart(), spawnDashboardDetached(), LOGS_DIR (+23 more)
...
Cohesion: 0.09
Nodes (29): DoneOptions, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES, CanonicalState, CanonicalStateDefinition (+21 more)
...
Cohesion: 0.11
Nodes (29): resolveModelId(), applyFallback(), applyTierAwareFallback(), detectEnabledProviders(), FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+21 more)
...
Cohesion: 0.1
Nodes (23): getWindowDimensionsAsync(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+15 more)
...
Cohesion: 0.11
Nodes (25): CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath(), isBranchMerged(), canonicalPrdSubdir() (+17 more)

### Community 220 - "Community 220"
Cohesion: 0.12
Nodes (27): archivePlanning(), CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut() (+19 more)
...
Cohesion: 0.09
Nodes (20): runWhiteboardWarmupOnce(), AutoPresoAgentMessage, AutoPresoListener, AutoPresoMode, AutoPresoSession, AutoPresoSnapshot, createWarmupUserMessage(), createWhiteboardSession() (+12 more)
...
Cohesion: 0.1
Nodes (17): ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), formatDuration(), SessionNode(), fixedNow, resolvedModels (+9 more)
...
Cohesion: 0.29
Nodes (21): archiveWorkspaceArtifacts(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync (+13 more)
...
Cohesion: 0.17
Nodes (15): buildMergeSetForIssue(), getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), resolveProjectReposFromResolvedIssue() (+7 more)
...
Cohesion: 0.2
Nodes (17): APP_DIR, configureWorkspaceForBot(), generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken(), githubApi() (+9 more)

### Community 398 - "Community 398"
Cohesion: 0.19
Nodes (15): doneCommand(), execAsync, getForgeAdapter(), ensureMergeSetForIssue(), upsertMergeSet(), withRepoArtifactUrl(), withRepoState(), buildRichReviewArtifactBody() (+7 more)
...
Cohesion: 0.11
Nodes (14): ensureDefaultConversationModel(), DEFAULT_MODELS_BY_WORK_TYPE, buildMiniMaxFormData(), SettingsConfig, allModelIds, config, defaults, DEPRECATED_MODEL_IDS (+6 more)
...
Cohesion: 0.17
Nodes (12): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveWindowUrl(), ROOT_DIR (+4 more)
...
Cohesion: 0.29
Nodes (13): startPostLaunchSidecars(), startSidecars(), readPlatformConfig(), getSupervisorPort(), getSupervisorUrl(), isProcessAlive(), isSupervisorRunning(), readSupervisorPid() (+5 more)
...
Cohesion: 0.27
Nodes (8): dispatchMenuAction(), showOrCreateWindow(), buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, onUpdateStatusChange()
...
Cohesion: 0.29
Nodes (6): colNames, cols, columns, db, row, stuckCol
...
## Knowledge Gaps
- **11469 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11464 more)
...
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 134`, `Community 264`, `Community 8`, `Community 524`, `Community 13`, `Community 397`, `Community 141`, `Community 272`, `Community 16`, `Community 18`, `Community 20`, `Community 23`, `Community 152`, `Community 24`, `Community 28`, `Community 30`, `Community 33`, `Community 553`, `Community 43`, `Community 44`, `Community 52`, `Community 181`, `Community 54`, `Community 57`, `Community 187`, `Community 64`, `Community 65`, `Community 589`, `Community 590`, `Community 593`, `Community 83`, `Community 105`, `Community 752`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 126` to `Community 9`, `Community 10`, `Community 59`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `useDashboardStore` connect `Community 1` to `Community 2`, `Community 3`, `Community 36`, `Community 4`, `Community 166`, `Community 265`, `Community 10`, `Community 47`, `Community 83`, `Community 20`, `Community 154`, `Community 28`, `Community 127`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11469 weakly-connected nodes found - possible documentation gaps or missing edges._
