# Graph Report - feature-pan-1170  (2026-05-18)

## Corpus Check
- 1742 files · ~2,323,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23873 nodes · 36561 edges · 1223 communities (1174 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 509 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5273e5c6`
...
## Communities (1223 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (135): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+127 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (140): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+132 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (128): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+120 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (147): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (106): PlanningState, ZoneAActionsState, DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost() (+98 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (130): monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription() (+122 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (94): parsePiSession(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, agentState, callOrder, checkFn (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (114): checkApiErrorAgents(), checkMissingReviewStatuses(), cleanupOrphanedReviewSessions(), dropLingeringPreMergeStashes(), postMergeLifecycle(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash() (+106 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (93): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+85 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (101): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+93 more)
...
Cohesion: 0.03
Nodes (80): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext (+72 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (86): importTrackerConfig(), AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+78 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (88): checkStuckReviewing(), buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation() (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (92): dequeueMerge(), execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody() (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (83): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+75 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (78): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails (+70 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (90): agentDir, dir1, dir2, marker, missing, nested, invalidateAgentsCache(), cb (+82 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (63): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, { projectPath, workspacePath }, promoted, specFiles, doc, path (+55 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (79): closeOutCommand(), CloseOutOptions, getGitHubConfig(), listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand() (+71 more)
...
Cohesion: 0.03
Nodes (74): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+66 more)
...
Cohesion: 0.03
Nodes (70): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, CostEvent, CostStreamResponse, fetchCostStream(), useCostStream() (+62 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (66): existingSkillDir, existsInTarget, mockClaudeSkills, mockPanopticonSkills, nonSkillDir, skillDir, skills, skillsToSync (+58 more)
...
Cohesion: 0.04
Nodes (68): copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions, SummaryForkResult (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (66): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (64): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+56 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (59): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+51 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (62): getNoResumeMode(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, { activeSessions }, agentDir, fortyMinutesAgo, twentyMinutesAgo, result (+54 more)
...
Cohesion: 0.05
Nodes (65): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), readWorkspaceContinue(), readWorkspaceContinueAsync(), uniqueTmpPath(), validateWorkspaceContinueState() (+57 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (50): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, BUCKET_STAGES, BucketedFeature, bucketFeature(), CostBadge() (+42 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (61): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+53 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (69): updateTtsConfig(), { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, clearConfigCache() (+61 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (62): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, ensureExcalidrawMcp(), ensurePlaywrightIsolation() (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (59): AgentRuntimeState, execAsync, pending, withBdMutex(), withWorkspaceBdMutex(), agentsCache, AgentStartGateDecision, buildAgentControlEventPayload() (+51 more)
...
Cohesion: 0.06
Nodes (59): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), clearStuckForks() (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (58): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), ensureLogDir() (+50 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (61): defaults, first, { models }, second, ModelRef, RoleConfig, WorkhorsesConfig, WorkhorseSlot (+53 more)
...
Cohesion: 0.06
Nodes (52): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+44 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (54): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+46 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (53): DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, ghCliIssue, githubApiIssue, githubOpenIssue (+45 more)
...
Cohesion: 0.05
Nodes (49): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostLimitsConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+41 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (52): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), confirmHostOverride() (+44 more)
...
Cohesion: 0.05
Nodes (49): showAction(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy(), arrayIndexCondition(), ArrayIndexTarget, buildFilterSql(), CosineSearchResult, cosineSimilarity() (+41 more)
...
Cohesion: 0.06
Nodes (41): sentinel, markAgentStateServiceInProcess(), emitReactiveLifecycleEvent(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore() (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (40): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+32 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (40): ConversationPanel(), ConversationPanelProps, ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS, resumeConversation() (+32 more)
...
Cohesion: 0.06
Nodes (49): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (50): acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonAuthToken() (+42 more)
...
Cohesion: 0.07
Nodes (38): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (43): agentDir, missing, snapshot, status, AgentEnrichment, discoverNewAgentIds(), Jsonish, ReadModelServiceShape (+35 more)
...
Cohesion: 0.07
Nodes (41): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+33 more)
...
Cohesion: 0.06
Nodes (46): Access, readLogTail(), buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), getIndexStats(), getIndexStats() (+38 more)
...
Cohesion: 0.08
Nodes (38): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, resolveBundledServerPath() (+30 more)
...
Cohesion: 0.05
Nodes (39): CheckTtsHealthOptions, clearTtsVoices(), createTtsVoice(), CreateTtsVoiceInput, deleteTtsVoiceRoute, deleteTtsVoicesRoute, ExtractEmbeddingDeps, ExtractEmbeddingInput (+31 more)
...
Cohesion: 0.11
Nodes (38): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+30 more)
...
Cohesion: 0.06
Nodes (27): TurnDiffSummary, DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+19 more)
...
Cohesion: 0.05
Nodes (43): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+35 more)
...
Cohesion: 0.09
Nodes (29): build_voice_clone_prompt(), _close_player(), _ensure_player(), _extract_audio(), _get_default_sink_state(), Handler, load_base_model(), load_design_model() (+21 more)
...
Cohesion: 0.09
Nodes (36): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+28 more)
...
Cohesion: 0.1
Nodes (35): DashboardBundleCandidate, dashboardBundleCandidates(), recordRestartStatus(), reportHeldRestartLock(), resolveNode22(), resolveScope(), restartCommand(), RestartOptions (+27 more)
...
Cohesion: 0.11
Nodes (30): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+22 more)
...
Cohesion: 0.08
Nodes (32): buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis(), parseGitHubPrUrl(), postPrComment() (+24 more)
...
Cohesion: 0.09
Nodes (32): cosineSimilarity(), RawFilter, SearchMode, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), countFtsSessions(), DiscoveredSession (+24 more)

### Community 157 - "Community 157"
Cohesion: 0.09
Nodes (34): embedAction(), ScanOptions, SearchQuery, countDiscoveredSessions(), getDiscoveredStats(), embedSessions(), EnrichOptions, aggregateDiscoveredSessionCostByPayload() (+26 more)
...
Cohesion: 0.08
Nodes (28): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ENV_KEYS, EnvSnapshot, getIssueDataService(), getIssueDataService(), ServerConfig, ServerConfigError (+20 more)
...
Cohesion: 0.08
Nodes (33): applyTierAwareFallback(), detectEnabledProviders(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModels(), getAvailableModels(), getBestAnthropicAtTier() (+25 more)
...
Cohesion: 0.09
Nodes (25): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), captureTldrMetrics() (+17 more)
...
Cohesion: 0.09
Nodes (27): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), ProjectConfig (+19 more)

### Community 184 - "Community 184"
Cohesion: 0.1
Nodes (30): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, defaultThresholds(), ensureResourceConfigLoaded() (+22 more)
...
Cohesion: 0.09
Nodes (27): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+19 more)

### Community 187 - "Community 187"
Cohesion: 0.06
Nodes (33): ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer, EmbedBodySchema, EmbedResponseSchema, EnrichBodySchema (+25 more)
...
Cohesion: 0.11
Nodes (28): isNoResumeValueEnabled(), formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow(), isBootNoResumeModeActive(), issueKey() (+20 more)

### Community 200 - "Community 200"
Cohesion: 0.07
Nodes (30): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, corruptLines (+22 more)
...
Cohesion: 0.11
Nodes (25): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+17 more)
...
Cohesion: 0.12
Nodes (24): scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+16 more)
...
Cohesion: 0.08
Nodes (19): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller (+11 more)
...
Cohesion: 0.14
Nodes (23): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, findWorkspacePath(), extractNumber(), extractPrefix() (+15 more)

### Community 262 - "Community 262"
Cohesion: 0.12
Nodes (24): clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent(), sendFeedbackToAgent() (+16 more)
...
Cohesion: 0.12
Nodes (26): ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync, fetchActivityData() (+18 more)
...
Cohesion: 0.08
Nodes (23): insertEmbedding(), a, b, bestOlderMatch, chalk, day, emb, expected (+15 more)
...
Cohesion: 0.16
Nodes (22): validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardSessionCookieHeader(), getDashboardSessionToken(), getHeader(), hasDashboardAuth(), hasDashboardAuthHeaders() (+14 more)
...
Cohesion: 0.18
Nodes (20): healthCommand(), HealthOptions, pendingCommand(), listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+12 more)
...
Cohesion: 0.1
Nodes (19): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+11 more)
...
Cohesion: 0.17
Nodes (18): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), clearPendingCodexReauthSession() (+10 more)
...
Cohesion: 0.1
Nodes (19): agentDir, body, dir, launcher, LEGACY_FIELDS, legacyFields, options, piFifoMocks (+11 more)
...
Cohesion: 0.13
Nodes (15): EventRouter(), EDITOR_LABELS, PanOpenInPickerProps, CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize() (+7 more)

### Community 396 - "Community 396"
Cohesion: 0.11
Nodes (18): ProviderCard(), PROVIDER_INFO, ProviderPanelProps, ApiKeysConfig, DeprecationWarning, Harness, ModelRef, ModelsConfig (+10 more)
...
Cohesion: 0.13
Nodes (17): fetchCost(), fetchSearch(), fetchSessions(), fetchStats(), fetchWorkspaceCost(), triggerScan(), CostThresholdDetails, embedSession() (+9 more)
...
Cohesion: 0.12
Nodes (13): issues, result, getCachedPlanningState(), getCanonicalStatus(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES, planningStateCache, PlanningStateCacheEntry (+5 more)
...
Cohesion: 0.22
Nodes (13): buildCorrelationMap(), CorrelationResult, sessionFilePath(), buildContinuation(), convertConversationTranscript(), ConvertOptions, ConvertResult, extractClaudeTranscript() (+5 more)
...
Cohesion: 0.21
Nodes (11): DEACON_PAUSE_QUERY_KEY, DeaconPauseBanner(), DeaconPauseToggle(), useDeaconPause(), useDeaconPauseMutation(), formatAge(), FreshnessIndicator(), Tab (+3 more)
...
Cohesion: 0.18
Nodes (5): NormalizedTtsDaemonConfig, TtsWatchdog, log, mocks, watchdog
...
Cohesion: 0.28
Nodes (7): buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result
...
Cohesion: 0.29
Nodes (7): CACHE_DB_PATH, CacheEntry, DEFAULT_TTLS, L1Entry, openSqliteDb(), RateLimitInfo, _require
...
## Knowledge Gaps
- **12424 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12419 more)
...
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 515`, `Community 134`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 144`, `Community 18`, `Community 657`, `Community 276`, `Community 22`, `Community 23`, `Community 24`, `Community 27`, `Community 156`, `Community 34`, `Community 39`, `Community 424`, `Community 298`, `Community 43`, `Community 302`, `Community 47`, `Community 818`, `Community 50`, `Community 55`, `Community 696`, `Community 56`, `Community 186`, `Community 57`, `Community 60`, `Community 700`, `Community 443`, `Community 697`, `Community 58`, `Community 66`, `Community 67`, `Community 197`, `Community 199`, `Community 970`, `Community 587`, `Community 588`, `Community 204`, `Community 462`, `Community 80`, `Community 219`, `Community 221`, `Community 355`, `Community 228`, `Community 105`, `Community 619`, `Community 119`, `Community 120`, `Community 124`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 7` to `Community 96`, `Community 1`, `Community 3`, `Community 324`, `Community 5`, `Community 261`, `Community 9`, `Community 105`, `Community 46`, `Community 15`, `Community 14`, `Community 146`, `Community 148`, `Community 53`, `Community 20`, `Community 25`, `Community 379`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 18` to `Community 32`, `Community 9`, `Community 10`, `Community 299`, `Community 654`, `Community 14`, `Community 50`, `Community 278`, `Community 87`, `Community 54`, `Community 29`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12424 weakly-connected nodes found - possible documentation gaps or missing edges._
