...
## Corpus Check
- 1878 files · ~2,476,798 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26664 nodes · 41396 edges · 1251 communities (1201 shown, 50 thin omitted)
...
## Communities (1251 total, 50 thin omitted)
...
Cohesion: 0.03
Nodes (201): checkThinkingSignatureCorruption(), cleanupOrphanedPlanningSessions(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions (+193 more)
...
Cohesion: 0.02
Nodes (140): BootstrapGate(), BootstrapGateProps, callApi(), CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, PaletteAction (+132 more)
...
Cohesion: 0.03
Nodes (126): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+118 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (119): TurnDiffFileChange, forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset() (+111 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (103): BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+95 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (105): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+97 more)
...
Cohesion: 0.03
Nodes (101): printActiveSliceForIssue(), uniqueTmpPath(), writeWorkspaceContinue(), annotated, before, candidate, check, claimed (+93 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (77): parsePiSession(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntime(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+69 more)
...
Cohesion: 0.03
Nodes (89): AgentRuntimeState, agentsCache, AgentStartGateDecision, buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), deleteAgentRoute, EMPTY_CONVERSATION, evaluateAgentStartGate() (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (69): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps (+61 more)
...
Cohesion: 0.03
Nodes (69): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+61 more)
...
Cohesion: 0.03
Nodes (74): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+66 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (75): buildPolyrepoContext(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand() (+67 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (80): killPostMergeRoleSessions(), listSessionNamesAsync(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId() (+72 more)
...
Cohesion: 0.04
Nodes (81): postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+73 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (73): checkHeartbeat(), checkStuckReviewing(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+65 more)
...
Cohesion: 0.04
Nodes (62): buildConvoyPrompt(), buildReviewRolePrompt(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions(), readConvoySubRoleTemplate() (+54 more)
...
Cohesion: 0.06
Nodes (61): deriveProjectRoot(), buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocumentFromString() (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (61): SwitchModelModal(), SwitchModelModalProps, VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, ActionKey, ActionLayout, derivePipelineState() (+53 more)
...
Cohesion: 0.05
Nodes (53): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), RestartLockError, RestartLockHandle (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (46): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+38 more)
...
Cohesion: 0.03
Nodes (50): DrawerActivityRail(), DrawerBeadsList(), DrawerReviewSpecialists(), createQueryClient(), drawerUi(), fetchMock, first, issue (+42 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (50): AGENTS_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_RULES_DIR, CERTS_DIR, CLAUDE_DIR (+42 more)
...
Cohesion: 0.06
Nodes (54): buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+46 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (50): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+42 more)
...
Cohesion: 0.06
Nodes (27): issues, result, importTrackerConfig(), findProjectsByRallyProject(), loadReviewStatusesForIssues(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus() (+19 more)
...
Cohesion: 0.04
Nodes (52): DatabaseError, cleanupOldEntries(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), getQueueForProject(), markMergeProcessing(), MergeQueueEntry (+44 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (55): Access, listSessionNamesAsyncEffect(), getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+47 more)
...
Cohesion: 0.05
Nodes (45): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailed(), AgentEnrichment, withConcurrencyLimit(), Handler, PipelineEvent, setPipelineHandler() (+37 more)
...
Cohesion: 0.06
Nodes (50): AIProvider, encodeClaudeProjectDir(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), pathExists(), pickFreshestSessionId(), readOptional() (+42 more)

### Community 95 - "Community 95"
Cohesion: 0.05
Nodes (41): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), recoverUnhealthyTestStack() (+33 more)
...
Cohesion: 0.05
Nodes (47): archiveConversation(), favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, CloisterStatusBar(), DashboardSettings (+39 more)
...
Cohesion: 0.04
Nodes (36): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), StandaloneTerminal(), StandaloneTerminalProps (+28 more)
...
Cohesion: 0.06
Nodes (22): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, createGoogleCloudTranscription() (+14 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (40): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId(), getRecentRunLogs(), getRunLog() (+32 more)
...
Cohesion: 0.06
Nodes (37): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getRecentSessions(), getSessionFiles(), importSessionToCostLog(), normalizeModelName(), parseAllSessions() (+29 more)

### Community 117 - "Community 117"
Cohesion: 0.11
Nodes (46): extractNumber(), extractPrefix(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+38 more)
...
Cohesion: 0.07
Nodes (38): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+30 more)

### Community 123 - "Community 123"
Cohesion: 0.06
Nodes (41): agentDir, missing, snapshot, status, discoverNewAgentIds(), Jsonish, ReviewStatusSnapshotInput, shouldSkipCheckpointReconciliation() (+33 more)
...
Cohesion: 0.07
Nodes (40): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+32 more)
...
Cohesion: 0.05
Nodes (32): SearchResult, RuntimeConversationsConfig, ReadModelServiceShape, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput (+24 more)
...
Cohesion: 0.08
Nodes (39): doCommit(), flushAutoCommits(), flushInner(), flushPromise(), FlushResult, GitResult, pending, queueAutoCommit() (+31 more)
...
Cohesion: 0.06
Nodes (30): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+22 more)
...
Cohesion: 0.07
Nodes (25): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, ConversationsConfig (+17 more)
...
Cohesion: 0.12
Nodes (25): buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+17 more)
...
Cohesion: 0.11
Nodes (17): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, findWorkspacePath(), canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere() (+9 more)
...
Cohesion: 0.13
Nodes (16): DEFAULT_VOICE_SETTINGS, getVoiceSettingsRoute, isVoiceSettings(), loadVoiceSettings(), normalizeVoiceSettings(), putVoiceSettingsRoute, readJsonBody, requireTrustedOrigin() (+8 more)
...
Cohesion: 0.19
Nodes (19): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), isDockerContainerProcess(), killOrphanedProcesses(), killOrphanedProcessesImpl() (+11 more)
...
- **Why does `fetch` connect `Community 98` to `Community 2`, `Community 3`, `Community 518`, `Community 7`, `Community 264`, `Community 8`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 277`, `Community 278`, `Community 149`, `Community 23`, `Community 24`, `Community 26`, `Community 25`, `Community 151`, `Community 30`, `Community 1057`, `Community 1058`, `Community 37`, `Community 39`, `Community 40`, `Community 169`, `Community 170`, `Community 683`, `Community 171`, `Community 45`, `Community 684`, `Community 167`, `Community 305`, `Community 436`, `Community 55`, `Community 568`, `Community 56`, `Community 58`, `Community 60`, `Community 66`, `Community 67`, `Community 68`, `Community 454`, `Community 455`, `Community 327`, `Community 76`, `Community 335`, `Community 336`, `Community 208`, `Community 210`, `Community 87`, `Community 216`, `Community 729`, `Community 89`, `Community 93`, `Community 355`, `Community 1124`, `Community 99`, `Community 102`, `Community 1123`, `Community 617`, `Community 236`, `Community 108`, `Community 239`, `Community 381`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 23` to `Community 160`, `Community 97`, `Community 161`, `Community 130`, `Community 3`, `Community 68`, `Community 42`, `Community 10`, `Community 843`, `Community 22`, `Community 215`, `Community 25`, `Community 538`, `Community 28`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `FsError` connect `Community 125` to `Community 640`, `Community 1`, `Community 2`, `Community 6`, `Community 266`, `Community 267`, `Community 11`, `Community 141`, `Community 15`, `Community 271`, `Community 278`, `Community 150`, `Community 25`, `Community 538`, `Community 27`, `Community 544`, `Community 34`, `Community 420`, `Community 168`, `Community 169`, `Community 42`, `Community 171`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 181`, `Community 438`, `Community 189`, `Community 190`, `Community 575`, `Community 450`, `Community 451`, `Community 69`, `Community 72`, `Community 456`, `Community 75`, `Community 332`, `Community 331`, `Community 333`, `Community 82`, `Community 466`, `Community 468`, `Community 469`, `Community 86`, `Community 87`, `Community 214`, `Community 95`, `Community 96`, `Community 226`, `Community 106`, `Community 494`, `Community 111`, `Community 116`, `Community 246`, `Community 379`, `Community 124`, `Community 255`?**
