...
## Corpus Check
- 1743 files · ~2,324,881 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23871 nodes · 36558 edges · 1201 communities (1151 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 509 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0384327a`
...
## Communities (1201 total, 50 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (199): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+191 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (155): PlanningState, ZoneAActionsState, BeadsDialog(), BeadsDialogProps, BeadsResponse, BeadTask, DeepWipeDialogProps, DeepWipeProgress (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (159): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+151 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (141): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (157): checkThinkingSignatureCorruption(), monitorReviewConvoySignals(), nudgeIdleWorkAgentsWithOpenBeads(), buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename (+149 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (121): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+113 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (115): buildMergeAgentMemory(), checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord, needsSessionRotation(), rotateSpecialistSession() (+107 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (131): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateSummaryForFork() (+123 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (121): closeOutCommand(), CloseOutOptions, getGitHubConfig(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions (+113 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (103): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, CostEvent, CostStreamResponse, fetchCostStream() (+95 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (113): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+105 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (106): ensureDefaultConversationModel(), CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn() (+98 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (91): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks(), ArtifactLinksProps, AlertOptions (+83 more)
...
Cohesion: 0.02
Nodes (91): EventRouter(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse (+83 more)
...
Cohesion: 0.04
Nodes (98): buildCorrelationMap(), CorrelationResult, embedAction(), scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir() (+90 more)
...
Cohesion: 0.04
Nodes (91): getTrackerContext(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand() (+83 more)
...
Cohesion: 0.03
Nodes (91): defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig, TtsDaemonConfig (+83 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (82): after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb(), getHistoryFromDb() (+74 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (72): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (76): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin(), resetRoute (+68 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (75): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue() (+67 more)
...
Cohesion: 0.04
Nodes (60): { projectPath, workspacePath }, promoted, specFiles, fsHooks, first, found, path, paths (+52 more)
...
Cohesion: 0.04
Nodes (62): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+54 more)
...
Cohesion: 0.05
Nodes (61): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), findSpecByIssueAsync(), completePlanningArtifacts(), readWorkspacePlanAsync() (+53 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (55): importTrackerConfig(), getGitHubClient(), GitHubClient, GitHubClientLive, GitHubClientOptionalLive, GitHubClientShape, GitHubComment, GitHubIssue (+47 more)
...
Cohesion: 0.05
Nodes (56): DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR, FEEDBACK_LOG (+48 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (52): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), planCommand(), PlanOptions, DASHBOARD_URL (+44 more)
...
Cohesion: 0.06
Nodes (53): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+45 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (57): checkMissingReviewStatuses(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), execAsync, isReviewSessionForIssue(), killAllReviewerSessions(), killAllReviewSessions() (+49 more)
...
Cohesion: 0.05
Nodes (50): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, HandoffContext (+42 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (56): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), finalizeRunLog(), generateRunId() (+48 more)
...
Cohesion: 0.06
Nodes (52): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+44 more)
...
Cohesion: 0.07
Nodes (44): buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+36 more)
...
Cohesion: 0.04
Nodes (49): buildEmbeddingText(), embed(), EmbeddingProviderName, EmbeddingResult, embedOllama(), embedOpenAI(), EmbedOptions, embedVoyage() (+41 more)
...
Cohesion: 0.08
Nodes (44): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+36 more)
...
Cohesion: 0.06
Nodes (45): Access, buildConversationResponse(), readBridgedCodexCredential(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats() (+37 more)
...
Cohesion: 0.06
Nodes (38): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG, getHealthThresholdsMs() (+30 more)
...
Cohesion: 0.09
Nodes (40): dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind, createNamedStash(), createRecoveryBranchFromStash(), dropStash() (+32 more)
...
Cohesion: 0.05
Nodes (42): Activity, AgentChannelReply, AgentId, AgentResolution, AgentRuntimeSnapshot, AgentSnapshot, CHANNEL_REPLY_KIND_VALUES, ChannelPermissionRequestSnapshot (+34 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (21): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+13 more)
...
Cohesion: 0.08
Nodes (33): evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji() (+25 more)
...
Cohesion: 0.13
Nodes (36): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, calls, ctx, mockClientCreateIssueLabel (+28 more)
...
Cohesion: 0.12
Nodes (34): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+26 more)
...
Cohesion: 0.08
Nodes (28): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, API_ERROR_PATTERNS, buildReviewerNodes(), BuildReviewerNodesOptions (+20 more)
...
Cohesion: 0.12
Nodes (26): acquireRestartLock(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder(), RestartLockHolder (+18 more)
...
Cohesion: 0.08
Nodes (20): SearchResult, RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, getProjectIssuePrefixes(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName() (+12 more)

### Community 219 - "Community 219"
Cohesion: 0.14
Nodes (28): createCostCommand(), formatIssueCostAggregate(), aggregate, output, IssueAggregate, AIProvider, BUDGETS_FILE, checkBudget() (+20 more)

### Community 220 - "Community 220"
Cohesion: 0.08
Nodes (22): sentinel, markAgentStateServiceInProcess(), EventRow, EventStore, EventSubscriber, getSharedDb(), initEventStore(), openEventDb() (+14 more)
...
Cohesion: 0.13
Nodes (15): countContextTokens(), findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions() (+7 more)
...
Cohesion: 0.14
Nodes (22): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+14 more)
...
Cohesion: 0.13
Nodes (21): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), getIssueDataService(), attachmentCleanupTimer, buildAgentStatusChangedPayload(), emitShutdownActivity(), es, handleShutdownSignal() (+13 more)
...
Cohesion: 0.25
Nodes (16): startPostLaunchSidecars(), startSidecars(), recordRestartStatus(), reportHeldRestartLock(), restartCommand(), runFullRestart(), getSupervisorPort(), getSupervisorUrl() (+8 more)
...
Cohesion: 0.33
Nodes (10): checkCliproxyPortAsync(), execAsync, getCliproxyPidPath(), isCliproxyRunning(), isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), stopCliproxy() (+2 more)
...
## Knowledge Gaps
- **12423 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12418 more)
...
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 3`, `Community 5`, `Community 9`, `Community 11`, `Community 268`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 529`, `Community 18`, `Community 22`, `Community 23`, `Community 406`, `Community 26`, `Community 27`, `Community 30`, `Community 160`, `Community 802`, `Community 35`, `Community 40`, `Community 169`, `Community 682`, `Community 42`, `Community 680`, `Community 47`, `Community 691`, `Community 53`, `Community 949`, `Community 55`, `Community 184`, `Community 186`, `Community 59`, `Community 570`, `Community 61`, `Community 62`, `Community 63`, `Community 58`, `Community 196`, `Community 68`, `Community 200`, `Community 81`, `Community 597`, `Community 220`, `Community 235`, `Community 236`, `Community 111`, `Community 117`, `Community 246`, `Community 118`, `Community 633`, `Community 634`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 0` to `Community 98`, `Community 2`, `Community 4`, `Community 197`, `Community 13`, `Community 686`, `Community 46`, `Community 143`, `Community 19`, `Community 20`, `Community 152`, `Community 25`, `Community 26`, `Community 124`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 27` to `Community 288`, `Community 36`, `Community 389`, `Community 525`, `Community 14`, `Community 13`, `Community 80`, `Community 20`, `Community 56`, `Community 28`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12423 weakly-connected nodes found - possible documentation gaps or missing edges._
