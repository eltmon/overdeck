...
## Corpus Check
- 1542 files · ~2,037,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21778 nodes · 32354 edges · 1132 communities (1098 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 435 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a96104fa`
...
## Communities (1132 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (134): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, formatCost() (+126 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (157): autoResumeStoppedWorkAgents(), checkStuckWorkAgents(), checkThinkingSignatureCorruption(), isAgentIdleForNudge(), nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName() (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (142): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput() (+134 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (115): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+107 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (108): BeadsTask, COMPLEXITY_KEYWORDS, COMPLEXITY_LABELS, ComplexityDetectionResult, ComplexityLevel, complexityToModel(), detectComplexity(), detectComplexityFromEstimate() (+100 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (120): checkStuckReviewing(), renderPrompt(), getActiveParallelReviewIssues(), buildMergeAgentMemory(), execAsync, MemoryTiers, MergeRecord, rotateSpecialistSession() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (117): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), DEFAULT_REVIEW_AGENTS, dispatchParallelReview(), execAsync (+109 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (87): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps (+79 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (96): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+88 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (70): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffContext, HandoffResult, createHandoffEvent() (+62 more)
...
Cohesion: 0.03
Nodes (104): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents(), checkFailedMergeRetry() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (91): agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+83 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (77): firstSessionPanel, firstWorkbench, workbench, ConversationList(), DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs() (+69 more)
...
Cohesion: 0.03
Nodes (87): BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), execFile(), kCustom, mockExecFile (+79 more)
...
Cohesion: 0.03
Nodes (78): setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH, _statusData (+70 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (76): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, PlanDialog() (+68 more)
...
Cohesion: 0.04
Nodes (61): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, FailedMessage (+53 more)
...
Cohesion: 0.03
Nodes (63): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (65): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (54): generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE, RouterConfig, RouterRule, getDebugInfo(), getGlobalRouter() (+46 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (61): findSpecByIssue(), updateSpecStatus(), next, path, read, state, after, continueContent (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (60): checkOrphanedReviewStatuses(), checkPendingTestDispatch(), err, exec(), execFile(), execMock, kCustom, prompt (+52 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (58): buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+50 more)
...
Cohesion: 0.06
Nodes (57): hookCommand(), HookOptions, activeViolations, checkAgentForViolations(), clearOldViolations(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig (+49 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (43): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, beadsDir, doc (+35 more)
...
Cohesion: 0.06
Nodes (51): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+43 more)
...
Cohesion: 0.04
Nodes (55): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+47 more)
...
Cohesion: 0.07
Nodes (54): calls, { mockExecAsync }, opts, applyClosedOutLabel(), applyLabelGitHub(), applyLabelLinear(), applyLabelViaTracker(), closeGitHubDirect() (+46 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (49): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), computePlanningState(), badPath, customPlanningDir, dir (+41 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (48): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+40 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (47): parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, withConcurrencyLimit(), result, ActivityContext, buildIssueTitleMap(), collectSessionTreeNodes() (+39 more)
...
Cohesion: 0.05
Nodes (47): ALL_TABS, OverviewTabSpec, ZoneCOverview(), ZoneCOverviewProps, BeadsTasksPanel(), CostEvent, CostStreamResponse, fetchCostStream() (+39 more)
...
Cohesion: 0.06
Nodes (49): Access, getIssueDataService(), ActivityContext, closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+41 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (41): abortReviewCommand(), DASHBOARD_URL, DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse, DASHBOARD_URL, resetReviewCommand(), ResetReviewOptions (+33 more)
...
Cohesion: 0.04
Nodes (42): listConversations(), MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, getClientIp(), getConversationDiffFullRoute (+34 more)
...
Cohesion: 0.06
Nodes (41): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse (+33 more)
...
Cohesion: 0.06
Nodes (33): getModelCapability(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults(), getSimpleModelMapping(), ModelSelectionResult (+25 more)
...
Cohesion: 0.05
Nodes (31): buildMenuTemplate(), callServerApi(), configureApplicationMenu(), currentStatus, DEFAULTS, electron, electron_updater, fetchActiveWorkspaces() (+23 more)
...
Cohesion: 0.09
Nodes (37): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec() (+29 more)
...
Cohesion: 0.07
Nodes (33): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRow() (+25 more)
...
Cohesion: 0.07
Nodes (37): agentDir, missing, result, snapshot, status, AgentEnrichment, discoverNewAgentIds(), ReadModelServiceShape (+29 more)
...
Cohesion: 0.1
Nodes (35): destroyRemoteWorkspace(), createFlyProvider(), FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, getRemoteProvider(), isRemoteAvailable() (+27 more)
...
Cohesion: 0.07
Nodes (27): createClaudeCodeRuntime(), getGlobalRegistry(), getRuntime(), RuntimeRegistry, setGlobalRegistry(), createPiRuntime(), PiSpawnTimeout, RuntimeName (+19 more)
...
Cohesion: 0.1
Nodes (33): AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR (+25 more)
...
Cohesion: 0.09
Nodes (29): cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildSyncFailureFeedback() (+21 more)
...
Cohesion: 0.08
Nodes (25): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+17 more)

### Community 173 - "Community 173"
Cohesion: 0.1
Nodes (30): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+22 more)
...
Cohesion: 0.09
Nodes (30): buildConversationResponse(), getCachedMessages(), validateCwdContainment(), stat, activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock (+22 more)
...
Cohesion: 0.07
Nodes (26): checkAndRotateIfNeeded(), DEFAULT_MEMORY_TIERS, needsSessionRotation(), exec(), execMock, kCustom, mockGetAgentState, mockGetRuntimeForAgent (+18 more)
...
Cohesion: 0.13
Nodes (13): findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModel(), getAllSessionFiles(), getProjectDirs(), getRecentSessions(), getSessionFiles() (+5 more)
...
Cohesion: 0.07
Nodes (26): agentDir, envArg, options, state, stateFile, workspace, anthropicModel, anthropicRouter (+18 more)
...
Cohesion: 0.14
Nodes (27): Conversation, listActiveConversations(), markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), extractConversationAttachmentPaths() (+19 more)
...
Cohesion: 0.24
Nodes (24): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+16 more)
...
Cohesion: 0.16
Nodes (23): listTestsCommand(), registerTestCommands(), runCommand(), RunOptions, deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft() (+15 more)
...
Cohesion: 0.14
Nodes (21): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+13 more)
...
Cohesion: 0.17
Nodes (17): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+9 more)

### Community 361 - "Community 361"
Cohesion: 0.17
Nodes (16): closeOutCommand(), CloseOutOptions, getGitHubConfig(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam() (+8 more)
...
Cohesion: 0.13
Nodes (17): AgentDetailView(), AgentDetailViewProps, AgentHealthHistory, fetchHealthHistory(), fetchSpecialists(), formatDuration(), formatTokens(), HEALTH_STATE_EMOJI (+9 more)
...
Cohesion: 0.27
Nodes (11): dispatchMenuAction(), showOrCreateWindow(), AgentStatus, buildContextMenu(), buildTooltip(), createTray(), createTrayIcon(), destroyTray() (+3 more)
...
Cohesion: 0.27
Nodes (11): activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings(), isCompacting(), maybeCompactBeforeRespawn() (+3 more)
...
Cohesion: 0.36
Nodes (10): checkOpenBeads(), checkUncommittedChanges(), checkVBriefACStatus(), errorCode(), execAsync, execFileAsync, isMissingCommand(), isTimeout() (+2 more)
...
## Knowledge Gaps
- **11596 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11591 more)
...
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 6`, `Community 7`, `Community 520`, `Community 10`, `Community 267`, `Community 140`, `Community 13`, `Community 14`, `Community 15`, `Community 141`, `Community 138`, `Community 18`, `Community 275`, `Community 148`, `Community 21`, `Community 22`, `Community 19`, `Community 23`, `Community 156`, `Community 413`, `Community 542`, `Community 543`, `Community 800`, `Community 35`, `Community 163`, `Community 37`, `Community 549`, `Community 41`, `Community 43`, `Community 172`, `Community 50`, `Community 51`, `Community 52`, `Community 56`, `Community 60`, `Community 61`, `Community 62`, `Community 65`, `Community 78`, `Community 80`, `Community 84`, `Community 86`, `Community 87`, `Community 217`, `Community 99`, `Community 745`, `Community 630`, `Community 380`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 4` to `Community 1`, `Community 14`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 34` to `Community 548`, `Community 358`, `Community 586`, `Community 46`, `Community 16`, `Community 29`, `Community 86`, `Community 92`, `Community 61`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11596 weakly-connected nodes found - possible documentation gaps or missing edges._
