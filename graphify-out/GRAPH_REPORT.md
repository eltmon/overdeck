...
## Corpus Check
- 1934 files · ~3,152,625 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27578 nodes · 43310 edges · 1306 communities (1250 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 801 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf9eafa0`
...
## Communities (1306 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (224): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+216 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (198): buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoffPromise() (+190 more)
...
Cohesion: 0.02
Nodes (163): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+155 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (127): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+119 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (122): buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync, isReviewSessionForIssue() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (110): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+102 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (92): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+84 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (96): cn(), Button, ButtonLink, SharedButtonBaseProps, SharedButtonLinkProps, SharedButtonProps, SharedButtonSize, SharedButtonVariant (+88 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (98): fetchConversations(), GeneralConversation, GeneralSectionProps, CloisterStatus, CloisterStatusBar(), DashboardSettings, emergencyStop(), fetchCloisterStatus() (+90 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (99): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ALL_TABS, OverviewTabSpec, ZoneCOverview() (+91 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (99): recordAutoCloseOutFailure(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailedSync(), emitActivityEntrySync() (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (98): queryCostEvents(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+90 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (100): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+92 more)
...
Cohesion: 0.02
Nodes (99): Platform, agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), createAgentStopHandler(), deleteAgentRoute (+91 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (80): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary (+72 more)
...
Cohesion: 0.04
Nodes (74): parsePiSessionSync(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync(), SessionIndexEntry, getGlobalRegistry(), getRuntime() (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (88): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), performHandoff() (+80 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (86): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+78 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (87): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions (+79 more)
...
Cohesion: 0.03
Nodes (79): rebuildCacheSync(), appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, eventsFileExists() (+71 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (68): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+60 more)
...
Cohesion: 0.03
Nodes (90): agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS, legacyFields (+82 more)
...
Cohesion: 0.04
Nodes (73): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (80): listPaneValues(), activeSwarmIssueIds, assertPathInside(), autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), canonicalIssueId(), clearAutoAdvanceFailureFields() (+72 more)
...
Cohesion: 0.03
Nodes (75): DEFAULTS, UIPreferences, useUIPreferences(), ProviderCard(), PROVIDER_INFO, ProviderPanelProps, DesktopSettings, DesktopSettingsSection() (+67 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (67): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+59 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (76): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin() (+68 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (71): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+63 more)
...
Cohesion: 0.04
Nodes (59): { projectPath, workspacePath }, promoted, specFiles, fsHooks, doc, items, path, paths (+51 more)
...
Cohesion: 0.05
Nodes (53): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+45 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (64): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+56 more)
...
Cohesion: 0.04
Nodes (69): buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, dropLingeringPreMergeStashes(), execAsync, __filename (+61 more)
...
Cohesion: 0.05
Nodes (66): BLANKED_PROVIDER_ENV, buildChildEnvSync(), buildChildEnvWithoutTmuxSync(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result (+58 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (60): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+52 more)
...
Cohesion: 0.05
Nodes (59): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+51 more)
...
Cohesion: 0.04
Nodes (53): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, deleteHumeConfig(), content, d, existingDir, lines (+45 more)
...
Cohesion: 0.04
Nodes (54): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), CostDonut(), CostDonutProps (+46 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (51): ComposerMode, IssueComposerProps, PlanningState, ZoneAActionsState, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, RestartResult (+43 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (36): EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate, MemoryHealthUpdateOptions, readMemoryHealth() (+28 more)
...
Cohesion: 0.03
Nodes (44): SETTINGS_FILE, getKimiAnthropicBaseUrl(), ProviderAuthType, ProviderName, generateRouterConfigFromWorkTypes(), Provider, ROUTER_CONFIG_DIR, ROUTER_CONFIG_FILE (+36 more)
...
Cohesion: 0.05
Nodes (57): buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback(), readPlanningContext() (+49 more)
...
Cohesion: 0.05
Nodes (57): closeMemoryFtsDatabases(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime() (+49 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (46): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+38 more)
...
Cohesion: 0.05
Nodes (55): getTrackerContext(), AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand() (+47 more)
...
Cohesion: 0.05
Nodes (51): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), parseClaudeSessionSync(), buildSessionIndex() (+43 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (59): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+51 more)

### Community 75 - "Community 75"
Cohesion: 0.04
Nodes (48): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+40 more)
...
Cohesion: 0.08
Nodes (60): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex() (+52 more)
...
Cohesion: 0.07
Nodes (56): addCommentBefore(), ALIAS, anchorIsValid(), atDocument(), callVisitor(), captureTldrMetricsSync(), clone(), constructor() (+48 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (42): buildACLookupByTitle(), criteria, doc, result, beadsDir, doc, AcceptanceCriterion, ACCompletionResult (+34 more)
...
Cohesion: 0.06
Nodes (23): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, setupVoiceWebSocket() (+15 more)
...
Cohesion: 0.07
Nodes (46): buildPolyrepoContext(), registerTestCommands(), runCommand(), RunOptions, addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+38 more)
...
Cohesion: 0.06
Nodes (42): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContextError, serializeHandoffContext() (+34 more)
...
Cohesion: 0.06
Nodes (44): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber() (+36 more)
...
Cohesion: 0.11
Nodes (47): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+39 more)
...
Cohesion: 0.08
Nodes (42): dashboardBundleMtimeMs(), parseHealthTimeout(), recordReloadStatus(), reloadCommand(), ReloadOptions, runBuild(), UsageError, DashboardBundleCandidate (+34 more)
...
Cohesion: 0.06
Nodes (38): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ActionKey (+30 more)

### Community 118 - "Community 118"
Cohesion: 0.06
Nodes (34): RestartLockHandle, allowedOrigin(), applyCors(), LOG_FILE, platformConfig, sendJson(), server, SUPERVISOR_PORT (+26 more)
...
Cohesion: 0.05
Nodes (31): ConversationTerminalProps, resumeConversation(), StandaloneTerminal(), StandaloneTerminalProps, SessionState, TerminalSessionWrapper(), TerminalSessionWrapperProps, ContextMenuState (+23 more)
...
Cohesion: 0.06
Nodes (33): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+25 more)
...
Cohesion: 0.09
Nodes (38): captureTmuxOutput(), isMergeAgentRunning(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+30 more)
...
Cohesion: 0.09
Nodes (39): embedAction(), SearchQuery, getSetting(), setSetting(), setSettingProgram(), getConversationByName(), aggregateDiscoveredSessionCost(), aggregateDiscoveredSessionCostBy() (+31 more)
...
Cohesion: 0.06
Nodes (25): evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill(), getAgentsToPoke(), getMultipleAgentHealth() (+17 more)
...
Cohesion: 0.13
Nodes (40): atLineEnd(), charAt(), compose(), continueScalar(), decorate(), end(), getErrorPos(), getLine() (+32 more)

### Community 172 - "Community 172"
Cohesion: 0.07
Nodes (35): scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget(), scan(), ScanMode (+27 more)
...
Cohesion: 0.05
Nodes (38): getConversationsConfig(), getConversationsConfigSync(), resolveConversationWatchDirs(), updateConversationsConfig(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema (+30 more)
...
Cohesion: 0.14
Nodes (30): GitHubApiError, LinearApiError, createTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig (+22 more)
...
Cohesion: 0.09
Nodes (29): forkCommand(), ForkOptions, buildCorrelationMapSync(), CorrelationResult, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork() (+21 more)
...
Cohesion: 0.09
Nodes (25): confirmCost(), enrichAction(), formatCost(), ConversationFilter, createConfiguredClaudeApi(), enrichSession(), EnrichSessionOptions, CostThresholdError (+17 more)
...
Cohesion: 0.14
Nodes (22): normalizeFilter(), SearchMode, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), arrayIndexCondition(), ArrayIndexTarget, buildFilterSql() (+14 more)
...
Cohesion: 0.15
Nodes (25): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), getPRDDraftPathSync(), hasPRDDraftPromise(), listPRDDrafts() (+17 more)
...
Cohesion: 0.13
Nodes (18): workspaceRebuildCommand(), StepResult, tempDirs, workspace, DevcontainerRenderResult, EnsureDevcontainerInput, EnsureDevcontainerResult, ensureDevcontainerSync() (+10 more)
...
Cohesion: 0.11
Nodes (16): ActionBar(), ActionBarProps, AgentTimeline(), AgentTimelineProps, TimelineEvent, TYPE_COLORS, BeadsKanban(), BeadsKanbanProps (+8 more)
...
Cohesion: 0.15
Nodes (13): after, before, blockers, result, statuses, clearReviewStatusSync(), DEFAULT_STATUS_FILE, getReviewStatusSync() (+5 more)
...
Cohesion: 0.11
Nodes (6): FlyApiClient, FlyApiError, client, fetchMock, machine, machines

### Community 430 - "Community 430"
Cohesion: 0.13
Nodes (9): wipeCommand(), WipeOptions, extractPrefixSync(), extractStandardNumberSync(), extractStandardPrefixSync(), normalizeIssueIdSync(), ParsedIssueId, parseIssueIdSync() (+1 more)
...
Cohesion: 0.13
Nodes (17): AgentHealth, checkAllTriggersPromise(), checkStuckEscalation(), checkTaskCompletion(), checkTaskCompletionPromise(), checkTestFailure(), detectTestFailure(), execAsync (+9 more)
...
Cohesion: 0.16
Nodes (16): DASHBOARD_LOG_FILE, describePid(), execAsync, isTraefikContainerRunningPromise(), killPidsSync(), pidsOnPort(), PlatformConfig, restartCliproxyPromise() (+8 more)
...
Cohesion: 0.18
Nodes (13): startPostLaunchSidecars(), startSidecars(), readPlatformConfigSync(), getSupervisorPortSync(), getSupervisorUrlSync(), isProcessAlive(), isSupervisorRunningSync(), readSupervisorPid() (+5 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, Cleanup After Shutdown, code:bash (# Stop all Panopticon services), code:bash (# Method 1: Separate commands), code:bash (# Clean up log files), code:bash (# Clean up stale resources), More Information, Next Steps (+8 more)
...
Cohesion: 0.19
Nodes (12): buildInspectPromptPromise(), execAsync, getBeadDescription(), InspectContext, spawnInspectAgent(), getDiffStats(), inspectCommand(), InspectOptions (+4 more)
...
Cohesion: 0.2
Nodes (6): dispatchMenuAction(), dispatchMenuAction(), consoleErrors, flywheelStatus, MockWebSocket, statusPane
...
Cohesion: 0.47
Nodes (4): FlywheelStatePayload, FlywheelStateReadOptions, readFlywheelState(), resolveStatePath()
...
## Knowledge Gaps
- **13623 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13618 more)
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 9`, `Community 1035`, `Community 12`, `Community 13`, `Community 14`, `Community 11`, `Community 17`, `Community 19`, `Community 532`, `Community 21`, `Community 535`, `Community 23`, `Community 25`, `Community 538`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 40`, `Community 554`, `Community 43`, `Community 556`, `Community 557`, `Community 45`, `Community 47`, `Community 48`, `Community 53`, `Community 55`, `Community 56`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 584`, `Community 73`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 87`, `Community 89`, `Community 90`, `Community 93`, `Community 97`, `Community 98`, `Community 100`, `Community 104`, `Community 108`, `Community 109`, `Community 110`, `Community 111`, `Community 116`, `Community 118`, `Community 123`, `Community 665`, `Community 157`, `Community 159`, `Community 161`, `Community 172`, `Community 173`, `Community 181`, `Community 182`, `Community 704`, `Community 222`, `Community 223`, `Community 224`, `Community 237`, `Community 752`, `Community 247`, `Community 272`, `Community 285`, `Community 802`, `Community 310`, `Community 331`, `Community 334`, `Community 341`, `Community 363`, `Community 393`, `Community 415`, `Community 434`, `Community 435`, `Community 448`, `Community 449`, `Community 452`, `Community 473`, `Community 485`, `Community 491`, `Community 493`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 9` to `Community 3`, `Community 4`, `Community 7`, `Community 391`, `Community 10`, `Community 11`, `Community 14`, `Community 16`, `Community 273`, `Community 20`, `Community 22`, `Community 534`, `Community 23`, `Community 27`, `Community 31`, `Community 160`, `Community 34`, `Community 35`, `Community 37`, `Community 295`, `Community 168`, `Community 39`, `Community 42`, `Community 43`, `Community 297`, `Community 429`, `Community 560`, `Community 50`, `Community 435`, `Community 55`, `Community 56`, `Community 189`, `Community 62`, `Community 63`, `Community 64`, `Community 704`, `Community 450`, `Community 448`, `Community 452`, `Community 70`, `Community 590`, `Community 1104`, `Community 339`, `Community 212`, `Community 471`, `Community 343`, `Community 94`, `Community 223`, `Community 97`, `Community 227`, `Community 101`, `Community 102`, `Community 238`, `Community 124`, `Community 117`, `Community 759`, `Community 123`, `Community 636`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 39` to `Community 32`, `Community 4`, `Community 107`, `Community 363`, `Community 558`, `Community 17`, `Community 211`, `Community 94`, `Community 311`, `Community 25`, `Community 90`, `Community 61`, `Community 30`, `Community 31`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13623 weakly-connected nodes found - possible documentation gaps or missing edges._
