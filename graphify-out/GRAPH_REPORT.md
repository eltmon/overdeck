...
## Corpus Check
- 1745 files · ~2,325,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23888 nodes · 36601 edges · 1213 communities (1165 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 510 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ce70acc`
...
## Communities (1213 total, 48 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (152): WorkLogEntry, ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage() (+144 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (141): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+133 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (157): fetchConversations(), GeneralConversation, GeneralSectionProps, ActivityEntry, AgentList(), AgentListProps, CloisterStatus, fetchActivity() (+149 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (137): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ArtifactLinks(), ArtifactLinksProps, formatCost() (+129 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (133): monitorReviewConvoySignals(), detectHandoffMethod(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn(), sleep(), waitForIdle() (+125 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (135): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkCompletedButUnsignaledReviews(), checkDeadEndAgents() (+127 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (123): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+115 more)
...
Cohesion: 0.03
Nodes (107): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch() (+99 more)
...
Cohesion: 0.03
Nodes (87): cleanupStaleAgentState(), isMergeAgentRunning(), parsePiSession(), agentState, callOrder, checkFn, killed, mockGetAgentState (+79 more)
...
Cohesion: 0.04
Nodes (100): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+92 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (96): resumeCommand(), AgentRuntimeState, getAgentRuntimeStateAsync(), getAgentStateAsync(), getLatestSessionIdAsync(), setAgentDeliveryMethod(), assertCanResumeSession(), getWorkAgentLifecycleStateAsync() (+88 more)
...
Cohesion: 0.03
Nodes (74): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+66 more)
...
Cohesion: 0.03
Nodes (86): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, autopresoRouteLayer, backToStagingRoute, readJsonBody, requireTrustedOrigin() (+78 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (68): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, criteria, doc, result, { projectPath, workspacePath }, promoted (+60 more)
...
Cohesion: 0.04
Nodes (81): checkApiErrorAgents(), captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+73 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (60): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (71): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), completePlanningArtifacts(), beadsDir, doc (+63 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (74): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), retryPendingSpawn(), DEFAULTS (+66 more)
...
Cohesion: 0.04
Nodes (72): readCavemanVariant(), checkStuckReviewing(), finalizeRunLog(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist() (+64 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (77): { config }, Role, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles() (+69 more)
...
Cohesion: 0.04
Nodes (62): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+54 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (62): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+54 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (59): pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+51 more)
...
Cohesion: 0.05
Nodes (55): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, extractFilePath(), FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction() (+47 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (58): defaults, first, { models }, second, clearConfigCache(), MODEL_DEPRECATIONS, deprecatedIds, resolved (+50 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (54): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart() (+46 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (50): SearchResult, RuntimeConversationsConfig, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, mapEventToDelta() (+42 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (51): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (52): checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffResult, activeRoleRunExists(), AgentCrashTracker (+44 more)
...
Cohesion: 0.06
Nodes (51): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), EnrichmentApiConfig (+43 more)
...
Cohesion: 0.07
Nodes (45): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+37 more)
...
Cohesion: 0.06
Nodes (42): buildSpecialistBaseCommand(), resolveModel(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS (+34 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (40): buildClaudeUserSettings(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE (+32 more)
...
Cohesion: 0.09
Nodes (44): acquireStartLock(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth(), getGpuMemoryUsedMb(), getTtsDaemonAuthToken() (+36 more)
...
Cohesion: 0.06
Nodes (38): DEFAULT_AUTO_RESUME_CONFIG, AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CostTrackingConfig, deepMerge(), DEFAULT_CLOISTER_CONFIG (+30 more)
...
Cohesion: 0.07
Nodes (38): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+30 more)
...
Cohesion: 0.07
Nodes (36): useLiveFlash(), activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose() (+28 more)
...
Cohesion: 0.06
Nodes (32): buildACLookupByTitle(), buildActiveSliceContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext() (+24 more)
...
Cohesion: 0.07
Nodes (31): getWindowDimensionsAsync(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+23 more)
...
Cohesion: 0.1
Nodes (32): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual() (+24 more)
...
Cohesion: 0.1
Nodes (30): mockLoadProjectsConfig, mockResolveProjectFromIssue, project, trackerType, wipeCommand(), WipeOptions, extractNumber(), extractPrefix() (+22 more)
...
Cohesion: 0.07
Nodes (33): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), AIProvider, calculateCost() (+25 more)
...
Cohesion: 0.11
Nodes (27): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), workspaceDeepCleanCommand(), WorkspaceDeepCleanOptions, updateCommand(), useConfigCommand() (+19 more)
...
Cohesion: 0.07
Nodes (24): CopyConfigOptions, sentinel, cache, db, loaded, row, rows, savedRow (+16 more)
...
Cohesion: 0.09
Nodes (32): AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath(), getSessionDir(), inferIssueId() (+24 more)

### Community 180 - "Community 180"
Cohesion: 0.08
Nodes (29): getTrackerConfig(), getTriageStatePath(), loadTriageState(), saveTriageState(), triageCommand(), TriageOptions, TriageState, ClaudePermissionMode (+21 more)
...
Cohesion: 0.11
Nodes (29): clearFeedbackFiles(), validateAndCleanStateFile(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), readWorkspaceContinueAsync(), uniqueTmpPath() (+21 more)
...
Cohesion: 0.1
Nodes (27): buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError(), doProbe(), formatProbeError() (+19 more)
...
Cohesion: 0.11
Nodes (31): appendToRunLog(), checkLogSizeLimit(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs(), getRunLog(), getRunLogPath() (+23 more)
...
Cohesion: 0.13
Nodes (31): Access, readBridgedCodexCredential(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), getIndexStats(), getIndexStats() (+23 more)
...
Cohesion: 0.13
Nodes (28): closeIssue(), approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+20 more)
...
Cohesion: 0.11
Nodes (22): assertIssueHasBeads(), BeadEntry, execFileAsync, queryBeadById(), queryBeadsForIssue(), readBeadsFromJsonl(), getForgeAdapter(), withRepoArtifactUrl() (+14 more)
...
Cohesion: 0.12
Nodes (19): cn(), SettingsRow(), SettingsRowProps, SettingsSection(), SettingsSectionProps, ProviderCard(), ProviderCardProps, THINKING_LEVEL_LABELS (+11 more)
...
Cohesion: 0.12
Nodes (21): configShadowCommand(), ShadowOptions, PanopticonConfig, getShadowModeFromEnv(), CanonicalState, getDisplayStatus(), getPendingSyncCount(), getShadowStatePath() (+13 more)
...
Cohesion: 0.1
Nodes (20): SettingsCardSection(), SettingsCardSectionProps, SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsRowStatus(), SettingsRowStatusProps (+12 more)
...
Cohesion: 0.11
Nodes (11): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode (+3 more)
...
Cohesion: 0.21
Nodes (19): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+11 more)
...
Cohesion: 0.12
Nodes (17): PROVIDER_INFO, ProviderPanelProps, ApiKeysConfig, DeprecationWarning, Harness, ModelRef, ModelsConfig, Provider (+9 more)
...
Cohesion: 0.2
Nodes (4): getProjectDirs(), getSessionFiles(), parseClaudeSession(), ClaudeCodeRuntime
...
Cohesion: 0.13
Nodes (8): NormalizedTtsDaemonConfig, startCliproxyWatchdog(), startSharedPresencePoller(), TtsWatchdog, CONFIG, log, mocks, watchdog
...
Cohesion: 0.14
Nodes (15): CostThresholdDetails, EnrichRequest, fetchSession(), formatDate(), fromRpcSession(), Props, Session, SessionDetail() (+7 more)
...
- **Why does `fetch` connect `Community 2` to `Community 0`, `Community 1`, `Community 386`, `Community 516`, `Community 7`, `Community 648`, `Community 649`, `Community 266`, `Community 11`, `Community 1036`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 655`, `Community 403`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 34`, `Community 36`, `Community 37`, `Community 292`, `Community 424`, `Community 170`, `Community 813`, `Community 50`, `Community 54`, `Community 55`, `Community 56`, `Community 701`, `Community 446`, `Community 63`, `Community 62`, `Community 194`, `Community 579`, `Community 196`, `Community 580`, `Community 202`, `Community 83`, `Community 218`, `Community 92`, `Community 235`, `Community 115`, `Community 116`, `Community 120`, `Community 121`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 34` to `Community 416`, `Community 193`, `Community 161`, `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 363`, `Community 46`, `Community 23`, `Community 20`, `Community 151`, `Community 218`, `Community 27`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 19` to `Community 288`, `Community 385`, `Community 100`, `Community 11`, `Community 44`, `Community 268`, `Community 51`, `Community 20`, `Community 182`, `Community 22`, `Community 25`, `Community 93`?**
