# Graph Report - feature-pan-1194  (2026-05-19)

## Corpus Check
- 1754 files · ~2,345,687 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24093 nodes · 36913 edges · 1205 communities (1159 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 533 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d140d24e`
...
3. `resolveProjectFromIssue()` - 122 edges
...
## Communities (1205 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (150): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (142): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (132): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (138): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+130 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (141): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), confirmCost(), enrichAction() (+133 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (139): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+131 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (137): monitorReviewConvoySignals(), spawnInspectAgent(), killCommand(), KillOptions, pauseCommand(), PauseOptions, recoverCommand(), RecoverOptions (+129 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (122): DiffPanel(), DEFAULTS, DiffIndicators, DiffPreferences, DiffRenderMode, HunkSeparators, LineDiffType, LineHoverHighlight (+114 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (137): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkCompletedButUnsignaledReviews() (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (101): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+93 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (114): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMap(), CorrelationResult, copySessionFromCompactBoundary(), createSummaryFork() (+106 more)
...
Cohesion: 0.03
Nodes (112): checkMissingReviewStatuses(), cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash() (+104 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (102): confirmHostOverride(), resumeCommand(), ResumeOptions, AgentEnrichment, computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime() (+94 more)
...
Cohesion: 0.02
Nodes (84): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (91): after, before, blockers, result, statuses, after, row, status (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (91): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache (+83 more)
...
Cohesion: 0.03
Nodes (83): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+75 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (66): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, doc, path (+58 more)
...
Cohesion: 0.05
Nodes (79): stampPlanForFinalization(), approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition() (+71 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (78): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), FetchLike, postSpeakPayload(), renderTemplate(), resolveAndSpeak(), ResolveAndSpeakDeps (+70 more)
...
Cohesion: 0.03
Nodes (78): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+70 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (77): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+69 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (76): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand() (+68 more)
...
Cohesion: 0.03
Nodes (73): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), conv (+65 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (70): checkStuckReviewing(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod() (+62 more)
...
Cohesion: 0.05
Nodes (69): readWorkspacePlanAsync(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, readWorkspaceContinueAsync(), completePlanningArtifacts(), readWorkspacePlanAsync(), beadsDir (+61 more)
...
Cohesion: 0.04
Nodes (64): getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (66): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+58 more)
...
Cohesion: 0.05
Nodes (67): createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, addTunnelIngress(), cfFetch(), CloudflareCredentials, CloudflareIngressRule (+59 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (64): NormalizedTtsDaemonConfig, acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync (+56 more)
...
Cohesion: 0.05
Nodes (65): deletePRDDraft(), getPRDDraftInfo(), getPRDDraftPath(), hasPRDDraft(), listPRDDrafts(), readPRDDraft(), resolveDraftProjectRoot(), writePRDDraft() (+57 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (52): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange, TurnDiffSummary, WorkLogEntry (+44 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (52): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCardProps, LastHeardCounter() (+44 more)
...
Cohesion: 0.05
Nodes (48): firstSessionPanel, firstWorkbench, overview, workbench, ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench() (+40 more)
...
Cohesion: 0.05
Nodes (55): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), countFts(), countFtsInSet(), findEnrichedSessionsMissingEmbedding() (+47 more)
...
Cohesion: 0.06
Nodes (50): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), validateAgentDeliveryMethodOrigin(), autopresoRouteLayer, backToStagingRoute, readJsonBody (+42 more)
...
Cohesion: 0.07
Nodes (52): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback(), readPlanningContext() (+44 more)
...
Cohesion: 0.04
Nodes (39): PlanDialog(), PlanDialogProps, PlanningStatus, resolveSettingsModelRef(), SettingsResponse, StartPlanningResult, Step, fetchMock (+31 more)
...
Cohesion: 0.06
Nodes (47): buildSpecialistBaseCommand(), canUseHarness(), canUseModelWithAuth(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK, SUBSCRIPTION_ONLY_OPENAI_MODELS, buildChannelsArgs() (+39 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (42): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps (+34 more)
...
Cohesion: 0.07
Nodes (44): AutoPresoAgentSettings, createModel(), createTools(), DEFAULT_SETTINGS, readCodexBearerToken(), runWhiteboardAgent(), runWhiteboardWarmupOnce(), systemPrompt() (+36 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (45): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+37 more)
...
Cohesion: 0.04
Nodes (46): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, execAsync, execFileAsync, firePostMergeLifecycle(), getModelsResolveRoute, getProjectPathForIssue() (+38 more)
...
Cohesion: 0.05
Nodes (39): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), checkPendingTestDispatch(), buildTestRolePrompt() (+31 more)
...
Cohesion: 0.05
Nodes (39): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+31 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (46): readLogTail(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), analyze_session(), find_sessions(), main(), Analyze a single session file for health issues. (+38 more)
...
Cohesion: 0.07
Nodes (35): readFeatureContext(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+27 more)
...
Cohesion: 0.09
Nodes (13): sshCommand(), execAsync, FlyProvider, mapFlyStateToVmStatus(), CONFIG, hadPackageDir, hadPython, hadVenvDir (+5 more)
...
Cohesion: 0.09
Nodes (35): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, startTtsDaemonFromDashboard(), StoredEvent (+27 more)
...
Cohesion: 0.08
Nodes (34): healthCommand(), HealthOptions, pendingCommand(), listRunningAgents(), AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput() (+26 more)
...
Cohesion: 0.1
Nodes (36): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+28 more)
...
Cohesion: 0.09
Nodes (35): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), recordDockerContainerLifecycleSnapshot(), resetCachedDockerContainerLifecycleSnapshotForTests(), dockerProject, health, now, projectRoot (+27 more)
...
Cohesion: 0.11
Nodes (35): listActiveConversations(), markConversationEnded(), handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertSafeName(), cleanupConversationAttachments() (+27 more)
...
Cohesion: 0.14
Nodes (31): buildClaudeUserSettings(), bypassPrefixForAgentFlag(), ClaudeUserSettings, getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE (+23 more)
...
Cohesion: 0.13
Nodes (31): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getAppStatus() (+23 more)
...
Cohesion: 0.08
Nodes (20): RuntimeConversationsConfig, buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, extractIssueIdFromSession(), mapEventToDelta(), PanRpcLayer, reviewRoleSessionName(), sharedPresencePoller (+12 more)

### Community 221 - "Community 221"
Cohesion: 0.09
Nodes (28): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+20 more)
...
Cohesion: 0.21
Nodes (28): cleanupLabelsGitHub(), cleanupLabelsLinear(), cleanupMergedLabels(), execAsync, LABELS_TO_REMOVE, buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads() (+20 more)
...
Cohesion: 0.09
Nodes (22): activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub(), setClientReady() (+14 more)
...
Cohesion: 0.13
Nodes (23): checkFailedMergeRetry(), cleanupAbandonedFeedback(), clearFeedbackFiles(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult (+15 more)
...
Cohesion: 0.14
Nodes (15): cn(), SettingsCardSection(), SettingsCardSectionProps, SettingsRow(), SettingsRowProps, SettingsRowStatus(), SettingsRowStatusProps, StatusVariant (+7 more)
...
Cohesion: 0.1
Nodes (17): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+9 more)
...
Cohesion: 0.12
Nodes (16): SettingsHeader(), SettingsHeaderProps, SettingsLayout(), SettingsLayoutProps, SettingsSection(), SettingsSectionProps, NavItem, SettingsSidebarNav() (+8 more)
...
Cohesion: 0.13
Nodes (8): DiffPanelProps, DiffThemeType, RenderablePatch, ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName()

### Community 415 - "Community 415"
Cohesion: 0.23
Nodes (18): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyAsync(), buildCliproxyConfig(), CliproxyCodexCredentials, CliproxyGeminiCredentials, CodexAuthFile, decodeJwtPayload() (+10 more)
...
Cohesion: 0.18
Nodes (14): COMPOSE_FILES, composeProjectNameForWorkspace(), declaredComposeProjectName(), dockerCompose(), execFileAsync, findDevcontainerComposeFile(), workspaceRebuildCommand(), tempDirs (+6 more)
...
Cohesion: 0.22
Nodes (12): checkCliproxyPortAsync(), execAsync, isCliproxyRunningAsync(), isProcessAlive(), readPidFile(), restartCliproxyAsync(), stopCliproxy(), stopCliproxyAsync() (+4 more)
...
Cohesion: 0.45
Nodes (13): detectPlatformAsset(), ensureConfigFile(), ensureDirs(), getCliproxyBinary(), getCliproxyConfigPath(), getCliproxyDir(), getCliproxyLogPath(), getCliproxyPidPath() (+5 more)
...
Cohesion: 0.25
Nodes (8): cleanupAllLogs(), cleanupOldLogs(), getSpecialistRetention(), cleanupLogsCommand(), resetCommand(), ResetOptions, wakeCommand(), WakeOptions
...
Cohesion: 0.27
Nodes (8): isRespawnPending(), markRespawnPending(), pendingRespawns, waitForSessionRespawn(), a, mockedSessionExistsAsync, respawn, start
...
Cohesion: 0.25
Nodes (6): chalk, cliRows, dashboardRows, logs, output, parsed
...
Cohesion: 0.29
Nodes (5): bead, beads, plan, specsDir, ws123
...
## Knowledge Gaps
- **12535 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+12530 more)
...
- **Why does `fetch` connect `Community 5` to `Community 0`, `Community 1025`, `Community 642`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 527`, `Community 528`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 284`, `Community 413`, `Community 801`, `Community 162`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 686`, `Community 47`, `Community 174`, `Community 48`, `Community 431`, `Community 52`, `Community 184`, `Community 570`, `Community 59`, `Community 60`, `Community 63`, `Community 64`, `Community 195`, `Community 68`, `Community 200`, `Community 210`, `Community 243`, `Community 116`, `Community 117`, `Community 633`, `Community 634`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `postMergeLifecycle()` connect `Community 19` to `Community 131`, `Community 5`, `Community 6`, `Community 71`, `Community 232`, `Community 681`, `Community 39`, `Community 106`, `Community 12`, `Community 8`, `Community 210`, `Community 147`, `Community 311`, `Community 24`, `Community 155`, `Community 28`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 20` to `Community 34`, `Community 99`, `Community 69`, `Community 42`, `Community 11`, `Community 266`, `Community 525`, `Community 173`, `Community 499`, `Community 86`, `Community 24`, `Community 26`, `Community 27`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _12535 weakly-connected nodes found - possible documentation gaps or missing edges._
