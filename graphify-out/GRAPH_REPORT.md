...
## Corpus Check
- 1929 files · ~3,151,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27551 nodes · 43262 edges · 1297 communities (1242 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `643d3ce7`
...
## Communities (1297 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (162): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+154 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (179): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+171 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (166): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, PlanningState, ZoneAActionsState (+158 more)
...
Cohesion: 0.02
Nodes (140): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+132 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (158): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+150 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (156): buildInspectPrompt(), __dirname, execAsync, __filename, getBeadDescription(), InspectResult, spawnInspectAgentPromise(), buildSpecialistBaseCommand() (+148 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (128): recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+120 more)
...
Cohesion: 0.03
Nodes (112): containerRestartBackoffMs(), DeaconState, captureTmuxOutput(), isMergeAgentRunning(), customPromisify, justNow, longAgo, old (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (103): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+95 more)
...
Cohesion: 0.02
Nodes (97): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+89 more)
...
Cohesion: 0.03
Nodes (75): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync() (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (87): AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow(), BlockedRowProps, fetchWorkspace(), forgeApprove(), forgeMerge(), formatRelative() (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (77): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+69 more)
...
Cohesion: 0.04
Nodes (93): deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile() (+85 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (87): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+79 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (88): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), buildActiveSliceContext(), buildPolyrepoContext() (+80 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (73): isRunningAgent(), useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton() (+65 more)
...
Cohesion: 0.04
Nodes (83): deliverReviewVerdictFeedback(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (77): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+69 more)
...
Cohesion: 0.04
Nodes (69): criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks, after (+61 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (75): destroyRemoteWorkspace(), cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote(), copyPlanningStateToRemote(), copyWorkspacePanStateFromRemote(), copyWorkspacePanStateToRemote() (+67 more)
...
Cohesion: 0.03
Nodes (78): pending, withBdMutex(), withBdMutexPromise(), withWorkspaceBdMutexPromise(), restoreTrackedBeadsExport(), runGit(), spawnerLayer, buildPermissionActivityDetails() (+70 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (75): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), getBarColor(), ResourceBar() (+67 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (79): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+71 more)
...
Cohesion: 0.03
Nodes (77): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+69 more)
...
Cohesion: 0.03
Nodes (71): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), performHandoff(), activeRoleRunExists() (+63 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (59): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+51 more)
...
Cohesion: 0.05
Nodes (72): boundedAutoPresoElements(), jsonByteLength(), readElementLikes(), validateAutoPresoCanvasElements(), AutoPresoSession, ExcalidrawElementLike, postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin() (+64 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (81): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), array (+73 more)
...
Cohesion: 0.04
Nodes (58): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, syncWalFromAllProjects(), IssueAggregate, BUDGETS_FILE (+50 more)
...
Cohesion: 0.06
Nodes (69): getTrackerContext(), doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview() (+61 more)
...
Cohesion: 0.04
Nodes (51): ensureOpenAICompatibleProxyRunning(), getOpenAICompatibleProxyBaseUrl(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError() (+43 more)
...
Cohesion: 0.07
Nodes (63): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear(), applyLabelLinearImpl(), applyLabelViaTracker() (+55 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (59): diffPatchFilesAgainstHead(), diffSinceCommit(), copySessionFromCompactBoundary(), listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache (+51 more)
...
Cohesion: 0.05
Nodes (54): monitorReviewConvoySignals(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions, HandoffResult, performHandoffPromise() (+46 more)
...
Cohesion: 0.07
Nodes (61): getMemoryStatus(), writeObservationRecord(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), resolveArchiveDir(), resolveCheckpointFile() (+53 more)
...
Cohesion: 0.04
Nodes (58): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), emitActivityDetailedSync(), emitDashboardLifecycleSync(), withConcurrencyLimit(), data, mockExistsSync, mockReadFile (+50 more)
...
Cohesion: 0.04
Nodes (57): claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange(), runInline() (+49 more)
...
Cohesion: 0.05
Nodes (54): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult, showCommand() (+46 more)
...
Cohesion: 0.06
Nodes (28): issues, result, importTrackerConfig(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged() (+20 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (51): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+43 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (54): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry, countItems() (+46 more)
...
Cohesion: 0.04
Nodes (47): sentinel, eightDaysAgo, events, payload, r1, r2, received, recent (+39 more)
...
Cohesion: 0.06
Nodes (46): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, addTunnelIngress() (+38 more)
...
Cohesion: 0.05
Nodes (48): AutoPresoControls(), warmupIcon(), AutoPresoView(), Excalidraw, ExcalidrawApiLike, TranscriptPanel(), ActivityEntry, ActivityItem() (+40 more)
...
Cohesion: 0.05
Nodes (45): confirmCost(), enrichAction(), formatCost(), runWithPool(), WorkPoolStats, DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding() (+37 more)
...
Cohesion: 0.07
Nodes (47): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget() (+39 more)
...
Cohesion: 0.05
Nodes (45): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), writeFeedbackFile(), buildReviewFeedbackBody(), DeliverReviewVerdictFeedbackOptions (+37 more)
...
Cohesion: 0.08
Nodes (50): assertSafeAgentId(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef(), checkpointSpawnerLayer, deleteAllCheckpoints() (+42 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (51): Access, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+43 more)
...
Cohesion: 0.07
Nodes (42): AgentRuntimeState, CheckpointOperation, CheckpointRequest, result, bind(), claimTranscriptRange(), commitTranscriptRange(), cryptoRandomUUID() (+34 more)
...
Cohesion: 0.05
Nodes (36): RoundMarker, fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR (+28 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (47): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), getSetting(), getConversationByName() (+39 more)

### Community 105 - "Community 105"
Cohesion: 0.06
Nodes (44): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+36 more)
...
Cohesion: 0.05
Nodes (44): validateCwdContainment(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), BriefRequestBody, decodeFlywheelRunId, decodeFlywheelStatus, FlywheelActionDeps, flywheelRouteLayer (+36 more)

### Community 113 - "Community 113"
Cohesion: 0.06
Nodes (32): TranscriptCheckpoint, appendJsonl(), countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript, registerTranscriptForPolling() (+24 more)
...
Cohesion: 0.1
Nodes (42): startFlywheelRun(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata() (+34 more)
...
Cohesion: 0.06
Nodes (32): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests() (+24 more)
...
Cohesion: 0.07
Nodes (29): CloseIssueOptions, approve(), buildResult(), cancelIssueWorkflow(), clearReviewStatusStep(), close(), closeOut(), deepWipe() (+21 more)
...
Cohesion: 0.08
Nodes (33): activityToStatus(), capitalize(), deriveDotStatus(), deriveSessionLabel(), deriveSessionModel(), describePresence(), describeSessionPurpose(), describeWaitingReason() (+25 more)
...
Cohesion: 0.08
Nodes (34): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanHooks(), CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings() (+26 more)
...
Cohesion: 0.08
Nodes (30): beadsDir, doc, AcceptanceCriterion, BeadsOperationError, createBeadsFromVBriefPromise(), CreateBeadsResult, deriveProjectPrefix(), execAsync (+22 more)
...
Cohesion: 0.09
Nodes (31): runFullRestart(), DASHBOARD_LOG_FILE, describePid(), execAsync, isTraefikContainerRunningPromise(), killPidsSync(), pidsOnPort(), PlatformConfig (+23 more)
...
Cohesion: 0.11
Nodes (35): getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime(), loadResumeSessionId(), resumeFlywheel(), saveResumeSessionId(), spawnFlywheelAgent(), loadConfigNoMigration(), abortFlywheelRunForDashboard() (+27 more)
...
Cohesion: 0.11
Nodes (31): healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls, logSpy, now (+23 more)
...
Cohesion: 0.18
Nodes (30): checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError, CliproxyGeminiCredentials, CodexAuthFile, detectPlatformAsset(), ensureConfigFile() (+22 more)
...
Cohesion: 0.13
Nodes (30): markConversationEnded(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments(), cleanupUnreferencedConversationAttachments(), ensureConversationAttachmentDir(), extractConversationAttachmentPaths(), getAttachmentCache() (+22 more)
...
Cohesion: 0.11
Nodes (27): buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, evaluateSeverity(), execAsync (+19 more)
...
Cohesion: 0.12
Nodes (22): generateSmartSummary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession(), SummaryForkOptions (+14 more)
...
Cohesion: 0.16
Nodes (19): costAction(), CostRow, formatTokens(), GroupBy, resolveGroupKey(), embedAction(), formatBrief(), formatDate() (+11 more)
...
Cohesion: 0.14
Nodes (22): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, parseRunId(), pauseFlywheel() (+14 more)
...
Cohesion: 0.17
Nodes (23): appendLineColumnFromHash(), basenameOfPath(), hasExternalScheme(), inferHomeFromCwd(), isAbsolutePath(), isLikelyPathCandidate(), isRelativePath(), isWindowsAbsolutePath() (+15 more)
...
Cohesion: 0.16
Nodes (19): clearFeedbackFilesPromise(), FsError, writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+11 more)

### Community 364 - "Community 364"
Cohesion: 0.09
Nodes (19): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+11 more)
...
Cohesion: 0.13
Nodes (19): ConversationRow(), ConversationRowProps, PHASE_ICONS, WorkingSpinner(), useNow(), AGENT_TOOLS, BASH_TOOLS, FILE_TOOLS (+11 more)
...
Cohesion: 0.11
Nodes (19): CostThresholdDetails, embedSession(), EnrichRequest, enrichSession(), fetchSession(), formatDate(), fromRpcSession(), parseCostThreshold() (+11 more)
...
Cohesion: 0.2
Nodes (11): cvCommand(), CVOptions, AgentCV, completeWorkSync(), formatCVSync(), getAgentCVSync(), getAgentRankingsSync(), getCVFile() (+3 more)
...
Cohesion: 0.2
Nodes (12): resolvePreferredEditor(), editorIconFor(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, rendered, wsTransportMock, openFavoriteEditor() (+4 more)

### Community 484 - "Community 484"
Cohesion: 0.13
Nodes (15): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), IMAGE_EXTENSIONS, MarkdownFileLink (+7 more)
...
Cohesion: 0.12
Nodes (8): mockConfig, mockGetIssue, parentWorkspace, planDoc, specsDir, written, path, paths
...
Cohesion: 0.13
Nodes (9): AgentState, __testInternals, state, actual, capture, FakeBridgeOptions, parsed, socketPath (+1 more)
...
Cohesion: 0.26
Nodes (11): addTunnelIngressPromise(), cfFetch(), CloudflareCredentials, CloudflareIngressRule, CloudflareTunnelConfig, readCloudflareCredentials(), removeTunnelIngressPromise(), resolveHostnames() (+3 more)
...
Cohesion: 0.27
Nodes (11): bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), ensureConfigFileAsync(), ensureDirsAsync(), getCliproxyAuthDir(), getCliproxyGeminiCredPath(), parseBridgedGeminiApiKey(), readBridgedGeminiApiKey() (+3 more)
...
Cohesion: 0.18
Nodes (9): evaluateAgentStartGate(), hasActiveAgentGateOrRetry(), ensureResourceConfigLoaded(), readGlobalResourceConfig(), resolveFiniteNumber(), SystemHealthSnapshot, decision, DeepPartial (+1 more)
...
Cohesion: 0.27
Nodes (8): isRespawnPending(), markRespawnPending(), pendingRespawns, waitForSessionRespawn(), a, mockedSessionExists, respawn, resultPromise
...
Cohesion: 0.22
Nodes (8): isCliproxyRunning(), startCliproxy(), cliproxyRouteLayer, CliproxyStatus, getCliproxyStatusRoute, postCliproxyRestartRoute, refreshStatus(), startCliproxyWatchdog()
...
Cohesion: 0.22
Nodes (7): content, d, existingDir, lines, oldDir, result, skillDir
...
Cohesion: 0.4
Nodes (5): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), defaultThresholds(), getResourceConfig()
...
## Knowledge Gaps
- **13614 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13609 more)
...
- **Why does `string()` connect `Community 5` to `Community 0`, `Community 1`, `Community 3`, `Community 1029`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 533`, `Community 529`, `Community 23`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 46`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 60`, `Community 62`, `Community 64`, `Community 65`, `Community 69`, `Community 581`, `Community 72`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 86`, `Community 89`, `Community 91`, `Community 94`, `Community 100`, `Community 104`, `Community 105`, `Community 107`, `Community 112`, `Community 121`, `Community 141`, `Community 661`, `Community 153`, `Community 164`, `Community 165`, `Community 166`, `Community 173`, `Community 699`, `Community 189`, `Community 191`, `Community 199`, `Community 211`, `Community 221`, `Community 224`, `Community 239`, `Community 240`, `Community 247`, `Community 248`, `Community 250`, `Community 797`, `Community 309`, `Community 314`, `Community 317`, `Community 333`, `Community 335`, `Community 344`, `Community 874`, `Community 363`, `Community 876`, `Community 391`, `Community 396`, `Community 421`, `Community 440`, `Community 452`, `Community 469`, `Community 480`, `Community 488`, `Community 506`, `Community 507`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 653`, `Community 13`, `Community 15`, `Community 20`, `Community 277`, `Community 21`, `Community 23`, `Community 24`, `Community 22`, `Community 282`, `Community 26`, `Community 155`, `Community 29`, `Community 152`, `Community 31`, `Community 46`, `Community 49`, `Community 53`, `Community 55`, `Community 56`, `Community 311`, `Community 699`, `Community 60`, `Community 189`, `Community 64`, `Community 452`, `Community 68`, `Community 69`, `Community 199`, `Community 78`, `Community 208`, `Community 81`, `Community 345`, `Community 96`, `Community 228`, `Community 101`, `Community 102`, `Community 103`, `Community 229`, `Community 105`, `Community 749`, `Community 629`, `Community 120`, `Community 250`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 26` to `Community 65`, `Community 33`, `Community 35`, `Community 164`, `Community 68`, `Community 417`, `Community 8`, `Community 554`, `Community 207`, `Community 16`, `Community 18`, `Community 20`, `Community 532`, `Community 150`, `Community 313`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13614 weakly-connected nodes found - possible documentation gaps or missing edges._
