...
## Corpus Check
- 1933 files · ~3,155,475 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27641 nodes · 43466 edges · 1305 communities (1249 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 808 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6774b1d2`
...
## Communities (1305 total, 56 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (156): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf, catchTag$1 (+148 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (174): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+166 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (165): resolveAutoResumeConfigForIssue(), checkCompletedButUnsignaledReviews(), monitorReviewConvoySignals(), captureHandoffContext(), detectHandoffMethod(), HandoffError, HandoffMethod, HandoffOptions (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (132): cont, doc, projectRoot, specsDir, workspace, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile() (+124 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (107): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+99 more)
...
Cohesion: 0.03
Nodes (93): parsePiSessionSync(), openBrowser(), runCommand(), ProcessSpawnError, ProcessTimeoutError, TmuxError, agentState, callOrder (+85 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (112): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (109): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, ZoneA(), ZoneAProps, ALL_TABS (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (108): containerRestartBackoffMs(), DeaconState, isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent (+100 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (87): isRunningAgent(), ComposerMode, IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps (+79 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (92): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+84 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (76): checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), HandoffResult, createHandoffEvent() (+68 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (102): ActivityEntry, AgentPauseFields, clearTroubledAgent(), CloisterHealth, fetchActivity(), formatDuration(), HEALTH_STATE_COLOR, HEALTH_STATE_EMOJI (+94 more)
...
Cohesion: 0.03
Nodes (98): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+90 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (89): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+81 more)
...
Cohesion: 0.03
Nodes (80): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (89): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (86): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, callApi(), CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, EMPTY_SEARCH (+78 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (89): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+81 more)
...
Cohesion: 0.02
Nodes (90): restoreTrackedBeadsExport(), runGit(), spawnerLayer, execFile(), kCustom, mockExecFile, ActivityEntry, activityLog (+82 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (83): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+75 more)
...
Cohesion: 0.04
Nodes (77): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+69 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (85): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), ResolveAndSpeakDeps (+77 more)
...
Cohesion: 0.04
Nodes (53): getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker, TrackerConfig (+45 more)
...
Cohesion: 0.04
Nodes (66): RecoverButton(), RecoverButtonProps, SwitchModelModal(), SwitchModelModalProps, VerifyingOnMainBadge(), WorkspaceStatusOverview(), WorkspaceStatusOverviewProps, ActionKey (+58 more)
...
Cohesion: 0.03
Nodes (63): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, comparePipelineIssues(), filterMatchesShipModifier() (+55 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (74): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+66 more)
...
Cohesion: 0.04
Nodes (53): githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync, STATE_MTIME (+45 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (68): embedAction(), confirmCost(), enrichAction(), formatCost(), normalizeFilter(), SearchMode, SearchQuery, searchSessions() (+60 more)
...
Cohesion: 0.04
Nodes (62): archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation(), unfavoriteConversation(), CloisterStatus, CloisterStatusBar() (+54 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (65): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+57 more)
...
Cohesion: 0.04
Nodes (58): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+50 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (72): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+64 more)
...
Cohesion: 0.05
Nodes (55): InlineSparkline(), InlineSparklineProps, STATUS_ANIM_CLASS, STATUS_COLOR, STATUS_GLOW, StatusDot(), StatusDotProps, StatusDotSize (+47 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (53): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+45 more)
...
Cohesion: 0.05
Nodes (57): DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync, exitGracePeriod(), FEEDBACK_DIR, FEEDBACK_LOG (+49 more)
...
Cohesion: 0.04
Nodes (55): runMemoryFtsTransaction(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate, MemoryHealthUpdateOptions (+47 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (54): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+46 more)
...
Cohesion: 0.06
Nodes (51): isSynthesisForActiveReviewRun(), cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions (+43 more)
...
Cohesion: 0.06
Nodes (57): getCostsForIssueSync(), Access, detectAwaitingInputForAgent(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache (+49 more)
...
Cohesion: 0.04
Nodes (54): listConversations(), markConversationActive(), updateForkStatus(), MessageDeliveryFailed, waitForClaudePrompt(), aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels() (+46 more)
...
Cohesion: 0.04
Nodes (58): assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue(), queryBeadsForIssuePromise() (+50 more)
...
Cohesion: 0.06
Nodes (51): CopyConfigOptions, checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+43 more)

### Community 72 - "Community 72"
Cohesion: 0.05
Nodes (43): appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile(), getEventsFilePath() (+35 more)
...
Cohesion: 0.06
Nodes (55): assertExistingPathInsideRoot(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions, execAsync (+47 more)
...
Cohesion: 0.05
Nodes (37): agentToConversation(), DrawerAgentSession(), DrawerAgentSessionProps, ENDED_AGENT_STATUSES, isEndedAgent(), pickDefaultDrawerAgent(), agents, ActionBar() (+29 more)
...
Cohesion: 0.06
Nodes (47): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContext (+39 more)
...
Cohesion: 0.05
Nodes (42): markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig() (+34 more)
...
Cohesion: 0.07
Nodes (46): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), dequeueMerge(), enqueueMerge(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued() (+38 more)
...
Cohesion: 0.06
Nodes (43): claim(), buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput (+35 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (42): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation() (+34 more)
...
Cohesion: 0.06
Nodes (43): applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig, deepMerge() (+35 more)

### Community 113 - "Community 113"
Cohesion: 0.06
Nodes (40): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+32 more)
...
Cohesion: 0.06
Nodes (34): execAsync, rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, CheckpointError (+26 more)
...
Cohesion: 0.09
Nodes (44): clearFlywheelRunGate(), flywheelAbortCommand(), getFlywheelActiveRunId(), getFlywheelRunPayload(), getFlywheelRunsPayload(), abortFlywheelRun(), clearFlywheelGate(), decodeFlywheelRunId (+36 more)
...
Cohesion: 0.05
Nodes (32): SearchResult, DiscoveredSession, AgentIssueLookup, AgentIssueRecord, buildAgentIssueLookup(), buildEnrichSessionsJobPayload(), EnrichSessionsRpcInput, filterDomainEventForIssue() (+24 more)
...
Cohesion: 0.07
Nodes (37): createHumeConfig(), deleteHumeConfig(), content, d, existingDir, lines, oldDir, result (+29 more)

### Community 140 - "Community 140"
Cohesion: 0.08
Nodes (39): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+31 more)

### Community 141 - "Community 141"
Cohesion: 0.06
Nodes (40): isReviewSessionForIssue(), killAllReviewSessions(), spawnReviewSubRoleForIssue(), agentSrc, content, dashboardStopIdx, dirtyIdx, dispatchFailedMatches (+32 more)

### Community 142 - "Community 142"
Cohesion: 0.07
Nodes (38): inferMemoryProjectId(), retrieveSpawnTimeMemoryContext(), resolveModel(), canUseHarnessSync(), canUseModelWithAuthSync(), GPT_5_5_API_KEY_BLOCK, HarnessPolicyDecision, PI_ANTHROPIC_SUBSCRIPTION_BLOCK (+30 more)
...
Cohesion: 0.06
Nodes (40): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), getAllActiveQueues(), setPipelineHandlerSync(), clearReviewStatus(), ensureManagedTmuxContextOnce(), closeMemoryFtsDatabases(), stopTranscriptPoller() (+32 more)

### Community 146 - "Community 146"
Cohesion: 0.06
Nodes (38): writeFeedbackFile(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, deliverReviewVerdictFeedbackPromise(), DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+30 more)
...
Cohesion: 0.07
Nodes (29): applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, FALLBACK_MAP, filterAvailableModelsSync(), getAvailableModelsSync(), getBestAnthropicAtTier(), getFallbackModelSync() (+21 more)
...
Cohesion: 0.07
Nodes (30): sentinel, emitResetMarkerCreated(), emitMemoryHealthChanged(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore, EventSubscriber (+22 more)
...
Cohesion: 0.09
Nodes (31): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+23 more)
...
Cohesion: 0.14
Nodes (36): extractNumberSync(), archiveWorkspaceArtifactsImpl(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl() (+28 more)

### Community 200 - "Community 200"
Cohesion: 0.09
Nodes (14): countContextTokens(), findSessionFile(), CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getAllSessionFilesSync(), getProjectDirsSync(), getRecentSessionsSync() (+6 more)
...
Cohesion: 0.08
Nodes (29): createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, addTunnelIngressPromise(), cfFetch(), CloudflareCredentials (+21 more)
...
Cohesion: 0.1
Nodes (26): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), IssueStats (+18 more)
...
Cohesion: 0.06
Nodes (35): getConversationsConfig(), resolveConversationWatchDirs(), updateConversationsConfig(), ConfigResponseSchema, ConversationsConfigBodySchema, CostResponseSchema, DiscoveredSessionResponseSchema, discoveredSessionsRouteLayer (+27 more)
...
Cohesion: 0.06
Nodes (31): writeStoryFeatureContext(), transitionIssueState(), transitionIssueToInReview(), writeWorkspaceContext(), execMock, mockCreateTracker, mockDropStash, mockFindWorkspacePath (+23 more)
...
Cohesion: 0.12
Nodes (29): getDefaultTtsDaemonConfig(), mergeTtsConfig(), mergeTtsDaemonConfigs(), YamlConfig, resolveAndSpeak(), speakTts(), ActivityTtsPayload, drainQueue() (+21 more)
...
Cohesion: 0.09
Nodes (24): addCandidateRoot(), collectCandidatePaths(), extractHashFromJsonlPath(), HashResolver, projectCandidateRoots(), ResolvedWorkspace, ReverseMapCache, getAgentWorkspace() (+16 more)
...
Cohesion: 0.11
Nodes (22): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+14 more)
...
Cohesion: 0.12
Nodes (5): enqueueMemoryExtractionJob(), enqueueReconciledMemoryExtractionJobs(), MemoryExtractionWorkerPool, MemoryPipelineWorkerPool, normalizeQueueLimit()

### Community 297 - "Community 297"
Cohesion: 0.12
Nodes (28): FlywheelScope, loadConfigNoMigration(), RoleEffort, assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+20 more)
...
Cohesion: 0.1
Nodes (25): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+17 more)
...
Cohesion: 0.08
Nodes (23): appendCostEvent(), branch, branchMatch, buffer, cavemanVariant, cost, entry, input (+15 more)
...
Cohesion: 0.17
Nodes (21): getContainersReferencingWorkspacePath(), findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches() (+13 more)

### Community 429 - "Community 429"
Cohesion: 0.13
Nodes (14): RoundMarker, ZoneCConversation(), ZoneCConversationProps, resolveWorkTypeKey(), useResolvedModels(), getViewKey(), PanelView, readView() (+6 more)
...
Cohesion: 0.1
Nodes (12): execFileMock, postMergeLifecycleMock, readContinueStateProgramMock, readdirSyncMock, resolveGitHubIssueMock, agentState, getShadowState, mockGetAgentState (+4 more)
...
Cohesion: 0.12
Nodes (16): updateConversationTitle(), client, input, input1, input2, makeClient(), mockConversation, patchCalls (+8 more)
...
Cohesion: 0.16
Nodes (13): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand(), projectShowCommand() (+5 more)
...
Cohesion: 0.21
Nodes (13): array, combine, hash(), number(), optimize(), random(), structure(), structureKeys() (+5 more)

### Community 584 - "Community 584"
Cohesion: 0.19
Nodes (12): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), validBackoffSchedule(), HealthThresholds, config, customConfig (+4 more)
...
Cohesion: 0.27
Nodes (11): execAsync, formatDuration(), generateReport(), parseTestOutput(), RunTestsOptions, runTestsPromise(), runTestSuite(), sendNotification() (+3 more)
...
Cohesion: 0.18
Nodes (8): archiveWorkspaceArtifacts(), movePrd(), activeDir, completedDir, ctx, { mockExecAsync }, result, wsPath
...
Cohesion: 0.22
Nodes (8): listener(), electron, IPC, result, wrapped(), notifyVoiceSettings(), publishFlywheelStatusCleared(), publishLatestFlywheelStatus()
...
Cohesion: 0.29
Nodes (6): fetchWithRetry(), isNetworkError(), RETRY_DELAYS, Issue, main(), parseArgs()
...
## Knowledge Gaps
- **13663 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13658 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 1035`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 30`, `Community 31`, `Community 35`, `Community 37`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 64`, `Community 67`, `Community 68`, `Community 583`, `Community 75`, `Community 589`, `Community 81`, `Community 82`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 97`, `Community 101`, `Community 105`, `Community 106`, `Community 111`, `Community 118`, `Community 120`, `Community 638`, `Community 126`, `Community 130`, `Community 138`, `Community 139`, `Community 142`, `Community 146`, `Community 662`, `Community 154`, `Community 667`, `Community 669`, `Community 672`, `Community 162`, `Community 165`, `Community 171`, `Community 174`, `Community 181`, `Community 189`, `Community 709`, `Community 199`, `Community 215`, `Community 220`, `Community 234`, `Community 245`, `Community 246`, `Community 247`, `Community 257`, `Community 259`, `Community 799`, `Community 806`, `Community 322`, `Community 340`, `Community 343`, `Community 350`, `Community 354`, `Community 884`, `Community 372`, `Community 400`, `Community 401`, `Community 404`, `Community 431`, `Community 475`, `Community 485`, `Community 491`, `Community 495`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 44` to `Community 1`, `Community 259`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 402`, `Community 20`, `Community 22`, `Community 24`, `Community 26`, `Community 282`, `Community 28`, `Community 32`, `Community 289`, `Community 290`, `Community 36`, `Community 170`, `Community 429`, `Community 46`, `Community 47`, `Community 48`, `Community 174`, `Community 50`, `Community 54`, `Community 56`, `Community 57`, `Community 61`, `Community 320`, `Community 709`, `Community 70`, `Community 714`, `Community 202`, `Community 590`, `Community 1104`, `Community 208`, `Community 80`, `Community 1105`, `Community 85`, `Community 86`, `Community 215`, `Community 342`, `Community 218`, `Community 475`, `Community 92`, `Community 349`, `Community 222`, `Community 96`, `Community 97`, `Community 353`, `Community 101`, `Community 249`, `Community 103`, `Community 232`, `Community 233`, `Community 494`, `Community 884`, `Community 758`, `Community 761`, `Community 635`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 32` to `Community 321`, `Community 322`, `Community 3`, `Community 164`, `Community 5`, `Community 35`, `Community 14`, `Community 559`, `Community 17`, `Community 401`, `Community 23`, `Community 250`, `Community 219`, `Community 189`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13663 weakly-connected nodes found - possible documentation gaps or missing edges._
