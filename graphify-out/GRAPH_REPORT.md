# Graph Report - feature-pan-1370  (2026-05-23)

## Corpus Check
- 1936 files · ~3,154,548 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27599 nodes · 43357 edges · 1320 communities (1260 shown, 60 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 801 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `825a3f82`
...
8. `jsonResponse()` - 57 edges
9. `spawnRun()` - 56 edges
10. `spawnAgent()` - 54 edges
...
## Communities (1320 total, 60 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (165): InlineSparkline(), InlineSparklineProps, REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle (+157 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (183): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+175 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (165): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (160): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (141): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ConversationPanel() (+133 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (139): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, ZoneA() (+131 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (158): spawnInspectAgentPromise(), renderPrompt(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, tellCommand(), reactivateConversationForSpawn(), ActivityEntry (+150 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (150): forkCommand(), ForkOptions, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryFork(), createSummaryForkPromise(), findLastCompactBoundaryOffset() (+142 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (120): EventRouter(), error, replayPromise, request, snapshot, unsubscribe, classifyStreamLine(), DrawerActiveAgent() (+112 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (130): buildActiveSliceContext(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), DASHBOARD_URL, difficultyColor(), dryRun(), isSwarmRecoverAction() (+122 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (102): ComposerMode, IssueComposerProps, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (99): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, callApi(), CommandPalette(), CommandPaletteProps, EMPTY_AGENTS, EMPTY_ISSUES, EMPTY_SEARCH (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (86): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+78 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (98): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+90 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (101): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+93 more)
...
Cohesion: 0.03
Nodes (83): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinksProps, CloseOutIssueButton(), CloseOutIssueButtonProps (+75 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (104): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+96 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (99): agentDir, dir1, dir2, marker, missing, nested, cb, cmdArgs (+91 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (91): recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname (+83 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (84): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+76 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (94): getReviewerSessionName(), parseReviewerSessionName(), Access, getAgentWorkspace(), encodeClaudeProjectDir(), getIssueDataService(), ActivityContext, awaitingInputFromProjection() (+86 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (87): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (76): ActivityFeedSidebar(), ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first (+68 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (82): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), findSpecByIssue(), getProjectPanPaths(), listSpecs(), mapVBriefPlanStatusToPanSpec(), parsePanSpecDocumentFromString() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (81): checkHeartbeat(), exec(), execMock, execResponses, kCustom, mockIsRunning, mockResolve, result (+73 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (82): buildChildEnvSync(), buildChildEnvWithoutTmuxSync(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, agentState (+74 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (81): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions (+73 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (79): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+71 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (76): transitionIssueToVerifyingOnMain(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions (+68 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (85): writeObservationRecord(), writeStatus(), writeDecision(), assertMemorySafeSegment(), assertUnderMemoryBase(), dateKey(), ensureDir(), ensureParentDir() (+77 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (67): buildACLookupByTitle(), criteria, doc, result, { projectPath, workspacePath }, promoted, specFiles, fsHooks (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (72): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+64 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (66): format(), LiveCounter(), LiveCounterProps, ACTIVE_AGENT_STATUSES, agentForFeature(), BucketedFeature, bucketFeaturePhase(), classifierAgent() (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (82): updateConversationsConfig(), postAgentMessageLikeRoute(), validateAgentDeliveryMethodOrigin(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+74 more)
...
Cohesion: 0.03
Nodes (72): ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState(), ContainerPortBinding, ContainerServiceHealth, deleteWorkspacePendingRoute (+64 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (72): buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readPendingFeedback(), readPlanningContext() (+64 more)
...
Cohesion: 0.03
Nodes (66): DEFAULT_FLYWHEEL_CONFIG, fetchFlywheelConversation(), fetchJson(), findFlywheelConversation(), FlywheelConversationPane(), FlywheelConversationPaneProps, FlywheelPaneViewMode, FlywheelRoleConfig (+58 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (63): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), buildHandoffPrompt(), captureHandoffContext(), detectHandoffMethod() (+55 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (73): updateTtsConfig(), defaults, first, { models }, second, clearConfigCache(), ModelRef, RoleConfig (+65 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (54): checkCommand(), syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion(), isNewer(), updateCommand(), ensureExcalidrawMcpSync() (+46 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (59): conversationsTab, firstLens, lens, overview, tablist, ConversationList(), CommandDeck(), CommandDeckProps (+51 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (74): add, addIn(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), applyReviver(), asItemIndex() (+66 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (64): embedAction(), ScanOptions, normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+56 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (64): resetDb(), resetDb(), insertCostEvent(), closeDatabase(), getDatabase(), getDatabasePath(), isBunRuntime(), _require (+56 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (62): extractNumberSync(), archiveWorkspaceArtifactsImpl(), execAsync, movePrdImpl(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl(), applyLabelLinear() (+54 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (58): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+50 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (66): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+58 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (50): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanel(), BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, AC_STATUS_COLORS, AC_STATUS_SYMBOL (+42 more)
...
Cohesion: 0.03
Nodes (48): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+40 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (56): pendingCommand(), after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus() (+48 more)
...
Cohesion: 0.04
Nodes (51): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+43 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (52): confirmCost(), enrichAction(), formatCost(), markEnrichmentFailed(), searchFts(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+44 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (50): queryCostEvents(), costEvents, extractedTurn(), identity, rollupJobs, statuses, transcriptPath, closeMemoryFtsDatabases() (+42 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (56): parseWalFile(), SyncResult, syncWalFromAllProjectsPromise(), syncWalFromDirPromise(), AgentRollup, CavemanExperimentRow, dailySpendCache, dailySpendCacheKey() (+48 more)
...
Cohesion: 0.06
Nodes (59): acquireStartLock(), buildManagedProcessIdentity(), buildTtsDaemonEnv(), clearState(), clearTtsDaemonManualStopGate(), defaultAllowedOrigins(), execFileAsync, fetchDaemonHealth() (+51 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (44): appendCostEvent(), appendCostEventSync(), CostEvent, deduplicateEventsSync(), ensureEventsFile(), EventMetadata, getCostsDir(), getEventsFile() (+36 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (50): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContextPromise(), execAsync, HandoffContextError, serializeHandoffContext() (+42 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (24): CLAUDE_PROJECTS_DIR, ClaudeMessage, getActiveSessionModelSync(), getProjectDirsSync(), getRecentSessionsSync(), getSessionFilesSync(), importSessionToCostLog(), normalizeModelName() (+16 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (55): cosineSimilarity(), getFtsRow(), insertEmbedding(), replaceDiscoveredSessionArrayIndexes(), replaceFtsRow(), replaceSessionArrayIndex(), rowToSession(), updateEnrichment() (+47 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (57): buildDefaultTtsTestVoice(), buildTtsSpeakPayload(), deleteTtsVoiceByName(), findVoiceByNameOrReport(), formatMegabytes(), formatSeconds(), formatTtsDaemonStatus(), formatVoiceDetails() (+49 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (38): branch, branchMatch, buffer, cavemanVariant, cost, entry, input, lines (+30 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (51): agentDir, missing, snapshot, status, AgentEnrichment, computeAgentEnrichment(), getAgentJsonlMtime(), discoverNewAgentIds() (+43 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (36): chunks, emitter, googleMocks, stream, emitter, onTurn, queue, DEFAULT_VOICE_SETTINGS (+28 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (51): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+43 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (52): deletePRDDraft(), deletePRDDraftPromise(), getPRDDraftInfo(), getPRDDraftInfoPromise(), getPRDDraftPath(), hasPRDDraft(), hasPRDDraftPromise(), listPRDDrafts() (+44 more)
...
Cohesion: 0.05
Nodes (51): computeAgentEnrichmentPromise(), execAsync, getActiveSessionPath(), getAgentJsonlMtimePromise(), getAgentJsonlPath(), getAgentJsonlPathPromise(), getAgentPendingQuestions(), getAgentPendingQuestionsPromise() (+43 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (53): bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+45 more)
...
Cohesion: 0.06
Nodes (52): assertExistingPathInsideRoot(), clearFlywheelRunGate(), commitFlywheelStateChanges(), createInitialFlywheelStatus(), dashboardBaseUrl(), decodeFlywheelStatus, emitStatusCommand(), EmitStatusOptions (+44 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (23): importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), IssueDataService, issuesChanged(), mapRallyStateToCanonical(), PLANNING_FINISHED_STATUSES (+15 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (47): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+39 more)
...
Cohesion: 0.04
Nodes (55): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, AgentOutput, ChatMessage (+47 more)

### Community 83 - "Community 83"
Cohesion: 0.04
Nodes (50): result, clearCacheRoute, ConfirmationRequest, deletePlanningSessionRoute, execAsync, getCacheStatusRoute, getConfirmationsRoute, getDeaconLogsRoute (+42 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (43): booleanOrDefault(), defaultMemorySettings(), getMemoryRollupPendingThreshold(), getMemoryWorkerConcurrency(), isMemoryPromptTimeInjectionEnabled(), isRecord(), loadMemorySettings(), MemorySettings (+35 more)

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (42): buildManifestFromDirectory(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), FileStatus, hashFileSync(), Manifest, ManifestEntry (+34 more)
...
Cohesion: 0.06
Nodes (37): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, WorkLogEntry, FailedMessage, AssistantMessageRow(), formatElapsed() (+29 more)
...
Cohesion: 0.07
Nodes (32): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, syncWalFromAllProjects(), IssueAggregate, BUDGETS_FILE (+24 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (43): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync, formatDuration() (+35 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (41): containerRestartBackoffMs(), DeaconState, isMergeAgentRunning(), customPromisify, justNow, longAgo, old, recent (+33 more)

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (39): buildPolyrepoContext(), registerTestCommands(), runCommand(), RunOptions, cloneReposOnVm(), collectPanWorkspaceFiles(), convertToSshUrl(), copyPlanningStateFromRemote() (+31 more)

### Community 93 - "Community 93"
Cohesion: 0.05
Nodes (39): sentinel, cache, db, loaded, row, rows, savedRow, snapshot (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (47): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+39 more)
...
Cohesion: 0.07
Nodes (40): appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogsSync(), cleanupOldLogsSync(), createRunLogSync(), ensureRunsDirectory(), finalizeRunLogSync(), generateRunId() (+32 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (30): TurnDiffSummary, DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState() (+22 more)
...
Cohesion: 0.05
Nodes (28): estimateCost(), CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore() (+20 more)
...
Cohesion: 0.07
Nodes (40): closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), doneCommand(), DoneOptions, execAsync (+32 more)
...
Cohesion: 0.08
Nodes (38): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+30 more)
...
Cohesion: 0.07
Nodes (38): deleteHumeConfig(), content, d, existingDir, lines, oldDir, result, skillDir (+30 more)

### Community 116 - "Community 116"
Cohesion: 0.06
Nodes (43): AIProvider, appendJsonl(), readTranscriptSlice(), buildConversationResponse(), getCachedMessages(), isPiSessionFile(), activitySummaryCache, claudeProjectDir() (+35 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (43): decodeFlywheelStatus, getFlywheelRunPayload(), getFlywheelRunsPayload(), postFlywheelStatusPayload(), decodeFlywheelRunId, decodeFlywheelStatus, decodeLaunchMetadata(), deriveRunStatus() (+35 more)
...
Cohesion: 0.09
Nodes (30): parsePiSessionSync(), ProcessSpawnError, TmuxError, CLAUDE_PROJECTS_DIR, SessionIndexEntry, agentDirFor(), agentsDir(), heartbeatsDir() (+22 more)
...
Cohesion: 0.08
Nodes (39): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), destroyCommand(), DestroyOptions (+31 more)

### Community 128 - "Community 128"
Cohesion: 0.08
Nodes (41): isRecord(), isSubagentHookPayload(), SubagentHookPayload, enqueuePipeline, getTranscriptSize, registerTranscript, response, statTranscript (+33 more)

### Community 129 - "Community 129"
Cohesion: 0.1
Nodes (39): contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand(), LayerName (+31 more)
...
Cohesion: 0.07
Nodes (30): applyTierAwareFallbackSync(), detectEnabledProvidersSync(), ENRICHMENT_TIER_MAX_MESSAGES, EnrichmentTierConfig, FALLBACK_MAP, filterAvailableModelsSync(), getAvailableModelsSync(), getBestAnthropicAtTier() (+22 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (35): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), generateHealthSummary(), getAgentHealth(), getAgentsNeedingAttention(), getAgentsToKill() (+27 more)
...
Cohesion: 0.06
Nodes (32): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+24 more)
...
Cohesion: 0.07
Nodes (38): AvailableModel, AvailableModelsResponse, ClaudeAuthStatus, DEFAULT_FLYWHEEL_CONFIG, DEFAULT_WORKHORSES, displayModelRef(), Effort, fetchAvailableModels() (+30 more)
...
Cohesion: 0.07
Nodes (33): contextDiffCommand(), renderLayerForHarness(), assembleWorkspaceContext(), claude, out, pf, WorkspaceContextInput, HARNESS_MARKERS (+25 more)
...
Cohesion: 0.06
Nodes (27): ActivitySection, formatModel(), IsolationMode(), IsolationModeProps, TYPE_STYLES, ALLOWED_CSS_PROPERTIES, ALLOWED_SHIKI_ATTRS, ALLOWED_SHIKI_TAGS (+19 more)
...
Cohesion: 0.06
Nodes (32): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), DEFAULT_GATES, runQualityGates(), calls, cmd (+24 more)
...
Cohesion: 0.08
Nodes (34): eventsFileExists(), getLastEventMetadataSync(), AgentContext, findSessionDirsByIssue(), getAgentsDir(), getClaudeProjectsDir(), getProjectPaths(), getProjectsYamlPath() (+26 more)

### Community 164 - "Community 164"
Cohesion: 0.07
Nodes (27): createClaudeCodeRuntimeSync(), getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry(), createPiRuntimeSync(), PiSpawnTimeout (+19 more)
...
Cohesion: 0.06
Nodes (32): DEFAULTS, UIPreferences, useUIPreferences(), ACTIVITY_SOURCE_OPTIONS, DEFAULT_VOICE_HARDWARE_SETTINGS, DEFAULT_VOICE_SETTINGS, fetchOpenRouterCatalog(), fetchSettings() (+24 more)
...
Cohesion: 0.06
Nodes (32): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), Handler, PipelineEvent, setPipelineHandlerSync(), clearReviewStatus(), ensureManagedTmuxContextOnce(), stopTranscriptPoller() (+24 more)

### Community 174 - "Community 174"
Cohesion: 0.06
Nodes (34): registerFlywheelCommands(), getFlywheelConversationPayload(), postFlywheelPausePayload(), postFlywheelResumePayload(), postFlywheelStartPayload(), subscribeLatestFlywheelStatus(), abort, aborted (+26 more)
...
Cohesion: 0.1
Nodes (27): addEventToCache(), CostCache, createEmptyCache(), getCacheFile(), getCacheStatus(), getCostsByIssueSync(), getCostsDir(), getCostsForIssueSync() (+19 more)

### Community 182 - "Community 182"
Cohesion: 0.08
Nodes (25): execAsync, rebaseFeatureBranchPromise(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+17 more)
...
Cohesion: 0.07
Nodes (32): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+24 more)
...
Cohesion: 0.07
Nodes (29): updateProviderApiKey(), getAvailableModelsRoute, getClaudeAuthRoute, getHarnessPolicyRoute, getMiniMaxDefaultsRoute, getOpenAIAuthRoute, getOpenRouterModelsRoute, getOptimalDefaultsRoute (+21 more)
...
Cohesion: 0.09
Nodes (26): buildCorrelationMapSync(), CorrelationResult, scanAction(), collectJsonlFiles(), discoverJsonlFiles(), filterByMode(), normalizeDir(), projectDirMatchesAnyTarget() (+18 more)
...
Cohesion: 0.1
Nodes (29): acquireRestartLock(), acquireRestartLockPromise(), acquireStaleBreaker(), isErrnoException(), isProcessAlive(), isStale(), readHolderFromPath(), readRestartLockHolder() (+21 more)
...
Cohesion: 0.1
Nodes (33): BudgetKey, buildContext(), CandidateContext, countHits(), emptyAllocations(), emptyHitCounts(), escapeJsonForPrompt(), estimateTokens() (+25 more)
...
Cohesion: 0.07
Nodes (26): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact(), CreateReviewArtifactInput, CreateReviewArtifactResult (+18 more)

### Community 214 - "Community 214"
Cohesion: 0.08
Nodes (25): getWindowDimensions(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub, removeClientFromHub() (+17 more)
...
Cohesion: 0.12
Nodes (33): sshCommand(), CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult (+25 more)

### Community 217 - "Community 217"
Cohesion: 0.09
Nodes (23): createFlyApiClientSync(), execAsync, FlyProviderConfig, { execAsyncMock, spawnMock, mockApi }, fly, p, createFlyProviderFromConfig(), getRemoteProvider() (+15 more)
...
Cohesion: 0.09
Nodes (28): AlsoSyncTool, collectSkillDirs(), extractSkillName(), MultiToolSyncResult, readSkillContent(), resolveAlsoSyncToolsSync(), runMultiToolSyncSync(), stripFrontmatter() (+20 more)
...
Cohesion: 0.09
Nodes (19): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, ProjectConfig, after, before, cfg, compose (+11 more)
...
Cohesion: 0.11
Nodes (31): addCommentBefore(), anchorIsValid(), captureTldrMetricsSync(), createStringifyContext(), format(), formatPropertyKey(), getTagObject(), getTldrMetricsSync() (+23 more)
...
Cohesion: 0.07
Nodes (27): agentDir, body, commit, dir, files, launcher, LEGACY_FIELDS, legacyFields (+19 more)
...
Cohesion: 0.07
Nodes (20): readFeatureContext(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig, mockStatSync (+12 more)

### Community 263 - "Community 263"
Cohesion: 0.17
Nodes (24): GitHubApiError, LinearApiError, AnyTrackerError, Comment, Issue, IssueFilters, IssueNotFoundError, IssueState (+16 more)
...
Cohesion: 0.1
Nodes (11): issues, result, CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry, openSqliteDb() (+3 more)

### Community 267 - "Community 267"
Cohesion: 0.09
Nodes (26): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate(), ResolveAndSpeakDeps (+18 more)
...
Cohesion: 0.12
Nodes (20): cvCommand(), CVOptions, relativeTime(), showCommand(), ShowOptions, calls, logSpy, now (+12 more)
...
Cohesion: 0.1
Nodes (21): buildMenuTemplate(), configureApplicationMenu(), fetchActiveWorkspaces(), rebuildMenu(), WorkspaceSummary, checkForUpdates(), currentStatus, getUpdateStatus() (+13 more)

### Community 275 - "Community 275"
Cohesion: 0.1
Nodes (26): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+18 more)
...
Cohesion: 0.1
Nodes (25): autoRevertMerge(), autoRevertMergePromise(), execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation() (+17 more)

### Community 287 - "Community 287"
Cohesion: 0.08
Nodes (26): calculateCostSync(), CostEntry, DEFAULT_PRICING, getPricingSync(), logUsageSync(), ModelPricing, anthropicModels, cost (+18 more)

### Community 288 - "Community 288"
Cohesion: 0.1
Nodes (23): err, exec(), execFile(), execMock, kCustom, prompt, spawnRunMock, tmuxCapturePaneAsyncMock (+15 more)
...
Cohesion: 0.1
Nodes (27): applyEvent(), bumpRuntimeSnapshotSequence(), DashboardLifecycleState, defaultRuntimeSnapshot(), getMaxMemoryObservationsPerIssue(), getMaxTurnDiffSummariesPerAgent(), MemoryHealthSnapshot, MemoryReadModelState (+19 more)
...
Cohesion: 0.07
Nodes (28): CLI Distribution Strategy, code:block109 (~/.panopticon/), code:yaml (# ~/.panopticon/traefik/dynamic/feature-min-648.yml), code:toml ([panopticon]), code:toml ([project]), code:bash (# First time - zero install), code:bash (# pan init adds to ~/.bashrc or ~/.zshrc:), code:bash (npm install -g panopticon) (+20 more)
...
Cohesion: 0.11
Nodes (20): createTerminalWindow(), createWindow(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerEntry(), resolveWindowUrl() (+12 more)

### Community 303 - "Community 303"
Cohesion: 0.11
Nodes (20): pruneCheckpointRefsForAgents(), pruneStaleCheckpointRefs(), CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, executeCloseOutPromise() (+12 more)

### Community 304 - "Community 304"
Cohesion: 0.11
Nodes (24): AnthropicContentBlock, AnthropicInputBlock, AnthropicMessage, AnthropicMessageResponse, AnthropicMessagesRequest, emptyBlock(), ensureOpenAICompatibleProxyRunningPromise(), getProxyPathname() (+16 more)

### Community 305 - "Community 305"
Cohesion: 0.15
Nodes (26): reconcileClosedPrReadyForMerge(), reconcileFalseMerged(), apiCatch(), APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateInstallationTokenPromise() (+18 more)

### Community 306 - "Community 306"
Cohesion: 0.11
Nodes (22): DatabaseError, dequeueMerge(), enqueueMerge(), getCurrentMerge(), markMergeProcessing(), MergeQueueEntry, resetProcessingToQueued(), next (+14 more)
...
Cohesion: 0.11
Nodes (17): cleanupPiTransientFiles(), execAsync, createPiFifo(), createPiFifoPromise(), destroyPiFifoSync(), execAsync, PiFifoError, PiFifoPaths (+9 more)

### Community 309 - "Community 309"
Cohesion: 0.13
Nodes (21): CLAUDE_DIR, createClaudeAdapter(), createClaudeAdapterSync(), createRuntimeRegistry(), getInstalledRuntimesPromise(), getRuntimeAdapter(), getSupportedRuntimes(), isRuntimeInstalled() (+13 more)
...
Cohesion: 0.12
Nodes (19): beadsDir, doc, getVBriefACStatusSync(), syncBeadStatusToVBrief(), BeadRecord, checkOpenBeads(), checkOpenBeadsPromise(), checkUncommittedChanges() (+11 more)

### Community 312 - "Community 312"
Cohesion: 0.1
Nodes (15): configShadowCommand(), ShadowOptions, ENV_KEYS, EnvSnapshot, PanopticonConfig, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnvSync() (+7 more)
...
Cohesion: 0.09
Nodes (18): ConversationsConfig, ConversationsEnrichmentConfig, deepMerge(), DEFAULT_CONFIG, getConversationsConfigSync(), GitHubConfig, GitLabConfig, LinearConfig (+10 more)
...
Cohesion: 0.12
Nodes (22): findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, selectSessionIdsForEmbedding(), embed(), EmbeddingProviderName, EmbeddingResult (+14 more)
...
Cohesion: 0.19
Nodes (24): appendLineColumnFromHash(), basenameOfPath(), hasExternalScheme(), inferHomeFromCwd(), isAbsolutePath(), isLikelyPathCandidate(), isRelativePath(), isWindowsAbsolutePath() (+16 more)
...
Cohesion: 0.11
Nodes (16): NormalizedTtsDaemonConfig, getTtsDaemonStatus(), hasTtsDaemonState(), isTtsDaemonManuallyStopped(), startTtsDaemon(), waitForTtsDaemonHealthPromise(), checkTtsHealth(), startTtsDaemonFromDashboard() (+8 more)
...
Cohesion: 0.14
Nodes (22): isNoResumeValueEnabled(), NO_RESUME_MODE_ACTIVE, TRUTHY_NO_RESUME_VALUES, formatGatingReason(), formatRestartAge(), formatRestartDuration(), formatTldrAge(), formatTldrRow() (+14 more)
...
Cohesion: 0.13
Nodes (22): clearFeedbackFilesPromise(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath() (+14 more)
...
Cohesion: 0.1
Nodes (22): CategoryFilter, formatContextLength(), formatCost(), ModelCard(), OpenRouterModel, OpenRouterModelBrowser(), OpenRouterModelBrowserProps, fetchOpenRouterModels() (+14 more)

### Community 349 - "Community 349"
Cohesion: 0.14
Nodes (20): resolveAndSpeak(), speakTts(), StoredEvent, ActivityTtsPayload, drainQueue(), dropIndexForFullQueue(), enqueueActivityTts(), eventPriority() (+12 more)

### Community 350 - "Community 350"
Cohesion: 0.13
Nodes (17): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+9 more)
...
Cohesion: 0.12
Nodes (18): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+10 more)
...
Cohesion: 0.08
Nodes (21): content, db, event, goodLine, history, ids, latest, lines (+13 more)
...
Cohesion: 0.14
Nodes (18): resolveProjectFromIssue(), getWorkspacePathForIssue(), readWorkspacePlanningMarkdown(), getWorkspacePathForIssue(), asPanRpcError(), isInsidePath(), LANGUAGE_BY_EXTENSION, languageForPath() (+10 more)
...
Cohesion: 0.17
Nodes (20): checkCostLimits(), checkDailyReset(), COST_DATA_FILE, CostAlert, CostAlertLevel, CostData, CostDataPersisted, getAgentCost() (+12 more)
...
Cohesion: 0.13
Nodes (19): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+11 more)

### Community 400 - "Community 400"
Cohesion: 0.19
Nodes (21): healthCommand(), HealthOptions, AgentHealth, formatHealthStatus(), getAgentHealth(), getAgentOutput(), getHealthFile(), handleStuckAgent() (+13 more)
...
Cohesion: 0.17
Nodes (21): findAllWorkspacePaths(), findWorkspacePath(), buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), isDockerContainerProcess() (+13 more)

### Community 423 - "Community 423"
Cohesion: 0.13
Nodes (19): buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+11 more)
...
Cohesion: 0.19
Nodes (15): startPostLaunchSidecars(), startSidecars(), restartCommand(), runFullRestart(), readPlatformConfigSync(), getSupervisorPortSync(), getSupervisorUrlSync(), isProcessAlive() (+7 more)

### Community 441 - "Community 441"
Cohesion: 0.17
Nodes (17): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), buildReviewSubRoleCommand(), generateLauncherWrapperSync(), LauncherConfig, LauncherHarness (+9 more)

### Community 442 - "Community 442"
Cohesion: 0.15
Nodes (18): transitionIssueState(), transitionIssueToInReview(), mockCreateTracker, mockCreateTrackerFromConfig, mockFindProjectByPath, mockGetIssuePrefix, mockTracker, warnSpy (+10 more)
...
Cohesion: 0.15
Nodes (18): CavemanVariant, determineCavemanVariant(), HookEntry, injectCavemanSettings(), injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript() (+10 more)

### Community 446 - "Community 446"
Cohesion: 0.1
Nodes (19): Capability, ModelDef, MODELS_BY_PROVIDER, OpenRouterFavoriteModel, ProviderDef, buildMiniMaxFormData(), buildTtsAutosavePayload(), ModelId (+11 more)
...
Cohesion: 0.15
Nodes (14): consumeDashboardBootstrapToken(), createPanRpcProtocolLayer(), dashboardMutationJsonHeaders(), dashboardSessionUrl(), DEFAULT_RETRY_DELAY, ensureDashboardSession(), formatError(), makePanRpcClient (+6 more)

### Community 461 - "Community 461"
Cohesion: 0.12
Nodes (18): CostThresholdDetails, embedSession(), EnrichRequest, enrichSession(), fetchSession(), formatDate(), fromRpcSession(), parseCostThreshold() (+10 more)

### Community 462 - "Community 462"
Cohesion: 0.13
Nodes (16): AddOptions, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand(), projectListCommand(), projectRemoveCommand(), projectShowCommand() (+8 more)

### Community 463 - "Community 463"
Cohesion: 0.15
Nodes (16): getShadowModeStatus(), getShadowModeStatusPromise(), getShadowModeSummary(), hasProjectShadowConfig(), isShadowModeEnabled(), isShadowModeEnabledPromise(), resolveShadowMode(), resolveShadowModePromise() (+8 more)
...
Cohesion: 0.18
Nodes (18): HandoffContext, ensureLogDir(), ensureLogDirAsync(), getHandoffStats(), getPendingVerificationHandoffs(), getPendingVerificationHandoffsSync(), HANDOFF_LOG_FILE, HandoffEvent (+10 more)

### Community 477 - "Community 477"
Cohesion: 0.19
Nodes (13): resolvePreferredEditor(), editorIconFor(), EDITOR_LABELS, PanOpenInPicker(), PanOpenInPickerProps, rendered, wsTransportMock, openFavoriteEditor() (+5 more)

### Community 478 - "Community 478"
Cohesion: 0.11
Nodes (15): RoundMarker, deriveRoundMarkers(), TimestampedItem, markers, MESSAGES, meta, divider, dividers (+7 more)
...
Cohesion: 0.11
Nodes (16): eightDaysAgo, events, payload, r1, r2, received, recent, remaining (+8 more)
...
Cohesion: 0.18
Nodes (15): getForgeAdapter(), ensureMergeSetForIssueSync(), upsertMergeSetSync(), withRepoArtifactUrlSync(), withRepoStateSync(), buildRichReviewArtifactBody(), createReviewArtifactsForIssue(), createReviewArtifactsForIssuePromise() (+7 more)

### Community 492 - "Community 492"
Cohesion: 0.14
Nodes (16): assertIssueHasBeadsPromise(), BeadEntry, BeadsMissingError, execFileAsync, queryBeadById(), queryBeadByIdPromise(), queryBeadsForIssue(), queryBeadsForIssuePromise() (+8 more)
...
Cohesion: 0.17
Nodes (7): extractPrefixSync(), extractStandardNumberSync(), extractStandardPrefixSync(), normalizeIssueIdSync(), ParsedIssueId, parseIssueIdSync(), result

### Community 518 - "Community 518"
Cohesion: 0.2
Nodes (15): buildSessionIndex(), decodeClaudeDirName(), extractCostEvents(), extractSessionId(), getAgentsDir(), getClaudeProjectsDir(), getSessionOffset(), inferIssueFromPath() (+7 more)
...
Cohesion: 0.21
Nodes (16): pauseFlywheel(), flywheelAbortCommand(), pauseFlywheelRun(), readFlywheelGateSnapshot(), DatabaseError, getFlywheelActiveRunId(), getSettingProgram(), isDeaconGloballyPaused() (+8 more)

### Community 522 - "Community 522"
Cohesion: 0.12
Nodes (13): ensuredLabels, mockGitHubAddLabel, mockGitHubCloseIssue, mockGitHubEnsureLabel, mockGitHubRemoveLabel, mockGitHubReopenIssue, mockLinearGetIssue, mockLinearGetTeamStates (+5 more)
...
Cohesion: 0.19
Nodes (10): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackupsSync(), createBackupSync(), createBackupTimestamp(), listBackupsSync() (+2 more)
...
Cohesion: 0.12
Nodes (16): Basic Usage, Cleanup After Shutdown, code:bash (# Stop all Panopticon services), code:bash (# Clean up log files), code:bash (# Monitor in one terminal), code:bash (# Clean up stale resources), Monitoring Shutdown, More Information (+8 more)
...
Cohesion: 0.2
Nodes (12): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getTldrDaemonServiceSync() (+4 more)
...
Cohesion: 0.12
Nodes (16): code:typescript (export function validateRallyConfig(config: RallyConfig): {), code:typescript (private async pollRally(): Promise<void> {), code:typescript (// POST /api/rally/validate - Test Rally connection and conf), code:typescript (describe('Rally Integration', () => {), code:markdown (### Rally Troubleshooting), code:block15, code:block16 (This will log the actual WSAPI queries being sent.), code:typescript (const mock = new RallyApiMock();) (+8 more)
...
Cohesion: 0.26
Nodes (13): getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsDaemonConfigs(), cloneTtsConfig(), currentConfig, findProjectRootAsync(), pathExists(), readProjectConfig() (+5 more)

### Community 568 - "Community 568"
Cohesion: 0.19
Nodes (14): array, combine, hash(), number(), optimize(), random(), structure(), structureKeys() (+6 more)

### Community 569 - "Community 569"
Cohesion: 0.16
Nodes (10): TrackerError, RallyApiConfig, RallyCreateConfig, RallyCreateResult, RallyQueryConfig, RallyQueryResult, RallyRestApi, RallyUpdateConfig (+2 more)
...
Cohesion: 0.15
Nodes (13): deliverReviewVerdictFeedback(), after, callback, command, commit, files, mockExecCallback, mockResolveProject (+5 more)
...
Cohesion: 0.23
Nodes (13): sessionFilePath(), buildContinuation(), convertConversationTranscript(), convertConversationTranscriptPromise(), ConvertOptions, ConvertResult, extractClaudeTranscript(), extractContentText() (+5 more)
...
Cohesion: 0.22
Nodes (9): CacheEntry, clearSnapshotCache(), loadSnapshotFromCache(), saveSnapshotToCache(), serialize(), bigSnapshot, err, loaded (+1 more)
...
Cohesion: 0.18
Nodes (9): archivePlanning(), archiveWorkspaceArtifacts(), movePrd(), activeDir, completedDir, ctx, { mockExecAsync }, result (+1 more)
...
Cohesion: 0.17
Nodes (11): CLI Command Reference, code:bash (# Single issue), code:bash (bd ready), Dependency Types, Human-Readable Output, Issue Types, JSON Output (Recommended for Agents), Output Formats (+3 more)
...
Cohesion: 0.18
Nodes (9): evaluateAgentStartGate(), evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), hasActiveAgentGateOrRetry(), resolveAgentCountEnv(), SystemHealthSnapshot, decision, DeepPartial (+1 more)
...
Cohesion: 0.24
Nodes (6): ensurePlaywrightIsolationSync(), EXCALIDRAW_MCP_DEFAULT, getIsolatedPlaywrightMcpConfigSync(), changed, config, result
...
Cohesion: 0.33
Nodes (8): execAsync, RebaseAllResult, rebaseAndPushRepos(), rebaseAndPushReposPromise(), RebaseError, rebaseOneRepo(), RebaseResult, tryResolvePlanningConflicts()
...
Cohesion: 0.22
Nodes (7): agentState, getShadowState, mockGetAgentState, mockGetAgentStateAsync, mockGetReviewStatus, mockGetShadowState, mockResumeAgent
...
Cohesion: 0.31
Nodes (7): isErrnoException(), readRestartStatusPromise(), RestartStatus, RestartStatusError, restartStatusPath(), RestartTrigger, writeRestartStatusPromise()
...
Cohesion: 0.22
Nodes (6): body, ClaudeAuthOverride, putCall, settingsPayload, settingsWithAnthropicEnabled, user

### Community 819 - "Community 819"
Cohesion: 0.42
Nodes (7): basenameOfPath(), canonicalizeWindowsDrivePath(), formatWorkspaceRelativePath(), normalizePathSeparators(), splitPathAndPosition(), stripRelativePrefixes(), trimTrailingPathSeparators()
...
Cohesion: 0.32
Nodes (6): agentDir(), AGENTS_DIR, cleanup(), ctxFile(), id, ids

### Community 897 - "Community 897"
Cohesion: 0.25
Nodes (4): after, doc, filename, path
...
Cohesion: 0.38
Nodes (4): resetCommand(), ResetOptions, wakeCommand(), WakeOptions
...
Cohesion: 0.33
Nodes (6): OpenRouterPage(), input, makeQueryClient(), mockFetch, onApiKeyChange, renderPage()
...
Cohesion: 0.33
Nodes (4): calls, { mockExecAsync }, opts, CompactBeadsOptions
...
Cohesion: 0.4
Nodes (5): code:yaml (# Your original docker-compose.yml), code:bash (# User has an existing project with docker-compose), How It Works, What Panopticon Injects, Workspace Portability: Bring Your Own Docker
...
Cohesion: 0.67
Nodes (3): execFile(), kCustom, mockExecFile
...
## Knowledge Gaps
- **13633 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13628 more)
...
- **Why does `string()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 518`, `Community 8`, `Community 9`, `Community 10`, `Community 7`, `Community 12`, `Community 521`, `Community 519`, `Community 15`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 549`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 55`, `Community 568`, `Community 569`, `Community 57`, `Community 60`, `Community 61`, `Community 63`, `Community 577`, `Community 66`, `Community 67`, `Community 65`, `Community 69`, `Community 74`, `Community 76`, `Community 78`, `Community 80`, `Community 89`, `Community 93`, `Community 96`, `Community 97`, `Community 108`, `Community 115`, `Community 117`, `Community 144`, `Community 676`, `Community 678`, `Community 182`, `Community 192`, `Community 193`, `Community 198`, `Community 715`, `Community 213`, `Community 216`, `Community 230`, `Community 249`, `Community 275`, `Community 276`, `Community 286`, `Community 288`, `Community 289`, `Community 806`, `Community 807`, `Community 302`, `Community 816`, `Community 306`, `Community 307`, `Community 311`, `Community 328`, `Community 336`, `Community 341`, `Community 344`, `Community 346`, `Community 348`, `Community 367`, `Community 392`, `Community 394`, `Community 396`, `Community 427`, `Community 440`, `Community 460`, `Community 461`, `Community 492`, `Community 495`, `Community 501`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 31` to `Community 896`, `Community 897`, `Community 35`, `Community 37`, `Community 199`, `Community 8`, `Community 9`, `Community 424`, `Community 172`, `Community 79`, `Community 310`, `Community 311`, `Community 24`, `Community 571`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 520`, `Community 649`, `Community 10`, `Community 11`, `Community 12`, `Community 9`, `Community 398`, `Community 15`, `Community 16`, `Community 274`, `Community 146`, `Community 20`, `Community 23`, `Community 152`, `Community 27`, `Community 28`, `Community 31`, `Community 166`, `Community 40`, `Community 425`, `Community 44`, `Community 304`, `Community 305`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 60`, `Community 61`, `Community 574`, `Community 192`, `Community 73`, `Community 715`, `Community 203`, `Community 333`, `Community 460`, `Community 79`, `Community 80`, `Community 340`, `Community 87`, `Community 90`, `Community 347`, `Community 348`, `Community 93`, `Community 220`, `Community 108`, `Community 110`, `Community 761`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Are the 220 inferred relationships involving `string()` (e.g. with `turnForSession()` and `observation()`) actually correct?**
  _`string()` has 220 INFERRED edges - model-reasoned connections that need verification._
- **Are the 200 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 200 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13633 weakly-connected nodes found - possible documentation gaps or missing edges._
