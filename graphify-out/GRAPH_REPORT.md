...
## Corpus Check
- 1574 files · ~2,071,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22398 nodes · 33617 edges · 1169 communities (1132 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 460 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2280f53f`
...
## Communities (1169 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (168): checkCompletedButUnsignaledReviews(), nudgeIdleWorkAgentsWithOpenBeads(), BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext() (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (167): readCavemanVariant(), checkStuckReviewing(), checkStuckWorkAgents(), patrolWorkAgentResolutions(), __dirname, execAsync, __filename, getBeadDescription() (+159 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (138): fetchMessages(), resumeConversation(), fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation() (+130 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (153): checkMissingReviewStatuses(), archiveReviewerRound(), buildConvoyPrompt(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS (+145 more)
...
Cohesion: 0.02
Nodes (144): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput() (+136 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (98): PlanningState, ZoneAActionsState, formatCost(), formatTokens(), InspectorPanel(), InspectorPanelProps, state, PanOpenInPicker() (+90 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (112): checkPostReviewCommits(), setAgentStoppedNotifier(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (113): loadCloisterConfig(), shouldAutoStart(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+105 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (91): ZoneBActionStrip(), ZoneBActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (85): parsePiSession(), getPiLauncherFields(), waitForPiAgentReady(), agentState, callOrder, checkFn, killed, mockGetAgentState (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (104): buildSpecialistBaseCommand(), agentDir, dir1, dir2, marker, missing, nested, getProviderAuthMode() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (88): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkAgentWarningDialog(), BulkAgentWarningDialogProps, BulkCloseOutProgress(), BulkCloseOutProgressProps (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (91): checkApiErrorAgents(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+83 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (80): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), fetchOutput(), TerminalPanel() (+72 more)
...
Cohesion: 0.04
Nodes (81): checkFailedMergeRetry(), checkOrphanedReviewStatuses(), checkPendingTestDispatch(), cleanupAbandonedFeedback(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult (+73 more)
...
Cohesion: 0.04
Nodes (59): ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffSummary, WorkLogEntry, ConversationPanelProps, ConversationViewProps (+51 more)
...
Cohesion: 0.05
Nodes (68): showCommand(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (57): ViewMode, firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), DeaconLogEntry, DeaconStatus() (+49 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (72): agentDir, body, envArg, LEGACY_FIELDS, legacyFields, options, reloaded, response (+64 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (56): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+48 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (57): ComposerMode, IssueComposer(), IssueComposerProps, IssueWorkbench(), IssueWorkbenchProps, ZoneA(), ZoneAProps, ALL_TABS (+49 more)
...
Cohesion: 0.05
Nodes (52): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+44 more)
...
Cohesion: 0.04
Nodes (56): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+48 more)
...
Cohesion: 0.04
Nodes (46): ActionBar(), ActionBarProps, AgentCard(), AgentCardProps, LastHeardCounter(), PHASE_COLORS, ROLE_COLORS, stalenessColor() (+38 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (56): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+48 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (44): ToggleButton(), DiffPanelLoadingState(), DiffPanelMode, DiffPanelShell(), getDiffPanelHeaderRowClassName(), cn(), SettingsCardSection(), SettingsCardSectionProps (+36 more)
...
Cohesion: 0.05
Nodes (46): ComposerFooter(), getDefaultConversationModel(), ForkModal(), ForkModalProps, useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, useRestartAgent() (+38 more)
...
Cohesion: 0.06
Nodes (42): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+34 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (36): ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel(), EFFORT_LEVELS (+28 more)
...
Cohesion: 0.07
Nodes (45): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), isMergeSetMergedIntoTargets(), restoreTrackedBeadsExport(), updateGitHubToInReview(), updateLinearToInReview() (+37 more)
...
Cohesion: 0.06
Nodes (26): ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyApiClient(), FlyApiClient, FlyApiError (+18 more)
...
Cohesion: 0.09
Nodes (40): buildPanSpecFilename(), buildPanSpecPath(), entryFromFile(), listSpecs(), parsePanSpecDocument(), projectPanPaths(), readSpec(), updateSpecStatus() (+32 more)
...
Cohesion: 0.07
Nodes (25): issues, result, getIssueDataService(), getIssueDataService(), getIssueDataService(), pruneClosedIssueReviewStatuses(), CACHE_DB_PATH, CacheEntry (+17 more)
...
Cohesion: 0.07
Nodes (42): Access, buildConversationResponse(), getCachedMessages(), isPiSessionFile(), validateCwdContainment(), getIndexStats(), getIndexStats(), stat (+34 more)
...
Cohesion: 0.07
Nodes (36): wipeCommand(), calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+28 more)
...
Cohesion: 0.09
Nodes (35): cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId(), isLegacyConversationDirectory(), isValidAgentDirectoryName(), OrphanedAgentDir, CloseOutContext (+27 more)
...
Cohesion: 0.09
Nodes (33): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), repos (+25 more)

### Community 115 - "Community 115"
Cohesion: 0.11
Nodes (35): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+27 more)
...
Cohesion: 0.15
Nodes (37): archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), activeDir, completedDir (+29 more)
...
Cohesion: 0.07
Nodes (29): criteria, doc, result, createCall, dbError, deleteCalls, doc, existingBeads (+21 more)
...
Cohesion: 0.09
Nodes (35): PrdLocation, ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync, execFileAsync (+27 more)
...
Cohesion: 0.1
Nodes (31): ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_REVIEW_PROMPTS_DIR, CACHE_RULES_DIR, CERTS_DIR (+23 more)
...
Cohesion: 0.07
Nodes (28): DEFAULT_GATES, calls, cmd, exec(), execMock, gatesWithBadPath, gatesWithPath, gatesWithQuotes (+20 more)

### Community 166 - "Community 166"
Cohesion: 0.09
Nodes (19): captureTldrMetrics(), daemonRegistry, ensureTldrStateDir(), execAsync, getStateFilePath(), getTldrMetrics(), hashWorkspacePath(), readStateFile() (+11 more)
...
Cohesion: 0.12
Nodes (29): buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory(), execAsync(), generateContextDigest(), getContextDigestPath(), getContextDirectory(), getContextRunsCount() (+21 more)
...
Cohesion: 0.1
Nodes (22): EventRouter(), createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState (+14 more)
...
Cohesion: 0.12
Nodes (21): ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap(), collectSessionTreeNodes(), compareSessionTreeSessionIds(), escapeRegExp(), fetchProjectSessionTree(), getAllSessionTreesRoute (+13 more)
...
Cohesion: 0.14
Nodes (26): APP_DIR, configureWorkspaceForBot(), execAsync, generateInstallationToken(), generateJWT(), getBotIdentity(), getCommitCheckState(), getInstallationAccessToken() (+18 more)

### Community 252 - "Community 252"
Cohesion: 0.09
Nodes (19): ALLOWED, AuthMode, AvailableModelsState, FALLBACK_GROUPS, getProviderForPickerModel(), HARNESS_OPTIONS, HarnessDecision, HarnessPolicyDecisions (+11 more)
...
Cohesion: 0.11
Nodes (19): createTerminalWindow(), createWindow(), dispatchMenuAction(), iconPath, IPC, isDevelopment, resolveResourcePath(), resolveServerStaticDir() (+11 more)
...
Cohesion: 0.12
Nodes (10): LinearTracker, createdIssue, mockAssignee, mockClient, mockComment, mockIssue, mockLabels, mockState (+2 more)
...
Cohesion: 0.23
Nodes (21): destroyRemoteWorkspace(), getManagedTmuxSocketName(), createFlyProvider(), AGENTS_DIR, buildRemoteTmuxCommand(), ensureRemoteTmuxContext(), getRemoteAgentOutput(), getRemoteAgentStateFile() (+13 more)
...
Cohesion: 0.18
Nodes (17): writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState(), workspacePanPaths() (+9 more)

### Community 359 - "Community 359"
Cohesion: 0.21
Nodes (20): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), dedupeRows(), formatTransition(), getProjectPath() (+12 more)
...
Cohesion: 0.17
Nodes (15): ForgeType, getRepoForge(), inferProjectForge(), normalizeForge(), resolveConfiguredRepos(), ResolvedProjectRepo, resolveProjectReposForIssue(), resolveProjectReposFromResolvedIssue() (+7 more)
...
Cohesion: 0.19
Nodes (16): BUNDLED_AGENTS_DIR, BUNDLED_SKILLS_DIR, copyBundledAgents(), copyBundledSkills(), __dirname, __filename, initCommand(), PACKAGE_ROOT (+8 more)
...
Cohesion: 0.17
Nodes (15): CostEvent, CostStreamResponse, fetchCostStream(), useCostStream(), UseCostStreamOptions, UseCostStreamResult, useIssueCostStream(), BreakdownRow (+7 more)
...
Cohesion: 0.12
Nodes (15): removeManifestEntry(), expectedHash, file1, file2, filePath, files, hash, loaded (+7 more)
...
Cohesion: 0.16
Nodes (10): ZoneCConversation(), ZoneCConversationProps, getViewKey(), PanelView, readView(), SessionPanel(), SessionPanelProps, cards (+2 more)
...
Cohesion: 0.23
Nodes (8): canonicalPrdSubdir(), findDraftPrd(), findPrdAnywhere(), findPrdAtStatus(), PrdFormat, PrdStatus, STATUS_DIRS, statusRoot()
...
Cohesion: 0.31
Nodes (9): getAllSpecialistStatus(), LegacySpecialistRuntimeStatus, SpecialistStatus, displaySpecialist(), getRelativeTime(), getStatusColor(), getStatusIcon(), listCommand() (+1 more)
...
Cohesion: 0.29
Nodes (6): dir, legacyDir, rawState, state, validDir, warnSpy
...
- **Why does `fetch` connect `Community 2` to `Community 3`, `Community 4`, `Community 9`, `Community 394`, `Community 137`, `Community 140`, `Community 781`, `Community 14`, `Community 12`, `Community 16`, `Community 274`, `Community 20`, `Community 21`, `Community 24`, `Community 282`, `Community 154`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 167`, `Community 427`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 567`, `Community 57`, `Community 58`, `Community 59`, `Community 187`, `Community 82`, `Community 604`, `Community 605`, `Community 995`, `Community 612`, `Community 251`, `Community 127`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 164` to `Community 0`, `Community 12`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Color` connect `Community 16` to `Community 1000`, `Community 99`?**
