...
## Corpus Check
- 1932 files · ~3,152,080 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27571 nodes · 43301 edges · 1297 communities (1238 shown, 59 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 801 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `292472e5`
...
## Communities (1297 total, 59 thin omitted)
...
Cohesion: 0.01
Nodes (166): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+158 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): ActivityFeedSidebarProps, BUCKET_LABELS, BUCKET_ORDER, createActionStatusObservationSelector(), EMPTY_OBSERVATIONS, bucket, first, second (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (157): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+149 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (147): resolveAutoResumeConfigForIssue(), spawnInspectAgentPromise(), buildSpecialistBaseCommand(), recoverCommand(), RecoverOptions, resetSessionCommand(), tellCommand(), reactivateConversationForSpawn() (+139 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (128): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+120 more)
...
Cohesion: 0.02
Nodes (117): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, PlanningState, ZoneAActionsState, SwitchModelModal() (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (125): isStale(), PHASE_CONFIG, recentActionObservations(), issue, list, onOpenWorkspaceHome, status, summary (+117 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (114): backup, bundledFrontendIndex, bundledServer, child, composeFile, config, configContent, configFile (+106 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (109): RoundMarker, ActivityFeedSidebar(), conversationsTab, firstLens, lens, overview, tablist, ConversationList() (+101 more)
...
Cohesion: 0.02
Nodes (108): bridgeCodexAuthToCliproxy(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), cloisterRouteLayer, getCloisterAgentsHealthRoute (+100 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (108): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync, __filename (+100 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (97): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError (+89 more)
...
Cohesion: 0.02
Nodes (93): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, AgentWarningDialogProps, applyReviewStateToIssue() (+85 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (94): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+86 more)
...
Cohesion: 0.02
Nodes (97): restoreTrackedBeadsExport(), runGit(), spawnerLayer, cb, cmdArgs, { MainDivergedErrorClass }, mockExec, mockGitPush (+89 more)
...
Cohesion: 0.03
Nodes (74): activeAgent, cafSpy, client, onNavigateToIssues, rafSpy, scrollSpy, tiles, url (+66 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (76): getUnblockedItems(), getUnblockedItemsSync(), isTaskReady(), isTaskReadySync(), TERMINAL_STATUSES, buildACLookupByTitle(), criteria, doc (+68 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (91): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, getIssueDataService(), ActivityContext, awaitingInputFromProjection() (+83 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (76): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+68 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (84): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand() (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (57): DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), createHandoffEvent(), performHandoff(), generateHealthSummary() (+49 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (87): buildActiveSliceContext(), printActiveSliceForIssue(), uniqueTmpPath(), writeWorkspaceContinue(), annotated, before, candidate, check (+79 more)
...
Cohesion: 0.03
Nodes (73): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, ConfirmationDialog(), ConfirmationDialogProps (+65 more)
...
Cohesion: 0.04
Nodes (78): after, row, status, clearWorkspaceStuck(), DatabaseError, DbReviewStatusRow, deleteReviewStatus(), getAllReviewStatusesFromDb() (+70 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (79): transitionIssueToVerifyingOnMain(), httpHandler(), HttpServerResponse, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent (+71 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (66): migrateConfigCommand(), MigrateConfigOptions, BACKUP_SETTINGS_PATH, convertToYamlConfigSync(), detectEnabledProviders(), getMigrationStatusSync(), hasLegacySettingsSync(), LEGACY_SETTINGS_PATH (+58 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (82): captureTmuxOutput(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS (+74 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (79): AgentRuntimeState, claimTranscriptRange(), commitTranscriptRange(), getTranscriptCheckpoint(), listTranscriptCheckpoints(), pendingRequests, postWorkerRequest(), releaseTranscriptRange() (+71 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (85): defaults, first, { models }, second, clearConfigCache(), hasModelCapabilitySync(), MODEL_DEPRECATIONS, deprecatedIds (+77 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (79): writeStoryFeatureContext(), findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, promotePlanning(), stampPlanForFinalization(), WorkspaceContinueState, completePlanningArtifacts() (+71 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (69): backupCleanCommand(), backupListCommand(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkPi(), CheckResult, compareSemver() (+61 more)
...
Cohesion: 0.03
Nodes (68): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST(), selectIssueActivityFeed(), AgentCard(), AgentCardProps (+60 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (74): AGENT_CONVERSATION_PREFIXES, archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), FavoriteType, listConversations(), listFavoritedIds() (+66 more)
...
Cohesion: 0.04
Nodes (67): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+59 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (49): buildObservation(), buildObservationPrompt(), ExtractedObservationPayload, ExtractedResultMetadata, ExtractObservationCall, extractObservationFromTurn(), ExtractObservationInput, ExtractObservationResult (+41 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (79): { config }, applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig, CavemanMode, cloneRoles(), ConfigCache (+71 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (68): readCavemanVariant(), finalizeRunLogSync(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+60 more)
...
Cohesion: 0.03
Nodes (66): agentsCache, AgentStartGateDecision, agentStopRoute(), buildAgentControlEventPayload(), buildStoppedAgentLifecycle(), createAgentStopHandler(), deleteAgentRoute, EMPTY_CONVERSATION (+58 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (67): buildWorkAgentPrompt(), extractStitchDesigns(), getTrackerContext(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), addGitHubComment(), fetchGitHubIssue() (+59 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (65): cosineSimilarity(), arrayIndexCondition(), ArrayIndexTarget, CosineSearchResult, cosineSimilarity(), FtsRow, FtsSearchResult, getDiscoveredSessionsByIds() (+57 more)
...
Cohesion: 0.04
Nodes (56): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+48 more)
...
Cohesion: 0.04
Nodes (50): ActivityLevel, ActivitySource, emitActivityDetailedSync(), EmitActivityOptions, emitActivityTtsSync(), emitDashboardLifecycleSync(), EmitDetailedOptions, EmitTtsOptions (+42 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (58): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), sentinel, markAgentStateServiceInProcess(), clearReviewStatus(), ensureManagedTmuxContextOnce(), emitResetMarkerCreated(), closeMemoryFtsDatabases() (+50 more)
...
Cohesion: 0.06
Nodes (34): parsePiSessionSync(), agentDirFor(), agentsDir(), cleanupPiTransientFiles(), execAsync, createPiFifo(), createPiFifoPromise(), destroyPiFifoSync() (+26 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (50): inferIssueIdFromWorkspace(), readPendingFeedback(), githubTracker, linearTracker, longBody, mockCreateTrackerFromConfig, mockExistsSync, mockLoadConfig (+42 more)
...
Cohesion: 0.07
Nodes (65): filterPayload(), add, addIn(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex() (+57 more)
...
Cohesion: 0.06
Nodes (26): issues, result, importTrackerConfig(), findProjectsByRallyProject(), computeBeadCounts(), getCachedPlanningState(), getCanonicalStatus(), IssueDataService (+18 more)
...
Cohesion: 0.04
Nodes (46): BASE_TIME, exitSpy, loadDeaconWithResumeMock(), loadStartCommand(), mailDir, mailFiles, state, stderrSpy (+38 more)
...
Cohesion: 0.05
Nodes (48): killCommand(), KillOptions, pauseCommand(), PauseOptions, printNextSteps(), unpauseCommand(), untroubledCommand(), applyAgentUnpaused() (+40 more)
...
Cohesion: 0.07
Nodes (45): cvCommand(), CVOptions, healthCommand(), HealthOptions, relativeTime(), showCommand(), ShowOptions, calls (+37 more)
...
Cohesion: 0.06
Nodes (44): confirmCost(), enrichAction(), formatCost(), ConversationFilter, markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt() (+36 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (33): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, DiffPanelLoadingState(), DiffPanelMode (+25 more)
...
Cohesion: 0.07
Nodes (55): addCommentBefore(), addMergeToJSMap(), ALIAS, anchorIsValid(), callVisitor(), captureTldrMetricsSync(), clone(), createNode() (+47 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (39): CLAUDE_PROJECTS_DIR, createClaudeCodeRuntimeSync(), SessionIndexEntry, getGlobalRegistry(), getRuntime(), getRuntimeForAgent(), RuntimeRegistry, setGlobalRegistry() (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.05
Nodes (45): ClaudeMessageWithCwd, ClaudeUsage, ContentBlock, FILE_TOOLS, parseSessionJsonl(), SessionMetadata, scanAction(), collectJsonlFiles() (+37 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (43): indexDailySummary(), createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime() (+35 more)
...
Cohesion: 0.06
Nodes (42): cont, doc, projectRoot, specsDir, workspace, runtime, state, next (+34 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (43): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+35 more)
...
Cohesion: 0.08
Nodes (46): embedAction(), ScanOptions, normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit() (+38 more)
...
Cohesion: 0.08
Nodes (39): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, createShadowStatePromise(), ensureShadowStateDir(), getDisplayStatus() (+31 more)
...
Cohesion: 0.05
Nodes (37): AC_STATUS_ICONS, BeadsResponse, BeadsTasksPanelProps, BeadTask, PlanItemDetailProps, CostBreakdownData, CostBreakdownModal(), CostBreakdownModalProps (+29 more)
...
Cohesion: 0.06
Nodes (42): clearFeedbackFiles(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+34 more)
...
Cohesion: 0.06
Nodes (35): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessionsSync(), importSessionToCostLog(), normalizeModelName(), parseAllSessionsSync(), AIProvider, calculateCostSync() (+27 more)
...
Cohesion: 0.06
Nodes (31): future, id, rows, rows1, rows2, backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema() (+23 more)
...
Cohesion: 0.09
Nodes (35): updateTtsConfig(), getDefaultTtsDaemonConfig(), getGlobalConfigPath(), mergeTtsConfig(), mergeTtsDaemonConfigs(), resolveAndSpeak(), speakTts(), StoredEvent (+27 more)
...
Cohesion: 0.07
Nodes (34): DiscoveredSession, findDiscoveredSessionIds(), findEnrichedSessionIdsMissingEmbedding(), searchFts(), buildEmbeddingText(), EmbedProgress, EmbedResult, EmbedSessionsOptions (+26 more)
...
Cohesion: 0.08
Nodes (28): execAsync, rebaseFeatureBranchPromise(), RebaseResult, openBrowser(), runCommand(), ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload() (+20 more)
...
Cohesion: 0.09
Nodes (32): getHealthThresholdsMs(), AgentHealth, evaluateHealthState(), formatDuration(), getAgentHealth(), getAgentsToKill(), getAgentsToPoke(), getHealthEmoji() (+24 more)
...
Cohesion: 0.09
Nodes (28): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), IMAGE_EXTENSIONS, MarkdownFileLink (+20 more)
...
Cohesion: 0.07
Nodes (31): buildFilterParams(), ConversationRpcFilter, ConversationsPage(), CostResponse, countCostFacets(), countFacetValues(), countTimeFacets(), DiscoveredSession (+23 more)
...
Cohesion: 0.15
Nodes (34): extractNumberSync(), applyLabelGitHubImpl(), applyLabelLinearImpl(), closeGitHubDirectImpl(), closeGitHubPrImpl(), closeLinearDirectImpl(), closeRallyDirectImpl(), execAsync (+26 more)
...
Cohesion: 0.08
Nodes (28): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+20 more)
...
Cohesion: 0.12
Nodes (32): loadConfigNoMigration(), runDashboardDbJob(), abortFlywheelRunForDashboard(), assertExistingPathInsideRoot(), createInitialFlywheelStatus(), dashboardSetting(), execAsync, FlywheelGateSnapshot (+24 more)
...
Cohesion: 0.09
Nodes (19): cleanupOldEventsSync(), CLOISTER_DB_PATH, CloisterDatabaseError, deleteAgentHistorySync(), getAgentsWithHistorySync(), getAllHealthHistorySync(), getDatabaseStatsSync(), getHealthDatabase() (+11 more)
...
Cohesion: 0.1
Nodes (26): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), buildCorrelationMapSync(), CorrelationResult, createSummaryFork(), createConversation() (+18 more)
...
Cohesion: 0.11
Nodes (23): clearFeedbackFilesPromise(), readFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+15 more)
...
Cohesion: 0.11
Nodes (21): createRecoveryCoordinator(), EventClassification, RecoveryCoordinator, RecoveryPhase, RecoveryPhaseKind, RecoveryReason, RecoveryState, CacheEntry (+13 more)
...
Cohesion: 0.1
Nodes (25): appendToRunLogSync(), checkLogSizeLimit(), createRunLogSync(), generateRunId(), getRunLogPath(), getRunLogSize(), getRunLogSync(), isRunLogActive() (+17 more)
...
Cohesion: 0.14
Nodes (13): cleanupAllLogsSync(), cleanupOldLogsSync(), ensureRunsDirectory(), getRecentRunLogs(), getRunsDirectory(), getSpecialistsDir(), liftLogError(), listRunLogsSync() (+5 more)
...
Cohesion: 0.13
Nodes (14): CloseOutContext, CloseOutError, CloseOutResult, CloseOutStep, execAsync, findWorkspacePath(), isBranchMerged(), ApproveOptions (+6 more)
...
Cohesion: 0.26
Nodes (11): getWorkspacePathForIssue(), asPanRpcError(), isInsidePath(), LANGUAGE_BY_EXTENSION, languageForPath(), readCappedFile(), readWorkspaceFile(), readWorkspaceFileEffect() (+3 more)
...
## Knowledge Gaps
- **13620 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13615 more)
...
- **Why does `string()` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 533`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 535`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 39`, `Community 40`, `Community 41`, `Community 556`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 62`, `Community 64`, `Community 68`, `Community 69`, `Community 580`, `Community 74`, `Community 76`, `Community 79`, `Community 82`, `Community 83`, `Community 85`, `Community 89`, `Community 92`, `Community 94`, `Community 99`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 112`, `Community 628`, `Community 117`, `Community 118`, `Community 146`, `Community 154`, `Community 155`, `Community 667`, `Community 668`, `Community 182`, `Community 199`, `Community 200`, `Community 203`, `Community 208`, `Community 744`, `Community 234`, `Community 235`, `Community 246`, `Community 269`, `Community 789`, `Community 797`, `Community 289`, `Community 292`, `Community 295`, `Community 306`, `Community 307`, `Community 325`, `Community 328`, `Community 335`, `Community 337`, `Community 342`, `Community 875`, `Community 365`, `Community 389`, `Community 393`, `Community 421`, `Community 436`, `Community 452`, `Community 453`, `Community 468`, `Community 479`, `Community 480`, `Community 484`, `Community 511`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 394`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 663`, `Community 24`, `Community 29`, `Community 31`, `Community 160`, `Community 288`, `Community 162`, `Community 37`, `Community 41`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 192`, `Community 66`, `Community 68`, `Community 69`, `Community 453`, `Community 82`, `Community 211`, `Community 339`, `Community 342`, `Community 343`, `Community 89`, `Community 345`, `Community 223`, `Community 96`, `Community 224`, `Community 101`, `Community 102`, `Community 744`, `Community 489`, `Community 748`, `Community 121`, `Community 635`, `Community 254`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 22` to `Community 418`, `Community 99`, `Community 66`, `Community 37`, `Community 40`, `Community 393`, `Community 558`, `Community 210`, `Community 307`, `Community 308`, `Community 21`, `Community 19`, `Community 27`, `Community 28`, `Community 159`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13620 weakly-connected nodes found - possible documentation gaps or missing edges._
