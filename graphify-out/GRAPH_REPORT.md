...
## Corpus Check
- 1545 files · ~2,065,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21577 nodes · 32114 edges · 1119 communities (1084 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 428 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2835ee77`
...
## Communities (1119 total, 35 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (126): PlanningState, ZoneAActionsState, DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState() (+118 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (128): ChatMarkdown, ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueComposer(), IssueWorkbenchProps (+120 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (123): checkFirstCompletionAgents(), isAgentIdleForNudge(), nudgeIdleWorkAgentsWithOpenBeads(), patrolWorkAgentResolutions(), isMergeAgentRunning(), spawnRebaseAgentForBranch(), writeStoryFeatureContext(), recoverCommand() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (126): checkMissingReviewStatuses(), checkOrphanedReviewStatuses(), checkStuckReviewing(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus() (+118 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (113): fetchConversations(), GeneralConversation, GeneralSectionProps, archiveConversation(), ConversationMutations, favoriteConversation(), stopConversation(), summaryForkConversation() (+105 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (118): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext() (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (94): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider() (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (87): ConversationView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+79 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (87): ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar(), ConfirmationDialog() (+79 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (96): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (104): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkHeartbeat(), checkMassDeath() (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (83): BulkAgentWarningDialog(), BulkAgentWarningDialogProps, DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, PlanDialogProps (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (84): ArtifactLinks(), ArtifactLinksProps, BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (88): resolveProjectConfig(), workspaceRenderDevcontainerCommand(), WorkspaceRenderDevcontainerOptions, createHumeConfig(), deleteHumeConfig(), humeFetch(), HumeResult, content (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (89): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, cleanupLegacyRuntimeSymlinks(), migrateSyncTargets() (+81 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (86): devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22(), sleep(), waitForHealth() (+78 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (72): AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions, SpawnedAgent, StartPlanningOptions, StartWorkOptions, getGitHubClient() (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (68): ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, selectIssueActivityFeed(), AgentCard(), AgentCardProps, LastHeardCounter() (+60 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (81): checkDeadEndAgents(), clearStaleCiFeedback(), buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions (+73 more)
...
Cohesion: 0.03
Nodes (72): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+64 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (63): abortReviewCommand(), DASHBOARD_URL, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (70): spawnReviewCoordinatorSession(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), {
  mockLoadYamlConfig,
...
Cohesion: 0.05
Nodes (73): checkApiErrorAgents(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel(), MODEL_PATTERNS, SessionInfo (+65 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (61): useLiveFlash(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+53 more)
...
Cohesion: 0.05
Nodes (63): emitCoordinatorDied(), pendingCommand(), after, row, status, clearWorkspaceStuck(), DbReviewStatusRow, deleteReviewStatus() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (64): findSpecByIssue(), updateSpecStatus(), next, path, read, state, after, continueContent (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (49): killCommand(), KillOptions, ensurePlaywrightIsolation(), getIsolatedPlaywrightMcpConfig(), changed, config, result, createFlyApiClient() (+41 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (64): checkPendingTestDispatch(), mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), cleanFile(), configCommand(), execAsync (+56 more)
...
Cohesion: 0.04
Nodes (56): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, beadsDir, doc, badPath, customPlanningDir, dir (+48 more)
...
Cohesion: 0.06
Nodes (55): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), deleteIssueDraft(), getDraftPath(), getDraftsDir(), getIssueDraftInfo() (+47 more)

### Community 36 - "Community 36"
Cohesion: 0.11
Nodes (62): ARCHIVES_DIR, archivePlanning(), archiveWorkspaceArtifacts(), execAsync, findAllWorkspacePaths(), findWorkspacePath(), movePrd(), applyClosedOutLabel() (+54 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (52): REVIEWER_STYLE, ReviewerRole, RoleBadge(), RoleBadgeProps, RoleBadgeSize, RoleStyle, SESSION_STYLE, SIZE_PX (+44 more)
...
Cohesion: 0.05
Nodes (51): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, result, ActivityContext, awaitingInputFromProjection(), buildIssueTitleMap() (+43 more)
...
Cohesion: 0.05
Nodes (45): BLANKED_PROVIDER_ENV, buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS, STRIPPED_KEYS, base, result, buildTmuxArgs() (+37 more)
...
Cohesion: 0.05
Nodes (45): ConversationPanel(), ConversationPanelProps, ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse, PHASE_ICONS (+37 more)
...
Cohesion: 0.06
Nodes (46): checkNodeVersion(), checkServerBundle(), __dirname, launch(), packageDir, resolveElectron(), ACTIVE_STATUS_PATTERNS, agentDir (+38 more)
...
Cohesion: 0.04
Nodes (42): canReplaceTitle(), listConversations(), ALLOWED_UPLOAD_MIME_TYPES, backfillConversationModels(), deleteConversationFavoriteRoute, execAsync, generateAiTitle(), getCachedFavoritedIds() (+34 more)
...
Cohesion: 0.06
Nodes (43): agentDir, missing, result, snapshot, status, AgentEnrichment, withConcurrencyLimit(), discoverNewAgentIds() (+35 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (43): reconcileAndCheckIfMerged(), reconcileFalseMerged(), ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput (+35 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (21): issues, result, importTrackerConfig(), computePlanningState(), getCanonicalStatus(), IssueDataService, issuesChanged(), mapRallyStateToCanonical() (+13 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (42): determineModel(), getActivity(), agentsCache, decodeDomainEvent, deleteAgentRoute, EMPTY_CONVERSATION, evaluateSpawnGuardrails(), execAsync (+34 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (34): buildACLookupByTitle(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks(), readFeatureContext(), readPendingFeedback() (+26 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (45): agentStatusCommand(), listRunningAgentsAsync(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+37 more)
...
Cohesion: 0.05
Nodes (44): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModalProps, MODELS_BY_PROVIDER (+36 more)
...
Cohesion: 0.09
Nodes (38): cleanupOrphanedReviewSessions(), killAllReviewSessions(), healthCommand(), HealthOptions, cleanupAgentDirectories(), CleanupResult, findOrphanedAgentDirs(), getPlanningIssueId() (+30 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (36): ViewMode, firstSessionPanel, firstWorkbench, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats (+28 more)
...
Cohesion: 0.09
Nodes (41): cleanupSpawnAndOrphanedStashes(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), dropLingeringPreMergeStashes(), ensureReviewTempStash(), applyStash(), buildStashMessage(), CanonicalStashKind (+33 more)
...
Cohesion: 0.1
Nodes (33): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), relativeTime(), showCommand(), ShowOptions, CanonicalState (+25 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (38): doneCommand(), DoneOptions, execAsync, getGitHubConfig(), updateGitHubToInReview(), updateLinearToInReview(), AutoCreateStateConfig, CANONICAL_STATES (+30 more)
...
Cohesion: 0.08
Nodes (36): captureTmuxOutput(), _closeIssueFailures, _completedPostMerge, __dirname, execAsync, __filename, getConflictFiles(), GIT_PATTERNS (+28 more)
...
Cohesion: 0.08
Nodes (22): DiffPanel(), DiffPanelProps, DiffThemeType, getRenderablePatch(), readDiffParamsFromUrl(), RenderablePatch, ToggleButton(), DiffPanelLoadingState() (+14 more)

### Community 137 - "Community 137"
Cohesion: 0.08
Nodes (33): setAgentStoppedNotifier(), announceMerge(), ActivityLevel, ActivitySource, emitActivityDetailed(), emitActivityEntry(), EmitActivityOptions, emitActivityTts() (+25 more)
...
Cohesion: 0.09
Nodes (33): computeAgentEnrichment(), execAsync, getActiveSessionPath(), getAgentJsonlMtime(), getAgentJsonlPath(), getAgentPendingQuestions(), getAgentWorkspace(), getClaudeProjectDir() (+25 more)
...
Cohesion: 0.1
Nodes (28): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+20 more)
...
Cohesion: 0.09
Nodes (23): closeIssueWithCircuitBreaker(), postMergeLifecycle(), calls, { mockExecAsync }, opts, compactBeads(), CompactBeadsOptions, execAsync (+15 more)
...
Cohesion: 0.1
Nodes (19): ComposerMode, IssueComposerProps, ZoneBActionStrip(), ZoneBActionStripProps, retryPendingSpawn(), clearPendingCodexSpawn(), getPendingCodexSpawn(), hasPendingCodexSpawn() (+11 more)
...
Cohesion: 0.1
Nodes (18): ModelOverrideModal(), PlanDialog(), AuthMode, AvailableModelsState, canUsePickerHarness(), FALLBACK_GROUPS, getProviderForPickerModel(), Harness (+10 more)
...
Cohesion: 0.12
Nodes (10): createTracker(), getAllTrackers(), getPrimaryTracker(), getSecondaryTracker(), getTrackerKeyFromConfig(), config, originalEnv, tracker (+2 more)
...
- **Why does `fetch` connect `Community 4` to `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 134`, `Community 11`, `Community 12`, `Community 13`, `Community 525`, `Community 526`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 152`, `Community 282`, `Community 668`, `Community 28`, `Community 30`, `Community 34`, `Community 164`, `Community 40`, `Community 47`, `Community 176`, `Community 48`, `Community 52`, `Community 57`, `Community 58`, `Community 188`, `Community 65`, `Community 583`, `Community 72`, `Community 73`, `Community 78`, `Community 486`, `Community 103`, `Community 746`, `Community 240`, `Community 883`, `Community 629`, `Community 636`, `Community 638`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 131` to `Community 2`, `Community 12`, `Community 5`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 34` to `Community 33`, `Community 35`, `Community 547`, `Community 72`, `Community 586`, `Community 337`, `Community 22`, `Community 60`, `Community 29`?**
