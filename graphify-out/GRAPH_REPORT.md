...
## Corpus Check
- 1566 files · ~2,061,678 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21631 nodes · 32040 edges · 1137 communities (1100 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17617d06`
...
Cohesion: 0.02
Nodes (168): forkCommand(), ForkOptions, normalize(), unarchiveConversationCommand(), copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary() (+160 more)
...
Cohesion: 0.03
Nodes (117): PlanningState, useZoneAActions(), ZoneAActionsState, ZoneActionStrip(), ZoneActionStripProps, ZoneBActionStrip(), ZoneBActionStripProps, ArtifactLinks() (+109 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (147): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents(), checkDeadEndAgents() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (131): buildSpecialistBaseCommand(), writeStoryFeatureContext(), recoverCommand(), RecoverOptions, ActivityEntry, AGENT_PREFIXES, AgentLaunchConfig, AgentResolution (+123 more)
...
Cohesion: 0.03
Nodes (114): getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions (+106 more)
...
Cohesion: 0.02
Nodes (87): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), Conversation, ConversationList(), ConversationListProps (+79 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (100): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, Access, AwaitingInputDetection, encodeClaudeProjectDir(), PrdLocation (+92 more)
...
Cohesion: 0.03
Nodes (82): getPiLauncherFields(), waitForPiAgentReady(), writePiAgentPrompt(), agentState, callOrder, checkFn, killed, mockGetAgentState (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (84): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), DeepWipeDialogProps, DeepWipeProgress (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (82): AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell(), DialogState, DoubleDialogComponent() (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (85): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cliproxyRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+77 more)
...
Cohesion: 0.06
Nodes (87): wipeCommand(), WipeOptions, extractNumber(), extractPrefix(), extractStandardNumber(), extractStandardPrefix(), normalizeIssueId(), ParsedIssueId (+79 more)
...
Cohesion: 0.04
Nodes (85): checkMissingReviewStatuses(), dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildReviewRolePrompt(), cleanupReviewTempStash(), ensureReviewTempStash(), execAsync, killAllReviewSessions() (+77 more)
...
Cohesion: 0.04
Nodes (69): setAgentStoppedNotifier(), setMergeReadyNotifier(), announceMerge(), DEACON_DIR, DEACON_STATE_PATH, _deaconState, mockNotifier, REVIEW_STATUS_PATH (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (67): checkPendingTestDispatch(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), BeadsTask, buildHandoffPrompt() (+59 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (68): readCavemanVariant(), finalizeRunLog(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir() (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (73): closeOutCommand(), CloseOutOptions, getGitHubConfig(), addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions (+65 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (69): captureTmuxOutput(), dismissDevChannelsDialog(), isClaudeRunningInSession(), BLANKED_PROVIDER_ENV, buildChildEnv(), buildChildEnvWithoutTmux(), LEAKED_ENV_KEYS, PROVIDER_ENV_KEYS (+61 more)
...
Cohesion: 0.04
Nodes (66): agentDir, body, LEGACY_FIELDS, legacyFields, options, reloaded, response, { config } (+58 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (66): defaults, first, { models }, second, clearConfigCache(), getGlobalConfigPath(), ModelRef, RoleConfig (+58 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (55): loadPinState(), PHASE_CHIP_COLORS, PHASE_LABELS, PipelinePhase, savePinState(), TAB_ID_TO_SESSION_TYPE, TerminalTab, TerminalTabs() (+47 more)
...
Cohesion: 0.04
Nodes (47): ActionBar(), ActionBarProps, AgentCard(), AgentCardProps, LastHeardCounter(), ROLE_COLORS, stalenessColor(), STATUS_GLOW (+39 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (56): createCostCommand(), formatIssueCostAggregate(), runCostSync(), aggregate, output, parseWalFile(), SyncResult, syncWalFromAllProjects() (+48 more)
...
Cohesion: 0.06
Nodes (51): deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles(), readContinueFile(), writeContinueFile(), next (+43 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (54): FileStatus, AGENTS_DIR, ARCHIVES_DIR, BACKUPS_DIR, BIN_DIR, CACHE_AGENTS_DIR, CACHE_MANIFEST, CACHE_RULES_DIR (+46 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (56): CLAUDE_PROJECTS_DIR, ClaudeMessage, getRecentSessions(), importSessionToCostLog(), normalizeModelName(), parseAllSessions(), AIProvider, BUDGETS_FILE (+48 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (42): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, computePlanningState(), criteria, doc, result, beadsDir (+34 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (47): findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), after, doc, filename, path (+39 more)
...
Cohesion: 0.08
Nodes (48): buildPanSpecFilename(), buildPanSpecPath(), ensurePanDirs(), entryFromFile(), findSpecByIssue(), listSpecs(), parsePanSpecDocument(), projectPanPaths() (+40 more)
...
Cohesion: 0.06
Nodes (38): parseContainerServiceName(), parseIssueIdFromText(), AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenuProps, FeatureItem() (+30 more)
...
Cohesion: 0.06
Nodes (38): abortReviewCommand(), DASHBOARD_URL, CompletePlanningResponse, DASHBOARD_URL, planDoneCommand(), DASHBOARD_URL, RequestReviewOptions, RequestReviewResponse (+30 more)
...
Cohesion: 0.05
Nodes (38): DEFAULTS, UIPreferences, useUIPreferences(), DesktopSettings, DesktopSettingsSection(), isDesktopApp(), NOTIFICATION_LABELS, NotificationEventType (+30 more)
...
Cohesion: 0.07
Nodes (36): buildInspectPrompt(), detectCompileCommand(), __dirname, execAsync, __filename, getBeadDescription(), InspectContext, InspectResult (+28 more)
...
Cohesion: 0.07
Nodes (36): AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CostLimitsConfig, CostTrackingConfig, DEFAULT_CLOISTER_CONFIG, HandoffConfig, HandoffTriggersConfig (+28 more)
...
Cohesion: 0.07
Nodes (39): agentDir, missing, snapshot, status, discoverNewAgentIds(), ReadModelServiceShape, shouldSkipCheckpointReconciliation(), SpecialistAgentName (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (39): AddOptions, BUNDLED_HOOKS_DIR, __dirname, __filename, installGitHooks(), ListOptions, projectAddCommand(), projectInitCommand() (+31 more)
...
Cohesion: 0.09
Nodes (34): clearFeedbackFiles(), buildACLookupByTitle(), buildPolyrepoContext(), buildWorkAgentPrompt(), extractStitchDesigns(), inferIssueIdFromWorkspace(), matchBeadToAC(), readBeadsTasks() (+26 more)
...
Cohesion: 0.11
Nodes (29): refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), CanonicalState, ensureShadowStateDir(), getDisplayStatus(), getShadowState() (+21 more)
...
Cohesion: 0.09
Nodes (17): getActiveSessionModel(), getProjectDirs(), getSessionFiles(), parseClaudeSession(), claudeProjectDir, content, lines, newContent (+9 more)
...
Cohesion: 0.11
Nodes (3): createHandoffEvent(), CloisterService, writeStateFile()
...
Cohesion: 0.09
Nodes (27): CloisterConfig, deepMerge(), loadCloisterConfig(), saveCloisterConfig(), shouldAutoStart(), updateCloisterConfig(), AgentHealth, detectTestCommand() (+19 more)
...
Cohesion: 0.1
Nodes (28): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), cleanFile(), configCommand(), execAsync, ExtendedProjectConfig (+20 more)
...
Cohesion: 0.06
Nodes (27): DeaconConfig, DeaconState, config, config1, config2, CONFIG_FILE, customConfig, DEACON_DIR (+19 more)
...
Cohesion: 0.14
Nodes (26): hookCommand(), HookOptions, clearHook(), collectMail(), getHook(), getHookDir(), getHookFile(), getMailDir() (+18 more)
...
Cohesion: 0.09
Nodes (27): agent2, baseAgent, bigOutput, events, existing, issues, next, planningAgent (+19 more)
...
Cohesion: 0.1
Nodes (20): SessionUsage, emptyUsage(), isAssistantMessage(), isMessage(), KNOWN_TYPES, parsePiSession(), parsePiSessionContent(), ParseResult (+12 more)
...
Cohesion: 0.2
Nodes (21): determineWorkspaceLocation(), ensureRemoteWorkspace(), execAsync, findLocalWorkspace(), findProjectRoot(), findWorkspace(), findWorkspaceWithLocation(), handleRemoteWorkspace() (+13 more)

### Community 332 - "Community 332"
Cohesion: 0.1
Nodes (16): getRuntimeSnapshotSync(), mirror, setAgentRuntimeMirror(), saveSessionId(), agentId, dir, lifecycle, sessionExistsSpy (+8 more)
...
Cohesion: 0.19
Nodes (17): buildChannelsArgs(), buildCommand(), buildNonConversationCommand(), buildPiCommand(), generateLauncherScript(), generateLauncherWrapper(), LauncherConfig, LauncherHarness (+9 more)
...
Cohesion: 0.15
Nodes (17): activitySummaryCache, claudeProjectDir(), compactOffsetCache, ContentBlock, ConversationActivitySummary, ConversationWatchHandle, discoverSessionFile(), encodeCwdToProjectDir() (+9 more)
...
Cohesion: 0.12
Nodes (15): content, dashboardStopIdx, dispatchFailedMatches, downBlockMatch, { mockKillSessionAsync }, { mockKillSessionAsync, mockSpawnRun, mockNotifyPipeline }, pendingMatches, requestReviewMatch (+7 more)
...
Cohesion: 0.23
Nodes (14): resetDb(), resetDb(), closeDatabase(), getDatabasePath(), isBunRuntime(), _require, resetDatabase(), resetDb() (+6 more)
...
Cohesion: 0.18
Nodes (11): buildConversationResponse(), getCachedMessages(), isPiSessionFile(), isSystemInjection(), parseConversationMessages(), providerFromModel(), consoleSpy, EMPTY (+3 more)
...
## Knowledge Gaps
- **11471 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+11466 more)
...
- **Why does `fetch` connect `Community 5` to `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 523`, `Community 12`, `Community 13`, `Community 272`, `Community 17`, `Community 20`, `Community 150`, `Community 151`, `Community 152`, `Community 23`, `Community 24`, `Community 414`, `Community 544`, `Community 804`, `Community 38`, `Community 40`, `Community 174`, `Community 52`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 958`, `Community 193`, `Community 67`, `Community 72`, `Community 586`, `Community 80`, `Community 102`, `Community 234`, `Community 747`, `Community 628`, `Community 629`, `Community 632`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 44` to `Community 72`, `Community 41`, `Community 45`, `Community 365`, `Community 47`, `Community 271`, `Community 22`, `Community 60`, `Community 189`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 135` to `Community 25`, `Community 10`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _11471 weakly-connected nodes found - possible documentation gaps or missing edges._
