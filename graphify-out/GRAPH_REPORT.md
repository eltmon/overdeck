...
## Corpus Check
- 1546 files · ~2,060,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21556 nodes · 31981 edges · 1132 communities (1096 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `751e6f45`
...
## Communities (1132 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (176): nudgeIdleWorkAgentsWithOpenBeads(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffMethod, HandoffOptions, performHandoff(), performKillAndSpawn() (+168 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (110): PlanningState, ZoneAActionsState, DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), formatCost() (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (135): loadCloisterConfig(), ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents(), checkApiErrorAgents() (+127 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (122): checkMissingReviewStatuses(), archiveReviewerRound(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, cleanupReviewTempStash(), coordinatorExitStatus(), DEFAULT_REVIEW_AGENTS, delay() (+114 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (110): readCavemanVariant(), spawnRebaseAgentForBranch(), renderPrompt(), spawnSingleReviewer(), resolveSpecialistBaseCommand(), finalizeRunLog(), buildProviderExportLines(), buildSpecialistCavemanExports() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (99): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, IssueWorkbenchProps, ZoneA(), ZoneAProps (+91 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (98): fetchConversations(), GeneralConversation, GeneralSectionProps, fetchAllSessionTrees(), fetchConversations(), fetchCostsByIssue(), fetchRegisteredProjects(), fetchVersion() (+90 more)
...
Cohesion: 0.03
Nodes (81): firstSessionPanel, firstWorkbench, overview, workbench, ConversationList(), CommandDeck(), CommandDeckProps, ContainerStats (+73 more)
...
Cohesion: 0.03
Nodes (89): getCavemanExperimentData(), adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute (+81 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (84): checkFailedMergeRetry(), checkPendingTestDispatch(), getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), WriteFeedbackOptions, WriteFeedbackResult, formatFeedbackForAgent() (+76 more)
...
Cohesion: 0.03
Nodes (78): useZoneAActions(), ZoneActionStrip(), ZoneActionStripProps, AlertOptions, ConfirmOptions, DialogContext, DialogContextValue, DialogProvider() (+70 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (71): ActivitySection, ActivityView(), ActivityViewProps, CostByStage, fetchActivity(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId() (+63 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (86): agentDir, dir1, dir2, marker, missing, nested, buildPlanningPrompt(), __dirname (+78 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (74): ViewMode, ChannelPermissionDialog(), ChannelPermissionDialogProps, { container }, onAllow, onDeny, request, CloisterStatusBar() (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (80): announceMerge(), captureTmuxOutput(), _closeIssueFailures, closeIssueWithCircuitBreaker(), _completedPostMerge, __dirname, execAsync, __filename (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (73): DeepWipeDialogProps, DeepWipeProgress, STEP_ICONS, STEP_LABELS, WipeState, SkillsList(), formatBytes(), severityClasses() (+65 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (75): showCommand(), findSpecByIssue(), updateSpecStatus(), writeSpecForIssue(), next, path, read, state (+67 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (64): getUnblockedItems(), isTaskReady(), TERMINAL_STATUSES, findWorkspaceRoot(), planFinalizeCommand(), PlanFinalizeOptions, stampPlanForFinalization(), beadsDir (+56 more)
...
Cohesion: 0.05
Nodes (71): addRepoCommand(), AddRepoOptions, convertToSshUrl(), createCommand(), CreateOptions, createRemoteWorkspace(), DestroyOptions, execAsync (+63 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (69): emitCoordinatorDied(), after, before, blockers, result, statuses, after, row (+61 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (58): criteria, doc, result, doc, path, ACCompletionResult, checkAllCriteriaCompleted(), extractAcceptanceCriteria() (+50 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (62): AggregateActivityState, AggregateBadge, buildActivitySummary(), computeDominantStatus(), FeatureContextMenu(), FeatureContextMenuProps, FeatureItem(), FeatureItemProps (+54 more)
...
Cohesion: 0.05
Nodes (55): configShadowCommand(), ShadowOptions, refreshCommand(), refreshFromLinear(), RefreshOptions, shadowCommand(), PanopticonConfig, ENV_FILE_PATH (+47 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (51): DetailPanelLayout(), fetchOutput(), TerminalPanel(), TerminalPanelProps, agent, derivePipelinePhase(), PipelinePhaseInput, PipelinePhaseResult (+43 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (62): defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath(), MODEL_DEPRECATIONS (+54 more)
...
Cohesion: 0.04
Nodes (45): Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, SORT_LABELS, sortConversations(), SortOption (+37 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (41): db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc, unsubscribe (+33 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (48): DEFAULT_GATES, execAsync, parseValidationOutput(), QualityGateResult, QualityGateRunOptions, runHttpHealthGate(), runMergeValidation(), runQualityGates() (+40 more)
...
Cohesion: 0.06
Nodes (40): ComposerFooter(), ComposerFooterProps, deleteConversationImage(), PendingImage, sendConversationMessage(), switchModel(), uploadConversationImage(), ensureDefaultConversationModel() (+32 more)
...
Cohesion: 0.05
Nodes (45): AgentRollup, CavemanExperimentRow, DailyTrend, DbCostRow, DbIssueSummaryRow, getAgentRollup(), getCostForIssueFromDb(), getCostsByIssueFromDb() (+37 more)
...
Cohesion: 0.06
Nodes (41): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS, { loadConfigMock, isShadowedMock, getPendingSyncCountMock, createTrackerMock, loadProjectsConfigMock }, mockIssues (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (40): MessageDeliveryFailed, ALLOWED_UPLOAD_MIME_TYPES, deleteConversationFavoriteRoute, execAsync, getClientIp(), getConversationDiffFullRoute, getConversationDiffsRoute, getConversationDiffTurnRoute (+32 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (45): destroyRemoteWorkspace(), getClaudePermissionFlags(), getClaudePermissionFlagsString(), readYoloEnv(), resolvePermissionMode(), YOLO_FALSE, YOLO_TRUE, ClaudePermissionMode (+37 more)
...
Cohesion: 0.08
Nodes (40): doneCommand(), execAsync, DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb() (+32 more)
...
Cohesion: 0.06
Nodes (25): issues, result, importTrackerConfig(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS, L1Entry (+17 more)
...
Cohesion: 0.08
Nodes (40): backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), createBackup(), createBackupTimestamp(), listBackups() (+32 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (43): Capability, CAPABILITY_INFO, getAllModels(), getCapabilityMatchScore(), getModelById(), ModelDef, ModelOverrideModal(), ModelOverrideModalProps (+35 more)
...
Cohesion: 0.08
Nodes (40): BUNDLED_GIT_HOOKS_DIR, checkCommand(), __dirname, __filename, syncCommand(), SyncOptions, getCurrentVersion(), getLatestVersion() (+32 more)
...
Cohesion: 0.07
Nodes (40): CostAlert, DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, HandoffContext, HandoffResult, createHandoffEvent() (+32 more)
...
Cohesion: 0.07
Nodes (35): ApproveReviewArtifactInput, buildRepositoryFlag(), CommentOnArtifactInput, CreateReviewArtifactInput, CreateReviewArtifactResult, DiscoverArtifactInput, execAsync, ForgeAdapter (+27 more)
...
Cohesion: 0.08
Nodes (38): calls, { mockExecAsync }, opts, CloseIssueOptions, compactBeads(), CompactBeadsOptions, execAsync, { mockExecAsync } (+30 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (38): appendCostEvent(), CostEvent, deduplicateEvents(), ensureEventsFile(), EventMetadata, eventsFileExists(), getCostsDir(), getEventsFile() (+30 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (31): fmtCost(), fmtDuration(), RoundCard(), RoundCardProps, RoundData, RoundVerdict, VERDICT_COLOR, VERDICT_LABEL (+23 more)
...
Cohesion: 0.07
Nodes (34): ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, FailedMessage, fetchMessages(), FORK_STEPS, MessagesResponse (+26 more)
...
Cohesion: 0.1
Nodes (34): clearFeedbackFiles(), writeStoryFeatureContext(), readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), validateWorkspaceContinueState() (+26 more)
...
Cohesion: 0.09
Nodes (24): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), daemonRegistry (+16 more)
...
Cohesion: 0.08
Nodes (37): getSetting(), isDeaconGloballyPaused(), setDeaconGloballyPaused(), setSetting(), cleanupOldHealthEvents(), deleteAgentHealthHistory(), getAgentsWithHistory(), getAllHealthHistory() (+29 more)
...
Cohesion: 0.07
Nodes (31): setAgentStoppedNotifier(), getAllActiveQueues(), emitDashboardLifecycle(), data, mockExistsSync, mockReadFile, mockUnlink, runner (+23 more)
...
Cohesion: 0.09
Nodes (37): appendToRunLog(), checkLogSizeLimit(), cleanupAllLogs(), cleanupOldLogs(), createRunLog(), ensureRunsDirectory(), generateRunId(), getRecentRunLogs() (+29 more)
...
Cohesion: 0.08
Nodes (35): execAsync, formatDuration(), generateReport(), parseTestOutput(), runTests(), RunTestsOptions, runTestSuite(), sendNotification() (+27 more)
...
Cohesion: 0.07
Nodes (21): format(), LiveCounter(), LiveCounterProps, BucketedFeature, bucketFeature(), CostBadge(), CostBreakdownPopover(), formatCost() (+13 more)
...
Cohesion: 0.09
Nodes (34): PrdLocation, getIssueDataService(), ActivityContext, awaitingInputFromProjection(), closedIssuesCache, commandDeckRouteLayer, costCache, execAsync (+26 more)
...
Cohesion: 0.08
Nodes (27): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+19 more)

### Community 172 - "Community 172"
Cohesion: 0.1
Nodes (30): Platform, buildLeakedSpecialists(), buildTopConsumers(), bytesToGb(), collectAgentProcesses(), CpuSample, DEFAULT_RESOURCE_CONFIG, ensureResourceConfigLoaded() (+22 more)

### Community 173 - "Community 173"
Cohesion: 0.11
Nodes (33): autoAdvanceInFlight, buildSlotPrompt(), buildStructuredSlotTaskInput(), createSlotWorktree(), DeferredSwarmItem, dispatchSwarmWave(), ensureSwarmAutoAdvanceLoop(), execAsync (+25 more)

### Community 174 - "Community 174"
Cohesion: 0.08
Nodes (28): BeadsTask, captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), execAsync, serializeHandoffContext(), __dirname (+20 more)
...
Cohesion: 0.1
Nodes (28): normalize(), unarchiveConversationCommand(), archiveConversation(), backfillConversationModel(), canReplaceTitle(), clearStuckForks(), createConversation(), FavoriteType (+20 more)
...
Cohesion: 0.13
Nodes (29): Conversation, listActiveConversations(), listConversations(), markConversationEnded(), backfillConversationModels(), assertSafeName(), cleanupConversationAttachments(), cleanupOrphanedConversationAttachments() (+21 more)
...
Cohesion: 0.16
Nodes (21): wipeCommand(), WipeOptions, CloseOutContext, CloseOutResult, CloseOutStep, execAsync, executeCloseOut(), findWorkspacePath() (+13 more)
...
Cohesion: 0.31
Nodes (20): buildPlaceholders(), clearLegacyPlanningDir(), clearProjectBeads(), clearShadowState(), deleteBranches(), execAsync, isDockerContainerProcess(), killOrphanedProcesses() (+12 more)
...
Cohesion: 0.18
Nodes (16): forkCommand(), ForkOptions, copySessionFromCompactBoundary(), createSummaryFork(), findLastCompactBoundaryOffset(), generateFallbackSummary(), generateSummaryForFork(), reserveSummaryForkSession() (+8 more)
...
Cohesion: 0.12
Nodes (16): AGENTS_DIR, agentDir, agentResult, beadsDir, branchResult, clearResult, content, legacyDir (+8 more)
...
Cohesion: 0.23
Nodes (13): handleConversationMessage(), resolveSessionFile(), activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings() (+5 more)
...
Cohesion: 0.22
Nodes (8): conversation, { editorState, mockFocus, mockToastError, mockSaveStoredModel }, fetchMock, file, onSend, secondConversation, url, view

### Community 687 - "Community 687"
Cohesion: 0.22
Nodes (7): evaluateSpawnGuardrails(), formatLeakedSpecialistSummary(), resolveAgentCountEnv(), defaultThresholds(), getResourceConfig(), SystemHealthSnapshot, decision
...
## Knowledge Gaps
- **11476 isolated node(s):** `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT`, `CLI_DIST` (+11471 more)
...
- **Why does `fetch` connect `Community 6` to `Community 641`, `Community 1`, `Community 3`, `Community 645`, `Community 133`, `Community 7`, `Community 8`, `Community 5`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 530`, `Community 147`, `Community 531`, `Community 277`, `Community 19`, `Community 276`, `Community 24`, `Community 25`, `Community 284`, `Community 29`, `Community 159`, `Community 32`, `Community 34`, `Community 35`, `Community 551`, `Community 39`, `Community 553`, `Community 43`, `Community 47`, `Community 48`, `Community 184`, `Community 66`, `Community 196`, `Community 83`, `Community 84`, `Community 92`, `Community 749`, `Community 122`, `Community 637`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComplexityLevel` connect `Community 132` to `Community 0`, `Community 174`, `Community 7`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 25` to `Community 101`, `Community 10`, `Community 555`, `Community 173`, `Community 206`, `Community 594`, `Community 371`, `Community 20`, `Community 21`?**
...
- **What connects `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname` to the rest of the system?**
  _11476 weakly-connected nodes found - possible documentation gaps or missing edges._
