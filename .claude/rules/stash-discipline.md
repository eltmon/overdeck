...
**Why:** PR #1537 (PAN-1531) removed Overdeck's silent stash flows. Silent agent-side stashing burned an entire day debugging a "missing work" incident before this rule was enforced.
