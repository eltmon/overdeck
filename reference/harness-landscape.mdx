...
<Note>
**This is a planning survey, not a support matrix.** Overdeck supports exactly
...
One nuance: Overdeck already authenticates **ChatGPT-subscription OAuth
...
- **Repo / package:** `github.com/badlogic/pi-mono`. **⚠ verify:** the project
  ...
  `@earendil-works/pi-coding-agent`; Overdeck's [Harnesses](/configuration/harnesses)
...
- **Extensibility:**
  - **Skills** — reads `SKILL.md`. Discovery: `~/.pi/agent/skills/`,
    ...
    arbitrary directories — Overdeck already exploits this by writing
...
- **Why a candidate:** Apache-2.0, native AGENTS.md + skills, excellent headless
  story, and Overdeck's ChatGPT-subscription auth already exists. The Codex
