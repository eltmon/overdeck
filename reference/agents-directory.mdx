...
review, plan and strike agents, workers, `pan spawn` panes, your conversations,
the subagents they started, and external agents that other tools launched (for
example Codex-plugin jobs). The page has three panes. Pick a place on the left,
