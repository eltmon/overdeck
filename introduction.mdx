...
`npx @overdeck/core` starts Command Deck immediately. For the packaged desktop app, use `@overdeck/desktop`. For headless and CI, use `pan` (install via `npm install -g @overdeck/core`).
