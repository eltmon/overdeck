...
<img src="/docs/screenshot-board.png" alt="Panopticon Kanban Board" style={{ borderRadius: '8px' }} />
...
<img src="/docs/dashboard-overview.png" alt="Mission Control" style={{ borderRadius: '8px' }} />
