...
| 7 | PAN-2230 | Circular-dependency ratchet (madge baseline in lint) | **IMPLEMENTED** — `lint:circular` wired into `npm run lint`; 76-cycle baseline at `scripts/circular-deps-baseline.txt` |
