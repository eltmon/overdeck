...
| `/plan` | Project | Planning for issues before implementation. Produces a canonical `specs/*.xbrief.json` plan on `overdeck-state`, initializes continue state, and updates the issue tracker. |
