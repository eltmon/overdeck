...
Project `CLAUDE.md`, `AGENTS.md`, `.claude/rules/`, `.cursor/rules/`, `.windsurf/rules/`,
...
shape is accepted temporarily as a no-op for compatibility. Skill, settings,
and hook distribution continues through its existing paths.
