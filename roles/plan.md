...
5. **Write the PRD draft** through the draft write door to `drafts/<ISSUE-ID>.md` on `overdeck-state` if it does not exist (see Outputs #1 for the standard). Do not proceed to the xBRIEF until the PRD is on disk.
