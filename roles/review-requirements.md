...
Do not run trace-validation scripts or other trace-checking CLIs. The context manifest already contains the trace data you need; verify it by reading the manifest and changed files only.
