...
```markdown
[PAN-1564](https://github.com/eltmon/overdeck/issues/1564)
```
...
| --- | --- | --- |
| `PAN-<n>` | GitHub (eltmon/overdeck) | `https://github.com/eltmon/overdeck/issues/<n>` — `PAN-<n>` **is** GitHub issue `#<n>` |
...
PRs follow the same rule: `#1430` → `[#1430](https://github.com/eltmon/overdeck/pull/1430)`.
