...
The model ID passes through unchanged. Prime Agent rejects an unknown model at
startup, and the launch error shows its message. Any other provider fails with a
