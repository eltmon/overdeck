...
- `gpt-5.6-sol` is the default OpenAI model surfaced by this harness. `gpt-6-astra`
  ...
  GPT-5.6 Sol and Luna at half their API price; they are opt-in too and need
  Codex CLI `0.156.0` or newer. Early rollout reports show `gpt-6-luna` refused
  on some ChatGPT sign-in accounts
