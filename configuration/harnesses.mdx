...
- Proxied models use a dedicated Claude Code context policy rather than copying
  ...
  separately measured conservative `150000` auto-compact policy, Kimi K2.7 Code
  keeps `262144`, and Anthropic models receive neither override so Claude Code's
  native context behavior remains in control.
