...
│   └── .claude/
│       ├── .overdeck/context/project.md # Managed project conventions
│       └── skills/
...
- Tasks: Generate .overdeck/context/project.md, repo-map.md, repo-groups.yaml, onboarding checklist
