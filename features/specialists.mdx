...
Review can also run in **convoy mode** — multiple reviewers in parallel, each with a focused lens (security, performance, requirements). See [Review Convoys](/features/convoys).
