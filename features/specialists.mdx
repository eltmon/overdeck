...
![Panopticon kanban board with specialists running](/images/specialists/01-board-hero.png)
...
![Specialists dashboard showing Cloister Deacon and per-project specialists](/images/specialists/02-agents-page.png)
...
![Model + specialist handoffs tracked over time](/images/specialists/04-handoffs.png)
...
![Inspector panel with merge-agent terminal streaming live](/images/specialists/08-inspector.png)
...
![Project health panel with per-project specialist roll-up](/images/specialists/06-health.png)

You can also watch handoffs and costs flow through the dashboard as they happen:

![Cost tracking across models and specialists](/images/specialists/09-costs.png)
