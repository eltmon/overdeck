...
<ThemedImage
  ...
  alt="Kanban board: issue columns with cost badges, agent status dots, and workspace controls, one card per issue/workspace"
/>
...
3. **Or kill manually** - `pan kill planning-<issue>`
...
<ThemedImage
  ...
  alt="Resources page: system RAM usage broken down by agents, conversations, and processes"
/>
