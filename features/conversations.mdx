...
linking or unlinking a PR by hand (dialog, transcript right-click, `pan conv
link-pr`), pipeline-created links, GitLab merge requests, the Pull requests page,
and search by PR number.
