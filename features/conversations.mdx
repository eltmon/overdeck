...
| **Conversation / Terminal toggle** | Switch between the rendered conversation and the raw terminal of the same session (the native CLI for OpenCode) |
...
available meanwhile. Other harnesses, including Codex app-server
conversations, keep their existing Terminal view.
