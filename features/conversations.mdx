...
| **Native CLI unavailable** | For example, the conversation uses the legacy `codex.transport: tui`, where its own terminal already runs the Codex CLI. **Show runtime log** opens it. |
